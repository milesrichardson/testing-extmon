...
c = {
  ...
  h: {
    ...
    1e4: { other: "00 tis\u00edc" },
    1e5: { other: "000 tis\u00edc" },
    1e6: { other: "0 mili\u00f3nov" },
    1e7: { other: "00 mili\u00f3nov" },
    1e8: { other: "000 mili\u00f3nov" },
    1e9: { other: "0 mili\u00e1rd" },
    1e10: { other: "00 mili\u00e1rd" },
    1e11: { other: "000 mili\u00e1rd" },
    1e12: { other: "0 bili\u00f3nov" },
    1e13: { other: "00 bili\u00f3nov" },
    1e14: { other: "000 bili\u00f3nov" }
  }
};
var d = {
  la: "y",
...
h = {
  B: ["pred Kr.", "po Kr."],
  A: ["pred Kristom", "po Kristovi"],
  P: "jfmamjjasond".split(""),
  ca: "jfmamjjasond".split(""),
  J: "janu\u00e1ra febru\u00e1ra marca apr\u00edla m\u00e1ja j\u00fana j\u00fala augusta septembra okt\u00f3bra novembra decembra".split(
    " "
  ),
  ba: "janu\u00e1r febru\u00e1r marec apr\u00edl m\u00e1j j\u00fan j\u00fal august september okt\u00f3ber november december".split(" "),
  Y: "jan feb mar apr m\u00e1j j\u00fan j\u00fal aug sep okt nov dec".split(" "),
  ea: "jan feb mar apr m\u00e1j j\u00fan j\u00fal aug sep okt nov dec".split(" "),
  ia: "nede\u013ea pondelok utorok streda \u0161tvrtok piatok sobota".split(" "),
  ga: "nede\u013ea pondelok utorok streda \u0161tvrtok piatok sobota".split(" "),
  aa: "ne po ut st \u0161t pi so".split(" "),
  fa: "ne po ut st \u0161t pi so".split(" "),
  R: "npus\u0161ps".split(""),
  da: "npus\u0161ps".split(""),
  Z: ["Q1", "Q2", "Q3", "Q4"],
  W: ["1. \u0161tvr\u0165rok", "2. \u0161tvr\u0165rok", "3. \u0161tvr\u0165rok", "4. \u0161tvr\u0165rok"],
  g: ["AM", "PM"],
  l: ["EEEE d. MMMM y", "d. MMMM y", "d. M. y", "d. M. y"],
  ha: ["H:mm:ss zzzz", "H:mm:ss z", "H:mm:ss", "H:mm"],
  m: ["{1} 'o' {0}", "{1} 'o' {0}", "{1}, {0}", "{1} {0}"],
  D: 0,
  ka: [5, 6],
  F: 3
};
