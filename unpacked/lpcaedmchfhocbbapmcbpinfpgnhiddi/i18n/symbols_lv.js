...
c = {
  i: {
    ...
    1e9: { other: "0\u00a0mljrd." },
    1e10: { other: "00\u00a0mljrd." },
    1e11: { other: "000\u00a0mljrd." },
    1e12: { other: "0\u00a0trilj." },
    1e13: { other: "00\u00a0trilj." },
    1e14: { other: "000\u00a0trilj." }
  },
  h: {
    1e3: { other: "0 t\u016bksto\u0161i" },
    1e4: { other: "00 t\u016bksto\u0161i" },
    1e5: { other: "000 t\u016bksto\u0161i" },
    1e6: { other: "0 miljoni" },
    1e7: { other: "00 miljoni" },
    1e8: { other: "000 miljoni" },
    1e9: { other: "0 miljardi" },
    1e10: { other: "00 miljardi" },
    1e11: { other: "000 miljardi" },
    1e12: { other: "0 triljoni" },
    1e13: { other: "00 triljoni" },
    1e14: { other: "000 triljoni" }
  }
};
var d = {
  la: "y",
...
h = {
  B: ["p.m.\u0113.", "m.\u0113."],
  A: ["pirms m\u016bsu \u0113ras", "m\u016bsu \u0113r\u0101"],
  P: "JFMAMJJASOND".split(""),
  ca: "JFMAMJJASOND".split(""),
  J: "janv\u0101ris febru\u0101ris marts apr\u012blis maijs j\u016bnijs j\u016blijs augusts septembris oktobris novembris decembris".split(
    " "
  ),
  ba: "janv\u0101ris febru\u0101ris marts apr\u012blis maijs j\u016bnijs j\u016blijs augusts septembris oktobris novembris decembris".split(
    " "
  ),
  Y: "janv. febr. marts apr. maijs j\u016bn. j\u016bl. aug. sept. okt. nov. dec.".split(" "),
  ea: "janv. febr. marts apr. maijs j\u016bn. j\u016bl. aug. sept. okt. nov. dec.".split(" "),
  ia: "sv\u0113tdiena pirmdiena otrdiena tre\u0161diena ceturtdiena piektdiena sestdiena".split(" "),
  ga: "Sv\u0113tdiena Pirmdiena Otrdiena Tre\u0161diena Ceturtdiena Piektdiena Sestdiena".split(" "),
  aa: "sv\u0113td. pirmd. otrd. tre\u0161d. ceturtd. piektd. sestd.".split(" "),
  fa: "Sv\u0113td. Pirmd. Otrd. Tre\u0161d. Ceturtd. Piektd. Sestd.".split(" "),
  R: "SPOTCPS".split(""),
  da: "SPOTCPS".split(""),
  Z: ["1.\u00a0cet.", "2.\u00a0cet.", "3.\u00a0cet.", "4.\u00a0cet."],
  W: ["1. ceturksnis", "2. ceturksnis", "3. ceturksnis", "4. ceturksnis"],
  g: ["priek\u0161pusdien\u0101", "p\u0113cpusdien\u0101"],
  l: ["EEEE, y. 'gada' d. MMMM", "y. 'gada' d. MMMM", "y. 'gada' d. MMM", "dd.MM.yy"],
