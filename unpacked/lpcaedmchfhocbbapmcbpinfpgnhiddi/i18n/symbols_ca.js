...
c = {
  ...
  h: {
    1e3: { other: "0 milers" },
    1e4: { other: "00 milers" },
    1e5: { other: "000 milers" },
    1e6: { other: "0 milions" },
    1e7: { other: "00 milions" },
    1e8: { other: "000 milions" },
    1e9: { other: "0 milers de milions" },
    1e10: { other: "00 milers de milions" },
    1e11: { other: "000 milers de milions" },
    1e12: { other: "0 bilions" },
    1e13: { other: "00 bilions" },
    1e14: { other: "000 bilions" }
  }
};
var d = {
  la: "y",
...
h = {
  B: ["aC", "dC"],
  A: ["abans de Crist", "despr\u00e9s de Crist"],
  P: "GN FB M\u00c7 AB MG JN JL AG ST OC NV DS".split(" "),
  ca: "GN FB M\u00c7 AB MG JN JL AG ST OC NV DS".split(" "),
  J: "de gener;de febrer;de mar\u00e7;d\u2019abril;de maig;de juny;de juliol;d\u2019agost;de setembre;d\u2019octubre;de novembre;de desembre".split(
    ";"
  ),
  ba: "gener febrer mar\u00e7 abril maig juny juliol agost setembre octubre novembre desembre".split(" "),
  Y: "de gen.;de febr.;de mar\u00e7;d\u2019abr.;de maig;de juny;de jul.;d\u2019ag.;de set.;d\u2019oct.;de nov.;de des.".split(";"),
  ea: "gen. febr. mar\u00e7 abr. maig juny jul. ag. set. oct. nov. des.".split(" "),
  ia: "diumenge dilluns dimarts dimecres dijous divendres dissabte".split(" "),
  ga: "diumenge dilluns dimarts dimecres dijous divendres dissabte".split(" "),
  aa: "dg. dl. dt. dc. dj. dv. ds.".split(" "),
  fa: "dg. dl. dt. dc. dj. dv. ds.".split(" "),
  R: "dg. dl. dt. dc. dj. dv. ds.".split(" "),
  da: "dg. dl. dt. dc. dj. dv. ds.".split(" "),
  Z: ["1T", "2T", "3T", "4T"],
  W: ["1r trimestre", "2n trimestre", "3r trimestre", "4t trimestre"],
  g: ["a.\u00a0m.", "p.\u00a0m."],
  l: ["EEEE, d MMMM 'del' y", "d MMMM 'del' y", "d MMM y", "d/M/yy"],
  ha: ["H:mm:ss (zzzz)", "H:mm:ss z", "H:mm:ss", "H:mm"],
  m: ["{1}, 'a' 'les' {0}", "{1}, 'a' 'les' {0}", "{1}, {0}", "{1} {0}"],
  D: 0,
  ka: [5, 6],
  F: 3
};
