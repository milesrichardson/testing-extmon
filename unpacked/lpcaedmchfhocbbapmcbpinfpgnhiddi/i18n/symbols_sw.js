...
c = {
  i: {
    1e3: { other: "elfu\u00a00;elfu\u00a0-0" },
    1e4: { other: "elfu\u00a000;elfu\u00a0-00" },
    1e5: { other: "elfu\u00a0000;elfu\u00a0-000" },
    1e6: { other: "0M" },
    1e7: { other: "00M" },
    1e8: { other: "000M" },
    1e9: { other: "0B;-0B" },
    1e10: { other: "00B;-00B" },
    1e11: { other: "000B;-000B" },
    1e12: { other: "0T" },
    1e13: { other: "00T" },
    1e14: { other: "000T" }
  },
  h: {
    ...
    1e4: { other: "elfu 00;elfu -00" },
    1e5: { other: "elfu 000;elfu -000" },
    1e6: { other: "milioni 0;milioni -0" },
    1e7: { other: "milioni 00;milioni -00" },
    1e8: { other: "milioni 000;milioni -000" },
    1e9: { other: "bilioni 0;bilioni -0" },
    1e10: { other: "bilioni 00;bilioni -00" },
    1e11: { other: "bilioni 000;bilioni -000" },
    1e12: { other: "trilioni 0;trilioni -0" },
    1e13: { other: "trilioni 00;trilioni -00" },
    1e14: { other: "trilioni 000;trilioni -000" }
  }
};
var d = {
  la: "y",
...
h = {
  B: ["KK", "BK"],
  A: ["Kabla ya Kristo", "Baada ya Kristo"],
  P: "JFMAMJJASOND".split(""),
  ca: "JFMAMJJASOND".split(""),
  J: "Januari Februari Machi Aprili Mei Juni Julai Agosti Septemba Oktoba Novemba Desemba".split(" "),
  ba: "Januari Februari Machi Aprili Mei Juni Julai Agosti Septemba Oktoba Novemba Desemba".split(" "),
  Y: "Jan Feb Mac Apr Mei Jun Jul Ago Sep Okt Nov Des".split(" "),
  ea: "Jan Feb Mac Apr Mei Jun Jul Ago Sep Okt Nov Des".split(" "),
  ia: "Jumapili Jumatatu Jumanne Jumatano Alhamisi Ijumaa Jumamosi".split(" "),
  ga: "Jumapili Jumatatu Jumanne Jumatano Alhamisi Ijumaa Jumamosi".split(" "),
  aa: "Jumapili Jumatatu Jumanne Jumatano Alhamisi Ijumaa Jumamosi".split(" "),
  fa: "Jumapili Jumatatu Jumanne Jumatano Alhamisi Ijumaa Jumamosi".split(" "),
  R: "SMTWTFS".split(""),
  da: "SMTWTFS".split(""),
  Z: ["Robo ya 1", "Robo ya 2", "Robo ya 3", "Robo ya 4"],
  W: ["Robo ya 1", "Robo ya 2", "Robo ya 3", "Robo ya 4"],
  g: ["AM", "PM"],
