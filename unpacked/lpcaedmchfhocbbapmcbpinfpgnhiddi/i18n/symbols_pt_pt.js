...
c = {
  ...
  h: {
    ...
    1e9: { other: "0 mil milh\u00f5es" },
    1e10: { other: "00 mil milh\u00f5es" },
    1e11: { other: "000 mil milh\u00f5es" },
    1e12: { other: "0 bili\u00f5es" },
    1e13: { other: "00 bili\u00f5es" },
    1e14: { other: "000 bili\u00f5es" }
  }
};
var d = {
  la: "y",
...
h = {
  ...
  aa: "domingo segunda ter\u00e7a quarta quinta sexta s\u00e1bado".split(" "),
  fa: "domingo segunda ter\u00e7a quarta quinta sexta s\u00e1bado".split(" "),
  R: "DSTQQSS".split(""),
  da: "DSTQQSS".split(""),
  Z: ["T1", "T2", "T3", "T4"],
  W: ["1.\u00ba trimestre", "2.\u00ba trimestre", "3.\u00ba trimestre", "4.\u00ba trimestre"],
  g: ["da manh\u00e3", "da tarde"],
  l: ["EEEE, d 'de' MMMM 'de' y", "d 'de' MMMM 'de' y", "dd/MM/y", "dd/MM/yy"],
