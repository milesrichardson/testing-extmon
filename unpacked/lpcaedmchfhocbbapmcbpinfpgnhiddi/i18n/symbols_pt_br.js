...
c = {
  ...
  h: {
    ...
    1e5: { other: "000 mil" },
    1e6: { other: "0 milh\u00f5es" },
    1e7: { other: "00 milh\u00f5es" },
    1e8: { other: "000 milh\u00f5es" },
    1e9: { other: "0 bilh\u00f5es" },
    1e10: { other: "00 bilh\u00f5es" },
    1e11: { other: "000 bilh\u00f5es" },
    1e12: { other: "0 trilh\u00f5es" },
    1e13: { other: "00 trilh\u00f5es" },
    1e14: { other: "000 trilh\u00f5es" }
  }
};
var d = {
  la: "y",
...
h = {
  B: ["a.C.", "d.C."],
  A: ["antes de Cristo", "depois de Cristo"],
  P: "JFMAMJJASOND".split(""),
  ca: "JFMAMJJASOND".split(""),
  J: "janeiro fevereiro mar\u00e7o abril maio junho julho agosto setembro outubro novembro dezembro".split(" "),
  ba: "janeiro fevereiro mar\u00e7o abril maio junho julho agosto setembro outubro novembro dezembro".split(" "),
  Y: "jan. fev. mar. abr. mai. jun. jul. ago. set. out. nov. dez.".split(" "),
  ea: "jan. fev. mar. abr. mai. jun. jul. ago. set. out. nov. dez.".split(" "),
  ia: "domingo segunda-feira ter\u00e7a-feira quarta-feira quinta-feira sexta-feira s\u00e1bado".split(" "),
  ga: "domingo segunda-feira ter\u00e7a-feira quarta-feira quinta-feira sexta-feira s\u00e1bado".split(" "),
  aa: "dom. seg. ter. qua. qui. sex. s\u00e1b.".split(" "),
  fa: "dom. seg. ter. qua. qui. sex. s\u00e1b.".split(" "),
  R: "DSTQQSS".split(""),
  da: "DSTQQSS".split(""),
  Z: ["T1", "T2", "T3", "T4"],
  W: ["1\u00ba trimestre", "2\u00ba trimestre", "3\u00ba trimestre", "4\u00ba trimestre"],
  g: ["AM", "PM"],
  l: ["EEEE, d 'de' MMMM 'de' y", "d 'de' MMMM 'de' y", "d 'de' MMM 'de' y", "dd/MM/y"],
  ha: ["HH:mm:ss zzzz", "HH:mm:ss z", "HH:mm:ss", "HH:mm"],
  m: ["{1} '\u00e0s' {0}", "{1} '\u00e0s' {0}", "{1}, {0}", "{1}, {0}"],
  D: 6,
  ka: [5, 6],
  F: 5
};
