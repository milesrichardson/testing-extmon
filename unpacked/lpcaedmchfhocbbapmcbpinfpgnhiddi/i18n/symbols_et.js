...
c = {
  ...
  h: {
    ...
    1e4: { other: "00 tuhat" },
    1e5: { other: "000 tuhat" },
    1e6: { other: "0 miljonit" },
    1e7: { other: "00 miljonit" },
    1e8: { other: "000 miljonit" },
    1e9: { other: "0 miljardit" },
    1e10: { other: "00 miljardit" },
    1e11: { other: "000 miljardit" },
    1e12: { other: "0 triljonit" },
    1e13: { other: "00 triljonit" },
    1e14: { other: "000 triljonit" }
  }
};
var d = {
  la: "y",
...
h = {
  B: ["eKr", "pKr"],
  A: ["enne Kristust", "p\u00e4rast Kristust"],
  P: "JVMAMJJASOND".split(""),
  ca: "JVMAMJJASOND".split(""),
  J: "jaanuar veebruar m\u00e4rts aprill mai juuni juuli august september oktoober november detsember".split(" "),
  ba: "jaanuar veebruar m\u00e4rts aprill mai juuni juuli august september oktoober november detsember".split(" "),
  Y: "jaan veebr m\u00e4rts apr mai juuni juuli aug sept okt nov dets".split(" "),
  ea: "jaan veebr m\u00e4rts apr mai juuni juuli aug sept okt nov dets".split(" "),
  ia: "p\u00fchap\u00e4ev esmasp\u00e4ev teisip\u00e4ev kolmap\u00e4ev neljap\u00e4ev reede laup\u00e4ev".split(" "),
  ga: "p\u00fchap\u00e4ev esmasp\u00e4ev teisip\u00e4ev kolmap\u00e4ev neljap\u00e4ev reede laup\u00e4ev".split(" "),
  aa: "PETKNRL".split(""),
  fa: "PETKNRL".split(""),
  R: "PETKNRL".split(""),
  da: "PETKNRL".split(""),
