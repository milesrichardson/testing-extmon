...
c = {
  ...
  h: {
    1e3: { other: "0 tuhatta" },
    1e4: { other: "00 tuhatta" },
    1e5: { other: "000 tuhatta" },
    1e6: { other: "0 miljoonaa" },
    1e7: { other: "00 miljoonaa" },
    1e8: { other: "000 miljoonaa" },
    1e9: { other: "0 miljardia" },
    1e10: { other: "00 miljardia" },
    1e11: { other: "000 miljardia" },
    1e12: { other: "0 biljoonaa" },
    1e13: { other: "00 biljoonaa" },
    1e14: { other: "000 biljoonaa" }
  }
};
var d = {
  la: "y",
...
h = {
  B: ["eKr.", "jKr."],
  A: ["ennen Kristuksen syntym\u00e4\u00e4", "j\u00e4lkeen Kristuksen syntym\u00e4n"],
  P: "THMHTKHESLMJ".split(""),
  ca: "THMHTKHESLMJ".split(""),
  J: "tammikuuta helmikuuta maaliskuuta huhtikuuta toukokuuta kes\u00e4kuuta hein\u00e4kuuta elokuuta syyskuuta lokakuuta marraskuuta joulukuuta".split(
    " "
  ),
  ba: "tammikuu helmikuu maaliskuu huhtikuu toukokuu kes\u00e4kuu hein\u00e4kuu elokuu syyskuu lokakuu marraskuu joulukuu".split(" "),
  Y: "tammik. helmik. maalisk. huhtik. toukok. kes\u00e4k. hein\u00e4k. elok. syysk. lokak. marrask. jouluk.".split(" "),
  ea: "tammi helmi maalis huhti touko kes\u00e4 hein\u00e4 elo syys loka marras joulu".split(" "),
  ia: "sunnuntaina maanantaina tiistaina keskiviikkona torstaina perjantaina lauantaina".split(" "),
  ga: "sunnuntai maanantai tiistai keskiviikko torstai perjantai lauantai".split(" "),
  aa: "su ma ti ke to pe la".split(" "),
  fa: "su ma ti ke to pe la".split(" "),
  R: "SMTKTPL".split(""),
  da: "SMTKTPL".split(""),
  Z: ["1. nelj.", "2. nelj.", "3. nelj.", "4. nelj."],
  W: ["1. nelj\u00e4nnes", "2. nelj\u00e4nnes", "3. nelj\u00e4nnes", "4. nelj\u00e4nnes"],
  g: ["ap.", "ip."],
