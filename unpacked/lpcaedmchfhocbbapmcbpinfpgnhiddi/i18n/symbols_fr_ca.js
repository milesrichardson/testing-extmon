...
c = {
  ...
  h: {
    ...
    1e4: { other: "00 mille" },
    1e5: { other: "000 mille" },
    1e6: { other: "0 millions" },
    1e7: { other: "00 millions" },
    1e8: { other: "000 millions" },
    1e9: { other: "0 milliards" },
    1e10: { other: "00 milliards" },
    1e11: { other: "000 milliards" },
    1e12: { other: "0 billions" },
    1e13: { other: "00 billions" },
    1e14: { other: "000 billions" }
  }
};
var d = {
  la: "y",
...
h = {
  B: ["av. J.-C.", "ap. J.-C."],
  A: ["avant J\u00e9sus-Christ", "apr\u00e8s J\u00e9sus-Christ"],
  P: "JFMAMJJASOND".split(""),
  ca: "JFMAMJJASOND".split(""),
  J: "janvier f\u00e9vrier mars avril mai juin juillet ao\u00fbt septembre octobre novembre d\u00e9cembre".split(" "),
  ba: "janvier f\u00e9vrier mars avril mai juin juillet ao\u00fbt septembre octobre novembre d\u00e9cembre".split(" "),
  Y: "janv. f\u00e9vr. mars avr. mai juin juill. ao\u00fbt sept. oct. nov. d\u00e9c.".split(" "),
  ea: "janv. f\u00e9vr. mars avr. mai juin juill. ao\u00fbt sept. oct. nov. d\u00e9c.".split(" "),
  ia: "dimanche lundi mardi mercredi jeudi vendredi samedi".split(" "),
  ga: "dimanche lundi mardi mercredi jeudi vendredi samedi".split(" "),
  aa: "dim. lun. mar. mer. jeu. ven. sam.".split(" "),
  fa: "dim. lun. mar. mer. jeu. ven. sam.".split(" "),
  R: "DLMMJVS".split(""),
  da: "DLMMJVS".split(""),
  Z: ["T1", "T2", "T3", "T4"],
  W: ["1er trimestre", "2e trimestre", "3e trimestre", "4e trimestre"],
  g: ["a.m.", "p.m."],
  l: ["EEEE d MMMM y", "d MMMM y", "d MMM y", "y-MM-dd"],
  ha: ["HH 'h' mm 'min' ss 's' zzzz", "HH 'h' mm 'min' ss 's' z", "HH 'h' mm 'min' ss 's'", "HH 'h' mm"],
  m: ["{1} '\u00e0' {0}", "{1} '\u00e0' {0}", "{1}, {0}", "{1} {0}"],
  D: 6,
  ka: [5, 6],
  F: 5
};
