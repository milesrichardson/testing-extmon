...
h = {
  B: ["SM", "M"],
  A: ["Sebelum Masehi", "Masehi"],
  P: "JFMAMJJASOND".split(""),
  ca: "JFMAMJJASOND".split(""),
  J: "Januari Februari Maret April Mei Juni Juli Agustus September Oktober November Desember".split(" "),
  ba: "Januari Februari Maret April Mei Juni Juli Agustus September Oktober November Desember".split(" "),
  Y: "Jan Feb Mar Apr Mei Jun Jul Agu Sep Okt Nov Des".split(" "),
  ea: "Jan Feb Mar Apr Mei Jun Jul Agu Sep Okt Nov Des".split(" "),
  ia: "Minggu Senin Selasa Rabu Kamis Jumat Sabtu".split(" "),
  ga: "Minggu Senin Selasa Rabu Kamis Jumat Sabtu".split(" "),
  aa: "Min Sen Sel Rab Kam Jum Sab".split(" "),
  fa: "Min Sen Sel Rab Kam Jum Sab".split(" "),
  R: "MSSRKJS".split(""),
  da: "MSSRKJS".split(""),
  Z: ["K1", "K2", "K3", "K4"],
  W: ["Kuartal ke-1", "Kuartal ke-2", "Kuartal ke-3", "Kuartal ke-4"],
  g: ["AM", "PM"],
  l: ["EEEE, dd MMMM y", "d MMMM y", "d MMM y", "dd/MM/yy"],
  ha: ["HH.mm.ss zzzz", "HH.mm.ss z", "HH.mm.ss", "HH.mm"],
  m: ["{1} 'pukul' {0}", "{1} 'pukul' {0}", "{1}, {0}", "{1}, {0}"],
  D: 6,
  ka: [5, 6],
  F: 5
};
