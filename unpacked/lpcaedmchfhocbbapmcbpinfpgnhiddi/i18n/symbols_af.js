...
c = {
  ...
  h: {
    1e3: { other: "0 duisend" },
    1e4: { other: "00 duisend" },
    1e5: { other: "000 duisend" },
    1e6: { other: "0 miljoen" },
    1e7: { other: "00 miljoen" },
    1e8: { other: "000 miljoen" },
    1e9: { other: "0 miljard" },
    1e10: { other: "00 miljard" },
    1e11: { other: "000 miljard" },
    1e12: { other: "0 biljoen" },
    1e13: { other: "00 biljoen" },
    1e14: { other: "000 biljoen" }
  }
};
var d = {
  la: "y",
...
h = {
  B: ["v.C.", "n.C."],
  A: ["voor Christus", "na Christus"],
  P: "JFMAMJJASOND".split(""),
  ca: "JFMAMJJASOND".split(""),
  J: "Januarie Februarie Maart April Mei Junie Julie Augustus September Oktober November Desember".split(" "),
  ba: "Januarie Februarie Maart April Mei Junie Julie Augustus September Oktober November Desember".split(" "),
  Y: "Jan. Feb. Mrt. Apr. Mei Jun. Jul. Aug. Sep. Okt. Nov. Des.".split(" "),
  ea: "Jan. Feb. Mrt. Apr. Mei Jun. Jul. Aug. Sep. Okt. Nov. Des.".split(" "),
  ia: "Sondag Maandag Dinsdag Woensdag Donderdag Vrydag Saterdag".split(" "),
  ga: "Sondag Maandag Dinsdag Woensdag Donderdag Vrydag Saterdag".split(" "),
  aa: "So. Ma. Di. Wo. Do. Vr. Sa.".split(" "),
  fa: "So. Ma. Di. Wo. Do. Vr. Sa.".split(" "),
  R: "SMDWDVS".split(""),
  da: "SMDWDVS".split(""),
  Z: ["K1", "K2", "K3", "K4"],
  W: ["1ste kwartaal", "2de kwartaal", "3de kwartaal", "4de kwartaal"],
  g: ["vm.", "nm."],
  l: ["EEEE dd MMMM y", "dd MMMM y", "dd MMM y", "y-MM-dd"],
