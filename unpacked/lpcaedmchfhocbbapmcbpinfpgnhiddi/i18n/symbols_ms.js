...
c = {
  ...
  h: {
    ...
    1e8: { other: "000 juta" },
    1e9: { other: "0 bilion" },
    1e10: { other: "00 bilion" },
    1e11: { other: "000 bilion" },
    1e12: { other: "0 trilion" },
    1e13: { other: "00 trilion" },
    1e14: { other: "000 trilion" }
  }
};
var d = {
  la: "y",
...
h = {
  B: ["S.M.", "TM"],
  A: ["S.M.", "TM"],
  P: "JFMAMJJOSOND".split(""),
  ca: "JFMAMJJOSOND".split(""),
  J: "Januari Februari Mac April Mei Jun Julai Ogos September Oktober November Disember".split(" "),
  ba: "Januari Februari Mac April Mei Jun Julai Ogos September Oktober November Disember".split(" "),
  Y: "Jan Feb Mac Apr Mei Jun Jul Ogo Sep Okt Nov Dis".split(" "),
  ea: "Jan Feb Mac Apr Mei Jun Jul Ogo Sep Okt Nov Dis".split(" "),
  ia: "Ahad Isnin Selasa Rabu Khamis Jumaat Sabtu".split(" "),
  ga: "Ahad Isnin Selasa Rabu Khamis Jumaat Sabtu".split(" "),
  aa: "Ahd Isn Sel Rab Kha Jum Sab".split(" "),
  fa: "Ahd Isn Sel Rab Kha Jum Sab".split(" "),
  R: "AISRKJS".split(""),
  da: "AISRKJS".split(""),
  Z: ["S1", "S2", "S3", "S4"],
  W: ["Suku pertama", "Suku Ke-2", "Suku Ke-3", "Suku Ke-4"],
  g: ["PG", "PTG"],
  l: ["EEEE, d MMMM y", "d MMMM y", "d MMM y", "d/MM/yy"],
  ha: ["h:mm:ss\u202fa zzzz", "h:mm:ss\u202fa z", "h:mm:ss\u202fa", "h:mm\u202fa"],
  m: ["{1} 'pada' {0}", "{1} 'pada' {0}", "{1}, {0}", "{1}, {0}"],
  D: 0,
  ka: [5, 6],
  F: 6
};
