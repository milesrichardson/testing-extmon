...
h = {
  B: ["f.Kr.", "e.Kr."],
  A: ["f\u00f8r Kristus", "etter Kristus"],
  P: "JFMAMJJASOND".split(""),
  ca: "JFMAMJJASOND".split(""),
  J: "januar februar mars april mai juni juli august september oktober november desember".split(" "),
  ba: "januar februar mars april mai juni juli august september oktober november desember".split(" "),
  Y: "jan. feb. mars apr. mai juni juli aug. sep. okt. nov. des.".split(" "),
  ea: "jan feb mar apr mai jun jul aug sep okt nov des".split(" "),
  ia: "s\u00f8ndag mandag tirsdag onsdag torsdag fredag l\u00f8rdag".split(" "),
  ga: "s\u00f8ndag mandag tirsdag onsdag torsdag fredag l\u00f8rdag".split(" "),
  aa: "s\u00f8n. man. tir. ons. tor. fre. l\u00f8r.".split(" "),
  fa: "s\u00f8n. man. tir. ons. tor. fre. l\u00f8r.".split(" "),
  R: "SMTOTFL".split(""),
  da: "SMTOTFL".split(""),
  Z: ["K1", "K2", "K3", "K4"],
