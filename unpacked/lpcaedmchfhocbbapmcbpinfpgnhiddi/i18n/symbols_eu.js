...
c = {
  ...
  h: {
    ...
    1e6: { other: "0 milioi" },
    1e7: { other: "00 milioi" },
    1e8: { other: "000 milioi" },
    1e9: { other: "0000 milioi" },
    1e10: { other: "00000 milioi" },
    1e11: { other: "000000 milioi" },
    1e12: { other: "0 bilioi" },
    1e13: { other: "00 bilioi" },
    1e14: { other: "000 bilioi" }
  }
};
var d = {
  la: "y",
...
h = {
  B: ["K.a.", "K.o."],
  A: ["K.a.", "Kristo ondoren"],
  P: "UOMAMEUAIUAA".split(""),
  ca: "UOMAMEUAIUAA".split(""),
  J: "urtarrila otsaila martxoa apirila maiatza ekaina uztaila abuztua iraila urria azaroa abendua".split(" "),
  ba: "urtarrila otsaila martxoa apirila maiatza ekaina uztaila abuztua iraila urria azaroa abendua".split(" "),
  Y: "urt. ots. mar. api. mai. eka. uzt. abu. ira. urr. aza. abe.".split(" "),
  ea: "urt. ots. mar. api. mai. eka. uzt. abu. ira. urr. aza. abe.".split(" "),
  ia: "igandea astelehena asteartea asteazkena osteguna ostirala larunbata".split(" "),
  ga: "igandea astelehena asteartea asteazkena osteguna ostirala larunbata".split(" "),
  aa: "ig. al. ar. az. og. or. lr.".split(" "),
  fa: "ig. al. ar. az. og. or. lr.".split(" "),
  R: "IAAAOOL".split(""),
  da: "IAAAOOL".split(""),
  Z: ["1Hh", "2Hh", "3Hh", "4Hh"],
  W: ["1. hiruhilekoa", "2. hiruhilekoa", "3. hiruhilekoa", "4. hiruhilekoa"],
  g: ["AM", "PM"],
