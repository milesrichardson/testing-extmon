...
c = {
  ...
  h: {
    1e3: { other: "0 inkulungwane" },
    1e4: { other: "00 inkulungwane" },
    1e5: { other: "000 inkulungwane" },
    1e6: { other: "0 isigidi" },
    1e7: { other: "00 isigidi" },
    1e8: { other: "000 isigidi" },
    1e9: { other: "0 isigidi sezigidi" },
    1e10: { other: "00 isigidi sezigidi" },
    1e11: { other: "000 isigidi sezigidi" },
    1e12: { other: "0 isigidintathu" },
    1e13: { other: "00 isigidintathu" },
    1e14: { other: "000 isigidintathu" }
  }
};
var d = {
  la: "y",
...
h = {
  B: ["BC", "AD"],
  A: ["BC", "AD"],
  P: "JFMEMJJASOND".split(""),
  ca: "JFMAMJJASOND".split(""),
  J: "Januwari Februwari Mashi Ephreli Meyi Juni Julayi Agasti Septhemba Okthoba Novemba Disemba".split(" "),
  ba: "Januwari Februwari Mashi Ephreli Meyi Juni Julayi Agasti Septhemba Okthoba Novemba Disemba".split(" "),
  Y: "Jan Feb Mas Eph Mey Jun Jul Aga Sep Okt Nov Dis".split(" "),
  ea: "Jan Feb Mas Eph Mey Jun Jul Aga Sep Okt Nov Dis".split(" "),
  ia: "ISonto UMsombuluko ULwesibili ULwesithathu ULwesine ULwesihlanu UMgqibelo".split(" "),
  ga: "ISonto UMsombuluko ULwesibili ULwesithathu ULwesine ULwesihlanu UMgqibelo".split(" "),
  aa: "Son Mso Bil Tha Sin Hla Mgq".split(" "),
  fa: "Son Mso Bil Tha Sin Hla Mgq".split(" "),
  R: "SMBTSHM".split(""),
  da: "SMBTSHM".split(""),
  Z: ["Q1", "Q2", "Q3", "Q4"],
  W: ["ikota yesi-1", "ikota yesi-2", "ikota yesi-3", "ikota yesi-4"],
  g: ["AM", "PM"],
  l: ["EEEE, MMMM d, y", "MMMM d, y", "MMM d, y", "M/d/yy"],
