...
h = {
  B: ["a. C.", "d. C."],
  A: ["antes de Cristo", "despu\u00e9s de Cristo"],
  P: "EFMAMJJASOND".split(""),
  ca: "EFMAMJJASOND".split(""),
  J: "enero febrero marzo abril mayo junio julio agosto septiembre octubre noviembre diciembre".split(" "),
  ba: "enero febrero marzo abril mayo junio julio agosto septiembre octubre noviembre diciembre".split(" "),
  Y: "ene feb mar abr may jun jul ago sept oct nov dic".split(" "),
  ea: "ene feb mar abr may jun jul ago sept oct nov dic".split(" "),
  ia: "domingo lunes martes mi\u00e9rcoles jueves viernes s\u00e1bado".split(" "),
  ga: "domingo lunes martes mi\u00e9rcoles jueves viernes s\u00e1bado".split(" "),
  aa: "dom lun mar mi\u00e9 jue vie s\u00e1b".split(" "),
  fa: "dom lun mar mi\u00e9 jue vie s\u00e1b".split(" "),
  R: "DLMXJVS".split(""),
  da: "DLMXJVS".split(""),
  Z: ["T1", "T2", "T3", "T4"],
  W: ["1.er trimestre", "2.\u00ba trimestre", "3.er trimestre", "4.\u00ba trimestre"],
  g: ["a.\u00a0m.", "p.\u00a0m."],
