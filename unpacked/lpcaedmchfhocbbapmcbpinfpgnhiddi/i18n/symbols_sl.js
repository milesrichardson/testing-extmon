...
c = {
  ...
  h: {
    ...
    1e4: { other: "00 tiso\u010d" },
    1e5: { other: "000 tiso\u010d" },
    1e6: { other: "0 milijonov" },
    1e7: { other: "00 milijonov" },
    1e8: { other: "000 milijonov" },
    1e9: { other: "0 milijard" },
    1e10: { other: "00 milijard" },
    1e11: { other: "000 milijard" },
    1e12: { other: "0 bilijonov" },
    1e13: { other: "00 bilijonov" },
    1e14: { other: "000 bilijonov" }
  }
};
var d = {
  la: "y",
...
h = {
  B: ["pr. Kr.", "po Kr."],
  A: ["pred Kristusom", "po Kristusu"],
  P: "jfmamjjasond".split(""),
  ca: "jfmamjjasond".split(""),
  J: "januar februar marec april maj junij julij avgust september oktober november december".split(" "),
  ba: "januar februar marec april maj junij julij avgust september oktober november december".split(" "),
  Y: "jan. feb. mar. apr. maj jun. jul. avg. sep. okt. nov. dec.".split(" "),
  ea: "jan. feb. mar. apr. maj jun. jul. avg. sep. okt. nov. dec.".split(" "),
  ia: "nedelja ponedeljek torek sreda \u010detrtek petek sobota".split(" "),
  ga: "nedelja ponedeljek torek sreda \u010detrtek petek sobota".split(" "),
  aa: "ned. pon. tor. sre. \u010det. pet. sob.".split(" "),
  fa: "ned. pon. tor. sre. \u010det. pet. sob.".split(" "),
  R: "npts\u010dps".split(""),
  da: "npts\u010dps".split(""),
