...
c = {
  ...
  h: {
    1e3: { other: "0 Tausend" },
    1e4: { other: "00 Tausend" },
    1e5: { other: "000 Tausend" },
    1e6: { other: "0 Millionen" },
    1e7: { other: "00 Millionen" },
    1e8: { other: "000 Millionen" },
    1e9: { other: "0 Milliarden" },
    1e10: { other: "00 Milliarden" },
    1e11: { other: "000 Milliarden" },
    1e12: { other: "0 Billionen" },
    1e13: { other: "00 Billionen" },
    1e14: { other: "000 Billionen" }
  }
};
var d = {
  la: "y",
...
h = {
  ...
  P: "JFMAMJJASOND".split(""),
  ca: "JFMAMJJASOND".split(""),
  J: "Januar Februar M\u00e4rz April Mai Juni Juli August September Oktober November Dezember".split(" "),
  ba: "Januar Februar M\u00e4rz April Mai Juni Juli August September Oktober November Dezember".split(" "),
  Y: "Jan. Feb. M\u00e4rz Apr. Mai Juni Juli Aug. Sept. Okt. Nov. Dez.".split(" "),
  ea: "Jan Feb M\u00e4r Apr Mai Jun Jul Aug Sep Okt Nov Dez".split(" "),
  ia: "Sonntag Montag Dienstag Mittwoch Donnerstag Freitag Samstag".split(" "),
  ga: "Sonntag Montag Dienstag Mittwoch Donnerstag Freitag Samstag".split(" "),
  aa: "So. Mo. Di. Mi. Do. Fr. Sa.".split(" "),
  fa: "So Mo Di Mi Do Fr Sa".split(" "),
  R: "SMDMDFS".split(""),
  da: "SMDMDFS".split(""),
  Z: ["Q1", "Q2", "Q3", "Q4"],
  W: ["1. Quartal", "2. Quartal", "3. Quartal", "4. Quartal"],
  g: ["AM", "PM"],
  l: ["EEEE, d. MMMM y", "d. MMMM y", "dd.MM.y", "dd.MM.yy"],
  ha: ["HH:mm:ss zzzz", "HH:mm:ss z", "HH:mm:ss", "HH:mm"],
  m: ["{1} 'um' {0}", "{1} 'um' {0}", "{1}, {0}", "{1}, {0}"],
  D: 0,
  ka: [5, 6],
  F: 3
};
