...
c = {
  ...
  h: {
    ...
    1e5: { other: "0" },
    1e6: { other: "0 mill\u00f3ns" },
    1e7: { other: "00 mill\u00f3ns" },
    1e8: { other: "000 mill\u00f3ns" },
    1e9: { other: "0000 mill\u00f3ns" },
    1e10: { other: "00000 mill\u00f3ns" },
    1e11: { other: "000000 mill\u00f3ns" },
    1e12: { other: "0 bill\u00f3ns" },
    1e13: { other: "00 bill\u00f3ns" },
    1e14: { other: "000 bill\u00f3ns" }
  }
};
var d = {
  la: "y",
...
d = {
  ...
  qa: "d 'de' MMM 'de' y",
  ja: "EEE, d 'de' MMM",
  ra: "EEE, d 'de' MMM 'de' y",
  o: "d",
  pa: "d 'de' MMM, HH:mm zzzz"
};
var h = {
  B: ["BC", "AD"],
...
h = {
  B: ["a.C.", "d.C."],
  A: ["antes de Cristo", "despois de Cristo"],
  P: "x. f. m. a. m. x. x. a. s. o. n. d.".split(" "),
  ca: "XFMAMXXASOND".split(""),
  J: "xaneiro febreiro marzo abril maio xu\u00f1o xullo agosto setembro outubro novembro decembro".split(" "),
  ba: "Xaneiro Febreiro Marzo Abril Maio Xu\u00f1o Xullo Agosto Setembro Outubro Novembro Decembro".split(" "),
  Y: "xan. feb. mar. abr. maio xu\u00f1o xul. ago. set. out. nov. dec.".split(" "),
  ea: "Xan. Feb. Mar. Abr. Maio Xu\u00f1o Xul. Ago. Set. Out. Nov. Dec.".split(" "),
  ia: "domingo luns martes m\u00e9rcores xoves venres s\u00e1bado".split(" "),
  ga: "Domingo Luns Martes M\u00e9rcores Xoves Venres S\u00e1bado".split(" "),
  aa: "dom. luns mar. m\u00e9r. xov. ven. s\u00e1b.".split(" "),
  fa: "Dom. Luns Mar. M\u00e9r. Xov. Ven. S\u00e1b.".split(" "),
  R: "d. l. m. m. x. v. s.".split(" "),
  da: "DLMMXVS".split(""),
  Z: ["T1", "T2", "T3", "T4"],
  W: ["1.\u00ba trimestre", "2.\u00ba trimestre", "3.\u00ba trimestre", "4.\u00ba trimestre"],
  g: ["a.m.", "p.m."],
  l: ["EEEE, d 'de' MMMM 'de' y", "d 'de' MMMM 'de' y", "d 'de' MMM 'de' y", "dd/MM/yy"],
