...
c = {
  ...
  h: {
    ...
    1e5: { other: "000 mila" },
    1e6: { other: "0 milioni" },
    1e7: { other: "00 milioni" },
    1e8: { other: "000 milioni" },
    1e9: { other: "0 miliardi" },
    1e10: { other: "00 miliardi" },
    1e11: { other: "000 miliardi" },
    1e12: { other: "0 mila miliardi" },
    1e13: { other: "00 mila miliardi" },
    1e14: { other: "000 mila miliardi" }
  }
};
var d = {
  la: "y",
...
h = {
  B: ["a.C.", "d.C."],
  A: ["avanti Cristo", "dopo Cristo"],
  P: "GFMAMGLASOND".split(""),
  ca: "GFMAMGLASOND".split(""),
  J: "gennaio febbraio marzo aprile maggio giugno luglio agosto settembre ottobre novembre dicembre".split(" "),
  ba: "gennaio febbraio marzo aprile maggio giugno luglio agosto settembre ottobre novembre dicembre".split(" "),
  Y: "gen feb mar apr mag giu lug ago set ott nov dic".split(" "),
  ea: "gen feb mar apr mag giu lug ago set ott nov dic".split(" "),
  ia: "domenica luned\u00ec marted\u00ec mercoled\u00ec gioved\u00ec venerd\u00ec sabato".split(" "),
  ga: "domenica luned\u00ec marted\u00ec mercoled\u00ec gioved\u00ec venerd\u00ec sabato".split(" "),
  aa: "dom lun mar mer gio ven sab".split(" "),
  fa: "dom lun mar mer gio ven sab".split(" "),
  R: "DLMMGVS".split(""),
  da: "DLMMGVS".split(""),
  Z: ["T1", "T2", "T3", "T4"],
  W: ["1\u00ba trimestre", "2\u00ba trimestre", "3\u00ba trimestre", "4\u00ba trimestre"],
  g: ["AM", "PM"],
  l: ["EEEE d MMMM y", "d MMMM y", "d MMM y", "dd/MM/yy"],
  ha: ["HH:mm:ss zzzz", "HH:mm:ss z", "HH:mm:ss", "HH:mm"],
  m: ["{1} 'alle' 'ore' {0}", "{1} 'alle' 'ore' {0}", "{1}, {0}", "{1}, {0}"],
  D: 0,
  ka: [5, 6],
  F: 3
};
