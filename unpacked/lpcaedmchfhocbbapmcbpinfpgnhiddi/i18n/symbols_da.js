...
c = {
  ...
  h: {
    1e3: { other: "0 tusind" },
    1e4: { other: "00 tusind" },
    1e5: { other: "000 tusind" },
    1e6: { other: "0 millioner" },
    1e7: { other: "00 millioner" },
    1e8: { other: "000 millioner" },
    1e9: { other: "0 milliarder" },
    1e10: { other: "00 milliarder" },
    1e11: { other: "000 milliarder" },
    1e12: { other: "0 billioner" },
    1e13: { other: "00 billioner" },
    1e14: { other: "000 billioner" }
  }
};
var d = {
  la: "y",
...
h = {
  B: ["f.Kr.", "e.Kr."],
  A: ["f\u00f8r Kristus", "efter Kristus"],
  P: "JFMAMJJASOND".split(""),
  ca: "JFMAMJJASOND".split(""),
  J: "januar februar marts april maj juni juli august september oktober november december".split(" "),
  ba: "januar februar marts april maj juni juli august september oktober november december".split(" "),
  Y: "jan. feb. mar. apr. maj jun. jul. aug. sep. okt. nov. dec.".split(" "),
  ea: "jan. feb. mar. apr. maj jun. jul. aug. sep. okt. nov. dec.".split(" "),
  ia: "s\u00f8ndag mandag tirsdag onsdag torsdag fredag l\u00f8rdag".split(" "),
  ga: "s\u00f8ndag mandag tirsdag onsdag torsdag fredag l\u00f8rdag".split(" "),
  aa: "s\u00f8n. man. tirs. ons. tors. fre. l\u00f8r.".split(" "),
  fa: "s\u00f8n. man. tirs. ons. tors. fre. l\u00f8r.".split(" "),
  R: "SMTOTFL".split(""),
  da: "SMTOTFL".split(""),
  Z: ["1. kvt.", "2. kvt.", "3. kvt.", "4. kvt."],
  W: ["1. kvartal", "2. kvartal", "3. kvartal", "4. kvartal"],
  g: ["AM", "PM"],
  l: ["EEEE 'den' d. MMMM y", "d. MMMM y", "d. MMM y", "dd.MM.y"],
