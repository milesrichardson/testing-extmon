...
c = {
  ...
  h: {
    1e3: { other: "0 de mii" },
    1e4: { other: "00 de mii" },
    1e5: { other: "000 de mii" },
    1e6: { other: "0 de milioane" },
    1e7: { other: "00 de milioane" },
    1e8: { other: "000 de milioane" },
    1e9: { other: "0 de miliarde" },
    1e10: { other: "00 de miliarde" },
    1e11: { other: "000 de miliarde" },
    1e12: { other: "0 de trilioane" },
...
h = {
  B: ["\u00ee.Hr.", "d.Hr."],
  A: ["\u00eenainte de Hristos", "dup\u0103 Hristos"],
  P: "IFMAMIIASOND".split(""),
  ca: "IFMAMIIASOND".split(""),
  J: "ianuarie februarie martie aprilie mai iunie iulie august septembrie octombrie noiembrie decembrie".split(" "),
  ba: "ianuarie februarie martie aprilie mai iunie iulie august septembrie octombrie noiembrie decembrie".split(" "),
  Y: "ian. feb. mar. apr. mai iun. iul. aug. sept. oct. nov. dec.".split(" "),
  ea: "ian. feb. mar. apr. mai iun. iul. aug. sept. oct. nov. dec.".split(" "),
  ia: "duminic\u0103 luni mar\u021bi miercuri joi vineri s\u00e2mb\u0103t\u0103".split(" "),
  ga: "duminic\u0103 luni mar\u021bi miercuri joi vineri s\u00e2mb\u0103t\u0103".split(" "),
  aa: "dum. lun. mar. mie. joi vin. s\u00e2m.".split(" "),
  fa: "dum. lun. mar. mie. joi vin. s\u00e2m.".split(" "),
  R: "DLMMJVS".split(""),
  da: "DLMMJVS".split(""),
  Z: ["trim. I", "trim. II", "trim. III", "trim. IV"],
  W: ["trimestrul I", "trimestrul al II-lea", "trimestrul al III-lea", "trimestrul al IV-lea"],
  g: ["a.m.", "p.m."],
  l: ["EEEE, d MMMM y", "d MMMM y", "d MMM y", "dd.MM.y"],
  ha: ["HH:mm:ss zzzz", "HH:mm:ss z", "HH:mm:ss", "HH:mm"],
  m: ["{1} 'la' {0}", "{1} 'la' {0}", "{1}, {0}", "{1}, {0}"],
  D: 0,
  ka: [5, 6],
  F: 6
};
