...
c = {
  ...
  h: {
    1e3: { other: "0 na libo" },
    1e4: { other: "00 na libo" },
    1e5: { other: "000 na libo" },
    1e6: { other: "0 na milyon" },
    1e7: { other: "00 na milyon" },
    1e8: { other: "000 na milyon" },
    1e9: { other: "0 na bilyon" },
    1e10: { other: "00 na bilyon" },
    1e11: { other: "000 na bilyon" },
    1e12: { other: "0 na trilyon" },
    1e13: { other: "00 na trilyon" },
    1e14: { other: "000 na trilyon" }
  }
};
var d = {
  la: "y",
...
h = {
  B: ["BC", "AD"],
  A: ["Before Christ", "Anno Domini"],
  P: "Ene Peb Mar Abr May Hun Hul Ago Set Okt Nob Dis".split(" "),
  ca: "E P M A M Hun Hul Ago Set Okt Nob Dis".split(" "),
  J: "Enero Pebrero Marso Abril Mayo Hunyo Hulyo Agosto Setyembre Oktubre Nobyembre Disyembre".split(" "),
  ba: "Enero Pebrero Marso Abril Mayo Hunyo Hulyo Agosto Setyembre Oktubre Nobyembre Disyembre".split(" "),
  Y: "Ene Peb Mar Abr May Hun Hul Ago Set Okt Nob Dis".split(" "),
  ea: "Ene Peb Mar Abr May Hun Hul Ago Set Okt Nob Dis".split(" "),
  ia: "Linggo Lunes Martes Miyerkules Huwebes Biyernes Sabado".split(" "),
  ga: "Linggo Lunes Martes Miyerkules Huwebes Biyernes Sabado".split(" "),
  aa: "Lin Lun Mar Miy Huw Biy Sab".split(" "),
  fa: "Lin Lun Mar Miy Huw Biy Sab".split(" "),
  R: "Lin Lun Mar Miy Huw Biy Sab".split(" "),
  da: "Lin Lun Mar Miy Huw Biy Sab".split(" "),
  Z: ["Q1", "Q2", "Q3", "Q4"],
  W: ["ika-1 quarter", "ika-2 quarter", "ika-3 quarter", "ika-4 na quarter"],
  g: ["AM", "PM"],
  l: ["EEEE, MMMM d, y", "MMMM d, y", "MMM d, y", "M/d/yy"],
  ha: ["h:mm:ss\u202fa zzzz", "h:mm:ss\u202fa z", "h:mm:ss\u202fa", "h:mm\u202fa"],
  m: ["{1} 'nang' {0}", "{1} 'nang' {0}", "{1}, {0}", "{1}, {0}"],
  D: 6,
  ka: [5, 6],
  F: 5
};
