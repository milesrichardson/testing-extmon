...
c = {
  ...
  h: {
    1e3: { other: "0 duizend" },
    1e4: { other: "00 duizend" },
    1e5: { other: "000 duizend" },
    1e6: { other: "0 miljoen" },
...
h = {
  ...
  P: "JFMAMJJASOND".split(""),
  ca: "JFMAMJJASOND".split(""),
  J: "januari februari maart april mei juni juli augustus september oktober november december".split(" "),
  ba: "januari februari maart april mei juni juli augustus september oktober november december".split(" "),
  Y: "jan feb mrt apr mei jun jul aug sep okt nov dec".split(" "),
  ea: "jan feb mrt apr mei jun jul aug sep okt nov dec".split(" "),
  ia: "zondag maandag dinsdag woensdag donderdag vrijdag zaterdag".split(" "),
  ga: "zondag maandag dinsdag woensdag donderdag vrijdag zaterdag".split(" "),
  aa: "zo ma di wo do vr za".split(" "),
  fa: "zo ma di wo do vr za".split(" "),
  R: "ZMDWDVZ".split(""),
  da: "ZMDWDVZ".split(""),
  Z: ["K1", "K2", "K3", "K4"],
  W: ["1e kwartaal", "2e kwartaal", "3e kwartaal", "4e kwartaal"],
  g: ["a.m.", "p.m."],
