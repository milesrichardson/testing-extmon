  ...
  function (t, e, n) {
    ...
    t.exports = function (t, e, n) {
      ...
      function h(e) {
        var n = a,
          o = s;
        return (a = s = void 0), (b = e), (l = t.apply(o, n));
      }
      function g(t) {
        return (b = t), (d = setTimeout(j, e)), v ? h(t) : l;
      }
      function x(t) {
        var n = t - p;
      ...
      function w(t) {
        return (d = void 0), y && a ? h(t) : ((a = s = void 0), l);
      }
      function O() {
        var t = r(),
          n = x(t);
        if (((a = arguments), (s = this), (p = t), n)) {
          if (void 0 === d) return g(p);
          if (m) return clearTimeout(d), (d = setTimeout(j, e)), h(p);
        }
        return void 0 === d && (d = setTimeout(j, e)), l;
      }
      return (
        (e = c(e) || 0),
        o(n) && ((v = !!n.leading), (f = (m = "maxWait" in n) ? i(c(n.maxWait) || 0, e) : f), (y = "trailing" in n ? !!n.trailing : y)),
        (O.cancel = function () {
          void 0 !== d && clearTimeout(d), (b = 0), (a = p = s = d = void 0);
        }),
        (O.flush = function () {
    ...
    var o = n(3),
      r = function (t) {
        var e = t.path,
          n = t.offsetSizeX,
          o = t.offsetSizeY;
        return "body button, body [type='button'], body input[type='reset'], body input[type='submit'], body [role=\"button\"], ::-webkit-search-cancel-button, ::-webkit-search-decoration, ::-webkit-scrollbar-button, ::-webkit-file-upload-button, [role^=button], .cc_pointer, [type=\"search\"]::-webkit-search-cancel-button, a, select, [type=\"search\"]::-webkit-search-decoration, .paper-button, .ytp-progress-bar-container, input[type=submit], :link, :visited, a > *, img,  ::-webkit-scrollbar-button, .ogdlpmhglpejoiomcodnpjnfgcpmgale_pointer, ::-webkit-file-upload-button, .ytp-volume-panel, #myogdlpmhglpejoiomcodnpjnfgcpmgale .icon, body ."
          .concat("custom-cursor-on-hover", ' {cursor: url("')
          .concat(e, '") ')
          .concat(n, " ")
          .concat(o, ", pointer !important;} ");
      },
      c = function (t) {
        var e = t.path,
          n = t.offsetSizeX,
          o = t.offsetSizeY;
        return "html,body,body select,body ."
          .concat("custom-cursor-default-hover", ' {cursor: url("')
          .concat(e, '") ')
          .concat(n, " ")
          .concat(o, ", auto !important;}");
      },
      i = function () {
      ...
      a = function (t) {
        ...
        e.frames.forEach(function (t) {
          n.push({ cursor: "url(".concat(t, ") ").concat(e.offsetX, " ").concat(e.offsetY, ", auto"), backfaceVisibility: "hidden" });
        });
        var o = { id: "custom-cursor-animated", duration: t.animationSpeed, iterations: 1 / 0 };
        i().animate(n, o);
      },
      s = function () {
        var t;
      ...
      f = function (t) {
        ...
        document.body.removeEventListener("mouseover", u), document.body.addEventListener("mouseover", u);
      },
      l = function () {
        chrome.storage.local.get("selected", function (t) {
          var e = t.selected;
          if (e && null !== e)
            if (document.body) f(e);
            else {
              var n = new MutationObserver(function () {
                document.body && (n.disconnect(), f(e));
              });
      ...
      d = function () {
        var t;
        (t = document.getElementById("custom-cursor")) && (t.parentNode.removeChild(t), s());
      },
      p = function (t, e, n) {
        switch (t.action) {
          case "clear":
