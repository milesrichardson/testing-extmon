    ...
    !(function () {
      ...
      var F,
        ...
        n = {
          ...
          startThunder: () => {
            chrome.runtime.sendMessage({ name: "xl_call_function", method: "startThunder" });
          },
          enterMultiDownload: (...E) => {
            chrome.runtime.sendMessage({ name: "xl_call_function", method: "enterMultiDownload", args: E });
          },
          removeBlackListPage: (...E) => {
            chrome.runtime.sendMessage({ name: "xl_call_function", method: "removeBlackListPage", args: E });
          },
          removeBlackListWebsite: (...E) => {
            chrome.runtime.sendMessage({ name: "xl_call_function", method: "removeBlackListWebsite", args: E });
          },
          addBlackListPage: (...E) => {
            chrome.runtime.sendMessage({ name: "xl_call_function", method: "addBlackListPage", args: E });
          },
          addBlackListWebsite: (...E) => {
            chrome.runtime.sendMessage({ name: "xl_call_function", method: "addBlackListWebsite", args: E });
          },
          isMonitorDomain: async () =>
            new Promise((E) => {
              chrome.runtime.sendMessage({ name: "xl_call_function", method: "isMonitorDomain" }, (C) => {
                E(C);
              });
            })
        },
      ...
      function m(E) {
        ...
        do {
          ...
          chrome.tabs.query({ active: !0, currentWindow: !0 }, function (E) {
            if (E && E.length > 0)
              for (var C = 0; C < E.length; C++) {
                let B = "xl-images.html?tabId=" + E[C].id;
                window.open(chrome.runtime.getURL(B)), window.close();
                break;
              }
            else window.close();
          });
      ...
      function p(E) {
        let C = (function () {
          ...
          do {
            ...
            if (C.match(/compatible/i) || C.match(/Windows/i)) {
              E = "https://down.sandai.net/thunder11/XunLeiWebSetup_ext.exe";
              break;
            }
            if (C.match(/Macintosh/i) || C.match(/MacIntel/i)) {
              E = "https://down.sandai.net/mac/thunder.dmg";
              break;
            }
          } while (0);
          return E;
        ...
        const o = (E) => {
            chrome.tabs.query({ active: !0, currentWindow: !0 }, (E) => {
              if (E[0]) {
                ...
                window.open(chrome.runtime.getURL(C));
              }
            });
          },
          r = () => {
