!(function (E) {
  ...
  function B(D) {
    ...
    return E[D].call(F.exports, F, F.exports, B), (F.l = !0), F.exports;
  }
  (B.m = E),
    (B.c = C),
    (B.d = function (E, C, D) {
      B.o(E, C) || Object.defineProperty(E, C, { enumerable: !0, get: D });
    }),
    (B.r = function (E) {
    ...
    (B.t = function (E, C) {
      if ((1 & C && (E = B(E)), 8 & C)) return E;
      if (4 & C && "object" == typeof E && E && E.__esModule) return E;
      var D = Object.create(null);
      if ((B.r(D), Object.defineProperty(D, "default", { enumerable: !0, value: E }), 2 & C && "string" != typeof E))
        for (var F in E)
          B.d(
            D,
            F,
  ...
  function (E, C, B) {
    const { ThunderEncode: D } = B(7),
      { videoExtensions: F } = B(10),
      { XLNativeMessage: A } = B(11),
      {
        SUPPORT_REQUEST_TYPE_ARRAY: e,
        FRAME_REQUEST_TYPE_ARRAY: t,
        CONTENT_TYPE_ARRAY: n,
        SUPPORT_MEDIA_EXT_ARRAY: o,
    ...
    E.exports = {
      ...
      macDownFile: function (E) {
        ...
        (C += new Date().toString()), navigator.clipboard.writeText(C), a();
      },
      onStartMacThunder: a,
      queryTabs: (E, C) => {
    ...
    !(function () {
        ...
        return (
          ...
          0 !=
            (function (E) {
              ...
              var C = E,
                B = C.indexOf(":");
              if (-1 == B) return !1;
              var D = C.substr(0, B + 1).toUpperCase();
              if ("" == D) return !1;
              var F = !0;
              return (
                -1 != Y.indexOf(D)
          ...
          0 !=
            (function (E) {
              ...
              var A = !0,
                e = E;
              for (var t in C)
                if (C[t].length > 0 && -1 != e.indexOf(C[t])) {
                  A = !1;
                  break;
                }
              return A;
          ...
          0 !=
            (function (E) {
              ...
              if (-1 == C) return !1;
              var B = E.toLowerCase();
              if ("xlapp://" == B.substr(0, C + 3).trimLeft(" ")) return !0;
              if (-1 != B.indexOf("ed2k://") || -1 != B.indexOf("magnet:?")) return !0;
              var D,
                F,
                A = !1,
      ...
      function BE() {
        ...
        (E = document.createElement("div")).classList.add("xl-chrome-ext-hover-popover"),
          (E.innerHTML =
            '\n      <div class="xl-chrome-ext-hover-popover__logo"></div>\n      <a>迅雷高速下载，限时<span style="color: #B4723C">送超级会员卡</span></a>\n    '),
      ...
      function AE(E, C) {
        ...
        do {
          ...
          if (E.clientX < D.left || E.clientY < D.top || E.clientX > D.right || E.clientY > D.bottom) break;
          B = !0;
        } while (0);
        return B;
      }
                  ...
                  case 68:
                    E.shiftKey &&
                      ((function () {
                        let E = !1;
                        do {
                          if (!document.activeElement) break;
                          let C = document.activeElement,
                            B = C.tagName.toUpperCase();
                          if ("INPUT" === B || "TEXTAREA" === B) {
                            E = !0;
                            break;
                          }
                          if (!C.contentEditable) break;
                          if ("true" === C.contentEditable.toLowerCase()) {
                            E = !0;
                            break;
                          }
                        } while (0);
      ...
      function oE() {
        chrome.runtime.onMessage.addListener(function (E, C, B) {
          if ("UpdatePluginEnabled" == E.name) (v = E.exception), (f = E.enable) || D.quit();
            ...
            } else if ("xl_chrome_iframe_multi_hotkey" === E.name) window.top === window.self && D.enter();
            else if ("GetAllImages" === E.name) {
              if (window.top === window.self) {
                let E = [];
                for (let C of document.images)
                  C.src &&
                    E.push({ src: C.src, width: C.width, height: C.height, naturalWidth: C.naturalWidth, naturalHeight: C.naturalHeight });
                return B(E), !0;
              }
      ...
      function iE(E) {
        ...
        do {
          ...
          if (!E.children || 0 === E.children.length) break;
          for (var B = 0; B < E.children.length; B++) {
            let D = E.children[B];
            if ("source" === D.tagName.toLowerCase() && D.src) {
              0 !== D.src.toLowerCase().indexOf("blob:") && (C = D.src);
              break;
            }
          }
        } while (0);
      ...
      function rE(E) {
        ...
        for (var B = 0; B < E.children.length; B++) {
          let F = E.children[B];
          if ("source" === F.tagName.toLowerCase() && F.type) {
            var D = F.type.split("/");
            D.length > 0 && (C = D[D.length - 1]);
            break;
          }
        }
        return C ? `.${C}` : "";
      ...
      function uE() {
        ...
        (E.className = "xl-chrome-ext-bar"),
          ...
          (E.innerHTML +=
            '\n    <div class="xl-chrome-ext-tips">\n      <a id="xl_chrome_ext_bar_screen" class="xl-chrome-ext-bar__option" href="javascript:;"></a>\n      <div class="xl-chrome-ext-title">投屏</div>\n    </div>\n\n    <div class="xl-chrome-ext-tips">\n      <a id="xl_chrome_ext_bar_copy" class="xl-chrome-ext-bar__option" href="javascript:;"></a>\n      <div class="xl-chrome-ext-title">复制链接</div>\n    </div>\n    ');
        let C,
          B = document.querySelector(".xl-chrome-ext-bar-toast");
        B ||
          (((B = document.createElement("div")).className = "xl-chrome-ext-bar-toast"),
          (B.innerHTML +=
            '\n        <div class="xl-chrome-ext-bar-toast__success"></div>\n        <div class="xl-chrome-ext-bar-toast__text">复制成功</div>\n      '),
          document.body.appendChild(B)),
          document.body.appendChild(E);
        for (var D = E.getElementsByTagName("a"), F = 0; F < D.length; F++) {
          D[F].addEventListener(
            "click",
            async (E) => {
              Promise.resolve(E.currentTarget);
              do {
                if (!E) break;
      ...
      function vE() {
        ...
        if (!document.getElementById(E)) {
          ...
          (C.className = "xl-chrome-ext-dialog"),
            (C.id = E),
            (C.innerHTML =
              '\n    <h2 class="xl-chrome-ext-dialog__title">浏览器无法直接打开磁力链等特殊格式链接</h2>\n    <a action="close" href="javascript:;" class="xl-chrome-ext-dialog__close" title="关闭"></a>\n    <ul class="xl-chrome-ext-dialog__content">\n      <li class="xl-chrome-ext-dialog__content-li">\n        <div class="xl-chrome-ext-dialog__content-icon xl-download"></div>\n        <div class="xl-chrome-ext-dialog__content-text">高速下载：基础加速、超级通道、会员加速三重加速</div>\n      </li>\n      <li class="xl-chrome-ext-dialog__content-li">\n        <div class="xl-chrome-ext-dialog__content-icon xl-compatible"></div>\n        <div class="xl-chrome-ext-dialog__content-text">强大兼容：支持磁力、种子、在线视频</div>\n      </li>\n      <li class="xl-chrome-ext-dialog__content-li">\n        <div class="xl-chrome-ext-dialog__content-icon xl-pan"></div>\n        <div class="xl-chrome-ext-dialog__content-text">超大云盘：最高12TB备份</div>\n      </li>\n    </ul>\n    <div class="xl-chrome-ext-dialog__footer">         \n      <button action="install" class="xl-chrome-ext-dialog__button xl-download">迅雷高速下载</button>\n      <button action="close" class="xl-chrome-ext-dialog__button xl-close">取消</button>\n    </div>\n    '),
      ...
      function pE(E, C) {
        ...
        D && document.body.removeChild(D),
          ...
          ((D = document.createElement("div")).className = "xl-chrome-ext-dialog"),
          (D.id = B),
      ...
      function _E() {
        ...
        const B = E.querySelector(".xl-chrome-ext-recall-dialog__carousel");
        C.forEach((E) => {
          const C = document.createElement("div");
          C.classList.add("xl-chrome-ext-recall-dialog__carouselItem"),
            C.setAttribute("data-index", E.index),
          ...
          const D = C.querySelector(".xl-chrome-ext-recall-dialog__content");
          E.content.forEach((E) => {
            D.innerHTML += `\n        <p class="xl-chrome-ext-recall-dialog__carousel-p ${E.class || ""}">${E.text}</p>\n        `;
          });
          const F = C.querySelector(".xl-chrome-ext-recall-dialog__footer");
          E.footer.forEach((E) => {
  ...
  function (E, C, B) {
    ...
    !(function () {
      function E() {
        (this._invertedSelection = !1), (this._curpos = { x: 0, y: 0 }), (this._selectableElements = []), (this._visibleElements = []);
        var E = this,
        ...
        (A.id = CSS.ids.help),
          (A.innerHTML = chrome.i18n.getMessage("usage")),
          (A.onmouseover = function () {
            A.classList.add(CSS.classes.invisible);
          }),
          (A.onmouseout = function () {
            A.classList.remove(CSS.classes.invisible);
          });
        var e,
          t,
          n = function (E) {
          ...
          o = function (C) {
            (E._curpos.x = C.clientX), (E._curpos.y = C.clientY);
          },
          i = null,
          r = {
            ...
            mousemove: function (C) {
              o(C), E.sm.fireEvent("mousemove");
            },
            mousedown: function (C) {
              if (null === i && (0 == C.button || 2 == C.button)) {
                switch ((i = 0 == C.button ? (C.ctrlKey ? 1 : 0) : 2)) {
                  case 0:
                    o(C), E.sm.fireEvent("mousedown");
                    break;
                  case 1:
                  case 2:
                    o(C), E.sm.fireEvent("alt_mousedown");
                }
                n(C);
              }
            },
            mouseup: function (C) {
              if (null !== i && (C.button == i || 0 == C.button || 1 == i)) {
                switch (C.button) {
                  case 0:
                    o(C), E.sm.fireEvent(1 == i ? "alt_mouseup" : "mouseup");
                    break;
                  case 2:
                    o(C), E.sm.fireEvent("alt_mouseup");
                }
                (i = null), n(C);
              }
            },
            ...
            resize:
              ((e = null),
              (t = function () {
                (e = null), E.updateVisibleElements();
              }),
              function (E) {
                null !== e && clearTimeout(e), (e = setTimeout(t, 100));
              }),
            scroll: (function () {
              var C = null,
                B = function () {
                  (C = null), E.updateVisibleElements();
                };
              return function (E) {
                null !== C && clearTimeout(C), (C = setTimeout(B, 100));
              };
            })()
          };
        document.addEventListener("contextmenu", r.contextmenu),
          document.addEventListener("scroll", r.scroll),
          window.addEventListener("resize", r.resize),
          document.addEventListener("keydown", r.keydown, !0),
          document.body.addEventListener("mousedown", r.mousedown, !0),
          document.body.addEventListener("mouseup", r.mouseup, !0),
          C.appendChild(A),
          C.appendChild(B);
        var a = new F();
        (a.states.load = {
          __enter__: function () {
            document.documentElement.classList.add(CSS.classes.loading),
              ...
              C.addEventListener("webkitTransitionEnd", function () {
                C.removeEventListener("webkitTransitionEnd", arguments.callee), E.sm.fireEvent("load_done");
              }),
              setTimeout(function () {
                E.populate(), E.updateVisibleElements(), document.documentElement.classList.remove(CSS.classes.loading);
              }, 0);
          },
          load_done: "idle"
        }),
          (a.states.exit = {
            __enter__: function () {
              E._cursel && d(),
                ...
                document.removeEventListener("scroll", r.scroll),
                window.removeEventListener("resize", r.resize),
                document.removeEventListener("contextmenu", r.contextmenu),
                document.removeEventListener("keydown", r.keydown, !0),
                document.body.removeEventListener("mousedown", r.mousedown, !0),
                document.body.removeEventListener("mouseup", r.mouseup, !0),
          ...
          (a.states.idle = { mousedown: "selection", alt_mousedown: "deselection", req_exit: "exit", req_download: "action-download" });
        var s = null,
          l = null,
          c = function () {
            var C = document.createElement("div");
            C.classList.add(CSS.classes.selectionRectangle),
              (C.style.left = E._curpos.x + "px"),
              (C.style.top = E._curpos.y + "px"),
              E._invertedSelection && C.classList.add(CSS.classes.inverted),
              (E._cursel = document.body.appendChild(C)),
              (E._startpos = { x: E._curpos.x, y: E._curpos.y }),
              (E._selrect = { x: E._curpos.x, y: E._curpos.y, w: 0, h: 0 }),
              (E._lastDrawn = {}),
              (s = setInterval(E.drawSelection.bind(E), 30)),
              (l = setInterval(E.calcSelectedElements.bind(E), 30)),
              document.addEventListener("mousemove", r.mousemove);
          },
          d = function () {
            for (var C in (document.removeEventListener("mousemove", r.mousemove),
            clearInterval(s),
            clearInterval(l),
            (s = null),
            (l = null),
            ...
            E._selectableElements)) {
              var B = E._selectableElements[C]._private;
              B.selected = B.selected2;
            }
            return (
              E._cursel.addEventListener(
                "webkitTransitionEnd",
                function () {
          ...
          m = function () {
            if (E._startpos) {
              var C = E._startpos,
                B = E._curpos,
                D = E._selrect;
              (D.x = Math.min(C.x, B.x)), (D.y = Math.min(C.y, B.y)), (D.w = Math.abs(C.x - B.x)), (D.h = Math.abs(C.y - B.y));
            }
          };
        (a.states.selection = {
          __enter__: function () {
            (E._invertedSelection = !1), c();
          },
          mousemove: m,
          mouseup: d,
          req_exit: "exit"
        }),
          (a.states.deselection = {
            __enter__: function () {
              (E._invertedSelection = !0), c();
            },
            mousemove: m,
            alt_mouseup: d,
            req_exit: "exit"
          }),
          (a.states["action-download"] = {
            __enter__: function () {
              var C,
                B,
                D =
                  ((C = E._selectableElements),
                  (B = {}),
                  C.forEach(function (E) {
                    if (E._private.selected) {
                      var C = (function (E) {
                        var C = E.href;
                        do {
                          var B = E.getAttribute("thunderhref");
                          if (B) {
                            C = B;
                            break;
                          }
                          var D = E.getAttribute("thundertype");
                          if (null === D) break;
                          var F = E.attributes.length;
                          if (F <= 0) break;
                          for (var A = 0; A < F; A++) {
                            var e = E.attributes[A].value;
                            if (e && 0 === e.toLowerCase().indexOf("thunder://")) {
                              C = e;
                              break;
                            }
                          }
                  ...
                  Object.keys(B));
              chrome.runtime.sendMessage({ name: "xl_download_multi", referurl: document.location.href, cookie: document.cookie, urls: D }),
                E.sm.fireEvent("done");
            },
            done: "exit"
          }),
      ...
      function C(E, C) {
        for (var B in E) E[B].classList.add(CSS.classes.selected);
        for (var B in C) C[B].classList.remove(CSS.classes.selected);
      }
      function B(E, C) {
        return !(E.bottom < C.y || C.y + C.h < E.top || E.right < C.x || C.x + C.w < E.left);
      }
      (CSS = {
        ids: {
        ...
        (E.prototype.populate = function () {
          for (var E = document.links, C = /^javascript:/, B = 0; B < E.length; B++) {
            var D = E[B];
            if (void 0 != D.href && !C.test(D.href)) {
              var F = D,
                A = D.getElementsByTagName("img");
              A.length && (F = A[0]),
                (D._private = { selected: !1, selected2: !1, delegate: F, positionfix: !1 }),
                this._selectableElements.push(D);
            }
          }
        }),
        (E.prototype.updateVisibleElements = function () {
          var E = { x: 0, y: 0, w: window.innerWidth, h: window.innerHeight },
            C = this._visibleElements,
            D = this._selectableElements;
          for (var F in (C.splice(0), D)) {
            var A = D[F],
              e = A._private,
              t = e.delegate;
            B(t.getBoundingClientRect(), E) &&
              (C.push(A),
              e.positionfix ||
                ((e.positionfix = !0), "static" == window.getComputedStyle(t).position && t.classList.add(CSS.classes.relative)));
          }
        }),
        (E.prototype.drawSelection = function () {
          var E = this._selrect,
            C = this._lastDrawn,
            B = this._cursel.style;
          (E.x == C.x && E.y == C.y && E.w == C.w && E.h == C.h) ||
            ((B.left = (C.x = E.x) + "px"), (B.top = (C.y = E.y) + "px"), (B.width = (C.w = E.w) + "px"), (B.height = (C.h = E.h) + "px"));
        }),
        (E.prototype.calcSelectedElements = function () {
          var E = this._visibleElements,
            ...
            A = [];
          for (var e in E) {
            for (var t = E[e]._private, n = t.delegate, o = t.delegate.getClientRects(), i = !1, r = 0; r < o.length; r++) {
              if (B(o[r], D)) {
                i = !0;
                break;
              }
            }
            var a = i ? !this._invertedSelection : t.selected;
            a != t.selected2 && ((a ? F : A).push(n), (t.selected2 = a));
          }
          (F || A) && setTimeout(C, 0, F, A);
        }),
        (D = {
          instance: null,
          enter: function () {
            null === D.instance &&
              ((D.instance = new E()),
              D.instance.sm.start("load"),
              chrome.runtime.sendMessage({ name: "xl_download_multi_start", referurl: document.location.href }));
          },
          quit: function () {
            D.instance && D.instance.sm.fireEvent("req_exit");
          },
          download: function () {
            D.instance && D.instance.sm.fireEvent("req_download");
          }
        });
    })(),
      (E.exports = { XLMultiDownload: D });
  },
  function (E, C) {
    function B() {
      (this.states = {}), (this._current = void 0);
    }
    (B.prototype.start = function (E) {
      if (void 0 !== this._current) throw "State machine already started";
      if (void 0 === E || null === E) throw "Please give a valid state name";
      setTimeout(B._changeState, 0, this, E);
    }),
      (B.prototype.fireEvent = function (E, C) {
        if (void 0 === this._current) throw "State machine not started";
        if (null === this._current) throw "State machine terminated";
        setTimeout(B._handleEvent, 0, this, E, C);
      }),
      (B._changeState = function (E, C) {
        if (null !== C && !E.states.hasOwnProperty(C)) throw ((E._current = null), 'No such state "' + C + '"');
        var D = E._current;
        if ((void 0 !== D && D.hasOwnProperty("__exit__") && D.__exit__.apply(E), null !== C)) {
          if ((D = E._current = E.states[C]).hasOwnProperty("__enter__")) {
            var F = D.__enter__.apply(E);
            void 0 !== F && setTimeout(B._changeState, 0, E, F);
          }
        } else E._current = null;
      }),
      (B._handleEvent = function (E, C, D) {
        var F = E._current[C];
        "function" == typeof F && (F = F.apply(E, D)), void 0 !== F && setTimeout(B._changeState, 0, E, F);
      }),
      (E.exports = { StateMachine: B });
  },
  function (E, C, B) {
    const { AnsicodeChr: D } = B(8),
      { UnicodeChr: F } = B(9);
    function A(E) {
      var C = E.toString(16);
      C = (C = "000" + C.toUpperCase()).substr(C.length - 4);
      var B = F().indexOf(C);
      return -1 != B && (C = D().substr(B, 4)), å, parseInt(C, 16);
    }
    var e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
    const t = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,
      n = (E) => (null == E ? "" : (E + "").replace(t, ""));
    E.exports = {
              ...
              (function (E) {
                ...
                do {
                  (D = (C = E.charCodeAt(i++)) >> 2),
                    ...
                    (o = 63 & n),
                    isNaN(B) ? (A = o = 64) : isNaN(n) && (o = 64),
                    (t = t + e.charAt(D) + e.charAt(F) + e.charAt(A) + e.charAt(o)),
                    (C = B = n = ""),
                    (D = F = A = o = "");
                } while (i < E.length);
                return t;
                ...
                (function (E) {
                  for (var C = E.length, B = "", D = 0; D < C; D++) {
                    var F = E.charCodeAt(D);
                    if ((F < 0 && (F += 65536), F > 127 && (F = A(F)), F > 255)) {
                      var e = 65280 & F;
                      e >>= 8;
                      var t = 255 & F;
                      B += String.fromCharCode(e) + String.fromCharCode(t);
                    } else B += String.fromCharCode(F);
                  }
                  return B;
                })("AA" + n(E) + "ZZ")
              );
      ...
      ThunderDecode: function (E) {
        try {
          ...
          var B = C.decode64(E.substr(10));
          return B.length < 6 ? "" : decodeURI(B.substr(2, B.length - 4));
        } catch (E) {
          return "";
        }
      }
  ...
  function (E, C, B) {
    "use strict";
    B.r(C),
      B.d(C, "videoExtensions", function () {
        return D;
      });
    const D = [
      ".xv",
  ...
  function (E, C, B) {
    ...
    F.prototype = {
      onNativeMessage: function (E) {
        var C = E.callbackId;
        if (C) {
          var B = this.callbackMap[C];
          B && (B.f.apply(B.o, [!0, E.result, E.paramters]), delete this.callbackMap[C]);
        }
        this.eventContainer.fireEvent("OnNativeMessage", E);
      },
      onDisconnect: function () {
        if (((this.nativePort = null), this.callbackMap))
          for (let C in this.callbackMap)
            if (C) {
              var E = this.callbackMap[C];
              E && (E.f.apply(E.o, [!1]), delete this.callbackMap[C]);
            }
      ...
      postMessage: function (E, C, B, D) {
        ...
        do {
          ...
          var A = void 0;
          D && (A = this.callbackIdIndex++);
          var e = { funcName: E, paramters: C, callbackId: A };
          try {
            this.nativePort.postMessage(e);
          } catch (E) {
            F = !1;
            break;
          }
          D && (this.callbackMap[A] = { o: B, f: D }), this.delayDisconnect();
        } while (0);
        return F || (D && D.apply(B, [!1])), F;
      },
      sendQuit: function () {
  ...
  function (E, C) {
    ...
    function D(E) {
      var C = Date.now();
      return (
        "undefined" != typeof performance && "function" == typeof performance.now && (C += performance.now()),
        "xxxxxxxxxxxxxxx".replace(/[x]/g, function (E) {
          var B = (C + 36 * Math.random()) % 36 | 0;
          return (C = Math.floor(C / 36)), (rc = ("x" === E ? B : (3 & B) | 8).toString(36)), Math.random() > 0.5 ? rc : rc.toUpperCase();
        }) + E
      );
    }
    (B.prototype.attachEvent = function (E, C, B, D) {
      if ((this[C] || (this[C] = []), !(this[C] instanceof Array))) return !1;
      for (var F = 0; F < this[C].length; F++) if (this[C][F].o == E && this[C][F].f == B) return !0;
      return this[C].push({ o: E, f: B, t: D }), !0;
    }),
      (B.prototype.detachEvent = function (E, C, B) {
        if (!(this[C] && this[C] instanceof Array)) return !1;
        for (var D = 0; D < this[C].length; D++)
          if (this[C][D].o == E && this[C][D].f == B) return this[C].splice(D, 1), 0 == this[C].length && delete this[C], !0;
        return !1;
      }),
      (B.prototype.fireEvent = function (E) {
        if (!(this[E] && this[E] instanceof Array)) return !1;
        for (
          var C = [].slice.call(arguments), B = this[E].slice(0), D = !1, F = 0;
          F < B.length &&
          ("number" == typeof B[F].t ? B[F].f.delayApply(B[F].t, B[F].o, C.slice(1)) : (D |= B[F].f.apply(B[F].o, C.slice(1))), !D);
          F++
        );
        return D;
      });
    E.exports = {
      EventContainer: B,
      generalWebPeerId: D,
      getWebPeerId: function (E, C) {
        return new Promise((C) => {
          chrome.storage.local.get("__XLWebPeerId__", (B) => {
            if (B && B.__XLWebPeerId__) C(B.__XLWebPeerId__);
            else {
              const B = D(E);
              chrome.storage.local.set({ __XLWebPeerId__: B }), C(B);
            }
          });
        });
      },
      versionCompare: function (E, C) {
        (E = E.split(".")), (C = C.split("."));
        let B = Math.max(E.length, C.length);
        for (let D = 0; D < B; D++) {
          if ((void 0 === E[D] && (E[D] = "0"), void 0 === C[D] && (C[D] = "0"), E[D] - C[D] > 0)) return 1;
          if (E[D] - C[D] < 0) return -1;
        }
        return 0;
      },
      Ajax: function (E) {
        ((E = E || {}).data = E.data || {}),
          ...
          (E.data = (function (E) {
            var C = [];
            for (var B in E) C.push(encodeURIComponent(B) + "=" + encodeURIComponent(E[B]));
            return C.join("&");
          })(E.data));
        var C = E.url,
          B = { method: E.type };
        "GET" == E.type
          ? E.data.length > 0 && (C = E.url + "?" + E.data)
          : (B = { method: E.type, body: E.data, headers: { "Content-Type": "application/x-www-form-urlencoded; charset=UTF-8" } }),
          fetch(C, B)
            .then((C) => {
              var B = C.status;
              B >= 200 &&
