  ...
  return (
    ...
    (function (n) {
      ...
      !(function () {
        ...
        for (var r = 2, i = 0; i < 64; ) t(r) && (i < 8 && (s[i] = e(n.pow(r, 0.5))), (B[i] = e(n.pow(r, 1 / 3))), i++), r++;
      })();
      var w = [],
        c = (o.SHA256 = i.extend({
          _doReset: function () {
          ...
          for (
            ...
            if (j < 16) (T = q.high = 0 | t[e + 2 * j]), (N = q.low = 0 | t[e + 2 * j + 1]);
              ...
              var Z = xt[j - 15],
                ...
                at = st.low;
              (T =
                (T = (T = J + nt + ((N = $ + ot) >>> 0 < $ >>> 0 ? 1 : 0)) + et + ((N += rt) >>> 0 < rt >>> 0 ? 1 : 0)) +
                ct +
                ((N += at) >>> 0 < at >>> 0 ? 1 : 0)),
                (q.high = T),
                (q.low = N);
            ...
            (X = U),
              ...
              (P =
                (M +
                  (kt =
                    (kt = (kt = kt + lt + ((ht = ht + ft) >>> 0 < ft >>> 0 ? 1 : 0)) + Bt + ((ht = ht + wt) >>> 0 < wt >>> 0 ? 1 : 0)) +
                    T +
                    ((ht = ht + N) >>> 0 < N >>> 0 ? 1 : 0)) +
                  ((W = (F + ht) | 0) >>> 0 < F >>> 0 ? 1 : 0)) |
                0),
          ...
          y = ((t.format = {}).OpenSSL = {
            ...
            parse: function (t) {
              var e,
                ...
                i = r.words;
              return (
                1398893684 == i[0] && 1701076831 == i[1] && ((e = a.create(i.slice(2, 4))), i.splice(0, 4), (r.sigBytes -= 16)),
