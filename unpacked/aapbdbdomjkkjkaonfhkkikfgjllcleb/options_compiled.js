...
*/
  ...
  var C = function (a, b, c) {
    ...
    Ga = function (a, b, c) {
      v(a) || Ca("Expected object but got %s: %s.", [qa(a), a], b, Array.prototype.slice.call(arguments, 2));
    },
    Ha = function (a, b, c) {
    ...
    nb = function (a, b) {
      ...
      for (var d = Math.max(a.length, b.length), e = 0; 0 == c && e < d; e++) {
        ...
        do {
          ...
          c =
            mb(0 == f[1].length ? 0 : parseInt(f[1], 10), 0 == h[1].length ? 0 : parseInt(h[1], 10)) ||
            mb(0 == f[2].length, 0 == h[2].length) ||
            mb(f[2], h[2]);
          f = f[3];
          h = h[3];
        } while (0 == c);
  ...
  var $b = function (a) {
    ...
    bc = function (a) {
      a instanceof L ||
        ((a = "object" == typeof a && a.Wa ? a.Aa() : String(a)),
        lb.test(a) &&
  ...
  var fc = { MATH: !0, SCRIPT: !0, STYLE: !0, SVG: !0, TEMPLATE: !0 },
    gc = (function (a) {
      var b = !1,
        c;
      return function () {
    ...
    kc = function (a) {
      ...
      return a.replace(nc, function (d, e) {
        ...
        if (!f) {
          ...
          if (c.tagName && fc[c.tagName.toUpperCase()])
  ...
  var N = function (a) {
    ...
    uc = function (a, b) {
      ...
      if (c.getElementsByClassName) a = c.getElementsByClassName(a)[0];
        ...
        c = document;
        var d = b || c;
        a = d.querySelectorAll && d.querySelector && a ? d.querySelector(a ? "." + a : "") : sc(c, a, b)[0] || null;
      }
      return a || null;
    },
    sc = function (a, b, c) {
    ...
    zc = function (a) {
      var b = xc(a);
      a = yc(a);
      return G && a.pageYOffset != b.scrollTop
    ...
    Jc = { SCRIPT: 1, STYLE: 1, HEAD: 1, IFRAME: 1, OBJECT: 1 },
    Kc = { IMG: " ", BR: "\n" },
    Lc = function (a, b) {
    ...
    Nc = function (a, b, c) {
      if (!(a.nodeName in Jc))
        ...
        else for (a = a.firstChild; a; ) Nc(a, b, c), (a = a.nextSibling);
    },
    Pc = function (a, b) {
      for (var c = 0; a; ) {
        C("parentNode" != a.name);
  ...
  var xd = function (a) {
    ...
    Bd = function (a) {
      return wd(a, rd, ud)
        ...
        : a instanceof L
        ? yd($b(a).toString())
        : yd(String(String(a)).replace(zd, Ad), xd(a));
    },
    yd = (function (a) {
      function b(c) {
        this.content = c;
    ...
    Hd = function (a) {
      wd(a, sd, vd)
        ? (a = a.getContent())
        : ((a = String(a)), Gd.test(a) || (Da("Bad value `%s` for |filterHtmlAttributes", [a]), (a = "zSoyz")));
      return a;
    },
    Id = function (a) {
...
*/
  ...
  var Pd = function (a, b) {
    ...
    m = m.width;
    Kd();
    if (Cd["jfk.templates.button.classes_"])
      b = Cd["jfk.templates.button.classes_"]({ sa: a, disabled: n, checked: x, style: w, width: m }, b);
    else {
      ...
      b +=
        ((m && m.Hb && (1).Hb ? (m.ta !== (1).ta ? 0 : m.toString() === (1).toString()) : 1 == m) ? " jfk-button-narrow" : "") +
        (x ? " jfk-button-checked" : "") +
        (a ? " " + a : "") +
        (n ? " jfk-button-disabled" : "");
    }
    return u(
      f +
        Q(b) +
        '"' +
        (e ? ' aria-disabled="true"' : ' tabindex="' + (h ? Q(h) : "0") + '"') +
        (k ? (p ? ' data-tooltip="' + Q(k) + '"' : ' title="' + Q(k) + '"') : "") +
        (q ? ' value="' + Q(q) + '"' : "") +
        (c ? Id(Hd(c)) : "") +
        ">" +
        Bd(null != d ? d : "") +
  ...
  if ("undefined" != typeof Symbol && "undefined" != typeof Symbol.hasInstance) {
    var $d = function () {
      ...
      ae = {};
    Object.defineProperties(Zd, ((ae[Symbol.hasInstance] = { value: $d, configurable: !1, writable: !1, enumerable: !1 }), ae));
  ...
  g.translate = function (a, b) {
    a instanceof M
      ...
      : (Ea(a), (this.left += a), (this.right += a), "number" === typeof b && ((this.top += b), (this.bottom += b)));
    return this;
  };
  ...
  var oe = function (a, b) {
    ...
    se = function (a) {
      if (G && !(8 <= Number(Tb))) return C(a && "offsetParent" in a), a.offsetParent;
      var b = qc(a),
        c = oe(a, "position"),
    ...
    ue = function (a) {
      for (var b = new me(0, Infinity, Infinity, 0), c = N(a), d = c.g.body, e = c.g.documentElement, f = xc(c.g); (a = se(a)); )
        if (!((G && 0 == a.clientWidth) || (I && 0 == a.clientHeight && a == d)) && a != d && a != e && "visible" != oe(a, "overflow")) {
          var h = te(a),
    ...
    ye = function (a) {
      var b = a.offsetWidth,
        c = a.offsetHeight,
        d = I && !b && !c;
      return (void 0 === b || d) && a.getBoundingClientRect ? ((a = re(a)), new jc(a.right - a.left, a.bottom - a.top)) : new jc(b, c);
    },
    Ae = function (a) {
      var b = te(a);
      a = ze(a);
  ...
  var De = (function () {
    ...
    return J
      ? ((a = /1[0|1][_.][0-9_.]+/), (a = a.exec(ob())) ? a[0].replace(/_/g, ".") : "10")
      : Gb
      ? ((a = /Android\s+([^\);]+)(\)|;)/), (a = a.exec(ob())) ? a[1] : "")
      : Hb || Ib || Jb
      ? ((a = /(?:iPhone|CPU)\s+OS\s+(\S+)/), (a = a.exec(ob())) ? a[1].replace(/_/g, ".") : "")
      : "";
  })();
  var Ee = function (a) {
  ...
  var Ie = function (a, b, c, d, e, f) {
      if (a.h) {
        ...
        if ((u = ue(k)))
          (k = Ae(k)),
            (k = new me(k.top, k.left + k.width, k.top + k.height, k.left)),
            Je(b)
              ? k.top < u.top && !(q & 1)
                ? (p -= u.top - k.top)
                : k.bottom > u.bottom && q & 1 && (p -= k.bottom - u.bottom)
              : k.left < u.left && !(q & 4)
              ? (p -= u.left - k.left)
              : k.right > u.right && q & 4 && (p -= k.right - u.right);
        ...
        n = Ae(k);
        if ((x = ue(k)))
          (F = new ne(x.left, x.top, x.right - x.left, x.bottom - x.top)),
            (x = Math.max(n.left, F.left)),
            (E = Math.min(n.left + n.width, F.left + F.width)),
            x <= E &&
              ((K = Math.max(n.top, F.top)),
              (F = Math.min(n.top + n.height, F.top + F.height)),
              K <= F && ((n.left = x), (n.top = K), (n.width = E - x), (n.height = F - K)));
        x = N(k);
        K = N(p);
        if (x.g != K.g) {
          E = x.g.body;
        ...
        w = 0;
        if (f || 0 != m)
          m & 4 ? (u.x -= k.width + (f ? f.right : 0)) : m & 2 ? (u.x -= k.width / 2) : f && (u.x += f.left),
            m & 1 ? (u.y -= k.height + (f ? f.bottom : 0)) : f && (u.y += f.top);
        q &&
          (r
            ? ((m = u),
              (w = k),
              (n = 0),
              65 == (q & 65) && (m.x < r.left || m.x >= r.right) && (q &= -2),
              132 == (q & 132) && (m.y < r.top || m.y >= r.bottom) && (q &= -5),
              m.x < r.left && q & 1 && ((m.x = r.left), (n |= 1)),
              q & 16 &&
                ((x = m.x),
                m.x < r.left && ((m.x = r.left), (n |= 4)),
                m.x + w.width > r.right &&
                  ((w.width = Math.min(r.right - m.x, x + w.width - r.left)), (w.width = Math.max(w.width, 0)), (n |= 4))),
              m.x + w.width > r.right && q & 1 && ((m.x = Math.max(r.right - w.width, r.left)), (n |= 1)),
              q & 2 && (n |= (m.x < r.left ? 16 : 0) | (m.x + w.width > r.right ? 32 : 0)),
              m.y < r.top && q & 4 && ((m.y = r.top), (n |= 2)),
              q & 32 &&
                ((x = m.y),
                m.y < r.top && ((m.y = r.top), (n |= 8)),
                m.y + w.height > r.bottom &&
                  ((w.height = Math.min(r.bottom - m.y, x + w.height - r.top)), (w.height = Math.max(w.height, 0)), (n |= 8))),
              m.y + w.height > r.bottom && q & 4 && ((m.y = Math.max(r.bottom - w.height, r.top)), (n |= 2)),
              q & 8 && (n |= (m.y < r.top ? 64 : 0) | (m.y + w.height > r.bottom ? 128 : 0)),
              (r = n))
            : (r = 256),
          (w = r));
        q = new ne(0, 0, 0, 0);
        ...
        r = w;
        r & 496 ||
          (qe(p, new M(q.left, q.top)),
          (k = new jc(q.width, q.height)),
          h == k ||
            (h && k && h.width == k.width && h.height == k.height) ||
            ((h = k),
            (p = p.style),
            H ? (p.MozBoxSizing = "border-box") : I ? (p.WebkitBoxSizing = "border-box") : (p.boxSizing = "border-box"),
            (p.width = Math.max(h.width, 0) + "px"),
            (p.height = Math.max(h.height, 0) + "px")));
        if (2 != e && r & 496) {
        ...
        !a.u ||
          r & 496 ||
          ((e = parseFloat(a.g.style.left)),
          (f = parseFloat(a.g.style.top)),
          C(!isNaN(e) && !isNaN(f), "Could not parse position."),
          (isFinite(e) && 0 == e % 1 && isFinite(f) && 0 == f % 1) || qe(a.g, Math.round(e), Math.round(f)));
      }
      Me(a, b, c, d);
    },
    Me = function (a, b, c, d) {
      ...
      a.h
        ? ((c = we(a.h, a.g)),
          (d = Ne(a.h, b)),
          Je(b) ? (e.style.top = Oe(c.y + d.y, a.g.offsetHeight - 15) + "px") : (e.style.left = Oe(c.x + d.x, a.g.offsetWidth - 15) + "px"))
        : (e.style[0 == c ? (Je(b) ? "top" : "left") : Je(b) ? "bottom" : "right"] = d + "px");
    },
    Oe = function (a, b) {
  ...
  var af = function (a) {
    ...
    this.i = this.dom.Z(
      "DIV",
      "jfk-tooltip-arrow",
      this.dom.Z("DIV", "jfk-tooltip-arrowimplbefore"),
      this.dom.Z("DIV", "jfk-tooltip-arrowimplafter")
    );
  ...
  lf.prototype.remove = function (a, b, c, d) {
    ...
    b = mf(e, b, c, d);
    return -1 < b
      ? (kf(e[b]), C(null != e.length), Array.prototype.splice.call(e, b, 1), 0 == e.length && (delete this.g[a], this.h--), !0)
      : !1;
  };
  var nf = function (a, b) {
    var c = b.type;
  ...
  var pf = "closure_lm_" + ((1e6 * Math.random()) | 0),
    ...
    vf = function (a, b, c, d, e, f) {
      ...
      d.src = a;
      d.listener = c;
      if (a.addEventListener) df || (e = h), void 0 === e && (e = !1), a.addEventListener(b.toString(), d, e);
    ...
    sf = function (a, b, c, d, e) {
      ...
      c = uf(c);
      return gf(a) ? a.m.add(String(b), c, !0, v(d) ? !!d.capture : !!d, e) : vf(a, b, c, !0, d, e);
    },
    Af = function (a, b, c, d, e) {
      if (Array.isArray(b)) for (var f = 0; f < b.length; f++) Af(a, b[f], c, d, e);
      else
        (d = v(d) ? !!d.capture : !!d),
          (c = uf(c)),
          gf(a) ? a.m.remove(String(b), c, d, e) : a && (a = wf(a)) && (b = of(a, b, c, d, e)) && Bf(b);
    },
    Bf = function (a) {
  ...
  var If = function (a, b, c, d, e, f) {
    if (Array.isArray(c)) for (var h = 0; h < c.length; h++) If(a, b, c[h], d, e, f);
    else
      (d = d || a.handleEvent),
        (e = v(e) ? !!e.capture : !!e),
        (f = f || a.S || a),
        (d = uf(d)),
        (e = !!e),
        (c = gf(b) ? of(b.m, String(c), d, e, f) : b ? ((b = wf(b)) ? of(b, c, d, e, f) : null) : null),
        c && (Bf(c), delete a.m[c.key]);
    return a;
  };
  ...
  Nf.prototype.ra = function () {
    if (!this.i) Rf(this), (this.o = this.h = null);
      ...
      var a = Pc(this.i, function (k) {
          return (
            k.getAttribute &&
            (k.getAttribute("data-tooltip-contained") || k.getAttribute("data-tooltip") || k.g) &&
      ...
      if (
        ...
        !(
          ...
          (this.na && "mouse" == a.getAttribute("data-tooltip-trigger"))
        ))
      ) {
        var c = dc;
  ...
  var Xf = function (a, b, c, d, e, f) {
    ...
    Vf = function (a) {
      if ((48 <= a && 57 >= a) || (96 <= a && 106 >= a) || (65 <= a && 90 >= a) || ((I || Db) && 0 == a)) return !0;
      switch (a) {
        case 32:
        case 43:
        case 63:
  ...
  g.Db = function (a) {
    if (I || Db)
      if ((17 == this.I && !a.ctrlKey) || (18 == this.I && !a.altKey) || (J && 91 == this.I && !a.metaKey)) this.ba = this.I = -1;
    -1 == this.I &&
      (a.ctrlKey && 17 != a.g ? (this.I = 17) : a.altKey && 18 != a.g ? (this.I = 18) : a.metaKey && 91 != a.g && (this.I = 91));
  ...
  g.handleEvent = function (a) {
    ...
    if (G && "keypress" == a.type) {
      ...
      (I || Db) && "keypress" == a.type
        ? ((d = this.ba), (e = 0 <= b.charCode && 63232 > b.charCode && Vf(d) ? b.charCode : 0))
        : ("keypress" == a.type
            ? (cg && (c = this.Qa),
              b.keyCode == b.charCode
                ? 32 > b.keyCode
                  ? ((d = b.keyCode), (e = 0))
                  : ((d = this.ba), (e = b.charCode))
                : ((d = b.keyCode || this.ba), (e = b.charCode || 0)))
            : ((d = b.keyCode || this.ba), (e = b.charCode || 0)),
          J && 63 == e && 224 == d && (d = 191));
    var f = (d = Wf(d));
    d
      ? 63232 <= d && d in ag
        ? (f = ag[d])
        : 25 == d && a.shiftKey && (f = 9)
      : b.keyIdentifier && b.keyIdentifier in bg && (f = bg[b.keyIdentifier]);
    if (!H || "keypress" != a.type || Xf(f, this.I, a.shiftKey, a.ctrlKey, c, a.metaKey))
      (a = f == this.I), (this.I = f), (b = new Zf(f, e, a, b)), (b.altKey = c), this.K(b);
  };
  g.j = function () {
    return this.ia;
  };
  ...
  X.prototype.T = function () {
    ...
    this.g.mb(this);
    this.F & -2 &&
      (this.Ba && Dg(this, !0), this.F & 32 && (a = this.j())) &&
      ((b = this.C || (this.C = new $f())),
      b.attach(a),
      kg(this).listen(b, "key", this.Eb).listen(a, "focus", this.Cb).listen(a, "blur", this.kb));
  };
  var Dg = function (a, b) {
    var c = kg(a),
      d = a.j();
    b
      ? (c.listen(d, Ag.Ma, a.ca).listen(d, [Ag.Na, Ag.gb], a.ka).listen(d, "mouseover", a.ra).listen(d, "mouseout", a.qa),
        a.X != Qa && c.listen(d, "contextmenu", a.X),
        G && !a.G && ((a.G = new Fg(a)), Ze(a, a.G)))
      : (If(If(If(If(c, d, Ag.Ma, a.ca), d, [Ag.Na, Ag.gb], a.ka), d, "mouseover", a.ra), d, "mouseout", a.qa),
        a.X != Qa && If(c, d, "contextmenu", a.X),
        G && (Ye(a.G), (a.G = null)));
  };
  ...
  X.prototype.setEnabled = function (a) {
    ...
    (b && "function" == typeof b.isEnabled && !b.isEnabled()) ||
      !Gg(this, 1, !a) ||
      (a || (Hg(this, !1), Ig(this, !1)), this.isVisible() && this.g.Ga(this, a), Jg(this, 1, !a, !0));
  };
  var Ig = function (a, b) {
    Gg(a, 2, b) && Jg(a, 2, b);
  };
  ...
  g.ca = function (a) {
    this.isEnabled() &&
      (Y(this, 2) && Ig(this, !0),
      0 != a.h.button || (J && a.ctrlKey) || (Y(this, 4) && Hg(this, !0), this.g && this.g.eb(this) && this.j().focus()));
  ...
  g.Ha = function (a) {
    ...
    if (b)
      if (this.Oa) {
        ...
        a
          ? (a instanceof L ? (b.g = a) : (b.setAttribute("data-tooltip", a), (b.g = null)), b.setAttribute("aria-label", c))
          : ((b.g = null), b.removeAttribute("aria-label"));
        a = N(b) || N();
        b = ua(a.g);
        Mf[b] || (Mf[b] = new Nf(a));
  ...
  Z.prototype.fa = function (a) {
    ...
    var b = a.i,
      c = Md(Pd, { disabled: !a.isEnabled(), checked: a.V(), style: a.L, title: a.xa(), Jb: a.Oa, value: a.R(), width: a.P }, b);
    b.tb(c, a.getContent());
    this.M(a, c);
    return c;
  };
  ...
  var Xg = function (a, b) {
    ...
    a = a.wb;
    Kd();
    Cd["jfk.templates.checkbox.main"]
      ? (c = Cd["jfk.templates.checkbox.main"](
          { attributes: c, sa: d, checked: e, disabled: f, id: h, ob: k, qb: p, ariaLabel: q, wb: a },
          b
        ))
      : ((b = p ? " " + Q("jfk-checkbox-undetermined") : e ? " " + Q("jfk-checkbox-checked") : " " + Q("jfk-checkbox-unchecked")),
        (e = p ? "mixed" : e ? "true" : "false"),
        (q = a ? ' aria-labelledby="' + Q(a) + '"' : q ? ' aria-label="' + Q(q) + '"' : ""),
        (c = yd(
          '<span class="' +
            Q("jfk-checkbox") +
            " " +
            ...
            q +
            (h ? ' id="' + Q(h) + '"' : "") +
            (f ? ' aria-disabled="true" tabindex="-1"' : ' tabindex="' + (k ? Q(k) : "0") + '"') +
            (c ? Id(Hd(c)) : "") +
            ' dir="ltr"><div class="' +
            Q("jfk-checkbox-checkmark") +
  ...
  var Yg = function (a, b, c) {
    if (b) {
      ...
      ge(b, d) ||
        ...
        Ve(b, "checked", null == c ? "mixed" : 1 == c ? "true" : "false"));
    }
  };
  ...
  g.T = function () {
    ...
    if (this.Ba) {
      ...
      this.J &&
        a
          .listen(this.J, "click", this.Va)
          .listen(this.J, "mouseover", this.ra)
          .listen(this.J, "mouseout", this.qa)
          .listen(this.J, "mousedown", this.ca)
          .listen(this.J, "mouseup", this.ka);
  ...
  var dh = function (a, b) {
    ...
    a = a.value;
    Kd();
    return Cd["jfk.templates.radiobutton.strict"]
      ? Cd["jfk.templates.radiobutton.strict"]({ attributes: c, checked: d, sa: e, disabled: f, id: h, label: k, name: p, value: a }, b)
      : yd(
          '<div class="' +
            Q("jfk-radiobutton") +
            (d ? " " + Q("jfk-radiobutton-checked") : "") +
            (f ? " " + Q("jfk-radiobutton-disabled") : "") +
            (e ? " " + Q(e) : "") +
            '"' +
            (p ? ' data-name="' + Q(p) + '"' : "") +
            (a ? ' data-value="' + Q(a) + '"' : "") +
            (h ? ' id="' + Q(h) + '"' : "") +
            (c ? Id(Hd(c)) : "") +
            ' role="radio"><span class="' +
            Q("jfk-radiobutton-radio") +
            '"></span><span class="' +
            Q("jfk-radiobutton-label") +
            '">' +
            (k ? Bd(k) : "") +
            "</span></div>"
        );
  ...
  var wh = function (a) {
    ...
    d = d || "";
    for (var h in c)
      (e = document.createElement("option")), (e.value = h), (e.text = c[h]), (e.h = b++), a.l.appendChild(e), h == d && (e.selected = !0);
  };
