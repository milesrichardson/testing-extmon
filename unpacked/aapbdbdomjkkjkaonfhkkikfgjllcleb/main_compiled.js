...
*/
      ...
      for (var e in c)
        if (Object.prototype.hasOwnProperty.call(c, e)) {
          ...
          for (var f = 0; f < d.length; f++) {
            var g = d[f];
            null != g &&
              (b || (b = a), (b += (b.length > a.length ? "&" : "") + encodeURIComponent(e) + "=" + encodeURIComponent(String(g))));
          }
        }
      return b;
    };
  var sa = function () {};
  var ta = Array.prototype.some
    ? function (a, b) {
        y(null != a.length);
  ...
  var Ga = function (a) {
      ...
      a instanceof J && a.constructor === J
        ? (a = a.g)
        : (z("expected object of type SafeUrl, got '" + a + "' of type " + m(a)), (a = "type_error:SafeUrl"));
      b.src = a;
    },
    Ia = function (a, b) {
      ua(a, "SCRIPT");
    ...
    function c() {
      ...
      return e.run(function () {
        ...
        if (d instanceof Array) var x = d;
          ...
          else if ("number" == typeof d.length) x = { next: aa(d) };
    ...
    bb = function () {
      if (k.Promise && k.Promise.resolve) {
        ...
        M = function () {
          var b = db,
            c;
          !(c = "function" !== typeof k.setImmediate) &&
            (c = k.Window && k.Window.prototype) &&
            ((c = va ? !!I && 0 < I.brands.length : !1) || (c = -1 == H().indexOf("Edge")),
            (c = c && k.Window.prototype.setImmediate == k.setImmediate));
        ...
        if (a.i) {
          ...
          if (c.h) {
            ...
            d &&
              (0 == c.g && 1 == e
                ? jb(c, b)
                : (f ? ((e = f), y(c.h), y(null != e), e.next == c.j && (c.j = e), (e.next = e.next.next)) : kb(c), lb(c, d, 3, b)));
          }
          a.i = null;
        } else N(a, 3, b);
    },
...
*/
  ...
  var Eb = function (a, b) {
      ...
      d.onerror = function () {
        U(d, !0, h);
        sb(g, new Cb(0, "Error while loading script " + e));
      };
      f = c.attributes || {};
  ...
  V.prototype.u = function (a) {
    ...
    if (864e5 < Math.abs(b - c) || e != a)
      (b = new C(la, "https://translate.googleapis.com/translate_a/l")),
        b instanceof C && b.constructor === C && b.h === ma
          ? (b = b.g)
          : (z("expected object of type Const, got '" + b + "'"), (b = "type_error:Const")),
        (b = qa(b)),
        new Fb(b).send({ client: "gtx", hl: e }, p(this.s, this, e));
  };
  var Nb = function (a, b) {
    var c = [],
      e;
  ...
  var Ob = t("(function(){({{$code}})();})();", { code: window.injection.toString() }),
    Pb = t("(function(){({{$code}})();})();", { code: window.injector.toString() }),
    Qb = /^[A-z-]{2,}$/;
  ...
  chrome.runtime.onMessage.addListener(function (a, b) {
    a.audioSrc
      ? K.paused || a.audioSrc != K.src
        ? (Ga(a.audioSrc), K.load(), K.play())
        : (K.pause(), (K.currentTime = 0))
      : a.bubbleClosed || a.popupClosed
      ? K.pause()
      : a.detectLanguage &&
        chrome.tabs.detectLanguage(function (c) {
  ...
  for (var Z; X.length && (Z = X.shift()); )
    X.length || void 0 === Ub ? (Y[Z] && Y[Z] !== Object.prototype[Z] ? (Y = Y[Z]) : (Y = Y[Z] = {})) : (Y[Z] = Ub);
