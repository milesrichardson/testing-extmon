...
*/
    ...
    tb = function (a, b) {
      ...
      for (var d = Math.max(a.length, b.length), e = 0; 0 == c && e < d; e++) {
        ...
        do {
          ...
          c =
            sb(0 == f[1].length ? 0 : parseInt(f[1], 10), 0 == h[1].length ? 0 : parseInt(h[1], 10)) ||
            sb(0 == f[2].length, 0 == h[2].length) ||
            sb(f[2], h[2]);
          f = f[3];
          h = h[3];
        } while (0 == c);
  ...
  var Pb = function (a) {
    ...
    Rb = function (a) {
      a instanceof A ||
        ((a = "object" == typeof a && a.Ra ? a.za() : String(a)),
        rb.test(a) &&
  ...
  var Vb = { MATH: !0, SCRIPT: !0, STYLE: !0, SVG: !0, TEMPLATE: !0 },
    Wb = (function (a) {
      var b = !1,
        c;
      return function () {
  ...
  var cc = function (a) {
    ...
    ec = function (a, b, c) {
      ...
      else for (var d = dc(a), e = cc(a), f = e.length, h = 0; h < f; h++) b.call(c, e[h], d && d[h], a);
    };
  var fc = RegExp(
      "^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$"
    ),
...
*/
  ...
  var zd = function (a) {
    ...
    Dd = function (a) {
      return Zc(a, Uc, Xc)
        ...
        : a instanceof A
        ? Ad(Pb(a).toString())
        : Ad(String(String(a)).replace(Bd, Cd), zd(a));
    },
    Ad = (function (a) {
      function b(c) {
        this.content = c;
    ...
    Ed = {},
    Fd = function (a, b) {
      return a && b && a.yc && b.yc
        ? a.qa !== b.qa
          ? !1
          : a.toString() === b.toString()
        : a instanceof Wc && b instanceof Wc
        ? a.qa != b.qa
          ? !1
          : a.toString() == b.toString()
        : a == b;
  ...
  var Sd = function (a) {
    ...
    ae = function (a) {
      var b = Zd(a);
      a = $d(a);
      return B && a.pageYOffset != b.scrollTop
    ...
    je = { SCRIPT: 1, STYLE: 1, HEAD: 1, IFRAME: 1, OBJECT: 1 },
    ke = { IMG: " ", BR: "\n" },
    le = function (a, b) {
...
*/
  function qe(a, b) {
    ...
    c = c.popup;
    Ld();
    if (Ed["extension.translation"]) b = Ed["extension.translation"]({ query: d, kc: e, fc: f, ic: h, hc: g, Xb: b, popup: c }, void 0);
    else {
      var l = "";
      if (d)
        if (e) {
          ...
          if (b) {
            ...
            for (e = 0; e < d; e++) {
              ...
              if (c) for (f = f.terms, h = f.length, g = 0; g < h; g++) l += (0 != g ? ", " : "") + Dd(f[g]);
              else for (f = f.terms, h = f.length, g = 0; g < h; g++) (n = f[g]), (l += 3 > g ? (0 != g ? ", " : "") + Dd(n) : "");
              l += "</td></tr>";
            }
            l += "</table>";
          }
  ...
  if ("undefined" != typeof Symbol && "undefined" != typeof Symbol.hasInstance) {
    var Fe = function () {
      ...
      Ge = {};
    Object.defineProperties(Ee, ((Ge[Symbol.hasInstance] = { value: Fe, configurable: !1, writable: !1, enumerable: !1 }), Ge));
  ...
  k.translate = function (a, b) {
    a instanceof D
      ...
      : (Ja(a), (this.left += a), (this.right += a), "number" === typeof b && ((this.top += b), (this.bottom += b)));
    return this;
  };
  ...
  var Ve = function (a, b) {
    ...
    Ze = function (a) {
      if (B && !(8 <= Number(yd))) return x(a && "offsetParent" in a), a.offsetParent;
      var b = Rd(a),
        c = Ve(a, "position"),
    ...
    ef = function (a) {
      var b = a.offsetWidth,
        c = a.offsetHeight,
        d = id && !b && !c;
      return (void 0 === b || d) && a.getBoundingClientRect ? ((a = Ye(a)), new Pd(a.right - a.left, a.bottom - a.top)) : new Pd(b, c);
    },
    gf = function (a) {
      var b = $e(a);
      a = ff(a);
  ...
  var lf = (function () {
    ...
    return jd
      ? ((a = /1[0|1][_.][0-9_.]+/), (a = a.exec(Gb())) ? a[0].replace(/_/g, ".") : "10")
      : ld
      ? ((a = /Android\s+([^\);]+)(\)|;)/), (a = a.exec(Gb())) ? a[1] : "")
      : md || nd || od
      ? ((a = /(?:iPhone|CPU)\s+OS\s+(\S+)/), (a = a.exec(Gb())) ? a[1].replace(/_/g, ".") : "")
      : "";
  })();
  var mf = function (a) {
  ...
  var qf = function (a, b, c, d, e, f) {
      if (a.m) {
        ...
        if (v) {
          ...
          if (!G || "static" != Ve(v, "position")) {
            ...
            if (!G) {
              ...
              G = M
                ? -v.scrollLeft
                : G && !hd && "visible" != Ve(v, "overflowX")
                ? v.scrollWidth - v.clientWidth - v.scrollLeft
                : v.scrollLeft;
        ...
        if ((G = af(g)))
          (P = new Ue(G.left, G.top, G.right - G.left, G.bottom - G.top)),
            ...
            G <= M &&
              ((K = Math.max(v.top, P.top)),
              (P = Math.min(v.top + v.height, P.top + P.height)),
              K <= P && ((v.left = G), (v.top = K), (v.width = M - G), (v.height = P - K)));
        G = Sd(g);
        K = Sd(l);
        if (G.g != K.g) {
          M = G.g.body;
        ...
        n &&
          (y
            ? ((r = p),
              ...
              r.x < y.left && n & 1 && ((r.x = y.left), (v |= 1)),
              n & 16 &&
                ((G = r.x),
                r.x < y.left && ((r.x = y.left), (v |= 4)),
                r.x + F.width > y.right &&
                  ((F.width = Math.min(y.right - r.x, G + F.width - y.left)), (F.width = Math.max(F.width, 0)), (v |= 4))),
              r.x + F.width > y.right && n & 1 && ((r.x = Math.max(y.right - F.width, y.left)), (v |= 1)),
              n & 2 && (v |= (r.x < y.left ? 16 : 0) | (r.x + F.width > y.right ? 32 : 0)),
              r.y < y.top && n & 4 && ((r.y = y.top), (v |= 2)),
              n & 32 &&
                ((G = r.y),
                r.y < y.top && ((r.y = y.top), (v |= 8)),
                r.y + F.height > y.bottom &&
                  ((F.height = Math.min(y.bottom - r.y, G + F.height - y.top)), (F.height = Math.max(F.height, 0)), (v |= 8))),
              r.y + F.height > y.bottom && n & 4 && ((r.y = Math.max(y.bottom - F.height, y.top)), (v |= 2)),
    ...
    tf = function (a, b, c, d) {
      ...
      a.m
        ? ((c = cf(a.m, a.g)),
          (d = uf(a.m, b)),
          rf(b) ? (e.style.top = vf(c.y + d.y, a.g.offsetHeight - 15) + "px") : (e.style.left = vf(c.x + d.x, a.g.offsetWidth - 15) + "px"))
        : (e.style[0 == c ? (rf(b) ? "top" : "left") : rf(b) ? "bottom" : "right"] = d + "px");
    },
    vf = function (a, b) {
  ...
  var Hf = function (a) {
    ...
    this.s = this.dom.ma(
      "DIV",
      "jfk-tooltip-arrow",
      this.dom.ma("DIV", "jfk-tooltip-arrowimplbefore"),
      this.dom.ma("DIV", "jfk-tooltip-arrowimplafter")
    );
  ...
  Sf.prototype.remove = function (a, b, c, d) {
    ...
    b = Tf(e, b, c, d);
    return -1 < b
      ? (Rf(e[b]), x(null != e.length), Array.prototype.splice.call(e, b, 1), 0 == e.length && (delete this.g[a], this.m--), !0)
      : !1;
  };
  var Uf = function (a, b) {
    var c = b.type;
  ...
  var Wf = "closure_lm_" + ((1e6 * Math.random()) | 0),
    ...
    bg = function (a, b, c, d, e, f) {
      ...
      d.src = a;
      d.listener = c;
      if (a.addEventListener) Kf || (e = h), void 0 === e && (e = !1), a.addEventListener(b.toString(), d, e);
    ...
    gg = function (a, b, c, d, e) {
      if (Array.isArray(b)) for (var f = 0; f < b.length; f++) gg(a, b[f], c, d, e);
      else
        (d = xa(d) ? !!d.capture : !!d),
          (c = ag(c)),
  ...
  var qg = function (a, b, c, d, e, f) {
    if (Array.isArray(c)) for (var h = 0; h < c.length; h++) qg(a, b, c[h], d, e, f);
    else
      (d = d || a.handleEvent),
        (e = xa(e) ? !!e.capture : !!e),
        (f = f || a.U || a),
  ...
  function ug(a, b) {
    if (b instanceof vb)
      b instanceof vb && b.constructor === vb
        ? (b = b.g)
        : (Ia("expected object of type SafeUrl, got '" + b + "' of type " + va(b)), (b = "type_error:SafeUrl"));
    else {
      b: if (Lc) {
        try {
          var c = new URL(b);
    ...
    if (!this.s) Ag(this), (this.F = this.m = null);
      ...
      if (
        ...
        !(
          ...
          (this.ka && "mouse" == a.getAttribute("data-tooltip-trigger"))
        ))
      ) {
        var c = Tb;
  ...
  wg.prototype.Y = function (a, b, c, d, e, f) {
    ...
    this.M != e && (this.M && !jb(bc(this.M)) && Qe(this.g.D(), this.M), jb(bc(e)) || Oe(this.g.D(), e), (this.M = e));
    Xe(this.g.D(), 0, 0);
    if (b instanceof A) {
      d = this.g.g;
      if (void 0 !== d.tagName) {
  ...
  var Gg = function (a, b, c, d, e, f) {
    ...
    Eg = function (a) {
      if ((48 <= a && 57 >= a) || (96 <= a && 106 >= a) || (65 <= a && 90 >= a) || ((id || gd) && 0 == a)) return !0;
      switch (a) {
        case 32:
        case 43:
        case 63:
  ...
  k.uc = function (a) {
    if (id || gd)
      if ((17 == this.S && !a.ctrlKey) || (18 == this.S && !a.altKey) || (jd && 91 == this.S && !a.metaKey)) this.ia = this.S = -1;
    -1 == this.S &&
    ...
    Gg(a.keyCode, this.S, a.shiftKey, a.ctrlKey, a.altKey, a.metaKey)
      ? ((this.ia = Fg(a.keyCode)), Mg && (this.rb = a.altKey))
      : this.handleEvent(a);
  };
  k.wc = function (a) {
    this.ia = this.S = -1;
  ...
  k.handleEvent = function (a) {
    ...
    if (B && "keypress" == a.type) {
      ...
      (id || gd) && "keypress" == a.type
        ? ((d = this.ia), (e = 0 <= b.charCode && 63232 > b.charCode && Eg(d) ? b.charCode : 0))
        : ("keypress" == a.type
            ? (Mg && (c = this.rb),
              b.keyCode == b.charCode
                ? 32 > b.keyCode
                  ? ((d = b.keyCode), (e = 0))
                  : ((d = this.ia), (e = b.charCode))
                : ((d = b.keyCode || this.ia), (e = b.charCode || 0)))
            : ((d = b.keyCode || this.ia), (e = b.charCode || 0)),
          jd && 63 == e && 224 == d && (d = 191));
    var f = (d = Fg(d));
    d
      ? 63232 <= d && d in Kg
        ? (f = Kg[d])
        : 25 == d && a.shiftKey && (f = 9)
      : b.keyIdentifier && b.keyIdentifier in Lg && (f = Lg[b.keyIdentifier]);
    if (!C || "keypress" != a.type || Gg(f, this.S, a.shiftKey, a.ctrlKey, c, a.metaKey))
      (a = f == this.S), (this.S = f), (b = new Ig(f, e, a, b)), (b.altKey = c), I(this, b);
  };
  k.D = function () {
    return this.wa;
  };
  ...
  J.prototype.ha = function () {
    ...
    this.g.cc(this);
    this.P & -2 &&
      (this.bb && kh(this, !0), this.P & 32 && (a = this.D())) &&
      ((b = this.K || (this.K = new Jg())),
      b.attach(a),
  ...
  var kh = function (a, b) {
    var c = Tg(a),
      d = a.D();
    b
      ? (c.listen(d, hh.ob, a.Pa).listen(d, [hh.pb, hh.Tb], a.Qa).listen(d, "mouseover", a.Ua).listen(d, "mouseout", a.Da),
        a.V != Ua && c.listen(d, "contextmenu", a.V),
        B && !a.N && ((a.N = new nh(a)), Ff(a, u(Ef, a.N))))
      : (qg(qg(qg(qg(c, d, hh.ob, a.Pa), d, [hh.pb, hh.Tb], a.Qa), d, "mouseover", a.Ua), d, "mouseout", a.Da),
  ...
  J.prototype.setEnabled = function (a) {
    ...
    (b && "function" == typeof b.isEnabled && !b.isEnabled()) ||
      !oh(this, 1, !a) ||
      (a || (ph(this, !1), qh(this, !1)), this.isVisible() && this.g.hb(this, a), sh(this, 1, !a, !0));
  };
  var qh = function (a, b) {
    oh(a, 2, b) && sh(a, 2, b);
  };
  ...
  k.Pa = function (a) {
    this.isEnabled() &&
      (L(this, 2) && qh(this, !0),
      0 != a.g.button || (jd && a.ctrlKey) || (L(this, 4) && ph(this, !0), this.g && this.g.Rb(this) && this.D().focus()));
  ...
  k.jb = function (a) {
    ...
    if (b)
      if (this.na) {
        ...
        a
          ? (a instanceof A ? (b.g = a) : (b.setAttribute("data-tooltip", a), (b.g = null)), b.setAttribute("aria-label", c))
  ...
  Bh.prototype.xa = function (a) {
    ...
    var b = a.u;
    var c = { disabled: !a.isEnabled(), checked: a.Aa(), style: a.W, title: a.Oa(), Bc: a.na, value: a.ua(), width: a.Y };
    if (Ed["jfk.templates.button.strict"]) var d = Ed["jfk.templates.button.strict"](c, void 0);
      ...
      if (Ed["jfk.templates.button.classes_"])
        c = Ed["jfk.templates.button.classes_"]({ rc: c, disabled: G, checked: F, style: M, width: v }, void 0);
      else {
        ...
        c = K +=
          (Fd(v, 1) ? " jfk-button-narrow" : "") +
          (F ? " jfk-button-checked" : "") +
          (c ? " " + c : "") +
          (G ? " jfk-button-disabled" : "");
      }
      f =
        h +
        Jd(c) +
        '"' +
        (f ? ' aria-disabled="true"' : ' tabindex="' + (g ? Jd(g) : "0") + '"') +
        (l ? (n ? ' data-tooltip="' + Jd(l) + '"' : ' title="' + Jd(l) + '"') : "") +
        (p ? ' value="' + Jd(p) + '"' : "");
      e
        ? (Zc(e, Vc, Yc)
            ? (e = e.getContent())
            : ((e = String(e)), Nd.test(e) || (Ia("Bad value `%s` for |filterHtmlAttributes", [e]), (e = "zSoyz"))),
  ...
  var Lh = function (a, b, c) {
    var d = c.toLowerCase();
    d in Jh && Kh[Jh[d.toLowerCase()]] >= b.length
      ? (a.Z && Ya(a.Z, "no-audio") && (0 == a.Z.length && (a.Z = null), ah(a, "no-audio", !1)), (a.Ub = b), (a.Va = c))
      : mh(a, "no-audio");
  };
  function Mh(a) {
  ...
  Th.prototype.F = function () {
    this.B();
    for (var a in this.g)
      0 != this.g[a] && (Wh(this, "/gen204?" + Vh(this, a, this.g[a][1])), a in this.g && (q.clearTimeout(this.g[a][0]), delete this.g[a]));
  };
  Th.T = function () {
    return Dg(Th);
  };
    ...
    try {
      ii(this),
        0 < this.K &&
          ...
          this.U ? ((this.g.timeout = this.K), (this.g.ontimeout = t(this.Ca, this))) : (this.N = mg(this.Ca, this.K, this))),
  ...
  N.prototype.Ca = function () {
    "undefined" != typeof ta &&
      this.g &&
      ((this.H = "Timed out after " + this.K + "ms, aborting"), Jc(this.m, gi(this, this.H)), I(this, "timeout"), this.abort(8));
  };
  var hi = function (a, b) {
      a.u = !1;
  ...
  function qi(a, b) {
    void 0 === a.eb ? Object.defineProperties(a, { eb: { value: b, configurable: !0, writable: !0, enumerable: !1 } }) : (a.eb |= b);
  }
  function ri(a) {
    return a.eb || 0;
  }
  ...
  } else (zi = qi), (Ai = ri), (Ci = si), (Bi = ti), (Di = ui), (Ei = vi), (Fi = wi), (Gi = xi), (Hi = yi);
  var Ni = function () {},
    Oi = function () {};
  m(Oi, Ni);
  var Pi = function () {};
  ...
  function bj(a, b) {
    var c = Ti(a, b);
    c instanceof Oi &&
      ((c = Ti(a, b)), Array.isArray(c) ? (c = Ma(c)) : c instanceof Oi ? (c = Ma(c.g(a, b))) : (x(null == c), (c = []), Si(a, b, c)));
    a = Ma(c);
        ...
        if (null != g) {
          ...
          if (h.A)
            (e.kb = h.A),
              ...
              h.l ? (l = l(g)) : ((g = Ma(g).map(l)), (l = g.length ? g : null));
          else
            b: {
              switch (typeof g) {
                case "string":
