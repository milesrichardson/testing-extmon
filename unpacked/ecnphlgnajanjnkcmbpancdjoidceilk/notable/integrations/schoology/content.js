  ...
  chrome.runtime.onMessage.addListener(function (o) {
    if (n()) {
      ...
      if (o.file_link) {
        ...
        if (!c) return;
        const m = c[1];
        var i = { schoology: { assignment_id: s, assignment_name: a, attachment_id: m, schoology_origin: e } };
        const l = "schoology-" + s + "-attachment-" + m,
          d = new URL(n),
          u = new URL(`${t}/web/viewer.html`);
        u.searchParams.set("file", d.toString()),
          u.searchParams.set("individual_copy_key", l),
