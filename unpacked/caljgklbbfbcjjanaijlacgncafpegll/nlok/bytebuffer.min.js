...
(function (k, m) {
  ...
  function r() {
    ...
    return function () {
      ...
      1024 < a.length + arguments.length && (b.push(w.apply(String, a)), (a.length = 0));
  ...
  h.wrap = function (a, b, c, d) {
    ...
    if (a instanceof Uint8Array)
      ...
      (b = new h(0, c, d)),
        0 < a.byteLength &&
          ((b.buffer = a), (b.offset = 0), (b.limit = a.byteLength), (b.view = 0 < a.byteLength ? new Uint8Array(a) : null));
    else if ("[object Array]" === Object.prototype.toString.call(a))
      for (b = new h(a.length, c, d), b.limit = a.length, c = 0; c < a.length; ++c) b.view[c] = a[c];
  ...
  k &&
    ...
    (e.readVarint64 = function (a) {
      ...
      if (
        g & 128 &&
        ((g = this.view[a++]), (d |= (g & 127) << 7), g & 128 || (this.noAssert && "undefined" === typeof g)) &&
        ((g = this.view[a++]), (d |= (g & 127) << 14), g & 128 || (this.noAssert && "undefined" === typeof g)) &&
        ((g = this.view[a++]), (d |= (g & 127) << 21), g & 128 || (this.noAssert && "undefined" === typeof g)) &&
        ((g = this.view[a++]), (f = g & 127), g & 128 || (this.noAssert && "undefined" === typeof g)) &&
        ((g = this.view[a++]), (f |= (g & 127) << 7), g & 128 || (this.noAssert && "undefined" === typeof g)) &&
        ((g = this.view[a++]), (f |= (g & 127) << 14), g & 128 || (this.noAssert && "undefined" === typeof g)) &&
        ((g = this.view[a++]), (f |= (g & 127) << 21), g & 128 || (this.noAssert && "undefined" === typeof g)) &&
        ((g = this.view[a++]), (e = g & 127), g & 128 || (this.noAssert && "undefined" === typeof g)) &&
        ((g = this.view[a++]), (e |= (g & 127) << 7), g & 128 || (this.noAssert && "undefined" === typeof g))
      )
  ...
  e.clone = function (a) {
    ...
    a
      ? ((b.buffer = new ArrayBuffer(this.buffer.byteLength)), (b.view = new Uint8Array(b.buffer)))
  ...
  e.compact = function (a, b) {
    ...
    if (0 === c)
      return (
        (this.buffer = v), (this.view = null), 0 <= this.markedOffset && (this.markedOffset -= a), (this.limit = this.offset = 0), this
      );
        ...
        c(b[(d >> 2) & 63]),
          ...
          null !== (d = a())
            ? ((f |= (d >> 4) & 15),
              c(b[(f | ((d >> 4) & 15)) & 63]),
              (f = (d & 15) << 2),
              null !== (d = a()) ? (c(b[(f | ((d >> 6) & 3)) & 63]), c(b[d & 63])) : (c(b[f & 63]), c(61)))
            : (c(b[f & 63]), c(61), c(61));
    };
    a.decode = function (a, b) {
      ...
      for (var f, e, h; null !== (f = a()); )
        if (
          ...
          null !== (f = a()) && ((h = c[f]), "undefined" === typeof h && d(f), b(((e << 2) >>> 0) | ((h & 48) >> 4)), null !== (f = a())))
        ) {
          e = c[f];
  ...
  e.toDebug = function (a) {
    for (var b = -1, c = this.buffer.byteLength, d, f = "", e = "", g = ""; b < c; ) {
      -1 !== b &&
        ((d = this.view[b]),
        (f = 16 > d ? f + ("0" + d.toString(16).toUpperCase()) : f + d.toString(16).toUpperCase()),
      ...
      f =
        b === this.offset && b === this.limit
          ...
          : b === this.limit
          ? f + (b === this.markedOffset ? "]" : ">")
          : f + (b === this.markedOffset ? "'" : a || (0 !== b && b !== c) ? " " : "");
    }
    if (a && " " !== f) {
      for (; 51 > f.length; ) f += " ";
      g += f + e + "\n";
    ...
    var a = {
      ...
      encodeUTF8: function (a, c) {
        ...
        for (; null !== d || null !== (d = a()); )
          128 > d
            ...
            : (2048 > d
                ? c(((d >> 6) & 31) | 192)
                : (65536 > d ? c(((d >> 12) & 15) | 224) : (c(((d >> 18) & 7) | 240), c(((d >> 12) & 63) | 128)), c(((d >> 6) & 63) | 128)),
              c((d & 63) | 128)),
            (d = null);
      },
      decodeUTF8: function (a, c) {
        for (
          ...
          if (0 === (d & 128)) c(d);
          else if (192 === (d & 224)) null === (f = a()) && h([d, f]), c(((d & 31) << 6) | (f & 63));
          else if (224 === (d & 240))
            (null !== (f = a()) && null !== (e = a())) || h([d, f, e]), c(((d & 15) << 12) | ((f & 63) << 6) | (e & 63));
          else if (240 === (d & 248))
            (null !== (f = a()) && null !== (e = a()) && null !== (g = a())) || h([d, f, e, g]),
              c(((d & 7) << 18) | ((f & 63) << 12) | ((e & 63) << 6) | (g & 63));
          else throw RangeError("Illegal starting byte: " + d);
      },
      UTF16toUTF8: function (a, c) {
        for (var d, e = null; null !== (d = null !== e ? e : a()); )
          55296 <= d && 57343 >= d && null !== (e = a()) && 56320 <= e && 57343 >= e
      ...
      calculateUTF8: function (a) {
        for (var c, d = 0; null !== (c = a()); ) d += 128 > c ? 1 : 2048 > c ? 2 : 65536 > c ? 3 : 4;
        return d;
      },
