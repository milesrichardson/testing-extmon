  ...
  chrome.storage.sync.get(tcDefaults, function (storage) {
    ...
    for (let i in storage.keyBindings) {
      ...
      if (item.predefined) {
        ...
        if (customActionsNoValues.includes(item["action"])) document.querySelector("#" + item["action"] + " .customValue").disabled = true;
        ...
        if (customActionsNoValues.includes(item["action"])) dom.querySelector(".customValue").disabled = true;
