...
MegaData.prototype.getSortByStatusFn = function (d) {
  ...
  sortfn = function (a, b, d) {
    var statusa = M.getSortStatus(a.u),
      statusb = M.getSortStatus(b.u);
    if (statusa < statusb) {
      return -1 * d;
      ...
      return M.compareStrings(M.getNameByHandle(a.h).toLowerCase(), M.getNameByHandle(b.h).toLowerCase(), d);
    }
  };
...
MegaData.prototype.getSortByInteractionFn = function () {
  ...
  sortfn = M.sortObjFn(
    ...
    function (a, b, d) {
      ...
      return M.compareStrings(self.getNameByHandle(a.h).toLowerCase(), self.getNameByHandle(b.h).toLowerCase(), d);
    }
  );
...
MegaData.prototype.getSortByVerificationFn = function () {
  ...
  return function (a, b, d) {
    const a_verifyState = (u_authring.Ed25519[a.h] || {}).method >= authring.AUTHENTICATION_METHOD.FINGERPRINT_COMPARISON;
    const b_verifyState = (u_authring.Ed25519[b.h] || {}).method >= authring.AUTHENTICATION_METHOD.FINGERPRINT_COMPARISON;
...
MegaData.prototype.doSort = function (n, d) {
  ...
  if (n === "ts") {
    ...
    subMenuSortClass = sortItemPrefix + "sharecreated," + sortItemPrefix + "timeAd";
  } else {
