...
(function (global) {
  ...
  AffiliateData.prototype.redeemStep1 = function () {
    ...
    return new Promise(function (resolve, reject) {
      ...
      if (affiliateRedemption.requests.first.m === 0) {
        req = Object.assign({ a: "affr1", extra: { al: affiliateRedemption.plan.chosenPlan } }, affiliateRedemption.requests.first);
      }
  ...
  AffiliateData.prototype.getFilteredRedempHistory = function (filter) {
    ...
    return this.redemptionHistory.r.filter(function (item) {
      const s = item.hasOwnProperty("state") ? item.state : item.s;
      switch (filter) {
        case "processing":
          return s > 0 && s < 4;
        case "complete":
      ...
      api_req(
        { a: "affrd", rid: rid },
        {
          ...
          callback: function (res, ctx) {
            ...
            if (typeof res === "object") {
              ctx.affiliate.redemptionHistory.r[redi] = Object.assign(ctx.affiliate.redemptionHistory.r[redi], res[0]);
  ...
  AffiliateData.prototype.getAffiliateData = function (force) {
    ...
    var promises =
      (refreshData && [this.getID(true), this.getBalance(), this.getRedemptionHistory(), this.getSignupList(), this.getCreditList()]) || [];
