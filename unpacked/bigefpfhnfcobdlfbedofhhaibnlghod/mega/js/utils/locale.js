...
function setDateTimeFormat(locales, format) {
  ...
  try {
    $.dateTimeFormat[locales + "-" + format] = typeof Intl !== "undefined" ? new Intl.DateTimeFormat(locales, options) : "ISO";
...
function setAccDateTimeFormat(locales) {
  ...
  // Create new DateTimeFormat object if it is not exist
  try {
    $.acc_dateTimeFormat[locales] = typeof Intl !== "undefined" ? new Intl.DateTimeFormat(locales, options) : "fallback";
...
mBroadcaster.once("boot_done", function populate_l() {
  ...
  l[517] = escapeHTML(l[517])
    .replace("[A]", '<a href="' + l.mega_help_host + '" class="help-center-link clickurl" target="_blank">')
    .replace("[/A]", "</a>");
  ...
  l[731] = escapeHTML(l[731]).replace("[A]", '<a href="https://mega.io/terms" target="_blank" class="clickurl">').replace("[/A]", "</a>");
  ...
  l[7156] = escapeHTML(l[7156])
    ...
    .replace("[/A]", "</a>");
  l[7202] = escapeHTML(l[7202])
    .replace("[A]", '<a href="https://mega.io/resellers" target="_blank" rel="noopener noreferrer" class="voucher-reseller-link">')
    .replace("[/A]", "</a>");
  ...
  l[7991] = escapeHTML(l[7991]).replace("%1", '<span class="provider-icon"></span><span class="provider-name"></span>');
  l[7996] = escapeHTML(l[7996]).replace("[S]", '<span class="purchase">').replace("[/S]", "</span>");

  l[8436] = escapeHTML(l[8436]).replace("[/A]", "</a>").replace("[A]", '<a class="red" href="mailto:support@mega.nz">');
  l[8440] = escapeHTML(l[8440])
    .replace("[A]", '<a href="https://github.com/meganz/">')
    .replace("[/A]", "</a>")
    .replace("[A2]", '<a href="/contact" class="clickurl">')
    .replace("[/A2]", "</a>");
  l[8441] = escapeHTML(l[8441])
    .replace("[A]", '<a href="mailto:bugs@mega.nz">')
    .replace("[/A]", "</a>")
  ...
  l[8653] = escapeHTML(l[8653])
    .replace("[S]", '<span class="renew-text">')
    .replace("[/S]", "</span>")
    .replace("%1", '<span class="pro-plan"></span>')
    .replace("%2", '<span class="plan-duration"></span>')
    .replace("%3", '<span class="provider-icon"></span>')
    .replace("%4", '<span class="gateway-name"></span>');
  ...
  l[12487] = escapeHTML(l[12487])
    .replace("[A1]", '<a href="" class="red windows">')
    .replace("[/A1]", "</a>")
    .replace("[A2]", '<a href="" class="red linux">')
    .replace("[/A2]", "</a>");
  ...
  l.bus_acc_delete_msg = escapeHTML(l.bus_acc_delete_msg).replace("[S]", '<span class="red">').replace("[/S]", "</span>");

  l[16167] = escapeHTML(l[16167])
    .replace("[A]", '<a href="https://mega.io/mobile" target="_blank" class="clickurl">')
    .replace("[/A]", "</a>");
  l[16301] = escapeHTML(l[16301]).replace("[S]", '<span class="quota-info-pr-txt-used">').replace("[/S]", "</span>");
  l[16306] = escapeHTML(l[16306]).replace("[A]", '<a href="/fm/rubbish" class="clickurl gotorub">').replace("[/A]", "</a>");
  l[16310] = escapeHTML(l[16310]).replace("[A]", '<a href="/fm/dashboard" class="clickurl dashboard-link">').replace("[/A]", "</a>");
  l[16317] = escapeHTML(l[16317]).replace("[S]", "<strong>").replace("[/S]", "</strong>");
  l[16494] = escapeHTML(l[16494]).replace("[S]2[/S]", "%1");
  l[25048] = escapeHTML(l[25048]).replace("[A]", '<a href="mailto:support@mega.nz">').replace("[/A]", "</a>");
  l[25050] = escapeHTML(l[25050]).replace("[A]", '<a href="mailto:support@mega.nz">').replace("[/A]", "</a>");
  l[25081] = escapeHTML(l[25081]).replace("[A]", '<a href="mailto:support@mega.nz">').replace("[/A]", "</a>");

  l[16649] = escapeHTML(l[16649]).replace("%1", '<span class="amount">10.00</span>');
  l[16501] = escapeHTML(l[16501])
    .replace("[A1]", '<a class="red" href="mailto:support@mega.nz">')
    .replace("[/A1]", "</a>")
    .replace(
      "[A2]",
  ...
  l[17793] = escapeHTML(l[17793])
    ...
    .replace("[/A2]", "</a>")
    .replace("[A3]", '<a class="freeupdiskspace">')
    .replace("[/A3]", "</a>");
  ...
  l[17097] = escapeHTML(l[17097])
    ...
    .replace("[/A]", "</a>");
  l[17690] = escapeHTML(l[17690]).replace("[A]", '<a href="https://mega.nz/recovery" target="_blank" class="red">').replace("[/A]", "</a>");
  l[17701] = escapeHTML(l[17701]).replace("[B]", "<b>").replace("[/B]", "</b>");
  l[17742] = escapeHTML(l[17742]).replace("[S]", "<strong>").replace("[/S]", "</strong>");
  l[17805] = escapeHTML(l[17805]).replace("[A]", '<a class="mobile red-email" href="mailto:support@mega.nz">').replace("[/A]", "</a>");
  l[18301] = escapeHTML(l[18301])
    .replace(/\[B]/g, '<b class="megasync-logo">')
    .replace(/\[\/B\]/g, "</b>")
    .replace(/\(M\)/g, "")
    .replace(/\[LOGO\]/g, "");
  l[18311] = escapeHTML(l[18311])
    .replace(/\[B1]/g, '<strong class="warning-text">')
    .replace(/\[\/B1\]/g, "</strong>");
  l[18312] = escapeHTML(l[18312])
    .replace(/\[B]/g, '<strong class="warning-text">')
    .replace(/\[\/B\]/g, "</strong>");

  l[18638] = escapeHTML(l[18638])
    .replace(/\[+[1-9B]+]/g, "<b>")
    .replace(/\[\/+[1-9B]+]/g, "</b>");
  ...
  l[19512] = escapeHTML(l[19512])
    .replace("%1", '<span class="plan-name"></span>')
    .replace("%2", '<span class="user-email"></span>')
    .replace("[B]", "<b>")
    .replace("[/B]", "</b>");
  ...
  l[19514] = escapeHTML(l[19514])
    ...
    .replace("[B]", "<b>")
    .replace("[/B]", "</b>");
  l[19661] = escapeHTML(l[19661])
    .replace("[A]", '<a href="' + l.mega_help_host + '/installs-apps/desktop-syncing" class="clickurl" rel="noreferrer" target="_blank">')
    .replace("[/A]", "</a>");
  ...
  l[19834] = escapeHTML(l[19834]).replace("[A]", '<a class="red" href="mailto:support@mega.nz">').replace("[/A]", "</a>");
  l[19835] = escapeHTML(l[19835]).replace("[A]", '<a class="red" href="mailto:support@mega.nz">').replace("[/A]", "</a>");
  l[19840] = escapeHTML(l[19840]).replace("[A]", '<a class="toResetLink">').replace("[/A]", "</a>");
  l[19843] = escapeHTML(l[19843]).replace("[A]", '<a class="red" href="mailto:support@mega.nz">').replace("[/A]", "</a>");
  l[23052] = escapeHTML(l[23052]).replace("[A]", '<a class="red" href="mailto:business@mega.nz">').replace("[/A]", "</a>");
  ...
  if (is_mobile) {
    l[20197] =
      escapeHTML(l[20197])
        .replace("[S1]", '<span class="used">')
        .replace("[/S1]", "</span>\n")
        .replace("[S2]", "")
        .replace("[/S2]", "\n")
        .replace("[S3]", '<span class="total">')
        .replace("[/S3]", "</span>\n")
        .replace("$1", "0")
        .replace("$2", "0") + "<br>";
    ...
    // Desktop only
    l[20197] = escapeHTML(l[20197])
      .replace("[S1]", '<span class="size-txt">')
      .replace("[/S1]", "</span>")
      .replace("[S2]", '<span class="of-txt">')
      .replace("[/S2]", "</span>\n")
      .replace("[S3]", '<span class="pecents-txt">')
  ...
  l[20609] = escapeHTML(l[20609])
    ...
    .replace("[/A]", "</a>");
  l[20650] = escapeHTML(l[20650])
    .replace(/\[S]/g, "<span>")
    .replace(/\[\/S]/g, "</span>")
    .replace("[A]", '<a href="/repay" class="clickurl">')
    .replace("[/A]", "</a>");
  l["20635.a"] = escapeHTML(l[20635]).replace("[A]", '<a class="clickurl" href="/register" data-eventid="99797">').replace("[/A]", "</a>");
  ...
  l[20959] = escapeHTML(l[20959])
    .replace("[A]", '<a class="red" href="https://mega.nz/SecurityWhitepaper.pdf" ' + 'target="_blank" rel="noopener noreferrer">')
    .replace("[/A]", "</a>");
  l["20975.b"] = escapeHTML(l[20975])
    .replace("[B]", '<b class="txt-dark">')
    .replace("[/B]", "</b>")
    .replace("[A]", '<a href="https://mega.io/security" class="clickurl green" target="_blank">')
    .replace("[/A]", "</a>");
  l[20975] = escapeHTML(l[20975])
    .replace("[B]", '<b class="txt-dark">')
    .replace("[/B]", "</b>")
    .replace("[A]", '<a href="https://mega.io/security" class="clickurl red txt-bold" target="_blank">')
    .replace("[/A]", "</a>");
  l[23748] = escapeHTML(l[23748])
    .replace("[B]", '<b class="txt-dark">')
    .replace("[/B]", "</b>")
    .replace("[A]", '<a href="https://mega.io/security" class="clickurl red txt-bold" target="_blank">')
    .replace("[/A]", "</a>");
  ...
  l[22696] = escapeHTML(l[22696])
    .replace("[A]", '<a class="clickurl" href="/pro">')
    .replace("[/A]", "</a>")
    .replace("[S]", '<span class="no-buisness">')
    .replace("[/S]", "</span>");
  l[22700] = escapeHTML(l[22700])
    .replace("[S]", '<i class="sprite-fm-mono icon-up"></i><span>')
    .replace("[/S]", "</span>")
    .replace("%1", "");
  ...
  l[22764] = escapeHTML(l[22764]).replace("[S]", '<span class="calc-price-week">').replace("[/S]", "</span>").replace("%1", "");
  ...
  l[22793] = escapeHTML(l[22793])
    .replace("[A1]", '<a class="clickurl" href="/business">')
    .replace("[/A1]", "</a>")
    .replace("[A2]", '<a class="clickurl" href="/pro">')
    .replace("[/A2]", "</a>");
  l[22795] = escapeHTML(l[22795]).replace("[A]", '<a class="to-aff-dash">').replace("[/A]", "</a>").replace(/\[BR]/g, "<br/>");
  l[22796] = escapeHTML(l[22796]).replace("[A]", '<a href="/contact" class="clickurl" target="_blank">').replace("[/A]", "</a>");
  l[22882] = escapeHTML(l[22882])
    .replace("[A]", '<a class="clickurl" href="/pro">')
    .replace("[/A]", "</a>")
    .replace("[S]", '<span class="no-buisness">')
    .replace("[/S]", "</span>")
    .replace("[B]", "<b>")
    .replace("[/B]", "</b>");
  l[22898] = escapeHTML(l[22898])
    .replace("[A]", '<a class="clickurl" href="https://mega.io/mobile" target="_blank">')
    .replace("[/A]", "</a>")
    .replace("[BR]", "<br>");
  ...
  l[23067] = escapeHTML(l[23067]).replace("[S]", '<span class="num">').replace("[/S]", "</span>").replace("%1", "<span></span>");
  l[23068] = escapeHTML(l[23068]).replace("[S]", '<span class="num">').replace("[/S]", "</span>").replace("%1", "<span></span>");
  l[23069] = escapeHTML(l[23069]).replace("[S]", '<span class="num">').replace("[/S]", "</span>").replace("%1", "<span></span>");
  ...
  l["referral_program_rules.m"] = escapeHTML(referral_program_rules)
    ...
    .replace(
      /\[L]/g,
      '<div class="mobile button-block no-bg"><div class="mobile fm-icon green-tick">' + '</div><div class="mobile label-info">'
    )
    .replace(/\[\/L]/g, "</div></div>")
    .replace(/\[BR]/g, "")
    .replace(/\[A]/g, '<a class="clickurl" href="https://mega.io/terms" target="_blank">')
    .replace(/\[\/A]/g, "</a>");
  l[23214] = escapeHTML(l[23214]).replace("[A]", '<a class="fm-affiliate guide-dialog to-rules">').replace("[/A]", "</a>");
  ...
  l[23332] = escapeHTML(l[23332])
    .replace("[A1]", '<a href="/cmd" target="_blank" class="clickurl">')
    .replace("[/A1]", "</a>")
    .replace(
      "[A2]",
      '<a class="link-qnap" href="https://www.qnap.com/en/app_center/' +
        '?qts=4.3&kw=megacmd&type_choose=&cat_choose=" target="_blank" rel="noopener noreferrer">'
    )
    .replace("[/A2]", "</a>")
    .replace(
      "[A3]",
      '<a class="link-synology" href="https://www.synology.com/en-nz/dsm/packages/MEGAcmd' + '" target="_blank" rel="noopener noreferrer">'
    )
    .replace("[/A3]", "</a>");
  l[23354] = escapeHTML(l[23354]).replace("[A]", '<a href="/pro" class="clickurl">').replace("[/A]", "</a>");
  l[23370] = escapeHTML(l[23370]).replace("[A]", '<a class="mailto" href="mailto:support@mega.nz">').replace("[/A]", "</a>");
  l[23371] = escapeHTML(l[23371]).replace("[A]", '<a class="mailto" href="mailto:support@mega.nz">').replace("[/A]", "</a>");
  l[23372] = escapeHTML(l[23372]).replace("[A]", '<a class="mailto" href="mailto:support@mega.nz">').replace("[/A]", "</a>");
  l[23373] = escapeHTML(l[23373]).replace("[A]", '<a class="mailto" href="mailto:support@mega.nz">').replace("[/A]", "</a>");
  l[23376] = escapeHTML(l[23376]).replace("[A]", '<a href="/security" class="clickurl" target="_blank">').replace("[/A]", "</a>");
  l[24074] = escapeHTML(l[24074]).replace("[A]", "<a>").replace("[/A]", "</a>");
  l[24141] = escapeHTML(l[24141])
    .replace("[A]", `<a class="red" href="https://blog.mega.io/mega-adds-two-factor-authentication" target="_blank">`)
    .replace("[/A]", "</a>");
  l[24431] = escapeHTML(l[24431])
    .replace("[A]", '<a href="/repay" class="clickurl">')
    .replace("[/A]", "</a>")
    .replace("[S]", "<span>")
    .replace("[/S]", "</span>");
  ...
  l[24547] = escapeHTML(l[24547])
    .replace("[A1]", '<a target="_blank" href="/sourcecode" class="clickurl">')
    .replace("[/A1]", "</a>")
  ...
  l.achievem_dialogfootertext = escapeHTML(l.achievem_dialogfootertext)
    ...
    .replace("[/A]", "</a>");
  l.achievem_pagedesc = escapeHTML(l.achievem_pagedesc).replace("[S]", "<span>").replace("[/S]", "</span>");
  l.achievem_storagetitle = escapeHTML(l.achievem_storagetitle).replace("[S]", "<span>").replace("[/S]", "</span>");
  l.bsn_calc_min_storage = escapeHTML(l.bsn_calc_min_storage).replace("[BR]", "<br>");
  l.bsn_calc_min_transfer = escapeHTML(l.bsn_calc_min_transfer).replace("[BR]", "<br>");
  l.bsn_calc_total = escapeHTML(l.bsn_calc_total).replace("[S]", "<span>").replace("[/S]", "</span>").replace("%1", "");
  l.bsn_page_plan_price = escapeHTML(l.bsn_page_plan_price).replace("[S]", "<span>").replace("[/S]", "</span>").replace("%1", "");
  ...
  l.bsn_plan_more_users = escapeHTML(l.bsn_plan_more_users).replace("[B]", "<strong>").replace("[/B]", "</strong>").replace("%1", "");
  l.bsn_plan_more_storage = escapeHTML(l.bsn_plan_more_storage).replace("[B]", "<strong>").replace("[/B]", "</strong>").replace("%1", "");
  l.bsn_plan_more_transfer = escapeHTML(l.bsn_plan_more_transfer).replace("[B]", "<strong>").replace("[/B]", "</strong>").replace("%1", "");
  l.bsn_versioning_info = escapeHTML(l.bsn_versioning_info).replace("[S]", "<span>").replace("[/S]", "</span>").replace("[BR]", "<br>");
  l.bsn_backup_info = escapeHTML(l.bsn_backup_info).replace("[S]", "<span>").replace("[/S]", "</span>").replace("[BR]", "<br>");
  l.bsn_meetings_info = escapeHTML(l.bsn_meetings_info).replace("[S]", "<span>").replace("[/S]", "</span>").replace("[BR]", "<br>");
  l.onboard_v4_control_finished = escapeHTML(l.onboard_v4_control_finished)
    .replace("[S]", "<span>")
    .replace("[/S]", "</span>")
    .replace("[A]", '<a class="clickurl" href="' + l.mega_help_host + '" target="_blank">')
    .replace("[/A]", "</a>");
  l.recovery_web_step_2 = escapeHTML(l.recovery_web_step_2).replace("[B]", "<strong>").replace("[/B]", "</strong>");
  l.recovery_ios_step_2 = escapeHTML(l.recovery_ios_step_2).replace("[B]", "<strong>").replace("[/B]", "</strong>");
  l.warning_has_subs_with_3p = escapeHTML(l.warning_has_subs_with_3p)
    ...
    .replace("[/A3]", "</a>");
  l.redeem_etoomany = escapeHTML(l.redeem_etoomany).replace("[A]", `<a class="clickurl" href="/support">`).replace("[/A]", "</a>");
  ...
  l.extensions_avbl_mobile = escapeHTML(l.extensions_avbl_mobile)
    .replace(/\[S]/g, "<strong>")
    .replace(/\[\/S]/g, "</strong>");
  l.copy_to_my_backups = escapeHTML(l.copy_to_my_backups).replace("[A]", "<a>").replace("[/A]", "</a>");
  l.backup_read_only_wrng = escapeHTML(l.backup_read_only_wrng).replace("[S]", "<span>").replace("[/S]", "</span>");
  l.cookie_banner_txt = escapeHTML(l.cookie_banner_txt)
    .replace("[A]", '<a href="https://mega.io/cookie" class="clickurl" target="_blank">')
    .replace("[/A]", "</a>");
  l.payment_card_almost_exp = escapeHTML(l.payment_card_almost_exp).replace("[A]", "<a>").replace("[/A]", "</a>");
  l.payment_card_exp = escapeHTML(l.payment_card_exp).replace("[A]", "<a>").replace("[/A]", "</a>");
  l.backup_pcs_info = escapeHTML(l.backup_pcs_info).replace("[A]", "<a>").replace("[/A]", "</a>");
  l.backup_mobiles_info = escapeHTML(l.backup_mobiles_info).replace("[A]", "<a>").replace("[/A]", "</a>");
  ...
  l.ri_s4_header = escapeHTML(l.ri_s4_header)
    ...
    .replace("[A2]", "<h2>")
    .replace("[/A2]", "</h2>");
  l.ri_s4_subheader = escapeHTML(l.ri_s4_subheader).replace("%1", "&#8364 1,000").replace("[B]", "<strong>").replace("[/B]", "</strong>");
  l.ri_s4_card1_desc = escapeHTML(l.ri_s4_card1_desc).replace("[B]", "<strong>").replace("[/B]", "</strong>");
  l.ri_s4_card3_desc = escapeHTML(l.ri_s4_card3_desc).replace("[B]", "<strong>").replace("[/B]", "</strong>");
  l.ri_s4_card4_desc = escapeHTML(l.ri_s4_card4_desc).replace("%1", "&#8364 2.99").replace("[B]", "<strong>").replace("[/B]", "</strong>");
  l.ri_s4_card5_desc = escapeHTML(l.ri_s4_card5_desc).replace("[B]", "<strong>").replace("[/B]", "</strong>");
  l.ri_s4_betat_header = escapeHTML(l.ri_s4_betat_header).replace("%1", "&#8364 1,000");
  l.ri_s4_regf_q6_ans1 = escapeHTML(l.ri_s4_regf_q6_ans1).replace("[B]", "<strong>").replace("[/B]", "</strong>");
  l.ri_s4_regf_q6_ans2 = escapeHTML(l.ri_s4_regf_q6_ans2).replace("[B]", "<strong>").replace("[/B]", "</strong>");
  l.ri_s4_regf_success = escapeHTML(l.ri_s4_regf_success).replace("[BR]", "<br>");
  ...
  l.about_contributors = escapeHTML(l.about_contributors)
    ...
    .replace(/\[\/S]/g, "</span>");
  // cant reduce size
  l.jobs_opportunity_invert_card_desc = escapeHTML(l.jobs_opportunity_invert_card_desc).replace(/\[BR]/g, "<br>");
  l.jobs_grow_invert_card_desc = escapeHTML(l.jobs_grow_invert_card_desc).replace("[BR]", "<br>");
  l.about_job_expressions_txt = escapeHTML(l.about_job_expressions_txt).replace("[BR]", "<br>");
  ...
  l.backup_setup_2fa_recovery_key = escapeHTML(l.backup_setup_2fa_recovery_key)
    ...
    .replace("[/D2]", "</div>");
  l.no_email_try_again = escapeHTML(l.no_email_try_again).replace("[A]", '<a class="try-again">').replace("[/A]", "</a>");
  ...
  l.s4_url_obj_level_subtxt = escapeHTML(l.s4_url_obj_level_subtxt)
    .replace(
      "[A]",
      `<a class="clickurl" target="_blank" href="${l.mega_help_host}` + `/megas4/s4-buckets/change-bucket-object-url-access">`
    )
    .replace("[/A]", "</a>");
  ...
  l.s4_invalid_bucket_name = escapeHTML(l.s4_invalid_bucket_name)
    .replace("[A]", `<a class="clickurl" target="_blank" href="${l.mega_help_host}` + `/megas4/s4-buckets/bucket-naming-conventions">`)
    .replace("[/A]", "</a>");
  ...
  l.file_request_upload_caption_2 = escapeHTML(l.file_request_upload_caption_2)
    ...
    .replace("[/A]", "</a>");
  l.redemption_support_email = escapeHTML(l.redemption_support_email).replace("[S]", "<span>").replace("[/S]", "</span>");
  l.estimated_price_text_min_50 = escapeHTML(l.estimated_price_text_min_50).replace("[S]", "<span>").replace("[/S]", "</span>");

  l.dl_limited_tq_non_user = escapeHTML(l.dl_limited_tq_non_user)
    .replace("[A]", `<a target="_blank" href="https://help.mega.io/plans-storage/space-storage/transfer-quota">`)
    .replace("[/A]", "</a>")
    .replace("[S1]", "<span>")
  ...
  l.two_fa_download_app = escapeHTML(l.two_fa_download_app).replace("[A]", '<a href="">').replace("[/A]", "</a>");
  ...
  date_months = [l[408], l[409], l[410], l[411], l[412], l[413], l[414], l[415], l[416], l[417], l[418], l[419]].map(escapeHTML);
...
lazy(mega, "intl", function _() {
  ...
  if (!Intl.NumberFormat) {
    // weak silly polyfill
    Intl.NumberFormat = function mIntlNumberFormat() {
      /* dummy */
    };
    Intl.NumberFormat.prototype = {
      ...
      formatToParts: function (n) {
        ...
        return [
          { type: "integer", value: i | 0 },
          { type: "decimal", value: "." },
          { type: "fraction", value: f | 0 }
        ];
      }
    };
