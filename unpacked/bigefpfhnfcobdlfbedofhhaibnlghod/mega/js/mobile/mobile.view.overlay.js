class MegaMobileViewOverlay extends MegaMobileComponent {
  ...
  async show(nodeHandle) {
    ...
    if (isPreviewable) {
      ...
      this.domNode.querySelector(".media-viewer-container .filetype-img i").className = this.nodeComponent.icon;
  ...
  setNode(nodeHandle) {
    this.nodeComponent =
      MegaMobileNode.getNodeComponentByHandle(nodeHandle) ||
