...
mobile.twofactor.verifyLogin = {
  ...
  initVerifyButton: function () {
    ...
    $verifyButton.off("tap").on("tap", function () {
      ...
      security.login.checkLoginMethod(email, password, pinCode, rememberMe, mobile.signin.old.startLogin, mobile.signin.new.startLogin);
  ...
  initLostAuthenticatorButton: function () {
    ...
    // On click/tap
    mobile.twofactor.verifyLogin.$page
      .find(".lost-authenticator-button")
      .off("tap")
      .on("tap", function () {
