...
mBroadcaster.once("startMega", () => {
  ...
  mega.ui.toast = {
     ...
     * @returns {undefined}
     */
    show: function (message, timeout, actionButtonText, { actionButtonCallback, clickCallback, timeoutCallback } = {}) {
  ...
  /*
    ...
    implementations.
    */
  mobile.showToast = mobile.showSuccessToast = mobile.showErrorToast = mega.ui.toast.legacy.show.bind(mega.ui.toast);
});
