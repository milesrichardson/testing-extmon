class MegaMobileTappable extends MegaMobileComponent {
  constructor(options) {
    ...
    this.domNode.classList.add("nav-elem", tappableTypes[options.type] || "normal");
  ...
  set loading(stateBool) {
    ...
    if (stateBool) {
      ...
      loading_elem.className = "notification-loading-spinner sprite-mobile-fm-mono icon-loader-thin-outline " + "loading";
