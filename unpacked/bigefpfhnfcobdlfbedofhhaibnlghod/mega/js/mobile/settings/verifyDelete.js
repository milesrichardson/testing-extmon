mobile.settings.account.verifyDelete = Object.create(mobile.settingsHelper, {
  ...
  init: {
    value: function () {
      ...
      const contentDiv = mCreateElement(
        "div",
        {
      ...
      const buttonsDiv = mCreateElement(
        "div",
        {
  ...
  renderSurvey: {
    value: function (parentNode) {
      ...
      const promptForm = mCreateElement(
        "div",
        {
          class: "mobile-settings-prompt"
        },
    ...
    value: function () {
      ...
      security.resetUser(this.code, u_attr.email, Math.random().toString(), function (code) {
        ...
        // If the code has expired
          ...
          msgDialog("warninga", l.account_delete_invalid_confirmation_link, l.account_delete_link_expired, false, () => {
            loadSubPage("fm/account");
          });
        }
      });
