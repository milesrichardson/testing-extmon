  ...
  init: {
    value: function (msg) {
      ...
      return new Promise((resolve) => {
        ...
        mCreateElement("h1", { class: "form-title" }, this.domNode).textContent = MegaMobileHeader.headings["fm/two-factor-confirmation"];

        this.msgNode = mCreateElement("div", { class: "form-info" }, this.domNode);

        const setNode = mCreateElement(
          "fieldset",
          {
  ...
  initPinInputs: {
    value: function () {
      ...
      for (let i = 0; i < this.pinInputs.length; i++) {
        ...
        this.pinInputs[i].$input
          .rebind("input.fieldsetAction", (e) => {
