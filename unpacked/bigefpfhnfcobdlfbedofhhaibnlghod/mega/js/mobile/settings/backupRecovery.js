...
mobile.settings.backupRecovery = Object.create(mobile.settingsHelper, {
  ...
  init: {
    value: function () {
      ...
      const recoveryKeyContainer = mCreateElement(
        "div",
        { class: "recovery-key container" },
        [
          mCreateElement("span", { class: "recovery-key blurb" }, [document.createTextNode(l.recovery_key_input_heading)]),
