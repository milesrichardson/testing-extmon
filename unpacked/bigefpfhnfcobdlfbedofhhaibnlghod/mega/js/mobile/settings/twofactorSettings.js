mobile.settings.account.twofactorSettings = Object.create(mobile.settingsHelper, {
  ...
  initSetup: {
    value: function () {
      ...
      mCreateElement("div", { class: "two-fa-details" }, this.setupNode).append(parseHTML(l.two_fa_download_app));
      ...
      this.copyTabNode = mCreateElement(
        "div",
        {
      ...
      this.scanTabNode = mCreateElement(
        "div",
        {
      ...
      mCreateElement(
        ...
        this.scanTabNode
      ).textContent = l.two_fa_scan_details;
  ...
  renderSetup: {
    value: function () {
      ...
      $(".two-fa-details a", this.setupNode)
        .rebind("tap.showApps", (e) => {
          e.preventDefault();
          this.showAppsDialog();
        })
  ...
  enableTwoFA: {
    value: async function () {
      ...
      const twoFactorPin = await mobile.settings.account.twofactorVerifyAction.init(l.two_fa_verify_enable);
  ...
  disableTwoFA: {
    value: async function () {
      ...
      // Get the Authenticator PIN code from the user
      const twoFactorPin = await mobile.settings.account.twofactorVerifyAction.init(l.two_fa_verify_disable);
  ...
  showAppsDialog: {
    value: function () {
      ...
      M.safeShowDialog("mobile-two-fa-apps", () => {
        ...
        mega.ui.sheet.addContents([l[19566], this.createAppButtons()]);
