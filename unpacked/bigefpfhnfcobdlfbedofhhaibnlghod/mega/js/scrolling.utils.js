...
function scrollToElement($scrollBlock, $scrollTo) {
  ...
  if ($scrollTo.length && $scrollBlock.length) {
    ...
    const scrollToHeight = $scrollTo.hasClass("expanded") ? $scrollTo.parent().outerHeight() : $scrollTo.outerHeight();
    ...
    if (scrollToOffset - scrollBlockOffset + scrollToHeight > scrollBlockHeight) {
      ...
      $scrollBlock.scrollTop(scrollToOffset - scrollBlockOffset + scrollValue - 8);
    }
  }
}
