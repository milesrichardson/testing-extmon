...
const CallFeedback = function (megaChat, options) {
  ...
  megaChat.rebind("onRoomInitialized.CallFeedback", (e, megaRoom) => {
    megaRoom.rebind(
      "onCallLeft.CallFeedback",
      (e, { callId, chatId, showCallFeedback }) => {
              ...
              new ChatDialogMessage({
                ...
                buttons: {
                  ...
                  sendFeedback: {
                    ...
                    callback: function () {
                      var feedbackDialog = mega.ui.FeedbackDialog.singleton(undefined, undefined, "call-ended");
