...
var tooltiplogin = {
  ...
  init: function (close) {
    ...
    $("#login-name, #login-password, .top-dialog-login-button", $dialog).rebind("keydown.loginpopup", function (e) {
      if (e.keyCode === 13) {
  ...
  startLogin: function () {
    ...
    if (email === "" || !isValidEmail(email)) {
      ...
      security.login.checkLoginMethod(email, password, twoFactorPin, rememberMe, tooltiplogin.old.startLogin, tooltiplogin.new.startLogin);
    }
