...
lazy(mega.ui, "mNodeFilter", () => {
  ...
  const hiddenSections = new Set(["shares", "out-shares", "public-links", "file-requests", "faves", "recents"]);
  ...
  const filters = {
    ...
    location: {
      ...
      match(n) {
        ...
        if (
          (this.selection.includes("cloud") && root === M.RootID) ||
