class MMenuSelectItem extends MComponent {
   ...
   */
  constructor({ label, selectFn, selected, selectable, leftIcon, rightIcon, additionalClasses, children }) {
    super();
    ...
    this.attachEvent("pointerenter", () => {
      ...
      for (let i = 0; i < items.length; i++) {
        ...
        if (otherItem !== this.el && otherItem.mComponent && otherItem.mComponent.subMenu) {
