...
class ReportAbuse {
  ...
  initAbuseTypesSection() {
    ...
    mega.controls.radio.init(".abusetype", $(".abusetype", this.$abuseTypesScreen).parent(), null, (val) => {
  ...
  initA() {
    ...
    mega.controls.checkbox.init(".js-abuse-a-check", this.$currentScreen, false, (val) => {
      if (val) {
        this.$btnSubmit.removeClass("disabled");
      } else {
        this.$btnSubmit.addClass("disabled");
  ...
  initB() {
    ...
    mega.controls.radio.init(".abuseBType", $(".abuseBType", this.$currentScreen).parent(), null, (val) => {
      this.selectedDataMap = reportAbuseMap[val];
    });
  }
  ...
  initC_D_E_G() {
    ...
    mega.controls.radio.init(".abuseSubType", $(".abuseSubType", this.$currentScreen).parent(), null, (val) => {
      this.$btnSubmit.removeClass("disabled");
  ...
  initF() {
    ...
    mega.controls.radio.init(".abuseFType", $(".abuseFType", this.$currentScreen).parent(), null, (val) => {
      this.selectedDataMap = reportAbuseMap[val];
    });
  }
  ...
  initCR_R_S() {
    ...
    mega.controls.radio.init(".contentowner", $(".contentowner", this.$currentScreen).parent(), null, (val) => {
  ...
  initIP() {
    ...
    mega.controls.checkbox.init(".js-abuse-ip-aware", $(".js-abuse-ip-aware", this.$currentScreen).parent(), false, (val) => {
      abuseAware = val;
    ...
    mega.controls.checkbox.init(".js-abuse-ip-believe", $(".js-abuse-ip-believe", this.$currentScreen).parent(), false, (val) => {
      abuseBelieve = val;
      if (abuseBelieve && abuseAware) {
        this.$btnSubmit.removeClass("disabled");
      } else {
