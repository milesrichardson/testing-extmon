...
mega.ui.MegaInputs.prototype.textArea._showHideErrorAndMsg = mega.ui.MegaInputs.prototype.underlinedText._updateShowHideErrorAndMessage;
...
mega.ui.MegaInputs.prototype.textArea._lengthChecker = function () {
  ...
  if ($input.hasClass("lengthChecker") && maxLength) {
    // Length section
    $wrapper.safeAppend(
      '<div class="length-check hidden">' + '<span class="chars-used"></span>' + `<span class="char-limit">/${maxLength}</span>` + "</div>"
    );
...
mega.ui.MegaInputs.prototype.textArea._extendedFunctions = mega.ui.MegaInputs.prototype.underlinedText._extendedFunctions;
