lazy(mega.slideshow.settings, "switch", () => {
  ...
  return class SlideshowSwitchSetting {
     ...
     */
    getValue() {
      return !is_mobile && this._isImplemented && fmconfig.viewercfg && fmconfig.viewercfg[this.name] !== undefined
    ...
    render($container, onUpdate) {
      ...
      if ((value && !$switch.hasClass("toggle-on")) || (!value && $switch.hasClass("toggle-on"))) {
        toggle();
      } else {
        $switch.trigger("update.accessibility");
      }
