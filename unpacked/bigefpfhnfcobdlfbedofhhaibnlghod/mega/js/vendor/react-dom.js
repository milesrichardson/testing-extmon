...

    {
      if ("contextType" in ctor) {
        var isValid =
          ...
          contextType === null ||
          (contextType !== undefined && contextType.$$typeof === REACT_CONTEXT_TYPE && contextType._context === undefined); // Not a <Context.Consumer>
      ...
      case DehydratedSuspenseComponent: {
        if (enableSuspenseServerRenderer) {
          if (current === null) {
            ...
            !_wasHydrated2
              ? invariant(false, "A dehydrated suspense component was completed without a hydrated node. This is probably a bug in React.")
              : void 0;
      ...
      do {
        if (_workInProgress.tag === SuspenseComponent && shouldCaptureSuspense(_workInProgress)) {
          ...
          if (retryCache === null) {
            ...
            !_current
              ? invariant(false, "A dehydrated suspense boundary must commit before trying to render. This is probably a bug in React.")
              : void 0;
      ...
      while (root !== null) {
        ...
        if (remainingExpirationTime === NoWork) {
          ...
          !(previousScheduledRoot !== null && lastScheduledRoot !== null)
            ? invariant(false, "Should have a previous and last root. This error is likely caused by a bug in React. Please file an issue.")
            : void 0;
