                ...
                helpers.extend(point, {
                  ...
                  _model: {
                    ...
                    rotation: custom.rotation
                      ? custom.rotation
                      : helpers.valueAtIndexOrDefault(dataset.pointRotation, index, pointElementOptions.rotation),
              ...
              if (isHorizontal) {
                ...
                if ((longestRotatedLabel + optionTicks.autoSkipPadding) * tickCount > me.width - (me.paddingLeft + me.paddingRight)) {
                  skipRatio =
                    1 +
                    Math.floor(
                      ((longestRotatedLabel + optionTicks.autoSkipPadding) * tickCount) / (me.width - (me.paddingLeft + me.paddingRight))
                    );
                }
        ...
        function (require, module, exports) {
          ...
          module.exports = Element.extend({
            ...
            getArea: function () {
              var vm = this._view;
              return (
                Math.PI * ((vm.endAngle - vm.startAngle) / (2 * Math.PI)) * (Math.pow(vm.outerRadius, 2) - Math.pow(vm.innerRadius, 2))
              );
            },
