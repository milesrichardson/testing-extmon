    ...
    parseMatches(text) {
      ...
      function captureMatchIfValidAndReset() {
        if (currentEmailMatch.hasDomainDot) {
          ...
          const emailAddress = currentEmailMatch.hasMailtoPrefix ? matchedText.slice("mailto:".length) : matchedText;
  ...
  class UrlMatcher extends Matcher {
    ...
    parseMatches(text) {
      ...
      while ((match = matcherRegex.exec(text)) !== null) {
        ...
        let urlMatchType = schemeUrlMatch ? "scheme" : wwwUrlMatch ? "www" : "tld",
