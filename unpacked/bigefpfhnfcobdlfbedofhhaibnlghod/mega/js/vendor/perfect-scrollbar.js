...
(function e(t, n, r) {
...
})(
  {
    ...
    6: [
      ...
      { "./plugin/destroy": 8, "./plugin/disable": 21, "./plugin/enable": 22, "./plugin/initialize": 16, "./plugin/update": 20 }
    ],
    7: [
      function (require, module, exports) {
        "use strict";
      ...
      function (require, module, exports) {
        ...
        function bindMouseScrollXHandler(element, i) {
          ...
          function updateScrollLeft(deltaX) {
            ...
            var scrollLeft =
              _.toInt((i.scrollbarXLeft * (i.contentWidth - i.containerWidth)) / (i.containerWidth - i.railXRatio * i.scrollbarXWidth)) -
    ...
    17: [
      function (require, module, exports) {
        ...
        function Instance(element, userSettings) {
          ...
          i.railBorderXWidth =
            _.toInt(dom.css(i.scrollbarXRail, "borderLeftWidth")) + _.toInt(dom.css(i.scrollbarXRail, "borderRightWidth"));
          ...
          i.railBorderYWidth =
            _.toInt(dom.css(i.scrollbarYRail, "borderTopWidth")) + _.toInt(dom.css(i.scrollbarYRail, "borderBottomWidth"));
