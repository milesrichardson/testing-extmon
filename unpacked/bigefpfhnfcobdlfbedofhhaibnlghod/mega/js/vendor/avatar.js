(function (window) {
  ...
  window.ImageExplorer = (function () {
    ...
    ImageExplorer.prototype.resetScaleSlider = function () {
      this.$scaleSlider.slider("value", 0).removeClass("disabled").removeAttr("disabled");
    };
    ...
    ImageUploadAndCrop.prototype._onFileProcessed2 = function (imageSrc) {
      if (imageSrc) {
        if (!isNaN(this.options.maxImageDimension)) {
          ...
          validatePromise
            .done(
              _.bind(function (imageWidth, imageHeight) {
              ...
              _.bind(function (imageWidth, imageHeight) {
                this._onFileError(
                  "The selected image size is " +
                    ...
                    "px * " +
                    imageHeight +
                    "px. The maximum allowed image size is " +
                    this.options.maxImageDimension +
                    "px * " +
                    this.options.maxImageDimension +
                    "px"
                );
