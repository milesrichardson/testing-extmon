mega.metatags = new (function () {
  ...
  var isPageExcluded = function (page) {
    ...
    var excludedPages = [
      ...
      "recoverybypark",
      "recoveryenterkey",
      "recoverykeychangepass",
      "recoveryparkchangepass",
      "redeem",
      "repay",
      "reset",
      "sms",
  ...
  this.getPageMetaTags = function (page) {
    ...
    if (page === "refer") {
      ...
      mTags.en_desc =
        "Download the MEGA app to securely upload, access and stream your files across your " +
      ...
      mTags.en_desc =
        "Access your MEGA account directly on your QNAP and Synology Network Attached Storage" + " (NAS) with our MEGA CMD tool.";
      ...
      mTags.en_desc =
        "Our MEGA Desktop App allows you to easily automate synchronisation between your " +
      ...
      mTags.en_desc = "Install the MEGA extension for your browser to reduce load times, improve performance" + " and strengthen security.";
      ...
      mTags.en_desc = "System administrators can automate MEGA account access by integrating scripts with " + "the MEGA CMD tool.";
      ...
      mTags.en_desc =
        "Compare MEGA's pricing plans. Get 16% off if you purchase an annual plan. " +
      ...
      mTags.en_desc =
        "Get started with MEGA, the world's largest fully-featured free cloud storage and " +
      ...
      mTags.en_desc =
        "Please read our Terms of Service that cover how you may access our services, website " + "domains, and client software.";
      ...
      mTags.en_desc =
        "If you believe that access to a file you have uploaded has been wrongly disabled, " + "please file a counter-notice.";
      ...
      mTags.en_desc =
        "We respect copyright and require that users of our services comply with applicable" +
      ...
      mTags.en_desc = 'MEGA Takedown Policy. Guidance on requesting user information or "takedown" of' + " user data.";
      ...
      mTags.en_desc = "We value your privacy. Learn about the necessary data MEGA collects through cookies " + "and similar technologies.";
      ...
      mTags.en_desc =
        "Conveniently purchase a MEGA Pro membership from one of our authorised resellers: " +
      ...
      mTags.en_desc = "Exchange messages, share your files and have audio and/or video calls with MEGA's " + "end-to-end encrypted chat.";
      ...
      mTags.en_desc =
        "Work remotely and never run out of storage. With MEGA, you'll have access to one of " +
      ...
      mTags.en_desc = "Get peace of mind when you back up data, such as important documents and files, " + "from your computer to MEGA.";
      ...
      mTags.en_desc = "Your files and chats are end-to-end encrypted with keys controlled by you and " + "nobody else.";
      ...
      mTags.en_desc =
        "MEGA's S4 beta program starts soon, for a limited number of participants. " +
      ...
      mTags.en_desc =
        "Check out the MEGA C++ client access engine with full documentation including " + "integration guides, data structures and more.";
      ...
      mTags.en_desc =
        "MEGA provides an API accessible with our software development kit (SDK), with a " + "full library of developer documentation.";
      mTags.mega_title = l[23998] || mTags.en_title;
      mTags.mega_desc = l[23999] || mTags.en_desc;
    } else if (page === "sdk") {
      mTags.en_title = "SDK - MEGA";
      mTags.en_desc = "MEGA SDK for C++, providing essential abstraction to your application's secure cloud storage access.";
      ...
      mTags.en_desc =
        "MEGA launched in 2013 as the world's first zero-knowledge, easy to use cloud " +
      ...
      mTags.en_desc =
        "Join the world's largest fully-featured cloud storage and privacy company. Check out" +
      ...
      mTags.en_desc =
        "MEGA is the world's leading fully-featured end-to-end encrypted cloud storage provider." +
      ...
      mTags.en_desc =
        "MEGA's CloudRAID technology means files are split into equal-sized parts and stored" +
      ...
      mTags.en_desc = "We publish the full source code for our client apps and welcome independent " + "verification and integrity checks.";
      ...
      mTags.en_desc =
        "MEGA would like to thank the authors of the following open source components that " +
      ...
      mTags.en_desc =
        "Massive storage, secure sharing across devices and 24/7 support make MEGA Business " + "the obvious choice for your team.";
      ...
      mTags.en_desc =
        "With our user-controlled end-to-end encryption, your data and communications have never " +
      ...
      mTags.en_desc = "Are you a journalist or technology reviewer? Download our MEGA media resources or " + "contact us for enquiries.";
      ...
      mTags.en_desc =
        "MEGA is the largest secure, fully-featured cloud storage provider in the world. " +
      ...
      mTags.en_desc =
        "MEGA understands the importance of keeping data and conversations private. We provide " +
    ...
    insertOgTwitterMetas(mTags.mega_title, mTags.mega_desc, getBaseUrl() + (page && page !== "start" ? "/" + page : ""), mTags.image);
