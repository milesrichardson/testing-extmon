...
function init_page() {
  ...
  mCreateElement(
    "div",
    { id: "FileRequest", class: "embed-button centre-button" },
    [mCreateElement("div", { class: "embed-content-wrapper" }, [mCreateElement("div", { class: "embed-mega-icon" }), textNode])],
    "body"
  );
  ...
  if (id) {
    ...
    elm.addEventListener("click", function () {
      window.open(
        getAppBaseUrl() + (is_extension ? "#" : "/") + "filerequest/" + id,
        "_blank",
