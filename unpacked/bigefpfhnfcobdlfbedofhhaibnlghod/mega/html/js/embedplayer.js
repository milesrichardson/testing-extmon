...
function init_embed(ph, key, g) {
  ...
  if (node) {
    ...
    var buffer = $.playbackOptions && $.playbackOptions.indexOf("1a") > -1 && (window.chrome || $.playbackOptions.indexOf("1m") > -1);

    iniVideoStreamLayout(node, $("body"), { preBuffer: buffer }).then(function (stream) {
