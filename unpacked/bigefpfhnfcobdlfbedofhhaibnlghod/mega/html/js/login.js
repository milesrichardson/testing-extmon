  ...
  return new Promise((resolve) => {
    var ctx = {
      checkloginresult(ctx, result) {
        ...
        security.login
          .checkToUpgradeAccountVersion(result, u_k, password)
          .catch(dump)
...
function pagelogin() {
  ...
  if (e === "" || !isValidEmail(e)) {
    ...
    security.login.checkLoginMethod(email, password, twoFactorPin, rememberMe, signin.old.startLogin, signin.new.startLogin);
  }
}
