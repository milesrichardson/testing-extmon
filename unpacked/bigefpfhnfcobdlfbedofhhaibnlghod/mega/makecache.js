  ...
  if ($(".loading-spinner").hasClass("hidden")) {
    ...
    setTimeout(function () {
      ...
      if (cachepages.length > cacheindex) {
        ...
        $("#startholder").append(
          '<div style="background-color:white; position:absolute; left:200px; top:200px; width:800px; height:300px; z-index:9999;"><a href="' +
            url +
            '" download="rootcache.json" style="font-size:30px;">DOWNLOAD JSON</a></div>'
        );
      }
    }, 200);
