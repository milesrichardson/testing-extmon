(() => {
  ...
  var e = {
      4654: function (e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }), (t.PostMessenger = void 0);
        const v = y(n(2081)),
          w = n(1614),
          m = n(3982),
          b = n(6068),
        ...
        (t.PostMessenger = class {
          constructor({ clientName: e = "unknown", enableLogging: t = !1, useEncryption: n = !0, maxResponseTime: u = 1e4, types: f }) {
            if (
              (r.add(this),
          ...
          connect({ targetWindow: e, targetOrigin: t, maxRetries: n = 10 }) {
            return d(this, void 0, void 0, function* () {
              ...
              c &&
                ...
                (g(this, o, "f").requestKey = yield crypto.subtle.generateKey({ length: 256, name: E }, !0, ["encrypt", "decrypt"])),
                (s = yield crypto.subtle.exportKey("jwk", g(this, o, "f").requestKey)),
                (g(this, o, "f").iv = i),
          ...
          acceptConnections({ allowAnyOrigin: e = !1, fromClientName: t = null, origin: n }) {
                    ...
                    postMessengerConnect: (n, r) =>
                      d(this, void 0, void 0, function* () {
                        ...
                        if (
                          ...
                          (this.connection = { clientName: n.clientName, types: n.types, useEncryption: !1 }),
                          this.useEncryption())
                        ) {
                          ...
                          (this.connection.useEncryption = !0),
                            ...
                            (g(this, o, "f").algorithm = { iv: g(this, o, "f").iv, name: E }),
                            (g(this, o, "f").requestKey = yield crypto.subtle.importKey("jwk", n.jsonRequestKey, { name: E }, !1, [
                              "encrypt",
                              "decrypt"
                            ]));
                        }
                        return (
                          ...
                          e(this.connection),
                          { clientName: this.clientName, types: n.types, useEncryption: this.useEncryption() }
                        );
                      })
                  },
                  i
          ...
          encrypt(e) {
            return d(this, void 0, void 0, function* () {
              ...
              const t = new TextEncoder().encode(JSON.stringify(e)),
                n = yield crypto.subtle.encrypt(g(this, o, "f").algorithm, g(this, o, "f").requestKey, t),
                r = (0, b.ab2str)(n);
          ...
          (f = function (e, t, n = {}, i) {
            return d(this, void 0, void 0, function* () {
              ...
              this.useEncryption(e, !0) && ((o = yield this.encrypt(n)), s && (s = yield this.encrypt(s))),
                g(this, r, "m", u).call(this, { data: o, errorMessage: s, isError: Boolean(s), messageId: t, type: e });
            });
          }),
          (l = function (e, t = {}, n = {}) {
            return d(this, void 0, void 0, function* () {
                  ...
                  s = this.addListener(o, (e, n) =>
                    d(this, void 0, void 0, function* () {
                      ...
                      try {
                        ...
                        (0, m.isError)(t)
                          ? g(this, r, "m", f).call(this, o, e.messageId, {}, t.message)
                          : g(this, r, "m", f).call(this, o, e.messageId, {}, this.prefix("responder threw a non Error object"));
                      }
                    })
                  );
                n.push(s);
      ...
      1614: (e, t, n) => {
        ...
        const g = function (e, t, n) {
          ...
          var u = void 0 !== e.msecs ? e.msecs : Date.now(),
            ...
            y = u - d + (g - p) / 1e4;
          if ((y < 0 && void 0 === e.clockseq && (a = (a + 1) & 16383), (y < 0 || u > d) && void 0 === e.nsecs && (g = 0), g >= 1e4))
            ...
            (function (e, t) {
              ...
              for (var n = 1732584193, r = -271733879, i = -1732584194, o = 271733878, s = 0; s < e.length; s += 16) {
                ...
                (n = E(n, r, i, o, e[s], 7, -680876936)),
                  ...
                  (n = A(n, (r = E(r, i, o, n, e[s + 15], 22, 1236535329)), i, o, e[s + 1], 5, -165796510)),
        ...
        const S = function (e) {
          ...
          for (var o = e.length / 4 + 2, s = Math.ceil(o / 16), a = new Array(s), c = 0; c < s; ++c) {
            for (var u = new Uint32Array(16), f = 0; f < 16; ++f)
              u[f] = (e[64 * c + 4 * f] << 24) | (e[64 * c + 4 * f + 1] << 16) | (e[64 * c + 4 * f + 2] << 8) | e[64 * c + 4 * f + 3];
            a[c] = u;
          }
    ...
    (() => {
      ...
      !(function (e) {
        (e.SPBInit = "checkout:SPBInit"),
          (e.memberUpgradeFacilitatorAccessToken = "SPB:memberUpgradeFacilitatorAccessToken"),
      ...
      !(function () {
        i(this, void 0, void 0, function* () {
          ...
          if (!o.dataset.iframeurl)
            return void console.error("honeySPBResponders data-iframeurl was not set on script element by honeySPBContent");
          const a = new t.PostMessenger({ clientName: r(s), enableLogging: true, types: e, useEncryption: !1 });
          let c = "memberUpgradeFacilitatorAccessToken";
          s === window.paypal.FUNDING.PAYLATER
            ? (c = "payLaterUpgradeFacilitatorAccessToken")
            : s === window.paypal.FUNDING.CARD && (c = "guestUpgradeFacilitatorAccessToken"),
            a.bindResponders({
              [c]: function (e) {
          ...
          yield a.connect({ targetOrigin: u.origin, targetWindow: window.parent });
        });
      })();
    })();
})();
