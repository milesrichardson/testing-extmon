      ...
      const e = yield (function (e, n = {}, t = {}) {
          return (function (e, n, t) {
            ...
            return new Promise((s, c) => {
              const r = { content: JSON.stringify(n), dest: t, service: "messages:cs", type: e };
              o
                ? (window.chrome.runtime.sendMessage(r), s())
                : window.chrome.runtime.sendMessage(r, null, (n) => {
          ...
          })("checkout:action:background", { action: e, data: n }, Object.assign(Object.assign({}, t), { background: !0 }));
