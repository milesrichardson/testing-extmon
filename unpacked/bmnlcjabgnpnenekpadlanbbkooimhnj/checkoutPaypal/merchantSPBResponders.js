  ...
  var e = {
      4654: function (e, t, r) {
        ...
        (t.PostMessenger = class {
          constructor({ clientName: e = "unknown", enableLogging: t = !1, useEncryption: r = !0, maxResponseTime: u = 1e4, types: h }) {
            if (
              (n.add(this),
          ...
          connect({ targetWindow: e, targetOrigin: t, maxRetries: r = 10 }) {
            return l(this, void 0, void 0, function* () {
              ...
              c &&
                ...
                (y(this, i, "f").requestKey = yield crypto.subtle.generateKey({ length: 256, name: x }, !0, ["encrypt", "decrypt"])),
          ...
          acceptConnections({ allowAnyOrigin: e = !1, fromClientName: t = null, origin: r }) {
                    ...
                    postMessengerConnect: (r, n) =>
                      l(this, void 0, void 0, function* () {
                        ...
                        if (
                          ...
                          (this.connection = { clientName: r.clientName, types: r.types, useEncryption: !1 }),
                          this.useEncryption())
                        ) {
                          ...
                          (this.connection.useEncryption = !0),
                            ...
                            (y(this, i, "f").algorithm = { iv: y(this, i, "f").iv, name: x }),
                            (y(this, i, "f").requestKey = yield crypto.subtle.importKey("jwk", r.jsonRequestKey, { name: x }, !1, [
                              "encrypt",
                              "decrypt"
                            ]));
                        }
                        return (
                          ...
                          e(this.connection),
                          { clientName: this.clientName, types: r.types, useEncryption: this.useEncryption() }
                        );
                      })
                  },
                  o
          ...
          encrypt(e) {
            return l(this, void 0, void 0, function* () {
              ...
              const t = new TextEncoder().encode(JSON.stringify(e)),
                r = yield crypto.subtle.encrypt(y(this, i, "f").algorithm, y(this, i, "f").requestKey, t),
                n = (0, b.ab2str)(r);
          ...
          (h = function (e, t, r = {}, o) {
            return l(this, void 0, void 0, function* () {
              ...
              this.useEncryption(e, !0) && ((i = yield this.encrypt(r)), s && (s = yield this.encrypt(s))),
                y(this, n, "m", u).call(this, { data: i, errorMessage: s, isError: Boolean(s), messageId: t, type: e });
            });
          }),
          (f = function (e, t = {}, r = {}) {
            return l(this, void 0, void 0, function* () {
                  ...
                  s = this.addListener(i, (e, r) =>
                    l(this, void 0, void 0, function* () {
                      ...
                      try {
                        ...
                        (0, w.isError)(t)
                          ? y(this, n, "m", h).call(this, i, e.messageId, {}, t.message)
                          : y(this, n, "m", h).call(this, i, e.messageId, {}, this.prefix("responder threw a non Error object"));
                      }
                    })
                  );
                r.push(s);
