(function (_, AvastWRC, EventEmitter) {
  ...
  Burger.initGlobalData = function (_data, _sendAll) {
    ...
    if (burgerConfigs) {
      ...
      Burger.Collection.events.BATCH_MAX_MESSAGES =
        AvastWRC.storageCache.get("max_burger_messages") || burgerConfigs.BATCH_MAX_MESSAGES || 20;
      Burger.Collection.events.SEND_INTERVAL_TIME =
        AvastWRC.storageCache.get("send_burger_interval") || burgerConfigs.SEND_INTERVAL_TIME || 300000;
    ...
    console.log(
      "BURGER-> sendData CONFIGS: Burger.GLOBAL.ENV",
      Burger.GLOBAL.ENV,
      "Burger.Collection.events.BATCH_MAX_MESSAGES: ",
      Burger.Collection.events.BATCH_MAX_MESSAGES,
      "Burger.Collection.events.SEND_INTERVAL_TIME: ",
  ...
  Burger.Gpb.GPBD = {
    bytes: function (id, repeated) {
      return Burger.Gpb.GpbType(id, repeated, function () {
        return PROTO.bytes;
      });
    },
  ...
  Burger.Gpb.Request = PROTO.Message("Burger.Gpb.Request", {
    Envelope: PROTO.Message("Burger.Gpb.Request.Envelope", {
      record: Burger.Gpb.GPBD.cType(1, PROTO.repeated, function () {
        return Burger.Gpb.Request.Envelope.Record;
      }),

      Record: PROTO.Message("Burger.Gpb.Request.Envelope.Record", {
        proto_version: Burger.Gpb.GPBD.int32(8, PROTO.optional),
        event: Burger.Gpb.GPBD.cType(2, PROTO.repeated, function () {
          return Burger.Gpb.Request.Envelope.Event;
        }),
        identity: Burger.Gpb.GPBD.cType(1, PROTO.optional, function () {
          return Burger.Gpb.Request.Envelope.Identity;
        }),
        product: Burger.Gpb.GPBD.cType(4, PROTO.optional, function () {
          return Burger.Gpb.Request.Envelope.Product;
        }),
        connection: Burger.Gpb.GPBD.cType(10, PROTO.optional, function () {
          return Burger.Gpb.Request.Envelope.Connection;
        })
      }),
      ...
      Product: PROTO.Message("Burger.Gpb.Request.Envelope.Product", {
        ...
        platform: Burger.Gpb.GPBD.cType(3, PROTO.optional, function () {
          return Burger.Gpb.Request.Envelope.Product.Platform;
        }),
      ...
      Connection: PROTO.Message("Burger.Gpb.Request.Envelope.Connection", {
        origin: Burger.Gpb.GPBD.cType(1, PROTO.optional, function () {
          return Burger.Gpb.Request.Envelope.Connection.Origin;
        }),
      ...
      if (!Burger.GLOBAL.IDENTITY_GUID || Burger.GLOBAL.IDENTITY_GUID === "") {
        if (AvastWRC && AvastWRC.CONFIG) {
          if (AvastWRC.CONFIG.providerType && AvastWRC.CONFIG.providerType !== "") {
            ...
            console.log(
              "BURGER-> identityMessage.guid: ",
              Burger.GLOBAL.IDENTITY_GUID,
              " use test guid setBurgerGuid-> ",
              AvastWRC.CONFIG.providerType
            );
          }
          if (AvastWRC.CONFIG.GUID && AvastWRC.CONFIG.GUID !== "") {
            ...
            console.log(
              "BURGER-> identityMessage.guid: ",
              Burger.GLOBAL.IDENTITY_GUID,
              " use avast guid setBurgerGuid-> ",
              AvastWRC.CONFIG.GUID
            );
          }
        }
      }
  ...
  Burger.Collection = {
    ...
    sendEvents: function () {
      ...
      while (numberOfEvents > 0) {
        ...
        console.log(
          "BURGER-> about to send " + eventsToSend.length + " events ",
          JSON.parse(JSON.stringify(eventsToSend)),
          "and left: " + Burger.Collection.events.eventList.length,
          JSON.parse(JSON.stringify(Burger.Collection.events.eventList))
        );
        ...
        if (eventsToSend && eventsToSend.length !== 0) {
          ...
          if (eventMessage && eventMessage.length > 0) {
            ...
            console.log(
              "BURGER-> sending queryOptions: ",
              JSON.parse(JSON.stringify(queryOptions)),
              " events list: ",
              JSON.parse(JSON.stringify(Burger.Collection.events.eventList))
            );
    ...
    addEventsOnError: function (eventsToRestore) {
      ...
      if (eventsToRestore.length > 0) {
        for (var i = 0; i < eventsToRestore.length; i++) {
          if (
            (eventsToRestore[i].type !== "HEARTBEAT" && eventsToRestore[i].resended < Burger.Collection.events.EVENT_MAX_RESEND) ||
...
(function (_, AvastWRC) {
  ...
  _.extend(Burger.Gpb, {
    Blob: PROTO.Message("Burger.Gpb.Blob", {
      ...
      PickedOffer: PROTO.Message("Burger.Gpb.Blob.PickedOffer", {
        ...
        product: Burger.Gpb.GPBD.cType(1, PROTO.optional, function () {
          return Burger.Gpb.Blob.PickedOffer.Product;
        }),
        voucher: Burger.Gpb.GPBD.cType(2, PROTO.optional, function () {
          return Burger.Gpb.Blob.PickedOffer.Voucher;
        }),
        accommodation: Burger.Gpb.GPBD.cType(3, PROTO.optional, function () {
          return Burger.Gpb.Blob.PickedOffer.Accommodation;
        }),
        query: Burger.Gpb.GPBD.cType(4, PROTO.optional, function () {
          return Burger.Gpb.Blob.PickedOffer.Query;
        }),
        redirect: Burger.Gpb.GPBD.cType(5, PROTO.optional, function () {
          return Burger.Gpb.Blob.PickedOffer.Redirect;
        }),
        ...
        context_voucher: Burger.Gpb.GPBD.cType(9, PROTO.optional, function () {
          return Burger.Gpb.Blob.PickedOffer.Voucher;
        })
      }),
      /**************************************************************************/
      ...
      OfferRating: PROTO.Message("Burger.Gpb.Blob.OfferRating", {
        client: Burger.Gpb.GPBD.cType(1, PROTO.optional, function () {
          return Burger.Gpb.Blob.ClientInfo;
        }),
        url: Burger.Gpb.GPBD.string(2, PROTO.optional),
        rating: Burger.Gpb.GPBD.int32(3, PROTO.optional),
        voucher: Burger.Gpb.GPBD.cType(4, PROTO.optional, function () {
          return Burger.Gpb.Blob.PickedOffer.Voucher;
        }),
        context_voucher: Burger.Gpb.GPBD.cType(5, PROTO.optional, function () {
          return Burger.Gpb.Blob.PickedOffer.Voucher;
        })
      }),
      /**************************************************************************/
      ...
      ClientEvent: PROTO.Message("Burger.Gpb.Blob.ClientEvent", {
        AditionalInfo: PROTO.Message("Burger.Gpb.Blob.ClientEvent.AditionalInfo", {
          ...
          event_type: Burger.Gpb.GPBD.cType(1, PROTO.optional, function () {
            return Burger.Gpb.Blob.ClientEvent.AditionalInfo.EventType;
          }),
          ui_category: Burger.Gpb.GPBD.cType(2, PROTO.optional, function () {
            return Burger.Gpb.Blob.ClientEvent.AditionalInfo.UiCategory;
          }),
          ui_source: Burger.Gpb.GPBD.cType(3, PROTO.optional, function () {
            return Burger.Gpb.Blob.ClientEvent.AditionalInfo.UiSource;
          }),
        ...
        url: Burger.Gpb.GPBD.string(2, PROTO.optional),
        aditional_info: Burger.Gpb.GPBD.cType(3, PROTO.optional, function () {
          return Burger.Gpb.Blob.ClientEvent.AditionalInfo;
        })
      }),
      ...
      PickedOfferEvent: PROTO.Message("Burger.Gpb.Blob.PickedOfferEvent", {
        ...
        url: Burger.Gpb.GPBD.string(2, PROTO.optional),
        picked_offer: Burger.Gpb.GPBD.cType(3, PROTO.optional, function () {
          return Burger.Gpb.Blob.PickedOffer;
        }),
        ...
        clickType: Burger.Gpb.GPBD.cType(7, PROTO.optional, function () {
          return Burger.Gpb.Blob.PickedOfferEvent.ClickType;
        }),
        ui_source: Burger.Gpb.GPBD.cType(8, PROTO.optional, function () {
          return Burger.Gpb.Blob.PickedOfferEvent.UiSource;
        }),
      ...
      UserSettingsChanged: PROTO.Message("Burger.Gpb.Blob.UserSettingsChanged", {
        ...
        new_settings: Burger.Gpb.GPBD.cType(2, PROTO.optional, function () {
          return Burger.Gpb.Blob.ClientInfo.UserSettings;
        })
      }),
      ...
      UserReports: PROTO.Message("Burger.Gpb.Blob.UserReports", {
        ...
        ShopReport: PROTO.Message("Burger.Gpb.Blob.UserReports.ShopReport", {
          ...
          report_reason: Burger.Gpb.GPBD.cType(3, PROTO.repeated, function () {
            return Burger.Gpb.Blob.UserReports.ReportReason;
          }),
        ...
        url: Burger.Gpb.GPBD.string(2, PROTO.optional),
        shop_report: Burger.Gpb.GPBD.cType(3, PROTO.optional, function () {
          return Burger.Gpb.Blob.UserReports.ShopReport;
        }),
        general_report: Burger.Gpb.GPBD.cType(4, PROTO.optional, function () {
          return Burger.Gpb.Blob.UserReports.GeneralReport;
        })
      })
    })
  });
  _.extend(Burger.Build, {
    ...
    blobMessage: function (eventDetails) {
      ...
      console.log(
        "BURGER-> transactionID: ",
        eventDetails.clientInfo ? eventDetails.clientInfo.transaction_id : null,
        " event: ",
