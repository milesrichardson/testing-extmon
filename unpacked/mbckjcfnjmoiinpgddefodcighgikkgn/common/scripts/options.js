...
(function ($) {
  ...
  AvastWRC.opt = AvastWRC.opt || {
    ...
    createDOM: function (data) {
      ...
      document.title = this.settings.avastBranding
        ? this.settings.poppupSettings.strings.spSettingsPageTitleAvast
        : this.settings.poppupSettings.strings.spSettingsPageTitleAvg;
