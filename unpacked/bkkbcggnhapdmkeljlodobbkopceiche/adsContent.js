/*! For license information please see adsContent.js.LICENSE.txt */
!(function (n) {
  var r = {};
  ...
  (__webpack_require__.m = n),
    ...
    __webpack_require__((__webpack_require__.s = 268));
})({
  0: function (n, r, i) {
    "use strict";
    i.d(r, "g", function () {
  ...
  268: function (n, r, i) {
    ...
    var o = i(6),
      ...
      $ = i(12);
    const inject = (n, r) => {
        $.a.getTrialEntity().then((i) => {
          const s = {
            trial: i,
            feature: o.a.AdsBlocker,
            anchorElement: r,
            ...
            cssProperties: a.a.SITES,
            horizontalPosition: a.b.Center,
            additionalFeaturesToActivate: [o.a.YoutubeBlocker, o.a.SocialBlocker],
            isRefreshRequired: !0,
            analyticsExtras: { provider: n }
          };
          Object(E.a)(s);
        });
      },
      getAdsContainers = (n) => document.querySelectorAll(n.selector),
      injectHookByConfig = (n, r) => {
        const i = getAdsContainers(r);
        for (const o of Array.from(i))
          if (
            Object(s.A)(o) &&
            !(
              (r.rules.minWidth && o.clientWidth < r.rules.minWidth) ||
              (r.rules.minHeight && o.clientHeight < r.rules.minHeight) ||
              (r.rules.maxWidth && o.clientWidth > r.rules.maxWidth) ||
              (r.rules.maxHeight && o.clientHeight > r.rules.maxHeight)
            )
          )
            return inject(n, o), !0;
        return !1;
    ...
    (async () => {
      new w.a(y.e.ADS_BLOCKER_CONFIG, y.a.KEY_CONFIG_STORAGE).get().then((n) => {
        const r = n.providers.filter((n) => !!n.hooks);
        let i;
        (i = new MutationObserver(
          (() => {
            for (const n of r)
              for (const r of n.hooks) {
                const o = getAdsContainers(r);
                if (o && 0 !== o.length && injectHookByConfig(n.name, r)) return void (i && i.disconnect());
              }
          }).bind(i)
        )),
    ...
    (function (n) {
      ...
      function qe(n, r, i) {
        var o,
          ...
          Oe = r.displayName && r.componentId ? Te(r.displayName) + "-" + r.componentId : r.componentId || he,
        ...
        E &&
          ...
          (we = r.shouldForwardProp
            ...
            : n.shouldForwardProp);
        var Ue,
          je = new ot(i, Oe, E ? n.componentStyle : void 0),
    ...
    r.a = function stylis_min(n) {
      ...
      function B(n, o) {
        ...
        var E = (function M(n, o, a, s, E) {
                  ...
                  switch (((se = a.substring(at, rt)), 0 === y && (y = (st = st.replace(r, "").trim()).charCodeAt(0)), y)) {
                    case 64:
                      ...
                      if (
                        ...
                        0 < Ye &&
                          ((he = H(3, se, (it = X(je, st, ot)), o, ve, Oe, at, oe, E, s)),
                          (st = it.join("")),
                ...
                case 59:
                  if (1 < (at = (st = (0 < it ? st.replace(i, "") : st).trim()).length))
                    switch (
                      ...
                      0 < Ye &&
                        void 0 !== (he = H(1, st, o, n, ve, Oe, ct.length, s, E, s)) &&
            ...
            switch (oe) {
              ...
              case 10:
                47 === Se ? (Se = 0) : 0 === 1 + y && 107 !== s && 0 < st.length && ((it = 1), (st += "\0")),
                  0 < Ye * Xe && H(0, st, o, n, ve, Oe, ct.length, s, E, s),
                  (Oe = 1),
                  ve++;
                break;
              case 59:
          ...
          if (0 < (at = ct.length)) {
            if (((it = o), 0 < Ye && void 0 !== (he = H(2, ct, it, n, ve, Oe, at, s, E, s)) && 0 === (ct = he).length)) return dt + ct + ft;
        ...
        return 0 < Ye && void 0 !== (s = H(-2, E, a, a, ve, Oe, E.length, 0, 0, 0)) && (E = s), "", (we = 0), (Oe = ve = 1), E;
      }
      var r = /^\0+/g,
        i = /[\0\r\f]/g,
        o = /: */g,
  ...
  73: function (n, r, i) {
    ...
    var Se = {
      ...
      Oe = {};
    function F(n, r, i) {
      (this.props = n), (this.context = r), (this.refs = Oe), (this.updater = i || Se);
    }
    function G() {}
    function H(n, r, i) {
      (this.props = n), (this.context = r), (this.refs = Oe), (this.updater = i || Se);
  ...
  74: function (n, r, i) {
    ...
    function ua(n, r, i) {
      if (Oe[n]) throw Error(u(100, n));
      (Oe[n] = r), (ve[n] = r.eventTypes[i].dependencies);
    }
    var ge = [],
      Se = {},
      Oe = {},
    ...
    var Or = s.unstable_runWithPriority,
              ...
              for (var y in (od(s, E), (n = null), E))
                if (E.hasOwnProperty(y)) {
                  ...
                  "children" === y
                    ...
                    : Oe.hasOwnProperty(y) && null != w && rd(i, y);
                }
              switch (s) {
                case "input":
                  xb(o), Eb(o, E, !0);
                ...
                if ($.hasOwnProperty(E)) {
                  ...
                  "style" === E
                    ...
                    : "suppressContentEditableWarning" !== E &&
                      ...
                      "autoFocus" !== E &&
                      (Oe.hasOwnProperty(E) ? null != ie && rd(i, E) : null != ie && Xa(n, E, ie, y));
                }
              switch (s) {
                case "input":
                  xb(n), Eb(n, o, !1);
            ...
            if (!o.hasOwnProperty(y) && E.hasOwnProperty(y) && null != E[y])
              if ("style" === y) for (w in ($ = E[y])) $.hasOwnProperty(w) && (i || (i = {}), (i[w] = ""));
                ...
                "dangerouslySetInnerHTML" !== y &&
                  ...
                  "autoFocus" !== y &&
                  (Oe.hasOwnProperty(y) ? n || (n = []) : (n = n || []).push(y, null));
          for (y in o) {
            var ie = o[y];
            if ((($ = null != E ? E[y] : void 0), o.hasOwnProperty(y) && ie !== $ && (null != ie || null != $)))
              if ("style" === y)
                ...
                "dangerouslySetInnerHTML" === y
                  ...
                  : "suppressContentEditableWarning" !== y &&
                    "suppressHydrationWarning" !== y &&
                    (Oe.hasOwnProperty(y) ? (null != ie && rd(s, y), n || $ === ie || (n = [])) : (n = n || []).push(y, ie));
          }
    ...
    function Bj(n, r) {
      ...
      if (0 !== i) {
        ...
        if ((Dj(), (n === yo && i === bo) || Ej(n, i), null !== To)) {
          ...
          if ((ng(), (_o = o), (po.current = a), 1 === So)) throw ((r = Oo), Ej(n, i), xi(n, i), Z(n), r);
          if (null === To)
    ...
    function yj(n) {
      ...
      if ((Dj(), (n === yo && r === bo) || Ej(n, r), null !== To)) {
        ...
        if ((ng(), (_o = i), (po.current = o), 1 === So)) throw ((i = Oo), Ej(n, r), xi(n, r), Z(n), i);
    ...
    function Ej(n, r) {
      ...
      (yo = n), (To = Sg(n.current, null)), (bo = r), (So = go), (Oo = null), (Io = vo = 1073741823), (Co = null), (Ao = 0), (wo = !1);
    }
    function Hj(n, r) {
      for (;;) {
        try {
          ...
          if (((_i = 0), (wi = vi = Ti = null), (Li = !1), null === To || null === To.return)) return (So = 1), (Oo = r), (To = null);
          e: {
            var a = n,
              s = To.return,
              E = To,
            ...
            if (
              ...
              do {
                ...
                if (le) {
                  ...
                  if (
                    (null === Oe
                      ? ((Oe = a.pingCache = new so()), (y = new Set()), Oe.set(w, y))
                      : void 0 === (y = Oe.get(w)) && ((y = new Set()), Oe.set(w, y)),
                    !y.has(E))
                  ) {
                    y.add(E);
                ...
                t: for (;;) {
                  for (
                    ...
                    ge !== y || (0 !== $ && 3 !== ge.nodeType) || (le = oe + $),
                      ...
                      null !== (Oe = ge.firstChild);

                  )
                    (Se = ge), (ge = Oe);
                  for (;;) {
                    if (ge === E) break t;
                    if ((Se === y && ++pe === $ && (le = oe), Se === ie && ++he === w && (se = oe), null !== (Oe = ge.nextSibling))) break;
                    Se = (ge = Se).parentNode;
                  }
                  ge = Oe;
                }
    ...
    function Oj(n, r, i) {
      ...
      null !== o && o.delete(r),
        yo === n && bo === i
          ? So === mo || (So === Eo && 1073741823 === vo && jr() - No < 500)
            ? Ej(n, bo)
            : (wo = !0)
    ...
    if ("undefined" == typeof window || "function" != typeof MessageChannel) {
      ...
      (je.port1.onmessage = function () {
        if (null !== Oe) {
          ...
          Ue = n + we;
          try {
            Oe(!0, n) ? We.postMessage(null) : ((Se = !1), (Oe = null));
          } catch (n) {
        ...
        (o = function (n) {
          (Oe = n), Se || ((Se = !0), We.postMessage(null));
        }),
        (a = function (n, i) {
          ve = se(function () {
            n(r.unstable_now());
  ...
  78: function (n, r, i) {
    ...
    var o = "function" == typeof Symbol && Symbol.for,
      ...
      Oe = o ? Symbol.for("react.block") : 60121,
