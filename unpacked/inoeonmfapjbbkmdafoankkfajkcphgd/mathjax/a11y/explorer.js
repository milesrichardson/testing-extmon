...
!(function () {
          ...
          return (function (t) {
            ...
            return (
              ...
              (o.prototype.explorable = function (t, o) {
                if ((void 0 === o && (o = !1), !(this.state() >= d.STATE.EXPLORER))) {
                  if (!this.isEscaped && (t.options.enableExplorer || o)) {
                    var r = this.typesetRoot,
                      n = e(this.root);
                    this.savedId && (this.typesetRoot.setAttribute("sre-explorer-id", this.savedId), (this.savedId = null)),
                      (this.explorers = (function (t, e, o) {
                        var r,
                          n,
                          i = {};
                        try {
                          for (var a = c(Object.keys(S)), s = a.next(); !s.done; s = a.next()) {
                            var l = s.value;
                            i[l] = S[l](t, e, o);
                          }
                        } catch (t) {
              ...
              (o.prototype.attachExplorers = function (t) {
                ...
                try {
                  for (var a = c(Object.keys(this.explorers)), s = a.next(); !s.done; s = a.next()) {
                    var l = s.value;
                    (p = this.explorers[l]) instanceof m.AbstractKeyExplorer && (p.AddEvents(), (p.stoppable = !1), i.unshift(p)),
                      t.options.a11y[l] ? (p.Attach(), this.attached.push(l)) : p.Detach();
                  }
                } catch (t) {
                  e = { error: t };
                } finally {
          ...
          return (
            (e = (function (t) {
              function e() {
                ...
                var i,
                  a = new v.SerializedMmlVisitor(r.mmlFactory);
                return (
                  (r.options.MathItem = M(r.options.MathItem, function (t) {
                    return a.visitTree(t);
                  })),
                  (r.explorerRegions =
                    ((i = r),
                    {
                      speechRegion: new _.LiveRegion(i),
                      brailleRegion: new _.LiveRegion(i),
                      magnifier: new _.HoverRegion(i),
                      tooltip1: new _.ToolTip(i),
                      tooltip2: new _.ToolTip(i),
                      tooltip3: new _.ToolTip(i)
                    })),
                  r
                );
              }
              return (
                ...
                (e.prototype.state = function (e, o) {
                  return (
                    ...
                    e < d.STATE.EXPLORER && this.processed.clear("explorer"),
                    this
                  );
                }),
                e
            ...
            (e.OPTIONS = i(i({}, t.OPTIONS), {
              enableExplorer: !0,
              renderActions: (0, y.expandable)(i(i({}, t.OPTIONS.renderActions), { explorable: [d.STATE.EXPLORER] })),
        ...
        var S = {
          speech: function (t, e) {
            ...
            return (
              ...
              i.speechGenerator.getOptions().locale !== w.default.engineSetup().locale &&
                ((t.options.sre.locale = w.default.engineSetup().locale), i.speechGenerator.setOptions({ locale: t.options.sre.locale })),
          ...
          braille: function (t, e) {
            ...
            return (
              i.speechGenerator.setOptions({ locale: "nemeth", domain: "default", style: "default", modality: "braille" }),
        ...
        (e.setA11yOptions = function (t, e) {
          ...
          for (var i in e)
            void 0 === t.options.a11y[i]
              ...
              : (A(t, i, e[i]), "locale" === i && (t.options.sre[i] = e[i]));
          try {
        ...
        var E = {},
          C = function (t, e) {
                ...
                i = function (e) {
                  ...
                  t.factory.get("variable")(
                    t.factory,
                    {
                      ...
                      setter: function (t) {
                        (E[e] = t),
                          n.setValue("clearspeak-" + w.default.clearspeakPreferences.addPreference(w.default.clearspeakStyle(), e, t));
                      },
                      getter: function () {
                        return E[e] || "Auto";
                      }
            ...
            var h = t.factory.get("selectionBox")(
              t.factory,
              { title: "Clearspeak Preferences", signature: "", order: "alphabetic", grid: "square", selections: a },
              t
            );
            return {
              type: "command",
        ...
        g.MJContextMenu.DynamicSubmenus.set("A11yLanguage", function (t, e) {
          ...
          try {
            for (var i = c(w.default.locales.keys()), a = i.next(); !a.done; a = i.next()) {
              var s = a.value;
              "nemeth" !== s && n.push({ type: "radio", id: s, content: w.default.locales.get(s) || s, variable: "locale" });
            }
          } catch (t) {
            o = { error: t };
          } finally {
          ...
          l = (function () {
            ...
            return (
              ...
              (t.create = function (t, e, o) {
                ...
                return new (this.bind.apply(this, n([void 0, t, e, o], r(i), !1)))();
              }),
              ...
              (t.prototype.getHighlighter = function () {
                ...
                return s.default.getHighlighter(o, e, { renderer: this.document.outputJax.name, browser: "v3" });
              }),
                    ...
                    for (; a; )
                      try {
                        if (
                          ((o = 1),
                          r &&
                            (n = 2 & i[0] ? r.return : i[0] ? r.throw || ((n = r.return) && n.call(r), 0) : r.next) &&
                            !(n = n.call(r, i[1])).done)
                        )
                          return n;
          ...
          u = (function (t) {
            ...
            return (
              ...
              (e.prototype.Detach = function () {
                this.active && ((this.node.tabIndex = this.oldIndex), (this.oldIndex = null), this.node.removeAttribute("role")),
                  (this.attached = !1);
              }),
        ...
        var h = (function (t) {
          ...
          return (
            ...
            (e.prototype.Start = function () {
              ...
              if (this.attached) {
                          ...
                          return a(this, function (e) {
                            return [
                              ...
                              c.default
                                .sreReady()
                                .then(function () {
                                  return c.default.setupEngine({ locale: r.locale });
                                })
                                .then(function () {
                ...
                t.prototype.Start.call(this),
                  ...
                  (this.walker = c.default.getWalker("table", this.node, this.speechGenerator, this.highlighter, this.mml)),
                    ...
                    return a(this, function (e) {
                      return [
                        ...
                        c.default
                          .sreReady()
                          .then(function () {
                            return c.default.setupEngine({ modality: n.modality, locale: n.locale });
                          })
                          .then(function () {
            ...
            (e.prototype.triggerLink = function (t) {
              ...
              return (
                !!(null === (o = null == r ? void 0 : r.getAttribute("data-semantic-postfix")) || void 0 === o
                  ? void 0
                  : o.match(/(^| )link($| )/)) && (r.parentNode.dispatchEvent(new MouseEvent("click")), !0)
              );
            }),
            ...
            (e.prototype.getOptions = function () {
              ...
              return (
                "speech" !== t.modality ||
                  ...
                  ((t.domain = e.domain), (t.style = e.style), (t.locale = e.locale), this.walker.update(t)),
                t
              );
            }),
        ...
        var p = (function (t) {
          function e(e, o, r, n) {
            ...
            return (
              ...
              (i.node = r),
              (i.mml = n),
              (i.walker = c.default.getWalker("table", i.node, c.default.getSpeechGenerator("Dummy"), i.highlighter, i.mml)),
              i
            );
          }
          return (
            ...
            (e.prototype.Start = function () {
              t.prototype.Start.call(this),
                this.attached && (this.region.Show(this.node, this.highlighter), this.walker.activate(), this.Update());
            }),
      ...
      367: function (t, e, o) {
              ...
              (t.prototype.stackRegions = function (t) {
                for (
                  var e = t.getBoundingClientRect(),
                    ...
                    n = this.document.adaptor.document.getElementsByClassName(this.CLASS.className + "_Show"),
                    i = 0,
                    a = void 0;
                  (a = n[i]);
                  i++
                  ...
                  a !== this.div &&
                    ((o = Math.max(a.getBoundingClientRect().bottom, o)), (r = Math.min(a.getBoundingClientRect().left, r)));
        ...
        var p = (function (t) {
          ...
          return (
            ...
            (e.style = new l.CssStyles(
              (((n = {})["." + e.className] = { position: "absolute", display: "inline-block", height: "1px", width: "1px" }),
              (n["." + e.className + "_Show"] = {
                width: "auto",
                height: "auto",
                opacity: 1,
        ...
        var f = (function (t) {
          ...
          return (
            ...
            (e.style = new l.CssStyles(
              (((a = {})["." + e.className] = { position: "absolute", height: "1px", width: "1px", padding: "1px", overflow: "hidden" }),
              (a["." + e.className + "_Show"] = {
                position: "absolute",
                width: "max-content",
                height: "auto",
            ...
            (e.prototype.Start = function () {
              if (!this.active) {
                ...
                this.node.hasAttribute("hasforegroundcolor") ||
                  (t.generateSpeech(this.node, this.mml), this.node.setAttribute("hasforegroundcolor", "true")),
  ...
  (t = u(723)),
    ...
    (0, t.r8)({ _: { a11y: { explorer_ts: o, explorer: { Explorer: r, KeyExplorer: n, MouseExplorer: i, Region: a, TreeExplorer: s } } } }),
    MathJax.startup &&
