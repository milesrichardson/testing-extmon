                  ...
                  if (!this.isEscaped && (t.options.enableEnrichment || n)) {
                    t.options.sre.speech !== y &&
                      ...
                      h.mathjax.retryAfter(
                        d.default.setupEngine(t.options.sre).then(function () {
          ...
          return (
            (r = (function (t) {
              function r() {
                ...
                return (
                  (a.options.MathItem = M(a.options.MathItem, e, function (t) {
            ...
            (r.OPTIONS = i(i({}, t.OPTIONS), {
              ...
              renderActions: (0, f.expandable)(
                i(i({}, t.OPTIONS.renderActions), { enrich: [u.STATE.ENRICHED], attachSpeech: [u.STATE.ATTACHSPEECH] })
              ),
              sre: (0, f.expandable)({ speech: "none", domain: "mathspeak", style: "default", locale: "en" })
            })),
            r
          );
        }
