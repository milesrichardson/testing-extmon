...
!(function () {
      ...
      589: function (t, e, o) {
          ...
          return (
            (e = (function (t) {
              function e() {
                ...
                return (
                  (i.options.MathItem = y(i.options.MathItem, function (t) {
              ...
              return (
                ...
                (e.prototype.state = function (e, o) {
                  return (
                    ...
                    e < p.STATE.COMPLEXITY && this.processed.clear("complexity"),
                    this
                  );
                }),
                e
            ...
            (e.OPTIONS = n(n(n({}, t.OPTIONS), u.ComplexityVisitor.OPTIONS), {
              ...
              renderActions: (0, h.expandable)(n(n({}, t.OPTIONS.renderActions), { complexity: [p.STATE.COMPLEXITY] }))
            })),
            e
          );
        }
        (0, p.newState)("COMPLEXITY", 40),
          ...
          (e.ComplexityHandler = function (t, e) {
            return (
              void 0 === e && (e = null),
              !t.documentClass.prototype.enrich && e && (t = (0, c.EnrichHandler)(t, e)),
          ...
          function t(e) {
            ...
            (this.cutoff = {
              ...
              (this.marker = {
                ...
                matrix: { squarematrix: "[::]", rowvector: "⟨⋯⟩", columnvector: "⟨⋮⟩", determinant: "|::|", value: "(::)" },
                cases: "{:",
                infixop: { addition: "+", subtraction: "−", multiplication: "⋅", implicit: "⋅", value: "+" },
              ...
              (this.collapse = new Map([
                  ...
                  function (t, e) {
                    return (
                      (e = o.uncollapseChild(e, t, 1)) > o.cutoff.fenced &&
                        ...
                        (e = o.recordCollapse(t, e, o.getText(t.childNodes[0]) + o.getText(t.childNodes[t.childNodes.length - 1]))),
                      e
                    );
                  }
                ],
                ...
                [
                  ...
                  function (t, e) {
                    return (
                      (e = o.uncollapseChild(e, t, 0, 2)) > o.cutoff.superscript && (e = o.recordCollapse(t, e, o.marker.superscript)), e
                    );
                  }
                ],
                [
        ...
        var l = o(176),
          ...
          p = (function (t) {
            function e(e, o) {
              ...
              var r = i.constructor;
              return (
                (i.options = (0, a.userOptions)((0, a.defaultOptions)({}, r.OPTIONS), o)),
            ...
            return (
              ...
              (e.prototype.visitMrootNode = function (t, e) {
                var o =
                  this.childrenComplexity(t) + this.complexity.sqrt - (1 - this.complexity.script) * this.getComplexity(t.childNodes[1]);
                return this.setComplexity(t, o, e);
              }),
              ...
              (e.prototype.visitMunderoverNode = function (e, o) {
                ...
                return (
                  ...
                  (l += this.complexity.child * ((i ? 1 : 0) + (r ? 1 : 0) + (n ? 1 : 0))),
              ...
              (e.prototype.setComplexity = function (t, e, o) {
                return (
                  o &&
                    (this.options.identifyCollapsible && (e = this.collapse.check(t, e)), t.attributes.set("data-semantic-complexity", e)),
                  e
                );
              }),
              ...
              (e.OPTIONS = { identifyCollapsible: !0, makeCollapsible: !0, Collapse: s.Collapse }),
              e
            );
          })(l.MmlVisitor);
  ...
  (t = a(723)),
    ...
    (0, t.r8)({ _: { a11y: { complexity_ts: o, complexity: { collapse: i, visitor: r }, "semantic-enrich": n } } }),
    MathJax.startup &&
