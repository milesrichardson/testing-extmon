(function () {
  ...
  if (
    window.location.href.lastIndexOf("word-edit.officeapps.live.com") > -1 ||
    window.location.href.lastIndexOf("sharepoint.com") > -1 ||
    window.location.href.lastIndexOf("https://onedrive.live.com/") > -1
  ) {
    return true;
  }
