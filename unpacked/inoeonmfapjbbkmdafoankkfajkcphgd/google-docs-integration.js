(function () {
  ...
  function ja(a, b) {
    ...
    switch (a) {
      ...
      case "\u0002":
        ...
        return a[0];
      default:
        throw Error("Unknown identifier in beginning of text \\x" + ha(a));
        throw void 0;
    }
  }
  function ka(a, b) {
    ...
    for (var c in b) {
      ...
      if ("function" === typeof d) {
        ...
        if (!e.includes("[native code]")) {
          if (a.test(e)) return (c = { parent: b, key: c, value: d }), la.set(a.toString(), c), c;
          if ("prototype" in d) {
            d = d.prototype;
            for (const f in d)
              if (
                ...
                return (c = { parent: d, key: f, value: e }), la.set(a.toString(), c), c;
          }
        }
      }
    }
  ...
  function sa(a, b) {
    for (let c = 0; c < a.length; c++) {
      ...
      for (let e = c + 1; e < a.length; e++) {
        const f = a[e];
        ta(d, f) && ((d.start = Math.min(d.start, f.start)), (d.end = Math.max(d.end, f.end)), a.splice(e, 1), e--, b && b(f));
      }
    }
  }
  function ua(a) {
    for (let c = 0; c < a.length; c++) {
      ...
      for (let e = c + 1; e < a.length; e++) {
        var b = a[e];
        if (ta({ start: d.left, end: d.left + d.width }, { start: b.left, end: b.left + b.width })) {
  ...
  function Ha(a, b) {
    ...
    for (var d; void 0 !== (d = a.shift()); ) {
      ...
      for (const f in e) {
        ...
        !(h instanceof Object) || Fa(h) || Ga(h) || Array.isArray(h) || c.includes(h) || (c.push(h), a.push([h, [...d, f]]));
      }
    }
    return null;
  }
      ...
      if (((e = c[a]), 0 === a))
        ...
        "string" === typeof e
          ? (d = e.match(/^([a-zA-Z0-9$_]+)\((.*?)\)$/))
            ? ((e = d[2].split(",").map((g) => Ja(g, b))), (h = h[d[1]](...e)))
            : (h = h[e])
          : (h = h[e]);
    return h;
  }
  function Ka(a) {
    ...
    const b = Ha(a, (d) =>
      ...
      null !== Ha(d, (e) => ("string" !== typeof e ? !1 : "\u0003" === e.charAt(0)))
        ? !0
        : !1
    );
      ...
      if (d) {
        const e = {
          ...
          Oe: (f) => {
            const h = Oa(),
              g = [h];
            3 === d[1].split(",").length && g.push(Pa(b)(h));
            g.push(f);
  ...
  function tb() {
    ...
    a: if (a.i) var b = a.i;
      ...
      for (var c in b) {
        const e = b[c];
        if (e instanceof Object && !Array.isArray(e) && !Fa(e) && !Ga(e))
          for (const f in e) {
            const h = e[f];
            if (h && h instanceof Object && !Array.isArray(h) && !Fa(h) && !Ga(h) && "function" === typeof h.getSelection) {
              b = a.i = e;
              break a;
            }
          }
    ...
    if (!a.Xa) {
      ...
      Object.defineProperty(a.g, b, {
        ...
        set: (d) => {
          const e = c;
          c = d;
          e !== d && null !== d && void 0 !== d && w(a.pb, a.getSelection());
        }
      });
    }
  }
  ...
  function Ab(a) {
    ...
    if (null === b) console.error("Unable to initialize listener for spellcheck changes!");
      ...
      var c = Ka(a.g);
      if ((b = b.map((p) => Ja(`this.${p}`, { this: c })).find((p) => "spellcheck" in p))) {
        var d = b.spellcheck,
          e = Object.keys(d)
            .map((p) => d[p])
            .find(
  ...
  function Mb(a) {
    ...
    const c = new Map();
    for (const d of b) (b = Ib(a, "spellcheck", d)), null !== b.text && c.set(d, b);
    return c;
  }
  function Jb(a) {
  ...
  function Qb(a) {
    a = a.g.getSelection();
    const b = Ha(a, (c) => (c && "object" === typeof c && "toString" in c && c.toString.toString().match(/Location/) ? !0 : !1));
  ...
  var ub = class {
    ...
    getSelection() {
      var a = this.g.getSelection(),
        b = Ha(a, (f) =>
          Array.isArray(f) && 0 !== f.length ? ((f = f[0]) && "object" === typeof f ? "start" in f && "end" in f : !1) : !1
        );
      if (null !== b) return (a = Ia(a, b)[0]), new Wa({ start: a.start, end: a.end + 1 });
      const c = Qb(this);
      if (c) {
        var d = this.ya;
        a = La(d, "CellBorderLocation");
        b = La(d, "InlineLocation");
        var e = La(d, "ListItemLocation");
        const f = La(d, "ListNestingLevelLocation");
        d = La(d, "PositionedLocation");
        if (c instanceof a) {
          a = (() => {
            for (const h in c) {
              const g = c[h];
        ...
        if (c instanceof b)
          return (a = ka(c, /this\.([a-zA-Z0-9$_]+)=a/)), null === a ? new Wa({ start: -1, end: -1 }) : new Wa({ start: a, end: a });
        if (c instanceof e) return (a = ka(c, /this\.([a-zA-Z0-9$_]+)=a/)), null === a ? new Wa({ start: -1, end: -1 }) : new $a(a);
        if (c instanceof f)
          return (
            (a = ka(c, /this\.([a-zA-Z0-9$_]+)=a/)),
            (b = ka(c, /this\.([a-zA-Z0-9$_]+)=c/)),
            (e = ka(c, /this\.([a-zA-Z0-9$_]+)=d/)),
            null === a || null === b || null === e ? new Wa({ start: -1, end: -1 }) : new ab(a, b, e)
          );
        if (c instanceof d)
          return (
            (a = (() => {
  ...
  function Wb(a, b, c, d, e) {
    ...
    if ((f = Xb(b, c)))
      return (c = f[1]), (h = f[3]), (b = f[4]), (f = Yb(a, f[0], f[2], d, e)), (a = Yb(a, c, h, d, e)), f.concat([["equal", b]], a);
  ...
  var kc = class {
    constructor() {
      ...
      this.sb = new Set();
      this.Sc = new WeakMap();
      this.Mc = new FinalizationRegistry(jc);
    }
    set(a, b) {
      var c = this.Sc.get(a);
  ...
  var lc = Symbol("WizkidsData"),
    mc = Symbol("MeasureText"),
    nc = Symbol("DataChangesSymbol"),
    oc = Symbol("GetRectsSymbol"),
    pc = Symbol("AlreadyHandledSymbol");
  const qc = /return!!this\.([a-zA-Z0-9$_]+)\|\|/,
    rc = /function(?: [a-zA-Z0-9$_]+)?\([a-zA-Z0-9$_]+\){this\.[a-zA-Z0-9$_]+=[a-zA-Z0-9$_]+}/,
    sc = /function(?: [a-zA-Z0-9$_]+)?\([a-zA-Z0-9$_]+,[a-zA-Z0-9$_]+,[a-zA-Z0-9$_]+\){this\.[a-zA-Z0-9$_]+=[a-zA-Z0-9$_]+}/;
  function tc(a, b) {
    if (a.u) return a.u;
    a: if (a.i) var c = a.i;
    else {
      ...
      for (c in b) {
        const d = b[c];
        if ("function" === typeof d && qc.test(d.toString())) {
          c = a.i = d;
          break a;
        }
      }
  ...
  function Gc(a, b) {
    return 48 > a
      ...
      ? !0
      : 65535 >= a
      ? 170 <= a && Dc.test(String.fromCharCode(a))
      : !1 === b
      ? !1
      : Ec(a, yc) || Ec(a, xc);
  }
  ...
  G.Y.ga = G.ca.ga = function () {
    if (1 === this.context.length) this.W = !0;
      ...
      a === I.$a && "function" === Ic(this).Ec && (a = this.context.pop());
      this.W = !a.bd;
    }
  };
  G.ha.ga = function (a) {
    ...
    a =
      d === I.Kb || d === I.$c
        ...
        ? a === G.Zb || (a === G.name && this.W)
          ? Jc.test(this.input.slice(this.ba, this.start))
  ...
  G.Ya.ga = G.Hb.ga = function (a) {
    ...
    a === G.Yb ||
    (a === G.ia && Ic(this) !== I.od) ||
    (a === G.Zb && Jc.test(this.input.slice(this.ba, this.start))) ||
    ((a === G.Ba || a === G.ha) && Ic(this) === I.$a)
      ? this.context.push(I.$c)
      : this.context.push(I.Kb);
    this.W = !1;
  };
  G.Ba.ga = function () {
    "function" === Ic(this).Ec && this.context.pop();
    this.W = !0;
  };
  G.Pa.ga = function () {
    Ic(this) === I.qd ? this.context.pop() : this.context.push(I.qd);
    this.W = !1;
  };
  G.ja.ga = function (a) {
  ...
  function Lc(a, b, c) {
    ...
    for (; b < c; b++) {
      ...
      if (Kc(d)) return b < c - 1 && 13 === d && 10 === a.charCodeAt(b + 1) ? b + 2 : b + 1;
    }
    return -1;
  }
  var Mc = /[\u1680\u2000-\u200a\u202f\u205f\u3000\ufeff]/,
    ...
    Sc =
      Array.isArray ||
      function (a) {
        return "[object Array]" === Rc.call(a);
      },
    Tc = {};
  function Uc(a) {
    return Tc[a] || (Tc[a] = new RegExp("^(?:" + a.replace(/ /g, "|") + ")$"));
  }
  function Vc(a) {
  ...
  function ad(a) {
    var b = {},
      c;
    for (c in Zc) b[c] = a && Qc.call(a, c) ? a[c] : Zc[c];
    "latest" === b.o
      ? (b.o = 1e8)
      : null == b.o
      ? (!$c &&
  ...
  var fd = class {
    ...
    I = {
      ...
      qd: new fd("`", !0, !0, function (a) {
        ...
        try {
          for (var b = "", c = a.h; ; ) {
            ...
            if (92 === d) (b += a.input.slice(c, a.h)), (b += gd(a, !0)), (c = a.h);
            else if (Kc(d)) {
              b += a.input.slice(c, a.h);
              ++a.h;
              switch (d) {
      ...
      $c: new fd("function", !1),
      Kb: new fd("function", !0),
      te: new fd("function", !0, !1, null, !0),
      ue: new fd("function", !1, !1, null, !0)
    },
    id = [];
  const jd = { kind: "loop" },
    kd = { kind: "switch" };
  function ld(a) {
    return ("MemberExpression" === a.type && "PrivateIdentifier" === a.fa.type) || ("ChainExpression" === a.type && ld(a.J));
  }
  class md {
    constructor() {
  ...
  var nd = class {
    constructor(a, b, c) {
      ...
      this.end = 0;
      this.start = b;
      a.options.ma && (this.Ob = new Yc(a, c, void 0));
  ...
  class Gd {
    constructor(a) {
      ...
      this.Ne =
        ...
        (13 <= a.options.o ? "d" : "") +
        (15 <= a.options.o ? "v" : "");
      this.Ub = xd[14 <= a.options.o ? 14 : a.options.o];
    ...
    current(a = !1) {
      return Dd(this, this.h, a);
    }
    advance(a = !1) {
      this.h = Ed(this, this.h, a);
    }
    m(a) {
  ...
  function Ld(a) {
    return a.options.ma ? new Xc(a.ab, a.h - a.gb) : null;
  }
  function Md(a, b) {
    ...
    for (;;) {
      ...
      if ("use strict" === (c[1] || c[2])) {
        ...
        return (
          ";" === d || "}" === d || (Jc.test(b[0]) && !(/[(`.[+\-/*%<>=,?^&]/.test(d) || ("!" === d && "=" === a.input.charAt(c + 1))))
        );
      }
      b += c[0].length;
      J.lastIndex = b;
  ...
  function Nd(a, b) {
    for (var c = a.h, d = a.options.Ga && Ld(a), e = a.input.charCodeAt((a.h += b)); a.h < a.input.length && !Kc(e); )
      e = a.input.charCodeAt(++a.h);
    a.options.Ga && a.options.Ga(!1, a.input.slice(c + b, a.h), c, a.h, d, Ld(a));
  }
  function Od(a, b) {
    a.u.push(new dd(b));
  }
  ...
  function M(a) {
    return new nd(a, a.start, a.O);
  }
  function Jd(a) {
    var b = Ic(a);
    (b && b.De) || Sd(a);
    a.start = a.h;
    a.options.ma && (a.O = Ld(a));
    if (a.h >= a.input.length) K(a, G.Ta);
    else if (b.nd) b.nd(a);
    else if (((b = Td(a)), Fc(b, 6 <= a.options.o) || 92 === b)) {
      b = Ud(a);
      var c = G.name;
      a.qb.test(b) && (c = Hc[b]);
      K(a, c, b);
  ...
  function Xd(a) {
    return a.type === G.Ta || a.type === G.ca || Jc.test(a.input.slice(a.ba, a.start));
  }
  function Yd(a) {
    return Xd(a) ? (a.options.jd && a.options.jd(a.ba, a.pa), !0) : !1;
  }
  function R(a) {
    a.m(G.ia) || Yd(a) || Q(a);
  }
  ...
  function ce(a, b) {
    return "ParenthesizedExpression" === b.type ? ce(a, b.J) : "Identifier" === b.type || "MemberExpression" === b.type;
  }
  function N(a, b, c, d) {
    var e = a.type,
      f = M(a);
    ...
    switch (e) {
      ...
      case G.Rd:
        ...
        b = "break" === d;
        a.next();
        a.m(G.ia) || Yd(a) ? (f.label = null) : a.type !== G.name ? Q(a) : ((f.label = T(a)), R(a));
      ...
      case G.Ya:
        return (
          b && (a.P || ("if" !== b && "label" !== b)) && 6 <= a.options.o && Q(a), (d = !b), a.next(), ge(a, f, 1 | (d ? 0 : 2), !1, !1)
        );
      case G.Hb:
        return b && Q(a), he(a, f, !0);
      case G.Oc:
        return a.next(), (f.test = ee(a)), (f.la = N(a, "if")), (f.Aa = a.m(G.Yb) ? N(a, "if") : null), O(a, f, "IfStatement");
      case G.Zb:
        return (
          a.Jd || a.options.de || a.j(a.start, "'return' outside of function"),
          a.next(),
          a.m(G.ia) || Yd(a) ? (f.B = null) : ((f.B = U(a)), R(a)),
      ...
      case G.ae:
        return (
          a.next(),
          Jc.test(a.input.slice(a.ba, a.start)) && a.j(a.ba, "Illegal newline after throw"),
          (f.B = U(a)),
          R(a),
      ...
      case G.be:
        return (
          ...
          a.type === G.Qd &&
            ...
            a.next(),
            a.m(G.X)
              ? ((b = ke(a)), (e = "Identifier" === b.type), Od(a, e ? 32 : 0), le(a, b, e ? 4 : 2), S(a, G.Y), (d.ib = b))
              : (10 > a.options.o && Q(a), (d.ib = null), Od(a, 0)),
            (d.body = je(a, !1)),
            ie(a),
            (f.Ea = O(a, d, "CatchClause"))),
          (f.cb = a.m(G.Xd) ? je(a) : null),
      ...
      case G.Jb:
        return (
          (h = h || a.value), b && "var" !== h && Q(a), (d = h), a.next(), me(a, f, !1, d, void 0), R(a), O(a, f, "VariableDeclaration")
        );
      case G.$b:
        return a.next(), (f.test = ee(a)), a.l.push(jd), (f.body = N(a, "while")), a.l.pop(), O(a, f, "WhileStatement");
      case G.Tc:
        return (
          a.P && a.j(a.start, "'with' in strict mode"), a.next(), (f.object = ee(a)), (f.body = N(a, "with")), O(a, f, "WithStatement")
        );
      case G.ha:
        return je(a, !0, f);
      case G.ia:
      ...
      case G.Ib:
        ...
        if (e === G.Ib) {
          a.next();
          if (a.type === G.xa) (f.Wa = id), (f.source = oe(a));
          else {
            a: {
              d = [];
              b = !0;
              ...
              if (a.type === G.ja)
                ...
                for (S(a, G.ha); !a.m(G.ca); ) {
                  if (b) b = !1;
                  else if ((S(a, G.N), Zd(a, G.ca))) break;
                  e = d;
                  g = e.push;
                  c = a;
                  k = M(c);
                  k.rc = qe(c);
                  P(c, "as") ? (k.local = T(c)) : (re(c, k.rc), (k.local = k.rc));
                  pe(c, k.local, 2);
            ...
            f.Wa = d;
            P(a, "from") || Q(a);
            f.source = a.type === G.xa ? oe(a) : Q(a);
          }
          R(a);
          a = O(a, f, "ImportDeclaration");
        } else if ((a.next(), a.m(G.ja)))
          11 <= a.options.o && (P(a, "as") ? ((f.qa = qe(a)), se(a, d, f.qa, a.A)) : (f.qa = null)),
            P(a, "from") || Q(a),
            a.type !== G.xa && Q(a),
            (f.source = oe(a)),
            R(a),
          ...
          se(a, d, "default", a.A),
            a.type === G.Ya || (g = te(a))
              ? ((d = M(a)), a.next(), g && a.next(), (d = ge(a, d, 5, !1, g)))
              : a.type === G.Hb
              ? (d = he(a, M(a), "nullableID"))
              : ((d = V(a)), R(a)),
            (f.Z = d),
            (a = O(a, f, "ExportDefaultDeclaration"));
        else {
          if ("var" === a.type.da || "const" === a.type.da || "class" === a.type.da || "function" === a.type.da || de(a) || te(a)) {
            f.Z = N(a, null);
            if ("VariableDeclaration" === f.Z.type) {
              if (((b = f.Z.Ja), d)) for (e = 0; e < b.length; e += 1) ue(a, d, b[e].id);
            } else se(a, d, f.Z.id, f.Z.id.start);
            f.Wa = [];
            f.source = null;
          } else {
            f.Z = null;
            ...
            for (S(a, G.ha); !a.m(G.ca); ) {
              ...
              var m = M(k);
              m.local = qe(k);
              m.qa = P(k, "as") ? qe(k) : m.local;
              se(k, h, m.qa, m.qa.start);
              k = O(k, m, "ExportSpecifier");
              c.call(g, k);
            }
            f.Wa = b;
            if (P(a, "from")) a.type !== G.xa && Q(a), (f.source = oe(a));
            else {
              d = 0;
        ...
        return a;
      default:
        if (te(a)) return b && Q(a), a.next(), (d = !b), a.next(), ge(a, f, 1 | (d ? 0 : 2), !1, !0);
        d = a.value;
        g = U(a);
  ...
  function Kd(a, b) {
    for (var c = 0; c < b.length && ve(a, b[c]); ++c) b[c].tf = b[c].J.raw.slice(1, -1);
  }
  function O(a, b, c) {
    return we(a, b, c, a.ba, a.pa);
  }
  function de(a, b) {
    if (6 > a.options.o || !Wd(a, "let")) return !1;
    J.lastIndex = a.h;
    ...
    if (Fc(d, !0)) {
      for (b = c + 1; Gc((d = a.input.charCodeAt(b)), !0); ) ++b;
      if (92 === d || (55295 < d && 56320 > d) || !Bc.test(a.input.slice(c, b))) return !0;
    }
    return !1;
  }
  function te(a) {
    if (8 > a.options.o || !Wd(a, "async")) return !1;
    J.lastIndex = a.h;
    var b = J.exec(a.input);
    b = a.h + b[0].length;
    var c;
    return (
      !Jc.test(a.input.slice(a.h, b)) &&
      "function" === a.input.slice(b, b + 8) &&
      (b + 8 === a.input.length || !(Gc((c = a.input.charCodeAt(b + 8))) || (55295 < c && 56320 > c)))
    );
  }
  function fe(a, b) {
    a.next();
    ...
    Od(a, 0);
    S(a, G.X);
    if (a.type === G.ia) return -1 < c && Q(a, c), xe(a, b, null);
    var d = de(a);
    if (a.type === G.Jb || a.type === G.Xb || d) {
      ...
      if ((a.type === G.za || (6 <= a.options.o && Wd(a, "of"))) && 1 === e.Ja.length)
        return 9 <= a.options.o && (a.type === G.za ? -1 < c && Q(a, c) : (b.Vc = -1 < c)), ye(a, b, e);
      -1 < c && Q(a, c);
      return xe(a, b, e);
    }
    e = Wd(a, "let");
    ...
    var f = new md(),
      h = U(a, -1 < c ? "await" : !0, f);
    if (a.type === G.za || (d = 6 <= a.options.o && Wd(a, "of")))
      return (
  ...
  function he(a, b, c) {
    ...
    var d = a.P;
    a.P = !0;
    a.type === G.name ? ((b.id = T(a)), c && pe(a, b.id, 2, !1)) : (!0 === c && Q(a), (b.id = null));
    b.mb = a.m(G.Vd) ? Ae(a, null, !1) : null;
        ...
        if (g.m(G.ia)) var m = null;
          ...
          if (P(g, "static")) {
            if (13 <= n && g.m(G.ha)) {
              ...
              g = p.l;
              p.l = [];
              for (Od(p, 320); p.type !== G.ca; ) (u = N(p, null)), t.body.push(u);
              p.next();
              ie(p);
              p.l = g;
              O(p, t, "StaticBlock");
            ...
            Be(g) || g.type === G.ja ? (r = !0) : (q = "static");
          }
          m.lb = r;
          !q && 8 <= n && P(g, "async") && ((!Be(g) && g.type !== G.ja) || Xd(g) ? (q = "async") : (p = !0));
          !q && (9 <= n || !p) && g.m(G.ja) && (t = !0);
          q || p || t || ((r = g.value), !P(g, "get") && !P(g, "set")) || (Be(g) ? (u = r) : (q = r));
          q
          ...
          13 > n || g.type === G.X || "method" !== u || t || p
            ? ((k = (n = !m.lb && ed(m, "constructor")) && k),
              ...
              "constructor" === u.kind
                ...
                : u.lb && ed(u, "prototype") && g.j(n.start, "Classes may not have a static property named prototype"),
              (p = u.value = Ee(g, t, p, k)),
            ...
            : ((p = g),
              ...
              ed(t, "constructor")
                ...
                : t.lb && ed(t, "prototype") && p.j(t.key.start, "Classes can't have a static field named 'prototype'"),
              p.m(G.Ka) ? ((g = Qd(p)), (u = g.Fa), (g.Fa = !0), (t.value = V(p)), (g.Fa = u)) : (t.value = null),
              R(p),
    ...
    if (a.options.ic)
      for (f = a.F.length, f = 0 === f ? null : a.F[f - 1], h = 0; h < e.length; ++h)
        (m = e[h]),
          Qc.call(d, m.name) || (f ? f.Fc.push(m) : a.j(m.start, "Private field '#" + m.name + "' must be declared in an enclosing class"));
  ...
  function me(a, b, c, d, e) {
    ...
    for (b.kind = d; ; ) {
      ...
      a.m(G.Ka)
        ? (f.R = V(a, c))
        : e || "const" !== d || a.type === G.za || (6 <= a.options.o && Wd(a, "of"))
        ? e || "Identifier" === f.id.type || (c && (a.type === G.za || Wd(a, "of")))
          ? (f.R = null)
  ...
  function le(a, b, c, d) {
    ...
    switch (b.type) {
      case "ObjectPattern":
        var e = 0;
        for (b = b.wa; e < b.length; e += 1) Ge(a, b[e], c, d);
        break;
      case "ArrayPattern":
        e = 0;
  ...
  function ge(a, b, c, d, e, f) {
    ...
    c & 1 &&
      ((b.id = c & 4 && a.type !== G.name ? null : T(a)), !b.id || c & 2 || pe(a, b.id, a.P || b.aa || b.async ? (a.Ic ? 1 : 2) : 3));
    e = a.i;
    var h = a.g,
      g = a.s;
    a.i = 0;
    a.g = 0;
    a.s = 0;
    Od(a, 2 | (b.async ? 4 : 0) | (b.aa ? 8 : 0));
    c & 1 || (b.id = a.type === G.name ? T(a) : null);
    S(a, G.X);
    b.T = Ie(a, G.Y, !1, 8 <= a.options.o);
    be(a);
    Je(a, b, d, !1, f);
    a.i = e;
    a.g = h;
  ...
  function V(a, b, c, d) {
    if (Wd(a, "yield")) {
      if (a.pb)
        return (
          ...
          (c = M(a)),
          a.next(),
          a.type === G.ia || Xd(a) || (a.type !== G.ja && !a.type.ka) ? ((c.Yc = !1), (c.B = null)) : ((c.Yc = a.m(G.ja)), (c.B = V(a, b))),
    ...
    var e = !1,
      ...
      h = -1,
      g = -1;
    c ? ((f = c.Ha), (h = c.oa), (g = c.bb), (c.Ha = c.oa = -1)) : ((c = new md()), (e = !0));
    var k = a.start,
      m = a.O;
    ...
    var u = a.O,
      r = Le(a, n, !1, !1, b);
    p = ae(a, n) ? r : r.start === p && "ArrowFunctionExpression" === r.type ? r : Me(a, r, p, u, -1, b);
    ae(a, n)
      ? (n = p)
      : a.m(G.rd)
    ...
    if (a.type.Lb)
      return (
        (d = W(a, k, m)),
        (d.H = a.value),
        a.type === G.Ka && (n = ze(a, n, !1, c)),
        e || (c.Ha = c.oa = c.bb = -1),
        c.Eb >= n.start && (c.Eb = -1),
        a.type === G.Ka ? le(a, n) : pe(a, n),
        (d.left = n),
        a.next(),
        (d.right = V(a, b)),
        -1 < g && (c.bb = g),
    ...
    switch (b.type) {
      case "Identifier":
        ...
        if (
          ...
          d && (Qc.call(d, b.name) && a.j(b.start, "Argument name clash"), (d[b.name] = !0)),
          5 !== c)
        ) {
          d = b.name;
          e = c;
          ...
          else if (4 === e) Rd(a).Na.push(d);
          else if (3 === e) (e = Rd(a)), (c = a.Ic ? -1 < e.Na.indexOf(d) : -1 < e.Na.indexOf(d) || -1 < e.Vb.indexOf(d)), e.pc.push(d);
          else
      ...
      case "MemberExpression":
        ...
        break;
      case "ParenthesizedExpression":
        return e && a.j(b.start, "Binding parenthesized expression"), pe(a, b.J, c, d);
      default:
  ...
  function Je(a, b, c, d, e) {
    var f = a.P,
      h = !1;
    c && a.type !== G.ha
      ? ((b.body = V(a, e)), (b.J = !0), Ne(a, b, !1))
      : ((e = 7 <= a.options.o && !Oe(b.T)),
        (!f || e) && (h = Md(a, a.end)) && e && a.j(b.start, "Illegal 'use strict' directive in function with non-simple parameter list"),
        (e = a.l),
        (a.l = []),
        h && (a.P = !0),
        Ne(a, b, !f && !h && !c && !d && Oe(b.T)),
        a.P && b.id && pe(a, b.id, 5),
  ...
  function De(a, b) {
    ...
    b.key = a.type === G.Ua || a.type === G.xa ? oe(a) : T(a, "never" !== a.options.ub);
  }
  function Ee(a, b, c, d) {
    var e = M(a),
      f = a.i,
    ...
    a.g = 0;
    a.s = 0;
    Od(a, 2 | (c ? 4 : 0) | (e.aa ? 8 : 0) | 64 | (d ? 128 : 0));
    S(a, G.X);
    e.T = Ie(a, G.Y, !1, 8 <= a.options.o);
    be(a);
    Je(a, e, !1, !0, !1);
    a.i = f;
    a.g = h;
  ...
  function qe(a) {
    if (13 <= a.options.o && a.type === G.xa) {
      var b = Se(a, a.value);
      Wc.test(b.value.toString()) && a.j(b.start, "An export name cannot include a lone surrogate.");
      return b;
    }
    return T(a, !0);
  }
  function se(a, b, c, d) {
    b &&
      ...
      Qc.call(b, c) && a.j(d, "Duplicate export '" + c + "'"),
      (b[c] = !0));
  }
  function oe(a, b, c, d) {
    a.type === G.ud && Te(a);
    ...
    switch (a.type) {
      ...
      case G.name:
        ...
        var f = a.C,
          h = T(a, !1);
        if (8 <= a.options.o && !f && "async" === h.name && !Xd(a) && a.m(G.Ya))
          return (e = I.Kb), Ic(a) !== e && (a.context[a.context.length - 1] = e), ge(a, W(a, b, d), 0, !1, !0, c);
        if (e && !Xd(a)) {
          if (a.m(G.Za)) return Ue(a, W(a, b, d), [h], !1, c);
          if (8 <= a.options.o && "async" === h.name && a.type === G.name && !f && (!a.Gb || "of" !== a.value || a.C))
            return (h = T(a, !1)), (!Xd(a) && a.m(G.Za)) || Q(a), Ue(a, W(a, b, d), [h], !0, c);
        }
        return h;
      case G.td:
        return (b = a.value), (a = Se(a, b.value)), (a.yf = { pattern: b.pattern, flags: b.flags }), a;
      case G.Ua:
      case G.xa:
        return Se(a, a.value);
      case G.Pc:
      ...
      case G.X:
        ...
        a: {
          ...
          if (6 <= a.options.o) {
            ...
            a.i = u || a.i;
            a.g = r || a.g;
            1 < n.length ? ((c = W(a, k, m)), (c.La = n), we(a, c, "SequenceExpression", g, q)) : (c = n[0]);
          } else c = ee(a);
          a.options.Ce && ((e = W(a, f, h)), (e.J = c), (c = O(a, e, "ParenthesizedExpression")));
        }
        b && (0 > b.Ha && !ce(a, c) && (b.Ha = d), 0 > b.Db && (b.Db = d));
        return c;
      case G.Ia:
        return (c = M(a)), a.next(), (c.elements = Ve(a, G.vb, !0, !0, b)), O(a, c, "ArrayExpression");
      case G.ha:
        return (c = I.bc), Ic(a) !== c && (a.context[a.context.length - 1] = c), Ke(a, !1, b);
      case G.Ya:
        return (b = M(a)), a.next(), ge(a, b, 0);
      case G.Hb:
        return he(a, M(a), !1);
      case G.Yd:
        return (
          ...
          6 <= a.options.o && a.type === G.Sa
            ...
            : ((c = a.start),
              ...
              a.m(G.X) ? (b.arguments = Ve(a, G.Y, 8 <= a.options.o, !1)) : (b.arguments = cd),
  ...
  function re(a, b) {
    ...
    Qd(a).Fa && "arguments" === b && a.j(c, "Cannot use 'arguments' in class field initializer");
  ...
  function ue(a, b, c) {
    ...
    else if ("ObjectPattern" === d) for (d = 0, c = c.wa; d < c.length; d += 1) ue(a, b, c[d]);
    else if ("ArrayPattern" === d)
      for (d = 0, c = c.elements; d < c.length; d += 1) {
        var e = c[d];
        e && ue(a, b, e);
      }
    else "Property" === d ? ue(a, b, c.value) : "AssignmentPattern" === d ? ue(a, b, c.left) : "RestElement" === d && ue(a, b, c.B);
  }
  function Se(a, b) {
    var c = M(a);
    c.value = b;
  ...
  function Ke(a, b, c) {
    ...
    for (a.next(); !a.m(G.ca); ) {
      if (e) e = !1;
      else if ((S(a, G.N), 5 <= a.options.o && Zd(a, G.ca))) break;
      var h = void 0,
        g = void 0,
        k = void 0;
      var m = a;
      ...
      if (9 <= m.options.o && m.m(G.wb))
        ...
        if (
          ...
          Jc.test(m.input.slice(m.ba, m.start))
        )
          var u = !1;
        else (u = !0), (k = 9 <= m.options.o && m.m(G.ja)), De(m, t);
        var r = m,
          v = t;
        (k || u) && r.type === G.Ba && Q(r);
        r.m(G.Ba)
          ? ((v.value = n ? Qe(r, r.start, r.O) : V(r, !1, q)), (v.kind = "init"))
          : 6 <= r.options.o && r.type === G.X
          ? (n && Q(r), (v.kind = "init"), (v.method = !0), (v.value = Ee(r, k, u)))
          : n ||
            p ||
            !(5 <= r.options.o) ||
            v.V ||
          ...
          ? 6 <= r.options.o && !v.V && "Identifier" === v.key.type
            ? ((k || u) && Q(r),
              ...
              (v.kind = "init"),
              n
                ? (v.value = Qe(r, g, h, $e(r, v.key)))
                : r.type === G.Ka && q
                ? (0 > q.Eb && (q.Eb = r.start), (v.value = Qe(r, g, h, $e(r, v.key))))
                : (v.value = $e(r, v.key)),
              (v.Bc = !0))
            : Q(r)
          : ((k || u) && Q(r),
  ...
  function Le(a, b, c, d, e) {
    ...
    if (Wd(a, "await") && a.ob) {
      ...
      if (ae(a, b)) return g;
      for (; a.type.yc && !Xd(a); )
        (b = W(a, f, h)), (b.H = a.value), (b.prefix = !1), (b.B = g), pe(a, g), a.next(), (g = O(a, b, "UpdateExpression"));
    } else (e || 0 === a.F.length) && a.options.ic && Q(a), (g = Ce(a)), a.type !== G.za && Q(a);
    if (!d && a.m(G.vd))
      if (c) Q(a, a.A);
      else return af(a, f, h, g, Le(a, null, !1, !1, e), "**", !1);
    else return g;
  }
  function Me(a, b, c, d, e, f) {
    ...
    if (null != h && (!f || a.type !== G.za) && h > e) {
      ...
      var n = a.start,
        q = a.O;
      h = Me(a, Le(a, null, !1, !1, f), n, q, h, f);
      b = af(a, c, d, b, h, m, g || k);
    ...
    for (
      ...
      a: {
        ...
        if (z || (x && k.type !== G.X && k.type !== G.Pa) || k.m(G.Sa))
          ...
          k.g = 0;
          k.s = 0;
          z = Ve(k, G.Y, 8 <= k.options.o, !1, t);
          if ((p = p && !x)) (p = k), (p = !Xd(p) && p.m(G.Za));
          if (p) {
            $d(k, t, !1);
            be(k);
  ...
  function Ve(a, b, c, d, e) {
    for (var f = [], h = !0; !a.m(b); ) {
      if (h) h = !1;
      else if ((S(a, G.N), c && Zd(a, b))) break;
  ...
  function Te(a) {
    for (var b, c, d = a.h; ; ) {
      ...
      Jc.test(e) && a.j(d, "Unterminated regular expression");
      if (b) b = !1;
      else {
        if ("[" === e) c = !0;
        else if ("]" === e && c) c = !1;
    ...
    cf(a, e);
    !e.nb && 9 <= a.options.o && 0 < e.yb.length && ((e.nb = !0), cf(a, e));
    e = null;
    try {
      e = new RegExp(b, c);
    } catch (n) {}
  ...
  function df(a, b) {
    ...
    for (; b.m(124); ) for (var c = a, d = b; d.h < d.source.length && ef(c, d); );
  ...
  function ef(a, b) {
    if (hf(a, b)) return b.Nb && ff(b) && b.U && b.j("Invalid quantifier"), !0;
    if (b.U) {
      for (var c = b.h, d = 0; -1 !== (d = b.current()) && !td(d); ) b.advance();
      a = b.h !== c || b.m(46) || jf(a, b) || kf(a, b) || lf(a, b) || mf(a, b);
    } else
      (a = b.m(46) || jf(a, b) || kf(a, b) || lf(a, b) || mf(a, b)) || (gf(b, !0) && b.j("Nothing to repeat"), (a = !1)),
        a ||
          ((a = b.current()),
  ...
  function hf(a, b) {
    ...
    if (b.m(40) && b.m(63)) {
      ...
      if (b.m(61) || b.m(33)) return df(a, b), b.m(41) || b.j("Unterminated group"), (b.Nb = !d), !0;
    }
    b.h = c;
    return !1;
  }
  ...
  function nf(a) {
    var b = a.h,
      c;
    for (a.v = 0; qd((c = a.current())); ) (a.v = 10 * a.v + (c - 48)), a.advance();
    return a.h !== b;
  }
  function jf(a, b) {
    var c = b.h;
  ...
  function mf(a, b) {
    if (b.m(40)) {
      9 <= a.options.o
        ? b.m(63) && (qf(a, b) ? (-1 !== b.yb.indexOf(b.L) && b.j("Duplicate capture group name"), b.yb.push(b.L)) : b.j("Invalid group"))
  ...
  function qf(a, b) {
    ...
    if (b.m(60)) {
      ...
      92 === e && sf(b, d) && (e = b.v);
      d = e;
      Fc(d, !0) || 36 === d || 95 === d ? ((b.v = e), (c = !0)) : ((b.h = c), (c = !1));
      if (c) {
        for (b.L += Vc(b.v); tf(a, b); ) b.L += Vc(b.v);
        a = !0;
      } else a = !1;
  ...
  function tf(a, b) {
    ...
    92 === a && sf(b, d) && (a = b.v);
    d = a;
    if (Gc(d, !0) || 36 === d || 95 === d || 8204 === d || 8205 === d) return (b.v = a), !0;
    b.h = c;
    return !1;
  }
  function sf(a, b) {
    ...
    if (a.m(117)) {
      ...
      if ((d = b && a.m(123))) {
        d = a.h;
        var e;
        for (a.v = 0; rd((e = a.current())); ) (a.v = 16 * a.v + sd(e)), a.advance();
        d = a.h !== d;
      }
  ...
  function of(a, b) {
    ...
    if (b.U && 9 <= a.options.o && ((d = 80 === c) || 112 === c)) {
      ...
      if ((a = b.m(123))) {
        a: {
          var e = b.h;
          for (b.L = ""; pd((a = b.current())); ) (b.L += Vc(a)), b.advance();
          if ("" !== b.L && b.m(61) && ((a = b.L), vf(b))) {
            e = b.L;
            Qc.call(b.Ub.ua, a) || b.j("Invalid property name");
  ...
  function pf(a) {
    ...
    b || (48 !== a.current() || qd(Dd(a, Ed(a, a.h, !1), !1)) ? (b = !1) : ((a.v = 0), a.advance(), (b = !0)));
    if (!b)
      a: {
        b = a.h;
        if (a.m(120)) {
    ...
    !(b = b || sf(a, !1)) &&
      (b = !a.U) &&
      (xf(a)
        ? ((b = a.v), xf(a) ? ((c = a.v), 3 >= b && xf(a) ? (a.v = 64 * b + 8 * c + a.v) : (a.v = 8 * b + c)) : (a.v = b), (b = !0))
        : (b = !1));
    return b || yf(a);
  }
  function wf(a) {
  ...
  function vf(a) {
    var b;
    for (a.L = ""; od((b = a.current())); ) (a.L += Vc(b)), a.advance();
    return "" !== a.L;
  }
  function rf(a, b) {
    ...
    if (b.Tb) {
      a: {
        ...
        if (!zf(a, b))
          if ((d = Af(a, b))) {
            2 === d && (c = 2);
            for (var e = b.h; Fd(b, [38, 38]); )
              38 !== b.current() && (d = Af(a, b)) ? 2 !== d && (c = 1) : b.j("Invalid character in character class");
            if (e !== b.h) {
              a = c;
              break a;
            }
            for (; Fd(b, [45, 45]); ) Af(a, b) || b.j("Invalid character in character class");
            if (e !== b.h) {
              a = c;
              break a;
            }
  ...
  function Cf(a, b) {
    ...
    if (!b.U && b.m(99)) {
      var d = b.current();
      qd(d) || 95 === d ? ((b.v = d % 32), b.advance(), (d = !0)) : (d = !1);
      if (d) return !0;
      b.h = c;
    }
    return of(a, b) || pf(b);
  ...
  function zf(a, b) {
    ...
    if (Df(b)) {
      a = b.v;
      if (b.m(45) && Df(b)) return (c = b.v), -1 !== a && -1 !== c && a > c && b.j("Range out of order in character class"), !0;
      b.h = c;
    }
    return !1;
  }
    ...
    if (Df(b)) b = 1;
      ...
      a: {
        ...
        if (Fd(b, [92, 113])) {
          if (b.m(123)) {
            var d;
            for (d = Ef(a, b); b.m(124); ) 2 === Ef(a, b) && (d = 2);
            if (b.m(125)) {
              c = d;
              break a;
            }
        ...
        case 47:
          switch (a.input.charCodeAt(a.h + 1)) {
            case 42:
              ...
              if (b.options.ma) {
                var f;
                for (f = d; -1 < (f = Lc(b.input, f, b.h)); ) ++b.ab, (f = b.gb = f);
              }
              b.options.Ga && b.options.Ga(!0, b.input.slice(d + 2, e), d, b.h, c, Ld(b));
              break;
            case 47:
              Nd(a, 2);
              break;
          ...
          break;
        default:
          if ((8 < b && 14 > b) || (5760 <= b && Mc.test(String.fromCharCode(b)))) ++a.h;
          else break a;
      }
    }
  }
  ...
  function Vd(a, b) {
    switch (b) {
      ...
      case 47:
        b = a.input.charCodeAt(a.h + 1);
        a.W ? (++a.h, Te(a)) : 61 === b ? X(a, G.assign, 2) : X(a, G.ud, 1);
        return;
      case 37:
      case 42:
      ...
      case 45:
        c = a.input.charCodeAt(a.h + 1);
        c === b
          ? 45 !== c || a.D || 62 !== a.input.charCodeAt(a.h + 2) || (0 !== a.ba && !Jc.test(a.input.slice(a.ba, a.h)))
            ? X(a, G.tc, 2)
            : (Nd(a, 3), Sd(a), Jd(a))
          : 61 === c
          ? X(a, G.assign, 2)
      ...
      case 35:
        a: {
          b = 35;
          if (13 <= a.options.o && (++a.h, (b = Td(a)), Fc(b, !0) || 92 === b)) {
            K(a, G.jb, Ud(a));
            break a;
          }
          a.j(a.h, "Unexpected character '" + Vc(b) + "'");
        }
        return;
    }
    a.j(a.h, "Unexpected character '" + Vc(b) + "'");
  ...
  function Ff(a, b) {
    ...
    !d && !b && 11 <= a.options.o && 110 === e
      ? ((d = Cd(a.input.slice(c, a.h))), ++a.h, Fc(Td(a)) && a.j(a.h, "Identifier directly after number"), K(a, G.Ua, d))
      : (d && /[89]/.test(a.input.slice(c, a.h)) && (d = !1),
        46 !== e || d || (++a.h, Hf(a, 10), (e = a.input.charCodeAt(a.h))),
        (69 !== e && 101 !== e) ||
          d ||
          ((e = a.input.charCodeAt(++a.h)), (43 !== e && 45 !== e) || ++a.h, null === Hf(a, 10) && a.j(c, "Invalid number")),
        Fc(Td(a)) && a.j(a.h, "Identifier directly after number"),
        (b = a.input.slice(c, a.h)),
  ...
  function Ud(a) {
    ...
    for (var b = "", c = !0, d = a.h, e = 6 <= a.options.o; a.h < a.input.length; ) {
      var f = Td(a);
      if (Gc(f, e)) a.h += 65535 >= f ? 1 : 2;
      else if (92 === f)
        (a.C = !0),
          (b += a.input.slice(d, a.h)),
          (d = a.h),
          117 !== a.input.charCodeAt(++a.h) && If(a, a.h, "Expecting Unicode escape sequence \\uXXXX"),
          ++a.h,
          (f = Jf(a)),
          (c ? Fc : Gc)(f, e) || If(a, d, "Invalid Unicode escape"),
          (b += Vc(f)),
          (d = a.h);
      else break;
      c = !1;
  ...
  function If(a, b, c) {
    if (a.sc && 9 <= a.options.o) throw hd;
    a.j(b, c);
  }
  function Jf(a) {
  ...
  function gd(a, b) {
    ...
    switch (c) {
      ...
      case 56:
      case 57:
        a.P && If(a, a.h - 1, "Invalid escape sequence"), b && If(a, a.h - 1, "Invalid escape sequence in template string");
      default:
        if (48 <= c && 55 >= c) {
          ...
          ("0" === d && 56 !== c && 57 !== c) ||
            (!a.P && !b) ||
            If(a, a.h - 1 - d.length, b ? "Octal literal in template string" : "Octal literal in strict mode");
          return String.fromCharCode(e);
        }
        return Kc(c) ? "" : String.fromCharCode(c);
    }
  }
  var Mf = class {
      constructor(a) {
        ...
        this.options = b = ad(b);
        this.Fb = b.Fb;
        this.qb = Uc(Ac[6 <= this.options.o ? 6 : "module" === b.kb ? "5module" : 5]);
        var c = "";
        !0 !== b.ub && ((c = zc[6 <= this.options.o ? 6 : 5 === b.o ? 5 : 3]), "module" === b.kb && (c += " await"));
        this.Kd = Uc(c);
        c = (c ? c + " " : "") + zc.P;
        this.Md = Uc(c);
        this.Nd = Uc(c + " " + zc.Ke);
        ...
        this.O = this.nc = Ld(this);
        this.pa = this.ya = null;
        this.A = this.ba = this.h;
        this.context = [I.$a];
        this.W = !0;
        this.P = (this.D = "module" === b.kb) || Md(this, this.h);
        this.Xa = -1;
        this.Gb = !1;
        this.i = this.g = this.s = 0;
        this.l = [];
        this.M = {};
        0 === this.h && b.ac && "#!" === this.input.slice(0, 2) && Nd(this, 2);
        this.u = [];
        Od(this, 1);
        this.Hc = null;
        this.F = [];
      ...
      get Jd() {
        return 0 < (Pd(this).flags & 2);
      }
      get pb() {
        return 0 < (Pd(this).flags & 8) && !Pd(this).Fa;
      }
      get ra() {
        return 0 < (Pd(this).flags & 4) && !Pd(this).Fa;
      }
      get ob() {
    ...
    Lf = class {
      constructor(a) {
        ...
        this.start = a.start;
        this.end = a.end;
        a.options.ma && (this.Ob = new Yc(a, a.O, a.nc));
  ...
  Y.ImportSpecifier = Y.ImportDefaultSpecifier = Y.ImportNamespaceSpecifier = Y.Identifier = Y.PrivateIdentifier = Y.Literal = Pf;
  ...
  var cg = {
    ...
    ArrowFunctionExpression: function (a, b) {
      ...
      const c = a.T;
      null != c && (1 === c.length && "I" === c[0].type[0] ? b.write(c[0].name, c[0]) : Tf(b, a.T));
      b.write(" => ");
    ...
    Literal: function (a, b) {
      null != a.raw ? b.write(a.raw, a) : null != a.Wc ? b.write(a.Wc + "n", a) : b.write(Qf(a.value), a);
    }
  };
  const dg = {};
  class eg {
    constructor() {
      this.i = "";
      this.aa = null != dg.aa ? dg.aa : cg;
      this.$ = null != dg.$ ? dg.$ : Sf;
      this.ta = null != dg.ta ? dg.ta : "  ";
  ...
  function ng(a) {
    ...
    const c = og(a, b, new RegExp("function(?: [a-zA-Z0-9$_]+)?\\([a-zA-Z0-9$_,]+\\){[^;]+;[a-zA-Z0-9$_]+=" + A(b.key.toString()) + "\\(")),
      d = og(a, c.path);
    var e = pg(a, d.path)
      .map((p) =>
        p.path.value
    ...
    const f = e[1],
      h = e[2],
      g = e[3];
    e = qg(d.path.value.toString(), c.path.key.toString()).find((p) => 4 < p.length);
    ...
    const [k, m] = e
      ...
      t = (p, u, r) => {
        let v = 0;
        for (let x = 0; x <= r; x++) {
          const z = Ja("this" + q[0].replace("[" + m + "]", ""), { this: "object" === typeof u ? u : p[f][u] });
          x in z && (v = x);
        }
        return v;
      };
    a.l = (p, u, r) => {
      const v = t(p, u, r),
        x = q.map((va) => Ja("this" + va, { this: "object" === typeof u ? u : p[f][u], [m]: v }));
      var z = Ja(h, { this: p });
      const L = Ja(g + d.link[0][0] + c.link[0][0], { this: p }),
        H = n.map((va) => Ja("this" + va, { this: "object" === typeof u ? u : p[f][u], [k]: r }));
      z = [L, H[0], ...x, z];
  ...
  function pg(a, b, c = new RegExp("(?<!function )(?<![a-zA-Z0-9$_])" + A(b.key.toString()) + "\\(")) {
      ...
      if (!this.A) {
        ...
        a.parent[a.key] = function (...d) {
          try {
            (() => {
              const [e, , f] = d;
              var h = Ja(c, { a: e }).getData();
              const g = { fc: [] };
              b.i.get(h) || uc(b.C, e, c);
              b.i.set(h, g);
              h[nc] = g;
              h[lc] = f;
              h[mc] = b.D.bind(b, e);
              h[oc] = b.u.bind(b, e);
              for (const k in e) e[k] && "object" === typeof e[k] && !Array.isArray(e[k]) && (e[k][oc] = b.u.bind(b, e));
  ...
  function Pg() {
    ...
    for (const c of b) "CANVAS" === c.tagName && (b = Qg.get(c)) && a.push(b);
    return a;
  }
  var Qg = new WeakMap();
  function Rg(a, b) {
  ...
  const Vg = () => ({ transform: { a: 1, b: 0, c: 0, d: 1, e: 0, f: 0 }, fillStyle: "", font: "", clip: null });
  function Wg(a, b) {
    var c = a.i.get(b);
    return c && 0 !== c.length ? c[c.length - 1] : ((c = Vg()), a.i.set(b, [c]), c);
  }
            ...
            if ("save" === c.G) {
              {
                ...
                let f = this.i.get(b);
                (f && 0 !== f.length) || ((f = [Vg()]), this.i.set(b, f));
                f.push(d);
              }
            }
              ...
              "clip" === c.G &&
                ...
                2 > c.length ||
                  ...
                  "call" === b.type &&
                    ...
                    e.clip && ((c = Rg(Sg(b), e.clip)), null !== c && (b = c)),
                    (e.clip = b))));
          }
        }
      };
    ...
    for (const { Ge: q, wc: t } of b)
      for (const p of q) {
        ...
        for (var m = 0; m < g.length; m++) {
          const x = g[m];
          var n = Ug(x.rect, { left: b, top: x.rect.top, width: r, height: x.rect.height });
          0 === n.length
            ? (g.splice(m, 1), m--)
            : 1 === n.length
            ? (x.rect = n[0])
  ...
  var dh = class {
    ...
    clear(a, b = { left: -1e8, top: -1e8, width: 2e8, height: 2e8 }) {
      Zg(this, a).ea.clearRect(b.left, b.top, b.width, b.height);
    }
  };
  function eh(a) {
      ...
      for (const k of c) {
        ...
        if (e.data) {
          var f = e.data.eb(),
            ...
            g = [];
          for (const { wc: m, S: n } of Mg(c.F, f)) (f = e.data.sa(n)), 0 !== f.length && g.push({ Ge: f, wc: m });
          if (0 !== g.length) {
            {
              c = Zg(c.D, d);
              c.ld.parentNode || d.canvas.after(c.ld);
              const { Me: m, ve: n } = ch(h, g);
              try {
                c.ea.save();
      ...
      const e = new WeakMap(),
        ...
        h = (g, k) => {
          if ("set" !== k.type) {
            ...
            k = k.I;
            try {
              if ((Qg.has(g.canvas) || Qg.set(g.canvas, g), "clearRect" === m || "fillRect" === m)) {
                const [Oc, Pc, ma, Nb] = k;
                f.set(g, 0);
                var n = this.l.get(g);
                if (n) {
                  var q = Wg(this.A, g),
                    t = Sg({
                      left: Oc * q.transform.a + q.transform.e,
                      top: Pc * q.transform.d + q.transform.f,
                      width: ma * q.transform.a,
                      height: Nb * q.transform.d
                    });
                  if (q.clip) {
                    const da = Rg(t, q.clip);
                    null === da ? (t = null) : (t = Sg(da));
                  }
                  if (null !== t) {
                    var p = [];
                    for (const da of n) {
                      const na = Rg(t, da.rect);
                  ...
                  r = k[0];
                {
                  ...
                  a: {
                    ...
                    k = `${L}:${z}`;
                    const Xe = x.g.get(k);
                    if (void 0 !== Xe) var H = Xe;
                    else {
                      var va = x.i;
                      try {
                        va.save();
                        va.font = L;
                        const Ye = L.match(/([\d.]+)px/),
                          Ze = { width: va.measureText(z).width, height: Ye ? parseFloat(Ye[1]) : 12 };
                        x.g.set(k, Ze);
                        H = Ze;
                        break a;
                      } finally {
                  ...
                  const { width: na, height: Kh } = H;
                  var Lh = { width: na * v.a, height: Kh * v.d, left: t.left * v.a + v.e, top: t.top * v.d + v.f };
                }
                const da = {
                  sf: u,
                  data: null,
  ...
  var jh = class extends ca {
    ...
    remove(a, b) {
      ...
      void 0 !== c &&
        ...
        a.remove(b),
        0 === c.hb.length && ((a = ih(this, a)), void 0 !== a && ((a = this.i.indexOf(a)), -1 !== a && this.i.splice(a, 1))));
    }
    clear() {
  ...
  function uh(a, b, c) {
    ...
    for (let g = 0; g < c.length; g++) {
      ...
      if (0 === f.kind) {
        ...
        for (const m of f) (f = new rh(e)), f.add(g, { start: m, end: m + k.length }), d.push(f);
        3 < g &&
          (d = d
            .sort((m, n) => {
  ...
  var wh = class {
    ...
    match(a, b) {
      ...
      c = uh(this, d[0].text, b).reduce((h, g) => {
        const k = g.g.length,
          m = h.get(k) || [];
        m.push(g);
        h.set(k, m);
  ...
  function yh(a) {
    ...
    const c = null !== (b = a.g) && void 0 !== b ? b : xh();
  ...
  var Ch = class {
      ...
      ed(a, b) {
        this.i.includes(a) || this.i.push(a);
        var c = Ea(b.text);
        c = { text: c, kind: 1 === b.kind || sh(c).match(/^(([a-zA-Z0-9]\.)+|[\w\W])$/) ? 1 : 0 };
      ...
      fd() {
        ...
        for (const b of this.i) {
          ...
          if (!c) continue;
          c.Ra = null;
          const d = new wh().match(Rb(this.A), c.items);
      ...
      sa(a) {
        ...
        for (const e of c) {
          ...
          if (d) {
            ...
            for (const f of d.Ca)
              if (f.data && ((d = f.data.eb()), (d = Jg(a, d)) && d.start !== d.end)) {
                d = f.data.sa(d);
                for (const h of d)
                  b.push({
  ...
  function Jh(a, b) {
    if (a.i && a.l) return Jh(a.i, { start: a.l.start + b.start, end: a.l.start + b.end });
    ...
    c = new Mh(
      (d) => {
        ...
        const f = d.i;
        d = d.l;
        f && d && (e = Nh(f, { start: 0, end: d.start }));
        return a.u(a) + e;
      },
      (d, e) => {
        ...
        const g = d.i;
        d = d.l;
        g && d && (h = Nh(g, { start: 0, end: d.start }));
        return Hh(a, { start: h + Math.min(Math.max(e.start, 0), f), end: h + Math.min(Math.max(e.end, 0), f) });
      }
    );
    c.F = a.F;
  ...
  var Ph = class {
    g(a, b, c, d) {
      ...
      f = Jh(d, { start: 0, end: e });
      d = Jh(d, { start: e, end: d.g.length });
  ...
  var Qh = class {
    g(a, b, c, d) {
      ...
      if (-1 === e && d.D) return Oh(d.D, d.g.length), Ih(d), 1;
      if (-1 !== e) {
        {
          var f = d.g;
          var h = e;
        ...
        0 < f.start && ((h = d.D), (h && Oh(h, f.start)) || (f.start = 0));
        if (0 === f.end - f.start) return 0;
        a(Jh(d, f));
        f.end !== d.g.length && c.unshift(Jh(d, { start: f.end, end: d.g.length }));
        Ih(d);
      }
      return 0;
    }
  ...
  var Th = class {
    qc() {
      ...
      var b = window;
      for (const { value: c } of Sh(b))
        if ("function" === typeof c && c.toString().match(a) && "prototype" in c) {
          b = c.prototype;
          for (const { key: d, value: e } of Sh(b)) {
            const f = e.toString();
            if (
              f.match(
  ...
  var Yh = class {
    qc() {
      const a = [],
        b = window;
      for (const { key: c, value: d } of Sh(b)) {
        if ("function" !== typeof d) continue;
        const e = d.toString();
  ...
  function bi(a, { I: b }) {
    (() => {
      ...
      if (d[oc]) {
        d[pc] !== ai &&
          ((c = (() => {
            for (const { key: k, value: m } of Sh(d)) if ("object" === typeof m && !Array.isArray(m) && "execute" in m) return k;
            return null;
          })()),
          null !== c && (d[c] = null),
          (d[pc] = ai));
        c = a.i.splice(0, a.i.length);
        for (var e of c) e.D && (Oh(e.D, e.g.length), Ih(e));
        if (
          ...
          if (0 !== e.length) {
            ...
            for (let k = 0; k < e.length; k++) {
              ...
              h || ((h = new Mh(p, (u, r) => d[oc](r))), (h.F = c), a.i.push(h));
              h.g = h.g.concat(n);
              h.A = h.A.concat(q);
              h.s = h.s.concat(g);
              f += n.join("").length;
  ...
  function ei(a, b, c, d, e, f, h) {
    let g = null;
    Array.isArray(d) ? (d = d.map((k) => Ea(k))) : (d = Ea(d));
    try {
      const k = () => {
        const m = a.i.shift();
        m && (m && m.F ? ((m.F = !1), a.i.unshift(m)) : 1 === (Array.isArray(d) ? new Ph() : new Qh()).g((n) => (g = n), d, a.i, m) && k());
      };
      k();
    } catch (k) {
      console.error(k);
      ...
      try {
        if (null !== g && !a.C) {
          ...
          if (Array.isArray(d) && Array.isArray(e) && Array.isArray(f) && Array.isArray(h)) {
            ...
            const { x: n, y: q } = m();
            k = fi(a, g, c, { x: e, y: f, md: n, xc: q, width: h, text: d });
          }
        }
      } catch (n) {
        console.error(n);
      ...
      a.l.push(e, {
        ...
        sa: (x) => {
          ...
          return L.start === L.end
            ? []
            : Hh(b, L).map((H) => ({ left: H.left + m, top: n - H.height, width: H.width, height: 1.2 * H.height }));
        }
      });
    }
    return 0;
  }
  var gi = class extends ca {
    constructor(a) {
      super();
      this.va = new y();
      this.ya = new y();
      ...
      this.i = [];
      this.s = new WeakMap();
      this.F = new Wh(new Th());
      this.D = new Wh(new Yh());
      this.A = new Wh(new Zh());
      this.l = new $h(a);
      zg().g.add((b, c) => {
      ...
      this.F.l.add((b) => bi(this, b));
      this.D.i.add((b) => {
        {
          const c = b.I;
          if ("string" === typeof c[1] || Array.isArray(c[1])) {
            const [d, e, f, h, g] = c;
            b.result = ei(this, b.result, d, e, f, h, g);
          }
        }
      });
      this.A.l.add((b) => ci(this, b));
      this.A.i.add((b) => di(this, b));
    }
    g() {
      super.g();
      Vh(this.F);
    ...
    zb() {
      if (!Uh(this.F)) throw Error("Unable to install text renderer!");
      if (!Uh(this.D)) throw Error("Unable to install renderer!");
      if (!Uh(this.A)) throw Error("Unable to install render queue executor!");
      ai++;
      Ah(this.pa);
    }
  };
  function hi(a) {
    if (!a.F) {
      ...
      b.rb.add((d, e) => {
        ...
        a.l = () => ({ paragraphStarts: Lb(b), text: d });
        window.clearTimeout(c);
        c = window.setTimeout(() => ii(a));
      });
    }
    return a.F;
  }
        ...
        a: {
          if (b.detail && "string" === typeof b.detail) {
            ...
            if ("object" === typeof c && "string" === typeof c.id && "string" === typeof c.type && Array.isArray(c.args)) {
              ...
              c = c.args;
              try {
                (d = pi(this, e, c)), qa(b, d);
              } catch (f) {
                f instanceof Error ? ra(b, f) : ra(b, Error(f + ""));
              }
            }
          }
          d = void 0;
  ...
  function mi(a) {
    l(a, function* () {
      yield qi(this, "default");
      let b = this.g;
      ri() && (yield qi(this, "fallback"));
      (() =>
        l(this, function* () {
          for (;;) {
            try {
              ri() ? "fallback" !== this.g && ((b = this.g), yield qi(this, "fallback")) : yield qi(this, b);
            } catch (c) {
              console.error(c);
            }
  ...
  function si(a) {
    return l(a, function* () {
      const b = this.g;
      b in this.s && (yield qi(this, this.s[b].oc));
    });
  }
  function qi(a, b) {
    return l(a, function* () {
      if (this.g !== b) {
        var c = this.i,
          d = c.xb();
        d && (lh(c, null), (this.C.i = null), d.Va.clear(), d.lc());
        if (b in this.s) {
          d = this.s[b];
          try {
            const e = yield d.xb();
  ...
  function pi(a, b, c) {
    ...
    switch (b) {
      ...
      case "kQIP":
        return a.i.sa(vg(c[0])).map((e) => ({ left: e.left, top: e.top, width: e.width, height: e.height }));
      case "149D":
        kh(a.i, { Cc: c[0] });
        return;
      case "2SZD":
        return Array.from(Mb(hi(a)).entries()).map((e) => [e[0], xg(e[1])]);
      case "aBmO":
        qi(a, c[0]);
        return;
      case "YP+n":
  ...
  const vi = compiler.VERSION;
  (function () {
    return l(this, function* () {
      const a = window;
      if ("wizkids-google-docs-integration" in a)
        a["wizkids-google-docs-integration"] !== vi && console.warn("Wizkids Google Docs integration version mismatch!");
      else {
        a["wizkids-google-docs-integration"] = vi;
        try {
          ni();
        } catch (b) {
          console.error(b);
