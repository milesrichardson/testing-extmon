      ...
      o = (r.WordArray = s.extend({
        ...
        concat: function (t) {
          ...
          if (((t = t.sigBytes), this.clamp(), r % 4))
            for (var e = 0; e < t; e++) n[(r + e) >>> 2] |= ((i[e >>> 2] >>> (24 - (e % 4) * 8)) & 255) << (24 - ((r + e) % 4) * 8);
          else if (65535 < i.length) for (e = 0; e < t; e += 4) n[(r + e) >>> 2] = i[e >>> 2];
...
!(function (t) {
  ...
  e = e.SHA256 = r.extend({
    ...
    _doProcessBlock: function (t, n) {
      for (var i = this._hash.words, r = i[0], e = i[1], s = i[2], a = i[3], c = i[4], h = i[5], f = i[6], u = i[7], l = 0; 64 > l; l++) {
        if (16 > l) p[l] = 0 | t[n + l];
        else {
          var d = p[l - 15],
            g = p[l - 2];
        ...
        (d = u + (((c << 26) | (c >>> 6)) ^ ((c << 21) | (c >>> 11)) ^ ((c << 7) | (c >>> 25))) + ((c & h) ^ (~c & f)) + o[l] + p[l]),
          (g = (((r << 30) | (r >>> 2)) ^ ((r << 19) | (r >>> 13)) ^ ((r << 10) | (r >>> 22))) + ((r & e) ^ (r & s) ^ (e & s))),
          (u = f),
          (f = h),
          (h = c),
          (c = (a + d) | 0),
  ...
  (n.SHA256 = r._createHelper(e)), (n.HmacSHA256 = r._createHmacHelper(e));
})(Math);
