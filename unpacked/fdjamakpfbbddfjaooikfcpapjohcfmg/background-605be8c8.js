  ...
  [264],
  {
    ...
    15868: (e, t, r) => {
      ...
      (t.default = (e = { flow: null }, t) => {
        ...
        (t.getEmptyLoginDeviceLimitFlowState = m);
    },
    36172: (e, t, r) => {
    ...
    49154: (e, t) => {
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.DeviceLimitCapabilityEventBus = void 0);
    ...
    27331: (e, t, r) => {
      ...
      let s;
      t.DeviceLimitFlowEventsManager = a;
      t.getDeviceLimitFlowEventsManager = (e) => (s || (s = new a(e)), s);
    },
    10984: (e, t, r) => {
      Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      t.toLoginDeviceLimitFlowView = (e) => {
        switch (e.name) {
          case o.LoginDeviceLimitFlowStage.OneDeviceLimitReached:
            return (
              (s = e),
              {
                ...
                login: s.login,
                previousDevice: (0, n.toPreviousDeviceInfo)(s.deviceLimitStatus.bucketOwner),
          ...
          case o.LoginDeviceLimitFlowStage.OpeningSessionAfterDeviceLimitRemoval:
            return (r = e.name), (i = e.login), { name: r, login: i };
    ...
    36077: (e, t) => {
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.noDeviceLimit = t.limitedToMultipleDevices = t.limitedToOneDevice = void 0);
    ...
    87314: (e, t) => {
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.limitedToMultipleDevices = t.notLimitedToMultipleDevices = void 0);
    ...
    44179: (e, t) => {
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.notLimitedToOneDevice = t.limitedToOneDevice = void 0);
      t.limitedToOneDevice = (e) => ({ _tag: "limitedToOneDevice", bucketOwner: e });
    ...
    88610: (e, t, r) => {
      ...
      async function x(e, t, r, o, a, c, d) {
        try {
          ...
          await W(e, p, r), await ae(o);
          if (await S.getInstance().user.accountExistsLocally()) throw new Error("Unexpected local account presence during OTP1 step");
        ...
        try {
          ...
          if ((a?.(`accountExistLocally? ${C}`), C)) {
            const t = E.getInstance(),
              r = await t.doesLocalKeyExist();
            if ((a?.(`doesLocalKeyExist? ${r}`), r))
              try {
                const e = await t.getLocalKey();
            ...
            C
              ? (a?.("initLocalSession START"),
                ...
                await (async function (e, t) {
                  ...
                  await a.refreshSessionData(), t?.requiredPermissions && (await $(o, r, t.requiredPermissions));
                  const c = await (0, F.attemptGetDeviceLimitStatus)(e);
                  if ("noDeviceLimit" !== c._tag) return await (0, F.startDeviceLimitFlow)(e, c), n.LoginResultEnum.DeviceLimitFlow;
                  return ee(e, t);
                })(e, o))
      ...
      (t.makeLoginController = (e) => ({
        ...
        openSessionWithToken: (t, r, o, a, c) =>
          (async function (e, t, r, o, a, c) {
            try {
              ...
              (t = (0, I.normalizeEmail)(t)), await W(e, t, r), await se(o);
              if (await u.getInstance().user.accountExistsLocally())
        ...
        openSessionWithDashlaneAuthenticator: (t, r, o, a) =>
          (async function (e, t, r, o, a) {
            try {
              ...
              (t = (0, I.normalizeEmail)(t)), await W(e, t, r);
              if (await d.getInstance().user.accountExistsLocally())
        ...
        openSessionWithOTP: (t, r, o, a, s) =>
          (async function (e, t, r, o, a, s) {
            ...
            try {
              (t = (0, I.normalizeEmail)(t)), await W(e, t, r), await ae(o);
              if (!(await E.getInstance().user.accountExistsLocally())) return x(e, t, r, o, a, void 0, s);
        ...
        openSessionWithExtraDeviceToken: (t, r, o, a) =>
          (async function (e, t, r, o, a) {
            try {
              ...
              await W(e, t, u, { authorizeDifferentLogin: ce.AUTHORIZED }), await se(r);
              if (await d.getInstance().user.accountExistsLocally())
                throw new Error(i.AuthenticationCode[i.AuthenticationCode.TOKEN_PROVIDED_FOR_LOCAL_SESSION]);
    ...
    9639: (e, t, r) => {
      ...
      t.loginViaSSO = async function (e, t) {
        ...
        try {
          ...
          r.setInstance(I, void 0);
          return (await r.getInstance().user.accountExistsLocally()) ? await L(e, v) : await U(e, v);
        } catch (t) {
          return (
    ...
    90822: (e, t) => {
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.loginNotificationListSelector = void 0);
    ...
    16088: (e, t) => {
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.loginStepInfoSelector = void 0);
    ...
    82569: (e, t, r) => {
      ...
      t.formatLogEntry = (e) => (t) => {
        const { details: r = {}, level: o = n.LogLevel.Debug, message: c, tag: l = [] } = t,
          u = (function (e) {
            const t = Array.isArray(e) ? e : [e];
            return t.length ? ` [${t.join(s)}]` : "";
          })(l),
          S = d[o],
          p = Boolean(c),
          m = p ? ` ${c}` : "",
          g = (function (e, t, r) {
            return Object.keys(t).reduce(
              (o, n) => (!Number.isInteger(parseInt(n, 10)) && r ? `${o}${a}${n}${i}${e(t[n])}` : `${o}${a}${e(t[n])}`),
              ""
            );
          })(e, r, p);
        return `${S}${u}${m}${g}`;
      ...
      t.makeEventLoggerService = (e) => {
        ...
        return {
          ...
          logEvent: async (o) => {
            ...
            if (!(!1 !== n)) return;
            return r().createLogger().logEvent(o), (0, c.storeEventsInQueue)(e, t);
          },
          logSync: async (o) => {
            const { interactionDataConsent: n } = await (0, d.getGlobalExtensionSettings)(e);
            if (!(!1 !== n)) return;
    ...
    39261: (e, t) => {
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.styxKeysSelector = void 0);
    ...
    74450: (e, t, r) => {
      ...
      t.default = function (e) {
        return (function (e, t, r) {
          ...
          if (((a[o] = a[o] || 0), a[o]++, a[o] > t)) return Promise.resolve();
          return r();
        })(e, i, () =>
    ...
    45709: (e, t, r) => {
      ...
      t.savePasswordGenerationSettingsHandler = async function (e, t) {
        try {
          const n = (0, a.fixIncoherentSettings)(t),
            i = {
              GeneratorDefaultSize: (r = n).length,
          ...
          (0, s.updatePersonalSettings)(e.storeService, e.sessionService, i),
    ...
    47820: (e, t, r) => {
      ...
      (t.getSetupRequisitesData = async function (e, t) {
        ...
        (t.triggerCleanOrSetupAccountRecovery = async function (e) {
          const { storeService: t, localStorageService: r, wsService: o } = e,
            n = t.getState();
          if ((0, A.recoveryInProgressSelector)(n)) return;
          ...
          if (
            await (async function (e, t) {
              ...
              if (n && i) return (0, T.recoveryHashFromPersonalSettingsSelector)(r) !== (0, T.recoveryHashFromPremiumStatusSelector)(r);
              return !0;
            })(t, r)
          )
            return void (await (0, v.setupAccountRecoveryForDevice)(t, r, o));
          (await (async function (e, t) {
    ...
    87993: (e, t, r) => {
      ...
      async function S(e, t) {
        ...
        d(r);
        return (await r.isRemoteFileContentExist(t))
          ? c.DownloadedFile.fromBase64Str(t, await r.getRemoteFileContent(t))
          : Promise.resolve(null);
      }
      async function p(e, t) {
        const r = e.getLocalStorage();
        d(r);
        return (await r.itemExists(t)) ? c.DownloadedFile.fromBase64Str(t, await r.readItem(t)) : Promise.resolve(null);
      }
    ...
    36428: (e, t, r) => {
      ...
      (t.callRemoteFileUpdateHandler = s),
        ...
        return (
          (_ =
            f?.ssoInfo.serviceProviderUrl && "mp_user_to_sso_member" !== f?.ssoInfo.migration
              ...
              : (function (e, t = []) {
                  const r = (function (e) {
                    const t = e.some((e) => "totp" === e.type);
                    if (t) return c.OtpType.OTP_LOGIN;
                    const r = e.filter((e) => "sso" !== e.type);
                    if (r.length > 0) throw new Error("Unsupported 2FA method requested");
                    return null;
                  })(t);
                  if (
                    ((function (e, t) {
    ...
    15718: (e, t) => {
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.pairingIdSelector = t.isPairingEnabledSelector = void 0);
        ...
        (t.checkLoginWithUki = async function (e, t, r) {
          ...
          if (
            !(await (async function (e, t, r) {
              const o = await e.authentication.validity({ login: t, uki: r });
              return "UKI VALID" === o;
            })(t, o, r))
          )
    ...
    19695: (e, t) => {
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.iconsFromStorage = t.iconsToStorage = void 0);
    ...
    12706: (e, t) => {
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.isSSOAccountCreationSelector = void 0);
    ...
    25421: (e, t) => {
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.accountAuthenticationTypeSelector = void 0);
    ...
    81200: (e, t, r) => {
      ...
      (t.getDefaultCredentialsDedupView = n),
    ...
    73472: (e, t, r) => {
      ...
      t.getEmptyLoginStepInfo = d;
      const l = (e, t) => ([n.LoginStep.Password, n.LoginStep.OTPToken].includes(t) ? t : e.step),
        u = (e, t) => (t === n.LoginStep.OTPToken ? Boolean(e.login) : ![n.LoginStep.OTP1, n.LoginStep.OTP2].includes(t) && e.validated),
        S = (e, t) => Object.entries(t).every(([t, r]) => e?.[t] === r);
      t.default = (e = p(), r) => {
        switch (r.type) {
          ...
          case a.WEB_ONBOARDING_MODE_UPDATED: {
            const t = (0, o.mergeDeepRight)(p(), e);
          ...
          case s.USER_MESSAGES_DISMISSED:
            return Object.assign({}, e, {
              userMessages: e.userMessages.some((e) => S(e, r.predicate))
                ? e.userMessages.map((e) => (S(e, r.predicate) ? { ...e, dismissedAt: Date.now() } : e))
          ...
          case i.UPDATE_LOGIN_STEP_INFO_STEP:
            return Object.assign({}, e, {
              loginStepInfo: { ...e.loginStepInfo, step: l(e.loginStepInfo, r.step), validated: u(e.loginStepInfo, r.step) }
            });
      ...
      (t.getEmptyOnboardingMode = () => ({
        ...
        (t.getEmptyLocalSettings = p);
    },
    73299: (e, t) => {
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.deviceNameSelector = void 0);
    ...
    56857: (e, t) => {
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.notificationsStatusSelector = void 0);
    ...
    20810: function (e, t, r) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }), n(r(10691), t), n(r(76556), t);
    },
    13042: (e, t, r) => {
    ...
    84827: (e, t) => {
      ...
      (t.setElementsAsSeenAction = (e, r) => ({ type: t.SET_ELEMENTS_AS_SEEN, pendingItemGroupIds: e, pendingUserGroupIds: r })),
        (t.default = (e = { pendingItemGroups: [], pendingUserGroups: [] }, r) => {
          switch (r.type) {
            case t.SET_ELEMENTS_AS_SEEN: {
              const { pendingUserGroupIds: t, pendingItemGroupIds: o } = r;
              return {
                pendingUserGroups: n(e.pendingUserGroups, t, "groupId"),
                pendingItemGroups: n(e.pendingItemGroups, o, "itemGroupId")
              };
            }
            case t.UPDATE_ALL_PENDING: {
              const { pendingUserGroups: t, pendingItemGroups: n } = r,
                i = o(e.pendingItemGroups, n, "itemGroupId");
              return { pendingUserGroups: o(e.pendingUserGroups, t, "groupId"), pendingItemGroups: i };
            }
            case t.SET_ALL_PENDING: {
              const { pendingUserGroups: e, pendingItemGroups: t } = r;
    ...
    63703: (e, t) => {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        (t.default = (e = r(), o) => (o.type === t.SET_SSO_SETTINGS ? Object.assign({}, e, { ...o.data }) : e)),
      ...
      (t.default = (e = { teams: {} }, t) => {
        switch (t.type) {
          ...
          case o.GROUP_ADMIN_ITEM_CREATED:
            const p = t,
              m = ((r = e.teams), (i = p.teamId), (r[i] && r[i].userGroupAdminItems) || []);
    ...
    69795: (e, t, r) => {
      ...
      (t.default = (e = n(), t) => (t.type === o.LAST_SENT_AT_UPDATED ? { ...e, lastSentAt: t.lastSentAt } : e)),
      ...
      t.convertTokenToAuthTicket = async (e, t) => {
        ...
        switch ((e.dispatch((0, s.resetAuthTicketInfo)()), t.type)) {
          case "emailToken":
            ...
            break;
          case "extraDeviceToken":
            return (0, n.isExtraDeviceTokenValid)(t.value) ? { success: !0, authTicket: void 0 } : l(o.AuthenticationCode.TOKEN_NOT_VALID);
          case "sso":
    ...
    27754: (e, t) => {
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.sessionStartTimeSelector = t.sessionIdSelector = void 0);
    ...
    80687: (e, t) => {
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.authorizationMiddleware = void 0);
    ...
    18324: (e, t, r) => {
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.debugMiddleware = void 0);
      r(4939), new Map();
    ...
    88626: function (e, t, r) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }), n(r(91069), t), n(r(57307), t);
    },
    91069: (e, t) => {
      Object.defineProperty(t, "__esModule", { value: !0 });
    },
    ...
    30137: function (e, t, r) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }), n(r(88626), t);
    },
    25566: (e, t, r) => {
    ...
    36884: (e, t, r) => {
      ...
      async function A(e, t, r) {
        const o = r
          ? await (async function (e, t, r) {
              ...
              return { groupKey: await o.asymmetricEncryption.encrypt(r, t), proposeSignature: s };
      ...
      async function y(e, t, r, o, n) {
        ...
        return {
          ...(t.privateKey ? { acceptSignature: await T(r, n, t.privateKey) } : {}),
          ...u,
          ...S,
          alias: e,
          permission: o,
      ...
      async function v(e, t, r, o, n, d) {
        ...
        return { groupId: l, permission: t, groupKey: p, proposeSignature: g, acceptSignature: await T(d, r, S) };
      }
      async function T(e, t, r) {
        const o = await (0, a.makeCryptoService)(),
      ...
      (t.ACCEPT_ITEM_GROUP = "acceptItemGroup"),
        ...
        (t.makeItemGroupService = function (e, r) {
          return {
            ...
            makeCreateItemGroupEvent: p,
            makeInviteItemGroupMembers: m,
            makeUpdateItemGroupMembers: E,
            makeUserUpdate: A,
            makeUserGroupUpdate: I,
            makeUserUpload: y,
            makeUserGroupInvite: v,
            ...
            deleteItemGroup: ({ login: t, uki: r }, o) => l(e, t, r, o),
            makeAcceptItemGroupEvent: u,
            makeRefuseItemGroupEvent: S,
            makeRevokeItemGroupMembers: g
          };
        });
    },
    10294: (e, t, r) => {
      ...
      (t.userMemberIsAdmin = (e) => "accepted" === e.status && "admin" === e.permission),
        ...
        (t.isItemGroupAccepted = function (e, t, r, o) {
          if (
            (function (e, t, r, o) {
              ...
              try {
                ...
                if (i.flatMap((e) => e.users).some((e) => e.acceptSignature && e.login === r)) return !0;
                return i
          ...
          if (
            ...
            return !0;
          return (function (e, t, r) {
            const o = (e.groups || []).filter((e) => "accepted" === e.status && e.acceptSignature),
              n = o.map((e) => e.groupId),
              i = t.filter((e) => n.includes(e.groupId));
            return i.some((e) => (e.users || []).some((e) => e.userId === r && "accepted" === e.status && Boolean(e.acceptSignature)));
          })(e, t, r);
        }),
            ...
            return o.reduce((o, { itemGroupId: n }) => {
              ...
              const s = (function (e, t, r) {
                const { groupId: o, revision: n } = r,
                  i = e.makeRefuseItemGroupEvent(o, n, null),
                  a = { type: "user", alias: t.alias };
                return { _tag: "refuse_pending_itemgroup", action: i, recipient: a };
              })(e, a, i);
              return o.concat(s);
            }, []);
          })(e, r, o, s);
        ...
        const { elementsToCreate: n } = (function (e, t, r) {
          ...
          { elementsToUpdate: i, elementsToDelete: a } = (function (e, t, r, o) {
            const n = t.map((e) => e.id),
              i = { elementsToUpdate: [], elementsToDelete: [] };
            return e.reduce((e, i) => {
              const a = n.indexOf(i[r]);
              if (a < 0) return { ...e, elementsToDelete: [...e.elementsToDelete, i[r]] };
              return t[a][o] > i[o] ? { ...e, elementsToUpdate: [...e.elementsToUpdate, i[r]] } : e;
            }, i);
          })(e, t, r, o);
        return []
                ...
                (async function (e, t, r, o) {
                  switch (r.type) {
                    ...
                    case _.Update: {
                      ...
                      const i = o[n.itemId];
                      if (!i) return null;
                      return (await (0, S.createOrUpdateItemEffect)(e, n, i)) ? r : null;
                    }
                  }
                          ...
                          const { permission: a, referrer: s, groupKey: c } = t,
                            d = (e.items || []).map(async (t) => {
                              try {
                                ...
                                if (!p) return null;
                                return await (0, S.getPendingItemGroup)(p, u, e.groupId, s, a, i);
                              } catch (e) {
                                return null;
                              }
                            });
    ...
    47683: (e, t, r) => {
      ...
      async function u(e, t, r, o, n) {
        try {
          ...
          if (!u) return !1;
          return await (0, a.isGroupSignatureValid)(e, d, u, l);
        } catch (e) {
      ...
      (t.validateItemGroup = async function (e, t, r, n, s, p) {
        ...
        (t.getDecryptedItemGroupKey = async function (e, t, r, o) {
          ...
          const s = n
            ...
            : await (0, a.getDecryptedItemGroupKeyFromUserGroupMember)(i, t, r, o);
          return s || null;
        }),
    ...
    52102: (e, t) => {
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.sharingDataSelector = void 0);
    ...
    46617: (e, t) => {
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.getSharingCapacity = void 0);
    ...
    7261: (e, t) => {
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.getSharingUserMappers = void 0);
    ...
    63925: (e, t, r) => {
      ...
      const o = (0, r(16516).defaultTo)("");
      t.detailView = (e) => ({ id: o(e.userId), itemCount: e.itemCount });
    ...
    779: (e, t) => {
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.getUserDownloadMappers = void 0);
    ...
    99729: (e, t, r) => {
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.listView = t.detailView = void 0);
      const o = (0, r(16516).defaultTo)("");
      t.detailView = (e) => ({ id: o(e.userId), permission: e.permission });
      t.listView = (e) => e.map(t.detailView);
    },
    79570: (e, t, r) => {
    ...
    95414: (e, t) => {
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.getUserGroupMappers = void 0);
    ...
    92215: (e, t) => {
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.convertDeviceKeysToUki = t.convertUkiToDeviceKeys = void 0);
