/*! For license information please see vendors-ab28add5.6.2346.0.js.LICENSE.txt */
(globalThis.webpackChunk_dashlane_leeloo = globalThis.webpackChunk_dashlane_leeloo || []).push([
  [2204],
  {
    ...
    349333: (t, e, n) => {
      ...
      r.inherits(c, u),
        ...
        (c.prototype._update = function (t, e) {
          for (
            var n = this.h[0], r = this.h[1], i = this.h[2], u = this.h[3], c = this.h[4], m = n, b = r, w = i, _ = u, S = c, x = 0;
            x < 80;
            x++
          ) {
            var E = s(o(h(n, f(x, r, i, u), t[d[x] + e], l(x)), y[x]), c);
            (n = c),
              (c = u),
              (u = o(i, 10)),
              (i = r),
              (r = E),
              (E = s(o(h(m, f(79 - x, b, w, _), t[g[x] + e], p(x)), v[x]), S)),
              (m = S),
              (S = _),
              (_ = o(w, 10)),
              (w = b),
      ...
      r.inherits(l, c),
        ...
        (l.prototype._update = function (t, e) {
          ...
          for (r = 0; r < n.length; r++) {
            var d = ~~(r / 20),
              g = h(s(i, 5), u(d, o, c, l), p, n[r], f[d]);
            (p = l), (l = c), (c = s(o, 30)), (o = i), (i = g);
          }
      ...
      r.inherits(m, y),
        ...
        (m.prototype._update = function (t, e) {
          ...
          for (s(this.k.length === n.length), r = 0; r < n.length; r++) {
            var S = u(_, p(m), c(m, b, w), this.k[r], n[r]),
              x = a(l(i), f(i, o, y));
            (_ = w), (w = b), (b = m), (m = a(v, S)), (v = y), (y = o), (o = i), (i = a(S, x));
          }
          (this.h[0] = a(this.h[0], i)),
            (this.h[1] = a(this.h[1], o)),
        ...
        (b.prototype._prepareBlock = function (t, e) {
          ...
          for (; r < n.length; r += 2) {
            var i = N(n[r - 4], n[r - 3]),
              ...
              c = n[r - 32],
              f = n[r - 31];
            (n[r] = p(i, o, s, a, h, u, c, f)), (n[r + 1] = d(i, o, s, a, h, u, c, f));
          }
        }),
        (b.prototype._update = function (t, e) {
          ...
          for (var C = 0; C < n.length; C += 2) {
            var I = T,
              ...
              U = y(I, R, D, z, B, H, M, V, q, F);
            (I = E(r, i)), (R = O(r, i)), (D = S(r, 0, s, 0, h)), (z = x(0, i, 0, a, 0, u));
            var K = f(I, R, D, z),
              Z = l(I, R, D, z);
            (T = A),
              (L = N),
    ...
    241901: (t, e, n) => {
      "use strict";
      if ((n.d(e, { Ep: () => f, Hp: () => p, PP: () => P, lX: () => w, ob: () => l, q_: () => k }), 8630 == n.j)) var r = n(2994);
      ...
      function w(t) {
        ...
        function C(t) {
          L
            ? ((L = !1), A())
            : P.confirmTransitionTo(t, "POP", S, function (e) {
                e
        ...
        function H(t) {
          1 === (B += t) && 1 === t
            ? (window.addEventListener(v, N), o && window.addEventListener(m, T))
            : 0 === B && (window.removeEventListener(v, N), o && window.removeEventListener(m, T));
        }
        var M = !1,
          V = {
            length: n.length,
            ...
            push: function (t, e) {
              var r = "PUSH",
                o = l(t, e, j(), V.location);
              P.confirmTransitionTo(o, r, S, function (t) {
                if (t) {
                  var e = D(o),
                    s = o.key,
                    a = o.state;
                  if (i)
                    if ((n.pushState({ key: s, state: a }, null, e), w)) window.location.href = e;
                      ...
                      var h = R.indexOf(V.location.key),
                        u = R.slice(0, h + 1);
                      u.push(o.key), (R = u), A({ action: r, location: o });
                    }
                ...
                if (t) {
                  ...
                  if (i)
                    if ((n.replaceState({ key: s, state: a }, null, e), w)) window.location.replace(e);
                      ...
                      var h = R.indexOf(V.location.key);
                      -1 !== h && (R[h] = o.key), A({ action: r, location: o });
                    }
      ...
      function k(t) {
        ...
        var e = window.history,
          ...
          h = n.hashType,
          p = void 0 === h ? "slash" : h,
          v = t.basename ? c(a(t.basename)) : "",
          m = S[p],
          b = m.encodePath,
          w = m.decodePath;
        function k() {
          var t = w(E());
          return v && (t = u(t, v)), l(t);
        }
        var j = d();
        function P(t) {
        ...
        function T() {
          ...
          if (n !== r) O(r);
            ...
            var i = k(),
              s = M.location;
            if (!A && ((e = i), (t = s).pathname === e.pathname && t.search === e.search && t.hash === e.hash)) return;
            if (N === f(i)) return;
            (N = null),
              (function (t) {
                if (A) (A = !1), P();
        ...
        var z = 0;
        function B(t) {
          1 === (z += t) && 1 === t ? window.addEventListener(_, T) : 0 === z && window.removeEventListener(_, T);
        }
        var H = !1,
          M = {
            length: e.length,
            ...
            createHref: function (t) {
              var e = document.querySelector("base"),
                n = "";
              return e && e.getAttribute("href") && (n = x(window.location.href)), n + "#" + b(v + f(t));
            },
            push: function (t, e) {
              var n = "PUSH",
                r = l(t, void 0, void 0, M.location);
      ...
      function P(t) {
        ...
        var y = j(a, 0, o.length - 1),
          v = o.map(function (t) {
            return l(t, void 0, "string" == typeof t ? g() : t.key || g());
          }),
          m = f;
        function b(t) {
    ...
    910063: (t, e, n) => {
      ...
      t.exports = function t(e, n, r) {
        if ("string" != typeof n) {
          ...
          var s = c(n);
          f && (s = s.concat(f(n)));
          for (var a = h(e), g = h(n), y = 0; y < s.length; ++y) {
            var v = s[y];
            if (!(o[v] || (r && r[v]) || (g && g[v]) || (a && a[v]))) {
              var m = l(n, v);
              try {
                u(e, v, m);
              } catch (t) {}
      ...
      (p.prototype._transform = function (t, e, n) {
        ...
        for (
          ...
          if ((this._last.push(p), this._last.length > 9 && this._last.shift(), this.raw)) {
            ...
            if ("text" !== this.state || p !== s || y(t[i + 1]))
              if (1 === this.tagState && y(p)) this.tagState = 2;
              else if (2 === this.tagState && p === f) this.tagState = 3;
              else if (3 === this.tagState && y(p));
              else if (3 === this.tagState && p !== a)
                (this.tagState = 4), (this.quoteState = p === u ? "double" : p === c ? "single" : null);
              else if (4 === this.tagState && !this.quoteState && y(p)) this.tagState = 2;
                ...
                "open" === this.state && d(this._last, l.comment)
                ...
                var v = this._getTag();
                "script" === v && (this.raw = l.endScript),
                  "style" === v && (this.raw = l.endStyle),
                  "title" === v && (this.raw = l.endTitle),
                  this._pushState("open");
              }
            else
                ...
                return (
                  n.forEach(function (t) {
                    var e,
                      n = t.key;
                    null !== this.keyPath
                      ? (this._addIdPropertyIfNeeded(t), (e = f.objectStore(this.storeName).put(t)))
                      : (e = f.objectStore(this.storeName).put(t, n)),
                      (e.onsuccess = l),
    ...
    247164: (t, e) => {
      (e.read = function (t, e, n, r, i) {
        var o,
          ...
          l = n ? -1 : 1,
          p = t[e + f];
        for (f += l, o = p & ((1 << -c) - 1), p >>= -c, c += a; c > 0; o = 256 * o + t[e + f], f += l, c -= 8);
        for (s = o & ((1 << -c) - 1), o >>= -c, c += r; c > 0; s = 256 * s + t[e + f], f += l, c -= 8);
        if (0 === o) o = 1 - u;
        else {
            ...
            e = Math.abs(e),
              isNaN(e) || e === 1 / 0
                ...
                : ((s = Math.floor(Math.log(e) / Math.LN2)),
                  ...
                  (e += s + f >= 1 ? l / h : l * Math.pow(2, 1 - f)) * h >= 2 && (s++, (h /= 2)),
                  s + f >= c
                    ? ((a = 0), (s = c))
                    : s + f >= 1
