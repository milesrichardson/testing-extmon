  ...
  var e = {
      ...
      7794: (e, t, n) => {
        ...
        const N = (function () {
          function e(t) {
            var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            O(this, e), (this.languageUtils = t), (this.options = n), (this.logger = a.create("pluralResolver")), (this.rules = C());
          }
          return (
        ...
        (e = n.nmd(e)).exports = (function () {
          ...
          function C(e) {
            for (var t, n, r, s, i = 0; i < e.length; ) {
              for (t = (s = E(e[i]).split("-")).length, n = (n = E(e[i + 1])) ? n.split("-") : null; t > 0; ) {
          ...
          function R(e, t) {
            ...
            return (
              null != t
                ? (null != A[e] && (t = H(A[e]._config, t)), ((n = new P(t)).parentLocale = A[e]), (A[e] = n), F(e))
          ...
          ne("M", ["MM", 2], "Mo", function () {
            ...
            je(["MMM", "MMMM"], function (e, t, n, r) {
              ...
              null != s ? (t[Ae] = s) : (h(n).invalidMonth = e);
            });
          var Ue = /D[oD]?(\[[^\[\]]*\]|\s+)+MMMM?/,
              ...
              n &&
                ...
                ((t =
                  n[Ae] < 0 || n[Ae] > 11
                    ...
                    ? Ee
                    : n[Ce] < 0 || n[Ce] > 24 || (24 === n[Ce] && (0 !== n[Ne] || 0 !== n[Fe] || 0 !== n[We]))
                    ? Ce
                    : n[Ne] < 0 || n[Ne] > 59
                    ? Ne
                    : n[Fe] < 0 || n[Fe] > 59
                    ...
                    ? We
                    : -1),
                h(e)._overflowDayOfYear && (t < Oe || t > Ee) && (t = Ee),
          ...
          (r.createFromInputFallback = w(
            ...
            je("YYYY", function (e, t) {
              t[Oe] = 2 === e.length ? r.parseTwoDigitYear(e) : b(e);
            }),
            je("YY", function (e, t) {
          ...
          function kt(e) {
            ...
            if (!e._d) {
              ...
              24 === e._a[Ce] && 0 === e._a[Ne] && 0 === e._a[Fe] && 0 === e._a[We] && ((e._nextDay = !0), (e._a[Ce] = 0)),
          ...
          function wt(e) {
            ...
            null != (t = e._w).GG || null != t.W || null != t.E
              ? ((i = 1),
                (a = 4),
                (n = bt(t.GG, e._a[Oe], Lt(At(), 1, 4).year)),
                (r = bt(t.W, 1)),
                ((s = bt(t.E, 1)) < 1 || s > 7) && (u = !0))
              : ((i = e._locale._week.dow),
                (a = e._locale._week.doy),
                (n = bt(t.gg, e._a[Oe], Lt(At(), i, a).year)),
                (r = bt(t.w, 1)),
                null != t.d
                  ? ((s = t.d) < 0 || s > 6) && (u = !0)
                  : null != t.e
              ...
              r < 1 || r > vt(n, i, a)
                ...
                : ((o = Mt(n, r, s, i, a)), (e._a[Oe] = o.year), (e._dayOfYear = o.dayOfYear));
          }
          function Dt(e) {
            if (e._f !== r.ISO_8601) {
              (e._a = []), (h(e).empty = !0);
              ...
              for (s = ae(e._f, e._locale).match(Z) || [], t = 0; t < s.length; t++)
                (i = s[t]),
                  (n = (o.match(De(i, e)) || [])[0]) &&
                    ...
                    (d += n.length)),
                  te[i] ? (n ? (h(e).empty = !1) : h(e).unusedTokens.push(i), Pe(i, n, e)) : e._strict && !n && h(e).unusedTokens.push(i);
              (h(e).charsLeftOver = u - d),
                o.length > 0 && h(e).unusedInput.push(o),
                !0 === h(e).bigHour && e._a[Ce] <= 12 && e._a[Ce] > 0 && (h(e).bigHour = void 0),
            ...
            return (
              ...
              null === t || (void 0 === n && "" === t)
                ...
                : ("string" == typeof t && (e._i = t = e._locale.preparse(t)),
                  L(t) ? new M(rt(t)) : (i(n) ? St(e) : n ? Dt(e) : a(t) ? (e._d = t) : Pt(e), _(e) || (e._d = null), e))
            );
          }
          function Pt(e) {
            var t = e._i;
          ...
          r.ISO_8601 = function () {};
          var Et = w("moment().min is deprecated, use moment.max instead. https://github.com/moment/moment/issues/1548", function () {
              var e = At.apply(null, arguments);
              return this.isValid() && e.isValid() ? (e < this ? this : e) : m();
            }),
            Ct = w("moment().max is deprecated, use moment.min instead. https://github.com/moment/moment/issues/1548", function () {
              var e = At.apply(null, arguments);
              return this.isValid() && e.isValid() ? (e > this ? this : e) : m();
            });
          function Nt(e, t) {
          ...
          function Vt(e, t) {
            var n, s;
            return t._isUTC
              ? ((n = t.clone()), (s = (L(e) || a(e) ? +e : +At(e)) - +n), n._d.setTime(+n._d + s), r.updateOffset(n, !1), n)
              : At(e).local();
          }
          function Bt(e) {
          ...
          function un(e, t) {
            ...
            return (
              zt(e)
                ...
                : (a = an.exec(e))
                ? ((n = "-" === a[1] ? -1 : 1),
                  (i = { y: 0, d: b(a[Ee]) * n, h: b(a[Ce]) * n, m: b(a[Ne]) * n, s: b(a[Fe]) * n, ms: b(a[We]) * n }))
                : (a = on.exec(e))
                ? ((n = "-" === a[1] ? -1 : 1),
                ...
                : "object" == typeof i &&
                  ("from" in i || "to" in i) &&
                  ((s = cn(At(i.from), At(i.to))), ((i = {}).ms = s.milliseconds), (i.M = s.months)),
              (r = new It(i)),
            ...
            var n = e || At(),
              ...
              i =
                s < -6
                  ...
                  : "sameElse",
              a = t && (S(t[i]) ? t[i]() : t[i]);
            return this.format(a || this.localeData().calendar(i, this, At(n)));
          }
          function gn() {
            return new M(this);
          }
          ...
          ne("DDD", ["DDDD", 3], "DDDo", "dayOfYear"),
            ...
            je(["h", "hh"], function (e, t, n) {
              (t[Ce] = b(e)), (h(n).bigHour = !0);
            }),
            je("hmm", function (e, t, n) {
              var r = e.length - 2;
              (t[Ce] = b(e.substr(0, r))), (t[Ne] = b(e.substr(r))), (h(n).bigHour = !0);
            }),
            je("hmmss", function (e, t, n) {
              var r = e.length - 4,
                s = e.length - 2;
              (t[Ce] = b(e.substr(0, r))), (t[Ne] = b(e.substr(r, 2))), (t[Fe] = b(e.substr(s))), (h(n).bigHour = !0);
            }),
            je("Hmm", function (e, t, n) {
              var r = e.length - 2;
              (t[Ce] = b(e.substr(0, r))), (t[Ne] = b(e.substr(r)));
            }),
            je("Hmmss", function (e, t, n) {
              var r = e.length - 4,
                s = e.length - 2;
              (t[Ce] = b(e.substr(0, r))), (t[Ne] = b(e.substr(r, 2))), (t[Fe] = b(e.substr(s)));
            });
          var Dr = /[ap]\.?m?\.?/i;
          function Tr(e, t, n) {
          ...
          var Sr = B("Hours", !0);
          ne("m", ["mm", 2], 0, "minute"), G("minute", "m"), we("m", he), we("mm", he, ue), je(["m", "mm"], Ne);
          var xr = B("Minutes", !1);
          ...
          (Cr.add = pn),
            ...
            (Cr.zoneAbbr = Ar),
            (Cr.zoneName = Er),
            (Cr.dates = w("dates accessor is deprecated. Use date instead.", dr)),
            (Cr.months = w("months accessor is deprecated. Use month instead", Ke)),
            (Cr.years = w("years accessor is deprecated. Use year instead", ft)),
            (Cr.zone = w("moment().zone is deprecated, use moment().utcOffset instead. https://github.com/moment/moment/issues/1779", qt));
          var Nr = Cr;
          function Fr(e) {
            return At(1e3 * e);
          }
    ...
    (() => {
      ...
      var c,
        ...
        _ = (function (e) {
          ...
          return t(n, e), Object.defineProperty(n.prototype, "errorDetails", { get: function () {}, enumerable: !1, configurable: !0 }), n;
        })(Error),
        m = (function (e) {
          function n() {
        ...
        b = (function () {
          ...
          return (
            (e.buildFailedResult = function (t, n, r) {
              return new e(this.resolveScenarioName(t, n), g.failed, r, this.getScenarioError(n));
            }),
            (e.resolveScenarioName = function (e, t) {
              return t instanceof v ? t.scenarioName : (null == e ? void 0 : e.name) ? e.name : "Unknown";
            }),
      ...
      var Y,
        ...
        D = (function () {
          ...
          return (
            ...
            (e.prototype.handleSuccess = function (e, t) {
              return void 0 === e && (e = g.succeeded), Promise.resolve(new L(e, t));
            }),
          ...
          return (
            ...
            (e.prototype.onTimeout = function () {
              ...
              try {
                ...
                if (!(e instanceof T)) return null === (t = this.promiseReject) || void 0 === t ? void 0 : t.call(this, e);
                if (this.isTimedOut)
        ...
        A = (function (e) {
          ...
          return (
            ...
            (n.prototype.getActionTimeoutError = function () {
              return new P(this.xpath, this.timeout);
            }),
            n
          );
        })(O),
                ...
                return o(this, function (n) {
                  switch (n.label) {
                    case 0:
                      return (
                        n.trys.push([0, 2, , 3]),
                        (this.domObserver = new A(this.xpath, this.timeout, this.parent)),
                        [4, this.domObserver.onElementVisible()]
                      );
                    case 1:
                      return (e = n.sent()), this.invokeClick(e), [2, this.handleSuccess()];
                    case 2:
                      return (t = n.sent()), [2, this.handleFail(h.clickWhenVisible, t)];
                    case 3:
                      return [2];
                  }
                });
        ...
        W = (function (e) {
          ...
          return (
            ...
            (n.prototype.parse = function (e) {
              return (
                (this.validateXpath(e.xpath) && this.validateTimeout(e.timeout)) || this.throwParseError(E.event),
                new E(e.xpath, e.timeout, e.parent)
              );
            }),
            n
          );
                  ...
                  return [
                    ...
                    new Promise(function (t) {
                      e.timer = window.setTimeout(function () {
                        return t(e.handleSuccess(g.succeeded));
                      }, e.timeout);
                    })
                  ];
                });
        ...
        I = (function (e) {
          ...
          return (
            t(n, e),
            (n.prototype.parse = function (e) {
              return this.validateTimeout(e.timeout) || this.throwParseError(R.event), new R(e.timeout);
            }),
            n
          );
        })(F),
              ...
              return a(this, void 0, void 0, function () {
                return o(this, function (e) {
                  try {
                    ...
                    return [2, this.handleFail(h.executeScript, e)];
                  }
                  return [2];
                });
              });
            }),
            (n.event = h.executeScript),
            n
          );
        })(D),
        U = (function (e) {
        ...
        J = (function (e) {
          ...
          return (
            t(n, e),
            (n.prototype.parse = function (e) {
              return this.validateUrl(e.stylesheetUrl) || this.throwParseError(G.event), new G(e.stylesheetUrl);
            }),
            n
          );
        })(F),
        V = (function (e) {
          ...
          return (
            ...
            (n.prototype.parseStringNodeComponent = function (e) {
              if (!N.nonEmptyString(e)) throw new Error();
            ...
            (n.prototype.parseObjectNodeComponent = function (e) {
              ...
              return i(i({}, e), { multipleMatch: t });
            }),
            (n.prototype.validateElementWithParent = function (e) {
              return N.nonEmptyString(e.xpath) && (!e.hasOwnProperty("parent") || N.nonEmptyString(e.parent));
            }),
            ...
            (n.prototype.parseGroupId = function (e) {
              if (e.hasOwnProperty("groupId")) {
                if (!N.nonEmptyString(e.groupId)) throw Error();
                return e.groupId;
              }
            }),
        ...
        B = new ((function () {
          ...
          return (
            ...
            (e.prototype.emit = function (e) {
              ...
              this.events[e] &&
                d([], this.events[e], !0).forEach(function (e) {
                  return e.apply(t, n);
                });
            }),
      ...
      var $,
        ...
        Z = (function () {
          function e(e) {
            (this.content = e), (this.domListeners = []), (this.uniqueId = X.generate());
          }
          return (
            ...
            (e.prototype.render = function () {
              if (document.getElementById(this.uniqueId)) throw new K(this.uniqueId);
            ...
            (e.prototype.getElement = function (e) {
              return (e.multipleMatch ? x.getAllElementsByXpath : x.getSingleElementByXPath)(e.xpath, this.getParentNode(e.parent));
            }),
        ...
        ee = (function (e) {
          ...
          return (
            ...
            (n.prototype.onResolve = function (e) {
              this.disposeComponent(), this.resolve(new L(g.succeeded, e.groupId));
            }),
            n
          );
        })(j),
        te = (function (e) {
          ...
          return (
            ...
            (n.prototype.onResolve = function (t) {
              B.emit(this.getTrackEventFromCondition(t), { content: this.trackableContent }), e.prototype.onResolve.call(this, t);
            }),
            (n.prototype.getTrackEventFromCondition = function (e) {
              return e.groupId === w.ScenarioClosed ? k.NotificationClosed : k.NotificationResolved;
            }),
            (n.prototype.buildComponent = function () {
              return new Q(this.content, this.className);
            }),
            (n.event = h.notification),
            n
          );
        })(ee),
        ne = (function (e) {
        ...
        re = (function (e) {
          function n(t, n, r, s) {
            ...
            return (i.timeout = n), (i.scrollToOptions = r), (i.domObserver = new A(t, n, s)), i;
          }
          return (
            t(n, e),
            (n.prototype.execute = function () {
              return a(this, void 0, void 0, function () {
                ...
                return o(this, function (r) {
                  switch (r.label) {
                    ...
                    case 2:
                      return (n = r.sent()), [2, this.handleFail(h.scroll, n)];
                    case 3:
                      return [2];
                  }
                });
        ...
        se = (function (e) {
          ...
          return (
            ...
            (n.prototype.parse = function (e) {
              return (
                (this.validateXpath(e.xpath) && this.validateTimeout(e.timeout) && this.validateScrollToOptionsGrouped(e)) ||
                  this.throwParseError(re.event),
                new re(e.xpath, e.timeout, e.scrollToOptions, e.parent)
              );
            }),
            ...
            (n.prototype.validateScrollToOptions = function (e) {
              var t = e;
              return N.isObjectWithKeys(e) && N.isNumber(t.left) && N.isNumber(t.top);
            }),
            n
          );
        })(F);
      ...
      var ie = { x: 0, y: 0 },
        ae = (function (e) {
          ...
          return (
            ...
            (n.prototype.getParentsBoundingRect = function () {
              return this.isParentIFrame ? this.targetParent.getBoundingClientRect() : ie;
            }),
        ...
        oe = (function (e) {
          ...
          return (
            ...
            (n.prototype.getTrackEventFromCondition = function (e) {
              return e.groupId === w.ScenarioClosed ? k.TooltipClosed : k.TooltipResolved;
            }),
            (n.prototype.buildComponent = function () {
              return new ae(
        ...
        ue = (function (e) {
          ...
          return (
            ...
            (n.prototype.parseOptions = function (e) {
              var t;
              return (
                this.validateTooltipOptions(e) || this.throwParseError(oe.event),
            ...
            (n.prototype.validateTooltipClassName = function (e) {
              return !e.hasOwnProperty("className") || N.isString(e.className);
            }),
            (n.prototype.validateSpaceBetween = function (e) {
              return e.hasOwnProperty("spaceBetween") || (e.spaceBetween = this.DEFAULT_ARROW_HEIGHT), N.isNumber(e.spaceBetween);
            }),
            n
          );
        })(V),
        de = (function (e) {
          ...
          return (
            ...
            (n.prototype.getTargetElement = function () {
              ...
              throw new T(this.xpaths.join());
            }),
            (n.prototype.getNode = function (t, n) {
              try {
            ...
            (n.prototype.getActionTimeoutError = function () {
              return new P(this.xpaths.join(), this.timeout);
            }),
            n
          );
        })(O),
        le = (function (e) {
          ...
          return (
            ...
            (n.prototype.setObserver = function () {
              this.disposeObserver(), (this.domObserver = new de(this.xpaths, this.timeout, this.parent));
            }),
        ...
        ce = (function (e) {
          ...
          return (
            ...
            (n.prototype.parse = function (e) {
              return (
                (N.isArray(e.xpaths) && this.validateXpaths(e.xpaths) && this.validateTimeout(e.timeout)) || this.throwParseError(le.event),
                new le(e.xpaths, e.timeout, e.parent)
              );
            }),
            (n.prototype.validateXpaths = function (e) {
        ...
        he = (function (e) {
          ...
          return (
            ...
            (n.prototype.setObserver = function () {
              this.disposeObserver(), (this.domObserver = new A(this.xpath, this.timeout, this.parent));
            }),
            (n.prototype.disposeObserver = function () {
              var e;
              null === (e = this.domObserver) || void 0 === e || e.dispose();
        ...
        _e = (function (e) {
          ...
          return (
            ...
            (n.prototype.parse = function (e) {
              return (
                (this.validateXpath(e.xpath) && this.validateTimeout(e.timeout)) || this.throwParseError(he.event),
                new he(e.xpath, e.timeout, e.parent)
              );
            }),
            n
          );
        ...
        me = (function (e) {
          ...
          return (
            ...
            (n.prototype.execute = function () {
              ...
              return a(this, void 0, void 0, function () {
                ...
                return o(this, function (o) {
                  switch (o.label) {
                    case 0:
                      o.trys.push([0, 14, , 15]), (r = this.getNodes(this.xpath, this.parent)), (o.label = 1);
                    case 1:
                      o.trys.push([1, 7, 8, 13]), (s = l(r)), (o.label = 2);
                    case 2:
                      return [4, s.next()];
                    case 3:
                      return (i = o.sent()).done ? [3, 6] : ((a = i.value), [4, this.delayedBatchClick(a)]);
                    case 4:
                      o.sent(), (o.label = 5);
                    case 5:
                      return [3, 2];
                    case 6:
                      return [3, 13];
                    case 7:
                      return (u = o.sent()), (e = { error: u }), [3, 13];
                    case 8:
                      return o.trys.push([8, , 11, 12]), i && !i.done && (t = s.return) ? [4, t.call(s)] : [3, 10];
                    case 9:
                      o.sent(), (o.label = 10);
                    case 10:
                      return [3, 12];
                    ...
                    case 14:
                      return (d = o.sent()), [2, this.handleFail(n.event, d)];
                    case 15:
                      return [2];
                  }
                });
            ...
            (n.prototype.delayedBatchClick = function (e) {
              return a(this, void 0, void 0, function () {
                var t = this;
                return o(this, function (n) {
                  return [
        ...
        pe = (function (e) {
          ...
          return (
            t(n, e),
            (n.prototype.parse = function (e) {
              return this.validateXpath(e.xpath) || this.throwParseError(me.event), new me(e.xpath, e.parent);
            }),
            n
          );
        })(F),
        fe = (function (e) {
          ...
          return (
            t(n, e),
            (n.prototype.parse = function (e) {
              return this.validateXpath(e.xpath) || this.throwParseError(H.event), new H(e.xpath, e.parent);
            }),
            n
          );
        })(F),
        ye = (function (e) {
          ...
          return (
                ...
                return o(this, function (t) {
                  switch (t.label) {
                    case 0:
                      ...
                      t.label = 1;
                    case 1:
                      return t.trys.push([1, 3, , 4]), [4, new le(this.xpaths, this.timeout, this.parent).execute()];
                    case 2:
                      return t.sent(), [2, this.click()];
                    case 3:
                      return (e = t.sent()), [2, this.handleFail(n.event, e)];
                    case 4:
                      return [2];
                  }
                });
                ...
                return o(this, function (r) {
                  try {
                    return (
                      ...
                      (t = this.findFirstNode(e))
                        ? (t.click(), [2, this.handleSuccess()])
                        : [2, this.handleFail(n.event, new T(this.xpaths.join(), e))]
                    );
                  } catch (e) {
                    return [2, this.handleFail(n.event, e)];
                  }
            ...
            (n.prototype.findFirstNode = function (e) {
            ...
            (n.prototype.getNode = function (e, t) {
              try {
                return x.getSingleElementByXPath(e, t);
              } catch (e) {
                return;
              }
            }),
            (n.event = h.clickOneOf),
            n
          );
        })(D),
        ge = (function (e) {
          ...
          return (
            t(n, e),
            (n.prototype.parse = function (e) {
              N.nonEmptyArray(e.xpaths) || this.throwParseError(ye.event);
              for (var t = 0, n = e.xpaths; t < n.length; t++) {
                var r = n[t];
                this.validateXpath(r) || this.throwParseError(ye.event);
              }
              return new ye(e.xpaths, e.timeout, e.parent);
            }),
            n
          );
        })(F),
              ...
              return a(this, void 0, void 0, function () {
                return o(this, function (e) {
                  try {
                    ...
                    return [2, this.handleFail(h.verifyOk, e)];
                  }
                  return [2];
                });
              });
        ...
        ve = (function (e) {
          ...
          return (
            t(n, e),
            (n.prototype.parse = function (e) {
              return this.validateXpath(e.xpath) || this.throwParseError(Le.event), new Le(e.xpath, e.parent);
            }),
            n
          );
        })(F),
        be = (function () {
          ...
          return (
            (e.prototype.parse = function (e) {
              var t = this;
              if (((this.invalidActions = []), !N.nonEmptyArray(e))) throw new m();
              var n = [];
              if (
                (e.forEach(function (e) {
                  try {
            ...
            (e.prototype.parseAction = function (e) {
              switch ((e.event || this.throwActionError("unspecified"), e.event)) {
                case H.event:
                  return new fe().parse(e);
                case ye.event:
                  return new ge().parse(e);
                case me.event:
                  return new pe().parse(e);
                case E.event:
                  return new W().parse(e);
                case R.event:
                  return new I().parse(e);
                case z.event:
                  return new U().parse(e);
                case G.event:
                  return new J().parse(e);
                case te.event:
                  return new ne().parse(e);
                case re.event:
        ...
        Ye = (function () {
          ...
          return (
            ...
            (e.prototype.parseHookActions = function (e) {
              return new be().parse(null == e ? void 0 : e.actions);
            }),
            e
          );
        })(),
          ...
          return (
              ...
              return a(this, void 0, void 0, function () {
                return o(this, function (e) {
                  return this.verifyPreconditions()
                    ? (ke.addPageStack({ target: this.target }), [2, this.executeActions()])
                    : [2, this.optional ? this.handleSuccess() : this.handleError(new De(this.target))];
                });
              });
            }),
            ...
            (e.prototype.pathnameMatches = function () {
              var e = window.location.origin + window.location.pathname,
                t = this.target.url;
              return N.isRegex(t) ? new RegExp(t.slice(1)).test(e) : "*" === t || t === e;
            }),
            (e.prototype.queryMatches = function () {
              if (void 0 === this.target.query || N.isEmptyArray(this.target.query)) return !0;
            ...
            (e.prototype.handleSuccess = function (e) {
              return void 0 === e && (e = g.succeeded), Promise.resolve(new Te(e));
            }),
        ...
        je = (function (e) {
          ...
          return (
            ...
            (n.prototype.executeGroupActions = function (e) {
              ...
              return a(this, void 0, void 0, function () {
                ...
                return o(this, function (o) {
                  switch (o.label) {
                    case 0:
                      if (!(r = this.getGroupById(e))) throw new we(e);
                      o.label = 1;
                    case 1:
                      o.trys.push([1, 7, 8, 13]), (i = l(r.actions.entries())), (o.label = 2);
                    case 2:
                      return [4, i.next()];
                    case 3:
                      return (a = o.sent()).done
                        ? [3, 6]
                        : ((u = a.value),
                          (d = u[0]),
                          (c = u[1]),
                          this.isLastAction(c, d, r) && B.emit(Y.onBeforeLastAction, c.getEvent()),
                          [4, this.executeAction(c, e)]);
                    case 4:
                      if ((s = o.sent()).nextGroup) return [2, this.executeGroupActions(s.nextGroup)];
                    ...
                    case 6:
                      return [3, 13];
                    case 7:
                      return (h = o.sent()), (t = { error: h }), [3, 13];
                    case 8:
                      return o.trys.push([8, , 11, 12]), a && !a.done && (n = i.return) ? [4, n.call(i)] : [3, 10];
                    case 9:
                      o.sent(), (o.label = 10);
                    case 10:
                      return [3, 12];
            ...
            (n.prototype.isLastAction = function (e, t, n) {
              var r = e.action instanceof ee ? e.action.getResolveConditionsGroupIds() : null,
                s =
                  null == r
                    ? void 0
                    : r.find(function (e) {
                        return e && e != w.ScenarioClosed && e != w.ScenarioRevoked;
                      });
              return void 0 === e.resolveGroup && t === n.actions.length - 1 && e.getEvent() != h.stopScenario && !s;
            }),
                ...
                return o(this, function (r) {
                  switch (r.label) {
                    case 0:
                      return [4, e.execute()];
                    case 1:
                      return (n = r.sent()), ke.addActionStack(xe.getGroupedActionStack(n, e, t)), [2, n];
                  }
                });
              });
            }),
            ...
            (n.prototype.executeActions = function () {
              ...
              return a(this, void 0, void 0, function () {
                ...
                return o(this, function (o) {
                  switch (o.label) {
                    case 0:
                      if (0 === this.actions.length) return [2, this.handleSuccess(g.succeeded)];
                      o.label = 1;
                    case 1:
                      o.trys.push([1, 10, 11, 16]), (s = l(this.actions.entries())), (o.label = 2);
                    case 2:
                      return [4, s.next()];
                    case 3:
                      if ((i = o.sent()).done) return [3, 9];
                      (a = i.value),
                        (u = a[0]),
                        (d = a[1]),
                        this.isLastAction(u) && B.emit(Y.onBeforeLastAction, d.getEvent()),
                        (o.label = 4);
                    case 4:
                      return o.trys.push([4, 6, , 7]), [4, this.executeAction(d)];
                    case 5:
                      return (r = o.sent()), [3, 7];
                    case 6:
                      return (c = o.sent()), [2, this.handleError(c)];
                    case 7:
                      if (r.resolution !== g.succeeded) return [3, 9];
                      o.label = 8;
                    case 8:
                      return [3, 2];
                    case 9:
                      return [3, 16];
                    case 10:
                      return (h = o.sent()), (e = { error: h }), [3, 16];
                    case 11:
                      return o.trys.push([11, , 14, 15]), i && !i.done && (t = s.return) ? [4, t.call(s)] : [3, 13];
                    case 12:
                      o.sent(), (o.label = 13);
                    case 13:
                      return [3, 15];
                    ...
                    case 15:
                      return [7];
                    case 16:
                      return [2, this.handleSuccess(null !== (n = r.resolution) && void 0 !== n ? n : g.succeeded)];
                  }
                });
              });
            }),
                ...
                return o(this, function (n) {
                  switch (n.label) {
                    case 0:
                      return [4, e.execute()];
                    case 1:
                      return (t = n.sent()), ke.addActionStack(xe.getActionStack(t, e)), [2, t];
                  }
                });
              });
            }),
              ...
              return a(this, void 0, void 0, function () {
                ...
                return o(this, function (r) {
                  switch (r.label) {
                    ...
                    case 1:
                      return (e = r.sent()), (t = e.nextGroup ? e : new L(e.resolution, this.resolveGroup)), [2, this.handleSuccess(t)];
                    case 2:
                      return (
                        (n = r.sent()),
                        this.rejectGroup ? [2, this.handleSuccess(new L(g.succeeded, this.rejectGroup))] : [2, this.handleError(n)]
                      );
                    case 3:
                      return [2];
                  }
        ...
        Ae = (function (e) {
          ...
          return (
            t(n, e),
            (n.prototype.parse = function (e) {
              if (!N.nonEmptyArray(e)) throw new m();
        ...
        Ee = (function () {
          function e(e) {
            void 0 === e && (e = new be()), (this.actionParser = e);
          }
          return (
            (e.prototype.parse = function (e) {
              ...
              if (n && r) throw new Pe();
              return n
                ? new He(t, this.parseActions(e.actions), e.optional)
                : new je(t, this.parseGroupedActions(e.groupedActions), e.optional);
            }),
            ...
            (e.prototype.executePages = function () {
              return a(this, void 0, void 0, function () {
                ...
                return o(this, function (i) {
                  switch (i.label) {
                    case 0:
                      if (0 === this.scenarioPages.length) return [2, this.handleSuccess(new b(this.name, g.succeeded, ke.getStack()))];
                    ...
                    case 6:
                      return t++, [3, 1];
                    case 7:
                      return [2, this.handleSuccess(new b(this.name, e.resolution, ke.getStack()))];
                  }
                });
              });
            }),
        ...
        Fe = (function (e) {
          function n(t, n) {
            void 0 === t && (t = new Ee()), void 0 === n && (n = new Ye());
            var r = e.call(this) || this;
          ...
          return (
            ...
            (n.prototype.parseScenario = function (e) {
              ...
              return this.invalidKeys.length && this.throwHandledError(t), new Ne(t, s, i);
            }),
            (n.prototype.validateScenarioName = function (e) {
              N.nonEmptyString(e) || this.pushInvalidKey(r.name, "The Scenario name was either not provided or the value is valid.");
            }),
            (n.prototype.getParsedPages = function (e) {
              var t = this;
              if (!N.nonEmptyArray(e))
                return this.pushInvalidKey(r.pages, "The Scenario pages are either not provided or the value is valid."), [];
              var n = [];
              return (
                e.forEach(function (e) {
                  try {
            ...
            return (
              (e.prototype.parse = function (e) {
                return (
                  ...
                  N.isObjectWithKeys(this.sourceData) || this.throwInvalidSourceData(),
                  this.parseScenario(this.sourceData)
                );
              }),
              (e.prototype.parseSourceData = function (e) {
                try {
                  return N.isString(e) ? JSON.parse(e) : e;
                } catch (e) {
              ...
              (e.prototype.throwHandledError = function (e) {
                throw (void 0 === e && (e = "Unknown"), (this.sourceData = void 0), new v(e, this.invalidKeys));
              }),
              e
            );
          })()
        ...
        Ie = (function () {
          function e(e) {
            (this.parser = e), (this.eventEmitter = B);
          }
          return (
            ...
            (e.prototype.start = function () {
              return a(this, void 0, void 0, function () {
                ...
                return o(this, function (n) {
                  switch (n.label) {
                    case 0:
                      if (!this.scenario) return [2, this.handleError(new We(this.constructor.name, "start"))];
                      n.label = 1;
                    case 1:
                ...
                return o(this, function (t) {
                  return this.scenario
                    ? (this.scenario.disposeActions(),
                      (e = new b(this.scenario.name, g.terminated, ke.getStack())),
                      [2, this.handleSuccess(e)])
                    : [2, this.handleError(new We(this.constructor.name, "stop"))];
                });
              });
            }),
            (e.prototype.handleSuccess = function (e) {
              ...
              return a(this, void 0, void 0, function () {
                ...
                return o(this, function (s) {
                  switch (s.label) {
                    ...
                    case 4:
                      return [4, null === (n = this.scenario) || void 0 === n ? void 0 : n.executeHook(c.onDisposed)];
                    case 5:
                      return s.sent(), [7];
                    case 6:
              ...
              return a(this, void 0, void 0, function () {
                ...
                return o(this, function (s) {
                  switch (s.label) {
                    case 0:
                      return (
                        (n = e instanceof _ ? e : new Re(e)),
                        (r = b.buildFailedResult(this.scenario, n, ke.getStack())),
                        this.eventEmitter.emit(Y.onError, r),
                        [4, null === (t = this.scenario) || void 0 === t ? void 0 : t.executeHook(c.onFailed)]
                      );
                    case 1:
              ...
              return a(this, void 0, void 0, function () {
                return o(this, function (e) {
                  switch (e.label) {
                    ...
                    case 1:
                      return e.sent(), (this.scenario = void 0), ke.clearStack(), [2];
                  }
                });
              });
            }),
      ...
      class Ve {
        ...
        onMessage(e, t, n) {
          if (e === Be.GET_TRANSLATIONS) n(this.translations);
        }
        async getTranslations() {
          ...
          return {
            resources: {
              en: { translation: Object.assign(Object.assign({}, Ge), e) },
        ...
        async safelyFetchTranslation(e) {
          const t = () => Je.retry(() => this.fetchTranslation(e), { numberOfRetries: 2 });
          try {
            const e = await Je.parallelRetry(t, {
              delay: 5e3,
              onParallelSuccess: (e) => {
        ...
        async registerI18nLocales() {
          await Ue.ZP.register(this.translations), (Ue.ZP.locale = this.locale);
        }
      ...
      class qe extends te {
        buildComponent() {
          return new Ke(this.content, this.className);
        }
      }
      qe.event = "aos-notification";
      class Ke extends Q {
        render() {
          super.render(),
      ...
      class Xe extends ne {
        ...
        renderBadge(e, t, n) {
          return e && t.includes("trigger-notification")
            ? `\n\t\t\t<span class='badge'>${(0, Ue.hd)("guides.notification.minutes", n)}</span>\n\t\t`
            : "";
        }
        renderActionLink(e, t) {
          return e && t.includes("trigger-notification")
            ? `\n\t\t\t<a class='a' data-aos-action='${e.action}'>${(0, Ue.hd)(e.text)}</a>\n\t\t`
            : "";
        }
        ...
        getParsedNotificationAction(e) {
          try {
            ...
            return new qe(this.parseHtmlContent(e), t, n, r);
          } catch (t) {
            this.throwParseError(e.event);
          }
        }
        getTrackableContent(e) {
          ...
          return `[${Ve.getTrackingTranslation(n)}] ${Ve.getTrackingTranslation(t)}`;
        }
        ...
        validateHtmlContent(e) {
          return (
            !!(
              [e.label, e.body].every((e) => N.isString(e)) &&
        ...
        validateButton(e) {
          ...
          return (
            N.isString(t.text) ||
            (t.hasOwnProperty("href") && N.isString(t.href)) ||
            (t.hasOwnProperty("action") && N.isString(t.action)) ||
            (t.hasOwnProperty("classname") && N.isString(t.classname)) ||
            (t.hasOwnProperty("isClose") && N.isBoolean(t.isClose))
          );
        }
        validateSecondaryButton(e) {
          ...
          return (
            N.isString(t.text) || (t.hasOwnProperty("href") && N.isString(t.href)) || (t.hasOwnProperty("action") && N.isString(t.action))
          );
        }
        validateHeading(e) {
          return !e.hasOwnProperty("heading") || N.isString(e.heading);
        }
        validateBadge(e) {
          return !e.hasOwnProperty("badge") || N.isBoolean(e.badge);
        }
        validateActionLink(e) {
          if (!e.hasOwnProperty("actionLink")) return !0;
          const t = e.actionLink;
          return N.isString(t.text) || N.isString(t.action);
        }
        validateIllustration(e) {
          return !e.hasOwnProperty("illustration") || N.isString(e.illustration);
        }
      }
      !(function (e) {
      ...
      class Ze extends Xe {
        renderButtonWrap(e) {
          if (!e) return "";
          const t = e.isClose ? "close-button" : "";
          return `\n\t\t\t<div class='button-wrap'>\n\t\t\t\t<a ${e.href && `href=${e.href}`} class="${t}" id='aos-init-guide'>${(0, Ue.hd)(
            e.text
          )}</a>\n\t\t\t</div>\n\t\t`;
        }
        renderSecondaryButtonWrap(e) {
          return e
            ? `\n\t\t\t<div class='button-wrap'>\n\t\t\t\t<a class='aos-secondary-button' ${
                e.href && `href=${e.href}`
              } id='aos-init-guide'>${(0, Ue.hd)(e.text)}</a>\n\t\t\t</div>\n\t\t`
            : "";
        }
        renderBadge(e, t, n) {
          return t.includes("trigger-notification")
            ? `\n\t\t\t<span class='badge'>${(0, Ue.hd)("guides.notification.minutes", n)}</span>\n\t\t`
            : "";
        }
        renderActionLink(e, t) {
          return t.includes("trigger-notification")
            ? `\n\t\t\t<a data-aos-action='${$e.OpenPreferences}' class='a preferences'>${(0, Ue.hd)("settings.notifications")}</a>\n\t\t`
            : "";
        }
      }
      class Qe extends ue {
        ...
        getParsedTooltipAction(e) {
          try {
            const { xpath: t, parent: n } = e,
              ...
              s = this.parseOptions(e.options),
              i = this.parseResolveConditions(e.resolveConditions),
              a = this.getTrackableContent(e.componentData);
            return i.push(this.getCloseResolveCondition()), new oe(t, r, s, i, n, a);
          } catch (t) {
            this.throwParseError(e.event);
          }
        }
        ...
        getCloseResolveCondition() {
          return {
            elements: [{ xpath: '//div[contains(@class, "aos-component")]//button[@class="close-icon"]' }],
            groupId: "scenario-closed"
          };
        }
        parseHtmlContent(e) {
          const { label: t, step: n, body: r, button: s } = e;
          if (![t, r].every((e) => N.isString(e)) || !this.validateButton(e)) throw new Error();
          const i = n ? (0, Ue.hd)(t, n) : (0, Ue.hd)(t);
          return `\n\t\t\t<header>\n\t\t\t\t<h2>${(0, Ue.hd)(
            "aos"
          )}</h2>\n\t\t\t\t<button class='close-icon'></button>\n\t\t\t</header>\n\t\t\t<div class='component-body'>\n\t\t\t\t<h4>${i}</h4>\n\t\t\t\t<p>${(0,
          Ue.hd)(r)}</p>\n\t\t\t\t${this.renderButtonWrap(s)}\n\t\t\t</div>\n\t\t`;
        }
        validateButton(e) {
          return !e.hasOwnProperty("button") || (N.nonEmptyString(e.button.text) && this.validateButtonHref(e.button));
        }
        validateButtonHref(e) {
          return !e.hasOwnProperty("href") || N.nonEmptyString(e.href);
        }
        renderButtonWrap(e) {
          return e
            ? `\n\t\t\t<div class='button-wrap'>\n\t\t\t\t<a id="aos-next-step" ${e.className && `class=${e.className}`} ${
                e.href && `href=${e.href}`
              }>\n\t\t\t\t\t${(0, Ue.hd)(e.text)}\n\t\t\t\t</a>\n\t\t\t</div>\n\t\t`
            : "";
        }
      ...
      class et extends be {
        parseAction(e) {
          switch (e.event) {
            case qe.event:
              return new Ze().parse(e);
            case "aos-tooltip":
              return new Qe().parse(e);
            default:
      ...
      const ct = "object" == typeof global && global && global.Object === Object && global;
      var ht = "object" == typeof self && self && self.Object === Object && self;
      const _t = ct || ht || Function("return this")();
      const mt = _t.Symbol;
      ...
      var bt = mt ? mt.toStringTag : void 0;
      const Yt = function (e) {
        return null == e ? (void 0 === e ? "[object Undefined]" : "[object Null]") : bt && bt in Object(e) ? Mt(e) : vt(e);
      };
      const kt = function (e) {
        return null != e && "object" == typeof e;
      };
      const wt = function (e) {
        return "symbol" == typeof e || (kt(e) && "[object Symbol]" == Yt(e));
      };
      var Dt = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,
        Tt = /^\w*$/;
      const St = function (e, t) {
        ...
        var n = typeof e;
        return (
          !("number" != n && "symbol" != n && "boolean" != n && null != e && !wt(e)) ||
          Tt.test(e) ||
          !Dt.test(e) ||
      ...
      const Ht = _t["__core-js_shared__"];
      var Pt,
        Ot = (Pt = /[^.]+$/.exec((Ht && Ht.keys && Ht.keys.IE_PROTO) || "")) ? "Symbol(src)_1." + Pt : "";
      const At = function (e) {
        return !!Ot && Ot in e;
      };
      ...
      const Ut = function (e) {
        return !(!xt(e) || At(e)) && (jt(e) ? zt : Nt).test(Ct(e));
      };
      ...
      (en.prototype.clear = Bt), (en.prototype.delete = $t), (en.prototype.get = Kt), (en.prototype.has = Zt), (en.prototype.set = Qt);
      const tn = en;
      const nn = function () {
      ...
      (cn.prototype.clear = nn), (cn.prototype.delete = on), (cn.prototype.get = un), (cn.prototype.has = dn), (cn.prototype.set = ln);
      const hn = cn;
      const _n = Jt(_t, "Map");
      const mn = function () {
        (this.size = 0), (this.__data__ = { hash: new tn(), map: new (_n || hn)(), string: new tn() });
      };
      const pn = function (e) {
        var t = typeof e;
      ...
      (vn.prototype.clear = mn), (vn.prototype.delete = yn), (vn.prototype.get = gn), (vn.prototype.has = Mn), (vn.prototype.set = Ln);
      const bn = vn;
      function Yn(e, t) {
        ...
        return (n.cache = new (Yn.Cache || bn)()), n;
      }
      Yn.Cache = bn;
      const kn = Yn;
      var wn = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g,
      ...
      const Tn = (function (e) {
        ...
        return (
          ...
          e.replace(wn, function (e, n, r, s) {
            t.push(r ? s.replace(Dn, "$1") : n || e);
          }),
          t
        );
      });
      ...
      var xn = mt ? mt.prototype : void 0,
        jn = xn ? xn.toString : void 0;
      const Hn = function e(t) {
        if ("string" == typeof t) return t;
        if (lt(t)) return Sn(t, e) + "";
        if (wt(t)) return jn ? jn.call(t) : "";
        var n = t + "";
      ...
      const On = function (e, t) {
        return lt(e) ? e : St(e, t) ? [e] : Tn(Pn(e));
      };
      const An = function (e) {
      ...
      const En = function (e, t) {
        for (var n = 0, r = (t = On(t, e)).length; null != e && n < r; ) e = e[An(t[n++])];
      ...
      class Nn {
        constructor(e) {
          this.browser = e;
          const t = function (...t) {
            const n = Cn(e, t.shift()) || {},
              r = n[t.shift()];
            return "function" == typeof r ? r.apply(n, t) : r;
          };
          (this.browserAction = new tt(t)),
            (this.extension = new nt(t)),
            (this.i18n = new st(t)),
            (this.runtime = new rt(t)),
            (this.storage = new it(t, this.browser)),
            (this.tabs = new at(t)),
            (this.windows = new ot(t)),
            (this.webNavigation = new ut(t)),
            (this.webRequest = new dt(t));
        }
      }
      class Fn {
        ...
        static async getCurrentTabId(e) {
          return (await Fn.getCurrentTab(e)).id;
        }
        ...
        static async sendBackgroundMessage(e, t, n, r) {
          return new Promise((s) => e.tabs.sendMessage(t.id, { message: n, data: r }, null, s));
        }
        static async sendContentMessage(e, t, n) {
          return new Promise((r) => e.runtime.sendMessage({ message: t, data: n }, null, r));
        }
      ...
      const Wn = "aos.runner.setScenario",
        Rn = "aos.runner.start",
        In = "aos.runner.stop",
        zn = "aos.runner.fail",
        Un = "aos.runner.completed",
        Gn = "aos.runner.getRunnerInfo",
        Jn = "aos.runner.registerRunnerEvents";
      const Vn = new Fe(
        new Ee(new et()),
        new (class extends Ye {
          parseHookActions(e) {
            return new et().parse(e.actions);
          }
        })()
      );
      Fn.injectNitroFont(new Nn(chrome)),
        new (class extends Ie {
          constructor(e) {
            super(e),
              (this.api = new Nn(chrome)),
              this.api.runtime.onMessage.addListener(this.onMessage.bind(this)),
          ...
          onRuntimeError(e) {
            ze.logResult(e), Fn.sendContentMessage(this.api, zn, { scenario: this.currentScenario, error: e });
          }
          onCompletedScenario(e) {
            Fn.sendContentMessage(this.api, Un, { result: e });
          }
            ...
            e &&
              ...
              e.forEach((e) => {
                this.eventEmitter.addListener(e, (...t) => {
                  ...
                  Fn.sendContentMessage(this.api, e, { scenario: this.currentScenario, eventArgs: n });
                });
              });
          }
        })(Vn);
