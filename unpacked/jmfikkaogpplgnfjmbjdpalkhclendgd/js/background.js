...
function ensureCssLoaded() {
  ...
  if (_cssState == NOT_LOADED) {
    ...
    requestCss(getFullUrl("/saved/extension/rsrc/css/"), function (success) {
...
function ensureJSLoaded() {
  ...
  if (_jsState == NOT_LOADED) {
    ...
    var randomKey = guid();
    requestScript(getFullUrl("/saved/extension/rsrc/js/?key=" + randomKey), function (success) {
      _jsState = success && SavedExtension !== undefined ? LOADED : NOT_LOADED;
      onLoadStateUpdated();
    });
  }
}
