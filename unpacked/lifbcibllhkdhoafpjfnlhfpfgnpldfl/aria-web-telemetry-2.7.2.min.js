      ...
      var n = (function () {
        ...
        return (
          (e.prototype.Add = function (e, t) {
            this._getIndex(e) == -1 && this._buffer.push({ Key: e, Value: t });
          }),
          (e.prototype.AddOrReplace = function (e, t) {
            var n = this._getIndex(e);
            n >= 0 ? (this._buffer[n] = { Key: e, Value: t }) : this._buffer.push({ Key: e, Value: t });
          }),
  ...
  !(function (t) {
        ...
        return (
          (e.GetString = function (e) {
            var t,
              ...
              s = e.length % 3,
              a = function (e) {
                return [r.charAt((e >> 18) & 63), r.charAt((e >> 12) & 63), r.charAt((e >> 6) & 63), r.charAt(63 & e)].join("");
              };
            for (t = 0, i = e.length - s; t < i; t += 3) (n = (e[t] << 16) + (e[t + 1] << 8) + e[t + 2]), o.push(a(n));
            switch (s) {
              case 1:
                (n = e[e.length - 1]), o.push(r.charAt(n >> 2)), o.push(r.charAt((n << 4) & 63)), o.push("==");
                break;
              case 2:
                (n = (e[e.length - 2] << 8) + e[e.length - 1]),
                  o.push(r.charAt(n >> 10)),
                  o.push(r.charAt((n >> 4) & 63)),
                  o.push(r.charAt((n << 2) & 63)),
                  o.push("=");
            }
            return o.join("");
          }),
        ...
        return (
          (e.GetBytes = function (e) {
            if (t.BrowserChecker.IsDataViewSupport()) {
              ...
              n.setFloat32(0, e, !0);
              for (var i = [], o = 0; o < 4; ++o) i.push(n.getUint8(o));
              return i;
            }
            return r.ConvertNumberToArray(e, !1);
          }),
          e
        );
      })();
        ...
        return (
          (e.GetBytes = function (e) {
            if (t.BrowserChecker.IsDataViewSupport()) {
              ...
              n.setFloat64(0, e, !0);
              for (var i = [], o = 0; o < 8; ++o) i.push(n.getUint8(o));
              return i;
            }
            return r.ConvertNumberToArray(e, !0);
          }),
          e
        );
      })();
    ...
    !(function (n) {
          ...
          (e.GetString = function (e) {
            for (var t = [], n = 0; n < e.length; ++n) {
              ...
              if (i <= 191) t.push(String.fromCharCode(i));
                ...
                var r = e[++n];
                t.push(String.fromCharCode(((31 & i) << 6) | (63 & r)));
              } else if (i <= 239) {
                var r = e[++n],
                  o = e[++n];
                t.push(String.fromCharCode(((15 & i) << 12) | ((63 & r) << 6) | (63 & o)));
              } else {
                var r = e[++n],
                  o = e[++n],
                  s = e[++n];
                (i = ((7 & i) << 18) | ((63 & r) << 12) | ((63 & o) << 6) | (63 & s)),
                  (i -= 65536),
                  t.push(String.fromCharCode(55296 | ((i >> 10) & 1023))),
                  t.push(String.fromCharCode(56320 | (1023 & i)));
              }
            }
            return t.join("");
          }),
      ...
      var o = (function () {
        ...
        return (
          (e.GetBytes = function (e) {
            for (var t = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", n = [], i = 0; i < e.length; ++i) {
              var r = t.indexOf(e.charAt(i++)),
                o = t.indexOf(e.charAt(i++)),
                s = t.indexOf(e.charAt(i++)),
                a = t.indexOf(e.charAt(i));
              n.push((r << 2) | (o >> 4)), s >= 0 && (n.push(((o << 4) & 240) | (s >> 2)), a >= 0 && n.push(((s << 6) & 192) | a));
            }
            return n;
          }),
          e
      ...
      var s = (function () {
        function t() {}
        return (
          (t.GetInt64 = function (t) {
            var n = new e.Bond.Int64("0"),
              i = this._Read(t);
            return (n.low = i[0]), i.length > 1 && (n.high = i[1]), n;
          }),
          (t.GetNumber = function (e) {
            return this._Read(e)[0];
          }),
          (t._Read = function (e) {
            for (var t = [], n = 0, i = !0, r = 0; i; ) {
              var o = e.shift();
              if (((i = 0 != (128 & o)), (o = 127 & o), !(r < 28))) {
                (n |= o << r), t.push(n), (n = o >> 4), (r = 3);
                break;
              }
              (n |= o << r), (r += 7);
            }
            for (; i; ) {
              var o = e.shift();
              if (((i = 0 != (128 & o)), (o = 127 & o), (n |= o << r), (r += 7), r >= 32)) break;
            }
            return t.push(n), t;
          }),
          t
      ...
      var a = (function () {
        ...
        return (
          (e.GetNumber = function (e) {
            if (t.BrowserChecker.IsDataViewSupport()) {
              for (var n = new DataView(new ArrayBuffer(4)), i = 0; i < 4; ++i) n.setUint8(i, e[i]);
              return n.getFloat32(0, !0);
            }
            return r.ConvertArrayToNumber(e, !1);
          }),
          e
        );
      })();
      ...
      var u = (function () {
        ...
        return (
          (e.GetNumber = function (e) {
            if (t.BrowserChecker.IsDataViewSupport()) {
              for (var n = new DataView(new ArrayBuffer(8)), i = 0; i < 8; ++i) n.setUint8(i, e[i]);
              return n.getFloat64(0, !0);
            }
            return r.ConvertArrayToNumber(e, !0);
          }),
          e
        );
      })();
        ...
        return (
          ...
          (t.DecodeZigzag64 = function (t) {
            var n = 1 & t.high,
              ...
              r = 1 & t.low,
              o = t.low >>> 1;
            (o = (n << 31) | o), r && ((o ^= 4294967295), (i ^= 4294967295));
            var s = new e.Bond.UInt64("0");
            return (s.low = o), (s.high = i), s;
          }),
          t
        );
      })();
      n.Zigzag = d;
    })((i = t.Decoding || (t.Decoding = {})));
    var r = (function () {
      function e() {}
      return (
        (e.ConvertNumberToArray = function (e, t) {
          ...
          var n = t ? 11 : 8,
            ...
            a = e < 0 ? 1 : 0;
          e = Math.abs(e);
          for (var u = Math.floor(e), d = e - u, c = 2 * (r + 2) + i, l = new Array(c), _ = 0; _ < c; ) l[_++] = 0;
          for (_ = r + 2; _ && u; ) (l[--_] = u % 2), (u = Math.floor(u / 2));
          for (_ = r + 1; _ < c - 1 && d > 0; ) (d *= 2), d >= 1 ? ((l[++_] = 1), --d) : (l[++_] = 0);
          for (var f = 0; f < c && !l[f]; ++f);
          var h = r + 1 - f,
            p = f + i;
          if (l[p + 1]) {
            for (_ = p; _ > f && !(l[_] = 1 - l[_]); --_);
            _ == f && ++h;
          }
          if (h > s || u)
            return a ? (t ? this._doubleNegInifinity : this._floatNegInifinity) : t ? this._doubleInifinity : this._floatInifinity;
          if (h < o) return t ? this._doubleZero : this._floatZero;
          if (t) {
            var I = 0;
            for (_ = 0; _ < 20; ++_) I = (I << 1) | l[++f];
            for (var T = 0; _ < 52; ++_) T = (T << 1) | l[++f];
            (I |= (h + r) << 20), (I = (a << 31) | (2147483647 & I));
            var S = [255 & T, (T >> 8) & 255, (T >> 16) & 255, T >>> 24, 255 & I, (I >> 8) & 255, (I >> 16) & 255, I >>> 24];
            return S;
          }
          var g = 0;
          for (_ = 0; _ < 23; ++_) g = (g << 1) | l[++f];
          (g |= (h + r) << 23), (g = (a << 31) | (2147483647 & g));
          var S = [255 & g, (g >> 8) & 255, (g >> 16) & 255, g >>> 24];
          return S;
        }),
        (e.ConvertArrayToNumber = function (e, n) {
          var i = n ? 11 : 8,
            r = (1 << (i - 1)) - 1,
            o = 0 != (128 & e[n ? 7 : 3]),
            s = n ? ((127 & e[7]) << 4) | ((240 & e[6]) >> 4) : ((127 & e[3]) << 1) | ((128 & e[2]) >> 7);
          if (255 == s) throw new t.Exception("Not a valid float/double buffer.");
          var a = 1,
            u = 1;
          if (n) {
            var d = ((15 & e[6]) << 28) | ((255 & e[5]) << 20) | ((255 & e[4]) << 12),
              c = (e[3] << 24) | ((255 & e[2]) << 16) | ((255 & e[1]) << 8) | (255 & e[0]);
            if (!s && !d && !c) return 0;
            for (var l = 0; l < 20; ++l) (u /= 2), d < 0 && (a += u), (d <<= 1);
            for (var l = 0; l < 32; ++l) (u /= 2), c < 0 && (a += u), (c <<= 1);
          } else {
            var _ = ((127 & e[2]) << 25) | ((255 & e[1]) << 17) | ((255 & e[0]) << 9);
            if (!s && !_) return 0;
            for (var l = 0; l < 23; ++l) (u /= 2), _ < 0 && (a += u), (_ <<= 1);
          }
          return (a *= Math.pow(2, s - r)), o ? 0 - a : a;
        }),
...
!(function (e) {
  ...
  !(function (e) {
    var t = (function () {
      ...
      return (
        (t.prototype.WriteBlob = function (e) {
        ...
        (t.prototype.WriteFieldBegin = function (e, t, n) {
          t <= 5
            ...
            : (this._stream.WriteByte(224 | e), this._stream.WriteByte(t), this._stream.WriteByte(t >> 8));
        }),
  ...
  var t = (function () {
    ...
    return (
      ...
      (t.IsReactNative = function () {
        return (
          null === t._isReactNative &&
            ("undefined" != typeof navigator && navigator.product
              ? (t._isReactNative = "ReactNative" === navigator.product)
              : (t._isReactNative = !1)),
          t._isReactNative
        );
      }),
      ...
      (t.ajax = function (e, n) {
        var i = t._createConnection();
        if (e.headers) {
          var r = "qsp=true";
          for (var o in e.headers) (r += "&"), (r += encodeURIComponent(o)), (r += "="), (r += encodeURIComponent(e.headers[o]));
          e.url.indexOf("?") < 0 ? (e.url += "?") : (e.url += "&"), (e.url += r);
        }
        i.open(e.type, e.url, !n),
          e.complete &&
            ((i.onload = function () {
              "undefined" == typeof i.status && (i.status = 200), e.complete(i);
            }),
            (i.ontimeout = function () {
              "undefined" == typeof i.status && (i.status = 500), e.complete(i);
            }),
            (i.onerror = function () {
              e.complete(i);
            })),
      ...
      (t.IsUsingXDomainRequest = function () {
        if (null == t._usingXDomainRequest) {
          ...
          "undefined" == typeof e.withCredentials && "undefined" != typeof XDomainRequest
            ? (t._usingXDomainRequest = !0)
            : (t._usingXDomainRequest = !1);
        }
    ...
    !(function (e) {
      ...
      !(function (t) {
        ...
        var i =
          ...
          (function () {
            function t() {
              (this.ScrubType = e.datamodels.PIIScrubber.NotSet), (this.Kind = e.datamodels.PIIKind.NotSet), (this.RawContent = "");
            }
            return (
              ...
              (t.prototype.WriteImpl = function (t, n) {
                t.WriteStructBegin(null, n),
                  this.ScrubType != e.datamodels.PIIScrubber.NotSet
                    ? (t.WriteFieldBegin(Microsoft.Bond.BondDataType.BT_INT32, 1, null), t.WriteInt32(this.ScrubType), t.WriteFieldEnd())
                    : t.WriteFieldOmitted(Microsoft.Bond.BondDataType.BT_INT32, 1, null),
                  this.Kind != e.datamodels.PIIKind.NotSet
                    ? (t.WriteFieldBegin(Microsoft.Bond.BondDataType.BT_INT32, 2, null), t.WriteInt32(this.Kind), t.WriteFieldEnd())
                    : t.WriteFieldOmitted(Microsoft.Bond.BondDataType.BT_INT32, 2, null),
                  "" != this.RawContent
                    ? (t.WriteFieldBegin(Microsoft.Bond.BondDataType.BT_STRING, 3, null), t.WriteString(this.RawContent), t.WriteFieldEnd())
                    : t.WriteFieldOmitted(Microsoft.Bond.BondDataType.BT_STRING, 3, null),
                  t.WriteStructEnd(n);
              }),
        ...
        var r = (function () {
          ...
          return (
            (t.prototype.AddOrReplacePII = function (t, n, i) {
              var r = new e.datamodels.PII();
              (r.RawContent = n), (r.Kind = i), (r.ScrubType = e.datamodels.PIIScrubber.O365), this.PIIExtensions.AddOrReplace(t, r);
            }),
            (t.prototype.Write = function (e) {
              this.WriteImpl(e, !1);
            }),
            (t.prototype.WriteImpl = function (t, n) {
              if (
                (t.WriteStructBegin(null, n),
                "" != this.Id
                  ? (t.WriteFieldBegin(Microsoft.Bond.BondDataType.BT_STRING, 1, null), t.WriteString(this.Id), t.WriteFieldEnd())
                  : t.WriteFieldOmitted(Microsoft.Bond.BondDataType.BT_STRING, 1, null),
                this.Timestamp.Equals("0")
                  ? t.WriteFieldOmitted(Microsoft.Bond.BondDataType.BT_INT64, 3, null)
                  : (t.WriteFieldBegin(Microsoft.Bond.BondDataType.BT_INT64, 3, null), t.WriteInt64(this.Timestamp), t.WriteFieldEnd()),
                "" != this.Type
                  ? (t.WriteFieldBegin(Microsoft.Bond.BondDataType.BT_STRING, 5, null), t.WriteString(this.Type), t.WriteFieldEnd())
                  : t.WriteFieldOmitted(Microsoft.Bond.BondDataType.BT_STRING, 5, null),
                "" != this.EventType
                  ? (t.WriteFieldBegin(Microsoft.Bond.BondDataType.BT_STRING, 6, null), t.WriteString(this.EventType), t.WriteFieldEnd())
                  : t.WriteFieldOmitted(Microsoft.Bond.BondDataType.BT_STRING, 6, null),
                this.Extension.Count())
              ) {
                t.WriteFieldBegin(Microsoft.Bond.BondDataType.BT_MAP, 13, null),
                  t.WriteMapContainerBegin(
                    this.Extension.Count(),
                    Microsoft.Bond.BondDataType.BT_STRING,
                    Microsoft.Bond.BondDataType.BT_STRING
                  );
                for (var i = 0; i < this.Extension.GetBuffer().length; ++i)
                  t.WriteString(this.Extension.GetBuffer()[i].Key), t.WriteString(this.Extension.GetBuffer()[i].Value);
                t.WriteContainerEnd(), t.WriteFieldEnd();
              } else t.WriteFieldOmitted(Microsoft.Bond.BondDataType.BT_MAP, 13, null);
              if (
                (this.RecordType != e.datamodels.RecordType.NotSet
                  ? (t.WriteFieldBegin(Microsoft.Bond.BondDataType.BT_INT32, 24, null), t.WriteInt32(this.RecordType), t.WriteFieldEnd())
                  : t.WriteFieldOmitted(Microsoft.Bond.BondDataType.BT_INT32, 24, null),
                this.PIIExtensions.Count())
              ) {
                t.WriteFieldBegin(Microsoft.Bond.BondDataType.BT_MAP, 30, null),
                  t.WriteMapContainerBegin(
                    this.PIIExtensions.Count(),
                    Microsoft.Bond.BondDataType.BT_STRING,
                    Microsoft.Bond.BondDataType.BT_STRUCT
                  );
                for (var r = 0; r < this.PIIExtensions.GetBuffer().length; ++r)
                  t.WriteString(this.PIIExtensions.GetBuffer()[r].Key), this.PIIExtensions.GetBuffer()[r].Value.WriteImpl(t, !1);
                t.WriteContainerEnd(), t.WriteFieldEnd();
              } else t.WriteFieldOmitted(Microsoft.Bond.BondDataType.BT_MAP, 30, null);
              t.WriteStructEnd(n);
            }),
            (t.prototype.Read = function (e) {
              this.ReadImpl(e, !1);
          ...
          return (
            ...
            (e.prototype.WriteImpl = function (e, t) {
              if (
                ...
                "" != this.Source
                  ? (e.WriteFieldBegin(Microsoft.Bond.BondDataType.BT_STRING, 2, null), e.WriteString(this.Source), e.WriteFieldEnd())
                  : e.WriteFieldOmitted(Microsoft.Bond.BondDataType.BT_STRING, 2, null),
                "" != this.DataPackageId
                  ? (e.WriteFieldBegin(Microsoft.Bond.BondDataType.BT_STRING, 5, null),
                    e.WriteString(this.DataPackageId),
                    e.WriteFieldEnd())
                  : e.WriteFieldOmitted(Microsoft.Bond.BondDataType.BT_STRING, 5, null),
                this.Timestamp.Equals("0")
                  ? e.WriteFieldOmitted(Microsoft.Bond.BondDataType.BT_INT64, 6, null)
                  : (e.WriteFieldBegin(Microsoft.Bond.BondDataType.BT_INT64, 6, null), e.WriteInt64(this.Timestamp), e.WriteFieldEnd()),
                this.Records.length)
              ) {
                e.WriteFieldBegin(Microsoft.Bond.BondDataType.BT_LIST, 8, null),
                  e.WriteContainerBegin(this.Records.length, Microsoft.Bond.BondDataType.BT_STRUCT);
          ...
          return (
            ...
            (e.prototype.WriteImpl = function (e, t) {
              if ((e.WriteStructBegin(null, t), this.DataPackages.length)) {
                e.WriteFieldBegin(Microsoft.Bond.BondDataType.BT_LIST, 1, null),
                  e.WriteContainerBegin(this.DataPackages.length, Microsoft.Bond.BondDataType.BT_STRUCT);
              ...
              0 != this.RequestRetryCount
                ? (e.WriteFieldBegin(Microsoft.Bond.BondDataType.BT_INT32, 2, null),
                  e.WriteInt32(this.RequestRetryCount),
                  e.WriteFieldEnd())
                : e.WriteFieldOmitted(Microsoft.Bond.BondDataType.BT_INT32, 2, null),
                e.WriteStructEnd(t);
            }),
            (e.prototype.Read = function (e) {
              this.ReadImpl(e, !1);
    ...
    !(function (e) {
      ...
      !(function (t) {
        ...
        var s = (function () {
          function e() {}
          return (
            (e.CreateTelemetryManager = function () {
              return new d();
            }),
            e
          );
        })();
        t.TelemetryManagerFactory = s;
        var a,
          u = (function () {
            function e() {}
            return (
              (e.MaxPackageSizeInBytes = function () {
                return 3e6;
              }),
        ...
        var d = (function () {
            ...
            return (
              (t.prototype.Initialize = function (e) {
                if (this._status != a.Created) throw new r(i.DATARV_ERROR_INVALID_STATUS);
                if (!e || !e.collectorUrl) throw new r(i.DATARV_ERROR_INVALID_CONFIG);
                (this._config = e), this._Reset(), (this._status = a.Initialized), this._Verbose("Initialize() done");
              }),
              (t.prototype.AddListener = function (e) {
                if (this._status < a.Initialized) throw new r(i.DATARV_ERROR_INVALID_STATUS);
                  ...
                  if (this._listeners[t] == e)
                    return (
                      1 == this._listeners.length
                        ? (this._listeners = [])
                        : t == this._listeners.length - 1
                        ? this._listeners.pop()
                        : (this._listeners[t] = this._listeners.pop()),
              ...
              (t.prototype.Start = function () {
                ...
                this._Verbose(["Start(), status:", this._status, "tag:", t._tag].join(" ")),
                  this._status >= a.Started && this._Verbose("Start() already, ignore"),
                  ++t._tag,
                  (this._status = a.Started),
              ...
              (t.prototype.Stop = function () {
                ...
                return (
                  ...
                  this._status == a.Initialized
                    ? void this._Verbose("Stop() already, ignore")
                    : (this._Reset(), (this._status = a.Initialized), void this._Verbose("Stop() done, status: " + this._status))
                );
              }),
              ...
              (t.prototype.SendAsync = function (e, n) {
                ...
                for (var o = 0; o < n.length; ++o)
                  if (!n[o].Id || !t._eventTypeRegex.test(n[o].EventType) || n[o].Timestamp.Equals("0"))
                    throw (
                      (this._Error(
                        [
                          "eventId:",
                      ...
                      new r(i.DATARV_ERROR_INVALID_EVENT))
                    );
                return (
                  this._eventsCache.AddEvents(e, n),
              ...
              (t.prototype._WorkThread = function (e, n) {
                var i = this;
                try {
                  if ((this._Verbose("_WorkThread, status: " + this._status), this._status < a.Started))
                  ...
                  if ((this._eventsCache.AddEvents(r.tenantToken, o.remainedEvents), null == o.buffer || 0 == o.buffer.length))
                    return void (this._eventsCache.IsEmpty()
                      ? (this._Verbose("eventsCache is empty, stop schedule"), this._CleanTimer())
                      : (this._Verbose("eventsCache is not empty, schedule for next run"), this._ScheduleTimer(!1)));
                  if (this._testServerResponseHook) {
                    var s = this._testServerResponseHook();
                    return void setTimeout(this._SendCallback(d, r.tenantToken, o.sendEvents, s, !1, null), 100);
                  }
                  var u = {
                    type: "POST",
                    ...
                    complete: function (t) {
                      return i._SendCallback(d, r.tenantToken, o.sendEvents, t, n, e);
                    }
                  };
                  sct.Utils.IsUint8ArrSupported()
                    ? (this._Verbose("Uint8Array is defined, send with binary format directly."), (u.data = new Uint8Array(o.buffer)))
                    : (this._Verbose("Uint8Array is undefined, send with base64 encode."),
                      (u.data = Microsoft.Bond.Encoding.Base64.GetString(o.buffer)),
                      (u.headers["content-encoding"] = "base64")),
                    r.tenantToken && (u.headers["x-apikey"] = r.tenantToken);
                  var d = t._tag;
                  (this._lastActiveTime = new Date().getTime()),
                    sct.Utils.ajax(u, n),
                    this._Verbose("_Workthread, send via jquery, tag: " + d);
                } catch (e) {
              ...
              (t.prototype._PackEvents = function (t, n) {
                ...
                var i = new e.datamodels.ClientToCollectorRequest(),
                  r = new e.datamodels.DataPackage();
                (r.Source = "JS_default_source"),
                  (r.DataPackageId = e.datamodels.utils.GetGuid()),
                  (r.Timestamp = e.datamodels.utils.GetTimeStamp());
                var o,
                  s = n;
                for (n = []; ; ) {
                  if (
                    ((r.Records = []),
                    r.Records.push.apply(r.Records, s),
                    (i.DataPackages = []),
                    i.DataPackages.push(r),
                    (o = this._Serialize(i)),
                    this._Verbose(
                      [
                    ...
                    o.length < this._MaxPackageSizeInBytes)
                  )
                    break;
                  if (1 == s.length) {
                    (s = []), (o = null);
                  ...
                  var a = s.splice(0, Math.floor(s.length / 2));
                  this._Verbose("_PackageEvents, too large, package again"), n.push.apply(n, s), (s = a);
                }
                return (
                  this._Verbose(
                    [
                  ...
                  { buffer: o, sendEvents: s, remainedEvents: n }
                );
              }),
              ...
              (t.prototype._SendCallback = function (e, i, r, o, s, u) {
                if (
                  (this._Verbose(
                    ["_SendCallback", "tag:", e, "current tag:", t._tag, "tenantToken:", i, "events count:", r.length, "jqXHR:", o].join("")
                  ),
                  u && u(o ? o.status : 0, i, r),
                  !s)
                ) {
                  var d = null != o && o.status >= 200 && o.status < 300;
                  if (this._status < a.Started || e < t._tag)
                    return void this._Verbose("_SendCallback, is not started, or tag is not the same, return");
                  if (!d && (!o || (o.status && 400 != o.status)))
                    return (
                      this._Verbose("retry statusCode: " + (o ? o.status : 0)),
                      this._eventsCache.AddEvents(i, r),
                      void this._ScheduleTimer(!0)
                    );
                  for (var c = 0; c < this._listeners.length; ++c) this._listeners[c](d ? n.SENT : n.SEND_FAILED, o ? o.status : 0, i, r);
              ...
              (t.prototype._ScheduleTimer = function (e) {
                ...
                if (!this._isPaused)
                  if ((this._Verbose("_ScheduleTimer: isRetry: " + e), this._CleanTimer(), e)) {
                    ...
                    var n = 0,
                      i = new Date().getTime(),
                      r = i - this._lastActiveTime;
                    (n = r > u.TimeIntervalForNextSendInMS() ? 0 : u.TimeIntervalForNextSendInMS() - r),
                      (this._timer = setTimeout(function () {
                        return t._WorkThread(null, !1);
                      }, n)),
          ...
          c = (function () {
            ...
            return (
              (e.prototype.AddEvents = function (e, t) {
                t.length &&
              ...
              (e.prototype.DequeuEvents = function () {
                ...
                var e = this._tokens.shift(),
                  t = this._events[e];
                return delete this._events[e], { tenantToken: e, events: t };
              }),
...
!(function (e) {
  ...
  !(function (t) {
    ...
    !(function (t) {
      var n = t._sender.TelemetryManagerFactory.CreateTelemetryManager(),
        i = (function () {
          function e() {
            (this.collectorUrl = null), (this.enableAutoUserSession = !1), (this.browserOverrides = new r());
          }
          return e;
        })();
      ...
      var o = (function () {
        ...
        s = (function () {
          ...
          return (
            (e.prototype.setProperty = function (n, i, r) {
              if (!n || !e._propertyNameRegex.test(n)) throw new u(a.INVALID_PROPERTY_NAME);
              r
                ? (this.properties[n] = { value: i, pii: r != t.datamodels.PIIKind.NotSet ? r : null })
                : (this.properties[n] = { value: i, pii: null });
            }),
      ...
      (t.EventProperties = s),
        ...
        })(t.TelemetryError || (t.TelemetryError = {}));
      ...
      var d = (function () {
        ...
        return (
          (n.prototype.setAppId = function (e) {
          ...
          (n.prototype.setDeviceId = function (e) {
            e && this._allowDeviceInfoFields && ((this.contextMap["DeviceInfo.Id"] = e), c.checkAndUpdateDeviceId(e));
          }),
          ...
          (n.prototype.setUserId = function (t, n, i) {
            if ((t && (this.contextMap["UserInfo.Id"] = t), i)) this.contextMap["UserInfo.IdType"] = i;
            else {
              var r;
              switch (n) {
                case e.applications.telemetry.datamodels.PIIKind.SipAddress:
                  r = e.applications.telemetry.datamodels.UserIdType.SipAddress;
                  break;
                case e.applications.telemetry.datamodels.PIIKind.PhoneNumber:
                  r = e.applications.telemetry.datamodels.UserIdType.PhoneNumber;
                  break;
                case e.applications.telemetry.datamodels.PIIKind.SmtpAddress:
                  r = e.applications.telemetry.datamodels.UserIdType.EmailAddress;
                  break;
                default:
                  r = e.applications.telemetry.datamodels.UserIdType.Unknown;
              }
              this.contextMap["UserInfo.IdType"] = r;
            }
            if (n) o._isPii(n) && (this.piiKind = n);
            else {
              var s;
              switch (i) {
                case e.applications.telemetry.datamodels.UserIdType.Skype:
                  s = e.applications.telemetry.datamodels.PIIKind.Identity;
                  break;
                case e.applications.telemetry.datamodels.UserIdType.EmailAddress:
                  s = e.applications.telemetry.datamodels.PIIKind.SmtpAddress;
                  break;
                case e.applications.telemetry.datamodels.UserIdType.PhoneNumber:
                  s = e.applications.telemetry.datamodels.PIIKind.PhoneNumber;
                  break;
                case e.applications.telemetry.datamodels.UserIdType.SipAddress:
                  s = e.applications.telemetry.datamodels.PIIKind.SipAddress;
                  break;
                default:
                  s = e.applications.telemetry.datamodels.PIIKind.NotSet;
              }
              o._isPii(s) && (this.piiKind = s);
            }
          }),
        ...
        return (
          (e.initialize = function (n) {
            ...
            var o = new Date().getTimezoneOffset(),
              ...
              u = "+";
            a > 0 && (u = "-"),
              e.semanticContext.setUserTimeZone(u + (a < 10 ? "0" + a : a.toString()) + ":" + (s < 10 ? "0" + s : s.toString()));
            var d = e._getUserAgent();
            d &&
              (e.semanticContext.setDeviceBrowserName(e._getBrowserName()),
            ...
            var c = e._getData(e.DEVICE_ID_COOKIE);
            (c && "" != c) || (c = t.datamodels.utils.GetGuid()), e.semanticContext.setDeviceId(c);
          }),
          (e.checkAndUpdateDeviceId = function (t) {
            var n = e._getData(e.DEVICE_ID_COOKIE);
            n != t && (e._saveData(e.DEVICE_ID_COOKIE, t), e._saveData(e.FIRST_LAUNCH_TIME_COOKIE, new Date().getTime().toString()));
            var i = e._getData(e.FIRST_LAUNCH_TIME_COOKIE);
            e.firstLaunchTime = parseInt(i);
          }),
          (e._saveData = function (e, t) {
            if (this._overrides.onSaveData) this._overrides.onSaveData(e, t);
            else if ("undefined" != typeof document && document.cookie) {
              var n = "expires=Mon, 31 Dec 2029 23:59:59 GMT";
              document.cookie = e + "=" + t + "; " + n;
            }
          }),
          (e._getData = function (e) {
            if (this._overrides.onGetData) return this._overrides.onGetData(e) || "";
            if ("undefined" != typeof document && document.cookie)
              for (var t = e + "=", n = document.cookie.split(";"), i = 0; i < n.length; i++) {
                for (var r = n[i], o = 0; " " == r.charAt(o); ) o++;
                if (((r = r.substring(o)), 0 == r.indexOf(t))) return r.substring(t.length, r.length);
              }
            return "";
          }),
          ...
          (e._getBrowserName = function () {
            return e._isOpera()
              ? e.BROWSERS.UNKNOWN
              : e._userAgentContainsString(e.BROWSERS.PHANTOMJS)
              ? e.BROWSERS.PHANTOMJS
              : e._isIe()
              ? e.BROWSERS.MSIE
              : e._isEdge()
              ? e.BROWSERS.EDGE
              : e._userAgentContainsString(e.BROWSERS.ELECTRON)
              ? e.BROWSERS.ELECTRON
              : e._userAgentContainsString(e.BROWSERS.CHROME)
              ? e.BROWSERS.CHROME
              : e._userAgentContainsString(e.BROWSERS.FIREFOX)
              ? e.BROWSERS.FIREFOX
              : e._userAgentContainsString(e.BROWSERS.SAFARI)
              ? e.BROWSERS.SAFARI
              : e._userAgentContainsString(e.BROWSERS.SKYPE_SHELL)
              ? e.BROWSERS.SKYPE_SHELL
              : e.BROWSERS.UNKNOWN;
          }),
          (e._getBrowserVersion = function () {
            function t() {
              var t,
                n = e._getUserAgent(),
                i = n.match(new RegExp(e.BROWSERS.MSIE + " " + e.REGEX_VERSION));
              return i ? i[1] : (t = n.match(new RegExp("rv:" + e.REGEX_VERSION))) ? t[1] : void 0;
            }
            function n(t) {
              var n;
              return (
                t === e.BROWSERS.SAFARI && (t = "Version"),
                (n = e._getUserAgent().match(new RegExp(t + "/" + e.REGEX_VERSION))),
                n ? n[1] : e.UNKNOWN_VERSION
              );
            }
            return e._isIe() ? t() : n(e._getBrowserName());
          }),
          (e._getOsName = function () {
            var t = /(windows|win32)/i,
              n = / arm;/i,
              i = /windows\sphone\s\d+\.\d+/i,
              r = /(macintosh|mac os x)/i,
              o = /(iPad|iPhone|iPod)(?=.*like Mac OS X)/i,
              s = /(linux|joli|[kxln]?ubuntu|debian|[open]*suse|gentoo|arch|slackware|fedora|mandriva|centos|pclinuxos|redhat|zenwalk)/i,
              a = /android/i;
            return e._getUserAgent().match(i)
              ? e.OPERATING_SYSTEMS.WINDOWS_PHONE
              : e._getUserAgent().match(n)
              ? e.OPERATING_SYSTEMS.WINDOWS_RT
              : e._getUserAgent().match(o)
              ? e.OPERATING_SYSTEMS.IOS
              : e._getUserAgent().match(a)
              ? e.OPERATING_SYSTEMS.ANDROID
              : e._getUserAgent().match(s)
              ? e.OPERATING_SYSTEMS.LINUX
              : e._getUserAgent().match(r)
              ? e.OPERATING_SYSTEMS.MACOSX
              : e._getUserAgent().match(t)
              ? e.OPERATING_SYSTEMS.WINDOWS
              : e.OPERATING_SYSTEMS.UNKNOWN;
          }),
          (e._getOsVersion = function () {
            ...
            return e._getOsName() === e.OPERATING_SYSTEMS.WINDOWS
              ? t()
              : e._getOsName() === e.OPERATING_SYSTEMS.MACOSX
              ? n()
              : e.UNKNOWN_VERSION;
          }),
          (e.semanticContext = new d(!0)),
          (e.firstLaunchTime = -1),
          (e.BROWSERS = {
            MSIE: "MSIE",
            CHROME: "Chrome",
          ...
          (e.VERSION_MAPPINGS = { 5.1: "XP", "6.0": "Vista", 6.1: "7", 6.2: "8", 6.3: "8.1", "10.0": "10" }),
          (e.REGEX_VERSION = "([\\d,.]+)"),
          (e.REGEX_VERSION_MAC = "([\\d,_,.]+)"),
          (e.UNKNOWN_VERSION = "Unknown"),
          (e.DEVICE_ID_COOKIE = "MicrosoftApplicationsTelemetryDeviceId"),
          (e.FIRST_LAUNCH_TIME_COOKIE = "MicrosoftApplicationsTelemetryFirstLaunchTime"),
          e
        );
      })();
      !(function (e) {
      ...
      var l = t.SessionState,
        _ = (function () {
          function e() {}
          return (
            (e.initialize = function (t, i) {
              if (!e._initialized) {
                if (!t) throw new u(a.INVALID_TENANT_TOKEN);
                if (
                  ((e._defaultToken = t),
                  (e._tmConfig.collectorUrl = "https://browser.pipe.aria.microsoft.com/Collector/3.0/"),
                  (e._configuration = i),
                  !("undefined" != typeof window || (i && i.browserOverrides && i.browserOverrides.onGetData)))
                )
                  throw new u(a.INVALID_CONFIGURATION_USE_CUSTOM_GET_SET);
                var o = new r();
                if (i && (i.collectorUrl && (e._tmConfig.collectorUrl = i.collectorUrl), i.browserOverrides)) {
                  if (i.browserOverrides.onGetData ? !i.browserOverrides.onSaveData : !!i.browserOverrides.onSaveData)
                    throw new u(a.INVALID_CONFIGURATION_USE_CUSTOM_GET_SET);
                  (o.onGetData = i.browserOverrides.onGetData), (o.onSaveData = i.browserOverrides.onSaveData);
                }
                n.Initialize(e._tmConfig),
                  ...
                  "undefined" != typeof window &&
                    ...
                    (i && i.enableAutoUserSession && ((e._logger = new f()), e._logger.logSession(l.STARTED)),
            ...
            (e.setContext = function (t, n, i) {
              e._contextProperties.setProperty(t, n, i);
            }),
            ...
            (e._teardown = function () {
              e._logger && e._logger.logSession(l.ENDED), e.flush();
            }),
            (e.__backToUninitialized = function () {
              (e._tmConfig = new t._sender.TelemetryConfig()),
                (e._semanticContext = new d(!0)),
                (e._contextProperties = new s()),
      ...
      var f = (function () {
        function e(e) {
          (this._initId = null),
            ...
            (this._contextProperties = new s()),
            (this._semanticContext = new d(!1)),
            (this._sessionStartTime = 0),
            (this._sessionId = null),
            e ? (this._tenantToken = e) : (this._tenantToken = _.getDefaultToken()),
            (this._initId = _._getInitIdForToken(this._tenantToken));
        }
        return (
          (e.prototype.logEvent = function (e) {
            if (!e.name) throw new u(a.MISSING_EVENT_PROPERTIES_NAME);
            var t = this._createEventRecord(e.name, e.eventType);
            this._addPropertiesAndSendEvent(t, e);
          }),
          (e.prototype.logFailure = function (e, t, n, i, r) {
            if (!e) throw new u(a.MISSING_FAILURE_SIGNATURE);
            if (!t) throw new u(a.MISSING_FAILURE_DETAIL);
            var o = this._createEventRecord("failure", "failure");
            o.Extension.Add("Failure.Signature", e),
              o.Extension.Add("Failure.Detail", t),
              n && o.Extension.Add("Failure.Category", n),
              i && o.Extension.Add("Failure.Id", i),
              this._addPropertiesAndSendEvent(o, r);
          }),
          (e.prototype.logPageView = function (e, t, n, i, r, o) {
            if (!e) throw new u(a.MISSING_PAGEVIEW_ID);
            if (!t) throw new u(a.MISSING_PAGEVIEW_NAME);
            ...
            s.Extension.Add("PageView.Id", e),
              ...
              i && s.Extension.Add("PageView.Uri", i),
              r && s.Extension.Add("PageView.ReferrerUri", r),
              this._addPropertiesAndSendEvent(s, o);
          }),
          (e.prototype.logSession = function (e, n) {
            if (e !== l.STARTED && e !== l.ENDED) throw new u(a.INVALID_SESSION_STATE);
            ...
            if (e === l.STARTED) {
              ...
              (this._sessionStartTime = new Date().getTime()),
                ...
                i.Extension.Add("Session.State", "Started");
            } else if (e === l.ENDED) {
              if (0 == this._sessionStartTime) return;
              var r = Math.floor((new Date().getTime() - this._sessionStartTime) / 1e3);
              i.Extension.Add("Session.Duration", r.toString()),
                i.Extension.Add("Session.DurationBucket", this._getSessionDurationFromTime(r)),
                i.Extension.Add("Session.Id", this._sessionId),
                i.Extension.Add("Session.State", "Ended"),
                (this._sessionId = null),
                (this._sessionStartTime = 0);
            }
            i.Extension.Add("Session.FirstLaunchTime", this._getISOString(new Date(c.firstLaunchTime))),
              this._addPropertiesAndSendEvent(i, n);
          }),
          ...
          (e.prototype._createEventRecord = function (e, n) {
            ...
            n || (n = "custom"),
              ...
              i.Extension.Add("EventInfo.Sequence", _._getSequenceForToken(this._tenantToken).toString()),
              i.Extension.Add("EventInfo.Name", e.toLowerCase());
            var r = new Date();
            return (
              (i.Timestamp = t.datamodels.utils.GetTimeStampWithValue(r.getTime())),
              i.Extension.Add("EventInfo.Time", this._getISOString(r)),
              i.Extension.Add("EventInfo.SdkVersion", "ACT-Web-JS-" + clienttelemetry_build.version),
              i
            );
          }),
          ...
          (e.prototype._addCustomPropertiesToEvent = function (e, t) {
            this._addSemanticContext(e, c.semanticContext),
              this._addSemanticContext(e, _._semanticContext),
              this._addSemanticContext(e, this._semanticContext),
              this._sessionId && e.Extension.Add("Session.Id", this._sessionId),
              this._addEventPropertiesToEvent(e, _._contextProperties),
          ...
          (e.prototype._addSemanticContext = function (e, n) {
            if (n && n.contextMap) {
              ...
              for (var r in n.contextMap)
                "UserInfo.Id" == r && n.piiKind != t.datamodels.PIIKind.NotSet
                  ? e.AddOrReplacePII(r, i[r], n.piiKind)
                  : e.Extension.AddOrReplace(r, i[r]);
            }
          }),
          (e.prototype._addEventPropertiesToEvent = function (e, n) {
            if (n) {
              n.timestamp &&
                n.timestamp >= new Date("1/1/2000").getTime() &&
                ((e.Timestamp = t.datamodels.utils.GetTimeStampWithValue(n.timestamp)),
                e.Extension.AddOrReplace("EventInfo.Time", this._getISOString(new Date(n.timestamp)))),
                n.name && ((e.EventType = n.name.toLowerCase()), e.Extension.AddOrReplace("EventInfo.Name", n.name.toLowerCase()));
              var i = n.properties;
              if (i)
                for (var r in i)
                  r &&
                    (i[r].value || i[r].value === !1 || 0 == i[r].value || "" == i[r].value) &&
                    (o._isPii(i[r].pii)
                      ? (e.AddOrReplacePII(r, i[r].value.toString(), i[r].pii), e.Extension.Remove(r))
                      : (e.Extension.AddOrReplace(r, i[r].value.toString()), e.PIIExtensions.Remove(r)));
            }
          }),
          (e.prototype._addPropertiesAndSendEvent = function (e, t) {
            this._addCustomPropertiesToEvent(e, t), _.isInitialized() && (this._sanitizeName(e), n.SendAsync(this._tenantToken, [e]));
          }),
  ...
  "undefined" != typeof module && (module.exports = microsoft.applications.telemetry);
