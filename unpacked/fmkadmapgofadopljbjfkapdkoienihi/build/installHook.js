(() => {
  ...
  window.hasOwnProperty("__REACT_DEVTOOLS_GLOBAL_HOOK__") ||
    (!(function (e) {
      ...
      function patchConsoleForInitialRenderInStrictMode({ hideConsoleLogsInStrictMode: e, browserTheme: t }) {
        ...
        (o = () => {
          ...
          ["error", "group", "groupCollapsed", "info", "log", "trace", "warn"].forEach((o) => {
            try {
              const i = (r[o] = n[o].__REACT_DEVTOOLS_STRICT_MODE_ORIGINAL_METHOD__
                ...
                overrideMethod = (...n) => {
                  if (!e) {
                    ...
                    i(
                      ...((r = n),
                      (_ = `color: ${e}`),
                      null == r || 0 === r.length || ("string" == typeof r[0] && r[0].match(/([^%]|^)(%c)/g)) || void 0 === _
                        ? r
                        : "string" == typeof r[0] && r[0].match(/([^%]|^)((%%)*)(%([oOdisf]))/g)
                        ? [`%c${r[0]}`, _, ...r.slice(1)]
                        : [
                            r.reduce((e, n, t) => {
                              switch ((t > 0 && (e += " "), typeof n)) {
                                case "string":
                                case "boolean":
                                case "symbol":
                                  return e + "%s";
      ...
      const s = {},
        ...
        O = {
          ...
          inject: function (n) {
                  ...
                  try {
                    ...
                    if (e.Mount && e.Mount._renderNewRootComponent) {
                      ...
                      return 0 !== t.indexOf("function")
                        ...
                        ? -1 !== t.indexOf("NODE_ENV") || -1 !== t.indexOf("development") || -1 !== t.indexOf("true")
                          ? "development"
            ...
            return O.emit("renderer", { id: t, renderer: n, reactBuildType: o }), t;
          },
          on: function (e, n) {
            u[e] || (u[e] = []), u[e].push(n);
          },
          off: function (e, n) {
            ...
            -1 !== t && u[e].splice(t, 1), u[e].length || delete u[e];
          },
          sub: function (e, n) {
            return O.on(e, n), () => O.off(e, n);
          },
          supportsFiber: !0,
          checkDCE: function (e) {
            try {
      ...
      Object.defineProperty(e, "__REACT_DEVTOOLS_GLOBAL_HOOK__", { configurable: !1, enumerable: !1, get: () => O });
    })(window),
