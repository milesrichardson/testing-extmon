(window.equatioChromeJsonp = window.equatioChromeJsonp || []).push([
  [22, 25],
  {
      ...
      !function (e) {
        ...
        function w(e) {
          ...
          if ("blob:" === e.protocol) n = new E(unescape(e.pathname), {});
            ...
            void 0 === n.slashes && (n.slashes = B.test(e.href));
          }
          return n;
        }
        function v(e) {
        ...
        function E(e, t, r) {
          ...
          r && (l.query = r(l.query)),
            ...
            "/" !== l.pathname.charAt(0) && v(l.protocol) && (l.pathname = "/" + l.pathname),
            ...
            (l.origin = "file:" !== l.protocol && v(l.protocol) && l.host ? l.protocol + "//" + l.host : "null"),
            (l.href = l.toString());
        }
        function K(e, t, r) {
          var n = this;
        ...
        function W(e) {
          ...
          var t = this,
            ...
            n =
              ...
              n + ((t.protocol && t.slashes) || v(t.protocol) ? "//" : ""));
          return (
            t.username
          ...
          e = t(function (e, r) {
            ...
            function o(e, t, r) {
              ...
              if (ArrayBuffer.isView(e))
                return I((a = e), Uint8Array) ? u((n = new Uint8Array(a)).buffer, n.byteOffset, n.byteLength) : s(a);
              if (null != e) {
                if (I(e, ArrayBuffer) || (e && I(e.buffer, ArrayBuffer))) return u(e, t, r);
                ...
                if (
                  ...
                  (o = p.isBuffer(n)
                    ...
                    : void 0 !== n.length
                    ? "number" != typeof n.length || j(n.length)
                      ? i(0)
                      : s(n)
            ...
            function d(e, t, r) {
              ...
              for (e = e || "utf8"; ; )
                switch (e) {
                  ...
                  case "base64":
                    return (w = this), (n = r), 0 === (v = t) && n === w.length ? _.fromByteArray(w) : _.fromByteArray(w.slice(v, n));

                  case "ucs2":
                  case "ucs-2":
                  case "utf16le":
                  case "utf-16le":
                    for (var w = t, v = r, x = this.slice(w, v), E = "", O = 0; O < x.length - 1; O += 2)
            ...
            function b(e, t, r, n, o) {
              ...
              if (
                ...
                (r = (r = j((r = +r)) ? (o ? 0 : e.length - 1) : r) < 0 ? e.length + r : r) >= e.length)
              ) {
                if (o) return -1;
                r = e.length - 1;
              } else if (r < 0) {
            ...
            function S(e, t, r) {
              ...
              var f = n,
                d = f.length;
              if (d <= w) return String.fromCharCode.apply(String, f);
              for (var h = "", b = 0; b < d; ) h += String.fromCharCode.apply(String, f.slice(b, (b += w)));
              return h;
            }
            (r.kMaxLength = n),
              ...
              (p.compare = function (e, t) {
                if (
                  (I(e, Uint8Array) && (e = p.from(e, e.offset, e.byteLength)),
                  I(t, Uint8Array) && (t = p.from(t, t.offset, t.byteLength)),
              ...
              (p.concat = function (e, t) {
                ...
                for (var r = p.allocUnsafe(t), n = 0, o = 0; o < e.length; ++o) {
                  var a = e[o];
                  if (I(a, Uint8Array)) n + a.length > r.length ? p.from(a).copy(r, n) : Uint8Array.prototype.set.call(r, a, n);
                  else {
              ...
              (p.prototype.compare = function (e, t, r, n, o) {
                if ((I(e, Uint8Array) && (e = p.from(e, e.offset, e.byteLength)), !p.isBuffer(e)))
            ...
            function O(e, t, r, n, o) {
              return (t = +t), (r >>>= 0), o || E(e, 0, r, 4), L.write(e, t, r, n, 23, 4), r + 4;
            }
            function k(e, t, r, n, o) {
              return (t = +t), (r >>>= 0), o || E(e, 0, r, 8), L.write(e, t, r, n, 52, 8), r + 8;
            }
            (p.prototype.slice = function (e, t) {
              ...
              (p.prototype.readUint32LE = p.prototype.readUInt32LE =
                function (e, t) {
                  return (
                    (e >>>= 0), t || v(e, 4, this.length), (this[e] | (this[e + 1] << 8) | (this[e + 2] << 16)) + 16777216 * this[e + 3]
                  );
                }),
              (p.prototype.readUint32BE = p.prototype.readUInt32BE =
                function (e, t) {
                  return (
                    (e >>>= 0), t || v(e, 4, this.length), 16777216 * this[e] + ((this[e + 1] << 16) | (this[e + 2] << 8) | this[e + 3])
                  );
                }),
              ...
              (p.prototype.readInt16LE = function (e, t) {
                return (e >>>= 0), t || v(e, 2, this.length), 32768 & (t = this[e] | (this[e + 1] << 8)) ? 4294901760 | t : t;
              }),
              (p.prototype.readInt16BE = function (e, t) {
                return (e >>>= 0), t || v(e, 2, this.length), 32768 & (t = this[e + 1] | (this[e] << 8)) ? 4294901760 | t : t;
              }),
              ...
              (p.prototype.readFloatLE = function (e, t) {
                return (e >>>= 0), t || v(e, 4, this.length), L.read(this, e, !0, 23, 4);
              }),
              (p.prototype.readFloatBE = function (e, t) {
                return (e >>>= 0), t || v(e, 4, this.length), L.read(this, e, !1, 23, 4);
              }),
              (p.prototype.readDoubleLE = function (e, t) {
                return (e >>>= 0), t || v(e, 8, this.length), L.read(this, e, !0, 52, 8);
              }),
              (p.prototype.readDoubleBE = function (e, t) {
                return (e >>>= 0), t || v(e, 8, this.length), L.read(this, e, !1, 52, 8);
              }),
                    ...
                    e.file(function (e) {
                      ...
                      (t.onload = function () {
                        ...
                        null === e
                          ...
                          : ((e = M.from(e)), (e = j(e)), r(null === e ? null : e));
                      }),
          ...
          O = function (e) {
            ...
            return null !== t
              ...
              : fetch(e)
                  ...
                  .then(function (e) {
                    return (e = M.from(e)), j(e);
                  });
          };
        (ne.getLatexFromBuffer = j), (ne.getLatexFromPersistentUrl = R), (ne.getLatexFromKnownUrl = P), (ne.getLatexFromImageUrl = O);
      }.call(this, t(58));
    },
    117: function (e, t, r) {
      "use strict";
      ...
      t.a = (function () {
        var t = o()(
          O.a.mark(function e(t) {
            var r, n, o, a, c, i, s, u, l, p, f, d, h, b, m, g, y, w, v, x, E;
            return O.a.wrap(function (e) {
              for (;;)
                switch ((e.prev = e.next)) {
                  ...
                  case 105:
                    if (a === S.ToolModes.GraphEditor)
                      return (w = Object(S.getGraphRendering)()), (s = w.getScreenshot), (u = w.getState), (e.next = 109), s();
                    e.next = 123;
                    break;
                  ...
                  case 125:
                    (w = e.sent),
                      ...
                      v < 20 ? (E = "width=20") : x < 20 && (E = "height=20"),
                      (c =
    ...
    30: function (e, t, r) {
              ...
              return C.a.wrap(
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (e.prev = 0), (e.next = 3), Object(M.a)(t);
                      ...
                      case 8:
                        return (e.prev = 8), (e.next = 11), Object(M.O)(r);
      ...
      t.b = (S) => (O) => (t) => {
        switch (t.type) {
          case A.Events.Toolbar.OpenMathspace:
            Object(M.cb)(null), Object(L.a)();
            break;

          case A.Events.General.RequestLicense:
            k()(
              C.a.mark(function e() {
                var t;
                return C.a.wrap(function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (e.next = 2), Object(T.b)();

                      case 2:
                        (t = e.sent), A.Actions.General.setLicense(t);
          ...
          case A.Events.Toolbar.SetInsertsLeft: {
            const r = t.value;
            Object(M.X)(r);
            break;
          }

          case A.Events.Toolbar.RequestExtractedMath: {
            const a = Object(I.a)();
            k()(
              C.a.mark(function e() {
                var t, r, n, o;
                return C.a.wrap(function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 5:
                        if (((r = S.getState()), (n = r.drawer.mode), (o = Object(j.a)()), "mathspace" !== t.type)) {
                          e.next = 16;
                          break;
                        }
                        if (Object(A.canUseFeature)(r, A.Features.Mathspace)) {
                          e.next = 11;
                          break;
                        }
                        return e.abrupt("return");
                      ...
                      case 11:
                        Object(M.R)("EditMathSelected", "Feature", "Math", {
                          type: "Mathspace",
                          location: o
                        }),
                          Object(L.a)(t.platformIntegrationId),
                          Object(R.d)(),
                          (e.next = 30);
                        break;
                      ...
                      case 16:
                        ...
                        if (Object(A.canUseFeature)(r, A.Features.GraphEditor)) {
                          e.next = 19;
                          break;
                        }
                        return e.abrupt("return");
                      ...
                      case 19:
                        Object(M.Q)(`Extract Graph - ${n} - ` + o),
                          Object(M.R)("EditMathSelected", "Feature", "Math", {
                            type: "Graph",
                            location: o
                          }),
                          A.Actions.Toolbar.setExtractedGraph(t.state),
                          n !== A.ToolModes.GraphEditor && A.Actions.Toolbar.setMode(A.ToolModes.GraphEditor),
                          (e.next = 30);
                        break;

                      case 25:
                        if (Object(A.canUseFeature)(r, A.Features.EquationEditor)) {
                          e.next = 27;
                          break;
                        }
                        return e.abrupt("return");
                      ...
                      case 27:
                        Object(M.Q)(`Extract Math - ${n} - ` + o),
                          Object(M.R)("EditMathSelected", "Feature", "Math", {
                            type: "Math",
                            location: o
                          }),
                          A.Actions.Toolbar.setExtractedMath(t, !0);
          ...
          case A.Events.Toolbar.InsertMath: {
            Object(M.cb)(null), A.Actions.Toolbar.setInsertMathLoading(!0);
            const n = S.getState().drawer.mode,
              o = t.width,
              c = t.height,
              i = t.latex,
              s = t.spokenText,
              ...
              p = l.math,
              f = Object(j.a)();
            Object(M.Q)(`Insert Math - ${n} - ` + f),
              Object(M.R)("MathInserted", "Feature", "Math", {
                type: n || "undefined",
                location: f
              }),
              k()(
                  ...
                  return C.a.wrap(
                    function (e) {
                      for (;;)
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (e.prev = 0), (e.next = 3), p(i, o, c, s, u);
                          ...
                          case 5:
                            (e.prev = 5),
                              (e.t0 = e.catch(0)),
                              A.Actions.Toolbar.setInsertMathLoading(!1),
                              console.error("Math insert failed", e.t0),
                              Object(M.cb)("insert_fail");

                          case 10:
                            A.Actions.Toolbar.setInsertMathLoading(!1), n === A.ToolModes.HandwritingRecognition && Object(M.eb)();
          ...
          case A.Events.Toolbar.InsertGraph: {
            Object(M.cb)(null);
            const d = S.getState().drawer.mode,
              h = t.imageData,
              b = t.calculatorState;
            if (h && b) {
              const m = Object(j.a)();
              Object(M.R)("GraphInserted", "Feature", "Graph", {
                location: m
              }),
                k()(
                  C.a.mark(function e() {
                    ...
                    return C.a.wrap(
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            case 0:
                              if ((A.Actions.Toolbar.setInsertMathLoading(!0), (e.prev = 1), (t = Object(L.b)()), (e.t0 = t), e.t0))
                                return (e.next = 7), Object(M.h)(!0);
                              e.next = 8;
                              break;
                            ...
                            case 8:
                              if (e.t0) return A.Actions.Toolbar.setInsertMathLoading(!1), e.abrupt("return");
                              e.next = 11;
                              break;

                            case 11:
                              return (t = Object(I.b)()), (r = t.graph), Object(M.Q)(`Insert Graph - ${d} - ` + m), (e.next = 15), r(h, b);
                            ...
                            case 22:
                              A.Actions.Toolbar.setInsertMathLoading(!1), Object(M.eb)();
          ...
          case A.Events.Toolbar.SetMode: {
            const g = t.mode;
            if ("screenshot_reader" === g) {
              const y = S.getState().licensing.profile,
                w = y.daysleft,
                v = y.features;
              if (w < 0 && !v["Screenshot Reader"])
                return O({
                  type: "noop"
                });
            }
            g === A.ToolModes.HandwritingRecognition ? Object(M.bb)() : g === A.ToolModes.EquationEditor && Object(M.db)(), Object(R.d)();
            break;
          }

          case A.Events.Favourites.Added: {
            const x = t.items;
            x && !x.length && ((D[x.name] = x), delete N[x.name], B(D, N));
            break;
          }

          case A.Events.Favourites.Removed: {
            const E = t.item;
            (N[E.name] = E), delete D[E.name], B(D, N);
            break;
          }

          case A.Events.Toolbar.MathCopied:
            Object(M.cb)(null),
              Object(M.R)("CopyMathSelected", "Feature", "Math", {
                format: t.mode
              }),
              k()(
                C.a.mark(function e() {
                  return C.a.wrap(
                    function (e) {
                      for (;;)
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (e.prev = 0), (e.next = 3), Object(_.a)(t.mode);

                          case 3:
                            if (t.mode === A.CopyMode.Download) return e.abrupt("return");
                            e.next = 5;
                            break;

                          case 5:
                            A.Actions.Toolbar.setCopyMathStatus(A.CopyMathStatus.Success), (e.next = 11);
                            break;

                          case 8:
                            (e.prev = 8), (e.t0 = e.catch(0)), A.Actions.Toolbar.setCopyMathStatus(A.CopyMathStatus.Failure);
          ...
          case A.Events.Toolbar.LatexChanged:
            (F = void 0 === F ? Object(U.a)() : F) && Object(P.b)(t.latex);
        }
        const e = O(t);
        return q(t), e;
      };
              ...
              return c.a.wrap(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 2:
                      return (n = e.sent), e.abrupt("return", Object(o.ib)(n, null));
    ...
    72: function (e, t, r) {
      ...
      const i = () => {
        ...
        s = (e) => {
          e || Object(c.R)("InsertMathspaceSelected", "Feature", "Mathspace"), Object(c.M)(e);
        };
    },
    73: function (e, t, r) {
      "use strict";
    ...
    80: function (e, t, r) {
      ...
      const n = (e, t = !1) => {
        ...
        if (!(r = !r && window && window.location ? window.location : r)) return "Unknown";
        const n = r,
          o = n.hostname,
          a = n.href,
          c = Object(u.c)(r);
        if (c) return t ? c : "" + c + (Object(u.d)(r) ? " - Response" : "");
        if (Object(s.a)(a)) return "OrbitNote";
        if (Object(l.b)(o, !0)) {
          const i = Object(l.c)(o);
          return i ? "Microsoft " + i : "Microsoft Office";
        }
        return Object(p.a)(o) ? "Partner - " + o : "Third Party Website";
      };
      t.a = n;
    },
    83: function (e, t, r) {
    ...
    91: function (e, t, r) {
                  ...
                  switch ((e.prev = e.next)) {
                    ...
                    case 2:
                      (n = e.sent),
                        ...
                        (b = b.provider),
                        (b = void 0 === b ? "google" : b),
                        v.Actions.Options.loadSettings(
                          {
                            fontSize: m,
                            showTips: g,
                            math: u,
      ...
      t.a = (o) => (n) => (e) => {
        const t = o.getState();
        switch (e.type) {
          case v.Events.PopupMenu.Shown: {
            const r = t.drawer.mode;
            r && v.Actions.Toolbar.setMode(r);
            break;
          }

          case v.Events.PopupMenu.ShowOptionsDialog:
            v.Actions.Academy.setHidden(),
              v.Actions.PopupMenu.show(!1),
              a()(
                w.a.mark(function e() {
                  return w.a.wrap(function (e) {
                    for (;;)
    ...
    92: function (U, e, t) {
              ...
              return h.a.wrap(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        (r = q.default.getState().mathOptions),
                        (t = r.locale),
                        (r = r.speechEngine),
                        (e.next = 3),
            ...
            h.a.mark(function e(t) {
              ...
              return h.a.wrap(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      if (((r = Cr()), (r = r.image), t.startsWith("http"))) return (e.next = 4), r(t);
                      e.next = 5;
                      break;
                    ...
                    case 5:
                      if (Object(D.b)()) return (e.next = 8), Object(b.ib)(null, t);
                      e.next = 13;
                      break;
          ...
          const e = (e) => {
            if (e && e.action) {
              ...
              switch (e.action) {
                ...
                case n.InsertMathspace:
                  Object(b.R)("MathspaceInserted", "Feature", "Mathspace", {
                    location: t
                  }),
                    F(e.image);
              }
      ...
      const G = (e) => {
          if (e) {
            ...
            const t = q.default.getState().drawer.mode;
      ...
      const i = (n) =>
            ...
            h.a.mark(function e(t) {
              return h.a.wrap(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      "mac" === t ? i(c.a.SelectDocsEquationMac) : i(c.a.SelectDocsEquationWin);
        ...
        ne = () => i(c.a.InsertPlaceholderCharacter),
        oe = (function () {
          var e = d()(
            h.a.mark(function e() {
              return h.a.wrap(
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (e.prev = 0), (e.next = 3), i(c.a.Delete);
      ...
      var ae = () => {
          if (!s) {
            ...
            e.length ||
              ...
              (s = e && e.length && e[0].closest(".goog-menuitem"));
          }
          return s;
        },
        f = t(28);
                              ...
                              for (;;)
                                switch ((e.prev = e.next)) {
                                  case 0:
                                    return (
                                      (e.next = 2),
                                      w(() => Array.from(document.querySelectorAll(`img[src='${t.src}']`)).find((e) => e.offsetParent), 50)
                                    );
                  ...
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        (e.next = 2),
                        Promise.all([
                          w(() => document.querySelector("input.docs-alt-text-tile-title-input"), 20),
                          w(() => document.querySelector("#docs-alt-text-tile-description"), 20)
                        ])
                      );
            ...
            function (e) {
              for (;;)
                switch ((e.prev = e.next)) {
                  ...
                  case 4:
                    return (r = e.sent), (r = p()(r, 2)), (t = r[0]), (r = r[1]), (e.prev = 8), (e.next = 11), he(r, !0);
      ...
      const v = (e) => "<math" === ("" + e).slice(0, 5).toLowerCase(),
        x = (e) => v(e) && (e.includes("data-is-equatio") || e.includes("data-latex"));
      var E = (function () {
          var t = d()(
            h.a.mark(function e(t) {
              var r, n, o;
      ...
      const me = () => {
        ...
        ye = (e) => (e && (e.includes("googleusercontent.com") || e.includes("filesystem:")) ? Object(O.a)(e) : null);
      var we = d()(
          h.a.mark(function e() {
            var t, r, n;
            return h.a.wrap(
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      if ((t = me())) {
                        if ("cell" === t.type) return e.abrupt("return", ge());
                        e.next = 4;
                      } else e.next = 26;
                      break;

                    case 4:
                      if (t.element) return (e.prev = 5), (e.next = 8), ye(t.element.src);
                      e.next = 26;
                      break;
    ...
    <mglyph src="" alt="Image"></mglyph>
                          ...
                          case 0:
                            if (
                              ...
                              (t = Array.from(document.querySelectorAll(".goog-menuitem-mnemonic-hint"))
                                ...
                                .filter((t) => Te.g.some((e) => t.closest(".goog-menuitem-label").textContent.startsWith(e)))),
                              (t =
          ...
          h.a.mark(function e(t) {
            ...
            return h.a.wrap(function (e) {
              for (;;)
                switch ((e.prev = e.next)) {
                  case 0:
                    Object(l.c)() !== l.a.GoogleSheets ? (e.next = 4) : (Re(), (e.next = 8));
                    break;
      ...
      chrome.runtime.onMessage.addListener((e) => {
        "image_dialog_loaded" === e.action && ((_e = e.pickerWindow), "function" == typeof A) && (A.call(void 0), (A = null));
      });
      const Ue = (function () {
          var t = d()(
            h.a.mark(function e(t, r = "image") {
              ...
              return h.a.wrap(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (o = xe(t, r, (n = "desmos" === r ? "Equatio Desmos Graph" : "Equatio Image"))), pe(n, o), (e.next = 5), Pe(t);
              ...
              return h.a.wrap(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 4:
                      return (n = e.sent), (e.next = 7), Ue(n, "desmos");
            ...
            h.a.mark(function e(t = !0) {
              ...
              return h.a.wrap(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      if (t === De()) return e.abrupt("return");
                      e.next = 2;
                      break;
                ...
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 14:
                        return (e.prev = 14), (e.t0 = e.catch(2)), (e.next = 18), Fe(!1).catch(() => {});

                      case 18:
                        throw e.t0;

                      case 19:
                        return (e.next = 21), Fe(!1).catch(() => {});
                ...
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 10:
                        return (
                          (e.prev = 10), (e.t0 = e.catch(5)), console.error("Sheets speed insert failed", e.t0), (e.next = 15), Ge(o, r, n)
                        );
                      ...
                      case 16:
                        return (e.prev = 16), (e.next = 19), Ge(o, r, n);
              ...
              h.a.mark(function e(t) {
                return h.a.wrap(function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return t && Object(f.a)(t), (e.next = 3), fe();

                      case 3:
                        return (e.next = 5), y(r, n);
      ...
      const Ye = [
        ...
        Ze = (e) => Ye.reduce((e, [t, r]) => e.replace(t, r), e);
      var et = (e) =>
          new Promise((o, a) => {
            Xe ||
              ((Xe = !0),
              Object(ze.a)(({ type: e }) => {
                e === u.Events.Toolbar.ExtractMathCancelled &&
                  ((M.src = "about:blank"), window.removeEventListener("message", I), (I = null));
              })),
            ...
            return h.a.wrap(
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      if (((t = Object(T.c)()), (t = (t ? Object(T.b) : Ve)()))) return Object(f.a)(t), (e.prev = 4), (e.next = 7), be();
                      e.next = 47;
                      break;
                    ...
                    case 11:
                      if (v(r)) return Object(b.Q)("Edit Math - MathML"), (e.prev = 13), (e.next = 16), et(r);
                      e.next = 22;
                      break;
                    ...
                    case 38:
                      if ([l.a.GoogleSlides, l.a.GoogleDrawings].includes(Object(l.c)())) return (e.next = 41), Object($e.b)();
                      e.next = 47;
                      break;
      ...
      function rt(e, t) {
        ...
        if (Array.isArray(e) || (c = nt(e)) || (t && e && "number" == typeof e.length))
          return (
            c && (e = c),
            (a = 0),
            {
                ...
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 13:
                        if (v(t)) return Object(b.Q)("Edit Math - MathML"), (e.prev = 15), (e.next = 18), et(t);
                        e.next = 24;
                        break;
              ...
              return h.a.wrap(
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        if (((t = Object(T.c)()), (n = (t ? Object(T.a) : at)()))) return (e.prev = 3), (e.next = 6), ft(n);
                        e.next = 17;
                        break;
                      ...
                      case 20:
                        if ((a = o.querySelector("desc"))) return (a = a.textContent), (e.next = 25), mt(a);
                        e.next = 28;
                        break;
                      ...
                      case 28:
                        if (o) return (a = o.querySelector("image").getAttribute("xlink:href")), (e.next = 32), gt(a);
                        e.next = 35;
                        break;
              ...
              return h.a.wrap(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 5:
                      if ((c = vt(t + n / 2, r + o / 2, a))) return (e.next = 9), gt(c.href.baseVal);
                      e.next = 11;
                      break;
              ...
              return h.a.wrap(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 2:
                      if ((t = document.querySelector(".kix-embeddedobject-image > image"))) return (e.next = 6), gt(t.href.baseVal);
                      e.next = 8;
                      break;
              ...
              return h.a.wrap(
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (e.prev = 0), (e.next = 3), wt();

                      case 3:
                        if ((t = e.sent)) if ((t = t.match(/<\s*math[\s\S]*<\/\s*math>/gi)) && 0 < t.length) return (e.next = 9), mt(t[0]);
                        e.next = 12;
                        break;
      ...
      var kt = () => (document.querySelector(".kix-canvas-tile-content") ? St : ht() ? bt : yt)(),
        Ct = () => (Object(l.b)() ? tt : kt)(),
        At = (e, t) => {
              ...
              return h.a.wrap(
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (e.prev = 0), (e.next = 3), w(() => document.querySelector(".picker-urlview-inner-input"), 200);
                ...
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          (t = () => {
                            ...
                            ).filter((t) => Te.b.some((e) => t.textContent && t.textContent.includes(e)));
                      ...
                      case 5:
                        return (r = e.sent), It(r), (e.next = 9), w(t, 30);
          ...
          return h.a.wrap(
            function (e) {
              for (;;)
                switch ((e.prev = e.next)) {
                  case 0:
                    if (((r = Object(l.c)()), (n = Object(C.b)()), r !== l.a.GoogleDocs || ct())) {
                      e.next = 5;
                      break;
                    }
                    return (e.next = 5), oe();
                  ...
                  case 5:
                    ...
                    return (e.next = 8), _t(...t);

                  case 8:
                    return e.abrupt("return", "automation");

                  case 9:
                    if (n === C.a.Automatic || n === C.a.Speed) return (e.prev = 10), (e.next = 13), _t(...t);
                    e.next = 22;
                    break;
                  ...
                  case 28:
                    return (e.prev = 28), (e.t1 = e.catch(22)), console.error("Quality insert failed", e.t1), (e.next = 33), _t(...t);
                  ...
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 4:
                        ...
                        return (e.prev = 6), (e.next = 9), ut(t, r, "api" === c);
            ...
            h.a.mark(function e(t, r = "image") {
              ...
              return h.a.wrap(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (o = xe(t, r, (n = "desmos" === r ? "Equatio Desmos Graph" : "Equatio Image"))), (e.next = 4), Ut(n, o, t);
              ...
              return h.a.wrap(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 4:
                      return (n = e.sent), (e.next = 7), Dt(n, "desmos");
                ...
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 18:
                        if (v(r)) return (e.prev = 19), (e.next = 22), et(r);
                        e.next = 28;
                        break;
      ...
      const Kt = (e) => {
            ...
            h.a.mark(function e(t, r, n) {
              ...
              return h.a.wrap(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      if ((Qt(n), (o = !!document.querySelector("#Title")), (a = !1), o)) {
                        e.next = 23;
                        break;
                      }
                      return (e.next = 6), w(() => document.querySelector("#Picture"), 50);

                    case 6:
                      return e.sent.click(), (e.next = 10), w(() => document.querySelector("#EditPictureAltText"), 10, !1);
                    ...
                    case 10:
                      ...
                      return (a = Jt()) && $t(!0), (e.next = 16), w(() => document.querySelector("#RibbonOverflowMenu-overflow"), 10, !1);
                    ...
                    case 21:
                      a && setTimeout(() => $t(!1), 200), c.click();

                    case 23:
                      return (e.next = 25), w(() => document.querySelector("#Title"), 100);
                    ...
                    case 29:
                      (i.value = t),
                        ...
                        Vt(s, r),
                        o || ((u = document.querySelector("#TaskPaneCloseBtnFormatPictureTaskPane")) ? u.click() : Kt(s || document.body)),
                        Wt(n);
            ...
            h.a.mark(function e() {
              ...
              return h.a.wrap(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (e.next = 2), w(() => document.querySelector("#Home"), 10, !1);
                    ...
                    case 10:
                      return (e.next = 12), w(() => document.querySelector("#Clipboard"), 10, !1);

                    case 12:
                      return (
                        (r = e.sent) && r.click(),
                        (e.next = 16),
                        w(() => document.querySelector("button[data-unique-id=Ribbon-Paste]"), 10, !1)
                      );
        ...
        rr = () => Gt(er());
      var nr = t(17);
      const or = () => Object(nr.d)(Object(nr.c)(window.location.hostname)),
        ar = (function () {
          var t = d()(
            h.a.mark(function e(t) {
              return h.a.wrap(
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      ...
                      return ar(t), e.abrupt("return");

                    case 3:
                      return (o = xe(t, r, (n = "desmos" === r ? "Equatio Desmos Graph" : "Equatio Image"))), (e.next = 7), Object(b.J)(t);
              ...
              return h.a.wrap(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 4:
                      return (n = e.sent), (e.next = 7), cr(n, "desmos");
              ...
              return h.a.wrap(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 8:
                      return (r = e.sent), (e.next = 11), ur(r);
              ...
              return h.a.wrap(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        (n = `<img src="${t}" alt="${"desmos" === r ? "Equatio Desmos Graph" : "Equatio Image"}" />`), (e.next = 4), br(n)
                      );
              ...
              return h.a.wrap(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 4:
                      return (n = e.sent), (e.next = 7), gr(n, "desmos");
        ...
        new Promise((o, a) => {
          const c = ({ action: e, command: t, value: r, fromEditor: n }) => {
            ...
            e =
              ...
              chrome.runtime.onMessage.addListener(c),
              Object(hr.b)());
          Object(b.T)(R.a.Extract, null, !1, e);
        });
      let xr;
      var Er = d()(
          h.a.mark(function e() {
            ...
            return h.a.wrap(function (e) {
              for (;;)
                switch ((e.prev = e.next)) {
                  ...
                  case 5:
                    if (((xr = xr || new DOMParser()), (r = xr.parseFromString(t, "text/html")), (r = r.querySelector("img")) && r.src))
