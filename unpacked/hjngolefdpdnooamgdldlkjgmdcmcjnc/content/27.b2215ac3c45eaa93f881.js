  ...
  [27],
  {
    415: function (R, I, t) {
      ...
      var H,
        e = t(715),
        x = t.n(e).a || {},
        B = "mathquill-command-id",
        g = "mathquill-block-id",
        M = Math.min,
        z = Math.max;
      if (!x) throw "MathQuill requires jQuery 1.5.2+ to be loaded first";
      function w() {}
      var P = [].slice;
      function F(n) {
        var i = n.length - 1;
        return function () {
          var t = P.call(arguments, 0, i),
            e = P.call(arguments, i);
      ...
      var U,
        ...
        i = function e(n, t) {
          function i() {
            var t = new r();
            return K(t.init) && t.init.apply(t, arguments), t;
          }
          function r() {}
          t === X && ((t = n), (n = Object)), (i.Bare = r);
          var s,
            o = (Y[U] = n[U]),
            a = (r[U] = i[U] = i.p = new Y());
          return (
            ...
            (i.open = function (t) {
              if (((s = {}), K(t) ? (s = t.call(i, a, o, i, n)) : G(t) && (s = t), G(s))) for (var e in s) V.call(s, e) && (a[e] = s[e]);
              return K(a.init) || (a.init = n), i;
            })(t)
          );
        };
      function G(t) {
      ...
      var y = i(x, function (t) {
        ...
        h = i(function (t) {
          ...
          (this.byId = {}),
            ...
            (t.bubble = W(function (t) {
              for (var e = this; e; e = e.parent) if (!1 === t(e)) break;
              return this;
            })),
            (t.postOrder = W(function (n) {
              return (
                (function t(e) {
                  e.eachChild(t), n(e);
                })(this),
        ...
        f = i(function (t) {
          (t.init = function (t, e, n) {
            (this.id = t.id),
              ...
              (this.container = e),
              (this.options = n),
              ((t.controller = this).cursor = t.cursor = J(t, n));
          }),
      ...
      var at = ((n.getInterface = ct).MIN = 1),
        lt = (ct.MAX = 2);
      function ct(s) {
        if (!(at <= s && s <= lt)) throw "Only interface versions between " + at + " and " + lt + " supported. You specified: " + s;
        function o(t) {
        ...
        function e(t, e) {
          ...
          e)) {
            var i, r;
            e.hasOwnProperty(n) && ((i = e[n]), (r = it[n]), (t[n] = r ? r(i) : i));
          }
        }
        (o.L = m),
          (o.R = v),
          (o.saneKeyboardEvents = pt),
          (o.config = function (t) {
            return e(nt.p, t), this;
          }),
        ...
        var t,
          n = (a.AbstractMathQuill = i(rt, function (t) {
            (t.init = function (t) {
        ...
        (a.EditableField = i(n, function (t, e) {
          (t.__mathquillify = function () {
            ...
            (t.dropEmbedded = function (t, e, n) {
              ...
              this.__controller.seek(y(i), t, e), Zt().setOptions(n).createLeftOf(this.__controller.cursor);
            }),
            (t.clickAt = function (t, e, n) {
              ...
              var i = this.__controller,
                r = i.root;
              return (
                x.contains(r.jQ[0], n) || (n = r.jQ[0]), i.seek(y(n), t + pageXOffset, e + pageYOffset), i.blurred && this.focus(), this
              );
            }),
          ...
          !(function (i, t) {
            ...
            (o[i] = function (t, e) {
              ...
              return n instanceof r || !t || !t.nodeType
                ? n
                : (((n = f(r.RootBlock(), y(t), nt())).KIND_OF_MQ = i), r(n).__mathquillify(e, s));
            }),
      ...
      n.noConflict = function () {
        return (window.MathQuill = ut), n;
      };
      var ut = window.MathQuill;
      function ft(t) {
      ...
      var ht,
        ...
        pt =
          ...
          function (t, e) {
            ...
            function l(e) {
              a(function (t) {
                (o = w), clearTimeout(n), e(t);
              });
            }
            function c(t) {
              o(), (o = w), clearTimeout(n), s.val(t), t && s[0].select && s[0].select(), (u = !!t);
            }
      ...
      f.open(function (t, e) {
        ...
        f.open(function (t) {
          ...
          this.onNotify(function (t) {
            ...
            (it.leftRightIntoCmdGoes = function (t) {
        ...
        (e = e(/^[^\\a-eg-zA-Z]/)
          ...
          .then(function (t) {
            var e = l[t];
            return e ? e(t).parser() : gt("unknown command: \\" + t);
          })
          .or(A)
          .or(Rt)),
        (L = t("{")
          ...
          .skip(t("}"))),
        (A = D.then(L.or(e.map(yt)))),
        (vt = A.many().map(bt).skip(D)),
        (Rt = t("[")
          .then(
            A.then(function (t) {
              return "]" !== t.join("latex") ? mt(t) : gt();
            })
              .many()
              .map(bt)
              .skip(D)
      ...
      function bt(t) {
        for (var e = t[0] || k(), n = 1; n < t.length; n += 1) t[n].children().adopt(e, e.ends[v], 0);
        return e;
      }
      f.open(function (t, e) {
        (t.exportLatex = function () {
          ...
          (t.writeLatex = function (t) {
            var e = this.notify("edit").cursor,
              n = q.all,
              i = q.eof,
              i = T.skip(i).or(n.result(!1)).parse(t);
            return (
              i &&
                !i.isEmpty() &&
          ...
          (t.renderLatexMath = function (t) {
            var e = this.root,
              ...
              i = q.all,
              r = q.eof,
              r = T.skip(r).or(i.result(!1)).parse(t),
              ...
              this.container.bind("mousedown.mathquill", function (t) {
                ...
                t.preventDefault(),
                  ...
                  r.options.ignoreNextMousedown(t) ||
                    ((r.options.ignoreNextMousedown = w),
        ...
        f.open(function (t) {
          t.seek = function (t, e, n) {
            var i,
              ...
              t = (i = !t ? i : (i = t.attr(g) || t.attr(B)) || (t = t.parent()).attr(g) || t.attr(B)) ? h.byId[i] : this.root;
        ...
        f.open(function (t) {
          (nt.p.substituteTextarea = function () {
            ...
            (t.setTextareaSelection = function () {
              ...
              var t = "";
              this.cursor.selection && ((t = this.cursor.selection.join("latex")), this.options.statelessClipboard) && (t = "$" + t + "$"),
                this.selectFn(t);
            }),
            (t.staticMathTextareaEvents = function () {
              ...
              this.container.prepend(x('<span class="mq-selectable">').text("$" + t.exportLatex() + "$")),
                (t.blurred = !0),
                n
                  .bind("cut paste", !1)
                  .bind("copy", function () {
            ...
            (nt.p.substituteKeyboardEvents = pt),
      ...
      var e = i(h, function (t, e) {
        ...
        o = i(e, function (t, r) {
          (t.init = function (t, e, n) {
            ...
            (t.createBlocks = function () {
              for (var t = this, e = t.numBlocks(), n = (t.blocks = Array(e)), i = 0; i < e; i += 1) (n[i] = k()).adopt(t, t.ends[v], 0);
            }),
        ...
        xt =
          ...
          i(k, ft)),
        wt =
          ((et.MathField = function (t) {
            return i(t.EditableField, function (t, n) {
              (this.RootBlock = xt),
                (t.__mathquillify = function (t, e) {
                  return (
                    this.config(t),
                    1 < e && (this.__controller.root.reflow = w),
          ...
          i(h, function (t, i) {
            function l(t) {
              ...
              var e,
                n = t.jQ[0].firstChild;
              if (n && (n = x(n).is(".mq-selection") ? n.firstChild : n))
                return (
            ...
            (t.ctrlSeq = "\\text"),
              ...
              (t.parser = function () {
                ...
                return q.optWhitespace
                  ...
                  .skip(t("}"))
                  .map(function (t) {
                    return 0 === t.length ? b() : (qt(t).adopt(e, 0, 0), e);
                  });
              }),
              ...
              (t.html = function () {
                var t = x('<span class="mq-text-mode" mathquill-command-id=' + this.id + "></span>");
        ...
        qt = i(h, function (t, e) {
          ...
          (t.init = function (t) {
            ...
            (t.splitRight = function (t) {
              var e = qt(this.text.slice(t)).adopt(this.parent, this, this[v]);
            ...
            (t.moveTowards = function (t, e) {
              ...
              var n = o(-t, this.text),
                i = this[-t];
              return i ? i.insTextAtDirEnd(n, t) : qt(n).createDir(-t, e), this.deleteTowards(t, e);
            }),
            (t.latex = function () {
              return this.text;
            }),
            ...
            (t.selectTowards = function (t, e) {
              ...
              return (
                r[t] === this
                  ? ((i = qt(s).createDir(t, e)), (r[t] = i), e.insDirOf(t, i))
                  : ((n = this[-t]) ? n.insTextAtDirEnd(s, t) : (i = qt(s).createDir(-t, e)).jQ.insDirOf(-t, e.selection.jQ),
      ...
      (l.text = l.textnormal = l.textrm = l.textup = l.textmd = wt),
        (l.em = l.italic = l.italics = l.emph = l.textit = l.textsl = Tt("\\textit", "i", 'class="mq-text-mode"')),
        (l.strong = l.bold = l.textbf = Tt("\\textbf", "b", 'class="mq-text-mode"')),
        (l.sf = l.textsf = Tt("\\textsf", "span", 'class="mq-sans-serif mq-text-mode"')),
        (l.tt = l.texttt = Tt("\\texttt", "span", 'class="mq-monospace mq-text-mode"')),
        (l.textsc = Tt("\\textsc", "span", 'style="font-variant:small-caps" class="mq-text-mode"')),
        (l.uppercase = Tt("\\uppercase", "span", 'style="text-transform:uppercase" class="mq-text-mode"')),
        (l.lowercase = Tt("\\lowercase", "span", 'style="text-transform:lowercase" class="mq-text-mode"'));
      for (
        var Ct = i(o, function (t, e) {
            (t.init = function (t) {
              ...
              (t.createBlocks = function () {
                e.createBlocks.call(this),
                  ...
                  (this.ends[m].write = function (t, e) {
                    "$" !== e
                      ? k.prototype.write.call(this, t, e)
                      : this.isEmpty()
          ...
          kt = i(xt, function (t, e) {
            (t.keystroke = function (t) {
              ...
              (t.write = function (t, e) {
                var n;
                t.show().deleteSelection(),
                  ("$" === e ? Ct(t) : ("<" === e ? (n = "&lt;") : ">" === e && (n = "&gt;"), d(e, n))).createLeftOf(t);
              });
          }),
          jt =
            ((et.TextField = function (t) {
            ...
            (l["\u2260"] = l.ne = l.neq = r(C, "\\ne ", "&ne;")),
            (l["\u2217"] = l.ast = l.star = l.loast = l.lowast = r(C, "\\ast ", "&lowast;")),
            (l.therefor = l.therefore = r(C, "\\therefore ", "&there4;")),
            (l.cuz = l.because = r(C, "\\because ", "&#8757;")),
            (l.prop = l.propto = r(C, "\\propto ", "&prop;")),
            (l["\u2248"] = l.approx = r(C, "\\approx ", "&asymp;")),
            (l.asymp = r(C, "\\asymp", "&#x224D;")),
            (l.isin = l.in = r(C, "\\in ", "&isin;")),
            (l.ni = l.contains = r(C, "\\ni ", "&ni;")),
            (l.notni = l.niton = l.notcontains = l.doesnotcontain = r(C, "\\not\\ni ", "&#8716;")),
            (l.sub = l.subset = r(C, "\\subset ", "&sub;")),
            (l.sup = l.supset = l.superset = r(C, "\\supset ", "&sup;")),
            (l.nsub = l.notsub = l.nsubset = l.notsubset = r(C, "\\not\\subset ", "&#8836;")),
            (l.nsup = l.notsup = l.nsupset = l.notsupset = l.nsuperset = l.notsuperset = r(C, "\\not\\supset ", "&#8837;")),
            (l.sube = l.subeq = l.subsete = l.subseteq = r(C, "\\subseteq ", "&sube;")),
            (l.supe = l.supeq = l.supsete = l.supseteq = l.supersete = l.superseteq = r(C, "\\supseteq ", "&supe;")),
            (l.nsube =
              l.nsubeq =
              l.notsube =
              l.notsubeq =
            ...
            (l.implies = r(C, "\\Rightarrow ", "&rArr;")),
            (l.rArr = l.Rightarrow = r(d, "\\Rightarrow ", "&rArr;")),
            (l.gets = r(C, "\\gets ", "&larr;")),
            (l.larr = l.leftarrow = r(d, "\\leftarrow ", "&larr;")),
            (l.impliedby = r(C, "\\Leftarrow ", "&lArr;")),
            (l.lArr = l.Leftarrow = r(d, "\\Leftarrow ", "&lArr;")),
            (l.harr = l.lrarr = l.leftrightarrow = r(d, "\\leftrightarrow ", "&harr;")),
            (l.iff = r(C, "\\Leftrightarrow ", "&hArr;")),
            (l.hArr = l.lrArr = l.Leftrightarrow = r(d, "\\Leftrightarrow ", "&hArr;")),
            ...
            (l.and = l.land = l.wedge = r(C, "\\wedge ", "&and;")),
            (l.or = l.lor = l.vee = r(C, "\\vee ", "&or;")),
            (l.o = l.O = l.empty = l.emptyset = l.oslash = l.Oslash = l.nothing = l.varnothing = r(C, "\\varnothing ", "&empty;")),
            (l.cup = l.union = r(C, "\\cup ", "&cup;")),
            (l.cap = l.intersect = l.intersection = r(C, "\\cap ", "&cap;")),
            ...
            i(d, function (t, e) {
              t.createLeftOf = function (t) {
                ...
                ((t[m] instanceof j && !1 !== t[m].isItalic) || (t[m] instanceof Ft && t[m][m] instanceof j && !1 !== t[m][m].isItalic))
              ...
              (t.text = function () {
                ...
                return (
                  this.isPartOfOperator
                    ...
                    : (!this[m] || this[m] instanceof j || this[m] instanceof C || "\\ " === this[m].ctrlSeq || (t = "*" + t),
                      !this[v] || this[v] instanceof C || this[v] instanceof Ft || (t += "*")),
                  t
                );
              });
          }),
          O =
            ...
            (it.autoCommands = function (t) {
              ...
              for (var e = t.split(" "), n = {}, i = 0, r = 0; r < e.length; r += 1) {
                ...
                if (l[s] === _t) throw '"' + s + '" is a built-in operator name';
                (n[s] = 1), (i = z(i, s.length));
              }
              return (n._maxLength = i), n;
            }),
            i(j, function (t, o) {
              function d(t) {
                return !t || t instanceof C || t instanceof Wt;
              }
              (t.init = function (t) {
                ...
                (t.createLeftOf = function (t) {
                  ...
                  var e = t.options.autoCommands,
                    n = e._maxLength;
                  if (0 < n) {
                    for (var i = "", r = this, s = 0; r instanceof O && r.ctrlSeq === r.letter && s < n; )
                ...
                (t.finalizeTree =
                  ...
                  t.siblingCreated =
                    function (t, e) {
                      (e !== m && this[v] instanceof O) || this.autoUnItalicize(t);
                    }),
                (t.autoUnItalicize = function (t) {
                  var e = t.autoOperatorNames;
                  if (0 !== e._maxLength) {
                    for (var n = this.letter, i = this[m]; i instanceof O; i = i[m]) n = i.letter + n;
                    for (var r = this[v]; r instanceof O; r = r[v]) n += r.letter;
                    ...
                    t: for (var s = 0, o = i[v] || this.parent.ends[m]; s < n.length; s += 1, o = o[v])
                      for (var a = M(e._maxLength, n.length - s); 0 < a; --a) {
                        var l = n.slice(s, s + a);
                        if (e.hasOwnProperty(l)) {
                          ...
                          var h,
                            p = Ot.hasOwnProperty(l);
                          (o.ctrlSeq = (p ? "\\" : "\\operatorname{") + o.ctrlSeq),
                            (f.ctrlSeq += p ? " " : "}"),
                            St.hasOwnProperty(l) && f[m][m][m].jQ.addClass("mq-last"),
                            d(o[m]) || o.jQ.addClass("mq-first"),
                            d(f[v]) ||
                              (f[v] instanceof Ft
                                ? ((h = f[v]).siblingCreated = h.siblingDeleted =
                                    function () {
                                      h.jQ.toggleClass("mq-after-operator-name", !(h[v] instanceof Q));
                                    })()
                                : f.jQ.toggleClass("mq-last", !(f[v] instanceof Q))),
                            (s += a - 1),
                            (o = f);
                          continue t;
                        }
          ...
          Et = "arg deg det dim exp gcd hom inf ker lg ln log max min sup limsup liminf injlim projlim Pr".split(" "),
          E = 0;
        E < Et.length;
        E += 1
      )
        Ot[Et[E]] = S[Et[E]] = 1;
      for (var Dt = "sin cos tan arcsin arccos arctan sinh cosh tanh sec csc cot coth".split(" "), E = 0; E < Dt.length; E += 1)
        Ot[Dt[E]] = 1;
      for (var At = "sin cos tan sec cosec csc cotan cot ctg".split(" "), E = 0; E < At.length; E += 1)
        S[At[E]] = S["arc" + At[E]] = S[At[E] + "h"] = S["ar" + At[E] + "h"] = S["arc" + At[E] + "h"] = 1;
      for (var Lt = "gcf hcf lcm proj span".split(" "), E = 0; E < Lt.length; E += 1) S[Lt[E]] = 1;
      it.autoOperatorNames = function (t) {
        if (!/^[a-z]+(?: [a-z]+)*$/i.test(t)) throw '"' + t + '" not a space-delimited list of only letters';
        for (var e = t.split(" "), n = {}, i = 0, r = 0; r < e.length; r += 1) {
          var s = e[r];
      ...
      var Qt,
        _t = i(p, function (t, e) {
          (t.init = function (t) {
            ...
            (t.createLeftOf = function (t) {
              for (var e = this.ctrlSeq, n = 0; n < e.length; n += 1) O(e.charAt(n)).createLeftOf(t);
            }),
            (t.parser = function () {
              for (var t = this.ctrlSeq, e = k(), n = 0; n < t.length; n += 1) O(t.charAt(n)).adopt(e, e.ends[v], 0);
              return q.succeed(e.children());
            });
        });
      for (Qt in S) S.hasOwnProperty(Qt) && (l[Qt] = _t);
      (l.operatorname = i(o, function (t) {
        (t.createLeftOf = w),
          ...
          (t.parser = function () {
            return T.block.map(function (t) {
              return t.children();
            });
          });
      })),
        (l.f = i(O, function (t, e) {
          (t.init = function () {
      ...
      var D = i(p, function (t, n) {
        ...
        t =
          ...
          (l.phi = r(j, "\\phi ", "&#981;")),
          (l.phiv = l.varphi = r(j, "\\varphi ", "&phi;")),
          (l.epsilon = r(j, "\\epsilon ", "&#1013;")),
          (l.epsiv = l.varepsilon = r(j, "\\varepsilon ", "&epsilon;")),
          (l.piv = l.varpi = r(j, "\\varpi ", "&piv;")),
          (l.sigmaf = l.sigmav = l.varsigma = r(j, "\\varsigma ", "&sigmaf;")),
          (l.thetav = l.vartheta = l.thetasym = r(j, "\\vartheta ", "&thetasym;")),
          (l.upsilon = l.upsi = r(j, "\\upsilon ", "&upsilon;")),
          (l.gammad = l.Gammad = l.digamma = r(j, "\\digamma ", "&#989;")),
          (l.kappav = l.varkappa = r(j, "\\varkappa ", "&#1008;")),
          (l.rhov = l.varrho = r(j, "\\varrho ", "&#1009;")),
          (l.pi = l["\u03c0"] = r(D, "\\pi ", "&pi;")),
          (l.lambda = r(D, "\\lambda ", "&lambda;")),
          ...
          i(o, function (t) {
            (t.init = function (t) {
              ...
              (t.parser = function () {
                var t = T.parse(this.latex).children();
                return q.succeed(t);
              });
          })),
        A =
              ...
              (t.contactWeld =
                ...
                t.siblingDeleted =
                  function (t, e) {
                    function n(t) {
                      return t[m]
                        ? t[m] instanceof C || /^[,;:\(\[]$/.test(t[m].ctrlSeq)
                          ? ""
                          : "mq-binary-operator"
        ...
        Nt =
          ((l["+"] = r(A, "+", "+")),
          (l["\u2013"] = l["-"] = r(A, "-", "&minus;")),
          (l["\xb1"] = l.pm = l.plusmn = l.plusminus = r(A, "\\pm ", "&plusmn;")),
          (l.mp = l.mnplus = l.minusplus = r(A, "\\mp ", "&#8723;")),
          (s["*"] = l.sdot = l.cdot = r(C, "\\cdot ", "&middot;", "*")),
          i(C, function (t, n) {
            (t.init = function (t, e) {
              this.data = t;
        ...
        It =
          ((l["<"] = l.lt = r(Nt, Rt, !0)),
          (l[">"] = l.gt = r(Nt, L, !0)),
          (l["\u2264"] = l.le = l.leq = r(Nt, Rt, !1)),
          (l["\u2265"] = l.ge = l.geq = r(Nt, L, !1)),
          i(C, function (t, e) {
            (t.init = function () {
              e.init.call(this, "=", "=");
            }),
              (t.createLeftOf = function (t) {
                t[m] instanceof Nt && t[m].strict ? (t[m].swap(!1), t[m].bubble("reflow")) : e.createLeftOf.apply(this, arguments);
              });
          }));
      (l["="] = It),
        (l["\xd7"] = l.times = r(C, "\\times ", "&times;", "[x]")),
        (l["\xf7"] = l.div = l.divide = l.divides = r(C, "\\div ", "&divide;", "[/]")),
        (s["~"] = l.sim = r(C, "\\sim ", "~", "~"));
      var Ht,
        Bt,
        Mt = w,
      ...
      var Pt = Ht
        ...
        Ft =
          ((l.mathrm = r(e, "\\mathrm", "span", 'class="mq-roman mq-font"')),
          (l.mathit = r(e, "\\mathit", "i", 'class="mq-font"')),
          (l.mathbf = r(e, "\\mathbf", "b", 'class="mq-font"')),
          (l.mathsf = r(e, "\\mathsf", "span", 'class="mq-sans-serif mq-font"')),
          (l.mathtt = r(e, "\\mathtt", "span", 'class="mq-monospace mq-font"')),
          (l.underline = r(e, "\\underline", "span", 'class="mq-non-leaf mq-underline"')),
          (l.overline = l.bar = r(e, "\\overline", "span", 'class="mq-non-leaf mq-overline"')),
          (l.overrightarrow = r(e, "\\overrightarrow", "span", 'class="mq-non-leaf mq-overarrow mq-arrow-right"')),
          (l.overleftarrow = r(e, "\\overleftarrow", "span", 'class="mq-non-leaf mq-overarrow mq-arrow-left"')),
          (l.overleftrightarrow = r(e, "\\overleftrightarrow", "span", 'class="mq-non-leaf mq-overarrow mq-arrow-both"')),
          (l.overarc = r(e, "\\overarc", "span", 'class="mq-non-leaf mq-overarc"')),
          (l.cancel = r(e, "\\cancel", "span", 'class="mq-non-leaf mq-cancel"')),
          (l.longdiv = r(e, "\\longdiv", "span", 'class="mq-non-leaf mq-longdiv"')),
          ...
          i(o, function (t, i) {
            (t.ctrlSeq = "_{...}^{...}"),
              ...
              (nt.p.charsThatBreakOutOfSupSub = ""),
              (t.finalizeTree = function () {
                this.ends[m].write = function (t, e) {
                  var n;
                  ...
                  t[m] && !t[v] && !t.selection && -1 < t.options.charsThatBreakOutOfSupSub.indexOf(e) && t.insRightOf(this.parent),
                    k.p.write.apply(this, arguments);
                };
              }),
              (t.moveTowards = function (t, e, n) {
      ...
      (l.subscript = l._ =
        i(Ft, function (t, e) {
          (t.supsub = "sub"),
            ...
            (t.textTemplate = ["_"]),
            (t.finalizeTree = function () {
              (this.downInto = this.sub = this.ends[m]), (this.sub.upOutOf = $t), e.finalizeTree.call(this);
            });
        })),
        (l.superscript =
          l.supscript =
          l["^"] =
            i(Ft, function (t, e) {
              (t.supsub = "sup"),
                ...
                (t.textTemplate = ["^"]),
                (t.finalizeTree = function () {
                  (this.upInto = this.sup = this.ends[v]), (this.sup.downOutOf = $t), e.finalizeTree.call(this);
                });
            }));
      var Wt = i(o, function (t, e) {
          (t.init = function (t, e) {
            e =
            ...
            (t.createLeftOf = function (t) {
              e.createLeftOf.apply(this, arguments), t.options.sumStartsWithNEquals && (O("n").createLeftOf(t), It().createLeftOf(t));
            }),
            (t.latex = function () {
              function t(t) {
            ...
            (t.parser = function () {
              for (
                var t = q.string, e = q.optWhitespace, n = q.succeed, i = T.block, r = this, s = (r.blocks = [k(), k()]), o = 0;
                o < s.length;
                o += 1
              )
        ...
        D =
          ((l["\u2211"] = l.sum = l.summation = r(Wt, "\\sum ", "&sum;")),
          (l["\u220f"] = l.prod = l.product = r(Wt, "\\prod ", "&prod;")),
          (l.coprod = l.coproduct = r(Wt, "\\coprod ", "&#8720;")),
          (l["\u222b"] =
            l.int =
            l.integral =
              i(Wt, function (t, e) {
          ...
          i(o, function (t, e) {
            (t.init = function (t, e) {
              ...
              (t.parser = function () {
                for (
                  var t = q.string, e = q.optWhitespace, n = q.succeed, i = T.block, r = this, s = (r.blocks = [k()]), o = 0;
                  o < s.length;
                  o += 1
                )
                  s[o].adopt(r, r.ends[v], 0);
              ...
              t.createLeftOf = function (t) {
                if (!this.replacedFragment) {
                  for (
                    var e = t[m];
                    e &&
                    !(e instanceof C || e instanceof (l.text || w) || e instanceof Wt || "\\ " === e.ctrlSeq || /^[,;:]$/.test(e.ctrlSeq));

                  )
                    e = e[m];
                  (e = e instanceof Wt && e[v] instanceof Ft && (e = e[v])[v] instanceof Ft && e[v].ctrlSeq != e.ctrlSeq ? e[v] : e) !==
            ...
            i(o, function (t, e) {
              (t.ctrlSeq = "\\sqrt"),
                ...
                (t.reflow = function () {
                  ...
                  Pt(t.prev(), 1, t.innerHeight() / +t.css("fontSize").slice(0, -2) - 0.1);
                });
            })),
        Vt =
      ...
      function Xt(t, e) {
        (t.jQadd = function () {
          ...
          (t.reflow = function () {
            ...
            Pt(this.delimjQs, M(1 + 0.2 * (t - 1), 1.2), 1.2 * t);
          });
      }
      (l.vec = r(Rt, "\\vec", "&rarr;", ["vec(", ")"])), (l.tilde = r(Rt, "\\tilde", "~", ["tilde(", ")"]));
      var Q = i(i(o, Xt), function (t, s) {
      ...
      function Kt(t, e) {
        var e = e || t,
          n = Gt[t],
          i = Gt[e];
        (s[t] = r(Q, m, t, n, e, i)), (s[n] = r(Q, v, t, n, e, i));
      }
      Kt("("),
        Kt("["),
        Kt("{", "\\{"),
        (l.langle = r(Q, m, "&lang;", "&rang;", "\\langle ", "\\rangle ")),
        (l.rangle = r(Q, v, "&lang;", "&rang;", "\\langle ", "\\rangle ")),
        (s["|"] = r(Q, m, "|", "|", "|", "|")),
        (l.lVert = r(Q, m, "&#8741;", "&#8741;", "\\lVert ", "\\rVert ")),
        (l.rVert = r(Q, v, "&#8741;", "&#8741;", "\\lVert ", "\\rVert ")),
        (l.left = i(o, function (t) {
          t.parser = function () {
            var t = q.regex,
              e = q.string,
              s = (q.succeed, q.optWhitespace);
      ...
      var Yt,
          ...
          ((l.begin = i(o, function (t, e) {
            t.parser = function () {
              ...
              return e("{")
                ...
                .skip(e("}"))
                .then(function (t) {
                  return (_[t] ? _[t]().parser() : q.fail("unknown environment type: " + t)).skip(e("\\end{" + t + "}"));
                });
            };
          })),
          i(o, function (t, e) {
          ...
          (t.delimiters = {
            ...
            (t.parser = function () {
              var s = this,
                ...
                e = q.string;
              return t
                .then(e(o.column).or(e(o.row)).or(T.block))
                .many()
                .skip(t)
                .then(function (t) {
                  var e = [],
                    n = 0;
                  function i() {
                    s.blocks.push(N(n, s, e)), (e = []);
                  }
                  s.blocks = [];
                  for (var r = 0; r < t.length; r += 1) t[r] instanceof k ? e.push(t[r]) : (i(), t[r] === o.row && (n += 1));
                  return i(), s.autocorrect(), q.succeed(s);
                });
            }),
            (t.finalizeTree = function () {
            ...
            (t.autocorrect = function () {
              ...
              if ((t = Math.max.apply(null, r)) !== Math.min.apply(null, r)) {
                for (a = 0; a < s.length; a += 1) for (e = t - s[a].length; e; ) (n = t * a + s[a].length), o.splice(n, 0, N(a, this)), --e;
                this.relink();
              }
            }),
              ...
              for (
                ...
                (f.parent = this),
                  ...
                  !0 === t &&
                    ...
                    (h = q.all),
                    (p = q.eof),
                    (p = T.skip(p).or(h.result(!1)).parse(c[u].latex())).isEmpty() || m.removeClass("mq-empty"),
        ...
        t = (_.matrix = i(D, function (t, e) {
          (t.environment = "matrix"),
            ...
            (t.createBlocks = function () {
              this.blocks = [N(0, this), N(0, this), N(1, this), N(1, this)];
            });
        })),
        N =
          ((_.pmatrix = i(t, function (t, e) {
          ...
          (_["align*"] = i(D, function (t, e) {
            (t.environment = "align*"),
              (t.removeEmptyColumns = !0),
              (t.createBlocks = function () {
                this.blocks = [N(0, this), N(0, this)];
              }),
              (t.html = function () {
                return (
          ...
          (_.aligned = i(_["align*"], function (t, e) {
            t.environment = "aligned";
          })),
          (_.array = i(D, function (t, e) {
            (t.environment = "array"),
              (t.removeEmptyColumns = !0),
              (t.createBlocks = function () {
                this.blocks = [N(0, this)];
              }),
              (t.html = function () {
                return (
                ...
                return e
                  ...
                  .then(function (t) {
                    return (
                      ...
                      e.then(n(s.delimiters.column).or(n(s.delimiters.row)).or(T.block)).many()
                    );
                  })
                  .skip(e)
                  .then(function (t) {
