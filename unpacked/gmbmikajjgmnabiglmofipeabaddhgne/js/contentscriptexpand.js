...
var module$exports$gdocs$ContentScriptExpand = {},
  module$contents$gdocs$ContentScriptExpand_ContentScriptExpand = function () {
    this.numPending_ = 0;
  };
module$contents$gdocs$ContentScriptExpand_ContentScriptExpand.prototype.init = function () {
  var a = document.getElementsByTagName("html")[0];
  this.sendExpandedCss_(a);
};
module$contents$gdocs$ContentScriptExpand_ContentScriptExpand.prototype.removeElem_ = function (a) {
  a.parentNode && a.parentNode.removeChild(a);
};
module$contents$gdocs$ContentScriptExpand_ContentScriptExpand.prototype.getStyleLinkElems_ = function (a) {
  var b = [];
  ...
  for (var c = a.next(); !c.done; c = a.next()) {
    ...
    d &&
      "stylesheet" == d.toLowerCase() &&
      (d = c.getAttribute("href")) &&
      (0 == d.toLowerCase().indexOf("chrome-extension://") ? this.removeElem_(c) : b.push(c));
  }
  return b;
};
module$contents$gdocs$ContentScriptExpand_ContentScriptExpand.prototype.sendExpandedCss_ = function (a) {
  a = a.cloneNode(!0);
  var b = this.getStyleLinkElems_(a);
  b = $jscomp.makeIterator(b);
  for (var c = b.next(); !c.done; c = b.next()) {
    c = c.value;
    var d = c.getAttribute("href"),
      e = new XMLHttpRequest();
    e.addEventListener("load", this.onLoad_.bind(this, a, c), !1);
    e.open("GET", d, !0);
    try {
      e.send();
    } catch (f) {
      window.console.log("Unable to send. e:" + f);
      continue;
    }
    this.numPending_++;
  }
  0 == this.numPending_ && chrome.runtime.sendMessage(null, a.outerHTML);
};
module$contents$gdocs$ContentScriptExpand_ContentScriptExpand.prototype.onLoad_ = function (a, b, c) {
  c = c.currentTarget;
  200 == c.status && this.replaceWithCssStyle_(b, c.responseText);
  --this.numPending_ || chrome.runtime.sendMessage(null, a.outerHTML);
};
module$contents$gdocs$ContentScriptExpand_ContentScriptExpand.prototype.replaceWithCssStyle_ = function (a, b) {
  var c = document.createElement("style");
  c.innerText = b;
  a.parentNode && a.parentNode.replaceChild(c, a);
};
new module$contents$gdocs$ContentScriptExpand_ContentScriptExpand().init();
var gdlog = {},
