...
var module$exports$gdocs$ContentScriptScroll = {},
  module$contents$gdocs$ContentScriptScroll_MessageType = {};
module$exports$gdocs$ContentScriptScroll.ContentScriptScroll = function (a) {
  this.window_ = a;
  this.document_ = this.window_.document;
  this.body_ = this.document_.body || this.document_.createElement("body");
  this.totalWidth_ = this.body_.scrollWidth;
  this.totalHeight_ = this.body_.scrollHeight;
  a = this.getViewPortSize_();
  this.visibleWidth_ = a.width;
  this.visibleHeight_ = a.height;
  ...
  this.hasFixedElems_ = !1;
  this.repositionedFixedElems_ = [];
  this.listenerFn_ = this.handleMessage_.bind(this);
};
module$exports$gdocs$ContentScriptScroll.ContentScriptScroll.prototype.init = function () {
  chrome.runtime.onMessage.hasListener(this.listenerFn_) || chrome.runtime.onMessage.addListener(this.listenerFn_);
};
module$exports$gdocs$ContentScriptScroll.ContentScriptScroll.prototype.handleMessage_ = function (a, b, c) {
  switch (a.msg) {
    case "init":
      c(this.scrollInit_());
      break;
    case "scrollTo":
      return this.scroll_(a.x, a.y, a.capturePosition, c), !0;
    case "restore":
      c(this.restore_());
      break;
    default:
      this.window_.console.log("ContentScriptScroll.handleMessage invalid message: " + a.msg);
  }
  return !1;
};
module$exports$gdocs$ContentScriptScroll.ContentScriptScroll.prototype.scrollInit_ = function () {
  this.hasScrollbar_() && this.findFixedPosElements_();
  this.window_.scrollTo(0, 0);
  this.hasFixedElems_ && this.showHideFixedElems_(module$exports$gdocs$ContentScriptScroll.Corner.TOP_LEFT);
  return {
    msg: "initialized",
...
module$exports$gdocs$ContentScriptScroll.ContentScriptScroll.prototype.hasVScrollbar_ = function () {
  return this.visibleHeight_ < this.totalHeight_;
};
module$exports$gdocs$ContentScriptScroll.ContentScriptScroll.prototype.hasHScrollbar_ = function () {
  return this.visibleWidth_ < this.totalWidth_;
};
module$exports$gdocs$ContentScriptScroll.ContentScriptScroll.prototype.hasScrollbar_ = function () {
  return this.hasVScrollbar_() || this.hasHScrollbar_();
};
module$exports$gdocs$ContentScriptScroll.ContentScriptScroll.prototype.scroll_ = function (a, b, c, d) {
  this.window_.scrollTo(a, b);
  this.hasFixedElems_ &&
    (this.restoreRepositionedElements_(), c ? this.showHideFixedElems_(c) : (this.hideFixedElems_(), this.handleSpanningFixedElems_()));
  this.waitAnimationFrame_(module$exports$gdocs$ContentScriptScroll.ContentScriptScroll.NUM_ANIMATION_FRAMES, d);
};
module$exports$gdocs$ContentScriptScroll.ContentScriptScroll.prototype.waitAnimationFrame_ = function (a, b) {
  0 >= a ? b({ msg: "scrollToDone" }) : window.webkitRequestAnimationFrame(this.waitAnimationFrame_.bind(this, a - 1, b));
};
module$exports$gdocs$ContentScriptScroll.ContentScriptScroll.prototype.restore_ = function () {
  this.window_.scrollTo(this.origXpos_, this.origYpos_);
  this.hasFixedElems_ && (this.restoreRepositionedElements_(), this.showFixedElems_());
  chrome.runtime.onMessage.removeListener(this.listenerFn_);
  return { msg: "endOfPage" };
};
module$exports$gdocs$ContentScriptScroll.ContentScriptScroll.prototype.showFixedElems_ = function () {
  this.setFixedElems_("visible");
};
module$exports$gdocs$ContentScriptScroll.ContentScriptScroll.prototype.hideFixedElems_ = function () {
  this.setFixedElems_("hidden");
};
module$exports$gdocs$ContentScriptScroll.ContentScriptScroll.prototype.setFixedElems_ = function (a) {
  this.fixedElems_.forEach(function (b) {
    b.element.style.visibility = a;
  });
};
module$exports$gdocs$ContentScriptScroll.ContentScriptScroll.prototype.findFixedPosElements_ = function () {
  for (
    var a = this.totalWidth_ % this.visibleWidth_,
      b = this.totalHeight_ % this.visibleHeight_,
      c = this.document_.createNodeIterator(this.body_, NodeFilter.SHOW_ELEMENT, null, !1),
      d;
    (d = c.nextNode());

  ) {
    var e = this.getComputedStyle_(d);
    e && "fixed" == e.position && "none" != e.display && "hidden" != e.visibility && this.computeElemFixedPosition_(d, a, b);
  }
  this.hasFixedElems_ = 0 < this.fixedElems_.length;
};
module$exports$gdocs$ContentScriptScroll.ContentScriptScroll.prototype.computeElemFixedPosition_ = function (a, b, c) {
  var d = !1,
    e = !1;
  if (this.hasVScrollbar_()) {
    var f = this.getOffsetTop(a);
    if (f <= this.visibleHeight_ - f - this.getOffsetHeight(a)) f = module$contents$gdocs$ContentScriptScroll_Edge.TOP;
    else if (f < this.visibleHeight_)
      (f = module$contents$gdocs$ContentScriptScroll_Edge.BOTTOM), 0 != c && (d = this.getOffsetHeight(a) > c);
    else return;
  } else f = module$contents$gdocs$ContentScriptScroll_Edge.TOP;
  if (this.hasHScrollbar_())
    if (((c = this.getOffsetLeft(a)), c <= this.visibleWidth_ - c - this.getOffsetWidth(a)))
      c = module$contents$gdocs$ContentScriptScroll_Edge.LEFT;
    else if (c < this.visibleWidth_) (c = module$contents$gdocs$ContentScriptScroll_Edge.RIGHT), 0 != b && (e = this.getOffsetWidth(a) > b);
    else return;
  else c = module$contents$gdocs$ContentScriptScroll_Edge.LEFT;
  this.fixedElems_.push({ cornerPosition: f + "_" + c, element: a });
  d && this.bottomPositionElements_.push({ edgePosition: c, element: a });
  e && this.rightPositionElements_.push({ edgePosition: f, element: a });
};
module$exports$gdocs$ContentScriptScroll.ContentScriptScroll.prototype.showHideFixedElems_ = function (a) {
  this.fixedElems_.forEach(function (b) {
    b.element.style.visibility = b.cornerPosition == a ? "visible" : "hidden";
  });
};
module$exports$gdocs$ContentScriptScroll.ContentScriptScroll.prototype.handleSpanningFixedElems_ = function () {
  var a = new module$contents$gdocs$ContentScriptScroll_Position(this.totalWidth_, this.body_.scrollLeft, this.visibleWidth_),
    b = new module$contents$gdocs$ContentScriptScroll_Position(this.totalHeight_, this.body_.scrollTop, this.visibleHeight_);
  this.checkSpan_(a, this.rightPositionElements_, "offsetWidth", module$contents$gdocs$ContentScriptScroll_Edge.RIGHT, b);
  this.checkSpan_(b, this.bottomPositionElements_, "offsetHeight", module$contents$gdocs$ContentScriptScroll_Edge.BOTTOM, a);
};
module$exports$gdocs$ContentScriptScroll.ContentScriptScroll.prototype.checkSpan_ = function (a, b, c, d, e) {
  a.isNextToLast &&
    b.forEach(function (f) {
      if (
        this.isFirstLast_(f.edgePosition, e) &&
        ((f = f.element), ("offsetWidth" == c ? this.getOffsetWidth(f) : this.getOffsetHeight(f)) > a.lastCapturePartial)
      ) {
        f.style.visibility = "visible";
        var g = this.getComputedStyle_(f)[d];
        this.repositionedFixedElems_.push([d, f, g]);
        f.style[d] = -a.lastCapturePartial + "px";
      }
    }, this);
};
module$exports$gdocs$ContentScriptScroll.ContentScriptScroll.prototype.isFirstLast_ = function (a, b) {
  return (
    (a == module$contents$gdocs$ContentScriptScroll_Edge.LEFT && b.isFirst) ||
    (a == module$contents$gdocs$ContentScriptScroll_Edge.RIGHT && b.isLast) ||
    (a == module$contents$gdocs$ContentScriptScroll_Edge.TOP && b.isFirst) ||
    (a == module$contents$gdocs$ContentScriptScroll_Edge.BOTTOM && b.isLast)
  );
};
module$exports$gdocs$ContentScriptScroll.ContentScriptScroll.prototype.restoreRepositionedElements_ = function () {
  this.repositionedFixedElems_.forEach(function (a) {
    a[1].style[a[0]] = a[2];
  });
  this.repositionedFixedElems_ = [];
};
module$exports$gdocs$ContentScriptScroll.ContentScriptScroll.prototype.getViewPortSize_ = function () {
  return "BackCompat" == this.document_.compatMode
    ? { width: this.body_.clientWidth, height: this.body_.clientHeight }
    : { width: this.document_.documentElement.clientWidth, height: this.document_.documentElement.clientHeight };
};
module$exports$gdocs$ContentScriptScroll.ContentScriptScroll.prototype.getComputedStyle_ = function (a) {
  return this.window_.getComputedStyle(a, null) || new CSSStyleDeclaration();
};
module$exports$gdocs$ContentScriptScroll.ContentScriptScroll.prototype.getOffsetTop = function (a) {
  return a.offsetTop;
};
module$exports$gdocs$ContentScriptScroll.ContentScriptScroll.prototype.getOffsetLeft = function (a) {
  return a.offsetLeft;
};
module$exports$gdocs$ContentScriptScroll.ContentScriptScroll.prototype.getOffsetWidth = function (a) {
  return a.offsetWidth;
};
module$exports$gdocs$ContentScriptScroll.ContentScriptScroll.prototype.getOffsetHeight = function (a) {
  return a.offsetHeight;
};
module$exports$gdocs$ContentScriptScroll.ContentScriptScroll.NUM_ANIMATION_FRAMES = 3;
var module$contents$gdocs$ContentScriptScroll_Position = function (a, b, c) {
  this.lastCapturePartial = a % c;
  this.remainingCapture = a - b;
  this.isFirst = 0 == b;
  this.isLast = this.remainingCapture <= c;
  this.isNextToLast = this.remainingCapture > c && this.remainingCapture <= 2 * c;
};
module$exports$gdocs$ContentScriptScroll.Corner = {
  TOP_LEFT: "top_left",
  TOP_RIGHT: "top_right",
  BOTTOM_LEFT: "bottom_left",
  BOTTOM_RIGHT: "bottom_right"
};
var module$contents$gdocs$ContentScriptScroll_Edge = { TOP: "top", BOTTOM: "bottom", LEFT: "left", RIGHT: "right" };
module$exports$gdocs$ContentScriptScroll.ContentScriptScroll.CornerElemData_ = {};
module$exports$gdocs$ContentScriptScroll.ContentScriptScroll.EdgeElemData_ = {};
new module$exports$gdocs$ContentScriptScroll.ContentScriptScroll(window).init();
var gdlog = {},
