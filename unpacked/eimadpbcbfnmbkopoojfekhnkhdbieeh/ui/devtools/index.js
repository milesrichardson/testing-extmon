(function () {
  ...
  function renderBody(data, devToolsData, actions) {
    sync(document.body, m$1(Body$1, { data: data, devtools: devToolsData, actions: actions }));
  }
  async function start() {
    ...
    let [data, devToolsData] = await Promise.all([connector.getData(), connector.getDevToolsData()]);
