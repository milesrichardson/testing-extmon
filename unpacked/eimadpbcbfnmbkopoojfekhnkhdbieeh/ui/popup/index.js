(function () {
  ...
  function setClassObject(element, classObj) {
    const cls = Array.isArray(classObj) ? classes$1(...classObj) : classes$1(classObj);
    if (cls) {
  ...
  function mergeValues(obj, old) {
    ...
    oldProps.filter((prop) => !newProps.has(prop)).forEach((prop) => values.set(prop, null));
  ...
  const specialAttrs = new Set(["key", "oncreate", "onupdate", "onrender", "onremove"]);
  ...
  class ElementVNode extends VNodeBase {
    ...
    getExistingElement(context) {
      ...
      if (nodeMatchesSpec(existing, this.spec)) {
        element = existing;
      } else if (!isElementRefined(parent, context.vdom) && context.vdom.isDOMNodeCaptured(parent)) {
        const sibling = context.sibling;
        const guess = sibling ? sibling.nextElementSibling : parent.firstElementChild;
  ...
  class DOMVNode extends VNodeBase {
    ...
    insertNode(context) {
      ...
      const shouldInsert = !(parent === this.node.parentElement && sibling === this.node.previousSibling);
      if (shouldInsert) {
    ...
    attached(context) {
      const { node } = this;
      if (node instanceof Element && !isElementRefined(node, context.vdom) && context.vdom.isDOMNodeCaptured(node)) {
        this.refine(context);
      }
    }
    children() {
  ...
  function createVDOM(rootNode) {
    ...
    function createVNodeLinks(vnode) {
      ...
      const parentNode = isDOMVNode(parent) ? parent.node : parentNodes.get(parent);
      parentNodes.set(vnode, parentNode);
  ...
  function normalize(attrsOrChild, ...otherChildren) {
    ...
    const children = attrs == null ? [attrsOrChild].concat(otherChildren) : otherChildren;
  ...
  class Connector {
    ...
    async applyDevDynamicThemeFixes(text) {
      return await this.sendRequest(MessageTypeUItoBG.APPLY_DEV_DYNAMIC_THEME_FIXES, text);
    }
    ...
    async applyDevInversionFixes(text) {
      return await this.sendRequest(MessageTypeUItoBG.APPLY_DEV_INVERSION_FIXES, text);
    }
    ...
    async applyDevStaticThemes(text) {
      return await this.sendRequest(MessageTypeUItoBG.APPLY_DEV_STATIC_THEMES, text);
    }
  ...
  function onSwipeStart(startEventObj, startHandler) {
    const isTouchEvent = typeof TouchEvent !== "undefined" && startEventObj instanceof TouchEvent;
    const touchId = isTouchEvent ? startEventObj.changedTouches[0].identifier : null;
  ...
  function Button(props, ...children) {
    ...
    return m$1("button", { class: cls, ...attrs }, m$1("span", { class: "button__wrapper" }, ...children));
  }
  ...
  function ColorPicker(props) {
    ...
    const resetButton = props.canReset
      ...
      : null;
    const textBoxLine = m$1("span", { class: "color-picker__textbox-line" }, textBox, previewElement, resetButton);
    ...
    return m$1(
      "span",
      {
        class: ["color-picker", store.isFocused && "color-picker--focused", props.class]
      },
    ...
    function onSelectedClick() {
      ...
      if (store.isOpen) {
        const onOuterClick = (e) => {
          ...
          const ex = e.clientX;
          const ey = e.clientY;
          if (ex < listRect.left || ex > listRect.right || ey < listRect.top || ey > listRect.bottom) {
            store.isOpen = false;
            context.refresh();
          }
        };
  ...
  function ColorDropDown(props) {
    ...
    const selectedDropDownValue = props.value === "" ? "default" : props.value === "auto" ? "auto" : "custom";
    ...
    const shouldFocusOnPicker =
      props.value !== "" && props.value !== "auto" && prevValue != null && (prevValue === "" || prevValue === "auto");
  ...
  function ResetButton(props, ...content) {
    return m$1(
      ...
      m$1("span", { class: "reset-button__content" }, m$1("span", { class: "reset-button__icon" }), ...content)
    );
  }
  ...
  function Select(props) {
    ...
    return m$1(
      ...
      m$1(
        ...
        m$1(Button, { class: "select__expand", onclick: onExpandClick }, m$1("span", { class: "select__expand__icon" }))
      ),
      m$1(VirtualScroll, {
        root: m$1("span", {
          class: {
  ...
  function Slider(props) {
    ...
    function onPointerDown(startEvt) {
      ...
      const { getClientX, pointerMoveEvent, pointerUpEvent } = (() => {
        const isTouchEvent = typeof TouchEvent !== "undefined" && startEvt instanceof TouchEvent;
        const touchId = isTouchEvent ? startEvt.changedTouches[0].identifier : null;
        function getTouch(e) {
  ...
  function TextList(props) {
    ...
    if (node && props.isFocused && (!prevProps || !prevProps.isFocused || prevProps.values.length < props.values.length)) {
      focusLastNode();
    }
    ...
    return m$1(VirtualScroll, {
      ...
      items: props.values.map(createTextBox).concat(createTextBox("", props.values.length)),
  ...
  function UpDown(props) {
    ...
    return m$1(
      ...
      m$1(
        "div",
        { class: "updown__line" },
        m$1(Button, { class: buttonDownCls, onclick: onButtonDownClick }, m$1("span", { class: "updown__icon updown__icon-down" })),
        m$1(Track, {
          value: trackValue,
          label: props.name,
          onChange: onTrackValueChange
        }),
        m$1(Button, { class: buttonUpCls, onclick: onButtonUpClick }, m$1("span", { class: "updown__icon updown__icon-up" }))
      ),
  ...
  function CustomSettingsToggle({ data, actions }) {
    ...
    const urlText = host.split(".").reduce((elements, part, i) => elements.concat(m$1("wbr", null), `${i > 0 ? "." : ""}${part}`), []);
    return m$1(
      Button,
      {
        class: {
  ...
  function SettingsIcon(props) {
    return m$1(
      ...
      m$1("defs", null, m$1("path", { id: "cog", d: "M-1.25,-6.5 h2.5 l1,3 h-4.5 z" })),
      m$1(
        "g",
    ...
    return m$1(
      ...
      m$1(
        ...
        ...Array.from({ length: 8 }).map((_, i) => {
          ...
          const pt = [5, 6].map((l) => [cx + l * Math.cos(angle), cy + l * Math.sin(angle)]);
          return m$1("line", {
            x1: pt[0][0],
            y1: pt[0][1],
            x2: pt[1][0],
  ...
  function CheckmarkIcon({ isChecked }) {
    return m$1(
      ...
      { viewBox: "0 0 8 8" },
      m$1("path", {
        d: isChecked ? "M1,4 l2,2 l4,-4 v1 l-4,4 l-2,-2 Z" : "M2,2 l4,4 v1 l-4,-4 Z M2,6 l4,-4 v1 l-4,4 Z"
      })
    );
  }
  ...
  function SiteToggleButton({ data, actions }) {
    ...
    const toggleHasEffect = data.settings.enableForProtectedPages || (!tab.isProtected && !pdf) || tab.isInjected;
    const isSiteEnabled = isURLEnabled(tab.url, data.settings, tab, data.isAllowedFileSchemeAccess) && Boolean(tab.isInjected);
    const host = getURLHostOrProtocol(tab.url);
    const urlText = host.split(".").reduce((elements, part, i) => elements.concat(m$1("wbr", null), `${i > 0 ? "." : ""}${part}`), []);
    return m$1(
      Button,
      ...
      m$1("span", { class: "site-toggle__mark" }, m$1(CheckmarkIcon, { isChecked: isSiteEnabled })),
      " ",
  ...
  const helpLocales = ["be", "cs", "de", "en", "es", "fr", "it", "nl", "pt", "ru", "sr", "tr", "zh-CN", "zh-TW"];
  function getHelpURL() {
  ...
  function MoreSiteSettings({ data, actions, isExpanded, onClose }) {
    ...
    return m$1(
      ...
      m$1(
        ...
        m$1("span", { class: "header__more-settings__top__text" }, getLocalMessage("site_toggle")),
        m$1(
          "span",
          {
      ...
      m$1(
        ...
        m$1(
          "div",
          {
            class: ["header__more-settings__line", "header__more-settings__enabled-by-default"]
          },
          m$1(CheckBox, {
        ...
        m$1(
          "div",
          {
            class: ["header__more-settings__line", "header__more-settings__detect-dark-theme"]
          },
          m$1(CheckBox, {
        ...
        m$1("p", { class: "header__more-settings__description" }, getLocalMessage("detect_website_dark_theme")),
        m$1(
          "span",
          {
            class: {
          ...
          m$1(ShortcutLink, {
            ...
            textTemplate: (hotkey) => (hotkey ? hotkey : getLocalMessage("click_to_set_shortcut")),
            onSetShortcut: (shortcut) => actions.setShortcut("addSite", shortcut)
          }),
          m$1(KeyboardIcon, null)
        ),
        m$1("p", { class: "header__more-settings__description" }, getLocalMessage("website_toggle_shortcut")),
        m$1(
          "div",
          ...
          m$1("p", { class: "header__more-settings__description" }, getLocalMessage("support_out_work"))
        )
      )
    );
  }
  ...
  function MoreToggleSettings({ data, actions, isExpanded, onClose }) {
    ...
    return m$1(
      ...
      m$1(
        "div",
        { class: "header__more-settings__top" },
        m$1("span", { class: "header__more-settings__top__text" }, getLocalMessage("automation")),
        m$1(
          "span",
          {
            class: "header__more-settings__top__close",
      ...
      m$1(
        ...
        m$1(
          ...
          m$1(CheckBox, {
            ...
            onchange: (e) => changeAutomationMode(e.target.checked ? AutomationMode.TIME : AutomationMode.NONE)
          }),
          m$1(TimeRangePicker, {
        ...
        m$1("p", { class: "header__more-settings__description" }, getLocalMessage("set_active_hours")),
        m$1(
          "div",
          {
          ...
          m$1(CheckBox, {
            ...
            onchange: (e) => changeAutomationMode(e.target.checked ? AutomationMode.LOCATION : AutomationMode.NONE)
          }),
          m$1(TextBox, {
            ...
            oncreate: (node) => (node.value = getLocationString(locationSettings.latitude)),
            onkeypress: (e) => {
              if (e.key === "Enter") {
                e.target.blur();
              }
          ...
          m$1(TextBox, {
            ...
            oncreate: (node) => (node.value = getLocationString(locationSettings.longitude)),
            onkeypress: (e) => {
              if (e.key === "Enter") {
                e.target.blur();
              }
        ...
        m$1("p", { class: "header__more-settings__location-description" }, getLocalMessage("set_location")),
        m$1(
          "div",
          {
            class: ["header__more-settings__line", "header__more-settings__system-dark-mode"]
          },
          m$1(CheckBox, {
            class: "header__more-settings__system-dark-mode__checkbox",
            checked: isSystemAutomation,
            onchange: (e) => changeAutomationMode(e.target.checked ? AutomationMode.SYSTEM : AutomationMode.NONE)
          }),
          m$1(
            Button,
            {
        ...
        m$1("p", { class: "header__more-settings__description" }, getLocalMessage("system_dark_mode_description")),
        !isMatchMediaChangeEventListenerBuggy
          ? null
          : m$1("p", { class: "header__more-settings__warning" }, getLocalMessage("system_dark_mode_chromium_warning")),
        m$1(
          "span",
          {
            class: {
        ...
        m$1("p", { class: "header__more-settings__description" }, getLocalMessage("extension_toggle_shortcut")),
        m$1(
          "div",
          { class: "header__more-settings__donate" },
          m$1(
  ...
  function Header({ data, actions, onMoreSiteSettingsClick, onMoreToggleSettingsClick }) {
  ...
  function AutomationPage(props) {
    ...
    return m$1(
      ...
      m$1(
        "div",
        {
          class: ["automation-page__line", "automation-page__system-dark-mode"]
        },
        m$1(CheckBox, {
      ...
      !isMatchMediaChangeEventListenerBuggy
        ? null
        : m$1("p", { class: "automation-page__warning" }, getLocalMessage("system_dark_mode_chromium_warning")),
      m$1(DropDown, {
  ...
  function ControlGroup(props, control, description) {
    return m$1("span", { class: ["control-group", props.class] }, control, description);
  }
  ...
  function SiteToggleGroup(props) {
    ...
    return m$1(
      ...
      m$1(ControlGroup$1.Control, { class: "site-toggle-group__control" }, m$1(SiteToggleButton, { ...props })),
      m$1(ControlGroup$1.Description, null, description)
    );
  }

  function ThemeControl(props, controls) {
    return m$1("span", { class: "theme-control" }, m$1("label", { class: "theme-control__label" }, props.label), controls);
  }
  ...
  function ResetButtonGroup$1(props) {
    ...
    return m$1(
      ControlGroup$1,
      null,
      m$1(ControlGroup$1.Control, null, m$1(ResetButton, { onClick: reset }, "Reset to defaults")),
  ...
  function PresetPicker(props) {
    ...
    const addNewPresetOption =
      props.data.settings.presets.length < MAX_ALLOWED_PRESETS ? { id: "add-preset", content: "\uff0b Create new theme" } : null;
    ...
    const dropdownOptions = [defaultOption, ...userPresetsOptions, addNewPresetOption, customSitePresetOption].filter(Boolean);
  ...
  function getCurrentThemePreset(props) {
    ...
    let theme = custom ? custom.theme : preset ? preset.theme : props.data.settings.theme;
    ...
    function setTheme(config) {
      ...
      if (config.mode != null && props.data.settings.automation.behavior === "Scheme") {
        props.actions.changeSettings({
          automation: {
            ...props.data.settings.automation,
            ...{ enabled: false }
  ...
  function ThemeGroup(props) {
    ...
    return m$1(
      "div",
      { class: "theme-group" },
      m$1("div", { class: "theme-group__presets-wrapper" }, m$1(PresetPicker, { ...props })),
      m$1(
        "div",
  ...
  function SwitchGroup(props) {
    return m$1(Array, null, m$1(AppSwitch, { ...props }), m$1(SiteToggleGroup, { ...props }));
  }
  function SettingsNavButton(props) {
    return m$1(ResetButton$1, { onClick: props.onClick }, m$1("span", { class: "settings-button-icon" }), "Settings");
  }
  function MainPage(props) {
    return m$1(
      ...
      m$1("section", { class: "m-section" }, m$1(SettingsNavButton, { onClick: props.onSettingsNavClick }), m$1(HelpGroup, null))
    );
  }
  ...
  function DevToolsGroup() {
    return m$1(
      ...
      m$1(
        ControlGroup$1.Control,
        null,
        m$1(ResetButton$1, { onClick: openDevTools$1, class: "dev-tools-button" }, "\uD83D\uDEE0 ", getLocalMessage("open_dev_tools"))
      ),
  ...
  function ManageSettingsButton(props) {
    return m$1(
      ControlGroup$1,
      null,
      m$1(ControlGroup$1.Control, null, m$1(ResetButton$1, { onClick: props.onClick }, "Manage settings")),
  ...
  function SiteListButton(props) {
    return m$1(
      ...
      m$1(
        ControlGroup$1.Control,
        null,
        m$1(ResetButton$1, { onClick: props.onClick }, m$1("span", { class: "site-list-button-icon" }), "Site list")
      ),
  ...
  function DetectDarkTheme(props) {
    ...
    return m$1(CheckButton, {
      ...
      description: props.data.settings.detectDarkTheme ? `Will not override website's dark theme` : `Will override website's dark theme`,
  ...
  function AppVersion() {
    ...
    return m$1("label", { class: "darkreader-version" }, "Version 5 Preview (", appVersion, ")");
  }
  ...
  function SiteList(props) {
    ...
    return m$1(
      ...
      m$1(VirtualScroll, {
        ...
        items: props.siteList.map((site, index) => createTextBox(site, index)).concat(createTextBox("", props.siteList.length)),
  ...
  function DeleteAllButton(props, ...content) {
    return m$1(
      ...
      m$1("span", { class: "delete-all-button__content" }, m$1("span", { class: "delete-all-button-icon" }), ...content)
    );
  }
  ...
  function RemoveAllButton(props) {
    ...
    return m$1(
      ...
      m$1(ControlGroup$1.Control, null, m$1(DeleteAllButton, { onClick: showDialog }, dialog))
    );
  }
  ...
  function ThemePage(props) {
    ...
    return m$1(
      ...
      m$1(
        Collapsible,
        null,
        m$1(Collapsible.Group, { id: "main", label: "Brightness, contrast, mode" }, m$1(MainGroup, { theme: theme, change: change })),
        m$1(
          Collapsible.Group,
  ...
  function ResetButtonGroup(props) {
    ...
    return m$1(
      ControlGroup$1,
      null,
      m$1(ControlGroup$1.Control, null, m$1(ResetButton, { onClick: showDialog }, "Reset settings", dialog)),
    ...
    validateProperty(
      ...
      (automation) => {
        ...
        automationValidator.validateProperty(
          automation,
          "mode",
          isOneOf(AutomationMode.SYSTEM, AutomationMode.TIME, AutomationMode.LOCATION, AutomationMode.NONE),
          automation
        );
  ...
  function ImportButton(props) {
    ...
    return m$1(
      ControlGroup$1,
      null,
      m$1(ControlGroup$1.Control, null, m$1(Button, { onclick: importSettings, class: "settings-button" }, "Import Settings", dialog)),
  ...
  function ExportButton(props) {
    ...
    return m$1(
      ControlGroup$1,
      null,
      m$1(ControlGroup$1.Control, null, m$1(Button, { onclick: exportSettings, class: "settings-button" }, "Export Settings")),
  ...
  function SyncSettings(props) {
    ...
    return m$1(CheckButton, {
      ...
      description: props.data.settings.syncSettings ? "Synchronized across devices" : "Not synchronized across devices",
  ...
  function ExportTheme({ data }) {
    ...
    return m$1(
      ControlGroup$1,
      null,
      m$1(ControlGroup$1.Control, null, m$1(Button, { onclick: exportCSS, class: "settings-button" }, "Export Dynamic Theme")),
  ...
  function FetchNews(props) {
    ...
    return m$1(CheckButton, {
      ...
      description: props.data.settings.fetchNews ? "Notifying of Dark Reader's news" : "Not Notifying of Dark Reader's news",
  ...
  function ManageSettingsPage(props) {
    const custom = props.data.settings.customThemes.find(({ url }) => isURLInList(props.data.activeTab.url, url));
    const engine = custom ? custom.theme.engine : props.data.settings.theme.engine;
    const tab = props.data.activeTab;
  ...
  function Pages(props) {
    ...
    return m$1(
      ...
      m$1(Page, { id: "manage-settings" }, m$1(ManageSettingsPage, { ...props }))
    );
  }
  ...
  function Body$2(props) {
    ...
    return m$1(
      ...
      m$1("section", { class: "m-section pages-section" }, m$1(Pages, { ...props })),
  ...
  function compileMarkdown(markdown) {
    return markdown.split("**").map((text, i) => (i % 2 ? m$1("strong", null, text) : text));
  }
  ...
  function MoreSettings({ data, actions, fonts }) {
    ...
    return m$1(
      ...
      m$1(
        "div",
        { class: "more-settings__section" },
        m$1("p", { class: "more-settings__description" }, compileMarkdown(getLocalMessage("try_experimental_theme_engines"))),
        m$1(EngineSwitch, {
      ...
      m$1(
        ...
        tab.isProtected
          ...
          : m$1("p", { class: "more-settings__description" }, getLocalMessage("only_for_description"))
      ),
      null
    );
  }
  ...
  function SiteListSettings({ data, actions, isFocused }) {
    ...
    return m$1(
      ...
      m$1(ShortcutLink, {
        ...
        commandName: "addSite",
        shortcuts: data.shortcuts,
        textTemplate: (hotkey) => (hotkey ? `${getLocalMessage("add_site_to_list")}: ${hotkey}` : getLocalMessage("setup_add_site_hotkey")),
        onSetShortcut: (shortcut) => actions.setShortcut("addSite", shortcut)
      })
    );
  }
    ...
    return m$1(
      ...
      m$1(
        ...
        m$1(
          ...
          m$1("span", { class: "mobile-link__text" }, getLocalMessage("mobile_link"))
        )
      ),
      m$1(
        "footer",
        ...
        m$1(
          ...
          m$1(Button, { onclick: openDevTools, class: "dev-tools-button" }, "\uD83D\uDEE0 ", getLocalMessage("open_dev_tools"))
        )
      ),
      m$1(NewsGroup, {
      ...
      props.data.uiHighlights.includes("new-toggle-menus") && !state.newToggleMenusHighlightHidden ? m$1(MoreNewHighlight, null) : null
    );
  }
  ...
  async function start() {
    ...
    const [data, fonts] = await Promise.all([connector.getData(), getFontList()]);
