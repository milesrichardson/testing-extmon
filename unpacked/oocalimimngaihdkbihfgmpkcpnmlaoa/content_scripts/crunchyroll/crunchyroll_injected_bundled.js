/******/ (() => {
  ...
  })(PlaybackState || (PlaybackState = {})); // CONCATENATED MODULE: ./src/Teleparty/ContentScripts/Crunchyroll/crunchyroll_injected.js
  ...
  if (!window.videoIdScriptLoaded && window != top && !!document.querySelector("#player0")) {
    ...
    var getInAd = function () {
      ...
      try {
        ...
        const isInAd =
          (_c =
            (_b = (_a = elementRoot[key].return) === null || _a === void 0 ? void 0 : _a.stateNode) === null || _b === void 0
              ? void 0
