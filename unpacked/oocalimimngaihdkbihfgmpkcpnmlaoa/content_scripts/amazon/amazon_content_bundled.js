...
(() => {
  ...
  (i.n = (t) => {
    ...
    (() => {
      ...
      class G extends R {
        constructor(t, e, i) {
          super(t, e, O.SET_TYPING), (this.data = i);
        }
      }
      class L extends R {
        constructor(t, e, i) {
          super(t, e, O.SEND_MESSAGE), (this.data = i);
        }
      }
      class H extends R {
        constructor(t, e, i) {
          super(t, e, O.BROADCAST_USER_SETTINGS), (this.data = i);
        }
      }
      class z extends N {
        constructor(t, e, i) {
      ...
      class W extends z {
        constructor(t, e, i) {
          super(t, e, U.TEARDOWN), (this.data = i);
        }
      }
      class K extends z {
        constructor(t, e, i) {
          super(t, e, U.LOG_EVENT), (this.data = i), (this.sender = t), (this.target = e);
        }
      }
      class J extends R {
        constructor(t, e, i) {
          super(t, e, O.SEND_REACTION), (this.data = i);
        }
      }
      class Y extends R {
        constructor(t, e, i) {
          super(t, e, O.SEND_GIF), (this.data = i);
        }
      }
          ...
          return tt(this, void 0, void 0, function* () {
            return new Promise((e, i) => {
              chrome.storage.local.get(t, (t) => {
                chrome.runtime.lastError ? (console.log(chrome.runtime.lastError), i(new Error(b))) : e(t);
              });
            });
          });
        }
          ...
          return tt(this, void 0, void 0, function* () {
            return new Promise((t, e) => {
              chrome.storage.local.get(null, (i) => {
                chrome.runtime.lastError ? (console.log(chrome.runtime.lastError), e(new Error(b))) : t(i);
              });
            });
          });
        }
      ...
      const rt = function (t) {
        return "string" == typeof t && ot.test(t);
      };
      for (var at = [], ct = 0; ct < 256; ++ct) at.push((ct + 256).toString(16).substr(1));
      const Dt = function (t) {
        ...
        if (!rt(i)) throw TypeError("Stringified UUID is invalid");
        return i;
      };
      const ht = function (t, e, i) {
        var n = (t = t || {}).random || (t.rng || ut)();
      ...
      const lt = chrome.extension.getURL("img/x-circle.svg"),
        pt = "with-chat";
      ...
      const Ft = new (class {
        ...
        getValidatedChromeStorageDataAsync() {
          return gt(this, void 0, void 0, function* () {
            const t = yield it.getAllItemsAsync(),
              e = Ft.validateStorageData(t);
      ...
      class Tt {
          ...
          (this.k = this.I.bind(this)),
            ...
            (this.M = (t) => {
              ...
              const e = jQuery("#chat-input")[0],
                i = t.detail.unicode,
                n = new K(M, S, { name: "user_click", component: { name: "chat_input_container-emoji_picker-emoji", type: i } });
              V.g(n);
              const s = new K(M, S, { eventType: `emoji-click-${i}`, sessionId: this.V.getSessionId() });
              V.g(s), Z.pushTask(() => this.updateFrequentlyUsed(t.detail.emoji));
              ...
              this.V.focusChat(), this.N(i);
              e.scrollHeight - e.scrollTop <= e.clientHeight + 40 && (e.scrollTop = e.scrollHeight), this.R(), this.V.onInputChange();
            }),
            (this.V = t);
        }
        O() {
          p("Idle Warning called"), _t(wt);
          const t = new K(M, S, {
            name: "party_warning",
            action: { description: "user has been warned for being idle", reason: "user was idle for 120000 time in milliseconds." }
          });
          V.g(t);
          const e = new K(M, S, { eventType: "idle-warn-2hr", sessionId: this.V.getSessionId() });
          V.g(e), (this.U = setTimeout(this.G.bind(this), ft));
        }
        G() {
          p("Idle kick called");
          const t = new K(M, S, {
        ...
        resetIdleTimer() {
          this.L && clearTimeout(this.L), this.U && (jt(), clearTimeout(this.U)), (this.L = setTimeout(this.O.bind(this), mt));
        }
        H() {
          (this.L = setTimeout(this.O.bind(this), mt)),
        ...
        startListening() {
          p("Listening for chat events"), this.H(), this.K(), this.initWindowListeners();
        }
        stopListening() {
          this.J(), this.W(), this.Y();
        }
        I() {
          this.V.clearUnreadCount();
        }
        X(t) {
          ...
          this.V.onInputChange();
        }
        initWindowListeners() {
          jQuery(window).on("focus", this.k),
            window.addEventListener("message", this.T),
            document.addEventListener("dragstart", this.q.bind(this)),
            document.addEventListener("webkitfullscreenchange", this.V.onFullScreen),
            document.addEventListener("fullscreenchange", this.V.onFullScreen),
        ...
        K() {
          jQuery(window).on("focus", this.k),
            jQuery("#party-tab").on("click", this.V.togglePartyTab.bind(this.V)),
            jQuery("#friends-tab").on("click", this.V.toggleFriendsTab.bind(this.V)),
            jQuery(".user-icon").on("click", this.V.toggleLargeUserIconButton.bind(this.V)),
            jQuery("#user-icon").on("click", this.V.toggleIconContainer.bind(this.V)),
            jQuery("#link-icon").on("click", this.V.linkIconListener.bind(this.V)),
            jQuery("#reset-icon").on("click", this.V.resetIconListener.bind(this.V)),
            jQuery(".image-button").on("click", this.V.userIconSelectorListener.bind(this.V)),
            jQuery("#chat-input-container").on("keydown", this.V.onChatKeyDown.bind(this.V)),
            jQuery("#nickname-edit").on("keydown", this.V.onChatKeyDown.bind(this.V)),
            jQuery("#chat-input").on("keypress", this.V.onChatKeyPress.bind(this.V)),
            jQuery("#chat-input").on("input", this.V.onInputChange.bind(this.V)),
            jQuery("#gif-search").on("keyup", this.V.onGifSearch.bind(this.V)),
            jQuery("#saveChanges").on("click", this.V.saveChangesListener.bind(this.V)),
            jQuery("#cancelNickname").on("click", this.V.cancelNicknameListener.bind(this.V)),
            jQuery("#chat-wrapper").on("mouseup", this.V.cancelEvent),
            jQuery("#chat-wrapper").on("mousedown", this.V.cancelEvent),
            jQuery("#chat-wrapper").on("pointerup", this.V.cancelEvent),
            jQuery("#chat-wrapper").on("pointerdown", this.V.cancelEvent),
            jQuery("#chat-wrapper").on("mousemove", this.V.cancelEvent),
            jQuery("#chat-wrapper").on("pointermove", this.V.cancelEvent),
            jQuery("#chat-wrapper").on("keyup", this.V.onChatKeyUp.bind(this.V)),
            jQuery("#emoji-picker-btn").on("click", this.V.addEmojiPicker.bind(this.V)),
            jQuery("#gif-btn").on("click", this.V.addGifPicker.bind(this.V)),
            jQuery(".gif-img").on("click", this.V.clickGif.bind(this.V)),
            jQuery(".gif-results").on("click", "video, img", this.V.clickGif.bind(this.V)),
            jQuery("#category-container").on("click", "video", this.V.clickGif.bind(this.V)),
            jQuery("#gif-input-back").on("click", this.V.resetGif.bind(this.V)),
            jQuery("#reaction-btn").on("click", this.V.addReactionTab.bind(this.V)),
            ...
            jQuery("#gif-results-wrapper").on("scroll", this.V.onScrollToBottom.bind(this.V)),
            this.et(),
            document.addEventListener("keydown", this.P.bind(this), !0),
            this.V.initCustomListeners();
        }
        et() {
          jQuery("#tp-heart-button").on("click", () => {
            this.V.onReactionClicked(It.HEART);
          }),
            jQuery("#tp-cry-button").on("click", () => {
              this.V.onReactionClicked(It.CRY);
            }),
            jQuery("#tp-angry-button").on("click", () => {
              this.V.onReactionClicked(It.ANGRY);
            }),
            jQuery("#tp-surprise-button").on("click", () => {
              this.V.onReactionClicked(It.SURPRISE);
            }),
            jQuery("#tp-laugh-button").on("click", () => {
              this.V.onReactionClicked(It.LAUGH);
            }),
            jQuery("#tp-fire-button").on("click", () => {
              this.V.onReactionClicked(It.FIRE);
            });
        }
        R() {
          var t, e;
        ...
        Z(t) {
          t.target === jQuery("#chat-input")[0] && this.V.focusChat();
        }
        N(t) {
          let e, i;
        ...
        Y() {
          jQuery(window).off("focus", this.k),
            ...
            document.removeEventListener("webkitfullscreenchange", this.V.onFullScreen),
            document.removeEventListener("fullscreenchange", this.V.onFullScreen);
        }
        J() {
      ...
      class Ut {
        ...
        reloadMessages() {
          this.V.queueMessageForFrame(dt.CLEAR_MESSAGES, "");
        ...
        addMessage(t, e, i) {
          ...
          this.V.queueMessageForFrame(dt.ADD_MESSAGE, { originalMessage: u, userIcon: o, userNickname: r });
        ...
        addGif(t, e) {
          ...
          this.V.queueMessageForFrame(dt.ADD_MESSAGE, { originalMessage: t, userIcon: s, userNickname: u });
          const o = "" === u ? this.yt(s, t, n) : this.Ft(s, u, t, n);
          (o[0].Bt = !0), this.ft(o, t, s, u, n), $t(100)().then(this.scrollToBottom.bind(this)), this.jt();
        }
        scrollToBottom() {
        ...
        setUserIconUrl(t) {
          (this.lt = t), this.V.queueMessageForFrame(dt.SET_USER_ICON_URL, t);
        }
        renderSidebar() {
          ...
          this.V.isChatFrameActive() && this.reloadMessages();
        }
        Qt(t) {
          let e = null;
          if (t)
        ...
        addReviewMessage() {
          ...
          V.g(t);
          const e = { eventType: "review-shown-chrome", sessionId: this.V.getSessionId() },
            i = new K(M, S, e);
          V.g(i),
            jQuery("#reviewLink").click(() => {
              ...
              V.g(t);
              const e = { eventType: "review-clicked-chrome", sessionId: this.V.getSessionId() },
                i = new K(M, S, e);
              V.g(i);
            });
        }
      ...
      class Gt {
        constructor(t) {
          (this.It = !1), (this.xt = !1), (this.St = !1), (this.V = t);
        }
        ...
        Tt() {
          const t = this.Pt();
          this.Mt().text(t), this.V.queueMessageForFrame(dt.SET_PRESENCE_MESSAGE, { text: t });
        }
      }
      ...
      class zt extends class {
        constructor() {
          (this.$t = !1),
            ...
            (this.setReactionsActive = (t) => {
              this.Wt.pushTask(() => Q.setItemsAsync({ [n]: t.active }));
            }),
            (this.onFullScreen = () => {
              var t;
              this.scrollToBottom(),
        ...
        de(t, e) {
          const i = new K(M, S, { name: "error", action: { reason: e, description: t } });
          V.g(i);
        }
          ...
          return Lt(this, void 0, void 0, function* () {
            try {
              console.log("Start delay"),
                yield Vt(() => this.Kt && null != this.pe, 3e4)(),
        ...
        ye() {
          return Lt(this, void 0, void 0, function* () {
            yield V.g(new z(M, S, U.LOAD_CHAT_WINDOW)), console.log(this.pe);
          });
        }
        resetChatWindow(t = !1) {
          var e;
          return Lt(this, void 0, void 0, function* () {
            yield V.g(new z(M, S, U.RESET_CHAT_WINDOW)),
              console.log(this.pe),
              (this.Zt = !0),
              (this.Gt = !0),
        ...
        hideChatWindow() {
          return Lt(this, void 0, void 0, function* () {
            yield V.g(new z(M, S, U.HIDE_CHAT_WINDOW)), (this.Zt = !1), (this.Gt = !1);
          });
        }
        fe() {
          return Lt(this, void 0, void 0, function* () {
        ...
        ve(t) {
          ...
          return Lt(this, void 0, void 0, function* () {
            ...
            if (((i.iconMap = f), (i.extensionBaseUrl = chrome.runtime.getURL("")), i.storageData)) {
              const t = yield vt.getValidatedChromeStorageDataAsync();
              i.storageData = t;
            }
        ...
        _e(t) {
          this.ue.initWindowListeners(), this.qt() && this.fe(), this.Wt.pushTask(this.Fe.bind(this)), jt(), (this.Ce = new x(t));
        ...
        checkAddYoutubePromo() {
          return Lt(this, void 0, void 0, function* () {
            "true" !== (yield it.getItemsAsync(["seenYoutubePromo"])).seenYoutubePromo &&
        ...
        Ae() {
          return Lt(this, void 0, void 0, function* () {
            try {
              yield Vt(() => null !== document.querySelector("#chat-history") || this.Xt || (this.Kt && this.Yt), 1e4)();
            } catch (t) {
        ...
        hideReactionHolder() {
          jQuery("#reaction-btn-icon").css({ opacity: "" }),
            ...
            this.Wt.pushTask(() => Q.setItemsAsync({ [n]: !1 }));
        }
        onOpenGifPicker() {
          var t, e;
          return Lt(this, void 0, void 0, function* () {
        ...
        je() {
          ...
          this.Se = this.Se.replace(/{CHAT_URL}/g, `${r}?t=${Date.now()}&id=${encodeURIComponent(t.substring(0, t.length - 1))}`);
          for (const t of a) {
        ...
        Me(t) {
          return new J(M, S, { reactionType: t });
        }
        Pe(t) {
          return new Y(M, S, { gifObject: t });
        }
        $e(t) {
          return new L(M, S, { body: t });
        }
        Ve(t) {
          return new G(M, S, { typing: t });
        }
        Qe(t) {
          return new H(M, S, { userSettings: t });
        }
        Ne(t) {
        ...
        showReaction(e) {
          ...
          const i = e.reactionType,
            n = this.getReactionContainer();
          if (n) {
            const e = Math.floor(40 * Math.random()) + 40,
              s = n[0].offsetWidth - (this.shouldAddReactionSpace() ? t : 0) - e,
              u = Math.floor(Math.random() * s) + (this.shouldAddReactionSpace() ? t : 0),
              o = this.Ne(i),
        ...
        onReactionClicked(t) {
          ...
          V.g(e);
          const i = new K(M, S, { eventType: "reaction-" + t, sessionId: this.getSessionId() });
          V.g(i);
        }
        onChatKeyUp(t) {
          t.stopPropagation();
          ...
          if (isNaN(e)) (e = "trending" === e ? "" : e), this.fetchGIFs(e), (jQuery("#gif-search")[0].value = e);
            ...
            this.ke(this.Pe(i), () => {
              ...
              const e = {
                ...
                i = new K(M, S, e);
              V.g(i);
              const n = new K(M, S, { eventType: "gif-share", sessionId: this.getSessionId() });
              V.g(n);
            }),
              this.toggleGIFs();
          }
        ...
        onScrollToBottom(t) {
          return Lt(this, void 0, void 0, function* () {
            ...
            else if ("0" !== this.Ot && e && this.Vt < 6) {
              (this.Vt += 1), (this.$t = !0), t.preventDefault();
        ...
        onChatKeyPress(t) {
          if ((t.stopPropagation(), "Enter" !== t.key || t.shiftKey))
            void 0 === this.ae ? this.ke(this.Ve(!0)) : clearTimeout(this.ae),
              (this.ae = setTimeout(() => {
                (this.ae = void 0), this.ke(this.Ve(!1));
              }, 500));
          else {
            jQuery("#emoji-picker-container").is(":hidden") || this.toggleEmojiClicker();
            const e = jQuery("#chat-input"),
              i = e[0].textContent;
            if (i && this.Le(i)) {
              void 0 !== this.ae && (clearTimeout(this.ae), (this.ae = void 0), this.ke(this.Ve(!1))),
        ...
        saveChangesListener() {
          ...
          p("saveChanges button clicked: " + e),
            e !== (null === (t = this.Ce) || void 0 === t ? void 0 : t.userNickname) &&
              this.Ce &&
              (this.Ce.saveUserNickname(e),
              this.queueMessageForFrame(dt.UPDATE_SETTINGS, { userSettings: this.Ce.userSettings }),
              this.ke(this.Qe(this.Ce.userSettings)),
        ...
        setChatVisible(t, e = !0) {
          ...
          return Ht(this, void 0, void 0, function* () {
            ...
            t
              ? (jQuery(".webPlayerSDKContainer").addClass(pt),
                jQuery("#chat-wrapper").show(),
                document.hasFocus() || this.clearUnreadCount())
              : (jQuery(".webPlayerSDKContainer").removeClass(pt), jQuery("#chat-wrapper").hide(), jQuery(window).trigger("resize")),
              this.We(t);
          });
        }
        We(t) {
          document.webkitIsFullScreen &&
            (t
              ? (jQuery("video").addClass("videoFullscreenWithChat"), jQuery(".webPlayerSDKUiContainer").addClass(pt))
              : (jQuery("video").removeClass("videoFullscreenWithChat"), jQuery(".webPlayerSDKUiContainer").removeClass(pt)));
        }
      ...
      })([], ["content_scripts/amazon/amazon_content_bundled.js"], "amazon", Yt.AMAZON, !1);
      Object.freeze(Zt);
      const te = Zt;
      var ee = i(1227),
        ie = i.n(ee);
      class ne {
        ...
        debug(t) {
          ...
          t.message && ie()(e)(t.message), t.object && ie()(e)(t.object);
        }
      }
      ...
      class ue extends class {
        ...
        logError(t, e) {
          ...
          const i = new K(M, S, { name: "video_error", action: { description: t, reason: e } });
          V.g(i);
        }
        doAdCheck() {
        ...
        constructor() {
          super(),
            (this.Ye = !1),
            (this.Xe = new ne("ext:ContentScripts:Amazon:AmazonVideoApi")),
            (this.qe = 6e4),
            (this.Ke = 0),
            (this.Ze = 0),
            (this.ti = []),
        ...
        getVideoType() {
          ...
          return t && t.length ? Jt.episode : Jt.movie;
        }
          ...
          return se(this, void 0, void 0, function* () {
            try {
              ...
              return (
                ...
                yield Vt(() => null != this.Ze && this.Ze > e, 4e3)(),
        ...
        oi() {
          ...
          return se(this, void 0, void 0, function* () {
            try {
              ...
              return (
                yield Vt(this.isVideoReady.bind(this), 5e3)(),
                (i.muted = !0),
                i.paused
                  ? (yield this.play(), yield $t(250)(), yield this.pause())
                  : (yield this.pause(), yield $t(250)(), yield this.play()),
                (i.muted = !1),
              ...
              return (
                ...
                null !== (e = te.getVideoId(new URL(window.location.href))) && void 0 !== e ? e : ""
              );
            }
          });
        }
        ...
        waitVideoApiReadyAsync() {
          return se(this, void 0, void 0, function* () {
            ...
            yield Vt(this.isVideoReady.bind(this), 1 / 0)(),
        ...
        waitVideoDoneLoadingAsync() {
          return se(this, void 0, void 0, function* () {
            yield Vt(() => this.ai() !== Wt.LOADING, 1e4)();
          });
        }
        getStateAsync() {
          return new Promise((t, e) => {
        ...
        freeze(t) {
          return se(this, void 0, void 0, function* () {
            this.Ke += 1;
            try {
              yield this.pause(), yield $t(t)(), yield this.play();
            } finally {
              this.Ke -= 1;
            }
          });
        ...
        pause() {
          return se(this, void 0, void 0, function* () {
            ...
            try {
              ...
              t.pause(), yield $t(250)(), yield Vt(() => this.ai() === Wt.PAUSED, 1250)();
            } finally {
              this.Ke -= 1;
            }
          });
        ...
        play() {
          return se(this, void 0, void 0, function* () {
            ...
            try {
              const t = this.getVideoElement();
              if (null === t) throw new Error(B);
              yield t.play(), yield Vt(() => this.ai() === Wt.PLAYING, 1250)();
            } finally {
              this.Ke -= 1;
            }
          });
          ...
          return se(this, void 0, void 0, function* () {
            ...
            try {
              ...
              this.gi(e),
                ...
                yield $t(500)(),
                yield Vt(() => this.ai() !== Wt.LOADING, 1 / 0)();
            } finally {
              this.Ke -= 1;
            }
          });
        ...
        ai() {
          const t = this.getVideoElement();
          let e;
          return (e = t && "" !== t.src ? (t.readyState < 4 ? Wt.LOADING : t.paused ? Wt.PAUSED : Wt.PLAYING) : Wt.NOT_READY), e;
        }
        yi() {
          const t = this.getVideoElement();
          if (t) {
            ...
            Vt(this.mi.bind(this), 5e3)().then(() =>
              se(this, void 0, void 0, function* () {
                ...
                try {
                  ...
                  s.paused ? (yield s.play(), yield $t(250)(), s.pause()) : (s.pause(), yield $t(250)(), yield s.play()),
                    null == this.videoId && this.si
                      ...
                      : (this.Xe.debug({ methodName: "_getVideoIdAsync", message: "Waiting for video Id" }),
                        yield this.updateVideoId(),
                        yield Vt(() => null != this.Ze && this.Ze > n, 4e3)(),
        ...
        mi() {
          const t = this.ai();
          return t === Wt.PAUSED || t === Wt.PLAYING;
        }
        getUpdateSessionDataAsync() {
          return se(this, void 0, void 0, function* () {
            ...
            const i = Date.now();
            return {
              state: t.playbackState === Wt.PLAYING ? Kt.PLAYING : Kt.PAUSED,
              lastKnownTime: e,
              lastKnownTimeUpdatedAt: i,
              bufferingState: this.ai() == Wt.LOADING
            };
          });
        }
      }
      var oe = function (t, e, i, n) {
        return new (i || (i = Promise))(function (s, u) {
          function o(t) {
            try {
              a(n.next(t));
      ...
      class De extends class {
        ...
        constructor(t, e) {
          ...
          super(t),
            ...
            (this.Xe = new ne("ext:ContentScripts:Amazon:AmazonVideoEventListener")),
            (this.Vi = () => {
              var t;
                    ...
                    .catch((t) => {
                      ...
                      this.Xe.debug({ methodName: "onVideoLoadStart", message: t }),
                        ...
                        this.fi.videoId !== (null === (e = this.Te) || void 0 === e ? void 0 : e.videoId) &&
                          ((null === (i = this.Te) || void 0 === i ? void 0 : i.changingVideo) ? this.Qi(Qt) : this.Qi(kt));
                    }))
                : this.Qi(Bt);
            }),
            (this.fi = t),
            ...
            (this.Ni = this.V.onVideoResize.bind(this.V)),
        ...
        Gi() {
          if (!this.fi.isPlayerPage()) return this.Qi(Bt), void this.stopListening();
        }
        onSeeking() {
        ...
        reloadListeners() {
          ...
          t &&
            ...
            t.addEventListener("loadstart", this.Vi));
        }
        startListening() {
          ...
          this.Ui.disconnect(),
            ...
            window.addEventListener("resize", this.Ni),
            window.document.addEventListener("webkitfullscreenchange", this.Ni),
            window.document.addEventListener("MSFullScreenChange", this.Ni),
            jQuery(".atvwebplayersdk-fullscreen-button").on("click", this.Ni),
        ...
        stopListening() {
          ...
          t &&
            ...
            t.removeEventListener("loadstart", this.Vi)),
            this.Ui.disconnect(),
            window.removeEventListener("resize", this.Ni),
            window.document.removeEventListener("webkitfullscreenchange", this.Ni),
            window.document.removeEventListener("MSFullScreenChange", this.Ni),
            window.removeEventListener("message", this.Ri, !1),
            window.removeEventListener("message", this.Pi, !1);
        }
        $i(t) {
          t.source == window && (("FROM_PAGE_POP" !== t.data.type && this.fi.isPlayerPage()) || this.Qi(Bt));
        }
        loadNewVideoAsync(t) {
          return ce(this, void 0, void 0, function* () {
            yield this.fi.skipPromo(),
              ...
              yield Vt(this.fi.isVideoReady.bind(this.fi), 1 / 0)(),
              yield Vt(this.fi.isTimeTextLoaded.bind(this.fi), 1 / 0)();
          });
        }
      }
      !(function (t) {
      ...
      class he extends R {
        constructor(t, e, i) {
          super(t, e, O.GET_SESSION_DATA), (this.data = i);
        }
      }
      class de {
        constructor() {
        ...
        Wi() {
          V.addListener(this.Li);
        }
        teardown() {
          (this.zi = []), V.removeListener(this.Li);
        }
        Hi(t, e, i) {
      ...
      class ge {
        constructor(t, e) {
          (this.V = t), (this.ne = e), p("Chat forwarder");
        }
        onMessage(t, e, i) {
          var n;
          switch (t.type) {
            ...
            case ae.ON_WATCHING_ADS: {
              const e = t;
              return this.Zi(e), !1;
            }
            case ae.UPDATE_SETTINGS: {
              const e = t;
              return this.tn(e), !1;
            }
            case ae.ON_REACTION: {
            ...
            case ae.ON_WEB_RTC:
              return this.V.onWebRTC(t.data), !0;
            case re.SET_CHAT_VISIBLE: {
              const e = t;
            ...
            case dt.SIDEBAR_MESSAGING_READY: {
              ...
              return console.log(t), this.V.setChatFrameReady(null != t ? t : 0), i(), !0;
            }
            ...
            case dt.ON_UPDATE_SETTINGS: {
              const e = t.data;
              return this.V.doUpdateSettings(e), i(), !0;
            }
            ...
            case dt.SET_REACTIONS_ACTIVE: {
              const e = t.data;
              return this.V.setReactionsActive(e), i(), !0;
            }
            case dt.RESET_VIEW:
              return this.V.resetChatWindow(!0), i(), !0;
            case dt.ON_FOCUS:
              return this.V.onSidebarFocus(), i(), !0;
            case dt.PREVIEW_REACTION: {
              const e = t.data;
              return this.V.showReaction(e), i(), !0;
            }
        ...
        un(t) {
          return pe(this, void 0, void 0, function* () {
            this.V.isPartyWindowsActive()
              ? t.visible
                ? yield this.V.resetChatWindow()
                : yield this.V.hideChatWindow()
              : (yield this.V.setChatVisible(t.visible), this.V.fixPageControls());
          });
        }
        Yi(t) {
          const e = t.sessionCallbackData.sessionId,
            i = `${o}/join/${e}`;
          if (
            (this.V.loadInitData(t),
            this.V.setPartyUrl(i),
            this.V.setSessionId(e),
            this.V._e(t.storageData),
            this.ne.onInitChat(),
            this.V.setSessionCreated(t.isCreate),
            this.V.sendInitDataToSidebar(t),
            t.sessionCallbackData.userList && this.V.loadUserList(t.sessionCallbackData.userList),
            t.showReviewMessage && this.V.addReviewMessage(),
            !t.isCreate)
          )
            for (const e of t.sessionCallbackData.messages) "gifObject" in e ? this.V.addGif(e) : this.V.addMessage(e, !0);
        }
        T(t) {
          this.V.addMessage(t.data);
        }
        en(t) {
          this.V.showReaction(t.data);
        }
        nn(t) {
          this.V.addGif(t.data);
        }
        Xi(t) {
          this.V.onBufferingMessage(t.data);
        }
        qi(t) {
          this.V.onTypingMessage(t.data);
        }
        Zi(t) {
          this.V.onWatchingAdsMessage(t.data);
        }
        tn(t) {
          this.V.onUpdateSettingsMessage(t.data);
        }
        sn(t) {
          this.V.loadUserList(t.data.userList), this.V.setSocketConnectionId(t.data.socketConnectionId);
        }
      }
      !(function (t) {
      ...
      class Fe extends R {
        constructor(t, e, i) {
          super(t, e, O.BROADCAST), (this.data = i);
        }
      }
      class ve extends N {
        constructor(t, e, i) {
      ...
      class ye extends ve {
        constructor(t, e) {
          super(t, e, le.GET_SERVER_TIME);
        }
      }
      class me extends R {
        constructor(t, e, i) {
          super(t, e, O.BROADCAST_NEXT_EPISODE), (this.data = i);
        }
      }
      class fe extends R {
        constructor(t, e, i) {
          super(t, e, O.SET_BUFFERING), (this.data = i);
        }
      }
      class Ce extends R {
        constructor(t, e, i) {
          super(t, e, O.SET_WATCHING_ADS), (this.data = i);
        }
      }
      const we = "PING",
        Ee = "SYNC",
      ...
      class _e extends z {
        constructor(t, e, i) {
          super(t, e, U.STAY_ALIVE), (this.data = i);
        }
      }
      ...
      const Be = new (class {
        getRedirectDataForTabAsync(t) {
          return je(this, void 0, void 0, function* () {
            const e = (yield it.getItemsAsync([h])).redirectDataMap,
              i = this.on(t);
            if (e && e[i]) {
              const t = e[i];
        ...
        deleteRedirectDataForTabAsync(t) {
          return je(this, void 0, void 0, function* () {
            const e = (yield it.getItemsAsync([h])).redirectDataMap,
              i = this.on(t);
            e && e[i] && delete e[i], yield Q.setItemsAsync({ [h]: e });
          });
        }
        on(t) {
          return t;
        ...
        storeRedirectDataForTabAsync(t, e) {
          return je(this, void 0, void 0, function* () {
            ...
            const i = this.on(e);
            let n = yield it.getItemsAsync([h]);
            (n[i] = t), (n = this.an(n)), yield Q.setItemsAsync({ [h]: n });
          });
        }
        an(t) {
          return (function (t, e) {
      ...
      class Qe {
          ...
          (this.cn = []),
            ...
            (this.bn = () =>
              ke(this, void 0, void 0, function* () {
                ...
                this._n == Kt.PAUSED ? yield this.kn(t) : this._n == Kt.PLAYING && (yield this.Qn(t)), !1 === this.pn && (this.pn = !0);
              })),
            (this.fi = t),
            (this.V = e),
            (this.ni = i),
        ...
        onMessage(t, e, i) {
          switch (t.type) {
            case U.GET_VIDEO_DATA:
              return this.Pn(i), !0;
            case U.LOAD_SESSION: {
              const e = t;
              return this.$n(e.data), !1;
            }
            case le.UPDATE_SESSION: {
              const e = t;
              return this.Vn(e.data), !1;
            }
            case le.NEXT_EPISODE: {
              const e = t;
              return this.Nn(e.data), !1;
            }
            case le.REBOOT_SESSION: {
              const e = t;
              return this.Rn(e.data, i), !0;
            }
            case le.RELOAD_PARTY:
        ...
        Zi(t) {
          t.data.anyoneWatchingAds && !this.St && (Z.pushTask(this.fi.doAdCheck.bind(this.fi)), this.forceSync()),
        ...
        Rn(t, e) {
          Z.resetTasks(), this.ii == t.videoId && this.Vn(t), e(this.ii == t.videoId);
          const i = new K(M, S, { eventType: "reboot", sessionId: this.Rt });
          V.g(i);
        }
        tryBroadcast(t = !1) {
          this.ln ||
            (this.Je
              ? this.forceSync()
              : 0 != this.fi.uiEventsHappening || this.yn || !this.Rt || Z.hasTaskInQueue(be) || Z.pushTask(() => this.vn(t), be));
        }
        setBuffering(t) {
          if (this.Rt) {
            const e = new fe(M, S, { buffering: t });
            V.g(e);
          }
        }
        isWatchingAds() {
        ...
        setWatchingAds(t, e) {
          if (this.Rt) {
            this.ln = t;
            const i = new Ce(M, S, { watchingAds: t, adDurationLeft: e });
            V.g(i);
          }
        }
        sendNextEpisodeAsync(t) {
          return ke(this, void 0, void 0, function* () {
            if (this.Rt && t !== this.ii && t !== this.Un) {
              (this.Un = t), (this.yn = !0);
              const e = new me(M, S, { nextEpisode: t }),
                i = yield V.g(e);
        ...
        Cn(t, e) {
          return ke(this, void 0, void 0, function* () {
            ...
            if (e && t.state === Kt.PAUSED && t.lastKnownTime < yt) return !1;
            const i = Math.abs(t.lastKnownTime - this.Ln());
            if (t.state == this._n && i < yt) return !1;
            if (i >= yt) {
              const t = new K(M, S, { name: "video_seek", action: { source: "self" } });
              V.g(t), this.Mn == Yt.AMAZON || this.Mn == Yt.PARAMOUNT ? yield $t(200)() : this.Mn == Yt.HBO_MAX && (yield $t(500)());
            }
            return !0;
          });
        }
        ...
        forceSync() {
          Z.pushTask(this.bn, Ee);
        }
        Nn(t) {
          return ke(this, void 0, void 0, function* () {
            (this.In = Date.now()), Z.pushTask(() => this.Hn(t));
          });
        }
        Hn(t) {
          return ke(this, void 0, void 0, function* () {
            try {
              p("Continue next episode called"),
                (this.yn = !0),
                yield this.fi.jumpToNextEpisode(t),
                yield this.ni.loadNewVideoAsync(t.videoId),
                ...
                this.Tn < this.In &&
                  ...
                  Z.pushTask(() => this.vn(!0, !0), be),
                  Z.removeTask(Ee)),
                (this.ii = t.videoId),
                (this.yn = !1);
              const e = new K(M, S, { name: "video_start", action: { description: "video session has begun" } });
              V.g(e);
            } catch (t) {
        ...
        persistExtension(t) {
          ...
          return ke(this, void 0, void 0, function* () {
            ...
            const n = null !== (i = null === (e = window.teleparty) || void 0 === e ? void 0 : e.tabId) && void 0 !== i ? i : 0,
              s = new _e(M, S, { tabId: n, persist: t });
            V.g(s);
            const u = yield this.zn();
            (u.date = Date.now()), Ae.storeRedirectDataForTabAsync(u, n);
          });
        }
        reloadPartyAsync() {
          var t, e;
          return ke(this, void 0, void 0, function* () {
            try {
              ...
              const n = yield this.Wn(i),
                ...
                u = new _e(M, S, { tabId: s, persist: !1 });
              yield V.g(u), yield Ae.storeRedirectDataForTabAsync(i, s), console.log("Redirect URL is", n), (window.location.href = n);
            } catch (t) {
              console.log("Error reloading party", t), this.de("Failed to fix next episode.");
              const e = new W(M, S, { showAlert: !0, alertModal: Et });
              V.g(e);
            }
          });
        }
        ...
        Vn(t) {
          (this.Tn = Date.now()), Z.pushTask(this.Kn(t).bind(this));
        }
        Kn(t) {
          if (t.state === Kt.PAUSED && this._n === Kt.PLAYING) {
            this.Bn();
            const t = new K(M, S, {
              name: "video_pause",
            ...
            V.g(t);
          } else if (t.state === Kt.PLAYING && this._n === Kt.PAUSED) {
            const t = new K(M, S, {
              name: "video_resume",
              action: { description: "video was played from pause", reason: "Video was played" }
            });
          ...
          return ke(this, void 0, void 0, function* () {
            try {
              ...
              (e.is_player_fullscreen = null != document.fullscreenElement || document.webkitIsFullScreen),
                (e.is_chat_visible = this.V.getChatVisible()),
        ...
        wn(t) {
          return ke(this, void 0, void 0, function* () {
            ...
            if (t.data.bufferingState) {
              (t.data.state = Kt.PAUSED), yield V.g(t, 1e3), yield this.fi.waitVideoDoneLoadingAsync();
              const i = yield this.mn();
              (i.data.bufferingState = !0), e == Kt.PLAYING && (i.data.state = Kt.PLAYING), yield V.g(i, 1e3);
            } else yield V.g(t, 1e3);
          });
        }
        $n(t) {
          return ke(this, void 0, void 0, function* () {
            ...
            (this.Rt = e.sessionId),
              ...
              t.isCreate ? ((this.pn = !0), Z.pushTask(this.vn.bind(this), be)) : this.forceSync();
            const i = new K(M, S, { name: "video_start", action: { description: "video session has begun" } });
            V.g(i), this.ni.startListening(), this.Jn();
          });
        }
        Yn() {
              ...
              .then((t) => {
                ...
                if (t) {
                  ...
                  n &&
                    (Nt(this.cn, e - i, 5),
                    (this.Dn = Ot(this.cn)),
                    Nt(this.dn, e - Math.round(this.Dn / 2) - n, 5),
                    (this.hn = Ot(this.dn)));
                }
              })
              .catch((t) => {
        ...
        Bn() {
          const t = new K(M, S, { name: "video_heartbeat", action: { description: "new heartbeat", reason: "Heartbeat session was due" } });
          V.g(t);
        }
        Jn() {
          this.On && clearInterval(this.On),
            this.jn && clearInterval(this.jn),
            (this.On = setInterval(() => {
              Z.hasTaskInQueue(Ee) || Z.pushTask(this.bn, Ee);
            }, 5e3)),
            (this.jn = setInterval(() => {
              this.Bn();
            }, 6e4)),
            (this.Xn = setInterval(() => {
              Z.hasTaskInQueue(we) || Z.pushTask(this.Yn.bind(this), we);
            }, 12500)),
            this.Yn();
        }
        An() {
        ...
        kn(t) {
          return ke(this, void 0, void 0, function* () {
            ...
            if ((e !== Wt.PAUSED && (yield this.fi.pause()), Math.abs(this.xn - i) > 2500)) {
              yield this.fi.setCurrentTime(this.xn);
              const t = new K(M, S, { name: "video_seek", action: { source: "another user" } });
              V.g(t);
            }
          });
        }
        Qn(t) {
          return ke(this, void 0, void 0, function* () {
            const { playbackState: e, playbackPositionMilliseconds: i } = t,
              n = this.Ln();
            if ((e == Wt.PAUSED && (yield this.fi.play()), Math.abs(n - i) > 2500)) {
        ...
        qn() {
          return this._n === Kt.PLAYING ? Date.now() - (this.Sn + this.hn) : 0;
        }
        Ln() {
      ...
      class Me extends Te {
        constructor(t, e, i) {
          super(t, e, re.CREATE_SESSION), (this.data = i);
        }
      }
      const Pe = new (class extends qt {
        isValidUrl(t) {
          return (function (t) {
      ...
      })([], ["content_scripts/netflix/netflix_content_bundled.js"], "netflix", Yt.NETFLIX, !1);
      Object.freeze(Pe);
      const $e = Pe;
      const Ve = new (class extends qt {
        isValidUrl(t) {
          return (function (t) {
      ...
      })([], ["content_scripts/hulu/hulu_content_bundled.js"], "hulu", Yt.HULU, !1);
      Object.freeze(Ve);
      const Ne = Ve;
      const Re = new (class extends qt {
        isValidUrl(t) {
          return (function (t) {
      ...
      })([], ["content_scripts/disney/disney_content_bundled.js"], "disney", Yt.DISNEY_PLUS, !1, [
        "browse_scripts/disney/disney_browse_bundled.js"
      ]);
      Object.freeze(Re);
      const Oe = Re;
      const Ue = new (class extends qt {
        isValidUrl(t) {
          return (function (t) {
            return (t.hostname.includes(".hbomax.") && "other" !== Pt(t.pathname)) || t.pathname.includes("urn:hbo:page");
          })(t);
        }
        isBrowsing(t) {
        ...
        getVideoType(t) {
          return Pt(t.pathname);
        }
      })([], ["content_scripts/hbo_max/hbo_max_content_bundled.js"], "hbomax", Yt.HBO_MAX, !1);
      Object.freeze(Ue);
      const Ge = Ue;
      const Le = new (class extends qt {
        isBrowsing(t) {
      ...
      })([], ["content_scripts/crunchyroll/crunchyroll_content_bundled.js"], "crunchyroll", Yt.CRUNCHYROLL, !1);
      Object.freeze(Le);
      const He = Le;
      const ze = new (class extends qt {
        isBrowsing(t) {
      ...
      })([], ["content_scripts/youtube/youtube_content_bundled.js"], "youtube", Yt.YOUTUBE, !1);
      Object.freeze(ze);
      const We = ze;
      const Ke = new (class extends qt {
        isBrowsing(t) {
      ...
      })([], ["content_scripts/espn/espn_content_bundled.js"], "espn", Yt.ESPN, !1);
      Object.freeze(Ke);
      const Je = Ke;
      const Ye = new (class extends qt {
        isBrowsing(t) {
      ...
      })([], ["content_scripts/paramount/paramount_content_bundled.js"], "paramount", Yt.PARAMOUNT, !1);
      Object.freeze(Ye);
      const Xe = Ye;
      const qe = new (class extends qt {
        isValidUrl(t) {
          return (function (t) {
      ...
      })([], ["content_scripts/hotstar/hotstar_content_bundled.js"], "hotstar", Yt.HOTSTAR, !1);
      Object.freeze(qe);
      const Ze = qe;
      const ti = new (class extends qt {
        isBrowsing(t) {
      ...
      })([], ["content_scripts/peacock/peacock_content_bundled.js"], "peacock", Yt.PEACOCK, !1);
      Object.freeze(ti);
      const ei = ti;
      const ii = new (class extends qt {
        isBrowsing(t) {
      ...
      })([], ["content_scripts/funimation/funimation_content_bundled.js"], "funimation", Yt.FUNIMATION, !1);
      Object.freeze(ii);
      const ni = ii;
      const si = new (class extends qt {
        isValidUrl(t) {
          return (function (t) {
      ...
      })([], ["content_scripts/max/max_content_bundled.js"], "max", Yt.MAX, !1);
      Object.freeze(si);
      const ui = si;
      const oi = new (class extends qt {
        isValidUrl(t) {
          return (function (t) {
      ...
      })([], ["content_scripts/starplus/starplus_content_bundled.js"], "starplus", Yt.STAR_PLUS, !1);
      Object.freeze(oi);
      const ri = oi;
      const ai = new (class extends qt {
        isBrowsing(t) {
          return (
      ...
      })([], ["content_scripts/plutotv/plutotv_content_bundled.js"], "plutotv", Yt.PLUTO_TV, !1);
      Object.freeze(ai);
      const ci = ai;
      const Di = new (class extends qt {
        isValidUrl(t) {
          return (function (t) {
      ...
      })([], ["content_scripts/appletv/appletv_content_bundled.js"], "appletv", Yt.APPLE_TV, !1);
      Object.freeze(Di);
      const hi = Di;
      const di = new (class extends qt {
        isValidUrl(t) {
      ...
      })([], ["content_scripts/jio_cinema/jio_cinema_content_bundled.js"], "jiocinema", Yt.JIO_CINEMA, !1);
      Object.freeze(di);
      const li = di;
      const pi = new (class extends qt {
        isBrowsing(t) {
      ...
      })([], ["content_scripts/tubitv/tubitv_content_bundled.js"], "tubitv", Yt.TUBI_TV, !1);
      Object.freeze(pi);
      const gi = pi;
      const Fi = new (class extends qt {
        isValidUrl(t) {
          return (function (t) {
      ...
      })([], ["content_scripts/crave/crave_content_bundled.js"], "crave", Yt.CRAVE, !1);
      Object.freeze(Fi);
      const vi = Fi;
      const yi = new (class extends qt {
        isValidUrl(t) {
          return (function (t) {
      ...
      })([], ["content_scripts/mubi/mubi_content_bundled.js"], "mubi", Yt.MUBI, !1);
      Object.freeze(yi);
      const mi = yi;
      const fi = new (class extends qt {
        isValidUrl(t) {
      ...
      })([], ["content_scripts/stan/stan_content_bundled.js"], "stan", Yt.STAN, !1);
      Object.freeze(fi);
      const Ci = fi;
      const wi = new (class extends qt {
        isValidUrl(t) {
          return (function (t) {
      ...
      })([], ["content_scripts/sling/sling_content_bundled.js"], "slingtv", Yt.SLING, !1);
      Object.freeze(wi);
      const Ei = wi;
      const bi = new (class extends qt {
        isValidUrl(t) {
          return (function (t) {
      ...
      })([], ["content_scripts/disneymena/disneymena_content_bundled.js"], "disneymena", Yt.DISNEY_PLUS_MENA, !1);
      Object.freeze(bi);
      const _i = bi;
      class ji {
        constructor(t, e) {
          ...
          const i = [hi],
            n = [$e, Ne, Oe, Ge, te, We, He, Je, Xe, Ze, ei, ri, ui, ni, hi, ci, li, gi, mi, Ci, vi, Ei, _i];
          for (const e of n) {
      ...
      class Bi extends Te {
        constructor(t, e, i) {
          super(t, e, re.RE_INJECT), (this.data = i);
        }
      }
      ...
      class Qi extends class {
        ...
        vs() {
          ...
          return Ai(this, void 0, void 0, function* () {
            ...
            if ((this.ys(), (this.ts = !0), !(null === (t = window.teleparty) || void 0 === t ? void 0 : t.contentScriptInjected))) {
              ...
              const t = new Bi(P, S, { extensionTabData: this.Ds });
              try {
                yield V.g(t);
              } catch (t) {
        ...
        de(t) {
          const e = new K(T, S, { name: "error", action: { description: "an error has occured", reason: t } });
          V.g(e);
        }
        Cs(t) {
        ...
        ws() {
          return new Me(P, S, this.Is());
        }
        Is() {
          return { createSettings: { controlLock: this.es }, streamingService: this.Ds.streamingService, tabId: this.Ds.id, source: "pc" };
        }
        ys() {
        ...
        constructor() {
          super(...arguments), (this.Xe = new ne("ext:ContentScripts:Amazon:AmazonPageControls"));
        }
        getControlsRoot() {
          return ki(this, void 0, void 0, function* () {
            return (
              yield Vt(this.xs, 1 / 0)(),
      ...
      class Ii extends class {
        constructor(t, e, i, n) {
          (this.V = t),
            ...
            window.teleparty && !window.teleparty.pageControls
              ...
              : (n.setChatApi(this.V), console.log("Resetting Chat Api for old controls")),
            (this.Ss = new ge(this.V, this.ne)),
            (this.Te = new Qe(this.fi, this.V, this.ni)),
            (this.Ts = !1),
            (this.Ms = !1),
            (this.De = !1),
            (this.Li = new de()),
        ...
        $s() {
          ...
          t.onDisconnect.addListener(() => {
            ...
            const t = { showAlert: this.V.inSession, alertModal: bt };
            this.Ns(t);
          }),
            t.onMessage.addListener(() => {
              p("Got background script"), (this.Ps = !0);
            });
        }
        onMessage(t, e, i) {
          if (t.target == M) {
            if (t.type === re.IS_CONTENT_SCRIPT_READY) {
              if (this.Ts) {
                i({ ready: !0 });
              } else (this.Ms = !0), this.Rs().then(i);
              return !0;
            }
            if (t.type === re.GET_INIT_DATA) {
              return i(this.Os()), !0;
            }
            if (t.type === re.DISCONNECT && t.sender == T) {
              const t = new W(M, S, Bt);
              V.g(t), i();
            } else {
              if (t.type == U.TEARDOWN) {
                const e = t;
                return this.Ns(e.data), i(), !0;
              }
              t.type === U.ON_NOTIF && this.Us();
            }
          }
          return !1;
        }
        ...
        Ns(t) {
          ...
          if (t.showAlert && t.alertModal) {
            const i = null !== (e = t.buttonUrl) && void 0 !== e ? e : this.V.getPartyUrl();
            _t(t.alertModal, i);
          }
          ...
          const s = {
            ...
            u = new K(M, S, s);
          V.g(u), window.teleparty && (window.teleparty.contentScriptInjected = !1) && (window.teleparty.contentScriptReady = !1);
        }
        de(t) {
          if (t === E) return;
          const e = new K(M, S, { name: "error", action: { reason: t } });
          V.g(e);
        }
        Gs() {
          return Ie(this, void 0, void 0, function* () {
            return Vt(() => this.Ps, 5e3)();
          });
        }
        Rs() {
          return Ie(this, void 0, void 0, function* () {
            try {
              console.log("Waiting for content script ready"), yield this.Gs();
        ...
        Ls() {
          return Ie(this, void 0, void 0, function* () {
            ...
            try {
              ...
              (t = { message: e.message, showButton: !1 }), this.de(e.message);
            }
            return { ready: this.Ts, error: t };
          });
        }
        Os() {
          return {
            inSession: this.V.inSession,
            isChatVisible: this.V.isPartyWindowsActive() ? this.V.getChatWindowVisible() : this.V.getChatVisible(),
            partyUrl: this.V.getPartyUrl(),
            showReviewMessage: !1,
            partyWindowsActive: this.V.isPartyWindowsActive()
          };
        }
        Hs() {
          return Ie(this, void 0, void 0, function* () {
        ...
        constructor() {
          const t = new zt(),
            e = new ue(),
            i = new De(e, t),
            n = new ne("ext:ContentScripts:Amazon:AmazonContentScript");
          let s;
          window.teleparty && window.teleparty.pageControls
      ...
      const xi = new ne("ext:ContentScripts:Amazon:AmazonContent");
      var Si;
