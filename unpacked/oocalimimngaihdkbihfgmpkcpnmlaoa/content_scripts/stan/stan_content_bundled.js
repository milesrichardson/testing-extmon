  ...
  (i.n = (t) => {
    ...
    (() => {
      ...
      class G extends class {
        ...
        B() {
          var t, e;
          const i = (null === (t = document.querySelector(G.TITLE_SELECTOR)) || void 0 === t ? void 0 : t.textContent) || "",
            n = (null === (e = document.querySelector(G.SUBTITLE_SELECTOR)) || void 0 === e ? void 0 : e.textContent) || "";
          let s = {},
            u = 0,
            o = 0,
            r = "";
          if (i && n) {
            ...
            if (2 === t.length) {
              const e = t[0].split(" ");
              (o = Number(e[0].trim().substring(1))),
                (u = Number(e[1].trim().substring(1))),
                (r = t[0].trim()),
                (s = { seasonNum: o, episodeNum: u, title: r });
            }
          }
          return s;
        }
      ...
      (G.TITLE_SELECTOR = ".vjs-metadata--title"), (G.SUBTITLE_SELECTOR = ".vjs-metadata--subtitle");
      var L = i(7206),
        O = i.n(L);
      const V = [
          "Batman.svg",
      ...
      class Ut {
        ...
        ht() {
          jQuery("#tp-heart-button").on("click", () => {
            this.K.onReactionClicked(Ot.HEART);
          }),
            jQuery("#tp-cry-button").on("click", () => {
              this.K.onReactionClicked(Ot.CRY);
            }),
            jQuery("#tp-angry-button").on("click", () => {
              this.K.onReactionClicked(Ot.ANGRY);
            }),
            jQuery("#tp-surprise-button").on("click", () => {
              this.K.onReactionClicked(Ot.SURPRISE);
            }),
            jQuery("#tp-laugh-button").on("click", () => {
              this.K.onReactionClicked(Ot.LAUGH);
            }),
            jQuery("#tp-fire-button").on("click", () => {
              this.K.onReactionClicked(Ot.FIRE);
            });
        }
        J() {
          var t, e;
        ...
        ut() {
          jQuery(window).off("focus", this.L),
      ...
      class Ht {
        constructor(t) {
          (this.Lt = !1), (this.Ot = !1), (this.Vt = !1), (this.K = t);
        }
        setupPresenceIndicator() {
          (this.Lt = !1), (this.Ot = !1), (this.Vt = !1), this.Ut();
        }
        Nt() {
      ...
      class Jt extends class {
        ...
        Pe() {
          this.pe.stopListening(), this.Le && (clearTimeout(this.Le), (this.Zt = !1));
        }
        teardown() {
          (this.le = !1),
            (this.Yt = void 0),
        ...
        getChatVisible() {
          var t;
          return null === (t = this.ei()) || void 0 === t ? void 0 : t.hasClass(jt);
        }
        getVideoTitle() {
          var t, e;
          return Yt(this, void 0, void 0, function* () {
            return (
              ((null === (t = document.querySelector(Jt.TITLE_SELECTOR)) || void 0 === t ? void 0 : t.textContent) || "") +
              ((null === (e = document.querySelector(Jt.SUBTITLE_SELECTOR)) || void 0 === e ? void 0 : e.textContent) || "")
            );
          });
        }
        ...
        setChatVisible(t, e = !0) {
          ...
          return Yt(this, void 0, void 0, function* () {
            ...
            const u = document.querySelectorAll(Jt.CONTROL_ELEMENT_SELECTOR);
            if (t) {
              jQuery("#chat-wrapper").show();
              const t = document.querySelector("#chat-wrapper");
              (null == t ? void 0 : t.style) && (t.style.position = "absolute"), null === (n = this.ei()) || void 0 === n || n.addClass(jt);
            } else jQuery("#chat-wrapper").hide(), null === (s = this.ei()) || void 0 === s || s.removeClass(jt);
            [...u].forEach((e) => this.ii(e, t));
          });
        }
        ei() {
          return jQuery(Jt.VIDEO_ELEMENT_SELECTOR);
        }
        ii(t, e) {
        ...
        removeChat() {
          var t;
          super.removeChat(), null === (t = this.ei()) || void 0 === t || t.removeClass(jt);
        }
      }
      (Jt.VIDEO_ELEMENT_SELECTOR = ".clpp-container"),
        (Jt.CONTROL_ELEMENT_SELECTOR = ".vjs-control-bar"),
        (Jt.TITLE_SELECTOR = ".vjs-metadata--title"),
        (Jt.SUBTITLE_SELECTOR = ".vjs-metadata--subtitle"),
        (function (t) {
      ...
      class Xt {
        ...
        oi() {
          I.addListener(this.ni);
        }
        teardown() {
          (this.ui = []), I.removeListener(this.ni);
        }
        si(t, e, i) {
      ...
      const le = new (class {
        ...
        storeRedirectDataForTabAsync(t, e) {
          return de(this, void 0, void 0, function* () {
            ...
            (n[i] = t), (n = this.fi(n)), yield Z.setItemsAsync({ [B]: n });
          });
        }
        fi(t) {
          return (function (t, e) {
      ...
      class Fe {
        constructor(t, e, i) {
          (this.Ci = []),
            ...
            (this.Mi = () =>
              ge(this, void 0, void 0, function* () {
                if (
                  ...
                  return;
                if ((yield this.Li.waitVideoDoneLoadingAsync(), this.Gi())) return;
                const t = yield this.Li.getStateAsync();
                this.Pi == $.PAUSED ? yield this.Oi(t) : this.Pi == $.PLAYING && (yield this.Vi(t)), !1 === this.ji && (this.ji = !0);
              })),
            (this.Li = t),
            (this.K = e),
            (this.A = i),
            ...
            (this.Hi = 0),
            (this.Wi = 0),
            (this.zi = this.Li.getStreamingServiceName()),
            Q("Video forwarder"),
            this.Ai();
        }
        onMessage(t, e, i) {
        ...
        di(t) {
          t.data.anyoneWatchingAds && !this.Vt && (ht.pushTask(this.Li.doAdCheck.bind(this.Li)), this.forceSync()),
        ...
        Xi(t, e) {
          ht.resetTasks(), this.Zi == t.videoId && this.Ji(t), e(this.Zi == t.videoId);
        ...
        tryBroadcast(t = !1) {
          this.bi ||
            (this.g
              ? this.forceSync()
              : 0 != this.Li.uiEventsHappening || this.Qi || !this.Yt || ht.hasTaskInQueue(ce) || ht.pushTask(() => this.ki(t), ce));
        }
        setBuffering(t) {
          if (this.Yt) {
        ...
        xi(e, i) {
          return ge(this, void 0, void 0, function* () {
            ...
            if (n >= Qt) {
              ...
              I.l(e), this.zi == t.AMAZON || this.zi == t.PARAMOUNT ? yield r(200)() : this.zi == t.HBO_MAX && (yield r(500)());
            }
            return !0;
          });
        }
        ...
        forceSync() {
          ht.pushTask(this.Mi, De);
        }
        qi(t) {
          return ge(this, void 0, void 0, function* () {
            (this.Ui = Date.now()), ht.pushTask(() => this.un(t));
          });
        }
        un(t) {
          return ge(this, void 0, void 0, function* () {
        ...
        Ji(t) {
          (this.Wi = Date.now()), ht.pushTask(this.an(t).bind(this));
        }
        an(t) {
          if (t.state === $.PAUSED && this.Pi === $.PLAYING) {
            this.Ri();
            const t = new l(F, p, {
              name: "video_pause",
            ...
            I.l(t);
          } else if (t.state === $.PLAYING && this.Pi === $.PAUSED) {
            const t = new l(F, p, {
              name: "video_resume",
              action: { description: "video was played from pause", reason: "Video was played" }
            });
          ...
          return (this.Pi = t.state), (this.Ni = t.lastKnownTime), (this.Hi = t.lastKnownTimeUpdatedAt), this.Mi;
        }
        Ki(t) {
          var e;
          return ge(this, void 0, void 0, function* () {
        ...
        Ti(t) {
          return ge(this, void 0, void 0, function* () {
            ...
            if (t.data.bufferingState) {
              (t.data.state = $.PAUSED), yield I.l(t, 1e3), yield this.Li.waitVideoDoneLoadingAsync();
              const i = yield this.Ii();
        ...
        Yi(t) {
          return ge(this, void 0, void 0, function* () {
            ...
            (this.Yt = e.sessionId),
              ...
              t.isCreate ? ((this.ji = !0), ht.pushTask(this.ki.bind(this), ce)) : this.forceSync();
            ...
            I.l(e)
              .then((t) => {
                ...
                if (t) {
                  ...
                  n &&
                    (D(this.Ci, e - i, 5), (this.Ei = c(this.Ci)), D(this._i, e - Math.round(this.Ei / 2) - n, 5), (this.wi = c(this._i)));
                }
              })
              .catch((t) => {
                Q(t), this.Ee(t);
        ...
        Dn() {
          this.tn && clearInterval(this.tn),
            this.$i && clearInterval(this.$i),
            (this.tn = setInterval(() => {
              ht.hasTaskInQueue(De) || ht.pushTask(this.Mi, De);
            }, 5e3)),
            (this.$i = setInterval(() => {
              this.Ri();
            }, 6e4)),
            (this.hn = setInterval(() => {
              ht.hasTaskInQueue(ae) || ht.pushTask(this.cn.bind(this), ae);
            }, 12500)),
            this.cn();
        }
        Gi() {
          return !this.Yt || this.Li.uiEventsHappening > 0 || this.bi || this.Qi || !this.A.shouldSync();
        }
        Oi(t) {
          return ge(this, void 0, void 0, function* () {
            const { playbackState: e, playbackPositionMilliseconds: i } = t;
            if ((e !== x.PAUSED && (yield this.Li.pause()), Math.abs(this.Ni - i) > 2500)) {
              yield this.Li.setCurrentTime(this.Ni);
        ...
        Vi(t) {
          return ge(this, void 0, void 0, function* () {
            const { playbackState: e, playbackPositionMilliseconds: i } = t,
              n = this.sn();
            if ((e == x.PAUSED && (yield this.Li.play()), Math.abs(n - i) > 2500)) {
        ...
        dn() {
          return this.Pi === $.PLAYING ? Date.now() - (this.Hi + this.wi) : 0;
        }
        sn() {
      ...
      class fe extends class {
        ...
        ln() {
          ...
          t.mediaSession.setActionHandler("play", () =>
            ye(this, void 0, void 0, function* () {
              this.gn(), this.Li.play(), console.log("Bluetooth device played the video");
            })
          ),
            t.mediaSession.setActionHandler("pause", () =>
              ye(this, void 0, void 0, function* () {
                this.gn(), this.Li.pause(), console.log("Bluetooth device paused the video");
              })
            );
        }
        pn() {
        ...
        constructor(t, e) {
          ...
          super(t),
            ...
            (null === (n = window.teleparty) || void 0 === n ? void 0 : n.injectScriptLoaded) ||
              ...
              })(chrome.extension.getURL("content_scripts/stan/stan_injected_bundled.js"));
        }
        reloadListeners() {
          const t = this.Li.getVideoElement();
          t && (t.addEventListener("play", this._n), t.addEventListener("seeking", this._n), t.addEventListener("pause", this._n));
        }
        startListening() {
        ...
        stopListening() {
          super.stopListening(), this.Bn && clearInterval(this.Bn);
          const t = this.Li.getVideoElement();
          t && (t.removeEventListener("play", this._n), t.removeEventListener("seeking", this._n), t.removeEventListener("pause", this._n)),
            ...
            yield new Promise((i, n) => {
              const s = setInterval(() => {
                const u = P.getVideoId(new URL(window.location.href)),
                  o = this.Li.getVideoElement();
                if (u === t && (!this.An || this.An !== (null == o ? void 0 : o.src)) && o instanceof Element && o.src)
                  return Q("Loaded new Stan video"), (this.An = o.src), clearInterval(s), void i();
            ...
            if ("FROM_PAGE_POP" !== t.data.type) {
              if (t.data.type && "FROM_PAGE" == t.data.type) {
                if (
                  ...
                  return void this.wn(Gt);
                {
                  const t = P.getVideoId(new URL(window.location.href));
                  if (!t) return Q("No video found. Tearing down"), void this.wn(Gt);
                  t !== (null === (e = this.Ue) || void 0 === e ? void 0 : e.videoId) &&
                    (this.K.setChatVisible(this.K.shouldChatBeVisible()), this.En(t));
                }
              }
            } else this.wn(Gt);
        }
      ...
      class hi {
        constructor(t, e) {
          ...
          const n = [je, Ae, Qe, xe, Se, Re, Pe, Le, Ve, Ne, We, Xe, Je, Ke, ii, ti, si, oi, ci, P, ai];
          for (const e of n) {
      ...
      class Fi extends class {
        ...
        On() {
          this.Qn || ((this.In = !this.In), this.Ln());
        }
        setResetChatButton() {
        ...
        Hn() {
          ...
          return li(this, void 0, void 0, function* () {
            ...
            if ((this.Wn(), (this.Qn = !0), !(null === (t = window.teleparty) || void 0 === t ? void 0 : t.contentScriptInjected))) {
              ...
              const t = new di(v, p, { extensionTabData: this.Rn });
              try {
                yield I.l(t);
              } catch (t) {
                return console.log(t), this.zn(), this.Ee(t), this.Kn(J), void (this.Qn = !1);
              }
            }
            ...
            try {
              const t = yield I.l(e);
              t.error ? (this.Kn(t.error.message), this.Ee(t.error.message)) : ((this.Qn = !1), this.Jn(), this.enablePartyIcons());
            } catch (t) {
              console.log(t), this.Kn(J), this.Ee(t);
            }
            this.zn(), (this.Qn = !1);
          });
        }
            ...
            if (!this.Sn && (this.Mn || this.Gn.inSession)) {
              ...
              try {
                yield this.addTpIcon(),
                  this.Gn.inSession ? this.enablePartyIcons() : this.Un(),
        ...
        Zn() {
          jQuery("#tp-control-lock-button").click(this.On.bind(this)),
        ...
        ei() {
          return jQuery(Fi.VIDEO_ELEMENT_SELECTOR);
        }
        getControlsHeight() {
          return "100px";
        }
      ...
      Fi.VIDEO_ELEMENT_SELECTOR = ".clpp-container";
      class vi extends class {
        constructor(t, e, i, n) {
          (this.K = t),
            ...
            (this.os = new ee(this.K, this.de)),
            (this.Ue = new Fe(this.Li, this.K, this.A)),
            (this.rs = !1),
            (this.Ds = !1),
            (this.fe = !1),
            (this.ni = new Xt()),
            this.ni.addMessageListener(this.Ue),
            this.ni.addMessageListener(this.os),
        ...
        hs() {
          ...
          t.onDisconnect.addListener(() => {
            ...
            t.onMessage.addListener(() => {
              Q("Got background script"), (this.cs = !0);
            });
        }
        onMessage(t, e, i) {
          if (t.target == F) {
        ...
        ls(t) {
          ...
          this.de.teardown(), this.Ue.teardown(), this.os.teardown(), this.ni.teardown();
          const s = {
              name: "error",
              action: {
