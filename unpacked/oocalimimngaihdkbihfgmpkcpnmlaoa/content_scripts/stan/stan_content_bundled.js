  ...
  (i.n = (t) => {
    ...
    (() => {
      ...
      class L extends class {
        ...
        B() {
          var t, e;
          const i = (null === (t = document.querySelector(L.TITLE_SELECTOR)) || void 0 === t ? void 0 : t.textContent) || "",
            n = (null === (e = document.querySelector(L.SUBTITLE_SELECTOR)) || void 0 === e ? void 0 : e.textContent) || "";
          let s = {},
            u = 0,
            o = 0,
            r = "";
      ...
      (L.TITLE_SELECTOR = ".vjs-metadata--title"), (L.SUBTITLE_SELECTOR = ".vjs-metadata--subtitle");
      var O = i(7206),
        V = i.n(O);
      const U = [
          "Batman.svg",
      ...
      class Ht {
        ...
        resetIdleTimer() {
          this.tt && clearTimeout(this.tt), this.X && (Lt(), clearTimeout(this.X)), (this.tt = setTimeout(this.q.bind(this), St));
        }
        et() {
      ...
      class Xt extends class {
        ...
        getChatVisible() {
          var t;
          return null === (t = this.ei()) || void 0 === t ? void 0 : t.hasClass(At);
        }
        getVideoTitle() {
          var t, e;
          return qt(this, void 0, void 0, function* () {
            return (
              ((null === (t = document.querySelector(Xt.TITLE_SELECTOR)) || void 0 === t ? void 0 : t.textContent) || "") +
              ((null === (e = document.querySelector(Xt.SUBTITLE_SELECTOR)) || void 0 === e ? void 0 : e.textContent) || "")
            );
          });
        }
        ...
        setChatVisible(t, e = !0) {
          ...
          return qt(this, void 0, void 0, function* () {
            ...
            const u = document.querySelectorAll(Xt.CONTROL_ELEMENT_SELECTOR);
            if (t) {
              jQuery("#chat-wrapper").show();
              const t = document.querySelector("#chat-wrapper");
              (null == t ? void 0 : t.style) && (t.style.position = "absolute"), null === (n = this.ei()) || void 0 === n || n.addClass(At);
            } else jQuery("#chat-wrapper").hide(), null === (s = this.ei()) || void 0 === s || s.removeClass(At);
            [...u].forEach((e) => this.ii(e, t));
          });
        }
        ei() {
          return jQuery(Xt.VIDEO_ELEMENT_SELECTOR);
        }
        ii(t, e) {
        ...
        removeChat() {
          var t;
          super.removeChat(), null === (t = this.ei()) || void 0 === t || t.removeClass(At);
        }
      }
      (Xt.VIDEO_ELEMENT_SELECTOR = ".clpp-container"),
        (Xt.CONTROL_ELEMENT_SELECTOR = ".vjs-control-bar"),
        (Xt.TITLE_SELECTOR = ".vjs-metadata--title"),
        (Xt.SUBTITLE_SELECTOR = ".vjs-metadata--subtitle"),
        (function (t) {
      ...
      const ge = new (class {
        ...
        storeRedirectDataForTabAsync(t, e) {
          return pe(this, void 0, void 0, function* () {
            ...
            (n[i] = t), (n = this.fi(n)), yield tt.setItemsAsync({ [h]: n });
          });
        }
        fi(t) {
          return (function (t, e) {
      ...
      class ye {
          ...
          (this.Ci = []),
            ...
            (this.Mi = () =>
              ve(this, void 0, void 0, function* () {
                ...
                this.Pi == R.PAUSED ? yield this.Oi(t) : this.Pi == R.PLAYING && (yield this.Vi(t)), !1 === this.ji && (this.ji = !0);
              })),
            (this.Li = t),
            (this.K = e),
            (this.A = i),
        ...
        di(t) {
          t.data.anyoneWatchingAds && !this.Vt && (lt.pushTask(this.Li.doAdCheck.bind(this.Li)), this.forceSync()),
        ...
        Xi(t, e) {
          lt.resetTasks(), this.Zi == t.videoId && this.Ji(t), e(this.Zi == t.videoId);
        ...
        tryBroadcast(t = !1) {
          this.bi ||
            (this.g
              ? this.forceSync()
              : 0 != this.Li.uiEventsHappening || this.Qi || !this.Yt || lt.hasTaskInQueue(de) || lt.pushTask(() => this.ki(t), de));
        }
        setBuffering(t) {
          if (this.Yt) {
        ...
        nn(t) {
          return ve(this, void 0, void 0, function* () {
            try {
              yield f(() => t == this.Zi, 1e4)(), (this.Qi = !1);
            } catch (t) {
        ...
        xi(e, i) {
          return ve(this, void 0, void 0, function* () {
            ...
            if (e.state == this.Pi && n < xt) return !1;
            if (n >= xt) {
              const e = new b(A, j, { name: "video_seek", action: { source: "self" } });
              x.l(e), this.zi == t.AMAZON || this.zi == t.PARAMOUNT ? yield m(200)() : this.zi == t.HBO_MAX && (yield m(500)());
            }
            return !0;
          });
        }
        ...
        forceSync() {
          lt.pushTask(this.Mi, he);
        }
        qi(t) {
          return ve(this, void 0, void 0, function* () {
            (this.Ui = Date.now()), lt.pushTask(() => this.un(t));
          });
        }
        un(t) {
          return ve(this, void 0, void 0, function* () {
        ...
        Ji(t) {
          (this.Wi = Date.now()), lt.pushTask(this.an(t).bind(this));
        }
        an(t) {
          if (t.state === R.PAUSED && this.Pi === R.PLAYING) {
            this.Ri();
            const t = new b(A, j, {
              name: "video_pause",
            ...
            x.l(t);
          } else if (t.state === R.PLAYING && this.Pi === R.PAUSED) {
            const t = new b(A, j, {
              name: "video_resume",
              action: { description: "video was played from pause", reason: "Video was played" }
            });
        ...
        Si(t) {
          return ve(this, void 0, void 0, function* () {
            ...
            if (t.data.bufferingState) {
              (t.data.state = R.PAUSED), yield x.l(t, 1e3), yield this.Li.waitVideoDoneLoadingAsync();
              const i = yield this.Ii();
        ...
        Yi(t) {
          return ve(this, void 0, void 0, function* () {
            ...
            (this.Yt = e.sessionId),
              ...
              t.isCreate ? ((this.ji = !0), lt.pushTask(this.ki.bind(this), de)) : this.forceSync();
            ...
            x
              ...
              .then((t) => {
                ...
                if (t) {
                  ...
                  n &&
                    (C(this.Ci, e - i, 5), (this.Ei = E(this.Ci)), C(this._i, e - Math.round(this.Ei / 2) - n, 5), (this.wi = E(this._i)));
                }
              })
              .catch((t) => {
                Q(t), this.Ee(t);
        ...
        cn() {
          this.tn && clearInterval(this.tn),
            this.$i && clearInterval(this.$i),
            (this.tn = setInterval(() => {
              lt.hasTaskInQueue(he) || lt.pushTask(this.Mi, he);
            }, 5e3)),
            (this.$i = setInterval(() => {
              this.Ri();
            }, 6e4)),
            (this.hn = setInterval(() => {
              lt.hasTaskInQueue(De) || lt.pushTask(this.Dn.bind(this), De);
            }, 12500)),
            this.Dn();
        }
        Gi() {
        ...
        Oi(t) {
          return ve(this, void 0, void 0, function* () {
            ...
            if ((e !== S.PAUSED && (yield this.Li.pause()), Math.abs(this.Ni - i) > 2500)) {
        ...
        Vi(t) {
          return ve(this, void 0, void 0, function* () {
            const { playbackState: e, playbackPositionMilliseconds: i } = t,
              n = this.sn();
            if ((e == S.PAUSED && (yield this.Li.play()), Math.abs(n - i) > 2500)) {
        ...
        dn() {
          return this.Pi === R.PLAYING ? Date.now() - (this.Hi + this.wi) : 0;
        }
        sn() {
            ...
            if ("FROM_PAGE_POP" !== t.data.type) {
              if (t.data.type && "FROM_PAGE" == t.data.type) {
                if (
                  ...
                  return void this.wn(Ot);
                {
                  const t = $.getVideoId(new URL(window.location.href));
                  if (!t) return Q("No video found. Tearing down"), void this.wn(Ot);
      ...
      class vi {
        constructor(t, e) {
          ...
          const i = [si],
            n = [Ae, Qe, xe, Te, Pe, Le, Re, Ve, Ne, We, Ke, ti, Xe, Je, si, ii, oi, ai, di, $, Di, pi, Fi];
          for (const e of n) {
      ...
      class Ei extends class {
        ...
        Hn() {
          ...
          return mi(this, void 0, void 0, function* () {
            ...
            if ((this.Wn(), (this.Qn = !0), !(null === (t = window.teleparty) || void 0 === t ? void 0 : t.contentScriptInjected))) {
              ...
              const t = new yi(k, j, { extensionTabData: this.Rn });
              try {
                yield x.l(t);
              } catch (t) {
                return console.log(t), this.zn(), this.Ee(t), this.Kn(q), void (this.Qn = !1);
              }
            }
            ...
            try {
              ...
              console.log(t), this.Kn(q), this.Ee(t);
            }
            this.zn(), (this.Qn = !1);
          });
        }
        ...
        $n() {
          this.Sn || (this.hideError(), jQuery("#tpIconContainer").addClass("hidden"));
        }
        Pn() {
          return mi(this, void 0, void 0, function* () {
            if (!this.Tn && (this.Mn || this.Gn.inSession)) {
              this.Tn = !0;
              try {
        ...
        ei() {
          return jQuery(Ei.VIDEO_ELEMENT_SELECTOR);
        }
        getControlsHeight() {
          return "100px";
        }
      ...
      Ei.VIDEO_ELEMENT_SELECTOR = ".clpp-container";
      class wi extends class {
        constructor(t, e, i, n) {
          (this.K = t),
            ...
            (this.os = new ne(this.K, this.de)),
            (this.Ue = new ye(this.Li, this.K, this.A)),
            (this.rs = !1),
            (this.cs = !1),
            (this.fe = !1),
            (this.ni = new te()),
        ...
        hs() {
          ...
          t.onDisconnect.addListener(() => {
            ...
            t.onMessage.addListener(() => {
              Q("Got background script"), (this.Ds = !0);
            });
        }
        onMessage(t, e, i) {
          if (t.target == A) {
