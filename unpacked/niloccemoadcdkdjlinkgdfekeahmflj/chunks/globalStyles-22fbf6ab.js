  ...
  if (h)
    return (
      ...
      Array.isArray(d)
        ...
        : null != d &&
          (L(d) && (d = K(d, c + (!d.key || (h && h.key === d.key) ? "" : ("" + d.key).replace(M$1, "$&/") + "/") + a)), b.push(d)),
      1
    );
  h = 0;
  e = "" === e ? "." : e + ":";
...
function qa(a, b, c, d) {
  ...
  var f =
    null !== e ? 0 === e.type : d ? !1 : !(2 < b.length) || ("o" !== b[0] && "O" !== b[0]) || ("n" !== b[1] && "N" !== b[1]) ? !1 : !0;
  f ||
    (na(b, c, e, d) && (c = null),
    d || null === e
...
fa &&
  ...
  "AnimationEvent" in window ||
    (delete Ec.animationend.animation, delete Ec.animationiteration.animation, delete Ec.animationstart.animation),
    ...
    if (0 === (b & 7)) {
        ...
        if (k || h) {
          ...
          if (k) {
            if (
              ...
              (k = d),
              (x = x ? wc(x) : null),
              null !== x && ((z = Zb(x)), x !== z || (5 !== x.tag && 6 !== x.tag)))
            )
              x = null;
          } else (k = null), (x = d);
          if (k !== x) {
      ...
      if ((Q = ce ? je(a, c) : ke(a, c)))
        (d = oe(d, "onBeforeInput")),
          0 < d.length && ((e = new Ld("onBeforeInput", "beforeinput", null, c, e)), g.push({ event: e, listeners: d }), (e.data = Q));
    }
    se(g, b);
  });
}
...
function oe(a, b) {
  for (var c = b + "Capture", d = []; null !== a; ) {
    ...
    5 === e.tag &&
      null !== f &&
      ((e = f), (f = Ob(a, c)), null != f && d.unshift(ef(a, f, e)), (f = Ob(a, b)), null != f && d.push(ef(a, f, e)));
    a = a.return;
  }
  return d;
}
...
function hf(a, b, c, d, e) {
  for (var f = b._reactName, g = []; null !== c && c !== d; ) {
    ...
    5 === h.tag &&
      null !== l &&
      ((h = l), e ? ((k = Ob(c, f)), null != k && g.unshift(ef(c, k, h))) : e || ((k = Ob(c, f)), null != k && g.push(ef(c, k, h))));
    c = c.return;
  }
  ...
  if (null !== f) {
    ...
    do {
      ...
      if ((d & h) === h) {
        ...
        (p = { eventTime: p, lane: h, tag: f.tag, payload: f.payload, callback: f.callback, next: null }),
...
function Mg(a, b, c) {
  ...
  "object" === typeof f && null !== f
    ? (f = vg(f))
    : ((e = Ff(b) ? Df : M.current), (d = b.contextTypes), (f = (d = null !== d && void 0 !== d) ? Ef(a, e) : Cf));
  b = new b(c, f);
...
function Rg(a, b) {
  if ("textarea" !== a.type)
    throw Error(
      y(31, "[object Object]" === Object.prototype.toString.call(b) ? "object with keys {" + Object.keys(b).join(", ") + "}" : b)
    );
}
function Sg(a) {
  function b(b, c) {
        ...
        case sa:
          a: {
            ...
            f.type === ua
              ...
              : ((h = Vg(f.type, f.key, f.props, null, a.mode, h)), (h.ref = Qg(a, d, f)), (h.return = a), (a = h));
          }
          return g(a);
        case ta:
          a: {
...
function Kh(a) {
  ...
  if (null !== e) {
    ...
    do {
      var l = k.lane;
      if ((xh & l) === l)
        null !== h && (h = h.next = { lane: 0, action: k.action, eagerReducer: k.eagerReducer, eagerState: k.eagerState, next: null }),
...
function Nh(a, b, c, d) {
  ...
  (He(C, c) && He(x, b) && He(A, d)) ||
    ((a = { pending: null, dispatch: null, lastRenderedReducer: Jh, lastRenderedState: n }),
...
function mi(a, b, c) {
  ...
  if ("hidden" === d.mode || "unstable-defer-without-hiding" === d.mode)
    if (0 === (b.mode & 4)) (b.memoizedState = { baseLanes: 0 }), ni(b, c);
      ...
      return (
        (a = null !== f ? f.baseLanes | c : c), (b.lanes = b.childLanes = 1073741824), (b.memoizedState = { baseLanes: a }), ni(b, a), null
      );
...
function pi(a, b, c, d, e) {
  ...
  if (null === b.stateNode)
    ...
    (n = "function" === typeof C || "function" === typeof g.getSnapshotBeforeUpdate) ||
      ("function" !== typeof g.UNSAFE_componentWillReceiveProps && "function" !== typeof g.componentWillReceiveProps) ||
      ((h !== A || p !== k) && Ng(b, g, d, k));
    wg = !1;
    p = b.memoizedState;
...
function wi(a, b, c, d, e) {
  ...
  0 === (f & 2) && b.child !== g
    ? ((c = b.child),
      ...
      (c.pendingProps = h),
      (g = c.lastEffect),
      null !== g ? ((b.firstEffect = c.firstEffect), (b.lastEffect = g), (g.nextEffect = null)) : (b.firstEffect = b.lastEffect = null))
    : (c = Tg(g, h));
      ...
      if (!d.hasOwnProperty(l) && e.hasOwnProperty(l) && null != e[l])
        if ("style" === l) {
          ...
          "dangerouslySetInnerHTML" !== l &&
            ...
            "autoFocus" !== l &&
            (ca.hasOwnProperty(l) ? f || (f = []) : (f = f || []).push(l, null));
    for (l in d) {
      var k = d[l];
      h = null != e ? e[l] : void 0;
        ...
        if ("style" === l)
          ...
          "dangerouslySetInnerHTML" === l
            ...
            : "suppressContentEditableWarning" !== l &&
              "suppressHydrationWarning" !== l &&
              (ca.hasOwnProperty(l)
                ? (null != k && "onScroll" === l && G("scroll", a), f || h === k || (f = []))
            ...
            if (h.hasOwnProperty(f)) {
              ...
              "style" === f
                ...
                : "suppressContentEditableWarning" !== f &&
                  ...
                  "autoFocus" !== f &&
                  (ca.hasOwnProperty(f) ? null != k && "onScroll" === f && G("scroll", a) : null != k && qa(a, f, k, g));
            }
          switch (c) {
            case "input":
              Va(a);
    ...
    case 6:
      if (a && null != b.stateNode) Ei(a, b, a.memoizedProps, d);
        ...
        rh(b)
          ...
          : ((d = (9 === c.nodeType ? c : c.ownerDocument).createTextNode(d)), (d[wf] = b), (b.stateNode = d));
      }
      return null;
    case 13:
      H(P);
  ...
  switch (c.tag) {
    ...
    case 1:
      ...
      c.flags & 4 &&
        (null === b
          ? a.componentDidMount()
          : ((d = c.elementType === c.type ? b.memoizedProps : lg(c.type, b.memoizedProps)),
    ...
    case 13:
      null === c.memoizedState &&
        ((c = c.alternate), null !== c && ((c = c.memoizedState), null !== c && ((c = c.dehydrated), null !== c && Cc(c))));
      return;
    case 19:
    case 17:
    case 20:
    ...
    (a = e ? a.stateNode : a.stateNode.instance),
      b
        ...
        : (8 === c.nodeType ? ((b = c.parentNode), b.insertBefore(a, c)) : ((b = c), b.appendChild(a)),
          ...
          (null !== c && void 0 !== c) || null !== b.onclick || (b.onclick = jf));
            ...
            case "select":
              (a = c._wrapperState.wasMultiple),
                ...
                null != f
                  ? fb(c, !!d.multiple, f, !1)
                  : a !== !!d.multiple &&
                    (null != d.defaultValue ? fb(c, !!d.multiple, d.defaultValue, !0) : fb(c, !!d.multiple, d.multiple ? [] : "", !1));
          }
        }
      }
      return;
...
function Jg(a, b, c) {
  ...
  1 === b
    ? 0 !== (X & 8) && 0 === (X & 48)
      ? Lj(a)
      : (Mj(a, c), 0 === X && (wj(), ig()))
    : (0 === (X & 4) || (98 !== d && 99 !== d) || (null === Cj ? (Cj = new Set([a])) : Cj.add(a)), Mj(a, c));
  vj = a;
}
function Kj(a, b) {
  a.lanes |= b;
...
function Mj(a, b) {
  ...
  if (0 === d) null !== c && (c !== Zf && Pf(c), (a.callbackNode = null), (a.callbackPriority = 0));
    ...
    15 === b
      ? ((c = Lj.bind(null, a)), null === ag ? ((ag = [c]), (bg = Of(Uf, jg))) : ag.push(c), (c = Zf))
      : 14 === b
            ...
            case 1:
              ...
              if (
                ...
                ("function" === typeof K.getDerivedStateFromError ||
                  (null !== Q && "function" === typeof Q.componentDidCatch && (null === Ti || !Ti.has(Q))))
              ) {
                p.flags |= 4096;
                b &= -b;
                p.lanes |= b;
          ...
          : ((v = ((q = t.ownerDocument || document) && q.defaultView) || window),
            v.getSelection &&
              ...
              h &&
                ...
                v.removeAllRanges(),
                J > g ? (v.addRange(q), v.extend(f.node, f.offset)) : (q.setEnd(f.node, f.offset), v.addRange(q))))));
      q = [];
    ...
    for (var c = a.return; null !== c; ) {
      if (3 === c.tag) {
        ...
        if (
          ...
          ("function" === typeof d.componentDidCatch && (null === Ti || !Ti.has(d)))
        ) {
          a = Mi(b, a);
          var e = Si(c, a, 1);
          Ag(c, e);
...
function lj(a, b) {
  ...
  0 === b &&
    ...
    0 === (b & 2)
      ...
      : 0 === (b & 4)
      ? (b = 99 === eg() ? 1 : 2)
      : (0 === Gj && (Gj = tj), (b = Yc(62914560 & ~Gj)), 0 === b && (b = 4194304)));
  c = Hg();
  a = Kj(a, b);
    ...
    case 10:
      a: {
        ...
        if (null !== g)
          if (
            ((h = g.value),
            (f = He(h, f) ? 0 : ("function" === typeof d._calculateChangedBits ? d._calculateChangedBits(h, f) : 1073741823) | 0),
            0 === f)
          ) {
...
var FacebookMono = ({ children, ...rest }) =>
  /*#__PURE__*/ React.createElement(
    "svg",
    _extends({}, rest, {
      fill: "currentColor",
