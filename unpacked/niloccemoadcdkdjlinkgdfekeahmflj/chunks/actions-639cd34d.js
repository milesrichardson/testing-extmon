...
var Hub = /** @class */ (function () {
  ...
  Hub.prototype.startSession = function (context) {
    ...
    var session = new Session(
      __assign$1(
        __assign$1(
          __assign$1({ release: release, environment: environment }, scope && { user: scope.getUser() }),
...
function getHubFromActiveDomain(registry) {
  ...
  try {
    var activeDomain =
      (_c =
        (_b = (_a = getMainCarrier().__SENTRY__) === null || _a === void 0 ? void 0 : _a.extensions) === null || _b === void 0
          ? void 0
...
function captureMessage(message, captureContext) {
  ...
  return callOnHub(
    ...
    message,
    level,
    __assign$2({ originalException: message, syntheticException: syntheticException }, context)
  );
}
/**
...
export {
  setSettings as $,
  dropUndefinedKeys as A,
  setDefaultIcon as B,
  OPEN_POCKET as C,
  COLOR_MODE_CHANGE as D,
  SEND_TAG_ERROR as E,
  REMOVE_ITEM as F,
  AUTH_CODE_RECEIVED as G,
  addExceptionMechanism as H,
  isDOMError as I,
  isDOMException as J,
  addExceptionTypeValue as K,
  LOGGED_OUT_OF_POCKET as L,
  isError as M,
  isEvent as N,
  OPEN_OPTIONS as O,
  SAVE_TO_POCKET_REQUEST as P,
  SAVE_TO_POCKET_SUCCESS as Q,
  RESAVE_ITEM as R,
  SessionStatus as S,
  TAGS_SYNC as T,
  USER_LOG_IN as U,
  SAVE_TO_POCKET_FAILURE as V,
  REMOVE_ITEM_REQUEST as W,
  setToolbarIcon as X,
  TAG_SYNC_REQUEST as Y,
  UPDATE_TAG_ERROR as Z,
  __extends as _,
  getGlobalObject as a,
  withScope as a0,
  Hub as a1,
  isNodeEnv as a2,
  fill as a3,
  extractExceptionKeysForMessage as a4,
  normalizeToSize as a5,
  getFunctionName as a6,
  UPDATE_ITEM_PREVIEW as a7,
  UPDATE_STORED_TAGS as a8,
  SUGGESTED_TAGS_SUCCESS as a9,
  REMOVE_ITEM_SUCCESS as aa,
  REMOVE_ITEM_FAILURE as ab,
  TAG_SYNC_SUCCESS as ac,
  TAG_SYNC_FAILURE as ad,
  getMainCarrier as ae,
  loadModule as af,
  __read as ag,
  __values as ah,
  __assign as ai,
  urlEncode as aj,
  captureMessage as ak,
  dynamicRequire as al,
  captureException as am,
  sendMessage as an,
  openTabWithUrl as ao,
  SyncPromise as b,
  checkOrSetAlreadyCaught as c,
  dateTimestampInSeconds as d,
  Scope as e,
  isThenable as f,
  getSetting as g,
  isPlainObject as h,
  isPrimitive as i,
  addGlobalEventProcessor as j,
  getEventDescription as k,
  logger as l,
  isMatchingPattern as m,
  normalize as n,
  isErrorEvent as o,
  parseRetryAfterHeader as p,
  isString as q,
