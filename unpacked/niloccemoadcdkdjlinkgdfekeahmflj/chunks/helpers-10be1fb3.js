...
function displayPublisher(item) {
  ...
  const urlToUse =
    (item === null || item === void 0 ? void 0 : item.given_url) || (item === null || item === void 0 ? void 0 : item.resolved_url);
  const derivedDomain = domainForUrl(urlToUse);
  return (
    (item === null || item === void 0
      ? void 0
      : (_item$domain_metadata = item.domain_metadata) === null || _item$domain_metadata === void 0
      ? void 0
...
function displayThumbnail(item) {
  ...
  return (
    ...
    (item === null || item === void 0
      ...
      ? void 0
      : (_item$images$Object$k = _item$images[Object.keys(item.images)[0]]) === null || _item$images$Object$k === void 0
      ? void 0
