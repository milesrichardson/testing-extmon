import {
  _ as __extends$2,
  a as getGlobalObject,
  c as checkOrSetAlreadyCaught,
  l as logger,
  i as isPrimitive,
  S as SessionStatus,
  b as SyncPromise,
  u as uuid4,
  d as dateTimestampInSeconds,
  e as Scope,
  n as normalize,
  t as truncate,
  f as isThenable,
  h as isPlainObject,
  j as addGlobalEventProcessor,
  k as getEventDescription,
  m as isMatchingPattern,
  p as parseRetryAfterHeader,
  o as isErrorEvent,
  q as isString,
  r as getLocationHref,
  s as getCurrentHub,
  v as safeJoin,
  w as htmlTreeAsString,
  x as parseUrl,
  y as isInstanceOf,
  z as timestampWithMs,
  A as dropUndefinedKeys,
  B as setDefaultIcon,
  O as OPEN_OPTIONS,
  C as OPEN_POCKET,
  D as COLOR_MODE_CHANGE,
  E as SEND_TAG_ERROR,
  T as TAGS_SYNC,
  R as RESAVE_ITEM,
  F as REMOVE_ITEM,
  L as LOGGED_OUT_OF_POCKET,
  U as USER_LOG_IN,
  G as AUTH_CODE_RECEIVED,
  H as addExceptionMechanism,
  I as isDOMError,
  J as isDOMException,
  K as addExceptionTypeValue,
  M as isError,
  N as isEvent,
  P as SAVE_TO_POCKET_REQUEST,
  g as getSetting,
  Q as SAVE_TO_POCKET_SUCCESS,
  V as SAVE_TO_POCKET_FAILURE,
  W as REMOVE_ITEM_REQUEST,
  X as setToolbarIcon,
  Y as TAG_SYNC_REQUEST,
  Z as UPDATE_TAG_ERROR,
  $ as setSettings,
  a0 as withScope,
  a1 as Hub,
  a2 as isNodeEnv,
  a3 as fill,
  a4 as extractExceptionKeysForMessage,
  a5 as normalizeToSize,
  a6 as getFunctionName,
  a7 as UPDATE_ITEM_PREVIEW,
  a8 as UPDATE_STORED_TAGS,
  a9 as SUGGESTED_TAGS_SUCCESS,
  aa as REMOVE_ITEM_SUCCESS,
  ab as REMOVE_ITEM_FAILURE,
  ac as TAG_SYNC_SUCCESS,
  ad as TAG_SYNC_FAILURE,
  ae as getMainCarrier,
  af as loadModule,
  ag as __read$3,
  ah as __values$2,
  ai as __assign$3,
  aj as urlEncode,
  ak as captureMessage,
  al as dynamicRequire,
  am as captureException
} from "../../chunks/actions-639cd34d.js";
import {
  i as isSystemPage,
  a as isSystemLink,
  c as closeLoginPage,
  g as getAccessToken,
  d as deriveItemData
} from "../../chunks/helpers-10be1fb3.js";
import {
  A as API_URL,
  L as LOGOUT_URL,
  a as AUTH_URL,
  ...
  b as POCKET_HOME,
  C as CONSUMER_KEY
} from "../../chunks/constants-064bdc7d.js";
...
var Dsn = /** @class */ (function () {
  ...
  Dsn.prototype._fromString = function (str) {
    ...
    var _a = __read$3(match.slice(1), 6),
      protocol = _a[0],
      publicKey = _a[1],
      _b = _a[2],
      pass = _b === void 0 ? "" : _b,
...
function instrumentFetch() {
  ...
  fill(global$4, "fetch", function (originalFetch) {
    return function () {
      ...
      return originalFetch.apply(global$4, args).then(
        function (response) {
...
var BaseClient = /** @class */ (function () {
  ...
  BaseClient.prototype._updateSessionFromEvent = function (session, event) {
    ...
    if (shouldUpdateAndSend) {
      session.update(
        __assign$1(__assign$1({}, crashed && { status: SessionStatus.Crashed }), { errors: session.errors || Number(errored || crashed) })
      );
  ...
  BaseClient.prototype._processEvent = function (event, hint, scope) {
    ...
    if (!isTransaction && typeof sampleRate === "number" && Math.random() > sampleRate) {
      ...
      return SyncPromise.reject(
        new SentryError("Discarding event because it's not included in the random sample (sampling rate = " + sampleRate + ")")
      );
    }
    return this._prepareEvent(event, scope, hint)
      .then(function (prepared) {
        var _a, _b;
        if (prepared === null) {
          (_b = (_a = transport).recordLostEvent) === null || _b === void 0
            ? void 0
            : _b.call(_a, Outcome.EventProcessor, event.type || "event");
      ...
      .then(function (processedEvent) {
        ...
        if (processedEvent === null) {
          (_b = (_a = transport).recordLostEvent) === null || _b === void 0
            ? void 0
            : _b.call(_a, Outcome.BeforeSend, event.type || "event");
...
function sessionToSentryRequest(session, api) {
  ...
  var envelopeHeaders = JSON.stringify(
    __assign$1(
      __assign$1({ sent_at: new Date().toISOString() }, sdkInfo && { sdk: sdkInfo }),
...
function eventToSentryRequest(event, api) {
  ...
  if (useEnvelope) {
    var envelopeHeaders = JSON.stringify(
      __assign$1(
        __assign$1({ event_id: event.event_id, sent_at: new Date().toISOString() }, sdkInfo && { sdk: sdkInfo }),
        api.forceEnvelope() && { dsn: api.getDsn().toString() }
      )
    );
    var itemHeaders = JSON.stringify({
...
var InboundFilters = /** @class */ (function () {
  ...
  InboundFilters.prototype._getLastValidUrl = function (frames) {
    ...
    for (var i = frames.length - 1; i >= 0; i--) {
      var frame = frames[i];
      if (
        ((_a = frame) === null || _a === void 0 ? void 0 : _a.filename) !== "<anonymous>" &&
        ((_b = frame) === null || _b === void 0 ? void 0 : _b.filename) !== "[native code]"
      ) {
...
var BrowserBackend = /** @class */ (function (_super) {
  ...
  BrowserBackend.prototype._setupTransport = function () {
    ...
    var transportOptions = __assign$2(__assign$2({}, this._options.transportOptions), {
  ...
  UserAgent.prototype.setupOnce = function () {
    addGlobalEventProcessor(function (event) {
      ...
      if (getCurrentHub().getIntegration(UserAgent)) {
        ...
        var headers = __assign$2(
          __assign$2(
            __assign$2({}, (_c = event.request) === null || _c === void 0 ? void 0 : _c.headers),
...
function localize(string) {
  ...
  return (_currentStrings$strin = currentStrings[string]) === null || _currentStrings$strin === void 0
    ? void 0
    : _currentStrings$strin.message;
}
...
async function save({ linkUrl, pageUrl, title, tabId }) {
  ...
  try {
    ...
    const { response: payload } = await saveToPocket({
      url,
      title,
      tabId
...
var Transaction = /** @class */ (function (_super) {
  ...
  Transaction.prototype.finish = function (endTimestamp) {
    ...
    if (this.sampled !== true) {
      ...
      (_e =
        (_c = (_a = this._hub.getClient()) === null || _a === void 0 ? void 0 : (_b = _a).getTransport) === null || _c === void 0
          ? void 0
          : (_d = _c.call(_b)).recordLostEvent) === null || _e === void 0
        ? void 0
        : _e.call(_d, Outcome.SampleRate, "transaction");
      return undefined;
    }
...
function _startTransaction(transactionContext, customSamplingContext) {
  ...
  transaction = sample(
    transaction,
    options,
    __assign({ parentSampled: transactionContext.parentSampled, transactionContext: transactionContext }, customSamplingContext)
  );
  if (transaction.sampled) {
