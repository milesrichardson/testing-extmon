...
import {
  ...
  _ as _extends$2,
  g as globalReset,
  b as globalVariables,
  E as ErrorIcon,
  d as PocketLogoIcon,
  B as Button,
  L as ListViewIcon,
  S as SettingsIcon
} from "../../chunks/globalStyles-22fbf6ab.js";

const doorhangerStyle = "d5dq2r3";
const Doorhanger = ({ isOpen, children }) => {
...
const Heading = ({ saveStatus, removeAction, saveAction }) => {
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        ...
        isLoading ? /*#__PURE__*/ React.createElement(Loading, null) : null,
        hasError ? /*#__PURE__*/ React.createElement(ErrorIcon, null) : null,
        !isLoading && !hasError ? /*#__PURE__*/ React.createElement(PocketLogoIcon, null) : null
      ),
      /*#__PURE__*/ React.createElement(
        "div",
        {
...
const HeadingConnector = ({ saveStatus }) => {
...
const ItemPreview = ({ title, thumbnail, publisher }) => {
  return title && publisher
    ? /*#__PURE__*/ React.createElement(
        ...
        /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement("p", null, publisher)
        )
      )
    : null;
};
      ...
      _this.buttonHandleBlur = function (event) {
        ...
        _this.internalSetTimeout(function () {
          if (
            ...
            _this.props.environment.document.activeElement !== blurTarget // Do nothing if we refocus the same element again (to solve issue in Safari on iOS)
          ) {
            _this.reset({
              type: blurButton
            });
        ...
        return _extends$1(
          {
            ...
            "aria-activedescendant":
              isOpen && typeof highlightedIndex === "number" && highlightedIndex >= 0 ? _this.getItemId(highlightedIndex) : null,
...
const Suggestions = ({ addTag, suggestions, used }) => {
  return /*#__PURE__*/ React.createElement(
    "div",
    {
    ...
    },
    {
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement("div", { ref: this.sizerRef, style: sizerStyle }, sizerValue),
          this.props.placeholder
            ? _react2.default.createElement("div", { ref: this.placeHolderSizerRef, style: sizerStyle }, this.props.placeholder)
            : null
        );
      }
    }
...
const Chips = ({ removeTag, tags, marked, toggleActive }) => {
  const listItems = () => {
...
const TaggingConnector = ({ closePanel }) => {
...
const Footer = ({ myListClick, settingsClick }) => {
  return /*#__PURE__*/ React.createElement(
    "footer",
    {
    ...
    /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(ListViewIcon, null),
...
const App = () => {
  ...
  const handleDocumentClick = (e) => {
    ...
    if (
      appTarget !== null &&
      appTarget !== void 0 &&
      (_appTarget$current = appTarget.current) !== null &&
      _appTarget$current !== void 0 &&
      _appTarget$current.contains(e.target)
    )
      return;
    setIsOpen(false);
  };
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    /*#__PURE__*/ React.createElement(
      ...
      !isRemoved && !hasError ? /*#__PURE__*/ React.createElement(ItemPreviewConnector, null) : null,
      !isRemoved && !hasError
        ? /*#__PURE__*/ React.createElement(TaggingConnector, {
            closePanel: closePanel
          })
        : null,
      hasError
        ...
        : null,
      !hasError ? /*#__PURE__*/ React.createElement(FooterConnector, null) : null
    )
  );
};
