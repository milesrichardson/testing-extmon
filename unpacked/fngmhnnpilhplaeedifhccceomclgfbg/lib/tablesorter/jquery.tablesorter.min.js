...
!(function (h) {
    ...
    tablesorter: new (function () {
      ...
      function r(b, a, c) {
        ...
        var f,
          ...
          d =
            "basic" === l
              ? h(a).attr(e.textAttribute) || a.textContent || a.innerText || h(a).text() || ""
              : "function" === typeof l
              ? l(a, b, c)
            ...
            for (x = f.columns, k = 0; k < x; k++) {
              ...
              if (!u)
                a: {
                  ...
                  B = -1;
                  u = k;
                  for (var A = void 0, K = g.parsers.length, G = !1, z = "", A = !0; "" === z && A; )
                    B++,
                      m[B]
                        ? ((G = m[B].cells[u]),
                          (z = r(h, G, u)),
                          h.config.debug && d("Checking if value was empty on row " + B + ", column: " + u + ': "' + z + '"'))
                        : (A = !1);
                  for (; 0 <= --K; )
      ...
      function w(b) {
        ...
        for (l = 0; l < t.length; l++)
          if (((u = []), (a = s.cache[l] = { normalized: [] }), !t.eq(l).hasClass(s.cssInfoBlock))) {
            m = (t[l] && t[l].rows.length) || 0;
            for (f = 0; f < m; ++f)
              if (((p = { child: [] }), (x = h(t[l].rows[f])), (k = []), x.hasClass(s.cssChildRow) && 0 !== f))
                ...
                for (e = 0; e < s.columns; ++e)
                  "undefined" === typeof w[e]
                    ? s.debug && d("No parser found for cell:", x[0].cells[e], "does it have a header?")
                    : ((c = r(b, x[0].cells[e], e)),
                      (c = "undefined" === typeof v[e].id ? c : v[e].format(c, b, x[0].cells[e], e)),
                      (c = "no-parser" === w[e].id ? "" : w[e].format(c, b, x[0].cells[e], e)),
                      k.push(s.ignoreCase && "string" === typeof c ? c.toLowerCase() : c),
                      "numeric" === (w[e].type || "").toLowerCase() && (u[e] = Math.max(Math.abs(c) || 0, u[e] || 0)));
                k[s.columns] = p;
                a.normalized.push(k);
              }
            a.colMax = u;
      ...
      function E(b) {
        ...
        n.$headers = h(b)
          ...
          .each(function (k) {
            ...
            "" !== n.headerTemplate &&
              ((l = n.headerTemplate.replace(/\{content\}/g, h(this).html()).replace(/\{icon\}/g, e)),
              n.onRenderTemplate && (f = n.onRenderTemplate.apply(c, [k, l])) && "string" === typeof f && (l = f),
              h(this).html('<div class="' + g.css.headerIn + '">' + l + "</div>"));
      ...
      function F(b) {
        ...
        for (a = 0; a < l; a++)
          if (
            2 !== e[a][1] &&
            ((b = f.$headers.not(".sorter-false").filter('[data-column="' + e[a][0] + '"]' + (1 === l ? ":last" : ""))), b.length)
          ) {
        ...
        f.$headers.not(".sorter-false").each(function () {
          var b = h(this),
            ...
            a =
              b.text() +
              ": " +
              g.language[b.hasClass(g.css.sortAsc) ? "sortAsc" : b.hasClass(g.css.sortDesc) ? "sortDesc" : "sortNone"] +
              g.language[0 === a ? "nextAsc" : 1 === a ? "nextDesc" : "nextNone"];
          b.attr("aria-label", a);
        });
      }
      function O(b) {
        ...
        if (n) {
          ...
          if (k.sortAppend && 1 < k.sortList.length)
            for (l = 0; l < k.sortAppend.length; l++)
              (d = g.isValueInArray(k.sortAppend[l][0], k.sortList)), 0 <= d && k.sortList.splice(d, 1);
                  ...
                  (f = /n/i.test(Q(t.parsers, e))) && t.strings[e]
                    ? ((f =
                      ...
                      (m = t.numberSorter
                        ...
                        : g["sortNumeric" + (s ? "Asc" : "Desc")](c[e], l[e], f, d[e], e, b)))
                    : ((r = s ? c : l),
                      (u = s ? l : c),
                      (m =
                        "function" === typeof v
                          ...
                          ? v[e](r[e], u[e], s, e, b)
                          : g["sortNatural" + (s ? "Asc" : "Desc")](c[e], l[e], e, b, t)));
                  if (m) return m;
                }
        ...
        c.unbind(
          ...
          .bind("updateCell" + a.namespace, function (f, e, l, g) {
            ...
            n.length &&
              ...
              (d = "undefined" === typeof a.extractors[m].id ? r(b, e, m) : a.extractors[m].format(r(b, e, m), b, e, m)),
              (e = "no-parser" === a.parsers[m].id ? "" : a.parsers[m].format(d, b, e, m)),
              (a.cache[f].normalized[n][m] = a.ignoreCase && "string" === typeof e ? e.toLowerCase() : e),
              "numeric" === (a.parsers[m].type || "").toLowerCase() &&
                (a.cache[f].colMax[m] = Math.max(Math.abs(e) || 0, a.cache[f].colMax[m] || 0)),
              I(c, l, g));
          })
                ...
                for (d = 0; d < n; d++)
                  (m =
                    "undefined" === typeof a.extractors[d].id
                      ? r(b, e[f].cells[d], d)
                      : a.extractors[d].format(r(b, e[f].cells[d], d), b, e[f].cells[d], d)),
                    ...
                    "numeric" === (a.parsers[d].type || "").toLowerCase() &&
                      (a.cache[t].colMax[d] = Math.max(Math.abs(u[d]) || 0, a.cache[t].colMax[d] || 0));
                u.push(q);
      ...
      g.setup = function (b, a) {
        ...
        a.$tbodies = f.children("tbody:not(." + a.cssInfoBlock + ")").attr({ "aria-live": "polite", "aria-relevant": "all" });
        ...
        a.supportsDataObject && "undefined" !== typeof f.data().sortlist
          ...
          : e && f.metadata() && f.metadata().sortlist && (a.sortList = f.metadata().sortlist);
        g.applyWidget(b, !0);
        ...
        a.showProcessing &&
          f
            ...
            .bind("sortBegin" + a.namespace + " sortEnd" + a.namespace, function (c) {
      ...
      g.getColumnData = function (b, a, c, f) {
        if ("undefined" !== typeof a && null !== a) {
          ...
          for (e in a)
            if (
              "string" === typeof e &&
              ((b = f ? d.$headers.eq(c).filter(e) : d.$headers.filter('[data-column="' + c + '"]:last').filter(e)), b.length)
            )
              return a[e];
        }
      };
      ...
      g.processTbody = function (b, a, c) {
        b = h(b)[0];
        if (c)
          return (b.isProcessing = !0), a.before('<span class="tablesorter-savemyplace"/>'), (c = h.fn.detach ? a.detach() : a.remove());
      ...
      g.bindEvents = function (b, a, c) {
        ...
        a.find(e.selectorSort)
          ...
          .unbind(["mousedown", "mouseup", "sort", "keyup", ""].join(e.namespace + " "))
          .bind(["mousedown", "mouseup", "sort", "keyup", ""].join(e.namespace + " "), function (c, d) {
            var g;
            g = c.type;
            if (
              !(
                ...
                ("keyup" === g && 13 !== c.which) ||
                ("mouseup" === g && !0 !== d && 250 < new Date().getTime() - f)
              )
            ) {
              if ("mousedown" === g)
                return (f = new Date().getTime()), /(input|select|button|textarea)/i.test(c.target.tagName) ? "" : !e.cancelSelection;
      ...
      g.destroy = function (b, a, c) {
        ...
        if (b.hasInitialized) {
          ...
          !1 === a &&
            ...
            (f.trigger("applyWidgetId", ["uitheme"]), f.trigger("applyWidgetId", ["zebra"]));
          ...
          e.$headers
            .add(k)
            .removeClass([g.css.header, e.cssHeader, e.cssAsc, e.cssDesc, g.css.sortAsc, g.css.sortDesc, g.css.sortNone].join(" "))
      ...
      g.applyWidget = function (b, a) {
        ...
        var c = b.config,
          ...
          p,
          k;
        (!1 !== a && b.hasInitialized && (b.isApplyingWidgets || b.isUpdating)) ||
          (c.debug && (l = new Date()),
          c.widgets.length &&
            ...
            h.each(e, function (e, g) {
              if (g) {
                if (a || !c.widgetInit[g.id])
                  (c.widgetInit[g.id] = !0),
                    g.hasOwnProperty("options") && (d = b.config.widgetOptions = h.extend(!0, {}, g.options, d)),
          ...
          c.debug &&
            ((p = c.widgets.length),
            q("Completed " + (!0 === a ? "initializing " : "applying ") + p + " widget" + (1 !== p ? "s" : ""), l)));
      };
      g.refreshWidgets = function (b, a, c) {
        ...
        for (f = 0; f < k; f++)
          q[f] &&
            ...
            q[f].hasOwnProperty("remove") && e.widgetInit[q[f].id] && (q[f].remove(b, e, e.widgetOptions), (e.widgetInit[q[f].id] = !1)));
      ...
      g.getData = function (b, a, c) {
        ...
        g = " " + (b.attr("class") || "");
        "undefined" !== typeof b.data(c) || "undefined" !== typeof b.data(c.toLowerCase())
          ? (d += b.data(c) || b.data(c.toLowerCase()))
          : e && "undefined" !== typeof e[c]
          ? (d += e[c])
          : a && "undefined" !== typeof a[c]
          ? (d += a[c])
          : " " !== g && g.match(" " + c + "-") && (d = g.match(new RegExp("\\s" + c + "-([\\w-]+)"))[1] || "");
        return h.trim(d);
      };
      g.formatFloat = function (b, a) {
        if ("string" !== typeof b || "" === b) return b;
        var c;
        b = (a && a.config ? !1 !== a.config.usNumberFormat : "undefined" !== typeof a ? a : 1)
          ? b.replace(/,/g, "")
  ...
  r.addParser({
    ...
    is: function (d) {
      return (
        /^[A-Z]{3,10}\.?\s+\d{1,2},?\s+(\d{4})(\s+\d{1,2}:\d{2}(:\d{2})?(\s+[AP]M)?)?$/i.test(d) ||
    ...
    format: function (d, h, p, y) {
      if (d) {
        ...
        "mmddyyyy" === y
          ...
          : "yyyymmdd" === y && (d = d.replace(/(\d{4})[\/\s](\d{1,2})[\/\s](\d{1,2})/, "$1/$2/$3"));
      }
  ...
  r.addWidget({
    ...
    remove: function (d, q, p) {
      ...
      for (p = 0; p < q.length; p++)
        (r = h.tablesorter.processTbody(d, q.eq(p), !0)), r.children().removeClass(v), h.tablesorter.processTbody(d, r, !1);
    }
  });
})(jQuery);
