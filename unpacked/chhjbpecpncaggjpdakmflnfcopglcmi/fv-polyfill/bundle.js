        ...
        function e(e) {
          ...
          function c(e) {
            e.hasAttribute("data-focus-visible-added") &&
              (e.classList.remove("focus-visible"), e.removeAttribute("data-focus-visible-added"));
          }
          function a(n) {
          ...
          function m(e) {
            d(e.target) && (t || s(e.target)) && u(e.target);
          }
          function v(e) {
            d(e.target) &&
          ...
          function L(e) {
            (e.target.nodeName && "html" === e.target.nodeName.toLowerCase()) || ((t = !1), E());
          }
