("undefined" != typeof globalThis
  ...
  ? global
  : {}
).parcelRequire60cc.register("5GtyY", function (e, t) {
  /*! @license DOMPurify | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/2.2.2/LICENSE */ e.exports,
    (e.exports = (function () {
      "use strict";
      function e(e) {
        if (Array.isArray(e)) {
      ...
      var d = w(Array.prototype.forEach),
      ...
      function X() {
        ...
        var me = {};
        t.isSupported = "function" == typeof ne && le && void 0 !== le.createHTMLDocument && 9 !== de;
        var pe = H,
          ge = U,
          he = j,
          ye = P,
          ...
          Ge = null,
          We = S({}, ["audio", "video", "img", "source", "image", "track"]),
          qe = null,
          Ke = S({}, [
            "alt",
            "class",
          ...
          Xe = function (e) {
            (Ve && Ve === e) ||
              ...
              (e = k(e)),
              (Ae = "ALLOWED_TAGS" in e ? S({}, e.ALLOWED_TAGS) : we),
              (xe = "ALLOWED_ATTR" in e ? S({}, e.ALLOWED_ATTR) : Se),
              (qe = "ADD_URI_SAFE_ATTR" in e ? S(k(Ke), e.ADD_URI_SAFE_ATTR) : Ke),
              (Ge = "ADD_DATA_URI_TAGS" in e ? S(k(We), e.ADD_DATA_URI_TAGS) : We),
              ...
              Pe &&
                ((Ae = S({}, [].concat(K(M)))),
                (xe = []),
                !0 === Pe.html && (S(Ae, _), S(xe, F)),
                !0 === Pe.svg && (S(Ae, D), S(xe, C), S(xe, z)),
                !0 === Pe.svgFilters && (S(Ae, E), S(xe, C), S(xe, z)),
                !0 === Pe.mathMl && (S(Ae, L), S(xe, I), S(xe, z))),
              e.ADD_TAGS && (Ae === we && (Ae = k(Ae)), S(Ae, e.ADD_TAGS)),
          ...
          $e = S({}, ["mi", "mo", "mn", "ms", "mtext"]),
          Ze = S({}, ["foreignobject", "desc", "title", "annotation-xml"]),
          Je = S({}, D);
        S(Je, E), S(Je, N);
        var Qe = S({}, L);
        S(Qe, O);
        var et = "http://www.w3.org/1998/Math/MathML",
          ...
          rt = function (e) {
            ...
            if (e.namespaceURI === et)
              return t.namespaceURI === nt ? "math" === n : t.namespaceURI === tt ? "math" === n && Ze[r] : Boolean(Qe[n]);
          ...
          st = function (e) {
            return "object" === (void 0 === l ? "undefined" : q(l))
              ? e instanceof l
              : e && "object" === (void 0 === e ? "undefined" : q(e)) && "number" == typeof e.nodeType && "string" == typeof e.nodeName;
          },
          ut = function (e, n, r) {
            me[e] &&
              d(me[e], function (e) {
          ...
          ft = function (e) {
            ...
            return e instanceof c && !rt(e)
              ...
              ? (Ne &&
                  ...
                  (n = y(n, pe, " ")),
                  (n = y(n, ge, " ")),
                  e.textContent !== n && (p(t.removed, { element: e.cloneNode() }), (e.textContent = n))),
              ...
              for (i = a.length; i--; ) {
                ...
                if (
                  ...
                  if (T(/\/>/i, r)) it(s, e);
                    ...
                    if (dt(f, o, r))
                      try {
                        u ? e.setAttributeNS(u, s, r) : e.setAttribute(s, r), m(t.removed);
                      } catch (e) {}
                  }
              }
          ...
          pt = function e(t) {
            ...
            for (ut("beforeSanitizeShadowDOM", t, null); (n = r.nextNode()); )
              ut("uponSanitizeShadowNode", n, null), ft(n) || (n.content instanceof o && e(n.content), mt(n));
        ...
        return (
          (t.sanitize = function (r, i) {
            ...
            if ((Oe || Xe(i), (t.removed = []), "string" == typeof r && (je = !1), je));
            else if (r instanceof l)
              (1 === (c = (a = at("\x3c!----\x3e")).ownerDocument.importNode(r, !0)).nodeType && "BODY" === c.nodeName) ||
              "HTML" === c.nodeName
                ? (a = c)
                : a.appendChild(c);
            else {
              if (!Fe && !Ne && !Le && -1 === r.indexOf("<")) return oe && ze ? oe.createHTML(r) : r;
              if (!(a = at(r))) return Fe ? null : ie;
            }
            a && Me && ot(a.firstChild);
            for (var d = lt(je ? r : a); (s = d.nextNode()); )
              (3 === s.nodeType && s === u) || ft(s) || (s.content instanceof o && pt(s.content), mt(s), (u = s));
            if (((u = null), je)) return r;
            if (Fe) {
              if (Ce) for (f = ue.call(a.ownerDocument); a.firstChild; ) f.appendChild(a.firstChild);
              else f = a;
              return Ie && (f = fe.call(n, f, !0)), f;
            }
            var m = Le ? a.outerHTML : a.innerHTML;
            return Ne && ((m = y(m, pe, " ")), (m = y(m, ge, " "))), oe && ze ? oe.createHTML(m) : m;
          }),
...
//# sourceMappingURL=purify.e7c71f30.js.map
