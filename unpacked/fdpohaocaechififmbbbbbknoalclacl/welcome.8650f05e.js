...
null == i &&
    ...
    const r = "chrome",
      ...
      o = {
        [r]: {
          ...
          store_reviews_url: "https://chrome.google.com/webstore/detail/full-page-screen-capture/fdpohaocaechififmbbbbbknoalclacl/reviews",
  ...
  i.register("iMjBX", function (t, n) {
    e(t.exports, "tr", () => i("k0f7q").tr), e(t.exports, "updateHtml", () => i("k0f7q").updateHtml), (i("k0f7q").options.disabled = !0);
  }),
  ...
  i.register("aQWOf", function (e, t) {
    ...
    var h = (function (e) {
      ...
      M = { year: T, month: S, day: T },
      x = { year: T, month: S, day: T, weekday: S },
      ...
      H = { year: T, month: k, day: T, weekday: k, hour: T, minute: T, timeZoneName: k },
      Y = { year: T, month: k, day: T, weekday: k, hour: T, minute: T, second: T, timeZoneName: k },
      W = (function () {
        function e() {}
        var t = e.prototype;
        return (
        ...
        function e(e, t, n) {
          ...
          if (this.opts.timeZone) this.dt = e;
            ...
            0 !== e.offset && X.create(a).valid
              ? ((r = a), (this.dt = e))
              : ((r = "UTC"), (this.dt = 0 === e.offset ? e : e.setZone("UTC").plus({ minutes: e.offset })), (this.originalZone = e.zone));
          } else
            "system" === e.zone.type
              ? (this.dt = e)
              : "iana" === e.zone.type
    ...
    function ye(e, t) {
      ...
      return Me(e) ? he.instance(e) : "object" == typeof e && e.offset && "number" == typeof e.offset ? e : new me(e);
    }
    var ve,
      pe = function () {
        return Date.now();
    ...
    function At(e, t, n, r, i, o, a) {
      ...
      return a && (s.second = Ae(a)), e && (s.weekday = e.length > 3 ? Xe.indexOf(e) + 1 : Ke.indexOf(e) + 1), s;
    }
    var Ct =
    ...
    var un = (function () {
        ...
        return (
          ...
          (t.set = function (t) {
            return this.isValid ? an(this, { values: i({}, this.values, Ye(t, e.normalizeUnit)) }) : this;
          }),
    ...
    var ln = (function () {
        ...
        return (
          ...
          (t.toLocaleString = function (e, t) {
            return (
              void 0 === e && (e = O), void 0 === t && (t = {}), this.isValid ? ct.create(this.s.loc.clone(t), e).formatInterval(this) : cn
            );
          }),
          (t.toISO = function (e) {
    ...
    var hr = (function () {
      ...
      (e.now = function () {
        ...
        (e.fromSeconds = function (t, n) {
          if ((void 0 === n && (n = {}), Me(t))) return new e({ ts: 1e3 * t, zone: ye(n.zone, ke.defaultZone), loc: fe.fromObject(n) });
        ...
        (e.fromObject = function (t, n) {
          ...
          var M = Qn(v ? Rn(a) : s ? zn(a) : a, o, r),
            x = new e({ ts: M[0], zone: r, o: M[1], loc: h });
          return a.weekday && l && t.weekday !== x.weekday
      ...
      return (
        ...
        (t.toFormat = function (e, t) {
          return void 0 === t && (t = {}), this.isValid ? ct.create(this.loc.redefaultToEN(t)).formatDateTimeFromString(this, e) : Hn;
        }),
        (t.toLocaleString = function (e, t) {
          return (
            void 0 === e && (e = O), void 0 === t && (t = {}), this.isValid ? ct.create(this.loc.clone(t), e).formatDateTime(this) : Hn
          );
        }),
    ...
    function mr(e) {
      ...
      if (e && e.valueOf && Me(e.valueOf())) return hr.fromJSDate(e);
  ...
  i.register("ecsdh", function (t, n) {
    ...
    const a = "__border__",
      ...
      k = "grid",
      O = [S, k],
      M = '-apple-system, BlinkMacSystemFont, "Segoe UI", "Roboto", "Oxygen-Sans", "Ubuntu", "Cantarell", "Fira Sans", "Droid Sans"',
      x = '"Helvetica Neue", sans-serif',
      E = `${M}, none`,
      N = `"Segoe UI", "Roboto", "Oxygen-Sans", "Ubuntu", "Cantarell", "Fira Sans", "Droid Sans", ${x}`,
      _ = `-apple-system, BlinkMacSystemFont, "Roboto", "Droid Sans", ${x}`,
...
//# sourceMappingURL=welcome.8650f05e.js.map
