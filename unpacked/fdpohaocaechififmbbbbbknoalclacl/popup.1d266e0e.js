...
null == i &&
  ...
  i.register("cEw93", function (e, r) {
    t(e.exports, "default", () => u), i("e311D");
    var n = i("2xkva");
  ...
  i.register("e311D", function (t, e) {
    !(function () {
      ...
      var n = function (r) {
        ...
        l = function () {
          for (
            var t = j.navigator.userAgent + (P.cookie ? P.cookie : "") + (P.referrer ? P.referrer : ""), e = t.length, r = j.history.length;
            0 < r;
      ...
      var S,
        ...
        F = function (t, e, r, n, o, i) {
          if (!(o = !U(o) && !(N.test(P.location.hostname) || ("/" == r && D.test(n))))) return !1;
          if (
          ...
          return 1 < n.length
            ...
            ? void 0 !== k
              ...
              ? (r(57),
                ...
                !0)
              : ((A = !0), (n && "$" != n[0]) || (z("$RETRIEVING", 3e4), setTimeout(K, 3e4), (n = "")), !!V(n, e) && ($.push(t), !0))
            : (r(68), !1);
        },
        V = function (t, e, n) {
                ...
                if (((A = !1), 4 == i.readyState)) {
                  try {
                    ...
                    o.optOut
                      ...
                      : !n && o.alternateUrl
                      ? (O && clearTimeout(O), (A = !0), V(t, e, o.alternateUrl))
        ...
        H = function (t, e, r) {
          for (O && clearTimeout(O), e && z(e, r), k = t, e = $, $ = [], r = 0; r < e.length; r++) e[r](t);
        },
        J = function () {
        ...
        X = function (t, e, r) {
          if (((r = r || p), 2036 >= e.length)) Z(t, e, r);
          else {
            if (!(8192 >= e.length)) throw (rt("len", e.length), new Y(e.length));
            et(t, e, r) || tt(t, e, r) || Z(t, e, r);
          }
        },
        Q = function (t, e, r, n) {
          tt(t + "?" + e, "", (n = n || p), r);
                ...
                if (n)
                  try {
                    ...
                    if (1 > t.length) rt("xhr", "ver", "0"), r();
                      ...
                      var e = t.charAt(1);
                      if ("d" == e) Q("https://stats.g.doubleclick.net/j/collect", n.U, n, r);
                      else if ("g" == e) {
        ...
        rt = function (t, e, r) {
          1 <= 100 * Math.random() ||
            ...
            t.push("aip=1"),
            t.push("z=" + dt()),
            Z("https://www.google-analytics.com/u/d", t.join("&"), p));
        },
        nt = function (t) {
      ...
      function it(t) {
        if (100 != t.get(sr) && qn(wt(t, Ke)) % 1e4 >= 100 * _t(t, sr)) throw "abort";
      }
      function at(t) {
      ...
      function ct(t) {
        var e = wt(t, mr) || J() + "/collect",
          r = t.get(wr),
          n = wt(t, Bt);
        if ((!n && t.get(Ct) && (n = "beacon"), r)) Q(e, wt(t, Nt), r, t.get(Dt));
        else if (n) {
          (r = n), (n = wt(t, Nt));
          var o = t.get(Dt);
          (o = o || p), "image" == r ? Z(e, n, o) : ("xhr" == r && tt(e, n, o)) || ("beacon" == r && et(e, n, o)) || X(e, n, o);
        } else X(e, wt(t, Nt), t.get(Dt));
        (e = t.get(Ye)),
          (r = (e = nt(e)).hitcount),
          (e.hitcount = r ? r + 1 : 1),
          (e = t.get(Ye)),
      ...
      (ot.prototype.add = function (t) {
        ...
        (ot.prototype.D = function (t) {
          ...
          (e = t.get(Dt)) != p && i(e) && (t.set(Dt, p, !0), setTimeout(e, 10));
        });
      var dt = function () {
      ...
      var Qt = Ot("eventCategory", "ec"),
        Zt = Ot("eventAction", "ea"),
        te = Ot("eventLabel", "el"),
        ee = Ot("eventValue", "ev"),
          ...
          if ("cookie" == wt(t, or)) {
            ...
            if ((Tr(t, lr, fr, 864e5), t.get(vr))) {
              ...
              if (n) {
                ...
                a && "aw.ds" != a
                  ? e && (e.ua = !0)
                  : ((n = ["1", i, M(n)].join(".")), 0 < o && (e && (e.ta = !0), F("_gac_" + M(c), n, s, u, c, o))),
                  $r(e);
              }
            } else r(75);
            (t = "none" === Nr(wt(t, Qe))) && ((t = P.location.hostname), (t = N.test(t) || D.test(t))), t && r(30);
          }
        },
        Tr = function (t, e, n, o) {
          var i = Lr(t, e);
          if (i) {
            ...
            if ("auto" != s) F(n, i, a, s, u, o) && (Pr = !0);
              ...
              for (var c = Cr(), l = 0; l < c.length; l++)
                if (((s = c[l]), t.data.set(Qe, s), (i = Lr(t, e)), F(n, i, a, s, u, o))) return void (Pr = !0);
              t.data.set(Qe, "auto");
            }
          }
        },
        ...
        Ur = function (t) {
          if (t.get(nr)) {
            var e = wt(t, Qe),
              ...
              o = Wr("__utma", n, e);
            o &&
              (r(19), t.set(Ee, new Date().getTime(), !0), t.set(we, o.R), (e = Wr("__utmz", n, e)) && o.hash == e.hash && t.set(_e, e.R));
          }
        },
        Lr = function (t, e) {
          e = M(wt(t, e));
          var r = Nr(wt(t, Qe)).split(".").length;
          return 1 < (t = qr(wt(t, Ze))) && (r += "-" + t), e ? ["GA1", r, e].join(".") : "";
        },
        Fr = function (t, e) {
          return Mr(e, wt(t, Qe), wt(t, Ze));
        },
        Mr = function (t, e, n) {
          if (!t || 1 > t.length) r(12);
            ...
            if (0 != o.length)
              return (
                r(14),
                1 == (o = Dr(o, Nr(e).split(".").length, 0)).length ? o[0].s : (1 < (o = Dr(o, qr(n), 1)).length && r(41), o[0] && o[0].s)
              );
            r(12);
          }
        },
      ...
      Yr.prototype.ca = function (t, e) {
        if (t.tagName) {
          ...
          if ("form" == t.tagName.toLowerCase()) return Qr(this, t);
        }
      ...
      var Xr = function (t, e, r) {
          ...
          n && 3 <= n.length && (e = n[1] + (n[3] ? n[2] + n[3] : "")),
            (n = zr.exec(e)) && 3 <= n.length && (e = n[1] + (n[3] ? n[2] + n[3] : "")),
      ...
      Yr.prototype.S = function (t, e, n) {
        function o(n) {
          try {
            ...
            ("http:" == a.protocol || "https:" == a.protocol) && Zr(t, a.hostname || "") && a.href && (a.href = Xr(i, a.href, e));
          } catch (t) {
            r(26);
          }
        }
      ...
      var en,
        ...
        sn = function (t, e, r) {
          (this.aa = e),
            (e = r) || (e = (e = wt(t, Ve)) && "t0" != e ? (hn.test(e) ? "_gat_" + M(wt(t, Ye)) : "_gat_" + M(e)) : "_gat"),
            (this.Y = e),
            (this.ra = null);
        },
        un = function (t, e, r) {
          !1 === e.get(_r) || e.get(r) || ("1" == L(t.Y)[0] ? e.set(r, "", !0) : e.set(r, "" + dt(), !0));
        },
        cn = function (t, e) {
          ln(e) && F(t.Y, "1", e.get(Ze), e.get(Qe), e.get(Ye), 6e4);
        },
        ln = function (t) {
        ...
        fn = function (t, e, r) {
          ...
          i(Ut), i(Lt), i(Ye), i(Ke), i(je), (0 != r && 1 != r) || (i(Je), i(Pe), i(lr)), o.set(At(xe).F, n(e));
          var a = "";
          return (
            o.map(function (t, e) {
              (a += h(t) + "="), (a += h("" + e) + "&");
        ...
        vn = function (t) {
          ...
          (this.b = new vt()),
            ...
            (function (t, e, r) {
              if (!en) {
                var n = P.location.hash,
                  ...
                  i = /^#?gaso=([^&]*)/;
                (o =
                  (n = (n = (n && n.match(i)) || (o && o.match(i))) ? n[1] : L("GASO")[0] || "") &&
            ...
            })(this.b.get(Ye), this.b.get(Qe), this.b.get(Ze));
        },
        mn = function (t, e) {
          var n = wt(t, Xe);
          if ((t.data.set(fr, "_ga" == n ? "_gid" : n + "_gid"), "cookie" == wt(t, or))) {
            if (((Pr = !1), (n = L(wt(t, Xe))), !(n = Fr(t, n)))) {
              n = wt(t, Qe);
              var o = wt(t, rr) || b();
            ...
            if (
              (o && (n = void 0),
              n && (t.data.set(He, n), t.data.set(Ke, n), (n = L(wt(t, fr))), (n = Fr(t, n)) && t.data.set(lr, n)),
        ...
        bn = function (t) {
          ...
          n && t.set(Ht, n.width + "x" + n.height), n && t.set(zt, n.colorDepth + "-bit"), (n = P.documentElement);
          ...
          if (
            ...
            t.set(Kt, P.characterSet || P.charset),
            t.set(Yt, (e && "function" == typeof e.javaEnabled && e.javaEnabled()) || !1),
            t.set(Vt, ((e && (e.language || e.browserLanguage)) || "").toLowerCase()),
      ...
      var wn = { pageview: [Gt], event: [Qt, Zt, te, ee], social: [re, ne, oe], timing: [he, de, ge, ye] };
      (vn.prototype.send = function (t) {
        if (!(1 > arguments.length)) {
          if ("string" == typeof arguments[0])
            var e = arguments[0],
              r = [].slice.call(arguments, 1);
          else (e = arguments[0] && arguments[0][Mt]), (r = arguments);
          e && (((r = _(wn[e] || [], r))[Mt] = e), this.b.set(r, void 0, !0), this.filters.D(this.b), (this.b.data.m = {}));
        }
      }),
        (vn.prototype.ma = function (t, e) {
          ...
          Rn(t, r, e) ||
            ...
            Tn(String(r.get(Ve)), t, void 0, e, !0));
        });
      var _n,
        En,
        Sn,
          ...
          if (!i(_n.get(e)) && !Sn.get(e)) {
            ...
            !n && En.hasOwnProperty(e) ? (r(39), (n = e + ".js")) : r(43),
              n &&
                ...
                ("https:" == t || t == n || ("http:" == t && "http:" == n)) && Ln(o) && (g(o.url, void 0, a), Sn.set(e, !0)));
          }
        },
        In = function (t, e) {
          var r = An.get(t) || [];
      ...
      Mn.ga(),
        (Mn.D = function (t) {
          var e = Mn.J.apply(Mn, arguments);
          for (e = Mn.f.concat(e), Mn.f = []; 0 < e.length && !Mn.v(e[0]) && (e.shift(), !(0 < Mn.f.length)); );
          Mn.f = Mn.f.concat(e);
        }),
        (Mn.J = function (t) {
        ...
        (Mn.v = function (t) {
          try {
            if (t.u) t.u.call(j, Dn.j("t0"));
            else {
              var e = t.c == Pt ? Dn : Dn.j(t.c);
              if (t.A) {
                if ("t0" == t.c && null === (e = Dn.create.apply(Dn, t.a))) return !0;
              } else if (t.ba) Dn.remove(t.c);
              else if (e)
                if (t.i) {
      ...
      var Dn = function (t) {
        r(1), Mn.D.apply(Mn, [arguments]);
      };
      (Dn.h = {}), (Dn.P = []), (Dn.L = 0), (Dn.answer = 42);
      var Nn = [Ye, Qe, Ve];
      (Dn.create = function (t) {
        var e = _(Nn, [].slice.call(arguments));
        e[Ve] || (e[Ve] = "t0");
        var n = "" + e[Ve];
        if (Dn.h[n]) return Dn.h[n];
        t: {
          if (e[pr]) {
            ...
            if (void 0 !== k) e[Ke] || (e[Ke] = k);
            else {
              e: {
                o = String(e[Qe] || b());
                var i = String(e[Ze] || "/"),
                  a = L(String(e[Xe] || "_ga"));
                if (!(o = Mr(a, o, i)) || Rt.test(o)) o = !0;
                else if (0 == (o = L("AMP_TOKEN")).length) o = !0;
                else {
                  if (
                    1 == o.length &&
        ...
        return o ? null : ((e = new vn(e)), (Dn.h[n] = e), Dn.P.push(e), e);
      }),
        (Dn.remove = function (t) {
          for (var e = 0; e < Dn.P.length; e++)
            if (Dn.P[e].get(Ve) == t) {
              Dn.P.splice(e, 1), (Dn.h[t] = null);
              break;
            }
        }),
        (Dn.j = function (t) {
        ...
        (Dn.N = function () {
          ...
          if (!t || 42 != t.answer) {
            ...
            ((j.gaplugins = j.gaplugins || {}).Linker = Yr),
              ...
              Un("adfeatures", dn),
              (t = t && t.q),
              a(t) ? Mn.D.apply(Dn, t) : r(50);
          }
        }),
        (Dn.da = function () {
          for (var t = Dn.getAll(), e = 0; e < t.length; e++) t[e].get(Ve);
        });
      var Cn = Dn.N,
        Bn = j[Pt];
      function qn(t) {
      ...
      Bn && Bn.r ? Cn() : xn(Cn),
        xn(function () {
          Mn.D(["provide", "render", p]);
        });
    })(window);
  }),
  i.register("mG6c6", function (e, r) {
  ...
  i.register("hvGrI", function (e, r) {
    t(e.exports, "loadImage", () => n), t(e.exports, "serialMap", () => o);
    const n = (t) =>
        new Promise((e, r) => {
          let n = new Image();
  ...
  i.register("dk7YQ", function (r, n) {
    t(r.exports, "isFieldHidden", () => l), t(r.exports, "default", () => f);
    var o = i("lSPyV"),
      a = i("yZcwP"),
      s = i("fMrNL");
    const { local: u, sync: c } = s.default,
      l = (t, e, r) => (t.hidden && "function" == typeof t.hidden ? t.hidden(e, r) : t.hidden);
    var f = class {
      getField(t) {
      ...
      async setObj(t) {
        ...
        return (
          Object.entries(t).forEach(([t, n]) => {
            ...
            e(a).ok(i, `no field found for ${o} (${t})`), (r[o] = this._serializeField(i, n));
          }),
      ...
      async get(t) {
        ...
        return this.storage.get(r).then((t) => {
          const r = {};
          return (
            Object.entries(t).forEach(([t, n]) => {
              const o = this.namespacedToField[t];
              e(a).ok(o, `no field found for ${t}`);
  ...
  i.register("69fUi", function (e, r) {
    ...
    function d(t, e, r) {
      ...
      if (K(t, ArrayBuffer) || (t && K(t.buffer, ArrayBuffer))) return m(t, e, r);
      if ("undefined" != typeof SharedArrayBuffer && (K(t, SharedArrayBuffer) || (t && K(t.buffer, SharedArrayBuffer)))) return m(t, e, r);
      ...
      var o = (function (t) {
        ...
        if (void 0 !== t.length) return "number" != typeof t.length || z(t.length) ? p(0) : v(t);
    ...
    (s = f),
      ...
      (h.compare = function (t, e) {
        if (
          (K(t, Uint8Array) && (t = h.from(t, t.offset, t.byteLength)),
          K(e, Uint8Array) && (e = h.from(e, e.offset, e.byteLength)),
      ...
      (h.concat = function (t, e) {
        ...
        for (r = 0; r < t.length; ++r) {
          var i = t[r];
          if (K(i, Uint8Array)) o + i.length > n.length ? h.from(i).copy(n, o) : Uint8Array.prototype.set.call(n, i, o);
          else {
      ...
      (h.prototype.compare = function (t, e, r, n, o) {
        if ((K(t, Uint8Array) && (t = h.from(t, t.offset, t.byteLength)), !h.isBuffer(t)))
    ...
    (h.prototype.slice = function (t, e) {
      ...
      (h.prototype.readFloatLE = function (t, e) {
        return (t >>>= 0), e || D(t, 4, this.length), c.read(this, t, !0, 23, 4);
      }),
      (h.prototype.readFloatBE = function (t, e) {
        return (t >>>= 0), e || D(t, 4, this.length), c.read(this, t, !1, 23, 4);
      }),
      (h.prototype.readDoubleLE = function (t, e) {
        return (t >>>= 0), e || D(t, 8, this.length), c.read(this, t, !0, 52, 8);
      }),
      (h.prototype.readDoubleBE = function (t, e) {
        return (t >>>= 0), e || D(t, 8, this.length), c.read(this, t, !1, 52, 8);
      }),
  ...
  i.register("ivIyE", function (t, e) {
    ...
    function L() {
      for (var t = arguments.length, e = new Array(t), r = 0; r < t; r++) e[r] = arguments[r];
      O.apply(void 0, [L, e.length].concat(e));
    }
    ...
    function A(t, e, n) {
      ...
      for (h = 0; h < x; h++) {
        ...
        if (l.length < h + 1)
          ...
          var I = f[h],
            U = l[h],
            L = U !== I && (!y(U, ",") || U.slice(0, -1) !== I);
          L && y(I, ",") && I.slice(0, -1) === U && ((L = !1), (U += ",")),
            L
              ? (T > 1 &&
                  h > 2 &&
                  (T > 4 ? ((i += "\n".concat(g, "...").concat(b)), (u = !0)) : T > 3 && ((i += "\n  ".concat(l[h - 2])), j++),
  ...
  i.register("jKPza", function (t, e) {
    ...
    function B(t, e, r, i) {
      ...
      if (Array.isArray(t)) {
        ...
        var h = I(t),
          y = I(e);
        return h.length === y.length && $(t, e, r, i, D, h);
      }
      ...
      if (m(t)) {
        ...
        if (v(t)) {
          ...
          var T = I(t),
            L = I(e);
          return T.length === L.length && $(t, e, r, i, M, T);
        }
        if (_(t)) return !(!_(e) || t.size !== e.size) && $(t, e, r, i, N);
    ...
    function $(t, e, o, i, u, l) {
      ...
      if (0 === l.length && (u === M || (u === D && 0 === t.length) || 0 === t.size)) return !0;
              ...
              if (null !== a) {
                for (var d = s(e), y = 0; y < d.length; y++) {
                  ...
                  if ("object" === n(f) && null !== f) {
                    if (!z(a, t, f, v, o, i)) return !1;
                  } else if (!(o || (t.has(f) && B(t.get(f), v, !1, i)) || z(a, t, f, v, !1, i))) return !1;
                }
                return 0 === a.size;
              }
              return !0;
  ...
  i.register("97FLL", function (t, e) {
    ...
    var a = function (t, e) {
      ...
      s = i("duDpq"),
      u = i("69fUi").Buffer,
      c = (void 0 !== r ? r : "undefined" != typeof window ? window : "undefined" != typeof self ? self : {}).Uint8Array || function () {};
    var l,
      f = i("faMnJ");
    ...
    function O(t, e, r) {
      (n = n || i("ilj3k")),
        ...
        (this.decoder = null),
        (this.encoding = null),
        t.encoding && (p || (p = i("lTqX2").StringDecoder), (this.decoder = new p(t.encoding)), (this.encoding = t.encoding));
    }
    function x(t) {
      if (((n = n || i("ilj3k")), !(this instanceof x))) return new x(t);
    ...
    (x.prototype.read = function (t) {
      ...
      (x.prototype.pipe = function (t, e) {
        ...
        var c = (function (t) {
          return function () {
            var e = t._readableState;
            l("pipeOnDrain", e.awaitDrain), e.awaitDrain && e.awaitDrain--, 0 === e.awaitDrain && a(t, "data") && ((e.flowing = !0), N(t));
          };
        })(r);
        t.on("drain", c);
        var f = !1;
          ...
          "data" === t
            ...
            : "readable" === t &&
              (n.endEmitted ||
                ...
                n.length ? T(this) : n.reading || o.nextTick(M, this))),
          r
        );
      }),
      ...
      "function" == typeof Symbol &&
        (x.from = function (t, e) {
          return void 0 === d && (d = i("2kWmT")), d(x, t, e);
        });
  }),
  ...
  i.register("aeAI7", function (t, e) {
    ...
    var s = { deprecate: i("aaAzx") },
      u = i("duDpq"),
      c = i("69fUi").Buffer,
      l = (void 0 !== r ? r : "undefined" != typeof window ? window : "undefined" != typeof self ? self : {}).Uint8Array || function () {};
    var f,
      p = i("eSPuu"),
  ...
  i.register("fMrNL", function (e, r) {
    ...
    class o {
      ...
      constructor(t) {
        (this.areaName = t), (this.storageArea = chrome.storage[t]), (this.formatError = (0, n.genLastErrorFmt)(`Chrome${t}StorageError`));
      }
    }
    const a = { local: new o("local"), sync: new o("sync") };
    var s = a;
  }),
  i.register("5dZ7N", function (e, r) {
  ...
  i.register("aiU1O", function (e, r) {
    t(e.exports, "getReportUrl", () => c), t(e.exports, "getReportUrlAsync", () => l), t(e.exports, "update", () => f);
    var n = i("h4XuO"),
      o = i("2xkva"),
      a = i("7i7LO"),
      s = i("03QYZ");
    a.default.load().catch((t) => o.default.error(t));
    const u = new Set(["url", "error", "type", "opts", "userId", "subState", "metadata"]);
    function c(t) {
      ...
      let { url: e, error: r, type: n, metadata: o, opts: i, userId: c, subState: l } = t;
      (e = e || window.location.href), (i = i || a.default.state);
      let f = r ? (0, s.errorToString)(r) : void 0;
      return n && (f = `[${n}]${f ? " " + f : ""}`), (0, s.reportLink)(e, f, i, c, l, o);
    }
    async function l(t) {
      let e;
      try {
        e = await a.default.load();
      } catch (t) {
        o.default.error(t), (e = { error: (0, s.errorToString)(t) });
      }
      return c({ ...t, opts: p(e) });
    }
    async function f(t, e) {
      const r = (e && e.metadata) || void 0,
        i = await l({ url: window.location.href, error: t, metadata: r });
      let a = "btn-report",
        s = (0, n.$)(a);
      return s ? ((s.href = i), n.$.show("btn-report")) : o.default.error(`No reportElt #${a}`), i;
    }
    const p = (t) => (
      (t = { ...t }),
      Object.entries(a.default.fields).forEach(([e, r]) => {
        if (r.default) {
  ...
  i.register("03QYZ", function (r, n) {
    t(r.exports, "GESTURE_TIMEOUT", () => y),
      t(r.exports, "reportLink", () => v),
      t(r.exports, "toQueryString", () => S),
      t(r.exports, "errorToString", () => m),
      t(r.exports, "asFilename", () => b),
      t(r.exports, "asArray", () => w),
      t(r.exports, "getQueryString", () => _),
      t(r.exports, "addViaToError", () => A),
      t(r.exports, "fullServiceDownload", () => O),
      t(r.exports, "scrollEltTo", () => x);
    var o = i("aQWOf"),
      a = i("eygci"),
      s = i("9X70u"),
      u = i("1BBN9"),
      ...
      p = i("83PZf"),
      h = i("3ESIc");
    const d = "https://screencapture.mrcoles.com/",
      y = 5e3,
      g = (t) => {
        var e = !1;
        try {
      ...
      v = (t, e, r, n, o, i) => {
        const a = (t) => {
            try {
              ...
              c.default.error("Error parsing obj!", t);
            }
            try {
              return JSON.stringify(t);
            } catch (t) {
              c.default.error("Error JSONifying obj!", t);
            }
            return "" + t;
          },
          s = [{ key: "v", val: g((0, h.getVersion)()) }];
        if (
          (t && s.push({ key: "u", val: g(t) }),
          n && s.push({ key: "i", val: g(n) }),
          o && o !== p.SUB_BAD && s.push({ key: "s", val: g(o) }),
          i)
        ) {
          const t = a(i);
          s.push({ key: "m", val: g(t) });
        }
        if (r) {
          const t = a(r);
          s.push({ key: "o", val: g(t) });
        }
        e && s.push({ key: "e", val: g(e) });
        let u = S(s);
        const l = 1600 - d.length - 1;
        return u.length >= l && (u = u.substring(0, l)), d + (u ? "?" + u : "");
      },
      m = (t) => {
        let e;
        return "string" == typeof t
      ...
      b = (t, r) => {
        ...
        let n = e(a).remove(t).split("?")[0].split("#")[0];
        n
          ? ((n = n
              .replace(/^https?:\/\/(www\.)?/, "")
              .replace(/^([^\/]+)\.com/, "$1")
      ...
      w = (t) => Array.prototype.slice.call(t, 0),
      _ = () => E(window.location.search.substring(1)),
      E = (t) => {
        var e = {};
        return (
      ...
      S = (t) => {
        ...
        return (
          Array.isArray(t) ? t.map(({ key: t, val: r }) => e(t) + e(r, !0)) : Object.entries(t).map(([t, r]) => e(t) + e(r, !0))
        ).join("&");
      },
      A = (t, e) => {
        t.via = (t.via ? `${t.via} > ` : "") + e;
      ...
      O = async (t, e = !1, r = !1) => {
        const n = await u.containsDownloads();
        if (n) {
          const o = await f.default.load(),
            i = (!(0, l.getIsMac)() || !(e || t.length > 1)) && (r || o.save_as),
            a = await s.downloadAll(t, o.dir, i);
          let u = a.reduce((t, e) => t + (!1 === e.success ? 1 : 0), 0);
          return { hasPerms: n, results: a, failCount: u, successCount: a.length - u };
        }
        return { hasPerms: n, results: t.map((t) => ({ url: t, success: !1 })) };
      },
      x = (t, e, r) => {
        t.scrollTo && "function" == typeof t.scrollTo ? t.scrollTo(e, r) : ((t.scrollLeft = e), (t.scrollTop = r));
      };
  }),
  i.register("eygci", function (t, e) {
    var r = {
        À: "A",
        Á: "A",
        Â: "A",
  ...
  i.register("9X70u", function (e, r) {
    ...
    const s = "AllowIncognitoNetworkError",
      ...
      c = (t, e, r, n = !1) => {
        const i = { url: t, conflictAction: chrome.downloads.FilenameConflictAction.UNIQUIFY };
        return (
          (r || e) && ((r = r || t.split("/").pop()), e && (r = `${e}/${r}`), (i.filename = r)),
          n && (i.saveAs = !0),
          ((t) =>
            new Promise((e, r) => {
      ...
      l = (t, e, r = !1) => {
        ...
        let i = 0,
          a = 0,
          s = [];
        const u = t.map((t) => ("string" == typeof t ? { url: t } : t));
        return (0, n.serialMap)(u, (t) =>
          c(t.url, e, t.filename, r)
            .then((e) => {
              (a += 1), s.push({ url: t, id: e, success: !0 });
            })
            .catch((e) => {
              (i += 1), s.push({ url: t, error: e, success: !1 });
            })
        ).then(() => {
          if (i && i === o && s.length && !1 === s[0].success) {
            const t = s[0].error;
            throw ((t.message += ` (downloadAll: ${i} of ${o})`), t);
          }
          return s;
        });
      };
  }),
  i.register("hoPfQ", function (e, r) {
    t(e.exports, "isFileUrl", () => o),
      t(e.exports, "isAllowedFileSchemeAccess", () => a),
      t(e.exports, "isAllowedIncognitoAccess", () => s);
    const n = (0, i("5dZ7N").genLastErrorFmt)("ChromeExtensionError"),
      o = (t) => {
        if (!t) return !1;
        try {
  ...
  i.register("1BBN9", function (e, r) {
    ...
    const n = (0, i("5dZ7N").genLastErrorFmt)("ChromePermissionsError"),
  ...
  i.register("83PZf", function (e, r) {
    t(e.exports, "SUB_BAD", () => c), t(e.exports, "default", () => d), t(e.exports, "resetUser", () => y);
    var n = i("aQWOf"),
      o = i("aIWoc"),
      a = i("jmw9X"),
      s = i("2xkva"),
    ...
    const c = "sub-none",
      l = "sub-needs-update",
      f = "sub-ok",
      p = { trialing: f, active: f, past_due: l, canceled: c, unpaid: l, "": c },
      h = (t, ...e) => (0, s.default)(`%c[\\USER//] ${t}`, "color: #0B3;background:#EEFFF3", ...e);
    var d = new (class {
      addListener(t) {
        this._listeners.push(t);
      }
      ...
      async loginStateProm(t) {
        h(`loginStateProm(${JSON.stringify(t)})`);
        const e = await u.default.load();
        h("got items"), (0, s.default)(e);
        let r = this._asLoginState(e.login_data, e);
        if ((h("converted data:"), (0, s.default)(r), r.subState === c)) return h(`BAD SUBSTATE ${r.subState}`), r;
        const o = n.DateTime.now().diff(r.updated, "days").days;
        if ((h(`days since: ${o}`), t && o >= 31 && navigator.onLine)) {
          let t;
          try {
            h("do extra login!!!!"), (t = await this._login()), h("got data!!!!"), (0, s.default)(t);
          } catch (t) {
            throw (s.default.error("Error logging in!"), t);
          }
          t && (r = this._asLoginState(t, e));
        }
        return h("RETURNING DATA!!!"), (0, s.default)(r), r;
      }
      async setWebsiteABState() {
        h("[User.setWebsiteABState] start");
        const t = await u.default.load(),
          e = t.ab;
        ...
        a.call("setAbJson", i), h("[User.setWebsiteABState] did setAbJson");
        let c = 2,
          l = null;
        for (; c > 0; ) {
          c--;
          let t = await a.get("getAbJson");
          h(`[User.setWebsiteABState] did getAbJson: ${t}`);
          try {
            l = JSON.parse(t);
          } catch (t) {
            h("[User -> postmate.getAbJson -> JSON.parse]"), s.default.error(t);
            continue;
          }
          if (l && "object" == typeof l) break;
          h(`[User -> postmate.getAbJson -> object] not object! ${l}`), (l = null);
        }
        l = l || {};
        const f = Object.keys(o).every((t) => t in l);
        return h(`[User.setWebsiteABState] isSet? ${f}: ${JSON.stringify(l)}`), f;
      }
      _asLoginState(t, e) {
        h("[User._asLoginState]", t, e), (t && "object" == typeof t) || s.default.error("INVALID DATA", t);
        const r = Object.assign({}, t);
        ["expires", "updated"].forEach((t) => (r[t] = n.DateTime.fromSeconds(r[t] || 0))), (r.status = r.status || "");
        const o = n.DateTime.now();
        (!r.userId || o > r.expires) && (r.status = "");
        let i = p[r.status];
        return (r.subState = i), (r.store = e), r;
      }
      _getHandshake() {
        return (
          this._handshake ||
            (this._handshake = new (0, o.default)({ container: document.body, url: a.WEBCOMM_URL, classListArray: ["h"] })),
          this._handshake
        );
      }
      async _login() {
        ...
        return (0, s.default)("[PARENT] authState", e), await this.storeLoginData(e), e;
      }
      storeLoginData(t) {
        h("[User.storeLoginData]", t);
        let e = t && t.show_experimental;
        null != e && (delete t.show_experimental, "boolean" != typeof e && (e = null)),
          (t.updated = Math.floor(n.DateTime.now().toSeconds()));
        const r = { login_data: t };
        return t.userId && (r.has_logged_in = !0), null != e && (r.show_experimental = e), u.default.setObj(r);
      }
      constructor() {
        (this._listeners = []),
          u.default.onUpdate((t) => {
            h(`Updated names: ${JSON.stringify(t)}`),
              this.loginStateProm()
                .then((t) => {
                  this._listeners.forEach((e) => e(t));
                })
                .catch((t) => {
                  h("Error loading subscription state!"), s.default.error(t);
                });
          });
      }
    })();
    const y = () => u.default.set("login_data", {});
  }),
  i.register("aIWoc", function (e, r) {
    t(e.exports, "default", () => l);
    /**
...
**/
  ...
  i.register("epmSf", function (e, r) {
    t(e.exports, "default", () => a);
    var n = i("jmw9X");
    const o = new (0, i("dk7YQ").default)("user", {
  ...
  i.register("8ABn4", function (r, n) {
    ...
    p.version(1).stores({ captures: "++id, domain, time" });
    class h {
      static from(t, e, r, n, o, i, a) {
        (e = e || ""), (n = n || 1);
        let s = (0, c.getImageFormat)(r);
        r !== s.key && (l.default.warn(`Wrong case for image format key ${r} vs ${s.key}`), (r = s.key)),
        ...
        let u = {
            ...
            format: r,
            scaleMultiplier: n,
            images: o.map((t) => t.filename),
            sizes: o.map((t) => t.size),
            time: a || new Date(),
            metadata: i
          },
          f = new h();
      ...
      get fullPaths() {
        return this.images.map((t) => u.default.absPath(`/${t}`));
      }
      get fileEntryPaths() {
      ...
      get dateTime() {
        return s.DateTime.fromJSDate(this.time);
      }
      get displayURL() {
        return (
      ...
      save() {
        return p.captures.put(this).then((t) => ((this.id = t), this));
      }
      hackUpdateCreated(t) {
        const e = new Date(),
          r = {},
      ...
      updateScaleMultiplier() {
        e(o).ok(!this.scaleMultiplier, `Should not set scaleMultiplier when already have (${this.id}: ${this.scaleMultiplier})`);
        const t = { scaleMultiplier: window.devicePixelRatio || 1, guessedScale: !0 };
        return p.captures.update(this.id, t).then((e) => {
          if (!e) {
            const t = new Error(`Capture not found for update scale (${this.id})`);
            throw ((t.name = "UpdateCaptureNotFound"), t);
          }
          return Object.entries(t).forEach(([t, e]) => (this[t] = e)), this;
        });
      }
      addEdit(t, r = 0) {
        e(o).number(t, "Capture.addEdit(editId)"),
          e(o).number(r, "Capture.addEdit(..., imageId)"),
          e(o).equal(t, r, `Must make editId (${t}) and imageId (${r}) the same!`);
        const n = new Date(),
          i = { id: t, imageId: r, created: n, updated: n };
        let a, s;
        return (
          this.edits
            ? (e(o).ok(!this.edits[t], `Cannot overwrite existing edit ${t} -> ${JSON.stringify(this.edits[t])}`),
              (a = `edits.${t}`),
              (s = i))
            : ((a = "edits"), (s = []), (s[t] = i)),
          p.captures.update(this.id, { [a]: s }).then((t) => {
            if (!t) {
            ...
            let e = this;
            return (
              a.split(".").forEach((t, r, n) => {
                (t = /^\d+$/.test(t) ? parseInt(t) : t), r === n.length - 1 ? (e[t] = s) : (e = this[t]);
              }),
              this
            );
          })
      ...
      static updateEditState(t, e, r) {
        return p.captures.update(t, { [`edits.${e}.undos`]: r, [`edits.${e}.updated`]: new Date() }).then((e) => {
          if (!e) {
      ...
      remove() {
        return u.default
          .requestFs()
          .then((t) => u.default.getFiles(t, this.fileEntryPaths, !0))
          .then((t) => u.default.rmFiles(t, (t) => (0, l.default)(t)))
          .then(({ succeeded: t, failed: e }) => {
            if (e.length) {
      ...
      static lookup(t) {
        return p.captures.get(d(t));
      }
      static lookupIds(t) {
        return (t = t.map((t) => d(t))), p.captures.where("id").anyOf(t).toArray();
      }
      static findSrc(t) {
        return p.captures
          .toCollection()
    ...
    const d = (t) => ("string" == typeof t && /^\d+$/.test(t) ? parseInt(t, 10) : t),
      y = (t, e, r) => {
        if (!t) {
  ...
  i.register("kUsEG", function (e, n) {
    ...
    (Z.ModifyError = z), (Z.DexieError = K), (Z.BulkError = H);
    var ct = {},
      lt = 100,
      ft = 7,
      pt = (function () {
    ...
    function Lt(t) {
      ...
      var e = (this._PSD = Rt);
      if ((D && ((this._stackHolder = q()), (this._prev = null), (this._numPrev = 0)), "function" != typeof t)) {
        if (t !== ct) throw new TypeError("Not a function");
        return (this._state = arguments[1]), (this._value = arguments[2]), void (!1 === this._state && Nt(this, this._value));
      }
      (this._state = null), (this._value = null), ++e.ref, Dt(this, t);
    }
    var Ft = {
      get: function () {
        var t = Rt,
        ...
        function r(r, n) {
          ...
          i && oe();
          var a = new Lt(function (e, a) {
            Bt(o, new Mt(fe(r, t, i), fe(n, t, i), e, a, t));
          });
          return D && Wt(a, this), a;
        }
          ...
          function (e) {
            if (null === t._state) {
              ...
              e && "function" == typeof e.then
                ? Dt(t, function (t, r) {
                    e instanceof Lt ? e._then(t, r) : e.then(t, r);
                  })
    ...
    function qt(t, e, r) {
      try {
        ...
        (kt = null), 0 == --It && zt(), --r.psd.ref || r.psd.finalize();
      }
    }
    function $t(t, e, r) {
      ...
      return D && ((n = $(t._stackHolder, 2)) && -1 === e.indexOf(n) && e.push(n), t._prev && $t(t._prev, e, r)), e;
    }
    function Wt(t, e) {
    ...
    f(Lt.prototype, {
      then: Ft,
      _then: function (t, e) {
        Bt(this, new Mt(null, null, t, e, Rt));
      },
      catch: function (t) {
      ...
      "undefined" != typeof Symbol && Symbol.toStringTag && h(Lt.prototype, Symbol.toStringTag, "Promise"),
      (Pt.env = ce()),
      f(Lt, {
        all: function () {
          var t = M.apply(null, arguments).map(ie);
          return new Lt(function (e, r) {
            0 === t.length && e([]);
            var n = t.length;
            t.forEach(function (o, i) {
              return Lt.resolve(o).then(function (r) {
                (t[i] = r), --n || e(t);
              }, r);
            });
          });
    ...
    function re(t, e, r, n) {
      ...
      (i.env = bt
        ? {
            Promise: Lt,
            PromiseProp: { value: Lt, configurable: !0, writable: !0 },
            all: Lt.all,
            race: Lt.race,
            resolve: Lt.resolve,
            reject: Lt.reject,
    ...
    function ae(t) {
      ++te, (Yt.echoes && 0 != --Yt.echoes) || (Yt.echoes = Yt.id = 0), Qt.push(Rt), ue(t, !0);
    }
    function se() {
    ...
    function ue(t, e) {
      var r,
        n = Rt;
      if (
        ((e ? !Yt.echoes || (Zt++ && t === Rt) : !Zt || (--Zt && t === Rt)) || ((r = e ? ae.bind(null, t) : se), gt.call(ht, r)),
    ...
    function Pe(t, e) {
      ...
      function lt(t, e, r) {
        var n = Y._createTransaction(J, L, R);
          ...
          (Rt.trans = n),
            0 === t
              ...
              : (function (t, e, r) {
                  ...
                  function u() {
                    return n.length ? Lt.resolve(n.shift()(e.idbtrans)).then(u) : Lt.resolve();
                  }
                  return (
      ...
      function yt(t, e, r) {
        (this.name = t),
          (this.schema = e),
          (this._tx = r),
          (this.hook = N[t] ? N[t].hook : ge(null, { creating: [ot, tt], reading: [rt, et], updating: [at, tt], deleting: [it, tt] }));
      }
      function gt(t, e, r) {
      ...
      function wt(t, e, r, n) {
        ...
        (this.db = Y),
          ...
          (this._spinCount = 0),
          (this._completion = new Lt(function (t, e) {
      ...
      (this.version = function (t) {
        ...
        s(ct.prototype, {
          stores: function (t) {
            ...
            return (
              ...
              (R = Y._dbSchema = r),
              [N, Y, wt.prototype].forEach(function (t) {
                for (var e in t) t[e] instanceof yt && delete t[e];
              }),
              Ot([N, Y, wt.prototype, this._cfg.tables], o(r), r),
              (L = o(r)),
              this
            );
          },
                  ...
                  o = (function (t) {
                    ...
                    return (
                      t.split(",").forEach(function (t) {
                        ...
                        e.push(new Ne(r, n || null, /\&/.test(t), /\*/.test(t), /\+\+/.test(t), i(n), /\./.test(t)));
                      }),
                      e
                    );
                  })(t[r]),
        ...
        (this.open = function () {
          ...
          D && (Z._stackHolder = q()), (W = !0), (B = null), (V = !1);
          var e = r,
            n = null;
          return Lt.race([
            Z,
              ...
              (i.onerror = Ue(r)),
                ...
                (i.onupgradeneeded = Jt(function (e) {
                  if (((n = i.transaction), nt && !Y._allowEmptyDB)) {
                    (i.onerror = Me), n.abort(), i.result.close();
                ...
                (i.onsuccess = Jt(function () {
                  if (((n = null), (C = i.result), Ae.push(Y), nt))
                    !(function () {
                      if (((Y.verno = C.version / 10), (Y._dbSchema = R = {}), 0 === (L = m(C.objectStoreNames, 0)).length)) return;
                      var t = C.transaction(Be(L), "readonly");
                      L.forEach(function (e) {
                        for (
                          var r = t.objectStore(e),
                            n = r.keyPath,
                            o = n && "string" == typeof n && -1 !== n.indexOf("."),
                            i = new Ne(n, n || "", !1, !1, !!r.autoIncrement, n && "string" != typeof n, o),
                            a = [],
                            s = 0;
                          ...
                          var c = new Ne(u.name, n, !!u.unique, !!u.multiEntry, !1, n && "string" != typeof n, o);
                          a.push(c);
                        }
                        R[e] = new Ce(e, i, a, {});
                      }),
                    ...
                    try {
                      Mt(R, C.transaction(Be(C.objectStoreNames), K));
                    } catch (t) {}
            ...
            .then(function () {
              return (
                (G = []),
                Lt.resolve(Pe.vip(Y.on.ready.fire)).then(function t() {
                  if (G.length > 0) {
                    var e = G.reduce(ut, tt);
                    return (G = []), Lt.resolve(Pe.vip(e)).then(t);
                  }
                })
              );
            })
        ...
        (this._transaction = function (t, e, r) {
          ...
          function a() {
            return Lt.resolve().then(function () {
              ...
              var u = Lt.follow(function () {
                if ((e = r.call(a, a)))
                  if (e.constructor === vt) {
                    var t = oe.bind(null, null);
                    e.then(t, t);
                  } else "function" == typeof e.next && "function" == typeof e.throw && (e = De(e));
              }, s);
              return (
                e && "function" == typeof e.then
                  ? Lt.resolve(e).then(function (t) {
        ...
        (this.table = function (t) {
          if (!l(N, t)) throw new X.InvalidTable("Table " + t + " does not exist");
          return N[t];
        }),
        f(yt.prototype, {
          ...
          get: function (t, e) {
            ...
            var r = this;
            return this._idbstore(K, function (e, n, o) {
              var i = o.get(t);
              (i.onerror = Ue(n)),
                (i.onsuccess = Jt(function () {
            ...
            return this._idbstore(
              ...
              function (n, o, i) {
                ...
                if (r.hook.creating.fire === tt && r.hook.updating.fire === tt) {
                  ...
                  (a.onerror = gt(c, u)), (a.onsuccess = Le(u));
                } else {
                  var d =
                      e ||
                      (i.keyPath &&
          ...
          bulkAdd: function (t, e) {
            ...
            return this._idbstore(J, function (o, i, a, s) {
              ...
              if (n !== tt) {
                ...
                (c.onerror = gt(p, u)), (c.onsuccess = Le(u));
              }
            });
          },
          add: function (t, e) {
        ...
        f(wt.prototype, {
          ...
          create: function (t) {
            ...
            return (
              ...
              ((t = this.idbtrans = t || C.transaction(Be(this.storeNames), this.mode)).onerror = Jt(function (r) {
                Me(r), e._reject(t.error);
              })),
              (t.onabort = Jt(function (r) {
                Me(r), e.active && e._reject(new X.Abort(t.error)), (e.active = !1), e.on("abort").fire(r);
              })),
          ...
          waitFor: function (t) {
            var e = this._root();
            if (((t = Lt.resolve(t)), e._waitingFor))
          ...
          table: function (t) {
            return new yt(t, Y.table(t).schema, this);
          }
        }),
        ...
        f(Et.prototype, function () {
          ...
          return {
            _read: function (t, e) {
              var r = this._ctx;
              return r.error ? r.table._trans(null, ye.bind(null, r.error)) : r.table._idbstore(K, t).then(e);
            },
            _write: function (t) {
              var e = this._ctx;
            ...
            primaryKeys: function (t) {
              ...
              if (u && "next" === e.dir && St(e, !0) && e.limit > 0)
                return this._read(function (t, n, o) {
                  ...
                  (a.onerror = Ue(n)), (a.onsuccess = Le(t));
                }).then(t);
              e.keysOnly = !e.isMatch;
              var n = [];
              return this.each(function (t, e) {
            ...
            modify: function (t) {
              ...
              return this._write(function (r, a, u, c) {
                ...
                var y = 0,
                  ...
                  w = null;
                function _(t) {
                  return t && (m.push(t), b.push(w)), a(new z("Error modifying one or more objects", m, g, b));
                }
                function E() {
    ...
    function Ue(t) {
      return Jt(function (e) {
        return Me(e), t(e.target.error), !1;
      });
    }
    function Le(t) {
      return Jt(function (e) {
    ...
    function De(t) {
      ...
      function o(t) {
        return function (e) {
          var o = t(e),
            a = o.value;
          return o.done ? a : a && "function" == typeof a.then ? a.then(r, n) : i(a) ? Lt.all(a).then(r, n) : r(a);
        };
      }
      return o(e)();
    }
    ...
    function Ce(t, e, r, n) {
      (this.name = t),
        (this.primKey = e || new Ne()),
        (this.indexes = r || [new Ne()]),
    ...
    N(D, je),
      ...
      f(Pe, {
        ...
        async: function (t) {
          return function () {
            try {
              var e = De(t.apply(this, arguments));
              return e && "function" == typeof e.then ? e : Lt.resolve(e);
            } catch (t) {
              return ye(t);
            }
          };
        ...
        spawn: function (t, e, r) {
          try {
            var n = De(t.apply(r, e || []));
            return n && "function" == typeof n.then ? n : Lt.resolve(n);
          } catch (t) {
            return ye(t);
          }
        },
        ...
        waitFor: function (t, e) {
          var r = Lt.resolve("function" == typeof t ? Pe.ignoreTransaction(t) : t).timeout(e || 6e4);
      ...
      (Lt.rejectionMapper = function (t, e) {
        if (!t || t instanceof K || t instanceof TypeError || t instanceof SyntaxError || !t.name || !Q[t.name]) return t;
  ...
  i.register("gstfn", function (e, r) {
    t(e.exports, "canvasToBlob", () => o), t(e.exports, "blobToUrl", () => a), t(e.exports, "revokeObjectUrl", () => s);
    var n = i("2xkva");
    async function o(t, e, r) {
      return (
        ...
        window.HTMLCanvasElement && HTMLCanvasElement.prototype.toBlob
          ? new Promise((n) => t.toBlob((t) => n(t), e, r))
          : new Promise((n) => {
              n(
                (function (t) {
    ...
    function s(t) {
      if (t && URL.revokeObjectURL)
        try {
          ...
          n.default.error("Unable to revoke object URL"), n.default.error(t);
        }
    }
  }),
  i.register("8P88O", function (e, r) {
...
//# sourceMappingURL=popup.1d266e0e.js.map
