...
null == n &&
  ...
  n.register("3A0PR", function (t, o) {
    e(t.exports, "ERROR_TYPE", () => s),
      e(t.exports, "getZoom", () => i),
      e(t.exports, "captureVisibleTab", () => l),
      e(t.exports, "isCaptureVisibleTabQuotaError", () => c),
      e(t.exports, "executeScript", () => d),
      e(t.exports, "isExecuteScriptChromeError", () => m),
      e(t.exports, "sendMessage", () => h),
      e(t.exports, "getCurrentTab", () => u),
      e(t.exports, "openInTabs", () => f);
    var r = n("5dZ7N");
    const s = "ChromeTabsError",
      a = (0, r.genLastErrorFmt)(s),
      i = (e) =>
        new Promise((t, o) => {
          chrome.tabs.getZoom(e, (e) => {
            const r = chrome.runtime.lastError;
            return r ? o(a(r, "getZoom")) : t(e);
          });
        }),
      l = (e, t) =>
        new Promise((o, r) => {
          chrome.tabs.captureVisibleTab(e, t, (e) => {
            ...
            return t ? r(a(t, "captureVisibleTab")) : o(e);
          });
        }),
      c = (e) =>
        e &&
      ...
      d = (e, t) =>
        new Promise((o, r) => {
          chrome.tabs.executeScript(e, t, (e) => {
            const t = chrome.runtime.lastError;
            return t ? r(a(t, "executeScript")) : o(e);
          });
        }),
      m = (e) =>
        e &&
      ...
      h = (e, t, o) =>
        new Promise((r, n) => {
          chrome.tabs.sendMessage(e, t, o, (e) => {
            const t = chrome.runtime.lastError;
            return t ? n(a(t, "sendMessage")) : r(e);
          });
        }),
      u = () => {
      ...
      f = async (e, t) => {
        ...
        const n = (s) => {
          ...
          return e.incognito && 0 === s
            ? ((c = { url: i, incognito: !1, focused: l }),
              new Promise((e, t) => {
                chrome.windows.create(c, (o) => {
                  const r = chrome.runtime.lastError;
                  return r ? t(a(r, "windowsCreate")) : e(o);
                });
              })).then((e) => ((o = e.id), n(s + 1)))
            : ((e) =>
                new Promise((t, o) => {
                  chrome.tabs.create(e, (e) => {
                    const r = chrome.runtime.lastError;
                    return r ? o(a(r, "create")) : t(e);
                  });
                }))({ url: i, active: l, windowId: o, openerTabId: e.id, index: (e.incognito ? 0 : e.index) + 1 + s }).then((e) =>
                n(s + 1)
              );
          var c;
        };
...
var s = n("aQWOf"),
  ...
  h = n("iMjBX"),
  u = n("9X70u");
(c = n("3A0PR")), (a = n("jmw9X")), (m = n("h4XuO"));
var f = {
    [u.ERROR_INCOGNITO_NETWORK_NAME]: {
      ...
      buttons: () => {
        ...
        return (
          ...
          m.$.on(t, "click", (t) => {
            t.preventDefault(), (0, c.getCurrentTab)().then((t) => (0, c.openInTabs)(t, [e]));
          }),
          [t]
        );
      }
...
function P(e) {
  ...
  b.default.error(t),
    e && e.stack && (0, b.default)(e.stack),
    C(() => m.$.hidden("loading"))
      .then(() => {
        m.$.show("close");
        const t = F(),
          o = e && e.name === i.ERROR_TYPES.CHROME_TABS && ("executeScript" === e.via || ("captureVisibleTab" === e.via && x.isOwnUrl(t))),
          r = e && e.name === O;
        if (o) {
          let o = x.getMatch(t),
            r = (0, m.$)("invalid-desc-detail");
          if (!r.dataset.default) {
            const e = (0, h.tr)(
              ...
              null,
              [a.CUR_BROWSER_INFO.browser_protocol],
              { browser_protocol: { content: "$1", example: "chrome://" } }
            );
            r.dataset.default = e;
          }
          return (
            (r.textContent = o ? o.explanation : r.dataset.default),
            ((n = e), N("invalid-link", n)).then(() => {
              o || B(), m.$.show("invalid");
            })
          );
        }
        if (r) {
          const e = (0, m.$)("expired-beta");
          e.textContent = "This test version has expired. Please reach out to get an update or switch over to the proper extension in the";
          const t = document.createElement("a");
          Object.assign(t, {
            targt: "_blank",
            rel: "noopener noreferrer",
            href: a.CUR_BROWSER_INFO.store_url,
            textContent: a.CUR_BROWSER_INFO.store
          }),
          ...
          {
            let t = f[e.name];
            ((0, m.$)("generic-error-title").innerText = t.title), ((0, m.$)("generic-error-body").innerText = t.body);
            let o = (0, m.$)("generic-error-buttons");
            m.$.empty(o),
              t.buttons &&
                t.buttons().forEach((e) => {
                  o.appendChild(e);
                }),
              m.$.show("generic-error");
          }
        }
        var n;
      })
...
function I(e) {
  ...
  ((0, m.$)("bar").style.width = t + "%"), ((0, m.$)("dots").style.width = 100 - t + 2 + "%");
}
function A(e) {
  return N("report-link", e);
}
function N(e, t) {
  return (0, _.getReportUrlAsync)({ url: F(), error: t })
    .then((t) => ((0, m.$)(e).setAttribute("href", t), t))
    .catch((e) => b.default.error(e));
}
function B() {
  (0, m.$)("invalid").classList.add("show-desc");
}
function F() {
  return S ? S.url : window.location.href;
}
if ("?test" === window.location.search)
  (window._progress = I),
    I(0.18),
    (0, $.asArray)(document.querySelectorAll("#wrap > div")).forEach((e) => {
  ...
  window.addEventListener("load", function () {
    m.$.on((0, m.$)("invalid-desc-a"), "click", (e) => {
      e.preventDefault(), B();
    }),
      m.$.on((0, m.$)("close"), "click", (e) => {
        e.preventDefault(), window.close();
      }),
      m.$.findClass("fp-btn", (0, m.$)("frame-perms")).forEach((e) => {
        let t = e.dataset.action;
        m.$.on(e, "click", (e) => {
          p.trigger("clicked", { action: t }), m.$.hide("frame-perms"), m.$.show("loading");
        });
      }),
      p.on("needFramePermsClick", (e) => {
        let t = "frame-perms-iframe",
          o = "frame-perms-frame",
          [r, n] = "iframe" === e.tagName ? [t, o] : [o, t];
        m.$.hide(n), m.$.show(r, "inline"), m.$.hide("loading"), m.$.show("frame-perms");
        let s = document.querySelector("#frame-perms .button-primary");
        s && s.focus();
      });
    let e = `${a.CUR_BROWSER_INFO.browser_protocol}extensions/?id=${chrome.runtime.id}`;
    m.$.findClass("ext-link", (0, m.$)("file-perms")).forEach((t) => {
      m.$.on(t, "click", () => {
        let t = { url: e };
        S && !S.incognito && (t.index = S.index + 1), chrome.tabs.create(t);
      });
    }),
      p.on("needFilePermsClick", () => {
        m.$.hide("loading"), m.$.show("file-perms");
      ...
      c
        ...
        .then((e) => {
          if (((S = e), "beta" === T && k)) {
            const e = s.DateTime.fromSeconds(k);
            if (s.DateTime.now().diff(e, "days").days > 90) {
        ...
        .then(async () => {
          try {
            L = await c.getZoom(S.id);
          } catch (e) {
            console.error("Error getting zoom", e);
          }
          (U = await E.default.load()),
            U.auto_dl2 &&
              ((await l.contains(l.PERMISSIONS.DOWNLOADS)) ||
                ((U.auto_dl2 = !1), (U.auto_dl_was_disabled = !0), await E.default.remove("auto_dl2")));
        })
        .then(() => A())
        .then(() => {
          U.auto_dl2
            ...
            : U.auto_dl_was_disabled &&
              C().then(() => {
                m.$.show("auto-dl-was-disabled");
              }),
            (function (e) {
              let t = m.$.findClass("frame_persist-toggle", (0, m.$)("frame-perms"))[0],
                o = t.getElementsByClassName("frame_persist-input")[0],
                r = t.getElementsByClassName("frame_persist-text")[0],
                n = "frame_persist",
                s = E.default.getField(n);
              (o.checked = e[n]),
                (r.innerText = s.help),
                m.$.on(o, "change", function (e) {
        ...
        .then(() => {
          ...
          if (e.startsWith(t) && [".jpg", ".png"].some((t) => e.endsWith(t))) return d.Capture.findSrc(e.split("/").pop());
        })
        .then((e) => {
          if (e) return e;
          const t = S.url || "about:blank",
            o = S.title,
            r = (0, g.getImageFormat)(U.fmt);
          U.fmt_details = r;
          const n = (0, $.asFilename)(t, r.ext);
          return i
            .captureToFiles(
              S,
              n,
              ...
              (e) => {
                m.$.show("split-image"),
                  ((0, m.$)("screenshot-count").innerText = e),
                  e > 10 &&
                    window.setTimeout(() => {
                      m.$.show("split-image-extra");
                    }, 2e3);
              },
              U
            )
            .then(({ files: e, scaleMultiplier: r, metadata: n }) => {
              if (!e || !e.length) {
                let t = new Error("No files passed to `displayCaptures` " + e);
                throw ((t.name = "NoFiles"), t);
              }
              return (
                (n = n || {}),
                1 !== L && (n.z = L),
                (n.ww && n.ww === S.width) || (n.tw = S.width),
                (n.wh && n.wh === S.height) || (n.th = S.height),
                i.filesToRecord(t, o, U.fmt, r, e, n)
              );
            });
        })
        .then((e) => (0, y.sleep)(U.auto_dl_was_disabled ? 2e3 : 0).then(() => e))
        .then((e) =>
          U && U.auto_dl2
            ? (async function (e) {
                const { hasPerms: t, results: o, failCount: r } = await (0, $.fullServiceDownload)(e, !0);
                if (!t) {
                  const e = new Error("Does not have permission.");
                  throw ((e.name = "ChromePermissions"), e);
                }
                if (r) throw o.find((e) => !1 === e.success).error;
                await (0, y.sleep)(2e3), window.close();
              })(e.fullPaths)
            : c.openInTabs(S, [e.displayURL])
        )
        .catch((e) => P(e));
  });
//# sourceMappingURL=popup.55a0b113.js.map
