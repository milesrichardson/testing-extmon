...
null == n &&
  ...
  n.register("5Notz", function (a, i) {
    e(a.exports, "getMaxVersion", () => l), e(a.exports, "getEmojiMaxSize", () => _), e(a.exports, "default", () => u);
    var o = n("ecsdh"),
      t = n("flY67");
    let r = null;
    const _ = () => {
        ...
        a > 0 &&
          f(t).groups.forEach(({ group: f, subgroups: o }) => {
            ...
            o.forEach(({ subgroup: f, emojis: e }) => {
              e.forEach(([e, o, t]) => {
                "2603" === e && (e = `${e}_fe0f`), t <= a && !i.has(e) && n.push({ code: e, name: o, text: c(e), subgroup: f });
              });
            }),
  ...
  n.register("2OdSy", function (a, i) {
    ...
    class u extends r.Component {
      ...
      render() {
        ...
        const { width: e, height: a } = this.state,
          i = Object.assign(
            {
              position: "fixed",
              top: 0,
        ...
        return f(r).createElement("canvas", { ref: this.canvasRef, style: i, width: e, height: a });
      }
      constructor(e) {
        super(e),
    ...
    class h {
      ...
      constructor(f, e, a = 128) {
        (this.rnd = f.rnd), (this.emojis = e), (this.ctxSize = a), (this.ctxs = []);
        const i = (0, l.getIsWindows)();
        this.emojis.forEach((f) => {
          ...
          (e.fillStyle = `hsl(${this.rnd.int(360)},90%,50%)`),
            ...
            (e.textAlign = "center"),
            (e.font = `${o}px ${d.FONT_FAMILY_EMOJIS}`),
...
//# sourceMappingURL=welcome.27842977.js.map
