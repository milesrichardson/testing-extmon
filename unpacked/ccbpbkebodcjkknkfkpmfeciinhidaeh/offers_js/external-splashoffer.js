      ...
      function (e, r, n) {
        ...
        !(function (e) {
          if (!window._fixBrokenFirefoxLinksApplied) {
            ...
            var r = navigator.userAgent.match(/Firefox\/(\d+)/);
            !r ||
              parseInt(r[1], 10) < 53 ||
              (chrome &&
                chrome.runtime &&
                chrome.runtime.sendMessage &&
                $(e).on("click", "a[target=_blank][href]", function (e) {
                  e.preventDefault(),
                    chrome.runtime.sendMessage({ publish: "navigate", message: { url: e.currentTarget.href, as_separate: !0 } });
                }));
          }
        })(document.body);
      },
