...
!(function e(t, n, i) {
...
})(
  {
    1: [
      ...
      { "core-js/modules/es6.array.iterator.js": 75, "core-js/modules/web.dom.iterable.js": 77 }
    ],
    2: [
      function (e, t, n) {
        t.exports = {
    ...
    3: [
      function (e, t, n) {
        t.exports = {
          ...
          lb_unsafe_content_bar_warning: "Avira Safe Shopping hat das Laden unsicherer Inhalte auf dieser Webseite verhindert.",
          ...
          lb_help: "Hilfe",
          lnk_abs_landing: "http://www.avira.com/safeshopping-ftu",
    ...
    4: [
      function (e, t, n) {
        t.exports = {
          ...
          lb_unsafe_content_bar_warning: "Avira Safe Shopping prevented unsafe content from loading on this webpage.",
    ...
    5: [
      function (e, t, n) {
        t.exports = {
          ...
          lb_unsafe_content_bar_warning: "Avira Safe Shopping ha evitado que se cargue contenido no seguro en esta página web.",
    ...
    6: [
      function (e, t, n) {
        t.exports = {
          ...
          lb_unsafe_content_bar_warning: "Avira Safe Shopping a empêché le chargement de contenu dangereux sur cette page Web.",
    ...
    7: [
      function (e, t, n) {
        t.exports = {
          ...
          lb_unsafe_content_bar_warning: "Avira Safe Shopping ha impedito il caricamento di contenuti non sicuri su questa pagina web.",
    ...
    8: [
      function (e, t, n) {
        t.exports = {
          ...
          lb_unsafe_content_bar_warning: "Avira Safe Shopping は、このウェブページでの安全でないコンテンツの読み込みを回避しました。",
    ...
    9: [
      function (e, t, n) {
        t.exports = {
          ...
          lb_unsafe_content_bar_warning: "Avira Safe Shopping voorkwam dat er onveilige inhoud op deze webpagina werd geladen.",
    ...
    10: [
      function (e, t, n) {
        t.exports = {
          ...
          lb_unsafe_content_bar_warning: "O Avira Safe Shopping evitou o carregamento de conteúdo inseguro nesta página da Web.",
      ...
      function (e, t, n) {
        t.exports = {
          ...
          lb_unsafe_content_bar_warning:
            "Средство Avira Safe Shopping предотвратило загрузку небезопасного содержимого на этой веб-странице.",
    ...
    12: [
      function (e, t, n) {
        t.exports = {
          ...
          lb_unsafe_content_bar_warning: "Avira Safe Shopping bu web sayfasında güvenli olmayan içeriğin yüklenmesini engelledi.",
    ...
    13: [
      function (e, t, n) {
        t.exports = {
          ...
          lb_unsafe_content_bar_warning: "Avira 安全购物防止在此网页上加载不安全的内容。",
    ...
    14: [
      function (e, t, n) {
        t.exports = {
          ...
          lb_unsafe_content_bar_warning: "Avira Safe Shopping 可防止此網頁載入不安全的內容。",
    ...
    22: [
      ...
      { "./assertThisInitialized.js": 15, "@babel/runtime/helpers/typeof": 24 }
    ],
    23: [
      function (e, t, n) {
        function i(e, n) {
            ...
            !(function (i) {
              ...
              n.extend(g.prototype, a, {
                ...
                destroy: function (e) {
                  ...
                  var o = !1;
                  return this.isNew() ? n.defer(e.success) : (U(this, e), (o = this.sync("delete", this, e))), r || s(), o;
                },
                url: function () {
                  ...
                  if (null != e) {
                    ...
                    for (o = 0; o < e.length; o++) {
                      ...
                      if (m) {
                        if (f && s !== m) {
                          ...
                          t.parse && (y = m.parse(y, t)), m.set(y, t), c.push(m), b && !h && (h = m.hasChanged(g));
                        }
                    ...
                    if (
                      (a.length && x
                        ...
                        : l.length && (b && (h = !0), w(this.models, l, null == r ? this.length : r), (this.length = this.models.length)),
                    ...
                    t[i] &&
                      (e.prototype[i] = (function (e, t, n, i) {
                        switch (t) {
                          ...
                          case 3:
                            return function (t, r) {
                              return e[n](this[i], I(t, this), r);
                            };
                          case 4:
                            return function (t, r, s) {
                              return e[n](this[i], I(t, this), r, s);
                            };
                          default:
                            return function () {
        ...
        this.ciuvoSDK = (function () {
          ...
          return (
                ...
                if (e) {
                  for (
                    o = (e = e.split("/")).length - 1,
                      u.nodeIdCompat && p.test(e[o]) && (e[o] = e[o].replace(p, "")),
              ...
              (o = function (e, t) {
                ...
                (r = function (e, n, i, r) {
                  var s,
                    ...
                    k = [],
                    x = typeof i;
                  if (((b = w((r = r || e))), "undefined" == x || "function" == x)) {
                    for (n = !n.length && i.length ? ["require", "exports", "module"] : n, p = 0; p < n.length; p += 1)
                      if ("require" === (u = (f = o(n[p], b)).f)) k[p] = a.require(e);
                      else if ("exports" === u) (k[p] = a.exports(e)), (y = !0);
                      else if ("module" === u) s = k[p] = a.module(e);
                      else if (h(l, u) || h(c, u) || h(d, u)) k[p] = v(u);
                      else {
                        if (!f.p) throw new Error(e + " missing " + u);
                        f.p.load(f.n, g(r, !0), m(u), {}), (k[p] = l[u]);
                      }
                    (_ = i ? i.apply(l[e], k) : void 0),
                      e && (s && s.exports !== t && s.exports !== l[e] ? (l[e] = s.exports) : (_ === t && y) || (l[e] = _));
                  } else e && (l[e] = i);
                }),
                (e =
                  n =
                  s =
                    function (e, n, i, l, c) {
                      if ("string" == typeof e) return a[e] ? a[e](n) : v(o(e, w(n)).f);
                      if (!e.splice) {
                ...
                (n.prototype = new t()),
                {
                  ...
                  parse: function (t) {
                    var n,
                      ...
                      _ = /^[\n\r\u2028\u2029]/,
                      f = { type: "class", value: "[\\n\\r\\u2028\\u2029]", description: "[\\n\\r\\u2028\\u2029]" },
                      p = { type: "other", description: "end of line" },
                      h = "\n",
                      ...
                      H = { type: "other", description: "Assignment Operator" },
                      W = "=",
                      ...
                      fe = { type: "other", description: "No-op Statement" },
                      pe = ";",
                      ...
                      je = /^[a-zA-Z_]/,
                      Ie = { type: "class", value: "[a-zA-Z_]", description: "[a-zA-Z_]" },
                      qe = function (e) {
                        return e.join("");
                      },
                      Pe = function (e, t) {
                      ...
                      Ot = "0",
                      Rt = { type: "literal", value: "0", description: '"0"' },
                      Lt = function (e, t) {
                        return e + t;
                      },
                      Bt = function (e) {
                      ...
                      Dt = /^[1-9]/,
                      Ht = { type: "class", value: "[1-9]", description: "[1-9]" },
                      Wt = function (e, t) {
                        return e + t;
                      },
                      Ft = /^[eE]/,
                      Ut = { type: "class", value: "[eE]", description: "[eE]" },
                      Vt = /^[\-+]/,
                      ...
                      yn = "u",
                      wn = { type: "literal", value: "u", description: '"u"' },
                      kn = function (e, t) {
                      ...
                      jn = "false",
                      In = { type: "literal", value: "false", description: '"false"' },
                      qn = "for",
                      Pn = { type: "literal", value: "for", description: '"for"' },
                      On = "in",
                      Rn = { type: "literal", value: "in", description: '"in"' },
                      Ln = "if",
                      Bn = { type: "literal", value: "if", description: '"if"' },
                      Mn = "null",
                      Nn = { type: "literal", value: "null", description: '"null"' },
                      Dn = "return",
                      Hn = { type: "literal", value: "return", description: '"return"' },
                      Wn = "true",
                      Fn = { type: "literal", value: "true", description: '"true"' },
                      Un = "require",
                        ...
                        (n = (function () {
                          ...
                          return (
                            (e = (function () {
                              var e, n, i, s, o, a;
                              if (((e = Xn), (n = hi()) !== r)) {
                                for (i = [], s = Xn, s = (o = pi()) !== r && (a = hi()) !== r ? (o = [o, a]) : ((Xn = s), r); s !== r; )
                                  i.push(s), (s = Xn), (s = (o = pi()) !== r && (a = hi()) !== r ? (o = [o, a]) : ((Xn = s), r));
                                e =
                                  i !== r &&
                                  (s = pi()) !== r &&
                                  (o = (function () {
                                    ...
                                    return (
                                      ...
                                      (e =
                                        (function () {
                                          var e;
                                          return t.substr(Xn, 6) === Dn ? ((e = Dn), (Xn += 6)) : ((e = r), 0 === Qn && ti(Hn)), e;
                                        })() !== r &&
                                        pi() !== r &&
                                        (n = gi()) !== r &&
                                        _i() !== r
                    ...
                    function si() {
                      ...
                      return (
                        ...
                        e === r &&
                          (e = (function () {
                            var e;
                            return O.test(t.charAt(Xn)) ? ((e = t.charAt(Xn)), Xn++) : ((e = r), 0 === Qn && ti(R)), e;
                          })()),
                        Qn--,
                        e === r && 0 === Qn && ti(c),
                        e
                    ...
                    function oi() {
                      var e;
                      return _.test(t.charAt(Xn)) ? ((e = t.charAt(Xn)), Xn++) : ((e = r), 0 === Qn && ti(f)), e;
                    }
                    function ai() {
                      var e;
                      return (
                        ...
                        e === r &&
                          ...
                          e === r &&
                            (13 === t.charCodeAt(Xn) ? ((e = v), Xn++) : ((e = r), 0 === Qn && ti(y)),
                            e === r &&
                              (8232 === t.charCodeAt(Xn) ? ((e = w), Xn++) : ((e = r), 0 === Qn && ti(k)),
                    ...
                    function ui() {
                      var e, n, i, s, o, a;
                      if (((e = Xn), t.substr(Xn, 2) === j ? ((n = j), (Xn += 2)) : ((n = r), 0 === Qn && ti(I)), n !== r)) {
                        for (
                          i = [],
                            o = s = Xn,
                            Qn++,
                    ...
                    function _i() {
                      ...
                      return (
                        (e = Xn),
                        (e = (n = fi()) !== r && (i = ai()) !== r ? (n = [n, i]) : ((Xn = e), r)) === r &&
                          ((e = Xn),
                          (e =
                            (n = fi()) !== r
                              ? ((i = Xn),
                                Qn++,
                                125 === t.charCodeAt(Xn) ? ((s = L), Xn++) : ((s = r), 0 === Qn && ti(B)),
                                Qn--,
                        ...
                        (e = (function () {
                                ...
                                ? ((i = ki()) === r && (i = null),
                                  ...
                                  (s = (function () {
                                    ...
                                    return (
                                      Qn++,
                                      (e = Xn),
                                      61 === t.charCodeAt(Xn) ? ((n = W), Xn++) : ((n = r), 0 === Qn && ti(F)),
                                      (e =
                                        n !== r
                                          ? ((i = Xn),
                                            Qn++,
                                            61 === t.charCodeAt(Xn) ? ((s = W), Xn++) : ((s = r), 0 === Qn && ti(F)),
                                            Qn--,
                                            (i = s === r ? void 0 : ((Xn = i), r)) !== r ? (n = U()) : ((Xn = e), r))
                                          : ((Xn = e), r)) === r &&
                              ...
                              (e =
                                (function () {
                                  ...
                                  ? (40 === t.charCodeAt(Xn) ? ((n = me), Xn++) : ((n = r), 0 === Qn && ti(ve)),
                                    ...
                                    (function () {
                                      var e;
                                      return t.substr(Xn, 2) === On ? ((e = On), (Xn += 2)) : ((e = r), 0 === Qn && ti(Rn)), e;
                                    })() !== r &&
                                    pi() !== r
                                      ? ((s = vi()) === r && (s = bi()),
                                        s !== r && pi() !== r
                                          ? (41 === t.charCodeAt(Xn) ? ((o = ye), Xn++) : ((o = r), 0 === Qn && ti(we)),
                                            o !== r && pi() !== r
                          ...
                          (e = (function () {
                            ...
                            return (
                              ...
                              (e =
                                (function () {
                                  var e;
                                  return t.substr(Xn, 2) === Ln ? ((e = Ln), (Xn += 2)) : ((e = r), 0 === Qn && ti(Bn)), e;
                                })() !== r && pi() !== r
                                  ? (40 === t.charCodeAt(Xn) ? ((n = me), Xn++) : ((n = r), 0 === Qn && ti(ve)),
                                    n !== r && pi() !== r && (i = Pi()) !== r && pi() !== r
                                      ? (41 === t.charCodeAt(Xn) ? ((s = ye), Xn++) : ((s = r), 0 === Qn && ti(we)),
                                        s !== r && pi() !== r
                                          ? ((o = hi()) === r && (o = mi()),
                                            o !== r && pi() !== r
                                              ? ((a = Xn),
                          ...
                          (e = (function () {
                            ...
                            return (
                              ...
                              (e =
                                (function () {
                                  var e;
                                  return t.substr(Xn, 7) === Un ? ((e = Un), (Xn += 7)) : ((e = r), 0 === Qn && ti(Vn)), e;
                                })() !== r &&
                                pi() !== r &&
                                (n = gi()) !== r &&
                                _i() !== r
                          ...
                          (e = (function () {
                            ...
                            return (
                              Qn++,
                              (e = Xn),
                              59 === t.charCodeAt(Xn) ? ((n = pe), Xn++) : ((n = r), 0 === Qn && ti(he)),
                              n !== r && (n = be()),
                              Qn--,
                              (e = n) === r && ((n = r), 0 === Qn && ti(fe)),
                              e
                            );
                          })()),
                        Qn--,
                            ...
                            s =
                              (o = pi()) !== r
                                ? (44 === t.charCodeAt(Xn) ? ((a = re), Xn++) : ((a = r), 0 === Qn && ti(se)),
                                  a !== r && (l = pi()) !== r && (c = bi()) !== r ? (o = [o, a, l, c]) : ((Xn = s), r))
                                : ((Xn = s), r);
                          s !== r;
                            ...
                            ? ((i = Xn),
                              (i =
                                (s = (function () {
                                  var e, t, n, i, s, o;
                                  if (((e = Xn), (t = hi()) !== r)) {
                                    for (n = [], i = Xn, i = (s = pi()) !== r && (o = hi()) !== r ? (s = [s, o]) : ((Xn = i), r); i !== r; )
                                      n.push(i), (i = Xn), (i = (s = pi()) !== r && (o = hi()) !== r ? (s = [s, o]) : ((Xn = i), r));
                              ...
                              (e = (function () {
                                ...
                                (e = (function () {
                                  ...
                                  return (
                                    ...
                                    (n = (function () {
                                      var e;
                                      return t.substr(Xn, 4) === Wn ? ((e = Wn), (Xn += 4)) : ((e = r), 0 === Qn && ti(Fn)), e;
                                    })()) !== r && (n = St()),
                                    (e = n) === r &&
                                      ((e = Xn),
                                      (n = (function () {
                                        var e;
                                        return t.substr(Xn, 5) === jn ? ((e = jn), (Xn += 5)) : ((e = r), 0 === Qn && ti(In)), e;
                                      })()) !== r && (n = Tt()),
                                      (e = n)),
                                    e
                                  );
                                ...
                                (e = (function () {
                                  ...
                                  return (
                                    ...
                                    (n = (function () {
                                      var e, n, i, s, o;
                                      if (((e = Xn), 48 === t.charCodeAt(Xn) ? ((n = Ot), Xn++) : ((n = r), 0 === Qn && ti(Rt)), n !== r))
                                      ...
                                      (n = (function () {
                                        ...
                                        return (
                                          ...
                                          (e =
                                            (n = Oi()) !== r
                                              ? (46 === t.charCodeAt(Xn) ? ((i = Et), Xn++) : ((i = r), 0 === Qn && ti(jt)),
                                                i !== r
                                                  ? ((s = Ri()) === r && (s = null),
                                                    s !== r
                                                      ? ((o = Bi()) === r && (o = null), o !== r ? (n = It(n, s, o)) : ((Xn = e), r))
                                                      : ((Xn = e), r))
                                                  : ((Xn = e), r))
                                              : ((Xn = e), r)) === r &&
                                            ((e = Xn),
                                            46 === t.charCodeAt(Xn) ? ((n = Et), Xn++) : ((n = r), 0 === Qn && ti(jt)),
                                            (e =
                                              n !== r && (i = Ri()) !== r
                                                ? ((s = Bi()) === r && (s = null), s !== r ? (n = qt(i, s)) : ((Xn = e), r))
                                                : ((Xn = e), r)) === r &&
                                              ((e = Xn),
                                              (e =
                                                (n = Oi()) !== r
                                                  ? ((i = Bi()) === r && (i = null), i !== r ? (n = Pt(n, i)) : ((Xn = e), r))
                                                  : ((Xn = e), r)))),
                                          e
                                        );
                                      })()),
                                  ...
                                  return (
                                    ...
                                    (e =
                                      n !== r
                                        ? ((i = (function () {
                                            var e, t;
                                            if (((e = []), (t = Hi()) !== r)) for (; t !== r; ) e.push(t), (t = Hi());
                                            else e = r;
                                            return e !== r && (e = on(e)), e;
                                          })()),
                                          i !== r
                                ...
                                (e = (function () {
                                  ...
                                  return (
                                    (e = Xn),
                                    91 === t.charCodeAt(Xn) ? ((n = Re), Xn++) : ((n = r), 0 === Qn && ti(Le)),
                                    (e =
                                      n !== r && pi() !== r
                                        ? ((i = wi()) === r && (i = null),
                                          i !== r && pi() !== r
                                            ? (93 === t.charCodeAt(Xn) ? ((s = Be), Xn++) : ((s = r), 0 === Qn && ti(Me)),
                                              s !== r ? (n = wt(i)) : ((Xn = e), r))
                                            : ((Xn = e), r))
                                        : ((Xn = e), r))
                                  );
                    ...
                    function yi() {
                      ...
                      return (
                        ...
                        (n = (function () {
                          var e, n;
                          if (((e = []), je.test(t.charAt(Xn)) ? ((n = t.charAt(Xn)), Xn++) : ((n = r), 0 === Qn && ti(Ie)), n !== r))
                            for (; n !== r; ) e.push(n), je.test(t.charAt(Xn)) ? ((n = t.charAt(Xn)), Xn++) : ((n = r), 0 === Qn && ti(Ie));
                          else e = r;
                          return e !== r && (e = qe(e)), e;
                        })()) !== r && pi() !== r
                        ...
                        for (
                          i = [],
                            ...
                            s =
                              (o = pi()) !== r
                                ? (44 === t.charCodeAt(Xn) ? ((a = re), Xn++) : ((a = r), 0 === Qn && ti(se)),
                                  a !== r && (l = pi()) !== r && (c = vi()) !== r ? (o = [o, a, l, c]) : ((Xn = s), r))
                                : ((Xn = s), r);
                          s !== r;
                    ...
                    function xi() {
                      ...
                      return (
                        (e = (function () {
                          var e, t, n;
                          return (e = Xn), (t = vi()) !== r && pi() !== r && (n = ki()) !== r ? (t = De(t, n)) : ((Xn = e), r);
                        })()) === r &&
                          (e = vi()) === r &&
                          ((e = Xn),
                          (e =
                            (n = (function () {
                              var e;
                              return (
                                43 === t.charCodeAt(Xn) ? ((e = We), Xn++) : ((e = r), 0 === Qn && ti(Fe)),
                                e === r &&
                                  (45 === t.charCodeAt(Xn) ? ((e = Ue), Xn++) : ((e = r), 0 === Qn && ti(Ve)),
                                  e === r &&
                    ...
                    function Ci() {
                      ...
                      return (
                        (e = Xn),
                        43 === t.charCodeAt(Xn) ? ((n = We), Xn++) : ((n = r), 0 === Qn && ti(Fe)),
                        (e =
                          n !== r
                            ? ((i = Xn),
                              Qn++,
                              43 === t.charCodeAt(Xn) ? ((s = We), Xn++) : ((s = r), 0 === Qn && ti(Fe)),
                              s === r && (61 === t.charCodeAt(Xn) ? ((s = W), Xn++) : ((s = r), 0 === Qn && ti(F))),
                              Qn--,
                              (i = s === r ? void 0 : ((Xn = i), r)) !== r ? (n = st()) : ((Xn = e), r))
                            : ((Xn = e), r)) === r &&
                          ((e = Xn),
                          45 === t.charCodeAt(Xn) ? ((n = Ue), Xn++) : ((n = r), 0 === Qn && ti(Ve)),
                          (e =
                            n !== r
                              ? ((i = Xn),
                                Qn++,
                                45 === t.charCodeAt(Xn) ? ((s = Ue), Xn++) : ((s = r), 0 === Qn && ti(Ve)),
                                s === r && (61 === t.charCodeAt(Xn) ? ((s = W), Xn++) : ((s = r), 0 === Qn && ti(F))),
                                Qn--,
                    ...
                    function Ei() {
                      ...
                      return (
                        ...
                        e === r &&
                          ...
                          e === r &&
                            (60 === t.charCodeAt(Xn) ? ((e = _t), Xn++) : ((e = r), 0 === Qn && ti(ft)),
                            e === r && (62 === t.charCodeAt(Xn) ? ((e = pt), Xn++) : ((e = r), 0 === Qn && ti(ht))))),
                        e
                      );
                    }
                    function ji() {
                    ...
                    function Oi() {
                      var e, n, i;
                      return (
                        48 === t.charCodeAt(Xn) ? ((e = Ot), Xn++) : ((e = r), 0 === Qn && ti(Rt)),
                        e === r &&
                          ((e = Xn),
                          (e =
                            (n = (function () {
                              var e;
                              return Dt.test(t.charAt(Xn)) ? ((e = t.charAt(Xn)), Xn++) : ((e = r), 0 === Qn && ti(Ht)), e;
                            })()) !== r
                              ? ((i = Ri()) === r && (i = null), i !== r ? (n = Lt(n, i)) : ((Xn = e), r))
                              : ((Xn = e), r))),
                        e
                      );
                    }
                    ...
                    function Bi() {
                      ...
                      return (
                        ...
                        (n = (function () {
                          var e;
                          return Ft.test(t.charAt(Xn)) ? ((e = t.charAt(Xn)), Xn++) : ((e = r), 0 === Qn && ti(Ut)), e;
                        })()) !== r &&
                        (i = (function () {
                          var e, n, i;
                          return (
                    ...
                    function Ni() {
                      ...
                      return (
                        ...
                        (e = (n = i === r ? void 0 : ((Xn = n), r)) !== r && (i = ri()) !== r ? (n = cn(i)) : ((Xn = e), r)) === r &&
                          ...
                          (e = n !== r && (i = Fi()) !== r ? (n = un(i)) : ((Xn = e), r)) === r && (e = Wi())),
                        e
                      );
                    }
                    function Di() {
                    ...
                    function Fi() {
                      ...
                      return (
                        (e = (function () {
                                  ...
                                  (i = (function () {
                                    ...
                                    return (
                                      (e = Ui()) === r &&
                                        ...
                                        e === r && (117 === t.charCodeAt(Xn) ? ((e = yn), Xn++) : ((e = r), 0 === Qn && ti(wn)))),
                                      e
                                    );
                                  })()),
                                  Qn--,
                          ...
                          ((e = Xn),
                          48 === t.charCodeAt(Xn) ? ((n = Ot), Xn++) : ((n = r), 0 === Qn && ti(Rt)),
                          (e =
                            n !== r
                              ? ((i = Xn),
                                Qn++,
                                (s = Li()),
                                Qn--,
                                (i = s === r ? void 0 : ((Xn = i), r)) !== r ? (n = fn()) : ((Xn = e), r))
                              : ((Xn = e), r)) === r &&
                            (e = (function () {
                              var e, n, i, s;
                              return (
                            ...
                            (e = (function () {
                              ...
                              return (
                                (e = Xn),
                                117 === t.charCodeAt(Xn) ? ((n = yn), Xn++) : ((n = r), 0 === Qn && ti(wn)),
                                (e =
                    ...
                    function Ui() {
                      var e;
                      return pn.test(t.charAt(Xn)) ? ((e = t.charAt(Xn)), Xn++) : ((e = r), 0 === Qn && ti(hn)), e !== r && (e = bn(e)), e;
                    }
                    function Vi() {
                      var e;
            ...
            (function (e) {
              ...
              var s,
                ...
                Q = {
                  ...
                  needsContext: new RegExp(
                    "^" + H + "*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\(" + H + "*((?:-\\d)?\\d*)" + H + "*\\)|)(?=[^-]|$)",
                    "i"
                  )
                },
                J = /HTML$/i,
              ...
              try {
                B.apply((O = M.call(S.childNodes)), S.childNodes), O[S.childNodes.length].nodeType;
              } catch (e) {
                B = {
                  apply: O.length
                    ? function (e, t) {
                ...
                if (!i && ((t ? t.ownerDocument || t : S) !== g && b(t), (t = t || g), v)) {
                  if (11 !== h && (c = ie.exec(e)))
                    if ((r = c[1])) {
                      ...
                      } else if (p && (a = p.getElementById(r)) && x(t, a) && a.id === r) return n.push(a), n;
                    } else {
                      if (c[2]) return B.apply(n, t.getElementsByTagName(e)), n;
                      if ((r = c[3]) && o.getElementsByClassName && t.getElementsByClassName)
                        return B.apply(n, t.getElementsByClassName(r)), n;
                    }
                  if (o.qsa && !I[e + " "] && (!y || !y.test(e)) && (1 !== h || "object" !== t.nodeName.toLowerCase())) {
                    if (((f = e), (p = t), 1 === h && G.test(e))) {
                      for (
                        ...
                        d[s] = "#" + l + " " + ve(d[s]);
                      (f = d.join(",")), (p = (re.test(e) && ge(t.parentNode)) || t);
                    }
                    try {
                      return B.apply(n, p.querySelectorAll(f)), n;
                    } catch (t) {
                      I(e, !0);
                    } finally {
                  ...
                  return (
                    s !== g &&
                      ...
                      (o.qsa = ne.test(g.querySelectorAll)) &&
                        (_e(function (e) {
                          (m.appendChild(e).innerHTML =
                            ...
                            e.querySelectorAll("[selected]").length || y.push("\\[" + H + "*(?:value|" + D + ")"),
                            e.querySelectorAll("[id~=" + A + "-]").length || y.push("~="),
                            e.querySelectorAll(":checked").length || y.push(":checked"),
                            e.querySelectorAll("a#" + A + "+*").length || y.push(".#.+[+~]");
                        }),
                        _e(function (e) {
                      ...
                      (o.matchesSelector = ne.test(
                        ...
                        _e(function (e) {
                          (o.disconnectedMatch = k.call(e, "*")), k.call(e, "[s!='']:x"), w.push("!=", U);
                        }),
                      ...
                      (q = t
                        ...
                        : function (e, t) {
                            ...
                            var n,
                              ...
                              o = [e],
                              a = [t];
                            if (!r || !s) return e === g ? -1 : t === g ? 1 : r ? -1 : s ? 1 : p ? N(p, e) - N(p, t) : 0;
                            if (r === s) return pe(e, t);
                            for (n = e; (n = n.parentNode); ) o.unshift(n);
                            for (n = t; (n = n.parentNode); ) a.unshift(n);
                            for (; o[i] === a[i]; ) i++;
                            return i ? pe(o[i], a[i]) : o[i] === S ? -1 : a[i] === S ? 1 : 0;
                          })),
                    g
                  );
                }),
              ...
              (ce.matchesSelector = function (e, t) {
                if (
                  ((e.ownerDocument || e) !== g && b(e), o.matchesSelector && v && !I[t + " "] && (!w || !w.test(t)) && (!y || !y.test(t)))
                )
                  try {
                    var n = k.call(e, t);
              ...
              (ce.uniqueSort = function (e) {
                var t,
                  ...
                  i = 0,
                  r = 0;
                if (((h = !o.detectDuplicates), (p = !o.sortStable && e.slice(0)), e.sort(q), h)) {
                      ...
                      return 1 === i && 0 === r
                        ...
                        : function (t, n, l) {
                            ...
                            if (b) {
                              ...
                              if (((p = [o ? b.firstChild : b.lastChild]), o && m)) {
                                for (
                                  v =
                                    (f =
                ...
                return (
                  ...
                  de(function (s, o, a, l) {
                    var c,
                      ...
                      g = n ? (r || (s ? e : p || i) ? [] : o) : b;
                    if ((n && n(b, g, a, l), i))
                      for (c = ke(g, f), i(c, [], a, l), u = c.length; u--; ) (d = c[u]) && (g[f[u]] = !(b[f[u]] = d));
                    if (s) {
                      if (r || e) {
                        if (r) {
                    ...
                    } else (g = ke(g === o ? g.splice(p, g.length) : g)), r ? r(null, o, g, l) : B.apply(o, g);
                  })
                );
              }
              function Ae(e) {
                for (
                  var t,
                    ...
                    d = [
                      function (e, n, i) {
                        var r = (!s && (i || n !== f)) || ((t = n).nodeType ? c(e, n, i) : u(e, n, i));
                        return (t = null), r;
                      }
                    ];
                  l < r;
                  ...
                  if ((n = a.relative[e[l].type])) d = [ye(we(d), n)];
                  else {
                        ...
                        (function (e, t) {
                          function n(n, s, o, l, c) {
                            var u,
                              ...
                              A = k.length;
                            for (c && (f = s === g || s || c); h !== A && null != (u = k[h]); h++) {
                              if (r && u) {
                              ...
                              i && ((u = !_ && u) && p--, n && m.push(u));
                            }
                            if (((p += h), i && h !== p)) {
                              for (d = 0; (_ = t[d++]); ) _(m, y, s, o);
                              if (n) {
                                if (0 < p) for (; h--; ) m[h] || y[h] || (y[h] = R.call(l));
                                y = ke(y);
                              }
                              B.apply(l, y), c && !n && 0 < y.length && 1 < p + t.length && ce.uniqueSort(l);
                            }
                            return c && ((T = x), (f = w)), m;
                          }
                          var i = 0 < t.length,
                    ...
                    if (((i = i || []), 1 === p.length)) {
                      ...
                      for (s = Q.needsContext.test(e) ? 0 : o.length; s-- && ((l = o[s]), !a.relative[(c = l.type)]); )
                        if ((_ = a.find[c]) && (r = _(l.matches[0].replace(se, n), (re.test(o[0].type) && ge(t.parentNode)) || t))) {
                          if ((o.splice(s, 1), !(e = r.length && ve(o)))) return B.apply(i, r), i;
                          break;
                        }
                    }
                    return (f || d(e, p))(r, t, !v, i, !t || (re.test(e) && ge(t.parentNode)) || t), i;
                  }),
    ...
    32: [
      ...
      { "./_to-absolute-index": 67, "./_to-iobject": 69, "./_to-length": 70 }
    ],
    33: [
      function (e, t, n) {
        var i = {}.toString;
    ...
    40: [
        ...
        var i = e("./_global"),
          ...
          l = function (e, t, n) {
            var c,
              ...
              b = e & l.P,
              g = e & l.B,
              m = p ? i : h ? i[t] || (i[t] = {}) : (i[t] || {}).prototype,
              v = p ? r : r[t] || (r[t] = {}),
              y = v.prototype || (v.prototype = {});
            for (c in (p && (n = t), n))
              (d = ((u = !f && m && void 0 !== m[c]) ? m : n)[c]),
      ...
      { "./_core": 34, "./_ctx": 35, "./_global": 43, "./_hide": 45, "./_redefine": 62 }
    ],
    41: [
      function (e, t, n) {
        t.exports = function (e) {
    ...
    45: [
      ...
      { "./_descriptors": 37, "./_object-dp": 56, "./_property-desc": 61 }
    ],
    46: [
      function (e, t, n) {
    ...
    47: [
      ...
      { "./_descriptors": 37, "./_dom-create": 38, "./_fails": 41 }
    ],
    48: [
      function (e, t, n) {
        var i = e("./_cof");
    ...
    50: [
      ...
      { "./_hide": 45, "./_object-create": 55, "./_property-desc": 61, "./_set-to-string-tag": 63, "./_wks": 74 }
    ],
    51: [
      function (e, t, n) {
        "use strict";
        ...
        t.exports = function (e, t, n, b, g, m, v) {
          ...
          var y,
            ...
            E = z || x(g),
            j = g ? (S ? x("entries") : E) : void 0,
            I = ("Array" == t && C.entries) || z;
          if (
            (I && (k = u(I.call(new e()))) !== Object.prototype && k.next && (c(k, A, !0), i || "function" == typeof k[d] || o(k, d, h)),
            S &&
              z &&
              z.name !== p &&
              ((T = !0),
            ...
            if (((y = { values: S ? E : x(p), keys: m ? E : x(f), entries: j }), v)) for (w in y) w in C || s(C, w, y[w]);
            else r(r.P + r.F * (_ || T), t, y);
          return y;
        };
      },
      {
    ...
    55: [
      ...
      { "./_an-object": 31, "./_dom-create": 38, "./_enum-bug-keys": 39, "./_html": 46, "./_object-dps": 57, "./_shared-key": 64 }
    ],
    56: [
      function (e, t, n) {
        var i = e("./_an-object"),
      ...
      { "./_an-object": 31, "./_descriptors": 37, "./_ie8-dom-define": 47, "./_to-primitive": 72 }
    ],
    57: [
      function (e, t, n) {
        var i = e("./_object-dp"),
      ...
      { "./_an-object": 31, "./_descriptors": 37, "./_object-dp": 56, "./_object-keys": 60 }
    ],
    58: [
      function (e, t, n) {
        var i = e("./_has"),
      ...
      { "./_has": 44, "./_shared-key": 64, "./_to-object": 71 }
    ],
    59: [
      function (e, t, n) {
        var i = e("./_has"),
      ...
      { "./_array-includes": 32, "./_has": 44, "./_shared-key": 64, "./_to-iobject": 69 }
    ],
    60: [
      function (e, t, n) {
      ...
      { "./_enum-bug-keys": 39, "./_object-keys-internal": 59 }
    ],
    61: [
      function (e, t, n) {
        t.exports = function (e, t) {
    ...
    62: [
      ...
      { "./_core": 34, "./_function-to-string": 42, "./_global": 43, "./_has": 44, "./_hide": 45, "./_uid": 73 }
    ],
    63: [
      function (e, t, n) {
    ...
    65: [
      ...
      { "./_core": 34, "./_global": 43, "./_library": 54 }
    ],
    66: [
      function (e, t, n) {
        "use strict";
    ...
    75: [
      ...
      { "./_add-to-unscopables": 30, "./_iter-define": 51, "./_iter-step": 52, "./_iterators": 53, "./_to-iobject": 69 }
    ],
    76: [
      function (e, t, n) {
        "use strict";
      ...
      { "./_a-function": 29, "./_export": 40, "./_fails": 41, "./_strict-method": 66, "./_to-object": 71 }
    ],
    77: [
      function (e, t, n) {
        for (
          ...
          var b,
            ...
            v = o[g],
            y = v && v.prototype;
          if (y && (y[u] || a(y, u, _), y[d] || a(y, d, g), (l[g] = _), m)) for (b in i) y[b] || s(y, b, i[b], !0);
        }
      },
      {
        "./_global": 43,
    ...
    79: [
        ...
        var d = e("./Messenger"),
          ...
          p = (function (e) {
            ...
            function n() {
              ...
              return (
                f.runtime.onMessage.addListener(i),
                window.addEventListener("unload", function () {
                  f.runtime.onMessage.removeListener(i);
                }),
                f.runtime.connect({ name: "ContentMessenger" }).onDisconnect.addListener(e._onDisconnect.bind((0, o.default)(e))),
                e
              );
            }
            return (
              (0, s.default)(n, [
                ...
                },
                {
                  ...
                  value: function (e, t, n) {
                    var i = 10;
                    !(function r() {
                      f.runtime.sendMessage({ publish: e, message: t }, function (e) {
      ...
      },
      {
        ...
        "@babel/runtime/helpers/getPrototypeOf": 19,
        "@babel/runtime/helpers/inherits": 20,
        "@babel/runtime/helpers/interopRequireDefault": 21,
    ...
    91: [
      ...
      { "./plugin/destroy": 93, "./plugin/initialize": 101, "./plugin/update": 105 }
    ],
    92: [
      function (e, t, n) {
        "use strict";
    ...
    93: [
      ...
      { "../lib/dom": 87, "../lib/helper": 90, "./instances": 102 }
    ],
    94: [
      function (e, t, n) {
        "use strict";
      ...
      { "../instances": 102, "../update-geometry": 103, "../update-scroll": 104 }
    ],
    95: [
      function (e, t, n) {
        "use strict";
      ...
      { "../../lib/dom": 87, "../../lib/helper": 90, "../instances": 102, "../update-geometry": 103, "../update-scroll": 104 }
    ],
    96: [
      function (e, t, n) {
        "use strict";
    ...
    98: [
      ...
      { "../instances": 102, "../update-geometry": 103 }
    ],
    99: [
      function (e, t, n) {
        "use strict";
      ...
      { "../../lib/helper": 90, "../instances": 102, "../update-geometry": 103, "../update-scroll": 104 }
    ],
    100: [
      function (e, t, n) {
        "use strict";
        ...
        function a(e, t, n, i) {
          ...
          function v(n) {
            if ((!f && t.settings.swipePropagation && m(n), !_ && f && g(n))) {
              var i = b(n),
    ...
    101: [
      ...
      {
        "./handler/click-rail": 94,
        "./handler/drag-scrollbar": 95,
        "./handler/keyboard": 96,
        "./handler/mouse-wheel": 97,
        "./handler/native-scroll": 98,
        "./handler/selection": 99,
        "./handler/touch": 100,
        "./instances": 102,
        "./update-geometry": 103
      }
    ...
    102: [
      ...
      { "../lib/dom": 87, "../lib/event-manager": 88, "../lib/guid": 89, "../lib/helper": 90, "./default-setting": 92 }
    ],
    103: [
      function (e, t, n) {
        "use strict";
      ...
      { "../lib/dom": 87, "../lib/helper": 90, "./instances": 102, "./update-scroll": 104 }
    ],
    104: [
      function (e, t, n) {
        "use strict";
          ...
          (function () {
            !(function (e, i) {
              ...
              var T = S("String"),
                ...
                q = S("ArrayBuffer"),
                P = S("Function"),
                O = n.document && n.document.childNodes;
              "function" != typeof /./ &&
              ...
              var R = P,
                L = S("Object"),
                B = d && L(new DataView(new ArrayBuffer(8))),
                M = "undefined" != typeof Map && L(new Map()),
                N = S("DataView");
              var D = B
                  ? function (e) {
                      return null != e && R(e.getInt8) && q(e.buffer);
                    }
                  : N,
                H = _ || S("Array");
              function W(e, t) {
              ...
              function ee(e, t) {
                ...
                var n = v.length,
                  ...
                  s = (R(i) && i.prototype) || r,
                  o = "constructor";
                for (W(e, o) && !t.contains(o) && t.push(o); n--; ) (o = v[n]) in e && e[o] !== s[o] && !t.contains(o) && t.push(o);
              }
              function te(e) {
                if (!k(e)) return [];
                if (f) return f(e);
              ...
              function ae(e, t, n, i) {
                ...
                if (!o) {
                  ...
                  var a = e.constructor,
                    c = t.constructor;
                  if (a !== c && !(R(a) && a instanceof a && R(c) && c instanceof c) && "constructor" in e && "constructor" in t) return !1;
                }
                i = i || [];
                ...
                if ((n.push(e), i.push(t), o)) {
                  ...
                  for (; u--; ) if (!W(t, (d = _[u])) || !oe(e[d], t[d], n, i)) return !1;
                }
              ...
              function ce(e) {
                ...
                return function (n) {
                  ...
                  var i = le(n);
                  if (J(i)) return !1;
                  for (var r = 0; r < t; r++) if (!R(n[e[r]])) return !1;
                  return e !== pe || !R(n[ue]);
                };
              }
              var ue = "forEach",
              ...
              function Be(e, t, n) {
                return null == e ? Pe : R(e) ? Le(e, t, n) : k(e) && !H(e) ? Oe(e) : Re(e);
              }
              function Me(e, t) {
                return Be(e, t, 1 / 0);
              }
              function Ne(e, t, n) {
                return ie.iteratee !== Me ? ie.iteratee(e, t) : Be(e, t, n);
              }
              function De() {}
              function He(e, t) {
              ...
              var nt = w(function (e, t, n) {
                  if (!R(e)) throw new TypeError("Bind must be called on a function");
                  var i = w(function (r) {
              ...
              function zt(e, t, n, i) {
                return it(e) || (e = ye(e)), ("number" != typeof n || i) && (n = 0), gt(e, t, n) >= 0;
              }
              var Et = w(function (e, t, n) {
                var i, r;
                return (
                  R(t) ? (r = t) : ((t = je(t)), (i = t.slice(0, -1)), (t = t[t.length - 1])),
                  wt(e, function (e) {
                    var s = r;
                    if (!s) {
                      if ((i && i.length && (e = Ie(e, i)), null == e)) return;
                      s = e[t];
                    }
              ...
              function It(e, t, n) {
                ...
                if (null == t || ("number" == typeof t && "object" != typeof e[0] && null != e))
                  for (var a = 0, l = (e = it(e) ? e : ye(e)).length; a < l; a++) null != (i = e[a]) && i > s && (s = i);
                else
                  (t = Ne(t, n)),
                    yt(e, function (e, n, i) {
              ...
              function qt(e, t, n) {
                if (null == t || n) return it(e) || (e = ye(e)), e[He(e.length - 1)];
                var i = it(e) ? ze(e) : ye(e),
                  r = J(i);
              ...
              var Dt = w(function (e, t) {
                  var n = {},
                    i = t[0];
                  if (null == e) return n;
                  R(i) ? (t.length > 1 && (i = Le(i, t[1])), (t = le(e))) : ((i = Nt), (t = rt(t, !1, !1)), (e = Object(e)));
              ...
              function Gt(e) {
                for (var t = (e && It(e, J).length) || 0, n = Array(t), i = 0; i < t; i++) n[i] = jt(e, i);
                return n;
              }
              var Kt = w(Gt);
              function Zt(e, t) {
              ...
              var Jt = {
                  ...
                  isArguments: U,
                  isFinite: function (e) {
                    return !I(e) && g(e) && !isNaN(parseFloat(e));
                  },
                  isNaN: V,
                  isTypedArray: Q,
                  isEmpty: function (e) {
                    if (null == e) return !0;
                    var t = J(e);
                    return "number" == typeof t && (H(e) || T(e) || U(e)) ? 0 === t : 0 === J(te(e));
                  },
                  isMatch: ne,
                  ...
                  result: function (e, t, n) {
                    var i = (t = je(t)).length;
                    if (!i) return R(n) ? n.call(e) : n;
                    for (var r = 0; r < i; r++) {
                      var s = null == e ? void 0 : e[t[r]];
                      void 0 === s && ((s = n), (r = i)), (e = R(s) ? s.call(e) : s);
                    }
                    return e;
                  },
                  uniqueId: function (e) {
                  ...
                  memoize: function (e, t) {
                    var n = function (i) {
                      ...
                      return W(r, s) || (r[s] = e.apply(this, arguments)), r[s];
                    };
                    return (n.cache = {}), n;
                  },
                  delay: ot,
                  ...
                  throttle: function (e, t, n) {
                    ...
                    n || (n = {});
                    var l = function () {
                        (a = !1 === n.leading ? 0 : We()), (i = null), (o = e.apply(r, s)), i || (r = s = null);
                      },
                      c = function () {
                        var c = We();
                        a || !1 !== n.leading || (a = c);
                  ...
                  debounce: function (e, t, n) {
                    var i,
                      ...
                      c = w(function (c) {
                        return (a = this), (s = c), (r = We()), i || ((i = setTimeout(l, t)), n && (o = e.apply(a, s))), o;
                      });
                    return (
                      (c.cancel = function () {
                  ...
                  partition: Bt,
                  toArray: function (e) {
                    return e ? (H(e) ? a.call(e) : T(e) ? e.match(Mt) : it(e) ? wt(e, Pe) : ye(e)) : [];
                  },
                  size: function (e) {
    ...
    107: [
      function (e, t, n) {
        t.exports =
          '<div id="cardContainer" class="card-content-container"></div>\n<div id="tourArea" class="tour-container"></div>\n<div id="viewArea" class="view-container"></div>';
      },
      {}
    ],
    108: [
      function (e, t, n) {
        t.exports = '<div data-subview="Offers"></div>';
      },
      {}
    ],
    109: [
    ...
    114: [
      ...
      { "background/localStorage": 1, configuration: 2, underscore: 106 }
    ],
    115: [
      function (e, t, n) {
        "use strict";
      ...
      { "content/core/Models/ModelBackground": 131 }
    ],
    116: [
      function (e, t, n) {
        "use strict";
      ...
      { "content/core/Models/ModelBackground": 131, "content/messagingInterface": 140 }
    ],
    117: [
      function (e, t, n) {
        "use strict";
    ...
    118: [
      ...
      {
        "content/Models/PUA": 116,
        "content/Models/SERP": 117,
        "content/Models/URLClassification": 119,
        "content/core/Models/ModelBackground": 131,
        "content/messagingInterface": 140,
        "modules/offers/content/iframe/models/Ciuvo": 148
      }
    ],
    119: [
      function (e, t, n) {
    ...
    120: [
      ...
      { "content/Transitions/Default": 121, "content/Views/Dash/TabView": 125, jquery: "jquery" }
    ],
    121: [
      function (e, t, n) {
        "use strict";
      ...
      { "content/core/Transitions/Base": 136, "content/core/Views/View": 138, jquery: "jquery" }
    ],
    122: [
      function (e, t, n) {
        "use strict";
      ...
      { "content/Transitions/Default": 121, "content/Views/Tour/TourStepBase": 130 }
    ],
    123: [
      function (e, t, n) {
        "use strict";
      ...
      { "content/core/Views/View": 138 }
    ],
    124: [
      function (e, t, n) {
        "use strict";
        const i = e("Card.mustache"),
          r = e("content/Views/Top");
        class s extends r {
          static initClass() {
      ...
      { "Card.mustache": 107, "content/Views/Top": 129 }
    ],
    125: [
      function (e, t, n) {
        "use strict";
    ...
    126: [
      ...
      { "Indicators/Close.mustache": 110, "content/Views/Indicators/Indicator": 127 }
    ],
    127: [
      function (e, t, n) {
        "use strict";
      ...
      { "content/Models/State": 118, "content/core/Views/View": 138 }
    ],
    128: [
      function (e, t, n) {
        "use strict";
    ...
    129: [
      ...
      {
        "Top.mustache": 111,
        "content/core/Views/EscChainOfResponsibility": 137,
        "content/core/Views/View": 138,
        "content/messagingInterface": 140,
        "content/mixpanel": 141,
        jquery: "jquery",
        underscore: 106
      }
    ],
    130: [
      ...
      { "content/Views/Mixins/Tooltip": 128, "content/core/Views/View": 138, jquery: "jquery", underscore: 106 }
    ],
    131: [
      function (e, t, n) {
        "use strict";
      ...
      { backbone: 27, "content/messagingInterface": 140, jquery: "jquery" }
    ],
    132: [
      function (e, t, n) {
        "use strict";
      ...
      { "content/core/Routing/AreasManagement/ViewTransitionStrategy": 133 }
    ],
    133: [
      function (e, t, n) {
        "use strict";
      ...
      {
        "content/Transitions/DashTransition": 120,
        "content/Transitions/Default": 121,
        "content/Transitions/TourStepTransition": 122,
        "content/core/Routing/AreasManagement/base/ViewTransitionStrategy": 134,
        "modules/offers/content/iframe/transitions/OffersIndicatorBarTransition": 152,
        "modules/offers/content/iframe/transitions/OffesDashTransition": 153
      }
    ],
    134: [
      function (e, t, n) {
    ...
    135: [
      ...
      {
        backbone: 27,
        "backbone.routefilter": 26,
        "content/core/Routing/AreasManagement/AreasManager": 132,
        "content/messagingInterface": 140
      }
    ],
    136: [
    ...
    138: [
      ...
      {
        backbone: 27,
        "backbone-subviews": 25,
        "content/Models/I18n": 115,
        "core-js/modules/es6.array.iterator.js": 75,
        "core-js/modules/web.dom.iterable.js": 77,
        mustache: "mustache",
        "perfect-scrollbar/jquery": 85,
        underscore: 106
      }
    ],
    139: [
      ...
      { Locale: 112, Locales: 113, config: 114, "content/messagingInterface": 140, underscore: 106 }
    ],
    140: [
      function (e, t, n) {
        "use strict";
    ...
    142: [
      function (e, t, n) {
        ...
        const i = e("backbone"),
          r = e("jquery"),
          s = e("content/Views/Card"),
          o = e("content/i18n_loader"),
          a = e("content/Models/I18n").getInstance(),
          l = e("content/messagingInterface"),
          c = e("modules/offers/content/CardOffers.js"),
          u = e("modules/offers/content/iframe/routers/CardRouters.js"),
          d = () =>
            o.getLocaleStrings(async (e, t) => {
              a.set({ strings: e, language: t });
              new s({ el: r("#card") }).render(), r("body").attr("lang", t);
              new c(new u()).enable(!1),
                l.subscribe("AO:navigate", (e) => {
                  const t = e[0];
                  return l.publish("router:navigateTo", { route: t });
                }),
                i.history.start();
            });
        (() => {
          ...
          ? l.publish("checkIframe", null, d)
          : d();
      },
      {
        backbone: 27,
        "content/Models/I18n": 115,
        "content/Views/Card": 124,
        "content/i18n_loader": 139,
        "content/messagingInterface": 140,
        jquery: "jquery",
        "modules/offers/content/CardOffers.js": 144,
        "modules/offers/content/iframe/routers/CardRouters.js": 151
      }
    ],
    143: [
      function (e, t, n) {
      ...
      { "content/Models/State": 118, "content/messagingInterface": 140, "modules/offers/content/iframe/models/Ciuvo": 148 }
    ],
    144: [
      function (e, t, n) {
        "use strict";
        ...
        t.exports = class extends r {
          getDefaultRoute() {
            const e = this.ciuvo.get("products").models.map((e) => e.get("category")),
              t = new Set(e);
            let n = "offers/minimized";
            return (
              t.has("Product")
                ? (n = "offers/products")
                : t.has("Similar")
                ...
                ? (n = "offers/hotel")
                : t.has("Similarhotel")
                ? (n = "offers/similarhotel")
                : t.has("CityHotel") && (n = "offers/products"),
              n
            );
          }
          _enable(e) {
            if ((this.state.set("offersActive", !0), this.ciuvo.isBrowserStartUpOffers() && e)) return;
            const t = this.ciuvoNotifications().get("type"),
              n = this.getDefaultRoute(),
              r = "singleCoupon" === t ? "offers/coupon" : n;
            i.publish("router:navigateTo", { route: r });
          }
        };
      },
      {
        ...
        "core-js/modules/es6.array.iterator.js": 75,
        "core-js/modules/web.dom.iterable.js": 77,
        "modules/offers/content/AppOffers": 143
      }
    ],
    145: [
      function (e, t, n) {
      ...
      { "content/messagingInterface": 140, "modules/offers/content/Scraper": 146, ms: 84 }
    ],
    146: [
      function (e, t, n) {
        "use strict";
      ...
      { "ciuvo/ciuvo-csl-interpreter.min": 28, "core-js/modules/es6.array.iterator.js": 75, "core-js/modules/web.dom.iterable.js": 77 }
    ],
    147: [
      function (e, t, n) {
        "use strict";
      ...
      },
      {
        ...
        "core-js/modules/es6.array.iterator.js": 75,
        "core-js/modules/web.dom.iterable.js": 77,
        "modules/offers/content/iframe/models/CiuvoProduct": 150
      }
    ],
    148: [
      function (e, t, n) {
        ...
        const o = e("jquery"),
          ...
          f = e("modules/offers/content/iframe/models/CiuvoNotification");
        (window.ABS = {}), (window.$ = o), (window._ = e("underscore"));
        class p extends l.Model {
          static getInstance() {
            return this.instance || (this.instance = new this()), this.instance;
          }
          initialize(...e) {
          ...
          _setData(e) {
            ...
            u.track(o, r), this.set("notification", new f(n.toJSON()));
          }
      ...
      },
      {
        ...
        "content/messagingInterface": 140,
        "content/mixpanel": 141,
        "core-js/modules/es6.array.sort.js": 76,
        jquery: "jquery",
        "modules/offers/content/Offers": 145,
        "modules/offers/content/iframe/collections/CiuvoProduct": 147,
        "modules/offers/content/iframe/models/CiuvoNotification": 149,
        underscore: 106
      }
    ],
    149: [
    ...
    151: [
      function (e, t, n) {
        ...
        const i = e("content/core/Routing/Router"),
          r = e("modules/offers/content/iframe/views/OffersTour"),
          s = e("modules/offers/content/iframe/views/vertical/WishlistContent"),
          o = e("modules/offers/content/iframe/views/vertical/CardCouponsArea"),
          a = e("modules/offers/content/iframe/views/vertical/CouponsContent"),
          l = e("modules/offers/content/iframe/views/vertical/CardOffersArea"),
          c = e("content/Views/BlankIndicators"),
          u = e("modules/offers/content/iframe/views/vertical/OffersContent");
        class d extends i {
          get routes() {
            return {
              "": "default",
              ...
              "offers/wishlist": "offersWishlist",
              "offers(/:type)": "offers"
            };
          }
          default() {
            this.setAreas({ headerAndFooter: new c() });
          }
          offersTour() {
            return this.setAreas({ headerAndFooter: new l(), tour: new r() });
          }
          offersMinimized() {
            return this.setAreas({ headerAndFooter: new l() });
          }
          offers() {
            return this.setAreas({ headerAndFooter: new l(), mainContent: new u() });
          }
          offersWishlist() {
            return this.setAreas({ headerAndFooter: new l(), mainContent: new s() });
          }
          coupon() {
            return this.setAreas({ headerAndFooter: new o() });
          }
          couponHelp() {
            return this.setAreas({ headerAndFooter: new o(), mainContent: new a() });
          }
        }
        d.initClass(), (t.exports = d);
      },
      {
        "content/Views/BlankIndicators": 123,
        "content/core/Routing/Router": 135,
        "modules/offers/content/iframe/views/OffersTour": 157,
        "modules/offers/content/iframe/views/vertical/CardCouponsArea": 159,
        "modules/offers/content/iframe/views/vertical/CardOffersArea": 160,
        "modules/offers/content/iframe/views/vertical/CouponsContent": 161,
        "modules/offers/content/iframe/views/vertical/OffersContent": 163,
        "modules/offers/content/iframe/views/vertical/WishlistContent": 165
      }
    ],
    152: [
      function (e, t, n) {
      ...
      { "content/core/Transitions/Base": 136, "modules/offers/content/iframe/views/OffersIndicatorBar": 156 }
    ],
    153: [
      function (e, t, n) {
        "use strict";
      ...
      { "content/Transitions/Default": 121, "modules/offers/content/iframe/views/OffersDash": 154 }
    ],
    154: [
      function (e, t, n) {
        "use strict";
      ...
      {
        "content/Views/Dash/TabView": 125,
        "modules/offers/content/iframe/models/Ciuvo": 148,
        "modules/offers/content/iframe/views/mixins/Offers": 158
      }
    ],
    155: [
      function (e, t, n) {
      ...
      {
        "content/Views/Indicators/Indicator": 127,
        "content/messagingInterface": 140,
        jquery: "jquery",
        "modules/offers/content/iframe/models/Ciuvo": 148,
        "modules/offers/content/iframe/views/mixins/Offers": 158
    ...
    156: [
      ...
      {
        "IndicatorBarOffers.mustache": 109,
        backbone: 27,
        "content/Views/Indicators/Close": 126,
        "content/core/Views/View": 138,
        "content/messagingInterface": 140,
        jquery: "jquery",
        "modules/offers/content/iframe/models/Ciuvo": 148,
        "modules/offers/content/iframe/views/OffersIndicator": 155
      }
    ],
    157: [
      function (e, t, n) {
      ...
      {
        "content/Views/Tour/TourStepBase": 130,
        "modules/offers/content/iframe/models/Ciuvo": 148,
        "modules/offers/content/iframe/views/mixins/Offers": 158
      }
    ],
    ...
    159: [
      function (e, t, n) {
        "use strict";
        const i = e("modules/offers/content/iframe/views/vertical/CardOffersArea"),
          r = e("modules/offers/content/iframe/views/vertical/CouponsHeaderAndFooter");
        class s extends i {
          static initClass() {
            this.prototype.subviewConstructors = { Offers: r };
          }
        }
        s.initClass(), (t.exports = s);
      },
      {
        "modules/offers/content/iframe/views/vertical/CardOffersArea": 160,
        "modules/offers/content/iframe/views/vertical/CouponsHeaderAndFooter": 162
      }
    ],
    160: [
      function (e, t, n) {
        ...
        const i = e("content/core/Views/View"),
          r = e("content/messagingInterface"),
          s = e("modules/offers/content/iframe/models/Ciuvo"),
          o = e("CardArea.mustache"),
          a = e("modules/offers/content/iframe/views/vertical/OffersHeaderAndFooter");
        class l extends i {
          static initClass() {
            (this.prototype.id = "cardContainer"),
              (this.prototype.className = "card-content-container"),
              (this.prototype.template = o),
              (this.prototype.subviewConstructors = { Offers: a });
          }
          initialize(...e) {
            return (
              super.initialize(...e),
      ...
      {
        "CardArea.mustache": 108,
        "content/core/Views/View": 138,
        "content/messagingInterface": 140,
        "modules/offers/content/iframe/models/Ciuvo": 148,
        "modules/offers/content/iframe/views/vertical/OffersHeaderAndFooter": 164
      }
    ],
    161: [
      function (e, t, n) {
        "use strict";
        const i = e("modules/offers/content/iframe/views/vertical/OffersContent");
        class r extends i {
          static initClass() {
    ...
    162: [
      function (e, t, n) {
        "use strict";
        const i = e("modules/offers/content/iframe/views/vertical/OffersHeaderAndFooter");
        class r extends i {
          static initClass() {
    ...
    163: [
      function (e, t, n) {
        ...
        class o extends i {
          static initClass() {
            (this.prototype.id = "offersContentArea"), (this.prototype.AO_TEMPLATE = "listing");
          }
          initialize(...e) {
            return (
              super.initialize(...e),
    ...
    164: [
      function (e, t, n) {
        ...
        const i = e("content/core/Views/View"),
          r = e("content/Models/State"),
          s = e("modules/offers/content/iframe/views/mixins/Offers"),
          o = e("modules/offers/content/iframe/models/Ciuvo");
        class a extends i {
          static initClass() {
            this.prototype.AO_TEMPLATE = "notification";
          }
    ...
    165: [
      function (e, t, n) {
        ...
        class r extends i {
          static initClass() {
            this.prototype.AO_TEMPLATE = "wishlist";
          }
        }
        r.initClass(), (t.exports = r);
      },
