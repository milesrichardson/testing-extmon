function updatePopup(document, msg) {
  ...
  if (enableAntiTrack) document.getElementById("status-text").textContent = chrome.i18n.getMessage("safe_website_antitrack");
  else document.getElementById("status-text").textContent = chrome.i18n.getMessage("safe_website");
