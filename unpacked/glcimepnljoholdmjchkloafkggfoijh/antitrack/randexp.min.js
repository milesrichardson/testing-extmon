          ...
          function (e, t, n) {
            ...
            function u(e, t) {
              ...
              switch (e.type) {
                ...
                case l.GROUP:
                  ...
                  for (
                    e.remember && void 0 === e.groupNumber && (e.groupNumber = t.push(null) - 1),
                      i = "",
                      h = 0,
                      c = (n = e.options ? a.call(this, e.options) : e.stack).length;
                    h < c;
                    h++
                  )
                    i += u.call(this, n[h], t);
                ...
                case l.REPETITION:
                  for (p = this.randInt(e.min, e.max === 1 / 0 ? e.min + this.max : e.max), i = "", h = 0; h < p; h++)
            ...
            var p = e("ret"),
              ...
              c = (t.exports = function (e, t) {
                if (((this.defaultRange = this.defaultRange.clone()), e instanceof RegExp))
                  (this.ignoreCase = e.ignoreCase), (this.multiline = e.multiline), i(this, e), (e = e.source);
                else {
                  ...
                  case "(":
                    ...
                    "?" === (n = f[i]) &&
                      ...
                      "=" === n
                        ...
                        : "!" === n
                        ? (d.notFollowedBy = !0)
                        : ":" !== n && r.error(e, "Invalid group, character '" + n + "' after '?' at column " + (i - 1)),
                      (d.remember = !1)),
                      h.push(d),
                      l.push(p),
                      (p = d),
                  ...
                  case "{":
                    ...
                    null !== w
                      ? (0 === h.length && c(i),
                        ...
                        (i += w[0].length),
                        h.push({ type: o.REPETITION, min: R, max: C, value: h.pop() }))
            ...
            (n.strToChars = function (e) {
              ...
              (n.tokenizeClass = function (e, t) {
                for (
                  ...
                  else if (a[7]) i.push({ type: r.RANGE, from: (a[8] || a[9]).charCodeAt(0), to: a[10].charCodeAt(0) });
                  else {
