...
(function () {
  ...
  const { RegExp, Reflect, Proxy, Object, Error, Array, Set, Math, Date, console } = globalThis;
            ...
            (() => {
              const functors = [
                ...
                ({ imports: $h‍_imports, liveVar: $h‍_live, onceVar: $h‍_once, importMeta: $h‍____meta }) => {
                  ...
                  const stringReplace = /** @type {any} */ uncurryThis(stringPrototype.replace);
                  ...
                  const promiseThen = /** @type {any} */ uncurryThis(promisePrototype.then);
                  ...
                  const getConstructorOf = (fn) => reflectGet(getPrototypeOf(fn), "constructor");
                ...
                ({ imports: $h‍_imports, liveVar: $h‍_live, onceVar: $h‍_once, importMeta: $h‍____meta }) => {
                  ...
                  const makeAssert = (optRaise = undefined, unredacted = false) => {
                    ...
                    /** @type {AssertFail} */
                    const fail = (optDetails = assertFailedDetails, ErrorConstructor = globalThis.Error) => {
                    ...
                    /** @type {BaseAssert} */
                    function baseAssert(flag, optDetails = undefined, ErrorConstructor = undefined) {
                    ...
                    const equal = (actual, expected, optDetails = undefined, ErrorConstructor = undefined) => {
                      is(actual, expected) ||
                        fail(optDetails || details`Expected ${actual} is same as ${expected}`, ErrorConstructor || RangeError);
                    };
                    freeze(equal);
                    ...
                    /** @type {AssertString} */
                    const assertString = (specimen, optDetails = undefined) => assertTypeof(specimen, "string", optDetails);
                  ...
                  const makeIntrinsicsCollector = () => {
                    ...
                    const completePrototypes = () => {
                      for (const [name, intrinsic] of entries(intrinsics)) {
                        ...
                        if (typeof namePrototype !== "string" || !objectHasOwnProperty(permitted, namePrototype)) {
                    ...
                    for (const intrinsicName of getOwnPropertyNames(intrinsics)) {
                      ...
                      if (isObject(intrinsic)) {
                        for (const methodName of getOwnPropertyNames(intrinsic)) {
                          ...
                          if (match) {
                            typeof intrinsic[methodName] === "function" || Fail`expected ${q(methodName)} to be a function`;
                            const nonLocaleMethodName = `${match[1]}${match[2]}`;
                            const method = intrinsic[nonLocaleMethodName];
                            typeof method === "function" || Fail`function ${q(nonLocaleMethodName)} not found`;
                ...
                ({ imports: $h‍_imports, liveVar: $h‍_live, onceVar: $h‍_once, importMeta: $h‍____meta }) => {
                  ...
                  const createSloppyGlobalsScopeTerminator = (globalObject) => {
                    ...
                    const sloppyGlobalsScopeTerminator = new Proxy(immutableObject, sloppyGlobalsScopeTerminatorHandler);
  ...
  `);
                ...
                ({ imports: $h‍_imports, liveVar: $h‍_live, onceVar: $h‍_once, importMeta: $h‍____meta }) => {
                   ...
                   */
                  const makeSafeEvaluator = ({ globalObject, moduleLexicals = {}, globalTransforms = [], sloppyGlobalsMode = false }) => {
                ...
                ({ imports: $h‍_imports, liveVar: $h‍_live, onceVar: $h‍_once, importMeta: $h‍____meta }) => {
                  ...
                  /** @type {readonly [ConsoleProps, LogSeverity | undefined][]} */
                  const consoleWhitelist = freeze([...consoleLevelMethods, ...consoleOtherMethods]);
                  ...
                  const makeCausalConsole = (baseConsole, loggedErrorHandler) => {
                    const { getStackString, tagError, takeMessageLogArgs, takeNoteLogArgsArray } = loggedErrorHandler;
                ...
                ({ imports: $h‍_imports, liveVar: $h‍_live, onceVar: $h‍_once, importMeta: $h‍____meta }) => {
                  ...
                  const tameConsole = (
                    ...
                    const ourConsole =
                      consoleTaming === "unsafe" ? originalConsole : makeCausalConsole(originalConsole, loggedErrorHandler);
                    ...
                    if (unhandledRejectionTrapping !== "none" && globalThis.process !== undefined) {
                ...
                ({ imports: $h‍_imports, liveVar: $h‍_live, onceVar: $h‍_once, importMeta: $h‍____meta }) => {
                  ...
                  const CALLSITE_PATTERNS = [CALLSITE_ELLIPSES_PATTERN, CALLSITE_PACKAGES_PATTERN];
                ...
                ({ imports: $h‍_imports, liveVar: $h‍_live, onceVar: $h‍_once, importMeta: $h‍____meta }) => {
                  ...
                  const loadRecord = (
                    ...
                    const { resolveHook, moduleRecords } = weakmapGet(compartmentPrivateFields, compartment);
                  ...
                  const loadWithoutErrorAnnotation = async (
                    ...
                    const { importHook, moduleMap, moduleMapHook, moduleRecords } = weakmapGet(compartmentPrivateFields, compartment);
                ...
                ({ imports: $h‍_imports, liveVar: $h‍_live, onceVar: $h‍_once, importMeta: $h‍____meta }) => {
                  ...
                  const getDeferredExports = (compartment, compartmentPrivateFields, moduleAliases, specifier) => {
                ...
                ({ imports: $h‍_imports, liveVar: $h‍_live, onceVar: $h‍_once, importMeta: $h‍____meta }) => {
                  ...
                  const provideCompartmentEvaluator = (compartmentFields, options) => {
                    const { sloppyGlobalsMode = false, __moduleShimLexicals__ = undefined } = options;
                ...
                ({ imports: $h‍_imports, liveVar: $h‍_live, onceVar: $h‍_once, importMeta: $h‍____meta }) => {
                  ...
                  const makeModuleInstance = (privateFields, moduleAliases, moduleRecord, importedInstances) => {
                    const { compartment, moduleSpecifier, staticModuleRecord, importMeta: moduleRecordMeta } = moduleRecord;
                    const {
                ...
                ({ imports: $h‍_imports, liveVar: $h‍_live, onceVar: $h‍_once, importMeta: $h‍____meta }) => {
                  ...
                  function validateStaticModuleRecord(staticModuleRecord, moduleSpecifier) {
                    ...
                    isArray(imports) ||
                      Fail`Property 'imports' of a static module record must be an array, got ${q(imports)}, for module ${q(
                        moduleSpecifier
                      )}`;
                    isArray(exports) ||
                  ...
                  const instantiate = (compartmentPrivateFields, moduleAliases, moduleRecord) => {
                    const { compartment, moduleSpecifier, resolvedImports, staticModuleRecord } = moduleRecord;
                ...
                ({ imports: $h‍_imports, liveVar: $h‍_live, onceVar: $h‍_once, importMeta: $h‍____meta }) => {
                  ...
                  const InertCompartment = function Compartment(_endowments = {}, _modules = {}, _options = {}) {
                  ...
                  const CompartmentPrototype = {
                    ...
                    async import(specifier) {
                      ...
                      return promiseThen(load(privateFields, moduleAliases, this, specifier), () => {
                        ...
                        const namespace = compartmentImportNow(/** @type {Compartment} */ this, specifier);
                  ...
                  const makeCompartmentConstructor = (targetMakeCompartmentConstructor, intrinsics, markVirtualizedNativeFunction) => {
                ...
                ({ imports: $h‍_imports, liveVar: $h‍_live, onceVar: $h‍_once, importMeta: $h‍____meta }) => {
                  ...
                  const tameSymbolConstructor = () => {
                    ...
                    const descs = fromEntries(arrayMap(originalDescsEntries, ([name, desc]) => [name, { ...desc, configurable: true }]));
      ...
      `
                  ...
                  const repairIntrinsics = (options = {}) => {
                    ...
                    const { addIntrinsics, completePrototypes, finalIntrinsics } = makeIntrinsicsCollector();
                ...
                (function () {
                  ...
                  function endowmentsToolkit({ createFunctionWrapper = defaultCreateFunctionWrapper } = {}) {
                    ...
                    function copyWrappedGlobals(globalRef, target, globalThisRefs = ["globalThis"]) {
                      ...
                      const endowmentSourceDescriptors = endowmentSources.map((globalProtoChainEntry) =>
                ...
                (function () {
                  ...
                  const scopeProxyHandlerProperties = {
                    ...
                    getOwnPropertyDescriptor(_target, prop) {
                      // Coerce with `String` in case prop is a symbol.
                      const quotedProp = q(String(prop));
                      console.warn(`getOwnPropertyDescriptor trap on scopeTerminatorHandler for ${quotedProp}`, new TypeError().stack);
                      return undefined;
                    }
                  };
