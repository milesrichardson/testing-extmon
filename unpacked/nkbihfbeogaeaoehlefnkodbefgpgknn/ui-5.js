  ...
  [
    [
      4897,
      {
        ...
        "../../../pages/confirm-approve/confirm-approve.util": 5645,
        "../../../store/actions": 5965,
        "../../component-library": 5242,
        "./custom-spending-cap-tooltip": 4896,
        "bignumber.js": 2804,
            ...
            return function () {
              ...
              return function (e, t, n) {
                ...
                var r = (function (e, t) {
                  ...
                  v = e("../../../contexts/gasFee"),
                  b = k(e("../../../helpers/constants/zendesk-url")),
                ...
                function w({
                  ...
                  passTheErrorText: T,
                  decimals: w,
                  setInputChangeInProgress: x,
                  customSpendingCap: E,
                  setCustomSpendingCap: C
                }) {
                  const M = (0, r.useContext)(l.I18nContext),
                    P = (0, a.useDispatch)(),
                    { updateTransaction: O } = (0, v.useGasFeeContext)(),
                    S = (0, r.useRef)(null),
                    [j, N] = (0, r.useState)(""),
                    [I, D] = (0, r.useState)(E !== String(o) && !0),
                    R = M("inputLogicEmptyState"),
                    A = (e) => e.replace(/,/gu, "."),
                    F = (e, t) => new g.Numeric(Number(A(e)), 10).greaterThan(Number(t), 10),
                    B = (e) =>
                      new g.Numeric(Number(A(e)), 10).lessThanOrEqualTo(new g.Numeric(Number(n), 10))
                        ? {
                            className: "custom-spending-cap__lowerValue",
                            description: M("inputLogicEqualOrSmallerNumber", [
                              r.default.createElement(
                                c.Text,
                                { key: "custom-spending-cap", variant: u.TextVariant.bodySmBold, as: "span" },
                                A(e),
                                " ",
                                t
                              )
                        ...
                        : F(e, n)
                        ? { className: "custom-spending-cap__higherValue", description: M("inputLogicHigherNumber") }
                        : { className: "custom-spending-cap__emptyState", description: M("inputLogicEmptyState") },
                    [L, W] = (0, r.useState)(B(E).description),
                    $ = async (t) => {
                      var n;
                      if (!e) return;
                      x(!0);
                      let r = "";
                      const a = B(t).description,
                        o = m.DECIMAL_REGEX.exec(A(t));
                      if ((null == o || null === (n = o[1]) || void 0 === n ? void 0 : n.length) > w) return void x(!1);
                      t && !m.NUM_W_OPT_DECIMAL_COMMA_OR_DOT_REGEX.test(t)
                        ? ((r = M("spendingCapError")), W(M("spendingCapErrorDescription", [k])), N(r))
                        : (W(a), N(""));
                      const l = (0, p.calcTokenAmount)(m.MAX_TOKEN_ALLOWANCE_AMOUNT, w);
                      if (Number(t.length) > 1 && Number(t)) {
                        new i.default(t).greaterThan(l) && ((r = M("spendLimitTooLarge")), N(r));
                      }
                      if ((C(String(t)), P((0, d.setCustomTokenAmount)(String(t))), "" !== String(t)))
                        try {
                          const n = (0, y.getCustomTxParamsData)(e.data, { customPermissionAmount: t, decimals: w }),
                            { from: r, to: a, value: o } = e,
                            i = await (0, h.estimateGas)({ from: r, to: a, value: o, data: n });
                          i && (await O({ gasLimit: (0, f.hexToDecimal)((0, s.addHexPrefix)(i)) }));
                        } catch (e) {
                          console.error("Error in trying to update gas limit", e);
                        }
                      x(!1);
                    };
                  (0, r.useEffect)(() => {
                  ...
                  const q = F(E, n)
                    ? M("warningTooltipText", [
                        r.default.createElement(
                          c.Text,
                          { key: "tooltip-text", variant: u.TextVariant.bodySmBold, as: "span", color: u.TextColor.errorDefault },
                          r.default.createElement(c.Icon, { name: c.IconName.Danger, size: c.IconSize.Inherit }),
                          " ",
                          M("beCareful")
                        )
                      ])
                    : M("inputLogicEmptyState");
                  return r.default.createElement(
                    ...
                    r.default.createElement(
                      c.Box,
                      {
                        ...
                        borderRadius: u.Size.SM
                      },
                      r.default.createElement(
                        c.Box,
                        { display: u.Display.Flex, alignItems: u.AlignItems.center, gap: 1, width: u.BlockSize.Full },
                        r.default.createElement(
                          "div",
                          null,
                          r.default.createElement(
                            c.Label,
                            { htmlFor: "custom-spending-cap", display: u.Display.Inline, marginRight: 1 },
                            M("customSpendingCap")
                          ),
                          r.default.createElement(_.CustomSpendingCapTooltip, {
                            tooltipContentText: A(E) ? q : "",
                            tooltipIcon: A(E) ? F(E, n) : ""
                          })
                        ),
                        I &&
                          r.default.createElement(
                      ...
                      r.default.createElement(c.TextField, {
                        ...
                        inputProps: {
                          ...
                          color: F(E, n) ? u.TextColor.errorDefault : u.TextColor.textDefault,
                          paddingInlineEnd: 4
                        },
                        id: "custom-spending-cap",
                        onChange: (e) => $(e.target.value),
                        placeholder: M("enterANumber"),
                        value: E,
                        endAccessory: r.default.createElement(
                          c.ButtonLink,
                          {
                            onClick: (e) => {
                              e.preventDefault(), $(n);
                      ...
                      r.default.createElement(
                        c.HelpText,
                        { color: j ? u.TextColor.errorDefault : u.TextColor.textDefault, variant: u.TextVariant.bodySm },
                        j || (A(E) ? L : R)
                      ),
                      r.default.createElement(
                        c.ButtonLink,
                        { size: u.Size.SM, href: b.default.TOKEN_ALLOWANCE_WITH_SPENDING_CAP, externalLink: !0 },
                ...
                w.propTypes = {
                  txParams: o.default.object.isRequired,
                  tokenName: o.default.string,
                  currentTokenBalance: o.default.string,
                  dappProposedValue: o.default.string,
                  siteOrigin: o.default.string,
                  passTheErrorText: o.default.func,
                  decimals: o.default.string,
                  setInputChangeInProgress: o.default.func.isRequired,
                  customSpendingCap: o.default.string,
                  setCustomSpendingCap: o.default.func.isRequired
                };
              };
            };
      },
              ...
              return function (e, t, n) {
                ...
                const p = ({ tokenAddress: e }) => {
                  const t = (0, o.useI18nContext)(),
                    [n, a] = (0, i.useCopyToClipboard)();
                  return r.default.createElement(
                    c.Box,
                    { display: l.Display.InlineFlex, className: "detected-token-address" },
                    r.default.createElement(c.Text, { color: l.TextColor.textDefault }, `${t("tokenAddress")}:`),
                    r.default.createElement(
                      s.default,
                ...
                p.propTypes = { tokenAddress: a.default.string };
                n.default = p;
              };
            };
      },
          ...
          with (this.globalThis)
            return function () {
              ...
              return function (e, t, n) {
                    ...
                    a.default.createElement(
                      ...
                      t("fromTokenLists", [
                        n > 0 && !r
                          ? a.default.createElement(
                              l.Text,
                              { as: "h6", fontWeight: s.FontWeight.Normal, key: "detected-token-aggrgators-with-more" },
                              `${e.slice(0, 2).join(", ")}`,
                              a.default.createElement(
                                l.ButtonLink,
                                {
                          ...
                          : a.default.createElement(
                              l.Text,
                              { as: "h6", fontWeight: s.FontWeight.Normal, key: "detected-token-aggrgators-without-more" },
                              `${e.join(", ")}.`
                            )
                      ])
                    )
                ...
                c.propTypes = { aggregators: o.default.array.isRequired };
                n.default = c;
              };
            };
      },
    ...
    [
      4900,
      {
        ...
        "../../../component-library": 5242,
        "../../../ui/identicon": 5430,
        "../detected-token-address/detected-token-address": 4898,
        "../detected-token-aggregators/detected-token-aggregators": 4899,
        "../detected-token-values/detected-token-values": 4903,
        "prop-types": 4219,
        react: 4475,
        "react-redux": 4440
      },
            ...
            return function () {
              ...
              return function (e, t, n) {
                ...
                var r = f(e("react")),
                  ...
                  u = f(e("../detected-token-address/detected-token-address")),
                ...
                const m = ({ token: e, handleTokenSelection: t, tokensListDetected: n }) => {
                  var a;
                  const f = (0, o.useSelector)(p.getTokenList)[null === (a = e.address) || void 0 === a ? void 0 : a.toLowerCase()];
                  return r.default.createElement(
                    i.Box,
                    { display: d.Display.Flex, className: "detected-token-details", marginBottom: 4 },
                    ...
                    r.default.createElement(
                      i.Box,
                      { display: d.Display.Grid, marginLeft: 2, className: "detected-token-details__data" },
                      r.default.createElement(l.default, { token: e, handleTokenSelection: t, tokensListDetected: n }),
                      r.default.createElement(u.default, { tokenAddress: e.address }),
                      (null == f ? void 0 : f.aggregators.length) > 0 &&
                        r.default.createElement(c.default, { aggregators: null == f ? void 0 : f.aggregators })
                    )
                  );
                };
                m.propTypes = {
                  token: a.default.shape({
                    ...
                    aggregators: a.default.array
                  }),
                  handleTokenSelection: a.default.func.isRequired,
                  tokensListDetected: a.default.object
                };
                n.default = m;
              };
            };
          ...
          with (this.globalThis)
            return function () {
              ...
              return function (e, t, n) {
                ...
                const c = ({ partiallyIgnoreDetectedTokens: e, onCancelIgnore: t, handleClearTokensSelection: n, isOpen: a }) => {
                  ...
                  return r.default.createElement(
                    ...
                    r.default.createElement(
                      l.ModalContent,
                      null,
                      r.default.createElement(l.ModalHeader, { marginBottom: 4 }, u(e ? "importSelectedTokens" : "areYouSure")),
                      r.default.createElement(l.Text, { marginBottom: 4 }, u(e ? "importSelectedTokensDescription" : "ignoreTokenWarning")),
                      r.default.createElement(
                        l.Box,
                        { display: s.Display.Flex, justifyContent: s.JustifyContent.center, gap: 4 },
                        r.default.createElement(
                          l.Button,
                          {
                ...
                c.propTypes = {
                  partiallyIgnoreDetectedTokens: a.default.bool.isRequired,
                  onCancelIgnore: a.default.func.isRequired,
                  handleClearTokensSelection: a.default.func.isRequired,
    ...
    [
      4902,
      {
        ...
        "../../../ui/button": 5377,
        "../../../ui/popover": 5465,
        "../detected-token-details/detected-token-details": 4900,
        "prop-types": 4219,
        react: 4475,
        "react-redux": 4440
      },
              ...
              return function (e, t, n) {
                ...
                const h = ({
                  ...
                  const h = (0, i.useI18nContext)(),
                    y = (0, r.useContext)(s.MetaMetricsContext),
                    v = (0, o.useSelector)(u.getCurrentChainId),
                    b = (0, o.useSelector)(u.getDetectedTokensInCurrentNetwork),
                    { selected: _ = [] } = g(e),
                    k = r.default.createElement(
                      ...
                      r.default.createElement(
                        p.default,
                        { className: "detected-token-selection-popover__ignore-button", type: "secondary", onClick: () => a() },
                        h("ignoreAll")
                      ),
                      r.default.createElement(
                        p.default,
                  ...
                  return r.default.createElement(
                    c.default,
                    {
                      ...
                      title: 1 === b.length ? h("tokenFoundTitle") : h("tokensFoundTitle", [b.length]),
                      onClose: () => {
                        m(!1);
                        const e = b.map(({ address: e, symbol: t }) => `${t} - ${e}`);
                        y({
                          event: l.MetaMetricsEventName.TokenImportCanceled,
                          category: l.MetaMetricsEventCategory.Wallet,
                          properties: { source_connection_method: l.MetaMetricsTokenEventSource.Detected, chain_id: v, tokens: e }
                        });
                      },
                      footer: k
                    },
                    r.default.createElement(
                      ...
                      { margin: 3 },
                      b.map((n, a) =>
                        r.default.createElement(f.default, { key: a, token: n, handleTokenSelection: t, tokensListDetected: e })
                      )
                    )
                  );
                };
                h.propTypes = {
                  tokensListDetected: a.default.object,
                  handleTokenSelection: a.default.func.isRequired,
                  onIgnoreAll: a.default.func.isRequired,
                  onImport: a.default.func.isRequired,
                  setShowDetectedTokens: a.default.func.isRequired,
                  sortingBasedOnTokenSelection: a.default.func.isRequired
                };
                n.default = h;
              };
            };
          ...
          with (this.globalThis)
            return function () {
              ...
              return function (e, t, n) {
                ...
                const f = ({ token: e, handleTokenSelection: t, tokensListDetected: n }) => {
                  var r;
                  const [o, p] = (0, a.useState)(() => {
                      var t;
                      return null === (t = n[e.address]) || void 0 === t ? void 0 : t.selected;
                    }),
                    { tokensWithBalances: f } = (0, l.useTokenTracker)({ tokens: [e] }),
                    m = null === (r = f[0]) || void 0 === r ? void 0 : r.string,
                    g = (0, u.useTokenFiatAmount)(e.address, m, e.symbol),
                    h = (0, i.useSelector)(c.getUseCurrencyRateCheck);
                  (0, a.useEffect)(() => {
                    var t;
                    p(null === (t = n[e.address]) || void 0 === t ? void 0 : t.selected);
                  }, [n, e.address, o, p]);
                  return a.default.createElement(
                    d.Box,
                    ...
                    a.default.createElement(
                      d.Box,
                      { marginBottom: 1 },
                      a.default.createElement(d.Text, { variant: s.TextVariant.bodyLgMedium, as: "h4" }, `${m || "0"} ${e.symbol}`),
                      a.default.createElement(
                        d.Text,
                    ...
                    a.default.createElement(
                      ...
                      a.default.createElement(d.Checkbox, {
                        isChecked: o,
                        onClick: () => {
                          p(!o), t(e);
                        }
    ...
    [
      4904,
      {
        ...
        "../../../selectors": 5958,
        "../../../store/actions": 5965,
        "./detected-token-ignored-popover/detected-token-ignored-popover": 4901,
        "./detected-token-selection-popover/detected-token-selection-popover": 4902,
        lodash: 4071,
        "prop-types": 4219,
        react: 4475,
        "react-redux": 4440
            ...
            return function () {
              ...
              return function (e, t, n) {
                ...
                var r = (function (e, t) {
                  ...
                  p = m(e("./detected-token-selection-popover/detected-token-selection-popover")),
                  f = m(e("./detected-token-ignored-popover/detected-token-ignored-popover"));
                function m(e) {
                  return e && e.__esModule ? e : { default: e };
                }
                function g(e) {
                ...
                const h = (e) =>
                    (0, i.chain)(e)
                      ...
                      .mapValues((e) =>
                        e.map(({ token: e }) => {
                          const { address: t, symbol: n, decimals: r, aggregators: a } = e;
                          return { address: t, symbol: n, decimals: r, aggregators: a };
                        })
                      )
                      .value(),
                  y = ({ setShowDetectedTokens: e }) => {
                    const t = (0, o.useDispatch)(),
                      ...
                      a = (0, o.useSelector)(l.getCurrentChainId),
                      i = (0, o.useSelector)(l.getDetectedTokensInCurrentNetwork),
                      m = (0, o.useSelector)(l.getSelectedNetworkClientId),
                      [g, y] = (0, r.useState)(() => i.reduce((e, t) => ((e[t.address] = { token: t, selected: !0 }), e), {})),
                      [v, b] = (0, r.useState)(!1),
                      [_, k] = (0, r.useState)(!1),
                      T = async (e) => {
                        e.forEach((e) => {
                        ...
                        const r = e.map(({ symbol: e }) => e);
                        t((0, s.setNewTokensImported)(r.join(", ")));
                      };
                    return r.default.createElement(
                      r.default.Fragment,
                      null,
                      v &&
                        r.default.createElement(f.default, {
                          ...
                          handleClearTokensSelection: async () => {
                            const { selected: r = [], deselected: a = [] } = h(g);
                            a.length < i.length && (await T(r));
                            const o = a.map(({ symbol: e, address: t }) => `${e} - ${t}`);
                            n({
                              event: d.MetaMetricsEventName.TokenHidden,
                              category: d.MetaMetricsEventCategory.Wallet,
                              sensitiveProperties: {
                                tokens: o,
                                location: d.MetaMetricsEventLocation.TokenDetection,
                                token_standard: c.TokenStandard.ERC20,
                                asset_type: c.AssetType.token
                              }
                            });
                            const l = a.map(({ address: e }) => e);
                            await t((0, s.ignoreTokens)({ tokensToIgnore: l, dontShowLoadingIndicator: !0 })), e(!1), k(!1);
                          },
                      ...
                      i.length > 0 &&
                        r.default.createElement(p.default, {
                          ...
                          handleTokenSelection: (e) => {
                            y((t) => ({ ...t, [e.address]: { ...t[e.address], selected: !t[e.address].selected } }));
                          },
                          onImport: async () => {
                            const { selected: t = [] } = h(g);
                            t.length < i.length ? (b(!0), k(!0)) : (await T(t), e(!1));
                          },
                          onIgnoreAll: () => {
                            const e = { ...g };
                ...
                y.propTypes = { setShowDetectedTokens: a.default.func.isRequired };
                n.default = y;
              };
            };
      },
    ...
    [
      4905,
      {
        ...
        "../../component-library": 5242,
        "../../ui/button": 5377,
        "../../ui/info-tooltip": 5431,
        "../advanced-gas-controls/advanced-gas-controls.component": 4805,
        "bignumber.js": 2804,
        "prop-types": 4219,
        react: 4475
      },
            ...
            return function () {
              ...
              return function (e, t, n) {
                ...
                var r = (function (e, t) {
                  ...
                  p = m(e("../advanced-gas-controls/advanced-gas-controls.component")),
                  f = e("../../../contexts/i18n");
                function m(e) {
                  return e && e.__esModule ? e : { default: e };
                }
                ...
                function h({
                  ...
                  balanceError: T,
                  gasErrors: w,
                  txParamsHaveBeenCustomized: x
                }) {
                  const E = (0, r.useContext)(f.I18nContext),
                    C = (0, r.useRef)(null),
                    M = (0, c.areDappSuggestedAndTxParamGasFeesTheSame)(n),
                    P = Boolean((null == n ? void 0 : n.dappSuggestedGasFees) && !v && M);
                  let O;
                  g !== undefined && y !== undefined && new o.default(g).lessThan(new o.default(y)) && (O = E("gasLimitRecommended", [y]));
                  const S = T && x;
                  return r.default.createElement(
                    "div",
                    ...
                    r.default.createElement(
                      ...
                      O && r.default.createElement(u.BannerAlert, { severity: l.Severity.Warning, description: O, marginBottom: 6 }),
                      P &&
                        r.default.createElement(u.BannerAlert, {
                      ...
                      e === i.EditGasModes.speedUp &&
                        r.default.createElement(
                          ...
                          r.default.createElement(
                            u.Text,
                            { color: l.TextColor.textDefault, variant: l.TextVariant.bodySm, as: "h6", fontWeight: l.FontWeight.Bold },
                            E("speedUpTooltipText"),
                            " ",
                            r.default.createElement(d.default, { position: "top", contentText: E("speedUpExplanation") })
                          )
                        ),
                      r.default.createElement(
                        u.Text,
                        { color: l.TextColor.textDefault, variant: l.TextVariant.headingLg, as: "h1", textAlign: l.TextAlign.Center },
                        t
                      ),
                      P &&
                        r.default.createElement(
                          s.default,
                          { className: "edit-gas-display__dapp-acknowledgement-button", onClick: () => b(!0) },
                    ...
                    r.default.createElement("div", { ref: C, className: "edit-gas-display__scroll-bottom" })
                  );
                }
                h.propTypes = {
                  mode: a.default.oneOf(Object.values(i.EditGasModes)),
    ...
    [
      4906,
      { "./edit-gas-display.component": 4905 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
              ...
              return function (e, t, n) {
                ...
                var r,
                  a = (r = e("./edit-gas-display.component")) && r.__esModule ? r : { default: r };
              };
            };
      },
    ...
    [
      4907,
      {
        ...
        "../../../hooks/useI18nContext": 5602,
        "../../../hooks/useTransactionEventFragment": 5625,
        "../../component-library": 5242,
        "../../ui/info-tooltip/info-tooltip": 5433,
        "prop-types": 4219,
        react: 4475
      },
      function () {
            ...
            return function () {
              ...
              return function (e, t, n) {
                ...
                var r = m(e("react")),
                  ...
                  c = e("../../../hooks/useTransactionEventFragment"),
                ...
                function g({ userAcknowledgedGasMissing: e }) {
                  const t = (0, u.useI18nContext)(),
                    ...
                    { updateTransactionEventFragment: _ } = (0, c.useTransactionEventFragment)(),
                    { openModal: k } = (0, d.useTransactionModalContext)();
                  if (!v || !g || !(!m || !0 === e)) return null;
                  let T = g,
                    w = g;
                  g === o.PriorityLevels.high && n === o.EditGasModes.swaps
                    ? ((T = "swapSuggested"), (w = "swapSuggested"))
                    : g === o.PriorityLevels.tenPercentIncreased && ((T = undefined), (w = "tenPercentIncreased"));
                  return r.default.createElement(
                    "div",
                    ...
                    r.default.createElement(
                      ...
                      {
                        onClick: () => {
                          _({ gas_edit_attempted: "basic" }), k("editGasFee");
                        },
                        "data-testid": "edit-gas-fee-button"
                      },
                      T && r.default.createElement("span", { className: "edit-gas-fee-button__icon" }, s.PRIORITY_LEVEL_ICON_MAP[T]),
                      r.default.createElement("span", { className: "edit-gas-fee-button__label" }, t(w)),
                      r.default.createElement(f.Icon, { name: f.IconName.ArrowRight, color: i.Color.primaryDefault, size: f.IconSize.Xs })
                    ),
                    "custom" === g &&
                      r.default.createElement(
                        "button",
                        {
                          onClick: () => {
                            _({ gas_edit_attempted: "advanced" }), k("advancedGasFee");
                          }
                        },
                        t("edit")
                      ),
                    "dappSuggested" === g &&
                      r.default.createElement(p.default, {
                        contentText: r.default.createElement(
                          ...
                          (null == b ? void 0 : b.origin) &&
                            r.default.createElement(
                              f.Text,
                              { variant: i.TextVariant.bodySm, as: "h6", color: i.TextColor.textAlternative },
                              t("dappSuggestedTooltip", [b.origin])
                            ),
                          r.default.createElement(
                            f.Text,
                            { variant: i.TextVariant.bodySm, as: "h6" },
                            r.default.createElement("b", null, t("maxBaseFee")),
                            " ",
                            h
                          ),
                          r.default.createElement(
                          ...
                          r.default.createElement(
                            f.Text,
                            { variant: i.TextVariant.bodySm, as: "h6" },
                            r.default.createElement("b", null, t("gasLimit")),
                            " ",
                            a
                          )
                        ),
                ...
                g.propTypes = { userAcknowledgedGasMissing: a.default.bool };
              };
            };
      },
          ...
          with (this.globalThis)
            return function () {
              ...
              return function (e, t, n) {
                ...
                var r,
                  a = (r = e("./edit-gas-fee-button")) && r.__esModule ? r : { default: r };
              };
            };
      },
    ...
    [
      4909,
      {
        ...
        "../../ui/popover": 5465,
        "../app-loading-spinner": 4834,
        "./edit-gas-item": 4911,
        "./network-statistics": 4916,
        react: 4475
      },
      function () {
        with (this.scopeTerminator)
              ...
              return function (e, t, n) {
                ...
                n.default = () => {
                  const { balanceError: e, editGasMode: t } = (0, p.useGasFeeContext)(),
                    ...
                    { closeAllModals: v, closeModal: b, currentModal: _, openModalCount: k } = (0, i.useTransactionModalContext)();
                  if ("editGasFee" !== _) return null;
                  let T = "editGasFeeModalTitle";
                  return (
                    t === a.EditGasModes.cancel
                      ? (T = "editCancellationGasFeeModalTitle")
                      : t === a.EditGasModes.speedUp && (T = "editSpeedUpEditGasFeeModalTitle"),
                    r.default.createElement(
                      u.default,
                      { title: n(T), onBack: 1 === k ? undefined : () => b(["editGasFee"]), onClose: v, className: "edit-gas-fee-popover" },
                      r.default.createElement(
                        r.default.Fragment,
                        null,
    ...
    [
      4910,
      {
        ...
        "../../../../hooks/useTransactionEventFragment": 5625,
        "../../../ui/info-tooltip": 5431,
        "../../../ui/loading-heartbeat": 5436,
        "../../user-preferenced-currency-display": 5167,
        "../edit-gas-tooltip/edit-gas-tooltip": 4914,
        "./useGasItemFeeDetails": 4913,
        classnames: 2952,
        "prop-types": 4219,
        react: 4475
      },
              ...
              return function (e, t, n) {
                ...
                const _ = ({ priorityLevel: e }) => {
                  const {
                    ...
                    { updateTransactionEventFragment: w } = (0, p.useTransactionEventFragment)(),
                    x = (0, d.useI18nContext)(),
                    { closeModal: E, openModal: C } = (0, f.useTransactionModalContext)(),
                    { dappSuggestedGasFees: M } = T,
                    {
                    ...
                    "button",
                    {
                      ...
                      onClick: () => {
                        e === i.PriorityLevels.custom
                          ? (w({ properties: { gas_edit_attempted: "advanced" } }), C("advancedGasFee"))
                          : (w({ properties: { gas_edit_type: "basic" } }),
                            E(["editGasFee"]),
                            e === i.PriorityLevels.tenPercentIncreased ? b() : e === i.PriorityLevels.dAppSuggested ? _() : k(e));
                      },
                      "aria-label": e,
                      autoFocus: e === n,
                      disabled: P,
            ...
            return function () {
              ...
              return function (e, t, n) {
                ...
                n.useGasItemFeeDetails = (e) => {
                  ...
                  let _, k, T;
                  const { dappSuggestedGasFees: w } = h;
                  if (null != p && p[e]) (_ = p[e].suggestedMaxFeePerGas), (k = p[e].suggestedMaxPriorityFeePerGas);
                  else if (e === o.PriorityLevels.dAppSuggested && w)
                    (_ = (0, c.hexWEIToDecGWEI)(w.maxFeePerGas || w.gasPrice)), (k = (0, c.hexWEIToDecGWEI)(w.maxPriorityFeePerGas || _));
                  else if (e === o.PriorityLevels.custom)
                    n === o.PriorityLevels.custom
                      ? ((_ = m), (k = g))
                      : b && t !== o.EditGasModes.swaps && ((_ = b.maxBaseFee), (k = b.priorityFee));
                  ...
                  return (
                    ...
                    { estimateGreaterThanGasUse: y, maxFeePerGas: _, maxPriorityFeePerGas: k, minWaitTime: T, hexMaximumTransactionFee: M }
                  );
                };
              };
            };
    ...
    [
      4921,
      {
        ...
        "../../../hooks/useIncrementedGasFees": 5603,
        "../../../store/actions": 5965,
        "../../component-library": 5242,
        "../../ui/loading-heartbeat": 5436,
        "../edit-gas-display": 4906,
        "prop-types": 4219,
        react: 4475,
        "react-redux": 4440
      },
              ...
              return function (e, t, n) {
                ...
                function b({
                  ...
                  const {
                    ...
                    B = I === l.CUSTOM_GAS_ESTIMATE || (0, s.txParamsAreDappSuggested)(C),
                    L = (0, r.useCallback)(() => {
                      y ? y() : k((0, p.hideModal)());
                    }, [y, k]),
                    W = (0, r.useCallback)(async () => {
                      ...
                      switch (h) {
                        case l.EditGasModes.cancel:
                          k((0, p.createCancelTransaction)(C.id, e));
                          break;
                        case l.EditGasModes.speedUp:
                          k((0, p.createSpeedUpTransaction)(C.id, e));
                          break;
                        case l.EditGasModes.modifyInPlace:
                          (e.userEditedGasLimit = n.userEditedGasLimit),
                            (e.userFeeLevel = n.userFeeLevel),
                            k((0, p.showLoadingIndication)()),
                            await k((0, p.updateTransactionGasFees)(n.id, e)),
                            k((0, p.hideLoadingIndication)());
                      }
                      L();
                    }, [C, h, k, L, S, P, a.originalGasEstimate, I]);
                  let $ = _("editGasTitle");
                  e
                    ? ($ = e)
                    : h === l.EditGasModes.speedUp
                    ? ($ = _("speedUpPopoverTitle"))
                    : h === l.EditGasModes.cancel && ($ = _("cancelPopoverTitle"));
                  const q = t || _("save");
                  return r.default.createElement(
                    u.Modal,
                    { isOpen: !0, onClose: L },
                    ...
                    r.default.createElement(
                      ...
                      r.default.createElement(u.ModalHeader, { onClose: L, marginBottom: 4 }, $),
                      r.default.createElement(
                        "div",
                        ...
                        r.default.createElement(
                          ...
                          v(
                            {
                              dappSuggestedGasFeeAcknowledged: T,
                              setDappSuggestedGasFeeAcknowledged: w,
                              estimatedMinimumNative: M,
                              gasPrice: P,
                              setGasPrice: O,
                              gasLimit: S,
    ...
    [
      4922,
      { "./edit-gas-popover.component": 4921 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      4925,
      {
        ...
        "../../../helpers/constants/common": 5535,
        "../../../helpers/constants/design-system": 5537,
        "../../../hooks/useDraftTransactionWithTxParams": 5598,
        "../../../hooks/useI18nContext": 5602,
        "../../../selectors": 5958,
        "../../ui/box": 5373,
        "../../ui/loading-heartbeat": 5436,
        "../gas-timing/gas-timing.component": 4927,
        "../transaction-detail-item/transaction-detail-item.component": 5153,
        "../user-preferenced-currency-display": 5167,
        "./gas-details-item-title": 4924,
        classnames: 2952,
        "prop-types": 4219,
        react: 4475,
        "react-redux": 4440
            ...
            return function () {
              ...
              return function (e, t, n) {
                ...
                var r = T(e("react")),
                  ...
                  f = T(e("../../ui/box")),
                  m = T(e("../../ui/loading-heartbeat")),
                  g = T(e("../gas-timing/gas-timing.component")),
                  h = T(e("../transaction-detail-item/transaction-detail-item.component")),
                  y = T(e("../user-preferenced-currency-display")),
                  v = e("../../../../shared/modules/conversion.utils"),
                  b = e("../../../hooks/useDraftTransactionWithTxParams"),
                  _ = e("../../../../shared/constants/gas"),
                  k = T(e("./gas-details-item-title"));
                function T(e) {
                  return e && e.__esModule ? e : { default: e };
                }
                const w = ({ "data-testid": e, userAcknowledgedGasMissing: t = !1 }) => {
                  var n, a;
                  const T = (0, p.useI18nContext)(),
                    w = (0, i.useSelector)(c.getCurrentDraftTransaction),
                  ...
                  return r.default.createElement(h.default, {
                    ...
                    "data-testid": e,
                    detailTitle: r.default.createElement(k.default, null),
                ...
                w.propTypes = { "data-testid": a.default.string, userAcknowledgedGasMissing: a.default.bool };
                n.default = w;
              };
            };
      },
              ...
              return function (e, t, n) {
                ...
                function _({ maxFeePerGas: e = 0, maxPriorityFeePerGas: t = 0, gasWarnings: n }) {
                  const o = (0, a.useSelector)(p.getGasEstimateType),
                    ...
                    T = (0, r.useContext)(c.I18nContext),
                    { estimateUsed: w } = (0, d.useGasFeeContext)(),
                    ...
                    Number(t) >= Number(O.suggestedMaxPriorityFeePerGas)
                      ? (j =
                          Number(t) < Number(S.suggestedMaxPriorityFeePerGas)
                            ? T("gasTimingPositive", [b(P.maxWaitTimeEstimate, T)])
                            : T("gasTimingVeryPositive", [b(S.minWaitTimeEstimate, T)]))
                      : ("low" === w && (N = "negative"),
                        x
                          ? _ && "unknown" !== _ && "unknown" !== (null == _ ? void 0 : _.upperTimeBound)
                            ? (j = T("gasTimingNegative", [b(Number(null == _ ? void 0 : _.upperTimeBound), T)]))
                            : ((j = T("editGasTooLow")), (N = "negative"))
                          : (j = T("gasTimingNegative", [b(P.maxWaitTimeEstimate, T)]))),
                    r.default.createElement(
                      f.default,
              ...
              return function (e, t, n) {
                ...
                function g({ buttonText: e, onLongPressed: t }) {
                  ...
                  return r.default.createElement(
                    ...
                    r.default.createElement(c.Box, { className: "hold-to-reveal-button__icon-container", marginRight: 2 }, T(), w()),
                    e
                  );
                }
    ...
    [
      4931,
      { "./home-notification.component": 4930 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      4933,
      { "./token-list-placeholder.component": 4934 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      4935,
      { "../../../../helpers/utils/util": 5578, "./token-list-placeholder": 4933, classnames: 2952, "prop-types": 4219, react: 4475 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      4936,
      { "./token-list.component": 4935, "react-redux": 4440 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
            ...
            return function () {
              ...
              return function (e, t, n) {
                ...
                var r,
                  ...
                  s = e("../../../../shared/constants/hardware-wallets"),
                ...
                const y = (e, t = !0, n = p.TextColor.textDefault) => t && a.default.createElement(c.Text, { color: n, as: "h6" }, e);
                function v({ showDataInstruction: e }) {
                  const t = (0, d.useI18nContext)(),
                    n = (0, o.useDispatch)(),
                    r = (0, o.useSelector)(u.getLedgerWebHidConnectedStatus),
                    i = (0, o.useSelector)(m.getLedgerTransportType),
                    h = (0, o.useSelector)(u.getLedgerTransportStatus),
                    v = (0, f.getEnvironmentType)() === l.ENVIRONMENT_TYPE_FULLSCREEN;
                  (0, a.useEffect)(() => {
                    (async () => {
                      if (
                        i === s.LedgerTransportTypes.webhid &&
                        r === s.WebHIDConnectedStatuses.connected &&
                        h === s.HardwareTransportStates.none
                      )
                        try {
                          const e = await (0, g.attemptLedgerTransportCreation)();
                          n(
                            (0, u.setLedgerTransportStatus)(
                              e ? s.HardwareTransportStates.verified : s.HardwareTransportStates.unknownFailure
                            )
                          );
                        } catch (e) {
                          e.message.match("Failed to open the device")
                            ? n((0, u.setLedgerTransportStatus)(s.HardwareTransportStates.deviceOpenFailure))
                            : e.message.match("the device is already open")
                            ? n((0, u.setLedgerTransportStatus)(s.HardwareTransportStates.verified))
                            : n((0, u.setLedgerTransportStatus)(s.HardwareTransportStates.unknownFailure));
                        }
                    })(),
                      (async () => {
                        if (i === s.LedgerTransportTypes.webhid && r !== s.WebHIDConnectedStatuses.connected) {
                          var e;
                          const t = await (null === (e = window.navigator) || void 0 === e || null === (e = e.hid) || void 0 === e
                              ? void 0
                              : e.getDevices()),
                            r = null == t ? void 0 : t.some((e) => e.vendorId === Number(s.LEDGER_USB_VENDOR_ID));
                          n(
                            (0, u.setLedgerWebHidConnectedStatus)(
                              r ? s.WebHIDConnectedStatuses.connected : s.WebHIDConnectedStatuses.notConnected
                            )
                          );
                        }
                      })();
                    ...
                    (0, a.useEffect)(
                      () => () => {
                        n((0, u.setLedgerTransportStatus)(s.HardwareTransportStates.none));
                      },
                      [n]
                    );
                  const b = i === s.LedgerTransportTypes.live,
                    _ = i === s.LedgerTransportTypes.webhid,
                    k = (0, f.getPlatform)() === l.PLATFORM_FIREFOX;
                  return a.default.createElement(
                    "div",
                    null,
                    a.default.createElement(
                      ...
                      a.default.createElement(
                        ...
                        a.default.createElement(
                          ...
                          y(`• ${t("ledgerConnectionInstructionStepOne")}`, !k && b),
                          y(`• ${t("ledgerConnectionInstructionStepTwo")}`, !k && b),
                          ...
                          y(
                            ...
                            h === s.HardwareTransportStates.deviceOpenFailure
                          ),
                          y(
                            a.default.createElement(
                              "span",
                              ...
                              a.default.createElement(
                                c.ButtonLink,
                                {
                                  ...
                                  onClick: async () => {
                                    if (v) {
                                      const e = (
                                        await window.navigator.hid.requestDevice({ filters: [{ vendorId: s.LEDGER_USB_VENDOR_ID }] })
                                      ).some((e) => e.vendorId === Number(s.LEDGER_USB_VENDOR_ID));
                                      n(
                                        (0, u.setLedgerWebHidConnectedStatus)({
                                          webHidConnectedStatus: e
                                            ? s.WebHIDConnectedStatuses.connected
                                            : s.WebHIDConnectedStatuses.notConnected
                                        })
                                      );
                            ...
                            _ && r === s.WebHIDConnectedStatuses.notConnected,
                ...
                v.propTypes = { showDataInstruction: i.default.bool };
              };
            };
      },
    ...
    [
      4943,
      { "./loading-network-screen.container": 4945 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      4944,
      {
        ...
        "../../component-library": 5242,
        "../../ui/box/box": 5372,
        "../../ui/loading-screen": 5439,
        "../../ui/popover/popover.component": 5466,
        "prop-types": 4219,
        react: 4475
      },
      function () {
    ...
    [
      4945,
      {
        ...
        "../../../selectors": 5958,
        "../../../store/actions": 5965,
        "./loading-network-screen.component": 4944,
        "react-redux": 4440
      },
      function () {
        with (this.scopeTerminator)
    ...
    [
      4946,
      { "./metamask-template-renderer": 4947, "./section-shape": 4949 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      4947,
      { "./safe-component-list": 4948, "./section-shape": 4949, lodash: 4071, react: 4475 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      4948,
      {
        "../../../pages/confirmation/components/confirmation-network-switch": 5677,
        "../../../pages/create-snap-account": 5705,
        "../../../pages/remove-snap-account": 5768,
        "../../../pages/snap-account-redirect": 5867,
        "../../component-library": 5242,
        "../../ui/actionable-message/actionable-message": 5369,
        "../../ui/box": 5373,
        "../../ui/button": 5377,
        "../../ui/chip": 5386,
        "../../ui/definition-list": 5395,
        "../../ui/popover": 5465,
        "../../ui/spinner": 5483,
        "../../ui/text-field": 5491,
        "../../ui/textarea/textarea": 5494,
        "../../ui/tooltip/tooltip": 5503,
        "../../ui/truncated-definition-list": 5504,
        "../../ui/typography": 5506,
        "../../ui/url-icon": 5511,
        "../metamask-translation": 4950,
        "../network-display": 5005,
        "../snaps/copyable": 5073,
        "../snaps/snap-authorship-header": 5080,
        "../snaps/snap-delineator": 5085,
        "../snaps/snap-ui-image": 5099,
        "../snaps/snap-ui-markdown": 5101
      },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
              ...
              return function (e, t, n) {
                ...
                var r = P(e("../../ui/button")),
                  a = P(e("../../ui/chip")),
                  o = P(e("../../ui/definition-list")),
                  i = P(e("../../ui/truncated-definition-list")),
                  s = P(e("../../ui/popover")),
                  l = P(e("../../ui/typography")),
                  u = P(e("../../ui/box")),
                  c = P(e("../metamask-translation")),
                  d = P(e("../network-display")),
                  p = P(e("../../ui/textarea/textarea")),
                  f = P(e("../../ui/text-field")),
                  m = P(e("../../../pages/confirmation/components/confirmation-network-switch")),
                  g = P(e("../../ui/url-icon")),
                  h = P(e("../../ui/tooltip/tooltip")),
                  y = e("../../component-library"),
                  v = P(e("../../ui/actionable-message/actionable-message")),
                  b = e("../snaps/snap-delineator"),
                  _ = e("../snaps/copyable"),
                  k = P(e("../../ui/spinner")),
                  T = e("../snaps/snap-ui-markdown"),
                  w = e("../snaps/snap-ui-image"),
                  x = e("../../../pages/create-snap-account"),
                  E = e("../../../pages/remove-snap-account"),
                  C = e("../../../pages/snap-account-redirect"),
                  M = P(e("../snaps/snap-authorship-header"));
                function P(e) {
                  return e && e.__esModule ? e : { default: e };
                }
                n.safeComponentList = {
                  ...
                  SnapUIMarkdown: T.SnapUIMarkdown,
                  SnapUIImage: w.SnapUIImage,
                  Spinner: k.default,
                  CreateSnapAccount: x.CreateSnapAccount,
                  RemoveSnapAccount: E.RemoveSnapAccount,
                  SnapAuthorshipHeader: M.default,
                  SnapAccountRedirect: C.SnapAccountRedirect
                };
              };
            };
      },
    ...
    [
      ...
      {
        "../../../hooks/useI18nContext": 5602,
        "../metamask-template-renderer": 4946,
        "../metamask-template-renderer/section-shape": 4949,
        "prop-types": 4219,
        react: 4475
      },
      function () {
    ...
    [
      4952,
      { "./modal-content": 4953, "./modal.component": 4955 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      4955,
      { "../../ui/button": 5377, classnames: 2952, "prop-types": 4219, react: 4475 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      4956,
      { "../../modal": 4952, "prop-types": 4219, react: 4475 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      4957,
      {
        "../../../../helpers/higher-order-components/with-modal-props": 5555,
        "../../../../selectors": 5958,
        "../../../../store/actions": 5965,
        "./confirm-delete-network.component": 4956,
        "react-redux": 4440,
        redux: 4505
      },
      function () {
    ...
    [
      4958,
      { "./confirm-delete-network.container": 4957 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      4960,
      {
        ...
        "../../../../selectors": 5958,
        "../../../../store/actions": 5965,
        "./confirm-remove-account.component": 4959,
        "react-redux": 4440,
        redux: 4505
      },
      function () {
    ...
    [
      4961,
      { "./confirm-remove-account.container": 4960 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      4963,
      {
        "../../../../helpers/higher-order-components/with-modal-props": 5555,
        "../../../../store/actions": 5965,
        "./confirm-reset-account.component": 4962,
        "react-redux": 4440,
        redux: 4505
      },
      function () {
    ...
    [
      4964,
      { "./confirm-reset-account.container": 4963 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      4965,
      {
        ...
        "../../../../hooks/useCopyToClipboard": 5595,
        "../../../../hooks/useI18nContext": 5602,
        "../../../../hooks/usePetnamesEnabled": 5607,
        "../../../../pages/send/send.utils": 5811,
        "../../../../selectors": 5958,
        "../../../component-library": 5242,
        "../../../ui/box": 5373,
        "../../../ui/button/button.component": 5376,
        "../../../ui/identicon": 5430,
        "../../../ui/nft-collection-image/nft-collection-image": 5454,
        "../../../ui/popover": 5465,
        "../../../ui/tooltip/tooltip": 5503,
        "../../name/name": 5002,
        "@metamask/etherscan-link": 1370,
            ...
            return function () {
              ...
              return function (e, t, n) {
                ...
                var r = w(e("react")),
                  ...
                  l = w(e("../../../ui/box")),
                  u = w(e("../../../ui/button/button.component")),
                  c = w(e("../../../ui/tooltip/tooltip")),
                  d = e("../../../../hooks/useI18nContext"),
                  p = w(e("../../../ui/identicon")),
                  ...
                  b = w(e("../../../ui/nft-collection-image/nft-collection-image")),
                  _ = e("../../../component-library"),
                  k = w(e("../../name/name")),
                  T = e("../../../../hooks/usePetnamesEnabled");
                function w(e) {
                  return e && e.__esModule ? e : { default: e };
                }
                function x({
                  ...
                  const j = (0, d.useI18nContext)(),
                    ...
                    A = (0, T.usePetnamesEnabled)(),
                    F = (0, i.useSelector)((e) => ({ data: (0, y.getAddressBookEntry)(e, a) })),
                    B = M === v.TokenStandard.ERC721 || M === v.TokenStandard.ERC1155 || (C && E) || (t && E);
                  return r.default.createElement(
                    m.default,
                    ...
                    r.default.createElement(
                      ...
                      r.default.createElement(
                        _.Text,
                        { variant: g.TextVariant.bodySm, as: "h6", display: g.Display.Flex, marginTop: 4, marginBottom: 2 },
                        B && j("contractRequestingAccess"),
                        P && j("contractRequestingSignature"),
                        !B && !P && j("contractRequestingSpendingCap")
                      ),
                      r.default.createElement(
                        l.default,
                        {
                        ...
                        r.default.createElement(
                          ...
                          A
                            ? r.default.createElement(
                                ...
                                r.default.createElement(k.default, { value: a, type: s.NameType.ETHEREUM_ADDRESS })
                              )
                            : r.default.createElement(
                                _.Text,
                                { fontWeight: g.FontWeight.Bold, variant: g.TextVariant.bodyMd, as: "h5" },
                                (null == F || null === (O = F.data) || void 0 === O ? void 0 : O.name) || (0, f.ellipsify)(a)
                              ),
                          !A &&
                            (null == F || null === (S = F.data) || void 0 === S ? void 0 : S.name) &&
                            r.default.createElement(
                              _.Text,
                              {
                                variant: g.TextVariant.bodySm,
    ...
    [
      4969,
      { "./customize-nonce.component": 4968 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      4971,
      {
        "../../../../helpers/higher-order-components/with-modal-props": 5555,
        "../../../../selectors": 5958,
        "./edit-approval-permission.component": 4970,
        "react-redux": 4440,
        redux: 4505
      },
      function () {
    ...
    [
      4972,
      { "./edit-approval-permission.container": 4971 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
              ...
              return function (e, t, n) {
                ...
                const v = ({ hideModal: e }) => {
                  const [t, n] = (0, r.useState)(!1),
                    ...
                    _ = (0, o.useDispatch)(),
                    k = (0, r.useContext)(g.MetaMetricsContext),
                    T = h === b("toggleEthSignModalFormValidation");
                  return r.default.createElement(
                    s.default,
                    {
                    ...
                    a
                      ? r.default.createElement(l.FormTextField, {
                          ...
                          error: h.length > 0 && !T,
                          helpText: h.length > 0 && !T && b("toggleEthSignModalFormError"),
    ...
    [
      4976,
      { "./hide-token-confirmation-modal": 4975 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      4979,
      { "./keyring-snap-removal-result-modal": 4980 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      4981,
      {
        "../../../../app/scripts/lib/util": 91,
        "../../../../shared/constants/app": 4749,
        "../../../helpers/utils/is-mobile-view": 5567,
        "../../../pages/onboarding-flow/add-network-modal": 5731,
        "../../../store/actions": 5965,
        "./confirm-delete-network": 4958,
        "./confirm-remove-account": 4961,
        "./confirm-reset-account": 4964,
        "./convert-token-to-nft-modal/convert-token-to-nft-modal": 4967,
        "./customize-nonce": 4969,
        "./edit-approval-permission": 4972,
        "./eth-sign-modal/eth-sign-modal": 4973,
        "./fade-modal": 4974,
        "./hide-token-confirmation-modal": 4976,
        "./new-account-modal": 4982,
        "./qr-scanner": 4987,
        "./reject-transactions": 4990,
        "./transaction-confirmed": 4993,
        "prop-types": 4219,
        react: 4475,
        "react-redux": 4440
      },
            ...
            return function () {
              ...
              return function (e, t, n) {
                ...
                var r = C(e("prop-types")),
                  ...
                  k = C(e("./fade-modal")),
                  T = C(e("./new-account-modal")),
                  w = C(e("./reject-transactions"));
                function x(e) {
                  if ("function" != typeof WeakMap) return null;
                  var t = new WeakMap(),
                    n = new WeakMap();
                ...
                const M = {
                  ...
                  S = {
                    ...
                    REJECT_TRANSACTIONS: {
                      contents: a.default.createElement(w.default, null),
                      mobileModalStyle: { ...O },
                      laptopModalStyle: { ...P },
                      contentStyle: { borderRadius: "8px" }
                    },
    ...
    [
      4982,
      { "./new-account-modal.container": 4984 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      4983,
      { "../../../component-library": 5242, "../../../ui/button/button.component": 5376, "prop-types": 4219, react: 4475 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      4984,
      { "../../../../store/actions": 5965, "./new-account-modal.component": 4983, "react-redux": 4440 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      4985,
      { "./nickname-popovers.component": 4986 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      4986,
      {
        "../../../../selectors": 5958,
        "../../../../store/actions": 5965,
        "../../../ui/nickname-popover": 5455,
        "../../../ui/update-nickname-popover/update-nickname-popover": 5510,
        "@metamask/etherscan-link": 1370,
        "prop-types": 4219,
        react: 4475,
        "react-redux": 4440
    ...
    [
      4988,
      {
        ...
        "../../../../../shared/constants/time": 4768,
        "../../../../helpers/utils/util": 5578,
        "../../../../helpers/utils/webcam-utils": 5579,
        "../../../ui/page-container/page-container-footer/page-container-footer.component": 5461,
        "../../../ui/spinner": 5483,
        "@zxing/library": 2735,
        loglevel: 4083,
        "prop-types": 4219,
                  ...
                  renderError() {
                    ...
                    return (
                      "NO_WEBCAM_FOUND" === t.type
                        ...
                        ? (a = e("unknownQrCode"))
                        : ((n = e("unknownCameraErrorTitle")), (a = e("unknownCameraError"))),
                      r.default.createElement(
                        r.default.Fragment,
                        null,
                        r.default.createElement(
    ...
    [
      4989,
      { "../../../../store/actions": 5965, "./qr-scanner.component": 4988, "react-redux": 4440 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      4990,
      { "./reject-transactions.container": 4992 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      ...
      {
        "../../../../helpers/higher-order-components/with-modal-props": 5555,
        "./reject-transactions.component": 4991,
        "react-redux": 4440,
        redux: 4505
      },
      function () {
    ...
    [
      4993,
      { "./transaction-confirmed.container": 4995 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      4995,
      { "../../../../helpers/higher-order-components/with-modal-props": 5555, "./transaction-confirmed.component": 4994 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
              ...
              return function (e, t, n) {
                ...
                function v({ transaction: e, layer2fee: t, nativeCurrency: n, plainStyle: o }) {
                  ...
                  let k = y("unknown"),
                    T = y("unknown");
                  if (null !== v) {
                    (k = `${new m.Numeric(v, 16, f.EtherDenomination.WEI).toDenomination(f.EtherDenomination.ETH).toFixed(12)} ${n}`),
                      (T = _ ? r.default.createElement(l.default, { type: c.SECONDARY, value: v, showFiat: !0, hideLabel: !0 }) : null);
                  }
                  const w = (0, p.sumHexes)(
                      t || "0x0",
                      v || "0x0",
                      (null == e || null === (h = e.txParams) || void 0 === h ? void 0 : h.value) || "0x0"
                    ),
                    x = `${new m.Numeric(w, 16, f.EtherDenomination.WEI).toDenomination(f.EtherDenomination.ETH).toFixed(12)} ${n}`,
                    E = _ ? r.default.createElement(l.default, { type: c.SECONDARY, value: w, showFiat: !0, hideLabel: !0 }) : null;
                  return r.default.createElement(
                    "div",
    ...
    [
      4998,
      { "./multiple-notifications.component": 4999 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      5e3,
      { "../../../../../shared/constants/metametrics": 4758, "../../../../contexts/metametrics": 5515, react: 4475 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      5001,
      {
        ...
        "../../../../store/actions": 5965,
        "../../../component-library": 5242,
        "../../../ui/form-combo-field/form-combo-field": 5408,
        "../name": 5002,
        "./metrics": 5e3,
        "@metamask/name-controller": 1596,
        "ethereumjs-util": 3272,
                ...
                Object.defineProperty(n, "__esModule", { value: !0 }),
                  (n.default = function ({ onClose: e, type: t, value: n }) {
                    const v = (0, o.useSelector)(p.getCurrentChainId),
                      { name: b, sourceId: k } = (0, g.useName)(n, t),
                      T = (0, o.useSelector)(p.getNameSources, i.isEqual),
                      [w, x] = (0, r.useState)(""),
                      [E, C] = (0, r.useState)(!1),
                      [M, P] = (0, r.useState)(),
                      [O, S] = (0, r.useState)(),
                      ...
                      [F, B] = (0, m.useCopyToClipboard)();
                    (0, r.useEffect)(() => {
                      x(b ?? ""), P(k ?? undefined), S(k ? b ?? undefined : undefined);
                    }, [b, k, x, P]);
                    const L = (0, r.useMemo)(
                        () =>
                          (function (e, t) {
                      ...
                      { trackPetnamesOpenEvent: W, trackPetnamesSaveEvent: $ } = (0, y.usePetnamesMetrics)({
                        initialSources: A,
                        name: w,
                        proposedNameOptions: L,
                        savedName: b,
                        savedSourceId: k,
                        selectedSourceId: M,
                        type: t
                    ...
                    const q = (0, r.useCallback)(async () => {
                        $(),
                          await j((0, f.setName)({ value: n, type: t, name: null != w && w.length ? w : null, sourceId: M, variation: v })),
                          e();
                      }, [w, M, e, $, v]),
                      G = (0, r.useCallback)(() => {
                        e();
                        ...
                        r.default.createElement(
                          ...
                          r.default.createElement(l.FormTextField, {
                            ...
                            endAccessory: r.default.createElement(l.ButtonIcon, {
                              display: u.Display.Flex,
                              iconName: F ? l.IconName.CopySuccess : l.IconName.Copy,
    ...
    [
      5002,
      {
        ...
        "../../../hooks/useName": 5604,
        "../../component-library": 5242,
        "./name-details/name-details": 5001,
        "@metamask/name-controller": 1596,
        classnames: 2952,
        "ethereumjs-util": 3272,
        react: 4475
                ...
                Object.defineProperty(n, "__esModule", { value: !0 }),
                  (n.default = function ({ value: e, type: t, disableEdit: n, internal: f }) {
                    ...
                    const v = (0, r.useCallback)(() => {
                      ...
                      k = Boolean(y),
                      T = k ? s.IconName.Save : s.IconName.Warning;
                    return r.default.createElement(
                      "div",
                      null,
                      ...
                      r.default.createElement(
                        "div",
                        { className: (0, o.default)({ name: !0, name__saved: k, name__missing: !k }), onClick: v },
                        r.default.createElement(s.Icon, { name: T, className: "name__icon", size: s.IconSize.Lg }),
                        !k && r.default.createElement("span", { className: "name__value" }, _),
                        k && r.default.createElement("span", { className: "name__name" }, y)
                      )
                    );
                  });
                var r = (function (e, t) {
    ...
    [
      5003,
      { "./network-account-balance-header": 5004 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      5006,
      {
        ...
        "../../component-library": 5242,
        "../../ui/chip/chip": 5385,
        "../../ui/color-indicator": 5388,
        "../../ui/loading-indicator": 5437,
        classnames: 2952,
        "prop-types": 4219,
        react: 4475,
        "react-redux": 4440
                ...
                function v({ indicatorSize: e, disabled: t, labelProps: n, targetNetwork: a, onClick: y }) {
                  ...
                  return r.default.createElement(d.default, {
                    ...
                    leftIcon: r.default.createElement(
                      ...
                      r.default.createElement(u.default, {
                        color: T === s.NETWORK_TYPES.RPC ? c.IconColor.iconMuted : T,
                        size: e,
                        type: u.default.TYPES.FILLED,
                        iconClassName: T === s.NETWORK_TYPES.RPC && e !== c.Size.XS ? "fa fa-question" : undefined
                      })
                    ),
                    rightIcon: y ? r.default.createElement(m.Icon, { name: m.IconName.ArrowDown, size: m.IconSize.Xs }) : null,
                    label: T === s.NETWORK_TYPES.RPC ? k ?? _("privateNetwork") : _((0, h.getNetworkLabelKey)(T)),
    ...
    [
      5009,
      {
        ...
        "../../../helpers/constants/design-system": 5537,
        "../../../helpers/constants/routes": 5542,
        "../../../helpers/utils/nfts": 5569,
        "../../../helpers/utils/util": 5578,
        "../../../hooks/useCopyToClipboard": 5595,
        "../../../hooks/useI18nContext": 5602,
        "../../../hooks/usePrevious": 5608,
        "../../../pages/asset/components/asset-navigation": 5633,
        "../../../selectors": 5958,
        "../../../store/actions": 5965,
        "../../component-library": 5242,
        "../../multichain/nft-item": 5335,
        "../../ui/box": 5373,
        "../../ui/button": 5377,
        "../../ui/info-tooltip": 5431,
        "../../ui/tooltip": 5502,
        "../nft-options/nft-options": 5010,
        lodash: 4071,
        "prop-types": 4219,
        react: 4475,
        "react-redux": 4440,
              ...
              return function (e, t, n) {
                ...
                function R({ nft: e }) {
                  ...
                  const {
                    ...
                    re = (0, d.formatDate)(new Date(null == W ? void 0 : W.event_timestamp).getTime(), "M/d/y"),
                  ...
                  const oe = (() => {
                      switch (V) {
                        case v.CHAIN_IDS.MAINNET:
                          return `https://opensea.io/assets/ethereum/${A}/${F}`;
                        case v.CHAIN_IDS.POLYGON:
                          return `https://opensea.io/assets/matic/${A}/${F}`;
                        case v.CHAIN_IDS.GOERLI:
                          return `https://testnets.opensea.io/assets/goerli/${A}/${F}`;
                        case v.CHAIN_IDS.SEPOLIA:
                          return `https://testnets.opensea.io/assets/sepolia/${A}/${F}`;
                        default:
                          return null;
                      }
                    })(),
                    ie = B !== P.TokenStandard.ERC721,
                    se = (0, b.getEnvironmentType)() === _.ENVIRONMENT_TYPE_POPUP,
                    le = async () => {
                      await G((0, w.startNewDraftTransaction)({ type: P.AssetType.NFT, details: e })), q.push(h.SEND_ROUTE);
                    },
                    ue = () =>
                      !1 === L
                        ...
                        : r.default.createElement(
                            l.default,
                            { display: u.Display.Flex, width: se ? u.BlockSize.Full : u.BlockSize.Half, margin: se ? [4, 0] : null },
                            r.default.createElement(
                              T.default,
                              {
                                type: "primary",
                            ...
                            ie ? r.default.createElement(x.default, { position: "top", contentText: $("sendingDisabled") }) : null
                          );
                  return r.default.createElement(
                    r.default.Fragment,
                    null,
                    r.default.createElement(m.default, {
                      ...
                      optionsButton: r.default.createElement(k.default, {
                        onViewOnOpensea: oe ? () => global.platform.openTab({ url: oe }) : null,
                        onRemove: () => {
                          G((0, y.removeAndIgnoreNft)(A, F)),
                          ...
                          r.default.createElement(
                            ...
                            r.default.createElement(
                              S.default,
                              {
                                ...
                                position: "bottom",
                                title: $(Y ? "copiedExclamation" : "copyToClipboard")
                              },
                              r.default.createElement(O.ButtonIcon, {
                                ...
                                iconName: Y ? O.IconName.CopySuccess : O.IconName.Copy
                              })
                            )
                          )
                        ),
                  ...
                  return r.default.createElement(
                    i.BannerAlert,
                    {
                      ...
                      actionButtonOnClick: (t) => {
                        t.preventDefault(), n.push(`${l.SECURITY_ROUTE}#opensea-api`), null == e || e();
                      }
                    },
            ...
            return function () {
              ...
              return function (e, t, n) {
                ...
                var r = (function (e, t) {
                  ...
                  s = e("lodash"),
                  l = w(e("../../ui/box")),
                  u = w(e("../../ui/typography/typography")),
                  c = e("../../../helpers/constants/design-system"),
                  ...
                  k = e("../../component-library"),
                  T = e("../../multichain/nft-item");
                function w(e) {
                  return e && e.__esModule ? e : { default: e };
                }
                function x(e) {
                          ...
                          r.default.createElement(
                            ...
                            r.default.createElement(
                              ...
                              r.default.createElement(k.Icon, {
                                name: s ? k.IconName.ArrowDown : k.IconName.ArrowRight,
                          ...
                          ? r.default.createElement(
                              ...
                              e.map((e, t) => {
                                ...
                                return r.default.createElement(
                                  ...
                                  r.default.createElement(T.NftItem, {
                                    nftImageURL: f,
                                    alt: d,
                                    src: p ? a : c,
                                    name: s,
    ...
    [
      5016,
      {
        ...
        "../../component-library": 5242,
        "../../multichain": 5327,
        "../../multichain/asset-list-conversion-button/asset-list-conversion-button": 5301,
        "../nfts-detection-notice-nfts-tab/nfts-detection-notice-nfts-tab": 5012,
        "../nfts-items": 5013,
        react: 4475,
        "react-redux": 4440,
        "react-router-dom": 4460
    ...
    [
      5018,
      {
        "../../../../shared/constants/snaps/permissions": 4765,
        "../../../helpers/constants/design-system": 5537,
        "../../../hooks/useI18nContext": 5602,
        "../../../store/actions": 5965,
        "../../component-library": 5242,
            ...
            return function () {
              ...
              return function (e, t, n) {
                ...
                const m = ({
                  ...
                  var v;
                  const b = (0, c.useI18nContext)();
                  let _ = s.IconColor.iconMuted,
                    k = l.IconName.Info,
                  ...
                  h ||
                    ...
                    (_ = s.IconColor.warningDefault),
                    (k = l.IconName.Danger)),
                    g && ((T = s.IconColor.iconMuted), (w = s.Color.backgroundAlternative)),
                    h && ((T = s.IconColor.iconMuted), (w = s.Color.backgroundAlternative));
                  let x = m;
                  return (
                    "string" != typeof m && null != m && null !== (v = m.props) && void 0 !== v && v.iconName && (x = m.props.iconName),
                    r.default.createElement(
                      i.default,
                      {
                      ...
                      r.default.createElement(
                        ...
                        r.default.createElement(
                          ...
                          !h && (g ? b("approvedOn", [(0, u.formatDate)(g, "yyyy-MM-dd")]) : b("permissionRequested")),
                          h ? b("permissionRevoked") : ""
                        )
                      ),
                      r.default.createElement(
                        i.default,
                        ...
                        y && e
                          ...
                          : r.default.createElement(
                              d.default,
                              { html: r.default.createElement("div", null, a), position: "bottom" },
                              r.default.createElement(l.Icon, { color: _, name: k, size: l.IconSize.Sm })
                            )
                      )
                    )
                  );
    ...
    [
      5020,
      { "./permission-page-container-content": 5021, "./permission-page-container.container": 5024 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      5021,
      { "./permission-page-container-content.component": 5022 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      ...
      {
        "../../../ui/tooltip": 5502,
        "../../permissions-connect-header": 5027,
        "../../permissions-connect-permission-list": 5029,
    ...
    [
      5023,
      {
        ...
        "../../../helpers/utils/util": 5578,
        "../../ui/page-container": 5458,
        "../permissions-connect-footer": 5025,
        "../snaps/snap-privacy-warning": 5095,
        "@metamask/permission-controller": 1667,
    ...
    [
      5024,
      { "../../../selectors": 5958, "./permission-page-container.component": 5023, "react-redux": 4440 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      5025,
      { "./permissions-connect-footer.component": 5026 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      5026,
      { "../../../helpers/constants/zendesk-url": 5547, "prop-types": 4219, react: 4475 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      5027,
      { "./permissions-connect-header.component": 5028 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      5029,
      { "./permissions-connect-permission-list": 5030 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      5030,
      { "../../../helpers/utils/permission": 5572, "../../../hooks/useI18nContext": 5602, "prop-types": 4219, react: 4475 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
                ...
                const h = "ACCESSING_CAMERA",
                  ...
                  b = ({ isReadingWallet: e, handleCancel: t, handleSuccess: n, setErrorTitle: i }) => {
                    const m = (0, d.useI18nContext)(),
                      [g, b] = (0, r.useState)(h),
                      [_, k] = (0, r.useState)(null),
                      [T, w] = (0, r.useState)(new o.URDecoder());
                    let x = null;
                    const E = (0, r.useRef)(!1),
                      ...
                      P = (t) => {
                        try {
                          if (!t) return;
                          if ((T.receivePart(t), T.isComplete())) {
                            const e = T.resultUR();
                            n(e).catch(k);
                          }
                        } catch (t) {
                          i(m(e ? "QRHardwareUnknownQRCodeTitle" : "QRHardwareInvalidTransactionTitle")), k(new Error(m("unknownQrCode")));
                        }
                      },
                      O = () => {
                        try {
                          ...
                          if (!E.current) return;
                          "NotAllowedError" === e.name ? (a.default.info(`Permission denied: '${e}'`), b(y)) : k(e);
                        }
                      };
                    (0, r.useEffect)(
                      () => (
                    ...
                    const S = () => {
                      clearTimeout(x), b(h), k(null), w(new o.URDecoder()), C();
                    };
                    return r.default.createElement(
                      "div",
                      { className: "qr-scanner" },
                        ...
                        ? (() => {
                            ...
                            return (
                              "NO_WEBCAM_FOUND" === _.type
                                ...
                                : ((n = m("unknownCameraErrorTitle")), (a = m("unknownCameraError"))),
                              r.default.createElement(
                                r.default.Fragment,
                                null,
                                r.default.createElement(
    ...
    [
      5034,
      {
        ...
        "../../../store/actions": 5965,
        "../../ui/popover": 5465,
        "./qr-hardware-sign-request": 5035,
        "./qr-hardware-wallet-importer": 5039,
        "eth-rpc-errors": 3226,
        react: 4475,
        "react-redux": 4440
      },
              ...
              return function (e, t, n) {
                ...
                n.default = () => {
                  ...
                  const t = (0, l.useI18nContext)(),
                    ...
                    k = (0, a.useDispatch)(),
                    T = (0, r.useCallback)(() => k((0, u.cancelSyncQRHardware)()), [k]),
                    w = (0, r.useCallback)(() => {
                      k((0, u.rejectPendingApproval)(_.id, (0, o.serializeError)(o.ethErrors.provider.userRejectedRequest()))),
                        k((0, u.cancelTx)(_)),
                        k((0, u.cancelQRHardwareSignRequest)());
                    }, [k, _]),
                    x = (0, r.useMemo)(() => {
                      let e = "";
                      return (
                  ...
                  return h
                    ? r.default.createElement(
                        s.default,
                        { title: x, onClose: m ? T : w },
                        m && r.default.createElement(c.default, { handleCancel: T, setErrorTitle: v }),
                        g && r.default.createElement(d.default, { setErrorTitle: v, handleCancel: w, request: f.request })
                      )
                    : null;
                };
              };
    ...
    [
      5035,
      { "./qr-hardware-sign-request.component": 5037 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      5037,
      { "../../../../store/actions": 5965, "./player": 5036, "./reader": 5038, "prop-types": 4219, react: 4475 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      5038,
      {
        "../../../../hooks/useI18nContext": 5602,
        "../base-reader": 5031,
        "@keystonehq/bc-ur-registry-eth": 550,
        "prop-types": 4219,
        react: 4475,
        uuid: 4695
      },
    ...
    [
      5039,
      { "./qr-hardware-wallet-importer.component": 5040 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      5043,
      {
        "../../../../../shared/constants/security-provider": 4762,
        "../../../../contexts/i18n": 5514,
        "../../../../helpers/constants/design-system": 5537,
        "../../../component-library": 5242,
        "../security-provider-banner-alert": 5044,
        "@sentry/browser": 2179,
        "prop-types": 4219,
        react: 4475
      },
    ...
    [
      5044,
      {
        ...
        "../../component-library": 5242,
        "../../ui/disclosure": 5400,
        "../../ui/disclosure/disclosure.constants": 5398,
        "prop-types": 4219,
        react: 4475
      },
      function () {
    ...
    [
      5045,
      { "./security-provider-banner-message": 5046 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      5047,
      { "./set-approval-for-all-warning": 5048 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      5050,
      {
        ...
        "../../../hooks/useI18nContext": 5602,
        "../../../selectors": 5958,
        "../network-account-balance-header": 5003,
        "prop-types": 4219,
        react: 4475,
        "react-redux": 4440
      },
              ...
              return function (e, t, n) {
                ...
                const h = ({ txData: e }) => {
                  const t = (0, i.useI18nContext)(),
                    ...
                    { useNativeCurrencyAsPrimaryCurrency: k } = (0, o.useSelector)(l.getPreferences),
                    T = (0, o.useSelector)(l.conversionRateSelector),
                    w = k ? null : T,
                  ...
                  return r.default.createElement(m.default, {
                    ...
                    accountName: g.name,
                    accountBalance: E,
                    tokenName: w ? (null == y ? void 0 : y.toUpperCase()) : h,
    ...
    [
      5051,
      { "./signature-request-original.container": 5055 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      5052,
      { "./signature-request-original-warning": 5053 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      5054,
      {
        ...
        "../../ui/site-origin": 5481,
        "../../ui/typography/typography": 5507,
        "../confirm-page-container/confirm-page-container-navigation": 4864,
        "../ledger-instruction-field": 4941,
        ...
        "../signature-request-header": 5049,
        "../snaps/snap-legacy-authorship-header": 5089,
        "./signature-request-original-warning": 5052,
        "@metamask/permission-controller": 1667,
        buffer: 2913,
        classnames: 2952,
        "eth-rpc-errors": 3226,
                ...
                (function (t) {
                  (function () {
                    ...
                    var r = (function (e, t) {
                      ...
                      k = E(e("../security-provider-banner-message/security-provider-banner-message")),
                      T = E(e("../signature-request-header")),
                      w = E(e("../snaps/snap-legacy-authorship-header")),
                          ...
                          M(this, "renderBody", () => {
                            ...
                            return r.default.createElement(
                              ...
                              (0, f.isSuspiciousResponse)(null == n ? void 0 : n.securityProviderResponse) &&
                                r.default.createElement(k.default, { securityProviderResponse: n.securityProviderResponse }),
                              r.default.createElement(
                                "div",
                                { className: "request-signature__origin" },
                                (null == u ? void 0 : u.subjectType) === l.SubjectType.Snap
                                  ? r.default.createElement(w.default, { snapId: u.origin, marginLeft: 4, marginRight: 4 })
                                  : r.default.createElement(m.default, {
                          ...
                          M(this, "render", () => {
                            ...
                            return r.default.createElement(
                              ...
                              r.default.createElement(
                                ...
                                r.default.createElement(T.default, { txData: a })
                              ),
                              this.renderBody(),
                    ...
                    (n.default = P),
                      M(P, "contextTypes", { t: a.default.func.isRequired }),
                      M(P, "propTypes", {
    ...
    [
      5055,
      {
        ...
        "../../../selectors": 5958,
        "../../../store/actions": 5965,
        "./signature-request-original.component": 5054,
        "react-redux": 4440,
        "react-router-dom": 4460,
        redux: 4505
      },
    ...
    [
      5057,
      { "./signature-request-siwe-header": 5058 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      5058,
      {
        "../../../../contexts/i18n": 5514,
        "../../../ui/tooltip": 5502,
        "../../account-list-item": 4803,
        "../../permissions-connect-header": 5027,
        "../signature-request-siwe-icon": 5059,
        "../signature-request-siwe-tag": 5062,
        "prop-types": 4219,
        react: 4475
      },
      function () {
    ...
    [
      5060,
      { "./signature-request-siwe-message": 5061 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      5063,
      {
        ...
        "../security-provider-banner-message/security-provider-banner-message": 5046,
        "../signature-request-header": 5049,
        "./signature-request-siwe-header": 5057,
        "./signature-request-siwe-message": 5060,
            ...
            return function () {
              ...
              return function (e, t, n) {
                ...
                var r = (function (e, t) {
                  ...
                  k = e("../../../ducks/confirm-transaction/confirm-transaction.duck"),
                  T = e("../../../helpers/constants/design-system"),
                  w = e("../../../store/actions"),
                  x = N(e("../security-provider-banner-message/security-provider-banner-message")),
                  E = N(e("../confirm-page-container/confirm-page-container-navigation")),
                  C = e("../../../ducks/history/history"),
                  M = N(e("../security-provider-banner-alert/blockaid-banner-alert/blockaid-banner-alert")),
                  P = N(e("../ledger-instruction-field")),
                  O = N(e("../signature-request-header")),
                  S = N(e("./signature-request-siwe-header")),
                  j = N(e("./signature-request-siwe-message"));
                function N(e) {
                  return e && e.__esModule ? e : { default: e };
                }
                function I(e) {
                ...
                function D({ txData: e }) {
                  const t = (0, o.useDispatch)(),
                    ...
                    N = (0, o.useSelector)(y.accountsWithSendEtherInfoSelector),
                    I = (0, o.useSelector)(y.getSubjectMetadata),
                    D = (0, o.useSelector)(y.getTotalUnapprovedMessagesCount),
                    R = (0, o.useSelector)(y.unconfirmedMessagesHashSelector),
                    A = (0, o.useSelector)(C.getMostRecentOverviewPage),
                    {
                      msgParams: {
                        from: F,
                        origin: B,
                        siwe: { parsedMessage: L }
                      },
                      id: W
                    } = e,
                    $ = (0, o.useSelector)((e) => (0, h.isAddressLedger)(e, F)),
                    q = (0, v.getAccountByAddress)(N, F),
                    G = I[B],
                    U = F.toLowerCase() === L.address.toLowerCase(),
                    z = (0, l.isValidSIWEOrigin)(e.msgParams),
                    [V, H] = (0, r.useState)(!1),
                    [Y, K] = (0, r.useState)(!1),
                    Q = (0, b.isSuspiciousResponse)(null == e ? void 0 : e.securityProviderResponse),
                    J = (0, r.useCallback)(async () => {
                      try {
                        await t((0, w.resolvePendingApproval)(W, null)), t((0, w.completedTx)(W));
                      } catch (e) {
                        s.default.error(e);
                      }
                    }, [W, t]),
                    X = (0, r.useCallback)(async () => {
                      try {
                        await t((0, w.rejectPendingApproval)(W, (0, u.serializeError)(u.ethErrors.provider.userRejectedRequest())));
                      } catch (e) {
                        s.default.error(e);
                      }
                    }, [t, W]),
                    Z = a("rejectRequestsN", [D]);
                  return r.default.createElement(
                    "div",
                    ...
                    r.default.createElement(O.default, { txData: e }),
                    r.default.createElement(M.default, { securityAlertResponse: null == e ? void 0 : e.securityAlertResponse, margin: 4 }),
                    Q && r.default.createElement(x.default, { securityProviderResponse: e.securityProviderResponse }),
                    r.default.createElement(S.default, { fromAccount: q, domain: B, isSIWEDomainValid: z, subjectMetadata: G }),
                    r.default.createElement(j.default, { data: (0, _.formatMessageParams)(L, a) }),
                    !U &&
                      r.default.createElement(
                        c.BannerAlert,
                        { severity: T.SEVERITIES.WARNING, marginLeft: 4, marginRight: 4, marginBottom: 4 },
                        a("SIWEAddressInvalid", [L.address, q.address])
                      ),
                    $ &&
                      r.default.createElement(
                        "div",
                        { className: "confirm-approve-content__ledger-instruction-wrapper" },
                        r.default.createElement(P.default, { showDataInstruction: !0 })
                      ),
                    !z &&
                      r.default.createElement(
                        c.BannerAlert,
                        { severity: T.SEVERITIES.DANGER, marginLeft: 4, marginRight: 4, marginBottom: 4 },
                        r.default.createElement(c.Text, { variant: T.TextVariant.bodyMdBold }, a("SIWEDomainInvalidTitle")),
                        " ",
                    ...
                    r.default.createElement(g.PageContainerFooter, {
                      ...
                      cancelText: a("cancel"),
                      submitText: a("signin"),
                      submitButtonType: z ? "primary" : "danger-primary"
                    }),
                    D > 1
                      ? r.default.createElement(
                          f.default,
                                ...
                                (() => {
                                  ...
                                  t(
                                    (0, w.showModal)({
                                      ...
                                      unapprovedTxCount: e,
                                      onSubmit: async () => {
                                        await t((0, w.rejectAllMessages)((0, v.valuesFor)(R))),
                                          t((0, k.clearConfirmTransaction)()),
                                          n.push(A);
                                      }
                                    })
                                  );
                      ...
                      r.default.createElement(
                        ...
                        r.default.createElement(
                          ...
                          r.default.createElement(
                            ...
                            a("SIWEDomainWarningBody", [L.domain])
                          )
                        )
                      )
                  );
    ...
    [
      5066,
      {
        ...
        "../../../component-library": 5242,
        "../../name/name": 5002,
        "../../transaction-decoding/components/decoding/address": 5143,
        "@metamask/name-controller": 1596,
        lodash: 4071,
        "prop-types": 4219,
        react: 4475,
    ...
    [
      5067,
      { "./signature-request-footer.component": 5068 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      5068,
      { "../../../ui/page-container": 5458, "prop-types": 4219, react: 4475 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      5069,
      { "./signature-request-message": 5070 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      5071,
      {
        ...
        "../../../helpers/utils/util": 5578,
        "../../../hooks/useI18nContext": 5602,
        "../../../hooks/useRejectTransactionModal": 5609,
        "../../../selectors": 5958,
        "../../../store/actions": 5965,
        "../../component-library": 5242,
        "../confirm-page-container": 4866,
        "../ledger-instruction-field": 4941,
        "../modals/contract-details-modal": 4966,
        "../security-provider-banner-alert/blockaid-banner-alert/blockaid-banner-alert": 5043,
        "../security-provider-banner-message": 5045,
        "../signature-request-header/signature-request-header": 5050,
        "./signature-request-footer": 5067,
        "./signature-request-message": 5069,
        "eth-rpc-errors": 3226,
        lodash: 4071,
        "prop-types": 4219,
        react: 4475,
            ...
            return function () {
              ...
              return function (e, t, n) {
                ...
                var r = (function (e, t) {
                  ...
                  k = e("../../../../shared/constants/security-provider"),
                  T = e("../../../helpers/constants/design-system"),
                ...
                const O = ({ txData: e }) => {
                  ...
                  const o = (0, r.useContext)(b.MetaMetricsContext),
                    ...
                    [R, A] = (0, r.useState)(!1),
                    {
                      id: F,
                      type: B,
                      msgParams: { from: L, data: W, origin: $, version: q }
                    } = e,
                    G = (0, a.useSelector)((e) => (0, u.doesAddressRequireLedgerHidConnection)(e, L)),
                    ...
                    Y = (0, a.useSelector)((e) => (0, c.isAddressLedger)(e, L)),
                    { handleCancelAll: K } = (0, f.useRejectTransactionModal)();
                  (0, r.useEffect)(() => {
                    A((null == I ? void 0 : I.scrollHeight) > (null == I ? void 0 : I.clientHeight));
                  }, [I]);
                  const Q = (null == H ? void 0 : H[$]) || null,
                    J = (0, i.memoize)((e) => {
                    ...
                    X = (0, r.useCallback)(() => {
                      o({
                        ...
                        properties: { action: "Sign Request", type: B, version: q, external_link_clicked: "security_alert_support_link" }
                      });
                    }, []),
                    {
                      sanitizedMessage: Z,
                  ...
                  return r.default.createElement(
                    ...
                    r.default.createElement(
                      ...
                      ((null == e || null === (t = e.securityProviderResponse) || void 0 === t ? void 0 : t.flagAsDangerous) !==
                        ...
                        (null == e || null === (n = e.securityProviderResponse) || void 0 === n ? void 0 : n.flagAsDangerous) !==
                          k.SECURITY_PROVIDER_MESSAGE_SEVERITY.NOT_MALICIOUS) ||
                      ...
                      r.default.createElement(
                        ...
                        r.default.createElement(w.TagUrl, {
                          label: $,
                          labelProps: { color: T.TextColor.textAlternative },
                          src: null == Q ? void 0 : Q.iconUrl
                        })
                      ),
                      r.default.createElement(
                        w.Text,
                        { className: "signature-request__content__title", variant: T.TextVariant.headingLg, marginTop: 4 },
                        P("sigRequest")
                      ),
                      r.default.createElement(
                        w.Text,
                      ...
                      ee
                        ? r.default.createElement(
                            ...
                            r.default.createElement(
                              ...
                              r.default.createElement(
                                w.Text,
                                { variant: T.TextVariant.bodySm, color: T.TextColor.primaryDefault, as: "h6" },
                    ...
                    r.default.createElement(C.default, {
                      cancelAction: async () => {
                        await M((0, l.rejectPendingApproval)(F, (0, s.serializeError)(s.ethErrors.provider.userRejectedRequest()))),
                          o({
                            category: _.MetaMetricsEventCategory.Transactions,
                            event: "Cancel",
                            properties: { action: "Sign Request", legacy_event: !0, type: B, version: q }
                          });
                      },
                      signAction: async () => {
                        await M((0, l.resolvePendingApproval)(F)),
                          (0, l.completedTx)(F),
                          o({
                            category: _.MetaMetricsEventCategory.Transactions,
                            event: "Confirm",
          ...
          with (this.globalThis)
            return function () {
              ...
              return function (e, t, n) {
                ...
                const d = ({ text: e }) => {
                  const [t, n] = (0, l.useCopyToClipboard)();
                  return r.default.createElement(
                    o.default,
                    {
                      className: "copyable",
                    ...
                    r.default.createElement(
                      i.default,
                      {
                        ...
                        color: s.TextColor.textAlternative,
                        marginRight: 2,
                        overflowWrap: s.OVERFLOW_WRAP.ANYWHERE
                      },
                      e
                    ),
                    r.default.createElement(
                      ...
                      t
                        ? r.default.createElement(u.Icon, {
                            name: u.IconName.CopySuccess,
                            size: u.IconSize.Lg,
                            color: s.Color.iconAlternative
                          })
                        : r.default.createElement(u.Icon, {
                            name: u.IconName.Copy,
                            size: u.IconSize.Lg,
                            color: s.Color.iconAlternative,
                            onClick: () => n(e)
                          })
                ...
                (n.Copyable = d), (d.propTypes = { text: a.default.string });
              };
            };
      },
    ...
    [
      5075,
      { "./keyring-snap-removal-warning": 5077 },
      function () {
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
    ...
    [
      5077,
      {
        ...
        "../../../component-library": 5242,
        "../../../ui/info-tooltip": 5431,
        "./keyring-account-list-item": 5076,
        "@metamask/etherscan-link": 1370,
        react: 4475,
        "react-redux": 4440
      },
        ...
        with (this.scopeTerminator)
          with (this.globalThis)
            return function () {
              ...
              return function (e, t, n) {
                Object.defineProperty(n, "__esModule", { value: !0 }),
                  (n.default = function ({ snap: e, keyringAccounts: t, onCancel: n, onClose: r, onSubmit: f, onBack: m, isOpen: g }) {
                    const h = (0, u.useI18nContext)(),
                      [y, v] = (0, a.useState)(!1),
                      [b, _] = (0, a.useState)(!1),
                      [k, T] = (0, a.useState)(""),
                      [w, x] = (0, a.useState)(!1),
                      { chainId: E } = (0, i.useSelector)(d.getProviderConfig);
                    (0, a.useEffect)(() => {
                      v(0 === t.length);
                    }, [t]);
                    return a.default.createElement(
                      ...
                      a.default.createElement(
                        ...
                        a.default.createElement(
                          s.ModalContent,
                          { modalDialogProps: { display: l.Display.Flex, flexDirection: l.FlexDirection.Column, gap: 4 } },
                          a.default.createElement(
                            s.ModalHeader,
                            {
                              onBack: () => {
                          ...
                          !1 === y
                            ? a.default.createElement(
                                ...
                                a.default.createElement(
                                  ...
                                  h("backupKeyringSnapReminder")
                                ),
                                a.default.createElement(
                                  s.Box,
                                  { display: l.Display.Flex, justifyContent: l.JustifyContent.spaceBetween },
                                  a.default.createElement(s.Text, null, h("removeKeyringSnap")),
                                  a.default.createElement(c.default, { contentText: h("removeKeyringSnapToolTip"), position: "top" })
                                ),
                                t.map((e, t) =>
                                  a.default.createElement(p.KeyringAccountListItem, {
                                    key: t,
                                    account: e,
                                    snapUrl: (0, o.getAccountLink)(e.address, E)
                                  })
                                )
                              )
                            : a.default.createElement(
                                ...
                                a.default.createElement(
                                  s.Box,
                                  { display: l.Display.Flex, flexDirection: l.FlexDirection.Column, marginTop: 6 },
                                  a.default.createElement(
                                    s.BannerAlert,
                                  ...
                                  a.default.createElement(
                                    s.Text,
                                    { marginBottom: 4 },
                                    h("keyringSnapRemoveConfirmation", [
                                      a.default.createElement(
                                        s.Text,
                                        { key: "keyringSnapRemoveConfirmation2", fontWeight: l.FontWeight.Bold, as: "span" },
                                  ...
                                  a.default.createElement(s.TextField, {
                                    ...
                                    onChange: (t) => {
                                      var n;
                                      T(t.target.value), _(((n = t.target.value), x(!1), n === e.manifest.proposedName || (x(!0), !1)));
                                    },
                                    error: w,
                ...
                var r,
                  ...
                  l = e("../../../../helpers/constants/design-system"),
                  u = e("../../../../hooks/useI18nContext"),
                  c = (r = e("../../../ui/info-tooltip")) && r.__esModule ? r : { default: r },
    ...
    [
      5079,
      {
        ...
        "../../../ui/tooltip/tooltip": 5503,
        "../snap-avatar": 5082,
        "../snap-version/snap-version": 5105,
              ...
              return function (e, t, n) {
                ...
                const k = ({ snapId: e, className: t, snap: n }) => {
                  const o = (0, c.useI18nContext)(),
                    ...
                    k = e && (0, u.removeSnapIdPrefix)(e),
                    T = "npm:" === _,
                    w = null != n && n.version ? `/v/${null == n ? void 0 : n.version}` : "",
                    x = T ? `https://www.npmjs.com/package/${k}${w}` : k,
                ...
                k.propTypes = { snapId: o.default.string, className: o.default.string, snap: o.default.object };
                n.default = k;
              };
            };
      },
          ...
          with (this.globalThis)
            return function () {
              ...
              return function (e, t, n) {
                ...
                const c = ({ snapName: e, type: t = l.DelineatorType.default, children: n }) => {
                  const a = (0, o.useI18nContext)(),
                    u = t === l.DelineatorType.Error;
                  return r.default.createElement(
                    s.Box,
                    {
                      ...
                      backgroundColor: u ? i.BackgroundColor.errorMuted : i.BackgroundColor.backgroundDefault
                    },
                    r.default.createElement(
                      s.Box,
                      { className: "snap-delineator__header", display: i.Display.Flex, alignItems: i.AlignItems.center, padding: 1 },
                      r.default.createElement(s.AvatarIcon, {
                        iconName: s.IconName.Snaps,
                        size: s.AvatarIconSize.Sm,
                        backgroundColor: u ? i.IconColor.errorDefault : i.IconColor.infoDefault,
                      ...
                      r.default.createElement(
                        s.Text,
                        {
                          ...
                          color: u ? i.TextColor.errorDefault : i.TextColor.textAlternative,
                          className: "snap-delineator__header__text",
                          marginLeft: 1,
                          marginTop: 0,
                          marginBottom: 0
                        },
                        a((0, l.getDelineatorTitle)(t), [e])
                      )
                    ),
                    r.default.createElement(s.Box, { className: "snap-delineator__content", padding: 4 }, n)
                  );
                };
                (n.SnapDelineator = c), (c.propTypes = { snapName: a.default.string, type: a.default.string, children: a.default.node });
              };
            };
      },
