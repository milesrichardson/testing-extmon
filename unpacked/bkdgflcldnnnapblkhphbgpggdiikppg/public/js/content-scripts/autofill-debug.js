(function () {
...
})()(
  {
    ...
    4: [
      ...
      { "./ZodError": 2, "./errors": 3, "./helpers/parseUtil": 6, "./helpers/typeAliases": 7, "./helpers/util": 8, "./types": 11 }
    ],
    5: [
      function (require, module, exports) {
        "use strict";
    ...
    11: [
      ...
      { "./ZodError": 2, "./errors": 3, "./helpers/errorUtil": 5, "./helpers/parseUtil": 6, "./helpers/util": 8 }
    ],
    12: [
      function (require, module, exports) {
        "use strict";
      ...
      { "./lib/device-api-call.js": 13, "./lib/device-api.js": 14 }
    ],
    13: [
      function (require, module, exports) {
        "use strict";
    ...
    17: [
      ...
      { "./lib/apple.password.js": 18, "./lib/constants.js": 19, "./lib/rules-parser.js": 20 }
    ],
    18: [
      function (require, module, exports) {
        "use strict";
      ...
      { "./constants.js": 19, "./rules-parser.js": 20 }
    ],
    19: [
      function (require, module, exports) {
        "use strict";
    ...
    20: [
      function (require, module, exports) {
        ...
        exports.SHOULD_NOT_BE_REACHED =
          exports.RuleName =
          exports.Rule =
          exports.ParserError =
          exports.NamedCharacterClass =
          exports.Identifier =
          exports.CustomCharacterClass =
            void 0;
    ...
    21: [
      function (require, module, exports) {
        module.exports = {
          ...
          "mysedgwick.com": {
            "password-rules":
              "minlength: 8; maxlength: 16; allowed: lower; required: upper; required: digit; required: [@#%^&+=!]; allowed: [-~_$.,;]"
          },
          "mysubaru.com": {
            "password-rules":
    ...
    22: [
      ...
      },
      {
        ...
        "./DeviceInterface/AndroidInterface.js": 23,
        "./DeviceInterface/AppleDeviceInterface.js": 24,
        "./DeviceInterface/AppleOverlayDeviceInterface.js": 25,
        "./DeviceInterface/ExtensionInterface.js": 26,
        "./DeviceInterface/WindowsInterface.js": 28,
        "./DeviceInterface/WindowsOverlayDeviceInterface.js": 29,
        "./Settings.js": 50,
        "./config.js": 63,
        "./deviceApiCalls/transports/transports.js": 71
      }
    ],
    23: [
      function (require, module, exports) {
        ...
        class AndroidInterface extends _InterfacePrototype.default {
           ...
           */
          async getAlias() {
            const { alias } = await (0, _autofillUtils.sendAndWaitForAnswer)(async () => {
              if (this.inContextSignup.isAvailable()) {
                const { isSignedIn } = await this.deviceApi.request(new _deviceApiCalls.ShowInContextEmailProtectionSignupPromptCall(null));
          ...
          storeUserData(_ref) {
            let {
              addUserData: { token, userName, cohort }
            } = _ref;
      ...
      {
        "../InContextSignup.js": 44,
        "../UI/controllers/NativeUIController.js": 56,
        "../autofill-utils.js": 61,
        "../deviceApiCalls/__generated__/deviceApiCalls.js": 65,
        "./InterfacePrototype.js": 27,
        "@duckduckgo/content-scope-scripts/src/apple-utils": 1
      }
    ],
    24: [
      function (require, module, exports) {
        ...
        class AppleDeviceInterface extends _InterfacePrototype.default {
          ...
          async getAddresses() {
            ...
            const { addresses } = await this.deviceApi.request((0, _index.createRequest)("emailHandlerGetAddresses"));
          ...
          async _checkDeviceSignedIn() {
            const { isAppSignedIn } = await this.deviceApi.request((0, _index.createRequest)("emailHandlerCheckAppSignedInStatus"));
          ...
          storeUserData(_ref) {
            ...
            return this.deviceApi.notify(
              (0, _index.createNotification)("emailHandlerStoreToken", {
                token,
                username: userName,
                cohort
              })
          ...
          getAutofillCredentials(id) {
            return this.deviceApi.request(
              (0, _index.createRequest)("pmHandlerGetAutofillCredentials", {
                id
              })
            );
          }
          ...
          getAutofillCreditCard(id) {
            return this.deviceApi.request(
              (0, _index.createRequest)("pmHandlerGetCreditCard", {
                id
              })
            );
          }
          ...
          async getAlias() {
            const { alias } = await this.deviceApi.request(
              new _additionalDeviceApiCalls.GetAlias({
      ...
      },
      {
        ...
        "../Form/matching.js": 43,
        "../InContextSignup.js": 44,
        "../UI/HTMLTooltip.js": 54,
        "../UI/controllers/HTMLTooltipUIController.js": 55,
        "../UI/controllers/NativeUIController.js": 56,
        "../UI/controllers/OverlayUIController.js": 57,
        "../autofill-utils.js": 61,
        "../deviceApiCalls/__generated__/deviceApiCalls.js": 65,
        "../deviceApiCalls/additionalDeviceApiCalls.js": 67,
        "./InterfacePrototype.js": 27,
        "@duckduckgo/content-scope-scripts/src/apple-utils": 1
      }
    ],
    25: [
      function (require, module, exports) {
        ...
        class AppleOverlayDeviceInterface extends _AppleDeviceInterface.AppleDeviceInterface {
          ...
          providerStatusUpdated(data) {
            const { credentials, availableInputTypes } = (0, _index.validate)(data, _validatorsZod.providerStatusUpdatedSchema);
      ...
      },
      {
        ...
        "../UI/controllers/HTMLTooltipUIController.js": 55,
        "../deviceApiCalls/__generated__/deviceApiCalls.js": 65,
        "../deviceApiCalls/__generated__/validators.zod.js": 66,
        "./AppleDeviceInterface.js": 24,
        "./overlayApi.js": 31
      }
    ],
    26: [
    ...
    27: [
      function (require, module, exports) {
        ...
        class InterfacePrototype {
              ...
              if (data) {
                if (Array.isArray(data.credentials) && data.credentials.length > 0) {
                  ...
                  return this.getLocalCredentials().filter(
                    (cred) => !!cred[subtype] || subtype === "password" || cred.id === _Credentials.PROVIDER_LOCKED
                  );
                }
              }
            }
                    ...
                    switch (id) {
                      ...
                      default:
                        ...
                        const checks = [
                          ...
                          data?.emailAddress === (0, _autofillUtils.formatDuckAddress)(this.#addresses.personalAddress)
                        ];
          ...
          async getAutofillCredentials(id) {
            return this.deviceApi.request(
              new _deviceApiCalls.GetAutofillCredentialsCall({
                id: String(id)
              })
            );
          }
          ...
          storeFormData(values, trigger) {
            this.deviceApi.notify(
              new _deviceApiCalls.StoreFormDataCall({
                ...values,
                trigger
              })
            );
          ...
          postAutofill(data, dataType, formObj) {
            ...
            if (
              _Credentials.AUTOGENERATED_KEY in data &&
              "password" in data &&
      ...
      {
        "../../packages/device-api/index.js": 12,
        "../EmailProtection.js": 32,
        "../Form/formatters.js": 36,
        "../Form/matching.js": 43,
        "../InputTypes/Credentials.js": 45,
        "../PasswordGenerator.js": 48,
        "../Scanner.js": 49,
        "../Settings.js": 50,
        "../UI/controllers/NativeUIController.js": 56,
        "../autofill-utils.js": 61,
      ...
      function (require, module, exports) {
        ...
        class WindowsInterface extends _InterfacePrototype.default {
          ...
          async _show(details) {
            ...
            this.deviceApi
              .request(new _deviceApiCalls.GetAutofillDataCall(details), {
    ...
    30: [
          ...
          const observer = new PerformanceObserver((list) => {
            const entries = list.getEntries().filter(
              (entry) =>
                ...
                (0, _autofillUtils.safeRegexTest)(/login|sign-in|signin/, entry.name)
            );
      ...
      { "../Form/label-util.js": 39, "../autofill-utils.js": 61 }
    ],
    31: [
      function (require, module, exports) {
        "use strict";
        ...
        function overlayApi(device) {
          return {
            ...
            async selectedDetail(data, type) {
              ...
              await device.deviceApi.notify(
                new _deviceApiCalls.SelectedDetailCall({
                  data: entries,
                  configType: type
                })
              );
    ...
    33: [
      function (require, module, exports) {
        ...
        const { ATTR_AUTOFILL, ATTR_INPUT_TYPE, MAX_INPUTS_PER_FORM, MAX_FORM_RESCANS } = _constants.constants;
        class Form {
          ...
          get submitButtons() {
            ...
            return allButtons.filter(
              (btn) =>
                (0, _autofillUtils.isPotentiallyViewable)(btn) &&
                (0, _autofillUtils.isLikelyASubmitButton)(btn, this.matching) &&
                (0, _autofillUtils.buttonMatchesFormType)(btn, this)
            );
          }
          ...
          getFirstViableCredentialsInput() {
            return [...this.inputs.credentials].find(
              (input) => (0, _inputTypeConfig.canBeInteractedWith)(input) && (0, _autofillUtils.isPotentiallyViewable)(input)
            );
          }
          async promptLoginIfNeeded() {
            ...
            if (
              this.device.settings.canAutofillType(
                {
                  mainType,
                  subtype
                },
    ...
    34: [
      function (require, module, exports) {
        ...
        class FormAnalyzer {
          ...
          updateSignal(_ref) {
            ...
            const matchesLogin =
              (0, _autofillUtils.safeRegexTest)(/current.?password/i, string) ||
              (0, _autofillUtils.safeRegexTest)(this.matching.getDDGMatcherRegex("loginRegex"), string) ||
              (0, _autofillUtils.safeRegexTest)(this.matching.getDDGMatcherRegex("resetPasswordLink"), string);

            // Check explicitly for unified login/signup forms
            if (
              shouldCheckUnifiedForm &&
              matchesLogin &&
              (0, _autofillUtils.safeRegexTest)(this.matching.getDDGMatcherRegex("conservativeSignupRegex"), string)
            ) {
            ...
            const matchesSignup =
              (0, _autofillUtils.safeRegexTest)(/new.?password/i, string) || (0, _autofillUtils.safeRegexTest)(signupRegexToUse, string);
      ...
      },
      {
        "../autofill-utils.js": 61,
        "../constants.js": 64,
        "./matching-config/__generated__/compiled-matching-config.js": 41,
        "./matching.js": 43
      }
    ],
    35: [
    ...
    36: [
      function (require, module, exports) {
        ...
        exports.prepareFormValuesForStorage =
          exports.inferCountryCodeFromElement =
          exports.getUnifiedExpiryDate =
          exports.getMMAndYYYYFromString =
          exports.getCountryName =
          exports.getCountryDisplayName =
          exports.formatPhoneNumber =
          exports.formatFullName =
          exports.formatCCYear =
            void 0;
        var _matching = require("./matching.js");
        ...
        const formatCCYear = (input, year, form) => {
          ...
          if (input.maxLength === 4 || (0, _matching.checkPlaceholderAndLabels)(input, FOUR_DIGIT_YEAR_REGEX, form.form, selector))
            return year;
        ...
        const getUnifiedExpiryDate = (input, month, year, form) => {
          ...
          const separator =
            (0, _matching.matchInPlaceholderAndLabels)(input, DATE_SEPARATOR_REGEX, form.form, cssSelector)?.groups?.separator || "/";
          return `${paddedMonth}${separator}${formattedYear}`;
        };
        exports.getUnifiedExpiryDate = getUnifiedExpiryDate;
        const formatFullName = (_ref) => {
          let { firstName = "", middleName = "", lastName = "" } = _ref;
        ...
        const getLocalisedCountryNamesToCodes = (el) => {
          ...
          return Object.fromEntries(
            Object.entries(_countryNames.COUNTRY_CODES_TO_NAMES).map((_ref2) => {
              let [code] = _ref2;
      ...
      { "./countryNames.js": 35, "./matching.js": 43 }
    ],
    37: [
      function (require, module, exports) {
        "use strict";
    ...
    38: [
        ...
        const inputTypeConfig = {
          ...
          credentials: {
            ...
            shouldDecorate: async (input, _ref5) => {
              let { isLogin, isHybrid, device } = _ref5;
      ...
      {
        "../InputTypes/Credentials.js": 45,
        "../InputTypes/CreditCard.js": 46,
        "../InputTypes/Identity.js": 47,
        "../UI/img/ddgPasswordIcon.js": 59,
        "../constants.js": 64,
        "./logo-svg.js": 40,
        "./matching.js": 43
      }
...
`.trim();
        ...
        const matchingConfiguration = (exports.matchingConfiguration = {
          ...
          strategies: {
            cssSelector: {
              selectors: {
                ...
                submitButtonSelector:
                  'input[type=submit], input[type=button], input[type=image], button:not([role=switch]):not([role=link]), [role=button], a[href="#"][id*=button i], a[href="#"][id*=btn i]',
                formInputsSelector:
                ...
                emailAddress:
                  'input:not([type])[name*=email i]:not([placeholder*=search i]):not([placeholder*=filter i]):not([placeholder*=subject i]):not([name*=code i]), input[type=""][name*=email i]:not([placeholder*=search i]):not([placeholder*=filter i]):not([placeholder*=subject i]):not([type=tel]), input[type=text][name*=email i]:not([placeholder*=search i]):not([placeholder*=filter i]):not([placeholder*=subject i]):not([name*=title i]):not([name*=tab i]):not([name*=code i]), input:not([type])[placeholder*=email i]:not([placeholder*=search i]):not([placeholder*=filter i]):not([placeholder*=subject i]):not([name*=code i]), input[type=text][placeholder*=email i]:not([placeholder*=search i]):not([placeholder*=filter i]):not([placeholder*=subject i]), input[type=""][placeholder*=email i]:not([placeholder*=search i]):not([placeholder*=filter i]):not([placeholder*=subject i]), input[type=email], input[type=text][aria-label*=email i]:not([aria-label*=search i]), input:not([type])[aria-label*=email i]:not([aria-label*=search i]), input[name=username][type=email], input[autocomplete=username][type=email], input[autocomplete=username][placeholder*=email i], input[autocomplete=email],input[name="mail_tel" i],input[value=email i]',
                username:
                ...
                password:
                  "input[type=password]:not([autocomplete*=cc]):not([autocomplete=one-time-code]):not([name*=answer i]):not([name*=mfa i]):not([name*=tin i]):not([name*=card i]):not([name*=cvv i]),input.js-cloudsave-phrase",
                cardName:
                  'input[autocomplete="cc-name" i], input[autocomplete="ccname" i], input[name="ccname" i], input[name="cc-name" i], input[name="ppw-accountHolderName" i], input[id*=cardname i], input[id*=card-name i], input[id*=card_name i]',
                cardNumber:
                  'input[autocomplete="cc-number" i], input[autocomplete="ccnumber" i], input[autocomplete="cardnumber" i], input[autocomplete="card-number" i], input[name="ccnumber" i], input[name="cc-number" i], input[name*=card i][name*=number i], input[name*=cardnumber i], input[id*=cardnumber i], input[id*=card-number i], input[id*=card_number i]',
                cardSecurityCode:
                ...
                firstName:
                  "[name*=fname i], [autocomplete*=given-name i], [name*=firstname i], [autocomplete*=firstname i], [name*=first-name i], [autocomplete*=first-name i], [name*=first_name i], [autocomplete*=first_name i], [name*=givenname i], [autocomplete*=givenname i], [name*=given-name i], [name*=given_name i], [autocomplete*=given_name i], [name*=forename i], [autocomplete*=forename i]",
                middleName:
                  "[name*=mname i], [autocomplete*=additional-name i], [name*=middlename i], [autocomplete*=middlename i], [name*=middle-name i], [autocomplete*=middle-name i], [name*=middle_name i], [autocomplete*=middle_name i], [name*=additionalname i], [autocomplete*=additionalname i], [name*=additional-name i], [name*=additional_name i], [autocomplete*=additional_name i]",
                lastName:
                  "[name=lname], [autocomplete*=family-name i], [name*=lastname i], [autocomplete*=lastname i], [name*=last-name i], [autocomplete*=last-name i], [name*=last_name i], [autocomplete*=last_name i], [name*=familyname i], [autocomplete*=familyname i], [name*=family-name i], [name*=family_name i], [autocomplete*=family_name i], [name*=surname i], [autocomplete*=surname i]",
                fullName:
                  "[autocomplete=name], [name*=fullname i], [autocomplete*=fullname i], [name*=full-name i], [autocomplete*=full-name i], [name*=full_name i], [autocomplete*=full_name i], [name*=your-name i], [autocomplete*=your-name i]",
                phone:
                  '[name*=phone i]:not([name*=extension i]):not([name*=type i]):not([name*=country i]), [name*=mobile i]:not([name*=type i]), [autocomplete=tel], [autocomplete="tel-national"], [placeholder*="phone number" i]',
                addressStreet:
                  "[name=address i], [autocomplete=street-address i], [autocomplete=address-line1 i], [name=street i], [name=ppw-line1 i], [name*=addressLine1 i]",
                ...
                addressPostalCode:
                  "[name=zip i], [name=zip2 i], [name=postal i], [autocomplete=postal-code i], [autocomplete=zip-code i], [name*=postalCode i], [name*=zipcode i]",
                addressCountryCode:
                  "[name=country i], [autocomplete=country i], [name*=countryCode i], [name*=country-code i], [name*=countryName i], [name*=country-name i],select.idms-address-country",
                birthdayDay:
                  '[name=bday-day i], [name*=birthday_day i], [name*=birthday-day i], [name=date_of_birth_day i], [name=date-of-birth-day i], [name^=birthdate_d i], [name^=birthdate-d i], [aria-label="birthday" i][placeholder="day" i]',
                birthdayMonth:
                  '[name=bday-month i], [name*=birthday_month i], [name*=birthday-month i], [name=date_of_birth_month i], [name=date-of-birth-month i], [name^=birthdate_m i], [name^=birthdate-m i], select[name="mm" i]',
                birthdayYear:
                  '[name=bday-year i], [name*=birthday_year i], [name*=birthday-year i], [name=date_of_birth_year i], [name=date-of-birth-year i], [name^=birthdate_y i], [name^=birthdate-y i], [aria-label="birthday" i][placeholder="year" i]'
              }
            },
            ddgMatcher: {
              matchers: {
            ...
            vendorRegex: {
              rules: {
                email:
                  /((^e-?mail$)|(^email-?address$))|(e.?mail|courriel|correo.*electr(o|ó)nico|メールアドレス|электронной.?почты|邮件|邮箱|電郵地址|ഇ-മെയില്‍|ഇലക്ട്രോണിക്.?മെയിൽ|ایمیل|پست.*الکترونیک|ईमेल|इलॅक्ट्रॉनिक.?मेल|(\b|_)eposta(\b|_)|(?:이메일|전자.?우편|[ee]-?mail)(.?주소)?)/iu,
                ...
                organization:
                  /((^company$)|(^company-?name$)|(^organization$)|(^organization-?name$))|(company|business|organization|organisation|empresa|societe|société|ragione.?sociale|会社|название.?компании|单位|公司|شرکت|회사|직장)/iu,
                "street-address":
                  /((^address$)|(^street-?address$)|(^addr$)|(^street$)|(^mailing-?addr(ess)?$)|(^billing-?addr(ess)?$)|(^mail-?addr(ess)?$)|(^bill-?addr(ess)?$))|(streetaddress|street-address)/iu,
                "address-line1":
                  /(addrline1|address_1)|((^address-?1$)|(^address-?line-?1$)|(^addr-?1$)|(^street-?1$))|(^address$|address[_-]?line[_-]?(1|one)|address1|addr1|street|(?:shipping|billing)address$|strasse|straße|hausnummer|housenumber|house.?name|direccion|dirección|adresse|indirizzo|^住所$|住所1|адрес|地址|(\b|_)adres(?! (başlığı(nız)?|tarifi))(\b|_)|^주소.?$|주소.?1)/iu,
                "address-line2":
                  /(addrline2|address_2)|((^address-?2$)|(^address-?line-?2$)|(^addr-?2$)|(^street-?2$))|(address[_-]?line(2|two)|address2|addr2|street|suite|unit(?!e)|adresszusatz|ergänzende.?angaben|direccion2|colonia|adicional|addresssuppl|complementnom|appartement|indirizzo2|住所2|complemento|addrcomplement|улица|地址2|주소.?2)/iu,
                "address-line3":
                  /(addrline3|address_3)|((^address-?3$)|(^address-?line-?3$)|(^addr-?3$)|(^street-?3$))|(address[_-]?line(3|three)|address3|addr3|street|suite|unit(?!e)|adresszusatz|ergänzende.?angaben|direccion3|colonia|adicional|addresssuppl|complementnom|appartement|indirizzo3|住所3|complemento|addrcomplement|улица|地址3|주소.?3)/iu,
                "address-level2":
                  /((^city$)|(^town$)|(^address-?level-?2$)|(^address-?city$)|(^address-?town$))|(city|town|\bort\b|stadt|suburb|ciudad|provincia|localidad|poblacion|ville|commune|localit(a|à)|citt(a|à)|市区町村|cidade|город|市|分區|شهر|शहर|ग्राम|गाँव|നഗരം|ഗ്രാമം|((\b|_|\*)([i̇ii̇]l[cç]e(miz|niz)?)(\b|_|\*))|^시[^도·・]|시[·・]?군[·・]?구)/iu,
                "address-level1":
                  /(land)|((^state$)|(^province$)|(^provence$)|(^address-?level-?1$)|(^address-?state$)|(^address-?province$))|(county|region|province|county|principality|都道府県|estado|provincia|область|省|地區|സംസ്ഥാനം|استان|राज्य|((\b|_|\*)(eyalet|[şs]ehir|[i̇ii̇]limiz|kent)(\b|_|\*))|^시[·・]?도)/iu,
                "postal-code":
                  /((^postal$)|(^zip$)|(^zip2$)|(^zip-?code$)|(^postal-?code$)|(^post-?code$)|(^address-?zip$)|(^address-?postal$)|(^address-?code$)|(^address-?postal-?code$)|(^address-?zip-?code$))|(zip|postal|post.*code|pcode|pin.?code|postleitzahl|\bcp\b|\bcdp\b|\bcap\b|郵便番号|codigo|codpos|\bcep\b|почтовый.?индекс|पिन.?कोड|പിന്‍കോഡ്|邮政编码|邮编|郵遞區號|(\b|_)posta kodu(\b|_)|우편.?번호)/iu,
                country:
                  /((^country$)|(^country-?code$)|(^country-?name$)|(^address-?country$)|(^address-?country-?name$)|(^address-?country-?code$))|(country|countries|país|pais|(\b|_)land(\b|_)(?!.*(mark.*))|国家|국가|나라|(\b|_)(ülke|ulce|ulke)(\b|_)|کشور)/iu,
                "cc-name":
                  /(accountholdername|titulaire)|(cc-?name|card-?name|cardholder-?name|cardholder|(^nom$))|(card.?(?:holder|owner)|name.*(\b)?on(\b)?.*card|(?:card|cc).?name|cc.?full.?name|karteninhaber|nombre.*tarjeta|nom.*carte|nome.*cart|名前|имя.*карты|信用卡开户名|开户名|持卡人姓名|持卡人姓名)/iu,
                ...
                "given-name":
                  /((^f-?name$)|(^first-?name$)|(^given-?name$)|(^first-?n$))|(first.*name|initials|fname|first$|given.*name|vorname|nombre|forename|prénom|prenom|名|\bnome|имя|نام|이름|പേര്|(\b|_|\*)(isim|ad|ad(i|ı|iniz|ınız)?)(\b|_|\*)|नाम)/iu,
                "additional-name":
                  /(apellido.?materno|lastlastname)|((^m-?name$)|(^middle-?name$)|(^additional-?name$)|(^middle-?initial$)|(^middle-?n$)|(^middle-?i$))|(middle.*name|mname|middle$|middle.*initial|m\.i\.|mi$|\bmi\b)/iu,
                "family-name":
                  /((^l-?name$)|(^last-?name$)|(^s-?name$)|(^surname$)|(^family-?name$)|(^family-?n$)|(^last-?n$))|(last.*name|lname|surname|last$|secondname|family.*name|nachname|apellidos?|famille|^nom(?!bre)|cognome|姓|apelidos|surename|sobrenome|фамилия|نام.*خانوادگی|उपनाम|മറുപേര്|(\b|_|\*)(soyisim|soyad(i|ı|iniz|ınız)?)(\b|_|\*)|\b성(?:[^명]|\b))/iu,
                "cc-number":
                  /((cc|kk)nr)|(cc-?number|cc-?num|card-?number|card-?num|(^number$)|(^cc$)|cc-?no|card-?no|(^credit-?card$)|numero-?carte|(^carte$)|(^carte-?credit$)|num-?carte|cb-?num)|((add)?(?:card|cc|acct).?(?:number|#|no|num|field)|カード番号|номер.*карты|信用卡号|信用卡号码|信用卡卡號|카드|(numero|número|numéro)(?!.*(document|fono|phone|réservation)))/iu,
                "cc-exp-month":
                  /((cc|kk)month)|((^exp-?month$)|(^cc-?exp-?month$)|(^cc-?month$)|(^card-?month$)|(^cc-?mo$)|(^card-?mo$)|(^exp-?mo$)|(^card-?exp-?mo$)|(^cc-?exp-?mo$)|(^card-?expiration-?month$)|(^expiration-?month$)|(^cc-?mm$)|(^cc-?m$)|(^card-?mm$)|(^card-?m$)|(^card-?exp-?mm$)|(^cc-?exp-?mm$)|(^exp-?mm$)|(^exp-?m$)|(^expire-?month$)|(^expire-?mo$)|(^expiry-?month$)|(^expiry-?mo$)|(^card-?expire-?month$)|(^card-?expire-?mo$)|(^card-?expiry-?month$)|(^card-?expiry-?mo$)|(^mois-?validite$)|(^mois-?expiration$)|(^m-?validite$)|(^m-?expiration$)|(^expiry-?date-?field-?month$)|(^expiration-?date-?month$)|(^expiration-?date-?mm$)|(^exp-?mon$)|(^validity-?mo$)|(^exp-?date-?mo$)|(^cb-?date-?mois$)|(^date-?m$))|(gueltig|gültig|monat|fecha|date.*exp|scadenza|有効期限|validade|срок действия карты|月)/iu,
                "cc-exp-year":
                  /((cc|kk)year)|((^exp-?year$)|(^cc-?exp-?year$)|(^cc-?year$)|(^card-?year$)|(^cc-?yr$)|(^card-?yr$)|(^exp-?yr$)|(^card-?exp-?yr$)|(^cc-?exp-?yr$)|(^card-?expiration-?year$)|(^expiration-?year$)|(^cc-?yy$)|(^cc-?y$)|(^card-?yy$)|(^card-?y$)|(^card-?exp-?yy$)|(^cc-?exp-?yy$)|(^exp-?yy$)|(^exp-?y$)|(^cc-?yyyy$)|(^card-?yyyy$)|(^card-?exp-?yyyy$)|(^cc-?exp-?yyyy$)|(^expire-?year$)|(^expire-?yr$)|(^expiry-?year$)|(^expiry-?yr$)|(^card-?expire-?year$)|(^card-?expire-?yr$)|(^card-?expiry-?year$)|(^card-?expiry-?yr$)|(^an-?validite$)|(^an-?expiration$)|(^annee-?validite$)|(^annee-?expiration$)|(^expiry-?date-?field-?year$)|(^expiration-?date-?year$)|(^cb-?date-?ann$)|(^expiration-?date-?yy$)|(^expiration-?date-?yyyy$)|(^validity-?year$)|(^exp-?date-?year$)|(^date-?y$))|(ablaufdatum|gueltig|gültig|jahr|fecha|scadenza|有効期限|validade|срок действия карты|年|有效期)/iu,
                "cc-exp":
                  /((^cc-?exp$)|(^card-?exp$)|(^cc-?expiration$)|(^card-?expiration$)|(^cc-?ex$)|(^card-?ex$)|(^card-?expire$)|(^card-?expiry$)|(^validite$)|(^expiration$)|(^expiry$)|mm-?yy|mm-?yyyy|yy-?mm|yyyy-?mm|expiration-?date|payment-?card-?expiration|(^payment-?cc-?date$))|(expir|exp.*date|^expfield$|gueltig|gültig|fecha|date.*exp|scadenza|有効期限|validade|срок действия карты)/iu,
              ...
              ruleSets: [
                ...
                },
                {
                  ...
                  "street-address":
                    "(^address$)|(^street-?address$)|(^addr$)|(^street$)|(^mailing-?addr(ess)?$)|(^billing-?addr(ess)?$)|(^mail-?addr(ess)?$)|(^bill-?addr(ess)?$)",
                  ...
                  "postal-code":
                    "(^postal$)|(^zip$)|(^zip2$)|(^zip-?code$)|(^postal-?code$)|(^post-?code$)|(^address-?zip$)|(^address-?postal$)|(^address-?code$)|(^address-?postal-?code$)|(^address-?zip-?code$)",
                  country:
                    "(^country$)|(^country-?code$)|(^country-?name$)|(^address-?country$)|(^address-?country-?name$)|(^address-?country-?code$)",
                  ...
                  "cc-number":
                    "cc-?number|cc-?num|card-?number|card-?num|(^number$)|(^cc$)|cc-?no|card-?no|(^credit-?card$)|numero-?carte|(^carte$)|(^carte-?credit$)|num-?carte|cb-?num",
                  "cc-exp":
                    "(^cc-?exp$)|(^card-?exp$)|(^cc-?expiration$)|(^card-?expiration$)|(^cc-?ex$)|(^card-?ex$)|(^card-?expire$)|(^card-?expiry$)|(^validite$)|(^expiration$)|(^expiry$)|mm-?yy|mm-?yyyy|yy-?mm|yyyy-?mm|expiration-?date|payment-?card-?expiration|(^payment-?cc-?date$)",
                  "cc-exp-month":
                ...
                {
                  email:
                    "e.?mail|courriel|correo.*electr(o|ó)nico|メールアドレス|Электронной.?Почты|邮件|邮箱|電郵地址|ഇ-മെയില്‍|ഇലക്ട്രോണിക്.?മെയിൽ|ایمیل|پست.*الکترونیک|ईमेल|इलॅक्ट्रॉनिक.?मेल|(\\b|_)eposta(\\b|_)|(?:이메일|전자.?우편|[Ee]-?mail)(.?주소)?",
                  ...
                  organization:
                    "company|business|organization|organisation|empresa|societe|société|ragione.?sociale|会社|название.?компании|单位|公司|شرکت|회사|직장",
                  "street-address": "streetaddress|street-address",
                  "address-line1":
                    "^address$|address[_-]?line[_-]?(1|one)|address1|addr1|street|(?:shipping|billing)address$|strasse|straße|hausnummer|housenumber|house.?name|direccion|dirección|adresse|indirizzo|^住所$|住所1|Адрес|地址|(\\b|_)adres(?! (başlığı(nız)?|tarifi))(\\b|_)|^주소.?$|주소.?1",
                  "address-line2":
                    "address[_-]?line(2|two)|address2|addr2|street|suite|unit(?!e)|adresszusatz|ergänzende.?angaben|direccion2|colonia|adicional|addresssuppl|complementnom|appartement|indirizzo2|住所2|complemento|addrcomplement|Улица|地址2|주소.?2",
                  "address-line3":
                    "address[_-]?line(3|three)|address3|addr3|street|suite|unit(?!e)|adresszusatz|ergänzende.?angaben|direccion3|colonia|adicional|addresssuppl|complementnom|appartement|indirizzo3|住所3|complemento|addrcomplement|Улица|地址3|주소.?3",
                  "address-level2":
                    "city|town|\\bort\\b|stadt|suburb|ciudad|provincia|localidad|poblacion|ville|commune|localit(a|à)|citt(a|à)|市区町村|cidade|Город|市|分區|شهر|शहर|ग्राम|गाँव|നഗരം|ഗ്രാമം|((\\b|_|\\*)([İii̇]l[cç]e(miz|niz)?)(\\b|_|\\*))|^시[^도·・]|시[·・]?군[·・]?구",
                  "address-level1":
                    "county|region|province|county|principality|都道府県|estado|provincia|область|省|地區|സംസ്ഥാനം|استان|राज्य|((\\b|_|\\*)(eyalet|[şs]ehir|[İii̇]limiz|kent)(\\b|_|\\*))|^시[·・]?도",
                  "postal-code":
                    "zip|postal|post.*code|pcode|pin.?code|postleitzahl|\\bcp\\b|\\bcdp\\b|\\bcap\\b|郵便番号|codigo|codpos|\\bcep\\b|Почтовый.?Индекс|पिन.?कोड|പിന്‍കോഡ്|邮政编码|邮编|郵遞區號|(\\b|_)posta kodu(\\b|_)|우편.?번호",
                  country:
                    "country|countries|país|pais|(\\b|_)land(\\b|_)(?!.*(mark.*))|国家|국가|나라|(\\b|_)(ülke|ulce|ulke)(\\b|_)|کشور",
                  "cc-name":
                  ...
                  "given-name":
                    "first.*name|initials|fname|first$|given.*name|vorname|nombre|forename|prénom|prenom|名|\\bnome|Имя|نام|이름|പേര്|(\\b|_|\\*)(isim|ad|ad(i|ı|iniz|ınız)?)(\\b|_|\\*)|नाम",
                  "additional-name": "middle.*name|mname|middle$|middle.*initial|m\\.i\\.|mi$|\\bmi\\b",
                  "family-name":
                    "last.*name|lname|surname|last$|secondname|family.*name|nachname|apellidos?|famille|^nom(?!bre)|cognome|姓|apelidos|surename|sobrenome|Фамилия|نام.*خانوادگی|उपनाम|മറുപേര്|(\\b|_|\\*)(soyisim|soyad(i|ı|iniz|ınız)?)(\\b|_|\\*)|\\b성(?:[^명]|\\b)",
                  "cc-number":
                    "(add)?(?:card|cc|acct).?(?:number|#|no|num|field)|カード番号|Номер.*карты|信用卡号|信用卡号码|信用卡卡號|카드|(numero|número|numéro)(?!.*(document|fono|phone|réservation))",
    ...
    42: [
      ...
      { "../autofill-utils.js": 61, "./matching.js": 43 }
    ],
    43: [
      function (require, module, exports) {
        "use strict";
        ...
        var _autofillUtils = require("../autofill-utils.js");
        const { TEXT_LENGTH_CUTOFF, ATTR_INPUT_TYPE } = _constants.constants;
    ...
    44: [
      function (require, module, exports) {
        ...
        class InContextSignup {
          ...
          async refreshData() {
            const incontextSignupDismissedAt = await this.device.deviceApi.request(
              new _deviceApiCalls.GetIncontextSignupDismissedAtCall(null)
            );
          ...
          onIncontextSignupDismissed() {
            ...
            this.device.deviceApi.notify(
              new _deviceApiCalls.SetIncontextSignupPermanentlyDismissedAtCall({
      ...
      { "./autofill-utils.js": 61, "./deviceApiCalls/__generated__/deviceApiCalls.js": 65 }
    ],
    45: [
      function (require, module, exports) {
        "use strict";
    ...
    48: [
      ...
      { "../packages/password/index.js": 17, "../packages/password/rules.json": 21 }
    ],
    49: [
      function (require, module, exports) {
        "use strict";
        ...
        var _autofillUtils = require("./autofill-utils.js");
        var _deviceApiCalls = require("./deviceApiCalls/__generated__/deviceApiCalls.js");
        const { MAX_INPUTS_PER_PAGE, MAX_FORMS_PER_PAGE, MAX_INPUTS_PER_FORM } = _constants.constants;
        ...
        class DefaultScanner {
          ...
          init() {
            ...
            if (this.device.globalConfig.isExtension) {
              this.device.deviceApi.notify(
                new _deviceApiCalls.AddDebugFlagCall({
                  flag: "autofill"
                })
              );
            }
        ...
        class Settings {
          ...
          async getFeatureToggles() {
            try {
              ...
              const autofillSettings = (0, _index.validate)(
                runtimeConfig.userPreferences?.features?.autofill?.settings,
                _validatorsZod.autofillSettingsSchema
              );
          ...
          async populateDataIfNeeded(_ref2) {
            let { mainType, subtype } = _ref2;
            if (
              this.isTypeUnavailable({
                mainType,
                subtype
              })
            )
        ...
        `;
          ...
          render(config, items, callbacks) {
            ...
            const shouldShowManageButton =
              isTopAutofill &&
              items.some((item) => !["personalAddress", "privateAddress", _Credentials.PROVIDER_LOCKED].includes(item.id()));
...
<div class="wrapper wrapper--data ${topClass}" hidden>
    <div class="tooltip tooltip--data${this.options.isIncontextSignupAvailable() ? " tooltip--incontext-signup" : ""}">
      ...
      { "../InputTypes/Credentials.js": 45, "../autofill-utils.js": 61, "./HTMLTooltip.js": 54 }
    ],
    52: [
      function (require, module, exports) {
        "use strict";
...
<div class="wrapper wrapper--email" hidden>
    <div class="tooltip tooltip--email">
        <button class="tooltip__button tooltip__button--email js-use-personal">
            <span class="tooltip__button--email__primary-text">
                Use <span class="js-address">${(0, _autofillUtils.formatDuckAddress)(
                  (0, _autofillUtils.escapeXML)(this.addresses.personalAddress)
                )}</span>
            </span>
    ...
    <div class="tooltip--email__caret"></div>
      ...
      { "../autofill-utils.js": 61, "./HTMLTooltip.js": 54 }
    ],
    53: [
      function (require, module, exports) {
        "use strict";
...
<div class="wrapper wrapper--email" hidden>
    ...
    `,
        ...
        class HTMLTooltip {
          ...
          dispatchClick() {
            ...
            if (handler) {
              if (
                this.activeButton.matches(".wrapper:not(.top-autofill) button:hover, .wrapper:not(.top-autofill) a:hover, .currentFocus")
              ) {
      ...
      { "../Form/matching.js": 43, "../autofill-utils.js": 61, "./styles/styles.js": 60 }
    ],
    55: [
      function (require, module, exports) {
        "use strict";
        ...
        class HTMLTooltipUIController extends _UIController.UIController {
          ...
          createTooltip(getPosition, topContextData) {
            ...
            if (this._options.tooltipKind === "legacy") {
              ...
              return new _EmailHTMLTooltip.default(config, topContextData.inputType, getPosition, tooltipOptions).render(
            ...
            if (this._options.tooltipKind === "emailsignup") {
              ...
              return new _EmailSignupHTMLTooltip.default(config, topContextData.inputType, getPosition, tooltipOptions).render(
                this._options.device
              );
            }
      ...
      {
        "../../Form/inputTypeConfig.js": 38,
        "../../Form/matching.js": 43,
        "../../autofill-utils.js": 61,
        "../DataHTMLTooltip.js": 51,
        "../EmailHTMLTooltip.js": 52,
        "../EmailSignupHTMLTooltip.js": 53,
        "../HTMLTooltip.js": 54,
        "./UIController.js": 58
      }
    ],
      ...
      function (require, module, exports) {
        ...
        class NativeUIController extends _UIController.UIController {
          ...
          attach(args) {
            ...
            device.deviceApi
              .request(new _deviceApiCalls.GetAutofillDataCall(payload))
              .then((resp) => {
                switch (resp.action) {
                  case "fill": {
                    if (mainType in resp) {
    ...
    57: [
      ...
      { "../../Form/matching.js": 43, "./UIController.js": 58 }
    ],
    58: [
      function (require, module, exports) {
        "use strict";
    ...
    59: [
      function (require, module, exports) {
        ...
        exports.ddgPasswordIconFocused =
          exports.ddgPasswordIconFilled =
          exports.ddgPasswordIconBaseWhite =
          exports.ddgPasswordIconBase =
          exports.ddgIdentityIconBase =
          exports.ddgCcIconFilled =
          exports.ddgCcIconBase =
            void 0;
        const ddgPasswordIconBase = (exports.ddgPasswordIconBase =
        ...
        const ddgPasswordIconBaseWhite = (exports.ddgPasswordIconBaseWhite =
        ...
        const ddgPasswordIconFilled = (exports.ddgPasswordIconFilled =
        ...
        const ddgPasswordIconFocused = (exports.ddgPasswordIconFocused =
        ...
        const ddgCcIconBase = (exports.ddgCcIconBase =
        ...
        const ddgCcIconFilled = (exports.ddgCcIconFilled =
    ...
    60: [
      function (require, module, exports) {
        ...
        const CSS_STYLES = (exports.CSS_STYLES =
    ...
    61: [
      function (require, module, exports) {
        ...
        exports.buttonMatchesFormType =
          exports.autofillEnabled =
          exports.addInlineStyles =
          exports.SIGN_IN_MSG =
          exports.ADDRESS_DOMAIN =
            void 0;
        exports.escapeXML = escapeXML;
        exports.isEventWithinDax =
          exports.isAutofillEnabledFromProcessedConfig =
          exports.getTextShallow =
          exports.getDaxBoundingBox =
          exports.formatDuckAddress =
            void 0;
        ...
        const isLikelyASubmitButton = (el, matching) => {
          ...
          if (
            ...
            return true;
          return (
            (safeRegexTest(/primary|submit/i, el.className) ||
              // has high-signal submit classes
              safeRegexTest(/submit/i, dataTestId) ||
              safeRegexTest(matching.getDDGMatcherRegex("submitButtonRegex"), text) ||
      ...
      { "./Form/matching.js": 43, "./constants.js": 64 }
    ],
    62: [
      function (require, module, exports) {
        "use strict";
      ...
      { "./DeviceInterface.js": 22, "./autofill-utils.js": 61, "./requestIdleCallback.js": 73 }
    ],
    63: [
      function (require, module, exports) {
        "use strict";
    ...
    65: [
      function (require, module, exports) {
        ...
        exports.StoreFormDataCall =
          ...
          exports.ShowInContextEmailProtectionSignupPromptCall =
          exports.SetSizeCall =
          exports.SetIncontextSignupPermanentlyDismissedAtCall =
          exports.SendJSPixelCall =
          exports.SelectedDetailCall =
          exports.OpenManagePasswordsCall =
          exports.OpenManageIdentitiesCall =
          exports.OpenManageCreditCardsCall =
          exports.GetRuntimeConfigurationCall =
          exports.GetIncontextSignupDismissedAtCall =
          exports.GetAvailableInputTypesCall =
          exports.GetAutofillInitDataCall =
          exports.GetAutofillDataCall =
          exports.GetAutofillCredentialsCall =
          exports.EmailProtectionStoreUserDataCall =
          exports.EmailProtectionRemoveUserDataCall =
          exports.EmailProtectionRefreshPrivateAddressCall =
          exports.EmailProtectionGetUserDataCall =
          exports.EmailProtectionGetIsLoggedInCall =
          exports.EmailProtectionGetCapabilitiesCall =
          exports.EmailProtectionGetAddressesCall =
          exports.CloseEmailProtectionTabCall =
          exports.CloseAutofillParentCall =
          exports.CheckCredentialsProviderStatusCall =
          exports.AskToUnlockProviderCall =
          exports.AddDebugFlagCall =
            void 0;
      ...
      { "../../../packages/device-api": 12, "./validators.zod.js": 66 }
    ],
    66: [
      function (require, module, exports) {
        "use strict";
        ...
        exports.userPreferencesSchema =
          exports.triggerContextSchema =
          exports.storeFormDataSchema =
          exports.showInContextEmailProtectionSignupPromptSchema =
          exports.setSizeParamsSchema =
          exports.setIncontextSignupPermanentlyDismissedAtSchema =
          exports.sendJSPixelParamsSchema =
          exports.selectedDetailParamsSchema =
          exports.runtimeConfigurationSchema =
          exports.providerStatusUpdatedSchema =
          exports.outgoingCredentialsSchema =
          exports.getRuntimeConfigurationResponseSchema =
          exports.getIncontextSignupDismissedAtSchema =
          exports.getAvailableInputTypesResultSchema =
          exports.getAutofillInitDataResponseSchema =
          exports.getAutofillDataResponseSchema =
          exports.getAutofillDataRequestSchema =
          exports.getAutofillCredentialsResultSchema =
          exports.getAutofillCredentialsParamsSchema =
          exports.getAliasResultSchema =
          exports.getAliasParamsSchema =
          exports.genericErrorSchema =
          exports.generatedPasswordSchema =
          exports.emailProtectionStoreUserDataParamsSchema =
          exports.emailProtectionRefreshPrivateAddressResultSchema =
          exports.emailProtectionGetUserDataResultSchema =
          exports.emailProtectionGetIsLoggedInResultSchema =
          exports.emailProtectionGetCapabilitiesResultSchema =
          exports.emailProtectionGetAddressesResultSchema =
          exports.credentialsSchema =
          exports.contentScopeSchema =
          exports.checkCredentialsProviderStatusResultSchema =
          exports.availableInputTypesSchema =
          exports.availableInputTypes1Schema =
          exports.autofillSettingsSchema =
          exports.autofillFeatureTogglesSchema =
          exports.askToUnlockProviderResultSchema =
          exports.apiSchema =
          exports.addDebugFlagParamsSchema =
            void 0;
        var _zod = require("zod");
        /* DO NOT EDIT, this file was generated by scripts/api-call-generator.js */
        // Generated by ts-to-zod

        const sendJSPixelParamsSchema = (exports.sendJSPixelParamsSchema = _zod.z.union([
          _zod.z.object({
        ...
        const userPreferencesSchema = (exports.userPreferencesSchema = _zod.z.object({
          ...
          platform: _zod.z.object({
            name: _zod.z.union([
              _zod.z.literal("ios"),
              _zod.z.literal("macos"),
              _zod.z.literal("windows"),
              _zod.z.literal("extension"),
              _zod.z.literal("android"),
              _zod.z.literal("unknown")
            ])
          }),
          features: _zod.z.record(
            _zod.z.object({
        ...
        const getAutofillDataResponseSchema = (exports.getAutofillDataResponseSchema = _zod.z.object({
          ...
          success: _zod.z
            .object({
              ...
              action: _zod.z.union([
                _zod.z.literal("fill"),
                _zod.z.literal("focus"),
                _zod.z.literal("none"),
                _zod.z.literal("acceptGeneratedPassword"),
                _zod.z.literal("rejectGeneratedPassword")
              ])
            })
            .optional(),
        ...
        const storeFormDataSchema = (exports.storeFormDataSchema = _zod.z.object({
          ...
          trigger: _zod.z
            .union([_zod.z.literal("formSubmission"), _zod.z.literal("passwordGeneration"), _zod.z.literal("emailProtection")])
            .optional()
        }));
        ...
        const apiSchema = (exports.apiSchema = _zod.z.object({
          ...
          getAutofillData: _zod.z
            ...
            .optional(),
          getRuntimeConfiguration: _zod.z
            .record(_zod.z.unknown())
            .and(
              _zod.z.object({
          ...
          askToUnlockProvider: _zod.z
            ...
            .optional(),
          checkCredentialsProviderStatus: _zod.z
            .record(_zod.z.unknown())
            .and(
              _zod.z.object({
          ...
          sendJSPixel: _zod.z
            ...
            .optional(),
          setIncontextSignupPermanentlyDismissedAt: _zod.z
            .record(_zod.z.unknown())
            .and(
              _zod.z.object({
            ...
            .optional(),
          getIncontextSignupDismissedAt: _zod.z
            .record(_zod.z.unknown())
            .and(
              _zod.z.object({
          ...
          emailProtectionStoreUserData: _zod.z
            .record(_zod.z.unknown())
            .and(
              _zod.z.object({
          ...
          emailProtectionGetIsLoggedIn: _zod.z
            .record(_zod.z.unknown())
            .and(
              _zod.z.object({
            ...
            .optional(),
          emailProtectionGetUserData: _zod.z
            .record(_zod.z.unknown())
            .and(
              _zod.z.object({
            ...
            .optional(),
          emailProtectionGetCapabilities: _zod.z
            .record(_zod.z.unknown())
            .and(
              _zod.z.object({
            ...
            .optional(),
          emailProtectionGetAddresses: _zod.z
            .record(_zod.z.unknown())
            .and(
              _zod.z.object({
            ...
            .optional(),
          emailProtectionRefreshPrivateAddress: _zod.z
            .record(_zod.z.unknown())
            .and(
              _zod.z.object({
          ...
          ShowInContextEmailProtectionSignupPrompt: _zod.z
            .record(_zod.z.unknown())
            .and(
              _zod.z.object({
    ...
    67: [
      ...
      { "../../packages/device-api/index.js": 12, "./__generated__/validators.zod.js": 66 }
    ],
    68: [
      function (require, module, exports) {
        "use strict";
      ...
      { "../../../packages/device-api/index.js": 12, "../__generated__/deviceApiCalls.js": 65 }
    ],
    69: [
      function (require, module, exports) {
        "use strict";
      ...
      function (require, module, exports) {
        ...
        class ExtensionTransport extends _index.DeviceApiTransport {
          ...
          async send(deviceApiCall) {
            ...
            if (
              deviceApiCall instanceof _deviceApiCalls.CloseAutofillParentCall ||
              deviceApiCall instanceof _deviceApiCalls.StartEmailProtectionSignupCall
            ) {
              return; // noop
            }
    ...
    71: [
      ...
      { "./android.transport.js": 68, "./apple.transport.js": 69, "./extension.transport.js": 70, "./windows.transport.js": 72 }
    ],
    72: [
      function (require, module, exports) {
        "use strict";
