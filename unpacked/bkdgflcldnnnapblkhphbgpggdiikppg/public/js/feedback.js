      ...
      module.exports = function () {
        ...
        if (this.model.isBrokenSite) {
          fields = bel`<div>
            ...
            <input class='js-feedback-url frm__input' type='text' placeholder='${t("feedback:brokenSitePlaceholder.title")}' value='${
              this.model.url
            }'/>
            <label class='frm__label'>${t("feedback:describeTheIssue.title")}</label>
            <textarea class='frm__text js-feedback-message' required placeholder='${t(
              "feedback:describeBreakagePlaceholder.title"
            )}'></textarea>
        </div>`;
        } else {
          fields = bel`<div>
