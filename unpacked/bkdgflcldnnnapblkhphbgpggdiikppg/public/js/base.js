...
(() => {
  ...
  var require_jquery = __commonJS({
    "node_modules/jquery/dist/jquery.js"(exports, module) {
      (function (global, factory) {
          ...
          makeArray: function (arr3, results) {
            ...
            if (arr3 != null) {
              if (isArrayLike(Object(arr3))) {
                jQuery.merge(ret, typeof arr3 === "string" ? [arr3] : arr3);
              } else {
                push.call(ret, arr3);
              }
            }
                ...
                return first === 1 && last === 0
                  ...
                  : function (elem, _context, xml) {
                      var cache,
                        ...
                        nodeIndex,
                        start,
                        dir3 = simple !== forward ? "nextSibling" : "previousSibling",
                      ...
                      if (parent) {
                        ...
                        if (forward && useCache) {
                          ...
                          while (
                            (node =
                              (++nodeIndex && node && node[dir3]) || // Fallback to seeking `elem` from the start
                              (diff = nodeIndex = 0) ||
                              start.pop())
                          ) {
        ...
        var rootjQuery,
          rquickExpr = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/,
          init2 = (jQuery.fn.init = function (selector, context, root) {
            var match, elem;
            if (!selector) {
              return this;
            }
        ...
        jQuery.extend({
                          ...
                          if (isFunction(then)) {
                            if (special) {
                              ...
                              then.call(
                                ...
                                resolve(maxDepth, deferred2, Identity, special),
                                resolve(maxDepth, deferred2, Thrower, special),
                                resolve(maxDepth, deferred2, Identity, deferred2.notifyWith)
                              );
                            }
                          } else {
                            if (handler !== Identity) {
          ...
          when: function (singleValue) {
            var remaining = arguments.length,
              ...
              resolveValues = slice2.call(arguments),
      ...
      ResourceStore = class extends EventEmitter {
        ...
        getResource(lng, ns, key) {
          ...
          const ignoreJSONStructure =
            options.ignoreJSONStructure !== void 0 ? options.ignoreJSONStructure : this.options.ignoreJSONStructure;
          let path = [lng, ns];
      ...
      PluralResolver = class {
        ...
        getSuffixes(code) {
          ...
          if (this.shouldUseIntlApi()) {
            return rule
              .resolvedOptions()
              .pluralCategories.sort((pluralCategory1, pluralCategory2) => suffixesOrder[pluralCategory1] - suffixesOrder[pluralCategory2])
              .map(
                (pluralCategory) => `${this.options.prepend}${options.ordinal ? `ordinal${this.options.prepend}` : ""}${pluralCategory}`
              );
          }
  ...
  function setPath2(object, path, newValue) {
    var _getLastOfPath = getLastOfPath2(object, path, Object),
      obj = _getLastOfPath.obj,
      k = _getLastOfPath.k;
    obj[k] = newValue;
  }
  function getPath2(object, path) {
    var _getLastOfPath3 = getLastOfPath2(object, path),
  ...
  function getDefaultHourSymbolFromLocale(locale) {
    ...
    var hourCycles =
      timeData[regionTag || ""] || timeData[languageTag || ""] || timeData["".concat(languageTag, "-001")] || timeData["001"];
    return hourCycles[0];
  }
  ...
  var _a,
    ...
    hasNativeStartsWith,
    hasNativeFromCodePoint,
    hasNativeFromEntries,
    hasNativeCodePointAt,
    hasTrimStart,
    hasTrimEnd,
    hasNativeIsSafeInteger,
    isSafeInteger,
        ...
        : // IE11
          function fromCodePoint2() {
            ...
            while (length > i) {
              ...
              elements +=
                code < 65536 ? String.fromCharCode(code) : String.fromCharCode(((code -= 65536) >> 10) + 55296, (code % 1024) + 56320);
            }
            return elements;
          };
      fromEntries = // native
      ...
      codePointAt = hasNativeCodePointAt
        ...
        : // IE 11
          function codePointAt3(s, index) {
            ...
            var second;
            return first < 55296 || first > 56319 || index + 1 === size || (second = s.charCodeAt(index + 1)) < 56320 || second > 57343
              ? first
        ...
        (function () {
          ...
          Parser2.prototype.parseArgumentOptions = function (nestingLevel, expectingCloseTag, value, openingBracePosition) {
            ...
            switch (argType) {
              ...
              case "time": {
                ...
                if (
                  styleAndLocation &&
                  startsWith(styleAndLocation === null || styleAndLocation === void 0 ? void 0 : styleAndLocation.style, "::", 0)
                ) {
                ...
                return {
                  val: {
                    ...
                    location: location_1,
                    style:
                      (_a2 = styleAndLocation === null || styleAndLocation === void 0 ? void 0 : styleAndLocation.style) !== null &&
                      _a2 !== void 0
                        ? _a2
                        : null
                  },
          ...
          Parser2.prototype.tryParsePluralOrSelectOptions = function (nestingLevel, parentArgType, expectCloseTag, parsedFirstIdentifier) {
            ...
            while (true) {
              ...
              if (parsedSelectors.has(selector)) {
                return this.error(
                  parentArgType === "select" ? ErrorKind.DUPLICATE_SELECT_ARGUMENT_SELECTOR : ErrorKind.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,
                  selectorLocation
                );
              }
              if (selector === "other") {
            ...
            if (options.length === 0) {
              return this.error(
                parentArgType === "select" ? ErrorKind.EXPECT_SELECT_ARGUMENT_SELECTOR : ErrorKind.EXPECT_PLURAL_ARGUMENT_SELECTOR,
                createLocation(this.clonePosition(), this.clonePosition())
              );
            }
          ...
          Parser2.prototype.bumpTo = function (targetOffset) {
            if (this.offset() > targetOffset) {
              throw Error(
                "targetOffset ".concat(targetOffset, " must be greater than or equal to the current offset ").concat(this.offset())
              );
            }
      ...
      InvalidValueTypeError =
        ...
        (function (_super) {
          ...
          function InvalidValueTypeError2(value, type, originalMessage) {
            return (
              _super.call(this, 'Value for "'.concat(value, '" must be of type ').concat(type), ErrorCode.INVALID_VALUE, originalMessage) ||
              this
            );
          }
        ...
        (function () {
          function IntlMessageFormat2(message, locales, overrideFormats, opts) {
            ...
            if (typeof message === "string") {
              ...
              var _a2 = opts || {},
                formatters = _a2.formatters,
                parseOpts = __rest(_a2, ["formatters"]);
    ...
    "shared/locales/bg/feedback.json"() {
      feedback_default = {
        ...
        brokenSitePlaceholder: {
          title:
            "\u041A\u043E\u043F\u0438\u0440\u0430\u0439\u0442\u0435 \u0438 \u043F\u043E\u0441\u0442\u0430\u0432\u0435\u0442\u0435 URL \u0430\u0434\u0440\u0435\u0441\u0430",
        ...
        feedbackHeaderLabel: {
          title:
            "\u041A\u0430\u043A\u0432\u043E \u0412\u0438 \u0445\u0430\u0440\u0435\u0441\u0432\u0430? \u041A\u0430\u043A\u0432\u043E \u043D\u0435 \u0440\u0430\u0431\u043E\u0442\u0438 \u043A\u0430\u043A\u0442\u043E \u0442\u0440\u044F\u0431\u0432\u0430? \u041A\u0430\u043A \u043C\u043E\u0436\u0435 \u0434\u0430 \u0441\u0435 \u043F\u043E\u0434\u043E\u0431\u0440\u0438 \u0440\u0430\u0437\u0448\u0438\u0440\u0435\u043D\u0438\u0435\u0442\u043E?",
          note: "Label over a feedback text area where the user can tell us about their experience with our browser extension."
        },
        feedbackPlaceholder: {
          title:
            "\u0417\u0430 \u043A\u043E\u0438 \u0444\u0443\u043D\u043A\u0446\u0438\u0438 \u0438\u043B\u0438 \u0444\u0443\u043D\u043A\u0446\u0438\u043E\u043D\u0430\u043B\u043D\u043E\u0441\u0442\u0438 \u0441\u0435 \u043E\u0442\u043D\u0430\u0441\u044F \u0412\u0430\u0448\u0438\u044F \u043E\u0442\u0437\u0438\u0432? \u041C\u043E\u043B\u044F, \u0434\u0430\u0439\u0442\u0435 \u043A\u043E\u043B\u043A\u043E\u0442\u043E \u043C\u043E\u0436\u0435 \u043F\u043E-\u043A\u043E\u043D\u043A\u0440\u0435\u0442\u0435\u043D \u043E\u0442\u0433\u043E\u0432\u043E\u0440.",
          note: "Placeholder text on feedback form input."
        },
        submittingFeedbackHelps: {
          title:
            "\u0418\u0437\u043F\u0440\u0430\u0449\u0430\u043D\u0435\u0442\u043E \u043D\u0430 \u0430\u043D\u043E\u043D\u0438\u043C\u0435\u043D \u043E\u0442\u0437\u0438\u0432 \u043D\u0438 \u043F\u043E\u043C\u0430\u0433\u0430 \u0434\u0430 \u043F\u043E\u0434\u043E\u0431\u0440\u0438\u043C DuckDuckGo Privacy Essentials.",
          note: "Description at top of feedback form."
        },
        reportBrokenSite: {
          title:
            "\u0418\u0441\u043A\u0430\u043C \u0434\u0430 \u043F\u043E\u0434\u0430\u043C \u0441\u0438\u0433\u043D\u0430\u043B \u0437\u0430 \u043F\u043E\u0432\u0440\u0435\u0434\u0435\u043D \u0441\u0430\u0439\u0442",
        ...
        describeTheIssue: {
          title:
            "\u041E\u043F\u0438\u0448\u0435\u0442\u0435 \u043F\u0440\u043E\u0431\u043B\u0435\u043C\u0430, \u043A\u043E\u0439\u0442\u043E \u0441\u0440\u0435\u0449\u043D\u0430\u0445\u0442\u0435:",
        ...
        describeBreakagePlaceholder: {
          title:
            "\u041A\u043E\u0435 \u0441\u044A\u0434\u044A\u0440\u0436\u0430\u043D\u0438\u0435 \u0438\u043B\u0438 \u0444\u0443\u043D\u043A\u0446\u0438\u043E\u043D\u0430\u043B\u043D\u043E\u0441\u0442 \u043D\u0430 \u0443\u0435\u0431\u0441\u0430\u0439\u0442\u0430 \u0435 \u043F\u043E\u0432\u0440\u0435\u0434\u0435\u043D\u043E? \u041C\u043E\u043B\u044F, \u0434\u0430\u0439\u0442\u0435 \u043A\u043E\u043B\u043A\u043E\u0442\u043E \u043C\u043E\u0436\u0435 \u043F\u043E-\u043A\u043E\u043D\u043A\u0440\u0435\u0442\u0435\u043D \u043E\u0442\u0433\u043E\u0432\u043E\u0440.",
        ...
        thankYouBrokenSite: {
          title:
            "\u0412\u0430\u0448\u0438\u0442\u0435 \u0441\u0438\u0433\u043D\u0430\u043B\u0438 \u0437\u0430 \u043F\u043E\u0432\u0440\u0435\u0434\u0435\u043D \u0441\u0430\u0439\u0442 \u043F\u043E\u043C\u0430\u0433\u0430\u0442 \u043D\u0430 \u043D\u0430\u0448\u0438\u044F \u0435\u043A\u0438\u043F \u043E\u0442 \u0440\u0430\u0437\u0440\u0430\u0431\u043E\u0442\u0447\u0438\u0446\u0438 \u0434\u0430 \u043E\u0442\u0441\u0442\u0440\u0430\u043D\u0438 \u0442\u0435\u0437\u0438 \u043F\u043E\u0432\u0440\u0435\u0434\u0438.",
    ...
    "shared/locales/bg/options.json"() {
      options_default = {
        ...
        globalPrivacyControlAbbr: {
          title:
            "\u0413\u043B\u043E\u0431\u0430\u043B\u0435\u043D \u043A\u043E\u043D\u0442\u0440\u043E\u043B \u043D\u0430 \u043F\u043E\u0432\u0435\u0440\u0438\u0442\u0435\u043B\u043D\u043E\u0441\u0442\u0442\u0430 (GPC)",
        ...
        notSellYourPersonalData: {
          title:
            "\u0414\u0430 \u043D\u0435 \u043F\u0440\u043E\u0434\u0430\u0432\u0430\u0442 \u0412\u0430\u0448\u0438\u0442\u0435 \u043B\u0438\u0447\u043D\u0438 \u0434\u0430\u043D\u043D\u0438.",
        ...
        limitSharingOfPersonalData: {
          title:
            "\u0414\u0430 \u043E\u0433\u0440\u0430\u043D\u0438\u0447\u0430\u0442 \u0441\u043F\u043E\u0434\u0435\u043B\u044F\u043D\u0435\u0442\u043E \u043D\u0430 \u043B\u0438\u0447\u043D\u0438\u0442\u0435 \u0412\u0438 \u0434\u0430\u043D\u043D\u0438 \u0441 \u0434\u0440\u0443\u0433\u0438 \u043A\u043E\u043C\u043F\u0430\u043D\u0438\u0438.",
        ...
        fireButtonDesc: {
          title:
            "\u0421 Fire Button \u043C\u043E\u0436\u0435\u0442\u0435 \u043B\u0435\u0441\u043D\u043E \u0434\u0430 \u0438\u0437\u0447\u0438\u0441\u0442\u0438\u0442\u0435 \u0440\u0430\u0437\u0434\u0435\u043B\u0438\u0442\u0435, \u0438\u0441\u0442\u043E\u0440\u0438\u044F\u0442\u0430 \u043D\u0430 \u0441\u044A\u0440\u0444\u0438\u0440\u0430\u043D\u0435 \u0438 \u0434\u0430\u043D\u043D\u0438\u0442\u0435. \u041C\u043E\u0436\u0435\u0442\u0435 \u0434\u0430 \u043A\u043E\u043D\u0442\u0440\u043E\u043B\u0438\u0440\u0430\u0442\u0435 \u0434\u0430\u043B\u0438 \u0438\u0441\u0442\u043E\u0440\u0438\u044F\u0442\u0430 \u043D\u0430 \u0441\u044A\u0440\u0444\u0438\u0440\u0430\u043D\u0435 \u0438 \u0434\u0430\u043D\u043D\u0438\u0442\u0435 \u0434\u0430 \u0441\u0435 \u0438\u0437\u0447\u0438\u0441\u0442\u0432\u0430\u0442, \u043A\u0430\u043A\u0442\u043E \u0438 \u0434\u0430\u043B\u0438 \u0442\u0435\u043A\u0443\u0449\u0438\u0442\u0435 \u0440\u0430\u0437\u0434\u0435\u043B\u0438 \u0434\u0430 \u0441\u0435 \u0437\u0430\u0442\u0432\u0430\u0440\u044F\u0442.",
        ...
        fireButtonClearHistoryDesc: {
          title:
            "\u0418\u043C\u0430\u0439\u0442\u0435 \u043F\u0440\u0435\u0434\u0432\u0438\u0434: \u0418\u0441\u0442\u043E\u0440\u0438\u044F\u0442\u0430 \u043D\u0430 \u0441\u044A\u0440\u0444\u0438\u0440\u0430\u043D\u0435 \u043C\u043E\u0436\u0435 \u0434\u0430 \u0431\u044A\u0434\u0435 \u0438\u0437\u0447\u0438\u0441\u0442\u0435\u043D\u0430 \u0441\u0430\u043C\u043E \u0437\u0430 \u043E\u043F\u0440\u0435\u0434\u0435\u043B\u0435\u043D \u043F\u0435\u0440\u0438\u043E\u0434 \u043E\u0442 \u0432\u0440\u0435\u043C\u0435 (\u043D\u0430\u043F\u0440. \u0437\u0430 \u201E\u043F\u043E\u0441\u043B\u0435\u0434\u043D\u0438\u044F \u0447\u0430\u0441\u201C \u0438\u043B\u0438 \u0437\u0430 \u201E\u0446\u044F\u043B\u043E\u0442\u043E \u0432\u0440\u0435\u043C\u0435\u201C), \u0430 \u043D\u0435 \u0437\u0430 \u0432\u0441\u0435\u043A\u0438 \u043E\u0442\u0434\u0435\u043B\u0435\u043D \u0441\u0430\u0439\u0442.",
  ...
  var init_feedback2 = __esm({
    "shared/locales/cs/feedback.json"() {
      feedback_default2 = {
        ...
        feedbackPlaceholder: {
          title:
            "Kter\xFDch vlastnost\xED nebo funkc\xED se tvoje zp\u011Btn\xE1 vazba t\xFDk\xE1? Bu\u010F co nejkonkr\xE9tn\u011Bj\u0161\xED.",
          note: "Placeholder text on feedback form input."
        },
        submittingFeedbackHelps: {
        ...
        thankYouBrokenSite: {
          title:
            "Tvoje hl\xE1\u0161en\xED o nefunk\u010Dn\xEDch str\xE1nk\xE1ch pom\xE1haj\xED t\xFDmu na\u0161ich v\xFDvoj\xE1\u0159\u016F tyhle chyby opravovat.",
          note: "Additional note when submitting a broken site."
        }
      };
    }
  ...
  var init_options2 = __esm({
    "shared/locales/cs/options.json"() {
      options_default2 = {
        ...
        optionsDesc: {
          title:
            "DuckDuckGo chr\xE1n\xED tvoje soukrom\xED na webu soukrom\xFDm vyhled\xE1v\xE1n\xEDm\n,blokov\xE1n\xEDm tracker\u016F\na\xA0\u0161ifrov\xE1n\xEDm str\xE1nek.",
          note: "This describes how we protect the user from being tracked online"
        },
        shareFeedback: {
        ...
        autofillEnabled: {
          title:
            'Je zapnut\xE9 automatick\xE9 vypl\u0148ov\xE1n\xED pro u\u017Eivatele <strong class="js-userdata-container">{userName}</strong>',
          note: "When we do help populate email addresses for (your email address here)"
        },
        noUnprotectedSitesAdded: {
        ...
        fireButtonDesc: {
          title:
            "Pomoc\xED tla\u010D\xEDtka Fire Button m\u016F\u017Ee\u0161 snadno vymazat karty, historii proch\xE1zen\xED a data. Je jen na tob\u011B, jestli se m\xE1 vymazat historie proch\xE1zen\xED i data a jestli se maj\xED zav\u0159\xEDt aktu\xE1ln\xED karty.",
          note: "Describes the Fire button features. As per glossary, please do not translate Fire Button."
        },
        fireButtonClearHistoryTitle: {
        ...
        fireButtonClearHistoryDesc: {
          title:
            "Upozor\u0148ujeme, \u017Ee historie proch\xE1zen\xED se d\xE1 vymazat jen pro konkr\xE9tn\xED \u010Dasov\xE9 obdob\xED (nap\u0159. za posledn\xED hodinu nebo za celou dobu), nikoli pro jednotliv\xE9 weby.",
          note: "Extra information about the clear history option toggle."
        },
        fireButtonTabClosureTitle: {
  ...
  var init_options3 = __esm({
    "shared/locales/da/options.json"() {
      options_default3 = {
        ...
        globalPrivacyControlDesc: {
          title:
            'Dine data burde ikke v\xE6re til salg. Det er vi enige i hos DuckDuckGo.Aktiv\xE9r indstillingen "Global Privacy Control" (GPC), s\xE5\nsignalerer vi til websteder, at du foretr\xE6kker:',
          note: "This describes the GPC feature, which lets the user set a preference to not have their personal information sold by websites to other parties. The string is followed by a list of actions like 'Not sell your personal data'. These are translated separately."
        },
        notSellYourPersonalData: {
        ...
        fireButtonDesc: {
          title:
            "Fire Button g\xF8r det nemt at rydde dine faner, browserhistorik og data. Du kan kontrollere, om den skal rydde browserhistorik og data, og om den skal lukke dine aktuelle faner eller ej.",
          note: "Describes the Fire button features. As per glossary, please do not translate Fire Button."
        },
        fireButtonClearHistoryTitle: {
          title: "Ryd historik",
        ...
        fireButtonClearHistoryDesc: {
          title:
            'Bem\xE6rk: Browserhistorikken kan kun slettes for et bestemt tidsrum (f.eks. "sidste time", eller "altid"), og ikke for hvert websted.',
          note: "Extra information about the clear history option toggle."
        },
        fireButtonTabClosureTitle: {
          title: "Luk fane",
  ...
  var init_options4 = __esm({
    "shared/locales/de/options.json"() {
      options_default4 = {
        ...
        optionsDesc: {
          title:
            "DuckDuckGo sch\xFCtzt deine Privatsph\xE4re online mit\nprivater Suche,\nTracker-Blockade\nund Website-Verschl\xFCsselung.",
          note: "This describes how we protect the user from being tracked online"
        },
        shareFeedback: {
        ...
        fireButtonDesc: {
          title:
            "Mit dem Fire Button k\xF6nnen Sie ganz einfach Ihre Tabs, Ihren Browserverlauf und Ihre Daten l\xF6schen. Sie k\xF6nnen festlegen, ob der Browserverlauf und die Daten gel\xF6scht werden sollen und ob die aktuellen Tabs geschlossen werden sollen oder nicht.",
          note: "Describes the Fire button features. As per glossary, please do not translate Fire Button."
        },
        fireButtonClearHistoryTitle: {
        ...
        fireButtonClearHistoryDesc: {
          title:
            "Hinweis: Der Browserverlauf kann nur f\xFCr einen bestimmten Zeitraum gel\xF6scht werden (z. B. \u201Eletzte Stunde\u201C oder \u201Ealle Zeiten\u201C) und nicht pro Website.",
          note: "Extra information about the clear history option toggle."
        },
        fireButtonTabClosureTitle: {
  ...
  var init_feedback5 = __esm({
    "shared/locales/el/feedback.json"() {
      feedback_default5 = {
        ...
        brokenSiteLabel: {
          title:
            "\u03A0\u03BF\u03B9\u03BF\u03C2 \u03B9\u03C3\u03C4\u03CC\u03C4\u03BF\u03C0\u03BF\u03C2 \u03B5\u03AF\u03BD\u03B1\u03B9 \u03BA\u03B1\u03C4\u03B5\u03C3\u03C4\u03C1\u03B1\u03BC\u03BC\u03AD\u03BD\u03BF\u03C2;",
          note: "We're asking feedback from users. Here they are reporting a website url that is not working correctly."
        },
        brokenSitePlaceholder: {
          title:
            "\u0391\u03BD\u03C4\u03B9\u03B3\u03C1\u03AC\u03C8\u03C4\u03B5 \u03BA\u03B1\u03B9 \u03B5\u03C0\u03B9\u03BA\u03BF\u03BB\u03BB\u03AE\u03C3\u03C4\u03B5 \u03C4\u03B7 \u03B4\u03B9\u03B5\u03CD\u03B8\u03C5\u03BD\u03C3\u03B7 URL \u03C3\u03B1\u03C2",
          note: `Instructions to fill an input field with a URL. Here "your URL" doesn't mean that they own the website, just that they're reporting it.`
        },
        feedbackHeaderLabel: {
          title:
            "\u03A4\u03B9 \u03C3\u03B1\u03C2 \u03B1\u03C1\u03AD\u03C3\u03B5\u03B9; \u03A4\u03B9 \u03B4\u03B5\u03BD \u03BB\u03B5\u03B9\u03C4\u03BF\u03C5\u03C1\u03B3\u03B5\u03AF; \u03A0\u03CE\u03C2 \u03B8\u03B1 \u03BC\u03C0\u03BF\u03C1\u03BF\u03CD\u03C3\u03B5 \u03BD\u03B1 \u03B2\u03B5\u03BB\u03C4\u03B9\u03C9\u03B8\u03B5\u03AF \u03B7 \u03B5\u03C0\u03AD\u03BA\u03C4\u03B1\u03C3\u03B7;",
          note: "Label over a feedback text area where the user can tell us about their experience with our browser extension."
        },
        feedbackPlaceholder: {
          title:
            "\u03A3\u03B5 \u03C0\u03BF\u03B9\u03B1 \u03C7\u03B1\u03C1\u03B1\u03BA\u03C4\u03B7\u03C1\u03B9\u03C3\u03C4\u03B9\u03BA\u03AC \u03AE \u03BB\u03B5\u03B9\u03C4\u03BF\u03C5\u03C1\u03B3\u03AF\u03B5\u03C2 \u03B1\u03BD\u03B1\u03C6\u03AD\u03C1\u03BF\u03BD\u03C4\u03B1\u03B9 \u03C4\u03B1 \u03C3\u03C7\u03CC\u03BB\u03B9\u03AC \u03C3\u03B1\u03C2; \u039D\u03B1 \u03B5\u03AF\u03C3\u03C4\u03B5 \u03CC\u03C3\u03BF \u03C4\u03BF \u03B4\u03C5\u03BD\u03B1\u03C4\u03CC\u03BD \u03C0\u03B9\u03BF \u03C3\u03C5\u03B3\u03BA\u03B5\u03BA\u03C1\u03B9\u03BC\u03AD\u03BD\u03BF\u03B9.",
          note: "Placeholder text on feedback form input."
        },
        submittingFeedbackHelps: {
          title:
            "\u0397 \u03C5\u03C0\u03BF\u03B2\u03BF\u03BB\u03AE \u03B1\u03BD\u03CE\u03BD\u03C5\u03BC\u03C9\u03BD \u03C3\u03C7\u03BF\u03BB\u03AF\u03C9\u03BD \u03BC\u03AC\u03C2 \u03B2\u03BF\u03B7\u03B8\u03AC \u03BD\u03B1 \u03B2\u03B5\u03BB\u03C4\u03B9\u03CE\u03BD\u03BF\u03C5\u03BC\u03B5 \u03C4\u03BF DuckDuckGo Privacy Essentials.",
          note: "Description at top of feedback form."
        },
        reportBrokenSite: {
          title:
            "\u0398\u03AD\u03BB\u03C9 \u03BD\u03B1 \u03B1\u03BD\u03B1\u03C6\u03AD\u03C1\u03C9 \u03AD\u03BD\u03B1\u03BD \u03B9\u03C3\u03C4\u03CC\u03C4\u03BF\u03C0\u03BF \u03C0\u03BF\u03C5 \u03B4\u03B5\u03BD \u03BB\u03B5\u03B9\u03C4\u03BF\u03C5\u03C1\u03B3\u03B5\u03AF \u03C3\u03C9\u03C3\u03C4\u03AC",
          note: "This opens a feedback form to report a broken site. Broken here means 'not working as expected'."
        },
        submit: {
          title: "\u03A5\u03C0\u03BF\u03B2\u03BF\u03BB\u03AE",
        ...
        describeTheIssue: {
          title:
            "\u03A0\u03B5\u03C1\u03B9\u03B3\u03C1\u03AC\u03C8\u03C4\u03B5 \u03C4\u03BF \u03C0\u03C1\u03CC\u03B2\u03BB\u03B7\u03BC\u03B1 \u03C0\u03BF\u03C5 \u03B1\u03BD\u03C4\u03B9\u03BC\u03B5\u03C4\u03C9\u03C0\u03AF\u03C3\u03B1\u03C4\u03B5:",
          note: "Label on broken site feedback textarea where users can describe in what way a site is not working as expected."
        },
        describeBreakagePlaceholder: {
          title:
            "\u03A0\u03BF\u03B9\u03BF \u03C0\u03B5\u03C1\u03B9\u03B5\u03C7\u03CC\u03BC\u03B5\u03BD\u03BF \u03AE \u03BB\u03B5\u03B9\u03C4\u03BF\u03C5\u03C1\u03B3\u03AF\u03B1 \u03C4\u03BF\u03C5 \u03B9\u03C3\u03C4\u03CC\u03C4\u03BF\u03C0\u03BF\u03C5 \u03B4\u03B5\u03BD \u03BB\u03B5\u03B9\u03C4\u03BF\u03C5\u03C1\u03B3\u03B5\u03AF \u03C3\u03C9\u03C3\u03C4\u03AC; \u039D\u03B1 \u03B5\u03AF\u03C3\u03C4\u03B5 \u03CC\u03C3\u03BF \u03C4\u03BF \u03B4\u03C5\u03BD\u03B1\u03C4\u03CC\u03BD \u03C0\u03B9\u03BF \u03C3\u03C5\u03B3\u03BA\u03B5\u03BA\u03C1\u03B9\u03BC\u03AD\u03BD\u03BF\u03B9.",
          note: "Placeholder text on the broken site form."
        },
        thankYou: {
          title:
        ...
        thankYouBrokenSite: {
          title:
            "\u039F\u03B9 \u03B1\u03BD\u03B1\u03C6\u03BF\u03C1\u03AD\u03C2 \u03C3\u03B1\u03C2 \u03B3\u03B9\u03B1 \u03B9\u03C3\u03C4\u03CC\u03C4\u03BF\u03C0\u03BF\u03C5\u03C2 \u03C0\u03BF\u03C5 \u03B4\u03B5\u03BD \u03BB\u03B5\u03B9\u03C4\u03BF\u03C5\u03C1\u03B3\u03BF\u03CD\u03BD \u03C3\u03C9\u03C3\u03C4\u03AC \u03B2\u03BF\u03B7\u03B8\u03BF\u03CD\u03BD \u03C4\u03B7\u03BD \u03BF\u03BC\u03AC\u03B4\u03B1 \u03B1\u03BD\u03AC\u03C0\u03C4\u03C5\u03BE\u03AE\u03C2 \u03BC\u03B1\u03C2 \u03BD\u03B1 \u03B4\u03B9\u03BF\u03C1\u03B8\u03CE\u03C3\u03B5\u03B9 \u03C4\u03B1 \u03C0\u03C1\u03BF\u03B2\u03BB\u03AE\u03BC\u03B1\u03C4\u03B1 \u03B1\u03C5\u03C4\u03AC.",
          note: "Additional note when submitting a broken site."
        }
      };
    }
  ...
  var init_options5 = __esm({
    "shared/locales/el/options.json"() {
      options_default5 = {
        ...
        optionsSubHeader: {
          title:
            "\u0391\u03BD\u03B1\u03B6\u03B7\u03C4\u03AE\u03C3\u03C4\u03B5 \u03BA\u03B1\u03B9 \u03C0\u03B5\u03C1\u03B9\u03B7\u03B3\u03B7\u03B8\u03B5\u03AF\u03C4\u03B5 \u03C3\u03C4\u03BF\u03BD \u0399\u03C3\u03C4\u03CC \u03C7\u03C9\u03C1\u03AF\u03C2 \u03BD\u03B1 \u03C3\u03B1\u03C2 \u03C0\u03B1\u03C1\u03B1\u03BA\u03BF\u03BB\u03BF\u03C5\u03B8\u03BF\u03CD\u03BD.",
          note: "We allow the user to browse the web without being followed by trackers"
        },
        optionsDesc: {
          title:
            "\u03A4\u03BF DuckDuckGo \u03C0\u03C1\u03BF\u03C3\u03C4\u03B1\u03C4\u03B5\u03CD\u03B5\u03B9 \u03C4\u03B7\u03BD \u03B9\u03B4\u03B9\u03C9\u03C4\u03B9\u03BA\u03CC\u03C4\u03B7\u03C4\u03AC \u03C3\u03B1\u03C2 \u03C3\u03C4\u03BF \u03B4\u03B9\u03B1\u03B4\u03AF\u03BA\u03C4\u03C5\u03BF \u03BC\u03B5\n\u03B9\u03B4\u03B9\u03C9\u03C4\u03B9\u03BA\u03AE \u03B1\u03BD\u03B1\u03B6\u03AE\u03C4\u03B7\u03C3\u03B7,\n\u03B1\u03C0\u03BF\u03BA\u03BB\u03B5\u03B9\u03C3\u03BC\u03CC \u03C0\u03B1\u03C1\u03B1\u03BA\u03BF\u03BB\u03BF\u03CD\u03B8\u03B7\u03C3\u03B7\u03C2,\n\u03BA\u03B1\u03B9 \u03BA\u03C1\u03C5\u03C0\u03C4\u03BF\u03B3\u03C1\u03AC\u03C6\u03B7\u03C3\u03B7 \u03B9\u03C3\u03C4\u03CC\u03C4\u03BF\u03C0\u03C9\u03BD.",
          note: "This describes how we protect the user from being tracked online"
        },
        shareFeedback: {
        ...
        showEmbeddedTweets: {
          title:
            "\u0395\u03BC\u03C6\u03AC\u03BD\u03B9\u03C3\u03B7 \u03B5\u03BD\u03C3\u03C9\u03BC\u03B1\u03C4\u03C9\u03BC\u03AD\u03BD\u03C9\u03BD Tweet",
          note: "Whether the user wants to see Tweets embedded in various webpages or should they be hidden util clicked on"
        },
        globalPrivacyControlAbbr: {
          title:
            "\u03A0\u03B1\u03B3\u03BA\u03CC\u03C3\u03BC\u03B9\u03BF\u03C2 \u03AD\u03BB\u03B5\u03B3\u03C7\u03BF\u03C2 \u03B1\u03C0\u03BF\u03C1\u03C1\u03AE\u03C4\u03BF\u03C5 (GPC)",
          note: "Global Privacy Control is the name of the feature that lets users set a preference to not have their information sold"
        },
        globalPrivacyControlDesc: {
          title:
            "\u03A4\u03B1 \u03B4\u03B5\u03B4\u03BF\u03BC\u03AD\u03BD\u03B1 \u03C3\u03B1\u03C2 \u03B4\u03B5\u03BD \u03C0\u03C1\u03AD\u03C0\u03B5\u03B9 \u03BD\u03B1 \u03C0\u03C9\u03BB\u03BF\u03CD\u03BD\u03C4\u03B1\u03B9. \u03A3\u03C4\u03B7\u03BD DuckDuckGo \u03C3\u03C5\u03BC\u03C6\u03C9\u03BD\u03BF\u03CD\u03BC\u03B5.\u0395\u03BD\u03B5\u03C1\u03B3\u03BF\u03C0\u03BF\u03B9\u03AE\u03C3\u03C4\u03B5 \u03C4\u03B9\u03C2 \u03C1\u03C5\u03B8\u03BC\u03AF\u03C3\u03B5\u03B9\u03C2 \u03B3\u03B9\u03B1 \u03C4\u03BF\u03BD \xAB\u03A0\u03B1\u03B3\u03BA\u03CC\u03C3\u03BC\u03B9\u03BF \u03AD\u03BB\u03B5\u03B3\u03C7\u03BF \u03B1\u03C0\u03BF\u03C1\u03C1\u03AE\u03C4\u03BF\u03C5\xBB (GPC) \u03BA\u03B1\u03B9 \u03B8\u03B1\n\u03B5\u03C0\u03B9\u03C3\u03B7\u03BC\u03AC\u03BD\u03BF\u03C5\u03BC\u03B5 \u03C3\u03C4\u03BF\u03C5\u03C2 \u03B9\u03C3\u03C4\u03CC\u03C4\u03BF\u03C0\u03BF\u03C5\u03C2 \u03C4\u03B7\u03BD \u03C0\u03C1\u03BF\u03C4\u03AF\u03BC\u03B7\u03C3\u03AE \u03C3\u03B1\u03C2:",
          note: "This describes the GPC feature, which lets the user set a preference to not have their personal information sold by websites to other parties. The string is followed by a list of actions like 'Not sell your personal data'. These are translated separately."
        },
        notSellYourPersonalData: {
          title:
        ...
        autofillEnabled: {
          title:
            '\u0397 \u03B1\u03C5\u03C4\u03CC\u03BC\u03B1\u03C4\u03B7 \u03C3\u03C5\u03BC\u03C0\u03BB\u03AE\u03C1\u03C9\u03C3\u03B7 \u03B5\u03AF\u03BD\u03B1\u03B9 \u03B5\u03BD\u03B5\u03C1\u03B3\u03BF\u03C0\u03BF\u03B9\u03B7\u03BC\u03AD\u03BD\u03B7 \u03B3\u03B9\u03B1 \u03C4\u03BF\u03BD \u03C7\u03C1\u03AE\u03C3\u03C4\u03B7 <strong class="js-userdata-container">{userName}</strong>',
          note: "When we do help populate email addresses for (your email address here)"
        },
        noUnprotectedSitesAdded: {
          title:
            "\u0394\u03B5\u03BD \u03AD\u03C7\u03BF\u03C5\u03BD \u03C0\u03C1\u03BF\u03C3\u03C4\u03B5\u03B8\u03B5\u03AF \u03BC\u03B7 \u03C0\u03C1\u03BF\u03C3\u03C4\u03B1\u03C4\u03B5\u03C5\u03BC\u03AD\u03BD\u03BF\u03B9 \u03B9\u03C3\u03C4\u03CC\u03C4\u03BF\u03C0\u03BF\u03B9",
          note: "Currently there are no websites on the list of websites where our privacy protections are disabled"
        },
        unprotectedSites: {
          title:
        ...
        addUnprotectedSite: {
          title:
            "\u03A0\u03C1\u03BF\u03C3\u03B8\u03AE\u03BA\u03B7 \u03BC\u03B7 \u03C0\u03C1\u03BF\u03C3\u03C4\u03B1\u03C4\u03B5\u03C5\u03BC\u03AD\u03BD\u03BF\u03C5 \u03B9\u03C3\u03C4\u03CC\u03C4\u03BF\u03C0\u03BF\u03C5",
          note: "Header for the user to add a site to the uprotected list"
        },
        enterURL: {
        ...
        fireButtonDesc: {
          title:
            "\u03A4\u03BF \u03BA\u03BF\u03C5\u03BC\u03C0\u03AF Fire Button \u03B4\u03B9\u03B5\u03C5\u03BA\u03BF\u03BB\u03CD\u03BD\u03B5\u03B9 \u03C4\u03B7 \u03B4\u03B9\u03B1\u03B4\u03B9\u03BA\u03B1\u03C3\u03AF\u03B1 \u03B5\u03BA\u03BA\u03B1\u03B8\u03AC\u03C1\u03B9\u03C3\u03B7\u03C2 \u03C4\u03C9\u03BD \u03BA\u03B1\u03C1\u03C4\u03B5\u03BB\u03CE\u03BD, \u03C4\u03BF\u03C5 \u03B9\u03C3\u03C4\u03BF\u03C1\u03B9\u03BA\u03BF\u03CD \u03C0\u03B5\u03C1\u03B9\u03AE\u03B3\u03B7\u03C3\u03B7\u03C2 \u03BA\u03B1\u03B9 \u03C4\u03C9\u03BD \u03B4\u03B5\u03B4\u03BF\u03BC\u03AD\u03BD\u03C9\u03BD \u03C3\u03B1\u03C2. \u039C\u03C0\u03BF\u03C1\u03B5\u03AF\u03C4\u03B5 \u03BD\u03B1 \u03B5\u03BB\u03AD\u03B3\u03BE\u03B5\u03C4\u03B5 \u03B1\u03BD \u03B8\u03B1 \u03B4\u03B9\u03B1\u03B3\u03C1\u03AC\u03C8\u03B5\u03B9 \u03C4\u03BF \u03B9\u03C3\u03C4\u03BF\u03C1\u03B9\u03BA\u03CC \u03C0\u03B5\u03C1\u03B9\u03AE\u03B3\u03B7\u03C3\u03B7\u03C2 \u03BA\u03B1\u03B8\u03CE\u03C2 \u03BA\u03B1\u03B9 \u03C4\u03B1 \u03B4\u03B5\u03B4\u03BF\u03BC\u03AD\u03BD\u03B1 \u03BA\u03B1\u03B9 \u03B1\u03BD \u03B8\u03B1 \u03BA\u03BB\u03B5\u03AF\u03C3\u03B5\u03B9 \u03AE \u03CC\u03C7\u03B9 \u03C4\u03B9\u03C2 \u03C4\u03C1\u03AD\u03C7\u03BF\u03C5\u03C3\u03B5\u03C2 \u03BA\u03B1\u03C1\u03C4\u03AD\u03BB\u03B5\u03C2 \u03C3\u03B1\u03C2.",
          note: "Describes the Fire button features. As per glossary, please do not translate Fire Button."
        },
        fireButtonClearHistoryTitle: {
        ...
        fireButtonClearHistoryDesc: {
          title:
            "\u03A3\u03B7\u03BC\u03B5\u03AF\u03C9\u03C3\u03B7: \u03C4\u03BF \u03B9\u03C3\u03C4\u03BF\u03C1\u03B9\u03BA\u03CC \u03C0\u03B5\u03C1\u03B9\u03AE\u03B3\u03B7\u03C3\u03B7\u03C2 \u03BC\u03C0\u03BF\u03C1\u03B5\u03AF \u03BD\u03B1 \u03B4\u03B9\u03B1\u03B3\u03C1\u03B1\u03C6\u03B5\u03AF \u03BC\u03CC\u03BD\u03BF \u03B3\u03B9\u03B1 \u03AD\u03BD\u03B1 \u03C3\u03C5\u03B3\u03BA\u03B5\u03BA\u03C1\u03B9\u03BC\u03AD\u03BD\u03BF \u03C7\u03C1\u03BF\u03BD\u03B9\u03BA\u03CC \u03B4\u03B9\u03AC\u03C3\u03C4\u03B7\u03BC\u03B1 (\u03C0.\u03C7.  \xAB\u03C4\u03B5\u03BB\u03B5\u03C5\u03C4\u03B1\u03AF\u03B1 \u03CE\u03C1\u03B1\xBB, \u03AE \xAB\u03CC\u03BB\u03BF\xBB) \u03BA\u03B1\u03B9 \u03CC\u03C7\u03B9 \u03B1\u03BD\u03AC \u03C4\u03BF\u03C0\u03BF\u03B8\u03B5\u03C3\u03AF\u03B1.",
          note: "Extra information about the clear history option toggle."
        },
        fireButtonTabClosureTitle: {
...
signal to websites your preference to:`,
        ...
        enableYoutubePreviewsDesc: {
          title:
            "DuckDuckGo automatically blocks embedded YouTube videos, along with their title and preview, from being loaded to improve your privacy. You can choose to enable previews, but doing so will allow Google to see some of your device\u2019s information when you visit any page with an embedded video.&nbsp;",
        ...
        fireButtonDesc: {
          title:
            "The Fire Button makes it easy to clear your tabs, browsing history, and data. You can control whether it clears browsing history as well as data, and whether or not it closes your current tabs.",
        ...
        fireButtonClearHistoryDesc: {
          title:
            'Please note: browsing history can be cleared only for a specified time range (e.g. "last hour", or "all time"), and not on a per-site basis.',
          note: "Extra information about the clear history option toggle."
        },
        fireButtonTabClosureTitle: {
          title: "Close Tabs",
  ...
  var init_options7 = __esm({
    "shared/locales/es/options.json"() {
      options_default7 = {
        ...
        globalPrivacyControlDesc: {
          title:
            "Tus datos no deber\xEDan estar a la venta. En DuckDuckGo, estamos de acuerdo.Activa la configuraci\xF3n de \xABControl Global de Privacidad\xBB (GPC) e\ninformaremos a los sitios web de que prefieres:",
          note: "This describes the GPC feature, which lets the user set a preference to not have their personal information sold by websites to other parties. The string is followed by a list of actions like 'Not sell your personal data'. These are translated separately."
        },
        notSellYourPersonalData: {
        ...
        fireButtonDesc: {
          title:
            "El Fire Button facilita el borrado de tus pesta\xF1as, historial de navegaci\xF3n y datos. Puedes controlar si se borra el historial de navegaci\xF3n adem\xE1s de los datos y si se cierran o no tus pesta\xF1as actuales.",
          note: "Describes the Fire button features. As per glossary, please do not translate Fire Button."
        },
        fireButtonClearHistoryTitle: {
        ...
        fireButtonClearHistoryDesc: {
          title:
            "Ten en cuenta que el historial de navegaci\xF3n solo se puede borrar para un intervalo de tiempo especificado (por ejemplo, \xAB\xFAltima hora\xBB, o \xABsiempre\xBB) y no en funci\xF3n del sitio web.",
          note: "Extra information about the clear history option toggle."
        },
        fireButtonTabClosureTitle: {
  ...
  var init_options8 = __esm({
    "shared/locales/et/options.json"() {
      options_default8 = {
        ...
        globalPrivacyControlDesc: {
          title:
            "Sinu andmeid ei ole m\xFC\xFCgiks DuckDuckGo n\xF5ustub sellega.Aktiveeri seadistus \u201E\xDCleilmne privaatsuskontroll\u201C (GPC) ja me anname veebisaitidele m\xE4rku sinu eelistusest:",
          note: "This describes the GPC feature, which lets the user set a preference to not have their personal information sold by websites to other parties. The string is followed by a list of actions like 'Not sell your personal data'. These are translated separately."
        },
        notSellYourPersonalData: {
        ...
        fireButtonDesc: {
          title:
            "Fire Button teeb vahekaartide, sirvimisajaloo ja andmete kustutamise lihtsaks. Saad m\xE4\xE4rata, kas see kustutab nii sirvimisajaloo kui ka andmed ja kas see sulgeb sinu praegused vahekaardid v\xF5i mitte.",
          note: "Describes the Fire button features. As per glossary, please do not translate Fire Button."
        },
        fireButtonClearHistoryTitle: {
        ...
        fireButtonClearHistoryDesc: {
          title:
            "Pane t\xE4hele: kustutada saab ainult m\xE4\xE4ratud ajavahemiku sirvimisajaloo (nt viimane tund v\xF5i kogu aeg) ning seda ei saa teha saidi kaupa.",
          note: "Extra information about the clear history option toggle."
        },
        fireButtonTabClosureTitle: {
  ...
  var init_options9 = __esm({
    "shared/locales/fi/options.json"() {
      options_default9 = {
        ...
        fireButtonDesc: {
          title:
            "Fire Button -painikkeen avulla v\xE4lilehtien, selaushistorian ja tietojen tyhjent\xE4minen on helppoa. Voit hallita, tyhjennet\xE4\xE4nk\xF6 selaushistoria ja tiedot, ja suljetaanko nykyiset v\xE4lilehdet.",
          note: "Describes the Fire button features. As per glossary, please do not translate Fire Button."
        },
        fireButtonClearHistoryTitle: {
        ...
        fireButtonClearHistoryDesc: {
          title:
            'Huomaa: selaushistoria voidaan tyhjent\xE4\xE4 vain tietylt\xE4 ajanjaksolta (esim. "viime tunti" tai "kaikki"), eik\xE4 sivustokohtaisesti.',
          note: "Extra information about the clear history option toggle."
        },
        fireButtonTabClosureTitle: {
  ...
  var init_feedback10 = __esm({
    "shared/locales/fr/feedback.json"() {
      feedback_default10 = {
        ...
        feedbackHeaderLabel: {
          title:
            "Qu'avez-vous le plus appr\xE9ci\xE9\xA0? Qu'avez-vous le moins appr\xE9ci\xE9\xA0? Comment l'extension pourrait-elle \xEAtre am\xE9lior\xE9e\xA0?",
          note: "Label over a feedback text area where the user can tell us about their experience with our browser extension."
        },
        feedbackPlaceholder: {
  ...
  var init_options10 = __esm({
    "shared/locales/fr/options.json"() {
      options_default10 = {
        ...
        optionsDesc: {
          title:
            "DuckDuckGo prot\xE8ge votre confidentialit\xE9 en ligne gr\xE2ce \xE0 la recherche priv\xE9e, au blocage des traqueurs et au cryptage de site.",
          note: "This describes how we protect the user from being tracked online"
        },
        shareFeedback: {
        ...
        globalPrivacyControlDisclaimer: {
          title:
            "<b>\xC9tant donn\xE9 que le Global Privacy Control (GPC) est une nouvelle norme, la plupart des sites Web ne la reconnaissent pas encore, mais nous mettons tout en \u0153uvre pour qu'elle soit reconnue dans le monde entier.</b> Cependant, les sites Web ne sont tenus de respecter cette demande que dans la mesure o\xF9 les lois applicables les y obligent.\xA0",
          note: "Explains to the user that we can communiate their choice to the website, but the website needs to choose to support this signal"
        },
        emailProtection: {
        ...
        fireButtonDesc: {
          title:
            "Le Fire Button permet de supprimer facilement vos onglets, votre historique de navigation et vos donn\xE9es. Vous pouvez contr\xF4ler s'il efface l'historique de navigation ainsi que les donn\xE9es, et s'il ferme ou non vos onglets en cours.",
          note: "Describes the Fire button features. As per glossary, please do not translate Fire Button."
        },
        fireButtonClearHistoryTitle: {
        ...
        fireButtonClearHistoryDesc: {
          title:
            "Remarque\xA0: l'historique de navigation ne peut \xEAtre effac\xE9 que sur une p\xE9riode sp\xE9cifi\xE9e (par exemple, \xAB\xA0derni\xE8re heure\xA0\xBB, ou \xAB\xA0depuis le d\xE9but\xA0\xBB) et non par site.",
          note: "Extra information about the clear history option toggle."
        },
        fireButtonTabClosureTitle: {
  ...
  var init_feedback11 = __esm({
    "shared/locales/hr/feedback.json"() {
      feedback_default11 = {
        ...
        thankYouBrokenSite: {
          title:
            "Tvoji izvje\u0161taji o neispravnim web stranicama/lokacijama poma\u017Eu na\u0161em razvojnom timu da popravi te probleme.",
          note: "Additional note when submitting a broken site."
        }
      };
    }
  ...
  var init_options11 = __esm({
    "shared/locales/hr/options.json"() {
      options_default11 = {
        ...
        fireButtonDesc: {
          title:
            "Fire Button olak\u0161ava brisanje kartica, povijesti pregledavanja i podataka. Mo\u017Ee\u0161 kontrolirati ho\u0107e li se izbrisati povijest pregledavanja i podaci te ho\u0107e li se zatvoriti tvoje aktualne (otvorene) kartice.",
          note: "Describes the Fire button features. As per glossary, please do not translate Fire Button."
        },
        fireButtonClearHistoryTitle: {
        ...
        fireButtonClearHistoryDesc: {
          title:
            'Imaj na umu: povijest pregledavanja mo\u017Ee se izbrisati samo za odre\u0111eni vremenski raspon (npr. "posljednji sat" ili "sve vrijeme"), a ne na temelju web lokacije.',
          note: "Extra information about the clear history option toggle."
        },
        fireButtonTabClosureTitle: {
  ...
  var init_feedback12 = __esm({
    "shared/locales/hu/feedback.json"() {
      feedback_default12 = {
        ...
        thankYouBrokenSite: {
          title:
            "A nem megfelel\u0151en m\u0171k\xF6d\u0151 webhelyekkel kapcsolatos bejelent\xE9sek seg\xEDtik fejleszt\u0151csapatunkat a hib\xE1k kijav\xEDt\xE1s\xE1ban.",
          note: "Additional note when submitting a broken site."
        }
      };
    }
  ...
  var init_options12 = __esm({
    "shared/locales/hu/options.json"() {
      options_default12 = {
        ...
        autofillEnabled: {
          title:
            'Az automatikus kit\xF6lt\xE9s <strong class="js-userdata-container">{userName}</strong> sz\xE1m\xE1ra enged\xE9lyezve van.',
          note: "When we do help populate email addresses for (your email address here)"
        },
        noUnprotectedSitesAdded: {
        ...
        fireButtonDesc: {
          title:
            "A T\u0171z gombbal k\xF6nnyen t\xF6r\xF6lheted a lapokat, a b\xF6ng\xE9sz\xE9si el\u0151zm\xE9nyeket \xE9s az adatokat. Be\xE1ll\xEDthatod, hogy a b\xF6ng\xE9sz\xE9si el\u0151zm\xE9nyeket \xE9s az adatokat is t\xF6r\xF6lje-e, illetve hogy bez\xE1rja-e a jelenlegi lapokat is.",
          note: "Describes the Fire button features. As per glossary, please do not translate Fire Button."
        },
        fireButtonClearHistoryTitle: {
        ...
        fireButtonClearHistoryDesc: {
          title:
            "Megjegyz\xE9s: a b\xF6ng\xE9sz\xE9si el\u0151zm\xE9nyek csak meghat\xE1rozott id\u0151tartamra vonatkoz\xF3an t\xF6r\xF6lhet\u0151k (pl. \u201Eel\u0151z\u0151 1 \xF3ra\u201D vagy \u201Eminden id\u0151pont\u201D), webhelyre vonatkoz\xF3an azonban nem.",
          note: "Extra information about the clear history option toggle."
        },
        fireButtonTabClosureTitle: {
  ...
  var init_feedback13 = __esm({
    "shared/locales/it/feedback.json"() {
      feedback_default13 = {
        ...
        feedbackPlaceholder: {
          title:
            "A quali caratteristiche o funzionalit\xE0 fa riferimento il tuo feedback? Inserisci informazioni il pi\xF9 specifiche possibile.",
          note: "Placeholder text on feedback form input."
        },
        submittingFeedbackHelps: {
...
segnaleremo ai siti web di:`,
        ...
        fireButtonDesc: {
          title:
            "Il Fire button semplifica l'eliminazione delle schede, della cronologia di navigazione e dei dati. Puoi controllare se eliminare la cronologia di navigazione e i dati e se chiudere le schede correnti.",
          note: "Describes the Fire button features. As per glossary, please do not translate Fire Button."
        },
        fireButtonClearHistoryTitle: {
        ...
        fireButtonClearHistoryDesc: {
          title:
            'Nota: la cronologia di navigazione pu\xF2 essere eliminata solo per un intervallo di tempo specificato (ad es. "ultima ora" o "sempre") e non in base al sito.',
          note: "Extra information about the clear history option toggle."
        },
        fireButtonTabClosureTitle: {
          title: "Chiudi schede",
  ...
  var init_feedback14 = __esm({
    "shared/locales/lt/feedback.json"() {
      feedback_default14 = {
        ...
        thankYouBrokenSite: {
          title:
            "J\u016Bs\u0173 prane\u0161imai apie neveikian\u010Dias svetaines padeda m\u016Bs\u0173 k\u016Br\u0117j\u0173 komandai i\u0161taisyti \u0161iuos gedimus.",
          note: "Additional note when submitting a broken site."
        }
      };
    }
  ...
  var init_options14 = __esm({
    "shared/locales/lt/options.json"() {
      options_default14 = {
        ...
        optionsDesc: {
          title:
            "\u201EDuckDuckGo\u201C saugo j\u016Bs\u0173 privatum\u0105 internete naudodama\npriva\u010Di\u0105 paie\u0161k\u0105,\nsek\u0117j\u0173 blokavim\u0105\nir svetaini\u0173 \u0161ifravim\u0105.",
          note: "This describes how we protect the user from being tracked online"
        },
        shareFeedback: {
        ...
        fireButtonDesc: {
          title:
            "Mygtukas \u201EFire\u201C leid\u017Eia lengvai i\u0161valyti skirtukus, nar\u0161ymo istorij\u0105 ir duomenis. Galite nustatyti, ar jis i\u0161trina nar\u0161ymo istorij\u0105 ir duomenis ir ar u\u017Edaro esamus skirtukus.",
          note: "Describes the Fire button features. As per glossary, please do not translate Fire Button."
        },
        fireButtonClearHistoryTitle: {
        ...
        fireButtonClearHistoryDesc: {
          title:
            "Atkreipkite d\u0117mes\u012F: nar\u0161ymo istorij\u0105 galima i\u0161trinti tik nurodytam laiko intervalui (pvz., \u201Epaskutin\u0117 valanda\u201C arba \u201Eviso laiko\u201C), o ne pagal kiekvien\u0105 svetain\u0119.",
          note: "Extra information about the clear history option toggle."
        },
        fireButtonTabClosureTitle: {
  ...
  var init_feedback15 = __esm({
    "shared/locales/lv/feedback.json"() {
      feedback_default15 = {
        ...
        feedbackPlaceholder: {
          title:
            "Uz kur\u0101m iesp\u0113j\u0101m vai funkcionalit\u0101ti attiecas tavas atsauksmes? L\u016Bdzu, nor\u0101di p\u0113c iesp\u0113jas prec\u012Bz\u0101k.",
          note: "Placeholder text on feedback form input."
        },
        submittingFeedbackHelps: {
        ...
        describeBreakagePlaceholder: {
          title:
            "K\u0101ds vietnes saturs vai funkcionalit\u0101te ir nedarbojas? L\u016Bdzu, nor\u0101di p\u0113c iesp\u0113jas prec\u012Bz\u0101k.",
          note: "Placeholder text on the broken site form."
        },
        thankYou: {
        ...
        thankYouBrokenSite: {
          title:
            "Tavi zi\u0146ojumi par vietn\u0113m, kas nedarbojas pareizi, pal\u012Bdz m\u016Bsu izstr\u0101d\u0101t\u0101ju komandai nov\u0113rst \u0161os darb\u012Bbas trauc\u0113jumus.",
          note: "Additional note when submitting a broken site."
        }
      };
    }
  ...
  var init_options15 = __esm({
    "shared/locales/lv/options.json"() {
      options_default15 = {
        ...
        optionsDesc: {
          title:
            "DuckDuckGo aizsarg\u0101 tavu priv\u0101tumu tie\u0161saist\u0113 ar\npriv\u0101to mekl\u0113\u0161anu,\nizsekot\u0101ju blo\u0137\u0113\u0161anu,\nun viet\u0146u \u0161ifr\u0113\u0161anu.",
          note: "This describes how we protect the user from being tracked online"
        },
        shareFeedback: {
        ...
        autofillEnabled: {
          title:
            'Iesl\u0113gta autom\u0101tisk\u0101 aizpild\u012B\u0161ana lietot\u0101jam <strong class="js-userdata-container">{userName}</strong>',
          note: "When we do help populate email addresses for (your email address here)"
        },
        noUnprotectedSitesAdded: {
        ...
        fireButtonDesc: {
          title:
            "Nospie\u017Eot Fire Button, vari viegli not\u012Br\u012Bt cilnes, p\u0101rl\u016Bko\u0161anas v\u0113sturi un datus. Vari izv\u0113l\u0113ties, vai not\u012Br\u012Bt gan p\u0101rl\u016Bko\u0161anas v\u0113sturi, gan datus, k\u0101 ar\u012B to, vai aizv\u0113rt pa\u0161reiz\u0113j\u0101s cilnes.",
          note: "Describes the Fire button features. As per glossary, please do not translate Fire Button."
        },
        fireButtonClearHistoryTitle: {
        ...
        fireButtonClearHistoryDesc: {
          title:
            'L\u016Bdzu, \u0146em v\u0113r\u0101: p\u0101rl\u016Bko\u0161anas v\u0113sturi var dz\u0113st tikai par noteiktu laika periodu (piem., "p\u0113d\u0113j\u0101 stunda" vai "visu laiku"), nevis katrai vietnei atsevi\u0161\u0137i.',
          note: "Extra information about the clear history option toggle."
        },
        fireButtonTabClosureTitle: {
  ...
  var init_options16 = __esm({
    "shared/locales/nb/options.json"() {
      options_default16 = {
        ...
        fireButtonDesc: {
          title:
            "Fire Button gj\xF8r det enkelt \xE5 fjerne faner, nettleserhistorikk og data. Du kan kontrollere om den skal fjerne b\xE5de nettleserhistorikk og data, og hvorvidt den skal lukke \xE5pne faner.",
          note: "Describes the Fire button features. As per glossary, please do not translate Fire Button."
        },
        fireButtonClearHistoryTitle: {
        ...
        fireButtonClearHistoryDesc: {
          title:
            "Merk: Nettleserhistorikk kan bare fjernes for en angitt tidsperiode (f.eks. \xABden siste timen\xBB eller \xABall tid\xBB), og ikke per nettsted.",
          note: "Extra information about the clear history option toggle."
        },
        fireButtonTabClosureTitle: {
          title: "Lukk faner",
  ...
  var init_options17 = __esm({
    "shared/locales/nl/options.json"() {
      options_default17 = {
        ...
        globalPrivacyControlDesc: {
          title:
            "Je gegevens zouden niet mogen worden verhandeld. Bij DuckDuckGo zijn we het daarmee eens.Activeer de instellingen voor 'Global Privacy Control' (GPC). We zullen\n vervolgens aan websites je voorkeuren doorgeven om:",
          note: "This describes the GPC feature, which lets the user set a preference to not have their personal information sold by websites to other parties. The string is followed by a list of actions like 'Not sell your personal data'. These are translated separately."
        },
        notSellYourPersonalData: {
        ...
        fireButtonDesc: {
          title:
            "Met de Fire Button kun je eenvoudig tabbladen, browsegeschiedenis en gegevens wissen. Je kunt bepalen of zowel de browsegeschiedenis als de gegevens worden gewist en of je huidige tabbladen worden gesloten of niet.",
          note: "Describes the Fire button features. As per glossary, please do not translate Fire Button."
        },
        fireButtonClearHistoryTitle: {
        ...
        fireButtonClearHistoryDesc: {
          title:
            "Let op: de browsegeschiedenis kan alleen worden gewist voor een bepaald tijdsbereik (bijv. 'afgelopen uur' of 'altijd') en niet per website.",
          note: "Extra information about the clear history option toggle."
        },
        fireButtonTabClosureTitle: {
  ...
  var init_feedback18 = __esm({
    "shared/locales/pl/feedback.json"() {
      feedback_default18 = {
        ...
        thankYouBrokenSite: {
          title:
            "Zg\u0142oszenia niedzia\u0142aj\u0105cych stron pomagaj\u0105 zespo\u0142owi programistycznemu naprawi\u0107 te b\u0142\u0119dy.",
          note: "Additional note when submitting a broken site."
        }
      };
    }
  ...
  var init_options18 = __esm({
    "shared/locales/pl/options.json"() {
      options_default18 = {
        ...
        optionsDesc: {
          title:
            "DuckDuckGo chroni Twoj\u0105 prywatno\u015B\u0107 w sieci dzi\u0119ki prywatnemu wyszukiwaniu\n, blokowaniu skrypt\xF3w \u015Bledz\u0105cych\n\ni szyfrowaniu stron.",
          note: "This describes how we protect the user from being tracked online"
        },
        shareFeedback: {
        ...
        globalPrivacyControlDesc: {
          title:
            "Twoje dane nie s\u0105 na sprzeda\u017C. W DuckDuckGo w pe\u0142ni si\u0119 z tym zgadzamy. Aktywuj ustawienie \u201EGlobalna kontrola prywatno\u015Bci\u201D (GPC), a my przeka\u017Cemy witrynom Twoje preferencje:",
          note: "This describes the GPC feature, which lets the user set a preference to not have their personal information sold by websites to other parties. The string is followed by a list of actions like 'Not sell your personal data'. These are translated separately."
        },
        notSellYourPersonalData: {
        ...
        fireButtonDesc: {
          title:
            "Przycisk Fire Button u\u0142atwia czyszczenie kart, historii przegl\u0105dania i danych. Mo\u017Cesz wybra\u0107, czy przycisk czy\u015Bci histori\u0119 przegl\u0105dania i dane i czy zamyka bie\u017C\u0105ce karty.",
          note: "Describes the Fire button features. As per glossary, please do not translate Fire Button."
        },
        fireButtonClearHistoryTitle: {
        ...
        fireButtonClearHistoryDesc: {
          title:
            "Uwaga: histori\u0119 przegl\u0105dania mo\u017Cna wyczy\u015Bci\u0107 tylko dla okre\u015Blonego zakresu czasu (np. \u201Eostatnia godzina\u201D, lub \u201Eca\u0142y czas\u201D), a nie dla poszczeg\xF3lnych witryn.",
          note: "Extra information about the clear history option toggle."
        },
        fireButtonTabClosureTitle: {
          title: "Zamknij karty",
  ...
  var init_options19 = __esm({
    "shared/locales/pt/options.json"() {
      options_default19 = {
        ...
        optionsDesc: {
          title:
            "O DuckDuckGo protege a tua privacidade online com\npesquisa privada,\nbloqueio de trackers\ne encripta\xE7\xE3o de sites.",
          note: "This describes how we protect the user from being tracked online"
        },
        shareFeedback: {
        ...
        fireButtonDesc: {
          title:
            "O Fire Button facilita a limpeza de separadores, hist\xF3rico de navega\xE7\xE3o e dados. Pode decidir se limpa ou n\xE3o o hist\xF3rico de navega\xE7\xE3o e os dados, e se fecha ou n\xE3o os separadores atuais.",
          note: "Describes the Fire button features. As per glossary, please do not translate Fire Button."
        },
        fireButtonClearHistoryTitle: {
        ...
        fireButtonClearHistoryDesc: {
          title:
            'Nota: precisa de especificar um intervalo de tempo para limpar o hist\xF3rico de navega\xE7\xE3o (por exemplo, "\xFAltima hora" ou "sempre"), e n\xE3o \xE9 poss\xEDvel limpar s\xF3 para um site.',
          note: "Extra information about the clear history option toggle."
        },
        fireButtonTabClosureTitle: {
  ...
  var init_feedback20 = __esm({
    "shared/locales/ro/feedback.json"() {
      feedback_default20 = {
        ...
        describeBreakagePlaceholder: {
          title:
            "Ce con\u021Binut sau func\u021Bie a site-ului nu func\u021Bioneaz\u0103 adecvat? Furnizeaz\u0103 detalii c\xE2t mai specifice.",
          note: "Placeholder text on the broken site form."
        },
        thankYou: {
        ...
        thankYouBrokenSite: {
          title:
            "Rapoartele tale privind site-urile care nu func\u021Bioneaz\u0103 adecvat ajut\u0103 echipa noastr\u0103 de dezvoltare s\u0103 remedieze aceste probleme.",
          note: "Additional note when submitting a broken site."
        }
      };
    }
  ...
  var init_options20 = __esm({
    "shared/locales/ro/options.json"() {
      options_default20 = {
        ...
        fireButtonDesc: {
          title:
            "Fire Button faciliteaz\u0103 \u0219tergerea filelor, a istoricului de navigare \u0219i a datelor. Po\u021Bi controla dac\u0103 \u0219terge istoricul de navigare, precum \u0219i datele \u0219i dac\u0103 \xEEnchide sau nu filele curente.",
          note: "Describes the Fire button features. As per glossary, please do not translate Fire Button."
        },
        fireButtonClearHistoryTitle: {
        ...
        fireButtonClearHistoryDesc: {
          title:
            "Re\u021Bine: istoricul de navigare poate fi \u0219ters numai pentru un interval specificat (de ex., \u201Eultima or\u0103\u201D sau \u201Etotdeauna\u201D) \u0219i nu \xEEn func\u021Bie de site.",
          note: "Extra information about the clear history option toggle."
        },
        fireButtonTabClosureTitle: {
  ...
  var init_feedback21 = __esm({
    "shared/locales/ru/feedback.json"() {
      feedback_default21 = {
        ...
        brokenSitePlaceholder: {
          title:
            "\u0421\u043A\u043E\u043F\u0438\u0440\u0443\u0439\u0442\u0435 \u0438 \u0432\u0441\u0442\u0430\u0432\u044C\u0442\u0435 \u0430\u0434\u0440\u0435\u0441 \u0441\u0430\u0439\u0442\u0430",
          note: `Instructions to fill an input field with a URL. Here "your URL" doesn't mean that they own the website, just that they're reporting it.`
        },
        feedbackHeaderLabel: {
          title:
            "\u0427\u0442\u043E \u0432\u0430\u043C \u043D\u0440\u0430\u0432\u0438\u0442\u0441\u044F? \u0427\u0442\u043E \u043D\u0435 \u0440\u0430\u0431\u043E\u0442\u0430\u0435\u0442? \u041A\u0430\u043A \u043C\u043E\u0436\u043D\u043E \u0443\u043B\u0443\u0447\u0448\u0438\u0442\u044C \u0440\u0430\u0441\u0448\u0438\u0440\u0435\u043D\u0438\u0435?",
          note: "Label over a feedback text area where the user can tell us about their experience with our browser extension."
        },
        feedbackPlaceholder: {
          title:
            "\u041A \u043A\u0430\u043A\u0438\u043C \u0432\u043E\u0437\u043C\u043E\u0436\u043D\u043E\u0441\u0442\u044F\u043C \u0438\u043B\u0438 \u0444\u0443\u043D\u043A\u0446\u0438\u044F\u043C \u043E\u0442\u043D\u043E\u0441\u0438\u0442\u0441\u044F \u0432\u0430\u0448 \u043E\u0442\u0437\u044B\u0432? \u041F\u043E\u0441\u0442\u0430\u0440\u0430\u0439\u0442\u0435\u0441\u044C \u043E\u0442\u0432\u0435\u0442\u0438\u0442\u044C \u043A\u0430\u043A \u043C\u043E\u0436\u043D\u043E \u043A\u043E\u043D\u043A\u0440\u0435\u0442\u043D\u0435\u0435.",
          note: "Placeholder text on feedback form input."
        },
        submittingFeedbackHelps: {
          title:
            "\u0410\u043D\u043E\u043D\u0438\u043C\u043D\u044B\u0435 \u043E\u0442\u0437\u044B\u0432\u044B \u043F\u043E\u043C\u043E\u0433\u0430\u044E\u0442 \u043D\u0430\u043C \u0443\u043B\u0443\u0447\u0448\u0438\u0442\u044C DuckDuckGo Privacy Essentials.",
          note: "Description at top of feedback form."
        },
        reportBrokenSite: {
          title:
        ...
        describeBreakagePlaceholder: {
          title:
            "\u0421 \u043A\u0430\u043A\u0438\u043C\u0438 \u043A\u043E\u043D\u0442\u0435\u043D\u0442\u043E\u043C \u0438\u043B\u0438 \u0444\u0443\u043D\u043A\u0446\u0438\u043E\u043D\u0430\u043B\u043E\u043C \u0441\u0430\u0439\u0442\u0430 \u0432\u043E\u0437\u043D\u0438\u043A\u043B\u0438 \u043F\u0440\u043E\u0431\u043B\u0435\u043C\u044B? \u041F\u043E\u0441\u0442\u0430\u0440\u0430\u0439\u0442\u0435\u0441\u044C \u043E\u0442\u0432\u0435\u0442\u0438\u0442\u044C \u043A\u0430\u043A \u043C\u043E\u0436\u043D\u043E \u043A\u043E\u043D\u043A\u0440\u0435\u0442\u043D\u0435\u0435.",
          note: "Placeholder text on the broken site form."
        },
        thankYou: {
          title:
        ...
        thankYouBrokenSite: {
          title:
            "\u0412\u0430\u0448\u0438 \u0441\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u044F \u043E \u043D\u0435\u0440\u0430\u0431\u043E\u0442\u0430\u044E\u0449\u0438\u0445 \u0441\u0430\u0439\u0442\u0430\u0445 \u043F\u043E\u043C\u043E\u0433\u0430\u044E\u0442 \u043D\u0430\u0448\u0438\u043C \u0440\u0430\u0437\u0440\u0430\u0431\u043E\u0442\u0447\u0438\u043A\u0430\u043C \u0443\u0441\u0442\u0440\u0430\u043D\u044F\u0442\u044C \u043D\u0435\u043F\u043E\u043B\u0430\u0434\u043A\u0438.",
          note: "Additional note when submitting a broken site."
        }
      };
    }
  ...
  var init_options21 = __esm({
    "shared/locales/ru/options.json"() {
      options_default21 = {
        ...
        optionsSubHeader: {
          title:
            "\u041F\u043E\u0438\u0441\u043A \u0438 \u043F\u0440\u043E\u0441\u043C\u043E\u0442\u0440 \u0418\u043D\u0442\u0435\u0440\u043D\u0435\u0442\u0430 \u0431\u0435\u0437 \u043E\u0442\u0441\u043B\u0435\u0436\u0438\u0432\u0430\u043D\u0438\u044F.",
          note: "We allow the user to browse the web without being followed by trackers"
        },
        optionsDesc: {
          title:
            "\u0427\u0442\u043E\u0431\u044B \u0437\u0430\u0449\u0438\u0442\u0438\u0442\u044C \u0432\u0430\u0448\u0438 \u0434\u0430\u043D\u043D\u044B\u0435 \u0432 \u0418\u043D\u0442\u0435\u0440\u043D\u0435\u0442\u0435, DuckDuckGo \u043F\u0440\u0435\u0434\u043B\u0430\u0433\u0430\u0435\u0442 \u043A\u043E\u043D\u0444\u0438\u0434\u0435\u043D\u0446\u0438\u0430\u043B\u044C\u043D\u044B\u0439 \u043F\u043E\u0438\u0441\u043A, \u0431\u043B\u043E\u043A\u0438\u0440\u043E\u0432\u043A\u0443 \u0442\u0440\u0435\u043A\u0435\u0440\u043E\u0432 \u0438 \u0448\u0438\u0444\u0440\u043E\u0432\u0430\u043D\u0438\u0435 \u0441\u043E\u0435\u0434\u0438\u043D\u0435\u043D\u0438\u044F \u0441 \u0441\u0430\u0439\u0442\u0430\u043C\u0438.",
          note: "This describes how we protect the user from being tracked online"
        },
        shareFeedback: {
        ...
        autofillEnabled: {
          title:
            '\u0412\u043A\u043B\u044E\u0447\u0435\u043D\u043E \u0430\u0432\u0442\u043E\u0437\u0430\u043F\u043E\u043B\u043D\u0435\u043D\u0438\u0435 \u0434\u043B\u044F <strong class="js-userdata-container">{userName}</strong>',
          note: "When we do help populate email addresses for (your email address here)"
        },
        noUnprotectedSitesAdded: {
          title:
            "\u041D\u0435\u0437\u0430\u0449\u0438\u0449\u0451\u043D\u043D\u044B\u0435 \u0441\u0430\u0439\u0442\u044B \u043D\u0435 \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u044B",
          note: "Currently there are no websites on the list of websites where our privacy protections are disabled"
        },
        unprotectedSites: {
        ...
        fireButtonDesc: {
          title:
            "\u041A\u043D\u043E\u043F\u043A\u0430 Fire Button (\xAB\u0422\u0440\u0435\u0432\u043E\u0433\u0430\xBB) \u043F\u043E\u0437\u0432\u043E\u043B\u044F\u0435\u0442 \u043C\u043E\u043C\u0435\u043D\u0442\u0430\u043B\u044C\u043D\u043E \u0437\u0430\u043A\u0440\u044B\u0442\u044C \u0432\u043A\u043B\u0430\u0434\u043A\u0438 \u0438 \u043E\u0447\u0438\u0441\u0442\u0438\u0442\u044C \u0438\u0441\u0442\u043E\u0440\u0438\u044E \u043F\u0440\u043E\u0441\u043C\u043E\u0442\u0440\u043E\u0432 \u0438 \u0434\u0430\u043D\u043D\u044B\u0435 \u0431\u0440\u0430\u0443\u0437\u0435\u0440\u0430. \u041F\u0440\u0435\u0434\u0443\u0441\u043C\u043E\u0442\u0440\u0435\u043D\u0430 \u043D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0430 \u0434\u0435\u0439\u0441\u0442\u0432\u0438\u0439 \u043F\u0440\u0438 \u043D\u0430\u0436\u0430\u0442\u0438\u0438 \u043A\u043D\u043E\u043F\u043A\u0438: \u043E\u0447\u0438\u0441\u0442\u043A\u0430 \u0438\u0441\u0442\u043E\u0440\u0438\u0438 \u043F\u0440\u043E\u0441\u043C\u043E\u0442\u0440\u043E\u0432, \u0434\u0430\u043D\u043D\u044B\u0445 \u0438 \u0437\u0430\u043A\u0440\u044B\u0442\u0438\u0435 \u0442\u0435\u043A\u0443\u0449\u0438\u0445 \u0432\u043A\u043B\u0430\u0434\u043E\u043A.",
          note: "Describes the Fire button features. As per glossary, please do not translate Fire Button."
        },
        fireButtonClearHistoryTitle: {
        ...
        fireButtonClearHistoryDesc: {
          title:
            "\u041F\u0440\u0438\u043C\u0438\u0442\u0435 \u0432\u043E \u0432\u043D\u0438\u043C\u0430\u043D\u0438\u0435. \u0447\u0442\u043E \u0438\u0441\u0442\u043E\u0440\u0438\u044E \u043F\u0440\u043E\u0441\u043C\u043E\u0442\u0440\u043E\u0432 \u043C\u043E\u0436\u043D\u043E \u0443\u0434\u0430\u043B\u0438\u0442\u044C \u0442\u043E\u043B\u044C\u043A\u043E \u0437\u0430 \u043E\u043F\u0440\u0435\u0434\u0435\u043B\u0451\u043D\u043D\u044B\u0439 \u043F\u0435\u0440\u0438\u043E\u0434 (\u043D\u0430\u043F\u0440\u0438\u043C\u0435\u0440, \xAB\u0437\u0430 \u043F\u043E\u0441\u043B\u0435\u0434\u043D\u0438\u0439 \u0447\u0430\u0441\xBB \u0438\u043B\u0438 \xAB\u0437\u0430 \u0432\u0441\u0451 \u0432\u0440\u0435\u043C\u044F\xBB), \u0430 \u043D\u0435 \u0432 \u043E\u0442\u043D\u043E\u0448\u0435\u043D\u0438\u0438 \u043A\u043E\u043D\u043A\u0440\u0435\u0442\u043D\u043E\u0433\u043E \u0441\u0430\u0439\u0442\u0430.",
          note: "Extra information about the clear history option toggle."
        },
        fireButtonTabClosureTitle: {
  ...
  var init_feedback22 = __esm({
    "shared/locales/sk/feedback.json"() {
      feedback_default22 = {
        ...
        feedbackPlaceholder: {
          title:
            "Ktor\xFDch vlastnost\xED alebo funkci\xED sa t\xFDka va\u0161a sp\xE4tn\xE1 v\xE4zba? Bu\u010Fte \u010Do najkonkr\xE9tnej\u0161\xED.",
          note: "Placeholder text on feedback form input."
        },
        submittingFeedbackHelps: {
        ...
        describeBreakagePlaceholder: {
          title:
            "Ak\xFD obsah alebo ak\xE1 funk\u010Dnos\u0165 webovej lokality je nefunk\u010Dn\xE1? Bu\u010Fte \u010Do najkonkr\xE9tnej\u0161\xED.",
          note: "Placeholder text on the broken site form."
        },
        thankYou: {
        ...
        thankYouBrokenSite: {
          title:
            "Va\u0161e hl\xE1senia o nefunk\u010Dn\xFDch lokalit\xE1ch pom\xE1haj\xFA n\xE1\u0161mu v\xFDvojov\xE9mu t\xEDmu tieto chyby opravi\u0165.",
          note: "Additional note when submitting a broken site."
        }
      };
    }
  ...
  var init_options22 = __esm({
    "shared/locales/sk/options.json"() {
      options_default22 = {
        ...
        globalPrivacyControlDesc: {
          title:
            "Va\u0161e \xFAdaje nesm\xFA by\u0165 na predaj. V\xA0DuckDuckGo s\xA0t\xFDm s\xFAhlas\xEDme. Aktivujte nastavenia \u201EGlob\xE1lne ovl\xE1danie ochrany s\xFAkromia\u201D (GPC) a my budeme\nsignalizova\u0165 webov\xFDm lokalit\xE1m va\u0161e preferencie, aby:",
          note: "This describes the GPC feature, which lets the user set a preference to not have their personal information sold by websites to other parties. The string is followed by a list of actions like 'Not sell your personal data'. These are translated separately."
        },
        notSellYourPersonalData: {
        ...
        fireButtonDesc: {
          title:
            "Tla\u010Didlo Fire Button u\u013Eah\u010Duje vymazanie kariet, hist\xF3rie prehliadania a\xA0\xFAdajov. M\xF4\u017Eete ovl\xE1da\u0165, \u010Di vyma\u017Ee hist\xF3riu prehliadania aj \xFAdaje a\xA0\u010Di sa zatvoria aktu\xE1lne karty.",
          note: "Describes the Fire button features. As per glossary, please do not translate Fire Button."
        },
        fireButtonClearHistoryTitle: {
        ...
        fireButtonClearHistoryDesc: {
          title:
            "Upozornenie: hist\xF3riu prehliadania mo\u017Eno vymaza\u0165 len pre konkr\xE9tne obdobie (napr. za posledn\xFA hodinu alebo za cel\xE9 obdobie), nie pre jednotliv\xE9 weby.",
          note: "Extra information about the clear history option toggle."
        },
        fireButtonTabClosureTitle: {
  ...
  var init_feedback23 = __esm({
    "shared/locales/sl/feedback.json"() {
      feedback_default23 = {
        ...
        feedbackPlaceholder: {
          title:
            "Na katere funkcije ali funkcionalnosti se nana\u0161ajo va\u0161e povratne informacije? Bodite \u010Dim bolj natan\u010Dni.",
          note: "Placeholder text on feedback form input."
        },
        submittingFeedbackHelps: {
  ...
  var init_options23 = __esm({
    "shared/locales/sl/options.json"() {
      options_default23 = {
        ...
        fireButtonDesc: {
          title:
            "Z gumbom Fire Button lahko preprosto zaprete zavihke, po\u010Distite zgodovino brskanja in podatke. Dolo\u010Dite lahko, ali \u017Eelite po\u010Distiti zgodovino brskanja in podatke ter ali naj se zaprejo trenutni zavihki.",
          note: "Describes the Fire button features. As per glossary, please do not translate Fire Button."
        },
        fireButtonClearHistoryTitle: {
        ...
        fireButtonClearHistoryDesc: {
          title:
            "Upo\u0161tevajte: Zgodovino brskanja lahko po\u010Distite le za dolo\u010Deno \u010Dasovno obdobje (npr.  \xBBzadnjo uro\xAB ali \xBBod za\u010Detka\xAB), in ne na podlagi posameznega spletnega mesta.",
          note: "Extra information about the clear history option toggle."
        },
        fireButtonTabClosureTitle: {
          title: "Zapri zavihke",
  ...
  var init_options24 = __esm({
    "shared/locales/sv/options.json"() {
      options_default24 = {
        ...
        fireButtonDesc: {
          title:
            "Med Fire Button \xE4r det enkelt att rensa dina flikar, din surfhistorik och dina data. Du kan sj\xE4lv best\xE4mma om s\xE5v\xE4l surfhistorik som data ska rensas, och om dina nuvarande flikar ska st\xE4ngs.",
          note: "Describes the Fire button features. As per glossary, please do not translate Fire Button."
        },
        fireButtonClearHistoryTitle: {
        ...
        fireButtonClearHistoryDesc: {
          title:
            "Obs! Surfhistorik kan endast rensas f\xF6r en specifik tidsperiod (t.ex. \u201Dsenaste timmen\u201D eller \u201Df\xF6r all tid\u201D) och inte per webbplats.",
          note: "Extra information about the clear history option toggle."
        },
        fireButtonTabClosureTitle: {
  ...
  var init_feedback25 = __esm({
    "shared/locales/tr/feedback.json"() {
      feedback_default25 = {
        ...
        feedbackPlaceholder: {
          title:
            "Geri bildiriminiz hangi \xF6zellikler veya i\u015Flevlerle ilgili? L\xFCtfen m\xFCmk\xFCn oldu\u011Funca spesifik bir \u015Fekilde belirtin.",
          note: "Placeholder text on feedback form input."
        },
        submittingFeedbackHelps: {
        ...
        describeBreakagePlaceholder: {
          title:
            "Hangi web sitesi i\xE7eri\u011Fi veya i\u015Flevi bozuk? L\xFCtfen m\xFCmk\xFCn oldu\u011Funca spesifik bir \u015Fekilde belirtin.",
          note: "Placeholder text on the broken site form."
        },
        thankYou: {
        ...
        thankYouBrokenSite: {
          title:
            "Bozuk sitelerle ilgili bildirimleriniz, geli\u015Ftirme ekibimizin bu ar\u0131zalar\u0131 gidermesine yard\u0131mc\u0131 olur.",
          note: "Additional note when submitting a broken site."
        }
      };
    }
...
web sitelerine tercihinizi iletiriz:`,
        ...
        fireButtonDesc: {
          title:
            "Fire Button, sekmelerinizi, tarama ge\xE7mi\u015Finizi ve verilerinizi temizlemenizi kolayla\u015Ft\u0131r\u0131r. Tarama ge\xE7mi\u015Finin yan\u0131 s\u0131ra verileri de temizleyip temizlemeyece\u011Fini ve mevcut sekmelerinizi kapat\u0131p kapatmayaca\u011F\u0131n\u0131 kontrol edebilirsiniz.",
          note: "Describes the Fire button features. As per glossary, please do not translate Fire Button."
        },
        fireButtonClearHistoryTitle: {
        ...
        fireButtonClearHistoryDesc: {
          title:
            'L\xFCtfen unutmay\u0131n: Tarama ge\xE7mi\u015Fi yaln\u0131zca belirli bir zaman aral\u0131\u011F\u0131 i\xE7in temizlenebilir (\xF6r. "son 1 saat", veya "her zaman") ve site baz\u0131nda temizlenemez.',
          note: "Extra information about the clear history option toggle."
        },
        fireButtonTabClosureTitle: {
