...
(() => {
  ...
  var require__ = __commonJS({
    "node_modules/@formatjs/intl-locale/node_modules/@formatjs/ecma402-abstract/262.js"(exports) {
      ...
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.msFromTime =
        exports.OrdinaryHasInstance =
        exports.SecFromTime =
        exports.MinFromTime =
        exports.HourFromTime =
        exports.DateFromTime =
        exports.MonthFromTime =
        exports.InLeapYear =
        exports.DayWithinYear =
        exports.DaysInYear =
        exports.YearFromTime =
        exports.TimeFromYear =
        exports.DayFromYear =
        exports.WeekDay =
        exports.Day =
        exports.Type =
    ...
    "node_modules/@formatjs/intl-locale/node_modules/@formatjs/ecma402-abstract/IsWellFormedUnitIdentifier.js"(exports) {
      ...
      function IsWellFormedUnitIdentifier(unit) {
        ...
        var numerator = units[0],
          denominator = units[1];
        if (
          !(0, IsSanctionedSimpleUnitIdentifier_1.IsSanctionedSimpleUnitIdentifier)(numerator) ||
  ...
  var require_utils = __commonJS({
    "node_modules/@formatjs/intl-locale/node_modules/@formatjs/ecma402-abstract/utils.js"(exports) {
      ...
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.invariant =
        exports.UNICODE_EXTENSION_SEQUENCE_REGEX =
        exports.defineProperty =
        exports.isLiteralPart =
        exports.getMultiInternalSlots =
        exports.getInternalSlot =
        exports.setMultiInternalSlots =
        exports.setInternalSlot =
        exports.repeat =
        exports.getMagnitude =
          void 0;
        ...
        switch (notation) {
          ...
          default: {
            ...
            if (style === "currency" && currencyDisplay !== "name") {
              var currency =
                dataLocaleData.numbers.currency[numberingSystem] || dataLocaleData.numbers.currency[dataLocaleData.numbers.nu[0]];
        ...
        switch (style) {
          ...
          case "unit": {
            ...
            if (unitData) {
              ...
              var numeratorUnitPattern = selectPlural(
                pl,
                numberResult.roundedNumber * Math.pow(10, exponent),
      ...
      function ResolveLocale(availableLocales, requestedLocales, options, relevantExtensionKeys, localeData, getDefaultLocale) {
        ...
        for (var _i = 0, relevantExtensionKeys_1 = relevantExtensionKeys; _i < relevantExtensionKeys_1.length; _i++) {
          ...
          (0, utils_1.invariant)(
            ...
            "locale data ".concat(key, " must be an object")
          );
          ...
          (0, utils_1.invariant)(
            ...
            "value must be string or null but got ".concat(typeof value, " in key ").concat(key)
          );
          ...
          if (key in options) {
            ...
            (0, utils_1.invariant)(
              typeof optionsValue === "string" || typeof optionsValue === "undefined" || optionsValue === null,
  ...
  var require_intl_localematcher = __commonJS({
    "node_modules/@formatjs/intl-locale/node_modules/@formatjs/intl-localematcher/index.js"(exports) {
      ...
      function match(requestedLocales, availableLocales, defaultLocale, opts) {
        ...
        return (0, ResolveLocale_1.ResolveLocale)(
          locales,
          (0, CanonicalizeLocaleList_1.CanonicalizeLocaleList)(requestedLocales),
          {
  ...
  var require_SetNumberFormatUnitOptions = __commonJS({
    "node_modules/@formatjs/intl-locale/node_modules/@formatjs/ecma402-abstract/NumberFormat/SetNumberFormatUnitOptions.js"(exports) {
      ...
      function SetNumberFormatUnitOptions(nf, options, _a) {
        ...
        var currencyDisplay = (0, GetOption_1.GetOption)(
          options,
          "currencyDisplay",
          "string",
  ...
  var require_SetNumberFormatDigitOptions = __commonJS({
    "node_modules/@formatjs/intl-locale/node_modules/@formatjs/ecma402-abstract/NumberFormat/SetNumberFormatDigitOptions.js"(exports) {
      ...
      function SetNumberFormatDigitOptions(internalSlots, opts, mnfdDefault, mxfdDefault, notation) {
        ...
        var roundingPriority = (0, GetOption_1.GetOption)(
          opts,
          "roundingPriority",
          "string",
  ...
  var require_InitializeNumberFormat = __commonJS({
    "node_modules/@formatjs/intl-locale/node_modules/@formatjs/ecma402-abstract/NumberFormat/InitializeNumberFormat.js"(exports) {
      ...
      var VALID_ROUND_INCREMENT_VALUES = [1, 2, 5, 10, 20, 25, 50, 100, 200, 250, 500, 1e3, 2e3];
      function InitializeNumberFormat(nf, locales, opts, _a) {
        ...
        var notation = (0, GetOption_1.GetOption)(
          options,
          "notation",
          "string",
        ...
        if (VALID_ROUND_INCREMENT_VALUES.indexOf(roundingIncrement) === -1) {
          throw new RangeError(
            "Invalid rounding increment value: ".concat(roundingIncrement, ".\nValid values are ").concat(VALID_ROUND_INCREMENT_VALUES, ".")
          );
        }
        ...
        internalSlots.signDisplay = (0, GetOption_1.GetOption)(
          options,
          "signDisplay",
          "string",
        ...
        internalSlots.roundingMode = (0, GetOption_1.GetOption)(
          options,
          "roundingMode",
          "string",
  ...
  var require_parser = __commonJS({
    "node_modules/@formatjs/intl-getcanonicallocales/src/parser.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.parseUnicodeLocaleId =
        exports.parseUnicodeLanguageId =
        exports.isUnicodeVariantSubtag =
        exports.isUnicodeScriptSubtag =
        exports.isUnicodeRegionSubtag =
        exports.isStructurallyValidLanguageTag =
        exports.isUnicodeLanguageSubtag =
        exports.SEPARATOR =
          void 0;
      var tslib_1 = (init_tslib_es6(), __toCommonJS(tslib_es6_exports));
  ...
  var require_emitter = __commonJS({
    "node_modules/@formatjs/intl-getcanonicallocales/src/emitter.js"(exports) {
      ...
      function emitUnicodeLanguageId(lang) {
        ...
        return tslib_1
          .__spreadArray([lang.lang, lang.script, lang.region], lang.variants || [], true)
          .filter(Boolean)
          .join("-");
      }
            ...
            case "u":
              chunks.push.apply(
                ...
                tslib_1.__spreadArray(
                  tslib_1.__spreadArray([], ext.attributes, false),
                  ext.keywords.reduce(function (all, kv) {
            ...
            case "t":
              chunks.push.apply(
                ...
                tslib_1.__spreadArray(
                  ...
                  ext.fields.reduce(function (all, kv) {
                    return all.concat(kv);
                  }, []),
                  false
                )
      ...
      function canonicalizeUnicodeLanguageId(unicodeLanguageId) {
        ...
        if (unicodeLanguageId.variants.length) {
          ...
          for (var _i = 0, _a = unicodeLanguageId.variants; _i < _a.length; _i++) {
            ...
            if (
              (replacedLang_1 =
                aliases_generated_1.languageAlias[
                  (0, emitter_1.emitUnicodeLanguageId)({
        ...
        if (finalLangAst.region) {
          ...
          if (regionAlias) {
            ...
            var likelySubtag =
              likelySubtags_generated_1.likelySubtags[
                (0, emitter_1.emitUnicodeLanguageId)({
                  lang: finalLangAst.lang,
                  script: finalLangAst.script,
                  variants: []
    ...
    "node_modules/@formatjs/intl-getcanonicallocales/index.js"(exports) {
      ...
      function CanonicalizeLocaleList(locales) {
        ...
        for (var _i = 0, locales_1 = locales; _i < locales_1.length; _i++) {
          ...
          var canonicalizedTag = (0, emitter_1.emitUnicodeLocaleId)(
            (0, canonicalizer_1.canonicalizeUnicodeLocaleId)((0, parser_1.parseUnicodeLocaleId)(locale))
          );
  ...
  var require_intl_locale = __commonJS({
    "node_modules/@formatjs/intl-locale/index.js"(exports) {
      ...
      function applyOptionsToTag(tag, options) {
        ...
        (0, ecma402_abstract_1.invariant)(
          (0, intl_getcanonicallocales_1.isStructurallyValidLanguageTag)(tag),
        ...
        if (language !== void 0) {
          (0, ecma402_abstract_1.invariant)(
            (0, intl_getcanonicallocales_1.isUnicodeLanguageSubtag)(language),
        ...
        if (script !== void 0) {
          (0, ecma402_abstract_1.invariant)(
            (0, intl_getcanonicallocales_1.isUnicodeScriptSubtag)(script),
        ...
        if (region !== void 0) {
          (0, ecma402_abstract_1.invariant)(
            (0, intl_getcanonicallocales_1.isUnicodeRegionSubtag)(region),
        ...
        return Intl.getCanonicalLocales(
          (0, intl_getcanonicallocales_1.emitUnicodeLocaleId)(
            tslib_1.__assign(tslib_1.__assign({}, (0, intl_getcanonicallocales_1.parseUnicodeLocaleId)(tag)), { lang: languageId })
          )
        )[0];
      }
      ...
      function addLikelySubtags(tag) {
        ...
        if (script && region) {
          var match_1 =
            intl_getcanonicallocales_1.likelySubtags[
              (0, intl_getcanonicallocales_1.emitUnicodeLanguageId)({ lang, script, region, variants: [] })
            ];
          if (match_1) {
        ...
        if (script) {
          var match_2 =
            intl_getcanonicallocales_1.likelySubtags[(0, intl_getcanonicallocales_1.emitUnicodeLanguageId)({ lang, script, variants: [] })];
          if (match_2) {
        ...
        if (region) {
          var match_3 =
            intl_getcanonicallocales_1.likelySubtags[(0, intl_getcanonicallocales_1.emitUnicodeLanguageId)({ lang, region, variants: [] })];
          if (match_3) {
        ...
        var match =
          intl_getcanonicallocales_1.likelySubtags[lang] ||
          intl_getcanonicallocales_1.likelySubtags[
            (0, intl_getcanonicallocales_1.emitUnicodeLanguageId)({ lang: "und", script, variants: [] })
          ];
        if (!match) {
      ...
      function removeLikelySubtags(tag) {
        ...
        maxLocale = (0, intl_getcanonicallocales_1.emitUnicodeLanguageId)(
          tslib_1.__assign(tslib_1.__assign({}, (0, intl_getcanonicallocales_1.parseUnicodeLanguageId)(maxLocale)), { variants: [] })
        );
        var ast = (0, intl_getcanonicallocales_1.parseUnicodeLocaleId)(tag);
        var _a = ast.lang,
          lang = _a.lang,
        ...
        if (trial === maxLocale) {
          return (0, intl_getcanonicallocales_1.emitUnicodeLocaleId)(
            tslib_1.__assign(tslib_1.__assign({}, ast), { lang: mergeUnicodeLanguageId(lang, void 0, void 0, variants) })
          );
        }
        if (region) {
          ...
          if (trial_1 === maxLocale) {
            return (0, intl_getcanonicallocales_1.emitUnicodeLocaleId)(
              tslib_1.__assign(tslib_1.__assign({}, ast), { lang: mergeUnicodeLanguageId(lang, void 0, region, variants) })
            );
          }
        }
        if (script) {
          ...
          if (trial_2 === maxLocale) {
            return (0, intl_getcanonicallocales_1.emitUnicodeLocaleId)(
              tslib_1.__assign(tslib_1.__assign({}, ast), { lang: mergeUnicodeLanguageId(lang, script, void 0, variants) })
            );
          }
        }
        return tag;
