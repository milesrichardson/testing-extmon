...
var ExtendedCss = (function () {
  ...
  utils.logError =
    typeof console !== "undefined" && console.error && Function.prototype.bind && console.error.bind
      ? console.error.bind(window.console)
      : console.error;
  /** Safe console.info version */

  utils.logInfo =
    typeof console !== "undefined" && console.info && Function.prototype.bind && console.info.bind
    ...
    ExtendedSelectorParser.prototype = {
      ...
      isLastToken: function isLastToken(tokens, i) {
        ...
        var isNextRemoveToken =
          tokens[i + 1] && tokens[i + 1].type === "PSEUDO" && tokens[i + 1].matches && tokens[i + 1].matches[0] === "remove"; // check if the token is last
  ...
  function ExtendedCss(configuration) {
    ...
    if (beforeStyleApplied && typeof beforeStyleApplied !== "function") {
      ...
      throw new Error(
        "Wrong configuration. Type of 'beforeStyleApplied' field should be a function, received: ".concat(_typeof(beforeStyleApplied))
      );
...
function injectPageScriptAPI(scriptName, shouldOverrideWebRTC, isInjected) {
  ...
  const overrideWebRTC = function () {
    ...
    function protectConfiguration(configuration) {
      ...
      const iceServers = safeCopyArray(configuration.iceServers, function (iceServer) {
