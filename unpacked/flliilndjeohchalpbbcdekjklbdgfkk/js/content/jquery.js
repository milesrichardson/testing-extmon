        ...
        !(function (e, n) {
                            ...
                            if (v) {
                              ...
                              if (((h = [a ? v.firstChild : v.lastChild]), a && m)) {
                                for (
                                  x =
                                    (d =
                                      (l = (c = (f = (p = v)[b] || (p[b] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] || [])[0] === T &&
                                      l[1]) && l[2],
                                    p = d && v.childNodes[d];
          ...
          w.extend({
            ...
            clone: function (e, t, n) {
              ...
              if (t)
                if (n) for (o = o || ye(e), a = a || ye(s), r = 0, i = o.length; r < i; r++) He(o[r], a[r]);
                else He(e, s);
                ...
                if ((u = !w.isEmptyObject(t)) || !w.isEmptyObject(d))
                  for (r in (f &&
                    ...
                    "none" === (c = w.css(e, "display")) &&
                      (l ? (c = l) : (ce([e], !0), (l = e.style.display || l), (c = w.css(e, "display")), ce([e]))),
          ...
          (Mt.href = bt.href),
            w.extend({
              ...
              ajax: function (t, n) {
                ...
                if ((d.data && d.processData && "string" != typeof d.data && (d.data = w.param(d.data, d.traditional)), Wt(Ot, d, n, E), l))
                  return E;
          ...
          w.ajaxSetup({
            ...
            (d.createHTMLDocument =
              (((_t = v.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>"), 2 === _t.childNodes.length)),
