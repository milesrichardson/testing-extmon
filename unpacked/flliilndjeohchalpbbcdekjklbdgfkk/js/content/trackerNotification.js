...
})(
  {
    ...
    4: [
      function (e, t, n) {
        ...
        const i = e("jquery"),
          a = e("mustache"),
          r = e("TrackerNotification.mustache"),
          o = e("browser_accessors/extensionAccessor"),
          s = e("content/i18n_loader"),
          _ = e("content/messagingInterface"),
          l = e("content/mixpanel"),
          c = new URL(window.location.href),
          u = parseInt(c.searchParams.get("threshold"), 10);
        function d(e) {
          e.preventDefault();
          const { target: t } = this.dataset,
            n = encodeURIComponent(this.dataset.url),
            i = encodeURIComponent(this.dataset.text);
          let a,
            r = 585;
          return (
            "twitter" === t
              ? ((r = 261), (a = `https://twitter.com/share?url=${n}&text=${i}`))
              : "facebook" === t && (a = `https://www.facebook.com/sharer/sharer.php?u=${n}&description=${i}`),
            l.track("Notification - Share", { "notification type": "Tracker Amount", "tracker amount": u, platform: t }),
            window.open(a, "", `menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=${r},width=368`),
            !1
          );
        }
        s.getLocaleStrings((e) => {
          const t = a.render(r, { threshold: Number(u).toLocaleString(), extName: o.getManifest().name }, e),
            n = i("#trackerNotification").html(t);
          l.track("Notification - Shown", { "notification type": "Tracker Amount", "tracker amount": u }),
            n.find(".sharer-link").click(d),
            n.find(".menu__close").click(() => {
              l.track("Notification - Close", { "notification type": "Tracker Amount", "tracker amount": u }, () =>
                _.publish("closeTrackerNotification", {})
              );
            });
        }),
          _.publish("Settings:get", "dark_mode", (e) => {
            e.dark_mode && i("#trackerNotification").addClass("theme-dark");
          });
      },
      {
        "TrackerNotification.mustache": 68,
        "browser_accessors/extensionAccessor": 2,
        "content/i18n_loader": 84,
        "content/messagingInterface": 85,
        "content/mixpanel": 86,
        jquery: "jquery",
        mustache: "mustache"
      }
        ...
        (function (e) {
          (function () {
            !(function (e, i) {
              ...
              var O = E,
                M = A("Object"),
                L = u && M(new DataView(new ArrayBuffer(8))),
                D = "undefined" != typeof Map && M(new Map()),
                N = A("DataView");
              var U = L
                  ? function (e) {
                      return null != e && O(e.getInt8) && C(e.buffer);
                    }
                  : N,
                W = d || A("Array");
              function R(e, t) {
              ...
              var J = c
                  ? function (e) {
                      return g ? g(e) && !U(e) : Y(e) && $.test(_.call(e));
                    }
                  : V(!1),
                X = Z("length");
              function ee(e, t) {
              ...
              function Le(e, t, n) {
                return null == e ? Ee : O(e) ? Me(e, t, n) : y(e) && !W(e) ? Ie(e) : Oe(e);
              }
              function De(e, t) {
                return Le(e, t, 1 / 0);
              }
              function Ne(e, t, n) {
                return ie.iteratee !== De ? ie.iteratee(e, t) : Le(e, t, n);
              }
              function Ue() {}
              function We(e, t) {
                return null == t && ((t = e), (e = 0)), e + Math.floor(Math.random() * (t - e + 1));
              }
              (ie.toPath = Pe), (ie.iteratee = De);
              var Re =
                Date.now ||
                function () {
              ...
              function kt(e, t, n) {
                var i, a;
                if (((t = Me(t, n)), it(e))) for (i = 0, a = e.length; i < a; i++) t(e[i], i, e);
                else {
                  var r = te(e);
              ...
              var It = Et(function (e, t, n) {
                  R(e, n) ? e[n].push(t) : (e[n] = [t]);
                }),
                Ot = Et(function (e, t, n) {
                  e[n] = t;
                }),
              ...
              var Ut = w(function (e, t) {
                  var n = {},
                    i = t[0];
                  if (null == e) return n;
                  O(i) ? (t.length > 1 && (i = Me(i, t[1])), (t = _e(e))) : ((i = Nt), (t = at(t, !1, !1)), (e = Object(e)));
                ...
                return (
                  kt(ye(e), function (t) {
                    ...
                    ie.prototype[t] = function () {
                      var e = [this._wrapped];
                      return o.apply(e, arguments), $t(this, n.apply(ie, e));
                    };
                  }),
                  ie
                );
              ...
              kt(["pop", "push", "reverse", "shift", "sort", "splice", "unshift"], function (e) {
                ...
                ie.prototype[e] = function () {
                  var n = this._wrapped;
                  return (
                    null != n && (t.apply(n, arguments), ("shift" !== e && "splice" !== e) || 0 !== n.length || delete n[0]), $t(this, n)
                  );
                };
              }),
                kt(["concat", "join", "slice"], function (e) {
                  ...
                  ie.prototype[e] = function () {
                    var e = this._wrapped;
                    return null != e && (e = t.apply(e, arguments)), $t(this, e);
                  };
                });
              var Xt = {
                  __proto__: null,
                  ...
                  partition: Lt,
                  toArray: function (e) {
                    return e ? (W(e) ? s.call(e) : S(e) ? e.match(Dt) : it(e) ? wt(e, Ee) : ke(e)) : [];
                  },
                  size: function (e) {
    ...
    83: [
      ...
      { "background/localStorage": 1, configuration: 3, underscore: 67 }
    ],
    84: [
      function (e, t, n) {
        "use strict";
      ...
      { Locale: 81, Locales: 82, config: 83, "content/messagingInterface": 85, underscore: 67 }
    ],
    85: [
      function (e, t, n) {
        "use strict";
