...
!(function e(t, n, i) {
...
})(
  {
    ...
    2: [
      ...
      { "core-js/modules/es6.array.iterator.js": 68, "core-js/modules/web.dom.iterable.js": 70 }
    ],
    3: [
      function (e, t, n) {
        "use strict";
        Object.defineProperty(n, "__esModule", { value: !0 }),
          (n.getBrowserName =
            ...
            n.isOpera =
              void 0);
        const i = (!!window.opr && !!opr.addons) || !!window.opera || navigator.userAgent.indexOf(" OPR/") >= 0;
        n.isOpera = i;
        const r = "undefined" != typeof InstallTrigger;
        n.isFirefox = r;
        const s =
        ...
        n.isIE = o;
        const a = !o && !!window.StyleMedia;
        n.isEdge = a;
        const l = !(!window.chrome || (!window.chrome.webstore && !window.chrome.runtime));
        n.isChrome = l;
        const c = l && -1 !== navigator.userAgent.indexOf("Edg");
        n.isEdgeChromium = c;
        const u = (l || i) && !!window.CSS;
        n.isBlink = u;
        n.getBrowserName = () =>
          i
            ? "Opera"
    ...
    4: [
      function (e, t, n) {
        "use strict";
        const i = { getManifest: () => chrome.runtime.getManifest(), getURL: (e) => chrome.runtime.getURL(e) };
        t.exports = i;
      },
      {}
    ],
    ...
    7: [
      function (e, t, n) {
        ...
        const i = e("backbone"),
          ...
          s = e("content/Models/URLClassification").getInstance(),
          o = e("content/i18n_loader"),
          a = e("popup/getRouter"),
          l = e("popup/Views/Popup"),
          c = e("popup/Views/Menu"),
          u = e("content/Models/I18n"),
          d = e("popup/init"),
          _ = e("config");
        setTimeout(() => {
          o.getLocaleStrings((e, t) => {
            u.getInstance().set({ strings: e, language: t }),
              d().then(([e]) => {
                r.publish("Popup:open", { tabId: e.id, url: e.url }),
                  r.publish("Tabs:getData", { classifier: "AUCClassifier", tabId: e.id, url: e.url }, (e) => {
                    s.set(e), a(), new l(), new c(), i.history.start();
                  }),
                  r.publish("offersSupported", null, (e) => {
                    _.supportedSettings.offers = e;
                  });
              });
          });
        }, 0);
      },
      {
        backbone: 20,
        config: 131,
        "content/Models/I18n": 132,
        "content/Models/URLClassification": 137,
        "content/i18n_loader": 154,
        "content/messagingInterface": 155,
        "core-js/modules/es6.array.iterator.js": 68,
        "core-js/modules/web.dom.iterable.js": 70,
        "popup/Views/Menu": 182,
        "popup/Views/Popup": 184,
        "popup/getRouter": 192,
        "popup/init": 193
      }
    ],
    ...
    15: [
      ...
      { "./assertThisInitialized.js": 8, "@babel/runtime/helpers/typeof": 17 }
    ],
    16: [
      function (e, t, n) {
        function i(e, n) {
          ...
          (function () {
            !(function (i) {
              ...
              a.trigger = function (e) {
                ...
                return c(h, this._events, e, void 0, n), this;
              };
              var h = function (e, t, n, i) {
                  if (e) {
                    var r = e[t],
                      s = e.all;
                    r && s && (s = s.slice()), r && f(r, i), s && f(s, [t].concat(i));
                  }
                  return e;
                },
                f = function (e, t) {
                  ...
                  if (null != e) {
                    ...
                    for (o = 0; o < e.length; o++) {
                      ...
                      if (m) {
                        if (p && s !== m) {
                          ...
                          t.parse && (w = m.parse(w, t)), m.set(w, t), c.push(m), b && !f && (f = m.hasChanged(g));
                        }
                    ...
                    if (
                      (a.length && x
                        ...
                        : l.length && (b && (f = !0), y(this.models, l, null == r ? this.length : r), (this.length = this.models.length)),
                      f && this.sort({ silent: !0 }),
                      !t.silent)
                    ) {
                      for (o = 0; o < l.length; o++) null != r && (t.index = r + o), (s = l[o]).trigger("add", s, this, t);
                      (f || k) && this.trigger("sort", this, t),
          ...
          return (
            (function (t) {
                ...
                if (e) {
                  for (
                    o = (e = e.split("/")).length - 1,
                      u.nodeIdCompat && h.test(e[o]) && (e[o] = e[o].replace(h, "")),
                ...
                if ((f || g) && b) {
                  for (d = (n = e.split("/")).length; 0 < d; d -= 1) {
                    if (((i = n.slice(0, d).join("/")), f))
                      for (_ = f.length; 0 < _; _ -= 1)
                        if ((r = b[f.slice(0, _).join("/")]) && (r = r[i])) {
                          (s = r), (a = d);
                          break;
                        }
                    if (s) break;
              ...
              function v(e) {
                ...
                if (!f(l, e) && !f(d, e)) throw new Error("No " + e);
                return l[e];
              }
              function w(e) {
                var t,
              ...
              (o = function (e, t) {
                ...
                (r = function (e, n, i, r) {
                  ...
                  if (((b = y((r = r || e))), "undefined" == x || "function" == x)) {
                    for (n = !n.length && i.length ? ["require", "exports", "module"] : n, h = 0; h < n.length; h += 1)
                      if ("require" === (u = (p = o(n[h], b)).f)) k[h] = a.require(e);
                      else if ("exports" === u) (k[h] = a.exports(e)), (w = !0);
                      else if ("module" === u) s = k[h] = a.module(e);
                      else if (f(l, u) || f(c, u) || f(d, u)) k[h] = v(u);
                      else {
                        if (!p.p) throw new Error(e + " missing " + u);
                        p.p.load(p.n, g(r, !0), m(u), {}), (k[h] = l[u]);
                      }
                ...
                ((i = function (e, t, n) {
                  ...
                  t.splice || ((n = t), (t = [])), f(l, e) || f(c, e) || (c[e] = [e, t, n]);
                }).amd = { jQuery: !0 });
            })(),
            i("almond", function () {}),
            i("constants", {
                ...
                (n.prototype = new t()),
                {
                  ...
                  parse: function (t) {
                    var n,
                      ...
                      _ = /^[\n\r\u2028\u2029]/,
                      p = { type: "class", value: "[\\n\\r\\u2028\\u2029]", description: "[\\n\\r\\u2028\\u2029]" },
                      h = { type: "other", description: "end of line" },
                      f = "\n",
                      ...
                      B = { type: "other", description: "Statement" },
                      ...
                      D = function (e, t, n, i) {
                        return {
                          ...
                          interpret: function (e) {
                            ...
                            if (
                              ("=" != this.operator && (n = Yi(this.variable.interpret(e), this.operator.substring(0, 1), n)),
                              null !== this.accessor)
                            ) {
                              var i = t.interpret(e);
                      ...
                      U = { type: "other", description: "Assignment Operator" },
                      H = "=",
                      ...
                      Pt = "0",
                      Mt = { type: "literal", value: "0", description: '"0"' },
                      Lt = function (e, t) {
                        return e + t;
                      },
                      Ot = function (e) {
                      ...
                      Dt = /^[1-9]/,
                      Ut = { type: "class", value: "[1-9]", description: "[1-9]" },
                      Ht = function (e, t) {
                        return e + t;
                      },
                      Vt = /^[eE]/,
                      ...
                      Wt = /^[\-+]/,
                      $t = { type: "class", value: "[-+]", description: "[-+]" },
                      Yt = function (e, t) {
                        return e + t;
                      },
                      Xt = /^[xX]/,
                      ...
                      hn = /^['"\\bfnrtv]/,
                      fn = { type: "class", value: "['\"\\\\bfnrtv]", description: "['\"\\\\bfnrtv]" },
                      bn = function (e) {
                        return e
                          .replace("b", "\b")
                          .replace("f", "\f")
                      ...
                      En = "else",
                      zn = { type: "literal", value: "else", description: '"else"' },
                      In = "false",
                      jn = { type: "literal", value: "false", description: '"false"' },
                      Rn = "for",
                      qn = { type: "literal", value: "for", description: '"for"' },
                      Pn = "in",
                      Mn = { type: "literal", value: "in", description: '"in"' },
                      Ln = "if",
                      On = { type: "literal", value: "if", description: '"if"' },
                      Bn = "null",
                      Nn = { type: "literal", value: "null", description: '"null"' },
                      Dn = "return",
                      Un = { type: "literal", value: "return", description: '"return"' },
                      Hn = "true",
                      Vn = { type: "literal", value: "true", description: '"true"' },
                      Fn = "require",
                      Wn = { type: "literal", value: "require", description: '"require"' },
                      $n = function (e) {
                        return {
                          type: "Program",
                          statements: null !== e ? e : [],
                        ...
                        (n = (function () {
                          ...
                          return (
                            (e = (function () {
                              var e, n, i, s, o, a;
                              if (((e = Xn), (n = fi()) !== r)) {
                                for (i = [], s = Xn, s = (o = hi()) !== r && (a = fi()) !== r ? (o = [o, a]) : ((Xn = s), r); s !== r; )
                                  i.push(s), (s = Xn), (s = (o = hi()) !== r && (a = fi()) !== r ? (o = [o, a]) : ((Xn = s), r));
                                e =
                                  i !== r &&
                                  (s = hi()) !== r &&
                                  (o = (function () {
                                    ...
                                    return (
                                      ...
                                      (e =
                                        (function () {
                                          var e;
                                          return t.substr(Xn, 6) === Dn ? ((e = Dn), (Xn += 6)) : ((e = r), 0 === Qn && ti(Un)), e;
                                        })() !== r &&
                                        hi() !== r &&
                                        (n = gi()) !== r &&
                                        _i() !== r
                    ...
                    function si() {
                      ...
                      return (
                        ...
                        e === r &&
                          (e = (function () {
                            var e;
                            return P.test(t.charAt(Xn)) ? ((e = t.charAt(Xn)), Xn++) : ((e = r), 0 === Qn && ti(M)), e;
                          })()),
                        Qn--,
                        e === r && 0 === Qn && ti(c),
                        e
                    ...
                    function ai() {
                      ...
                      return (
                        Qn++,
                        10 === t.charCodeAt(Xn) ? ((e = f), Xn++) : ((e = r), 0 === Qn && ti(b)),
                        e === r &&
                          ...
                          if (((e = Xn), t.substr(Xn, 2) === T ? ((n = T), (Xn += 2)) : ((n = r), 0 === Qn && ti(C)), n !== r)) {
                            for (
                              i = [],
                                o = s = Xn,
                                Qn++,
                                t.substr(Xn, 2) === E ? ((a = E), (Xn += 2)) : ((a = r), 0 === Qn && ti(z)),
                                Qn--,
                            ...
                            e =
                              i !== r
                                ? (t.substr(Xn, 2) === E ? ((s = E), (Xn += 2)) : ((s = r), 0 === Qn && ti(z)),
                                  s !== r ? (n = [n, i, s]) : ((Xn = e), r))
                                : ((Xn = e), r);
                          } else (Xn = e), (e = r);
                          return e;
                    ...
                    function di() {
                      var e;
                      return 36 === t.charCodeAt(Xn) ? ((e = R), Xn++) : ((e = r), 0 === Qn && ti(q)), e;
                    }
                    function _i() {
                      var e, n, i, s;
                      return (
                        ...
                        (e = (n = pi()) !== r && (i = ai()) !== r ? (n = [n, i]) : ((Xn = e), r)) === r &&
                          ...
                          (e =
                            (n = pi()) !== r
                              ? ((i = Xn),
                                Qn++,
                                125 === t.charCodeAt(Xn) ? ((s = L), Xn++) : ((s = r), 0 === Qn && ti(O)),
                                Qn--,
                        ...
                        (e = (function () {
                                ...
                                ? ((i = ki()) === r && (i = null),
                                  ...
                                  (s = (function () {
                                    ...
                                    return (
                                      Qn++,
                                      (e = Xn),
                                      61 === t.charCodeAt(Xn) ? ((n = H), Xn++) : ((n = r), 0 === Qn && ti(V)),
                                      (e =
                                        n !== r
                                          ? ((i = Xn),
                                            Qn++,
                                            61 === t.charCodeAt(Xn) ? ((s = H), Xn++) : ((s = r), 0 === Qn && ti(V)),
                                            Qn--,
                                            (i = s === r ? void 0 : ((Xn = i), r)) !== r ? (n = F()) : ((Xn = e), r))
                                          : ((Xn = e), r)) === r &&
                                        (t.substr(Xn, 2) === W ? ((e = W), (Xn += 2)) : ((e = r), 0 === Qn && ti($)),
                                        e === r &&
                                          (t.substr(Xn, 2) === Y ? ((e = Y), (Xn += 2)) : ((e = r), 0 === Qn && ti(X)),
                                          e === r &&
                          ...
                          (e = (function () {
                            ...
                            return (
                              ...
                              (e =
                                (function () {
                                  var e;
                                  return t.substr(Xn, 3) === Rn ? ((e = Rn), (Xn += 3)) : ((e = r), 0 === Qn && ti(qn)), e;
                                })() !== r && hi() !== r
                                  ? (40 === t.charCodeAt(Xn) ? ((n = me), Xn++) : ((n = r), 0 === Qn && ti(ve)),
                                    ...
                                    (function () {
                                      var e;
                                      return t.substr(Xn, 2) === Pn ? ((e = Pn), (Xn += 2)) : ((e = r), 0 === Qn && ti(Mn)), e;
                                    })() !== r &&
                                    hi() !== r
                                      ? ((s = vi()) === r && (s = bi()),
                                        s !== r && hi() !== r
                                          ? (41 === t.charCodeAt(Xn) ? ((o = we), Xn++) : ((o = r), 0 === Qn && ti(ye)),
                                            o !== r && hi() !== r
                                              ? ((a = fi()) === r && (a = mi()), a !== r ? ke(i, s, a) : ((Xn = e), r))
                                              : ((Xn = e), r))
                                          : ((Xn = e), r))
                                      : ((Xn = e), r))
                                  : ((Xn = e), r)),
                          ...
                          (e = (function () {
                            ...
                            return (
                              ...
                              (e =
                                (function () {
                                  var e;
                                  return t.substr(Xn, 2) === Ln ? ((e = Ln), (Xn += 2)) : ((e = r), 0 === Qn && ti(On)), e;
                                })() !== r && hi() !== r
                                  ? (40 === t.charCodeAt(Xn) ? ((n = me), Xn++) : ((n = r), 0 === Qn && ti(ve)),
                                    n !== r && hi() !== r && (i = qi()) !== r && hi() !== r
                                          ...
                                          ? ((o = fi()) === r && (o = mi()),
                                            o !== r && hi() !== r
                                              ? ((a = Xn),
                                                (l = (function () {
                                                  var e;
                                                  return t.substr(Xn, 4) === En ? ((e = En), (Xn += 4)) : ((e = r), 0 === Qn && ti(zn)), e;
                                                })()),
                                                (a =
                                                  l !== r && (c = hi()) !== r
                                                    ? ((u = fi()) === r && (u = mi()), u !== r ? (l = [l, c, u]) : ((Xn = a), r))
                                                    : ((Xn = a), r)) === r && (a = null),
                                                a !== r ? Ae(i, o, a) : ((Xn = e), r))
                                              : ((Xn = e), r))
                                          : ((Xn = e), r))
                          ...
                          (e = (function () {
                            ...
                            return (
                              ...
                              (e =
                                (function () {
                                  var e;
                                  return t.substr(Xn, 7) === Fn ? ((e = Fn), (Xn += 7)) : ((e = r), 0 === Qn && ti(Wn)), e;
                                })() !== r &&
                                hi() !== r &&
                                (n = gi()) !== r &&
                                _i() !== r
                          ...
                          (e = (function () {
                            ...
                            return (
                              Qn++,
                              (e = Xn),
                              59 === t.charCodeAt(Xn) ? ((n = he), Xn++) : ((n = r), 0 === Qn && ti(fe)),
                              n !== r && (n = be()),
                              Qn--,
                            ...
                            s =
                              (o = hi()) !== r
                                ? (44 === t.charCodeAt(Xn) ? ((a = re), Xn++) : ((a = r), 0 === Qn && ti(se)),
                                  a !== r && (l = hi()) !== r && (c = bi()) !== r ? (o = [o, a, l, c]) : ((Xn = s), r))
                                : ((Xn = s), r);
                          s !== r;
                            ...
                            ? ((i = Xn),
                              (i =
                                (s = (function () {
                                  var e, t, n, i, s, o;
                                  if (((e = Xn), (t = fi()) !== r)) {
                                    for (n = [], i = Xn, i = (s = hi()) !== r && (o = fi()) !== r ? (s = [s, o]) : ((Xn = i), r); i !== r; )
                                      n.push(i), (i = Xn), (i = (s = hi()) !== r && (o = fi()) !== r ? (s = [s, o]) : ((Xn = i), r));
                            ...
                            return (
                              (e = (function () {
                                ...
                                return (
                                  (e = (function () {
                                    var e;
                                    return t.substr(Xn, 4) === Bn ? ((e = Bn), (Xn += 4)) : ((e = r), 0 === Qn && ti(Nn)), e;
                                  })()) !== r && (e = At()),
                                  e
                                );
                              })()) === r &&
                                (e = (function () {
                                  ...
                                  return (
                                    ...
                                    (n = (function () {
                                      var e;
                                      return t.substr(Xn, 4) === Hn ? ((e = Hn), (Xn += 4)) : ((e = r), 0 === Qn && ti(Vn)), e;
                                    })()) !== r && (n = St()),
                                    (e = n) === r &&
                                      ((e = Xn),
                                      (n = (function () {
                                ...
                                (e = (function () {
                                  ...
                                  return (
                                    ...
                                    (n = (function () {
                                      var e, n, i, s, o;
                                      if (((e = Xn), 48 === t.charCodeAt(Xn) ? ((n = Pt), Xn++) : ((n = r), 0 === Qn && ti(Mt)), n !== r))
                                        if ((Xt.test(t.charAt(Xn)) ? ((i = t.charAt(Xn)), Xn++) : ((i = r), 0 === Qn && ti(Gt)), i !== r)) {
                                          if (((s = []), (o = Bi()) !== r)) for (; o !== r; ) s.push(o), (o = Bi());
                                          else s = r;
                                          e = s !== r ? (n = Kt(s)) : ((Xn = e), r);
                                        } else (Xn = e), (e = r);
                                      else (Xn = e), (e = r);
                                      ...
                                      (n = (function () {
                                        ...
                                        return (
                                          ...
                                          (e =
                                            (n = Pi()) !== r
                                              ? (46 === t.charCodeAt(Xn) ? ((i = zt), Xn++) : ((i = r), 0 === Qn && ti(It)),
                                                i !== r
                                                  ? ((s = Mi()) === r && (s = null),
                                                    s !== r
                                                      ? ((o = Oi()) === r && (o = null), o !== r ? (n = jt(n, s, o)) : ((Xn = e), r))
                                                      : ((Xn = e), r))
                                                  : ((Xn = e), r))
                                              : ((Xn = e), r)) === r &&
                                            ((e = Xn),
                                            46 === t.charCodeAt(Xn) ? ((n = zt), Xn++) : ((n = r), 0 === Qn && ti(It)),
                                            (e =
                                              n !== r && (i = Mi()) !== r
                                                ? ((s = Oi()) === r && (s = null), s !== r ? (n = Rt(i, s)) : ((Xn = e), r))
                                                : ((Xn = e), r)) === r &&
                                              ((e = Xn),
                                              (e =
                                                (n = Pi()) !== r
                                                  ? ((i = Oi()) === r && (i = null), i !== r ? (n = qt(n, i)) : ((Xn = e), r))
                                                  : ((Xn = e), r)))),
                                          e
                                        );
                                      })()),
                                    (e =
                                      n !== r
                                        ? ((i = Xn),
                                          ...
                                          (s = di()),
                                          Qn--,
                                          (i = s === r ? void 0 : ((Xn = i), r)) !== r ? (n = Et(n)) : ((Xn = e), r))
                                        : ((Xn = e), r)),
                                    Qn--,
                                    e === r && ((n = r), 0 === Qn && ti(Ct)),
                                    e
                                  ...
                                  return (
                                    ...
                                    (e =
                                      n !== r
                                        ? ((i = (function () {
                                            var e, t;
                                            if (((e = []), (t = Ui()) !== r)) for (; t !== r; ) e.push(t), (t = Ui());
                                            else e = r;
                                            return e !== r && (e = on(e)), e;
                                          })()),
                                          i !== r
                                ...
                                (e = (function () {
                                  ...
                                  return (
                                    (e = Xn),
                                    91 === t.charCodeAt(Xn) ? ((n = Me), Xn++) : ((n = r), 0 === Qn && ti(Le)),
                                    (e =
                                      n !== r && hi() !== r
                                        ? ((i = yi()) === r && (i = null),
                                          i !== r && hi() !== r
                                            ? (93 === t.charCodeAt(Xn) ? ((s = Oe), Xn++) : ((s = r), 0 === Qn && ti(Be)),
                                              s !== r ? (n = yt(i)) : ((Xn = e), r))
                                            : ((Xn = e), r))
                                        : ((Xn = e), r))
                                  );
                        ...
                        for (
                          i = [],
                            ...
                            s =
                              (o = hi()) !== r
                                ? (44 === t.charCodeAt(Xn) ? ((a = re), Xn++) : ((a = r), 0 === Qn && ti(se)),
                                  a !== r && (l = hi()) !== r && (c = vi()) !== r ? (o = [o, a, l, c]) : ((Xn = s), r))
                                : ((Xn = s), r);
                          s !== r;
                    ...
                    function xi() {
                      ...
                      return (
                        (e = (function () {
                          var e, t, n;
                          return (e = Xn), (t = vi()) !== r && hi() !== r && (n = ki()) !== r ? (t = De(t, n)) : ((Xn = e), r);
                        })()) === r &&
                          (e = vi()) === r &&
                          ((e = Xn),
                          (e =
                            (n = (function () {
                              var e;
                              return (
                                43 === t.charCodeAt(Xn) ? ((e = He), Xn++) : ((e = r), 0 === Qn && ti(Ve)),
                                e === r &&
                                  (45 === t.charCodeAt(Xn) ? ((e = Fe), Xn++) : ((e = r), 0 === Qn && ti(We)),
                                  e === r &&
                                    (126 === t.charCodeAt(Xn) ? ((e = $e), Xn++) : ((e = r), 0 === Qn && ti(Ye)),
                    ...
                    function Ci() {
                      ...
                      return (
                        (e = Xn),
                        43 === t.charCodeAt(Xn) ? ((n = He), Xn++) : ((n = r), 0 === Qn && ti(Ve)),
                        (e =
                          n !== r
                            ? ((i = Xn),
                              Qn++,
                              43 === t.charCodeAt(Xn) ? ((s = He), Xn++) : ((s = r), 0 === Qn && ti(Ve)),
                              s === r && (61 === t.charCodeAt(Xn) ? ((s = H), Xn++) : ((s = r), 0 === Qn && ti(V))),
                              Qn--,
                              (i = s === r ? void 0 : ((Xn = i), r)) !== r ? (n = st()) : ((Xn = e), r))
                            : ((Xn = e), r)) === r &&
                          ((e = Xn),
                          45 === t.charCodeAt(Xn) ? ((n = Fe), Xn++) : ((n = r), 0 === Qn && ti(We)),
                          (e =
                            n !== r
                              ? ((i = Xn),
                                Qn++,
                                45 === t.charCodeAt(Xn) ? ((s = Fe), Xn++) : ((s = r), 0 === Qn && ti(We)),
                                s === r && (61 === t.charCodeAt(Xn) ? ((s = H), Xn++) : ((s = r), 0 === Qn && ti(V))),
                                Qn--,
                      ...
                      return (
                        ...
                        e === r &&
                          ...
                          e === r &&
                            ...
                            e === r && (62 === t.charCodeAt(Xn) ? ((e = ht), Xn++) : ((e = r), 0 === Qn && ti(ft))))),
                        e
                      );
                    }
                    function Ii() {
                    ...
                    function Pi() {
                      var e, n, i;
                      return (
                        48 === t.charCodeAt(Xn) ? ((e = Pt), Xn++) : ((e = r), 0 === Qn && ti(Mt)),
                        e === r &&
                          ((e = Xn),
                          (e =
                            (n = (function () {
                              var e;
                              return Dt.test(t.charAt(Xn)) ? ((e = t.charAt(Xn)), Xn++) : ((e = r), 0 === Qn && ti(Ut)), e;
                            })()) !== r
                              ? ((i = Mi()) === r && (i = null), i !== r ? (n = Lt(n, i)) : ((Xn = e), r))
                              : ((Xn = e), r))),
                        e
                      );
                    }
                    function Mi() {
                      var e, t;
                      if (((e = []), (t = Li()) !== r)) for (; t !== r; ) e.push(t), (t = Li());
                      else e = r;
                      return e !== r && (e = Ot(e)), e;
                    }
                    function Li() {
                      var e;
                      return Bt.test(t.charAt(Xn)) ? ((e = t.charAt(Xn)), Xn++) : ((e = r), 0 === Qn && ti(Nt)), e;
                    }
                    function Oi() {
                      var e, n, i;
                      return (
                        ...
                        (n = (function () {
                          var e;
                          return Vt.test(t.charAt(Xn)) ? ((e = t.charAt(Xn)), Xn++) : ((e = r), 0 === Qn && ti(Ft)), e;
                        })()) !== r &&
                        (i = (function () {
                          var e, n, i;
                          return (
                            (e = Xn),
                            Wt.test(t.charAt(Xn)) ? ((n = t.charAt(Xn)), Xn++) : ((n = r), 0 === Qn && ti($t)),
                            n === r && (n = null),
                            (e = n !== r && (i = Mi()) !== r ? (n = Yt(n, i)) : ((Xn = e), r))
                          );
                        })()) !== r
                          ? (n = Ht(n, i))
                          : ((Xn = e), r)
                    ...
                    function Ni() {
                      ...
                      return (
                        ...
                        (e = (n = i === r ? void 0 : ((Xn = n), r)) !== r && (i = ri()) !== r ? (n = cn(i)) : ((Xn = e), r)) === r &&
                          ...
                          (e = n !== r && (i = Vi()) !== r ? (n = un(i)) : ((Xn = e), r)) === r && (e = Hi())),
                        e
                      );
                    }
                    function Di() {
                    ...
                    function Vi() {
                      ...
                      return (
                        (e = (function () {
                          ...
                          ((e = Xn),
                          48 === t.charCodeAt(Xn) ? ((n = Pt), Xn++) : ((n = r), 0 === Qn && ti(Mt)),
                          (e =
                            n !== r
                              ? ((i = Xn),
                                Qn++,
                            ...
                            (e = (function () {
                              ...
                              return (
                                ...
                                (e = n !== r && (i = Bi()) !== r && (s = Bi()) !== r ? (n = kn(i, s)) : ((Xn = e), r))
                              );
                            })()) === r &&
                            (e = (function () {
                              var e, n, i, s, o, a;
                              return (
                                ...
                                (e =
                                  n !== r && (i = Bi()) !== r && (s = Bi()) !== r && (o = Bi()) !== r && (a = Bi()) !== r
                                    ? (n = xn(i, s, o, a))
                                    : ((Xn = e), r))
                              );
                            })())),
                    ...
                    function Fi() {
                      var e;
                      return hn.test(t.charAt(Xn)) ? ((e = t.charAt(Xn)), Xn++) : ((e = r), 0 === Qn && ti(fn)), e !== r && (e = bn(e)), e;
                    }
                    function Wi() {
                      var e;
            ...
            (function (e) {
              ...
              try {
                O.apply((P = B.call(S.childNodes)), S.childNodes), P[S.childNodes.length].nodeType;
              } catch (e) {
                O = {
                  apply: P.length
                    ? function (e, t) {
                ...
                if (!i && ((t ? t.ownerDocument || t : S) !== g && b(t), (t = t || g), v)) {
                  if (11 !== f && (c = ie.exec(e)))
                    if ((r = c[1])) {
                      ...
                      } else if (h && (a = h.getElementById(r)) && x(t, a) && a.id === r) return n.push(a), n;
                    } else {
                  ...
                  if (o.qsa && !j[e + " "] && (!w || !w.test(e)) && (1 !== f || "object" !== t.nodeName.toLowerCase())) {
                    if (((p = e), (h = t), 1 === f && G.test(e))) {
                      for (
                        ...
                        d[s] = "#" + l + " " + ve(d[s]);
                      (p = d.join(",")), (h = (re.test(e) && ge(t.parentNode)) || t);
                    }
                    try {
                      return O.apply(n, h.querySelectorAll(p)), n;
                    } catch (t) {
                      j(e, !0);
                    } finally {
                      ...
                      (o.qsa = ne.test(g.querySelectorAll)) &&
                        (_e(function (e) {
                          (m.appendChild(e).innerHTML =
                            ...
                            e.querySelectorAll("[msallowcapture^='']").length && w.push("[*^$]=" + U + "*(?:''|\"\")"),
                            e.querySelectorAll("[selected]").length || w.push("\\[" + U + "*(?:value|" + D + ")"),
                        ...
                        _e(function (e) {
                          ...
                          t.setAttribute("type", "hidden"),
                            ...
                            e.querySelectorAll("[name=d]").length && w.push("name" + U + "*[*^$|!~]?="),
                      ...
                      (R = t
                        ...
                        : function (e, t) {
                            ...
                            var n,
                              ...
                              o = [e],
                              a = [t];
                            if (!r || !s) return e === g ? -1 : t === g ? 1 : r ? -1 : s ? 1 : h ? N(h, e) - N(h, t) : 0;
                            if (r === s) return he(e, t);
                            for (n = e; (n = n.parentNode); ) o.unshift(n);
                            for (n = t; (n = n.parentNode); ) a.unshift(n);
                            for (; o[i] === a[i]; ) i++;
                            return i ? he(o[i], a[i]) : o[i] === S ? -1 : a[i] === S ? 1 : 0;
                          })),
                    g
                  );
                }),
              ...
              (ce.attr = function (e, t) {
                ...
                var n = a.attrHandle[t.toLowerCase()],
                  i = n && q.call(a.attrHandle, t.toLowerCase()) ? n(e, t, !v) : void 0;
                return void 0 !== i
                  ? i
                  : o.attributes || !v
                  ? e.getAttribute(t)
              ...
              (ce.uniqueSort = function (e) {
                var t,
                  ...
                  i = 0,
                  r = 0;
                if (((f = !o.detectDuplicates), (h = !o.sortStable && e.slice(0)), e.sort(R), f)) {
                      ...
                      return 1 === i && 0 === r
                        ...
                        : function (t, n, l) {
                            ...
                            if (b) {
                              if (s) {
                                for (; f; ) {
                                  for (_ = t; (_ = _[f]); ) if (a ? _.nodeName.toLowerCase() === g : 1 === _.nodeType) return !1;
                                  h = f = "only" === e && !h && "nextSibling";
                                }
                                return !0;
                              }
                              if (((h = [o ? b.firstChild : b.lastChild]), o && m)) {
                                for (
                                  v =
                                    (p =
              ...
              function xe(e, t, n, i, r, s) {
                return (
                  ...
                  de(function (s, o, a, l) {
                    ...
                    } else (g = ke(g === o ? g.splice(h, g.length) : g)), r ? r(null, o, g, l) : O.apply(o, g);
                  })
                );
              }
              function Ae(e) {
                for (
                  ...
                  if ((n = a.relative[e[l].type])) d = [we(ye(d), n)];
                    ...
                    if ((n = a.filter[e[l].type].apply(null, e[l].matches))[A]) {
                      ...
                      return xe(
                        1 < l && ye(d),
                        1 < l && ve(e.slice(0, l - 1).concat({ value: " " === e[l - 2].type ? "*" : "" })).replace($, "$1"),
                        n,
                        l < i && Ae(e.slice(l, i)),
                        i < r && Ae((e = e.slice(i))),
                        i < r && ve(e)
                ...
                (u = ce.tokenize =
                  function (e, t) {
                    ...
                    for (o = e, l = [], c = a.preFilter; o; ) {
                      for (s in ((n && !(i = Y.exec(o))) || (i && (o = o.slice(i[0].length) || o), l.push((r = []))),
                      (n = !1),
                      (i = X.exec(o)) && ((n = i.shift()), r.push({ value: n, type: i[0].replace($, " ") }), (o = o.slice(n.length))),
                      a.filter))
                        !(i = Q[s].exec(o)) ||
                          (c[s] && !(i = c[s](i))) ||
                    ...
                    return t ? o.length : o ? ce.error(e) : z(e, l).slice(0);
                  }),
                (d = ce.compile =
                  function (e, t) {
                    var n,
                        ...
                        (function (e, t) {
                          function n(n, s, o, l, c) {
                            var u,
                              ...
                              A = k.length;
                            for (c && (p = s === g || s || c); f !== A && null != (u = k[f]); f++) {
                              if (r && u) {
                              ...
                              i && ((u = !_ && u) && h--, n && m.push(u));
                            }
                            if (((h += f), i && f !== h)) {
                              for (d = 0; (_ = t[d++]); ) _(m, w, s, o);
                              if (n) {
                                if (0 < h) for (; f--; ) m[f] || w[f] || (w[f] = M.call(l));
                                w = ke(w);
                              }
                              O.apply(l, w), c && !n && 0 < w.length && 1 < h + t.length && ce.uniqueSort(l);
                            }
                            return c && ((T = x), (p = y)), m;
                          }
                          var i = 0 < t.length,
                    ...
                    if (((i = i || []), 1 === h.length)) {
                      ...
                      for (s = Q.needsContext.test(e) ? 0 : o.length; s-- && ((l = o[s]), !a.relative[(c = l.type)]); )
                        if ((_ = a.find[c]) && (r = _(l.matches[0].replace(se, n), (re.test(o[0].type) && ge(t.parentNode)) || t))) {
                          if ((o.splice(s, 1), !(e = r.length && ve(o)))) return O.apply(i, r), i;
                          break;
                        }
                    }
                    return (p || d(e, h))(r, t, !v, i, !t || (re.test(e) && ge(t.parentNode)) || t), i;
                  }),
                (o.sortStable = A.split("").sort(R).join("") === A),
    ...
    25: [
      ...
      { "./_to-absolute-index": 60, "./_to-iobject": 62, "./_to-length": 63 }
    ],
    26: [
      function (e, t, n) {
        var i = {}.toString;
    ...
    33: [
      ...
      { "./_core": 27, "./_ctx": 28, "./_global": 36, "./_hide": 38, "./_redefine": 55 }
    ],
    34: [
      function (e, t, n) {
        t.exports = function (e) {
    ...
    38: [
      ...
      { "./_descriptors": 30, "./_object-dp": 49, "./_property-desc": 54 }
    ],
    39: [
      function (e, t, n) {
    ...
    43: [
      ...
      { "./_hide": 38, "./_object-create": 48, "./_property-desc": 54, "./_set-to-string-tag": 56, "./_wks": 67 }
    ],
    44: [
      function (e, t, n) {
        "use strict";
        ...
        t.exports = function (e, t, n, b, g, m, v) {
          ...
          var w,
            ...
            z = E || x(g),
            I = g ? (S ? x("entries") : z) : void 0,
            j = ("Array" == t && C.entries) || E;
          if (
            (j && (k = u(j.call(new e()))) !== Object.prototype && k.next && (c(k, A, !0), i || "function" == typeof k[d] || o(k, d, f)),
            S &&
              E &&
              E.name !== h &&
              ((T = !0),
            ...
            if (((w = { values: S ? z : x(h), keys: m ? z : x(p), entries: I }), v)) for (y in w) y in C || s(C, y, w[y]);
    ...
    48: [
      ...
      { "./_an-object": 24, "./_dom-create": 31, "./_enum-bug-keys": 32, "./_html": 39, "./_object-dps": 50, "./_shared-key": 57 }
    ],
    49: [
      function (e, t, n) {
        var i = e("./_an-object"),
      ...
      { "./_an-object": 24, "./_descriptors": 30, "./_ie8-dom-define": 40, "./_to-primitive": 65 }
    ],
    50: [
      function (e, t, n) {
        var i = e("./_object-dp"),
      ...
      { "./_an-object": 24, "./_descriptors": 30, "./_object-dp": 49, "./_object-keys": 53 }
    ],
    51: [
      function (e, t, n) {
        var i = e("./_has"),
      ...
      { "./_has": 37, "./_shared-key": 57, "./_to-object": 64 }
    ],
    52: [
      function (e, t, n) {
        var i = e("./_has"),
      ...
      { "./_array-includes": 25, "./_has": 37, "./_shared-key": 57, "./_to-iobject": 62 }
    ],
    53: [
      function (e, t, n) {
      ...
      { "./_enum-bug-keys": 32, "./_object-keys-internal": 52 }
    ],
    54: [
      function (e, t, n) {
        t.exports = function (e, t) {
    ...
    55: [
      ...
      { "./_core": 27, "./_function-to-string": 35, "./_global": 36, "./_has": 37, "./_hide": 38, "./_uid": 66 }
    ],
    56: [
      function (e, t, n) {
    ...
    58: [
      ...
      { "./_core": 27, "./_global": 36, "./_library": 47 }
    ],
    59: [
      function (e, t, n) {
        "use strict";
    ...
    68: [
      ...
      { "./_add-to-unscopables": 23, "./_iter-define": 44, "./_iter-step": 45, "./_iterators": 46, "./_to-iobject": 62 }
    ],
    69: [
      function (e, t, n) {
        "use strict";
      ...
      { "./_a-function": 22, "./_export": 33, "./_fails": 34, "./_strict-method": 59, "./_to-object": 64 }
    ],
    70: [
      function (e, t, n) {
        for (
    ...
    72: [
      ...
      },
      {
        ...
        "./Messenger": 74,
        "./chrome": 76,
        "@babel/runtime/helpers/assertThisInitialized": 8,
        "@babel/runtime/helpers/classCallCheck": 9,
        ...
        function a(e, t, n, i) {
          ...
          n
            ? (t.event.bind(window, "touchstart", h),
              t.event.bind(window, "touchend", f),
            ...
            : i &&
              (window.PointerEvent
                ? (t.event.bind(window, "pointerdown", h),
                  t.event.bind(window, "pointerup", f),
                ...
                : window.MSPointerEvent &&
                  ...
                  t.event.bind(window, "MSPointerUp", f),
    ...
    96: [
      ...
      { "../lib/dom": 80, "../lib/helper": 83, "./instances": 95, "./update-scroll": 97 }
    ],
    97: [
      function (e, t, n) {
        "use strict";
        ...
        (function (e) {
          (function () {
            !(function (e, i) {
              ...
              var M = q,
                L = S("Object"),
                O = d && L(new DataView(new ArrayBuffer(8))),
                B = "undefined" != typeof Map && L(new Map()),
                N = S("DataView");
              var D = O
                  ? function (e) {
                      return null != e && M(e.getInt8) && R(e.buffer);
                    }
                  : N,
                U = _ || S("Array");
              function H(e, t) {
              ...
              var Q = u
                  ? function (e) {
                      return f ? f(e) && !D(e) : K(e) && Z.test(l.call(e));
                    }
                  : $(!1),
                J = X("length");
              function ee(e, t) {
              ...
              function ae(e, t, n, i) {
                ...
                if (!o) {
                  ...
                  var a = e.constructor,
                    c = t.constructor;
                  if (a !== c && !(M(a) && a instanceof a && M(c) && c instanceof c) && "constructor" in e && "constructor" in t) return !1;
                }
                i = i || [];
              ...
              function ce(e) {
                ...
                return function (n) {
                  ...
                  var i = le(n);
                  if (J(i)) return !1;
                  for (var r = 0; r < t; r++) if (!M(n[e[r]])) return !1;
                  return e !== he || !M(n[ue]);
                };
              }
              var ue = "forEach",
                ...
                pe = de.concat(ue, _e),
                he = de.concat(_e),
                fe = ["add"].concat(de, ue, "has"),
                be = B ? ce(pe) : S("Map"),
                ge = B ? ce(he) : S("WeakMap"),
                me = B ? ce(fe) : S("Set"),
                ve = S("WeakSet");
              function we(e) {
              ...
              function Oe(e, t, n) {
                return null == e ? qe : M(e) ? Le(e, t, n) : k(e) && !U(e) ? Pe(e) : Me(e);
              }
              function Be(e, t) {
                return Oe(e, t, 1 / 0);
              }
              function Ne(e, t, n) {
                return ie.iteratee !== Be ? ie.iteratee(e, t) : Oe(e, t, n);
              }
              function De() {}
              function Ue(e, t) {
                return null == t && ((t = e), (e = 0)), e + Math.floor(Math.random() * (t - e + 1));
              }
              (ie.toPath = ze), (ie.iteratee = Be);
              var He =
                Date.now ||
                function () {
              ...
              var Fe = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#x27;", "`": "&#x60;" },
                We = Ve(Fe),
                $e = Ve(ye(Fe)),
                Ye = (ie.templateSettings = { evaluate: /<%([\s\S]+?)%>/g, interpolate: /<%=([\s\S]+?)%>/g, escape: /<%-([\s\S]+?)%>/g }),
                Xe = /(.)^/,
                Ge = { "'": "'", "\\": "\\", "\r": "r", "\n": "n", "\u2028": "u2028", "\u2029": "u2029" },
                Ke = /\\|'|\r|\n|\u2028|\u2029/g;
              function Ze(e) {
              ...
              function bt(e, t, n) {
                return function (i, r, s) {
                  ...
                  if (r != r) return (s = t(a.call(i, o, l), W)) >= 0 ? s + o : -1;
              ...
              function wt(e, t, n) {
                var i, r;
                if (((t = Le(t, n)), it(e))) for (i = 0, r = e.length; i < r; i++) t(e[i], i, e);
                else {
                  var s = te(e);
              ...
              var zt = y(function (e, t, n) {
                var i, r;
                return (
                  M(t) ? (r = t) : ((t = Ie(t)), (i = t.slice(0, -1)), (t = t[t.length - 1])),
                  yt(e, function (e) {
                    var s = r;
                    if (!s) {
              ...
              function Rt(e, t, n) {
                if (null == t || n) return it(e) || (e = we(e)), e[Ue(e.length - 1)];
                var i = it(e) ? Ee(e) : we(e),
                  r = J(i);
              ...
              var Pt = qt(function (e, t, n) {
                  H(e, n) ? e[n].push(t) : (e[n] = [t]);
                }),
                Mt = qt(function (e, t, n) {
                  e[n] = t;
                }),
                Lt = qt(function (e, t, n) {
                  H(e, n) ? e[n]++ : (e[n] = 1);
                }),
                Ot = qt(function (e, t, n) {
                  e[n ? 0 : 1].push(t);
                }, !0),
                Bt = /[^\ud800-\udfff]|[\ud800-\udbff][\udc00-\udfff]|[\ud800-\udfff]/g;
              function Nt(e, t, n) {
              ...
              var Dt = y(function (e, t) {
                  var n = {},
                    i = t[0];
                  if (null == e) return n;
                  M(i) ? (t.length > 1 && (i = Le(i, t[1])), (t = le(e))) : ((i = Nt), (t = rt(t, !1, !1)), (e = Object(e)));
              ...
              function Yt(e, t, n, i) {
                ...
                for (var r = [], s = [], o = 0, a = J(e); o < a; o++) {
                  var l = e[o],
                    c = n ? n(l, o, e) : l;
                  t && !n ? ((o && s === c) || r.push(l), (s = c)) : n ? Et(s, c) || (s.push(c), r.push(l)) : Et(r, l) || r.push(l);
                }
                return r;
              }
              var Xt = y(function (e) {
              ...
              var Jt = {
                  ...
                  isEmpty: function (e) {
                    if (null == e) return !0;
                    var t = J(e);
                    return "number" == typeof t && (U(e) || T(e) || F(e)) ? 0 === t : 0 === J(te(e));
                  },
                  isMatch: ne,
                  ...
                  result: function (e, t, n) {
                    ...
                    for (var r = 0; r < i; r++) {
                      ...
                      void 0 === s && ((s = n), (r = i)), (e = M(s) ? s.call(e) : s);
                    }
                    return e;
                  },
                  uniqueId: function (e) {
                  ...
                  partition: Ot,
                  toArray: function (e) {
                    return e ? (U(e) ? a.call(e) : T(e) ? e.match(Bt) : it(e) ? yt(e, qe) : we(e)) : [];
                  },
                  size: function (e) {
                  ...
                  intersection: function (e) {
                    for (var t = [], n = arguments.length, i = 0, r = J(e); i < r; i++) {
                      ...
                      if (!Et(t, s)) {
                        var o;
                        for (o = 1; o < n && Et(arguments[o], s); o++);
                        o === n && t.push(s);
                      }
                    }
                    return t;
    ...
    101: [
      function (e, t, n) {
        t.exports =
          '<div class="feedback flex flex--col flex--g1">\n  <div class="head__name">\n    <div class="topbar">\n      <a href="#" class="feedback__back-button" />\n      <h3>{{> lb_feedback }}</h3>\n    </div>\n  </div>\n  <div class="feedback__container flex flex--col flex--ac flex--g1">\n    {{^ showThankYou }}\n      <div class="flex flex--col flex--ac flex--c flex--g1">\n        <div class="feedback__text-title">{{> lb_feedback_question }}</div>\n        <div>\n          {{# stars }}\n            <svg id="feedback__star-{{ value }}" class="feedback__star" width="40px" height="40px" viewBox="0 0 40 40">\n              <g stroke-width="2">\n                <path d="M19,1.57446638 L23.2238002,14.1864378 L36.5237238,14.306197 L25.8342523,22.2205832 L29.8302569,34.9065698 L19,27.1859581 L8.16974307,34.9065698 L12.1657477,22.2205832 L1.47627618,14.306197 L14.7761998,14.1864378 L19,1.57446638 Z" />\n              </g>\n            </svg>\n          {{/ stars }}\n        </div>\n        </div>\n    {{/ showThankYou }}\n    {{# showThankYou }}\n      <div class="flex flex--col flex--ac flex--c flex--g1">\n        <img class="feedback__checkmark" src="/img/ico_tick.png" alt="check" />\n        {{# showRateStore }}\n          <div class="feedback__text-title">{{> lb_feedback_thank_you_feedback }}</div>\n          <div class="feedback__text">{{ rateStoreString }}</div>\n        {{/ showRateStore }}\n        {{^ showRateStore }}\n          <div class="feedback__text-title">{{> lb_feedback_thank_you }}</div>\n          <div class="feedback__text">{{> lb_feedback_help_improve }}</div>\n        {{/ showRateStore }}\n      </div>\n    {{/ showThankYou }}\n  </div>\n  <div class="feedback__button-container">\n    {{^ showThankYou }}\n      <button id="feedback__send-button" class="button button--full feedback__button" title="{{> lb_feedback_send_title }}">{{> lb_feedback_send }}</button>\n    {{/ showThankYou }}\n    {{# showThankYou }}\n      {{# showRateStore }}\n        <button id="feedback__rate-now-button" class="button button--full feedback__button">{{> lb_feedback_rate_now }}</button>\n        <button id="feedback__later-button" class="button button--ghost button--full feedback__button">{{> lb_feedback_later }}</button>\n      {{/ showRateStore }}\n      {{^ showRateStore }}\n        <button id="feedback__ok-button" class="button button--full feedback__button">{{> lb_feedback_ok }}</button>\n      {{/ showRateStore }}\n    {{/ showThankYou }}\n  </div>\n</div>\n';
      },
      {}
    ],
    102: [
    ...
    104: [
      function (e, t, n) {
        t.exports =
          '<div id="domain" class="section section--s txt--truncate txt--medium txt--center" title="{{ domain }}">\n  {{ domain }}\n</div>\n';
      },
      {}
    ],
    105: [
    ...
    131: [
      ...
      { "background/localStorage": 2, configuration: 6, underscore: 99 }
    ],
    132: [
      function (e, t, n) {
        "use strict";
      ...
      { "content/core/Models/ModelBackground": 147 }
    ],
    133: [
      function (e, t, n) {
        "use strict";
      ...
      { "content/core/Models/ModelBackground": 147, "content/messagingInterface": 155 }
    ],
    134: [
      function (e, t, n) {
        "use strict";
    ...
    135: [
      ...
      { "content/Models/base/Settings": 138 }
    ],
    136: [
      function (e, t, n) {
        "use strict";
      ...
      {
        "content/Models/PUA": 133,
        "content/Models/SERP": 134,
        "content/Models/URLClassification": 137,
        "content/core/Models/ModelBackground": 147,
        "content/messagingInterface": 155,
        "modules/offers/content/iframe/models/Ciuvo": 160
      }
    ],
    137: [
      function (e, t, n) {
    ...
    138: [
      function (e, t, n) {
        ...
        class a extends s.Model {
          ...
          set(...e) {
            const t = super.set(...e);
            return r.extend(this.changedByAction, this.changed), t;
          }
          sync(e) {
            let t = "get";
            return (
              ...
              this._listeningToBg ||
                (o.subscribe("Settings:change", (e) => {
                  super.set(e);
                }),
                (this._listeningToBg = !0)),
              new i.Deferred((e) => {
                o.publish(`Settings:${t}`, this.changedByAction, (t) => {
      ...
      { backbone: 20, "content/messagingInterface": 155, jquery: "jquery", underscore: 99 }
    ],
    139: [
      function (e, t, n) {
        "use strict";
      ...
      { "content/Transitions/Default": 140, "content/Views/Dash/TabView": 142, jquery: "jquery" }
    ],
    140: [
      function (e, t, n) {
        "use strict";
      ...
      { "content/core/Transitions/Base": 152, "content/core/Views/View": 153, jquery: "jquery" }
    ],
    141: [
      function (e, t, n) {
        "use strict";
      ...
      { "content/Transitions/Default": 140, "content/Views/Tour/TourStepBase": 146 }
    ],
    142: [
      function (e, t, n) {
        "use strict";
    ...
    143: [
      ...
      { "Indicators/Close.mustache": 107, "content/Views/Indicators/Indicator": 144 }
    ],
    144: [
      function (e, t, n) {
        "use strict";
      ...
      { "content/Models/State": 136, "content/core/Views/View": 153 }
    ],
    145: [
      function (e, t, n) {
        "use strict";
    ...
    146: [
      ...
      { "content/Views/Mixins/Tooltip": 145, "content/core/Views/View": 153, jquery: "jquery", underscore: 99 }
    ],
    147: [
      function (e, t, n) {
        "use strict";
      ...
      { backbone: 20, "content/messagingInterface": 155, jquery: "jquery" }
    ],
    148: [
      function (e, t, n) {
        "use strict";
      ...
      { "content/core/Routing/AreasManagement/ViewTransitionStrategy": 149 }
    ],
    149: [
      function (e, t, n) {
        "use strict";
      ...
      {
        "content/Transitions/DashTransition": 139,
        "content/Transitions/Default": 140,
        "content/Transitions/TourStepTransition": 141,
        "content/core/Routing/AreasManagement/base/ViewTransitionStrategy": 150,
        "modules/offers/content/iframe/transitions/OffersIndicatorBarTransition": 163,
        "modules/offers/content/iframe/transitions/OffesDashTransition": 164
      }
    ],
    150: [
      function (e, t, n) {
    ...
    151: [
      ...
      {
        backbone: 20,
        "backbone.routefilter": 19,
        "content/core/Routing/AreasManagement/AreasManager": 148,
        "content/messagingInterface": 155
      }
    ],
    152: [
    ...
    153: [
      ...
      {
        backbone: 20,
        "backbone-subviews": 18,
        "content/Models/I18n": 132,
        "core-js/modules/es6.array.iterator.js": 68,
        "core-js/modules/web.dom.iterable.js": 70,
        mustache: "mustache",
        "perfect-scrollbar/jquery": 78,
        underscore: 99
      }
    ],
    154: [
      ...
      { Locale: 128, Locales: 129, config: 131, "content/messagingInterface": 155, underscore: 99 }
    ],
    155: [
      function (e, t, n) {
        "use strict";
    ...
    157: [
      ...
      { "content/messagingInterface": 155, "modules/offers/content/Scraper": 158, ms: 77 }
    ],
    158: [
      function (e, t, n) {
        "use strict";
      ...
      { "ciuvo/ciuvo-csl-interpreter.min": 21, "core-js/modules/es6.array.iterator.js": 68, "core-js/modules/web.dom.iterable.js": 70 }
    ],
    159: [
      function (e, t, n) {
        "use strict";
      ...
      },
      {
        ...
        "core-js/modules/es6.array.iterator.js": 68,
        "core-js/modules/web.dom.iterable.js": 70,
        "modules/offers/content/iframe/models/CiuvoProduct": 162
      }
    ],
    160: [
      function (e, t, n) {
      ...
      },
      {
        ...
        backbone: 20,
        "content/messagingInterface": 155,
        "content/mixpanel": 156,
        "core-js/modules/es6.array.sort.js": 69,
        jquery: "jquery",
        "modules/offers/content/Offers": 157,
        "modules/offers/content/iframe/collections/CiuvoProduct": 159,
        "modules/offers/content/iframe/models/CiuvoNotification": 161,
        underscore: 99
      }
    ],
    161: [
    ...
    163: [
      ...
      { "content/core/Transitions/Base": 152, "modules/offers/content/iframe/views/OffersIndicatorBar": 167 }
    ],
    164: [
      function (e, t, n) {
        "use strict";
      ...
      { "content/Transitions/Default": 140, "modules/offers/content/iframe/views/OffersDash": 165 }
    ],
    165: [
      function (e, t, n) {
        "use strict";
      ...
      {
        "content/Views/Dash/TabView": 142,
        "modules/offers/content/iframe/models/Ciuvo": 160,
        "modules/offers/content/iframe/views/mixins/Offers": 168
      }
    ],
    166: [
      function (e, t, n) {
      ...
      {
        "content/Views/Indicators/Indicator": 144,
        "content/messagingInterface": 155,
        jquery: "jquery",
        "modules/offers/content/iframe/models/Ciuvo": 160,
        "modules/offers/content/iframe/views/mixins/Offers": 168
    ...
    167: [
      ...
      {
        "IndicatorBarOffers.mustache": 106,
        backbone: 20,
        "content/Views/Indicators/Close": 143,
        "content/core/Views/View": 153,
        "content/messagingInterface": 155,
        jquery: "jquery",
        "modules/offers/content/iframe/models/Ciuvo": 160,
        "modules/offers/content/iframe/views/OffersIndicator": 166
      }
    ],
    168: [
      function (e, t, n) {
    ...
    169: [
      function (e, t, n) {
        ...
        const i = e("jquery"),
          ...
          s = e("backbone"),
          o = e("content/messagingInterface"),
          a = e("popup/Models/Tab");
        class l extends s.Model {
          static getInstance() {
            return this.instance || (this.instance = new this()), this.instance;
          }
          sync(e, t) {
            if (this._promise) return this._promise;
            const n = a.getInstance().fetch(),
              s = n.then(
                (e) =>
                  new i.Deferred((t) => {
                    o.publish("Tabs:getData", { tabId: e.id, classifier: "Adguard" }, (e) => {
                      t.resolve(e);
                    });
                  })
              ),
              l = n.then(
                ({ url: e }) =>
                  new i.Deferred((n) => {
                    o.publish("Adguard:isWhitelisted", { url: e }, (e) => n.resolve(e)),
                      t.on("change:whitelisted", (n, i) => {
                        null != t.previous("whitelisted") && o.publish("Adguard:setWhitelisted", { url: e, value: i });
                      });
                  })
              ),
              c = new i.Deferred((e) => {
                o.publish("Adguard:getCountTotal", null, (t) => {
                  e.resolve(t);
                });
              });
            return (
              (this._promise = i.when(s, l, c).done((e, n, i) => {
                const s = r.extend({ whitelisted: n, countTotal: i }, e);
                return t.set(s), s;
              })),
              o.subscribe("Tabs:change", ({ Adguard: e }) => {
                e && (t.set(e), o.publish("Adguard:getCountTotal", null, (e) => t.set({ countTotal: e })));
              }),
              this._promise
            );
          }
      ...
      { backbone: 20, "content/messagingInterface": 155, jquery: "jquery", "popup/Models/Tab": 170, underscore: 99 }
    ],
    170: [
      function (e, t, n) {
        "use strict";
          ...
          sync(e, t) {
            return (
              (this._pCurrentTab =
                this._pCurrentTab ||
                new i.Deferred((e) => {
                  o.publish("getCurrentTab", null, (n) => {
                    t.set(r.pick(n, ["id", "url"])), e.resolve(n);
                  });
                })),
              this._pCurrentTab.promise()
            );
          }
        }
        t.exports = a;
    ...
    171: [
      function (e, t, n) {
        ...
        const i = e("backbone"),
          r = e("content/core/Routing/AreasManagement/AreasManager"),
          s = e("content/core/Routing/Router"),
          o = e("popup/Views/Header"),
          a = e("popup/Views/Main/Privacy"),
          l = e("popup/Views/Main/Security"),
          c = e("popup/Views/Main/SecurityUnsafeContent"),
          u = e("popup/Views/Tabs"),
          d = e("popup/Views/Settings"),
          _ = e("popup/Views/Feedback"),
          p = e("popup/Views/Classification"),
          h = e("popup/core/Routing/AreasManagement/ViewTransitionStrategy"),
          f = e("popup/Views/Header/Domain"),
          b = e("popup/Views/Header/Classification"),
          g = e("content/Models/URLClassification").getInstance();
        t.exports = class extends s {
          constructor() {
            super(), (this._areasManager = new r(["page"], h));
          }
          static getInstance() {
            return this.instance || (this.instance = new this()), this.instance;
          }
          ...
          default() {
            return (g.isUnsafe() || g.get("hasUnsafeContent")) && "" === i.history.getFragment()
              ? this.navigate("dash/security", { trigger: !0, replace: !0 })
              : "dash/privacy" !== i.history.getFragment()
              ? this.navigate("dash/privacy", { trigger: !0, replace: !0 })
              : this.setAreas({ page: new p({ subviewConstructors: { Header: o, Tabs: u, Main: a, Domain: f, Classification: b } }) });
          }
          security() {
            if (!(g.isUnsafe() || g.get("hasUnsafeContent"))) return this.navigate("dash/privacy", { trigger: !0, replace: !0 });
            const e = g.get("hasUnsafeContent") ? c : l;
            return this.setAreas({ page: new p({ subviewConstructors: { Header: o, Tabs: u, Main: e, Domain: f, Classification: b } }) });
          }
          settings() {
            return this.setAreas({ page: new d() });
          }
          feedback() {
            return this.setAreas({ page: new _() });
          }
        };
      },
      {
        ...
        "content/Models/URLClassification": 137,
        "content/core/Routing/AreasManagement/AreasManager": 148,
        "content/core/Routing/Router": 151,
        "popup/Views/Classification": 173,
        "popup/Views/Feedback": 174,
        "popup/Views/Header": 175,
        "popup/Views/Header/Classification": 176,
        "popup/Views/Header/Domain": 177,
        "popup/Views/Main/Privacy": 179,
        "popup/Views/Main/Security": 180,
        "popup/Views/Main/SecurityUnsafeContent": 181,
        "popup/Views/Settings": 185,
        "popup/Views/Tabs": 186,
        "popup/core/Routing/AreasManagement/ViewTransitionStrategy": 191
      }
    ],
    172: [
      function (e, t, n) {
        ...
        const i = e("underscore"),
          r = e("content/Transitions/Default"),
          s = e("popup/Views/Page");
        class o extends r {
          execute(e) {
            if (this.from.xIndex === this.to.xIndex) return super.execute(e);
            this._handoverViewElement();
            let t = "-100%",
              n = "100%";
            return (
              this.from.xIndex > this.to.xIndex && ((t = "100%"), (n = "-100%")),
              this.to.render(),
              this.to.$el.css("left", n),
              this.from.$el.css("left", "0%"),
              this.to.show(),
              setTimeout(() => {
                this.from.$el.css("left", t),
                  this.to.$el.css("left", "0%"),
                  this.from.$el.on("transitionend", () => {
                    this.from.hide(), this.from.remove(), this.from.$el.remove(), e();
                  });
              }, 0)
            );
          }
        }
        i.extend(o, { from: s, to: s, weight: 10 }), (t.exports = o);
      },
      { "content/Transitions/Default": 140, "popup/Views/Page": 183, underscore: 99 }
    ],
    173: [
      function (e, t, n) {
        "use strict";
        const i = e("popup/Views/Page"),
          r = e("Classification.mustache"),
          s = e("popup/Models/Adguard");
        class o extends i.extend({ template: r, xIndex: 1 }) {
          initialize(e) {
            (this.model = s.getInstance()), i.prototype.initialize.call(this, e);
          }
          afterRender() {
            const e = this.$("#tabs"),
              t = this.$("#trackers-blocked-text");
            if (!e) return;
            if ((e.height() <= 0 && this.$(".counter-wrapper").addClass("notabs"), !t)) return;
            const n = this.$("#count-trackers").height() > 0;
            t.height() >= 50 && n && this.$(".counter-wrapper").addClass("ptxxs");
          }
        }
        t.exports = o;
      },
      { "Classification.mustache": 100, "popup/Models/Adguard": 169, "popup/Views/Page": 183 }
    ],
    174: [
      function (e, t, n) {
        "use strict";
        const i = e("popup/Views/base/BaseFeedback");
        t.exports = class extends i {};
      },
      { "popup/Views/base/BaseFeedback": 188 }
    ],
    175: [
      function (e, t, n) {
        "use strict";
        const i = e("content/core/Views/View"),
          r = e("Header.mustache"),
          s = e("popup/Views/Header/Extension"),
          o = i.extend({ el: "#header", template: r, subviewConstructors: { Extension: s } });
        t.exports = o;
      },
      { "Header.mustache": 102, "content/core/Views/View": 153, "popup/Views/Header/Extension": 178 }
    ],
    176: [
      function (e, t, n) {
        "use strict";
        const i = e("content/core/Views/View"),
          r = e("Header/Classification.mustache"),
          s = e("content/Models/URLClassification"),
          o = e("content/Models/I18n"),
          a = i.extend({
            template: r,
            _getTitleKey: (e) =>
              e.get("unsafe") || e.get("isMSE")
                ? "lb_unsafe_website"
                : e.get("isPUA") || e.get("hasUnsafeContent")
                ? "lb_unsafe_content_website"
                : "lb_safe_website",
            _getImage: (e) =>
              e.isUnsafe() || e.get("hasUnsafeContent") ? "/img/abs-attention-small-yellow.png" : "/img/abs-check-small.png",
            _getColour: (e) => (e.isUnsafe() || e.get("hasUnsafeContent") ? "red" : "green"),
            beforeRender() {
              const e = s.getInstance(),
                t = o.getInstance().get("strings");
              return { image: this._getImage(e), title: t[this._getTitleKey(e)], colour: this._getColour(e) };
            }
          });
        t.exports = a;
      },
      {
        "Header/Classification.mustache": 103,
        "content/Models/I18n": 132,
        "content/Models/URLClassification": 137,
        "content/core/Views/View": 153
      }
    ...
    177: [
      function (e, t, n) {
        "use strict";
        const i = e("content/core/Views/View"),
          r = e("Header/Domain.mustache"),
          s = e("underscore"),
          o = e("content/Models/URLClassification").getInstance(),
          a = i.extend({ template: r, beforeRender: (e) => s.extend(e, { domain: o.get("domain") || o.get("url") }) });
        t.exports = a;
      },
      { "Header/Domain.mustache": 104, "content/Models/URLClassification": 137, "content/core/Views/View": 153, underscore: 99 }
    ],
    178: [
      function (e, t, n) {
        "use strict";
        const i = e("content/core/Views/View"),
          r = e("Header/Extension.mustache"),
          s = e("browser_accessors/extensionAccessor"),
          o = e("underscore"),
          a = i.extend({ template: r, beforeRender: (e) => o.extend(e, { extName: s.getManifest().name }) });
        t.exports = a;
      },
      { "Header/Extension.mustache": 105, "browser_accessors/extensionAccessor": 4, "content/core/Views/View": 153, underscore: 99 }
    ],
    179: [
      function (e, t, n) {
        "use strict";
        const i = e("underscore"),
          r = e("messenger/Content").getInstance(),
          s = e("content/core/Views/View"),
          o = e("Main/Privacy.mustache"),
          a = e("content/Models/URLClassification").getInstance(),
          l = e("content/Models/Settings").getInstance(),
          c = e("popup/Models/Adguard");
        class u extends s.extend({
          el: "#main",
          template: o,
          events: { "change #toggle-blocked": "_toggleBlocked" },
          className: "flex--g1 flex main--safe"
        }) {
          initialize(e) {
            (this.model = c.getInstance()),
              this.listenTo(
                this.model,
                "change",
                (e) => {
                  null == e.changed.whitelisted && this.render();
                },
                this
              ),
          ...
          beforeRender(e) {
            const t = a.get("domain") || a.get("url"),
              n = t && t.length > 25 ? `${t.substring(0, 25)} ...` : t,
              r = l.get("adguard");
            return i.extend(e, { fullDomain: t, domain: n, adguard: r });
          }
          render() {
            s.prototype.render.call(this), (this.el.className = this.className);
          }
          _toggleBlocked() {
            const e = !this.model.get("whitelisted");
            this.model.set("whitelisted", e),
              r.publish("DNT:update", { exception: { domain: a.get("domain") || a.get("url"), action: e ? "allow" : "block" } });
          }
        }
        t.exports = u;
      },
      {
        "Main/Privacy.mustache": 108,
        "content/Models/Settings": 135,
        "content/Models/URLClassification": 137,
        "content/core/Views/View": 153,
        "messenger/Content": 71,
        "popup/Models/Adguard": 169,
        underscore: 99
      }
    ],
    180: [
      function (e, t, n) {
        "use strict";
        const i = e("content/core/Views/View"),
          r = e("Main/Security.mustache"),
          s = e("content/Models/URLClassification").getInstance(),
          o = e("content/Models/I18n"),
          a = e("content/messagingInterface"),
          l = e("content/mixpanel"),
          c = e("popup/Models/Tab").getInstance(),
          u = e("underscore"),
          d = e("popup/popupAccessor");
        class _ extends i.extend({
          el: "#main",
          events: {
          ...
          _takeMeAway(e) {
            e.preventDefault(),
              l.track("Classification - Take me back", { Domain: s.get("domain"), URL: s.get("url") }),
              a.publish("navigate", { tabId: c.get("id"), url: e.target.dataset.href }),
              d.close();
          }
          _toggleException(e) {
            e.preventDefault();
            ...
            let n, i;
            t
              ? ((n = "addException"), (i = "Classification - Add Exception"))
              : ((n = "removeException"), (i = "Classification - Remove Exception")),
              s.set("is_exempt", t),
              a.publish("AUCClassifier", { action: n, permanent: !0, tabId: c.get("id"), url: c.get("url") }),
              l.track(i, { Domain: s.get("domain"), URL: s.get("url") });
          }
          _mseTakeMeAway(e) {
            e.preventDefault(), a.publish("navigate", { url: e.target.dataset.href }), d.close();
          }
          beforeRender() {
            const e = o.getInstance().get("strings"),
              t = s.getCategoryName(),
              n = e[`msg_category_${t}`],
              i = e[`msg_category_${t}_sub`],
              r = 5 === s.get("category");
            return u.extend({}, s.toJSON(), { title: n, subtitle: i, image: "/img/abs-attention.png", isPUADownload: r });
          }
          render() {
            i.prototype.render.call(this), this.$el.css("height", "auto");
          }
        }
        t.exports = _;
      },
      {
        "Main/Security.mustache": 109,
        "content/Models/I18n": 132,
        "content/Models/URLClassification": 137,
        "content/core/Views/View": 153,
        "content/messagingInterface": 155,
        "content/mixpanel": 156,
        "popup/Models/Tab": 170,
        "popup/popupAccessor": 194,
        underscore: 99
      }
    ],
    181: [
      function (e, t, n) {
        "use strict";
        const i = e("content/core/Views/View"),
          r = e("Main/SecurityUnsafeContent.mustache"),
          s = e("content/Models/URLClassification").getInstance(),
          o = e("content/Models/I18n"),
          a = e("content/messagingInterface"),
          l = e("content/mixpanel"),
          ...
          d = i.extend({
            el: "#main",
            events: { "click #unsafe-content-toggle-details": "_toggleDetails", "change #cb-unsafe-content-exception": "_toggleException" },
            template: r,
            _toggleDetails(e) {
              e.preventDefault(),
                this.$(e.currentTarget).toggleClass("txt-toggler--active"),
                this.$("#unsafe-content-details").animate({ opacity: "toggle", height: "toggle" }),
                this.$("#security-details").animate({ opacity: "toggle", height: "toggle" });
            },
            _toggleException(e) {
              e.preventDefault();
              const t = e.target.checked;
              let n, i;
              t
                ? ((n = "addUCException"), (i = "UnsafeContent - Add Exception"))
                : ((n = "removeUCException"), (i = "UnsafeContent - Remove Exception")),
                s.set("hasUnsafeContentException", t),
                a.publish("AUCClassifier", { action: n, url: c.get("url") }),
                l.track(i, { Domain: s.get("domain"), URL: s.get("url") });
            },
            beforeRender() {
              const e = o.getInstance().get("strings"),
                ...
                n = e[`msg_category_${t}`],
                i = e[`msg_category_${t}_sub`];
              return u.extend({}, s.toJSON(), { title: n, subtitle: i, image: "/img/abs-check.png" });
            }
          });
        t.exports = d;
      },
      {
        "Main/SecurityUnsafeContent.mustache": 110,
        "content/Models/I18n": 132,
        "content/Models/URLClassification": 137,
        "content/core/Views/View": 153,
        "content/messagingInterface": 155,
    ...
    182: [
      function (e, t, n) {
        ...
        const i = e("jquery"),
          r = e("backbone"),
          s = e("popup/Views/Tooltip"),
          o = e("Menu/Help.mustache"),
          a = e("popup/Router"),
          l = e("popup/popupAccessor"),
          c = i("body");
        class u extends r.View {
          get el() {
            return "#menu";
          }
          get events() {
            return { "click .menu__close": "_closePopup", "click .menu__help": "_openHelp" };
          }
          _closePopup(e) {
            e.preventDefault(), l.close();
          }
          initialize(e) {
            r.View.prototype.initialize.call(this, e);
            const t = this.$(".menu__help");
            (this.helpMenu = new s({ owner: t, container: this.$el, position: "bottom", template: o })),
              a.getInstance().on("route", (e) => {
                this.$(".menu__item").removeClass("menu__item--active").filter(`[active="${e}"]`).addClass("menu__item--active");
              });
          }
          _openHelp(e) {
            e.preventDefault();
            const t = () => {
              c.off("click", t), this.helpMenu.remove();
            };
            if (i.contains(document, this.helpMenu.$el.get(0))) return t();
            this.helpMenu.render(), e.stopPropagation(), c.on("click", t);
          }
        }
        t.exports = u;
      },
      {
        "Menu/Help.mustache": 1,
        backbone: 20,
        jquery: "jquery",
        "popup/Router": 171,
        "popup/Views/Tooltip": 187,
        "popup/popupAccessor": 194
      }
    ],
    183: [
      function (e, t, n) {
        "use strict";
        const i = e("underscore"),
          r = e("content/core/Views/View");
        class s extends r.extend({ el: "#page", id: "page", className: "page flex flex--col" }) {
          render() {
            super.render();
          }
          onSubviewsRendered() {
            setTimeout(() => {
              const e = i.reduce(this.subviews, (e, t) => e + t.$el.outerHeight(), 0);
              this.$el.trigger("PageView:rendered", { height: e });
            }, 50);
          }
          goBack(e) {
      ...
      { "content/core/Views/View": 153, underscore: 99 }
    ],
    184: [
      function (e, t, n) {
        "use strict";
        const i = e("backbone"),
          r = e("popup/Views/Tooltip"),
          s = e("content/messagingInterface"),
          o = e("popup/popupAccessor"),
          a = e("popup/Models/Tab").getInstance(),
          l = e("content/Models/Settings");
        class c extends i.View {
          constructor() {
            super(),
              (this._tooltip = null),
              (this._tooltip$el = null),
              (this._removeTooltip = this._removeTooltip.bind(this)),
              (this._darkMode = l.getInstance().attributes.dark_mode);
          }
          initialize() {
            (this.model = l.getInstance()),
              this.listenTo(this.model, "change", (e) => {
                (this._darkMode = e.attributes.dark_mode), this.render();
              });
          }
          get el() {
            return "body";
          ...
          render() {
            i.View.prototype.render.call(this), this._updateMode();
          }
          get events() {
            return {
          ...
          _openLink(e) {
            e.preventDefault(), s.publish("navigate", { tabId: a.get("id"), url: e.target.href, as_separate: !0 }), o.close();
          }
          _showTooltip(e) {
            this._removeTooltip();
            const t = this.$(e.target);
            (this._tooltip$el = t),
              (this._tooltip = new r({ owner: t, container: this.$el })),
              this._tooltip.render(),
              t.on("mouseleave click", this._removeTooltip);
          }
          _removeTooltip() {
            this._tooltip &&
          ...
          _updateMode() {
            this._darkMode ? this.$el.addClass("theme-dark") : this.$el.removeClass("theme-dark");
          }
          _handleRenderedPage(e, t) {
            const n = this.$el.height();
            n && t.height > n && (this.$el.add("html").css("height", t.height), s.publish("Popup:resized", t)), this._updateMode();
          }
        }
        t.exports = c;
      },
    ...
    185: [
      function (e, t, n) {
        "use strict";
        const i = e("popup/Views/base/BaseSettings");
        t.exports = class extends i {};
      },
      { "popup/Views/base/BaseSettings": 189 }
    ],
    186: [
      function (e, t, n) {
        "use strict";
        const i = e("popup/Views/base/BaseTabs");
        t.exports = class extends i {};
      },
      { "popup/Views/base/BaseTabs": 190 }
    ],
    187: [
      function (e, t, n) {
        "use strict";
        const i = e("underscore"),
          ...
          o = r.extend({
            ...
            template: s,
            initialize(e) {
              i.extend(this, e), r.prototype.initialize.call(this, e);
            },
            beforeRender(e) {
              return i.extend(e, { message: this.owner.data("tooltip") });
            },
            render() {
              r.prototype.render.call(this), this.container.append(this.$el), this._reposition();
            },
            remove() {
              this.$el.remove();
            },
            _reposition() {
              const { top: e, left: t } = this.owner.offset(),
                n = this.$(".tooltip"),
                i = n.width(),
                r = n.height(),
                s = this.owner.width(),
                o = this.owner.height();
              let a, l;
              (a = "bottom" === this.position ? e + o + this.HORIZONTAL_OFFSET : e - r - this.HORIZONTAL_OFFSET),
                a < this.MIN_OFFSET_TOP && (n.addClass("tooltip--bottom"), (a = e + o + this.HORIZONTAL_OFFSET)),
                (l = "right" === this.position ? t + s / 2 - this.VERTICAL_OFFSET : t - i + s / 2 + this.VERTICAL_OFFSET),
                l < this.MIN_OFFSET_LEFT && (n.addClass("tooltip--right"), (l = t + s / 2 - this.VERTICAL_OFFSET)),
                n.css("top", a),
                n.css("left", l);
            }
          });
      ...
      { "Tooltip.mustache": 115, "content/core/Views/View": 153, underscore: 99 }
    ],
    188: [
      function (e, t, n) {
        "use strict";
        const i = e("jquery"),
          r = e("config"),
          s = e("content/mixpanel"),
          o = e("popup/Views/Page"),
          a = e("browser_accessors/extensionAccessor"),
          l = e("browser_accessors/BrowserNameAccessor"),
          c = e("Feedback/Feedback.mustache"),
          u = ["1", "2", "3", "4", "5"];
        class d extends o.extend({
          template: c,
          xIndex: 11,
          events: {
            "click .feedback__star": "_highlight",
            "click .feedback__back-button": "goBack",
            "click #feedback__ok-button": "goBack",
            "click #feedback__later-button": "goBack",
            "click #feedback__send-button": "_sendRating",
            "click #feedback__rate-now-button": "_openStoreLink"
          }
        }) {
          initialize(e) {
            super.initialize(e),
              (this.rating = 0),
              (this.stars = u.map((e) => ({ value: e }))),
              (this.showThankYou = !1),
              (this.showRateStore = !1),
              (this.rateStoreString = this._formatRateStoreString());
          }
          _highlight(e) {
            if (!e.target.id.includes("feedback__star")) return;
            const t = Number(e.target.id.substr(-1));
            if (t > this.rating) for (let e = this.rating + 1; e <= t; e++) i(`#feedback__star-${e}`).addClass("feedback__star-selected");
            else if (t < this.rating)
              for (let e = t + 1; e <= this.rating; e++) i(`#feedback__star-${e}`).removeClass("feedback__star-selected");
            this.rating = t;
          }
          _sendRating() {
            (this.showThankYou = !0),
              this.rating >= 4 && (this.showRateStore = !0),
              this.render(),
              s.track("SendFeedback", { rating: this.rating });
          }
          _formatRateStoreString() {
            const { lb_feedback_rate_store: e } = this.i18n;
            return (function (e, ...t) {
              let n = e;
              for (let e = 0; e < t.length; e++) {
                const i = new RegExp(`\\{${e}\\}`, "gm");
                n = n.replace(i, t[e]);
              }
              return n;
            })(e, a.getManifest().name, l.getBrowserName());
          }
          _openStoreLink() {
            let e = r.storeURLs.abs_chrome;
            const t = a.getManifest().name;
            l.isFirefox
              ? (e = r.storeURLs.abs_firefox)
              : l.isOpera
              ? (e = r.storeURLs.ss_opera)
              : l.isEdge
              ? (e = r.storeURLs.ss_edge)
              : l.isChrome && "Avira Safe Shopping" === t && (e = r.storeURLs.ss_chrome),
              window.open(e);
          }
          beforeRender() {
            return {
              ...
              showRateStore: this.showRateStore,
              rateStoreString: this.rateStoreString
            };
          }
        }
        t.exports = d;
      ...
      {
        "Feedback/Feedback.mustache": 101,
        "browser_accessors/BrowserNameAccessor": 3,
        "browser_accessors/extensionAccessor": 4,
        config: 131,
        "content/mixpanel": 156,
        jquery: "jquery",
        "popup/Views/Page": 183
      }
    ],
    189: [
      function (e, t, n) {
        ...
        const i = e("underscore"),
          r = e("jquery"),
          s = e("popup/Views/Page"),
          o = e("content/Models/Settings"),
          a = e("Settings/Settings.mustache"),
          l = e("Settings/Setting.mustache"),
          c = e("Settings/SettingsFooter.mustache"),
          u = e("content/mixpanel"),
          d = e("Subsettings"),
          _ = e("SettingDefaults.json"),
          p = e("config");
        class h extends s.extend({
          template: a,
          xIndex: 10,
          events: { "change input": "_toggleSetting", "click .settings__back-button": "goBack" },
          templates: { setting: l, footer: c }
        }) {
          initialize(e) {
            (this.model = o.getInstance()),
              super.initialize(e),
              this.listenTo(this.model, "change", (e) => {
                this._update(e.changed), this._updateDisabled();
              });
          }
          _update(e) {
            i.each(e, (e, t) => {
              const n = this.$el.find(`[name="${t}"]`);
              n.is("[type=checkbox]") ? (n[0].checked = e) : n.val(e);
            });
          }
          _toggleProp(e, t) {
            this.model.set(e, t), this.model.save();
          }
          _updateDisabled() {
            this.getSettings().forEach((e) => {
              const t = d[e];
              if (t) {
                this.$el.find(`[name="${e}"]`).prop("disabled", !this.model.get(t));
              }
            });
          }
          _trackSettingChange(e, t) {
            u.track(`Settings - Entry - Clicked -  ${e}`, { checked: t });
          }
          _toggleSetting(e) {
            const t = r(e.currentTarget).attr("name"),
              { checked: n } = e.currentTarget;
            return "extension_scan" !== t
              ? (this._toggleProp(t, n), this._trackSettingChange(t, n), !0)
              : (n
                  ? chrome.permissions.request(
                      { permissions: ["management"] },
                      (e) => (this._update({ extension_scan: e }), this._toggleProp(t, e), this._trackSettingChange(t, e), !0)
                    )
                  : chrome.permissions.remove(
                      { permissions: ["management"] },
                      (e) => (e && (this._toggleProp(t, n), this._trackSettingChange(t, n)), !0)
                    ),
                this._toggleProp(t, n),
                this._trackSettingChange(t, n),
                !0);
          }
          beforeRender(e) {
            return {
              settings: this.getSettings().map((t) => {
                const n = d[t];
                return {
                  name: t,
                  caption: this.i18n[`lb_setting_${t}`],
                  tooltip: this.i18n[`lb_setting_tooltip_${t}`],
                  value: e[t],
                  disabled: !!n && !e[n]
                };
              })
          ...
          getSettings() {
            const { supportedSettings: e } = p;
            return Object.keys(i.pick(_, (t, n) => e[n]));
          }
        }
        t.exports = h;
      },
      {
        "SettingDefaults.json": 5,
        "Settings/Setting.mustache": 111,
        "Settings/Settings.mustache": 112,
        "Settings/SettingsFooter.mustache": 113,
        Subsettings: 130,
        config: 131,
        "content/Models/Settings": 135,
        "content/mixpanel": 156,
    ...
    190: [
      function (e, t, n) {
        ...
        const i = e("backbone"),
          ...
          o = e("content/Models/I18n"),
          a = e("content/Models/URLClassification").getInstance();
        class l extends r.extend({ el: "#tabs", template: s }) {
          beforeRender() {
            const e = a.isUnsafe() || a.get("hasUnsafeContent"),
              t = o.getInstance().get("strings"),
              n = i.history.getFragment();
            return {
              sections: this.getSections(e).map((e) => ({
                name: e.path,
                title: t[e.localizationKey],
                active: n === e.path,
                elementId: e.path.replace("/", "_")
              }))
            };
          }
          getSections(e) {
            ...
            return (
              e &&
                t.push(
                  { path: "dash/security", localizationKey: "lb_tab_security" },
                  { path: "dash/privacy", localizationKey: "lb_tab_privacy" }
                ),
              t
            );
          }
    ...
    191: [
      function (e, t, n) {
        ...
        const i = e("content/core/Routing/AreasManagement/ViewTransitionStrategy"),
          r = e("content/Transitions/Default"),
          s = e("popup/Transitions/PageTransition");
        class o extends i {}
        (o.prototype._transitionList = { Default: r, PageTransition: s }), (t.exports = o);
      },
      {
        "content/Transitions/Default": 140,
        "content/core/Routing/AreasManagement/ViewTransitionStrategy": 149,
        "popup/Transitions/PageTransition": 172
      }
    ],
    192: [
      function (e, t, n) {
        "use strict";
        const i = e("popup/Router");
        t.exports = function () {
    ...
    193: [
      function (e, t, n) {
        "use strict";
        e("core-js/modules/es6.array.iterator.js"), e("core-js/modules/web.dom.iterable.js");
        const i = e("popup/Models/Tab"),
          r = e("popup/Models/Adguard"),
          s = e("content/Models/Settings");
        t.exports = function () {
          return Promise.all([i.getInstance().fetch(), r.getInstance().fetch(), s.getInstance().fetch()]);
        };
      },
      {
        "content/Models/Settings": 135,
