...
(self["webpackChunkbrowser_extension"] = self["webpackChunkbrowser_extension"] || []).push([
  [981],
  {
    /***/ 3388: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
***************************************************************************** */
    ...
    /***/ 1020: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      function toActionObject(action, actionFunctionMap) {
        ...
        if ((0, _utils_js__WEBPACK_IMPORTED_MODULE_0__ /* .isString */.HD)(action) || typeof action === "number") {
          ...
          if ((0, _utils_js__WEBPACK_IMPORTED_MODULE_0__ /* .isFunction */.mf)(exec)) {
            actionObject = (0, _virtual_tslib_js__WEBPACK_IMPORTED_MODULE_2__ /* .__assign */.pi)(
              (0, _virtual_tslib_js__WEBPACK_IMPORTED_MODULE_2__ /* .__assign */.pi)({}, action),
              {
                exec: exec
              }
            );
            ...
            actionObject = (0, _virtual_tslib_js__WEBPACK_IMPORTED_MODULE_2__ /* .__assign */.pi)(
              (0, _virtual_tslib_js__WEBPACK_IMPORTED_MODULE_2__ /* .__assign */.pi)(
                (0, _virtual_tslib_js__WEBPACK_IMPORTED_MODULE_2__ /* .__assign */.pi)({}, exec),
                action
              ),
              {
                type: actionType
      ...
      function resolveRaise(action, ctx, _event, delaysMap) {
        ...
        var resolvedEvent = (0, _utils_js__WEBPACK_IMPORTED_MODULE_0__ /* .toSCXMLEvent */.g5)(
          (0, _utils_js__WEBPACK_IMPORTED_MODULE_0__ /* .isFunction */.mf)(action.event)
        ...
        if ((0, _utils_js__WEBPACK_IMPORTED_MODULE_0__ /* .isString */.HD)(action.delay)) {
          ...
          resolvedDelay = (0, _utils_js__WEBPACK_IMPORTED_MODULE_0__ /* .isFunction */.mf)(configDelay)
            ? configDelay(ctx, _event.data, meta)
            : configDelay;
        } else {
          resolvedDelay = (0, _utils_js__WEBPACK_IMPORTED_MODULE_0__ /* .isFunction */.mf)(action.delay)
      ...
      function send(event, options) {
        return {
          ...
          event: (0, _utils_js__WEBPACK_IMPORTED_MODULE_0__ /* .isFunction */.mf)(event)
            ? event
            : (0, _utils_js__WEBPACK_IMPORTED_MODULE_0__ /* .toEventObject */._v)(event),
          delay: options ? options.delay : undefined,
          ...
          id:
            options && options.id !== undefined
              ? options.id
              : (0, _utils_js__WEBPACK_IMPORTED_MODULE_0__ /* .isFunction */.mf)(event)
              ? event.name
              : (0, _utils_js__WEBPACK_IMPORTED_MODULE_0__ /* .getEventType */.x6)(event)
        };
      }
      function resolveSend(action, ctx, _event, delaysMap) {
        ...
        var resolvedTarget = (0, _utils_js__WEBPACK_IMPORTED_MODULE_0__ /* .isFunction */.mf)(action.to)
      ...
      function sendParent(event, options) {
        return send(
          event,
          (0, _virtual_tslib_js__WEBPACK_IMPORTED_MODULE_2__ /* .__assign */.pi)(
            (0, _virtual_tslib_js__WEBPACK_IMPORTED_MODULE_2__ /* .__assign */.pi)({}, options),
            {
      ...
      var resolveLog = function (action, ctx, _event) {
        return (0, _virtual_tslib_js__WEBPACK_IMPORTED_MODULE_2__ /* .__assign */.pi)(
          (0, _virtual_tslib_js__WEBPACK_IMPORTED_MODULE_2__ /* .__assign */.pi)({}, action),
          {
            value: (0, _utils_js__WEBPACK_IMPORTED_MODULE_0__ /* .isString */.HD)(action.expr)
              ? action.expr
      ...
      function stop(actorRef) {
        var activity = (0, _utils_js__WEBPACK_IMPORTED_MODULE_0__ /* .isFunction */.mf)(actorRef)
          ? actorRef
      ...
      function resolveStop(action, context, _event) {
        var actorRefOrString = (0, _utils_js__WEBPACK_IMPORTED_MODULE_0__ /* .isFunction */.mf)(action.activity)
      ...
      function after(delayRef, id) {
        ...
        return ""
          .concat(_types_js__WEBPACK_IMPORTED_MODULE_3__ /* .ActionTypes.After */.M.After, "(")
          .concat(delayRef, ")")
          .concat(idSuffix);
      }
      /**
            ...
            var resolvedTarget =
              typeof originalTarget_1 === "function"
                ? originalTarget_1.apply(
                    void 0,
                    (0, _virtual_tslib_js__WEBPACK_IMPORTED_MODULE_2__ /* .__spreadArray */.ev)(
                      [],
                      (0, _virtual_tslib_js__WEBPACK_IMPORTED_MODULE_2__ /* .__read */.CR)(args),
                      false
                    )
                  )
                : originalTarget_1;
      ...
      var pluckAssigns = function (actionBlocks) {
        ...
        try {
          for (
            var actionBlocks_1 = (0, _virtual_tslib_js__WEBPACK_IMPORTED_MODULE_2__ /* .__values */.XA)(actionBlocks),
      ...
      function resolveActions(machine, currentState, currentContext, _event, actionBlocks, predictableExec, preserveActionOrder) {
        ...
        var updatedContext = assignActions.length
          ? (0, _utils_js__WEBPACK_IMPORTED_MODULE_0__ /* .updateContext */.dt)(currentContext, _event, assignActions, currentState)
          : currentContext;
        ...
        function handleAction(blockType, actionObject) {
          ...
          switch (actionObject.type) {
            ...
            case _actionTypes_js__WEBPACK_IMPORTED_MODULE_1__ /* .send */.lW:
              ...
              if (!_environment_js__WEBPACK_IMPORTED_MODULE_4__ /* .IS_PRODUCTION */.M) {
                ...
                (0, _utils_js__WEBPACK_IMPORTED_MODULE_0__ /* .warn */.ZK)(
                  !(0, _utils_js__WEBPACK_IMPORTED_MODULE_0__ /* .isString */.HD)(configuredDelay) || typeof sendAction.delay === "number", // tslint:disable-next-line:max-line-length
            ...
            case _actionTypes_js__WEBPACK_IMPORTED_MODULE_1__ /* .choose */.RN: {
              ...
              var matchedActions =
                (_a = chooseAction.conds.find(function (condition) {
                  ...
                  return (
                    !guard ||
                    (0, _utils_js__WEBPACK_IMPORTED_MODULE_0__ /* .evaluateGuard */.vx)(
                      machine,
                      guard,
                      updatedContext,
                      _event,
              ...
              var _b = (0, _virtual_tslib_js__WEBPACK_IMPORTED_MODULE_2__ /* .__read */.CR)(
                  resolveActions(
                    machine,
                    currentState,
                    updatedContext,
                    ...
                    [
                      {
                        ...
                        actions: toActionObjects(
                          (0, _utils_js__WEBPACK_IMPORTED_MODULE_0__ /* .toArray */.qo)(matchedActions),
            ...
            case _actionTypes_js__WEBPACK_IMPORTED_MODULE_1__ /* .pure */.Le: {
              ...
              var _c = (0, _virtual_tslib_js__WEBPACK_IMPORTED_MODULE_2__ /* .__read */.CR)(
                  resolveActions(
                    machine,
                    currentState,
                    updatedContext,
            ...
            case _actionTypes_js__WEBPACK_IMPORTED_MODULE_1__ /* .assign */.f0: {
              updatedContext = (0, _utils_js__WEBPACK_IMPORTED_MODULE_0__ /* .updateContext */.dt)(
                updatedContext,
                _event,
                [actionObject],
                !predictableExec ? currentState : undefined
            ...
            default:
              ...
              if (predictableExec) {
                ...
                var wrapped = (0, _virtual_tslib_js__WEBPACK_IMPORTED_MODULE_2__ /* .__assign */.pi)(
                  (0, _virtual_tslib_js__WEBPACK_IMPORTED_MODULE_2__ /* .__assign */.pi)({}, resolvedActionObject),
                  {
                    exec: function (_ctx) {
                      var args = [];
        ...
        function processBlock(block) {
          ...
          try {
            for (
              var _b = (0, _virtual_tslib_js__WEBPACK_IMPORTED_MODULE_2__ /* .__values */.XA)(block.actions), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var action = _c.value;
    ...
    /***/ 8351: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      function mapFilterValues(collection, iteratee, predicate) {
        ...
        try {
          for (
            var _b = (0, _virtual_tslib_js__WEBPACK_IMPORTED_MODULE_1__ /* .__values */.XA)(Object.keys(collection)), _c = _b.next();
            !_c.done;
            _c = _b.next()
          ) {
            var key = _c.value;
      ...
      var path = function (props) {
        return function (object) {
          ...
          try {
            for (
              var props_1 = (0, _virtual_tslib_js__WEBPACK_IMPORTED_MODULE_1__ /* .__values */.XA)(props), props_1_1 = props_1.next();
              !props_1_1.done;
      ...
      function nestedPath(props, accessorProp) {
        return function (object) {
          ...
          try {
            for (
              var props_2 = (0, _virtual_tslib_js__WEBPACK_IMPORTED_MODULE_1__ /* .__values */.XA)(props), props_2_1 = props_2.next();
              !props_2_1.done;
      ...
      function flatten(array) {
        ...
        return (_a = []).concat.apply(
          ...
          (0, _virtual_tslib_js__WEBPACK_IMPORTED_MODULE_1__ /* .__spreadArray */.ev)(
            [],
            (0, _virtual_tslib_js__WEBPACK_IMPORTED_MODULE_1__ /* .__read */.CR)(array),
            false
          )
        );
      }
      ...
      function mapContext(mapper, context, _event) {
        ...
        try {
          for (
            var _b = (0, _virtual_tslib_js__WEBPACK_IMPORTED_MODULE_1__ /* .__values */.XA)(Object.keys(mapper)), _c = _b.next();
            !_c.done;
            _c = _b.next()
          ) {
            var key = _c.value;
      ...
      function partition(items, predicate) {
        ...
        try {
          for (
            var items_1 = (0, _virtual_tslib_js__WEBPACK_IMPORTED_MODULE_1__ /* .__values */.XA)(items), items_1_1 = items_1.next();
            !items_1_1.done;
        ...
        var updatedContext = context
          ? assignActions.reduce(function (acc, assignAction) {
              ...
              if (isFunction(assignment)) {
                ...
                try {
                  for (
                    var _b = (0, _virtual_tslib_js__WEBPACK_IMPORTED_MODULE_1__ /* .__values */.XA)(Object.keys(assignment)),
                      _c = _b.next();
                    !_c.done;
                    _c = _b.next()
                  ) {
      ...
      function toTransitionConfigArray(event, configLike) {
        var transitions = toArrayStrict(configLike).map(function (transitionLike) {
          ...
          return (0, _virtual_tslib_js__WEBPACK_IMPORTED_MODULE_1__ /* .__assign */.pi)(
            (0, _virtual_tslib_js__WEBPACK_IMPORTED_MODULE_1__ /* .__assign */.pi)({}, transitionLike),
            {
              event: event
            }
          );
      ...
      function reportUnhandledExceptionOnInvocation(originalError, currentError, id) {
        if (!_environment_js__WEBPACK_IMPORTED_MODULE_2__ /* .IS_PRODUCTION */.M) {
          ...
          if (originalError === currentError) {
            // tslint:disable-next-line:no-console
            console.error(
              "Missing onError handler for invocation '".concat(id, "', error was '").concat(originalError, "'.").concat(originalStackTrace)
            );
          } else {
            var stackTrace = currentError.stack ? " Stacktrace was '".concat(currentError.stack, "'") : ""; // tslint:disable-next-line:no-console

            console.error(
              "Missing onError handler and/or unhandled exception/promise rejection for invocation '".concat(id, "'. ") +
                "Original error: '"
      ...
      function isRaisableAction(action) {
        return (
          (action.type === _actionTypes_js__WEBPACK_IMPORTED_MODULE_3__ /* .raise */.OU ||
            (action.type === _actionTypes_js__WEBPACK_IMPORTED_MODULE_3__ /* .send */.lW &&
              action.to === _types_js__WEBPACK_IMPORTED_MODULE_4__ /* .SpecialTargets.Internal */.K.Internal)) &&
