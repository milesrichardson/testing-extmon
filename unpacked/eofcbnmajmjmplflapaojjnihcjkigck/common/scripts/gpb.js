(function (AvastWRC, PROTO) {
  ...
  var GPBD = {
    bytes: function (id, repeated) {
      return gpbType(id, repeated, function () {
        return PROTO.bytes;
      });
    },
  ...
  AvastWRC.gpb.All = PROTO.Message("AvastWRC.gpb.All", {
    LocalServerRequest: PROTO.Message("AvastWRC.gpb.All.LocalServerRequest", {
      ...
      type: GPBD.cType(1, PROTO.optional, function () {
        return AvastWRC.gpb.All.LocalServerRequest.CommandType;
      }),
      params: GPBD.bytes(2, PROTO.repeated),
      browser: GPBD.cType(3, PROTO.optional, function () {
        return AvastWRC.gpb.All.LocalServerRequest.BrowserType;
      })
    }),
  ...
  AvastWRC.gpb.All.Identity = PROTO.Message("AvastWRC.gpb.All.Identity", {
    ...
    token: GPBD.bytes(3),
    auid: GPBD.bytes(4),
    browserType: GPBD.cType(5, PROTO.optional, function () {
      return AvastWRC.gpb.All.BrowserType;
    }),
  ...
  AvastWRC.gpb.All.UrlInfo = PROTO.Message("AvastWRC.gpb.All.UrlInfo", {
    webrep: GPBD.cType(1, PROTO.optional, function () {
      return AvastWRC.gpb.All.WebRep;
    }),
    phishing: GPBD.cType(2, PROTO.optional, function () {
      return AvastWRC.gpb.All.PhishingNew;
    }),
    blocker: GPBD.cType(3, PROTO.optional, function () {
      return AvastWRC.gpb.All.Blocker;
    }),
    typo: GPBD.cType(4, PROTO.optional, function () {
      return AvastWRC.gpb.All.Typo;
    }),
    safeShop: GPBD.cType(5, PROTO.optional, function () {
      return AvastWRC.gpb.All.SafeShop;
    }),
    ajax: GPBD.cType(7, PROTO.optional, function () {
      return AvastWRC.gpb.All.Ajax;
    })
  });
  ...
  AvastWRC.gpb.All.Origin = PROTO.Message("AvastWRC.gpb.All.Origin", {
    origin: GPBD.cType(1, PROTO.optional, function () {
      return AvastWRC.gpb.All.OriginType;
    }),
    hash: GPBD.int32(2)
  });
  ...
  AvastWRC.gpb.All.UrlInfoRequest = PROTO.Message("AvastWRC.gpb.All.UrlInfoRequest", {
    Request: PROTO.Message("AvastWRC.gpb.All.UrlInfoRequest.Request", {
      ...
      apikey: GPBD.bytes(4),
      identity: GPBD.cType(5, PROTO.optional, function () {
        return AvastWRC.gpb.All.Identity;
      }),
      visited: GPBD.bool(6),
      udpateRequest: GPBD.cType(7, PROTO.optional, function () {
        return AvastWRC.gpb.All.UpdateRequest;
      }),
      requestedServices: GPBD.sint32(8),
      customKeyValue: GPBD.cType(9, PROTO.repeated, function () {
        return AvastWRC.gpb.All.KeyValue;
      }),
      referer: GPBD.string(10),
      windowNum: GPBD.sint32(11),
      tabNum: GPBD.sint32(12),
      windowEvent: GPBD.cType(13, PROTO.optional, function () {
        return AvastWRC.gpb.All.EventType;
      }),
      origin: GPBD.cType(14, PROTO.optional, function () {
        return AvastWRC.gpb.All.OriginType;
      }),
      dnl: GPBD.bool(15),
      ...
      client: GPBD.cType(18, PROTO.optional, function () {
        return AvastWRC.gpb.All.Client;
      }),
      originHash: GPBD.int32(19),
      lastOrigin: GPBD.cType(20, PROTO.optional, function () {
        return AvastWRC.gpb.All.Origin;
      }),
      clientTimestamp: GPBD.int64(21)
    }),
    Response: PROTO.Message("AvastWRC.gpb.All.UrlInfoRequest.Response", {
      urlInfo: GPBD.cType(1, PROTO.repeated, function () {
        return AvastWRC.gpb.All.UrlInfo;
      }),
      updateResponse: GPBD.cType(2, PROTO.optional, function () {
        return AvastWRC.gpb.All.UpdateResponse;
      })
    })
  });
  ...
  AvastWRC.gpb.All.Typo = PROTO.Message("AvastWRC.gpb.All.Typo", {
    ...
    urlInfo: GPBD.cType(3, PROTO.optional, function () {
      return AvastWRC.gpb.All.UrlInfo;
    }),
    is_typo: GPBD.bool(4)
  });
  ...
  AvastWRC.gpb.All.WebRep = PROTO.Message("AvastWRC.gpb.All.WebRep", {
    ...
    rating_level: GPBD.cType(5, PROTO.optional, function () {
      return AvastWRC.gpb.All.RatingLevel;
    })
  });
  ...
  AvastWRC.gpb.All.Client = PROTO.Message("AvastWRC.gpb.All.Client", {
    id: GPBD.cType(1, PROTO.optional, function () {
      return AvastWRC.gpb.All.AvastIdentity;
    }), // all kinds of Avast's identities
    type: GPBD.cType(2, PROTO.optional, function () {
      return AvastWRC.gpb.All.Client.CType;
    }), // request's send-from source
    browserExtInfo: GPBD.cType(3, PROTO.optional, function () {
      return AvastWRC.gpb.All.BrowserExtInfo;
  ...
  AvastWRC.gpb.All.BrowserExtInfo = PROTO.Message("AvastWRC.gpb.All.BrowserExtInfo", {
    extensionType: GPBD.cType(1, PROTO.optional, function () {
      return AvastWRC.gpb.All.ExtensionType;
    }),
    extensionVersion: GPBD.sint32(2),
    browserType: GPBD.cType(3, PROTO.optional, function () {
      return AvastWRC.gpb.All.BrowserType;
    }),
    browserVersion: GPBD.string(4),
    os: GPBD.cType(5, PROTO.optional, function () {
      return AvastWRC.gpb.All.OS;
    }),
    ...
    AvastWRC.gpb.All.SafeShopOffer = PROTO.Message("AvastWRC.gpb.All.SafeShopOffer", {
      ...
      ClientInfo: PROTO.Message("AvastWRC.gpb.All.SafeShopOffer.ClientInfo", {
        Browser: PROTO.Message("AvastWRC.gpb.All.SafeShopOffer.ClientInfo.Browser", {
          ...
          type: GPBD.cType(1, PROTO.optional, function () {
            return AvastWRC.gpb.All.SafeShopOffer.ClientInfo.Browser.BrowserType;
          }), // same values as on UrlInfo-> BrowserType
        ...
        Extension: PROTO.Message("AvastWRC.gpb.All.SafeShopOffer.ClientInfo.Extension", {
          ...
          type: GPBD.cType(1, PROTO.optional, function () {
            return AvastWRC.gpb.All.SafeShopOffer.ClientInfo.Extension.ExtensionType;
          }), // same values as on UrlInfo ExtensionType
          version: GPBD.string(2, PROTO.optional)
        }),
        ...
        UserSettings: PROTO.Message("AvastWRC.gpb.All.SafeShopOffer.ClientInfo.UserSettings", {
          Advanced: PROTO.Message("AvastWRC.gpb.All.SafeShopOffer.ClientInfo.UserSettings.Advanced", {
            OffersConfigs: PROTO.Message("AvastWRC.gpb.All.SafeShopOffer.ClientInfo.UserSettings.Advanced.OffersConfigs", {
              OffersVisibility: PROTO.Enum(
                "AvastWRC.gpb.All.SafeShopOffer.ClientInfo.UserSettings.Advanced.OffersConfigs.OffersVisibility",
                {
                  SHOW_ALL_OFFERS: 0,
              ...
              //  accommodation = 2
              //  special = 4
              offers_visibility: GPBD.cType(3, PROTO.optional, function () {
                return AvastWRC.gpb.All.SafeShopOffer.ClientInfo.UserSettings.Advanced.OffersConfigs.OffersVisibility;
              }),
            ...
            CouponsConfigs: PROTO.Message("AvastWRC.gpb.All.SafeShopOffer.ClientInfo.UserSettings.Advanced.CouponsConfigs", {
              CouponsVisibility: PROTO.Enum(
                "AvastWRC.gpb.All.SafeShopOffer.ClientInfo.UserSettings.Advanced.CouponsConfigs.CouponsVisibility",
                {
                  SHOW_ALWAYS: 0,
              ...
              coupons_visibility: GPBD.cType(1, PROTO.optional, function () {
                return AvastWRC.gpb.All.SafeShopOffer.ClientInfo.UserSettings.Advanced.CouponsConfigs.CouponsVisibility;
              }),
              include_flag: GPBD.int32(2, PROTO.optional) //  bit mask:
              //  eShop = 1
              //  accommodation = 2
            ...
            RedirectConfigs: PROTO.Message("AvastWRC.gpb.All.SafeShopOffer.ClientInfo.UserSettings.Advanced.RedirectConfigs", {
              RedirectVisibility: PROTO.Enum(
                "AvastWRC.gpb.All.SafeShopOffer.ClientInfo.UserSettings.Advanced.RedirectConfigs.RedirectVisibility",
                {
                  SHOW_ALWAYS: 0,
                  DO_NOT_NOTIFY: 1
                }
              ...
              redirect_visibility: GPBD.cType(1, PROTO.optional, function () {
                return AvastWRC.gpb.All.SafeShopOffer.ClientInfo.UserSettings.Advanced.RedirectConfigs.RedirectVisibility;
              })
            }),

            offers_configs: GPBD.cType(1, PROTO.optional, function () {
              return AvastWRC.gpb.All.SafeShopOffer.ClientInfo.UserSettings.Advanced.OffersConfigs;
            }),
            coupons_configs: GPBD.cType(2, PROTO.optional, function () {
              return AvastWRC.gpb.All.SafeShopOffer.ClientInfo.UserSettings.Advanced.CouponsConfigs;
            }),
            redirect_configs: GPBD.cType(3, PROTO.optional, function () {
              return AvastWRC.gpb.All.SafeShopOffer.ClientInfo.UserSettings.Advanced.RedirectConfigs;
            })
          }),

          show_automatic: GPBD.bool(1, PROTO.optional), // same values as on UrlInfo ExtensionType
          advanced: GPBD.cType(2, PROTO.optional, function () {
            return AvastWRC.gpb.All.SafeShopOffer.ClientInfo.UserSettings.Advanced;
          }),
        ...
        browser: GPBD.cType(4, PROTO.optional, function () {
          return AvastWRC.gpb.All.SafeShopOffer.ClientInfo.Browser;
        }),
        extension: GPBD.cType(5, PROTO.optional, function () {
          return AvastWRC.gpb.All.SafeShopOffer.ClientInfo.Extension;
        }),
        client: GPBD.cType(6, PROTO.optional, function () {
          return AvastWRC.gpb.All.SafeShopOffer.ClientInfo.Client;
        }),
        guid: GPBD.string(7, PROTO.optional),
        campaign_id: GPBD.string(8, PROTO.optional),
        user_settings: GPBD.cType(9, PROTO.optional, function () {
          return AvastWRC.gpb.All.SafeShopOffer.ClientInfo.UserSettings;
        }),
      ...
      ScraperRequest: PROTO.Message("AvastWRC.gpb.All.SafeShopOffer.ScraperRequest", {
        client_info: GPBD.cType(1, PROTO.optional, function () {
          return AvastWRC.gpb.All.SafeShopOffer.ClientInfo;
        }),
      ...
      ScraperResponse: PROTO.Message("AvastWRC.gpb.All.SafeShopOffer.ScraperResponse", {
        ...
        scraper: GPBD.cType(1, PROTO.repeated, function () {
          return AvastWRC.gpb.All.SafeShopOffer.ScraperResponse.ProviderScraper;
        }),
      ...
      OfferRequest: PROTO.Message("AvastWRC.gpb.All.SafeShopOffer.OfferRequest", {
        ...
        provider_query: GPBD.cType(2, PROTO.repeated, function () {
          return AvastWRC.gpb.All.SafeShopOffer.OfferRequest.ProviderQuery;
        }),
        url: GPBD.string(3, PROTO.optional),
        url_info_flag: GPBD.cType(4, PROTO.optional, function () {
          return AvastWRC.gpb.All.SafeShopOffer.OfferRequest.UrlinfoFlags;
        }),
        notification_flags: GPBD.cType(5, PROTO.optional, function () {
          return AvastWRC.gpb.All.SafeShopOffer.OfferRequest.NotificationFlags;
        }),
      ...
      OfferResponse: PROTO.Message("AvastWRC.gpb.All.SafeShopOffer.OfferResponse", {
        ...
        Product: PROTO.Message("AvastWRC.gpb.All.SafeShopOffer.OfferResponse.Product", {
          offer: GPBD.cType(1, PROTO.optional, function () {
            return AvastWRC.gpb.All.SafeShopOffer.OfferResponse.GeneralOffer;
          }),
        ...
        Accommodation: PROTO.Message("AvastWRC.gpb.All.SafeShopOffer.OfferResponse.Accommodation", {
          ...
          type: GPBD.cType(8, PROTO.optional, function () {
            return AvastWRC.gpb.All.SafeShopOffer.OfferResponse.Accommodation.AccommodationType;
          }),
        ...
        Voucher: PROTO.Message("AvastWRC.gpb.All.SafeShopOffer.OfferResponse.Voucher", {
          ...
          type: GPBD.cType(10, PROTO.optional, function () {
            return AvastWRC.gpb.All.SafeShopOffer.OfferResponse.Voucher.VoucherType;
          }),
        ...
        Redirect: PROTO.Message("AvastWRC.gpb.All.SafeShopOffer.OfferResponse.Redirect", {
          ...
          category: GPBD.cType(12, PROTO.optional, function () {
            return AvastWRC.gpb.All.SafeShopOffer.OfferResponse.Redirect.RedirectCategory;
          }),
          sub_category: GPBD.cType(13, PROTO.optional, function () {
            return AvastWRC.gpb.All.SafeShopOffer.OfferResponse.Redirect.RedirectSubCategory;
          }),
        ...
        Notification: PROTO.Message("AvastWRC.gpb.All.SafeShopOffer.OfferResponse.Notification", {
          ...
          type: GPBD.cType(1, PROTO.optional, function () {
            return AvastWRC.gpb.All.SafeShopOffer.OfferResponse.Notification.NotificationType;
          }),
          name: GPBD.string(2, PROTO.optional),
          deep_integration: GPBD.cType(3, PROTO.repeated, function () {
            return AvastWRC.gpb.All.SafeShopOffer.OfferResponse.DeepIntegrationRule;
          })
        }),

        query: GPBD.cType(1, PROTO.repeated, function () {
          return AvastWRC.gpb.All.SafeShopOffer.OfferResponse.Query;
        }),
        product: GPBD.cType(2, PROTO.repeated, function () {
          return AvastWRC.gpb.All.SafeShopOffer.OfferResponse.Product;
        }),
        accommodation: GPBD.cType(3, PROTO.repeated, function () {
          return AvastWRC.gpb.All.SafeShopOffer.OfferResponse.Accommodation;
        }),
        voucher: GPBD.cType(4, PROTO.repeated, function () {
          return AvastWRC.gpb.All.SafeShopOffer.OfferResponse.Voucher;
        }),
        context_voucher: GPBD.cType(5, PROTO.repeated, function () {
          return AvastWRC.gpb.All.SafeShopOffer.OfferResponse.Voucher;
        }),
        redirect: GPBD.cType(6, PROTO.repeated, function () {
          return AvastWRC.gpb.All.SafeShopOffer.OfferResponse.Redirect;
        }),
        notification: GPBD.cType(7, PROTO.optional, function () {
          return AvastWRC.gpb.All.SafeShopOffer.OfferResponse.Notification;
        })
      }),
      ...
      SearchCouponResponse: PROTO.Message("AvastWRC.gpb.All.SafeShopOffer.SearchCouponResponse", {
        voucher: GPBD.cType(1, PROTO.repeated, function () {
          return AvastWRC.gpb.All.SafeShopOffer.OfferResponse.Voucher;
        })
      }),
      /**********************************************************************/
      ...
      SearchOfferResponse: PROTO.Message("AvastWRC.gpb.All.SafeShopOffer.SearchOfferResponse", {
        product: GPBD.cType(1, PROTO.repeated, function () {
          return AvastWRC.gpb.All.SafeShopOffer.OfferResponse.Product;
        }),
        accommodation: GPBD.cType(2, PROTO.repeated, function () {
          return AvastWRC.gpb.All.SafeShopOffer.OfferResponse.Accommodation;
        })
      })
    });
