...
(function ($) {
  ...
  AvastWRC.USettings = AvastWRC.USettings || {
    ...
    bind: function (data, tab) {
      ...
      $("#asp-poppup-settings-save").hover(
        function (e) {
          e.preventDefault();
        ...
        function (e) {
          e.preventDefault();
          if (
            AvastWRC.USettings.data.poppupSettingsNew.menuOpt.notifications.settingsChanged ||
    ...
    AdvancedOptionsChanges: function (e, data) {
      if (
        data.poppupSettings.menuOpt.notifications.offers.showAlways === data.poppupSettingsNew.menuOpt.notifications.offers.showAlways &&
        ...
        data.poppupSettings.menuOpt.notifications.accommodations.showBetter ===
          data.poppupSettingsNew.menuOpt.notifications.accommodations.showBetter &&
        data.poppupSettings.menuOpt.notifications.accommodations.showSimilar ===
          data.poppupSettingsNew.menuOpt.notifications.accommodations.showSimilar &&
        data.poppupSettings.menuOpt.notifications.accommodations.showPopular ===
          data.poppupSettingsNew.menuOpt.notifications.accommodations.showPopular &&
    ...
    SelectAccommodationsOptions: function (e, data) {
      ...
      if (e.target.id.indexOf("accommodationsShowBetter") !== -1 || e.currentTarget.id.indexOf("accommodationsShowBetter") !== -1) {
        ...
        e.target.id.indexOf("accommodationsShowSimilar") !== -1 ||
        e.currentTarget.id.indexOf("accommodationsShowSimilar") !== -1
      ) {
        ...
        e.target.id.indexOf("accommodationsShowPopular") !== -1 ||
        e.currentTarget.id.indexOf("accommodationsShowPopular") !== -1
      ) {
    ...
    AddSite: function (e, data) {
      ...
      if (!site || site === "") {
        ...
        $(".asp-p-cl-sites-box").append(
          Mustache.render(AvastWRC.Templates.whiteListElement, { site: site, icon: data.poppupSettings.images.erase })
        );
        $(".asp-p-cl-box-element-close").unbind("click", AvastWRC.USettings.RemoveSite);
        $(".asp-p-cl-box-element-close").click(function (e) {
    ...
    PrivacyCheckboxToggle: function (e, data) {
      $(".asp-middle-panel-privacy-image").css(
        "background-image",
        'url("' +
          (data.poppupSettingsNew.menuOpt.privacy.accepted
            ? data.poppupSettings.images.checkbox
            : data.poppupSettings.images.checkboxChecked) +
          '")'
      );
    ...
    SaveNewSettings: function (e, data) {
      ...
      if (data.poppupSettingsNew.menuOpt.notifications.settingsChanged) {
        ...
        data.poppupSettings.menuOpt.notifications.accommodations.showBetter = data.poppupSettingsNew.menuOpt.notifications.accommodations
          .showBetter
          ? true
          : false;
        data.poppupSettings.menuOpt.notifications.accommodations.showSimilar = data.poppupSettingsNew.menuOpt.notifications.accommodations
          .showSimilar
          ? true
          : false;
        data.poppupSettings.menuOpt.notifications.accommodations.showPopular = data.poppupSettingsNew.menuOpt.notifications.accommodations
          .showPopular
          ? true
          : false;
        data.poppupSettings.menuOpt.notifications.coupons.showAlways = data.poppupSettingsNew.menuOpt.notifications.coupons.showAlways
        ...
        AvastWRC.USettings.originalSettings.menuOpt.notifications.offers.showAlways = data.poppupSettingsNew.menuOpt.notifications.offers
          .showAlways
          ? true
          : false;
        AvastWRC.USettings.originalSettings.menuOpt.notifications.offers.showBetter = data.poppupSettingsNew.menuOpt.notifications.offers
          .showBetter
          ? true
          : false;
        AvastWRC.USettings.originalSettings.menuOpt.notifications.offers.hide = data.poppupSettingsNew.menuOpt.notifications.offers.hide
          ? true
          : false;
        AvastWRC.USettings.originalSettings.menuOpt.notifications.accommodations.showBetter = data.poppupSettingsNew.menuOpt.notifications
          .accommodations.showBetter
          ? true
          : false;
        AvastWRC.USettings.originalSettings.menuOpt.notifications.accommodations.showSimilar = data.poppupSettingsNew.menuOpt.notifications
          .accommodations.showSimilar
          ? true
          : false;
        AvastWRC.USettings.originalSettings.menuOpt.notifications.accommodations.showPopular = data.poppupSettingsNew.menuOpt.notifications
          .accommodations.showPopular
          ? true
          : false;
        AvastWRC.USettings.originalSettings.menuOpt.notifications.coupons.showAlways = data.poppupSettingsNew.menuOpt.notifications.coupons
          .showAlways
          ? true
          : false;
        AvastWRC.USettings.originalSettings.menuOpt.notifications.coupons.showOnce = data.poppupSettingsNew.menuOpt.notifications.coupons
          .showOnce
          ? true
          : false;
        AvastWRC.USettings.originalSettings.menuOpt.notifications.coupons.hide = data.poppupSettingsNew.menuOpt.notifications.coupons.hide
          ? true
          : false;
        AvastWRC.USettings.originalSettings.menuOpt.notifications.others.showAlways = data.poppupSettingsNew.menuOpt.notifications.others
          .showAlways
          ? true
          : false;
      }
      if (data.poppupSettingsNew.menuOpt.customList.settingsChanged) {
        data.poppupSettingsNew.menuOpt.customList.settingsChanged = AvastWRC.USettings.listAreDifferents(
          AvastWRC.USettings.originalSettings.menuOpt.customList.whiteList,
          data.poppupSettingsNew.menuOpt.customList.whiteList.slice()
        );
        if (data.poppupSettingsNew.menuOpt.customList.settingsChanged) {
      ...
      if (data.poppupSettingsNew.menuOpt.defaultMenuChanged) {
        ...
        AvastWRC.USettings.originalSettings.menuOpt.notifications.selected = data.poppupSettingsNew.menuOpt.notifications.selected
          ? true
          : false;
      ...
      if (
        data.poppupSettingsNew.menuOpt.notifications.settingsChanged ||
