...
<div class="unsync-header sync-message-hidden">
  ...
  <div class="unsync-header-message sync-message-error">
    <div class="unsync-message-box">
      <i class="material-icons md-24" role="img" aria-hidden="true">error</i>
      &nbsp;
      <span id="sync-reload-page-message">${translate("unsync_error_msg_part_1")}&nbsp;&nbsp;&nbsp;${translate(
        "unsync_error_msg_part_2"
      )}&nbsp;&nbsp;&nbsp;${unsyncErrorMsgPart3.anchorPrefixText}<span class="sync-message-link">${unsyncErrorMsgPart3.anchorText}</span>${
        unsyncErrorMsgPart3.anchorPostfixText
      }</span>
    </div>
  </div>
</div>`;
