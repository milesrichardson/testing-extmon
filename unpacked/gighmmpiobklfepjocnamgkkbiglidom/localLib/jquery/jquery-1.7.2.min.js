      ...
      removeAttr: function (a, b) {
        ...
        if (b && a.nodeType === 1) {
          ...
          for (; i < g; i++)
            (e = d[i]),
              e &&
                ((c = f.propFix[e] || e), (h = u.test(e)), h || f.attr(a, e, ""), a.removeAttribute(v ? e : c), h && c in a && (a[c] = !1));
        }
      },
      attrHooks: {
        type: {
          ...
          if (typeof l == "string")
            if (!_.test(l)) l = b.createTextNode(l);
              ...
              !f.support.leadingWhitespace && X.test(l) && p.insertBefore(b.createTextNode(X.exec(l)[0]), p.firstChild),
                (l = p.childNodes),
                p &&
                  (p.parentNode.removeChild(p), q.length > 0 && ((r = q[q.length - 1]), r && r.parentNode && r.parentNode.removeChild(r)));
            }
          var u;
