      ...
      if (!(a.nodeType === 3 || a.nodeType === 8 || !c || !d || !(h = f._data(a)))) {
        ...
        for (k = 0; k < c.length; k++) {
          (l = A.exec(c[k]) || []),
            ...
            (s = f.event.special[m] || {}),
            (o = f.extend(
              { type: m, origType: l[1], data: e, handler: d, guid: d.guid, selector: g, quick: G(g), namespace: n.join(".") },
              p
            )),
            (r = j[m]);
          if (!r) {
    ...
    f.expr &&
      ...
      ((f.expr.filters.hidden = function (a) {
        var b = a.offsetWidth,
          c = a.offsetHeight;
        return (
          (b === 0 && c === 0) || (!f.support.reliableHiddenOffsets && ((a.style && a.style.display) || f.css(a, "display")) === "none")
        );
      }),
      ...
      ajax: function (a, c) {
        ...
        h.promise(v),
          ...
          d.crossDomain == null &&
            ...
            (d.crossDomain = !(
              !r ||
              (r[1] == bW[1] && r[2] == bW[2] && (r[3] || (r[1] === "http:" ? 80 : 443)) == (bW[3] || (bW[1] === "http:" ? 80 : 443)))
            ))),
  ...
  f.ajaxSetup({
    ...
    f.ajaxPrefilter("json jsonp", function (b, c, d) {
      ...
      if (b.dataTypes[0] === "jsonp" || (b.jsonp !== !1 && (ce.test(b.url) || (e && ce.test(b.data))))) {
        ...
        b.jsonp !== !1 &&
          ((j = j.replace(ce, l)),
          b.url === j && (e && (k = k.replace(ce, l)), b.data === k && (j += (/\?/.test(j) ? "&" : "?") + b.jsonp + "=" + h))),
          (b.url = j),
          (b.data = k),
          (a[h] = function (a) {
            g = [a];
