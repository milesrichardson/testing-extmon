...
!(function (e, t) {
  ...
  return (function e() {
    ...
    if (((n.version = "2.2.6"), (n.removed = []), !t || !t.document || 9 !== t.document.nodeType)) return (n.isSupported = !1), n;
    var r = t.document,
      o = t.document,
    ...
    var de = {};
    n.isSupported = le && void 0 !== le.createHTMLDocument && 9 !== me;
    var pe = z,
      ge = H,
      he = U,
      ye = j,
    ...
    var et = "http://www.w3.org/1998/Math/MathML",
      ...
      ft = function (e) {
        ...
        if (
          ...
          return ot(e), !0;
        if (!Ae[r] || ke[r]) {
          if (Ue && !Be[r]) for (var o = ne(e), i = te(e), a = i.length - 1; a >= 0; --a) o.insertBefore(Q(i[a], !0), ee(e));
          return ot(e), !0;
        }
    ...
    return (
      (n.sanitize = function (e, o) {
        ...
        for (var m = lt(je ? e : i); (s = m.nextNode()); )
          (3 === s.nodeType && s === u) || ft(s) || (s.content instanceof a && pt(s.content), dt(s), (u = s));
