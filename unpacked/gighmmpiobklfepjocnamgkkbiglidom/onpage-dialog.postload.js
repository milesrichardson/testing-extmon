/******/ (() => {
      ...
      (function (global, factory) {
        ...
        function createDOMPurify() {
          ...
          var _parseConfig = function _parseConfig(cfg) {
            ...
            DATA_URI_TAGS =
              "ADD_DATA_URI_TAGS" in cfg ? addToSet(clone(DEFAULT_DATA_URI_TAGS), cfg.ADD_DATA_URI_TAGS) : DEFAULT_DATA_URI_TAGS;
  ...
  (() => {
    ...
    var purify = __webpack_require__(245); // CONCATENATED MODULE: ./adblock-betafish/fonts/lato.woff
    ...
    connect();
    /* harmony default export */ const js_api_api = /* unused pure expression or super */ null && api_api; // CONCATENATED MODULE: ./adblockplusui/js/api/index.ts
    ...
    function loadResources(base) {
      ...
      document.fonts.add(
        new FontFace("Material Icons", `url("${MaterialIcons_Regular_woff2_namespaceObject}")`, { style: "normal", weight: "normal" })
      );
    }
