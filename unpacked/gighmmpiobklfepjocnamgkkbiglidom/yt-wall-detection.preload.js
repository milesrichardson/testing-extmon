/******/ (() => {
  ...
  (() => {
    ...
    var browser_polyfill = __webpack_require__(935); // CONCATENATED MODULE: ./src/yt-wall-detection/shared/messages.types.ts
    const youTubeWallDetected = "yt-site.ad-wall-detected";
    const youTubeNavigation = "yt-site.navigation"; // CONCATENATED MODULE: ./src/yt-wall-detection/content/detection.ts
    ...
    start(); // CONCATENATED MODULE: ./src/yt-wall-detection/content/index.ts
  })();
