  ...
  .then(function (values) {
    ...
    prefNames.forEach(function (prefName) {
      ...
      if (prefSchema.type === "boolean") {
        ...
        renderPreference = renderBooleanPref(prefSchema.title, prefSchema.description, prefName);
    ...
    chrome.storage.onChanged.addListener(function (changes, areaName) {
      var prefs = areaName === storageAreaName ? userPrefs : areaName === "managed" ? managedPrefs : null;
      if (prefs) {
        renderedPrefNames.forEach(function (prefName) {
