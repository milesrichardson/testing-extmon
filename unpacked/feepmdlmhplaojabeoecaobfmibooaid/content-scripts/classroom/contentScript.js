        ...
        if (element == parentLinkItem) {
          ...
          if (linkAddress.indexOf("id=") == -1) {
              ...
              if (classroomOpenWith) {
                ...
                if (createButton == null) {
                  ...
                  if (setPossTeacherRole) {
                    extensionAddress +=
                      "https://drive.google.com/uc?id=" + driveId + "&export=download&filename=" + aria + "&ClassroomTeacherSrc=true";
                  } else {
                    extensionAddress +=
            ...
            if (classroomOpenWith) {
              ...
              extensionAddress = "https://orbit.texthelp.com/?file=";
              extensionAddress +=
                "https://drive.google.com/uc?id=" + address[0] + "&export=download&filename=" + aria + "&ClassroomRetUrl=" + activeLocation;
              location.href = extensionAddress;
            }
          }
        }
