!(function (t) {
  ...
  function (t, n, e) {
    ...
    if (e(8)) {
      var r = e(30),
        ...
        Wt = function (t, n, e) {
          return !(Ut(t, (n = b(n, !0))) && x(e) && m(e, "value")) ||
            m(e, "get") ||
            m(e, "set") ||
            e.configurable ||
      ...
      bt || ((W.f = Dt), (D.f = Wt)),
        u(u.S + u.F * !bt, "Object", { getOwnPropertyDescriptor: Dt, defineProperty: Wt }),
        o(function () {
          pt.call({});
        }) &&
          (pt = ht =
      ...
      h(Bt, Ct),
        p(Bt, vt, Ct.values),
        h(Bt, { slice: Rt, set: Nt, constructor: function () {}, toString: pt, toLocaleString: jt }),
        kt(Bt, "buffer", "b"),
        kt(Bt, "byteOffset", "o"),
        kt(Bt, "byteLength", "l"),
        kt(Bt, "length", "e"),
            ...
            : (o(function () {
              ...
              ((v = e(function (t, e, r, i) {
                ...
                return (
                  f(t, v, s),
                  x(e)
                    ? e instanceof Y || "ArrayBuffer" == (o = w(e)) || "SharedArrayBuffer" == o
                      ? void 0 !== i
                        ? new y(e, _t(r, n), i)
                        : void 0 !== r
                        ? new y(e, _t(r, n))
    ...
    t.exports = function (t, n, e, d, g, y) {
      ...
      if (
        ...
        E ||
          ...
          (x.constructor = m)),
          (I || A) && (O("delete"), O("has"), g && O("get")),
          (A || T) && O(w),
          y && x.clear && delete x.clear;
      } else (m = d.getConstructor(n, t, g, w)), u(m.prototype, e), (c.NEED = !0);
  ...
  function (t, n, e) {
    ...
    t.exports = function (t, n, e, v, d, g, y) {
      ...
      var b,
        ...
        _ = !1,
        T = t.prototype,
        I = T[l] || T["@@iterator"] || (d && T[d]),
        E = I || x(d),
        A = d ? (O ? x("entries") : E) : void 0,
        k = ("Array" == n && T.entries) || I;
      if (
        (k && (w = f(k.call(new t()))) !== Object.prototype && w.next && (s(w, S, !0), r || "function" == typeof w[l] || u(w, l, h)),
        O &&
          I &&
          "values" !== I.name &&
          ((_ = !0),
        ...
        if (((b = { values: O ? E : x("values"), keys: g ? E : x("keys"), entries: A }), y)) for (m in b) m in T || o(T, m, b[m]);
        else i(i.P + i.F * (p || _), n, b);
      return b;
    };
  },
  function (t, n, e) {
  ...
  function (t, n, e) {
    ...
    (p && h) ||
      ...
      "process" == e(23)(l)
        ...
        : v
        ? ((o = (i = new v()).port2), (i.port1.onmessage = m), (r = u(o.postMessage, o, 1)))
  ...
  function (t, n, e) {
    ...
    function M(t, n, e) {
      ...
      for (
        (t = _(t)) != t || t === S
          ...
          : ((r = I(E(t) / A)),
            t * (o = T(2, -r)) < 1 && (r--, (o *= 2)),
            (t += r + s >= 1 ? f / o : f * T(2, 1 - s)) * o >= 2 && (r++, (o /= 2)),
            r + s >= a
              ? ((i = 0), (r = a))
              : r + s >= 1
              ? ((i = (t * o - 1) * T(2, n)), (r += s))
              : ((i = t * T(2, s - 1) * T(2, n)), (r = 0)));
        n >= 8;
        u[l++] = 255 & i, i /= 256, n -= 8
      );
    ...
    if (u.ABV) {
      ...
      (b = function (t) {
        ...
        i && (W(b, "byteLength", "_l"), W(m, "buffer", "_b"), W(m, "byteLength", "_l"), W(m, "byteOffset", "_o")),
        a(m.prototype, {
          getInt8: function (t) {
    ...
    y(b, "ArrayBuffer"), y(m, "DataView"), c(m.prototype, u.VIEW, !0), (n.ArrayBuffer = b), (n.DataView = m);
  },
  function (t, n) {
    var e = (t.exports =
      "undefined" != typeof window && window.Math == Math
  ...
  function (t, n) {
    var e = {
      ...
      sendRequest: function (t, n, r, i) {
        ...
        if (
          new RegExp("https://" + e.LaunchpadUri).test("https://betalaunchpad.classlink.com") ||
          new RegExp("https://" + e.LaunchpadUri).test("https://betamyapps.classlink.com")
        )
          n = "https://analytics-log-beta.classlink.io" + n;
        else n = "https://analytics-log.classlink.io" + n;
        o.open(t, n, !0),
          ...
          (o.onreadystatechange = function () {
            4 === o.readyState &&
              (200 === o.status
                ...
                : i({ status: o.status, statusText: o.statusText, responseText: o.responseText }));
          }),
          o.send();
      },
          ...
          (e.LaunchpadUri = t.LaunchpadUri),
            e.sendRequest("POST", "/launch/v1p0/launch?applicationId=" + encodeURIComponent(i.appid), i.gwstoken, function (t, i) {
              if (t) console.log(t);
                ...
                try {
                  (i = JSON.parse(i)),
                    (e.clOpenTabs[r] = { lapse: 0, interval: null, windowId: n, launchToken: i.launchToken }),
                    chrome.tabs.query({ active: !0, windowId: n }, function (t) {
      ...
      appAnalyticsActivity: function (t, n) {
        Object.keys(e.clOpenTabs).forEach(function (t) {
          e.clOpenTabs[t] &&
            e.clOpenTabs[t].interval &&
            chrome.windows.get(e.clOpenTabs[t].windowId, function (n) {
              "minimized" == n.state
                ? (clearInterval(e.clOpenTabs[t].interval), (e.clOpenTabs[t].interval = null))
                : chrome.tabs.query({ active: !0, windowId: e.clOpenTabs[t].windowId }, function (n) {
          ...
          e.clOpenTabs &&
            e.clOpenTabs[n] &&
            !e.clOpenTabs[n].interval &&
            (e.clOpenTabs[n].interval = setInterval(function () {
              chrome.windows.get(e.clOpenTabs[n].windowId, function (t) {
                "minimized" != t.state
                  ? ((e.clOpenTabs[n].lapse += 10),
                    3e5 == e.clOpenTabs[n].lapse &&
                      ((e.clOpenTabs[n].lapse = 0),
                      e.sendRequest(
                        "POST",
                        "/activity/v1p0/activity?launchToken=" + encodeURIComponent(e.clOpenTabs[n].launchToken) + "&activeS=300",
                        null,
                        function (t, r) {
                          if (t) {
                            if (t.status && 400 == t.status && t.responseText)
                              try {
                                ...
                                if (i.statusCode && 400 == i.statusCode && i.message && "Invalid launchToken" == i.message)
                                  return (
                                    clearInterval(e.clOpenTabs[n].interval), (e.clOpenTabs[n].interval = null), void delete e.clOpenTabs[n]
                                  );
                              } catch (t) {}
                            console.log(t);
                          } else;
      ...
      fnFocusChanged: function (t) {
        t == chrome.windows.WINDOW_ID_NONE
          ? Object.keys(e.clOpenTabs).forEach(function (t) {
              e.clOpenTabs[t] && e.clOpenTabs[t].interval
                ? chrome.windows.get(e.clOpenTabs[t].windowId, function (n) {
                ...
                : chrome.windows.getAll(function (t) {
                    ...
                    chrome.tabs.query({ active: !0, windowId: n.id }, function (t) {
          ...
          : chrome.windows.get(t, function (n) {
              "minimized" == n.state
                ? Object.keys(e.clOpenTabs).forEach(function (n) {
                    e.clOpenTabs[n] &&
                      e.clOpenTabs[n].interval &&
                      e.clOpenTabs[n].windowId == t &&
                      (clearInterval(e.clOpenTabs[n].interval), (e.clOpenTabs[n].interval = null));
                  })
                : (Object.keys(e.clOpenTabs).forEach(function (n) {
                    e.clOpenTabs[n] &&
                      e.clOpenTabs[n].interval &&
                  ...
                  chrome.tabs.query({ active: !0, windowId: t }, function (n) {
      ...
      fnRemoved: function (t, n) {
        e.clOpenTabs &&
          ...
          e.sendRequest(
            "POST",
            "/activity/v1p0/close?launchToken=" +
              encodeURIComponent(e.clOpenTabs[t].launchToken) +
              "&activeS=" +
              encodeURIComponent(Math.ceil(e.clOpenTabs[t].lapse / 1e3)),
            null,
            function (n, r) {
              if (n) {
                if (n.status && 400 == n.status && n.responseText)
                  try {
                    ...
                    if (i.statusCode && 400 == i.statusCode && i.message && "Invalid launchToken" == i.message)
                      return clearInterval(e.clOpenTabs[t].interval), (e.clOpenTabs[t].interval = null), void delete e.clOpenTabs[t];
                  } catch (t) {}
                console.log(n);
    ...
    chrome.tabs.onActivated.addListener(function (t) {
      ...
      chrome.windows.onRemoved.addListener(function (t) {
        Object.keys(e.clOpenTabs).forEach(function (t) {
          chrome.windows.get(e.clOpenTabs[t].windowId, function (n) {
            "minimized" == n.state && e.clOpenTabs[t].interval
              ? (clearInterval(e.clOpenTabs[t].interval), (e.clOpenTabs[t].interval = null))
              : e.appAnalyticsActivity(e.clOpenTabs[t].windowId, t);
          });
        });
      }),
      ...
      chrome.webNavigation.onCommitted.addListener(function (t) {
        t &&
          0 == t.frameId &&
          ("typed" == t.transitionType || ("generated" == t.transitionType && "from_address_bar" == t.transitionQualifiers)) &&
          e.fnRemoved(t.tabId, t);
      }),
                  ...
                  try {
                    c
                      ? (i || (2 == t._h && N(t), (t._h = 1)),
                        ...
                        e === n.promise ? s(O("Promise-chain cycle")) : (o = M(e)) ? o.call(e, a, s) : a(e))
                      : s(r);
                  } catch (t) {
                    f && !u && f.exit(), s(t);
                  }
    ...
    var r = e(1),
      ...
      H = function (t, n, e) {
        return (
          ...
          i(W, n)
            ? (e.enumerable
                ? (i(t, N) && t[N][n] && (t[N][n] = !1), (e = _(e, { enumerable: O(0, !1) })))
                : (i(t, N) || F(t, N, O(1, {})), (t[N][n] = !0)),
              K(t, n, e))
            : F(t, n, e)
        );
      },
      ...
      Z = function (t, n) {
        if (((t = x(t)), (n = S(n, !0)), t !== G || !i(W, n) || i(B, n))) {
          var e = P(t, n);
      ...
      (c(
        (j = function () {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function (e) {
              this === G && n.call(B, e), i(this, N) && i(this[N], t) && (this[N][t] = !1), K(this, t, O(1, e));
            };
          return o && q && K(G, t, { configurable: !0, set: n }), Y(t);
        }).prototype,
        "toString",
        function () {
          return this._k;
      ...
      "Array",
      {
        from: function (t) {
          var n,
            ...
            y = 0,
            b = f(p);
          if ((g && (d = r(d, v > 2 ? arguments[2] : void 0, 2)), null == b || (h == Array && c(b))))
            for (e = new h((n = a(p.length))); n > y; y++) s(e, y, g ? d(p[y], y) : p[y]);
          else for (l = b.call(p), e = new h(); !(i = l.next()).done; y++) s(e, y, g ? u(l, d, [i.value, y], !0) : i.value);
          return (e.length = y), e;
        }
      }
    );
    ...
    if (
      ...
      s = function (t, n) {
        ...
        return !e && r && t.constructor === s && o
          ? t
          : i(v ? new f(r && !o ? t.source : t, n) : f((r = t instanceof s) ? t.source : t, r && o ? a.call(t) : n), e ? this : l, s);
      };
      for (
        var d = function (t) {
            (t in s) ||
        ...
        [
          ...
          function (t, n) {
            ...
            for (var w = 0, x = 0, S = []; x < p.length; ) {
              ...
              var O,
                _ = a(b, h ? p : p.slice(x));
              if (null === _ || (O = l(c(b.lastIndex + (h ? 0 : x)), p.length)) === w) x = u(p, x, g);
              else {
  ...
  function (t, n, e) {
    ...
    p &&
      h &&
      (a((r = s.getConstructor(y, "WeakMap")).prototype, b),
      (c.NEED = !0),
  ...
  function (t, n, e) {
    ...
    t.exports = function t(n, e, a, s, f, l, p, h) {
      for (var v, d, g = f, y = 0, b = !!p && u(p, h, 3); y < s; ) {
        if (y in a) {
          if (((v = b ? b(a[y], y, e) : a[y]), (d = !1), i(v) && (d = void 0 !== (d = v[c]) ? !!d : r(v)), d && l > 0))
  ...
  function (t, n, e) {
    for (
      ...
      var g,
        ...
        m = u[y],
        w = m && m.prototype;
      if (w && (w[f] || c(w, f, p), w[l] || c(w, l, y), (a[y] = p), b)) for (g in r) w[g] || o(w, g, r[g], !0);
    }
  },
  function (t, n, e) {
    var r = (function (t) {
  ...
  function (t, n, e) {
            ...
            function (t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    (o = !0), (u = !1), (c = void 0), (t.prev = 3), (a = e.tasks[Symbol.iterator]());
                  case 5:
                    if ((o = (f = a.next()).done)) {
                      t.next = 51;
                      break;
                  ...
                  case 32:
                    return (
                      (g = t.sent) && g.error
                        ? d.args.elseThenSkipTo && (i = d.args.elseThenSkipTo)
                        : d.args.ifThenSkipTo && (i = d.args.ifThenSkipTo),
                      1 == parseInt(e.debug) && console.log("TASK:Result => TabId:" + n + ", Type:" + d.type + ",  result: finished"),
                      t.abrupt("break", 48)
                    );
                  case 36:
                  ...
                  case 51:
                    ...
                    break;
                  case 53:
                    (t.prev = 53), (t.t1 = t.catch(3)), (u = !0), (c = t.t1);
                  case 57:
    ...
    function d(t, n) {
      ...
      (e +=
        " s.textContent = \"(function() { var interval = setInterval(function() { if(window.CloudApp && window.CloudApp.MyApps) { window.CloudApp.MyApps.Controller.openRDPClient('" +
        n +
        "'); clearInterval(interval); } }, 700); })();\";"),
        (e += " document.head.appendChild(s);"),
        chrome.tabs.executeScript(t, { code: e });
    }
    function g(t, n) {
    ...
    chrome.tabs.onCreated.addListener(function (t) {
      setTimeout(function () {
        a &&
          r &&
          r.app_id &&
          r.windowId == t.windowId &&
          r.tabId == t.openerTabId &&
          (i.CLAnalytics.appAnalyticsLaunch(r, r.windowId, t.id), (r = null));
      }, 300);
    }),
        ...
        "initiate-sso-tasks" == t.type
          ...
          ? ((o = t.data),
            ...
            chrome.tabs.onUpdated.addListener(function t(n, e, r) {
              if (n === u && (e.url && (c = !0), "complete" === e.status && c)) {
                  ...
                  !(function (t, n, e, r) {
                    ...
                    switch (u) {
                      ...
                      case 27:
                        ...
                        (f +=
                          " s.textContent = \"(function() { var interval = setInterval(function() { if(window.CloudApp && window.CloudApp.MyApps) { window.CloudApp.MyApps.Controller.launchLocalApp('" +
                          s +
                          "'); clearInterval(interval); } }, 700); })();\";"),
                          (f += " document.head.appendChild(s);"),
                          chrome.tabs.executeScript(n, { code: f });
                        break;
                      case 28:
          ...
          : "initiate-apptimer" == t.type
          ? (r = { app_id: t.data.app_id, windowId: s, tabId: l, gwstoken: t.data.gwstoken, LaunchpadUri: t.data.LaunchpadUri })
          : "initiate-ssosignout" == t.type
          ? t.data &&
            t.data.length > 0 &&
            t.data.forEach(function (t) {
              chrome.tabs.create({ url: t, active: !1 });
            })
          : "stopapptimers" == t.type &&
            (Object.keys(i.CLAnalytics.clOpenTabs).forEach(function (t) {
      ...
      chrome.windows.onCreated.addListener(function (t) {
        t &&
          ...
          chrome.windows.getAll(function (t) {
            if (1 == t.length) {
              var n = [
                btoa("islogin_betalaunchpad.classlink.com"),
                btoa("islogin_stagingclouddesktop.classlink.com"),
                btoa("islogin_launchpad.classlink.com")
              ];
    ...
    chrome.windows.getAll({ populate: !0 }, function (t) {
      for (var n, e = 0, r = t.length; e < r; e++)
        for (var i, o = 0, u = (n = t[e]).tabs.length; o < u; o++)
          (i = n.tabs[o]),
            new RegExp(
              "^https:\\/\\/(betalaunchpad\\.classlink\\.com|stagingclouddesktop\\.classlink\\.com|launchpad\\.classlink\\.com|my\\.classlink\\.eu|betamyapps\\.classlink\\.com|stagingmyapps\\.classlink\\.com|myapps\\.classlink\\.com)"
            ).test(i.url) && y(i);
    });
  }
]);
