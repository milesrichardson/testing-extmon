!(function (t) {
  ...
  function (t, n, e) {
    ...
    t.exports = function (t, n) {
      ...
      return function (n, c, v) {
        for (var d, g, y = i(n), m = o(y), w = r(c, v, 3), b = u(m.length), x = 0, S = e ? h(n, b) : a ? h(n, 0) : void 0; b > x; x++)
          if ((p || x in m) && ((g = w((d = m[x]), x, y)), t))
            if (e) S[x] = g;
            else if (g)
              switch (t) {
                case 3:
  ...
  function (t, n, e) {
    ...
    if (e(8)) {
      var r = e(30),
        ...
        Ut = function (t, n, e) {
          return !(Dt(t, (n = m(n, !0))) && x(e) && w(e, "value")) ||
            w(e, "get") ||
            w(e, "set") ||
            e.configurable ||
      ...
      mt || ((U.f = Vt), (V.f = Ut)),
        u(u.S + u.F * !mt, "Object", { getOwnPropertyDescriptor: Vt, defineProperty: Ut }),
        i(function () {
          pt.call({});
        }) &&
          (pt = ht =
      ...
      h(Gt, Lt),
        p(Gt, vt, Lt.values),
        h(Gt, { slice: Nt, set: Ct, constructor: function () {}, toString: pt, toLocaleString: jt }),
        Mt(Gt, "buffer", "b"),
        Mt(Gt, "byteOffset", "o"),
        Mt(Gt, "byteLength", "l"),
        Mt(Gt, "length", "e"),
          ...
          w
            ? ((v = e(function (t, e, r, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (x(e)) {
                  if (!(e instanceof K || "ArrayBuffer" == (a = b(e)) || "SharedArrayBuffer" == a))
                    return wt in e ? Ot(v, e) : Pt.call(v, e);
                  (i = e), (h = Et(r, n));
                  var y = e.byteLength;
                  if (void 0 === o) {
            ...
            : (i(function () {
              ...
              ((v = e(function (t, e, r, o) {
                ...
                return (
                  f(t, v, s),
                  x(e)
                    ? e instanceof K || "ArrayBuffer" == (i = b(e)) || "SharedArrayBuffer" == i
                      ? void 0 !== o
                        ? new y(e, Et(r, n), o)
                        : void 0 !== r
                        ? new y(e, Et(r, n))
  ...
  function (t, n, e) {
    ...
    t.exports = function (t, n, e, v, d, g, y) {
      ...
      var m,
        ...
        E = !1,
        A = t.prototype,
        k = A[l] || A["@@iterator"] || (d && A[d]),
        R = k || x(d),
        O = d ? (_ ? x("entries") : R) : void 0,
        M = ("Array" == n && A.entries) || k;
      if (
        (M && (b = f(M.call(new t()))) !== Object.prototype && b.next && (s(b, S, !0), r || "function" == typeof b[l] || u(b, l, h)),
        _ &&
          k &&
          "values" !== k.name &&
          ((E = !0),
        ...
        if (((m = { values: _ ? R : x("values"), keys: g ? R : x("keys"), entries: O }), y)) for (w in m) w in A || i(A, w, m[w]);
    ...
    if (u.ABV) {
      if (
        ...
        for (
          ...
          (B = H[X++]) in m || c(m, B, _[B]);
        i || (J.constructor = m);
      }
      var K = new w(new m(2)),
        z = w.prototype.setInt8;
      ...
      (m = function (t) {
        ...
        o && (U(m, "byteLength", "_l"), U(w, "buffer", "_b"), U(w, "byteLength", "_l"), U(w, "byteOffset", "_o")),
        a(w.prototype, {
          getInt8: function (t) {
      ...
      e(2)(function () {
        ...
        ? function (t, n) {
            for (var e = c(t), s = arguments.length, f = 1, l = i.f, p = u.f; s > f; )
              for (var h, v = a(arguments[f++]), d = l ? o(v).concat(l(v)) : o(v), g = d.length, y = 0; g > y; )
                  ...
                  try {
                    c
                      ? (o || (2 == t._h && C(t), (t._h = 1)),
                        ...
                        e === n.promise ? s(_("Promise-chain cycle")) : (i = F(e)) ? i.call(e, a, s) : a(e))
                      : s(r);
                  } catch (t) {
                    f && !u && f.exit(), s(t);
                  }
  ...
  function (t, n, e) {
    ...
    var r = e(1),
      ...
      Y = function (t, n, e) {
        return (
          ...
          o(U, n)
            ? (e.enumerable
                ? (o(t, C) && t[C][n] && (t[C][n] = !1), (e = E(e, { enumerable: _(0, !1) })))
                : (o(t, C) || I(t, C, _(1, {})), (t[C][n] = !0)),
              X(t, n, e))
            : I(t, n, e)
        );
      },
    ...
    B ||
      ...
      (e(45).f = Q),
      (R.f = tt),
      i && !e(30) && c(W, "propertyIsEnumerable", Q, !0),
      (v.f = function (t) {
        return K(h(t));
      })),
      ...
      "Array",
      {
        from: function (t) {
          var n,
            ...
            y = 0,
            m = f(p);
          if ((g && (d = r(d, v > 2 ? arguments[2] : void 0, 2)), null == m || (h == Array && c(m))))
            for (e = new h((n = a(p.length))); n > y; y++) s(e, y, g ? d(p[y], y) : p[y]);
          else for (l = m.call(p), e = new h(); !(o = l.next()).done; y++) s(e, y, g ? u(l, d, [o.value, y], !0) : o.value);
          return (e.length = y), e;
        }
      }
    );
    ...
    if (
      ...
      s = function (t, n) {
        ...
        return !e && r && t.constructor === s && i
          ? t
          : o(v ? new f(r && !i ? t.source : t, n) : f((r = t instanceof s) ? t.source : t, r && i ? a.call(t) : n), e ? this : l, s);
      };
      for (
        var d = function (t) {
            (t in s) ||
      ...
      return [
        ...
        function (t, n) {
          ...
          for (var b, x = "", S = 0, _ = 0; _ < m.length; _++) {
            w = m[_];
            for (var E = String(w[0]), A = s(f(u(w.index), p.length), 0), k = [], R = 1; R < w.length; R++)
              k.push(void 0 === (b = w[R]) ? b : String(b));
            var O = w.groups;
            if (h) {
        ...
        [
          ...
          function (t, n) {
            ...
            for (var b = 0, x = 0, S = []; x < p.length; ) {
              ...
              var _,
                E = a(m, h ? p : p.slice(x));
              if (null === E || (_ = l(c(m.lastIndex + (h ? 0 : x)), p.length)) === b) x = u(p, x, g);
              else {
  ...
  function (t, n, e) {
    ...
    t.exports = function t(n, e, a, s, f, l, p, h) {
      for (var v, d, g = f, y = 0, m = !!p && u(p, h, 3); y < s; ) {
        if (y in a) {
          if (((v = m ? m(a[y], y, e) : a[y]), (d = !1), o(v) && (d = void 0 !== (d = v[c]) ? !!d : r(v)), d && l > 0))
          ...
          ((f = !p && b && void 0 !== b[s]) && c(m, s)) ||
            ...
            (m[s] =
              h && "function" != typeof b[s]
                ...
                ? i(Function.call, l)
                : l),
            d && (((m.virtual || (m.virtual = {}))[s] = l), t & a.R && w && !w[s] && u(w, s, l)));
      };
    ...
    !(function (t) {
      t(document).on("click", ".loginProcess,.js-uc", function () {
        if ("bg-info js-uc" == t(this).attr("class")) {
          var n = {
              appResponse: JSON.parse(
                t("head")[0]
                  .innerHTML.match(/appResponse:(.*)/g)[0]
                  .replace(/^appResponse: JSON.parse\(\'/, "")
                  .replace(/'\),$/, "")
                  .replace(/\\'/g, "'")
              ),
              gwstokenMd5: t("head")[0]
                .innerHTML.match(/gwstokenMd5:(.*)/g)[0]
                .replace(/^gwstokenMd5: "/, "")
                .replace(/",$/, "")
            },
      ...
      t.extend(n.prototype, {
        ...
        handleIfSelector: function (n, e) {
          ...
          if (n.waitForIt)
            var i = setInterval(function () {
              var e = Date.now() - r;
              t(n.selector).length > 0 && t(n.selector).is(":visible") && (o(), clearInterval(i)),
                n.timeout && e > n.timeout && (clearInterval(i), o());
            }, 100);
          else o();
        },
        handleInput: function (n, e, r) {
          var o = this,
            i = Date.now(),
            u = e.value ? e.value.replace(/^\{auth\./, "").replace("}", "") : "",
            c = e.selector,
            a = function () {
              if (t(c).length > 0 && t(c).is(":visible")) {
                for (var n = o.args.auth[u], i = 0; i < n.length; i++)
                  t(c)[0].dispatchEvent(
                    new KeyboardEvent("keydown", { bubbles: !0, cancelable: !0, key: n.charAt(i), char: n.charAt(i), shiftKey: !0 })
                  );
                if (
                  (t(c).val(o.args.auth[u]),
                  t(c)[0].dispatchEvent(new Event("input", { bubbles: !0, cancelable: !0 })),
                  t(c)[0].dispatchEvent(new Event("change", { bubbles: !0, cancelable: !0 })),
                  t(c)[0].dispatchEvent(new KeyboardEvent("keydown", { key: "Shift" })),
                  t(c)[0].dispatchEvent(new Event("blur")),
                  e.hitEnter)
                ) {
                  t(c).focus();
        ...
        handleClick: function (n, e) {
          ...
          if ("string" == typeof n)
            t((o = n)).length > 0
              ? (t(o)[0].dispatchEvent(new MouseEvent("mousedown", { view: window, bubbles: !0, cancelable: !0 })),
                t(o)[0].dispatchEvent(new MouseEvent("mouseup", { view: window, bubbles: !0, cancelable: !0 })),
                t(o)[0].click(),
                e())
              : (t("#clloginProcess").remove(), e({ error: "no_such_element" }));
          else {
            o = n.selector;
            var i = function () {
              t(o).length > 0 && t(o).is(":visible")
                ? (t(o)[0].dispatchEvent(new MouseEvent("mousedown", { view: window, bubbles: !0, cancelable: !0 })),
                  t(o)[0].dispatchEvent(new MouseEvent("mouseup", { view: window, bubbles: !0, cancelable: !0 })),
                  t(o)[0].click(),
                  e())
              ...
              var u = setInterval(function () {
                ...
                if (t(o).length > 0 && t(o).is(":visible")) {
                  if (n.attributes) {
                    var c = !0;
                    if (
                      (t.each(n.attributes, function (n, e) {
                        "{falsy}" === e ? t(o).attr(n) && (c = !1) : t(o).attr(n) !== e && (c = !1);
                      }),
                      !c)
                    )
                      return n.timeout && e > n.timeout ? (clearInterval(u), void i()) : void 0;
                  }
                  i(), clearInterval(u);
                }
        ...
        handleCall: function (t, n) {
          var e = t.ctx,
            r = e ? t.fn.bind(e) : t.fn,
            o = Array.isArray(t.args) ? t.args : [],
            i = o.indexOf("::callback::");
          return -1 === i
            ? r(o)
            : promiseFromCallback(function (t) {
                (o[i] = function (n) {
                  t(null, n);
                }),
                  r(o);
        ...
        handleWaitForSelector: function (n, e) {
          var r = Date.now(),
            o = setInterval(function () {
              var i = Date.now() - r;
              t(n.selector).length > 0 && t(n.selector).is(":visible") && (e(), clearInterval(o)),
                n.timeout && i > n.timeout && (clearInterval(o), e());
            }, 100);
        },
          ...
          var r = Date.now(),
            o = setInterval(function () {
              if (
                ...
                t("#recaptcha-anchor div.recaptcha-checkbox-checkmark").length &&
                t("#recaptcha-anchor div.recaptcha-checkbox-checkmark").is(":visible") &&
                ((c = t("#recaptcha-anchor div.recaptcha-checkbox-checkmark").get(0)),
                (a = t(window).scrollTop()),
                (s = a + t(window).height()),
                (f = t(c).offset().top) + t(c).height() <= s && f >= a)
              ) {
                var n = !0;
                if (
                  (sessionStorage.getItem("recaptchaaccesstime") &&
                    Date.now() - parseInt(sessionStorage.getItem("recaptchaaccesstime"), 10) < 7e3 &&
                    (n = !1),
                  n)
                ) {
                  t("#recaptcha-anchor div.recaptcha-checkbox-checkmark").click(),
                    sessionStorage.setItem("recaptchaaccesstime", Date.now() + ""),
                    clearInterval(o);
                  var i = Date.now(),
                    u = setInterval(function () {
                      return t("#recaptcha-token").length && t("#recaptcha-token").val()
                        ? (clearInterval(u), e())
                        : Date.now() - i > 1e4
                        ? (clearInterval(u), e())
                        : void 0;
            ...
            if ((r = JSON.parse(o)).appResponse.advance_sso) {
              ...
              for (var c = 0; c < r.appResponse.selectors.length; c++) {
                ...
                if (r.appResponse.userauth && 0 == r.appResponse.userauth.length) {
                  ...
                  r.appResponse.userauth[0][r.appResponse.selectors[c].sel] ||
                    (r.appResponse.userauth[0][r.appResponse.selectors[c].sel] = a);
              }
              r.appResponse.userauth && r.appResponse.userauth.length > 0 && (i.auth = r.appResponse.userauth[0]),
                chrome.runtime.sendMessage(chrome.runtime.id, { type: "initiate-sso-tasks", data: i }),
                setTimeout(function () {
                  t("#clloginProcess").remove();
                }, 3e3);
            } else
              setTimeout(function () {
                (r.appResponse.pre_auth_script = r.appResponse.pre_auth_script || ""),
                  (r.appResponse.preauth_delay = r.appResponse.preauth_delay || ""),
                  (r.appResponse.post_auth_script = r.appResponse.post_auth_script || ""),
                  (r.appResponse.postauth_delay = r.appResponse.postauth_delay || ""),
                  console.log(r.appResponse);
                var n = function () {
                  var n = !1;
                  if (r.appResponse.userauth.length > 0)
                    for (var o = 0; o < r.appResponse.selectors.length; o++)
                      ("text" != r.appResponse.selectors[o].type && "password" != r.appResponse.selectors[o].type) ||
                        (r.appResponse.selectors[o].value = r.appResponse.userauth[0][r.appResponse.selectors[o].sel]);
                  for (var i = 0; i < r.appResponse.selectors.length; i++) {
                    ...
                    "" != c || n || (n = !0),
                      "submit" == r.appResponse.selectors[i].type
                        ? (e = r.appResponse.selectors[i].sel)
                        : t(r.appResponse.selectors[i].sel.replace(":", "")).val(c);
                  }
                  r.appResponse.selectors.length > 0 &&
                    ("" == e ? t(r.appResponse.selectors[0].sel).closest("form").submit() : t(e).trigger("click"),
                    (function () {
                      r.appResponse.postauth_delay = r.appResponse.postauth_delay ? r.appResponse.postauth_delay : 0;
                      var t = r.appResponse.post_auth_script,
                        n = function () {
                          var n = "(function() { " + t + "})();",
                            e = document.createElement("script");
                          (e.textContent = n), (document.head || document.documentElement).appendChild(e), e.remove();
                        };
                      "" != r.appResponse.postauth_delay && "" != r.appResponse.post_auth_script
                        ? setTimeout(function () {
                            n();
                          }, r.appResponse.postauth_delay)
                        : "" != r.appResponse.post_auth_script && n();
                    })(),
                    setTimeout(function () {
                      t("#clloginProcess").remove();
                    }, 2e3));
                };
                "" != r.appResponse.pre_auth_script || "" != r.appResponse.preauth_delay
                  ? (function () {
                      r.appResponse.preauth_delay = r.appResponse.preauth_delay ? r.appResponse.preauth_delay : 0;
                      var t = r.appResponse.pre_auth_script,
                        e = function () {
                          var n = "(function() { " + t + "})();",
                            e = document.createElement("script");
                          (e.textContent = n), (document.head || document.documentElement).appendChild(e), e.remove();
                        };
                      "" != r.appResponse.preauth_delay && "" != t
                        ? setTimeout(function () {
                            e(), n();
                          }, r.appResponse.preauth_delay)
                        : "" != r.appResponse.preauth_delay && "" == t
                        ? setTimeout(function () {
                            n();
                          }, r.appResponse.preauth_delay)
                        : "" == r.appResponse.preauth_delay && "" != t && (e(), n());
                    })()
                  : n();
              }, 1e3);
          }
      ...
      if (new RegExp(r + "/browsersso").test(window.location.href)) {
        ...
        if (o.appResponse.userauth.length <= 1) {
          for (var u = 0; u < o.appResponse.selectors.length; u++) {
            ...
            if (
              ("TEXT" == o.appResponse.selectors[u].type.toUpperCase() ||
                "PASSWORD" == o.appResponse.selectors[u].type.toUpperCase() ||
                "HIDDEN" == o.appResponse.selectors[u].type.toUpperCase()) &&
              "" == a
            ) {
              i = !0;
              break;
        ...
        new RegExp(r + "/home").test(window.location.href) ||
        new RegExp(r + "/admin").test(window.location.href) ||
        new RegExp(r + "/oauth").test(window.location.href)
      ) {
        window.addEventListener(
          "message",
          function (t) {
            var n = JSON.parse(atob(t.data));
            if ("stopapptimers" == n.type) chrome.runtime.sendMessage(chrome.runtime.id, n);
            else if (new RegExp(r).test(t.origin))
              try {
                switch (n.type) {
                  case "autolaunch":
                    if (n.data.length > 0) {
                      ...
                      chrome.storage.sync.get(function (t) {
                        if (!t[e]) {
                          ...
                          (r[e] = !0),
                            ...
                            chrome.runtime.sendMessage(chrome.runtime.id, { type: "initiate-autolaunch", data: n });
                        }
                      });
                    }
                    break;
        ...
        new RegExp(r).test(window.location.origin) && t("#login_form_action").length > 0
          ? f()
          : new RegExp(r).test(r + "/quickcard") && f();
      function s(t) {
        if (!new RegExp(r).test(window.location.origin)) return !1;
        t.LaunchpadUri = window.location.origin;
        var n = JSON.stringify(t),
          e = t.appResponse.login_url;
        chrome.runtime.sendMessage(chrome.runtime.id, { type: "initiate-sso", data: encodeURIComponent(n) }), (window.location.href = e);
      }
      function f() {
        var t = [];
        t.push(btoa("islogin_" + window.location.host)),
          window.location.host.includes("beta")
            ? t.push(btoa("islogin_betamyapps.classlink.com"))
            : window.location.host.includes("staging")
            ? t.push(btoa("islogin_stagingmyapps.classlink.com"))
            : t.push(btoa("islogin_myapps.classlink.com")),
