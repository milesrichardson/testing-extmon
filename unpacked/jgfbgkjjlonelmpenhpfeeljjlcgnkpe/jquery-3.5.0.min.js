!(function (e, t) {
      ...
      if (!r && (T(t), (t = t || C), E)) {
        ...
        if (d.qsa && !j[e + " "] && (!v || !v.test(e)) && (1 !== p || "object" !== t.nodeName.toLowerCase())) {
          if (((c = e), (f = t), 1 === p && (V.test(e) || X.test(e)))) {
            for (
              ((f = (ne.test(e) && ye(t.parentNode)) || t) === t && d.scope) ||
                ((s = t.getAttribute("id")) ? (s = s.replace(ie, oe)) : t.setAttribute("id", (s = S))),
                o = (l = h(e)).length;
              o--;
      ...
      for (
        ...
        if ((t = b.relative[e[s].type])) c = [be(we(c), t)];
          ...
          if ((t = b.filter[e[s].type].apply(null, e[s].matches))[S]) {
            ...
            return Ce(
              1 < s && we(c),
              1 < s && xe(e.slice(0, s - 1).concat({ value: " " === e[s - 2].type ? "*" : "" })).replace(z, "$1"),
              t,
              s < n && Ee(e.slice(s, n)),
              n < r && Ee((e = e.slice(n))),
              n < r && xe(e)
      ...
      S.cssHooks[u] = {
        ...
        set: function (e, t, n) {
          var r,
            ...
            s = n ? ut(e, u, n, a, i) : 0;
          return (
            a && o && (s -= Math.ceil(e["offset" + u[0].toUpperCase() + u.slice(1)] - parseFloat(i[u]) - ut(e, u, "border", !1, i) - 0.5)),
  ...
  function wt(o, e, t) {
    var n,
      ...
      u = function () {
        if (a) return !1;
        for (
          var e = ft || mt(), t = Math.max(0, l.startTime + l.duration - e), n = 1 - (t / l.duration || 0), r = 0, i = l.tweens.length;
          r < i;
          r++
        )
          l.tweens[r].run(n);
  ...
  (S.Animation = S.extend(wt, {
    ...
    (S.speed = function (e, t, n) {
      var r =
        e && "object" == typeof e
          ? S.extend({}, e)
          : { complete: n || (!n && t) || (x(e) && e), duration: e, easing: (n && t) || (t && !x(t) && t) };
      return (
        S.fx.off
          ? (r.duration = 0)
      ...
      attr: function (e, t, n) {
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return void 0 === e.getAttribute
            ? S.prop(e, t, n)
            : ((1 === o && S.isXMLDoc(e)) || (i = S.attrHooks[t.toLowerCase()] || (S.expr.match.bool.test(t) ? Tt : void 0)),
              void 0 !== n
                ? null === n
    ...
    S.fn.extend({
      ...
      toggleClass: function (i, t) {
        ...
        return "boolean" == typeof t && a
          ...
          : this.each(function () {
              var e, t, n, r;
              if (a) for (t = 0, n = S(this), r = Nt(i); (e = r[t++]); ) n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
              else
                (void 0 !== i && "boolean" != o) ||
      ...
      hasClass: function (e) {
        var t,
          n,
          r = 0;
        for (t = " " + e + " "; (n = this[r++]); ) if (1 === n.nodeType && -1 < (" " + kt(At(n)) + " ").indexOf(t)) return !0;
        return !1;
      }
    });
  var Dt = /\r/g;
  ...
  S.extend(S.event, {
    trigger: function (e, t, n, r) {
      ...
      if (
        ...
        if (!r && !c.noBubble && !g(n)) {
          for (s = c.delegateType || d, qt.test(s + d) || (o = o.parentNode); o; o = o.parentNode) p.push(o), (a = o);
  ...
  function Wt(n, e, r, i) {
    ...
    else for (t in e) Wt(n + "[" + t + "]", e[t], r, i);
  }
      ...
      ajax: function (e, t) {
        ...
        v.hasContent
          ...
          : ((o = v.url.slice(f.length)),
            v.data && (v.processData || "string" == typeof v.data) && ((f += (Ot.test(f) ? "&" : "?") + v.data), delete v.data),
            !1 === v.cache && ((f = f.replace($t, "$1")), (o = (Ot.test(f) ? "&" : "?") + "_=" + Ht.guid++ + o)),
            (v.url = f + o)),
        v.ifModified &&
        ...
        T.setRequestHeader(
          ...
          v.dataTypes[0] && v.accepts[v.dataTypes[0]]
            ? v.accepts[v.dataTypes[0]] + ("*" !== v.dataTypes[0] ? ", " + Gt + "; q=0.01" : "")
            : v.accepts["*"]
        ),
        v.headers))
  ...
  S.ajaxSetup({
    ...
    (m.createHTMLDocument =
      (((tn = E.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>"), 2 === tn.childNodes.length)),
