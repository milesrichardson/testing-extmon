  ...
  [7091],
  {
    ...
    67091: (e, t, i) => {
      ...
      const v = new u.ZP({ feature: "weather" }),
        f = {
          name: "Weather",
          components: {
            WeatherApp: () => Promise.all([i.e(6179), i.e(7745)]).then(i.bind(i, 57745)),
            AppDash: l.Z,
      ...
      i(89697);
      const b = (0, i(51900).Z)(f, a, [], !1, null, "1ebbfa5f", null).exports,
        y = document.querySelector(".region.top-right"),
        S = document.createElement("div");
      y.prepend(S), new n.Z({ render: (e) => e(b) }).$mount(S);
    },
    29505: (e, t, i) => {
      "use strict";
      i.d(t, { Z: () => S });
          ...
          methods: {
            ...
            onStorageEvent(e) {
              ...
              if ((null == e ? void 0 : e.key) === w && null != e && e.newValue) {
                ...
                n[b] > ((null === (i = this.conditionsRaw) || void 0 === i ? void 0 : i[b]) || 0) && (this.conditionsRaw = n);
              } else (null == e ? void 0 : e.key) === v && (this.manualLocation = t(e.newValue));
            },
            getLastUpdated() {
              const e = localStorage.getObject(w);
              return e ? parseInt(e[this.detailed ? f : b] || 0) : 0;
            },
            getTimeToNextUpdate() {
    ...
    89697: (e, t, i) => {
      ...
      n.__esModule && (n = n.default),
        ...
        (0, i(45346).Z)("74a1b8da", n, !1, { ssrId: !0 });
    },
    98346: (e, t, i) => {
      var n = {
        "./clearDay.svg": 92123,
