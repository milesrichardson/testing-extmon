(globalThis.webpackChunkmomentum = globalThis.webpackChunkmomentum || []).push([
  [7085, 6399],
  {
      ...
      const a = {
        bind: function (e, t) {
          ...
          (e.dataset.clickOutsideMouseupHandlerId = Math.random().toString(36).substring(7)),
            ...
            (s[e.dataset.clickOutsideMouseupHandlerId] = o),
            (s[e.dataset.clickOutsideMousedownHandlerId] = n),
      ...
      const n = {
        fadeTrack(e, t) {
          ...
          window.soundscapes[t.name]
            ...
            : ((i = window.soundscapes[t.name] =
              ...
              i.play()),
            i.fade(i.volume(), 0.01 * e, a.Z.fadeDuration),
            a.Z.globalPlaying ||
              setTimeout(() => {
                i.pause();
              }, a.Z.fadeDuration),
        ...
        fadeInAllTracks() {
          ...
          e &&
            e.length &&
            e.forEach((e) => {
              const t = a.Z.tracks[e].volume * a.Z.globalVolume * 0.01;
    ...
    16730: (e, t, i) => {
      "use strict";
      i.d(t, { Z: () => s });
      const s = i(99437).Z.observable({ globalPlaying: !1, globalVolume: 50, tracks: {}, fadeDuration: 500, random: !1 });
    },
    68657: (e, t, i) => {
      "use strict";
    ...
    87085: (e, t, i) => {
      ...
      const w = new h.ZP({ feature: "soundscapes", is_paid_event: !0 }),
        b = {
          ...
          components: {
            PlayButton: () => i.e(688).then(i.bind(i, 50688)),
            SmoothReflow: r.default,
            AppContainer: o.default,
            AppDash: n.Z,
            SoundscapesApp: () =>
              Promise.all([i.e(8725), i.e(6179), i.e(955), i.e(4752), i.e(6283), i.e(7168), i.e(3473)]).then(i.bind(i, 84873)),
            Tracks: () => i.e(7168).then(i.bind(i, 87168))
          },
      ...
      i(88695);
      const y = (0, i(51900).Z)(b, a, [], !1, null, "62dcfd3c", null).exports,
        S = document.querySelector(".region.top-left"),
        A = document.createElement("div");
      S && S.append(A), new s.Z({ render: (e) => e(y) }).$mount(A);
    },
    36399: (e, t, i) => {
      "use strict";
      ...
      const h = d;
      i(67135);
      const p = (0, i(51900).Z)(h, s, [], !1, null, "256e142c", null).exports;
    },
    67135: (e, t, i) => {
      var s = i(68657);
    ...
    88695: (e, t, i) => {
      ...
      s.__esModule && (s = s.default),
        "string" == typeof s && (s = [[e.id, s, ""]]),
        s.locals && (e.exports = s.locals),
        (0, i(45346).Z)("17f687ea", s, !1, { ssrId: !0 });
    },
    33875: (e) => {
      "use strict";
      e.exports =
