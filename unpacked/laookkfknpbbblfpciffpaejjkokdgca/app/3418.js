  ...
  [3418],
  {
        ...
        methods: {
          registerEventListener(t, e, i, n) {
            this.events.hasOwnProperty(e)
              ? this.events[e].hasOwnProperty(i) || (this.events[e][i] = [])
          ...
          removeEventListener(t, e, i) {
            ...
            if (!this.events[e].hasOwnProperty(i))
          ...
          _eventRouter(t) {
            ...
            if (!this.events.hasOwnProperty(t.type)) return;
            if (!this.events[t.type].hasOwnProperty(t.keyCode)) return;
    ...
    68814: (t, e, i) => {
      ...
      n.__esModule && (n = n.default),
        ...
        (0, i(45346).Z)("00d245d5", n, !1, { ssrId: !0 });
    }
  }
]);
