(globalThis.webpackChunkmomentum = globalThis.webpackChunkmomentum || []).push([
  [6370, 7652],
  {
    ...
    3714: (e, t, n) => {
      ...
      a.push([
        e.id,
        ".links-dash[data-v-7cff4af9]{order:3}.links-dash.column[data-v-7cff4af9]{max-width:15rem;max-height:100%}.links-dash.row[data-v-7cff4af9]{min-width:0;flex-shrink:2}.base-item-list.row[data-v-7cff4af9]{height:100%}.base-item-list.row .link-list-item[data-v-7cff4af9]{width:3.5rem;padding:1.0625rem .25rem}@media screen and (width <= 1000px){.links-dash.column[data-v-7cff4af9]{max-width:10rem}}@media screen and (width <= 800px){.links-dash.column[data-v-7cff4af9]{max-width:5rem}}@media screen and (width <= 450px){.links-dash[data-v-7cff4af9]{display:none}}",
        ""
      ]);
      const o = a;
    },
    ...
    30245: (e, t, n) => {
      ...
      const M = new h.ZP({ feature: "links" }),
        g = {
          ...
          components: {
            LinksApp: () =>
              Promise.all([n.e(8725), n.e(6179), n.e(955), n.e(4752), n.e(5852), n.e(5645), n.e(5415), n.e(1952), n.e(1841)]).then(
                n.bind(n, 81841)
              ),
            AppDash: a.Z,
      ...
      f._withStripped = !0;
      var w = n(55040);
      const S = new h.ZP({ feature: "links" }),
        A = {
          name: "LinksDash",
          components: {
            OverflowCarousel: () => n.e(4594).then(n.bind(n, 94594)),
            AppContainer: () => Promise.resolve().then(n.bind(n, 1077)),
            LinksListItem: () => Promise.all([n.e(8725), n.e(4752), n.e(1952), n.e(5598)]).then(n.bind(n, 22021)),
            BaseItemList: () => n.e(3509).then(n.bind(n, 73509))
          },
          mixins: [c.Z],
          provide() {
            return {
          ...
          computed: {
            ...
            direction() {
              return this.mode === k.LS.Tile ? w.O.Row : w.O.Column;
            },
      ...
      n(1238);
      const b = (0, L.Z)(A, f, [], !1, null, "7cff4af9", null).exports;
      var O = n(7838);
      ...
      C && (C.prepend(y), C.prepend(x)),
        ...
        new i.Z({ render: (e) => e(b, { props: { mode: k.LS.Tile } }) }).$mount(y);
      const T = document.createElement("div");
      D && D.prepend(T), new i.Z({ render: (e) => e(b, { props: { mode: k.LS.List } }) }).$mount(T);
    },
    89968: (e, t, n) => {
      "use strict";
    ...
    50776: (e, t, n) => {
      ...
      i.__esModule && (i = i.default),
        "string" == typeof i && (i = [[e.id, i, ""]]),
        i.locals && (e.exports = i.locals),
        (0, n(45346).Z)("51015b82", i, !1, { ssrId: !0 });
    },
    45231: (e) => {
      "use strict";
      e.exports =
