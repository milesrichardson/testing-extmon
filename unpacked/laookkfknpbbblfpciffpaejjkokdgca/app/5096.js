(globalThis.webpackChunkmomentum = globalThis.webpackChunkmomentum || []).push([
  [5096, 6399],
  {
    ...
    47932: (t, e, s) => {
      ...
      const r = new (class {
        async sendMessage({ content: t, parentId: e }) {
          this.cancelTokenSource = o.default.CancelToken.source();
    ...
    89896: (t, e, s) => {
      ...
      i._withStripped = !0;
      var a = s(56179);
      const o = { name: "ChatApp", components: { ChatContent: s(10842).Z, AppPopup: a.Z }, inject: ["viewStateStore"] };
      s(94253);
    ...
    36399: (t, e, s) => {
      ...
      const h = {
        ...
        c = h.setup;
      h.setup = c ? (t, e) => (l(), c(t, e)) : l;
      const d = h;
      s(67135);
      const u = (0, s(51900).Z)(d, i, [], !1, null, "256e142c", null).exports;
    },
    67135: (t, e, s) => {
      var i = s(68657);
    ...
    94253: (t, e, s) => {
      ...
      i.__esModule && (i = i.default),
        "string" == typeof i && (i = [[t.id, i, ""]]),
        i.locals && (t.exports = i.locals),
        (0, s(45346).Z)("4bd27ebe", i, !1, { ssrId: !0 });
    },
    98944: (t) => {
      "use strict";
      t.exports =
