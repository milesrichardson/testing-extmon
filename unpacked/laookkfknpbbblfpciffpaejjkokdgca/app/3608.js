  ...
  [3608],
  {
    ...
    55806: (e, t, n) => {
      ...
      !(function (e) {
        ...
        (function (e) {
          (e.BodyHTML = "<p></p>"), (e.BodyOrTitleText = "");
        })(m || (m = {})),
        (function (e) {
      ...
      const f = {
        [g.Summary]: { path: "request_summary", dataRequired: ["selectedText"] },
        [g.ImproveWriting]: { path: "request_improved_writing", dataRequired: ["selectedText"] },
        [g.Translation]: { path: "request_translation", dataRequired: ["selectedText", "languageId"] },
        [g.ActionItems]: { path: "request_action_items", dataRequired: ["selectedText"] },
        [g.FixSpellingGrammar]: { path: "fix_spelling_and_grammar", dataRequired: ["selectedText"] },
        [g.Simplification]: { path: "request_simplification", dataRequired: ["selectedText"] },
        [g.Expansion]: { path: "request_expansion", dataRequired: ["selectedText"] },
        [g.JournalPrompts]: { path: "request_journal_prompts", dataRequired: ["selectedText"] },
        [g.Outline]: { path: "request_outline", dataRequired: ["selectedText"] }
      };
    },
    75716: (e, t, n) => {
      "use strict";
      ...
      const l = {
        ...
        components: { NodeViewWrapper: r.T5 },
        props: { ...r.Un },
      ...
      const p = new c.H$("customMention"),
                ...
                if (o && (s || e.view.composing) && r.active) {
                  const e = ((e, t) => {
                    ...
                    const s = [...a.matchAll(/\[\[/g)],
                      ...
                      u = s[l];
                    if (!u) return null;
                    const c = void 0 !== u.index ? a.slice(u.index + 2) : "",
                      p = o.pos - a.length + (null !== (r = u.index) && void 0 !== r ? r : 0);
                    return { range: { from: p, to: p + c.length + 2 }, query: c };
                  })(a, r.range);
        ...
        h = i.NB.create({
          ...
          renderHTML({ HTMLAttributes: e, node: t }) {
            var n, r, o;
            const a = ["span", (0, i.P1)({ "data-type": this.name }, e)];
            ...
            const d = null === (r = this.editor) || void 0 === r ? void 0 : r.view.nodeDOM(s);
