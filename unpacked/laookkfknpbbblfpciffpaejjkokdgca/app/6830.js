(globalThis.webpackChunkmomentum = globalThis.webpackChunkmomentum || []).push([
  [6830, 5273],
  {
    ...
    30827: (t, e, i) => {
      ...
      i.d(e, { Z: () => a });
      var s = i(99437);
      const a = (m.showAnyway = new (s.Z.extend({
        name: "ShowAnyway",
        data: () => ({ widgets: [] }),
        methods: {
          show(t) {
    ...
    66830: (t, e, i) => {
      ...
      const d = {
        ...
        computed: {
          hour12clock() {
            return this.updateTime(), o.ax.hour12clock;
          },
          date: () => m.models.date
        },
        methods: {
      ...
      var l = i(51900);
      const c = (0, l.Z)(d, r, [], !1, null, null, null).exports;
      var u = function () {
        var t = this,
          e = t._self._c;
      ...
      const D = {
        ...
        components: {
          ...
          DefaultClock: c,
          PercentClock: g,
          ToastMenu: () => i.e(7449).then(i.bind(i, 97449)),
          Dropdown: () => i.e(9600).then(i.bind(i, 59600)),
          DropdownOption: () => i.e(4541).then(i.bind(i, 84541)),
          QuickNav: () => i.e(1532).then(i.bind(i, 1532)),
          QuickNavOptionsList: () => i.e(8622).then(i.bind(i, 88622))
        },
        mixins: [h.Z],
        unreactive: () => ({ centerOptions: a.Z, showAnyway: w.Z }),
        ...
        computed: {
          ...
          percentClock: {
            get: () => o.ax.percentClock,
            set(t) {
              o.ax.percentClock = t;
            }
          },
          hour12clock: {
            get: () => o.ax.hour12clock,
            set(t) {
              o.ax.hour12clock = t;
            }
          }
        ...
        methods: {
          ...
          switchBetween12and24hr() {
            (this.hour12clock = !this.hour12clock),
              f.ZP.capture("clock format toggle", { feature: "default clock", new_value: this.hour12clock ? "12h" : "24h" });
          },
          openScheduleSettings() {
            this.$plus
              ? (m.commandManager.executeAsync("settings.display", null, { scheduleVisible: !0, section: "balance" }),
                (this.dropdownActive = !1),
                f.ZP.capture("edit schedule click", { feature: "percent clock", is_paid_event: !0 }))
              : m.cmd("modal.open", "UPSELL_BALANCE_MODE", { eventSource: "dash" });
          }
        }
      };
      i(47904);
      const A = (0, l.Z)(D, s, [], !1, null, "6e66e530", null).exports;
    },
    55273: (t, e, i) => {
      "use strict";
    ...
    82800: (t, e, i) => {
      ...
      s.__esModule && (s = s.default),
        "string" == typeof s && (s = [[t.id, s, ""]]),
        s.locals && (t.exports = s.locals),
        (0, i(45346).Z)("ee88c396", s, !1, { ssrId: !0 });
    },
    35966: (t) => {
      "use strict";
      t.exports =
