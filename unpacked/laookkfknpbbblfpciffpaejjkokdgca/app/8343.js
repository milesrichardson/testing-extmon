(globalThis.webpackChunkmomentum = globalThis.webpackChunkmomentum || []).push([
  [8343, 9437],
  {
    ...
    18343: (t, e, o) => {
      ...
      const f = {
          name: "Bookmarks",
          enabling: b.Z.appsReady,
          components: { Bookmark: c, BookmarkFolder: u },
          ...
          methods: {
            async getBookmarks() {
              if (!m.utils.getBrowser().bookmarks || !m.utils.getBrowser().topSites) {
                const t = m.models.bookmarksSettings,
                  e = { permissions: t.permissions.permissions, origins: t.permissions.origins };
                if (
                  !(await new Promise((t) => {
                    m.cmd("modal.open", "PERMISSION_REQUEST", {
                      ...
                      permissions: e,
                      widgetName: "Momentum",
                      permissionExplanation: "To display your bookmarks"
                    });
                  }))
                )
                  return (p.ax.bookmarksVisible = !1), void m.models.bookmarksSettings.set("defaultMostVisited", !1);
              }
        ...
        g = f;
      o(45453);
      const w = (0, l.Z)(g, i, [], !1, null, "7322c900", null).exports,
        v = document.createElement("div");
      document.querySelector(".top-bar").appendChild(v), new s.Z({ render: (t) => t(w) }).$mount(v);
    },
    40063: (t, e, o) => {
      "use strict";
      o.d(e, { Z: () => i });
    ...
    40531: (t, e, o) => {
      "use strict";
      o.d(e, { Fl: () => a, Jr: () => d, ax: () => n });
      var s = o(99437);
      const i = new s.Z.observable({}),
        a = new Proxy(i, {
          get: (t, e) => (Object.prototype.hasOwnProperty.call(t, e) || s.Z.set(t, e, m.models.customization.getComputedSetting(e)), t[e]),
          set: () => (
            console.warn('Computed settings cannot be set by reactiveCustomization. Instead set persistent settings with "persistent"'), !1
          )
        }),
        r = new s.Z.observable({}),
        n = new Proxy(r, {
          get: (t, e) => (Object.prototype.hasOwnProperty.call(t, e) || s.Z.set(t, e, m.models.customization.get(e)), t[e]),
          set: (t, e, o) => (m.models.customization.save(e, o), s.Z.set(t, e, o), !0)
        });
      function d(t = {}) {
        Object.entries(t).forEach(([t, e]) => s.Z.set(r, t, e)), m.models.customization.save(t);
      }
      m.models.customization.on("change", (t) => {
        t &&
          ("balanceModeStr" in t.changed && Object.entries(m.models.customization.attributes).forEach(([t, e]) => s.Z.set(i, t, e)),
          Object.entries(t.changed).forEach(([t, e]) => {
            (i[t] = m.models.customization.getComputedSetting(t)), s.Z.set(r, t, e);
          }));
      }),
        m.on("customization:update", (t) => {
          t.forEach((t) => {
            const e = m.models.customization.getComputedSetting(t);
            s.Z.set(i, t, e), s.Z.set(r, t, e);
          });
        });
    },
    44468: (t, e, o) => {
    ...
    64471: (t, e, o) => {
      ...
      r.push([
        t.id,
        "\n/* stylelint-disable */\n.bookmarks[data-v-7322c900] { height: 36px; display: block; background-color: var(--color-bg); text-shadow: none;\n}\n.animating.bookmarks[data-v-7322c900] { transition: all 0.5s ease;\n}\n.bookmarks-list[data-v-7322c900] { height: 100%; padding: 0 4px; display: flex; align-items: flex-end; transition: transform 0.25s ease, opacity 0.25s ease; white-space: nowrap;\n}\n.bookmarks-item[data-v-7322c900] { color: var(--color-text);\n}\n[data-v-7322c900] .bookmark { max-width: 150px; margin: 4px 1px; padding: 6px; position: relative; display: flex; align-items: center; border-radius: 30px; color: var(--color-text); cursor: pointer; line-height: 1.25; transition: background 0s ease;\n}\n[data-v-7322c900] .bookmark:hover { background: var(--hover-bg);\n}\n[data-v-7322c900] .bookmark-icon-wrapper { --size: 16px; height: var(--size); width: var(--size);\n}\n[data-v-7322c900] .bookmark-icon { --size: 16px; height: var(--size); width: var(--size); fill: var(--color-text);\n}\n[data-v-7322c900] .bookmark-img { filter: var(--filter-dark-invert);\n}\n[data-v-7322c900] .bookmark-label { margin-left: 6px; display: inline-block; font-size: 0.75rem; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;\n}\n\n\t\t\t\t/* Back icon appears in Most Visited and in subfolders */\n[data-v-7322c900] .icon-back-wrapper { --size: 16px; height: var(--size); width: var(--size); display: flex; align-items: center; justify-content: center; opacity: 0.6;\n}\n[data-v-7322c900] .icon-back-wrapper .icon-back { --size: 14px;\n}\n\n\t\t/* Most visited */\n.most-visited[data-v-7322c900] {\n}\n.most-visited:not(.icons-only) .bookmarks-item[data-v-7322c900]:not(.back) { width: 1%; flex-grow: 1;\n}\n.most-visited .bookmark[data-v-7322c900] { max-width: none;\n}\n\n\t\t/* Overflow dropdown button */\n.overflow[data-v-7322c900] { flex-grow: 1; display: flex; justify-content: flex-end;\n}\n.slide-enter-active[data-v-7322c900], .slide-leave-active[data-v-7322c900] { transition: height .2s ease;\n}\n.slide-enter[data-v-7322c900], .slide-leave-to[data-v-7322c900] { height: 0;\n}\n",
        ""
      ]);
      const n = r;
    },
    1618: (t, e, o) => {
      ...
      s.__esModule && (s = s.default),
        ...
        (0, o(45346).Z)("062cd0ba", s, !1, { ssrId: !0 });
    },
    60767: (t, e, o) => {
      var s = o(48769);
      s.__esModule && (s = s.default),
        "string" == typeof s && (s = [[t.id, s, ""]]),
        s.locals && (t.exports = s.locals),
        (0, o(45346).Z)("2210f464", s, !1, { ssrId: !0 });
    },
    45453: (t, e, o) => {
      var s = o(64471);
      s.__esModule && (s = s.default),
        "string" == typeof s && (s = [[t.id, s, ""]]),
        s.locals && (t.exports = s.locals),
        (0, o(45346).Z)("afe77a16", s, !1, { ssrId: !0 });
    },
    97510: (t) => {
      "use strict";
      t.exports =
