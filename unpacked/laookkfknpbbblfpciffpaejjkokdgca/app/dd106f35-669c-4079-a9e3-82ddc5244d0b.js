  ...
  (i.styles = i.styles || {}),
    ...
    (i.templates.item = Handlebars.template({
      1: function (t, e, s, i, n) {
        ...
        return (
          ...
          c(
            typeof (o = null != (o = r(s, "isFavClass") || (null != e ? r(e, "isFavClass") : e)) ? o : l) == d
              ? o.call(a, {
                  name: "isFavClass",
                  hash: {},
                  data: n,
          ...
          '" title="' +
          c(
            typeof (o = null != (o = r(s, "isFavTitle") || (null != e ? r(e, "isFavTitle") : e)) ? o : l) == d
              ? o.call(a, {
                  name: "isFavTitle",
                  hash: {},
                  data: n,
      ...
      main: function (t, e, s, i, n) {
        ...
        return (
          ...
          r(
            typeof (a = null != (a = u(s, "body") || (null != e ? u(e, "body") : e)) ? a : d) == c
          ...
          r(
            typeof (a = null != (a = u(s, "source") || (null != e ? u(e, "source") : e)) ? a : d) == c
          ...
          r(
            typeof (a = null != (a = u(s, "labelSelect") || (null != e ? u(e, "labelSelect") : e)) ? a : d) == c
              ? a.call(l, { name: "labelSelect", hash: {}, data: n, loc: { start: { line: 8, column: 62 }, end: { line: 8, column: 77 } } })
              : a
          ) +
          ...
          r(
            typeof (a = null != (a = u(s, "labelSyncError") || (null != e ? u(e, "labelSyncError") : e)) ? a : d) == c
              ? a.call(l, {
                  name: "labelSyncError",
                  hash: {},
                  data: n,
          ...
          r(
            typeof (a = null != (a = u(s, "inputLengthMaxHtml") || (null != e ? u(e, "inputLengthMaxHtml") : e)) ? a : d) == c
              ? a.call(l, {
          ...
          '" maxlength="' +
          r(
            typeof (a = null != (a = u(s, "inputLengthMaxHtmlSource") || (null != e ? u(e, "inputLengthMaxHtmlSource") : e)) ? a : d) == c
              ? a.call(l, {
    ...
    (i.templates.main = Handlebars.template({
      ...
      main: function (t, e, s, i, n) {
        ...
        return (
          ...
          r(
            typeof (a = null != (a = u(s, "title") || (null != e ? u(e, "title") : e)) ? a : d) == c
              ? a.call(l, { name: "title", hash: {}, data: n, loc: { start: { line: 5, column: 5 }, end: { line: 5, column: 14 } } })
              : a
          ) +
          '</h3>\n\t<p class="description">' +
          r(
            typeof (a = null != (a = u(s, "description") || (null != e ? u(e, "description") : e)) ? a : d) == c
              ? a.call(l, { name: "description", hash: {}, data: n, loc: { start: { line: 6, column: 24 }, end: { line: 6, column: 39 } } })
              : a
          ) +
          ...
          r(
            typeof (a = null != (a = u(s, "feedMomentumClass") || (null != e ? u(e, "feedMomentumClass") : e)) ? a : d) == c
              ? a.call(l, {
          ...
          r(
            typeof (a = null != (a = u(s, "feedCustomClass") || (null != e ? u(e, "feedCustomClass") : e)) ? a : d) == c
              ? a.call(l, {
          ...
          r(
            typeof (a = null != (a = u(s, "labelCustom") || (null != e ? u(e, "labelCustom") : e)) ? a : d) == c
              ? a.call(l, {
                  name: "labelCustom",
                  hash: {},
                  data: n,
          ...
          (null !=
          (o = u(s, "unless").call(l, null != e ? u(e, "isPlus") : e, {
            name: "unless",
            hash: {},
            fn: t.program(1, n, 0),
            inverse: t.noop,
    ...
    (i.models.QuoteSettingsManager = Backbone.Model.extend({
      ...
      onActiveQuoteChanged: function (t) {
        if (this.lastActiveQuote !== t && this.history) {
          ...
          if (e && e.get("_id") !== t) {
            ...
            if (
              (!s && this.collection && (s = this.collection.findWhere({ id: t })),
              !s && this.favorites && (s = this.favorites.findWhere({ id: t })),
              s)
            ) {
              var i = s.clone();
              i.has("_id") || i.set("id", t),
                i.set("sort_order", i.get("sort_order") + "-" + l.now()),
                (i.prepend = !0),
                this.history.add(i),
                this.history.sort(),
      ...
      Favorites: function () {
        return (
          this.favorites ||
            ((this.favorites = new i.collect.Quotes()),
  ...
  return (
    (i.views.Main = e.views.SettingsPanel.extend({
      ...
      selectSubnav: function (t, e, s) {
        e.stopPropagation(),
          this.subnav !== t ? (this.hideAddForm(), this.resetAdd(), s()) : l.utils.toggleClassTwice(d(e.delegatedTarget), "active");
      },
      renderCustom: function () {
        this.customView || (this.customView = new i.views.Custom({ el: this.$customList, main: this })),
          l.settingsUtils.renderSubnav(this, this.customView, "custom");
      },
      renderFavorites: function () {
        this.favoritesView || (this.favoritesView = new i.views.Favorites({ el: this.$favoritesList, main: this })),
          l.settingsUtils.renderSubnav(this, this.favoritesView, "favorites");
      },
      renderHistory: function () {
        this.historyView || (this.historyView = new i.views.History({ el: this.$historyList, main: this })),
