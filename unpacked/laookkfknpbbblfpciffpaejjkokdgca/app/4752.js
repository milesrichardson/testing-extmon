(globalThis.webpackChunkmomentum = globalThis.webpackChunkmomentum || []).push([
  [4752],
  {
    91804: (t, e, o) => {
      ...
      s.push([
        t.id,
        ".base-dropdown-container[data-v-1647fb9e]{--dropdown-x: var(--3c0a539b);--dropdown-y: var(--b828ff0c);--nipple-displacement: var(--8e214688);--nipple-color: var(--dropdown-background-color);--dropdown-window-edge-padding: var(--69bf650f);--dropdown-window-width: calc(var(--d60450d0) - var(--dropdown-window-edge-padding) * 2);width:var(--a763e1c0);min-width:min(var(--dropdown-window-width),var(--508022fa));max-width:min(var(--dropdown-window-width),var(--8b4281b0));position:absolute;transform:translate3d(var(--dropdown-x), var(--dropdown-y), 0);outline:none;color:var(--dropdown-color);text-shadow:none}.base-dropdown-transition-fade-enter-active[data-v-1647fb9e],.base-dropdown-transition-fade-leave-active[data-v-1647fb9e]{transition:opacity .1s ease}.base-dropdown-transition-fade-enter[data-v-1647fb9e],.base-dropdown-transition-fade-leave-to[data-v-1647fb9e]{opacity:0}",
        ""
      ]);
      const r = s;
    },
    ...
    97021: (t, e, o) => {
      ...
      const v = {
          name: "BaseDropdown",
          components: { BaseDropdownContent: o(80766).Z, ToastMenuContainer: h, BaseDropdownContainer: a.Z, PortalToggle: p },
          directives: { ClickOutside: i.Z },
          props: {
            tag: p.props.tag,
    ...
    65547: (t, e, o) => {
      ...
      const d = {
        ...
        l = () => {
          (0, r.sj)((t, e) => ({
            "3c0a539b": t.x + "px",
            b828ff0c: t.y + "px",
            "8e214688": t.nippleDisplacement + "px",
            "69bf650f": t.windowEdgePadding + "px",
            d60450d0: t.maxWindowWidth,
            a763e1c0: t.width,
            "508022fa": t.minWidth,
            "8b4281b0": t.maxWidth
          }));
      ...
      const c = d;
      o(42725);
      const u = (0, o(51900).Z)(c, n, [], !1, null, "1647fb9e", null).exports;
    },
    80766: (t, e, o) => {
      "use strict";
      o.d(e, { Z: () => i });
    ...
    43628: (t, e, o) => {
      ...
      n.__esModule && (n = n.default),
        "string" == typeof n && (n = [[t.id, n, ""]]),
        n.locals && (t.exports = n.locals),
        (0, o(45346).Z)("54381304", n, !1, { ssrId: !0 });
    },
    32254: (t, e, o) => {
      var n = o(92576);
      n.__esModule && (n = n.default),
        "string" == typeof n && (n = [[t.id, n, ""]]),
        n.locals && (t.exports = n.locals),
        (0, o(45346).Z)("e899e256", n, !1, { ssrId: !0 });
    },
    49710: (t) => {
      "use strict";
      t.exports =
