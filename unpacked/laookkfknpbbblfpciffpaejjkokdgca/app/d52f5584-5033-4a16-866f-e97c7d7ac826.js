    ...
    (s.templates.detailCustom = Handlebars.template({
      ...
      main: function (t, e, i, s, n) {
        ...
        return (
          ...
          r(
            typeof (o = null != (o = d(i, "title") || (null != e ? d(e, "title") : e)) ? o : l) == c
              ? o.call(a, { name: "title", hash: {}, data: n, loc: { start: { line: 17, column: 91 }, end: { line: 17, column: 100 } } })
              : o
          ) +
          '" maxlength="' +
          r(
            typeof (o = null != (o = d(i, "inputLengthMaxHtml") || (null != e ? d(e, "inputLengthMaxHtml") : e)) ? o : l) == c
              ? o.call(a, {
          ...
          r(
            typeof (o = null != (o = d(i, "source") || (null != e ? d(e, "source") : e)) ? o : l) == c
              ? o.call(a, { name: "source", hash: {}, data: n, loc: { start: { line: 22, column: 102 }, end: { line: 22, column: 112 } } })
              : o
          ) +
          '" maxlength="' +
          r(
    ...
    (s.templates.detailStock = Handlebars.template({
      ...
      3: function (t, e, i, s, n) {
        ...
        return (
          ...
          r(
            typeof (o = null != (o = d(i, "sourceUrl") || (null != e ? d(e, "sourceUrl") : e)) ? o : l) == c
              ? o.call(a, {
                  name: "sourceUrl",
                  hash: {},
                  data: n,
          ...
          '" target="_blank">' +
          r(
            typeof (o = null != (o = d(i, "attribution") || (null != e ? d(e, "attribution") : e)) ? o : l) == c
              ? o.call(a, {
                  name: "attribution",
                  hash: {},
                  data: n,
      ...
      5: function (t, e, i, s, n) {
        ...
        return (
          ...
          t.escapeExpression(
            "function" ==
              typeof (o = null != (o = a(i, "attribution") || (null != e ? a(e, "attribution") : e)) ? o : t.hooks.helperMissing)
      ...
      7: function (t, e, i, s, n) {
        ...
        return (
          ...
          t.escapeExpression(
            "function" ==
              typeof (a = null != (a = c(i, "labelSelect") || (null != e ? c(e, "labelSelect") : e)) ? a : t.hooks.helperMissing)
              ? a.call(l, {
                  name: "labelSelect",
                  hash: {},
                  data: n,
          ...
          "\n\t\t\t\t" +
          (null !=
          (o = c(i, "unless").call(l, null != e ? c(e, "plusUser") : e, {
            name: "unless",
            hash: {},
            fn: t.program(8, n, 0),
            inverse: t.noop,
    ...
    (s.templates.main = Handlebars.template({
      ...
      main: function (t, e, i, s, n) {
        ...
        return (
          ...
          d(
            typeof (a = null != (a = u(i, "feedMomentumClass") || (null != e ? u(e, "feedMomentumClass") : e)) ? a : c) == r
              ? a.call(l, {
          ...
          d(
            typeof (a = null != (a = u(i, "feedCustomClass") || (null != e ? u(e, "feedCustomClass") : e)) ? a : c) == r
              ? a.call(l, {
          ...
          d(
            typeof (a = null != (a = u(i, "labelCustom") || (null != e ? u(e, "labelCustom") : e)) ? a : c) == r
              ? a.call(l, {
                  name: "labelCustom",
                  hash: {},
                  data: n,
          ...
          (null !=
          (o = u(i, "unless").call(l, null != e ? u(e, "isPlus") : e, {
            name: "unless",
            hash: {},
            fn: t.program(1, n, 0),
            inverse: t.noop,
    ...
    (s.templates.tile = Handlebars.template({
      ...
      3: function (t, e, i, s, n) {
        ...
        return (
          ...
          t.escapeExpression(
            "function" ==
              typeof (o = null != (o = a(i, "labelSelect") || (null != e ? a(e, "labelSelect") : e)) ? o : t.hooks.helperMissing)
              ? o.call(null != e ? e : t.nullContext || {}, {
                  name: "labelSelect",
                  hash: {},
                  data: n,
      ...
      main: function (t, e, i, s, n) {
        ...
        return (
          ...
          (null !=
          (o = u(i, "unless").call(l, null != e ? u(e, "showSetActive") : e, {
            name: "unless",
            hash: {},
            fn: t.program(1, n, 0),
            inverse: t.noop,
          ...
          (null !=
          (o = u(i, "if").call(l, null != e ? u(e, "showSetActive") : e, {
            name: "if",
            hash: {},
            fn: t.program(3, n, 0),
            inverse: t.noop,
          ...
          d(
            typeof (a = null != (a = u(i, "labelSelectError") || (null != e ? u(e, "labelSelectError") : e)) ? a : c) == r
              ? a.call(l, {
          ...
          d(
            typeof (a = null != (a = u(i, "editIconTitle") || (null != e ? u(e, "editIconTitle") : e)) ? a : c) == r
              ? a.call(l, {
                  name: "editIconTitle",
                  hash: {},
                  data: n,
          ...
          d(
            typeof (a = null != (a = u(i, "editIconClass") || (null != e ? u(e, "editIconClass") : e)) ? a : c) == r
              ? a.call(l, {
                  name: "editIconClass",
                  hash: {},
                  data: n,
    ...
    (s.models.BackgroundSettingsManager = Backbone.Model.extend({
      ...
      onBackgroundLoad: function (t) {
        if (this.lastActiveBackground !== t && this.history) {
          ...
          if (e && e.get("_id") !== t) {
            ...
            if (
              (!i && this.collection && (i = this.collection.findWhere({ id: t })),
              !i && this.favorites && (i = this.favorites.findWhere({ id: t })),
              i)
            ) {
              var s = i.clone();
              s.has("_id") || s.set("id", t),
                s.set("sort_order", s.get("sort_order") + "-" + a.now()),
                (s.prepend = !0),
                this.history.add(s),
                this.history.sort(),
      ...
      uploadFile: function (t, e) {
        if (t.type.startsWith("image/"))
          ...
          var i = { name: t.name, type: t.type };
          this.skippedFiles.add(i), this.trigger("fileSkipped", i);
        }
      },
    ...
    (a.models.UploadManager = Backbone.Model.extend({
      ...
      uploadFile: function (n) {
        ...
        function g() {
          if (0 < r) {
            var t = o.slice(c, c + l),
              e = i.blockIdPrefix + i.pad(d.length, 6);
            d.push(btoa(e)), s.readAsArrayBuffer(t), (c += l), (r -= l) < l && (l = r);
          } else
            !(function () {
              var t,
                e = a + "&comp=blocklist",
                i = "<?xml version='1.0' encoding='utf-8'?><BlockList>";
              for (t = 0; t < d.length; t++) i += "<Latest>" + d[t] + "</Latest>";
              (i += "</BlockList>"),
                p.ajax({
                  url: e,
                  type: "PUT",
                  ...
                  modifyHeaders: function (t) {
                    return (
                      ...
                      (t["x-ms-blob-content-type"] = o.type),
                      t
                    );
                  },
                  success: function () {
        ...
        (this.totalBytes += h),
          ...
          (s.onloadend = function (t) {
            if (t.target.readyState == FileReader.DONE) {
              var e = a + "&comp=block&blockid=" + d[d.length - 1],
              ...
              p.ajax({
                ...
                success: function () {
                  (u += s), n.set({ fileprogress: parseInt((u / h) * 100) }), g();
                },
                error: function () {
                  n.set({ upload_failed: !0 });
                }
  ...
  return (
    (s.views.Main = e.views.SettingsPanel.extend({
      ...
      render: function () {
        ...
        return (
          this.$el.html(this.template(p.extend(t, a.settingsUtils.getInitialFeedSettings(this.manager)))),
          this.setViewVars(),
          "favorites" === this.subnav
            ? this.renderFavorites()
            : "history" === this.subnav
            ? this.renderHistory()
            : "custom" === this.subnav || this.plusUser
            ? this.renderCustom()
            : this.renderHistory(),
      ...
      selectSubnav: function (t, e, i) {
        e.stopPropagation(), this.subnav !== t ? i() : a.utils.toggleClassTwice(p(e.delegatedTarget), "active");
      },
      ...
      fileInputChanged: function (t) {
        ...
        e.length &&
          ...
          this.manager.uploadFiles(e, function () {
      ...
      detailUpdateSetActiveButton: function (t) {
        var e = t.model.id || t.model.get("_id"),
          i = a.models.activeBackground.activeBackgroundUuid() === e;
        t.$(".button-set-active")
    ...
    a.commandManager &&
      ...
      a.commandManager.registerCommand("background.custom.uploadfiles", function (t) {
        t.length &&
          ...
          1 == t.length
            ? a.backgroundSettingsManager.uploadFile(t[0], function (i) {
                i.getThumbnailUrl(function (t) {
                  var e = new a.models.BackgroundBase({ _id: i.id, title: "", attribution: " ", source: "", filename: t });
                  a.models.activeBackground.setActiveBackground(e),
