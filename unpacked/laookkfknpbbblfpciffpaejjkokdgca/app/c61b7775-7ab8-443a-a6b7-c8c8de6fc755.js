var fn_addin = function (d, s, n) {
  ...
  (l.styles = l.styles || {}),
    ...
    (l.dependencies = n || l.dependencies || {}),
    (l.styles.style = function () {}),
    (l.views = l.views || {}),
    (l.collect = l.collect || {}),
    (l.models = l.models || {}),
    ...
    d.console.log(d.elapsed() + ": " + l.info.id + " started"),
    (l.templates = l.templates || {}),
    (l.templates.boards_available = Handlebars.template({
      1: function (n, t, e, a, o) {
        var i,
          s,
          l = null != t ? t : n.nullContext || {},
        ...
        return (
          '            <li data-board-id="' +
          d(
            typeof (s = null != (s = p(e, "id") || (null != t ? p(t, "id") : t)) ? s : r) == c
              ? s.call(l, { name: "id", hash: {}, data: o, loc: { start: { line: 5, column: 31 }, end: { line: 5, column: 37 } } })
              : s
          ) +
          '" class="connect-board">\n                <div class="u--flex-grow">\n                    ' +
          (null !=
          (i = p(e, "if").call(l, null != t ? p(t, "icon_url") : t, {
            name: "if",
            hash: {},
            fn: n.program(2, o, 0),
            inverse: n.noop,
          ...
          d(
            typeof (s = null != (s = p(e, "board_name") || (null != t ? p(t, "board_name") : t)) ? s : r) == c
      ...
      2: function (n, t, e, a, o) {
        ...
        return (
          ...
          n.escapeExpression(
            "function" == typeof (i = null != (i = s(e, "icon_url") || (null != t ? s(t, "icon_url") : t)) ? i : n.hooks.helperMissing)
              ? i.call(null != t ? t : n.nullContext || {}, {
                  name: "icon_url",
                  hash: {},
                  data: o,
      ...
      main: function (n, t, e, a, o) {
        ...
        return (
          ...
          n.escapeExpression(
            "function" ==
              typeof (s =
                null != (s = r(e, "organization_name") || (null != t ? r(t, "organization_name") : t)) ? s : n.hooks.helperMissing)
              ? s.call(l, {
          ...
          (null !=
          (i = r(e, "each").call(l, null != t ? r(t, "boards") : t, {
            name: "each",
            hash: {},
            fn: n.program(1, o, 0),
            inverse: n.noop,
    ...
    (l.templates.boards_connected = Handlebars.template({
      1: function (n, t, e, a, o) {
        var i,
          s,
          l = null != t ? t : n.nullContext || {},
        ...
        return (
          ...
          d(
            typeof (s = null != (s = p(e, "id") || (null != t ? p(t, "id") : t)) ? s : r) == c
              ? s.call(l, { name: "id", hash: {}, data: o, loc: { start: { line: 4, column: 21 }, end: { line: 4, column: 27 } } })
              : s
          ) +
    ...
    (l.templates.main = Handlebars.template({
      compiler: [8, ">= 4.3.0"],
      main: function (n, t, e, a, o) {
  ...
  var t = l.dependencies.settings;
  return (
    (l.views.Main = t.views.SettingsPanel.extend({
      attributes: { id: "settings-trello", class: "settings-view settings-trello" },
      template: l.templates.main,
      panelid: "trello",
      events: {
      ...
      disconnectBoard: function (n) {
        ...
        var t = s(n.delegatedTarget).closest(".has-board-id"),
          e = t.data("board-id");
        if (e) {
          ...
          var r = this;
          this.authAttempts = 0;
          var a = d.globals.urlRootApi + "settings/todo/providers/5",
            o = { operation: "disconnect_board", board_id: e };
          s.ajax({ type: "POST", contentType: "application/json", url: a, data: JSON.stringify(o) })
            .done(function (n) {
              if (n.status && "authRequired" == n.status) {
                if (n.authorizationUrl && r.authAttempts < 2) {
                  r.authAttempts++;
                  var t = n.winWidth ? n.winWidth : 600,
                    e = n.winHeight ? n.winHeight : 510,
                    a = n.windowFeatures ? n.windowFeatures : "titlebar,resizable,toolbar,status",
                    o = window.screen.width / 2 - t / 2,
                    i = window.screen.height / 2 - e / 2,
                    s = window.open(
                      n.authorizationUrl,
                      "MomentumAuthWindow",
                      a + ",left=" + o + ",top=" + i + ",width=" + t + ",height=" + e
                    ),
                ...
                n.status && "success" == n.status && d.commandManager.execute("settings.todo.provider.change", null, { provider_id: "1" }),
                  r.$el.find(".pop-body").scrollTop(0),
                  r.refreshData();
            })
            .fail(function () {
      ...
      connectBoard: function (n) {
        n && (n.stopPropagation(), n.preventDefault());
        var t = s(n.delegatedTarget).data("board-id");
        if (t) {
          s(n.delegatedTarget).find(".status").html('<span class="loading"><i class="loading-icon"></i>Connecting...</span>');
          var r = this;
          this.authAttempts = 0;
          var e = d.globals.urlRootApi + "settings/todo/providers/5",
            c = { operation: "connect_board", board_id: t };
          s.ajax({ type: "POST", contentType: "application/json", url: e, data: JSON.stringify(c) })
            .done(function (n) {
              if (n.status && "authRequired" == n.status) {
                if (n.authorizationUrl && r.authAttempts < 2) {
                  r.authAttempts++;
      ...
      populateConnectedBoards: function () {
        var n = s(this.$("#connected-providers")[0]),
          t = l.templates.boards_connected({ organization_name: "", boards: this.collection.toJSON() });
        n.html(t),
      ...
      populateAvailableBoards: function () {
        ...
        o.html("");
        var n = _.chain(a.collection.lastResponse.available_boards).where({ starred: !0 }).sortBy("board_name").value();
        if (n && 0 < n.length) {
          var t = l.templates.boards_available({ organization_name: "Starred Boards", boards: n });
          o.append(t);
        }
        var e = _.chain(a.collection.lastResponse.available_boards)
          .filter(function (n) {
          ...
          .value();
        if (e && 0 < e.length) {
          t = l.templates.boards_available({ organization_name: "Recent Boards", boards: e });
          o.append(t);
        }
        var i = _.chain(a.collection.lastResponse.available_boards)
          .filter(function (n) {
          ...
          .value();
        if (i && 0 < i.length) {
          t = l.templates.boards_available({ organization_name: "My Boards", boards: i });
          o.append(t);
        }
        _.each(a.collection.organizations, function (n) {
          var t = _.chain(a.collection.lastResponse.available_boards).where({ organization_id: n.id }).sortBy("board_name").value();
          if (t && 0 < t.length) {
            var e = l.templates.boards_available({ organization_name: n.name, boards: t });
            o.append(e);
          }
        }),
    ...
    d.commandManager &&
      d.commandManager.registerCommand("settings.panels.trello.config", function () {
        return l.styleLoaded || ((l.styleLoaded = !0), l.styles.style()), new l.views.Main();
      }),
    l
  );
};
