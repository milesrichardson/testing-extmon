      ...
      const c = {
        ...
        o = [
          ...
          },
          {
            ...
            icon: n(45534),
            tracks: [
              { ...c.coWorkers, volume: 13 },
              { ...c.copier, volume: 8 },
              { ...c.airConditioner, volume: 7 },
              { ...c.fluorescentHum, volume: 3 },
              { ...c.mechanicalKeyboard, volume: 1 }
            ]
          },
          { name: "Random", icon: n(12046) },
          { name: "Custom", icon: n(56248), tracks: Object.values(c) }
        ];
    }
  }
]);
