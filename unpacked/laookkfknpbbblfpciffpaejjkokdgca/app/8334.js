  ...
  [8334],
  {
    ...
    47932: (e, t, s) => {
      ...
      const i = new (class {
        async sendMessage({ content: e, parentId: t }) {
          this.cancelTokenSource = n.Z.CancelToken.source();
    ...
    78334: (e, t, s) => {
      ...
      const u = new (s(81405).ZP)({ feature: "ask ai", is_paid_event: !0, location: "search" }),
        g = {
          name: "BigSearch",
          components: {
            SearchChat: () => Promise.all([s.e(9980), s.e(464), s.e(6970), s.e(5494), s.e(3379)]).then(s.bind(s, 73379)),
            SearchInput: i.Z,
            ThreeColLayout: o.Z
          },
          mixins: [c.Z],
          ...
          computed: { ...(0, p.Kc)(h.a, l), searchVisible: () => n.ax.searchVisible && n.ax.centerBelowNavVisible },
          mounted() {
    ...
    90019: (e, t, s) => {
      ...
      a.__esModule && (a = a.default),
        ...
        (0, s(45346).Z)("04b279fa", a, !1, { ssrId: !0 });
    }
  }
]);
