(globalThis.webpackChunkmomentum = globalThis.webpackChunkmomentum || []).push([
  [9980],
  {
    ...
    67022: (e, t, r) => {
      ...
      (t.lib = {}),
                ...
                return (
                  ...
                  (function (e, t) {
                    ...
                    return s(u, t)
                      ...
                      : 35 === t.charCodeAt(0) &&
                        l.test(t) &&
                        o((r = "x" === t[1].toLowerCase() ? parseInt(t.slice(2), 16) : parseInt(t.slice(1), 10)))
                      ? i(r)
                      : e;
                  })(e, r)
                );
        ...
        (t.normalizeReference = function (e) {
          return (
            (e = e.trim().replace(/\s+/g, " ")), "Ṿ" === "ẞ".toLowerCase() && (e = e.replace(/ẞ/g, "ß")), e.toLowerCase().toUpperCase()
          );
        });
    },
    51685: (e, t, r) => {
      "use strict";
      (t.parseLinkLabel = r(33595)), (t.parseLinkDestination = r(12548)), (t.parseLinkTitle = r(88040));
    },
    12548: (e, t, r) => {
      "use strict";
      var n = r(67022).unescapeAll;
    ...
    82471: (e, t, r) => {
      ...
      var n = r(79580),
        s = [
          ["table", r(91785), ["paragraph", "reference"]],
          ["code", r(38768)],
          ["fence", r(13542), ["paragraph", "reference", "blockquote", "list"]],
          ["blockquote", r(45258), ["paragraph", "reference", "blockquote", "list"]],
          ["hr", r(35634), ["paragraph", "reference", "blockquote", "list"]],
          ["list", r(18532), ["paragraph", "reference", "blockquote"]],
          ["reference", r(43804)],
          ["html_block", r(76329), ["paragraph", "reference", "blockquote"]],
          ["heading", r(61630), ["paragraph", "reference", "blockquote"]],
          ["lheading", r(56850)],
          ["paragraph", r(96864)]
        ];
      function o() {
    ...
    94485: (e, t, r) => {
      ...
      var n = r(79580),
        ...
        o = [
          ["balance_pairs", r(89354)],
          ["strikethrough", r(44814).g],
          ["emphasis", r(97894).g],
          ["fragments_join", r(69969)]
        ];
      function i() {
        var e;
    ...
    77529: (e, t, r) => {
      "use strict";
      var n = r(67022).assign,
        s = r(67022).unescapeAll,
        o = r(67022).escapeHtml,
        i = {};
      function a() {
        this.rules = n({}, i);
      }
      (i.code_inline = function (e, t, r, n, s) {
        ...
        (i.fence = function (e, t, r, n, i) {
          var a,
            ...
            m = "";
          return (
            f && ((d = (l = f.split(/(\s+)/g))[0]), (m = l.slice(2).join(""))),
            0 === (a = (r.highlight && r.highlight(h.content, d, m)) || o(h.content)).indexOf("<pre")
              ? a + "\n"
              : f
              ? ((c = h.attrIndex("class")),
                (u = h.attrs ? h.attrs.slice() : []),
                c < 0 ? u.push(["class", r.langPrefix + d]) : ((u[c] = u[c].slice()), (u[c][1] += " " + r.langPrefix + d)),
                (p = { attrs: u }),
          ...
          return i.hidden
            ...
            : (i.block && -1 !== i.nesting && t && e[t - 1].hidden && (s += "\n"),
              ...
              i.block &&
                ...
                1 === i.nesting &&
                  t + 1 < e.length &&
                  ("inline" === (n = e[t + 1]).type || n.hidden || (-1 === n.nesting && n.tag === i.tag)) &&
                  (o = !1)),
              (s += o ? ">\n" : ">"));
        }),
        (a.prototype.renderInline = function (e, t, r) {
          for (var n, s = "", o = this.rules, i = 0, a = e.length; i < a; i++)
            void 0 !== o[(n = e[i].type)] ? (s += o[n](e, i, t, r, this)) : (s += this.renderToken(e, i, t));
          return s;
        }),
      ...
      (t.prototype.__find__ = function (e) {
        ...
        (t.prototype.after = function (e, t, r, n) {
          var s = this.__find__(e),
            o = n || {};
          if (-1 === s) throw new Error("Parser rule not found: " + e);
          this.__rules__.splice(s + 1, 0, { name: t, enabled: !0, fn: r, alt: o.alt || [] }), (this.__cache__ = null);
        }),
    ...
    45258: (e, t, r) => {
      ...
      e.exports = function (e, t, r, s) {
        ...
        for (
          ...
          if (62 !== e.src.charCodeAt(D++) || A) {
            ...
            if (C) {
              (e.lineMax = h),
                0 !== e.blkIndent &&
                  (d.push(e.bMarks[h]), m.push(e.bsCount[h]), b.push(e.tShift[h]), k.push(e.sCount[h]), (e.sCount[h] -= e.blkIndent));
              break;
            }
        ...
        for (
          ...
          (e.bMarks[a + t] = d[a]), (e.tShift[a + t] = b[a]), (e.sCount[a + t] = k[a]), (e.bsCount[a + t] = m[a]);
    ...
    38768: (e) => {
      ...
      e.exports = function (e, t, r) {
        ...
        return (
          (e.line = s),
          ((o = e.push("code_block", "code", 0)).content = e.getLines(t, s, 4 + e.blkIndent, !1) + "\n"),
          (o.map = [t, e.line]),
          !0
        );
      };
      ...
      e.exports = function (e, t, r, n) {
        ...
        for (a = t; !(++a >= r || ((h = c = e.bMarks[a] + e.tShift[a]) < (f = e.eMarks[a]) && e.sCount[a] < e.blkIndent)); )
          if (
            ...
            !(e.sCount[a] - e.blkIndent >= 4 || (h = e.skipChars(h, s)) - c < o || (h = e.skipSpaces(h)) < f)
          ) {
            p = !0;
            break;
          }
    ...
    35634: (e, t, r) => {
      ...
      e.exports = function (e, t, r, s) {
        ...
        return !(
          i < 3 ||
          (s || ((e.line = t + 1), ((c = e.push("hr", "hr", 0)).map = [t, e.line]), (c.markup = Array(i + 1).join(String.fromCharCode(o)))),
          0)
        );
      };
    },
    ...
    18532: (e, t, r) => {
      ...
      function s(e, t) {
        ...
        return (
          ...
          (o = e.eMarks[t]),
          (42 !== (r = e.src.charCodeAt(s++)) && 45 !== r && 43 !== r) || (s < o && ((i = e.src.charCodeAt(s)), !n(i))) ? -1 : s
        );
      }
      function o(e, t) {
        var r,
    ...
    43804: (e, t, r) => {
      "use strict";
      var n = r(67022).normalizeReference,
        s = r(67022).isSpace;
      e.exports = function (e, t, r, o) {
        ...
        for (
          l = e.lineMax, v = e.md.block.ruler.getRules("reference"), m = e.parentType, e.parentType = "reference";
          w < l && !e.isEmpty(w);
          w++
        )
      ...
      (o.prototype.push = function (e, t, r) {
        ...
        (o.prototype.getLines = function (e, t, r, n) {
          var o,
            ...
            h = e;
          if (e >= t) return "";
          for (u = new Array(t - e), o = 0; h < t; h++, o++) {
            ...
            u[o] = i > r ? new Array(i - r + 1).join(" ") + this.src.slice(c, l) : this.src.slice(c, l);
          }
          return u.join("");
        }),
        (o.prototype.Token = n),
    ...
    91785: (e, t, r) => {
      ...
      function o(e) {
        ...
        for (t = e.charCodeAt(n); n < s; )
          124 === t && (o ? ((a += e.substring(i, n - 1)), (i = n)) : (r.push(a + e.substring(i, n)), (a = ""), (i = n + 1))),
            (o = 92 === t),
            n++,
            (t = e.charCodeAt(n));
      ...
      e.exports = function (e, t, r, i) {
        ...
        for (f = (c = s(e, t + 1)).split("|"), g = [], u = 0; u < f.length; u++) {
          if (!(_ = f[u].trim())) {
        ...
        for (
          m = e.push("tr_close", "tr", -1), m = e.push("thead_close", "thead", -1), h = t + 2;
          ...
          for (
            (f = o(c)).length && "" === f[0] && f.shift(),
              f.length && "" === f[f.length - 1] && f.pop(),
              h === t + 2 && ((m = e.push("tbody_open", "tbody", 1)).map = b = [t + 2, 0]),
            ...
            if ("inline" === C[r].type && e.md.linkify.pretest(C[r].content))
              for (m = 0, t = (i = C[r].children).length - 1; t >= 0; t--)
                if ("link_close" !== (c = i[t]).type) {
                  if (
                    ("html_inline" === c.type && ((v = c.content), /^<a[>\s]/i.test(v) && m > 0 && m--, s(c.content) && m++),
                    ...
                    for (
                      p = c.content,
                        ...
                        d = c.level,
                        f = 0,
                        b.length > 0 && 0 === b[0].index && t > 0 && "text_special" === i[t - 1].type && (b = b.slice(1)),
                        u = 0;
                      u < b.length;
                      u++
                    )
                      (g = b[u].url),
                        ...
                        e.md.validateLink(_) &&
                          ...
                          (h = b[u].index) > f && (((a = new e.Token("text", "", 0)).content = p.slice(f, h)), (a.level = d), l.push(a)),
                          ((a = new e.Token("link_open", "a", 1)).attrs = [["href", _]]),
                          (a.level = d++),
                          (a.markup = "linkify"),
                          (a.info = "auto"),
                          l.push(a),
                          ...
                          l.push(a),
                          (f = b[u].lastIndex));
                    f < p.length && (((a = new e.Token("text", "", 0)).content = p.slice(f)), (a.level = d), l.push(a)),
                      (C[r].children = i = n(i, t, l));
                  }
                } else for (t--; i[t].level !== c.level && "link_open" !== i[t].type; ) t--;
      };
    },
    74129: (e) => {
      "use strict";
    ...
    2834: (e) => {
      ...
      function i(e) {
        ...
        for (t = e.length - 1; t >= 0; t--)
          "text" !== (r = e[t]).type || s || (r.content = r.content.replace(n, o)),
        ...
        if (e.md.options.typographer)
          for (n = e.tokens.length - 1; n >= 0; n--)
            "inline" === e.tokens[n].type &&
              (r.test(e.tokens[n].content) && i(e.tokens[n].children), t.test(e.tokens[n].content) && a(e.tokens[n].children));
      };
    },
    58450: (e, t, r) => {
      "use strict";
      var n = r(67022).isWhiteSpace,
        s = r(67022).isPunctChar,
        o = r(67022).isMdAsciiPunct,
        i = /['"]/,
        a = /['"]/g;
      function c(e, t, r) {
      ...
      e.exports = function (e) {
        ...
        if (e.md.options.typographer)
          for (t = e.tokens.length - 1; t >= 0; t--)
            "inline" === e.tokens[t].type && i.test(e.tokens[t].content) && l(e.tokens[t].children, e);
      };
    },
    16480: (e, t, r) => {
      "use strict";
    ...
    46633: (e) => {
      ...
      e.exports = function (e) {
        ...
        for (t = 0, r = a.length; t < r; t++)
          if ("inline" === a[t].type) {
            for (o = (n = a[t].children).length, s = 0; s < o; s++) "text_special" === n[s].type && (n[s].type = "text");
            for (s = i = 0; s < o; s++)
            ...
            ? ((o = e.md.normalizeLink(s)),
              !!e.md.validateLink(o) &&
                (n ||
                  ...
                  (i.markup = "autolink"),
                  (i.info = "auto"),
                  ((i = e.push("text", "", 0)).content = e.md.normalizeLinkText(s)),
      ...
      (e.exports.w = function (e, t) {
        ...
        for (n = e.scanDelims(e.pos, 42 === o), r = 0; r < n.length; r++)
          (e.push("text", "", 0).content = String.fromCharCode(o)),
            e.delimiters.push({ marker: o, length: n.length, token: e.tokens.length - 1, end: -1, open: n.can_open, close: n.can_close });
    ...
    99391: (e, t, r) => {
      ...
      var n = r(26233),
        s = r(67022).has,
        o = r(67022).isValidEntityCode,
        i = r(67022).fromCodePoint,
      ...
      e.exports = function (e, t) {
        ...
        if (35 === e.src.charCodeAt(p + 1)) {
          if ((l = e.src.slice(p).match(a)))
            return (
              t ||
                ((r = "x" === l[1][0].toLowerCase() ? parseInt(l[1].slice(1), 16) : parseInt(l[1], 10)),
                ((u = e.push("text_special", "", 0)).content = o(r) ? i(r) : i(65533)),
                (u.markup = l[0]),
                (u.info = "entity")),
              (e.pos += l[0].length),
              !0
          ...
          return (
            t || (((u = e.push("text_special", "", 0)).content = n[l[1]]), (u.markup = l[0]), (u.info = "entity")),
            (e.pos += l[0].length),
            !0
          );
        return !1;
    ...
    1917: (e, t, r) => {
      "use strict";
      for (var n = r(67022).isSpace, s = [], o = 0; o < 256; o++) s.push(0);
      "\\!\"#$%&'()*+,./:;<=>?@[]^_`{|}~-".split("").forEach(function (e) {
        ...
        (e.exports = function (e, t) {
          ...
          if (10 === (r = e.src.charCodeAt(l))) {
            for (t || e.push("hardbreak", "br", 0), l++; l < u && ((r = e.src.charCodeAt(l)), n(r)); ) l++;
            return (e.pos = l), !0;
          }
          return (
            (a = e.src[l]),
            r >= 55296 && r <= 56319 && l + 1 < u && (o = e.src.charCodeAt(l + 1)) >= 56320 && o <= 57343 && ((a += e.src[l + 1]), l++),
            (i = "\\" + a),
            t ||
        ...
        if ((u = c + 1) < b && 40 === e.src.charCodeAt(u)) {
          ...
          for (
            g = u,
              (h = e.md.helpers.parseLinkDestination(e.src, u, e.posMax)).ok &&
                ((_ = e.md.normalizeLink(h.str)), e.md.validateLink(_) ? (u = h.pos) : (_ = "")),
              g = u;
            u < b && ((o = e.src.charCodeAt(u)), s(o) || 10 === o);
            u++
          );
          if (((h = e.md.helpers.parseLinkTitle(e.src, u, e.posMax)), u < b && g !== u && h.ok))
          ...
          if (
            (u < b && 91 === e.src.charCodeAt(u)
              ? ((g = u + 1), (u = e.md.helpers.parseLinkLabel(e, u)) >= 0 ? (a = e.src.slice(g, u++)) : (u = c + 1))
              : (u = c + 1),
            a || (a = e.src.slice(l, c)),
    ...
    81727: (e, t, r) => {
      ...
      e.exports = function (e, t) {
        ...
        if ((l = a + 1) < m && 40 === e.src.charCodeAt(l)) {
          for (_ = !1, l++; l < m && ((o = e.src.charCodeAt(l)), s(o) || 10 === o); l++);
          if (l >= m) return !1;
          if (((g = l), (u = e.md.helpers.parseLinkDestination(e.src, l, e.posMax)).ok)) {
            for (
              h = e.md.normalizeLink(u.str), e.md.validateLink(h) ? (l = u.pos) : (h = ""), g = l;
              l < m && ((o = e.src.charCodeAt(l)), s(o) || 10 === o);
              l++
            );
            if (((u = e.md.helpers.parseLinkTitle(e.src, l, e.posMax)), l < m && g !== l && u.ok))
              for (f = u.str, l = u.pos; l < m && ((o = e.src.charCodeAt(l)), s(o) || 10 === o); l++);
          }
        ...
        if (_) {
          ...
          if (
            (l < m && 91 === e.src.charCodeAt(l)
              ? ((g = l + 1), (l = e.md.helpers.parseLinkLabel(e, l)) >= 0 ? (i = e.src.slice(g, l++)) : (l = a + 1))
              : (l = a + 1),
            i || (i = e.src.slice(c, a)),
        ...
        if (((r = e.pending.length - 1), (s = e.posMax), !t))
          if (r >= 0 && 32 === e.pending.charCodeAt(r))
            if (r >= 1 && 32 === e.pending.charCodeAt(r - 1)) {
              for (o = r - 1; o >= 1 && 32 === e.pending.charCodeAt(o - 1); ) o--;
    ...
    50670: (e, t, r) => {
      "use strict";
      var n = r(75872),
        s = r(67022).isWhiteSpace,
        o = r(67022).isPunctChar,
        i = r(67022).isMdAsciiPunct;
      function a(e, t, r, n) {
        (this.src = e),
          (this.env = r),
          (this.md = t),
      ...
      (a.prototype.pushPending = function () {
        ...
        (a.prototype.push = function (e, t, r) {
          ...
          return (
            ...
            (s.level = this.level),
            r > 0 &&
              (this.level++, this._prev_delimiters.push(this.delimiters), (this.delimiters = []), (o = { delimiters: this.delimiters })),
    ...
    44814: (e) => {
      ...
      (e.exports.w = function (e, t) {
        ...
        for (s % 2 && ((e.push("text", "", 0).content = o), s--), r = 0; r < s; r += 2)
          (e.push("text", "", 0).content = o + o),
            e.delimiters.push({ marker: a, length: 0, token: e.tokens.length - 1, end: -1, open: n.can_open, close: n.can_close });
        return (e.pos += n.length), !0;
      }),
        (e.exports.g = function (e) {
          var r,
        ...
        return (
          ...
          (s = (function (e) {
            var r,
              ...
              s = t[e];
            if (s) return s;
            for (s = t[e] = [], r = 0; r < 128; r++) (n = String.fromCharCode(r)), s.push(n);
          ...
          e.replace(/(%[a-f0-9]{2})+/gi, function (e) {
            ...
            for (t = 0, r = e.length; t < r; t += 3)
              (n = parseInt(e.slice(t + 1, t + 3), 16)) < 128
                ? (l += s[n])
                : 192 == (224 & n) && t + 3 < r && 128 == (192 & (o = parseInt(e.slice(t + 4, t + 6), 16)))
                ? ((l += (c = ((n << 6) & 1984) | (63 & o)) < 128 ? "��" : String.fromCharCode(c)), (t += 3))
                : 224 == (240 & n) &&
                  t + 6 < r &&
                  ...
                  128 == (192 & o) && 128 == (192 & i))
                ? ((l +=
                    (c = ((n << 12) & 61440) | ((o << 6) & 4032) | (63 & i)) < 2048 || (c >= 55296 && c <= 57343)
                      ? "���"
                ...
                ? ((c = ((n << 18) & 1835008) | ((o << 12) & 258048) | ((i << 6) & 4032) | (63 & a)) < 65536 || c > 1114111
                    ? (l += "����")
            ...
            l = (function (e) {
              ...
              for (s = t[e] = [], r = 0; r < 128; r++)
                (n = String.fromCharCode(r)),
                  /^[0-9a-z]$/i.test(n) ? s.push(n) : s.push("%" + ("0" + r.toString(16).toUpperCase()).slice(-2));
    ...
    48765: (e, t, r) => {
      "use strict";
      (e.exports.encode = r(70729)), (e.exports.decode = r(83122)), (e.exports.format = r(2201)), (e.exports.parse = r(9553));
    },
    9553: (e) => {
      "use strict";
      function t() {
      ...
      (t.prototype.parse = function (e, t) {
        ...
        var _ = r.exec(m);
        if (
          (_ && ((i = (_ = _[0]).toLowerCase()), (this.protocol = _), (m = m.substr(_.length))),
          (t || _ || m.match(/^\/\/[^@\/]+@[^@\/]+/)) &&
            (!(d = "//" === m.substr(0, 2)) || (_ && p[_]) || ((m = m.substr(2)), (this.slashes = !0))),
          !p[_] && (d || (_ && !h[_])))
        ) {
          var k,
            b,
    ...
    84205: (e, t, r) => {
      "use strict";
      (t.Any = r(29369)), (t.Cc = r(99413)), (t.Cf = r(52326)), (t.P = r(73189)), (t.Z = r(35045));
    },
    29369: (e) => {
      e.exports =
        /[\0-\uD7FF\uE000-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/;
