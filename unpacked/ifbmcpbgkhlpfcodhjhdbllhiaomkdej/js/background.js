var background = /******/ (function (modules) {
  // webpackBootstrap
  /******/ // The module cache
  ...
  \****************************************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CopyPasteService", function () {
          return CopyPasteService;
        });
        /* harmony import */ var _getClipboardDataReturnValue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! ./getClipboardDataReturnValue */ "../../packages/office-online-ccp/lib/getClipboardDataReturnValue.js"
        );
        ...
        class CopyPasteService {
          constructor(logger, imageReader, window) {
            ...
            this.onPasteEventImage = (event) => {
              ...
              for (let i = 0; i < items.length; i += 1) {
                if (this.imageReader.isImageFile(items[i])) {
                  ...
                  if (file != null) this.imageBlobs.push(file);
                }
              }
            };
            ...
            this.getClipboardData = (event) => {
              ...
              if (event.clipboardData.types.indexOf("ppt/objectmetadata") !== -1) {
                this.clipboardData.pptObjectMetaData = event.clipboardData.getData("ppt/objectmetadata");
              }
              if (event.clipboardData.types.indexOf("ppt/objectdata") !== -1) {
                this.clipboardData.pptObjectData = event.clipboardData.getData("ppt/objectdata");
              }
            };
          ...
          isTrustedSender(sender) {
            var _a;
            try {
              if (sender === null || sender.url === undefined) return false;
              const senderUrl = new URL(sender.url);
              if (senderUrl.origin === null) return false;
              const domainMatch = senderUrl.origin.match(
          ...
          handleGetClipboardDataCommand(_message, sender, sendResponse) {
            ...
            try {
              ...
              (_a = this.logger) === null || _a === void 0
                ? void 0
                : _a.error(`handleGetClipboardDataCommand() - Exception: ${e.toString()}`);
            }
  ...
  \************************************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        "use strict";
        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FileReaderEx", function () {
          return FileReaderEx;
        });
        class FileReaderEx {
          constructor() {
            ...
            this.onloadendInternal = (event) => {
              if (this.onloadend !== null) this.onloadend(event);
            };
            this.onabortInternal = (event) => {
              if (this.onabort !== null) this.onabort(event);
            };
          ...
          readAsDataURL(blob) {
            ...
            if (this.reader !== undefined) this.reader.readAsDataURL(blob);
          }
          isBlob(obj) {
  ...
  \***************************************************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        "use strict";
        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GetClipboardDataReturnValue", function () {
          return GetClipboardDataReturnValue;
        });
  ...
  \***********************************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        "use strict";
        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ImageReader", function () {
          return ImageReader;
        });
        class ImageReader {
  ...
  \*****************************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        "use strict";
        __webpack_require__.r(__webpack_exports__);
        /* harmony import */ var _copyPasteService__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! ./copyPasteService */ "../../packages/office-online-ccp/lib/copyPasteService.js"
        );
        /* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "CopyPasteService", function () {
          return _copyPasteService__WEBPACK_IMPORTED_MODULE_0__["CopyPasteService"];
        });

        /* harmony import */ var _fileReaderEx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ./fileReaderEx */ "../../packages/office-online-ccp/lib/fileReaderEx.js"
        );
        /* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "FileReaderEx", function () {
          return _fileReaderEx__WEBPACK_IMPORTED_MODULE_1__["FileReaderEx"];
        });

        /* harmony import */ var _imageReader__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ./imageReader */ "../../packages/office-online-ccp/lib/imageReader.js"
        );
        /* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ImageReader", function () {
          return _imageReader__WEBPACK_IMPORTED_MODULE_2__["ImageReader"];
        });
  ...
  \*****************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        "use strict";
        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CopyPasteMessageListener", function () {
          return CopyPasteMessageListener;
        });
        /* harmony import */ var _1js_office_online_ccp__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! @1js/office-online-ccp */ "../../packages/office-online-ccp/lib/index.js"
        );
  ...
  \***************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _CopyPasteMessageListener__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ./CopyPasteMessageListener */ "./src/CopyPasteMessageListener.ts"
        );
        ...
        var copyPasteService = new _1js_office_online_ccp__WEBPACK_IMPORTED_MODULE_0__["CopyPasteService"](
          null /* logger */,
          imageReader,
          window
        );
        var copyPasteMessageListener = new _CopyPasteMessageListener__WEBPACK_IMPORTED_MODULE_1__["CopyPasteMessageListener"](
          copyPasteService
        );
