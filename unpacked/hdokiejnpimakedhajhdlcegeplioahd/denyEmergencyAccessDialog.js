...
(DenyEmergencyAccessDialog.prototype = Object.create(Dialog.prototype)),
  ((DenyEmergencyAccessDialog.prototype.constructor = DenyEmergencyAccessDialog).prototype.initialize = function (e) {
    Dialog.prototype.initialize.apply(this, arguments);
  }),
  (DenyEmergencyAccessDialog.prototype.setup = function (e, t) {
    t.sharee &&
      (t.sharee.getAccessDate() < new Date()
        ? $("#denyEmergencyAccessDialogText").text(
            Strings.translateString("%s gained emergency access to your vault on %s", t.sharee.getName(), t.sharee.getAccessDateAsString())
          )
        : $("#denyEmergencyAccessDialogText").text(
            Strings.translateString(
              "%s requested emergency access to your vault. They will receive access on %s",
              t.sharee.getName(),
              t.sharee.getAccessDateAsString()
            )
          )),
  ...
  (DenyEmergencyAccessDialog.prototype.handleSubmit = function () {
    LPRequest.makeRequest(LPProxy.denyEmergencyAccess, {
      params: { email: this.data.sharee.getName() },
      success: function () {
