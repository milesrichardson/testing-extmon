...
function LPDOMHelper_lib() {
  ...
  (this.InputIsText = function (t) {
    ...
    (this.elt_getId = function (t) {
      var t;
      return t ? ("string" == typeof t.id ? t.id : null === (t = t.getAttribute("id")) ? "" : t) : "";
    }),
    (this.elt_getName = function (t) {
      var t;
      return t ? ("string" == typeof t.name ? t.name : null === (t = t.getAttribute("name")) ? "" : t) : "";
    }),
    (this.elt_getType = function (t) {
      var t;
      return t ? ("string" == typeof t.type ? t.type : null === (t = t.getAttribute("type")) ? "" : t) : "";
    }),
    (this.elt_getAttribute = function (t, e) {
      return !t || !e || void 0 === t.getAttribute ? "" : t.getAttribute(e);
    }),
    (this.is_encrypted_field = function (t) {
      return "function" == typeof is_encrypted_field
        ? is_encrypted_field(t)
        : "text" == t || "password" == t || "textarea" == t || "email" == t || "tel" == t || "url" == t;
    }),
    ...
    (this.GetLocationFromDocument = function (t) {
      ...
      try {
        var n = t.location;
        n && (e = n), void 0 === (e = isEmptyObject(n) ? null : e) && (e = null);
      } catch (t) {
    ...
    (this.GetOwnerDocument = function (t) {
      return !t || void 0 === t.ownerDocument ? null : t.ownerDocument;
    }),
    (this.GetWindowFromDocument = function (t) {
      return !t || void 0 === t.defaultView ? null : t.defaultView;
    }),
    ...
    (this.FindElementById = function (t) {
      var e = LP_derive_doc();
      return "undefined" != typeof LPDriver && void 0 !== LPDriver.find_element_by_id
        ? LPDriver.find_element_by_id(e, t)
        : r.GetElementById(t);
    }),
    (this.FindElementByName = function (t) {
      var e = LP_derive_doc(),
        e;
      return "undefined" != typeof LPDriver && void 0 !== LPDriver.find_element_by_name
        ? LPDriver.find_element_by_name(e, t)
        : !(e = e.getElementsByName(t)) || e.length < 1
        ? null
        : e[0];
    }),
    ...
    (this.DetachElement = function (t) {
      var e;
      return t ? ((e = t.parentNode) && e.removeChild(t), t) : null;
    }),
