...
!(function (o) {
  "use strict";
  var e =
    ((r.prototype.checkUserState = function (o) {
      !this.global.lploggedin && this.global.shouldOpenLogin()
        ? (o({ error: "User is not logged in." }), this.platform.openLoginPopover())
        : o({ result: "OK." });
    }),
        ...
        loadHandler: function (t) {
          var o = {
            ...
            error: function (o, e, r) {
              s.handleResponseFromThridParty(t, n, { error: e });
            }
          };
          if (i.header) {
            o.headers = {};
          ...
          if ("json" !== i.dataType) {
            var r = [],
              a;
            for (a in i.data) r.push(a + "=" + encodeURIComponent(i.data[a]));
            o.data = r.join("&");
          } else o.data = JSON.stringify(i.data);
          t.getTop().jQuery.ajax(o),
            (s.cstimeout = setTimeout(function () {
              s.handleResponseFromThridParty(t, n, { error: "timeout" });
            }, 1e4));
        }
      });
    }),
    ...
    (r.prototype.getLocalKey = function (o) {
      o({ key: g_local_key, hash: g_local_key_hash, hex: g_local_key_hex });
    }),
    (r.prototype.urlToCall = function (o) {
      var o = lpParseUri(o);
      return o.protocol ? o.protocol + "://" + o.host : o.host;
    }),
    r);
  function r(o, e) {
