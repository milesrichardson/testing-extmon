(function () {
  ...
  var validateSamlResponse = function () {
    ...
    if (
      ...
      runtime.sendMessage({ validateK1: samlForm.SAMLResponse.value }, function (isValid) {
        if (isValid) {
   ...
   */
  const successPages = ["https://accounts.lastpass.com/auth/saml2/success", "https://accounts.lastpass.com/federated/oidcredirect.html"];
