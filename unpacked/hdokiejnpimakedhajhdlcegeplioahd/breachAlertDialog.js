...
(BreachAlertDialog.prototype = Object.create(Dialog.prototype)),
  ((BreachAlertDialog.prototype.constructor = BreachAlertDialog).prototype.initialize = function () {
    var t;
    Dialog.prototype.initialize.apply(this, arguments),
      (t = this),
      $("#breachAlertDialogAction").bind("click", function () {
        t.submit();
      });
  }),
  (BreachAlertDialog.prototype.setupButtons = function () {}),
  (BreachAlertDialog.prototype.close = function () {
  ...
  (BreachAlertDialog.prototype.setup = function (t, e) {
    e.notification &&
      ($("#breachAlertDialogName").text(" " + e.notification.name),
      $("#breachAlertDialogUsername").text(" " + e.notification.username),
      (this.breached = e.notification.breached)),
