SiteLaunchObserver = (function (i) {
  function o() {
    (this.acc = null),
      ...
      (this.hasFormWithPassword = !1),
      (this.formData = null),
      (this.formDisappeared = !1),
      (this.timeout = null),
      (this.timedout = !1);
  }
  var r = {},
    e = !1;
  function t(t, a) {
    t(reduxApp.getState().user.launchSiteTrackingEnabled);
  }
  function a(t, a) {
  ...
  function u(a, t, e) {
    r[a] && !r[a].launchedSite && (clearTimeout(r[a].timeout), delete r[a]),
      (r[a] = new o()),
      (r[a].acc = t),
      (r[a].timeout = setTimeout(function () {
        var t = r[a];
  ...
  function c(t) {
    (t.hasFormWithPassword = !!t.formData || t.hasFormWithPassword),
      D(t.acc, " Tracking Results:"),
      D(t.acc, " FormFound: " + t.hasFormWithPassword),
      D(t.acc, " FormSubmitted: " + t.formSubmitted),
      D(t.acc, " FormDisappeared: " + t.formDisappeared),
      D(t.acc, " UserInteraction: " + t.userInteraction),
      D(t.acc, " TimedOut: " + t.timedout);
  }
  function s(t, a) {
    for (var e = 0; e < a.length; e++) for (var i in a[e]) if (a[e][i] === t[i] && a[e].hasOwnProperty(i) && "" != a[e][i]) return;
  }
  function d(t, a) {
    var t;
    r[a.tabID] &&
      ((r[a.tabID].formData = t),
      (r[a.tabID].formSubmitted = !0),
      (r[a.tabID].userInteraction = t.userSubmit),
      h(a),
      (t = t.id || t.name),
      D(r[a.tabID].acc, "Form(" + t + ") submitted."));
  }
  function f(t, a) {
  ...
  function h(e) {
    var i = r[e.tabID],
      t;
    i &&
      LPTabs.get({ tabID: e.tabID }).forEachWindow({
        each: function (t, a) {
