...
(LoginDialog.prototype = Object.create(Dialog.prototype)),
  ((LoginDialog.prototype.constructor = LoginDialog).prototype.initialize = function (o) {
    var t, a, i;
    Dialog.prototype.initialize.apply(this, arguments),
      (t = $(window)),
      (a = $(".inputCapsMatter")),
      t.bind("capsOn", function (o) {
        a.addClass("isCaps");
      }),
      ...
      t.capslockstate(),
      a.addClass(t.capslockstate("state")),
      (i = this),
  ...
  (LoginDialog.prototype.validate = function (o) {
    ...
    return (
      "" === o.email && (this.addError("email", Strings.translateString("Please enter your email.")), (t = !1)),
      "" === o.password && (this.addError("password", Strings.translateString("Please enter your password.")), (t = !1)),
      t
    );
  });
