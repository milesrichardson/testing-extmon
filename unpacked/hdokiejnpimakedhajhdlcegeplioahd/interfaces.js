Interfaces = (function () {
  var a = function (t, n) {
    ...
    o = function (t, n) {
      var n = [].concat(n);
      for (i = 0; i < n.length; ++i) for (j = 0; j < t.length; ++j) if (t[j] === n[i]) return !0;
      return !1;
    },
    t =
      ...
      function (t, n) {
        for (var o in n) {
          var i = n[o];
          "object" == typeof i && t.hasOwnProperty(o) ? Interfaces.extend(t[o], i) : (t[o] = i);
        }
      });
  (p = function (o, i, e) {
    return function (t) {
      var n = i[t];
      if (n && n.options && n.options.sourceFunction && !1 !== e.direct) return n.options.sourceFunction();
      if (i.hasOwnProperty(t)) return o[t];
    ...
    (h = function (i, e, r, c) {
      ...
      return c.direct
        ...
        : function (t, n) {
            var o = e[t];
            s(o, t, n), o.shouldSendIndirect() && c.requestFunction({ cmd: "LPData.setValue", args: [r.concat(t), n] });
          };
    }),
    (l = function (n, o, r, c) {
      return function () {
    ...
    (y = function (i, e, r) {
      if ("function" == typeof r.requestFunction)
        return function () {
          for (var t = [], n = 0, o = arguments.length; n < o; ++n) t.push(arguments[n]);
          return r.requestFunction({ cmd: 0 < i.length ? i.concat(e) : e, args: t });
        };
    ...
    (v = function (t, n, o, i, e, r) {
      ...
      for (u in i) {
        ...
        f instanceof a
          ? f.isFunction()
            ? !f.requiredBy(r.context) ||
              (f.isSyncronousFunction() && r.asyncOnly) ||
              (r.direct || f.isSyncronousFunction()
                ? n && "function" == typeof n[u]
                  ? ((t[u] = l(f, n, n[u], r)), !r.direct && f.shouldSendIndirect() && (t[u] = d(t, t[u], y(e, u, r))))
                  : s.push(f.type + ": " + e.concat(u).join("."))
                : (t[u] = y(e, u, r)))
            : f.isConstructor()
            ? f.requiredBy(r.context) &&
              !r.asyncOnly &&
              (n && "function" == typeof n[u] ? (t[u] = n[u]) : s.push(f.type + ": " + e.concat(u).join(".")))
            : (c = !0)
          : (t.hasOwnProperty(u) || (t[u] = {}), v(t[u], n && n[u], o && o[u], i[u], e.concat(u), r));
      }
      if ((c && ((t.get = p(o, i, r)), (t.set = h(o, i, e, r))), 0 < s.length && r.checkMissing))
        ...
        for (r in t) {
          ...
          s instanceof a
            ? s.isPrimitive() &&
              s.requiredBy(n) &&
              (!o || s.isSyncronized()) &&
              e.push({ sourceFunction: s.options && s.options.sourceFunction, path: c })
      ...
      function (t, n) {
        ...
        for (var i = 0; i < t.length; ++i) {
          var e = t[i],
            r;
          n.syncronizedOnly
            ? void 0 === (r = u[e]) && (r = u[e] = f(n.interface, e, !0))
            : void 0 === (r = c[e]) && (r = c[e] = f(n.interface, e, !1)),
            (o = o.concat(r));
        }
        return o;
      }),
      ...
      if (t.context)
        for (var o = s(t.context, t), i = 0, e = o.length; i < e; ++i) {
          var r = o[i],
            c,
            c = r.sourceFunction
              ? "function" == typeof r.sourceFunction
                ? r.sourceFunction()
                : LPReflection.callFunction(null, r.sourceFunction, [], { context: t.source })
              : LPReflection.getValue(t.interface, r.path, { context: t.source });
          LPReflection.setValue(null, r.path, c, { context: n });
        }
      return n;
    },
    clearPrimitives: function (t) {
      if (t.context)
        for (var n = s(t.context, t), o = 0; o < n.length; ++o) LPReflection.setValue(null, n[o].path, null, { context: t.source });
    },
    getName: function (t) {
      for (var n in this) if (t === this[n]) return n;
