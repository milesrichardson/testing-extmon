var ContainerSelectionDialog = function (e) {
  ...
  VaultItemDialog.call(this, e, {
    ...
    (this.availableCollapsed = !1),
    (this.selectedCollapsed = !1),
    (this.toggleCollapse =
      ((a = this),
      function (e, t, n) {
        var n = $(n.target);
        a[e]
          ? (t.expandAll(), (a[e] = !1), n.attr("title", "Collapse All"))
          : (t.collapseAll(), (a[e] = !0), n.attr("title", "Expand All")),
          n.toggleClass("selected");
      }));
};
(ContainerSelectionDialog.prototype = Object.create(VaultItemDialog.prototype)),
  ...
  (function (e) {
    ContainerSelectionDialog.prototype.initialize = function (e) {
      ...
      VaultItemDialog.prototype.initialize.apply(this, arguments),
        (t = this),
        e.find(".availableSearch").LP_addSearchHandlers("inputDialog", function (e) {
        ...
        (t.availableContainerElement = e.find(".containerSelectionDialogAvailable")),
        t.availableContainerElement.bind("dragover", function (e) {
        ...
        (t.selectedContainerElement = e.find(".containerSelectionDialogSelected")),
        t.selectedContainerElement.bind("dragover", function (e) {
        ...
        (t.availableVaultItemOverrides = {
          getContextMenuItems: function (e) {
            return [new LPTools.ContextMenuItem(Constants.ACTION_ADD, { text: t.getAddToSelectedText() })];
          },
        ...
        (t.selectedVaultItemOverrides = {
          getContextMenuItems: function (e) {
            return [new LPTools.ContextMenuItem(Constants.ACTION_REMOVE, { text: t.getRemoveFromSelectedText() })];
          },
          isOverride: function (e) {
    ...
    (ContainerSelectionDialog.prototype.getAddToSelectedText = function () {
      ...
      (ContainerSelectionDialog.prototype.setup = function (e, t) {
        ...
        (this.selectedFromAvailable = []),
          ...
          ((n = this).containers.available = new Container(n.getAvailableItems(t), {
          ...
          n.containers.available.initialize(n.availableContainerElement.get(0)),
          (n.containers.selected = new Container(n.getSelectedItems(t), {
            display: VaultItemBaseDisplay.prototype.DISPLAY_LIST,
            additionalItemClasses: "dialogItem noItemButtons",
            additionalGroupClasses: "dialogItemGroup",
            forceDrag: !0,
          ...
          n.containers.selected.initialize(n.selectedContainerElement.get(0)),
