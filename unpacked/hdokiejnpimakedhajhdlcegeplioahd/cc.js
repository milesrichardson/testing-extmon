...
function LPCC_lib() {
  ...
  function h(A) {
    if (null !== A && 0 < A.length && null !== A.match(/^35[\d]{14}/)) {
      var g = parseInt(A);
      if (!isNaN(g) && 3528e12 <= A && A <= 0xcc11602be5fff) return 1;
    }
  }
  function z(A) {
    return (
      null !== A &&
      0 < A.length &&
      (null !== A.match(/^30[0123459][\d]{11}/) || null !== A.match(/^36[\d]{12}/) || null !== A.match(/^3[89][\d]{12}/))
    );
  }
  function H(A) {
    if (null !== A && 0 < A.length && null !== A.match(/^622[\d]{13}/)) {
      var g = parseInt(A);
      if (!isNaN(g) && 622126e10 <= A && A <= 6229259999999999) return 1;
    }
  }
  function F(A) {
  ...
  (this.geticonFF = function (A, g) {
    var D = "function" == typeof getBG ? getBG() : null,
      ...
      e;
    if (
      ("undefined" != typeof g_formfills
        ? ((w = g_formfills), (n = !0))
        : D && void 0 !== D.g_formfills
        ? ((w = D.g_formfills), (n = !0))
        : "undefined" != typeof lpformfills
        ? (w = lpformfills)
        : D && void 0 !== D.lpformfills && (w = D.lpformfills),
      null != A && null !== w)
    )
      for (var f in w) {
        if (A == w[f].ffid)
          return (
            (e = ""), geticonCCnum((e = n ? lpmdec_acct(w[f].ccnum, !0, w[f], D.g_shares) : lpdec_acct(w[f].ccnum, w[f], lpshares)), g)
          );
      }
    return g ? B.geticonFF4_0(A) : E;
  }),
      ...
      if (A && "object" != typeof A && "function" != typeof A)
        switch (B.getCCType(A)) {
          ...
          case j:
            ...
            break;
          default:
            g = null !== A && 0 < A.length ? e : E;
        }
      return g;
    }),
    "undefined" != typeof g_iscasper && g_iscasper && ((B.visa_ico = D), (B.generic_ico = e), (B.default_ico = E)),
    (this.getCCIcon = function (A) {
      var g,
        D = "Form_Fill.png";
    ...
    (this.getFormattedNumber = function (A) {
      return A ? (this.getCCType(A) !== i ? "•••• •••• •••• " + A.slice(-4) : "•••• •••••• " + A.slice(-5)) : "---- ---- ---- ----";
    });
  var O = {
    T_VISA:
