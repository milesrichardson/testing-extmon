...
(RestrictedSharingDialog.prototype = Object.create(Dialog.prototype)),
  ((RestrictedSharingDialog.prototype.constructor = RestrictedSharingDialog).prototype.initialize = function (t) {
    var i;
    Dialog.prototype.initialize.apply(this, arguments),
      (i = this),
      document.querySelector("#dialogCloseButton").classList.remove("dialogCloseButton"),
      (document.querySelector("#dialogCloseButton").innerHTML = "&#10006;"),
      t.find("#dialogOverlay").bind("click", function () {
        i.close(!0);
      }),
