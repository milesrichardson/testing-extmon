  ...
  var e = Dialog,
    ...
    a =
      ((((t.prototype = Object.create(Dialog.prototype)).constructor = t).prototype.close = function (o) {
        ...
        return (
          t &&
            (0 === e.prototype.getDialogCount() && 0 === LPDialog.getPendingCount()
              ? csTop.LPFrame.close(i.dialogID)
              : this.setFrameSize()),
          this.data.modal && csTop.LPFrame.hideModal(),
          t
        );
      }),
      (t.prototype.setFrameSize = function (t) {
        csTop.LPFrame.css({ id: i.dialogID, css: this.getSize(), callback: t && t.callback });
      }),
    ...
    o =
        ...
        for (var t = $(".dialog:visible, .selectDropdownList:visible"), o = null, e = 0; e < t.length; ++e) {
          ...
          null === o
            ...
            : ((o.top = Math.min(o.top, i.top)),
              (o.right = Math.max(o.right, i.right)),
              (o.bottom = Math.max(o.bottom, i.bottom)),
              (o.left = Math.min(o.left, i.left)));
        }
        return { "max-height": o ? o.bottom - o.top : 0, "max-width": o ? o.right - o.left : 0 };
      }),
      ...
      (t.prototype.requestAnimationFrame = function (t) {
        ...
        0 === this.pendingAnimations
          ? csTop.LPFrame.css({ id: i.dialogID, css: { "max-height": "none", "max-width": "none" }, callback: e })
          : e();
      }),
      (t.prototype.postSetup = function () {
        e.prototype.postSetup.apply(this, arguments),
          this.hide(),
          csTop.LPFrame.css({
            id: i.dialogID,
            css: { display: "block" },
      ...
      (t.prototype.showInitial = function () {
        this.show(),
          this.data.modal && csTop.LPFrame.showModal(),
          this.data.fullScreen || csTop.LPFrame.css({ id: i.dialogID, css: this.getSize() });
      }),
