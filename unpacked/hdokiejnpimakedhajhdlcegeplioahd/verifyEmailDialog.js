...
(VerifyEmailDialog.prototype = Object.create(Dialog.prototype)),
  ((VerifyEmailDialog.prototype.constructor = VerifyEmailDialog).prototype.handleSubmit = function () {
    var t;
    (t = this),
      LPRequest.makeRequest(LPProxy.sendVerificationEmail, {
