    ...
    var i = this,
      ...
      d = function (e, n) {
        LPMessaging.handleRequest(
          ...
          e,
          function (e) {
            l({ type: "contentScriptResponse", data: e, frameID: n });
          },
          { context: t.reflectionContext, additionalArguments: n }
        );
      },
      l = function (n) {
        (n.sourceFrameID = a),
          LPMessaging.makeRequest(c, n, function (e) {
            l({ type: "contentScriptResponse", data: e, frameID: n.frameID || 0 });
          });
      },
      m = function (e) {
        if (null === a && e.request.initializationID === u) {
          "undefined" != typeof Topics && Topics.get(Topics.REQUEST_FRAMEWORK_INITIALIZED).publish(e, i),
            (a = e.frameID),
            (o = !1),
            c({ type: "initialized", sourceFrameID: a });
      ...
      R =
        ((this.initialize = function (e) {
          null !== a || o || ((c = n(g, R)), t.frameIdentityManager ? t.frameIdentityManager.getFrameIdentity(I) : I(), (o = !0)),
            e && r.push(e);
        }),
