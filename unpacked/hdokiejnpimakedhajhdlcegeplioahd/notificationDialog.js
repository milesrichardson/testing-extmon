...
(NotificationDialog.prototype = Object.create(Dialog.prototype)),
  ((NotificationDialog.prototype.constructor = NotificationDialog).prototype.setupButtons = function () {
    var t;
    (t = this),
      $("#notificationDialogFeedback").bind("click", function () {
        bg.openURL(bg.get("base_url") + "feedback.php"), t.close();
      }),
      $("#notificationDialogTryAgain").bind("click", function () {
        window.location.href = "webclient-popover.html";
      }),
      $("#notificationDialogClose").bind("click", function () {
        t.close();
      }),
      $("#notificationDialogDisableMulti").bind("click", function () {
        bg.openURL(bg.get("base_url") + t.data.notification.multifactor_disable_url), t.close();
      }),
  ...
  (NotificationDialog.prototype.setup = function (t, o) {
    var i;
    LPFeatures.updateFeatures({ multifactor_disable: !0 }),
      o.notification &&
        (LPTools.setContent($("#notificationDialogMessage"), o.notification.msg),
        (i = []),
        o.notification.showFeedback && i.push("feedback"),
        o.notification.showLogin && i.push("tryAgain"),
        o.notification.showCreateAccount && i.push("createAccount"),
        o.notification.multifactor_disable_url && i.push("multifactor"),
        o.notification.showStartTrial && i.push("trial"),
        0 === i.length && i.push("default"),
        this.dialogContent.children().first().attr("class", i.join(" "))),
