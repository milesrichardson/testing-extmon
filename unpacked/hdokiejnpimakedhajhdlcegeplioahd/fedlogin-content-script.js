      ...
      get: function (T) {
        ...
        return (
          i ||
            ((s = []),
            (E = function (T) {
              for (var i = 0, E = s.length; i < E; ++i) if (T === s[i]) return i;
              return -1;
            }),
            (o = function (T) {
              var T = E(T);
            ...
            (i = {
              publish: function () {
                for (var T = !0, i = s.slice(), E = 0, o = i.length; E < o && !1 !== T; ++E)
                  try {
    ...
    (function (s) {
      ...
      (s.requestFrameworkInitializer =
        ...
        (s.requestNativeMessaging = function (T) {
          var i = getBG();
          i.Preferences.set("native_messaging_asked", "1"),
            T
      ...
      window.addEventListener(
        ...
        function (T) {
          ...
          !i.type ||
            ...
            o.origin !== T.origin ||
            i.fromExtension ||
            (E && E.cmd && "FederatedLogin" !== E.cmd[0] && "getVersion" !== E.cmd) ||
            s(i);
        },
        !0
      );
