with ((function () {
  var getProxy = function (globalContext, proxifyGlobalContext) {
    ...
    var isGlobalProperty = function (property) {
      ...
      if (hasOwnProperty(globalContext, property)) {
        return (
          !(value instanceof Element || value instanceof HTMLCollection) || Object.getOwnPropertyNames(globalContext).includes(property)
        );
      } else {
        return (
          (typeof EventTarget !== "undefined" && hasOwnProperty(EventTarget.prototype, property)) ||
  ...
  with ((function () {
    var i,
      ...
      t = {},
      p = function (i, o) {
        return !!i && (Object.prototype.hasOwnProperty.call(i, o) || i.hasOwnProperty(o));
      },
      _ = function (i) {
        var o;
        return (
          ...
          ((o = c[i]),
          p(c, i)
            ? !(o instanceof Element || o instanceof HTMLCollection) || Object.getOwnPropertyNames(c).includes(i)
            : ("undefined" != typeof EventTarget && p(EventTarget.prototype, i)) ||
              ("undefined" != typeof ContentScriptGlobalScope && p(ContentScriptGlobalScope.prototype, i)))
        );
      },
      ...
      I =
        "function" != typeof Proxy
          ...
          : new Proxy(Object.create(null), {
              get: function (i, o, T) {
                var E = Object.prototype.hasOwnProperty.call(r, o),
                  s,
                  e;
                if (o !== Symbol.unscopables && (_(o) || E))
                  return (
                    (s = p(t, o)),
                    (e = (E ? r : s ? t : c)[o]),
                    n && e === c && (e = I),
                    E || s || "function" != typeof e || !/^[a-z]/.test(o)
                      ? e
                      : (r[o] = new Proxy(e, {
                          construct: function (i, o, T) {
                            return Reflect.construct(i, o, T);
                          },
                          apply: function (i, o, T) {
                            return Reflect.apply(i, o === I ? c : o, T);
                          }
                        }))
                  );
              },
              set: function (i, o, T) {
                return n ? (t[o] = T) : (c[o] = T), delete r[o];
              },
              has: function () {
                return !0;
              }
    ...
    function addWebsiteAbilities(i) {
      var o = document.documentElement.getAttribute("lastpass-extension"),
        o;
      (o = (o = o ? o.split(" ") : []).concat(i)), document.documentElement.setAttribute("lastpass-extension", o.join(" "));
    }
    (Topics = (function () {
      var e = {};
      return {
        publish: function (i, o) {
          Topics.get(i).publish(o);
        },
        get: function (i) {
          var o = i && e[i],
            s,
          ...
          return (
            o ||
              ((s = []),
              (T = function (i) {
                for (var o = 0, T = s.length; o < T; ++o) if (i === s[o]) return o;
                return -1;
              }),
              (E = function (i) {
                var i = T(i);
              ...
              (o = {
                publish: function () {
                  for (var i = !0, o = s.slice(), T = 0, E = o.length; T < E && !1 !== i; ++T)
                    try {
                      "function" == typeof o[T] && (i = o[T].apply(window, arguments));
                    } catch (i) {
                      "function" == typeof LPPlatform.logException && LPPlatform.logException(i);
                    }
                },
                subscribe: function (i) {
                  -1 === T(i) && s.push(i);
                },
                subscribeFirst: function (i) {
                  E(i), s.unshift(i);
                },
      ...
      !(function (s) {
        ...
        (s.requestFrameworkInitializer =
          ...
          function (i) {
            return o((chrome.runtime && chrome.runtime.connect) || parent.chrome.runtime.connect, i);
          })),
          (s.installBinary = function (o, T) {
            var E = getBG();
            chrome.permissions.contains({ permissions: ["nativeMessaging"] }, function (i) {
              o || i ? E.openURL(E.base_url + "installer/") : s.requestNativeMessaging(T);
            });
          }),
          (s.requestNativeMessaging = function (i) {
            var o = getBG();
            o.Preferences.set("native_messaging_asked", "1"),
              i
                ? window.open("/native_messaging.html?hidenever=1")
                : void 0 !== chrome.permissions &&
                  chrome.permissions.request({ permissions: ["nativeMessaging", "privacy"] }, function (i) {
                    i && alert(o.gs("Please restart your browser to finish enabling native messaging."));
                  });
          });
      })(LPPlatform),
      addWebsiteAbilities("fedlogin"),
      !(function () {
        var E = null,
          i,
          s = LPPlatform.requestFrameworkInitializer(function (i) {
            (i.fromExtension = !0), E && E.target.postMessage(i, E.origin);
          }),
          o;
        window.addEventListener(
          ...
          function (i) {
            ...
            !o.type ||
              !(E =
                null === E && (i.origin === window.origin || ("undefined" != typeof bg && bg.get("base_url") === i.origin + "/"))
                  ? { target: i.source, origin: i.origin }
                  : E) ||
              E.target !== i.source ||
              E.origin !== i.origin ||
              o.fromExtension ||
              (T && T.cmd && "FederatedLogin" !== T.cmd[0] && "getVersion" !== T.cmd) ||
              s(o);
          },
          !0
        );
