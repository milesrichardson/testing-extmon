ExtensionLanguageUpdate = (function (e) {
    ...
    t = function () {
      ...
      i.eq(0).addClass("active"),
        ...
        a.click(function () {
          ...
          bg.switchLanguage(e),
            bg.saveUserLanguage(e),
            bg.setLanguageNotificationDismissal(function () {
        ...
        $("#laterButton").click(function () {
          u(),
            bg.clear_badge_text(),
            bg.setLanguageNotificationDismissal(function () {
              bg.sendLpImprove("language_downgrade_notification_dismiss", { source: "extension_dropdown" });
            });
        }),
  ...
  function l(e, n) {
    var a = e,
      ...
      e = e + 1;
    -1 == t
      ? ((n[a].className = "step active"), (n[e].className = "step next"))
      : (a === n.length - 1 ? (n[a].className = "step active") : ((n[a].className = "step active"), (n[e].className = "step next")),
        (n[t].className = "step prev"));
  }
  function u() {
  ...
  return {
    initialize: function () {
      n.addClass("languageUpdateInfo panelIsActive"),
        t(),
        bg.sendLpImprove("language_downgrade_notification_seen", { source: "extension_dropdown" });
    }
  };
})(document);
