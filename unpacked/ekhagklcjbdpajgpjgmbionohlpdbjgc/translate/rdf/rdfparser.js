    ...
    while (frame["parent"]) {
        ...
        if (!frame["parent"] || !frame["parent"]["nodeType"] || frame["parent"]["nodeType"] == frame["ARC"]) {
          ...
          if (rdftype != null) {
            this["store"]["add"](
              frame["node"],
              this["store"]["sym"](RDFParser["ns"]["RDF"] + "type"),
              this["store"]["sym"]($rdf.Util.uri.join(rdftype["nodeValue"], frame["base"])),
              this["why"]
            );
            if (rdftype["nodeName"]) {
          ...
          for (var x = attrs["length"] - 1; x >= 0; x--) {
            this["store"]["add"](
              ...
              this["store"]["literal"](attrs[x]["nodeValue"], frame["lang"]),
              this["why"]
            );
          }
        } else {
      ...
      while (frame["parent"]) {
        ...
        if (candidate == null || !dig) {
          ...
          (candidate["nodeType"] != RDFParser["nodeType"]["ELEMENT"] &&
