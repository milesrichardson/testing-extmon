    ...
    */
    ...
    if (this._parentContext == null) {
      throw BadSyntax(
        ...
        str,
        j,
        "Can't use ?xxx syntax for variable in outermost level: " + pyjslib_slice(str, j - 1, i)
      );
    }
    ...
    while (j < pyjslib_len(str)) {
      ...
      if (!m) {
        throw BadSyntax(
          ...
          str,
          j,
          "Closing quote missing in string at ^ in " + pyjslib_slice(str, j - 20, j) + "^" + pyjslib_slice(str, j, j + 20)
        );
      }
