...
var TRANSLATOR_OPTIONAL_PROPERTIES = [
  "targetAll",
  "browserSupport",
  "minVersion",
  "maxVersion",
...
var TRANSLATOR_PASSING_PROPERTIES = TRANSLATOR_REQUIRED_PROPERTIES.concat([
  "targetAll",
  "browserSupport",
  "code",
  "runMode",
...
Zotero.Translator.prototype.init = function (info) {
  ...
  var supported =
    !Zotero.isBookmarklet || this.browserSupport.includes("b") || /(?:^|; ?)bookmarklet-debug-mode=1(?:$|; ?)/.test(document.cookie);
