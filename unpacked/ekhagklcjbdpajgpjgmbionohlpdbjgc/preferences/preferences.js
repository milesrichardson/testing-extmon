...
var Zotero_Preferences = {
  ...
  init: async function () {
    ...
    Zotero.Prefs.loadNamespace("shortcuts").then(function () {
      ...
      for (let span of spans) {
        ReactDOM.render(
          React.createElement(Zotero_Preferences.Components.ShortcutInput, {
  ...
  refreshData: function () {
    // get errors
    return Zotero.Errors.getErrors()
...
Zotero_Preferences.General = {
  init: function () {
    ...
    document.getElementById("general-button-authorize").onclick = document.getElementById("general-button-reauthorize").onclick =
      Zotero_Preferences.General.authorize;
...
Zotero_Preferences.Advanced = {
  init: function () {
    ...
    if (testRunnerButton)
      testRunnerButton.onclick = function () {
...
Zotero_Preferences.Components.ClientStatus = class ClientStatus extends React.Component {
  ...
  checkStatus() {
    return Zotero.Connector.checkIsOnline().then(
      function (status) {
        this.setState({
          available: status
        });
  ...
  render() {
    ...
    return React.createElement(
      "div",
      null,
      React.createElement("p", null, "Zotero is currently ", available),
      React.createElement(
        "p",
        null,
...
Zotero_Preferences.Components.ProxyPreferences =
  ((_temp = class ProxyPreferences extends React.Component {
    constructor(props) {
      super(props);
      ...
      let settings = [
        ...
        "disableByDomain",
        "disableByDomainString",
        "loopPreventionTimestamp"
      ];
    ...
    render() {
      ...
      if (this.state.loopPreventionTimestamp > Date.now() && this.state.transparent) {
        redirectLoopPrevention = React.createElement(
          "div",
          {
            className: "group"
          },
          React.createElement(
            "b",
            null,
            "Zotero detected a proxy redirect loop and has temporarily suspended automatic proxy redirection."
          ),
          " ",
          React.createElement("input", {
            type: "button",
  ...
  renderProxySettings() {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement("label", null, "Hostnames"),
        React.createElement(
          "select",
          {
  ...
  render() {
    return React.createElement(
      ...
      React.createElement(
        ...
        this.state.proxies.length &&
          this.state.proxies.map((proxy, i) => {
            return React.createElement(
              "option",
              {
                key: i,
...
Zotero_Preferences.Components.MIMETypeHandling = class MIMETypeHandling extends React.Component {
  ...
  render() {
    ...
    if (this.state.hosts.length) {
      hosts = this.state.hosts.map((h, i) =>
        React.createElement(
          "option",
          {
            value: i,
    ...
    return React.createElement(
      "div",
      null,
      React.createElement("p", null, "Available when Zotero is running"),
      React.createElement(
        "p",
        null,
        React.createElement(
      ...
      React.createElement(
        ...
        React.createElement("label", null, "Enabled Hostnames"),
        React.createElement(
          "select",
          {
