...
(function () {
  ...
  Zotero.GoogleDocs.UI = {
    ...
    injectIntoDOM: async function () {
      ...
      document
        .querySelector(".kix-appview-editor-container")
        .insertBefore(Zotero.GoogleDocs.UI.pleaseWaitContainer, document.querySelector(".kix-appview-editor"));
      ReactDOM.render(
        React.createElement(Zotero.GoogleDocs.UI.PleaseWait, {
      ...
      document
        ...
        .insertBefore(Zotero.GoogleDocs.UI.orphanedCitationsContainer, document.querySelector("#docs-titlebar-share-client-button"));
      ReactDOM.render(
        React.createElement(Zotero.GoogleDocs.UI.OrphanedCitations, {
    ...
    toggleEnabled: function (state) {
      ...
      if (!state) {
        ...
        this._menubuttonHoverRemoveObserver = new MutationObserver(
          function () {
        ...
        this._buttonHoverRemoveObserver = new MutationObserver(
          function () {
    ...
    addKeyboardShortcuts: async function () {
      ...
      Zotero.Inject.addKeyboardShortcut(
    ...
    activate: async function (force, message) {
      message =
        message ||
        "Zotero needs the Google Docs tab to stay active for the current operation. " +
    ...
    closeInsertLinkPopup: async function (confirm = true) {
      ...
      if (confirm && urlInput.value) {
        ...
        if (urlInput.value) {
          textEventTarget.contentDocument.dispatchEvent(
            new KeyboardEvent("keydown", {
              key: "ArrowRight",
              keyCode: 39
            })
    ...
    render() {
      ...
      if (this.props.shortcutKey && shortcutIdx != -1) {
        label = React.createElement(
          ...
          label.substring(0, shortcutIdx),
          React.createElement("u", null, label[shortcutIdx]),
          label.substring(shortcutIdx + 1)
        );
      } else {
        label = React.createElement(
          "span",
