    ...
    try {
      ...
      if (e.status == 503) {
        ...
        Zotero.Inject.confirm({
          ...
          message: Zotero.getString("integration_error_clientUpgrade", ZOTERO_CONFIG.CLIENT_NAME + " 5.0.46"),
          button2Text: ""
        });
      } else if (e.status == 0) {
        ...
        Zotero.Inject.confirm({
          ...
          message:
            Zotero.getString("integration_error_connection", [connectorName, ZOTERO_CONFIG.CLIENT_NAME]) +
            "<br /><br />" +
