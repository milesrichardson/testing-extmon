/*! @sentry/browser 7.4.1 (3d8edc5) | https://github.com/getsentry/sentry-javascript */
var Sentry = (function (t) {
  ...
  function w(t) {
    return "string" == typeof t
      ? (function (t) {
          ...
          return _({ host: s, pass: i, path: a, projectId: c, port: o, protocol: e, publicKey: r });
        })(t)
      : _(t);
  }
  var x,
  ...
  function R(t) {
    if (s(t)) return { message: t.message, name: t.name, stack: t.stack, ...M(t) };
    if (l(t)) {
      var n = { type: t.type, target: I(t.target), currentTarget: I(t.currentTarget), ...M(t) };
  ...
  function A(t, n) {
    if (h(t)) {
      ...
      var e = {};
      for (var r of (n.set(t, e), Object.keys(t))) void 0 !== t[r] && (e[r] = A(t[r], n));
      return e;
    }
    if (Array.isArray(t)) {
      var i;
  ...
  function L(...t) {
    ...
    return (t, e = 0) => {
      ...
      return (function (t) {
        ...
        return n
          .slice(0, 50)
          .map((t) => ({ ...t, filename: t.filename || n[0].filename, function: t.function || "?" }))
          .reverse();
      })(r);
    };
  }
        ...
        case "console":
          !(function () {
            ...
            E.forEach(function (t) {
              t in F.console &&
                O(F.console, t, function (n) {
                  return function (...e) {
                    J("console", { args: e, level: t }), n && n.apply(F.console, e);
                  };
                });
            });
          })();
                    ...
                    return function (n, e, r) {
                      if ("click" === n || "keypress" == n)
                        try {
                          ...
                          o &&
                            ((o.refCount -= 1),
                            o.refCount <= 0 && (t.call(this, n, o.handler, r), (o.handler = void 0), delete s[n]),
          ...
          !(function () {
            ...
            O(t, "open", function (t) {
              return function (...n) {
                var e = this,
                  r = n[1],
                  i = (e.__sentry_xhr__ = { method: c(n[0]) ? n[0].toUpperCase() : n[0], url: n[1] });
                ...
                var s = function () {
                  if (4 === e.readyState) {
                    ...
                    J("xhr", { args: n, endTimestamp: Date.now(), startTimestamp: Date.now(), xhr: e });
                  }
                };
                return (
                  "onreadystatechange" in e && "function" == typeof e.onreadystatechange
                    ? O(e, "onreadystatechange", function (t) {
                        return function (...n) {
              ...
              O(t, "send", function (t) {
                return function (...n) {
                  return (
                    ...
                    J("xhr", { args: n, startTimestamp: Date.now(), xhr: this }),
                    t.apply(this, n)
                  );
                };
              });
        ...
        case "fetch":
          !(function () {
            ...
            O(F, "fetch", function (t) {
              return function (...n) {
                var e = { args: n, fetchData: { method: K(n), url: G(n) }, startTimestamp: Date.now() };
                return (
                  J("fetch", { ...e }),
                  t.apply(F, n).then(
                    (t) => (J("fetch", { ...e, endTimestamp: Date.now(), response: t }), t),
                    (t) => {
                      throw (J("fetch", { ...e, endTimestamp: Date.now(), error: t }), t);
                    }
                  )
                );
              };
          ...
          !(function () {
            ...
            (F.onpopstate = function (...n) {
              var e = F.location.href,
                r = V;
              if (((V = e), J("history", { from: r, to: e }), t))
                try {
                  return t.apply(this, n);
                } catch (t) {}
            }),
        ...
        case "error":
          (tt = F.onerror),
            (F.onerror = function (t, n, e, r, i) {
              return J("error", { column: r, error: i, line: e, msg: t, url: n }), !!tt && tt.apply(this, arguments);
            });
          break;
  ...
  function K(t = []) {
    return "Request" in F && d(t[0], Request) && t[0].method
  ...
  var bt = (function () {
    ...
    _t = void 0 === bt ? gt : { nowSeconds: () => (bt.timeOrigin + bt.now()) / 1e3 },
  ...
  function jt(t, n) {
    ...
    return [
      N({ type: "attachment", length: e.length, filename: t.filename, content_type: t.contentType, attachment_type: t.attachmentType }),
      e
    ];
  }
  (() => {
  ...
  function Rt(t, { statusCode: n, headers: e }, r = Date.now()) {
    ...
    if (s)
      for (var u of s.trim().split(",")) {
        ...
        var a = parseInt(t, 10),
          c = 1e3 * (isNaN(a) ? 60 : a);
        if (n) for (var f of n.split(";")) i[f] = r + c;
        else i.all = r + c;
      }
    else
      o
  ...
  class Ct {
    ...
    setUser(t) {
      return (this.O = t || {}), this.C && Mt(this.C, { user: t }), this.U(), this;
    }
    getUser() {
      return this.O;
    }
    ...
    setContext(t, n) {
      return null === n ? delete this.D[t] : (this.D = { ...this.D, [t]: n }), this.U(), this;
    }
    setSpan(t) {
    ...
    applyToEvent(t, n = {}) {
      if (
        (this.T && Object.keys(this.T).length && (t.extra = { ...this.T, ...t.extra }),
        this.j && Object.keys(this.j).length && (t.tags = { ...this.j, ...t.tags }),
        this.O && Object.keys(this.O).length && (t.user = { ...this.O, ...t.user }),
        this.D && Object.keys(this.D).length && (t.contexts = { ...this.D, ...t.contexts }),
        this.I && (t.level = this.I),
        this.N && (t.transaction = this.N),
        this.M)
      ) {
        t.contexts = { trace: this.M.getTraceContext(), ...t.contexts };
    ...
    P(t, n, e, r = 0) {
      return new pt((i, s) => {
        ...
        if (null === n || "function" != typeof o) i(n);
          ...
          var u = o({ ...n }, e);
          v(u)
            ? u.then((n) => this.P(t, n, e, r + 1).then(i)).then(null, s)
            : this.P(t, u, e, r + 1)
                .then(i)
                .then(null, s);
        }
  ...
  class Ut {
    ...
    captureException(t, n) {
      ...
      return (
        this.X((i, s) => {
          i.captureException(t, { originalException: t, syntheticException: r, ...n, event_id: e }, s);
        }),
        e
      );
    }
    captureMessage(t, n, e) {
      ...
      return (
        this.X((s, o) => {
          s.captureMessage(t, n, { originalException: t, syntheticException: i, ...e, event_id: r }, o);
        }),
        r
      );
    }
    ...
    endSession() {
      ...
      e &&
        (function (t, n) {
          let e = {};
          n ? (e = { status: n }) : "ok" === t.status && (e = { status: "exited" }), Mt(t, e);
        })(e),
        this.J(),
        n && n.setSession();
    }
    startSession(t) {
      ...
      var a = It({ release: i, environment: s, ...(n && { user: n.getUser() }), ...(u && { userAgent: u }), ...t });
      if (n) {
        var c = n.getSession && n.getSession();
        c && "ok" === c.status && Mt(c, { status: "exited" }), this.endSession(), n.setSession(a);
      }
      return a;
    }
    J() {
  ...
  function Ht() {
    var t,
      n = qt();
    return ((t = n) && t.__SENTRY__ && t.__SENTRY__.hub && !Ft(n).isOlderThan(4)) || Bt(n, new Ut()), Ft(n);
  }
  function Ft(t) {
  ...
  function captureException(t, n) {
    return Ht().captureException(t, { captureContext: n });
  }
  function Xt(t) {
    Ht().withScope(t);
  }
  ...
  function Gt(t, n, e, r) {
    ...
    var c = (function (t, n, e, r) {
      ...
      return {
        ...
        ...(n && { sdk: n }),
        ...(!!e && { dsn: b(r) }),
        ...("transaction" === t.type && s && { trace: N({ ...s }) })
      };
    })(t, i, r, n);
    return delete t.sdkProcessingMetadata, Et(c, [[{ type: s, sample_rates: [{ id: u, rate: a }] }, t]]);
  }
  var Vt = [];
  function Qt(t) {
  ...
  function Yt(t) {
    ...
    let r = [...Qt(n)];
    Array.isArray(e)
      ? (r = [...r.filter((t) => e.every((n) => n.name !== t.name)), ...Qt(e)])
      : "function" == typeof e && ((r = e(r)), (r = Array.isArray(r) ? r : [r]));
  ...
  class Zt {
    ...
    constructor(t) {
      if (
        ...
        this.nt = t.transport({ recordDroppedEvent: this.recordDroppedEvent.bind(this), ...t.transportOptions, url: n });
      }
    }
    ...
    captureSession(t) {
      this.it() && ("string" != typeof t.release || (this.sendSession(t), Mt(t, { init: !1 })));
    }
    getDsn() {
      return this.tt;
    }
    ...
    sendEvent(t, n = {}) {
      if (this.tt) {
        ...
        for (var e of n.attachments || []) r = St(r, jt(e, this.Z.transportOptions && this.Z.transportOptions.textEncoder));
        this.ut(r);
      }
    }
    sendSession(t) {
      if (this.tt) {
        var n = (function (t, n, e, r) {
          var i = Kt(e);
          return Et({ sent_at: new Date().toISOString(), ...(i && { sdk: i }), ...(!!r && { dsn: b(n) }) }, [
    ...
    at(t, n) {
      ...
      var u = "ok" === t.status;
      ((u && 0 === t.errors) || (u && e)) &&
        (Mt(t, { ...(e && { status: "crashed" }), errors: t.errors || Number(r || e) }), this.captureSession(t));
    }
    st(t) {
      return new pt((n) => {
        let e = 0;
    ...
    ct(t, n, e) {
      ...
      var s = { ...t, event_id: t.event_id || n.event_id || et(), timestamp: t.timestamp || wt() };
      this.ft(s), this.ht(s);
      let o = e;
    ...
    lt(t, n, e) {
      ...
      var r = {
        ...t,
        ...(t.breadcrumbs && { breadcrumbs: t.breadcrumbs.map((t) => ({ ...t, ...(t.data && { data: ct(t.data, n, e) }) })) }),
        ...(t.user && { user: ct(t.user, n, e) }),
        ...(t.contexts && { contexts: ct(t.contexts, n, e) }),
        ...(t.extra && { extra: ct(t.extra, n, e) })
      };
      return (
        t.contexts &&
          t.contexts.trace &&
          r.contexts &&
          ((r.contexts.trace = t.contexts.trace), t.contexts.trace.data && (r.contexts.trace.data = ct(t.contexts.trace.data, n, e))),
    ...
    vt(t, n, e) {
      ...
      return !s && "number" == typeof i && Math.random() > i
        ? (this.recordDroppedEvent("sample_rate", "error"),
          dt(new m(`Discarding event because it's not included in the random sample (sampling rate = ${i})`)))
        : this.ct(t, n, e)
            .then((e) => {
              if (null === e)
                throw (
                  (this.recordDroppedEvent("event_processor", t.type || "error"),
                  new m("An event processor returned null, will not send event."))
                );
              return (n.data && !0 === n.data.__sentry__) || s || !r
                ? e
                : (function (t) {
            ...
            .then((r) => {
              if (null === r)
                throw (
                  (this.recordDroppedEvent("before_send", t.type || "error"), new m("`beforeSend` returned `null`, will not send event."))
                );
  ...
  function tn(t, n, e = yt(t.bufferSize || 30)) {
    ...
    return {
      send: function (i) {
        ...
        return e
          .add(() =>
            n({ body: Ot(o, t.textEncoder) }).then(
              (t) => {
                r = Rt(r, t);
              },
              (t) => {
  ...
  class on {
    ...
    constructor(t = {}) {
      (this.Z = t), on.prototype.__init.call(this);
    }
    setupOnce(t, n) {
      var e = (t) => {
        var e = n();
  ...
  on.__initStatic();
  var an = Object.freeze({ __proto__: null, FunctionToString: rn, InboundFilters: on });
  function cn(t, n) {
    const e = hn(t, n),
      r = { type: n && n.name, value: vn(n) };
  ...
  function dn(t, n, e, r, i) {
      ...
      return (
        (c = (function (t, n, e, r) {
          const i = {
            ...
            extra: { __serialized__: ft(n) }
          };
          if (e) {
            const n = hn(t, e);
            n.length && (i.exception.values[0].stacktrace = { frames: n });
          }
          return i;
        })(t, n, e, i)),
        ut(c, { synthetic: !0 }),
    ...
    return (c = pn(t, n, e, r)), ot(c, `${n}`, void 0), ut(c, { synthetic: !0 }), c;
  }
  function pn(t, n, e, r) {
    const i = { message: n };
    if (r && e) {
      const r = hn(t, e);
      r.length && (i.exception = { values: [{ value: n, stacktrace: { frames: r } }] });
    }
    return i;
  }
  ...
  class mn {
    ...
    constructor(t) {
      mn.prototype.__init.call(this), (this.options = { console: !0, dom: !0, fetch: !0, history: !0, sentry: !0, xhr: !0, ...t });
    }
    setupOnce() {
          ...
          W(
            ...
            (function (t) {
              function n(n) {
                ...
                0 !== e.length &&
                  Ht().addBreadcrumb({ category: `ui.${n.name}`, message: e }, { event: n.event, name: n.name, global: n.global });
              }
              return n;
            })(this.options.dom)
          ),
  ...
  function gn(t) {
    ...
    Ht().addBreadcrumb(n, { input: t.args, level: t.level });
  }
  function bn(t) {
    if (t.endTimestamp) {
      if (t.xhr.__sentry_own_request__) return;
      const { method: n, url: e, status_code: r, body: i } = t.xhr.__sentry_xhr__ || {};
      Ht().addBreadcrumb({ category: "xhr", data: { method: n, url: e, status_code: r }, type: "http" }, { xhr: t.xhr, input: i });
    } else;
  }
  function _n(t) {
    t.endTimestamp &&
      ((t.fetchData.url.match(/sentry_key/) && "POST" === t.fetchData.method) ||
        (t.error
          ? Ht().addBreadcrumb({ category: "fetch", data: t.fetchData, level: "error", type: "http" }, { data: t.error, input: t.args })
          : Ht().addBreadcrumb(
              { category: "fetch", data: { ...t.fetchData, status_code: t.response.status }, type: "http" },
  ...
  function wn(t) {
    ...
    o.path || (o = s),
      ...
      Ht().addBreadcrumb({ category: "navigation", data: { from: r, to: i } });
  }
  mn.__initStatic();
  const xn = e();
  let En;
  function Sn() {
    if (En) return En;
    if (H(xn.fetch)) return (En = xn.fetch.bind(xn));
    const t = xn.document;
    let n = xn.fetch;
  ...
  class kn extends Zt {
    constructor(t) {
      (t.ot = t.ot || {}),
        (t.ot.sdk = t.ot.sdk || {
          ...
          packages: [{ name: "npm:@sentry/browser", version: nn }],
          version: nn
        }),
        super(t),
        t.sendClientReports &&
    ...
    yt() {
      ...
      const n = Jt(this.tt, this.Z.tunnel),
        e =
          ((r = t),
          Et((i = this.Z.tunnel && b(this.tt)) ? { dsn: i } : {}, [
            [{ type: "client_report" }, { timestamp: s || wt(), discarded_events: r }]
          ]));
      var r, i, s;
      try {
        !(function (t, n) {
          "[object Navigator]" === Object.prototype.toString.call(xn && xn.navigator) && "function" == typeof xn.navigator.sendBeacon
            ? xn.navigator.sendBeacon.bind(xn.navigator)(t, n)
            : P() && Sn()(t, { body: n, method: "POST", credentials: "omit", keepalive: !0 }).then(null, (t) => {});
        })(n, Ot(e));
      } catch (t) {}
    }
  }
  function On(t, n = Sn()) {
    return tn(t, function (e) {
      const r = { body: e.body, method: "POST", referrerPolicy: "origin", headers: t.headers, ...t.fetchOptions };
    ...
    An = [
      ...
      (t) => {
        ...
        if (n) {
          ...
          let t = n[3],
            e = n[1] || Tn;
          return ([e, t] = zn(e, t)), Dn(t, e, n[4] ? +n[4] : void 0, n[5] ? +n[5] : void 0);
        }
      }
    ],
    ...
    const sentryWrapped = function () {
      ...
      try {
        ...
        throw (
          ...
          Xt((e) => {
            e.addEventProcessor(
              (t) => (n.mechanism && (ot(t, void 0, void 0), ut(t, n.mechanism)), (t.extra = { ...t.extra, arguments: r }), t)
            ),
              captureException(t);
          }),
          t)
  ...
  class Vn {
    ...
    __init2() {
      this.gt = { onerror: Qn, onunhandledrejection: Yn };
    }
    constructor(t) {
      Vn.prototype.__init.call(this), Vn.prototype.__init2.call(this), (this.Z = { onerror: !0, onunhandledrejection: !0, ...t });
    }
    setupOnce() {
  ...
  function Qn() {
    W("error", (t) => {
      const [n, e, r] = ne();
      if (!n.getIntegration(Vn)) return;
      const { msg: i, url: s, line: o, column: a, error: f } = t;
      if (Jn() || (f && f.__sentry_own_request__)) return;
      const h =
        void 0 === f && c(i)
          ? (function (t, n, e, r) {
              ...
              const a = s.match(i);
              a && ((o = a[1]), (s = a[2]));
              return Zn({ exception: { values: [{ type: o, value: s }] } }, n, e, r);
            })(i, s, o, a)
          : Zn(dn(e, f || i, void 0, r, !1), s, o, a);
      (h.level = "error"), te(n, f, h, "onerror");
    });
  }
  function Yn() {
    W("unhandledrejection", (t) => {
      ...
      const s = f(i)
        ? {
            exception: { values: [{ type: "UnhandledRejection", value: `Non-Error promise rejection captured with value: ${String(i)}` }] }
          }
        : dn(e, i, void 0, r, !0);
      (s.level = "error"), te(n, i, s, "onunhandledrejection");
    });
  }
  function Zn(t, n, r, i) {
    ...
    return 0 === f.length && f.push({ colno: h, filename: v, function: "?", in_app: !0, lineno: l }), t;
  }
  function te(t, n, e, r) {
    ut(e, { handled: !1, type: r }), t.captureEvent(e, { originalException: n });
  }
  function ne() {
    const t = Ht(),
      n = t.getClient(),
      e = (n && n.getOptions()) || { stackParser: () => [], attachStacktrace: !1 };
  ...
  class re {
    ...
    constructor(t) {
      re.prototype.__init.call(this),
        (this.Z = { XMLHttpRequest: !0, eventTarget: !0, requestAnimationFrame: !0, setInterval: !0, setTimeout: !0, ...t });
    }
    setupOnce() {
      const t = e();
  ...
  function ie(t) {
    return function (...n) {
      const e = n[0];
      return (n[0] = Gn(e, { mechanism: { data: { function: q(t) }, handled: !0, type: "instrument" } })), t.apply(this, n);
    };
  }
  function se(t) {
    return function (n) {
      return t.apply(this, [
        Gn(n, { mechanism: { data: { function: "requestAnimationFrame", handler: q(t) }, handled: !0, type: "instrument" } })
      ]);
    };
  }
  function oe(t) {
      ...
      return (
        ["onload", "onerror", "onprogress", "onreadystatechange"].forEach((t) => {
          t in e &&
            "function" == typeof e[t] &&
            O(e, t, function (n) {
              const e = { mechanism: { data: { function: t, handler: q(n) }, handled: !0, type: "instrument" } },
                r = D(n);
              return r && (e.mechanism.data.handler = q(r)), Gn(n, e);
            });
        }),
        t.apply(this, n)
      );
  ...
  function ue(t) {
    ...
    r &&
      ...
      (O(r, "addEventListener", function (n) {
        return function (e, r, i) {
          try {
            "function" == typeof r.handleEvent &&
              (r.handleEvent = Gn(r.handleEvent, {
                mechanism: { data: { function: "handleEvent", handler: q(r), target: t }, handled: !0, type: "instrument" }
              }));
          } catch (t) {}
          return n.apply(this, [
            e,
            Gn(r, { mechanism: { data: { function: "addEventListener", handler: q(r), target: t }, handled: !0, type: "instrument" } }),
            i
          ]);
        };
      }),
  ...
  class ae {
    ...
    constructor(t = {}) {
      ae.prototype.__init.call(this), (this.bt = t.key || "cause"), (this._t = t.limit || 5);
    }
    setupOnce() {
        ...
        At((n, e) => {
          ...
          return r
            ? (function (t, n, e, r, i) {
              ...
              })(t.getOptions().stackParser, r.bt, r._t, n, e)
            : n;
        });
    }
  }
      ...
      At((t) => {
        if (Ht().getIntegration(he)) {
          ...
          const n = (t.request && t.request.url) || (fe.location && fe.location.href),
            ...
            i = {
              ...(n && { url: n }),
              headers: { ...(t.request && t.request.headers), ...(e && { Referer: e }), ...(r && { "User-Agent": r }) }
            };
          return { ...t, request: i };
        }
        return t;
  ...
  return (
    ...
    (t.init = function (t = {}) {
      if ((void 0 === t.defaultIntegrations && (t.defaultIntegrations = ge), void 0 === t.release)) {
        const n = e();
    ...
    (t.showReportDialog = function (t = {}, n = Ht()) {
      ...
      const { client: i, scope: s } = n.getStackTop(),
        o = t.dsn || (i && i.getDsn());
      if (!o) return;
      s && (t.user = { ...s.getUser(), ...t.user }), t.eventId || (t.eventId = n.lastEventId());
    ...
    (t.startTransaction = function (t, n) {
      return Ht().startTransaction({ ...t }, n);
    }),
