      ...
      <div class="Section" data-role="section">
        ...
        const a = (e) =>
            e
              ...
              .join(""),
          s = Object.freeze(["border-top-width", "border-bottom-width", "padding-top", "padding-bottom", "height"]),
          { _: d } = self;
        class c extends n.oi {
          ...
          firstUpdated(e) {
            ...
            var o, n;
            (null === (o = this.shadowRoot) || void 0 === o || null === (n = o.querySelectorAll) || void 0 === n
              ? void 0
              : n.call(o, '[data-role="with image"]')
            ).forEach((e) => {
              const t = e.textContent
                ...
                .map((e, t) => {
                  ...
                  return (
                    Object.entries({ src: "/images/help/plus.svg", width: "23", height: "13", alt: "" }).forEach(([e, t]) => {
                      i.setAttribute(e, t);
                    }),
            ...
            const r = [];
            (null === (t = this.shadowRoot) || void 0 === t || null === (i = t.querySelectorAll) || void 0 === i
              ? void 0
              : i.call(t, '[data-role="section"]')
            ).forEach((e, t) => {
              const i = e.querySelector("div.Section_Information"),
                o = e.querySelector('[data-click="trigger"]');
              if (!i) throw new Error("No information element in unblock-proxy");
              if (!o) throw new Error("No trigger element in unblock-proxy");
              r.push({ elements: { parent: e, trigger: o, information: i }, visible: !1 });
            });
            const l = r.map((e, t) => t);
            r.forEach((e, t) => {
              const { elements: i } = e;
              i.trigger.addEventListener("click", async () => {
                if (this.freeze) return;
                this.freeze = !0;
                let o = d
                  .without(l, t)
                  .filter((e) => r[e].visible)
                  .map(async (e) => {
                    const { elements: t } = r[e];
                    t.information.style.cssText = "display:block;overflow:hidden";
                    const i = getComputedStyle(t.information),
                      o = t.information.animate(
                        [
                          {
                            height: i.getPropertyValue("height"),
                            paddingTop: i.getPropertyValue("padding-top"),
                            paddingBottom: i.getPropertyValue("padding-bottom")
                          },
                    ...
                    await new Promise((e) => {
                      ...
                      t.parent.classList.remove("open"),
                      (t.information.style.cssText = ""),
                      (r[e].visible = !1);
                  });
                o.push(
                  (async () => {
                    const t = ((e, t, i = {}) => {
                      "up" !== t && (e.style.cssText = "display:block;");
                      let o = getComputedStyle(e),
                        n = Object.fromEntries(s.map((e) => [a(e), o.getPropertyValue(e)])),
                        r = Object.fromEntries(s.map((e) => [a(e), 0])),
                        l = "up" === t ? [n, r] : [r, n];
                      return (
                        (e.style.cssText =
                          "up" === t ? "overflow:hidden;" : "overflow:hidden;display:block;" + s.map((e) => `${e}:0px;`).join("")),
                        e.animate(l, i)
                      );
                    })(i.information, e.visible ? "up" : "down", { duration: 700, easing: "linear" });
                    await new Promise((e) => {
                      t.onfinish = e;
                    }),
                      e.visible ? i.parent.classList.remove("open") : i.parent.classList.add("open"),
                      (i.information.style.cssText = ""),
                      (e.visible = !e.visible);
                  })()
                ),
                  await Promise.all(o),
        ...
        customElements.define("main-block", c);
        var p = i(4168);
        (document.title = (0, o.Z)("how_to_use_smart_settings")),
          (async () => {
            const e = (0, p.Z)();
            (window.language = e),
              "ru" === e && document.documentElement.setAttribute("lang", "ru"),
  ...
  (o.m = t),
    ...
    (o.O = (t, i, n, r) => {
      if (!i) {
        ...
        for (c = 0; c < e.length; c++) {
          for (var [i, n, r] = e[c], a = !0, s = 0; s < i.length; s++)
            (!1 & r || l >= r) && Object.keys(o.O).every((e) => o.O[e](i[s])) ? i.splice(s--, 1) : ((a = !1), r < l && (l = r));
          if (a) {
            e.splice(c--, 1);
            var d = n();
            void 0 !== d && (t = d);
    ...
    (() => {
      ...
      var t = (t, i) => {
          ...
          for (t && t(i); d < l.length; d++) (r = l[d]), o.o(e, r) && e[r] && e[r][0](), (e[r] = 0);
          return o.O(c);
        },
        i = (self.webpackChunkbrowsec_extension = self.webpackChunkbrowsec_extension || []);
      i.forEach(t.bind(null, 0)), (i.push = t.bind(null, i.push.bind(i)));
    })();
  var n = o.O(void 0, [592], () => o(8729));
  n = o.O(n);
})();
