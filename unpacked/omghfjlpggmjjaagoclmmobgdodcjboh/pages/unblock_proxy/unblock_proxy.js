    ...
    t = {
      2499: (e, t, o) => {
        ...
        const i = Object.assign(
          (...e) => {
            (0, n.Z)({ type: "log", data: e }), console.log.apply(console, e);
          },
          {
            warn: (...e) => {
              (0, n.Z)({ type: "log.warn", data: e }), console.warn.apply(console, e);
            },
            error: (...e) => {
              (0, n.Z)({ type: "log.error", data: e }), console.error.apply(console, e);
            }
          }
        );
        var s = o(6194),
      ...
      <div class="ContactSupport">
        ...
        const { _: g } = self,
          u = async () => {
            ...
            if ("function" != typeof chrome.management.getAll) {
          ...
          x = async () => {
            let { success: e, error: t } = await (0, n.Z)({ type: "proxy disable broken mode" });
            if (e) return e;
            let { message: o } = t,
              i = new Error(o);
            throw (
        ...
        class m extends c.oi {
          ...
          static get properties() {
            return {
              contactSupportUrl: { type: String },
              extensions: { type: Array },
              hasManagement: { type: Boolean },
              logoUrl: { type: String },
              mode: { type: String }
            };
          }
          get contactSupportUrl() {
            return this.browsecLink(s.Z.contactUs);
          }
          constructor() {
            super(),
              (this.extensions = []),
              (this.hasManagement = !1),
              (this.logoUrl = ""),
              (this.mode = "information"),
              (async () => {
                let e = await r.Z.getStateAsync();
                (this.browsecLink = (t, o = (e) => e) => (0, p.Z)(t, (t) => Object.assign(o(t), { instd: e.daysAfterInstall }))),
          ...
          async firstUpdated(e) {
            ...
            let { permissions: t } = await new Promise((e) => {
              chrome.permissions.getAll(e);
            });
            t.includes("management") && ((this.hasManagement = !0), this.getExtensionsList());
          }
          async disableExtensions() {
            let e = this.extensions.filter(({ checked: e }) => e);
            if (0 === e.length) return void (0 === this.extensions.length && (x(), (this.mode = "success")));
            await u();
            let t = e.map(
              ({ id: e }) =>
                new Promise((t) => {
                  ...
                  o && o.management.setEnabled(e, !1, t);
                })
            );
            try {
              await Promise.all(t);
              try {
                await x(), (this.mode = "success");
              } catch (e) {
                this.mode = "error";
              }
            } catch (e) {
              (this.mode = "error"), i.error("Unblock proxy error: ", e);
            }
          }
          extensionCheckbox({ model: e, target: { checked: t } }) {
            let o = e.get("item"),
              n = this.extensions.indexOf(o),
              i = g.cloneDeep(this.extensions);
            (i[n].checked = t), (this.extensions = i);
          }
          async getExtensionsList() {
            let e = await new Promise((e) => {
              ...
              t && t.management.getAll(e);
            });
            const t = [];
            for (const { enabled: o, icons: n, id: i, name: s, permissions: r } of e) {
              if (!r.includes("proxy")) continue;
              if (chrome.runtime.id === i) continue;
              if (!o) continue;
              const e = { checked: !0, id: i, name: s },
                a = n[1] || n[0];
              null != a && a.url && (e.icon = `chrome://favicon/size/38/chrome-extension://${i}/`), t.push(e);
            }
            this.extensions = t;
          }
          async scanExtensions() {
            let e = async () => {
              await u(), "information" !== this.mode && (this.mode = "information"), (this.hasManagement = !0), this.getExtensionsList();
            };
            if (await (0, n.Z)({ type: "proxy.isControlled" }))
              try {
                await x(), (this.mode = "success");
              } catch (t) {
                e();
        ...
        customElements.define("main-block", m);
        var b = o(4168);
        (document.title = (0, a.Z)("your_proxy_settings_are_blocked")),
          (async () => {
            var e;
            await r.Z.initiate();
            const t = (0, b.Z)();
            (window.language = t), "ru" === t && document.documentElement.setAttribute("lang", "ru");
            const o = document.querySelector("div.main");
            null == o || null === (e = o.append) || void 0 === e || e.call(o, document.createElement("main-block"));
          })();
      }
    },
    o = {};
  ...
  (n.m = t),
    ...
    (n.O = (t, o, i, s) => {
      if (!o) {
        ...
        for (l = 0; l < e.length; l++) {
          for (var [o, i, s] = e[l], a = !0, c = 0; c < o.length; c++)
            (!1 & s || r >= s) && Object.keys(n.O).every((e) => n.O[e](o[c])) ? o.splice(c--, 1) : ((a = !1), s < r && (r = s));
          if (a) {
            e.splice(l--, 1);
            var d = i();
            void 0 !== d && (t = d);
    ...
    (() => {
      ...
      var t = (t, o) => {
          ...
          for (t && t(o); d < r.length; d++) (s = r[d]), n.o(e, s) && e[s] && e[s][0](), (e[s] = 0);
          return n.O(l);
        },
        o = (self.webpackChunkbrowsec_extension = self.webpackChunkbrowsec_extension || []);
      o.forEach(t.bind(null, 0)), (o.push = t.bind(null, o.push.bind(o)));
    })();
  var i = n.O(void 0, [592], () => n(2499));
  i = n.O(i);
})();
