  ...
  <div class="In">
    ...
    <div class="Pointer ${this.withScroll ? "withScroll" : ""}"><div class="In">
      ...
      <div class="Pointer_Text">
        ...
        const u = class {
            constructor(e) {
              if (!e) throw new Error("AnimationElement argument is not Element");
              this.element = e;
            }
            set value(e) {
              e !== this._oldValue && ((this._oldValue = e), (this.element.style.cssText = e));
            }
          },
          l = [1e3, 400, 1250, 200, 300, 1250, 200, 400, 1250, 200, 400, 750, 200, 400, 1250, 200, 400, 1250],
          p = l.reduce((e, o) => e + o, 0),
          d = l.map((e) => e / p),
          g = d.map((e, o) => d.slice(0, o + 1).reduce((e, o) => e + o, 0)),
          m = [1250, 200, 400, 1250, 200, 400, 750, 200, 400, 1250, 200, 400, 1250],
          _ = m.reduce((e, o) => e + o, 0),
          v = m.map((e) => e / _),
          w = v.map((e, o) => v.slice(0, o + 1).reduce((e, o) => e + o, 0)),
          { userAgent: h } = navigator,
          y = "undefined" == typeof browser && h.includes("Chrome") && ["Edg", "Edge"].every((e) => !h.includes(e));
        let b;
        if (y)
          try {
            b = Number(h.match(/Chrome\/\d+/)[0].split("/")[1]);
          } catch (e) {}
        const A = Boolean(y && b && b >= 84);
        function f() {
    ...
    <div class="Animation_Cursor"></div>
        ...
        class P extends i.oi {
          ...
          async firstUpdated(e) {
            ...
            if (!o) throw new Error("Shadow root not found");
            const t = o.querySelector("div.Animation");
            if (!t) throw new Error("Animation element not found");
            const n = A
                ? ((e) => {
                    let o = new u(e.querySelector("div.Animation_Search")),
                      t = new u(e.querySelector("div.Animation_Cursor")),
                      n = new u(e.querySelector("div.Animation_ExtensionsIcon")),
                      i = new u(e.querySelector("div.Animation_BrowsecIcon")),
                      a = new u(e.querySelector("div.Animation_BrowsecIconUk")),
                      r = new u(e.querySelector("div.Animation_BrowsecIconUs")),
                      c = new u(e.querySelector("div.Animation_ExtensionsPopup")),
                      s = new u(e.querySelector("div.Animation_PinEnabled")),
                      l = new u(e.querySelector("div.Animation_PinEnabledHover")),
                      m = new u(e.querySelector("div.Animation_BrowsecPopup")),
                      _ = new u(e.querySelector("div.Animation_SwitchOn")),
                      v = new u(e.querySelector("div.Animation_SwitchOff")),
                      w = new u(e.querySelector("div.Animation_BrowsecPopup_NoProtection")),
                      h = new u(e.querySelector("div.Animation_BrowsecPopup_Protection")),
                      y = new u(e.querySelector("div.Animation_BrowsecPopup_Protection_Hover")),
                      b = new u(e.querySelector("div.Animation_BrowsecPopup_ProtectionUs")),
                      A = new u(e.querySelector("div.Animation_BrowsecPopup_SmartSettings")),
                      f = new u(e.querySelector("div.Animation_BrowsecPopup_SmartSettingsHover"));
                    return {
                      start: () =>
                        new Promise((e) => {
                          let u,
                            P = (k) => {
                              void 0 === u && (u = k);
                              let S = k - u;
                              if (S > p) return void e();
                              const x =
                                (() => {
                                  let e = Math.floor(S / p);
                                  return S - e * p;
                                })() / p;
                              {
                                let e = (() => {
                                    switch (!0) {
                                      case x <= g[1]:
                                        return 532;
                                      case x <= g[2]:
                                        return 487 + 45 * (1 - (x - g[1]) / d[2]);
                                      case x <= g[4]:
                                        return 487;
                                      case x <= g[5]:
                                        return 487 + ((x - g[4]) / d[5]) * 13;
                                      case x <= g[7]:
                                        return 500;
                                      case x <= g[8]:
                                        return 500 + ((x - g[7]) / d[8]) * -180;
                                      case x <= g[10]:
                                        return 320;
                                      case x <= g[11]:
                                        return 320 + ((x - g[10]) / d[11]) * 124;
                                      case x <= g[13]:
                                        return 444;
                                      case x <= g[14]:
                                        return 444 + ((x - g[13]) / d[14]) * -120;
                                      default:
                                        return 324;
                                    }
                                  })(),
                                  o = (() => {
                                    switch (!0) {
                                      case x <= d[0]:
                                        return 19 + 164 * (1 - x / d[0]);
                                      case x <= g[1]:
                                        return 19;
                                      case x <= g[2]:
                                        return 19 + ((x - g[1]) / d[2]) * 144;
                                      case x <= g[4]:
                                        return 163;
                                      case x <= g[5]:
                                        return 19 + 144 * (1 - (x - g[4]) / d[5]);
                                      case x <= g[7]:
                                        return 19;
                                      case x <= g[8]:
                                        return 19 + ((x - g[7]) / d[8]) * 336;
                                      case x <= g[10]:
                                        return 355;
                                      case x <= g[11]:
                                        return 355 + ((x - g[10]) / d[11]) * -11;
                                      case x <= g[13]:
                                        return 344;
                                      case x <= g[14]:
                                        return 344 + ((x - g[13]) / d[14]) * -47;
                                      default:
                                        return 297;
                                    }
                                  })();
                                t.value = `left:${e}px;top:${o}px;`;
                              }
                              n.value = x <= d[0] ? "opacity:0;" : x <= g[6] ? "opacity:1;" : "opacity:0;";
                              {
                                let e = x <= d[0] ? 0 : x <= g[1] ? (x - d[0]) / d[1] : x <= g[6] ? 1 : 0;
                                c.value = `opacity:${e};`;
                              }
                              (l.value = x <= g[3] ? "opacity:0" : x <= g[4] ? "opacity:1" : "opacity:0"),
                                (s.value = x <= g[4] ? "opacity:0" : x <= g[6] ? "opacity:1" : "opacity:0"),
                                (o.value = x <= g[3] ? "opacity:0" : "opacity:1"),
                                (i.value = x <= g[6] ? "opacity:0;" : x <= g[9] ? "opacity:1;" : "opacity:0;"),
                                (a.value = x <= g[9] ? "opacity:0;" : x <= g[15] ? "opacity:1;" : "opacity:0;"),
                                (r.value = x <= g[15] ? "opacity:0" : (g[16], "opacity:1")),
                                (m.value = x <= g[6] ? "" : x <= g[7] ? `opacity:${(x - g[6]) / d[7]};` : "opacity:1;");
                              {
                                let e = x <= g[6] ? 0 : x <= g[9] ? 1 : x <= g[10] ? 1 - (x - g[9]) / d[10] : 0;
                                v.value = `opacity:${e};`;
                              }
                              {
                                let e = x <= g[9] ? 0 : x <= g[10] ? (x - g[9]) / d[10] : 1;
                                _.value = `opacity:${e};`;
                              }
                              (w.value =
                                x <= g[6] ? "" : x <= g[9] ? "opacity:1;" : x <= g[10] ? `opacity:${1 - (x - g[9]) / d[10]};` : ""),
                                (h.value =
                                  x <= g[9]
                                    ? ""
                                    : x <= g[10]
                                    ? `opacity:${(x - g[9]) / d[10]};`
                                    : x <= g[11] && (x - g[10]) / d[11] < 0.7
                                    ? "opacity:1;"
                                    : ""),
                                (y.value =
                                  x <= g[10]
                                ...
                                (f.value =
                                  x <= g[13]
                                    ...
                                    ? "opacity:1;"
                                    : x <= g[16]
                                    ? `opacity:${1 - (x - g[15]) / d[16]};`
                                    : ""),
                                (b.value = x <= g[15] ? "" : x <= g[16] ? `opacity:${(x - g[15]) / d[16]};` : "opacity:1;"),
                                self.requestAnimationFrame(P);
                            };
                          self.requestAnimationFrame(P);
                        })
                    };
                ...
                : ((e) => {
                    let o = new u(e.querySelector("div.Animation_Cursor")),
                      t = new u(e.querySelector("div.Animation_BrowsecIcon")),
                      n = new u(e.querySelector("div.Animation_BrowsecIconUk")),
                      i = new u(e.querySelector("div.Animation_BrowsecIconUs")),
                      a = new u(e.querySelector("div.Animation_BrowsecPopup")),
                      r = new u(e.querySelector("div.Animation_SwitchOn")),
                      c = new u(e.querySelector("div.Animation_SwitchOff")),
                      s = new u(e.querySelector("div.Animation_BrowsecPopup_NoProtection")),
                      l = new u(e.querySelector("div.Animation_BrowsecPopup_Protection")),
                      p = new u(e.querySelector("div.Animation_BrowsecPopup_Protection_Hover")),
                      d = new u(e.querySelector("div.Animation_BrowsecPopup_ProtectionUs")),
                      g = new u(e.querySelector("div.Animation_BrowsecPopup_SmartSettings")),
                      m = new u(e.querySelector("div.Animation_BrowsecPopup_SmartSettingsHover"));
                    return {
                      start: () =>
                        new Promise((e) => {
                          let u,
                            h = (y) => {
                              void 0 === u && (u = y);
                              let b = y - u;
                              if (b > _) return void e();
                              const A =
                                (() => {
                                  let e = Math.floor(b / _);
                                  return b - e * _;
                                })() / _;
                              {
                                let e = (() => {
                                    switch (!0) {
                                      ...
                                      case A <= w[2]:
                                        return 564;
                                      case A <= w[3]:
                                        return 564 + ((A - w[2]) / v[3]) * -194;
                                      case A <= w[5]:
                                        return 370;
                                      case A <= w[6]:
                                        return 370 + ((A - w[5]) / v[6]) * 138;
                                      case A <= w[8]:
                                        return 508;
                                      case A <= w[9]:
                                        return 508 + ((A - w[8]) / v[9]) * -120;
                                      default:
                                        return 388;
                                    }
                                  })(),
                                  t = (() => {
                                    switch (!0) {
                                      case A <= v[0]:
                                        return 19 + 144 * (1 - A / v[0]);
                                      case A <= w[2]:
                                        return 19;
                                      case A <= w[3]:
                                        return 19 + ((A - w[2]) / v[3]) * 336;
                                      case A <= w[5]:
                                        return 355;
                                      case A <= w[6]:
                                        return 355 + ((A - w[5]) / v[6]) * -11;
                                      case A <= w[8]:
                                        return 344;
                                      case A <= w[9]:
                                        return 344 + ((A - w[8]) / v[9]) * -47;
                                      default:
                                        return 297;
                                    }
                                  })();
                                o.value = `left:${e}px;top:${t}px;`;
                              }
                              (a.value = A <= w[1] ? "" : A <= w[2] ? `opacity:${(A - w[1]) / v[2]};` : "opacity:1;"),
                                (t.value = A <= w[1] ? "opacity:0;" : A <= w[4] ? "opacity:1;" : "opacity:0;"),
                                (n.value = A <= w[4] ? "opacity:0;" : A <= w[10] ? "opacity:1;" : "opacity:0;"),
                                (i.value = A <= w[10] ? "opacity:0" : (w[11], "opacity:1"));
                              {
                                let e = A <= w[1] ? 0 : A <= w[4] ? 1 : A <= w[5] ? 1 - (A - w[4]) / v[5] : 0;
                                c.value = `opacity:${e};`;
                              }
                              {
                                let e = A <= w[4] ? 0 : A <= w[5] ? (A - w[4]) / v[5] : 1;
                                r.value = `opacity:${e};`;
                              }
                              (s.value = A <= w[1] ? "" : A <= w[4] ? "opacity:1;" : A <= w[5] ? `opacity:${1 - (A - w[4]) / v[5]};` : ""),
                                (l.value =
                                  A <= w[4]
                                    ? ""
                                    : A <= w[5]
                                ...
                                (m.value =
                                  A <= w[8]
                                    ...
                                    ? "opacity:1;"
                                    : A <= w[11]
                                    ? `opacity:${1 - (A - w[10]) / v[11]};`
                                    : ""),
                                (d.value = A <= w[10] ? "" : A <= w[11] ? `opacity:${(A - w[10]) / v[11]};` : "opacity:1;"),
        ...
        customElements.define("use-animation", P);
        class k extends (0, s.$)(c.Z)(i.oi) {
          render() {
            return r.call(this);
          }
          static get properties() {
            return { withScroll: { type: Boolean } };
          }
          constructor() {
            super(),
              (this.withScroll = document.documentElement.scrollHeight > document.documentElement.clientHeight),
              window.addEventListener("resize", () => {
                const e = document.documentElement.scrollHeight > document.documentElement.clientHeight;
                e !== this.withScroll && (this.withScroll = e);
              });
          }
        }
        customElements.define("main-block-modern", k);
        var S = t(6492),
          x = t.n(S),
          B = t(4168),
          I = t(5119),
          q = t(2338);
        (document.title = (0, n.Z)("you_just_installed_browsec")), I.Z.track("congrats_tab_open");
        const E = new Promise((e) => {
          ...
          $ = (async () => {
            const e = await q.Z.get("gaRareUserId");
        ...
        (async () => {
          var e;
          const o = (0, B.Z)();
          if (((window.language = o), "ru" === o && document.documentElement.setAttribute("lang", "ru"), "undefined" == typeof browser)) {
            const e = x().type.startsWith("qa") ? "gchiwwppyi" : "gchhvrqrwi";
            (t = window),
              (n = document),
              (a = "script"),
              (r = e),
              ...
              ((c = n.createElement(a)).async = 1),
              (c.src = "https://www.clarity.ms/tag/" + r),
              (s = n.getElementsByTagName(a)[0]).parentNode.insertBefore(c, s),
              $.then((e) => {
          ...
          var t, n, i, a, r, c, s;
          await E;
          const u = document.querySelector("div.Main > div.In");
          null == u || null === (e = u.append) || void 0 === e || e.call(u, document.createElement("main-block-modern"));
        })();
        let O = !1;
        "undefined" == typeof browser &&
          chrome.runtime.onMessage.addListener((e, o) => {
            "popup open" === (null == e ? void 0 : e.type) &&
              o.url === chrome.runtime.getURL("/popup/popup.html") &&
              (O || ((O = !0), "function" == typeof window.clarity && window.clarity("set", "pop-up open", "true")));
          });
      }
    },
    t = {};
  ...
  (n.m = o),
    ...
    (n.O = (o, t, i, a) => {
      if (!t) {
        ...
        for (l = 0; l < e.length; l++) {
          for (var [t, i, a] = e[l], c = !0, s = 0; s < t.length; s++)
            (!1 & a || r >= a) && Object.keys(n.O).every((e) => n.O[e](t[s])) ? t.splice(s--, 1) : ((c = !1), a < r && (r = a));
          if (c) {
            e.splice(l--, 1);
            var u = i();
            void 0 !== u && (o = u);
    ...
    (() => {
      ...
      var o = (o, t) => {
          ...
          for (o && o(t); u < r.length; u++) (a = r[u]), n.o(e, a) && e[a] && e[a][0](), (e[a] = 0);
          return n.O(l);
        },
        t = (self.webpackChunkbrowsec_extension = self.webpackChunkbrowsec_extension || []);
      t.forEach(o.bind(null, 0)), (t.push = o.bind(null, t.push.bind(t)));
    })();
  var i = n.O(void 0, [592], () => n(6499));
  i = n.O(i);
})();
