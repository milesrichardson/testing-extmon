(function () {
  ...
  */
  ...
  var D = function (a, b) {
    ...
    b === "port"
      ? (a.port = String(Number(a.hostname ? a.port : u.location.port) || (a.protocol == "http" ? 80 : a.protocol == "https" ? 443 : "")))
      : b === "host" && (a.hostname = (a.hostname || u.location.hostname).replace(z, "").toLowerCase());
  ...
  var R = function (a, b) {
    a = [
      ...
      self.navigator.userLanguage || self.navigator.language,
...
(function () {
  ...
  */
  ...
  var ra = function () {
    for (
      var a = O.navigator.userAgent + (M.cookie ? M.cookie : "") + (M.referrer ? M.referrer : ""), b = a.length, c = O.history.length;
      c > 0;
      ...
      if (void 0 !== Ab) a[Q] || (a[Q] = Ab);
        ...
        a: {
          ...
          if (!b || jd.test(b)) b = !0;
            ...
            if (
              b.length == 1 &&
              ((b = decodeURIComponent(b[0])), b == "$RETRIEVING" || b == "$OPT_OUT" || b == "$ERROR" || b == "$NOT_FOUND")
            ) {
              b = !0;
              break a;
            }
    ...
    if (b.length === 0) c();
      ...
      switch (d) {
        ...
        case "g":
          ...
          (b = b.substring(1)) &&
            (/^[a-z.]{1,6}$/.test(b) ? wc("https://www.google.%/ads/ga-audiences".replace("%", b), a.google, ua) : ge("tld", "bcc", b));
          break;
        case "G":
          if (a.V) {
            a.V("G-" + b.substring(1));
    ...
    switch (P(a, ad)) {
      ...
      default:
        b
          ? ((c = P(a, Ra)),
            (d = (d = a.Z(Ia)) || ua),
            b == "image" ? wc(e, c, d) : (b == "xhr" && wd(e, c, d)) || (b == "beacon" && x(e, c, d)) || ba(e, c, d))
          : ba(e, P(a, Ra), a.Z(Ia));
    }
    e = P(a, Na);
    e = h(e);
    ...
    if (P(a, ac) == "cookie") {
      ...
      if (a.get(je)) {
        ...
        if (c) {
          ...
          g && g != "aw.ds"
            ? b && (b.ua = !0)
            : ((c = ["1", e, Cc(c)].join(".")), d > 0 && (b && (b.ta = !0), zc("_gac_" + Cc(k), c, ca, l, k, d, a)));
          le(b);
        }
      } else J(75);
    }
  ...
  var Pd = function (a, b, c) {
    !1 === b.get(Ud) || b.get(c) || (Ca(a.Y)[0] == "1" ? b.set(c, "", !0) : b.set(c, "" + hd(), !0));
  };
  var Qd = function (a, b) {
  ...
  var td = function (a, b) {
    ...
    if (P(a, ac) == "cookie") {
      ...
      if (a.get(je) && ((c = a.get(ce)), (d = a.get(ie)), !c || (d && d != "aw.ds"))) {
        c = {};
        if (M) {
          d = [];
          e = M.cookie.split(";");
      ...
      if (b || !a.get(Je)) g = !1;
        ...
        if ((g = d._up))
          (g = Jc.exec(M.referrer))
            ? ((g = g[1]), (ca = "browsec.com"), (g = ca === g || ca.indexOf("." + g) >= 0 || g.indexOf("." + ca) >= 0 ? !0 : !1))
            : (g = !1);
        g = g ? !0 : !1;
      }
      ca = d.gclid;
          ...
          if (c) {
            b: if (((d = c.indexOf(".")), d == -1)) J(22);
              ...
              if ((c = be("_gac", !!a.get(cc))))
                (c = c.split(".")),
                  c[0] != "1" || c.length != 4 ? J(72) : ke(c[3], c[1]) ? J(71) : (a.data.set(ce, c[3]), a.data.set(fe, c[2]), J(70));
            }
          }
        } else J(21);
      }
    ...
    a.get(Q) ||
      ((b = (b = O.gaGlobal) && b.from_cookie && P(a, ac) !== "cookie" ? void 0 : (b = b && b.vid) && b.search(jd) !== -1 ? b : void 0),
      ...
      if ("https:" !== "https:" && !Ba) {
        a: {
          ...
          for (var c = 0; c < b.length && c < 100; c++) {
            var d = b[c].src;
            if (d && d.indexOf(bd(!0) + "/analytics") == 0) {
              b = !0;
              break a;
            }
          }
