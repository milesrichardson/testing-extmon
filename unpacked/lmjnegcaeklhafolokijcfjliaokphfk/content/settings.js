(() => {
  ...
  var t = combineReducers({ prefs: prefsSettingsReducer }),
    a = createStore(t);
  function r() {
  ...
  var n = {
      renderInput: function () {
        ...
        return React.createElement(
          "div",
          { className: "input-group", id: "weh-param-" + e.paramIndex },
          React.createElement("input", {
            ref: function (t) {
              t && (t.value = e.state.value);
            },
            onChange: n.onChange.bind(e),
          ...
          React.createElement(
            ...
            React.createElement(
              "button",
              {
                className: "btn",
                onClick: function () {
                  return n.selectDirectory.call(e);
                }
              },
              weh._("change")
            )
      ...
      onChange: function (e) {
        var t = this,
          a = e.target;
        weh.rpc
          .call("coappProxy", "path.homeJoin", a.value)
          .then(function (e) {
    ...
    c = (function (t) {
      function c(e) {
        ...
        return (
          (t.state = { activeTab: "general", moreOpen: !1, conversion: void 0, modal: null }),
          (t.fileInputChange = t.fileInputChange.bind(t)),
          t
        );
      }
      return (
        ...
        e(c, [
          ...
          },
          {
            ...
            value: function () {
              var e = this,
                t = this,
                a = { prefs: !0, backlist: !1, outputconfigs: !1 };
              function r(e) {
                return function (t) {
                  ...
                  modal: {
                    ...
                    body: React.createElement(
                      ...
                      React.createElement(
                        ...
                        React.createElement(
                          "label",
                          { className: "col-8 col-form-label", htmlFor: "reset-convrules" },
                      ...
                      React.createElement(
                        ...
                        React.createElement(
                          "label",
                          { className: "col-8 col-form-label", htmlFor: "reset-variants" },
          ...
          },
          {
            ...
            value: function (e) {
              e.prefs &&
                (a.dispatch({ type: "PREFS_RESET" }),
                a.dispatch({ type: "PREFS_UPDATED", payload: {} }),
                a.dispatch({ type: "PREFS_SAVE", payload: {} })),
          ...
          },
          {
            ...
            value: function (e) {
              var t = this,
                r = this,
                n = r.fileInput.files[0];
              if (n) {
                var c = new FileReader();
                (c.onload = function (e) {
                  try {
                    var n = JSON.parse(e.target.result);
                    weh.rpc.call("importSettings", n).then(function (e) {
                      Object.keys(e).forEach(function (t) {
                        a.dispatch({ type: "PREF_UPDATE", payload: { prefName: t, value: e[t] } });
                      });
                    });
                  } catch (e) {
                    r.setState({
          ...
          },
          {
            ...
            value: function (e) {
              var t = this;
              return function (e) {
                e && e.removeEventListener("change", t.fileInputChange),
                  (t.fileInput = e),
                  e && e.addEventListener("change", t.fileInputChange);
              };
            }
          },
          {
          ...
          },
          {
            ...
            value: function () {
              return React.createElement(
                ...
                React.createElement(WehParam, { prefName: "lastDownloadDirectory", renderInput: n.renderInput }),
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      ...
                      React.createElement(DropdownItem, { onClick: r("editConverterConfigs") }, weh._("conversion_outputs")),
                      React.createElement(DropdownItem, { onClick: r("editConversionRules") }, weh._("conversion_rules")),
                      React.createElement(DropdownItem, { onClick: r("editBlacklist") }, weh._("blacklist")),
                      React.createElement(DropdownItem, { onClick: r("editSmartName") }, weh._("smartnaming_rules")),
                      React.createElement(DropdownItem, { onClick: r("editVariants") }, weh._("video_qualities")),
                      React.createElement(DropdownItem, { onClick: this.conversion() }, weh._("licensing")),
                      React.createElement(DropdownItem, { onClick: r("openTranslation") }, weh._("translation")),
                      weh.prefs.coappShellEnabled && React.createElement(DropdownItem, { onClick: r("openCoapp") }, weh._("coapp")),
                      React.createElement(DropdownItem, { divider: !0 }),
                      React.createElement(DropdownItem, { onClick: r("exportSettings") }, weh._("export")),
  ...
  render(React.createElement(Provider, { store: a }, React.createElement(c, null)), document.getElementById("root")),
