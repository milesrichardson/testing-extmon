(() => {
  ...
  var t = combineReducers({
      data: function () {
        var e =
            arguments.length > 0 && void 0 !== arguments[0]
              ? arguments[0]
              : { mode: "page-title", domains: [], domain: "", ref: null, xpath: null, regex: null, delay: 0 },
          t = arguments[1];
        if ("SET_DATA" === t.type) e = Object.assign({}, e, t.payload);
        return e;
      }
    }),
    a = createStore(t);
  weh.rpc.listen({
    setData: function (e) {
      a.dispatch({ type: "SET_DATA", payload: e });
    }
  });
  var n = connect(function (e, t) {
    return { data: e.data };
  })(
    (function (t) {
      function a(e) {
        ...
        e(a, [
            ...
            value: function (e) {
              ...
              this.setState(
                ...
                window.addEventListener("beforeunload", function () {
                  weh.rpc.call("closedSmartNameDefiner", l.props.data.ref);
                });
            }
          },
          {
          ...
          },
          {
            ...
            value: function (e) {
              var t = this;
              return function (a) {
                if ("advanced" === e) return t.setState({ advanced: a.target.checked });
                ...
                switch (e) {
                  ...
                  case "xpath":
                    r.xpath = n;
                    try {
                      document.evaluate(n, document, null, XPathResult.STRING_TYPE, null),
                        (r.xpathClass = ""),
                        weh.rpc.call("selectSmartNameXPath", t.props.data.ref, n);
                    } catch (e) {
  ...
  render(
    React.createElement(Provider, { store: a }, React.createElement("div", { className: "weh-shf" }, React.createElement(n, null))),
