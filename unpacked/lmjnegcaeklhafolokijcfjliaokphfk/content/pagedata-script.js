(() => {
  var e = {
      2: function (e, r) {
        ...
        (s = [e]),
                  ...
                  n = (e, r) => {
                    ...
                    return function (n, ...a) {
                      ...
                      return new Promise((r, t) => {
                        n[e](...a, s({ resolve: r, reject: t }));
                      });
                    };
                  },
                  a = (e, r, t) => new Proxy(r, { apply: (r, s, n) => t.call(s, e, ...n) });
                      ...
                      o = {
                        ...
                        get(e, o, m) {
                          ...
                          if ("function" == typeof l)
                            if ("function" == typeof r[o]) l = a(e, e[o], r[o]);
                            else if (i(t, o)) {
                              let r = n(o, t[o]);
                              l = a(e, e[o], r);
                            } else l = l.bind(e);
                        ...
                        set: (e, r, t, n) => (r in s ? (s[r] = t) : (e[r] = t), !0),
          ...
          void 0 === (n = "function" == typeof t ? t.apply(r, s) : t) || (e.exports = n);
      },
      30: (e, r, t) => {
        "use strict";
        e.exports = t(10);
      ...
      10: (e, r, t) => {
        ...
        var s = t(0),
          n = s.browser;
        s.rpc = t(1);
        var a = n.runtime.connect({ name: "weh:" + n.runtime.id + ":" + s.uiName });
                ...
                value: function () {
                  ...
                  return new Promise(function (s, g) {
                    ...
                    i.debugLevel >= 2 && i.logger.info("rpc #" + o, "call =>", n, a),
                      i.hook({ type: "call", callee: r, rid: o, method: n, args: a }),
                      (i.replies[o] = { resolve: s, reject: g, peer: r });
                    var m = e || (i.useTarget && i.posts[r]) || i.post;
                    i.useTarget
                      ? m(r, { type: "weh#rpc", _request: o, _method: n, _args: [].concat(t(a)) })
                      : m({ type: "weh#rpc", _request: o, _method: n, _args: [].concat(t(a)) });
                  });
                }
              },
              {
                      ...
                      .then(function () {
                        ...
                        if ("function" == typeof r)
                          return (
                            ...
                            s.hook({ type: "call", caller: t, rid: e._request, method: e._method, args: e._args }),
                            Promise.resolve(r.apply(null, e._args))
                              .then(function (r) {
                                return s.hook({ type: "reply", caller: t, rid: e._request, result: r }), r;
                              })
                              .catch(function (r) {
                                throw (s.hook({ type: "reply", caller: t, rid: e._request, error: r.message }), r);
                              })
                          );
                      ...
                      n
                        ? e._error
                          ? (s.debugLevel >= 1 && s.logger.info("rpc #" + e._reply, "call <= !", e._error),
                            s.hook({ type: "reply", callee: n.peer, rid: e._reply, error: e._error }),
                            n.reject(new Error(e._error)))
                          : (s.debugLevel >= 2 && s.logger.info("rpc #" + e._reply, "call <= ", e._result),
                            s.hook({ type: "reply", callee: n.peer, rid: e._reply, result: e._result }),
                            n.resolve(e._result))
      ...
      0: (e, r, t) => {
        ...
        (r.browser = t(2)),
          ...
          (r.isBrowser = function () {
            ...
            for (var n = 0; n < t.length; n++) if (t[n] == r.browserType) return !0;
            return !1;
          }),
          (r.error = function (e) {
  ...
  function t(s) {
    ...
    var a = (r[s] = { exports: {} });
    return e[s].call(a.exports, a, a.exports, t), a.exports;
  }
  (() => {
    "use strict";
    var e = t(30),
      r = t(188).SmartNameEvaluate;
    var s = { pageUrl: window.document.URL };
    try {
    ...
    if (n.thumbnailUrl) s.thumbnailUrl = n.thumbnailUrl;
    else
      try {
    ...
    var a = window._$vdhHitId,
      i = window._$vdhSmartNameSpecs;
    Promise.resolve()
      .then(function () {
        if (i)
      ...
      .then(function (r) {
        r && (s.title = r), e.rpc.call("hitPageData", { id: a, data: s });
      });
  })();
})();
