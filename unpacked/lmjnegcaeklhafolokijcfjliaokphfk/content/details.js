(() => {
  ...
  var o = createStore(function () {
      var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : { hit: null },
        t = arguments[1];
      return "setHit" == t.type ? (e = { hit: t.payload }) : "setError" == t.type && (e = { error: t.payload }), e;
    }),
    l = decodeURIComponent(new URL(document.URL).hash.substr(1));
  weh.rpc
    .call("getHit", l)
    .then(function (e) {
      e ? o.dispatch({ type: "setHit", payload: e }) : o.dispatch({ type: "setError", payload: weh._("no_such_hit") });
    })
    .catch(function (e) {
      o.dispatch({ type: "setError", payload: e.message });
    });
  var c = (function (o) {
      function l() {
        ...
        t(l, [
          {
            key: "renderValue",
            value: function () {
              return "thumbnailUrl" == this.props.name || "thumbnail" == this.props.name
                ? React.createElement(
                    "div",
                    null,
    ...
    i = connect(function (e, t) {
      return { hit: e.hit, error: e.error };
    })(
      (function (e) {
        function o() {
          ...
          t(o, [
            ...
            },
            {
              ...
              value: function () {
                ...
                var e = this,
                  t = Object.keys(this.props.hit)
                    .sort()
                    .map(function (t) {
                      return React.createElement(c, { key: t, name: t, value: e.props.hit[t] });
                    });
                return React.createElement("table", { className: "details" }, React.createElement("tbody", null, t));
              }
            }
          ]),
          o
