(() => {
  var e = {
                      ...
                      a = {
                        ...
                        get(e, a, m) {
                          ...
                          if ("function" == typeof l)
                            if ("function" == typeof r[a]) l = g(e, e[a], r[a]);
                            else if (o(s, a)) {
                              let r = n(a, s[a]);
                              l = g(e, e[a], r);
                            } else l = l.bind(e);
      ...
      11: (e, r, s) => {
        ...
        var t = s(0).browser,
          n = {},
          g = new RegExp("\\$[a-zA-Z]*([0-9]+)\\$", "g");
        function o() {
          t.storage.local.get("wehI18nCustom").then(function (e) {
        ...
        o(),
          (e.exports = {
            getMessage: function (e, r) {
              if (/-/.test(e)) {
                var s = e.replace(/-/g, "_");
                console.warn("Wrong i18n message name. Should it be", s, "instead of", e, "?"), (e = s);
              }
              var o = n[e];
              return o && o.message.length > 0
                ? (Array.isArray(r) || (r = [r]),
                  (o.message || "").replace(g, function (e) {
                    var s = g.exec(e);
                    return (s && r[parseInt(s[1]) - 1]) || "??";
                  }))
                : t.i18n.getMessage.apply(t.i18n, arguments);
            },
            reload: o
          });
      },
              ...
              { key: "nullHook", value: function () {} },
              {
                ...
                value: function () {
                  ...
                  return new Promise(function (t, i) {
                    var a = ++o.replyId;
                    o.debugLevel >= 2 && o.logger.info("rpc #" + a, "call =>", n, g),
                      o.hook({ type: "call", callee: r, rid: a, method: n, args: g }),
                      (o.replies[a] = { resolve: t, reject: i, peer: r });
  ...
  (() => {
    ...
    function t() {
      ...
      if (s) {
        for (var t = {}, n = 0; n < s.rangeCount; n++) {
          var g = s.getRangeAt(n),
            o = g.commonAncestorContainer;
          if ((1 == o.nodeType && (o = o.parentNode), "function" == typeof o.querySelectorAll)) {
            var i = o.querySelectorAll("a[href]");
            Array.from(i).forEach(function (e) {
              if (g.isPointInRange(e, 0)) {
        ...
        e.rpc.call("tbvwsSelectedIds", { pageUrl: window.location.href, topUrl: _$vdhTopUrl, ids: Object.keys(t) });
      }
    }
    var n = null;
    document.addEventListener("selectionchange", function () {
      ...
      t(),
      /vdh\-bulk=/.test(window.location.href) &&
        (function () {
          e._ = s(11).getMessage;
          ...
          Object.assign(t.style, {
            ...
            t.appendChild(document.createTextNode(e._("bulk_in_progress"))),
            r.appendChild(t),
