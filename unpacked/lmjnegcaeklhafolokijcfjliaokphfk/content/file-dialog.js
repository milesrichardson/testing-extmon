(() => {
  ...
  var i = createStore(function () {
    ...
    switch (t.type) {
      case "SET_WEH_DATA":
        e = Object.assign({}, e, { wehData: t.payload });
        break;
      case "SET_ERROR":
        e = Object.assign({}, e, { error: t.payload });
    }
    return e;
  });
  weh.rpc.listen({
  ...
  var o = connect(
      function (e, t) {
        return Object.assign({}, (e && e.wehData) || {}, { error: (e && e.error) || null });
      },
      function (e) {
      ...
      (function (i) {
        function o(e) {
          n(this, o);
          var t = r(this, (o.__proto__ || Object.getPrototypeOf(o)).call(this, e));
          return (
            (t.state = {
              files: [],
              parents: [],
          ...
          t(o, [
            {
              ...
              value: function (e) {
                var t,
                  ...
                  r = this;
                weh.rpc
                  .call("coappProxy", "path.homeJoin", e.directory)
                  .then(function (e) {
                    return (t = e), r.init(t);
                  })
                  .then(function () {
            ...
            },
            {
              ...
              value: function (e) {
                var t = this;
                weh.rpc
                  .call("coappProxy", "fs.mkdirp", e)
                  .then(function () {
                    t.setState({ modal: null }), t.init(e);
                  })
                  .catch(function (e) {
                    t.props.setError(e);
                  });
            ...
            },
            {
              ...
              value: function (e) {
                var t = this,
                  n = this;
                return weh.rpc
                  .call("coappProxy", "fs.stat", e)
                  .then(function () {
                    n.setState({ dirExits: !0 });
                  })
                  .catch(function () {
                    n.setState({ dirExits: !1 });
                  })
                  .then(function () {
                    return n.props.uniqueFilename
                      ? weh.rpc.call("coappProxy", "makeUniqueFileName", e, t.props.filename).then(function (e) {
                          n.setState({ directory: e.directory, filename: e.fileName });
                        })
                      : weh.rpc
                          .call("coappProxy", "path.homeJoin", e)
                          .then(function (t) {
                            n.setState({ directory: t || e, filename: n.props.filename });
                          })
                          .catch(function (e) {
                            n.props.setError(e);
                          });
            ...
            },
            {
              ...
              value: function (e) {
                var t = this;
                return t.state.dirExits
                  ? weh.rpc
                      .call("coappProxy", "listFiles", e)
                      .then(function (e) {
                  ...
                  : (t.setState({ files: [] }), Promise.resolve());
              }
            },
            {
              key: "updateParents",
              value: function (e) {
                var t = this;
                return weh.rpc
                  .call("coappProxy", "getParents", e)
                  .then(function (e) {
                    t.setState({ parents: e });
                  })
                  .catch(function (e) {
                    t.props.setError(e);
                  });
            ...
            },
            {
              ...
              value: function (e) {
                var t = this;
                return (
                  t.setState({ parent: "", directory: e, selected: {}, selectAll: !1 }),
            ...
            },
            {
              ...
              value: function (e) {
                return e < 1024
                  ? weh._("Bytes", e)
                  : e < 1024e3
                  ? weh._("KB", Math.round(e / 100) / 10)
                  : e < 1024e6
                  ? weh._("MB", Math.round(e / 1e5) / 10)
                  : weh._("GB", Math.round(e / 1e8) / 10);
              }
            },
            {
              key: "getDate",
              value: function (e) {
                ...
                return t.getDate() == n.getDate() && t.getMonth() == n.getMonth() && t.getFullYear() == n.getFullYear()
                  ? n.getHours() + ":" + ("00" + n.getMinutes()).substr(-2, 2)
            ...
            },
            {
              ...
              value: function () {
                var e = this;
                return function (t, n) {
                  return "size" == e.state.sortField
                    ? (t[1].size - n[1].size) * e.state.sortDir
                    : "date" == e.state.sortField
                    ? (new Date(t[1].mtime).getTime() - new Date(n[1].mtime).getTime()) * e.state.sortDir
                    : t[0] == n[0]
                    ? 0
                    : t[0].toLowerCase() > n[0].toLowerCase()
                    ? e.state.sortDir
                    : -e.state.sortDir;
                };
              }
            },
            {
              ...
              value: function (e) {
                var t = this;
                return function () {
                  t.state.sortField == e ? t.setState({ sortDir: -t.state.sortDir }) : t.setState({ sortField: e, sortDir: 1 });
                };
              }
            },
            {
            ...
            },
            {
              ...
              value: function () {
                var e = this;
                return function (t) {
                  e.setState({ filename: t.target.value });
                };
              }
            },
            {
            ...
            },
            {
              ...
              value: function () {
                ...
                return function () {
                  var n = {};
                  t.state.selectAll ||
                    t.state.files.forEach(function (t) {
                      var r = e(t, 2),
                        a = r[0];
                      r[1].dir || (n[a] = !0);
                    }),
                    t.setState({ selected: n, selectAll: !t.state.selectAll });
                };
              }
            },
            {
              ...
              value: function () {
                var e = this;
                return this.props.outputConfigs
                  ? !!this.state.outputConfig &&
                      Object.keys(e.state.selected).filter(function (t) {
            ...
            },
            {
              ...
              value: function () {
                ...
                this.state.filename && n.push(this.state.filename),
                  (e = weh.rpc).call.apply(e, ["coappProxy", "path.homeJoin"].concat(n)).then(function (e) {
                    var n = { fileName: t.state.filename, directory: t.state.directory, filePath: e };
                    t.props.outputConfigs &&
                      ((n.selected = Object.keys(t.state.selected).filter(function (e) {
                        return !!t.state.selected[e];
                      })),
                      (n.outputConfig = t.state.outputConfig),
                      delete n.fileName,
                      delete n.filePath),
                                ...
                                modal: {
                                  ...
                                  buttons: [
                                    ...
                                    },
                                    {
                                      ...
                                      color: "primary",
                                      click: function () {
                                        t.setState({ modal: null }), weh.trigger(n);
                                      }
                                    }
                                  ]
                                }
                    ...
                    t.props.selectMultiple &&
                      t.setState({
                        selected: Object.assign(
                          ...
                          ((r = {}),
                          (a = e),
                          (i = !t.state.selected[e]),
                          a in r ? Object.defineProperty(r, a, { value: i, enumerable: !0, configurable: !0, writable: !0 }) : (r[a] = i),
                          r)
                        )
                      });
                };
                    ...
                    modal: {
                      ...
                      buttons: [
                        ...
                        },
                        {
                          ...
                          color: "primary",
                          click: function () {
                            e.setState({ modal: null }), e.createSubDirectory(t.value);
                          }
                        }
                      ]
                    }
            ...
            },
            {
              ...
              value: function (e) {
                var t,
                  n = this;
                weh.rpc
                  .call("coappProxy", "path.homeJoin", n.state.directory, e)
                  .then(function (e) {
                ...
                var e = this,
                  ...
                  n = this.state.files.sort(this.sort()).map(function (n) {
                    return n[1].dir
                      ? React.createElement(
                          "tr",
                          { className: "dir-entry", key: n[0], onClick: e.gotoDir(n[1].path) },
                          React.createElement("td", null, React.createElement("img", { src: "images/folder.png" })),
                          React.createElement("td", null, React.createElement("div", null, n[0])),
                          !t.props.noSizeColumn && React.createElement("td", null),
                          React.createElement("td", null, t.getDate(new Date(n[1].mtime)))
                        )
                      : t.props.dirOnly
                      ? null
                      : React.createElement(
                          ...
                          React.createElement("td", null, React.createElement("div", null, n[0])),
                          !t.props.noSizeColumn && React.createElement("td", null, t.getSize(n[1].size)),
                          React.createElement("td", null, t.getDate(new Date(n[1].mtime)))
                        );
                  }),
                      ...
                      React.createElement(
                        ...
                        React.createElement(
                          ...
                          r.length > 0 &&
                            React.createElement(
                              "select",
                              { value: this.state.parent, onChange: this.toParent(), className: "form-control" },
                              r
                            ),
                          null !== this.state.filename &&
                          ...
                          null !== this.state.directory &&
                            this.props.readonlyDir &&
                            React.createElement(
                              "div",
                              { className: "form-control dir-path", title: this.state.directory },
                              this.state.directory
                            ),
                          this.props.newDir &&
                            this.state.dirExits &&
                        ...
                        this.props.outputConfigs &&
                          React.createElement(
                            ...
                            React.createElement(c, { updateState: this.updateState.bind(this), cancel: this.cancel().bind(this) })
                          )
                      ),
                      React.createElement(
                        "footer",
                        ...
                        React.createElement(
                          ...
                          React.createElement(
                            "button",
                            { className: "btn btn-outline-secondary", onClick: this.cancel() },
                            weh._("cancel")
                          ),
                          React.createElement(
                            "button",
    ...
    c = (function (e) {
      function i(e) {
        ...
        t.state = { outputConfig: "", outputConfigs: {} };
        var a = t;
        return (
          weh.prefs.on("dlconvLastOutput", function (e, t) {
            a.setState({ outputConfig: t }), a.props.updateState({ outputConfig: t });
          }),
          t
        );
      }
        ...
        t(i, [
          ...
          },
          {
            ...
            value: function () {
              var e = this;
              return function (t) {
                e.setState({ outputConfig: t.target.value }), e.props.updateState({ outputConfig: t.target.value });
              };
            }
          },
          {
  ...
  render(React.createElement(Provider, { store: i }, React.createElement(o, { store: i })), document.getElementById("root"));
})();
