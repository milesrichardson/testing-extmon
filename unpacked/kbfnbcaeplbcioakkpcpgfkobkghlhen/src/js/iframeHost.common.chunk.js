  ...
  [1090],
  {
    4557: (e, t, n) => {
      ...
      !(function (e) {
        ...
        e.validate = (t, n, s) => {
          const p = ((t, n) =>
              0 === t.trim().length ? i.some(n.nameEmpty) : t.length > e.NAME_LENGTH_LIMIT ? i.some(n.nameTooLong) : i.none)(t, s),
            a = ((t, n) =>
              0 === t.trim().length ? i.some(n.textEmpty) : t.length > e.CONTENT_LENGTH_LIMIT ? i.some(n.textTooLong) : i.none)(n, s);
          return i.isNone(p) && i.isNone(a) ? r.right(void 0) : r.left({ nameError: p, contentError: a });
        };
      })(s || (s = {}));
    },
    98094: (e, t, n) => {
      n.r(t), n.d(t, { createComponentProxy: () => U, deserializeCard: () => K, serializeCard: () => z });
      var s = {};
      n.r(s),
        n.d(s, {
          AddToDictButton: () => u.X,
          AddedToDictCard: () => d.S,
          AuthenticatedFooter: () => C.S,
          Card: () => f.Z,
          Container: () => R.W,
          DefinitionsCard: () => _.l,
          FluencyFooter: () => g.A,
          ...
          IgnoreButton: () => h.Q,
          Item: () => b.c,
          KnowledgeHubCard: () => D.i,
          PositionedCard: () => l.J,
          RenderWithStyles: () => F.L,
          ReplacementCard: () => w.X,
          RowWithIcon: () => y.O,
          SimpleFooter: () => E.z,
          SimpleMessageCard: () => x.t,
          SnippetsCard: () => L.L,
          SnippetsCreateBtn: () => L.O,
          SnippetsEditor: () => N.M,
          SnippetsStopPropagationWrapper: () => M.q,
          SuggestionCard: () => T.Y,
          SuggestionCardMini: () => I.O,
          SynonymsCard: () => k.x,
          TextOnlyCard: () => P.A,
          UnifiedFunnelAnonymousFooter: () => v.h,
          UnknownWordCard: () => B.$,
          UpgradeButton: () => m.Y,
          VoxReplacementCard: () => A.W,
          VoxTextOnlyCard: () => O.a
        });
      var i = n(27378),
        r = n(98036),
        ...
        R = n(13792),
        F = n(41572);
      const W = p.Y.create("universal/cs/integration/fluid/iframe-proxy/ComponentProxy");
      function U(e) {
        return i.createElement(Z, { ...e });
      }
      const Z = ({ children: e, cardKey: t, onUpdate: n, ...s }) => {
          const r = i.useRef({}),
            [p, a] = i.useState(null),
            o = i.useMemo(
              () => (e) => {
                const t = r.current[e.id];
                t ? t(...e.args) : W.warn(`Skipping Callback ${e.id}`);
              },
              []
            );
          return (
            i.useEffect(() => {
              const { callbackRegister: i, card: c, key: l } = z({ card: e, key: t }, s),
                d = n({ card: c, key: l });
              return (
                (r.current = i),
                a(d.subscribe(o)),
                () => {
                  p && p.unsubscribe(), a(null);
                }
              );
            }, [e]),
            null
        ...
        q = (e, t, n = "root") => {
          var p, o;
          try {
            const l = Object.entries(t.options.namedObjects).find(([t, n]) => n === e);
            if (l) return { __type: "namedObject", name: l[0] };
            if ("object" == typeof e && i.isValidElement(e)) {
              let i;
              for (const t in s) {
                const n = $(s, t);
                if (e.type === n) {
              ...
              if (!i) throw new Error(`Cannot find component name for ${e.type.toString()}`);
              return { __type: "react", props: q(e.props, t, `${n}.[${i}]`), componentName: i };
            }
            if (e instanceof Array) return e.map((e, s) => q(e, t, `${n}.${s}`));
            if (
              e instanceof HTMLDocument ||
              ("object" == typeof e &&
                (null !==
                  (o = null === (p = null == e ? void 0 : e.constructor) || void 0 === p ? void 0 : p.toString().indexOf("HTMLDocument")) &&
                void 0 !== o
                  ? o
                  : -1) > -1)
            )
            ...
            if ("function" == typeof e) {
              const s = `${n}-${c.iy.create()}`;
              return (t.callbackRegister[s] = e), { __type: "callback", id: s };
            }
            return (0, a.Kn)(e)
              ? e instanceof r.L
                ? null
                : Object.keys(e).reduce((s, i) => Object.assign(s, { [i]: q(e[i], t, `${n}.${i}`) }), {})
              : e;
          } catch (t) {
            return W.warn(`Card Serialize Error ${t}`), e;
          }
        },
        z = (e, t) => {
          const n = {};
          return { card: e.card && q(e.card, { callbackRegister: n, options: t }), key: e.key, callbackRegister: n };
        };
      function K(e, t, n, s) {
        return null === e ? null : j(e, { emitCallback: t, getIframeOffset: n, options: s });
      }
      const j = (e, t, n = "root") => {
        try {
          if (!(0, a.Kn)(e)) return e instanceof Array ? e.map((e, s) => j(e, t, `${n}.${s}`)) : e;
          switch (e.__type) {
            case "callback": {
              const n = e.id;
              return (...e) => {
                t.emitCallback({ id: n, args: e });
              };
            }
            case "react": {
              const r = e.componentName ? e.componentName : o.L.getLazyComponentName(e),
                p = $(s, r);
              if (!p) throw new Error(`Component ${e.componentName} is not recognized as card component`);
              const a = j(e.props, t, `${n}.[${e.componentName}]`);
              return (
                "Container" === e.componentName && Object.assign(a, { iframeFocusedFieldPosition: t.getIframeOffset() }),
                i.createElement(p, { ...a })
              );
            }
            case "document":
              return document;
            case "namedObject": {
              const n = t.options.namedObjects[e.name];
              if (!n) throw new Error("Cannot find namedObject");
              return n;
            }
            default:
              return (0, a.UI)((e, s) => (void 0 === s ? s : j(s, t, `${n}.${e}`)), e);
          }
        } catch (t) {
          return W.error(`Card Deserialize Error ${t}`), e;
        }
      };
    },
    97234: (e, t, n) => {
      n.d(t, { TV: () => s });
      var s = n(22390).v.isRichText;
    },
    77825: (e, t, n) => {
      n.d(t, { C2: () => N, EH: () => G, pi: () => j });
      var s = n(88133),
        i = n(9205),
        r = n(9629),
        p = n(40327),
      ...
      class L {
        constructor(e, t) {
          (this._root = w()),
            e.forEach((e) => {
              const n = e[t];
              if (!(0, y.HD)(n)) throw new Error("Can't search for non-string attributes");
              n.toLowerCase()
                .split("")
                .reduce((t, n) => (t.items.push(e), t.children.has(n) || t.children.set(n, w()), t.children.get(n)), this._root)
                .items.push(e);
            });
        }
        search(e) {
          const t = [];
          let n = null,
            s = { node: this._root, depth: 0 };
          const i = [];
          for (; s; ) {
            (n = x(e.toLowerCase(), s.node)), n && i.push({ node: n, depth: s.depth });
            const r = s.node.children.values();
            let p = r.next();
            for (; !p.done; ) t.push({ node: p.value, depth: s.depth + 1 }), (p = r.next());
            s = t.shift() || null;
          }
          return Array.from(
            i
              .reduce(
                (t, n) => (
                  n.node.items.forEach((s) => {
                    t.has(s) || t.set(s, { start: n.depth, end: n.depth + e.length });
                  }),
                  t
                ),
                new Map()
      ...
      function j(e, t, n) {
        if (!t) {
          if (e.deltaChange.isEmpty) return null;
          {
            ...
            let s = t.pop();
            for (; t.length && s && !I.s.isInsertString(s); ) s = t.pop();
            if (s && I.s.isInsertString(s) && !K.test(s.insert)) {
              const t = e.deltaChange.delta.ops.reduce(
                (e, t) => (I.s.isInsertString(t) ? e + t.insert.length : I.s.isRetain(t) ? e + t.retain : e),
                0
              );
              return new RegExp(`^(.*\\s)?${(0, b.hr)(n)}(\\s.*)?$`).test(
                (0, f.l)(e.deltaChange.delta, e.prevText).slice(Math.max(t - n.length - 1, 0), t + 1)
              )
                ? { start: t - n.length, end: t }
                : null;
            }
            return null;
          }
        ...
        {
          const { effectStartIndex: s, sizeDelta: i } = e.deltaChange.delta.ops.reduce(
            (e, t) => (
              I.s.isRetain(t)
                ? (e.index += t.retain)
                : I.s.isDelete(t)
      ...
      class G {
        constructor(e, t, n, i, r, p, g, S, E, f, b, y, w, x, N, I, k, P, B = T.Y.create("Snippets")) {
          var A, O;
          (this._snippetsProvider = e),
            (this._textObserver = t),
            (this._replacementService = n),
            (this._geometryProvider = i),
            (this._geometryLayout = r),
            (this._textFieldLayout = p),
            (this._getCurrentTextMap = g),
            (this._controller = S),
            (this._keyDown = E),
            (this._gnar = f),
            (this._checkingService = b),
            (this._selectionSource = y),
            (this._state = w),
            (this._updateSnippetsShortcutPopupCounter = x),
            (this._isCurrentFieldFocused = N),
            (this._events = I),
            (this._alertStateService = k),
            (this._experimentClient = P),
            (this._log = B),
            (this._subs = []),
            ...
            (this._snippetsDataByName = new L([], "name")),
            (this._snippetsDataByContent = new L([], "content")),
            (this._triggerSequence = z.QQ),
            ...
            (this.showSnippetsEditor = (e) => {
              this._snippetsProvider.snippetsAndSettings
                .pipe((0, h.M)(this._selectionObservable.pipe((0, m.O)(null))), D.q(1))
                .subscribe(([t, n]) => {
                  const s = this._getModel("editor", t, n, null, e);
                  s && this._controller.show(s);
                });
            }),
            (this._initialShortcutPopupCounter =
              null !== (O = null === (A = this._state.get()) || void 0 === A ? void 0 : A.page.snippetsShortcutPopupCounter) && void 0 !== O
                ? O
                : 0),
            (this._snippetsModel = (0, c.aj)([
              this._insertionRange,
              this._activeSnippet,
              this._textFieldLayout.rect.behavior,
              this._snippetsProvider.snippetsAndSettings
            ]).pipe(
              (0, d.U)(([e, t, n, s]) => (e ? this._getModel("list", s, e, t) : null)),
              (0, _.B)(),
              (0, m.O)(null)
            )),
          ...
          this._subs.push(
            this._snippetsProvider.snippetsAndSettings.subscribe((e) => {
              (this._triggerSequence = e.triggerSequence),
                (this._snippetsDataByName = new L(e.snippets, "name")),
                (this._snippetsDataByContent = new L(e.snippets, "content")),
                this._gnar.snippetsListLoaded(e.snippets.length, U ? new Date().getTime() - W : void 0),
                (U = !1);
            })
          ),
            this._subs.push(
              (0, l.T)(
                ...
                this._events.pipe(
                  (0, h.M)(this._snippetsProvider.snippetsAndSettings),
                  d.U(([{ text: e, textRange: t, onCreate: n }, s]) => this._getModel("editor", s, t, void 0, e, n)),
                  F.b((e) => this._log.trace("Model changed", e))
                )
              ).subscribe((e) => {
            ...
            this._subs.push(
              this._isCurrentFieldFocused.pipe((0, u.h)((e) => !e)).subscribe(() => this._hide("Current field lost its focus"))
            ),
            this._subs.push(
              this._snippetsProvider.snippetsEnabled.pipe((0, u.h)((e) => !e)).subscribe(() => this._hide("Snippets feature got disabled."))
            ),
            this._subs.push(
              this._textObserver.contentChanges.async
                .pipe(
                  ...
                  (0, h.M)(this._insertionRange.pipe((0, m.O)(null)), this._snippetsProvider.snippetsAndSettings.pipe((0, m.O)(null)))
                )
                .subscribe(([e, t, n]) => {
                  if (!n || !n.enabled) return;
                  const s = n.triggerSequence,
                    i = j(e, t, s);
                  this._insertionRange.next(i),
                    t && null === i && this._dismiss("edit"),
                    null === t &&
                      i &&
                      (this._gnar.snippetsTriggerSequenceEntered(!0, s),
                      this._log.trace("Snippets trigger sequence entered."),
                      this._gnar.snippetsListPresented(s));
                })
            ),
            this._subs.push(
              this._keyDown
                .pipe(
                  (0, h.M)(
                    this._insertionRange.pipe((0, m.O)(null)),
                    this._snippetsModel,
                    this._selectionObservable.pipe((0, m.O)(null)),
                    this._isCurrentFieldFocused,
                    this._snippetsProvider.snippetsAndSettings
                  )
                )
                .subscribe(([e, t, n, i, r, p]) => {
                  if (!p.enabled) return;
                  const a = (0, s.O)(),
                    o = (e) =>
                      e.key.toLowerCase() === p.creationShortcut &&
                  ...
                  if (
                    ...
                    const t = this._getModel("editor", p, i);
                    if (t)
                      return (
                  ...
                  if (e.keyCode === M.VD.Escape) return this._dismiss("esc"), void e.stopPropagation();
                  t &&
                    ((e.keyCode !== M.VD.Tab && e.keyCode !== M.VD.RightArrow && e.keyCode !== M.VD.Return) ||
                    e.altKey ||
                    e.ctrlKey ||
                    e.shiftKey ||
                    e.metaKey
                      ? (e.keyCode !== M.VD.UpArrow && e.keyCode !== M.VD.DownArrow) ||
                        (e.preventDefault(), e.stopPropagation(), this._shiftActiveSnippet(e.keyCode === M.VD.UpArrow, n))
                      : t &&
                        n &&
                        n.activeSnippet &&
                        (e.preventDefault(), e.stopPropagation(), this._applySnippet(n.activeSnippet.snippet, t, p.triggerSequence)));
                })
            ),
            this._subs.push(
              this._textFieldLayout.scroll.behavior
                .pipe(
                  (0, h.M)(this._snippetsModel),
                  (0, u.h)(([e, t]) => !!t)
                )
                .subscribe(() => {
            ...
            this._subs.push(
              this._alertStateService.newlyHighlightedAlerts
                .pipe(
                  h.M(this._snippetsProvider.snippetsEnabled),
                  u.h(([e, t]) => t && C.S.isSuggestedSnippetAlert(e))
                )
                .subscribe(() => {
        ...
        _applySnippet(e, t, n) {
          const s = this._experimentClient.isGateEnabled(i.K.RtfSnippets) && (0, E.TV)(e.contentDelta),
            r = s ? e.contentDelta : e.content;
          this._dismiss("apply"),
            this._gnar.snippetsSnippetApplied(s, t.end - t.start - n.length),
            this._replacementService.performReplacement({ pos: t, value: r }),
            this._checkingService && this._checkingService.onSnippetFeedback({ kind: k.JE.SNIPPET_ACCEPTED, snippetUuid: e.id });
        }
        _selectSnippet(e) {
        ...
        _getSnippetsForText(e) {
          return [
            ...this._snippetsDataByName.search(e).map((e) => ({ snippet: e.item, range: e.range, location: N.name })),
            ...this._snippetsDataByContent.search(e).map((e) => ({ snippet: e.item, range: e.range, location: N.content }))
        ...
        _shiftActiveSnippet(e, t) {
          ...
          if (t && t.matches.length && t.activeSnippet) {
            const s = t.activeSnippet.index;
            s > -1
              ? this._activeSnippet.next(
                  (null === (n = t.matches[Math.min(t.matches.length - 1, Math.max(s + (e ? -1 : 1), 0))]) || void 0 === n
                    ? void 0
                    : n.snippet) || null
                )
        ...
        _getModel(e, t, n, s, i, p) {
          var a;
          const o = this._getCurrentTextMap(),
            c = n && this._geometryProvider.create(n, o),
            l = c ? this._geometryProvider.getClientRects(c) : null,
            d = null !== (a = l && l.length && ("list" === e ? l[0] : l[l.length - 1])) && void 0 !== a ? a : null,
            u =
              (d &&
                (0, S.Z)(
              ...
              ("editor" === e && ((h = this._textFieldLayout.rect.getApproximate().client), g.UL.setPosition(h, { height: 1, width: 1 })));
          var h;
          if (!u) return null;
          if ("shortcutPopup" === e) {
            if ("test" === this._experimentClient.peekTreatment(r.p.GbSnippetsSelectionPopup)) return null;
          ...
          const m = n ? this._getSnippetsForText(o.getPlainText().substring(n.start + t.triggerSequence.length, n.end)) : [],
            _ = n ? n.end - n.start - t.triggerSequence.length : 0,
            C = s ? m.findIndex((e) => e.snippet.id === s.id) : -1;
          return {
            rect: u,
            matches: m,
            mode: e,
            applySnippet: (e) => {
              const s = m.find((t) => t.snippet.id === e);
              n && s && this._applySnippet(s.snippet, n, t.triggerSequence);
            },
            selectSnippet: (e) => {
              const t = m.find((t) => t.snippet.id === e);
              t && this._selectSnippet(t.snippet);
            },
            addSnippet: async (e, t) => {
              (await this._snippetsProvider.addSnippet(e, t)) && (p && p(), this._gnar.snippetsInlineSnippetCreated()),
                this._hide("Close on snippet add.");
            },
            activeSnippet: m.length ? (s && C > -1 ? { snippet: s, index: C } : { snippet: m[0].snippet, index: 0 }) : null,
            matchLength: _,
            triggerSequence: t.triggerSequence,
            creationShortcut: t.creationShortcut,
            content: i || ("list" !== e && n ? o.getPlainText().substring(n.start, n.end) : "")
          };
        }
        _show(e) {
        ...
        static _subscribeToMuteOrUndoMuteButtonClick(e, t, n, s, i) {
          e.add(
            t
              .pipe(
                u.h(s),
                ...
                u.h(b.fQ),
                u.h(A.i.isSuggestedSnippetItem)
              )
              .subscribe(i)
          );
        }
        ...
        initCardActionsProcessing(e, t, n, s) {
          return new W.y(() => {
            const i = new U.w();
            return (
              i.add(
                e
                  .pipe(
                    u.h(B.lY.isCreateSnippetAction),
                    F.b(() => {
              ...
              i.add(
                e.pipe(u.h(B.lY.isSuggestedSnippetSuccessDismissed)).subscribe((e) => {
                  (0, p.pipe)(
                    t.getById(e.alertId),
                    $.chain(P.bZ.getRawId),
                    $.fold(
                      ...
                      (e) => {
                        var t;
                        return null === (t = this._checkingService) || void 0 === t ? void 0 : t.onAlertAcknowledged(e, k.e3.Sidebar);
                      }
                    )
                  );
                })
              ...
              i.add(
                n.pipe(u.h(A.i.isSuggestedSnippetItem)).subscribe(() => {
              ...
              i.add(
                e
                  ...
                  .subscribe((e) =>
                    (0, p.pipe)(
                      t.getById(e),
                      $.filter(P.bZ.isSuggestedSnippet),
                      q.bw(() => {
              ...
              i.add(
                e.pipe(u.h(B.lY.isAlertIgnoreAction)).subscribe((e) =>
                  (0, p.pipe)(
                    t.getById(e.alertId),
                    $.filter(P.bZ.isSuggestedSnippet),
                    q.bw(() => {
              ...
              G._subscribeToMuteOrUndoMuteButtonClick(i, e, s, B.lY.isMuteCategoryAction, () => {
                this._gnar.suggestedSnippetCardDeactivate("assistant");
              }),
              G._subscribeToMuteOrUndoMuteButtonClick(i, e, s, B.lY.isUndoMuteCategoryAction, () => {
    ...
    25309: (e, t, n) => {
      ...
      const l = (e) => {
          ...
          return e.location === p.C2.content
            ? {
        ...
        u = () => ((0, s.O)().config.systemInfo.os.isMac ? "CONTROL" : "ALT"),
        h = () =>
          r.createElement(
            "svg",
        ...
        v = (e) => {
          ...
          const n = r.useRef(null),
            [s, p] = r.useState({ menuOpen: !1, visibleSnippetsAmount: 30 });
          r.useEffect(() => a());
          const a = () => {
              ...
              if (i && n.current) {
                ...
                const l = (s.visibleSnippetsAmount - 1) * e;
                p + r.offsetHeight > l && d();
              }
            },
            d = () => {
              p((e) => ({ ...e, visibleSnippetsAmount: s.visibleSnippetsAmount + 30 }));
            },
            v = (t) => {
              p((e) => ({ ...e, menuOpen: !1 })), e.onOpenLink(t);
            };
          return r.createElement(
            "div",
            { className: c.snippetsCard },
            e.matches.length
              ? r.createElement(
                  "dl",
                  { ref: n, className: c.snippetsCard__snippets },
                  e.matches.slice(0, s.visibleSnippetsAmount).map((n) => {
                    var s, i;
                    return r.createElement(
                      "div",
                      {
                        ...(0, o.Sh)(
                          c.snippetsCard__snippet,
                          n.snippet.id ===
                            (null === (i = null === (s = e.activeSnippet) || void 0 === s ? void 0 : s.snippet) || void 0 === i
                              ? void 0
                              : i.id)
                            ? c.snippetsCard__snippet_active
                            : null
                        ),
                        key: n.snippet.id,
                        onClick: () => e.applySnippet(n.snippet.id),
                        onMouseEnter: () => {
                          return (s = n.snippet.id), void (t || e.selectSnippet(s));
                          var s;
                        }
                      },
                      r.createElement(f, { match: n, triggerSequence: e.triggerSequence }),
                      r.createElement(b, { match: n, content: l(n) })
                    );
                  })
                )
              : r.createElement(y, { creationShortcut: e.creationShortcut }),
            r.createElement(
              "div",
              { className: c.snippetsCard__footer },
              r.createElement("div", { className: c["snippetsCard__footer-logo"] }, r.createElement(h, null)),
              r.createElement(
                "div",
                { className: c["snippetsCard__footer-hints"] },
                r.createElement(
                  "span",
                  { className: c.buttonTip__group },
                  "navigate",
                  " ",
                  r.createElement("span", { className: c.buttonTip }, r.createElement(m, null)),
                  " ",
                  r.createElement("span", { className: c.buttonTip }, r.createElement(_, null))
                ),
                r.createElement(
                  "span",
                  { className: c.buttonTip__group },
                  "select ",
                  r.createElement("span", { className: c.buttonTip }, "Enter")
                ),
                r.createElement(
                  "span",
                  { className: c.buttonTip__group },
                  "cancel ",
                  r.createElement("span", { className: c.buttonTip }, "Esc")
                )
              ),
              r.createElement(
                "span",
                {
                  ...(0, o.Sh)(c["snippetsCard__footer-menuButton"], s.menuOpen ? c["snippetsCard__footer-menuButton_active"] : null),
                  onClick: () => {
                    p((e) => ({ ...e, menuOpen: !s.menuOpen }));
                  }
                },
              ...
              s.menuOpen &&
                r.createElement(
                  "ul",
                  { className: c["snippetsCard__footer-menu"] },
                  r.createElement(
                    "li",
                    { className: c["snippetsCard__footer-menuItem"] },
                    r.createElement(
                      "a",
                      {
                        target: "_blank",
                      ...
                      r.createElement("span", { className: c["snippetsCard__footer-menuItem-icon"] }, r.createElement(g, null)),
                      r.createElement(
                        "span",
                        { className: c["snippetsCard__footer-menuItem-textGroup"] },
                        r.createElement("span", { className: c["snippetsCard__footer-menuItem-text"] }, "Create snippet"),
                        r.createElement(
                          "span",
                          { className: c["snippetsCard__footer-shortcut"] },
                          r.createElement("span", { className: c.buttonTip }, u()),
                          " +",
                          " ",
                          r.createElement("span", { className: c.buttonTip }, e.creationShortcut.toUpperCase())
                        )
                      )
                    )
                  ),
                  r.createElement(
                    ...
                    r.createElement(
                      ...
                      r.createElement("span", { className: c["snippetsCard__footer-menuItem-icon"] }, r.createElement(S, null)),
                      r.createElement(
                        "span",
                        { className: c["snippetsCard__footer-menuItem-textGroup"] },
                        r.createElement("span", { className: c["snippetsCard__footer-menuItem-text"] }, "Open library")
                      )
                    )
                  ),
                  r.createElement(
                    ...
                    r.createElement(
                      ...
                      r.createElement("span", { className: c["snippetsCard__footer-menuItem-icon"] }, r.createElement(E, null)),
                      r.createElement(
                        "span",
                        { className: c["snippetsCard__footer-menuItem-textGroup"] },
                        r.createElement("span", { className: c["snippetsCard__footer-menuItem-text"] }, "Edit shortcut"),
                        r.createElement(
                          "span",
                          { className: c["snippetsCard__footer-shortcut"] },
                          r.createElement("span", { ...(0, o.Sh)(c.buttonTip, c["snippetsCard__footer-editShortcut"]) }, e.triggerSequence)
                        )
                      )
                    )
                  )
        ...
        f = (e) =>
          r.createElement(
            "dt",
            { className: c["snippetsCard__snippet-name"] },
            r.createElement("span", {
              ...(0, o.Sh)(
                c["snippetsCard__snippet-logo"],
                "PERSONAL" === e.match.snippet.hierarchy ? c["snippetsCard__snippet-logo-personal"] : c["snippetsCard__snippet-logo-global"]
              )
            }),
            r.createElement("span", { className: c["snippetsCard__snippet-name-match"] }, e.triggerSequence),
            e.match.location === p.C2.name
              ? r.createElement(
                  r.Fragment,
                  null,
                  ...
                  r.createElement(
                    "span",
                    { className: c["snippetsCard__snippet-name-match"] },
                    e.match.snippet.name.slice(e.match.range.start, e.match.range.end)
                  ),
                  e.match.snippet.name.slice(e.match.range.end)
                )
              : r.createElement(r.Fragment, null, e.match.snippet.name)
          ),
        b = (e) =>
          r.createElement(
            "dd",
            { className: c["snippetsCard__snippet-content"] },
            e.match.location === p.C2.content
              ? r.createElement(
                  r.Fragment,
                  null,
                  e.content.prefix,
                  r.createElement("span", { className: c["snippetsCard__snippet-content-match"] }, e.content.content),
                  e.content.suffix
                )
              : r.createElement(r.Fragment, null, e.content.content)
          ),
        y = (e) =>
          r.createElement(
            "div",
            { className: c.snippetsCard__empty },
            r.createElement("div", { className: c["snippetsCard__empty-pic"] }),
            r.createElement("span", { className: c["snippetsCard__empty-title"] }, "Your search did not match any snippets"),
            r.createElement(
              "div",
              { className: c["snippetsCard__empty-shortcut"] },
              "To create one, press ",
              r.createElement("span", { ...(0, o.Sh)(c.buttonTip) }, u()),
              "+",
              r.createElement("span", { ...(0, o.Sh)(c.buttonTip) }, e.creationShortcut.toUpperCase())
            )
          ),
        w = (e) => (
          r.useEffect(() => {
          ...
          r.createElement(
            "div",
            { className: c.snippetsCreateBtn },
            r.createElement(
              "span",
              { className: c.snippetsCreateBtn__logo },
              r.createElement(
                "svg",
            ...
            r.createElement(
              "span",
              { className: c.snippetsCreateBtn__textGroup },
              r.createElement("span", { onClick: () => e.openEditor(), className: c.snippetsCreateBtn__text }, "Create a snippet"),
              r.createElement(
                "span",
                { onClick: () => e.openEditor(), className: c.snippetsCreateBtn__shortcut },
                r.createElement("span", { className: c.buttonTip }, u()),
                " +",
                " ",
                r.createElement("span", { className: c.buttonTip }, e.creationShortcut.toUpperCase())
            ...
            r.createElement(
              ...
              r.createElement("span", { className: c.snippetsCreateBtn__tooltip }, "?")
            )
          )
        );
    },
      ...
      const c = {
        ...
        l = (e) => {
          ...
          return i.createElement(
            ...
            i.createElement(
              "div",
              { className: r.snippetsEditor__topWrapper },
              i.createElement("input", {
                ...
                autoFocus: !0,
                className: r.snippetsEditor__topWrapper_name,
                placeholder: "New snippet",
                name: "snippet-name-input"
              }),
              u.length ? i.createElement("div", { className: r.snippetsEditor__topWrapper_nameError }, u) : null,
              i.createElement("textarea", {
                ...
                className: r.snippetsEditor__topWrapper_content,
                placeholder: "Write a snippet of text that can be used again and again.",
                value: l,
                name: "snippet-content-input"
              }),
              m.length ? i.createElement("div", { className: r.snippetsEditor__topWrapper_contentError }, m) : null
            ),
            i.createElement(
              "div",
              { className: r.snippetsEditor__bottomWrapper },
              i.createElement(
                "div",
                { className: r.snippetsEditor__bottomWrapper_logo },
                i.createElement(
                  "svg",
                  { viewBox: "0 0 22 22", version: "1.1", xmlns: "http://www.w3.org/2000/svg" },
              ...
              i.createElement(
                "div",
                { className: r.snippetsEditor__bottomWrapper_text },
                "This snippet will be added to your default collection. To use it later, type",
                i.createElement("span", { className: r.buttonTip }, e.triggerSequence)
              ),
              i.createElement(
                "div",
                { className: r.snippetsEditor__bottomWrapper_buttons },
                i.createElement(
                  "div",
                  {
                    onClick: () => e.dismiss(),
                    className: r.snippetsEditor__bottomWrapper_cancelBtn,
                ...
                i.createElement(
                  "div",
                  { onClick: () => C(t, l), className: r.snippetsEditor__bottomWrapper_saveBtn, "data-name": "save-snippet-button" },
                  "Save"
                )
              )
            )
    ...
    9917: (e, t, n) => {
      ...
      var s = n(27378);
      const i = (e) =>
        s.createElement("div", { onKeyDown: (e) => e.stopPropagation(), onMouseDown: (e) => e.stopPropagation() }, e.children);
    },
    4947: (e) => {
      e.exports = {
