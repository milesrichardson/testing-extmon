  ...
  [8513],
  {
    ...
    101: (e, t, n) => {
      ...
      var L = function (e, t) {
        ...
        A = function (e) {
          return "viewportProvider".concat(T._A(e));
        };
    },
    64757: (e, t, n) => {
    ...
    42484: (e, t, n) => {
      ...
      class f {
        constructor(e, t, n, o, a, r = h.Y.create("knowledgeHub.onboardingViewModel")) {
          (this.actions = e),
            ...
            this._subscriptions.add(this._handleAnchorNode()),
            this._subscriptions.add(this._handleNext()),
            this._subscriptions.add(this._handleSkip()),
            this._subscriptions.add(this._handleDismiss());
        }
        _handleAnchorNode() {
          return this.actions
            .pipe(
              s.kA.ofKind(s.p4.Kind.onboardingAnchorMounted),
              l.M(this._csState),
        ...
        _handleNext() {
          return this.actions
            .pipe(
              s.kA.ofKind(s.p4.Kind.nextStepOnboarding),
              u.b(() => {
        ...
        _setOnboardingSeen(e) {
          this._csActions
            .setKnowledgeHubOnboardingSeen(o.v3.OnboardingSeenFor[e])
            .catch(this._onHandleReject("csActions.setKnowledgeHubOnboardingSeen"));
        }
        _handleDismiss() {
          return this.actions
            .pipe(
              s.kA.ofKind(s.p4.Kind.closeOnboarding),
              u.b(() => {
                this._state.set(i.empty());
              })
            )
            .subscribe();
        }
        _handleSkip() {
          return this.actions
            .pipe(
              s.kA.ofKind(s.p4.Kind.skipStepOnboarding),
              u.b(() => {
                this._state.set(i.empty());
              })
            )
      ...
      const N = ({ className: e, width: t = 48, height: n = 48 }) =>
        v.createElement(
          ...
          v.createElement("path", {
            d: "M43.0976 38.4967L28.853 46.7976C27.7361 47.4484 26.3601 47.4484 25.2432 46.7976L4.90243 34.9443C3.69919 34.2431 3.69919 32.4901 4.90243 31.789L19.147 23.4881C20.2639 22.8373 21.6399 22.8373 22.7568 23.4881L43.0976 35.3414C44.3008 36.0426 44.3008 37.7956 43.0976 38.4967Z",
            fill: "#638EEB",
            stroke: "#0E101A"
          }),
          v.createElement("path", {
            d: "M43.0976 31.4967L28.853 39.7976C27.7361 40.4484 26.3601 40.4484 25.2432 39.7976L4.90243 27.9443C3.69919 27.2431 3.69919 25.4901 4.90243 24.789L19.147 16.4881C20.2639 15.8373 21.6399 15.8373 22.7568 16.4881L43.0976 28.3414C44.3008 29.0426 44.3008 30.7956 43.0976 31.4967Z",
            fill: "#28BAC7",
            stroke: "#0E101A"
          }),
          v.createElement("path", {
            d: "M43.0976 24.4967L28.853 32.7976C27.7361 33.4484 26.3601 33.4484 25.2432 32.7976L4.90243 20.9443C3.69919 20.2431 3.69919 18.4901 4.90243 17.789L19.147 9.48813C20.2639 8.83729 21.6399 8.83729 22.7568 9.48813L43.0976 21.3414C44.3008 22.0426 44.3008 23.7956 43.0976 24.4967Z",
            fill: "#87E8D1",
            stroke: "#0E101A"
          }),
          v.createElement("ellipse", {
            ...
            rx: "10.1841",
            ry: "5.33071",
            transform: "matrix(0.983255 0.182236 -0.363576 0.931564 13.4807 12.6812)",
            fill: "#0E101A"
          }),
          v.createElement("path", {
            d: "M25 23C31.0751 23 36 18.0751 36 12C36 5.92487 31.0751 1 25 1C18.9249 1 14 5.92487 14 12C14 18.0751 18.9249 23 25 23Z",
            fill: "#15C39A",
            stroke: "#0E101A",
            strokeMiterlimit: "10"
          }),
          v.createElement("path", {
            d: "M23.5336 16.2311C23.3596 16.2311 23.1856 16.1527 23.0613 16.0219L20.1283 12.9888C19.8549 12.7012 19.8549 12.2567 20.1283 11.9691C20.4017 11.6815 20.8243 11.6815 21.0977 11.9691L23.5088 14.5054L28.9026 8.83144C29.176 8.54382 29.5986 8.54382 29.872 8.83144C30.1454 9.11906 30.1454 9.56356 29.872 9.85118L24.0059 16.0219C23.8816 16.1788 23.7076 16.2311 23.5336 16.2311Z",
            fill: "white",
            stroke: "white"
          }),
          v.createElement("path", {
            d: "M42 8L43.0804 10.9196L46 12L43.0804 13.0804L42 16L40.9196 13.0804L38 12L40.9196 10.9196L42 8Z",
            fill: "white"
          }),
          v.createElement("path", {
            d: "M9.5 0L10.4453 2.55468L13 3.5L10.4453 4.44532L9.5 7L8.55468 4.44532L6 3.5L8.55468 2.55468L9.5 0Z",
            fill: "white"
          }),
          v.createElement("path", {
            d: "M2.5 9L3.17523 10.8248L5 11.5L3.17523 12.1752L2.5 14L1.82477 12.1752L0 11.5L1.82477 10.8248L2.5 9Z",
            fill: "white"
          })
        );
      var x = n(37869),
        ...
        A = n(63326),
        H = n(57112);
      const M = { large: { along: 33, across: 12 }, small: { along: 16, across: 8 } },
        F = v.forwardRef(function ({ placement: e, style: t, theme: n = "light", size: i = "large" }, o) {
          return v.createElement(
            "div",
            { ref: o, style: { width: M[i].along }, ...(0, L.Sh)(H.arrow, "light" === n ? H.arrowLight : H.arrowDark) },
            v.createElement(
              "svg",
              {
                width: M[i].along,
                height: M[i].across,
                viewBox: `0 0 ${M[i].along} ${M[i].across}`,
                fill: "none",
                style: { ...t, transform: `${(null == t ? void 0 : t.transform) || ""} rotate(${D(e)}deg)`.trimStart(), ...P(i, e) }
              },
              "large" === i
                ? v.createElement("path", {
                    d: "M1.14,0L31.86,0C28.02,0 26.015,0.867 23.874,3.552L17.514,11.014C16.939,11.689 15.891,11.689 15.315,11.014L8.955,3.552C6.815,0.867 4.98,0 1.14,0Z",
                    fill: "inherit"
                  })
                : v.createElement("path", { d: "M16,0L8,8L0,-0L16,0Z", fill: "inherit" })
            )
          );
        });
      function D(e) {
      ...
      function P(e, t) {
        return (null == t ? void 0 : t.startsWith("bottom"))
          ? { top: -M[e].across }
          : (null == t ? void 0 : t.startsWith("top"))
          ? { bottom: -M[e].across }
          : (null == t ? void 0 : t.startsWith("right"))
          ? { transformOrigin: "top left", top: 0.5 * -M[e].along, left: 0 }
          : (null == t ? void 0 : t.startsWith("left"))
          ? { transformOrigin: "top right", top: 0.5 * -M[e].along, right: 0 }
          : {};
      }
      var O;
      !(function (e) {
        let t, n;
        function i(e, t) {
          return t ? v.createElement(T.d, { onClickAway: t.onClickAway, additionalEventSources: t.additionalEventSources }, e) : e;
        }
        !(function (e) {
          const t = ({
            content: e,
              ...
              (e.createFlow = (e, t = !0) =>
                _.Z.animatingFlow(
                  ...
                  (function (e) {
                    return (t, n) =>
                      p.isSome(n)
                        ? p.isNone(t) || p.isNone(t.value)
                          ? p.some(K.F2("fadein"))
                          : e
                          ? p.some(K.Hk("fadeout", "fadein"))
                          : p.none
                        : p.some(K.t$("fadeout"));
                  })(t)
                ));
          ...
          (e.WithRef = (e) => {
            ...
            return (
              ...
              i(v.createElement("div", null, o), e.clickAwayOptions)
            );
          });
      })(O || (O = {}));
      var B = n(5397);
      const Z = _.UI.Grid.make(({ slots: e, state: t }) =>
        v.createElement(
          ...
          null,
          t.pipe(
            b.U(({ anchorNode: t, placement: n, distance: i, show: o }) =>
              v.createElement(O.WithRef, {
                key: "onboarding",
                content: v.createElement(I.F.Fragment, null, e.content),
                referenceElement: t,
                offsets: { away: i ? i + 8 : 6, along: 0 },
                theme: "dark",
                arrowSize: "small",
                useArrow: !0,
                placement: n || "top",
                style: { zIndex: B.op, width: 340 },
                animateBetweenStates: !1,
                show: o
              })
            )
          )
                  ...
                  v.createElement(
                    ...
                    v.createElement(
                      j.o.Tertiary,
                      {
                        ...
                        theme: "dark",
                        compact: !0,
                        onClick: t({ kind: "close", onboardingType: e })
                      },
          ...
          function n(e, t) {
            return _.Z.fromSideEffect(
              (e) => {
                switch (e.kind) {
                  case "next":
                    t.next({ kind: s.p4.Kind.nextStepOnboarding, step: "initial", onboardingType: e.onboardingType });
                    break;
                  case "skip":
                    t.next({ kind: s.p4.Kind.skipStepOnboarding, step: "initial", onboardingType: e.onboardingType });
                    break;
                  case "close":
                    t.next({ kind: s.p4.Kind.closeOnboarding, step: "initial", onboardingType: e.onboardingType });
                    break;
                  default:
                    (0, C.L0)(e);
                }
            ...
            return _.Z.fromSideEffect((t) => {
              switch (t.kind) {
                case "next":
                  ...
                  break;
                case "skip":
                  e.next({ kind: s.p4.Kind.skipStepOnboarding, step: t.step, onboardingType: t.onboardingType });
                  break;
                case "close":
                  e.next({ kind: s.p4.Kind.closeOnboarding, step: t.step, onboardingType: t.onboardingType });
                  break;
                default:
                  (0, C.L0)(t);
              }
      ...
      const V = ({ className: e, width: t = 48, height: n = 48 }) =>
        v.createElement(
          ...
          { className: e, width: t, height: n, viewBox: "0 0 48 48" },
          v.createElement("path", {
            d: "M16 46C24.8366 46 32 38.8366 32 30C32 21.1634 24.8366 14 16 14C7.16345 14 0 21.1634 0 30C0 38.8366 7.16345 46 16 46Z",
            fill: "url(#paint0_linear_5149_54795)"
          }),
          v.createElement("path", {
            d: "M21 41C29.8366 41 37 33.8366 37 25C37 16.1634 29.8366 9 21 9C12.1634 9 5 16.1634 5 25C5 33.8366 12.1634 41 21 41Z",
            fill: "#15C39A",
            stroke: "#0E101A",
            strokeMiterlimit: "10"
          }),
          v.createElement("path", {
            d: "M18.8667 31.1541C18.6136 31.1541 18.3605 31.04 18.1798 30.8498L13.9135 26.4381C13.5158 26.0197 13.5158 25.3732 13.9135 24.9548C14.3112 24.5364 14.9258 24.5364 15.3235 24.9548L18.8306 28.6439L26.6761 20.3909C27.0739 19.9726 27.6885 19.9726 28.0862 20.3909C28.4839 20.8093 28.4839 21.4558 28.0862 21.8742L19.5537 30.8498C19.3729 31.078 19.1198 31.1541 18.8667 31.1541Z",
            fill: "white",
            stroke: "white"
          }),
          v.createElement("path", {
            d: "M40 4L40.8103 6.18973L43 7L40.8103 7.81027L40 10L39.1897 7.81027L37 7L39.1897 6.18973L40 4Z",
            fill: "white"
          }),
          v.createElement("path", {
            d: "M4.5 0L5.71541 3.28459L9 4.5L5.71541 5.71541L4.5 9L3.28459 5.71541L0 4.5L3.28459 3.28459L4.5 0Z",
            fill: "white"
          }),
          v.createElement("path", {
            d: "M42 36L43.6205 40.3795L48 42L43.6205 43.6205L42 48L40.3795 43.6205L36 42L40.3795 40.3795L42 36Z",
            fill: "white"
          }),
          v.createElement(
            "defs",
            ...
            v.createElement(
              "linearGradient",
              { id: "paint0_linear_5149_54795", x1: "32", y1: "14", x2: "-0.746126", y2: "45.2173", gradientUnits: "userSpaceOnUse" },
              v.createElement("stop", { stopColor: "#15C39A" }),
              v.createElement("stop", { offset: "1", stopColor: "#8780E4" })
            )
          )
        );
      var X;
                ...
                v.createElement(
                  ...
                  v.createElement(
                    j.o.Tertiary,
                    {
                      ...
                      theme: "dark",
                      compact: !0,
                      onClick: e({ kind: "close", onboardingType: t })
                    },
                    v.createElement($.B, null)
                  )
                )
            ...
            return _.Z.composeUnion(
              {
                ...
                fullScreen: Y.createFlow(
                  t,
                  e.pipe(
                    b.U(({ currentStep: e, onboardingType: t }) => {
                      switch (e) {
                        case "highlightsAppear":
                          return {
                            step: e,
                            title: "Knowledge Share detects and highlights key terms in your team’s written communications.",
                            index: 0,
                            totalSteps: 3,
                            video: n.step1,
                            onboardingType: t
                        ...
                        case "mouseHovers":
                          return {
                            step: e,
                            title: "Quickly access information about important terms, related documents, and project team members.",
                            index: 1,
                            totalSteps: 3,
                            video: n.step2,
                            onboardingType: t
                        ...
                        case "mouseClicks":
                          return {
                            step: e,
                            title: "Keep information accurate and up-to-date by directly making edits for a particular term.",
                            index: 2,
                            totalSteps: 3,
                            video: n.step3,
                            onboardingType: t
              ...
              () =>
                e.pipe(
                  b.U(({ currentStep: e }) => {
                    switch (e) {
                      case "initial":
                        return { stepView: "initial" };
                      case "complete":
                        return { stepView: "complete" };
                      case "highlightsAppear":
                      case "mouseHovers":
                      case "mouseClicks":
                        return { stepView: "fullScreen" };
                      default:
                        (0, C.L0)(e);
                    }
                  })
          ...
          v.createElement(
            ...
            t.pipe(
              b.U(
                p.fold(
                  () => null,
                  () => v.createElement(I.F.Fragment, null, e.content)
                )
              )
            )
          )
      ...
      class re {
        constructor(e, t = h.Y.create("knowledgeHub.onboardingInjectionManager")) {
          ...
          const n = ie.V.get({ monitorAs: "knowledgeHub-onboarding" }).inject(
            ...
            oe.zs.appendChild(document.documentElement),
            () =>
              v.createElement(
                ne.L,
          ...
          this._logger.debug("OnboardingInjectionManager created"), this._subs.add(() => n.dispose());
        }
        dispose() {
      ...
      class se {
        ...
        dispose() {
          se._subscribersCount--,
            0 === se._subscribersCount && (this._onboardingInjectionManager.dispose(), this._viewModel.dispose(), (se._instance = null));
        }
      }
      (se._instance = null), (se._subscribersCount = 0);
    },
    2320: (e, t, n) => {
      var i, o;
      n.d(t, { $: () => i, f: () => o }),
        (function (e) {
          function t(t) {
            return e.Steps.indexOf(t) === e.Steps.length - 1;
          }
          (e.Steps = ["initial", "highlightsAppear", "mouseHovers", "mouseClicks", "complete"]),
            (e.first = function () {
              return e.Steps[0];
            }),
            (e.isLast = t),
            (e.next = function (n) {
              const i = e.Steps.indexOf(n);
              return t(n) ? n : e.Steps[i + 1];
            });
        })(i || (i = {})),
        (function (e) {
          (e.SUGGESTED_TERM = "SUGGESTED_TERM"), (e.TERM_DETAILS = "TERM_DETAILS");
        })(o || (o = {}));
    },
    20883: (e, t, n) => {
      n.d(t, { N1: () => S, cv: () => U, u$: () => i });
      ...
      class S {
        ...
        addEffects(...e) {
          for (const t of e)
            switch (t.uniqueness) {
              case i.Singleton:
                this._addSingletonEffect(t);
                break;
              case i.Multiton:
                this._addMultitonEffect(t);
                break;
              default:
                (0, w.L0)(t);
            }
        ...
        _subscribeToEffect(e) {
          this._subscription.add(e.effect(this._actions).subscribe((e) => this._actions.next(e)));
        }
      }
      var U;
      (S._instance = null),
        ...
        (function (e) {
          (e.tracking = function (e, t) {
            ...
            (e.feedback = function (e, t) {
              return (0, o.ls)(I.kA.ofKind(e), l.b(t), p.c(u.E));
            }),
            (e.logAction = function (e) {
              return {
                id: "logActions",
                uniqueness: i.Singleton,
                effect: (0, o.ls)(
                  l.b((t) => e.trace(`[${t.kind}]`, E.CE(t, "kind"))),
                  d.w(() => u.E)
                )
              };
            }),
            (e.toggleActiveHighlightCard = function (e, t) {
              return {
                uniqueness: i.Multiton,
                effect: () =>
                  e.pipe(
                    m.R(t),
                    h.U(y.toNullable),
            ...
            (e.toggleFeature = function (e, t) {
              return {
                id: "toggleFeature",
                uniqueness: i.Singleton,
                effect: (0, o.ls)(
                  I.kA.ofKind(I.p4.Kind.toggleFeature),
                  l.b(({ featureOn: n }) => {
                    e.toggleKnowledgeHub(n).catch(t("csActions.toggleKnowledgeHub"));
                  }),
                  p.c(u.E)
                )
              };
            ...
            (e.showCopyNameNotification = function () {
              return {
                id: "showCopyNameNotification",
                uniqueness: i.Singleton,
                effect: (0, o.ls)(
            ...
            (e.handleCopyNameError = function (e) {
              return {
                id: "handleCopyNameError",
                uniqueness: i.Singleton,
                effect: (0, o.ls)(
                  I.kA.ofKind(I.p4.Kind.copyNameResult),
                  v.h(({ result: e }) => C.isLeft(e)),
                  l.b(({ result: t }) => (0, o.zG)(t, C.mapLeft(e("trackCopyNameError")))),
                  p.c(u.E)
                )
              };
            }),
            (e.showTermDismissedNotification = function () {
              return {
                id: "showTermDismissedNotification",
                uniqueness: i.Singleton,
                effect: (0, o.ls)(
            ...
            (e.toggleActiveHighlightOnboarding = function (e, t, n) {
              return {
                uniqueness: i.Multiton,
                effect: () =>
                  e.pipe(
                    ...
                    h.U((e) => ({
                      ...
                      anchorNode: {
                        getBoundingClientRect: () => {
                          const n = (0, s.Z)(e.activeHighlightRect, t.textNode.rect.getCurrent().client, t.textNode.scroll.getCurrent());
            ...
            (e.showCopyDescriptionNotification = function () {
              return {
                id: "showCopyDescriptionNotification",
                uniqueness: i.Singleton,
                effect: (0, o.ls)(
            ...
            (e.handleCopyDescriptionError = function (e) {
              return {
                id: "handleCopyDescriptionError",
                uniqueness: i.Singleton,
                effect: (0, o.ls)(
                  I.kA.ofKind(I.p4.Kind.copyDescriptionResult),
                  v.h(({ result: e }) => C.isLeft(e)),
                  l.b(({ result: t }) => (0, o.zG)(t, C.mapLeft(e("trackCopyDescriptionError")))),
                  p.c(u.E)
                )
              };
            });
    ...
    22012: (e, t, n) => {
      ...
      function l(e) {
        return {
          id: "feedbackDismissTerm",
          uniqueness: c.u$.Singleton,
          effect: c.cv.feedback(s.p4.Kind.dismissTerm, (t) => e.get().sendKnowledgeHubFeedback({ kind: o.Lu.IGNORE, itemId: t.itemId }))
        };
      }
      function d(e) {
        return {
          id: "feedbackItemLooked",
          uniqueness: c.u$.Singleton,
        ...
        constructor(e, t, n, v, b) {
          (this.actions = e),
            ...
            (this._handleSetCardVisibleFor = this.actions.pipe(
              ...
              l.b(([e, t]) =>
                (0, o.zG)(
                  i.Y(u.option)({ item: e, activeAnnotation: t }),
                  u.fold(
                    () => this._state.set(u.none),
                    ({ item: e, activeAnnotation: t }) => {
                      this._state.modify(() =>
                        u.some({
                          item: e,
                          docId: e.docId,
            ...
            (this._handleCardLookedDuration = this.actions.pipe(
              ...
              s.U(
                u.fold(
                  () => ({ timestamp: Date.now(), termId: g.li.create("") }),
                  (e) => ({ timestamp: Date.now(), termId: e.termId })
                )
              ),
              d.j(2),
            ...
            this._subscriptions.add(this._handleCardHovered()),
            this._subscriptions.add(this._handleCardLookedDuration.subscribe());
        }
        _handleCardHovered() {
          return this.actions
    ...
    25485: (e, t, n) => {
      n.r(t),
        n.d(t, {
          createKnowledgeHubIntegration: () => w,
          hasKnowledgeHubInGDoc: () => i.Lt,
          isKnowledgeHubAlertAvailableInGdocs: () => i.kt,
          isKnowledgeHubTermDetailsSupported: () => i.nM
        });
      var i = n(95948),
        o = n(55649),
        a = n(20434),
      ...
      var f = n(42484),
        ...
        b = n(48015),
        k = n(52423);
      function w(e, t, n, i, l, d, u, g, b, k, w = o.Y.create("knowledgeHub.integration")) {
        return k === m.nk.All
          ...
          : (function (e, t, n, i, c, l, d, u, p, g = o.Y.create("knowledgeHub.onboardingIntegration")) {
              ...
              return (
                ...
                e.next({ kind: a.p4.Kind.integrationCreated, mode: m.nk.OnlyOnboarding }),
                {
                  actions: e,
                  dispose() {
                    k.dispose(), C.dispose(), y.dispose(), g.debug("Knowledge Hub Onboarding integration disposed");
                  }
                }
              );
            })(e, t, n, i, l, d, u, g, b, w);
      ...
      function E(e, t, n, i) {
        return e.getHighlightedAlert().pipe(
          l.h(b.Nf),
          d.U((e) => ({ ...e, alert: t.alerts.getAlertById(e.alertId) })),
          l.h(({ alert: e }) => null !== e && i(e)),
          u.q(1),
          d.U(({ activeHighlightRect: e, alert: t }) => ({
            clientRectangle: (0, k.Z)(e, n.textField.rect.getCurrent().client, n.textField.scroll.getCurrent()),
            onboardingType: (0, v.kK)(t) ? g.f.SUGGESTED_TERM : g.f.TERM_DETAILS
          }))
        );
      }
    },
    42651: (e, t, n) => {
      n.r(t), n.d(t, { KnowledgeHubFeatureImpl: () => o });
      const i = "KnowledgeHubTerms";
      class o {
        constructor(e, t) {
          (this._subs = []),
            this._subs.push(
              e.view("knowledgeHubSettings").subscribe((e) => {
                const n = t();
                n && e && (e.enabled ? n.onAlertUnmuted(i) : n.onAlertMuted(i));
              })
            );
        }
        dispose() {
    ...
    26821: (e, t, n) => {
      ...
      if (1388 == n.j) var k = n(98403);
      if (1388 == n.j) var w = n(5114);
      if (1388 == n.j) var E = n(55415);
      ...
      function N(e, t, n, N, x, T, K, L) {
        ...
        return (
          N.addEffects(S.cv.toggleActiveHighlightCard(H, A), S.cv.toggleActiveHighlightOnboarding(H, t, A)),
          {
            ...
            highlightsLayerOrder: p.C.knowledgeHub,
            highlightsUI: () =>
              o.createElement(
                c.L,
                { chunkName: "knowledgeHubIntegration" },
                o.createElement(I.x, {
                  highlights: T,
                  getHoverState: (e) => O.getHoveredStateBehavior(e),
                  highlightsTheme: (0, i.zG)(
                    (0, l.D)(e, (0, d.o)(e)),
                    w.fold(
                      () => "light",
                      (e) => (e ? "light" : "dark")
      ...
      class b {
        constructor(e, t) {
          (this._actions = e),
                        ...
                        o.DZ((t) =>
                          (0, i.zG)(
                            ...
                            h.map(() => ({
                              ...
                              headerIconSrc: t.headerIconSrc,
                              articleTitle: t.articleTitle,
                              aliases: t.aliases,
                              articleContent: t.articleContent,
                              pointPeople: t.pointPeople,
                              relatedMaterials: t.relatedMaterials,
                              suggestCorrectionUrl: t.suggestCorrectionUrl,
                              span: t.span
                            }))
                          )
                        ),
            ...
            this._subscriptions.add(this._handleDismissItem());
        }
        _handleDismissItem() {
          return this._actions
            .pipe(
              g.kA.ofKind(g.p4.Kind.dismissTerm),
              p.b(({ termId: e }) => this._dismissed.modify(s.$T(l.li.eq)(e))),
              p.b(() => this._actions.next({ kind: g.p4.Kind.dismissTermResult }))
            )
            .subscribe();
        }
        dispose() {
    ...
    64168: (e, t, n) => {
      ...
      var i,
        o = n(18999);
      !(function (e) {
        e.fromStaticCheck = function (e) {
          return {
            id: o.q.Id.create(e.id),
            itemId: e.id,
            docId: e.docId,
            span: e.span,
            termId: e.termId,
            headerText: e.headerText,
            headerIconSrc: e.headerIconSrc,
        ...
        return (
          ...
          C.debug(
            `Thread integration created for thread #${
              n
                .view("threadId")
                .view((0, i.ls)(c.fromEither, c.toUndefined))
                .get() || "unknown"
            }`
          ),
    ...
    10160: (e, t, n) => {
      ...
      var l = n(80608);
      const d = ({ heightOffset: e = 0, hoverState: t, rects: n, id: d, theme: u }) =>
        i.createElement(
          i.Fragment,
          null,
          n.map((p, m) => {
    ...
    70569: (e, t, n) => {
      ...
      const l = (e) => () =>
          (0, c.zG)(
            e,
            i.U((e) => {
              const t = e.map((e) => ({ name: e.name, isLast: !1 }));
              return (t[t.length - 1].isLast = !0), t;
            }),
            o.O([])
          ),
    ...
    35855: (e, t, n) => {
      ...
      var i,
        ...
        d = n(34761);
      !(function (e) {
        e.copyDescription = "copyDescription";
      })(i || (i = {}));
      const u = c.UI.Node.make(({ state: e, notify: t }) =>
        o.createElement(
          s.F.Fragment,
          null,
          e.pipe(
            r.U(({ articleContent: e }) =>
              o.createElement(
                a.zx,
                {
                  ...
                  className: d.copyButton,
                  onClick: t({ kind: i.copyDescription, articleContent: e })
                },
                o.createElement("span", { className: d.copyButtonLabel }, o.createElement(l.c, { width: 14 }), " Copy text")
              )
            )
          )
        )
    ...
    98710: (e, t, n) => {
      ...
      var l = n(34217);
      if (1388 == n.j) var d = n(58561);
      if (1388 == n.j) var u = n(12921);
      const p = (e, t) =>
          l.Z.fromSideEffect(
            ({ action: e }) => {
              switch (e.kind) {
                case u.je.pointPersonContact:
                  t.next({ kind: i.p4.Kind.pointPersonContact });
                  break;
                case u.je.pointPersonCopy:
                  t.next({ kind: i.p4.Kind.pointPersonCopy, displayName: e.personName });
                  break;
                default:
                  (0, s.L0)(e);
              }
    ...
    79100: (e, t, n) => {
      ...
      var l = n(34217);
      if (1388 == n.j) var d = n(58561);
      if (1388 == n.j) var u = n(16853);
      const p = (e, t) =>
          l.Z.fromSideEffect(
            ({ action: e }) => {
              if (e.kind === u.je.relatedMaterialsClick) t.next({ kind: i.p4.Kind.relatedMaterialsClick });
              else (0, s.L0)(e.kind);
            },
            e.pipe(o.O([]))
          ),
    ...
    92426: (e, t, n) => {
      ...
      var i,
        ...
        d = n(43063);
      !(function (e) {
        e.dismissTerm = "dismissTerm";
      })(i || (i = {}));
      const u = l.UI.Node.make(({ state: e, notify: t }) =>
          o.createElement(
            c.F.Fragment,
            null,
            e.pipe(
              s.U(({ itemId: e, termId: n }) =>
                o.createElement(
                  r.zx.Flat,
                  {
                    ...
                    onClick: t({ kind: i.dismissTerm, itemId: e, termId: n })
                  },
        ...
        p = l.UI.Grid.make(({ slots: e }) =>
          o.createElement(
            "div",
            { "data-grammarly-part": "knowledge-hub-card-footer", className: d.cardFooter },
            e.dismissButton,
            e.suggestCorrection
          )
        ),
    ...
    83876: (e, t, n) => {
      ...
      var i,
        ...
        u = n(38876);
      !(function (e) {
        e.suggestEditAction = "suggestEditAction";
      })(i || (i = {}));
      const p = l.UI.Node.make(({ view: e, notify: t }) =>
        o.createElement(
          c.F.Fragment,
          null,
          e("suggestCorrectionUrl").pipe(
            s.U(
              d.fold(
                () => null,
                (e) =>
                  o.createElement(
                    r.zx.Flat,
                    {
                      ...
                      key: "edit-button",
                      name: "edit-button",
                      "data-grammarly-part": "knowledge-hub-card-edit-button",
                      className: u.button,
                      textPosition: "surrounded",
                      target: "_blank",
                      href: e,
    ...
    6850: (e, t, n) => {
      ...
      const l = ({
        ...
        return (
          ...
          i.createElement(
            ...
            {
              ref: g,
              style: { ...k.popper, zIndex: l },
              className: c.popover,
              onMouseMove: () => (null == e ? void 0 : e(!0)),
              onMouseLeave: () => (null == e ? void 0 : e(!1)),
              ...w.popper
            },
            p,
      ...
      const b = m.UI.Node.make(({ state: e }) =>
          i.createElement(
            ...
            e.pipe(
              u.U(({ name: e, isLast: t }) =>
                i.createElement("span", { "data-grammarly-part": "knowledge-hub-card-alias" }, e, t ? "" : ", ")
              )
            )
          )
        ),
        k = m.UI.List.make(g.Bk, b),
        w = m.UI.Grid.make(({ slots: e }) =>
          i.createElement("span", { "data-grammarly-part": "knowledge-hub-card-aliases-list", className: v.list }, "also known as ", e.list)
        ),
        E = m.UI.Knot.make(w, { list: k }),
      ...
      const K = m.UI.Grid.make(({ slots: e }) =>
          i.createElement(
            "div",
            { "data-grammarly-part": "knowledge-hub-card-content", className: T.cardContent },
            i.createElement("div", { className: T.section }, e.title, e.aliases, e.description),
            e.relatedMaterialsList,
            e.peopleList
          )
        ),
      ...
      const M = m.UI.Node.make(({ view: e }) =>
          i.createElement(
            p.F.Fragment,
            null,
            e("headerIconSrc").pipe(u.U((e) => i.createElement("div", { className: H.icon }, i.createElement("img", { src: e, alt: "" }))))
          )
        ),
        F = m.UI.Union.asOption(M),
        D = m.UI.Grid.make(({ view: e, slots: t }) =>
          i.createElement(
            "div",
            { "data-grammarly-part": "knowledge-hub-card-header", className: H.cardHeader },
            i.createElement(
              p.F.div,
              { "data-grammarly-part": "knowledge-hub-card-title", className: H.title },
              t.headerIcon,
              i.createElement(p.F.div, { className: H.text }, e("headerText"))
            )
          )
        ),
        P = m.UI.Knot.make(D, { headerIcon: F });
      var O = n(1889);
      const B = m.UI.Grid.make(({ slots: e }) =>
          i.createElement(
            p.F.Fragment,
            null,
                ...
                content:
                  ...
                  l.Z.composeKnot({
                    header: (0, m.A)(
                      t.pipe(
                        i.oA,
                        o.U((e) => ({ headerText: e.item.headerText, headerIconSrc: e.item.headerIconSrc }))
                      )
                    ),
                    content: (0, u.M)(
                      t.pipe(
                        i.oA,
                        o.U((e) => ({
                          articleTitle: e.item.articleTitle,
                          aliases: e.item.aliases,
                          articleContent: e.item.articleContent,
                          pointPeople: e.item.pointPeople,
                          relatedMaterials: e.item.relatedMaterials
                        }))
                      ),
                      n
                    ),
                    footer: (0, p.l)(
                      t.pipe(
                        i.oA,
                        o.U((e) => ({ itemId: e.item.itemId, termId: e.item.termId, suggestCorrectionUrl: e.item.suggestCorrectionUrl }))
                      ),
                      n
                    )
                  }))
    ...
    65338: (e, t, n) => {
      ...
      !(function (e) {
        e.Impl = class {
          constructor(e, t, n, i) {
            (this.actions = e),
              (this._notificationRequestRefinement = t),
              (this._notificationDurationMs = n),
              (this._maxNotificationsCountAtOnce = i),
              (this._subscriptions = new l.w()),
              (this._state = g.h.create([])),
              (this.state = this._state.view()),
              this._subscriptions.add(this._autoDismissNotifications()),
              this._subscriptions.add(this._handleShowNotifications()),
              this._subscriptions.add(this._handleDismissNotifications());
          }
          _autoDismissNotifications() {
            return d
              .F(1e3)
              .pipe(
                u.M(this._state),
        ...
        (function (e) {
          class t extends i.Impl {
            constructor(e) {
              super(e, c.P.Request.isToast, 6e3, 3);
            }
          }
          e.Impl = t;
        })(o || (o = {}));
      var v = n(27378),
        ...
        C = n(8543);
      class I {
        constructor(e, t = y.Y.create("knowledgeHub.notifications")) {
          (this._logger = t), (this._subs = new l.w());
          const n = k.V.get({ monitorAs: "knowledgeHub-notifications" }).inject(
            w.EM.fromDocument(document, "grammarly-extension"),
            w.zs.appendChild(document.documentElement),
            () =>
              v.createElement(
                b.L,
                { chunkName: "knowledgeHubIntegration" },
                v.createElement(
                  E.o,
                  { "data-grammarly-part": "knowledgeHub-notifications" },
                  v.createElement(C.F.Fragment, null, v.createElement(e, null))
                )
              )
          );
          this._logger.debug("NotificationsInjectionManager created"), this._subs.add(() => n.dispose());
        }
        dispose() {
          this._subs.unsubscribe();
        }
      ...
      var _ = n(34217),
        ...
        N = n(76974),
        x = n(31278);
      const T = ({ className: e, width: t = 24 }) =>
        v.createElement(
          x.a1,
          { className: e, width: t, viewBox: "0 0 24 24" },
          v.createElement(
            "g",
            { fillRule: "evenodd" },
            v.createElement("circle", { cx: "12", cy: "12", r: "11.5", fill: "inherit" }),
            v.createElement("path", { stroke: "inherit", strokeWidth: "2", d: "M7.54 12.81l3.343 3.5 6.657-7.78", strokeLinecap: "round" })
          )
        );
      var K;
      !(function (e) {
      ...
      class M {
        ...
        dispose() {
          M._subscribersCount--,
            0 === M._subscribersCount && (this._notificationsInjectionManager.dispose(), this._viewModel.dispose(), (M._instance = null));
        }
      }
      (M._instance = null), (M._subscribersCount = 0);
    },
    40435: (e, t, n) => {
      n.d(t, { P: () => i });
      var i,
      ...
      !(function (e) {
        ...
        !(function (e) {
          let t;
          !(function (e) {
            (e.textCopiedSuccess = "textCopiedSuccess"),
              (e.descriptionCopiedSuccess = "descriptionCopiedSuccess"),
              (e.termDismissedSuccess = "termDismissedSuccess");
          })((t = e.Kind || (e.Kind = {})));
        })((t = e.Toast || (e.Toast = {}))),
          (function (e) {
            e.isToast = function (e) {
          ...
          (e.create = function (e, n) {
            const i = { id: o.iy.create(), dismissTimestamp: Date.now() + n };
            switch (e.kind) {
              case t.Kind.textCopiedSuccess:
              case t.Kind.descriptionCopiedSuccess:
    ...
    18999: (e, t, n) => {
      ...
      !(function (e) {
        let t;
        !(function (e) {
          (e.codec = o.UQ(o.Z_, (e) => "string" == typeof e, "AnnotationId")),
            (e.create = function (e) {
              return e;
            }),
            (e.eq = a.yv);
                ...
                e
                  ? s
                      .T(
                        ...
                        this._options.offByTextPositionChange || c.E,
                        this._options.cardDismissed.pipe(l.h(null))
                      )
                      .pipe(
                        d.b(() => this._log.trace("Active state was overriden by text or geometry change")),
                        u.q(1),
                        p.O(e)
                      )
                  : a.of(null)
    ...
    57073: (e, t, n) => {
      ...
      if (1388 == n.j) var k = n(24209);
      if (1388 == n.j) var w = n(49708);
      if (1388 == n.j) var E = n(23063);
                ...
                if (e && t && (0, u._N)(e, this._options.textNode)) {
                  ...
                  return Array.from(e.keys()).reduce((n, i) => {
                    ...
                    if (o) {
                      const e =
                        o.rects &&
                        (null === o.meta.highlightDisplayFormat || d.jk.isInteractable(o.meta.highlightDisplayFormat)) &&
                        o.rects.find((e) => c.UL.contains(t, e));
                      if (e)
                        return {
                          annotation: o.meta.annotation,
                          activeHighlightId: o.meta.highlightId,
                          activeHighlightRect: e,
                          highlightIds: [],
                          highlightRects: []
                        };
                    }
      ...
      function S(e, t) {
        return k
          .T(
            ...
            e.scroll.changes.pipe(v.b(() => t.trace("Text field scroll has been changed"))),
            w.R(self, "scroll").pipe(v.b(() => t.trace("Window scroll detected")))
          )
          .pipe(E.q(1), g.h(null), y.B());
      }
    },
    75581: (e, t, n) => {
      ...
      !(function (e) {
        ...
        (function (e) {
          ...
          !(function (e) {
            (e.start = "start"),
              (e.error = "error"),
              (e.updateContextInfoFinished = "updateContextInfoFinished"),
              (e.docFinished = "docFinished"),
              (e.knowledgeHubItem = "knowledgeHubItem");
          })((t = e.Kind || (e.Kind = {}))),
            (e.isUpdateContextInfoFinished = function (e) {
              return e.kind === t.updateContextInfoFinished;
            }),
            (e.isDocFinished = function (e) {
              return e.kind === t.docFinished;
            }),
            (function (e) {
              let n;
              (e.isItem = function (e) {
                return e.kind === t.knowledgeHubItem;
              }),
                (function (e) {
                  (e.create = (e) => e), (e.toAlertId = (e) => e);
                })((n = e.ItemId || (e.ItemId = {})));
    ...
    83825: (e, t, n) => {
      ...
      n.d(t, { C: () => i, G: () => o }),
        (function (e) {
          (e[(e.reader = 0)] = "reader"), (e[(e.knowledgeHub = 1)] = "knowledgeHub");
        })(i || (i = {})),
        (function (e) {
          (e[(e.reader = 1)] = "reader"), (e[(e.knowledgeHub = 2)] = "knowledgeHub");
        })(o || (o = {}));
    },
    82730: (e, t, n) => {
      n.d(t, { o: () => i });
    ...
    92247: (e, t, n) => {
      ...
      const c = ({ isActive: e }) => i.createElement("div", { ...(0, a.Sh)(s().progressDot, e && s().active) }),
        l = ({ stepIndex: e, totalSteps: t }) =>
          i.createElement(
            "div",
            { className: s().progressDotsContainer },
        ...
        d = ({ title: e, skipText: t, nextText: n, index: a, totalSteps: r, onSkipClick: c, onNextClick: d }) =>
          i.createElement(
            ...
            i.createElement("h3", { className: s().newHeader }, e),
            i.createElement(
              "div",
              ...
              i.createElement(
                "div",
                null,
                t && i.createElement(o.C9, { className: s().buttonMinWidth, clickHandler: c }, t),
                i.createElement(o.KM, { className: s().buttonMinWidth, clickHandler: d }, n)
              )
            )
          );
    },
    ...
    16873: (e) => {
      e.exports = {
        onboarding: "PC2lY",
        onboardingHeader: "fPu0i",
        onboardingContent: "O05bt",
        onboardingClose: "p10W_",
        onboardingIcon: "sq8Cj",
        onboardingFooter: "Ni4ZE",
        rightButton: "FV7vq",
        onboardingFull: "r6LZG"
      };
    },
    92741: (e) => {
      e.exports = {
        onboardingDialog: "M0FuP",
        onboardingDialogAppear: "FuUvB",
        viewContainer: "GGHsa",
        view: "T1cLX",
        windows: "Q5aCh",
        footer: "SGgJv",
        hide: "DFF5s",
        onboardingDialogDisappear: "JylR4",
        content: "a446Q",
        centeredOnboardingDialogContentDisappear: "RuNwA",
        centeredOnboardingDialogContentAppear: "bN5F5",
        onboardingTour: "Bef6i",
        close: "Srmk5",
        video: "JpjOC"
      };
    },
    80608: (e) => {
      e.exports = { highlight: "BjZzK", dark: "JQczQ", background: "jnvl0", showBackground: "cvyYe", hovered: "_bFrN", icon: "AKcx4" };
    },
    87783: (e) => {
    ...
    20920: (e) => {
      e.exports = { section: "aZNNO", title: "yiNpC" };
    },
    48834: (e) => {
    ...
    20909: (e) => {
      e.exports = { popover: "Lkv8f" };
    },
    1889: (e) => {
      e.exports = { card: "dCBw3" };
    },
    17227: (e) => {
      e.exports = { notification: "eE27U", iconAndText: "L6eHW", icon: "Wf_bz", closeButton: "NWJTy" };
    },
    98679: (e) => {
      e.exports = { notificationsContainer: "sJ3W3" };
    },
    52102: (e) => {
    ...
    57112: (e) => {
      e.exports = { arrow: "zBsZn", arrowDark: "htSot", arrowLight: "QNmjC" };
    },
    17330: (e) => {
