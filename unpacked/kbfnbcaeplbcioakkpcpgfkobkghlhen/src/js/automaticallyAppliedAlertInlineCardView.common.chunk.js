  ...
  [3429],
  {
    43863: (e, t, n) => {
      ...
      const C = () =>
        ...
        M = (e) => l.createElement(a.u, { message: e.text, showDelay: 500 }, l.createElement("div", null, e.children)),
        Z = (e) => {
          const t = [
              ...(e.showDisableButtons
                ? [
                    l.createElement(
                      "div",
                      { className: s.listItem, key: "disableOnce" },
                      l.createElement(
                        i.M,
                        ...
                        l.createElement(
                          ...
                          l.createElement(
                            ...
                            l.createElement(
                              "svg",
                              { width: "16", height: "17", viewBox: "0 -1 16 16", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
                              l.createElement("path", {
                          ...
                          l.createElement("span", { className: s.caption }, "Turn off until next visit")
                        )
                      )
                    ),
                    l.createElement(
                      "div",
                      { className: s.listItem, key: "disableAlways" },
                      l.createElement(
                        i.M,
                        ...
                        l.createElement(
                          ...
                          l.createElement("span", { className: s.caption }, "Turn off forever")
                        )
                      )
                    )
                  ]
              ...
              const t =
                "" === e.originalText
                  ...
                  : l.createElement(
                      ...
                      null,
                      "Change back to ",
                      l.createElement("span", { className: s.originalText }, e.originalText)
                    );
              return l.createElement(
                "div",
                { className: s.buttonRow, key: "buttons" },
                l.createElement(
                  i.M,
                  { clickHandler: () => e.onAcceptClick() },
                  l.createElement("div", { ...(0, r.Sh)(s.button, s.acceptButton) }, "Looks good")
                ),
                l.createElement(
                  i.M,
                  { clickHandler: () => e.onRejectClick() },
                  l.createElement("div", { ...(0, r.Sh)(s.button, s.rejectButton) }, t)
                )
              );
            };
          return l.createElement(
                        ...
                        l.createElement(
                          i.M,
                          {
                            clickHandler: () => {
                              var t;
                              a.modify((e) => !e),
                                null === (t = e.onSettingsButtonClick) || void 0 === t || t.call(e, a.get() ? "open" : "close");
                            }
                          },
                          l.createElement(
                            "div",
                            { className: s.settingsButton },
                            l.createElement(M, { text: e.settingsTooltipText }, l.createElement(C, null))
                          )
                        )
                    ),
                      ...
                      a.view(
                        (e) =>
                          ...
                          l.createElement(
                            l.Fragment,
                            { key: "settings" },
                            l.createElement("div", { className: s.divider, key: "divider" }),
                            t
                          )
                      )
                  ),
