/******/ (() => {
  // webpackBootstrap
  /******/ "use strict";
  var __webpack_exports__ = {}; // CONCATENATED MODULE: ./src/bypass/content/public-api.ts
  ...
  function isAuthRequestEvent(event) {
    return event.detail && typeof event.detail.signature === "string" && typeof event.detail.timestamp === "number";
  }
  ...
  start(); // CONCATENATED MODULE: ./src/bypass/content/index.ts
