/******/ (() => {
  // webpackBootstrap
  /******/ "use strict";
  var __webpack_exports__ = {}; // CONCATENATED MODULE: ./src/core/api/front/api.port.ts
  ...
  /* harmony default export */ const front = front_api; // CONCATENATED MODULE: ./src/composer/content/composer.ts

  var composer_awaiter =
    (undefined && undefined.__awaiter) ||
    function (thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P
  ...
  function getBlockableElementOrAncestor(element) {
    return composer_awaiter(this, void 0, void 0, function* () {
      while (element && element !== document.documentElement && element !== document.body) {
        if (!(element instanceof HTMLElement) || element.localName === "area") {
          ...
          const { filters } = yield getFiltersForElement(element);
          if (filters.length > 0) {
            return element;
          }
  ...
  function addElementOverlay(element) {
    ...
    overlay.setAttribute("style", "opacity:0.4; display:inline-block !important; " + "overflow:hidden; box-sizing:border-box;");
  ...
  function mouseOver(event) {
    return composer_awaiter(this, void 0, void 0, function* () {
      ...
      const element = yield getBlockableElementOrAncestor(event.target);
  ...
  function startPickingElement() {
    ...
    Array.prototype.forEach.call(document.querySelectorAll("object,embed,iframe,frame"), (element) =>
      composer_awaiter(this, void 0, void 0, function* () {
        const { filters } = yield getFiltersForElement(element);
        if (filters.length > 0) {
  ...
  function previewBlockedElements(active) {
    return composer_awaiter(this, void 0, void 0, function* () {
      ...
      let selectors;
      if (active) {
        ({ selectors } = yield getFiltersForElement(element));
  ...
  function elementPicked(event) {
    return composer_awaiter(this, void 0, void 0, function* () {
      ...
      event.stopPropagation();
      const element = currentElement.prisoner || currentElement;
      const { filters, selectors } = yield getFiltersForElement(element);
      if (currentlyPickingElement) {
        stopPickingElement();
      }
  ...
  start(); // CONCATENATED MODULE: ./src/composer/content/index.ts
