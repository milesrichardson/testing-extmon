/******/ (() => {
  ...
  /******/ var __webpack_modules__ = {
    ...
    /***/ 382: /***/ (module, __webpack_exports__, __webpack_require__) => {
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__
        /* harmony export */
      });
    ...
    /***/ 904: /***/ (module, __webpack_exports__, __webpack_require__) => {
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__
        /* harmony export */
      });
      ...
      /* harmony import */ var _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_1_use_1_light_css__WEBPACK_IMPORTED_MODULE_3__ =
        __webpack_require__(545);
      /* harmony import */ var _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_1_use_1_io_circle_toggle_css__WEBPACK_IMPORTED_MODULE_4__ =
        __webpack_require__(382);
      /* harmony import */ var _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_1_use_1_io_popup_footer_css__WEBPACK_IMPORTED_MODULE_5__ =
      ...
      ___CSS_LOADER_EXPORT___.i(
        _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_1_use_1_light_css__WEBPACK_IMPORTED_MODULE_3__ /* ["default"] */.Z
      );
      ___CSS_LOADER_EXPORT___.i(
        _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_1_use_1_io_circle_toggle_css__WEBPACK_IMPORTED_MODULE_4__ /* ["default"] */.Z
      );
      ___CSS_LOADER_EXPORT___.i(
        _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_1_use_1_io_popup_footer_css__WEBPACK_IMPORTED_MODULE_5__ /* ["default"] */.Z
      );
      // Module
      ___CSS_LOADER_EXPORT___.push([
        module.id,
...
*/
  ...
  (() => {
    ...
    /* harmony default export */ const front = front_api; // CONCATENATED MODULE: ./js/common.mjs
    ...
    function setupBlock(tab) {
      ...
      browser.tabs
        ...
        .then((response) => {
          if (response && response.active) $("#page-info").classList.add("blocking");
        })
        .catch((err) => {
    ...
    /* harmony default export */ const block_element = setupBlock; // CONCATENATED MODULE: ./js/pages/popup/social-media-share.mjs
    ...
    const shareLinksContent = {
      facebook(blockedCount) {
        if (blockedCount < 1000) return "#AdblockPlus100";

        if (blockedCount < 10000) return "#AdblockPlus1000";

        if (blockedCount < 100000) return "#AdblockPlus10K";

        if (blockedCount < 1000000) return "#AdblockPlus100K";

        return "#AdblockPlus1M";
      },
      twitter(blockedCount) {
        return browser.i18n.getMessage("share_on_twitter_message", [blockedCount.toLocaleString()]);
      },
      weibo(blockedCount) {
        return browser.i18n.getMessage("share_on_weibo_message", [blockedCount.toLocaleString()]);
      }
    };
    ...
    function createShareLink(network, blockedCount) {
      ...
      for (const key in params) {
        ...
        if (value == messageMark) value = shareLinksContent[network](blockedCount);
    ...
    function whenPageReady(tab) {
      return new Promise((resolve) => {
        function onMessage(message, sender) {
          if (message.type == "composer.ready" && sender.page && sender.page.id == tab.id) {
    ...
    var popup = __webpack_require__(904); // CONCATENATED MODULE: ./css/pages/popup.css
    var options = {};
    ...
    /* harmony default export */ const pages_popup =
      popup /* default */.Z && popup /* default.locals */.Z.locals ? popup /* default.locals */.Z.locals : undefined; // CONCATENATED MODULE: ./node_modules/@ungap/weakmap/esm/index.js
 ...
 */
    ...
    /* harmony default export */ const io_element = IOElement; // CONCATENATED MODULE: ./js/io-circle-toggle.mjs
    ...
    /* harmony default export */ const io_circle_toggle = /* unused pure expression or super */ null && IOCircleToggle; // CONCATENATED MODULE: ./js/pages/popup/notifications.mjs
    ...
    front.notifications.get("popup").then((notification) => {
      if (notification) {
    ...
    <div class="${"content " + notification.type}">
      <div>
        ...
        function insertMessage(element, text, links) {
          ...
          if (tagName == "a" && links && links.length) newElement.href = links.shift();
  ...
  /></li>`;
    ...
    function setupShare() {
      ...
      firstFocusable.addEventListener("transitionend", () => {
        if (isExpanded() && document.activeElement === shareButton) firstFocusable.focus();
      });
      ...
      wrapper.addEventListener("transitionend", () => {
        ...
        if (!expanded && document.activeElement === cancelButton) shareButton.focus();
      });
