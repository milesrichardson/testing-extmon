/******/ (() => {
  ...
  /* harmony default export */ const front = front_api; // CONCATENATED MODULE: ./src/premium/content/activation.ts

  var activation_awaiter =
    (undefined && undefined.__awaiter) ||
    function (thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P
  ...
  function activation_onMessage(event) {
    return activation_awaiter(this, void 0, void 0, function* () {
      ...
      const { data } = event;
      if (data.version !== 1 || data.command !== "payment_success" || !data.userId) {
  ...
  start(); // CONCATENATED MODULE: ./src/premium/content/index.ts
