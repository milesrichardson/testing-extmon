...
*/
  ...
  (() => {
    ...
    var day1 = __webpack_require__(755); // CONCATENATED MODULE: ./css/pages/day1.css
    var options = {};
    ...
    /* harmony default export */ const pages_day1 =
      day1 /* default */.Z && day1 /* default.locals */.Z.locals ? day1 /* default.locals */.Z.locals : undefined; // CONCATENATED MODULE: ./js/landing.mjs
    ...
    initCopyrightNotice(); // CONCATENATED MODULE: ./js/pages/day1.mjs
    ...
    function initTitle() {
      front.stats.getBlockedTotal().then((blockedTotal) => {
        ...
        const message = browser.i18n.getMessage("day1_header_title", [blockedTotal]);
