/******/ (() => {
  ...
  connect();
  /* harmony default export */ const front_api = /* unused pure expression or super */ null && api_api; // CONCATENATED MODULE: ./src/core/api/front/index.ts

  /* harmony default export */ const front = /* unused pure expression or super */ null && api; // CONCATENATED MODULE: ./src/devtools/ui/devtools.ts

  var devtools_awaiter =
    (undefined && undefined.__awaiter) ||
    function (thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P
  ...
  void start().catch(console.error); // CONCATENATED MODULE: ./src/devtools/ui/index.ts
