/******/ (() => {
  ...
  /******/ var __webpack_modules__ = {
    ...
    /***/ 324: /***/ (module, __webpack_exports__, __webpack_require__) => {
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__
        /* harmony export */
      });
    ...
    /***/ 146: /***/ (module, __webpack_exports__, __webpack_require__) => {
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__
        /* harmony export */
      });
    ...
    /***/ 248: /***/ (module, __webpack_exports__, __webpack_require__) => {
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__
        /* harmony export */
      });
    ...
    /***/ 923: /***/ (module, __webpack_exports__, __webpack_require__) => {
      ...
      /* harmony import */ var _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_1_use_1_common_css__WEBPACK_IMPORTED_MODULE_3__ =
        __webpack_require__(546);
      /* harmony import */ var _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_1_use_1_light_css__WEBPACK_IMPORTED_MODULE_4__ =
        __webpack_require__(545);
      /* harmony import */ var _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_1_use_1_io_steps_css__WEBPACK_IMPORTED_MODULE_5__ =
        __webpack_require__(248);
      /* harmony import */ var _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_1_use_1_io_highlighter_css__WEBPACK_IMPORTED_MODULE_6__ =
        __webpack_require__(146);
      /* harmony import */ var _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_1_use_1_io_highlighter_fixes_css__WEBPACK_IMPORTED_MODULE_7__ =
      ...
      ___CSS_LOADER_EXPORT___.i(
        _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_1_use_1_common_css__WEBPACK_IMPORTED_MODULE_3__ /* ["default"] */.Z
      );
      ___CSS_LOADER_EXPORT___.i(
        _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_1_use_1_light_css__WEBPACK_IMPORTED_MODULE_4__ /* ["default"] */.Z
      );
      ___CSS_LOADER_EXPORT___.i(
        _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_1_use_1_io_steps_css__WEBPACK_IMPORTED_MODULE_5__ /* ["default"] */.Z
      );
      ___CSS_LOADER_EXPORT___.i(
        _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_1_use_1_io_highlighter_css__WEBPACK_IMPORTED_MODULE_6__ /* ["default"] */.Z
      );
      ___CSS_LOADER_EXPORT___.i(
        _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_1_use_1_io_highlighter_fixes_css__WEBPACK_IMPORTED_MODULE_7__ /* ["default"] */.Z
      );
      // Module
      ___CSS_LOADER_EXPORT___.push([
        module.id,
...
*/
  ...
  (() => {
    ...
    /* harmony default export */ const front = front_api; // CONCATENATED MODULE: ./js/pages/issue-reporter/report.mjs
      ...
      return browser.tabs
        ...
        .then((tab) => {
          ...
          browser.tabs.onUpdated.addListener((updatedTabId, changeInfo) => {
            if (updatedTabId == dataGatheringTabId && changeInfo.status == "complete") minimumTimeMet();
          });
    ...
    function closeRequestsCollectingTab() {
      if (!closedRequestsCollectingTab) closedRequestsCollectingTab = browser.tabs.remove(dataGatheringTabId);
      ...
      return front.subscriptions
        ...
        .then((subscriptions) => {
          ...
          for (const subscription of subscriptions) {
            ...
            if (subscription.version) subscriptionElement.setAttribute("version", subscription.version);
    ...
    function validateCommentsPage() {
      ...
      if (anonSubmissionField.checked) {
        ...
        if (emailElement.parentNode) emailElement.parentNode.removeChild(emailElement);
      } else {
        ...
        sendButton.disabled = value == "" || !emailField.validity.valid || !isMinimumTimeMet;
      }
 ...
 */
    ...
    /* harmony default export */ const io_element = IOElement; // CONCATENATED MODULE: ./js/io-steps.mjs
    ...
    IOSteps.define("io-steps"); // CONCATENATED MODULE: ./js/drawing-handler.mjs
    ...
    /* harmony default export */ const drawing_handler = DrawingHandler; // CONCATENATED MODULE: ./js/io-highlighter.mjs
    ...
    <div class="split">
      <div class="options">
        <button
          ...
          class="highlight"
          onclick="${(event) => {
            if (io_element.utils.event.isLeftClick(event)) changeMode(this, "highlight");
          }}"
        >
        ...
        <button
          ...
          class="hide"
          onclick="${(event) => {
            if (io_element.utils.event.isLeftClick(event)) changeMode(this, "hide");
          }}"
        >
      ...
      <canvas />
        ...
        if (!this.drawingHandler) this.drawingHandler = new drawing_handler($("canvas", this), parseInt(this.dataset.maxSize, 10) || 800);
      }
    ...
    // EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[1].use[1]!./css/pages/issue-reporter.css
    var issue_reporter = __webpack_require__(923); // CONCATENATED MODULE: ./css/pages/issue-reporter.css
    var options = {};
    ...
    /* harmony default export */ const pages_issue_reporter =
      issue_reporter /* default */.Z && issue_reporter /* default.locals */.Z.locals
        ? issue_reporter /* default.locals */.Z.locals
        : undefined; // CONCATENATED MODULE: ./js/pages/issue-reporter/index.mjs
    ...
    document.addEventListener("DOMContentLoaded", () => {
      ...
      const manageSteps = browser.tabs.captureVisibleTab(null, { format: "png" }).then((screenshot) => {
    ...
    function reportWithScreenshot(xmlReport, stepsData) {
      ...
      const element = $("screenshot", xmlReport.documentElement) || xmlReport.createElement("screenshot");
    ...
    function sendReport(reportData) {
      ...
      const reportSent = (event) => {
        ...
        try {
          ...
          if (request.status != 0) errorMessage = request.status + " " + request.statusText;
        } catch (e) {
        ...
        if (!success) {
          ...
          while (errorElement.firstChild) errorElement.removeChild(errorElement.firstChild);
