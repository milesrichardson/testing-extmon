/******/ (() => {
  ...
  /* harmony default export */ const front = /* unused pure expression or super */ null && api; // CONCATENATED MODULE: ./src/options/ui/options.ts
  ...
  void start().catch(console.error); // CONCATENATED MODULE: ./src/options/ui/index.ts
