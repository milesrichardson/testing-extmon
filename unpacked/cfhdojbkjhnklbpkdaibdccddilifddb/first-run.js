/******/ (() => {
  ...
  /******/ var __webpack_modules__ = {
    ...
    /***/ 520: /***/ (module, __webpack_exports__, __webpack_require__) => {
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__
        /* harmony export */
      });
...
*/
  ...
  (() => {
    ...
    // EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[1].use[1]!./css/pages/first-run.css
    var first_run = __webpack_require__(520); // CONCATENATED MODULE: ./css/pages/first-run.css
    var options = {};
    ...
    /* harmony default export */ const pages_first_run =
      first_run /* default */.Z && first_run /* default.locals */.Z.locals ? first_run /* default.locals */.Z.locals : undefined; // CONCATENATED MODULE: ./js/pages/first-run.mjs
    ...
    function initLinks() {
      Promise.all([front.doclinks.get("acceptable_ads_criteria"), front.doclinks.get("acceptable_ads_opt_out")]).then(
        ([urlCriteria, urlOptOut]) => {
    ...
    function initWarnings() {
      front.subscriptions.getInitIssues().then((issues) => {
