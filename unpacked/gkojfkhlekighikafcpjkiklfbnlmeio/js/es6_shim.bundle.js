      ...
      (function () {
        ...
        !((__WEBPACK_AMD_DEFINE_RESULT__ = function () {
          ...
          function add_prop(obj, prop, fn) {
            if (obj[prop]) return;
            Object.defineProperty(obj, prop, { enumerable: false, writable: true, configurable: true, value: fn });
          }
          ...
          E.t.object_values = function (obj) {
            ...
            var res = [];
            for (var prop in obj) {
              if (obj.hasOwnProperty(prop)) res.push(obj[prop]);
            }
            return res;
          };
          ...
          E.t.object_entries = function (obj) {
            ...
            var res = [];
            for (var prop in obj) {
              if (obj.hasOwnProperty(prop)) res.push([prop, obj[prop]]);
            }
            return res;
          };
          ...
          E.t.object_setPrototypeOf = function (obj, proto) {
            if (can_set_proto) obj.__proto__ = proto;
            else {
          ...
          E.t.array_find = function (fn, this_arg) {
            ...
            for (var i = 0; i < a.length; i++) {
              value = a[i];
              if (i in a && fn.call(this_arg, value, i, a)) return value;
            }
          };
          ...
          E.t.array_findIndex = function (fn, this_arg) {
            ...
            for (var i = 0; i < a.length; i++) {
              value = a[i];
              if (i in a && fn.call(this_arg, value, i, a)) return i;
            }
            return -1;
          };
          add_prop(Array.prototype, "findIndex", E.t.array_findIndex);
          E.t.array_of = function () {
          ...
          if (typeof ArrayBuffer != "undefined") add_prop(ArrayBuffer.prototype, "slice", E.t.arraybuffer_slice);
          add_prop(Number, "EPSILON", Math.pow(2, -52));
          E.t.number_isFinite = function (x) {
          ...
          function ie9_console() {
            ...
            if (window.console) {
              if (!window.console.debug) window.console.debug = window.console.info;
              return;
            }
            ...
            ["memory"].forEach(function (p) {
              console[p] = {};
            });
          }
          ie9_console();
          function ie9_location_origin() {
            if (typeof window != "object" || !window.location || "origin" in window.location) {
              return;
            }
            var location = window.location;
            var default_ports = { "http:": 80, "https:": 443 };
            var port = location.port;
            if (default_ports[location.protocol] == port) port = null;
            location.origin = location.protocol + "//" + location.hostname + (port ? ":" + port : "");
          }
          ie9_location_origin();
          function element_matches() {
            if ((typeof Element != "object" && typeof Element != "function") || Element.prototype.matches) {
              return;
            }
          ...
          function ie_edge_closest() {
            if ((typeof Element != "object" && typeof Element != "function") || Element.prototype.closest) {
              return;
            }
          ...
          function ie_function_name() {
            if (ie_function_name.name == "ie_function_name") return;
            Object.defineProperty(Function.prototype, "name", { enumerable: false, configurable: false, get: E.t.function_name });
          }
          ie_function_name();
          function android18_animFrame() {
            if (typeof window != "object" || window.requestAnimationFrame) return;
            var start = Date.now();
