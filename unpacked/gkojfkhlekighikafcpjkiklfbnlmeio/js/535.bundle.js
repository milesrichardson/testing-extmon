...
(self["webpackChunk"] = self["webpackChunk"] || []).push([
  [535, 932],
  {
    ...
    2535: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      __webpack_require__.r(__webpack_exports__);
      __webpack_require__.d(__webpack_exports__, { init: () => init });
      var classnames__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(793);
      ...
      var conf__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9641);
      ...
      var _util_util_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(1291);
      var _util_util_js__WEBPACK_IMPORTED_MODULE_5___default = __webpack_require__.n(_util_util_js__WEBPACK_IMPORTED_MODULE_5__);
      ...
      var _bext_vpn_ui_ui_lib_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(2075);
      var _bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(6357);
      ...
      var _bext_vpn_ui_page_lib_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(726);
      // LICENSE_CODE ZON
      function _extends() {
      ...
      const useState = react__WEBPACK_IMPORTED_MODULE_1___default().useState,
        useEffect = react__WEBPACK_IMPORTED_MODULE_1___default().useEffect;
      const T = _bext_vpn_ui_ui_lib_js__WEBPACK_IMPORTED_MODULE_8__.Z.T,
        Mitm_btn = _bext_vpn_ui_ui_lib_js__WEBPACK_IMPORTED_MODULE_8__.Z.Mitm_btn;
      const perr = (id, info) => _bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_9__.Z.perr(id, info, {}, true);
      ...
      const Report_problem = () =>
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement(
          ...
          react__WEBPACK_IMPORTED_MODULE_1___default().createElement(
            ...
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement(T, null, "Report a problem")
          )
        );
      const Mitm = () => {
        const _useState = useState(""),
          _useState2 = _slicedToArray(_useState, 2),
          root_url = _useState2[0],
          set_root_url = _useState2[1];
        const _useState3 = useState(),
          _useState4 = _slicedToArray(_useState3, 2),
          tab_id = _useState4[0],
          set_tab_id = _useState4[1];
        const _useState5 = useState("us"),
          _useState6 = _slicedToArray(_useState5, 2),
          country = _useState6[0],
          set_country = _useState6[1];
        useEffect(() => {
          let qs = _util_url_js__WEBPACK_IMPORTED_MODULE_6___default().qs_parse(window.location.search.replace(/^\?/, ""));
          set_root_url(qs.root_url);
          if (!+qs.tab_id) {
            perr("mitm_ui_missing_tab_id");
            window.close();
          }
          set_tab_id(+qs.tab_id);
          if (qs.country) set_country(qs.country);
        }, []);
        const get_user_info = () => ({
          user: _bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_9__.Z.get_user(),
          is_plus: _bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_9__.Z.get_is_premium()
        });
        ...
        useEffect(() => {
          ...
          const beforeunload = () => ignore();
          _bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_9__.Z.on("user_changed", update_user);
          window.addEventListener("beforeunload", beforeunload);
          return () => {
            _bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_9__.Z.off("user_changed", update_user);
        ...
        const approve = () =>
          _util_etask_js__WEBPACK_IMPORTED_MODULE_7___default()(function* () {
            ...
            yield _bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_9__.Z.mitm_set_unblock(root_url, tab_id);
            if (yield _bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_9__.Z.need_trial(root_url)) {
              let next_trial_ts = yield _bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_9__.Z.get_next_trial_ts(root_url);
              if (!next_trial_ts || next_trial_ts < _bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_9__.Z.now())
                yield _bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_9__.Z.start_trial(root_url);
            }
            yield _bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_9__.Z.unblock_action({
              country,
              src: "mitm",
              url: _bext_vpn_util_util_js__WEBPACK_IMPORTED_MODULE_10___default().root2url(root_url),
              mitm: true
            });
            yield _bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_9__.Z.reload_tab(tab_id);
            yield _bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_9__.Z.focus_on_tab(tab_id);
            window.close();
          });
        const ignore = () =>
          _util_etask_js__WEBPACK_IMPORTED_MODULE_7___default()(function* () {
            perr("mitm_manual_ignore");
            yield _bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_9__.Z.mitm_set_ignore(root_url, tab_id);
            yield _bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_9__.Z.focus_on_tab(tab_id);
            window.close();
          });
        const title = react__WEBPACK_IMPORTED_MODULE_1___default().createElement(
          "span",
          null,
          react__WEBPACK_IMPORTED_MODULE_1___default().createElement("b", null, root_url),
          " ",
          T("is blocked in your country or office")
        );
        const buttons = [
          react__WEBPACK_IMPORTED_MODULE_1___default().createElement(Mitm_btn, { root_url, enable: false, on_click: ignore, key: "no" }),
          react__WEBPACK_IMPORTED_MODULE_1___default().createElement(Mitm_btn, { root_url, enable: true, on_click: approve, key: "yes" })
        ];
        return react__WEBPACK_IMPORTED_MODULE_1___default().createElement(
          _bext_vpn_ui_page_lib_js__WEBPACK_IMPORTED_MODULE_11__.f6,
          _extends({}, user_info, { cls: "mitm" }),
          react__WEBPACK_IMPORTED_MODULE_1___default().createElement(Report_problem, null),
          react__WEBPACK_IMPORTED_MODULE_1___default().createElement(
            _bext_vpn_ui_page_lib_js__WEBPACK_IMPORTED_MODULE_11__.$0,
            { title, cls: "mitm-section" },
            buttons
          ),
          ";"
        );
      ...
      const init = () =>
        _util_etask_js__WEBPACK_IMPORTED_MODULE_7___default()(function* () {
          yield (0, _bext_vpn_ui_page_lib_js__WEBPACK_IMPORTED_MODULE_11__.VV)();
          let root = react_dom__WEBPACK_IMPORTED_MODULE_2___default().createRoot(document.querySelector(".react-root"));
          root.render(react__WEBPACK_IMPORTED_MODULE_1___default().createElement(Mitm, null));
        });
    },
    726: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      __webpack_require__.d(__webpack_exports__, { $0: () => Section, VV: () => init_api, f6: () => Page_layout });
      ...
      const Label_line = (props) =>
        React.createElement(
          ...
          props.label && React.createElement("div", { className: "label-line-label" }, props.label),
          React.createElement("div", { className: "label-line-children" }, props.children)
        );
      const Modal = ({ action, title, on_close, children, className }) =>
        ReactDOM.createPortal(
          React.createElement(
            ...
            React.createElement(
              "div",
              { className: classnames("page-modal", className) },
              React.createElement(
                "div",
                ...
                React.createElement(
                  ...
                  React.createElement("div", { className: "icon-remove", title: T("Close"), onClick: on_close })
                ),
                React.createElement("div", { className: "page-modal-content" }, children),
                action && React.createElement("div", { className: "page-modal-actions" }, action)
              )
            )
          ),
          document.body
      ...
      const Legal_section = (props) =>
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement("a", { href: ui_api.hola_url() + "/legal/privacy" }, "https://", www_host, "/legal/privacy")
          ),
          React.createElement(
            Label_line,
            { label: T("End User License") },
            React.createElement("a", { href: ui_api.hola_url() + "/legal/sla" }, "https://", www_host, "/legal/sla")
          ),
          props.children
        );
