...
(self["webpackChunk"] = self["webpackChunk"] || []).push([
  [331],
  {
    6331: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      var _bext_vpn_ui_page_lib_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(726);
      var _bext_vpn_ui_ui_lib_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2075);
      ...
      var _bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(6357);
      // LICENSE_CODE ZON
      function _extends() {
      ...
      const T = _bext_vpn_ui_ui_lib_js__WEBPACK_IMPORTED_MODULE_3__.Z.T;
      const REPORT_HASH = "#report_issue";
      const Report_problem = () => {
        const _useState = useState(false),
          _useState2 = _slicedToArray(_useState, 2),
          modal = _useState2[0],
          set_modal = _useState2[1];
        const _useState3 = useState(""),
          _useState4 = _slicedToArray(_useState3, 2),
          url = _useState4[0],
          set_url = _useState4[1];
        const _useState5 = useState(""),
          _useState6 = _slicedToArray(_useState5, 2),
          subj = _useState6[0],
          set_subj = _useState6[1];
        useEffect(() => {
          const on_hash_change = () => set_modal(window.location.hash == REPORT_HASH);
          window.addEventListener("hashchange", on_hash_change, false);
          on_hash_change();
          let qs = _util_url_js__WEBPACK_IMPORTED_MODULE_4___default().qs_parse(window.location.search.replace(/^\?/, ""));
          set_url(qs.url);
          set_subj(qs.subj);
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
          ...
          react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
            "a",
            { className: "title", href: "#report_issue" },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(T, null, "Report a problem")
          ),
          modal &&
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_bext_vpn_ui_page_lib_js__WEBPACK_IMPORTED_MODULE_2__.zv, {
              url,
              init_subj: subj,
              close_cb: hide_modal
            })
      ...
      let dev_mode_counter = 0,
        dev_mode_first_ts = 0;
      const About_details = () => {
        const _useState7 = useState(_bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_6__.Z.get_dev_mode()),
          _useState8 = _slicedToArray(_useState7, 2),
          dev_mode = _useState8[0],
          set_dev_mode = _useState8[1];
        const info = _bext_vpn_ui_ui_lib_js__WEBPACK_IMPORTED_MODULE_3__.Z.use_etask(
          () => _bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_6__.Z.get_product_info(),
          []
        );
        useEffect(() => {
          const update = () => set_dev_mode(_bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_6__.Z.get_dev_mode());
          _bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_6__.Z.on("dev_mode_changed", update);
          return () => _bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_6__.Z.off("dev_mode_changed", update);
        }, []);
        const on_title_click = () => {
          let now = Date.now();
          if (!dev_mode_first_ts || now - dev_mode_first_ts > 5e3) {
            dev_mode_first_ts = now;
            dev_mode_counter = 0;
          }
          dev_mode_counter++;
          if (dev_mode_counter != 5) return;
          dev_mode_counter = 0;
          dev_mode_first_ts = 0;
          _bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_6__.Z.set_dev_mode(!dev_mode);
        };
        const send_email = (e) => {
          _bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_6__.Z.perr(
            "be_report_problem",
            { email: 1 },
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
          _bext_vpn_ui_page_lib_js__WEBPACK_IMPORTED_MODULE_2__.$0,
          { title: T("About Hola") + s, on_click: on_title_click },
          info.map((line) =>
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
              _bext_vpn_ui_page_lib_js__WEBPACK_IMPORTED_MODULE_2__.PH,
              { key: line.name, label: T(line.name) + ":" },
              line.value
            )
          ),
          react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
            ...
            null,
            "Send email to ",
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_bext_vpn_ui_ui_lib_js__WEBPACK_IMPORTED_MODULE_3__.Z.Link_mailto, {
              on_click: send_email
            })
          )
        );
      ...
      const About_layout = () => {
        const get_user_info = () => ({
          user: _bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_6__.Z.get_user(),
          is_plus: _bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_6__.Z.get_is_premium()
        });
        const _useState9 = useState(get_user_info()),
          _useState10 = _slicedToArray(_useState9, 2),
          user_info = _useState10[0],
          set_user_info = _useState10[1];
        useEffect(() => {
          const update = () => set_user_info(get_user_info());
          _bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_6__.Z.on("user_changed", update);
          return () => _bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_6__.Z.off("user_changed", update);
        }, []);
        return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
          _bext_vpn_ui_page_lib_js__WEBPACK_IMPORTED_MODULE_2__.f6,
          _extends({}, user_info, { title: T("About"), cls: "about" }),
          react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Report_problem, null),
          react__WEBPACK_IMPORTED_MODULE_0___default().createElement(About_details, null),
          react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_bext_vpn_ui_page_lib_js__WEBPACK_IMPORTED_MODULE_2__.St, null)
        );
      };
      const init = () =>
        _util_etask_js__WEBPACK_IMPORTED_MODULE_5___default()(function* () {
          yield (0, _bext_vpn_ui_page_lib_js__WEBPACK_IMPORTED_MODULE_2__.VV)();
          let root = react_dom__WEBPACK_IMPORTED_MODULE_1___default().createRoot(document.querySelector(".react-root"));
          root.render(react__WEBPACK_IMPORTED_MODULE_0___default().createElement(About_layout, null));
        });
    },
    726: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      const Report_problem_modal = ({ url, init_subj, close_cb }) => {
        useEffect(
          () =>
            void _bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_7__.Z.perr(
              "be_report_problem",
              { perr: 1 },
              { with_log: true, rate_limit: { count: 1 } }
            ),
        ...
        const _useState3 = useState(() =>
            _util_util_js__WEBPACK_IMPORTED_MODULE_4___default().get(
              _bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_7__.Z.get_user(),
              "emails.0.value",
              ""
            )
          ),
        ...
        const verify_email = () => set_valid_email(_util_url_js__WEBPACK_IMPORTED_MODULE_3___default().is_valid_email(email));
        const on_change = (setter) => (ev) => setter(ev.target.value);
        const send_click = () => {
          if (!can_submit) return void set_error("Please fill all fields");
          _bext_vpn_ui_ui_api_js__WEBPACK_IMPORTED_MODULE_7__.Z.send_issue_report({ email, subj, desc, url });
          close_cb();
        };
        const send_report = react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
          Btn,
          { disabled: !can_submit, arrow: true, onClick: send_click },
          react__WEBPACK_IMPORTED_MODULE_0___default().createElement(T, null, "Send")
        );
        return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
          Modal,
          ...
          react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
            "div",
            { className: classnames__WEBPACK_IMPORTED_MODULE_2___default()("form-group", { "has-error": !valid_email }) },
            ...
            !valid_email &&
              react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
                ...
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img", { src: "./bext/vpn/ui/img/icon_warning.svg" }),
                " ",
...
//# sourceMappingURL=https://hola.org/be_source_map/1.216.954/331.bundle.js.map?build=nopeer_v2
