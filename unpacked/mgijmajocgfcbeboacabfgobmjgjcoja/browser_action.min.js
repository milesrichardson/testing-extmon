...
*/
    ...
    r = function () {
      ...
      if ((a = e.value.replace(/^\s+|\s+$/g, "")))
        (g.textContent = "Searching..."),
          ...
          (d.disabled = !0),
          c++,
          chrome.runtime.sendMessage({ type: "fetch_html", eventKey: c, query: a }, q);
    },
    q = function (a) {
      if (a.eventKey === c) {
        if (a.html) {
          ...
          (g.textContent = "No definition found."),
            (f.style.display = "block"),
            (h.href = "https://www.google.com/search?q=" + a.sanitizedQuery),
            (h.innerHTML = 'Search the web for "' + a.sanitizedQuery + '" &raquo;'),
  ...
  chrome.tabs.query({ active: !0, currentWindow: !0 }, function (a) {
    a.length &&
      ...
      chrome.tabs.sendMessage(a[0].id, { type: "get_selection" }, function (b) {
