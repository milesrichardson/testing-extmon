/* Copyright 2011 Google Inc. All Rights Reserved. */ (function () {
  ...
  var w =
      "\" ' ( ) , - . / 0 1 2 : ? a about and are as be but com for from have i in is it like may more my next not of on search that the this to was when with you your".split(
        " "
      ),
    x = !1,
    y = {},
    ...
    G = function (a) {
      for (var b = 0, c = w.length; b < c; b++) if (a === w[b]) return !0;
      return !1;
    },
    H = function (a, b, c) {
      "initialize" === a.type && c({ instanceId: A++ });
    },
    I = function (a) {
      "openOptionsPage" === a.type && chrome.tabs.create({ url: chrome.runtime.getURL("options.html") });
    },
    J = function (a, b, c) {
      "options" === a.type && c({ options: y });
    },
    N = function (a, b, c) {
      if ("fetch_raw" !== a.type && "fetch_html" !== a.type) return !1;
      _gaq && _gaq.push(["_trackEvent", "lookup", a.type]);
      -1 !== B && C !== a.instanceId && chrome.tabs.sendMessage(B, { type: "hide", instanceId: C });
        ...
        f = function () {
          ...
          chrome.tabs.getSelected(null, function (m) {
            ...
            chrome.tabs.detectLanguage(m.id, function (k) {
              e.tabLangTranReqTimedOut ||
                (window.clearTimeout(h),
                "und" !== k
                  ? ((e.tabLang = "he" === k ? "iw" : k),
                    M(d, e.tabLang, function (n) {
                      e.tabLangTranRes = n;
                      L(e);
                    }))
                  : L(e));
      ...
      if (x) f();
        ...
        var g = function (e) {
          if (x) return f();
          if (10 < e) return c({ eventKey: a.eventKey, sanitizedQuery: d });
    ...
    K = function (a, b, c) {
      ...
      f || (f = b);
      a = { path: "v1/dictionaryExtensionData", params: { term: a, language: d, corpus: f } };
      ...
      gapi.client.request(a).execute(function (g) {
        ...
        if (e && 200 != e) c(null);
          ...
          var m = function (h) {
            ...
            h = h.senseFamilies;
            for (var k = h.length, n = 0; n < h.length; n++) h[n].senses && (k += 0.1 * h[n].senses.length);
            return k;
          };
          e = function (h, k) {
            return m(k) - m(h);
    ...
    M = function (a, b, c) {
      a =
        "https://clients5.google.com/translate_a/single?dj=1&dt=t&dt=sp&dt=ld&dt=bd&client=dict-chrome-ex&sl=" +
        b +
        "&tl=" +
        y.language +
        "&q=" +
    ...
    L = function (a) {
      ...
      if (4 === a.numResponses) {
        ...
        e && c && c.audio && "en" === h.srcLang.toLowerCase() && (h.audio = c.audio);
        ...
        d = R(d);
        if ("fetch_html" === a.request.type)
          (b = ""),
            (b = e ? S(m, h.audio, c) : T(a.dictRes, d)),
            (e = { eventKey: a.request.eventKey, sanitizedQuery: a.sanitizedQuery, html: b });
        else {
          var k = null,
            n = null;
          ...
          k &&
            "true" === y.storeHistory &&
            !a.incognito &&
            chrome.storage.local.get("word-history", function (F) {
          ...
          e = !1;
          (("true" === y.popupDblclick && "none" === y.popupDblclickKey) || ("true" === y.popupSelect && "none" === y.popupSelectKey)) &&
            G(a.sanitizedQuery) &&
            (e = !0);
          e = { eventKey: a.request.eventKey, sanitizedQuery: a.sanitizedQuery, meaningObj: k, showOptionsTip: e };
        }
        a.callback(e);
      }
    },
    ...
    Q = function (a, b) {
      if (!a || !a.sentences || 0 === a.sentences.length || a.sentences[0].orig.toLowerCase() == a.sentences[0].trans.toLowerCase())
        return null;
      ...
      return { type: "translation", meaningText: c, attribution: "Translated from " + d, srcLang: a.src };
    },
    O = function (a, b) {
      b = b.split(".");
    ...
    P = function (a) {
      ...
      !c &&
        (b = O(a, "webDefinitions[0]")) &&
        ((c = b.sourceUrl), (c = { meaningText: b.definition, attribution: '<a href="' + c + '">' + c + "</a>", type: "webDef" }));
      if (!c) return null;
      b = c.meaningText;
    ...
    Y = function () {
      ...
      chrome.storage.local.get("word-history", function (c) {
        c["word-history"] || chrome.storage.local.set({ "word-history": {} });
      });
