/* Copyright 2011 Google Inc. All Rights Reserved. */ (function () {
  var e,
    ...
    y = function () {
      u(
        chrome.runtime.getURL("content.min.css"),
        function (a) {
          var b = function (c) {
            this.P = c.instanceId;
            this.O = a;
            ...
            this.J = this.l.attachShadow({ mode: "open" });
          ...
          chrome.runtime.sendMessage({ type: "initialize" }, b);
        }.bind(this)
      );
    },
    x = function (a) {
      ...
      a.i.querySelector("a").onclick = function () {
        chrome.runtime.sendMessage({ type: "openOptionsPage" }, function () {});
        return !1;
      };
      var b = function (c) {
        c.preventDefault();
    ...
    w = function (a, b) {
      ...
      c.id = "gdx-arrow-main";
      "up" === b
        ? ((d.id = "gdx-bubble-arrow-inner-up"), (a.id = "gdx-bubble-arrow-outer-up"))
        : ((d.id = "gdx-bubble-arrow-inner-down"), (a.id = "gdx-bubble-arrow-outer-down"));
      c.appendChild(d);
      c.appendChild(a);
      return c;
    },
  ...
  y.prototype.S = function (a) {
    if (a.eventKey === this.C) {
      ...
      if (a.meaningObj) {
        ...
        b.attribution &&
          ("translation" === b.type
            ? ((this.D.innerHTML = b.attribution), (this.B.className = "display-none"), (this.D.className = ""))
            : ((this.K.innerHTML = b.attribution),
  ...
  var F = function (a, b) {
      b === a.C &&
        ((a.u.textContent = "Dictionary is disabled for https pages."),
  ...
  var H = function (a, b) {
      return (
        "none" === b ||
        ("alt" === b && a.altKey) ||
        ("ctrl" === b && (-1 !== window.navigator.platform.toLowerCase().indexOf("mac") ? a.metaKey : a.ctrlKey)) ||
        ("shift" === b && a.shiftKey)
      );
    },
    I = function (a, b) {
      for (b = b.target; b; b = b.parentNode) if (b === a.l) return !0;
      return !1;
    },
    K = function (a, b, c, d) {
      if ("mouseup" === c) var g = "true" === d.popupSelect && H(b, d.popupSelectKey);
        ...
        "dblclick" === c
          ? (g = "true" === d.popupSelect && H(b, d.popupSelectKey) ? !1 : "true" === d.popupDblclick && H(b, d.popupDblclickKey))
          : (console.warn("Unexpected eventType: " + c), (g = !1));
      if (g) {
        g = 0;
        for (var f = J.length; g < f; g++) if (location.href.match(J[g])) return;
        if (!t(b.target)) {
          g = null;
          f = "";
          ...
          if (!(!f || (1 === f.length && 127 >= f.charCodeAt(0) && !f.match(v)) || ("dblclick" === c && -1 !== f.indexOf(" ")))) {
            ...
            var n = a.C;
            I(a, b) || G(a, g);
            "false" === d.enableHttps && 0 === location.href.lastIndexOf("https", 0)
              ? F(a, n)
              : (window.setTimeout(
                  function () {
                    n === this.C &&
                      ((this.u.textContent = "Searching..."),
                      (this.j.className = "display-none"),
                      (this.i.className = "display-none"),
                ...
                chrome.runtime.sendMessage({ type: "fetch_raw", eventKey: n, instanceId: a.P, query: f }, a.S.bind(a)));
          }
        }
      }
    };
  y.prototype.V = function (a) {
    ...
    chrome.runtime.sendMessage({ type: "options" }, b);
  };
