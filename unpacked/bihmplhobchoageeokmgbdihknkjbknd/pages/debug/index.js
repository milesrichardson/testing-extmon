!(function (e) {
  ...
  17: function (e, t, n) {
    ...
    function Mt(e, t) {
      for (var n = 0; n < e.length; n += 2) {
        var r = e[n],
          l = e[n + 1];
        (l = "on" + (l[0].toUpperCase() + l.slice(1))), zt.set(r, t), Lt.set(r, l), s(l, [r]);
      }
    }
    (0, a.unstable_now)();
    var Rt = 8;
    ...
    var Pn = on(
      ...
      On = on(
        l({}, pn, { touches: 0, targetTouches: 0, changedTouches: 0, altKey: 0, metaKey: 0, ctrlKey: 0, shiftKey: 0, getModifierState: _n })
      ),
    ...
    function Wn(e, t, n, r) {
      Te(r), 0 < (t = zr(t, "onChange")).length && ((n = new dn("onChange", "change", null, n, r)), e.push({ event: n, listeners: t }));
    }
    var Hn = null,
      Qn = null;
    function qn(e) {
        ...
        if (0 == (7 & t)) {
          if (
            ...
            if (
              ...
              (i.relatedTarget = p),
              (m = null),
              Xr(l) === r && (((c = new c(d, h + "enter", s, n, l)).target = p), (c.relatedTarget = f), (m = c)),
              (f = m),
              u && s)
            )
              e: {
          ...
          switch (
            ...
            case "focusin":
              ($n(v) || "true" === v.contentEditable) && ((hr = v), (mr = r), (gr = null));
              break;
            case "focusout":
              gr = mr = hr = null;
              break;
          ...
          b &&
            ...
            (y = Rn
              ...
              : (function (e, t) {
                  if (Vn) return "compositionend" === e || (!jn && Un(e, t)) ? ((e = nn()), (tn = en = Zt = null), (Vn = !1), e) : null;
                  switch (e) {
                    case "paste":
                      return null;
                    case "keypress":
    ...
    function Mr(e, t, n, r, l) {
      for (var a = t._reactName, o = []; null !== n && n !== r; ) {
        ...
        5 === i.tag &&
          null !== s &&
          ((i = s), l ? null != (u = Ue(n, a)) && o.unshift(Lr(n, u, i)) : l || (null != (u = Ue(n, a)) && o.push(Lr(n, u, i)))),
          (n = n.return);
      }
    ...
    function Wl() {
      if (!Fl && null !== Ml) {
        ...
        try {
          ...
          throw (null !== Ml && (Ml = Ml.slice(e + 1)), kl(Pl, $l), t);
        } finally {
          Fl = !1;
        }
      }
    ...
    function wa(e) {
      ...
      function d(e, t, n) {
        ...
        if ("object" == typeof t && null !== t) {
          ...
          if (va(t) || B(t)) return ((t = Vu(t, e.mode, n, null)).return = e), t;
          ba(e, t);
        }
        return null;
      }
    ...
    function Ua(e) {
      if (Fa) {
        ...
        if (t) {
          var n = t;
          if (!Da(e, t)) {
            if (!(t = $r(n.nextSibling)) || !Da(e, t)) return (e.flags = (-1025 & e.flags) | 2), (Fa = !1), void (Ma = e);
            Ia(Ma, n);
          }
    ...
    function Va(e) {
      ...
      var t = e.type;
      if (5 !== e.tag || ("head" !== t && "body" !== t && !Ur(t, e.memoizedProps))) for (t = Ra; t; ) Ia(e, t), (t = $r(t.nextSibling));
      if ((Aa(e), 13 === e.tag)) {
    ...
    function to(e, t, n, r, l, a) {
      if (
        ...
        do {
          ...
          (a += 1), (Ga = Ya = null), (t.updateQueue = null), (Ha.current = To), (e = n(r, l));
        } while (Ja);
      }
      if (((Ha.current = Po), (t = null !== Ya && null !== Ya.next), (qa = 0), (Ga = Ya = Ka = null), (Xa = !1), t)) throw Error(o(300));
      return e;
    }
    function no() {
      ...
      if (null !== l) {
        ...
        do {
          ...
          if ((qa & c) === c)
            ...
            null === u ? ((i = u = f), (a = r)) : (u = u.next = f), (Ka.lanes |= c), (Mi |= c);
          }
          s = s.next;
        } while (null !== s && s !== l);
        null === u ? (a = r) : (u.next = i),
    ...
    function Ro(e, t, n, r, l, a) {
      if (null === e) {
        var o = n.type;
        return "function" != typeof o || Du(o) || void 0 !== o.defaultProps || null !== n.compare || void 0 !== n.defaultProps
    ...
    function Vo(e, t, n, r, l, a) {
      ...
      return (
        (t.flags |= 1),
        null !== e && o ? ((t.child = ka(t, e.child, null, a)), (t.child = ka(t, null, i, a))) : jo(e, t, i, a),
    ...
    function Go(e, t, n, r, l) {
      ...
      return (
        0 == (2 & a) && t.child !== o
          ...
          : (n = Uu(o, i)),
        null !== e ? (r = Uu(e, r)) : ((r = Vu(r, a, l, null)).flags |= 2),
        (r.return = t),
        (n.return = t),
        (n.sibling = r),
        (t.child = n),
    ...
    function Zo(e, t, n) {
      var r = t.pendingProps,
        l = r.revealOrder,
        a = r.tail;
      if ((jo(e, t, r.children, n), 0 != (2 & (r = za.current)))) (r = (1 & r) | 2), (t.flags |= 64);
      else {
                ...
                if (c.hasOwnProperty(i)) {
                  ...
                  "style" === i
                    ...
                    : "suppressContentEditableWarning" !== i &&
                      ...
                      "autoFocus" !== i &&
                      (u.hasOwnProperty(i) ? null != f && "onScroll" === i && Cr("scroll", e) : null != f && w(e, i, f, s));
                }
              switch (n) {
                case "input":
                  G(e), re(e, r, !1);
              ...
              : ((r = null !== r),
                ...
                r &&
                  ...
                  ((null === e && !0 !== t.memoizedProps.unstable_avoidThisFallback) || 0 != (1 & za.current)
                    ? 0 === Li && (Li = 3)
                    : ((0 !== Li && 3 !== Li) || (Li = 4), null === _i || (0 == (134217727 & Mi) && 0 == (134217727 & Ri)) || fu(_i, Ni))),
                (r || n) && (t.flags |= 4),
                null)
          );
        case 4:
        ...
        case 19:
          ...
          if (((i = 0 != (64 & t.flags)), null === (s = r.rendering)))
            if (i) ti(r, !1);
              ...
              null !== r.tail && Dl() > Ui && ((t.flags |= 64), (i = !0), ti(r, !1), (t.lanes = 33554432));
            }
          else {
            if (!i)
              if (null !== (e = ja(s))) {
                ...
                2 * Dl() - r.renderingStartTime > Ui && 1073741824 !== n && ((t.flags |= 64), (i = !0), ti(r, !1), (t.lanes = 33554432));
            r.isBackwards
    ...
    function ri(e) {
      switch (e.tag) {
        ...
        case 3:
          if ((Oa(), al(sl), al(ul), Wa(), 0 != (64 & (t = e.flags)))) throw Error(o(285));
              ...
              if ("style" === f)
                ...
                "dangerouslySetInnerHTML" === f
                  ...
                  : "suppressContentEditableWarning" !== f &&
                    "suppressHydrationWarning" !== f &&
                    (u.hasOwnProperty(f)
                      ? (null != c && "onScroll" === f && Cr("scroll", e), i || s === c || (i = []))
      ...
      switch (n.tag) {
        ...
        case 22:
          ...
          if (null !== (t = null !== (t = n.updateQueue) ? t.lastEffect : null)) {
            ...
            do {
              var l = e;
              (r = l.next), 0 != (4 & (l = l.tag)) && 0 != (1 & l) && (Tu(n, e), Ou(n, e)), (e = r);
            } while (e !== t);
          }
          return;
        case 1:
    ...
    function bi(e, t) {
      switch (t.tag) {
        ...
        case 12:
          return;
        case 13:
          return null !== t.memoizedState && ((Di = Dl()), pi(t.child, !0)), void wi(t);
        case 19:
          return void wi(t);
        case 17:
          return;
    ...
    var Vi,
      ...
      lu = !1;
    function au() {
      return 0 != (48 & Ci) ? Dl() : -1 !== eu ? eu : (eu = Dl());
    }
    function ou(e) {
      if (0 == (2 & (e = e.mode))) return 1;
      if (0 == (4 & e)) return 99 === Ul() ? 1 : 2;
      if ((0 === tu && (tu = ji), 0 !== Hl.transition)) {
    ...
    function iu(e, t, n) {
      ...
      Bt(e, t, n), e === _i && ((Ri |= t), 4 === Li && fu(e, Ni));
      var r = Ul();
      1 === t
        ? 0 != (8 & Ci) && 0 == (48 & Ci)
          ? du(e)
          : (su(e, n), 0 === Ci && (Ai(), $l()))
        : (0 == (4 & Ci) || (98 !== r && 99 !== r) || (null === Xi ? (Xi = new Set([e])) : Xi.add(e)), su(e, n)),
        (Ii = e);
    }
    function uu(e, t) {
      e.lanes |= t;
    ...
    function su(e, t) {
      ...
      if (((r = It(e, e === _i ? Ni : 0)), (t = Rt), 0 === r))
        ...
        15 === t
          ? ((n = du.bind(null, e)), null === Ml ? ((Ml = [n]), (Rl = kl(Pl, Wl))) : Ml.push(n), (n = zl))
          : 14 === t
    ...
    function cu(e) {
      ...
      if ((Xl(), (Ei.current = a), (Ci = l), null !== Pi ? (r = 0) : ((_i = null), (Ni = 0), (r = Li)), 0 != (ji & Ri))) vu(e, 0);
      else if (0 !== r) {
        if ((2 === r && ((Ci |= 64), e.hydrate && ((e.hydrate = !1), Br(e.containerInfo)), 0 !== (n = Dt(e)) && (r = wu(e, n))), 1 === r))
        ...
        switch (((e.finishedWork = e.current.alternate), (e.finishedLanes = n), r)) {
          ...
          case 2:
            ...
            break;
          case 3:
            if ((fu(e, n), (62914560 & n) === n && 10 < (r = Di + 500 - Dl()))) {
              if (0 !== It(e, 0)) break;
      ...
      return su(e, Dl()), e.callbackNode === t ? cu.bind(null, e) : null;
    }
    function fu(e, t) {
      for (t &= ~Fi, t &= ~Ri, e.suspendedLanes |= t, e.pingedLanes &= ~t, e = e.expirationTimes; 0 < t; ) {
        var n = 31 - $t(t),
          r = 1 << n;
        (e[n] = -1), (t &= ~r);
      }
    ...
    function du(e) {
      ...
      if ((Nu(), e === _i && 0 != (e.expiredLanes & Ni))) {
        var t = Ni,
          n = wu(e, t);
        0 != (ji & Ri) && (n = wu(e, (t = It(e, t))));
      } else n = wu(e, (t = It(e, 0)));
      if (
        (0 !== e.tag && 2 === n && ((Ci |= 64), e.hydrate && ((e.hydrate = !1), Br(e.containerInfo)), 0 !== (t = Dt(e)) && (n = wu(e, t))),
        1 === n)
      )
        throw ((n = zi), vu(e, 0), fu(e, t), su(e, Dl()), n);
      return (e.finishedWork = e.current.alternate), (e.finishedLanes = t), Cu(e), su(e, Dl()), null;
    }
    function pu(e, t) {
      var n = Ci;
      Ci |= 1;
    ...
    function vu(e, t) {
      ...
      (_i = e), (Pi = Uu(e.current, null)), (Ni = Oi = ji = t), (Li = 0), (zi = null), (Fi = Ri = Mi = 0);
    }
    function yu(e, t) {
      for (;;) {
        var n = Pi;
        try {
          ...
          if (((qa = 0), (Ga = Ya = Ka = null), (Ja = !1), (xi.current = null), null === n || null === n.return)) {
            (Li = 1), (zi = t), (Pi = null);
            break;
          }
          e: {
    ...
    function wu(e, t) {
      ...
      if ((Xl(), (Ci = n), (Ei.current = r), null !== Pi)) throw Error(o(261));
    ...
    function xu(e) {
      ...
      do {
        ...
        if (((e = t.return), 0 == (2048 & t.flags))) {
          if (null !== (n = ni(n, t, Oi))) return void (Pi = n);
    ...
    function _u(e, t) {
      ...
      if (
        ...
        if (((l = Ci), (Ci |= 32), (xi.current = null), (Fr = Kt), dr((i = fr())))) {
        ...
        (Ir = { focusedElem: i, selectionRange: u }), (Kt = !1), (ru = null), (lu = !1), (Bi = r);
        do {
          try {
            Pu();
          } catch (e) {
            if (null === Bi) throw Error(o(330));
            ju(Bi, e), (Bi = Bi.nextEffect);
          }
        } while (null !== Bi);
        (ru = null), (Bi = r);
        do {
            ...
            for (i = e; null !== Bi; ) {
              ...
              switch (1038 & b) {
                case 2:
                  ...
                  break;
                case 6:
                  vi(Bi), (Bi.flags &= -3), bi(Bi.alternate, Bi);
                  break;
                case 1024:
                  Bi.flags &= -1025;
                  break;
        ...
        (Kt = !!Fr), (Ir = Fr = null), (e.current = n), (Bi = r);
        do {
          try {
            for (b = e; null !== Bi; ) {
              var E = Bi.flags;
              if ((36 & E && di(b, Bi.alternate, Bi), 128 & E)) {
                w = void 0;
                var x = Bi.ref;
                if (null !== x) {
                  var C = Bi.stateNode;
      ...
      if (Qi) (Qi = !1), (qi = e), (Ki = t);
        ...
        for (Bi = r; null !== Bi; )
          (t = Bi.nextEffect), (Bi.nextEffect = null), 8 & Bi.flags && (((E = Bi).sibling = null), (E.stateNode = null)), (Bi = t);
      if (
      ...
      if ((su(e, Dl()), $i)) throw (($i = !1), (e = Wi), (Wi = null), e);
      return 0 != (8 & Ci) || $l(), null;
    }
    function Pu() {
      for (; null !== Bi; ) {
        var e = Bi.alternate;
        lu || null === ru || (0 != (8 & Bi.flags) ? Ze(Bi, ru) && (lu = !0) : 13 === Bi.tag && ki(e, Bi) && Ze(Bi, ru) && (lu = !0));
        var t = Bi.flags;
        0 != (256 & t) && fi(e, Bi),
          0 == (512 & t) ||
            Qi ||
    ...
    function zu(e, t, n) {
      oa(e, (t = ii(0, (t = li(n, t)), 1))), (t = au()), null !== (e = uu(e, 1)) && (Bt(e, 1, t), su(e, t));
    }
    function ju(e, t) {
      if (3 === e.tag) zu(e, e, t);
      else
        for (var n = e.return; null !== n; ) {
          ...
          if (1 === n.tag) {
            ...
            if (
              ...
              if ((oa(n, l), (l = au()), null !== (n = uu(n, 1)))) Bt(n, 1, l), su(n, l);
    ...
    function Mu(e, t, n) {
      ...
      null !== r && r.delete(t),
        ...
        _i === e && (Ni & n) === n && (4 === Li || (3 === Li && (62914560 & Ni) === Ni && 500 > Dl() - Di) ? vu(e, 0) : (Fi |= n)),
        su(e, t);
    }
    function Ru(e, t) {
      var n = e.stateNode;
      null !== n && n.delete(t),
        0 === (t = 0) &&
          (0 == (2 & (t = e.mode))
            ...
            : 0 == (4 & t)
            ? (t = 99 === Ul() ? 1 : 2)
            : (0 === tu && (tu = ji), 0 === (t = At(62914560 & ~tu)) && (t = 4194304))),
        (n = au()),
      ...
      if (((r = e), "function" == typeof e)) Du(e) && (i = 1);
        ...
        e: switch (e) {
          ...
          case C:
            ...
            break;
          case _:
            return ((e = Iu(12, n, t, 8 | l)).elementType = _), (e.type = _), (e.lanes = a), e;
          case T:
            return ((e = Iu(13, n, t, l)).type = T), (e.elementType = T), (e.lanes = a), e;
          case L:
            return ((e = Iu(19, n, t, l)).elementType = L), (e.lanes = a), e;
          case I:
            return Bu(n, l, a, t);
          case D:
            return ((e = Iu(24, n, t, l)).elementType = D), (e.lanes = a), e;
          default:
      ...
      switch (((t.lanes = 0), t.tag)) {
        ...
        case 3:
          ...
          if (
            ...
            if (((a = (l = t.stateNode).hydrate) && ((Ra = $r(t.stateNode.containerInfo.firstChild)), (Ma = t), (a = Fa = !0)), a)) {
        ...
        case 5:
          return (
            ...
            (i = l.children),
            Ur(r, l) ? (i = null) : null !== a && Ur(r, a) && (t.flags |= 16),
            Do(e, t),
            jo(e, t, i, n),
            t.child
          );
        ...
        case 4:
          return (
            Na(t, t.stateNode.containerInfo), (r = t.pendingProps), null === e ? (t.child = ka(t, null, r, n)) : jo(e, t, r, n), t.child
          );
        case 11:
    ...
    var ts = { Events: [Jr, Zr, el, Te, Le, Nu, { current: !1 }] },
  ...
  20: function (e, t, n) {
        ...
        if (n !== t) {
          ...
          e: for (var r = 0, l = e.length; r < l; ) {
            var a = 2 * (r + 1) - 1,
              ...
              u = e[i];
            if (void 0 !== o && 0 > _(o, n))
              void 0 !== u && 0 > _(u, o) ? ((e[r] = u), (e[i] = n), (r = i)) : ((e[r] = o), (e[a] = n), (r = a));
            else {
    ...
    function I(e, n) {
      ...
      var r = L;
      try {
        for (R(n), T = x(P); null !== T && (!(T.expirationTime > n) || (e && !t.unstable_shouldYield())); ) {
          var o = T.callback;
          if ("function" == typeof o) {
            (T.callback = null), (L = T.priorityLevel);
            var i = o(T.expirationTime <= n);
            (n = t.unstable_now()), "function" == typeof i ? (T.callback = i) : T === x(P) && C(P), R(n);
          } else C(P);
          T = x(P);
        }
        if (null !== T) var u = !0;
    ...
    (t.unstable_IdlePriority = 5),
      ...
      (t.unstable_scheduleCallback = function (e, n, o) {
        ...
        return (
          (e = { id: O++, callback: n, priorityLevel: e, startTime: o, expirationTime: (u = o + u), sortIndex: -1 }),
          o > i
            ? ((e.sortIndex = o), E(N, e), null === x(P) && e === x(N) && (M ? a() : (M = !0), l(F, o - i)))
            : ((e.sortIndex = u), E(P, e), j || z || ((j = !0), r(I))),
          e
        );
      }),
  ...
  207: function (e, t, n) {
    ...
    var r = n(11),
      ...
      i = n(9),
      u = n(0);
    const s = "Proxy.Config.config",
      c = "Proxy.Config.stopUpdate";
    class f extends o.Component {
      constructor() {
        super(),
          (this.state = { i: 0 }),
          (this.form = { search: "", address: "", scheme: "https", port: "443", country: "", priority: "1000" });
      }
      fieldChanged(e, t) {
        (this.form[e] = t.trim()), this.setState(({ i: e }) => ({ i: e + 1 }));
      }
      render() {
        const e = this.getServers();
        return Object(u.jsxs)("div", {
          id: "content",
          children: [
            Object(u.jsx)("div", { className: "title", children: "Debug" }),
            Object(u.jsxs)("div", {
              ...
              children: [
                Object(u.jsx)(i.a, {
                  ...
                  onChange: this.fieldChanged.bind(this, "search")
                }),
                Object(u.jsx)("button", {
                ...
                Object(u.jsx)("button", {
                  style: { marginLeft: "10px" },
                  onClick: this.deleteAllServers.bind(this),
                  children: "Delete all servers"
                })
              ]
            }),
            this.renderTable(e)
      ...
      renderTable(e) {
        ...
        for (const r in e) {
          ...
          n.push(
            Object(u.jsxs)(
              ...
              {
                children: [
                  Object(u.jsx)("td", { children: l.address }),
                  Object(u.jsx)("td", { children: l.scheme }),
                  Object(u.jsx)("td", { children: l.port }),
                  Object(u.jsx)("td", { children: l.country }),
                  Object(u.jsx)("td", { children: l.password ? "Old" : "New" }),
                  Object(u.jsx)("td", {
                    children: Object(u.jsx)("span", {
                      className: "red",
                      onClick: this.deleteServer.bind(this, l.address),
                      children: "Delete"
                    })
                  })
                ]
        ...
        return Object(u.jsxs)("table", {
          children: [
            Object(u.jsx)("thead", {
              children: Object(u.jsxs)("tr", {
                children: [
                  Object(u.jsx)("td", { children: "Address" }),
                  Object(u.jsx)("td", { children: "Scheme" }),
                  Object(u.jsx)("td", { children: "Port" }),
                  Object(u.jsx)("td", { children: "Country" }),
                  Object(u.jsx)("td", { children: "Type" }),
                  Object(u.jsx)("td", { children: "Delete" })
                ]
              })
            }),
            Object(u.jsxs)("tbody", {
                    ...
                    children: [
                      Object(u.jsx)("td", {
                        children: Object(u.jsx)(i.a, {
                          ...
                          style: { width: "250px" },
                          onChange: this.fieldChanged.bind(this, "address")
                        })
                      }),
                      Object(u.jsx)("td", {
                        children: Object(u.jsx)(i.a, {
                          label: "Scheme",
                          theme: "white",
                          value: this.form.scheme,
                          style: { width: "75px" },
                          onChange: this.fieldChanged.bind(this, "scheme")
                        })
                      }),
                      Object(u.jsx)("td", {
                        children: Object(u.jsx)(i.a, {
                          ...
                          style: { width: "75px" },
                          onChange: this.fieldChanged.bind(this, "port")
                        })
                      }),
                      Object(u.jsx)("td", {
                        children: Object(u.jsx)(i.a, {
                      ...
                      Object(u.jsx)("td", {}),
                      Object(u.jsx)("td", {
                        children: Object(u.jsx)("span", { className: "red", onClick: this.addServer.bind(this), children: "Add" })
                      })
                    ]
                  },
                  ++t
      ...
      addServer() {
        const e = JSON.parse(JSON.stringify(sdk.storage.get(s)));
        e.free.push({
          address: this.form.address,
          country: this.form.country ? this.form.country : this.form.address,
          ...
          sdk.storage.set(c, !0).then(() => {
            sdk.storage.set(s, e).then(() => {
              sdk.restoreConfig(), this.setState(({ i: e }) => ({ i: e + 1 }));
            });
          });
      }
      resetToDefault() {
      ...
      deleteAllServers() {
        sdk.storage.set(c, !0).then(() => {
          sdk.storage.set(s, { free: [] }).then(() => {
            sdk.restoreConfig(), this.setState(({ i: e }) => ({ i: e + 1 }));
          });
        });
      }
      deleteServer(e) {
        const t = JSON.parse(JSON.stringify(sdk.storage.get(s))),
          n = { free: [] };
        for (const r in t.free) t.free[r].address !== e && n.free.push(t.free[r]);
        sdk.storage.set(c, !0).then(() => {
          sdk.storage.set(s, n).then(() => {
            sdk.restoreConfig(), this.setState(({ i: e }) => ({ i: e + 1 }));
          });
        });
      }
      getServers() {
        const e = JSON.parse(JSON.stringify(sdk.storage.get(s).free)),
          t = "" !== this.form.search && new RegExp(this.form.search, "gi");
        for (const n in e) {
          const r = e[n];
          t && (r.address.match(t) || r.name.match(e) || r.title.match(e) || r.country.match(e) || delete e[n]);
        }
        return e;
      }
    }
    ...
    class p {
      ...
      create() {
        (window.panel = this), (window.controller = l.a.render(Object(u.jsx)(d, {}), document.getElementById("page")));
      }
    }
    Promise.all([
      new Promise((e) => {
      ...
      const e = () => {
        ...
        (window.storage = {}), new a.a(), new p().init();
      };
      e();
    });
  },
...
*/ var r = Object.getOwnPropertySymbols,
  ...
  9: function (e, t, n) {
    ...
    class a extends r.Component {
      ...
      onChange(e) {
        const t = this.state;
        (t.value = e.target.value), this.callbacs.onChange(t.value), this.setState(t);
      }
      onEnter(e) {
      ...
      render() {
        return Object(l.jsxs)("div", {
          ...
          children: [
            ...
            this.state.message && Object(l.jsx)("div", { className: "inputMessage", children: this.state.message }),
            this.children
          ]
        });
      }
