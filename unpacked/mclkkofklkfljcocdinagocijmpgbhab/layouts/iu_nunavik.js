...
*/
  ...
  google.elements.keyboard.loadme({
    ...
    historyPruneRegex:
      " | |a|b|d|e|f|g|h|i|j|k|l|m|n|o|p|q|r|s|t|u|v|y|aa|pi|pe|ti|to|tu|ta|da|du|do|pu|po|pa|te|ki|ke|ku|ko|ka|gi|ge|gu|go|ga|ng|mi|me|mu|mo|ma|ni|ne|nu|no|na|si|se|su|so|sa|li|le|lu|lo|la|ji|je|ju|jo|ja|ye|yi|yu|yo|ya|ri|re|ru|ro|ra|va|ve|vi|vu|vo|fi|fe|fu|fo|fa|hi|he|hu|ho|ha|nn|ql|qi|qe|qu|qo|qa|qq|ba|pa|ta|da|ka|ma|na|sa|la|ya|ja|ra|va|ga|paa|taa|daa|kaa|gaa|maa|naa|saa|laa|jaa|yaa|raa|vaa|qaa|ngaa|qli|qle|qlu|qlo|qla|ngi|nge|ngu|ngo|nga|nng|nni|nne|nnu|nno|nna|qqi|qqe|qqu|qqo|qqa|nngi|nnge|nngu|nngo|nnga"
  });
}).call(this);
