...
*/
  ...
  google.elements.keyboard.loadme({
    ...
    mappings: {
      ",c": { "": "`1234567890[]',.pyfgcrl/=\\aoeuidhtns-;qjkxbmwvz" },
      "s,sc": { "": '~!@#$%^&*(){}"<>PYFGCRL?+|AOEUIDHTNS_:QJKXBMWVZ' },
      "l,cl": { "": "`1234567890[]',.PYFGCRL/=\\AOEUIDHTNS-;QJKXBMWVZ" },
      "sl,scl": { "": '~!@#$%^&*(){}"<>pyfgcrl?+|aoeuidhtns_:qjkxbmwvz' }
    }
  });
}).call(this);
