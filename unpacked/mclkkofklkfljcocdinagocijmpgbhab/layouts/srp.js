...
*/
  ...
  var f = function (a, b, c) {
    ...
    n = function () {
      ...
      this.o = /[\u11a8-\u11c3]/g;
      this.R = RegExp("\u1169\u1161|\u1169\u1162|\u1169\u1175|\u116e\u1165|\u116e\u1166|\u116e\u1175|\u1173\u1175", "g");
      this.O = /[\uac00-\ud7af]/g;
    ...
    q = function (a, b) {
      return b.replace(a.R, function (c) {
        return a.I[c];
      });
    },
    l = this || self;
  ...
  (function () {
    ...
    m(function (b) {
      ...
      b = c.replace(a.O, k(a.H, a));
      c = k(a.J, a);
      b = q(a, p(a, b)).replace(a.A, c).replace(a.u, c).replace(a.v, c).replace(a.C, c).replace(a.P, k(a.D, a));
      c = "";
  ...
  google.elements.keyboard.loadme({
    id: "srp",
    title: "Crnogorski jezik",
    mappings: {
      "": { "": "<1234567890/+qwertyuiop\u0161\u0111\u017easdfghjkl\u010d\u0107zxcvbnm,.-" },
      s: { "": ">!\"#$%&'()=?*QWERTYUIOP\u0160\u0110\u017dASDFGHJKL\u010c\u0106ZXCVBNM;:_" },
      l: { "": "<1234567890/+QWERTYUIOP\u0160\u0110\u017dASDFGHJKL\u010c\u0106ZXCVBNM,.-" },
      sl: { "": ">!\"#$%&'()=?*qwertyuiop\u0161\u0111\u017easdfghjkl\u010d\u0107zxcvbnm;:_" },
      c: {
        1: "~",
        2: "\u02c7",
        3: "^",
