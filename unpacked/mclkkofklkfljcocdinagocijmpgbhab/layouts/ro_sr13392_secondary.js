...
*/
  ...
  var f = function (a, b, c) {
    ...
    n = function () {
      ...
      this.M = /[\uac00-\ud7af]/g;
      this.N = /([\u1100-\u1112][\u1161-\u1175][\u11a7-\u11c3]?)/g;
      this.B = RegExp("([\u1161-\u1175])([\u1100-\u1112])([\u1100-\u1112][\u1161-\u1175])");
      this.u = RegExp(
        "([\u1161-\u1175])(\u1100\u1109|\u1102\u110c|\u1102\u1112|\u1105\u1100|\u1105\u1106|\u1105\u1107|\u1105\u1109|\u1105\u1110|\u1105\u1111|\u1105\u1112|\u1107\u1109)(([^\u1161-\u1175]|$))"
      );
      this.v = RegExp("([\u1161-\u1175])([\u1100-\u1112])([\u1100-\u1112]([^\u1161-\u1175]|$))");
      this.F = RegExp("([\u1161-\u1175])([\u1100-\u1112])(([^\u1100-\u1112\u1161-\u1175]|$))");
      this.h = {
        "\u1107": "\u3142",
        "\u110c": "\u3148",
        "\u1103": "\u3137",
  ...
  n.prototype.K = function (a, b, c, d) {
    return b + this.i[c] + d;
  };
  (function () {
    var a = new n();
    m(function (b) {
      ...
      b = c.replace(a.M, k(a.H, a));
      c = k(a.K, a);
      b = q(a, p(a, b)).replace(a.B, c).replace(a.u, c).replace(a.v, c).replace(a.F, c).replace(a.N, k(a.G, a));
      c = "";
  ...
  google.elements.keyboard.loadme({
    id: "ro_sr13392_secondary",
    is102Keyboard: !0,
    title: "Rom\u00e2n\u0103 SR13392 Secondary",
    mappings: {
      ...
      "sc,cl": { m: "-", "=": "\u00b1", Q: "\u00c2", T: "\u021a", I: "\u00ce", A: "\u0102", S: "\u0218", D: "\u0110", L: "\u0141" }
    },
    transform: {
      "` ": "`",
      "`A": "\u00c0",
