...
function Config(
  ...
  // RDP over VM bus (Hyper-V), simple session mode
  /*************************************************************************************************************************************************************************************************/
  /*** Enums                                                                                                                                                                                     ***/
  /*************************************************************************************************************************************************************************************************/
  ...
  // server
  this.getHttpServerUrl = function () {
    return httpServerUrl;
  };

  // host type
  this.getHostType = function () {
    return hostType == "RDP" ? hostTypeEnum.RDP : hostTypeEnum.SSH;
  };
  this.getHostTypeEnum = function () {
    return hostTypeEnum;
  };
  this.getVMNotEnhanced = function () {
    return vmNotEnhanced;
  };

  // dialog
  this.getStatEnabled = function () {
    return statEnabled;
  };
  this.getDebugEnabled = function () {
    return debugEnabled;
  };
  this.getDebugConsole = function () {
    return debugConsole;
  };
  this.getDebugLinesMax = function () {
    return debugLinesMax;
  };
  this.getKeyboardHelperEnabled = function () {
    return keyboardHelperEnabled;
  };
  this.getKeyboardHelperSize = function () {
    return keyboardHelperSize;
  };
  this.getKeyboardHelperTimeout = function () {
    return keyboardHelperTimeout;
  };
  ...
  this.getBrowserResizeEnum = function () {
    return browserResizeEnum;
  };
  this.getBrowserResize = function () {
    return browserResize == null
      ? null
      : browserResize == "SCALE"
      ? browserResizeEnum.SCALE
      : browserResize == "RECONNECT"
      ? browserResizeEnum.RECONNECT
      : browserResizeEnum.NONE;
  };
  this.getDefaultResize = function () {
  ...
  this.getDisplayModeEnum = function () {
  ...
  this.getImageEncodingEnum = function () {
    return imageEncodingEnum;
  };
  this.getImageEncoding = function () {
    return imageEncoding;
  };
  this.setImageEncoding = function (encoding) {
  ...
  this.getImageQuantity = function () {
    return imageQuantity;
  };
  this.setImageQuantity = function (quantity) {
    imageQuantity = quantity;
  };
  this.getImageTweakBandwidthLowerThreshold = function () {
    return imageTweakBandwidthLowerThreshold;
  };
  this.getImageTweakBandwidthHigherThreshold = function () {
    return imageTweakBandwidthHigherThreshold;
  };
  this.getImageTweakLatencyLowerThreshold = function () {
    return imageTweakLatencyLowerThreshold;
  };
  this.getImageTweakLatencyHigherThreshold = function () {
    return imageTweakLatencyHigherThreshold;
  };
  this.getImageTweakLatencyCountPerSec = function () {
    return imageTweakLatencyCountPerSec;
  };
  this.getImageCountOk = function () {
    return imageCountOk;
  };
  this.getImageCountMax = function () {
    return imageCountMax;
  };
  this.getImageModeEnum = function () {
    return imageModeEnum;
  };
  ...
  this.getImageBlobEnabled = function () {
    return imageBlobEnabled;
  };
  this.setImageBlobEnabled = function (enabled) {
    imageBlobEnabled = enabled;
  };
  this.getImageDebugEnabled = function () {
    return imageDebugEnabled;
  };
  this.getPeriodicalFullscreenInterval = function () {
    return periodicalFullscreenInterval;
  };
  this.getAdaptiveFullscreenTimeout = function () {
    return adaptiveFullscreenTimeout;
  };

  // audio
  this.getAudioFormatEnum = function () {
  ...
  // network
  this.getAdditionalLatency = function () {
    return additionalLatency;
  };
  this.getRoundtripDurationMax = function () {
    return roundtripDurationMax;
  };
  this.getBandwidthCheckInterval = function () {
    return bandwidthCheckInterval;
  };
  this.getNetworkModeEnum = function () {
    return networkModeEnum;
  };
  this.getNetworkMode = function () {
    return networkMode;
  };
  this.setNetworkMode = function (mode) {
    networkMode = mode;
  };

  // websocket
  this.getHttpSessionKeepAliveInterval = function () {
    return httpSessionKeepAliveInterval;
  };

  // xmlhttp
  this.getXmlHttpTimeout = function () {
    return xmlHttpTimeout;
  };

  // long-polling
  this.getLongPollingDuration = function () {
    return longPollingDuration;
  };

  // buffer
  this.getBufferEnabled = function () {
    return bufferEnabled;
  };
  this.setBufferEnabled = function (enabled) {
    bufferEnabled = enabled;
  };
  this.getBufferDelayBase = function () {
    return bufferDelayBase;
  };
  this.getBufferDelayEmpty = function () {
    return bufferDelayEmpty;
  };
  ...
  // mouse
  this.getMouseMoveSamplingRate = function () {
    return mouseMoveSamplingRate;
  };
}
