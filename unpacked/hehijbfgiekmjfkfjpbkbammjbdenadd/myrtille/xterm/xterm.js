  ...
  return (function () {
  ...
  })()(
    {
      1: [
          ...
          var AccessibilityManager = (function () {
            function AccessibilityManager(_terminal) {
              ...
              this._disposables.push(
                this._terminal.addDisposableListener("resize", function (data) {
                  return _this._onResize(data.cols, data.rows);
                })
              );
              this._disposables.push(
                this._terminal.addDisposableListener("refresh", function (data) {
                  return _this._refreshRows(data.start, data.end);
                })
              );
              this._disposables.push(
                this._terminal.addDisposableListener("scroll", function (data) {
                  return _this._refreshRows();
                })
              );
              this._disposables.push(
                this._terminal.addDisposableListener("a11y.char", function (char) {
                  return _this._onChar(char);
                })
              );
              this._disposables.push(
                this._terminal.addDisposableListener("linefeed", function () {
                  return _this._onChar("\n");
                })
              );
              this._disposables.push(
                this._terminal.addDisposableListener("a11y.tab", function (spaceCount) {
                  return _this._onTab(spaceCount);
                })
              );
              this._disposables.push(
                this._terminal.addDisposableListener("key", function (keyChar) {
                  return _this._onKey(keyChar);
                })
              );
              this._disposables.push(
                this._terminal.addDisposableListener("blur", function () {
                  return _this._clearLiveRegion();
                })
              );
              this._disposables.push(
                this._terminal.addDisposableListener("dprchange", function () {
                  return _this._refreshRowsDimensions();
                })
              );
              this._disposables.push(
                this._terminal.renderer.addDisposableListener("resize", function () {
                  return _this._refreshRowsDimensions();
                })
              );
              this._disposables.push(
                Dom_1.addDisposableListener(window, "resize", function () {
                  return _this._refreshRowsDimensions();
                })
              );
            }
        ...
        { "./Strings": 15, "./shared/utils/Browser": 39, "./utils/Dom": 43, "./utils/RenderDebouncer": 45 }
      ],
      2: [
        function (require, module, exports) {
          "use strict";
          ...
          var Buffer = (function () {
            ...
            Buffer.prototype.addMarker = function (y) {
              ...
              marker.disposables.push(
                this.lines.addDisposableListener("trim", function (amount) {
                  marker.line -= amount;
                  if (marker.line < 0) {
                    marker.dispose();
                  }
        ...
        { "./EventEmitter": 8, "./utils/CircularList": 41 }
      ],
      3: [
        function (require, module, exports) {
          "use strict";
      ...
      9: [
            ...
            InputHandler.prototype.deviceStatus = function (params) {
              if (!this._terminal.prefix) {
                switch (params[0]) {
                  ...
                  case 6:
                    this._terminal.send(
                      EscapeSequences_1.C0.ESC + "[" + (this._terminal.buffer.y + 1) + ";" + (this._terminal.buffer.x + 1) + "R"
                    );
                    break;
                }
              } else if (this._terminal.prefix === "?") {
        ...
        { "./Buffer": 2, "./CharWidth": 4, "./Charsets": 5, "./EscapeSequences": 7 }
      ],
      10: [
        function (require, module, exports) {
          "use strict";
          ...
          var Linkifier = (function (_super) {
            ...
            Linkifier.prototype._linkifyRow = function (rowIndex) {
              ...
              while (currentIndex < this._terminal.buffer.lines.length && this._terminal.buffer.lines.get(currentIndex).isWrapped) {
        ...
        { "./EventEmitter": 8, "./input/MouseZoneManager": 20 }
      ],
      11: [
        function (require, module, exports) {
          "use strict";
                  ...
                  case 3:
                    if (ch in csiStateHandler) {
                      if (this._terminal.debug) {
                        this._terminal.log(
                          "CSI " +
                            (this._terminal.prefix ? this._terminal.prefix : "") +
                            " " +
                            (this._terminal.params ? this._terminal.params.join(";") : "") +
                            " " +
                            (this._terminal.postfix ? this._terminal.postfix : "") +
                            " " +
                            ch
                        );
                      }
      ...
      12: [
        function (require, module, exports) {
          ...
          var SelectionManager = (function (_super) {
              ...
              if (this._dragScrollAmount) {
                ...
                if (this._dragScrollAmount > 0) {
                  this._model.selectionEnd = [
                    ...
                    Math.min(this._terminal.buffer.ydisp + this._terminal.rows, this._terminal.buffer.lines.length - 1)
                  ];
                } else {
            ...
            SelectionManager.prototype._selectToWordAt = function (coords) {
              ...
              if (wordPosition) {
                this._model.selectionEnd = [
                  this._model.areSelectionValuesReversed() ? wordPosition.start : wordPosition.start + wordPosition.length,
                  coords[1]
                ];
              }
            };
        ...
        },
        {
          ...
          "./EventEmitter": 8,
          "./SelectionModel": 13,
          "./handlers/AltClickHandler": 18,
          "./shared/utils/Browser": 39,
          "./utils/MouseHelper": 44
        }
      ],
      13: [
        function (require, module, exports) {
            ...
            SoundManager.prototype.playBellSound = function () {
              ...
              if (this._audioContext) {
                ...
                this._audioContext.decodeAudioData(
                  this._base64ToArrayBuffer(this._removeMimeType(this._terminal.options.bellSound)),
                  function (buffer) {
      ...
      16: [
        function (require, module, exports) {
          ...
          var Terminal = (function (_super) {
            ...
            Terminal.prototype.open = function (parent) {
              ...
              this._disposables.push(
                Dom.addDisposableListener(window, "resize", function () {
                  return _this.renderer.onWindowResize(window.devicePixelRatio);
                })
              );
              ...
              this._viewportElement.addEventListener("scroll", function () {
            ...
            Terminal.prototype.bindMouse = function () {
              ...
              function sendEvent(button, pos) {
                ...
                if (self._decLocator) {
                  ...
                  self.send(
                    EscapeSequences_1.C0.ESC + "[" + button + ";" + (button === 3 ? 4 : 0) + ";" + pos.y + ";" + pos.x + ";" + pos.page ||
                      0 + "&w"
                  );
                  return;
                }
              ...
              on(el, "mousedown", function (ev) {
                ...
                if (_this.normalMouse) on(_this._document, "mousemove", sendMove);
                if (!_this.x10Mouse) {
                  var handler_1 = function (ev) {
                    sendButton(ev);
                    if (_this.normalMouse) off(_this._document, "mousemove", sendMove);
        ...
        },
        {
          ...
          "./Strings": 15,
          "./Viewport": 17,
          "./handlers/Clipboard": 19,
          "./input/MouseZoneManager": 20,
          "./renderer/ColorManager": 22,
          "./renderer/Renderer": 26,
          "./renderer/atlas/CharAtlasCache": 30,
          "./shared/utils/Browser": 39,
          "./utils/CharMeasure": 40,
          "./utils/Clone": 42,
          "./utils/Dom": 43,
          "./utils/MouseHelper": 44,
          "./utils/ScreenDprMonitor": 46
        }
      ],
      17: [
        function (require, module, exports) {
            ...
            Viewport.prototype._refresh = function () {
              if (this._charMeasure.height > 0) {
                ...
                var newBufferHeight =
                  ...
                  (this._lastRecordedViewportHeight - this._terminal.renderer.dimensions.canvasHeight);
        ...
        function (require, module, exports) {
          ...
          var AltClickHandler = (function () {
            ...
            AltClickHandler.prototype._moveToRequestedCol = function () {
              ...
              return repeat(
                this._bufferLine(this._startCol, startRow, this._endCol, endRow, direction === "C").length,
      ...
      21: [
            ...
            BaseRenderLayer.prototype.drawChar = function (terminal, char, code, width, x, y, fg, bg, bold, dim, italic) {
              ...
              var atlasDidDraw =
                ...
                this._charAtlas.draw(
                  this._ctx,
                  { char: char, code: code, bg: bg, fg: fg, bold: bold && terminal.options.enableBold, dim: dim, italic: italic },
                  x * this._scaledCellWidth + this._scaledCharLeft,
                  y * this._scaledCellHeight + this._scaledCharTop
                );
              if (!atlasDidDraw) {
        ...
        { "../Buffer": 2, "./atlas/CharAtlasCache": 30, "./atlas/Types": 36 }
      ],
      22: [
        function (require, module, exports) {
          "use strict";
          ...
          var ColorManager = (function () {
            ...
            ColorManager.prototype._parseColor = function (css, fallback, allowTransparency) {
              ...
              if (!allowTransparency && data[3] !== 0xff) {
                console.warn(
                  "Color: " + css + " is using transparency, but allowTransparency is false. " + ("Using fallback " + fallback.css + ".")
                );
                return fallback;
              }
              return {
      ...
      26: [
        ...
        {
          "../EventEmitter": 8,
          "../utils/RenderDebouncer": 45,
          "../utils/ScreenDprMonitor": 46,
          "./ColorManager": 22,
          "./CursorRenderLayer": 23,
          "./LinkRenderLayer": 25,
          "./SelectionRenderLayer": 27,
          "./TextRenderLayer": 28
        }
      ],
      27: [
      ...
      28: [
        ...
        { "../Buffer": 2, "./BaseRenderLayer": 21, "./GridCache": 24, "./atlas/Types": 36 }
      ],
      29: [
        function (require, module, exports) {
          "use strict";
      ...
      30: [
        ...
        { "./CharAtlasUtils": 31, "./DynamicCharAtlas": 32, "./NoneCharAtlas": 34, "./StaticCharAtlas": 35 }
      ],
      31: [
        function (require, module, exports) {
          "use strict";
      ...
      32: [
        function (require, module, exports) {
          ...
          var DynamicCharAtlas = (function (_super) {
            ...
            DynamicCharAtlas.prototype._drawFromCache = function (ctx, cacheValue, x, y) {
              ...
              var _a = this._toCoordinates(cacheValue.index),
                cacheX = _a[0],
                cacheY = _a[1];
              ctx.drawImage(
                this._cacheCanvas,
            ...
            DynamicCharAtlas.prototype._drawToCache = function (glyph, index) {
              ...
              var _a = this._toCoordinates(index),
                x = _a[0],
                y = _a[1];
        ...
        { "../../shared/atlas/CharAtlasGenerator": 37, "../ColorManager": 22, "./BaseCharAtlas": 29, "./LRUMap": 33, "./Types": 36 }
      ],
      33: [
        function (require, module, exports) {
          "use strict";
      ...
      35: [
        ...
        { "../../shared/atlas/CharAtlasGenerator": 37, "../../shared/atlas/Types": 38, "./BaseCharAtlas": 29, "./Types": 36 }
      ],
      36: [
        function (require, module, exports) {
          "use strict";
        ...
        function (require, module, exports) {
          ...
          var MouseHelper = (function () {
            ...
            MouseHelper.prototype.getCoords = function (event, element, charMeasure, lineHeight, colCount, rowCount, isSelection) {
              ...
              coords[0] = Math.ceil(
                (coords[0] + (isSelection ? this._renderer.dimensions.actualCellWidth / 2 : 0)) / this._renderer.dimensions.actualCellWidth
              );
