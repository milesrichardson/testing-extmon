...
function Buffer(config, dialog, network) {
  ...
  this.getBufferDelay = function () {
    return bufferDelay;
  };
  this.setBufferDelay = function (delay) {
    bufferDelay = delay;
  };
  ...
  this.getSendEmptyBuffer = function () {
    return sendEmptyBuffer;
  };

  var clearBuffer = true;
  this.setClearBuffer = function (enabled) {
    clearBuffer = enabled;
  };
  ...
  function doFlush() {
    try {
      if (!config.getBufferEnabled()) return;
