  ...
  this.init = function () {
    try {
      ...
      if (canvasContext == null || !canvasContext) {
        ...
        canvasObject.width =
          config.getBrowserResize() == config.getBrowserResizeEnum().SCALE ? display.getBrowserWidth() : config.getDisplayWidth();
        canvasObject.height =
          config.getBrowserResize() == config.getBrowserResizeEnum().SCALE ? display.getBrowserHeight() : config.getDisplayHeight();
