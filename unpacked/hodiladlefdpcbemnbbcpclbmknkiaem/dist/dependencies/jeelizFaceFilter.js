...
var JEEFACEFILTERAPI = (function () {
  window.JEEFACEFILTERAPIGEN = function () {
    ...
    function Nb(a) {
      ...
      l = a + d + 1;
      for (var n = 0; n < e; ++n) {
        for (var p = l * n, y = 0 === nb(c, p) ? 1 : -1, m = p + 1, r = 1, x = 0, z = m + a - 1; z >= m; --z) (x += r * nb(c, z)), (r *= 2);
        m = x;
        p = p + 1 + a;
        r = k.length;
        x = 0;
        ...
        -1 !== X.nDetectsPerLoop
          ...
          : ((a = I.Ta),
            ...
            P.ia > I.ea[1]
              ...
              : P.ia < I.ea[0] && ((P.G = Math.max(P.G - 1, I.za[0])), (P.ia = (I.ea[0] + I.ea[1]) / 2)));
        ra.F();
          ...
          if (-1 !== E.L.indexOf(a)) {
            ...
            if (c.Da < I.mb) H.ga && (d.rz = 0);
              ...
              f =
                ...
                (1 -
                  db.Ia(sa.rotationFactorRange[0], sa.rotationFactorRange[1], Math.sqrt(f.Va * f.Va + f.Wa * f.Wa + f.Xa * f.Xa) / P.ra)) *
    ...
    function Vb() {
      ...
      t.Pd("u39", Xa, Ya, vb);
      Q.g(!1, !1);
      E.Zb && (b.viewport(1, a, 1, 1), t.set("s51"), Q.g(!1, !1), b.viewport(2, a, 1, 1), t.set("s52"), Q.g(!1, !1));
      Oa += bb;
        ...
        var d = null,
          ...
          y = {
            ...
            Le: function () {
              ...
              e.width = d.width;
              e.height = d.height;
              for (var m = y.hd(), r = f.createImageData(e.width, e.height), x = e.width, z = e.height, T = r.data, M = 0; M < z; ++M)
            ...
            o: function (m) {
              ...
              if (!b) {
                ...
                b ? (l = !0) : ((b = d.getContext("webgl", r)) || (b = d.getContext("experimental-webgl", r)), (l = !1));
              }
          ...
          n = {
            ...
            o: function () {
              k ||
                ...
                b.bufferData(b.ARRAY_BUFFER, new Float32Array([-1, -1, 3, -1, -1, 3]), b.STATIC_DRAW),
                (c = b.createBuffer()),
                b.bindBuffer(b.ELEMENT_ARRAY_BUFFER, c),
                b.bufferData(b.ELEMENT_ARRAY_BUFFER, new Uint16Array([0, 1, 2]), b.STATIC_DRAW),
                n.oa(),
                (k = !0));
            },
            instance: function (p) {
          ...
          B = {
            ...
            instance: function (q) {
              function C() {
                ...
                h.isPot
                  ? (b.texParameteri(b.TEXTURE_2D, b.TEXTURE_WRAP_S, h.isMirrorX ? b.MIRRORED_REPEAT : b.REPEAT),
                    b.texParameteri(b.TEXTURE_2D, b.TEXTURE_WRAP_T, h.isMirrorY ? b.MIRRORED_REPEAT : b.REPEAT))
                  : (b.texParameteri(b.TEXTURE_2D, b.TEXTURE_WRAP_S, b.CLAMP_TO_EDGE),
                    b.texParameteri(b.TEXTURE_2D, b.TEXTURE_WRAP_T, b.CLAMP_TO_EDGE));
                h.isAnisotropicFiltering &&
                  "undefined" !== typeof JESETTINGS &&
                  b.texParameterf(b.TEXTURE_2D, JEContext.Me().TEXTURE_MAX_ANISOTROPY_EXT, JESETTINGS.$d);
                b.texParameteri(b.TEXTURE_2D, b.TEXTURE_MAG_FILTER, h.isLinear ? b.LINEAR : b.NEAREST);
                h.isLinear
                  ? b.texParameteri(b.TEXTURE_2D, b.TEXTURE_MIN_FILTER, h.isMipmap && !Ja ? b.NEAREST_MIPMAP_LINEAR : b.LINEAR)
                  : b.texParameteri(b.TEXTURE_2D, b.TEXTURE_MIN_FILTER, h.isMipmap && !Ja ? b.NEAREST_MIPMAP_NEAREST : b.NEAREST);
                fa = z[h.Ka - 1];
                ia = T[h.Ka - 1];
                ja = x[qa];
                if (Z.u()) {
                  ...
                  try {
                    b.getError(),
                      ...
                      b.getError() !== b.NO_ERROR &&
                        ...
                        b.getError() !== b.NO_ERROR && b.texImage2D(b.TEXTURE_2D, 0, b.RGBA, J, K, 0, b.RGBA, b.UNSIGNED_BYTE, null));
                  } catch (gc) {
                    b.texImage2D(b.TEXTURE_2D, 0, ia, J, K, 0, fa, ja, null);
                  }
              ...
              h.data &&
                ((h.array = "string" === typeof h.data ? Nb(h.data) : h.isFloat ? new Float32Array(h.data) : new Uint8Array(h.data)),
                (h.isFlipY = !1));
              var qa = 0,
                ua = h.D ? !0 : !1,
                xa = null,
              ...
              var W = {
                  ...
                  if (Ja) {
                    ...
                    for (var L = J, da = K, O = 1; O <= v; ++O)
                      (L /= 2),
                        ...
                        b.viewport(0, 0, L, da),
                        a(Sa[O - 1]),
                        b.framebufferTexture2D(aa.ha(), b.COLOR_ATTACHMENT0, b.TEXTURE_2D, Sa[O], 0),
                        ka.g(!1, 1 === O);
                    y[0] = -1;
                  } else W.bb();
                },
                ...
                oc: function () {
                  ...
                  for (var v = J * K, L = 2 * v, da = 3 * v, O = 0; O < v; ++O)
                    (ya[0][O] = Wa[O]), (ya[1][O] = Wa[O + v]), (ya[2][O] = Wa[O + L]), (ya[3][O] = Wa[O + da]);
                  return ya;
                },
                Gd: function () {
                ...
                Ib: function (v) {
                  ...
                  t.set("s12");
                  W.b(0);
                  if (v) b.viewport(0, 0, J, K), t.tb("u8", 0.25, 0.25, 0.25, 0.25), ka.g(!1, !0);
                  else for (v = 0; 4 > v; ++v) b.viewport(0, K * v, J, K), t.tb("u8", A[v]), ka.g(!1, 0 === v);
                },
                Bf: function (v) {
                  var L = ja === x[0] && !f();
                  a(ta);
                ...
                rf: function (v, L) {
                  ...
                  if ("RGBA" === v || "RGBE" === v || "RGBAARRAY" === v) {
                    ...
                    if (L) (O = new Float32Array(da)), b.viewport(0, 0, J, K), ka.g(!0, !0), b.readPixels(0, 0, J, K, b.RGBA, b.FLOAT, O);
                    else {
                      for (O = 0; 4 > O; ++O) b.viewport(0, K * O, J, K), t.tb("u8", A[O]), ka.g(!O, !O);
                      W.oc();
                      O = Array(da);
                      for (L = 0; L < da; ++L)
                        (O[4 * L] = ya[0][L]), (O[4 * L + 1] = ya[1][L]), (O[4 * L + 2] = ya[2][L]), (O[4 * L + 3] = ya[3][L]);
                    }
                  return {
                    format: v,
                    data: O,
                ...
                h.array
                  ? (h.H && !h.isFloat
                      ...
                      : ((wa = h.isFloat
                        ...
                        C()),
                    h.isKeepArray || (wa && wa !== h.array && (wa = null), delete h.array))
                  : C();
              W.Ve = W.A;
      ...
      Va = (function () {
        function a(z, T, M, F) {
          ...
          D === b.INVALID_OPERATION &&
            ...
            (b.bindBuffer(b.PIXEL_PACK_BUFFER, null), b.readPixels(0, 0, 1, 1, b.RGBA, b.UNSIGNED_BYTE, l), (D = b.getError()));
        ...
        function d(z) {
          return Z.Kc() ? (a(r, Z.Fa(), new Uint16Array(p), z) || a(r, b.FLOAT, new Float32Array(p), z) ? ((k = f.Ra), !0) : !1) : !1;
        }
        var e = !1,
          f = { yb: 3, Ra: 2, RGBA8: 0 },
          k = f.RGBA8,
      ...
      Lb = (function () {
        return {
          instance: function (a) {
            ...
            a.mask && ((d = !0), I && void 0 !== I.Ec && (a.mask = I.Ec + a.mask), (c = R.instance({ isFloat: !1, url: a.mask })));
            var m = !1;
            a.customInputShader &&
              ((m = "s42"),
              t.zb({
        ...
        return {
          instance: function (a) {
            ...
            var c = {
              ...
              z = { isEnabled: !1 };
            a.sd
              ? ((a.sparsity = "undefined" !== typeof a.sparsity ? a.sparsity : a.Na.eb()), (n = !1))
            ...
            var oa = {
              ...
              I: function (B) {
                ...
                if (n)
                  return (
                    F ? (c.pb.J(), c.S.b(0), t.set(G), t.wa("u7", 1 / a.size, 1 / a.size), Q.g(!1, !1), (B = c.pb)) : (B = c.S),
                    B.b(0),
                    y && (c.Ma.l(), t.set("s21"), t.wa("u13", p, D / p), Q.g(!1, !1), (B = c.Ma), c.Ma.b(0)),
                    B
                  );
                B = c.S;
                a.disableNormalize ||
                  (t.set("gpuRawAvg" === k ? "s8" : "s7"), t.B("u4", 1 / a.size), c.qb.J(), c.S.b(0), Q.g(!1, !1), (B = c.qb));
                switch (k) {
                  case "cpuRGBA2Float":
                    B.Ib(!1);
                    B = oa.Fd(B);
              ...
              Tc: function (B) {
                ...
                for (var q = 0, C = 0, h = 0; q < B; ++q)
                  e.push(C + (a.size - 1 - h) * a.size), f.push([-1, -1, -1, -1]), ++C, C === a.size && ((C = 0), ++h);
                a.disableNormalize ||
                  (c.qb = R.instance({
                    isFloat: !0,
                    isPot: !0,
    ...
    var Zb = (function () {
      ...
      S = {
        ...
        Sc: function (a) {
          function c(r) {
            return [480, 576, 640, 648, 720, 768, 800, 960, 1080, 1152, 1280, 1366, 1920].sort(function (x, z) {
            ...
            if (a.video.width.ideal && a.video.height.ideal) {
              ...
              for (l.X = void 0; n < f.length; l = { X: l.X }, ++n) {
                ...
                for (p.W = void 0; y < k.length; p = { W: p.W }, ++y)
                  if (((p.W = k[y]), l.X !== a.video.width.ideal || p.W !== a.video.height.ideal)) {
      ...
      Kb = {
        ...
        toggle_slow: function (a) {
          ob() &&
            ea === ba.play &&
            (a && !H.Ha
              ? ((H.nc = H.Aa), (X.nDetectsPerLoop = 1), this.set_animateDelay(100), (H.Ha = !0))
              : !a && H.Ha && ((X.nDetectsPerLoop = -1), this.set_animateDelay(H.nc), (H.Ha = !1)));
        },
