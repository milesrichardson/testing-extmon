...
!(function (t, e) {
  ...
  function g(t, e, n, r) {
    return { y: r.get(t, e, n), x: r.get(t, e, n + h) };
  }
  function v(t, e, n) {
  ...
  function b(t, e, n) {
    ...
    for (var r = 0, o = 0, i = 0; i < t.length; i++)
      e.keypoints[i].score > n &&
        ((o += 1), (r += Math.pow(t[i].x - e.keypoints[i].position.x, 2) + Math.pow(t[i].y - e.keypoints[i].position.y, 2)));
  ...
  function x(t, e, n, r, o, i, a) {
    for (
      ...
      p = Math.min(p, s - 1);
      var v = n({ x: (m = Math.min(m, u - 1)), y: p }),
        w = v.y * r + v.x;
  ...
  function k(t, n, r, o, i, a, s, u, d, f, l) {
    for (
      var c = s[0],
        ...
        x = y[1],
        S = n.reshape([b, x, 2, h]),
        M = new Float32Array(l * h * 3).fill(0),
        k = 0;
      k < r.length;
      k++
    )
      ...
      a(this, void 0, void 0, function () {
        ...
        return s(this, function (s) {
          switch (s.label) {
            ...
            case 4:
              (b = s.sent()),
                (d = (function (t, e, n, r, o, i, a, s, u, d) {
                  var f = a[0],
                    l = a[1];
                  void 0 === d && (d = 5);
                  for (
                    ...
                    for (var x = 0; x < o; x += 1) {
                      var k = b * o + x;
                      if (1 === t[k]) {
                        var _ = S({ x: x, y: b }, e, n, d, [h, p], [v, w], y, [r, o], i, u);
                        _ >= 0 && (c[_][k] = 1);
                      }
                    }
                  return c;
      ...
      a(this, void 0, void 0, function () {
        ...
        return s(this, function (s) {
          switch (s.label) {
            ...
            case 5:
              (E = s.sent()),
                (f = (function (t, e, n, r, o, i, a, s, u, d, f) {
                  var l = s[0],
                    c = s[1];
                  void 0 === f && (f = 5);
                  for (
                    ...
                    for (var k = 0; k < i; k += 1) {
                      var _ = x * i + k;
                      if (1 === t[_]) {
                        var E = S({ x: k, y: x }, e, r, f, [p, g], [w, y], b, [o, i], a, d);
                        E >= 0 && (h[E][_] = n[_]);
                      }
                    }
                  return h;
                })(b, x, E, a, i, u, d, [v, w], l, h)),
                (s.label = 6);
            case 6:
              return [
                2,
  ...
  function B(t, e, n, r) {
    return { y: w(Math.round(t.y / e), 0, n - 1), x: w(Math.round(t.x / e), 0, r - 1) };
  }
  function F(t, e, n, r, o, i, a, s) {
    ...
    for (
      ...
      var m = B(h, i, d, f),
        v = g(m.y, m.x, n, o);
      h = y({ x: m.x * i, y: m.y * i }, { x: v.x, y: v.y });
    }
    var w = B(h, i, d, f),
      b = r.get(w.y, w.x, n);
    return { position: h, part: c[n], score: b };
  }
  function D(t, e, n, r, o, i) {
    var a = e.shape[2],
      ...
      f = t.score,
      l = v(d, r, n);
    u[d.id] = { score: f, part: c[d.id], position: l };
    for (var h = s - 1; h >= 0; --h) {
      var p = H[h],
        m = T[h];
        ...
        d = (function (t, e, n) {
          for (
            ...
            for (var d = 0; d < i; ++d)
              for (var f = 0; f < a; ++f) {
                var l = n.get(u, d, f);
                l < t || (A(f, l, u, d, e, n) && s.enqueue({ score: l, part: { heatmapY: u, heatmapX: d, id: f } }));
              }
          return s;
        })(a, z, t),
        f = s * s;
  ...
  var X = { low: "low", medium: "medium", high: "high", full: "full" },
    Y = (((W = {})[X.low] = 0.25), (W[X.medium] = 0.5), (W[X.high] = 0.75), (W[X.full] = 1), W),
    G = 0.1,
    J = 2;
  function Z(t, n, r) {
    var o = r[0],
      ...
      a = (function (t) {
        ...
        return (
          e.util.assert("number" == typeof t && t <= J && t >= G, function () {
  ...
  function tt(t, n) {
    ...
    return (
      s / a < u
        ? ((f = 0), (l = 0), (c = Math.round(0.5 * (u * a - s))), (h = Math.round(0.5 * (u * a - s))))
        : ((f = Math.round(0.5 * ((1 / u) * s - a))), (l = Math.round(0.5 * ((1 / u) * s - a))), (c = 0), (h = 0)),
      {
        ...
        padding: { top: f, left: c, right: h, bottom: l }
      }
    );
  }
  function et(t) {
  ...
  var ot = { architecture: "MobileNetV1", outputStride: 16, quantBytes: 4, multiplier: 0.75 },
    it = ["MobileNetV1", "ResNet50"],
    at = { MobileNetV1: [8, 16, 32], ResNet50: [32, 16] },
    st = { MobileNetV1: [0.5, 0.75, 1], ResNet50: [1] },
    ut = [1, 2, 4];
  var dt = {
      flipHorizontal: !1,
              ...
              switch (s.label) {
                ...
                case 2:
                  return (
                    ...
                    (b = g[3]),
                    (x = rt(
                      (x = C(v, w, y, b, this.baseModel.outputStride, e.maxDetections, e.scoreThreshold, e.nmsRadius)),
                      [h, p],
                      l,
                      f,
                      !1
              ...
              switch (s.label) {
                case 0:
                  return (
                    ...
                    (o = r[0]),
                    (a = r[1]),
                    (u = Z(n.internalResolution, this.baseModel.outputStride, [o, a])),
                    (f = tt(t, u)),
                    (l = f.resized),
                    (c = f.padding),
                    (h = e.tidy(function () {
                      var t,
                        e = O.predictForMultiPersonInstanceSegmentationAndPart(l),
                        r = e.segmentLogits,
                        i = e.longOffsets,
                        s = e.heatmapScores,
                        f = e.offsets,
                ...
                case 1:
                  return (
                    ...
                    (k = b[3]),
                    (_ = rt(
                      (_ = C(x, S, M, k, this.baseModel.outputStride, n.maxDetections, n.scoreThreshold, n.nmsRadius)),
                      [o, a],
                      u,
                      c,
                      !1
              ...
              switch (s.label) {
                case 0:
                  return (
                    ...
                    (o = r[0]),
                    (a = r[1]),
                    (f = Z(n.internalResolution, this.baseModel.outputStride, [o, a])),
                    (l = tt(t, f)),
                    (c = l.resized),
                    (h = l.padding),
                    (p = e.tidy(function () {
                ...
                case 1:
                  return (
                    ...
                    (E = S[3]),
                    (O = rt(
                      (O = C(M, k, _, E, this.baseModel.outputStride, n.maxDetections, n.scoreThreshold, n.nmsRadius)),
                      [o, a],
                      f,
                      h,
                      !1
  ...
  function pt(t) {
    return a(this, void 0, void 0, function () {
      ...
      return s(this, function (s) {
        switch (s.label) {
          case 0:
            if (((r = t.outputStride), (o = t.quantBytes), (i = t.multiplier), null == e))
              throw new Error(
  ...
  function vt(t, e, n, r) {
    ...
    if (o !== a || i !== s)
      throw new Error(
        "error: dimensions must match. " + n + " has dimensions " + o + "x" + i + ", " + r + " has dimensions " + a + "x" + s
      );
  }
  function wt(t) {
  ...
  var Et = { blurred: "blurred", blurredMask: "blurred-mask", mask: "mask", lowresPartMask: "lowres-part-mask" };
  (t.BodyPix = ht),
    (t.load = function (t) {
      return (
        void 0 === t && (t = ot),
        a(this, void 0, void 0, function () {
          return s(this, function (e) {
            return "ResNet50" ===
              (t = (function (t) {
                if ((null == (t = t || ot).architecture && (t.architecture = "MobileNetV1"), it.indexOf(t.architecture) < 0))
                  throw new Error("Invalid architecture " + t.architecture + ". Should be one of " + it);
                if ((null == t.outputStride && (t.outputStride = 16), at[t.architecture].indexOf(t.outputStride) < 0))
                  throw new Error(
                ...
                if ((null == t.multiplier && (t.multiplier = 1), st[t.architecture].indexOf(t.multiplier) < 0))
                  throw new Error(
                    "Invalid multiplier " +
                      t.multiplier +
                      ". Should be one of " +
                ...
                if ((null == t.quantBytes && (t.quantBytes = 4), ut.indexOf(t.quantBytes) < 0))
                  throw new Error(
                    "Invalid quantBytes " + t.quantBytes + ". Should be one of " + ut + " for architecture " + t.architecture + "."
                  );
                return t;
              })(t)).architecture
              ? [2, mt(t)]
    ...
    (t.blurBodyPart = function (t, e, n, r, o, i, a) {
      ...
      if (Array.isArray(n) && 0 === n.length) u.drawImage(s, 0, 0);
        ...
        var d = (function (t, e, n) {
          var r = Mt(kt(t, { r: 0, g: 0, b: 0, a: 0 }, { r: 0, g: 0, b: 0, a: 255 }, !0, e), Et.mask);
        ...
        var f = Q(e),
          l = f[0],
          c = f[1];
        u.drawImage(e, 0, 0, c, l), yt(u, d, "destination-in"), yt(u, s, "destination-over"), u.restore();
      }
    }),
    (t.drawBokehEffect = function (t, e, n, r, o, i) {
      ...
      if (Array.isArray(n) && 0 === n.length) s.drawImage(a, 0, 0);
        ...
        var u = (function (t, e) {
          var n = Mt(kt(t, { r: 0, g: 0, b: 0, a: 255 }, { r: 0, g: 0, b: 0, a: 0 }), Et.mask);
    ...
    (t.drawMask = function (t, e, n, r, o, i) {
      ...
      if ((d.save(), i && wt(t), d.drawImage(e, 0, 0), (d.globalAlpha = r), n)) {
        vt({ width: u, height: s }, n, "image", "mask");
    ...
    (t.drawPixelatedMask = function (t, e, n, r, o, i, a) {
      ...
      var s = Q(e),
        u = s[0];
      vt({ width: s[1], height: u }, n, "image", "mask");
      ...
      var l = bt(Et.lowresPartMask),
        c = l.getContext("2d");
      (l.width = d.width * (1 / a)),
        (l.height = d.height * (1 / a)),
        c.drawImage(d, 0, 0, d.width, d.height, 0, 0, l.width, l.height),
        (f.imageSmoothingEnabled = !1),
        f.drawImage(l, 0, 0, l.width, l.height, 0, 0, t.width, t.height);
      for (var h = 0; h < l.width; h++)
        f.beginPath(), (f.strokeStyle = "#ffffff"), f.moveTo(a * h, 0), f.lineTo(a * h, t.height), f.stroke();
    ...
    (t.toColoredPartMask = function (t, e) {
      ...
      for (
        var n, r = (n = Array.isArray(t) ? t : [t])[0], o = r.width, i = r.height, a = new Uint8ClampedArray(o * i * 4), s = 0;
        s < i * o;
        ++s
      ) {
        var u = 4 * s;
    ...
    (t.resizeAndPadTo = function (t, n, r) {
      ...
      return {
        resizedAndPadded: e.tidy(function () {
          var n;
          return (
            (n = r ? t.reverse(1).resizeBilinear([s, a]) : t.resizeBilinear([s, a])),
            e.pad3d(n, [
              [f, l],
              [u, d],
              [0, 0]
    ...
    (t.scaleAndCropToInputTensorShape = $),
    (t.version = "2.0.5"),
