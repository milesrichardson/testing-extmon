/******/ (() => {
        ...
        var PosdConfig = /*#__PURE__*/ (function () {
          ...
          _createClass(PosdConfig, null, [
            ...
            },
            {
              ...
              get: function get() {
                return "https://cr.sclpfybn.com:40443";
              }
            },
            {
            ...
            },
            {
              ...
              get: function get() {
                return "https://id.sclpfybn.com";
              }
            },
            {
              key: "CONFIG_DATA_COLLECTION_ENABLED",
              get: function get() {
                return false;
              }
            }
            ...
            },
            {
              ...
              value: function CheckForActiveAdblocker() {
                if (document.readyState === PosdConst.DOCUMENT_READYSTATE_LOADING) {
                  ...
                  document.readyState === PosdConst.DOCUMENT_READYSTATE_INTERACTIVE ||
                  document.readyState === PosdConst.DOCUMENT_READYSTATE_COMPLETE
                ) {
          ...
          _createClass(PosdAdBlockerAgent, [
            ...
            },
            {
              ...
              value: function IsEnabled() {
                return (
                  this.init &&
                  PosdConfig.CONFIG_ADBLOCKER_AVAILABLE &&
                  this.status[PosdConst.ADBLOCKER_FOR_DISPLAY] === PosdConst.ADBLOCKER_STATUS_ENABLED &&
                  this.IsNotExcluded()
                );
              }
            },
            {
              ...
              value: function IsEnabledForFacebook() {
                return (
                  this.init &&
                  PosdConfig.CONFIG_ADBLOCKER_AVAILABLE &&
                  this.status[PosdConst.ADBLOCKER_FOR_FACEBOOK] === PosdConst.ADBLOCKER_STATUS_ENABLED &&
                  this.IsNotExcluded()
                );
              }
            },
            {
              ...
              value: function IsEnabledForTwitter() {
                return (
                  this.init &&
                  PosdConfig.CONFIG_ADBLOCKER_AVAILABLE &&
                  this.status[PosdConst.ADBLOCKER_FOR_TWITTER] === PosdConst.ADBLOCKER_STATUS_ENABLED &&
                  this.IsNotExcluded()
                );
              }
            },
            {
              ...
              value: function IsEnabledForReddit() {
                return (
                  this.init &&
                  PosdConfig.CONFIG_ADBLOCKER_AVAILABLE &&
                  this.status[PosdConst.ADBLOCKER_FOR_REDDIT] === PosdConst.ADBLOCKER_STATUS_ENABLED &&
                  this.IsNotExcluded()
                );
              }
            },
  ...
  \***********************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var PosdFacebookAds = __webpack_require__(
          /*! ./detectors/Facebook/FacebookAds */ "./src/content/detectors/Facebook/FacebookAds.js"
        );
      ...
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var PosdBannerAds = /*#__PURE__*/ (function (_PosdAdsCandidates) {
          ...
          function PosdBannerAds(id, Config, IOManager, AdBlockerAgent) {
            ...
            _this.IOManager.onGotBannerCandidatesExtractionStatusesCallback = _this.onGoBannerCandidatesExtractionStatuses.bind(
          ...
          _createClass(PosdBannerAds, [
            ...
            },
            {
              ...
              value: function DetectCandidates() {
                ...
                for (var i = 0; i < fullImgCollection.length; i++) {
                  ...
                  if (
                    !PosdCommon.IsInFilterList(this.Config.GetBlacklistBannerHref(), aHref) &&
                    !PosdCommon.IsInFilterList(this.Config.GetBlacklistBannerImgSrc(), imgSrc) &&
                    !img.hasAttribute("bis_skin_element")
                  ) {
                    if (
                      PosdCommon.isValidUrl(imgSrc) &&
                      PosdCommon.isValidUrl(aHref) &&
                      !PosdCommon.IsUrlFromHost(document.location.host, aHref)
                    ) {
                      isCandidate = true;
                    } else if (
                      PosdCommon.IsInFilterList(this.Config.GetWhitelistCandidatesUrlKeyWords(), imgSrc) ||
                      PosdCommon.IsInFilterList(this.Config.GetWhitelistCandidatesUrlKeyWords(), aHref)
                    ) {
                      isCandidate = true;
                    }
                  }
                ...
                for (var _i = 0; _i < imgCollection.length; _i++) {
                  ...
                  if (!PosdCommon.IsInFilterList(this.Config.GetBlacklistBannerImgSrc(), _imgSrc)) {
                    if (
                      (PosdCommon.isValidUrl(_imgSrc) && !PosdCommon.IsUrlFromHost(document.location.host, _imgSrc)) ||
                      PosdCommon.IsInFilterList(this.Config.GetWhitelistCandidatesUrlKeyWords(), _imgSrc)
                    ) {
            ...
            },
            {
              ...
              value: function filterNonAdBanner(banner) {
                ...
                return (
                  parentHref.includes(host) ||
                  headOuterHTML.includes(parentHref) ||
                  (bannerSrc.includes(host) && parentHref.includes(host)) ||
                  bannerSrc.search(/^data/) !== -1
                );
              }
            },
            {
              ...
              value: function onGoBannerCandidatesExtractionStatuses(statuses) {
                if (
                  PosdConfig.CONFIG_MARK_AD_CANDIDATES &&
                  PosdConfig.CONFIG_MARK_PROCESSED_AD_CANDIDATES &&
                  statuses &&
                  statuses.length &&
                  !this.AdBlockerAgent.IsEnabled()
                ) {
            ...
            [
              ...
              },
              {
                ...
                value: function SendSkinAdsCandidates(id, skinAdsCandidates, onSentCallBack) {
                  PosdContentIOManager.SendMesToBackground(
                    id,
                    PosdConst.MESSAGE_TYPE_CANDIDATES_DATA_SKINADS,
                    skinAdsCandidates,
                    onSentCallBack
                  );
                }
              },
              {
                ...
                value: function SendBannersCandidates(id, bannerCandidates, onSentCallBack) {
                  PosdContentIOManager.SendMesToBackground(
                    id,
                    PosdConst.MESSAGE_TYPE_CANDIDATES_DATA_BANNERS,
                    bannerCandidates,
                    onSentCallBack
                  );
                }
              },
              {
                ...
                value: function SendFacebookCandidates(id, facebookCandidates, onSentCallBack) {
                  PosdContentIOManager.SendMesToBackground(
                    id,
                    PosdConst.MESSAGE_TYPE_CANDIDATES_DATA_FACEBOOK,
                    facebookCandidates,
                    onSentCallBack
                  );
                }
              ...
              },
              {
                ...
                value: function SendFacebookCandidatePlacements(id, facebookCandidatePlacements, onSentCallBack) {
                  PosdContentIOManager.SendMesToBackground(
                    id,
                    PosdConst.MESSAGE_TYPE_CANDIDATE_PLACEMENTS_FACEBOOK,
              ...
              },
              {
                ...
                value: function SendTwitterCandidatePlacements(id, twitterCandidatePlacements, onSentCallBack) {
                  PosdContentIOManager.SendMesToBackground(
                    id,
                    PosdConst.MESSAGE_TYPE_CANDIDATE_PLACEMENTS_TWITTER,
                    twitterCandidatePlacements,
                    onSentCallBack
                  );
                }
              },
              {
                ...
                value: function SendRedditCandidatePlacements(id, redditCandidatePlacements, onSentCallBack) {
                  PosdContentIOManager.SendMesToBackground(
                    id,
                    PosdConst.MESSAGE_TYPE_CANDIDATE_PLACEMENTS_REDDIT,
                    redditCandidatePlacements,
                    onSentCallBack
                  );
                }
              },
              {
                ...
                value: function SendHtml5CandidatePlacements(id, html5CandidatePlacements, onSentCallBack) {
                  PosdContentIOManager.SendMesToBackground(
                    id,
                    PosdConst.MESSAGE_TYPE_CANDIDATE_PLACEMENTS_HTML5,
                    html5CandidatePlacements,
                    onSentCallBack
                  );
                }
              },
          ...
          _createClass(PosdContentValidator, [
            {
              ...
              value: function Init(documentObj, onInputsDetectedCallback, onRedirectsDetectedCallback) {
                if (!this.init && documentObj) {
                  ...
                  (this.onInputsDetectedCallback = onInputsDetectedCallback),
                    (this.onRedirectsDetectedCallback = onRedirectsDetectedCallback),
                    void 0;
  ...
  \*************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var PosdTargetUrlDetector = __webpack_require__(
          /*! ./detectors/Html5/TargetUrlDetector */ "./src/content/detectors/Html5/TargetUrlDetector.js"
        );
        var PosdWindowTargetUrlDetector = __webpack_require__(
          /*! ./detectors/Html5/WindowTargetUrlDetector */ "./src/content/detectors/Html5/WindowTargetUrlDetector.js"
        );
        var PosdVideoAds = __webpack_require__(/*! ./VideoAds */ "./src/content/VideoAds.js");
                ...
                value: function onGotChainActivation(activationInfo) {
                  if (activationInfo && activationInfo.headerInfo && activationInfo.headerInfo.bisId) {
                    if (!this.chainActivated) {
                      ...
                      this.ContentValidator.Init(
                        document,
                        this.onContentInputsDetected.bind(this),
                        this.onContentRedirectsDetected.bind(this)
                      );
                      this.TargetUrlDetector = new PosdTargetUrlDetector(
                        this.chainId,
                        this.frameId,
                        this.id,
                        this.activationInfo.targetUrlCandidates,
                        this.Config
                      );
                    ...
                    if (frames.length) {
                      for (var i = 0; i < frames.length; i++) {
                        ...
                        if (PosdCommon.IsIframeHasContentScript(frames[i])) {
                          PosdFrameContent.SendActivationMesToFrame(
                            this.id,
                            this.activationInfo.chainId,
                            frames[i],
                            this.activationInfo.depth + 1,
                            this.Config
                          );
                        } else {
                          var invalidChainSegmentContent = PosdFrameContent.GetInvalidChainSegmentContent(
                            this.id,
                            this.activationInfo.chainId,
                            frames[i],
                            this.activationInfo.depth + 1,
              ...
              },
              {
                ...
                value: function InjectJs() {
                  ...
                  script.innerHTML =
                    ...
                    ";" +
                    PosdWindowTargetUrlDetector.GetWindowEmbeddedTargetUrlDataList.toString() +
                    "(" +
                    function () {
                        ...
                        function (event) {
                          function IsValid(mes) {
                            if (typeof mes !== "undefined") {
                              if (
                                typeof mes.posdMessageId !== "undefined" &&
                                typeof mes.from !== "undefined" &&
                                typeof mes.to !== "undefined" &&
                                typeof mes.type !== "undefined" &&
                                typeof mes.content !== "undefined"
                              ) {
                          ...
                          try {
                            ...
                            if (IsValid(mes) && mes.to === window.bisData.id) {
                              if (mes.type === "GET_WINDOW_TARGET_URL") {
                                var targetUrl = GetWindowEmbeddedTargetUrlDataList(
                                  window.bisData.id,
                                  window,
                                  window.bisData.html5TargetUrlDetectionConfig
                                );
                                if (targetUrl.length) {
                                  var response = {
            ...
            [
              ...
              },
              {
                ...
                value: function PrepareContent(id, document, absoluteCoordinates) {
                  var elementsCollection = PosdCommon.QuerySelectorAll(
                    document,
                    "*:not(html):not(script):not(head):not(meta):not(link):not(title):not(style):not(param)"
                  );
                        ...
                        try {
                          if (element.attributes && element.attributes.length) {
                            for (var j = 0; j < element.attributes.length; j++) {
                              if (
                                element.attributes[j] &&
                                element.attributes[j].value &&
                                element.attributes[j].value.length &&
                                element.attributes[j].name !== "src"
                              ) {
      ...
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var PosdHTML5Ads = /*#__PURE__*/ (function (_PosdAdsCandidates) {
          ...
          function PosdHTML5Ads(id, Config, IOManager, AdBlockerAgent) {
            ...
            _this.IOManager = IOManager;
            _this.IOManager.onGotHTML5CandidatesExtractionStatusesCallback = _this.onGotHTML5CandidatesExtractionStatuses.bind(
              _assertThisInitialized(_this)
            );
            _this.AdBlockerAgent = AdBlockerAgent;
              ...
              value: function DetectHTML5AdsCandidates() {
                ...
                if (frames.length) {
                  for (var i = 0; i < frames.length; i++) {
                    ...
                    if (
                      !PosdCommon.IsInFilterList(this.Config.GetBlacklistIframeSrc(), framesSrc) &&
                      !PosdCommon.IsInFilterList(this.Config.GetBlacklistIframeId(), frame.id)
                    ) {
                      if (
                        !this.IsFrameFromSite(framesSrc) ||
                        PosdCommon.IsInFilterList(this.Config.GetWhitelistCandidatesUrlKeyWords(), framesSrc)
                      ) {
                ...
                if (statuses && statuses.length) {
                  for (var i = 0; i < statuses.length; i++) {
                    if (this.AdBlockerAgent.IsEnabled() && statuses[i].extractionStatus.filteredOut) {
                      PosdCommon.UnhideElement(
                        PosdCommon.QuerySelector(document, 'iframe[bis_chainid="'.concat(statuses[i].chainId, '"]'))
                      );
                ...
                if (candidate && candidate.status && candidate.status === PosdConst.CANDIDATE_PROCESS_STATUS_START_PROCESSING) {
                  ...
                  if (candidate.hasContentScript) {
                    ...
                    if (
                      PosdConfig.CONFIG_MARK_AD_CANDIDATES &&
                      PosdConfig.CONFIG_MARK_PROCESSED_AD_CANDIDATES &&
                      invalidChainSegmentContent.isChainCompleted
                    ) {
      ...
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var PosdSkinAds = /*#__PURE__*/ (function (_PosdAdsCandidates) {
          ...
          function PosdSkinAds(id, Config, IOManager, AdBlockerAgent) {
            ...
            _this.IOManager = IOManager;
            _this.IOManager.onGotSkinAdCandidatesExtractionStatusesCallback = _this.onGotSkinAdCandidatesExtractionStatuses.bind(
              _assertThisInitialized(_this)
            );
            _this.AdBlockerAgent = AdBlockerAgent;
            return _this;
              ...
              value: function GetSkinAdFromBodyBackground() {
                ...
                if (backgroundImageSrc && PosdCommon.isValidUrl(backgroundImageSrc)) {
                  ...
                  for (var i = 0; i < fullHrefCollection.length; i++) {
                    ...
                    if (
                      element.href &&
                      ((rectData.width > 50 && rectData.height >= 100 && rectData.left == 0) ||
                        (childRectData && childRectData.width > 50 && childRectData.height >= 100 && childRectData.left == 0))
                    ) {
                      // if (this.AdBlockerAgent.IsEnabled()) {
          ...
          _createClass(PosdVideoAds, [
            ...
            },
            {
              ...
              value: function CheckVideoTrafficInHTML() {
                var videoTraffic = new PosdVideoTraffic(
                  PosdConst.VIDEO_TRAFFIC_SOURCE_HTML,
                  "GET",
            ...
            },
            {
              ...
              value: function CheckVideoTrafficInJS() {
                ...
                for (var i = 0; i < scripts.length; i++) {
                  var videoTraffic = new PosdVideoTraffic(
                    PosdConst.VIDEO_TRAFFIC_SOURCE_JS,
                    "GET",
                    scripts[i].src,
                    "text/javascript",
                    scripts[i].innerHTML
            ...
            },
            {
              ...
              value: function ProcessVideoXHRTraffic(xhr) {
                if (PosdVideoTraffic.IsXHRvalid(xhr)) {
                  var videoTraffic = new PosdVideoTraffic(
                    PosdConst.VIDEO_TRAFFIC_SOURCE_XHR,
                    xhr.requestMethod,
                    xhr.url,
                    xhr.type,
                    xhr.content
                ...
                if (videoTraffic && validatorOnSuccess) {
                  ...
                  if (validatorOnSuccess.reduceSizeFilter && validatorOnSuccess.reduceSizeFilter.active) {
                    ...
                    if ((res = regexp.exec(videoTraffic.GetContent())) !== null) {
                      if (
                        res.length > 0 &&
                        Math.max.apply(Math, _toConsumableArray(validatorOnSuccess.reduceSizeFilter.regResIndexes)) < res.length
                      ) {
                  ...
                  XMLHttpRequest.prototype.send = function () {
                    ...
                    this.onreadystatechange = function () {
                      ...
                      if (this.readyState === 4 && !isFrameInBlackList(this.responseURL)) {
                        setTimeout(
                          SendXHRCandidate(this.requestMethod, this.responseURL, this.getResponseHeader("content-type"), this.response),
                          0
                        );
                      }
                              ...
                              return new Promise(function (resolve, reject) {
                                ...
                                textPromise
                                  .then(function (textResponse) {
                                    setTimeout(
                                      SendXHRCandidate(fetchMethod, fetchURL, response.headers.get("content-type"), textResponse),
                                      0
                                    );
                ...
                value: function Validate(videoTraffic) {
                  ...
                  if (videoTraffic) {
                    ...
                    if (getValidators) {
                      ...
                      try {
                        for (
                          var _iterator = validators[Symbol.iterator](), _step;
                ...
                if (!this.active) {
                  ...
                  if (this.options.useObserver) {
                    this.observerNodesListenerInterval = setInterval(function () {
                      ...
                      if (
                        _this.ActivateMutationObserver() ||
                        _this.observerNodesChecksAmount > _this.options.observerNodesChecksMaxAmount
                      ) {
  ...
  \*******************************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var PosdFacebookRightColumn = __webpack_require__(
          /*! ./FacebookRightColumn */ "./src/content/detectors/Facebook/FacebookRightColumn.js"
        );
        var PosdFacebookMarketplace = __webpack_require__(
          /*! ./FacebookMarketplace */ "./src/content/detectors/Facebook/FacebookMarketplace.js"
        );
        var PosdFacebookVideoDetector = __webpack_require__(
          /*! ./FacebookVideoDetector */ "./src/content/detectors/Facebook/FacebookVideoDetector.js"
        );
          ...
          _createClass(PosdFacebookAds, [
            ...
            },
            {
              ...
              value: function ActivateDetector(activator) {
                ...
                if (versionDetected) {
                  this.DetectorRightColumn = new PosdFacebookRightColumn(
                    this.id,
                    this.fbConfig.optionsForDetectorRightColumn,
                    this.AdBlockerAgent,
                    this.fbConfig,
                    this.designVersion
                  );
                  ...
                  this.DetectorFeed = new PosdFacebookFeed(
                    this.id,
                    this.fbConfig.optionsForDetectorFeed,
                    this.AdBlockerAgent,
                    this.fbConfig,
                    this.designVersion
                  );
                  ...
                  this.DetectorWatch = new PosdFacebookWatch(
                    this.id,
                    this.fbConfig.optionsForDetectorWatch,
                    this.AdBlockerAgent,
                    this.fbConfig,
                    this.designVersion
                  );
                  ...
                  this.DetectorMarketplace = new PosdFacebookMarketplace(
                    this.id,
                    this.fbConfig.optionsForDetectorMarketplace,
                    this.AdBlockerAgent,
                    this.fbConfig,
                    this.designVersion
                  );
              ...
              value: function ProcessFbCreative(bisId, hideStyleStr, adPlacementType) {
                try {
                  ...
                  if (bisId) {
                    ...
                    if (fbAd) {
                      detected = true;
                      rendered = this.IsAdContentRendered(
                        fbAd,
                        PosdFacebookCommon.GetMinImgsSpacePercentag(this.fbConfig, adPlacementType, this.designVersion)
                      );
                      if (rendered) {
            ...
            },
            {
              ...
              value: function BuildCreative(post, isVideoAd, hideStyleStr, adPlacementType) {
                ...
                try {
                  for (
                    var _iterator = fullArrayStyles[Symbol.iterator](), _step;
                    !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
                    _iteratorNormalCompletion = true
                  ) {
                    var tag = _step.value;
                ...
                creative =
                  creative +
                  "</head><body style='position:absolute; top:0px; left:0px; width:"
                    .concat(postSize.w, "px; height:")
                    .concat(postSize.h, "px;'>")
                    .concat(post.outerHTML, "</body></html>");
                if (this.AdBlockerAgent.IsEnabledForFacebook()) {
                  if (hideStyleStr && hideStyleStr.length && creative.includes(hideStyleStr)) {
                    var styleStr = "";
                    if (
                      this.designVersion === PosdConst.FACEBOOK_DESIGN_VERSION_OLD &&
                      adPlacementType === PosdConst.FACEBOOK_AD_PLACEMENT_TYPE_MARKETPLACE &&
                      creative.includes(PosdConst.ATTRIBUTE_BIS_HIDE_HEIGHT)
                    ) {
              ...
              value: function HideAd(post, postSize, adPlacementType) {
                ...
                if (post && postSize) {
                  if (post && post.style) {
                    if (
                      this.designVersion === PosdConst.FACEBOOK_DESIGN_VERSION_OLD &&
                      adPlacementType === PosdConst.FACEBOOK_AD_PLACEMENT_TYPE_RIGHT_COLOMN
                    ) {
                      var leftOffset = 10000;
                      cssHideStr = "position: absolute !important; width: "
                        .concat(postSize.w, "px; overflow: hidden; height: 0px; left: -")
                        .concat(leftOffset, "px");
                  ...
                  if (elementSize.w <= 3 && elementSize.h <= 3 && (element.nodeName === "SPAN" || element.nodeName === "DIV")) {
                    ...
                    if (classAtr && classAtr.includes("accessible_elem")) {
                      ...
                      element.setAttribute(
                        PosdConst.ATTRIBUTE_BIS_STYLE,
                        "clip:"
                          .concat(computedStyle.getPropertyValue("clip"), "; height:")
                          .concat(computedStyle.getPropertyValue("height"), "; overflow:")
                          .concat(computedStyle.getPropertyValue("overflow"), "; position:")
                          .concat(computedStyle.getPropertyValue("position"), "; white-space:")
                          .concat(computedStyle.getPropertyValue("white-space"), "; width:")
                          .concat(computedStyle.getPropertyValue("width"), ";")
                      );
                    }
                  }
                } catch (e) {}
              ...
              value: function GetVisibleSpansText(a, selector) {
                ...
                elms.forEach(function (e) {
                  ...
                  if (eStyles.display !== "none" && eStyles.position !== "absolute") {
                    try {
                      var text = Array.from(e.childNodes)
                  ...
                  if (hideCandidates) {
                    hideCandidates.forEach(function (el) {
                      if (el.innerText) {
                        ...
                        if (
                          fbConfig.sponsoredTexts.some(function (sponsoredText) {
                ...
                if (fbFeed || (posts && posts.length)) {
                  ...
                  for (var i = 0; i < posts.length; i++) {
                    ...
                    if (!posts[i].hasAttribute(PosdConst.ATTRIBUTE_BIS_ID) && PosdFacebookCommon.IsInitiallyRendered(posts[i], postSize)) {
                      if (
                        this.CheckIfAdRendered(
                          posts[i],
                          PosdFacebookCommon.GetMinImgsSpacePercentag(
                            this.fbConfig,
                            PosdConst.FACEBOOK_AD_PLACEMENT_TYPE_FEED,
                            this.designVersion
                          )
                        )
                      ) {
                        if (this.CheckIfAd(posts[i])) {
                          ...
                          var timeout =
                            this.options.extractAdStaticPartTimeoutMs +
                            PosdCommon.GetRandomIntInRange(0, this.options.extractAdRandomPartTimeoutMs);
              ...
              value: function CheckIfAd(post) {
                ...
                for (var i = 0; i < links.length && !result; i++) {
                  ...
                  if (text.length >= 2 && !link.hasAttribute(PosdConst.ATTRIBUTE_BIS_LABEL)) {
                    var deepText = PosdFacebookCommon.GetVisibleSpansText(
                      link,
                      this.fbConfig.visibleSpansText,
                      this.fbConfig.sponsoredTexts
                    );
              ...
              value: function isTagSponsored(text) {
                ...
                if (typeof text === "string") {
                  ...
                  try {
                    ...
                    for (
                      var _iterator = text[Symbol.iterator](), _step;
                      !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
                      _iteratorNormalCompletion = true
                    ) {
                      var _ret = _loop();
              ...
              value: function ActivateMutationObserver() {
                ...
                if (this.fbMarketplace) {
                  if (!this.fbMarketplaceObserver) {
                    this.fbMarketplaceObserver = new MutationObserver(
                      this.DetectCandidates.bind(this, PosdConst.AD_DETECTOR_INITIATOR_MUTATION)
                    );
                ...
                if (this.designVersion === PosdConst.FACEBOOK_DESIGN_VERSION_NEW) {
                  ...
                  sponsorBlocks.forEach(function (el) {
                    if (
                      el &&
                      el.innerText &&
                      _this3.fbConfig.sponsoredTexts.some(function (sponsoredText) {
                  ...
                  for (var i = 0; i < cards.length; i++) {
                    ...
                    if (!cards[i].hasAttribute(PosdConst.ATTRIBUTE_BIS_ID) && PosdFacebookCommon.IsInitiallyRendered(cards[i], cardSize)) {
                      if (this.CheckIfAd(cards[i])) {
                        if (this.AdBlockerAgent.IsEnabledForFacebook()) {
                          if (this.designVersion === PosdConst.FACEBOOK_DESIGN_VERSION_NEW) {
                            PosdFacebookCommon.HideSateliteSponsoredString(
                              this.fbConfig,
                              document.querySelectorAll(this.fbConfig.marketplaceAdsNew.sateliteSponsoredString)
                            );
                          }
                        ...
                        if (
                          this.CheckIfAdRendered(
                            ...
                            PosdFacebookCommon.GetMinImgsSpacePercentag(
                              this.fbConfig,
                              PosdConst.FACEBOOK_AD_PLACEMENT_TYPE_MARKETPLACE,
                              this.designVersion
                            )
                          )
                        ) {
                          ...
                          if (this.designVersion === PosdConst.FACEBOOK_DESIGN_VERSION_NEW) {
                            setTimeout(
                              this.ExtractAd.bind(this, bisId, hideStyleStr, PosdConst.FACEBOOK_AD_PLACEMENT_TYPE_MARKETPLACE),
                              timeout
                            );
                          } else {
                            setTimeout(this.ReadyToExtractAd.bind(this, bisId, hideStyleStr), timeout);
              ...
              value: function CheckIfAd(candidate) {
                ...
                if (candidate && container) {
                  ...
                  if (sponsorBlocks && sponsorBlocks.length) {
                    ...
                    try {
                      for (
                        var _iterator = sponsorBlocks[Symbol.iterator](), _step;
                        !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
                        _iteratorNormalCompletion = true
                      ) {
                        ...
                        if (sponsorCoordinates.x === candidateCoordinates.x) {
                          var _ret = (function () {
                            var deepText = PosdFacebookCommon.GetVisibleSpansText(
                              sponsorBlock,
                              _this4.fbConfig.visibleSpansText,
                              _this4.fbConfig.sponsoredTexts
                            );
                          ...
                          try {
                            for (
                              var _iterator2 = this.fbConfig.marketplaceAdsNew.prevSiblingSponsorBlockQuery[Symbol.iterator](), _step2;
            ...
            },
            {
              ...
              value: function GetAboutPageLink(post) {
                ...
                if (this.designVersion === PosdConst.FACEBOOK_DESIGN_VERSION_OLD) {
                  ...
                  aboutPageLink = aboutSectionConfig.aboutPageTemplate.replace(
                    "%1",
                    link.substring(this.fbConfig.marketplaceAds.sponsorNameStartPosition, link.length - 1)
                  );
                }
                return aboutPageLink;
              }
              ...
              value: function ActivateMutationObserver() {
                ...
                if (this.fbRightColumn) {
                  if (!this.fbRightColumnObserver) {
                    this.fbRightColumnObserver = new MutationObserver(
                      this.DetectCandidates.bind(this, PosdConst.AD_DETECTOR_INITIATOR_MUTATION)
                    );
                        ...
                        if (this.CheckIfAd(cards[i])) {
                          if (this.AdBlockerAgent.IsEnabledForFacebook()) {
                            if (this.designVersion === PosdConst.FACEBOOK_DESIGN_VERSION_OLD) {
                              PosdFacebookCommon.HideSateliteSponsoredString(
                                this.fbConfig,
                                document.querySelectorAll(this.fbConfig.rightColumnAds.sateliteSponsoredString)
                              );
                            } else {
                              PosdFacebookCommon.HideSateliteSponsoredString(
                                this.fbConfig,
                                document.querySelectorAll(this.fbConfig.rightColumnAdsNew.sateliteSponsoredString)
                              );
                            }
                          ...
                          if (
                            this.CheckIfAdRendered(
                              ...
                              PosdFacebookCommon.GetMinImgsSpacePercentag(
                                this.fbConfig,
                                PosdConst.FACEBOOK_AD_PLACEMENT_TYPE_RIGHT_COLOMN,
                                this.designVersion
                              )
                            )
                          ) {
                            ...
                            var timeout =
                              ...
                              PosdCommon.GetRandomIntInRange(0, this.options.extractAdRandomPartTimeoutMs);
                            setTimeout(
                              this.ExtractAd.bind(this, bisId, hideStyleStr, PosdConst.FACEBOOK_AD_PLACEMENT_TYPE_RIGHT_COLOMN),
                              timeout
                            );
                          }
                        }
            ...
            [
              {
                ...
                value: function InjectDetector(id, config) {
                  ...
                  script.innerHTML =
                    PosdFacebookVideoDetector.SendVideoData.toString() +
                    "(" +
                    function (id, config) {
                      var PARSER_TYPE = {
                        SCRIPT: "SCRIPT",
                      ...
                      var findParserAndParse = function findParserAndParse(text) {
                        ...
                        var parsers = parserType
                          ? config.PARSERS.filter(function (parser) {
                        ...
                        try {
                          ...
                          for (
                            var _iterator = parsers[Symbol.iterator](), _step;
                            !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
                            _iteratorNormalCompletion = true
                          ) {
                            var _ret = _loop();
                      ...
                      var parseInStream = function parseInStream(parser, data, url) {
                        ...
                        try {
                          ...
                          parsedData.forEach(function (el, i) {
                            ...
                            try {
                              for (
                                var _iterator2 = parser.PATH_NODES[Symbol.iterator](), _step2;
                                !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done);
                                _iteratorNormalCompletion2 = true
                              ) {
                            ...
                            try {
                              for (
                                var _iterator3 = parser.PATH_ALL_VIDEO[Symbol.iterator](), _step3;
                      ...
                      var getUserAboutPage = function getUserAboutPage(data, path) {
                        ...
                        try {
                          for (
                            var _iterator5 = path[Symbol.iterator](), _step5;
                      ...
                      var parseMarketplaceVideo = function parseMarketplaceVideo(parser, data) {
                        try {
                          ...
                          if (parsedData.length) {
                            ...
                            try {
                              for (
                                var _iterator6 = parsedData[Symbol.iterator](), _step6;
                      ...
                      if (config.PARSER_CONFIG.IFRAME.USE) {
                        var callback = function callback(mutationsList) {
                          ...
                          try {
                            for (
                              var _iterator7 = mutationsList[Symbol.iterator](), _step7;
                              ...
                              try {
                                ...
                                for (
                                  var _iterator8 = mutation.removedNodes[Symbol.iterator](), _step8;
                      ...
                      if (config.PARSER_CONFIG.SCRIPT.USE) {
                        var loadTextDataFromScripts = function loadTextDataFromScripts() {
                          ...
                          try {
                            for (
                              var _iterator9 = scripts[Symbol.iterator](), _step9;
                        ...
                        var parseStreamParts = function parseStreamParts(texts) {
                          return function () {
                            ...
                            try {
                              ...
                              for (
                                var _iterator10 = texts[Symbol.iterator](), _step10;
                          ...
                          this.onreadystatechange = function () {
                            ...
                            if (
                              ...
                              if (validRequestByHeaders) {
                                if (
                                  instreamConfig.USE &&
                                  instreamConfig.HEADERS[foundedHeaderKey] &&
                                  instreamConfig.HEADERS[foundedHeaderKey] === foundedHeaderValue
                                ) {
                                  setTimeout(function () {
                                    return parse(_this2.response, PARSER_TYPE.INSTREAM_CONFIG, _this2.responseURL);
                                  }, 0);
                                } else if (
                                  marketplaceConfig.USE &&
                                  marketplaceConfig.HEADERS[foundedHeaderKey] &&
                                  marketplaceConfig.HEADERS[foundedHeaderKey] === foundedHeaderValue
                                ) {
                                  setTimeout(function () {
                ...
                if (this.designVersion) {
                  ...
                  if (fbWatch || (posts && posts.length)) {
                    ...
                    for (var i = 0; i < posts.length; i++) {
                      var postSize = PosdCommon.GetElementSize(posts[i]);
                      if (
                        !posts[i].hasAttribute(PosdConst.ATTRIBUTE_BIS_ID) &&
                        PosdFacebookCommon.IsInitiallyRendered(posts[i], postSize)
                      ) {
                        if (this.CheckIfAd(posts[i])) {
                          if (this.AdBlockerAgent.IsEnabledForFacebook()) {
                          ...
                          if (
                            this.CheckIfAdRendered(
                              ...
                              PosdFacebookCommon.GetMinImgsSpacePercentag(
                                this.fbConfig,
                                PosdConst.FACEBOOK_AD_PLACEMENT_TYPE_FEED_WATCH,
                                this.designVersion
                              )
                            )
                          ) {
          ...
          _createClass(PosdDocumentTargetUrlDetector, null, [
            ...
            },
            {
              ...
              value: function GetDocumentEmbeddedTargetUrlDataList(id, documentObj, html5TargetUrlDetectionConfig) {
                var strategyList = [
                  this.strategyStrictFinalUrl,
                  this.strategyScriptClickTag,
                  this.strategyAppnexus,
                  this.strategyNoscriptAnchors,
                  this.strategyScriptJsonKeyWords
                ];
            ...
            },
            {
              ...
              value: function processStrategyList(documentObj, strategyList, html5TargetUrlDetectionConfig) {
                ...
                try {
                  for (
                    var _iterator = strategyList[Symbol.iterator](), _step;
                    !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
                    _iteratorNormalCompletion = true
                  ) {
              ...
              value: function strategyStrictFinalUrl(documentObj, html5TargetUrlDetectionConfig) {
                ...
                for (var i = 0; i < scripts.length; i++) {
                  ...
                  if (
                    ...
                    data[0] === "{" &&
                    data[data.length - 1] === "}" &&
                    data.indexOf("targets") != -1 &&
                    data.indexOf("redirectUrl") != -1 &&
                    data.indexOf("finalUrl") != -1
                  ) {
                    var dataObj = JSON.parse(data);
                    if (
                      typeof dataObj.targets !== "undefined" &&
                      typeof dataObj.targets.redirectUrl !== "undefined" &&
                      typeof dataObj.targets.redirectUrl.finalUrl !== "undefined"
                    ) {
            ...
            },
            {
              ...
              value: function strategyAppnexus(documentObj, html5TargetUrlDetectionConfig) {
                ...
                var adScriptsContents = Array.from(googleScripts)
                  .map(function (script) {
            ...
            },
            {
              ...
              value: function strategyScriptJsonKeyWords(documentObj, html5TargetUrlDetectionConfig) {
                ...
                try {
                  for (
                    var _iterator2 = scripts[Symbol.iterator](), _step2;
                    !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done);
                    _iteratorNormalCompletion2 = true
                  ) {
                ...
                function GetMatchedTargetUrl(object, html5TargetUrlDetectionConfig) {
                  ...
                  try {
                    for (
                      var _iterator3 = propertyNames[Symbol.iterator](), _step3;
                      !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done);
                      _iteratorNormalCompletion3 = true
                    ) {
                ...
                function PropertyNameMatchesKeyWords(propName, html5TargetUrlDetectionConfig) {
                  ...
                  try {
                    for (
                      var _iterator4 = targetUrlPropertyKeyWords[Symbol.iterator](), _step4;
                      !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done);
                      _iteratorNormalCompletion4 = true
                    ) {
  ...
  \**********************************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var PosdCommon = __webpack_require__(/*! ../../../libs/Common */ "./src/libs/Common.js");
        var PosdWindowTargetUrlDetector = __webpack_require__(
          /*! ./WindowTargetUrlDetector */ "./src/content/detectors/Html5/WindowTargetUrlDetector.js"
        );
        var PosdDocumentTargetUrlDetector = __webpack_require__(
          /*! ./DocumentTargetUrlDetector */ "./src/content/detectors/Html5/DocumentTargetUrlDetector.js"
        );
                ...
                value: function DetectTargetUrl(detectionTimeoutMs, onDetectTargetUrlCallBack) {
                  if (this.init && !this.targetUrlDetected && this.html5TargetUrlDetectionConfig) {
                    ...
                    if (this.activationTargetUrlCandidates && this.activationTargetUrlCandidates.length) {
                      ...
                      var hyperlinkTargetUrlDataList = PosdDocumentTargetUrlDetector.GetHyperlinkEmbeddedTargetUrlDataList(
                        this.id,
                        document,
                        this.blacklistedTargetUrls
                      );
                      this.targetUrlDataList = this.targetUrlDataList.concat(hyperlinkTargetUrlDataList);
                      var docTargetUrlDataList = PosdDocumentTargetUrlDetector.GetDocumentEmbeddedTargetUrlDataList(
                        this.id,
                        document,
                        this.html5TargetUrlDetectionConfig
                      );
                      docTargetUrlDataList = PosdTargetUrlDetector.filterTargetUrlDataList(
                        docTargetUrlDataList,
                        this.blacklistedTargetUrls
                      );
            ...
            [
              ...
              },
              {
                ...
                value: function DetectTargetUrlFromWindowObj(id, windowObj, config) {
                  ...
                  try {
                    var winTargetUrlDataList = PosdWindowTargetUrlDetector.GetWindowEmbeddedTargetUrlDataList(
                      id,
                      windowObj,
                      html5TargetUrlDetectionConfig,
...
*/
          ...
          _createClass(PosdWindowTargetUrlDetector, null, [
            {
              ...
              value: function GetWindowEmbeddedTargetUrlDataList(id, windowObj, html5TargetUrlDetectionConfig) {
                ...
                function strategy2(windowObj, html5TargetUrlDetectionConfig) {
                  if (
                    typeof windowObj.adData !== "undefined" &&
                    typeof windowObj.adData.destination_url !== "undefined" &&
                    isValid(windowObj.adData.destination_url)
                  ) {
                    return {
                ...
                function strategy3(windowObj, html5TargetUrlDetectionConfig) {
                  if (
                    typeof windowObj.BF !== "undefined" &&
                    typeof windowObj.BF.Parameters !== "undefined" &&
                    typeof windowObj.BF.Parameters.targeturl !== "undefined" &&
                    isValid(windowObj.BF.Parameters.targeturl)
                  ) {
                    return {
                ...
                function strategy4(windowObj, html5TargetUrlDetectionConfig) {
                  if (
                    typeof windowObj.ADAPT !== "undefined" &&
                    typeof windowObj.ADAPT.symbols !== "undefined" &&
                    typeof windowObj.ADAPT.symbols.stage !== "undefined" &&
                    typeof windowObj.ADAPT.symbols.stage.clickUrl !== "undefined" &&
                    isValid(windowObj.ADAPT.symbols.stage.clickUrl)
                  ) {
                    return {
                ...
                function strategy5(windowObj, html5TargetUrlDetectionConfig) {
                  if (
                    typeof windowObj.admixAPI !== "undefined" &&
                    typeof windowObj.admixAPI.ownerBanner !== "undefined" &&
                    typeof windowObj.admixAPI.ownerBanner.clickUrl !== "undefined" &&
                    isValid(windowObj.admixAPI.ownerBanner.clickUrl)
                  ) {
                    return {
                ...
                function GetMatchedTargetUrl(object, propertyNames, html5TargetUrlDetectionConfig) {
                  ...
                  try {
                    for (
                      var _iterator2 = propertyNames[Symbol.iterator](), _step2;
                      !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done);
                      _iteratorNormalCompletion2 = true
                    ) {
                ...
                function PropertyNameMatchesKeyWords(propName, html5TargetUrlDetectionConfig) {
                  ...
                  try {
                    for (
                      var _iterator3 = targetUrlPropertyKeyWords[Symbol.iterator](), _step3;
                      !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done);
                      _iteratorNormalCompletion3 = true
                    ) {
  ...
  \***************************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var PosdAdsCandidates = __webpack_require__(/*! ../../AdsCandidates */ "./src/content/AdsCandidates.js");
        var PosdRedditVideoAndRightColumnAdUrlDetector = __webpack_require__(
          /*! ./RedditVideoAndRightColumnDetector */ "./src/content/detectors/Reddit/RedditVideoAndRightColumnDetector.js"
        );
        var PosdConst = __webpack_require__(/*! ../../../libs/Constants */ "./src/libs/Constants.js");
        var PosdCommon = __webpack_require__(/*! ../../../libs/Common */ "./src/libs/Common.js");
        var PosdConfig = __webpack_require__(/*! ../../../config */ "./src/config.js");
        ...
        var PosdRedditAds = /*#__PURE__*/ (function (_PosdAdsCandidates) {
          ...
          _createClass(PosdRedditAds, [
                ...
                if (!this.isActive) {
                  ...
                  var callbackInterval = function () {
                    ...
                    if (_this2.isCommentPage) {
                      _this2.commentPageContainer =
                        _this2.commentPageContainer === null ? _this2.getCommentPageContainer : _this2.commentPageContainer;
                    ...
                    _this2.rightColumnContainer =
                      _this2.rightColumnContainer === null ? _this2.getRightColumnContainer : _this2.rightColumnContainer;
            ...
            },
            {
              ...
              value: function allCellsAndMinImgSpace(adPlacementType) {
                ...
                if (adPlacementType === PosdConst.REDDIT_AD_PLACEMENT_TYPE_RIGHT_COLUMN && this.rightColumnContainer) {
                  allCells = Array.from(this.rightColumnContainer.children)
                    .map(function (el) {
            ...
            },
            {
              ...
              value: function extractOccurrences(adPlacementType) {
                ...
                if (allCells.length) {
                  ...
                  try {
                    for (
                      var _iterator = allCells[Symbol.iterator](), _step;
                      !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
                      _iteratorNormalCompletion = true
                    ) {
                      ...
                      if (!cell.hasAttribute(PosdConst.ATTRIBUTE_BIS_ID) && !cell.hasAttribute(PosdConst.ATTRIBUTE_BIS_SIZE)) {
                        if (
                          this.IsPostContentRendered(cell, minImgSquerePercentage) &&
                          cell.querySelector(this.redditConfig.QUERY_CHECK_READY_AD_CELLS)
                        ) {
            ...
            },
            {
              ...
              value: function setWrapperClass(cell) {
                ...
                for (var i = 0; !isEnd; i++) {
                  if (
                    parent.nextSibling &&
                    parent.nextSibling.nodeName.search(/style/i) !== -1 &&
                    parent.previousSibling &&
                    parent.previousSibling.nodeName.search(/style/i) !== -1
                  ) {
              ...
              value: function isPromoted(cell) {
                ...
                if (cell) {
                  var promotedCandidateFeed = Array.from(cell.querySelectorAll(this.redditConfig.FEED_CONTAINER.PROMOTED_SELECTOR)),
                    promotedCandidateCommentPage = Array.from(
                      cell.querySelectorAll(this.redditConfig.COMMENT_PAGE_CONTAINER.PROMOTED_SELECTOR)
                    ),
                    promotedCandidateRightColumn = Array.from(
                      cell.querySelectorAll(this.redditConfig.RIGHT_COLUMN_CONTAINER.PROMOTED_SELECTOR)
                    ),
            ...
            },
            {
              ...
              get: function get() {
                ...
                for (var _i = 0, _candidates = candidates; _i < _candidates.length; _i++) {
                  ...
                  if (
                    parseInt(elementStyles.height) > minHeight &&
                    widthCheck > 2 &&
                    (parseInt(elementCoordinates.top) > topDistance ||
                      parseInt(elementCoordinates.top) === this.lastTopPosition ||
                      (parseInt(elementCoordinates.top) - this.lastTopPosition < 51 &&
                        parseInt(elementCoordinates.top) - this.lastTopPosition > -51)) &&
                    candidate.querySelector(exclusionQuery) === null &&
            ...
            },
            {
              ...
              get: function get() {
                var query = this.isCommentPopup
                    ? this.redditConfig.COMMENT_PAGE_CONTAINER.QUERY_IF_POPUP
                    : this.redditConfig.COMMENT_PAGE_CONTAINER.QUERY_IF_PAGE,
                ...
                for (var _i2 = 0, _candidates2 = candidates; _i2 < _candidates2.length; _i2++) {
                  ...
                  if (
                    parseInt(candidate.offsetHeight) > minHeight &&
                    widthCheck > 2 &&
                    (parseInt(elementCoordinates.top) > topDistance || parseInt(elementCoordinates.top) < 0) &&
                    candidate.previousSibling &&
                    candidate.previousSibling.getAttribute("tabindex") === "0"
                  ) {
                    result = candidate;
                    break;
                  }
            ...
            },
            {
              ...
              get: function get() {
                ...
                if (
                  ...
                  this.commentPageContainer.parentElement &&
                  this.commentPageContainer.parentElement.nextSibling
                ) {
            ...
            [
              {
                ...
                value: function InjectDetector(id, config) {
                  ...
                  script.innerHTML =
                    PosdRedditVideoAndRightColumnAdUrlDetector.SendVideoData.toString() +
                    PosdRedditVideoAndRightColumnAdUrlDetector.SendRightColumnAdUrl.toString() +
                    "(" +
                    this.funcToInject() +
                    '("'.concat(id, '", ').concat(config, "))");
                  if (document.head) {
                ...
                value: function funcToInject() {
                  return function (id, config) {
                    ...
                    function PreSendRightColumnData(data) {
                      ...
                      try {
                        for (
                          var _iterator = fullData[Symbol.iterator](), _step;
                          !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
                          _iteratorNormalCompletion = true
                        ) {
                          var i = _step.value;
  ...
  \*****************************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var PosdAdsCandidates = __webpack_require__(/*! ../../AdsCandidates */ "./src/content/AdsCandidates.js");
        var PosdContentIOManager = __webpack_require__(/*! ../../ContentIOManager */ "./src/content/ContentIOManager.js");
        var PosdTwitterVideoDetector = __webpack_require__(
          /*! ./TwitterVideoDetector */ "./src/content/detectors/Twitter/TwitterVideoDetector.js"
        );
            ...
            },
            {
              ...
              value: function ActivateDetector(activator) {
                ...
                if (this.twConfig && !this.activated) {
                  ...
                  this.processTwitterAdsInterval = setInterval(
                    this.processTwitterAds.bind(this, PosdConst.AD_DETECTOR_INITIATOR_TIMER),
                    1000
                  );
                  ...
                  this.observerNodesListenerInterval = setInterval(function () {
                    ...
                    if (!_this2.feedObserver && feed) {
                      _this2.feedObserver = new MutationObserver(
                        _this2.processFeedTwitterAds.bind(_this2, PosdConst.AD_DETECTOR_INITIATOR_MUTATION)
                      );
                    ...
                    if (!_this2.rightColumnObserver && rightColumn) {
                      _this2.rightColumnObserver = new MutationObserver(
                        _this2.processRightColumnWhoToFollowAds.bind(_this2, PosdConst.AD_DETECTOR_INITIATOR_MUTATION)
                      );
            ...
            },
            {
              ...
              value: function processAndSendTwitterAd(bisId, adTwitter) {
                ...
                if (ad) {
                  ...
                  if (PosdConfig.CONFIG_MARK_AD_CANDIDATES && PosdConfig.CONFIG_MARK_PROCESSED_AD_CANDIDATES) {
                    ad.style.cssText += checkOnVideoTag
                      ? "outline: rgba(42, 213, 255, 1) solid 6px !important;"
                      : "outline: green solid 6px !important;";
                  }
                }
              }
            },
            ...
            [
              {
                ...
                value: function InjectDetector(id, config) {
                  ...
                  script.innerHTML =
                    PosdTwitterVideoDetector.SendVideoData.toString() +
                    "(" +
                    this.funcToInject() +
                    '("'.concat(id, '", ').concat(config, "))");
                  if (document.head) {
                ...
                value: function funcToInject() {
                  return function (id, config) {
                        ...
                        for (var i = 0; i < rules.length; i++) {
                          ...
                          for (var _i = 0; _i < items.length; _i++) {
                            ...
                            if (rule_1.limit === "*") {
                              ...
                              try {
                                for (
                                  var _iterator = pre_data[Symbol.iterator](), _step;
                                  !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
                                  _iteratorNormalCompletion = true
                                ) {
                                  var key = _step.value;
                        ...
                        items.forEach(function (item) {
                          if (item.parents.length) {
                            item.parents.forEach(function (index) {
                              ...
                              tweetsCollection[index][rule.element] = tweetsCollection[index][rule.element]
                                ? tweetsCollection[index][rule.element].concat(item.data)
                                : [item.data];
                            });
                          }
                        });
                          ...
                          return JsonQuery.query(q, independObj[i]).map(function (el) {
                            if (args.props) {
                              ...
                              try {
                                ...
                                for (
                                  var _iterator2 = args.props[Symbol.iterator](), _step2;
                                  !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done);
                                  _iteratorNormalCompletion2 = true
                                ) {
                                  _loop();
                        ...
                        var result = data.filter(function (v) {
                          ...
                          var nextFilter = args.types.some(function (type) {
                            ...
                            if (check) {
                              ...
                              try {
                                for (
                                  var _iterator3 = args.props[Symbol.iterator](), _step3;
                                  !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done);
                                  _iteratorNormalCompletion3 = true
                                ) {
                    ...
                    function runPipeLine(parser, data) {
                      ...
                      try {
                        for (
                          var _iterator4 = parser.pipes[Symbol.iterator](), _step4;
                          !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done);
                          _iteratorNormalCompletion4 = true
                        ) {
                    ...
                    XMLHttpRequest.prototype.send = function () {
                      ...
                      try {
                        for (
                          var _iterator5 = config.parsers[Symbol.iterator](), _step5;
                          !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done);
                          _iteratorNormalCompletion5 = true
                        ) {
            ...
            },
            {
              ...
              value: function GetCurrentDataTimeStr() {
                ...
                return ""
                  ...
                  .concat(Normalize2(now.getMonth() + 1), "-")
                  .concat(Normalize2(now.getDate()), " ")
                  .concat(Normalize2(now.getHours()), ":")
                  .concat(Normalize2(now.getMinutes()), ":")
                  .concat(Normalize2(now.getSeconds()));
              }
            },
            {
              key: "GetWindowSize",
              ...
              value: function IsIframeSecure(iframe) {
                if (iframe) {
                  if (
                    ...
                    iframe.src.indexOf("javascript:") === 0
                  ) {
                    return false;
                  }
                }
            ...
            },
            {
              ...
              value: function IsFBVideoDataValid(videoData) {
                ...
                if (videoData) {
                  try {
                    if (
                      typeof videoData.detectionTime === "number" &&
                      typeof videoData.videoId === "string" &&
                      typeof videoData.videoUrl === "string" &&
                      videoData.videoId.length &&
                      videoData.videoUrl.length
                    ) {
                      valid = true;
                    }
                  } catch (e) {}
