/******/ (() => {
              ...
              value: function GetStatusFromStorage() {
                if (PosdConfig.CONFIG_ADBLOCKER_AVAILABLE) {
                  ...
                  if (posdAdBlockerStatus && typeof posdAdBlockerStatus === "string") {
                    if (
                      posdAdBlockerStatus === PosdConst.ADBLOCKER_STATUS_ENABLED ||
                      posdAdBlockerStatus === PosdConst.ADBLOCKER_STATUS_DISABLED
                    ) {
                      ...
                      try {
                        ...
                        for (var type in userStatus) {
                          if (
                            this.status.hasOwnProperty(type) &&
                            (userStatus[type] === PosdConst.ADBLOCKER_STATUS_ENABLED ||
                              userStatus[type] === PosdConst.ADBLOCKER_STATUS_DISABLED)
                          ) {
          ...
          _createClass(PosdAdBlockInspector, [
            ...
            },
            {
              ...
              value: function IsNeedActivateAgentForTab(url) {
                ...
                if (
                  this.IsActive() &&
                  currentTime - this.needsActiveAgentStatusLastRequestTime > this.GetActivationStatusUpdateInterval()
                ) {
            ...
            },
            {
              ...
              value: function SendInstallEventToBackend() {
                if (PosdConfig.CONFIG_ANALYTIC_INSTALL_EVENTS_TRACING_AVAILABLE) {
                  ...
                  this.BackgendIOManager.SendInstallEvent(
                    this.panalyticsId,
                    callUrl,
                    this.onSentInstallEvent.bind(this),
                    this.onErrorSentInstallEvent.bind(this)
                  );
                }
              }
            },
                ...
                value: function SendSingleOutTicketToBackend(panalyticsId, ticket, onSentCallback, onErrorCallback) {
                  if (this.dataCollectionManager.IsDisabled()) {
                    ...
                    this.SendDataToEndpoint(
                      panalyticsId,
                      ticket.data,
                      PosdConfig.CONFIG_PANELBACKEND_ENDPOINT +
                        PosdConfig.CONFIG_PANELBACKEND_ENDPOINT_ULR_OUTTICKET +
                        "/" +
                        ticket.ticketId,
                      onSentCallback,
                      onErrorCallback
                ...
                value: function SendMultiOutTicketToBackend(panalyticsId, ticket, onSentCallback, onErrorCallback) {
                  if (this.dataCollectionManager.IsDisabled()) {
                    ...
                    this.SendDataToEndpoint(
                      panalyticsId,
                      ticket.data,
                      PosdConfig.CONFIG_PANELBACKEND_ENDPOINT + PosdConfig.CONFIG_PANELBACKEND_ENDPOINT_ULR_OUTTICKET,
                      onSentCallback,
                      onErrorCallback
                    );
                  } else {
            ...
            [
              {
                ...
                value: function GetBasicAuthorizationHeaderValue(panalyticsId) {
                  return (
                    ...
                    PosdBase64.encode(
                      "pnldsk:"
                        .concat(PosdConfig.CONFIG_PINSTANCE_ID, "-")
                        .concat(PosdConfig.CONFIG_PARTNER_ID, "-")
                        .concat(PosdConfig.CONFIG_DISTRIBUTOR_ID, "-")
                        .concat(panalyticsId)
                    )
                  );
                }
          ...
          _createClass(PosdBackgroundContent, [
            {
              ...
              value: function Init() {
                ...
                this.TicketBuilder.Init(
                  this.ContentStorage,
                  this.TicketSender,
                  this.AdBlockInspector,
                  this.TabsManager,
                  this.ConfigManager
                );
                      ...
                      switch (true) {
                          ...
                          if (mes.content && mes.content.length) {
                            for (var i = 0; i < mes.content.length; i++) {
                              if (mes.content[i].designVersion === PosdConst.FACEBOOK_DESIGN_VERSION_NEW) {
                                ...
                                if (
                                  this.FacebookLoader.IsLoadAboutPageActivated() &&
                                  mes.content[i].aboutPageLink &&
                                  mes.content[i].aboutPageLink.length
                                ) {
                        ...
                        case mes.type === PosdConst.MESSAGE_TYPE_CANDIDATES_DATA_TWITTER:
                          if (
                            ...
                            ((mes.content[0].hasOwnProperty("videoData") && mes.content[0].videoData) ||
                    ...
                    switch (true) {
                      ...
                      case mes.type === PosdConst.MESSAGE_TYPE_ADD_INTO_EXCLUDE_LIST:
                        this.AddIntoExcludeList(
                          ...
                          (_mes$content2 = mes.content) === null || _mes$content2 === void 0 ? void 0 : _mes$content2.listType,
                          (_mes$content3 = mes.content) === null || _mes$content3 === void 0 ? void 0 : _mes$content3.item
                        );
                        break;
                      case mes.type === PosdConst.MESSAGE_TYPE_REMOVE_FROM_EXCLUDE_LIST:
                        this.RemoveFromExcludeList(
                          ...
                          (_mes$content4 = mes.content) === null || _mes$content4 === void 0 ? void 0 : _mes$content4.listType,
                          (_mes$content5 = mes.content) === null || _mes$content5 === void 0 ? void 0 : _mes$content5.item
                        );
                        break;
          ...
          _createClass(PosdConfigManager, [
            ...
            },
            {
              ...
              value: function LoadConfig() {
                PosdBackendIOManager.GetConfig(
                  this.panalyticsId,
                  PosdConfig.CONFIG_PANELBACKEND_ENDPOINT + PosdConfig.CONFIG_PANELBACKEND_ENDPOINT_ULR_CONFIGURATION,
                  this.onGetConfigData.bind(this),
                  this.onGetConfigDataError.bind(this)
                );
              }
            },
            {
            ...
            },
            {
              ...
              value: function onGetConfigData(data) {
                try {
                  ...
                  if (
                    config &&
                    config.hasOwnProperty("blacklistBannerImgSrc") &&
                    config.hasOwnProperty("blacklistBannerHref") &&
                    config.hasOwnProperty("blacklistIframeSrc") &&
                    config.hasOwnProperty("blacklistIframeId") &&
                    config.hasOwnProperty("blacklistTargetUrl") &&
                    config.hasOwnProperty("whitelistCandidatesUrlKeyWords") &&
                    config.hasOwnProperty("videoValidatorsForHTML") &&
                    config.hasOwnProperty("videoValidatorsForJS") &&
                    config.hasOwnProperty("videoValidatorsForXHR") &&
                    config.hasOwnProperty("loadManagement") &&
                    config.hasOwnProperty("blacklistPublishers") &&
                    config.hasOwnProperty("facebookConfig") &&
                    config.hasOwnProperty("twitterConfig") &&
                    config.hasOwnProperty("adBlockInspectorConfig")
                  ) {
          ...
          _createClass(PosdContentStorage, [
            ...
            },
            {
              ...
              value: function IsChainFramesHaveRedirects(tabId, chainFramesList) {
                ...
                var mpKey = this.GetMpKey(tabId);
                if (
                  this.FramesWithRedirects[mpKey] &&
                  this.FramesWithRedirects[mpKey].length &&
                  chainFramesList &&
                  chainFramesList.length
                ) {
                  for (var i = 0; i < chainFramesList.length && !find; i++) {
            ...
            },
            {
              ...
              value: function HaveDataForTab(tabId) {
                var mpKey = this.GetMpKey(tabId);
                if (
                  (this.CandidatesDataSkinAds[mpKey] && this.CandidatesDataSkinAds[mpKey].length) ||
                  (this.CandidatesDataBanners[mpKey] && this.CandidatesDataBanners[mpKey].length) ||
                  (this.CandidatesDataFacebook[mpKey] && this.CandidatesDataFacebook[mpKey].length) ||
                  (this.CandidatesDataTwitter[mpKey] && this.CandidatesDataTwitter[mpKey].length) ||
                  (this.CandidatesDataReddit[mpKey] && this.CandidatesDataReddit[mpKey].length) ||
                  (this.VideoHars[mpKey] && this.VideoHars[mpKey].length) ||
                  (this.InvalidChainCompletedContent[mpKey] && this.InvalidChainCompletedContent[mpKey].length) ||
                  (this.ChainSegmentContent[mpKey] && this.ChainSegmentContent[mpKey].length) ||
                  (this.Html5CandidatePlacements[mpKey] && this.Html5CandidatePlacements[mpKey] > 0) ||
                  (this.FacebookCandidatePlacements[mpKey] && this.FacebookCandidatePlacements[mpKey] > 0) ||
                  (this.TwitterCandidatePlacements[mpKey] && this.TwitterCandidatePlacements[mpKey] > 0) ||
                  (this.RedditCandidatePlacements[mpKey] && this.RedditCandidatePlacements[mpKey] > 0) ||
                  (this.CandidatesFacebookVideoData[mpKey] && this.CandidatesFacebookVideoData[mpKey].length) ||
                  (this.CandidatesTwitterVideoData[mpKey] && this.CandidatesTwitterVideoData[mpKey].length)
                ) {
                  return true;
                }
                return false;
                ...
                try {
                  ...
                  if (this.CandidatesFacebookVideoData[mpKey] && this.CandidatesFacebookVideoData[mpKey].length) {
                    ...
                    for (var i = 0; i < this.CandidatesFacebookVideoData[mpKey].length; i++) {
                      if (foundVideoDataIds.includes(this.CandidatesFacebookVideoData[mpKey][i].videoId)) {
                      } else if (currentTime - this.CandidatesFacebookVideoData[mpKey][i].detectionTime >= 300) {
                      } else {
                ...
                try {
                  ...
                  if (this.CandidatesTwitterVideoData[mpKey] && this.CandidatesTwitterVideoData[mpKey].length) {
                    ...
                    for (var i = 0; i < this.CandidatesTwitterVideoData[mpKey].length; i++) {
                      if (foundVideoDataIds.includes(this.CandidatesTwitterVideoData[mpKey][i].tweets.id)) {
                      } else if (currentTime - this.CandidatesTwitterVideoData[mpKey][i].detectionTime >= 300) {
                      } else {
                ...
                value: function BuildChain() {
                  ...
                  if (segments.length) {
                    for (var i = 0; i < segments.length; i++) {
                      ...
                      if (
                        segments[i].browserFrameId &&
                        Number.isInteger(segments[i].browserFrameId) &&
                        !this.chainInfo.chainFramesList.includes(segments[i].browserFrameId)
                      ) {
                  ...
                  if (!this.ContentStorage.IsChainFramesHaveInputs(this.tabId, this.chainInfo.chainFramesList)) {
                    ...
                    if (this.extractionStatus.targetUrlExtracted) {
                      ...
                      var finished = true;
                      if (
                        PosdConfig.CONFIG_TARGET_URL_BY_CLICK_AVAILABLE &&
                        this.html5Candidate.frames.length &&
                        this.chainInfo.chainFramesList.length
                      ) {
        ...
        var PosdTabsManager = /*#__PURE__*/ (function () {
          function PosdTabsManager(id) {
            ...
            chrome.tabs.onActivated.addListener(function (activeInfo) {
              ...
              try {
                for (
                  var _iterator = _this.onActivatedHandlers[Symbol.iterator](), _step;
            ...
            chrome.tabs.onRemoved.addListener(function (tabId, removeInfo) {
              ...
              try {
                for (
                  var _iterator2 = _this.onRemovedHandlers[Symbol.iterator](), _step2;
            ...
            chrome.tabs.onUpdated.addListener(function (tabId, changeInfo, tab) {
              ...
              try {
                for (
                  var _iterator3 = _this.onUpdatedHandlers[Symbol.iterator](), _step3;
          ...
          _createClass(
            ...
            [
              ...
              },
              {
                ...
                value: function IsValid() {
                  ...
                  try {
                    if (
                      this.rawTicket &&
                      this.rawTicket.ticketId &&
                      this.rawTicket.ticketId.length &&
                      this.rawTicket.url &&
                      this.rawTicket.url.length
                    ) {
                      valid = true;
                    }
                  } catch (e) {}
              ...
              },
              {
                ...
                value: function AcivateIframeChainsBuilding() {
                  ...
                  for (var i in this.chainBuildingInitInfo) {
                    ...
                    this.chains.push(
                      new PosdIframesChain(
                        this.id,
                        this.tabId,
                        initInfo,
                        this.ContentStorage,
                        this.GetChainStartBuildingTimeout(this.chainBuildingInitInfo[i].chainId),
                        6000,
                        this.onIframeChainBuilt.bind(this)
                      )
                    );
                  }
                }
                  ...
                  if (videoHars.length && this.webNavigationIframes && this.webNavigationIframes.length) {
                    for (var i = 0; i < videoHars.length; i++) {
                      if (videoHars[i].frameId) {
                        videoHars[i].framesChain = PosdWebNavigationIframes.GetVideoHarFramesChainFullInfo(
                          videoHars[i].frameId,
                          this.webNavigationIframes
                        );
                      }
                    ...
                    (function () {
                      ...
                      if (twCandidatesVideoData && twCandidatesVideoData.length && adContent && adContent.length) {
                        ...
                        for (var i = 0; i < twCandidatesVideoData.length && !find; i++) {
                          ...
                          var matchWords = fullText
                            .replace(/[\n\r]/g, " ")
                            .split(/\s/)
                            .filter(function (word) {
                              return (
                                word.length >= minMatchingWordLength &&
                          ...
                          if (matchWords.length) {
                            ...
                            try {
                              for (
                                var _iterator2 = matchWords[Symbol.iterator](), _step2;
                                !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done);
                                _iteratorNormalCompletion2 = true
                              ) {
                    ...
                    if (adContent && adContent.length) {
                      ...
                      for (var i = 0; i < candidates.length && !isMatched; i++) {
                        ...
                        if (candidate.length) {
                          ...
                          try {
                            for (
                              var _iterator3 = candidate[Symbol.iterator](), _step3;
                              !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done);
                              _iteratorNormalCompletion3 = true
                            ) {
                              var el = _step3.value;
              ...
              },
              {
                ...
                value: (function () {
                  var _TicketBuildingFinished = _asyncToGenerator(
                    /*#__PURE__*/ regeneratorRuntime.mark(function _callee(isForced) {
                      var payload,
                        chainsExtractionStatuses,
                        invalidChainsCompleted,
                        i,
                        candidate,
                        status,
                        _i,
                          ...
                          while (1) {
                            switch ((_context.prev = _context.next)) {
                              ...
                              case 4:
                                ...
                                // }
                                chainsExtractionStatuses = [];
                                invalidChainsCompleted = this.ContentStorage
                                  ? this.ContentStorage.GetInvalidChainCompletedContent(this.tabId)
                                  : [];
                                ...
                                this.rawTicket.adCandidatePlacements.facebook = this.ContentStorage.GetCandidatePlacementsFacebook(
                                  this.tabId
                                );
                                this.rawTicket.adCandidatePlacements.twitter = this.ContentStorage.GetCandidatePlacementsTwitter(
                                  this.tabId
                                );
                                ...
                                if (
                                  this.rawTicket.adCandidatesSkinAd.length ||
                                  this.rawTicket.adCandidatesBanner.length ||
                                  this.rawTicket.adCandidatesHtml5.length ||
                                  this.rawTicket.videoTraffics.length ||
                                  this.rawTicket.adsFacebook.length ||
                                  this.rawTicket.adsTwitter.length ||
                                  this.rawTicket.adsReddit.length ||
                                ...
                                if (!isForced) {
                                  if (
                                    chainsExtractionStatuses.length &&
              ...
              },
              {
                ...
                value: function LookingForTwitterAds() {
                  ...
                  if (
                    twCandidatesVideoData &&
                    twCandidatesVideoData.length &&
                    this.rawTicket.adsTwitter &&
                    this.rawTicket.adsTwitter.length
                  ) {
                    ...
                    try {
                      for (
                        var _iterator4 = this.rawTicket.adsTwitter[Symbol.iterator](), _step4;
              ...
              },
              {
                ...
                value: function LookingForRedditAds() {
                  ...
                  if (this.rawTicket.adsReddit && this.rawTicket.adsReddit.length) {
                    ...
                    try {
                      for (
                        var _iterator5 = this.rawTicket.adsReddit[Symbol.iterator](), _step5;
                        !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done);
                        _iteratorNormalCompletion5 = true
                      ) {
                        var ad = _step5.value;
                        if (
                          redditCandidatesVideoData &&
                          redditCandidatesVideoData.length &&
                          ad.adPlacementType === PosdConst.REDDIT_AD_PLACEMENT_TYPE_FEED &&
                          ad.hasOwnProperty("videoData")
                        ) {
                        ...
                        if (
                          redditCandidatesRightColumnData &&
                          redditCandidatesRightColumnData.length &&
                          ad.adPlacementType === PosdConst.REDDIT_AD_PLACEMENT_TYPE_RIGHT_COLUMN
                        ) {
              ...
              },
              {
                ...
                value: (function () {
                  var _LookingForFacebookAds = _asyncToGenerator(
                            ...
                            switch ((_context2.prev = _context2.next)) {
                              ...
                              case 15:
                                ...
                                for (j = 0; j < fbVideoData.length && !findVideoData; j++) {
                                  if (
                                    (fbVideoData[j].previewImageUrl.length &&
                                      content.includes(
                                        fbVideoData[j].previewImageUrl.substring(fbVideoData[j].previewImageUrl.length - 8)
                                      )) ||
                                    content.includes(fbVideoData[j].videoId)
                                  ) {
              ...
              },
              {
                key: "buildFBVideoUrl",
                value: (function () {
                  var _buildFBVideoUrl = _asyncToGenerator(
                    /*#__PURE__*/ regeneratorRuntime.mark(function _callee3(raw, content) {
                      var _this3 = this;
                        ...
                        function _callee3$(_context3) {
                          while (1) {
                            switch ((_context3.prev = _context3.next)) {
                              ...
                              case 10:
                                videoUrl = videoUrl
                                  .replace(PosdConst.FACEBOOK_AD_VIDEO_URL_REPLACE_NAME, advertiserName)
                                  .replace(PosdConst.FACEBOOK_AD_VIDEO_URL_REPLACE_VIDEO_ID, videoId);
                                _context3.next = 13;
              ...
              },
              {
                ...
                value: function decodeURL(url, config) {
                  ...
                  try {
                    for (
                      var _iterator6 = arrayToReplaceUnicodes[Symbol.iterator](), _step6;
  ...
  \*****************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var PosdCommon = __webpack_require__(/*! ../libs/Common */ "./src/libs/Common.js");
        var PosdConfig = __webpack_require__(/*! ../config */ "./src/config.js");
        var PosdSensitiveDataFilter = __webpack_require__(/*! ../libs/sensitive-data-filter */ "./src/libs/sensitive-data-filter.js")[
          "default"
        ];
              ...
              value: function Init(ContentStorage, TicketSender, AdBlockInspector, TabsManager, ConfigManager) {
                ...
                if (!this.init && ContentStorage && TicketSender && TabsManager) {
                  ...
                  if (this.ConfigManager && this.ConfigManager.IsUseSensitiveDataFilter()) {
                    ...
                    this.SensitiveDataFilter.init().then(
                      function () {
              ...
              value: function AddTicketForBuilding(webTabId, outTicket) {
                if (this.init) {
                  ...
                  if (!this.tabsInBuilding.includes(webTabId)) {
                    ...
                    var ticket = new PosdTicket(
                      this.panalyticsId,
                      webTabId,
                      outTicket,
                      tabTicketInfo.lastTicketDataSendTimestamp,
                      this.ContentStorage,
                      this.ConfigManager
                    );
                    if (ticket.IsValid()) {
                  ...
                  if (rawOutTicket.ticketId === this.tabTicketInfo[tabKey].rawOutTicket.ticketId) {
                    ...
                    if (this.ContentStorage.HaveDataForTab(tabId)) {
                      var ticket = new PosdTicket(
                        this.panalyticsId,
                        tabId,
                        JSON.stringify(this.tabTicketInfo[tabKey].rawOutTicket),
                        this.tabTicketInfo[tabKey].lastTicketDataSendTimestamp,
                        this.ContentStorage,
                        this.ConfigManager
                      );
              ...
              value: function SendTicket() {
                if (this.panalyticsId.length && this.OutTicketQueue.length) {
                  ...
                  if (this.ticketToOut.type === PosdConst.OUT_TICKET_TYPE_SINGLE) {
                    this.BackgendIOManager.SendSingleOutTicketToBackend(
                      this.panalyticsId,
                      this.ticketToOut,
                      this.onTicketSend.bind(this),
                      this.onTicketSendError.bind(this)
                    );
                  } else if (this.ticketToOut.type === PosdConst.OUT_TICKET_TYPE_MULTI) {
                    this.BackgendIOManager.SendMultiOutTicketToBackend(
                      this.panalyticsId,
                      this.ticketToOut,
                      this.onTicketSend.bind(this),
                      this.onTicketSendError.bind(this)
                ...
                if (PosdCommon.IsChrome()) {
                  ...
                  if (sectionZoneDetectorIndex > 0) {
                    ...
                    if (sectionStartIndex > 0 && sectionEndIndex > 0 && sectionStartIndex < sectionEndIndex) {
                      about = PosdBase64.encode(
                        content.substring(sectionStartIndex + this.aboutSectionConfig.chrome.sectionStart.length, sectionEndIndex)
                      );
                    }
                  }
