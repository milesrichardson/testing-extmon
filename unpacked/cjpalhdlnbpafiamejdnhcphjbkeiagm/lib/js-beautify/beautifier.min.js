    ...
    var t = {
              ...
              if ("<" === e) {
                ...
                "{" === e &&
                  (this._disabled.handlebars ||
                    ...
                    (t =
                      (t = (t = t || this.__patterns.handlebars_comment.read()) || this.__patterns.handlebars_unescaped.read()) ||
                  ...
                  this._disabled.smarty ||
                    (this._disabled.django &&
                      this._disabled.handlebars &&
                      (t =
                        (t = (t = t || this.__patterns.smarty_comment.read()) || this.__patterns.smarty_literal.read()) ||
          ...
          (r.prototype.tokenize = function () {
            ...
            for (var e = new _(u.START, ""), i = null, n = [], a = new s(); e.type !== u.EOF; ) {
              ...
              a.isEmpty() || ((t.comments_before = a), (a = new s())),
                ...
                this._is_opening(t)
                  ? (n.push(i), (i = t))
                  : i && this._is_closing(t, i) && ((t.opened = i), (i.closed = t), (i = n.pop()), (t.parent = i)),
                (t.previous = e),
                (e.next = t),
                this.__tokens.add(t),
                (e = t);
          ...
          (c.prototype.eatString = function (t) {
            ...
            (c.prototype.beautify = function () {
              ...
              (this._output = new _(this._options, i)),
                ...
                (this._ch = null);
              for (
                var n, c, f = 0, d = !1, g = !1, b = !1, m = !1, k = !1, w = !1, y = this._ch, x = !1;
                (n = "" !== this._input.read(h)),
                  (c = y),
                  (this._ch = this._input.next()),
                ...
                if ("/" === this._ch && "*" === this._input.peek()) {
                  ...
                  E && "start" === E.ignore && (v += a.readIgnored(this._input)),
                    this.print_string(v),
                  ...
                  if ((this.preserveSingleSpace(n), "{" === this._input.peek())) this.print_string(this._ch + this.eatString("}"));
                    ...
                    O.match(/[ :]$/) &&
                      ((O = this.eatString(": ").replace(/\s$/, "")), this.print_string(O), (this._output.space_before_token = !0)),
                      "extend" === (O = O.replace(/\s$/, "")) ? (m = !0) : "import" === O && (k = !0),
                      O in this.NESTED_AT_RULE
                        ? ((this._nestedLevel += 1), O in this.CONDITIONAL_GROUP_RULE && (b = !0))
                        : d || 0 !== f || -1 === O.indexOf(":") || ((g = !0), this.indent());
                  }
                else if ("#" === this._ch && "{" === this._input.peek())
                  this.preserveSingleSpace(n), this.print_string(this._ch + this.eatString("}"));
                else if ("{" === this._ch)
                  g && ((g = !1), this.outdent()),
                    b ? ((b = !1), (d = this._indentLevel >= this._nestedLevel)) : (d = this._indentLevel >= this._nestedLevel - 1),
                    ...
                    "expand" === this._options.brace_style
                      ...
                      : ("(" === c ? (this._output.space_before_token = !1) : "," !== c && this.indent(), this.print_string(this._ch)),
                    this.eatWhitespace(!0),
                    this._output.add_new_line();
                else if ("}" === this._ch)
                  this.outdent(),
                  ...
                  (!d && !b) || this._input.lookBack("&") || this.foundNestedPseudoClass() || this._input.lookBack("(") || m || 0 !== f
                  ...
                  if (this._input.lookBack("url"))
                    ...
                    var A = !1;
                    this._input.lookBack("with") && (A = !0),
                      this.preserveSingleSpace(n || A),
                      this.print_string(this._ch),
                      g && "$" === c && this._options.selector_separator_newline
                        ? (this._output.add_new_line(), (w = !0))
                  ...
                  f && (f--, this.outdent()),
                    w &&
                      ...
                      ((w = !1), this.outdent(), this._output.add_new_line()),
                    this.print_string(this._ch);
                else if ("," === this._ch)
                  this.print_string(this._ch),
                    this.eatWhitespace(!0),
                    !this._options.selector_separator_newline || (g && !w) || 0 !== f || k || m
                      ? (this._output.space_before_token = !0)
                      : this._output.add_new_line();
                  ...
                  this._options.space_around_combinator
                    ...
                    : (this.print_string(this._ch), this.eatWhitespace(), this._ch && o.test(this._ch) && (this._ch = ""));
        ...
        843: function (t, e, i) {
          ...
          (l.prototype.get_parser_token = function () {
            ...
            (c.prototype.beautify = function () {
              ...
              for (var c = null, d = p.next(); d.type !== a.EOF; )
                d.type === a.TAG_OPEN || d.type === a.COMMENT
                  ? (_ = c = this._handle_tag_open(h, d, _, n))
                  : d.type === a.ATTRIBUTE || d.type === a.EQUALS || d.type === a.VALUE || (d.type === a.TEXT && !_.tag_complete)
                  ? (c = this._handle_inside_tag(h, d, _, p))
                  : d.type === a.TAG_CLOSE
                  ? (c = this._handle_tag_close(h, d, _))
                  : d.type === a.TEXT
                  ? (c = this._handle_text(h, d, _))
                  : h.add_raw_token(d),
                  (n = c),
                  (d = p.next());
              ...
              return (
                ...
                i.is_unformatted
                  ...
                  : ("<" === i.tag_start_char &&
                    ...
                    t.print_token(e)),
                !i.indent_content || i.is_unformatted || i.is_content_unformatted || (t.indent(), (i.indent_content = !1)),
              ...
              if ((t.set_space_before_token(e.newlines || "" !== e.whitespace_before, !0), i.is_unformatted)) t.add_raw_token(e);
                ...
                if (
                  (e.type === a.ATTRIBUTE
                    ...
                    : (e.type === a.EQUALS || (e.type === a.VALUE && e.previous.type === a.EQUALS)) && t.set_space_before_token(!1),
                  e.type === a.ATTRIBUTE &&
                    "<" === i.tag_start_char &&
            ...
            (c.prototype._print_custom_beatifier_text = function (t, e, i) {
              ...
              if ("" !== e.text) {
                var _,
                  ...
                  u = "",
                  r = "";
                "javascript" === i.custom_beautifier_name && "function" == typeof this._js_beautify
                  ? (_ = this._js_beautify)
                  : "css" === i.custom_beautifier_name && "function" == typeof this._css_beautify
          ...
          var f = function (t, e) {
            if (
              ...
              (this.tag_start_char = e.text[0]),
                (this.text = e.text),
                "<" === this.tag_start_char
                  ? ((i = e.text.match(/^<([^\s>]*)/)), (this.tag_check = i ? i[1] : ""))
                  : ((i = e.text.match(/^{{~?(?:[\^]|#\*?)?([^\s}]+)/)),
              ...
              "{" === this.tag_start_char && this.text.length >= 3 && "~" === this.text.charAt(2) && (n = 3),
                (this.is_end_tag =
                  this.is_end_tag || ("{" === this.tag_start_char && (this.text.length < 3 || /[^#\^]/.test(this.text.charAt(n)))));
          ...
          (c.prototype._get_tag_open_token = function (t) {
            ...
            return (
              ...
              (e.is_end_tag = e.is_end_tag || h(e.tag_check, this._options.void_elements)),
              (e.is_empty_element = e.tag_complete || (e.is_start_tag && e.is_end_tag)),
              (e.is_unformatted = !e.tag_complete && h(e.tag_check, this._options.unformatted)),
              (e.is_content_unformatted = !e.is_empty_element && h(e.tag_check, this._options.content_unformatted)),
              (e.is_inline_element = h(e.tag_name, this._options.inline) || e.tag_name.includes("-") || "{" === e.tag_start_char),
              e
            );
          }),
              ...
              if (
                (i.is_empty_element ||
                  (i.is_end_tag
                    ...
                    : (this._do_optional_end_element(i) && (i.is_inline_element || t.print_newline(!1)),
                      this._tag_stack.record_tag(i),
                      ("script" !== i.tag_name && "style" !== i.tag_name) ||
                        i.is_unformatted ||
                        i.is_content_unformatted ||
                        (i.custom_beautifier_name = (function (t, e) {
                          var i = null,
                            n = null;
                          return e.closed
                            ? ("script" === t ? (i = "text/javascript") : "style" === t && (i = "text/css"),
                              (i =
                                (function (t) {
                                  for (var e = null, i = t.next; i.type !== a.EOF && t.closed !== i; ) {
                                    if (i.type === a.ATTRIBUTE && "type" === i.text) {
                                      i.next &&
                                        i.next.type === a.EQUALS &&
                                        i.next.next &&
                ...
                (i.indent_content = !i.custom_beautifier_name),
                  "<" === i.tag_start_char &&
                    ("html" === i.tag_name
                      ...
                      : "body" === i.tag_name && (i.indent_content = this._options.indent_body_inner_html)),
              ...
              if ("body" === t.tag_name) e = e || this._tag_stack.try_pop("head");
                ...
                "rp" === t.tag_name || "rt" === t.tag_name
                  ...
                  : ("th" !== t.tag_name && "td" !== t.tag_name) ||
                    (e =
                      (e = e || this._tag_stack.try_pop("td", ["table", "thead", "tbody", "tfoot", "tr"])) ||
                      ...
                      (i =
                        (i =
                          (i =
                            (i =
                              (i =
                                (i = (i = i || this._read_open_handlebars(n, e)) || this._read_attribute(n, t, e)) ||
                                this._read_close(n, e)) || this._read_raw_content(n, t, e)) || this._read_content_word(n)) ||
                          this._read_comment_or_cdata(n)) || this._read_processing(n)) || this._read_open(n, e)) ||
                ...
                "<" === t &&
                  ("!" === this._input.peek(1) &&
                    ((i = this.__patterns.comment.read())
                      ? (n = o.get_directives(i)) && "start" === n.ignore && (i += o.readIgnored(this._input))
              ...
              return (
                e ||
                  (this._options.indent_handlebars &&
                    ...
                    "{" === this._input.peek(1) &&
                    ("!" === this._input.peek(2)
                      ? ((i = (i = this.__patterns.handlebars_comment.read()) || this.__patterns.handlebars.read()),
                        (n = this._create_token(r.COMMENT, i)))
                      : ((i = this.__patterns.handlebars_open.read()), (n = this._create_token(r.TAG_OPEN, i))))),
                n
              );
            }),
              ...
              return (
                e &&
                  ("<" === e.text[0] && (">" === t || ("/" === t && ">" === this._input.peek(1)))
                    ? ((i = this._input.next()), "/" === t && (i += this._input.next()), (n = this._create_token(r.TAG_CLOSE, i)))
                    : "{" === e.text[0] &&
                      "}" === t &&
                      "}" === this._input.peek(1) &&
                      (this._input.next(), this._input.next(), (n = this._create_token(r.TAG_CLOSE, "}}")))),
                n
              );
            }),
              ...
              if (i && "<" === i.text[0])
                if ("=" === t) n = this._create_token(r.EQUALS, this._input.next());
                  ...
                  (_ = this.__patterns.attribute.read()) &&
                    (n = e.type === r.EQUALS ? this._create_token(r.VALUE, _) : this._create_token(r.ATTRIBUTE, _));
              return n;
            }),
        ...
        273: function (t, e) {
          ...
          (e.identifier = new RegExp(
            ...
            (e.identifierStart = new RegExp(n)),
            ...
            (R.prototype.handle_whitespace_and_comments = function (t, e) {
              ...
              if (t.comments_before)
                for (var _ = t.comments_before.next(); _; )
                  this.handle_whitespace_and_comments(_, e), this.handle_token(_, e), (_ = t.comments_before.next());
          ...
          (R.prototype.allow_wrap_or_preserved_newline = function (t, e) {
            ...
            (R.prototype.print_newline = function (t, e) {
              if (
                ...
                "," !== this._flags.last_token.text &&
                "=" !== this._flags.last_token.text &&
                (this._flags.last_token.type !== h.OPERATOR || "--" === this._flags.last_token.text || "++" === this._flags.last_token.text)
              )
                for (
                  var i = this._tokens.peek();
                  !(this._flags.mode !== m || (this._flags.if_block && l(i, "else")) || this._flags.do_block);
            ...
            (R.prototype.print_token_line_indentation = function (t) {
              this._output.just_added_newline() &&
                (this._options.keep_array_indentation && t.newlines && ("[" === t.text || O(this._flags.mode))
              ...
              if (this._output.raw) this._output.add_raw_token(t);
                ...
                if (
                  ...
                  this._output.previous_line.is_empty() &&
                    (this._output.previous_line.push(e), this._output.trim(!0), this._output.current_line.pop(), this._output.trim()),
            ...
            (R.prototype.start_of_object_property = function () {
              return (
                ...
                this._flags.mode === m &&
                ((":" === this._flags.last_token.text && 0 === this._flags.ternary_depth) || c(this._flags.last_token, ["get", "set"]))
              );
            }),
                  ...
                  (e =
                    (e =
                      (e =
                        (e =
                          (e =
                            (e = e || (c(this._flags.last_token, ["var", "let", "const"]) && t.type === h.WORD)) ||
                            l(this._flags.last_token, "do")) ||
                          (!(this._flags.parent.mode === k && this._flags.mode === m) && c(this._flags.last_token, A) && !t.newlines)) ||
                        (l(this._flags.last_token, "else") && !(l(t, "if") && !t.comments_before))) ||
            ...
            (R.prototype.handle_start_expr = function (t) {
              ...
              if ("[" === t.text) {
                if (this._flags.last_token.type === h.WORD || ")" === this._flags.last_token.text)
                  return (
                    c(this._flags.last_token, r) && (this._output.space_before_token = !0),
                    this.print_token(t),
                    this.set_mode(e),
                    this.indent(),
                ...
                (e = w),
                  O(this._flags.mode) &&
                    (("[" !== this._flags.last_token.text &&
                      ...
                      this.print_newline()),
                  p(this._flags.last_token.type, [h.START_EXPR, h.END_EXPR, h.WORD, h.OPERATOR, h.DOT]) ||
                    (this._output.space_before_token = !0);
              } else {
                if (this._flags.last_token.type === h.RESERVED)
                  "for" === this._flags.last_token.text
                    ? ((this._output.space_before_token = this._options.space_before_conditional), (e = y))
                    : p(this._flags.last_token.text, ["if", "while", "switch"])
                    ? ((this._output.space_before_token = this._options.space_before_conditional), (e = x))
                    : p(this._flags.last_word, ["await", "async"])
                    ? (this._output.space_before_token = !0)
                    : "import" === this._flags.last_token.text && "" === t.whitespace_before
                    ? (this._output.space_before_token = !1)
                    : (p(this._flags.last_token.text, r) || "catch" === this._flags.last_token.text) &&
                      (this._output.space_before_token = !0);
                  ...
                  if (this._options.space_after_named_function && i) {
                    ...
                    c(i, ["async", "function"]) || ("*" === i.text && c(n, ["async", "function"]))
                      ? (this._output.space_before_token = !0)
                      : this._flags.mode === k
                      ? ("{" !== i.text && "," !== i.text && ("*" !== i.text || ("{" !== n.text && "," !== n.text))) ||
                        (this._output.space_before_token = !0)
                ...
                ((this._flags.last_token.type === h.RESERVED &&
                  ...
                  ("*" === this._flags.last_token.text &&
                    (p(this._last_last_text, ["function", "yield"]) || (this._flags.mode === k && p(this._last_last_text, ["{", ","]))))) &&
            ...
            (R.prototype.handle_end_expr = function (t) {
              ...
              this.handle_whitespace_and_comments(t),
                this._flags.multiline_frame &&
                  this.allow_wrap_or_preserved_newline(t, "]" === t.text && O(this._flags.mode) && !this._options.keep_array_indentation),
                this._options.space_in_paren &&
                  (this._flags.last_token.type !== h.START_EXPR || this._options.space_in_empty_paren
                    ? (this._output.space_before_token = !0)
            ...
            (R.prototype.handle_start_block = function (t) {
              ...
              "switch" === this._flags.last_word && this._flags.last_token.type === h.END_EXPR
                ...
                ? this.set_mode(b)
                : i &&
                  ((p(i.text, [":", ","]) && p(e.type, [h.STRING, h.WORD, h.RESERVED])) ||
                    (p(e.text, ["get", "set", "..."]) && p(i.type, [h.WORD, h.RESERVED])))
                ? p(this._last_last_text, ["class", "interface"]) && !p(i.text, [":", ","])
                  ? this.set_mode(b)
                  : this.set_mode(k)
                : this._flags.last_token.type === h.OPERATOR && "=>" === this._flags.last_token.text
                ? this.set_mode(b)
                : p(this._flags.last_token.type, [h.EQUALS, h.START_EXPR, h.COMMA, h.OPERATOR]) ||
                  c(this._flags.last_token, ["return", "throw", "import", "default"])
                ? this.set_mode(k)
                : this.set_mode(b),
                this._flags.last_token && c(this._flags.last_token.previous, ["class", "extends"]) && (this._flags.class_start_block = !0);
              ...
              ("expand" === this._options.brace_style || ("none" === this._options.brace_style && t.newlines)) && !this._flags.inline_frame
                ? this._flags.last_token.type !== h.OPERATOR &&
                  (_ ||
                    ...
                    (c(this._flags.last_token, f) && "else" !== this._flags.last_token.text))
                  ? (this._output.space_before_token = !0)
                  : this.print_newline(!1, !0)
                : (!O(this._previous_flags.mode) ||
                    (this._flags.last_token.type !== h.START_EXPR && this._flags.last_token.type !== h.COMMA) ||
                    ((this._flags.last_token.type === h.COMMA || this._options.space_in_paren) && (this._output.space_before_token = !0),
                    (this._flags.last_token.type === h.COMMA ||
                      (this._flags.last_token.type === h.START_EXPR && this._flags.inline_frame)) &&
              ...
              this._flags.inline_frame && !e
                ...
                : e ||
                  (O(this._flags.mode) && this._options.keep_array_indentation
                    ? ((this._options.keep_array_indentation = !1), this.print_newline(), (this._options.keep_array_indentation = !0))
                    : this.print_newline()),
                this.restore_mode(),
                this.print_token(t);
            }),
            (R.prototype.handle_word = function (t) {
              if (
                (t.type === h.RESERVED &&
                  ((p(t.text, ["set", "get"]) && this._flags.mode !== k) ||
                    ("import" === t.text && p(this._tokens.peek().text, ["(", "."])) ||
                    (p(t.text, ["as", "from"]) && !this._flags.import_block) ||
                    (this._flags.mode === k && ":" === this._tokens.peek().text)) &&
                  (t.type = h.WORD),
                this.start_of_statement(t)
                  ? c(this._flags.last_token, ["var", "let", "const"]) && t.type === h.WORD && (this._flags.declaration_statement = !0)
                  : !t.newlines ||
                    T(this._flags.mode) ||
                    (this._flags.last_token.type === h.OPERATOR &&
                      "--" !== this._flags.last_token.text &&
                      "++" !== this._flags.last_token.text) ||
                    this._flags.last_token.type === h.EQUALS ||
                    (!this._options.preserve_newlines && c(this._flags.last_token, ["var", "let", "const", "set", "get"]))
                  ? this.handle_whitespace_and_comments(t)
              ...
              if (
                ...
                return (
                  (p(this._flags.last_token.text, ["}", ";"]) ||
                    (this._output.just_added_newline() &&
                      !p(this._flags.last_token.text, ["(", "[", "{", ":", "=", ","]) &&
                      this._flags.last_token.type !== h.OPERATOR)) &&
                    (this._output.just_added_blankline() || t.comments_before || (this.print_newline(), this.print_newline(!0))),
                  this._flags.last_token.type === h.RESERVED || this._flags.last_token.type === h.WORD
                    ? c(this._flags.last_token, ["get", "set", "new", "export"]) ||
                      c(this._flags.last_token, A) ||
                      (l(this._flags.last_token, "default") && "export" === this._last_last_text) ||
                      "declare" === this._flags.last_token.text
                      ? (this._output.space_before_token = !0)
                      : this.print_newline()
                    : this._flags.last_token.type === h.OPERATOR || "=" === this._flags.last_token.text
                    ? (this._output.space_before_token = !0)
                    : (this._flags.multiline_frame || (!T(this._flags.mode) && !O(this._flags.mode))) && this.print_newline(),
                  this.print_token(t),
              ...
              this._flags.last_token.type === h.END_BLOCK
                ...
                ? (e = "NEWLINE")
                : this._flags.last_token.type === h.SEMICOLON && T(this._flags.mode)
                ? (e = "SPACE")
                ...
                : this._flags.last_token.type === h.END_EXPR && ((this._output.space_before_token = !0), (e = "NEWLINE")),
                c(t, r) &&
                  ")" !== this._flags.last_token.text &&
                  (e =
                ...
                c(t, ["else", "catch", "finally"])
                  ? (this._flags.last_token.type !== h.END_BLOCK ||
                    ...
                    : (this._output.trim(!0),
                      ...
                      (this._output.space_before_token = !0))
                  : "NEWLINE" === e
                  ? c(this._flags.last_token, f) || ("declare" === this._flags.last_token.text && c(t, ["var", "let", "const"]))
                    ? (this._output.space_before_token = !0)
                    : this._flags.last_token.type !== h.END_EXPR
                    ? (this._flags.last_token.type === h.START_EXPR && c(t, ["var", "let", "const"])) ||
                      ":" === this._flags.last_token.text ||
                      (l(t, "if") && l(t.previous, "else") ? (this._output.space_before_token = !0) : this.print_newline())
                    : c(t, r) && ")" !== this._flags.last_token.text && this.print_newline()
                  : this._flags.multiline_frame &&
                    O(this._flags.mode) &&
                    "," === this._flags.last_token.text &&
                    "}" === this._last_last_text
                ...
                t.type === h.RESERVED &&
                  ("do" === t.text
                    ...
                    : this._flags.import_block && l(t, "from") && (this._flags.import_block = !1));
            }),
            (R.prototype.handle_semicolon = function (t) {
              ...
              for (
                var e = this._tokens.peek();
                !(this._flags.mode !== m || (this._flags.if_block && l(e, "else")) || this._flags.do_block);
            ...
            (R.prototype.handle_string = function (t) {
              (!t.text.startsWith("`") ||
                0 !== t.newlines ||
                "" !== t.whitespace_before ||
                (")" !== t.previous.text && this._flags.last_token.type !== h.WORD)) &&
                (this.start_of_statement(t)
                  ? (this._output.space_before_token = !0)
                  : (this.handle_whitespace_and_comments(t),
            ...
            (R.prototype.handle_comma = function (t) {
              this.handle_whitespace_and_comments(t, !0),
                ...
                this._flags.declaration_statement
                  ? (T(this._flags.parent.mode) && (this._flags.declaration_assignment = !1),
                  ...
                  : this._flags.mode === k || (this._flags.mode === m && this._flags.parent.mode === k)
                  ? (this._flags.mode === m && this.restore_mode(), this._flags.inline_frame || this.print_newline())
                  : this._options.comma_first && this.allow_wrap_or_preserved_newline(t);
            }),
            (R.prototype.handle_operator = function (t) {
              var e =
                  ...
                  (c(this._flags.last_token, ["function", "yield"]) ||
                    p(this._flags.last_token.type, [h.START_BLOCK, h.COMMA, h.END_BLOCK, h.SEMICOLON])),
                i =
                  p(t.text, ["-", "+"]) &&
                  (p(this._flags.last_token.type, [h.START_BLOCK, h.START_EXPR, h.EQUALS, h.OPERATOR]) ||
                    p(this._flags.last_token.text, r) ||
                    "," === this._flags.last_token.text);
              ...
              if ("*" !== t.text || this._flags.last_token.type !== h.DOT)
                if ("::" !== t.text) {
                  if (
                    (this._flags.last_token.type === h.OPERATOR &&
                      p(this._options.operator_position, g) &&
                      this.allow_wrap_or_preserved_newline(t),
                  ...
                  if (
                    ...
                    switch (this._options.operator_position) {
                      case d.before_newline:
                        return (
                          (this._output.space_before_token = !k),
                          this.print_token(t),
                      ...
                      case d.preserve_newline:
                        return (
                          k || this.allow_wrap_or_preserved_newline(t),
                  ...
                  if (e) {
                    ...
                    this.allow_wrap_or_preserved_newline(t), (_ = this._flags.last_token.type === h.START_BLOCK), (s = !1);
                  else if (p(t.text, ["--", "++", "!", "~"]) || i) {
                    if (
                      ((this._flags.last_token.type !== h.COMMA && this._flags.last_token.type !== h.START_EXPR) ||
                        this.allow_wrap_or_preserved_newline(t),
                      (_ = !1),
                      (s = !1),
                    ...
                    ";" === this._flags.last_token.text && T(this._flags.mode) && (_ = !0),
                      this._flags.last_token.type === h.RESERVED
                        ? (_ = !0)
                        : this._flags.last_token.type === h.END_EXPR
                        ? (_ = !("]" === this._flags.last_token.text && ("--" === t.text || "++" === t.text)))
                        : this._flags.last_token.type === h.OPERATOR &&
                          ((_ = p(t.text, ["--", "-", "++", "+"]) && p(this._flags.last_token.text, ["--", "-", "++", "+"])),
                          p(t.text, ["+", "-"]) && p(this._flags.last_token.text, ["--", "++"]) && (s = !0)),
                      ((this._flags.mode !== b || this._flags.inline_frame) && this._flags.mode !== m) ||
            ...
            (R.prototype.handle_block_comment = function (t, e) {
              return this._output.raw
                ...
                : ((this._output.space_before_token = !0), this.print_token(t), void (this._output.space_before_token = !0));
            }),
            (R.prototype.print_block_commment = function (t, e) {
              ...
              if (
                ...
                for (
                  _ = (function (t, e) {
                    for (var i = 0; i < t.length; i++) if ("*" !== t[i].trim().charAt(0)) return !1;
                    return !0;
                  })((n = n.slice(1))),
                    a = (function (t, e) {
                      for (var i, n = 0, _ = t.length; n < _; n++) if ((i = t[n]) && 0 !== i.indexOf(e)) return !1;
                      return !0;
                    })(n, u),
                  ...
                  _
                    ? (this.print_token_line_indentation(t), this._output.add_token(n[i].replace(/^\s+/g, "")))
                    : a && n[i]
                    ? (this.print_token_line_indentation(t), this._output.add_token(n[i].substring(r)))
                    : (this._output.current_line.set_indent(-1), this._output.add_token(n[i])),
                    this.print_newline(!1, e);
            ...
            (R.prototype.handle_dot = function (t) {
              this.start_of_statement(t) || this.handle_whitespace_and_comments(t, !0),
                ...
                c(this._flags.last_token, f)
                  ? (this._output.space_before_token = !1)
                  : this.allow_wrap_or_preserved_newline(t, ")" === this._flags.last_token.text && this._options.break_chained_methods),
        ...
        76: function (t, e, i) {
          ...
          ((v.prototype = new _())._is_comment = function (t) {
                    ...
                    (i =
                      (i =
                        (i =
                          (i =
                            (i =
                              (i = (i = (i = i || this._read_non_javascript(n)) || this._read_string(n)) || this._read_word(t)) ||
                              this._read_singles(n)) || this._read_comment(n)) || this._read_regexp(n, t)) || this._read_xml(n, t)) ||
                      this._read_punctuation()) || this._create_token(p.UNKNOWN, this._input.next()));
            }),
            (v.prototype._read_word = function (t) {
              var e;
              return "" !== (e = this.__patterns.identifier.read())
                ? ((e = e.replace(u.allLineBreaks, "\n")),
                  t.type !== p.DOT && (t.type !== p.RESERVED || ("set" !== t.text && "get" !== t.text)) && x.test(e)
                    ? ("in" !== e && "of" !== e) || (t.type !== p.WORD && t.type !== p.STRING)
            ...
            (v.prototype._allow_regexp_or_xml = function (t) {
              return (
                (t.type === p.RESERVED && h(t.text, ["return", "case", "throw", "else", "do", "typeof", "yield"])) ||
                (t.type === p.END_EXPR &&
                  ")" === t.text &&
                  t.opened.previous.type === p.RESERVED &&
                  h(t.opened.previous.text, ["if", "while", "for"])) ||
                h(t.type, [p.COMMENT, p.START_EXPR, p.START_BLOCK, p.START, p.END_BLOCK, p.OPERATOR, p.EQUALS, p.EOF, p.SEMICOLON, p.COMMA])
              );
            }),
            (v.prototype._read_regexp = function (t, e) {
              if ("/" === t && this._allow_regexp_or_xml(e)) {
                for (
                  var i = this._input.next(), n = !1, _ = !1;
                  this._input.hasNext() && (n || _ || this._input.peek() !== t) && !this._input.testChar(u.newline);

                )
                  (i += this._input.peek()),
                    n
                      ? (n = !1)
                      : ((n = "\\" === this._input.peek()), "[" === this._input.peek() ? (_ = !0) : "]" === this._input.peek() && (_ = !1)),
                    this._input.next();
                return (
                  this._input.peek() === t && ((i += this._input.next()), (i += this._input.read(u.identifier))),
            ...
            (v.prototype._read_xml = function (t, e) {
              if (this._options.e4x && "<" === t && this._allow_regexp_or_xml(e)) {
                ...
                if (n) {
                  ...
                  return (
                    n || (i += this._input.match(/[\s\S]*/g)[0]), (i = i.replace(u.allLineBreaks, "\n")), this._create_token(p.STRING, i)
                  );
                }
              }
              return null;
            ...
            (v.prototype._read_string_recursive = function (t, e, i) {
              ...
              "'" === t
                ...
                : '"' === t
                ? (_ = this.__patterns.double_quote)
                : "`" === t
                ? (_ = this.__patterns.template_text)
                : "}" === t && (_ = this.__patterns.template_expression);
              for (var s = _.read(), a = ""; this._input.hasNext(); ) {
                ...
                "\\" === a && this._input.hasNext()
                  ? ("x" === (n = this._input.peek()) || "u" === n
                    ...
                    (a += this._input.next()))
                  : i &&
                    ("${" === i && "$" === a && "{" === this._input.peek() && (a += this._input.next()),
                    i === a &&
                      ((a += "`" === t ? this._read_string_recursive("}", e, "`") : this._read_string_recursive("`", e, "${")),
            ...
            (t.exports.d2 = v),
            (t.exports.o3 = p),
            (t.exports.L2 = g.slice()),
            (t.exports.O9 = w.slice());
        }
      },
      e = {};
    return (function i(n) {
