...
if (typeof vAPI === "object" && vAPI.randomToken instanceof Function === false) {
  ...
  vAPI.messaging = {
    ...
    canDestroyPort: function () {
      return this.pending.size === 0 && (this.extensions.length === 0 || this.extensions.every((e) => e.canDestroyPort()));
    },
    ...
    extend: function () {
      if (this.extended === undefined) {
        this.extended = vAPI.messaging
          .send("vapi", {
            what: "extendClient"
          })
          .then(() => typeof vAPI === "object" && this.extensions.length !== 0)
          .catch(() => {});
      }
