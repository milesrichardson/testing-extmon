...
const synchronizeDOM = function () {
  dom.cl.toggle(dom.body, "advancedUser", qs$('[data-setting-name="advancedUserEnabled"]').checked === true);
};
...
const changeUserSettings = function (name, value) {
  ...
  switch (name) {
    ...
    case "uiAccentCustom0":
      setAccentColor(qs$('[data-setting-name="uiAccentCustom"]').checked, qs$('[data-setting-name="uiAccentCustom0"]').value, true);
      break;
    default:
      break;
  }
...
dom.on('[data-i18n-title="settingsAdvancedUserSettings"]', "click", self.uBlockDashboard.openOrSelectPage);
